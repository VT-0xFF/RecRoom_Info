...
// DTO classes: 157 (plus referenced enums)
...
public class HTTPResponse
{
    ...
    public MemoryStream decompressorInputStream;    // 0x0xB8
    public MemoryStream decompressorOutputStream;    // 0x0xC0
    public GZipStream decompressorGZipStream;    // 0x0xC8
    public byte[] copyBuffer;    // 0x0xD0
}
...
public class WebSocketResponse : HTTPResponse
{
    ...
    public object FrameLock;    // 0x0x138
    public object SendLock;    // 0x0x140
    public List<WebSocketFrame> unsentFrames;    // 0x0x148
    public AutoResetEvent newFrameSignal;    // 0x0x150
    public bool sendThreadCreated;    // 0x0x158
    public bool closeSent;    // 0x0x159
    public bool closed;    // 0x0x15A
    public DateTime lastPing;    // 0x0x160
    public DateTime lastMessage;    // 0x0x168
    public CircularBuffer<int> rtts;    // 0x0x170
}
...
// --------------------------------------------------------------------------
// Gaia.FullSerializer.fsResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class fsResult : ValueType
{
    public bool _success;    // 0x0x0
    public List<string> _messages;    // 0x0x8
}
...
// base   : Mono.Net.Dns.DnsPacket
//   (not directly referenced by a detected call)
public class DnsResponse : DnsPacket
{
    public ReadOnlyCollection<DnsQuestion> question;    // 0x0x28
    public ReadOnlyCollection<DnsResourceRecord> answer;    // 0x0x30
    public ReadOnlyCollection<DnsResourceRecord> authority;    // 0x0x38
    public ReadOnlyCollection<DnsResourceRecord> additional;    // 0x0x40
    public int offset;    // 0x0x48
}
...
// base   : Mono.Security.Protocol.Tls.Handshake.HandshakeMessage
//   (not directly referenced by a detected call)
public class TlsServerCertificateRequest : HandshakeMessage
{
    public ClientCertificateType[] certificateTypes;    // 0x0x58
    public string[] distinguisedNames;    // 0x0x60
}
...
// base   : Org.BouncyCastle.Asn1.Asn1Encodable
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// Org.BouncyCastle.Crypto.Operators.SigResult
//   (not directly referenced by a detected call)
public class SigResult
{
    public ISigner sig;    // 0x0x10
}
...
{
    public Status status;    // 0x0x10
    public string notification;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.AddVersionInventionRequestDTO
//   REQUEST  POST   api/inventions/   [Service.API]
public class AddVersionInventionRequestDTO
{
    public int instantiationCost;    // 0x0x10
    public List<string> referencedImages;    // 0x0x18
    public List<string> referencedData;    // 0x0x20
}
...
public class Avatar
{
    public string <OutfitSelections>k__BackingField;    // 0x0x10
    public string <FaceFeatures>k__BackingField;    // 0x0x18
    public string <SkinColor>k__BackingField;    // 0x0x20
    public string <HairColor>k__BackingField;    // 0x0x28
}
...
//   RESPONSE POST   api/chat/   [Service.API]
...
//   RESPONSE GET    api/storefronts/   [Service.API]
...
// --------------------------------------------------------------------------
// RecNet.Group
//   RESPONSE GET    api/groups/   [Service.API]
public class Group
{
...
{
    public List<InventionTag> <Tags>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.InventionResponse
//   RESPONSE POST   api/inventions/   [Service.API]
...
public class InventionVersion
{
    ...
    public string <BlobName>k__BackingField;    // 0x0x20
}
...
//   REQUEST  POST   api/PlayerReporting/   [Service.API]
...
//   RESPONSE GET    api/playerevents/   [Service.API]
...
// --------------------------------------------------------------------------
// RecNet.MatchmakingConfigParams
//   (not directly referenced by a detected call)
public class MatchmakingConfigParams
{
    public float <PreferFullRoomsFrequency>k__BackingField;    // 0x0x10
    public float <PreferEmptyRoomsFrequency>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// RecNet.ModerationBlockDetail
//   RESPONSE GET    api/PlayerReporting/   [Service.API]
...
public class NewInventionRequestDTO
{
    ...
    public List<string> referencedImages;    // 0x0x30
    public List<string> referencedData;    // 0x0x38
}
...
//   REQUEST  POST   api/objectives/   [Service.API]
...
// --------------------------------------------------------------------------
// RecNet.OkResponse
//   REQUEST  POST   api/PlayerCheer/   [Service.API]
//   RESPONSE POST   api/PlayerCheer/   [Service.API]
//   REQUEST  POST   api/PlayerReporting/   [Service.API]
//   RESPONSE POST   api/PlayerReporting/   [Service.API]
//   RESPONSE POST   api/platformlogin/   [Service.API]
//   RESPONSE POST   api/playerevents/   [Service.API]
//   RESPONSE POST   api/players/   [Service.API]
//   RESPONSE POST   api/rooms/   [Service.API]
...
//   RESPONSE GET    api/rooms/   [Service.API]
...
{
    public bool <CrcCheckEnabled>k__BackingField;    // 0x0x10
    public bool <EnableServerTracingAfterDisconnect>k__BackingField;    // 0x0x11
}
...
//   RESPONSE GET    api/quickPlay/   [Service.API]
...
public class Profile
{
    ...
    public ObscuredBool <AvoidJuniors>k__BackingField;    // 0x0xBC
    public ObscuredBool <HasBirthday>k__BackingField;    // 0x0xC8
    public Reputation <Reputation>k__BackingField;    // 0x0xD8
    public PlatformMapping <PlatformId>k__BackingField;    // 0x0xE0
}
...
{
    public string <MessageOfTheDay>k__BackingField;    // 0x0x10
    public Uri <CdnBaseUri>k__BackingField;    // 0x0x18
    public MatchmakingConfigParams <MatchmakingParams>k__BackingField;    // 0x0x20
    public Dictionary<int, int> <LevelProgressionMap>k__BackingField;    // 0x0x28
    public Objective[][] <DailyObjectives>k__BackingField;    // 0x0x30
    public PhotonConfig <PhotonConfig>k__BackingField;    // 0x0x38
    public ServerMaintenanceDTO <ServerMaintenance>k__BackingField;    // 0x0x40
    public AutoMicMutingConfig <AutoMicMutingConfig>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// RecNet.Relationship
//   RESPONSE GET    api/relationships/   [Service.API]
...
public class Room
{
    ...
    public int <CreatorPlayerId>k__BackingField;    // 0x0x30
    public RoomState <State>k__BackingField;    // 0x0x34
    public RoomAccessibility <Accessibility>k__BackingField;    // 0x0x38
    public bool <SupportsLevelVoting>k__BackingField;    // 0x0x3C
    public bool <IsAGRoom>k__BackingField;    // 0x0x3D
    public bool <IsDormRoom>k__BackingField;    // 0x0x3E
    public bool <CloningAllowed>k__BackingField;    // 0x0x3F
    public bool <SupportsScreens>k__BackingField;    // 0x0x40
    public bool <SupportsWalkVR>k__BackingField;    // 0x0x41
    public bool <SupportsTeleportVR>k__BackingField;    // 0x0x42
    public bool <AllowsJuniors>k__BackingField;    // 0x0x43
    public bool <DisableMicAutoMute>k__BackingField;    // 0x0x44
}

// --------------------------------------------------------------------------
// RecNet.RoomAccessibility
// base   : System.Enum
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.RoomInstanceDetails
//   RESPONSE GET    api/rooms/   [Service.API]
public class RoomInstanceDetails
{
    public int <PlayerCount>k__BackingField;    // 0x0x10
    public int <GameSessionCount>k__BackingField;    // 0x0x14
}
...
// --------------------------------------------------------------------------
// RecNet.Setting
//   REQUEST  POST   api/settings/   [Service.API]
...
public class StorefrontGiftDrop
{
    ...
    public string <EquipmentPrefabName>k__BackingField;    // 0x0x38
    public string <EquipmentModificationGuid>k__BackingField;    // 0x0x40
    public bool <IsQuery>k__BackingField;    // 0x0x48
    public bool <Unique>k__BackingField;    // 0x0x49
    public GiftRarity <Rarity>k__BackingField;    // 0x0x4C
    public GiftBoxContents <Content>k__BackingField;    // 0x0x50
    public GiftContext <Context>k__BackingField;    // 0x0x54
}
...
{
    public ConfirmDialogResponses responseType;    // 0x0x0
    public InventionModificationPermission modificationPermission;    // 0x0x4
    public InventionRepublishingPermission republishingPermission;    // 0x0x8
}
...
{
    public ObjectiveType objectiveType;  // wrapper
    public ApiCallback<Leaderboard> callback;  // wrapper
    public object SortAscending;  // candidate
    public object Limit;  // candidate
}

// api/PlayersBanned/  [API POST]
public class PlayersBannedRequest
{
...
// api/offlineinvite/  [API POST]
public class OfflineinviteRequest
{
    public ApiCallback<string> callback;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerReputation/  [API POST]
public class PlayerReputationRequest
{
    public float GoodKarmaMinutes;  // wrapper
}

// api/players/  [API POST]
public class PlayersRequest
{
    ...
    public DateTime dateTime;  // wrapper
...
// api/playersubscriptions/  [API GET]
public class PlayersubscriptionsRequest
{
    public object PlayerId;  // candidate
}

// api/presence/v3/heartbeat  [API POST]
public class PresenceV3HeartbeatRequest
{
    public object UseHeartbeatWebSocket;  // candidate
}

// api/relationships/  [API GET]
