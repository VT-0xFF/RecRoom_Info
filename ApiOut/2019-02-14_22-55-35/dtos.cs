...
// DTO classes: 160 (plus referenced enums)
...
{
    public Uri <CdnBaseUri>k__BackingField;    // 0x0x10
    public Dictionary<int, int> <LevelProgressionMap>k__BackingField;    // 0x0x18
...
// api/platformlogin/  [API POST]
public class PlatformloginRequest
{
    public ApiCallback<List<CachedLogin>> callback;  // wrapper
    public object Platform;  // candidate
    public object PlatformId;  // candidate
    public object Email;  // candidate
...
// api/purchase/v1/cancelpurchase  [API POST]
...
// api/purchase/v1/completepurchase  [API POST]
...
// api/purchase/v1/initiatepurchase  [API POST]
