...
// DTO classes: 156 (plus referenced enums)
...
//   RESPONSE POST   api/PlayerReporting/v2/voteToKick   [Service.API]
...
//   RESPONSE GET    api/rooms/v2/instancedetails/{instancedetailId}   [Service.API]
...
// api/PlayerReporting/v2/voteToKick  [API POST]
public class PlayerReportingV2VoteToKickRequest
{
    public ApiCallback<OkResponse> callback;  // wrapper
...
// api/players/v1/avoidJuniors  [API POST]
public class PlayersV1AvoidJuniorsRequest
{
    public ApiCallback callback;  // wrapper
    public object AvoidJuniors;  // candidate
}
...
// api/presence/v2/list  [API POST]
public class PresenceV2ListRequest
{
    public long[] profileIds;  // wrapper
}
...
// api/presence/v3/heartbeatwebsocket  [API POST]
public class PresenceV3HeartbeatwebsocketRequest
{
    public object UseHeartbeatWebSocket;  // candidate
}
