...
public class ChatMessage
{
    ...
    public string <FormattedTimeSentString>k__BackingField;    // 0x0x50
}
...
public class ChatThread
{
    ...
    public string cachedCalculatedChatName;    // 0x0x58
}
...
{
    public List<StorefrontGiftDrop> <GiftDrops>k__BackingField;    // 0x0x30
}
...
public enum CreationResult
{
    ...
    Failure_ConnectedToolFrozen = 4,
    Failure_LockedByOther = 5,
    Failure_HeldByOther = 6,
    Failure_SelectingFrozenTool = 7,
    Failure_SettingsChangedByOther = 8,
    Failure_InsufficientResources = 9,
    Failure_Parented = 10,
    Failure_ObjectDoesNotExist = 11,
    Failure_ParentChanged = 12,
    Failure_ToolHeld = 13,
    Failure_NetworkError = 14,
    Failure_ObjectAlreadyExists = 15,
    Failure_ToolNotEnabled = 16,
    Failure_PermissionDenied = 17,
    Failure_InvalidAction = 18,
    Failure_ObjectInUse = 19,
    Failure_MaxSpawnsUsed = 20,
    Failure_InsufficientLightResources = 21,
    Failure_ContainsDisallowedObjects = 22,
}
