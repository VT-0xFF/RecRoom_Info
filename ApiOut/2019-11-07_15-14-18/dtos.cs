...
// DTO classes: 207 (plus referenced enums)
...
public class NewInventionRequestDTO
{
    ...
    public int <instantiationCost>k__BackingField;    // 0x0x28
    public int <lightsCost>k__BackingField;    // 0x0x2C
    public long <creationRoomId>k__BackingField;    // 0x0x30
    public string <inventionDataFilename>k__BackingField;    // 0x0x38
    public List<long> <referencedInventions>k__BackingField;    // 0x0x40
    public RoomRole? <creatorPlayerRole>k__BackingField;    // 0x0x48
    public RoomPermissionValue? <creatorPlayerCoOwnerRoomPermission>k__BackingField;    // 0x0x50
    public RoomPermissionValue? <creatorPlayerModeratorRoomPermission>k__BackingField;    // 0x0x58
    public RoomPermissionValue? <creatorPlayerHostRoomPermission>k__BackingField;    // 0x0x60
}
...
//   RESPONSE POST   api/players/v1/username   [Service.API]
...
public class Profile
{
    ...
    public ObscuredString <RawUsername>k__BackingField;    // 0x0x30
    public ObscuredString <Username>k__BackingField;    // 0x0x38
    public ObscuredString <DisplayName>k__BackingField;    // 0x0x40
    public string <Bio>k__BackingField;    // 0x0x48
    public ObscuredInt <XP>k__BackingField;    // 0x0x50
    public ObscuredInt <Level>k__BackingField;    // 0x0x60
    public ObscuredInt _registrationStatus;    // 0x0x70
    public ObscuredBool <Developer>k__BackingField;    // 0x0x80
    public ObscuredBool <CanReceiveInvites>k__BackingField;    // 0x0x8C
    public ObscuredString <ProfileImageName>k__BackingField;    // 0x0x98
    public ObscuredBool <JuniorProfile>k__BackingField;    // 0x0xA0
    public ObscuredBool <ForceJuniorImages>k__BackingField;    // 0x0xAC
    public ObscuredBool <PendingJunior>k__BackingField;    // 0x0xB8
    public ObscuredBool <HasBirthday>k__BackingField;    // 0x0xC4
    public Reputation <Reputation>k__BackingField;    // 0x0xD0
    public PlatformMapping <PlatformId>k__BackingField;    // 0x0xD8
}
...
public class RoomDetails
{
    ...
    public RoomRole <LocalPlayerRole>k__BackingField;    // 0x0x88
}
...
// api/players/v1/username  [API POST]
public class PlayersV1UsernameRequest
{
    public ApiCallback<OkResponse> callback;  // wrapper
    public object Name;  // candidate
}
