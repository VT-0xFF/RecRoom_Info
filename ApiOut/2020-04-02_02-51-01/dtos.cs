...
{
    public int CreatorPlayerId;    // 0x0x10
    public string Data;    // 0x0x18
    public bool IsValid;    // 0x0x20
}
...
public class AnnouncementDTO
{
    ...
    public AnnouncementLinkType <LinkType>k__BackingField;    // 0x0x38
    public string <LinkName>k__BackingField;    // 0x0x40
    public string <LinkUri>k__BackingField;    // 0x0x48
    public PlatformType <Platform>k__BackingField;    // 0x0x50
    public DateTime <CreatedAt>k__BackingField;    // 0x0x58
    public AnnouncementStatus <AnnouncementStatus>k__BackingField;    // 0x0x60
    public bool <IsMostRecent>k__BackingField;    // 0x0x64
}
...
{
    public double FreshnessSeconds;    // 0x0x10
    public string Url;    // 0x0x18
}
...
{
    public long <RoomId>k__BackingField;    // 0x0x10
    public bool isCheering;    // 0x0x18
    public bool isBookmarked;    // 0x0x19
}
...
public class RecRoomConfig
{
    ...
    public string <ShareBaseUrl>k__BackingField;    // 0x0x30
}
...
{
    public string Info;    // 0x0x10
    public int ReferrerId;    // 0x0x18
}
...
public class RoomDetails
{
    ...
    public List<ObscuredInt> <CoOwnerIds>k__BackingField;    // 0x0x20
    public List<int> <InvitedCoOwnerIds>k__BackingField;    // 0x0x28
    public List<ObscuredInt> <ModeratorIds>k__BackingField;    // 0x0x30
    public List<int> <InvitedModeratorIds>k__BackingField;    // 0x0x38
    public List<ObscuredInt> <HostIds>k__BackingField;    // 0x0x40
...
{
    public long <RoomPlaylistId>k__BackingField;    // 0x0x10
    public string <Name>k__BackingField;    // 0x0x18
    public string <Description>k__BackingField;    // 0x0x20
    public string <ImageName>k__BackingField;    // 0x0x28
    public ObscuredInt _creatorPlayerId;    // 0x0x30
    public RoomState <State>k__BackingField;    // 0x0x40
    public RoomAccessibility <Accessibility>k__BackingField;    // 0x0x44
    public bool <SupportsLevelVoting>k__BackingField;    // 0x0x48
    public bool <IsAGRoom>k__BackingField;    // 0x0x49
    public bool <IsDormRoom>k__BackingField;    // 0x0x4A
    public bool <CloningAllowed>k__BackingField;    // 0x0x4B
    public bool <SupportsScreens>k__BackingField;    // 0x0x4C
    public bool <SupportsWalkVR>k__BackingField;    // 0x0x4D
    public bool <SupportsTeleportVR>k__BackingField;    // 0x0x4E
    public bool <SupportsVRLow>k__BackingField;    // 0x0x4F
    public bool <SupportsMobile>k__BackingField;    // 0x0x50
    public bool <AllowsJuniors>k__BackingField;    // 0x0x51
    public bool <DisableMicAutoMute>k__BackingField;    // 0x0x52
    public RoomWarningMask <RoomWarningMask>k__BackingField;    // 0x0x54
    public string <CustomRoomWarning>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// RecNet.RoomPlaylistDetails
//   RESPONSE GET    api/roomplaylist/byname/   [Service.API]
//   RESPONSE GET    api/roomplaylist/{roomplaylistId}/v1/details   [Service.API]
public class RoomPlaylistDetails
{
    public RoomPlaylist <Playlist>k__BackingField;    // 0x0x10
    public List<Room> <Rooms>k__BackingField;    // 0x0x18
    public List<string> AllTags;    // 0x0x20
    public int <CheerCount>k__BackingField;    // 0x0x28
    public int <FavoriteCount>k__BackingField;    // 0x0x2C
    public int <VisitCount>k__BackingField;    // 0x0x30
}
...
public class TestCase
{
    ...
    public string RoomName;    // 0x0x30
    public TestCaseStatus Status;    // 0x0x38
    public int MinNumAssignedPlayers;    // 0x0x3C
    public List<int> AssignedPlayerIds;    // 0x0x40
    public List<string> AssignedPlayerNames;    // 0x0x48
    public List<string> Tags;    // 0x0x50
    public string JiraUrl;    // 0x0x58
    public string JiraBugUrl;    // 0x0x60
}
...
{
    public uint Id;    // 0x0x10
    public string Name;    // 0x0x18
    public string Description;    // 0x0x20
    public DateTime StartDate;    // 0x0x28
    public DateTime? EndDate;    // 0x0x30
    public bool WasManuallyClosed;    // 0x0x40
    public List<TestCase> TestCases;    // 0x0x48
    public List<string> Tags;    // 0x0x50
    public int NumTestCases;    // 0x0x58
    public int NumPassedTestCases;    // 0x0x5C
    public int NumFailedTestCases;    // 0x0x60
}
...
public enum CreationResult
{
    ...
    Failure_ShapeContainerCapacity = 24,
    Failure_LockedByEditedGizmo = 25,
}
