...
public class LCINPNMFEKB
{
    ...
    public List<Room> <OPEFAHNKKHE>k__BackingField;    // 0x0x18
...
public class NewInventionRequestDTO
{
    ...
    public JEOPBMGBDBJ creatorPlayerCoOwnerRoomPermission;    // 0x0x4C
    public JEOPBMGBDBJ creatorPlayerModeratorRoomPermission;    // 0x0x50
    public JEOPBMGBDBJ creatorPlayerHostRoomPermission;    // 0x0x54
}
