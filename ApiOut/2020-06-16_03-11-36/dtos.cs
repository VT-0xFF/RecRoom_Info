...
// DTO classes: 188 (plus referenced enums)
...
public class BCALPMDHDAJ
{
    ...
    public bool <AKNMDBHFGFN>k__BackingField;    // 0x0x4C
    public bool <IKHHNCBCNDF>k__BackingField;    // 0x0x4D
    public bool <KPJFHGOFIIN>k__BackingField;    // 0x0x4E
    public bool <CJFMCHOJLEL>k__BackingField;    // 0x0x4F
    public bool <PNCPHDGELMM>k__BackingField;    // 0x0x50
    public bool <MIFCOAAHJFP>k__BackingField;    // 0x0x51
    public bool <EDEFMJKNIKL>k__BackingField;    // 0x0x52
    public bool <HFECFKPEFOH>k__BackingField;    // 0x0x53
    public CJOMJNKJIHO <ILLFFPAEDPK>k__BackingField;    // 0x0x54
    public string <JGIAFLDCHJP>k__BackingField;    // 0x0x58
}
...
public class Room
{
    ...
    public bool <IIJLJMNCOGJ>k__BackingField;    // 0x0x4A
    public bool <MNIFGMHOBNL>k__BackingField;    // 0x0x4B
    public bool <CJFMCHOJLEL>k__BackingField;    // 0x0x4C
    public bool <PNCPHDGELMM>k__BackingField;    // 0x0x4D
    public bool <AKNMDBHFGFN>k__BackingField;    // 0x0x4E
    public bool <IKHHNCBCNDF>k__BackingField;    // 0x0x4F
    public bool <KPJFHGOFIIN>k__BackingField;    // 0x0x50
    public bool <MIFCOAAHJFP>k__BackingField;    // 0x0x51
    public CJOMJNKJIHO <ILLFFPAEDPK>k__BackingField;    // 0x0x54
    public string <JGIAFLDCHJP>k__BackingField;    // 0x0x58
    public bool <EDEFMJKNIKL>k__BackingField;    // 0x0x60
    public bool <HFECFKPEFOH>k__BackingField;    // 0x0x61
    public bool <GGBFBBJFFEG>k__BackingField;    // 0x0x62
    public int <KHMMNNCJHDD>k__BackingField;    // 0x0x64
}
