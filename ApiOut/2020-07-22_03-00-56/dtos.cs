...
// DTO classes: 189 (plus referenced enums)
...
public class LCBFDIJKDDD
{
    ...
    public int <LGOHPODJGPG>k__BackingField;    // 0x0x48
    public string <IBLODFDLDCB>k__BackingField;    // 0x0x50
    public GFFOIJNGBAH <PJNLMBIKFJO>k__BackingField;    // 0x0x58
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{fFHLLGDDJJD}   [Service.API]
...
public class LLIKADOBGFB
{
    ...
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x18
    public string <OEBMNNJCJBN>k__BackingField;    // 0x0x20
    public DateTime <DCDJJLEIKCO>k__BackingField;    // 0x0x28
    public DateTime <KGOPIALBPNB>k__BackingField;    // 0x0x30
    public GFFOIJNGBAH <PJNLMBIKFJO>k__BackingField;    // 0x0x38
}
...
public class PlayerReportingV3CreateRequest
{
    ...
    public float? EAKABNOKGJE;  // wrapper
    public KONLKGGBLKB<GHMHHBBANDH> KJOEHOGADLP;  // wrapper
