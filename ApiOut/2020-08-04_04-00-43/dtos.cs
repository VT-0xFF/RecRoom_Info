...
// DTO classes: 190 (plus referenced enums)
...
// --------------------------------------------------------------------------
// CircuitsV2.Graph.ConnectionResult
// base   : System.Enum
//   (not directly referenced by a detected call)
public enum ConnectionResult
{
    ...
    AlreadyConnected = 1,
    CanConvert = 2,
    ErrorCycleDetected = 3,
    ErrorInvalidType = 4,
    ErrorNull = 5,
}

// --------------------------------------------------------------------------
// CircuitsV2.Graph.DisconnectionResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class DisconnectionResult : ValueType
{
    public int <IndexOfDstInSrc>k__BackingField;    // 0x0x0
    public DisconnectionResultKind Kind;    // 0x0x4
}
