...
// --------------------------------------------------------------------------
// AGFNMJKCPKD
//   RESPONSE GET    api/inventions/v1/personaldetails/{mMJFAOPCMEC}   [Service.API]
public class AGFNMJKCPKD
{
    public bool <PIDEHJMPLBM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// AGIAJIKKIIB
//   (not directly referenced by a detected call)
public class AGIAJIKKIIB
{
    public long <MOIPGJNOGJA>k__BackingField;    // 0x0x10
    public Guid <PEIMBKDJJMG>k__BackingField;    // 0x0x18
    public long <CCIJOGDDBLN>k__BackingField;    // 0x0x28
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x30
    public string <OEBMNNJCJBN>k__BackingField;    // 0x0x38
    public int <BILPNPMBFDD>k__BackingField;    // 0x0x40
}
...
public class AHHCAHFLOIN : PMMEPNILBLN
{
    public List<HCODDAHMEOI> NABNIDFMIMG;    // 0x0x30
}

// --------------------------------------------------------------------------
// AICBIMDFDJC
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class AICBIMDFDJC
{
    public CHPFAPMKECO <FHPCCJJDLFG>k__BackingField;    // 0x0x10
    public LPILNJBDBFB <MBJJNIHHKAP>k__BackingField;    // 0x0x14
    public int <GFDDFGFGKOG>k__BackingField;    // 0x0x18
    public int <FMFNAEKFLAJ>k__BackingField;    // 0x0x1C
    public int <COHDHJEPNEB>k__BackingField;    // 0x0x20
    public JGEHIEAMBPN <DBBIEGGKGBD>k__BackingField;    // 0x0x24
    public bool <EGJFIKOLBAN>k__BackingField;    // 0x0x28
    public float <BIEJNLCEJJD>k__BackingField;    // 0x0x2C
    public int <KLOMEGIHBNO>k__BackingField;    // 0x0x30
    public bool <AABGDEEIALH>k__BackingField;    // 0x0x34
}
...
public class ALPGKPFIHII
{
    public long <ONFLICEDMGF>k__BackingField;    // 0x0x10
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x18
    public string <OEBMNNJCJBN>k__BackingField;    // 0x0x20
    public DateTime <EBLFPKMIJHE>k__BackingField;    // 0x0x28
    public string <IBLODFDLDCB>k__BackingField;    // 0x0x30
    public OJGKPMLCPIK <LHEEMJAAGII>k__BackingField;    // 0x0x38
    public int <IGCGNAKPEOB>k__BackingField;    // 0x0x3C
    public int <CECIPMAICOK>k__BackingField;    // 0x0x40
    public List<HMDKJCCDPCI> <EGICLDOOIOM>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// BCALPMDHDAJ
//   (not directly referenced by a detected call)
public class BCALPMDHDAJ
{
    public long <MGEFDKELMBK>k__BackingField;    // 0x0x10
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x18
    public string <OEBMNNJCJBN>k__BackingField;    // 0x0x20
    public string <IBLODFDLDCB>k__BackingField;    // 0x0x28
    public ObscuredInt OFPMPJMEHMF;    // 0x0x30
    public FOOHFCBAIDK <AAKDFODLAKM>k__BackingField;    // 0x0x40
    public JBJABBMCLIM <PJNLMBIKFJO>k__BackingField;    // 0x0x44
    public bool <AJDLCBNCIJD>k__BackingField;    // 0x0x48
    public bool <POMAEKMENAG>k__BackingField;    // 0x0x49
    public bool <IIJLJMNCOGJ>k__BackingField;    // 0x0x4A
    public bool <MNIFGMHOBNL>k__BackingField;    // 0x0x4B
    public DateTime <EBLFPKMIJHE>k__BackingField;    // 0x0x50
    public bool <AKNMDBHFGFN>k__BackingField;    // 0x0x58
    public bool <IKHHNCBCNDF>k__BackingField;    // 0x0x59
    public bool <KPJFHGOFIIN>k__BackingField;    // 0x0x5A
    public bool <CJFMCHOJLEL>k__BackingField;    // 0x0x5B
    public bool <PNCPHDGELMM>k__BackingField;    // 0x0x5C
    public bool <MIFCOAAHJFP>k__BackingField;    // 0x0x5D
    public bool <EDEFMJKNIKL>k__BackingField;    // 0x0x5E
    public bool <HFECFKPEFOH>k__BackingField;    // 0x0x5F
    public CJOMJNKJIHO <ILLFFPAEDPK>k__BackingField;    // 0x0x60
    public string <JGIAFLDCHJP>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// BFEMJODFODI
//   (not directly referenced by a detected call)
public class BFEMJODFODI
{
    public long <FNOEIKCLJAG>k__BackingField;    // 0x0x10
    public string <GBFKODLFPDF>k__BackingField;    // 0x0x18
    public string <PAJNFEABMLO>k__BackingField;    // 0x0x20
    public AFCMJFAICOE? <KKNECNLCLMF>k__BackingField;    // 0x0x28
    public string <MKCEDABDMIO>k__BackingField;    // 0x0x30
    public string <OFJAAJIKCIK>k__BackingField;    // 0x0x38
    public ECAJBNFBBDG <ELHFPOKLIFP>k__BackingField;    // 0x0x40
    public int <NEGMJFANEJD>k__BackingField;    // 0x0x44
    public int <BOKNNFMKKCF>k__BackingField;    // 0x0x48
    public DFJIHNKMKPA <GFLDMKHDBBK>k__BackingField;    // 0x0x4C
    public PNBNLCANAON <LBOEFGONHHG>k__BackingField;    // 0x0x50
}
...
public class BPGGGGKFOFC
{
    public long <GMICDKMMJAP>k__BackingField;    // 0x0x10
    public long <CCIJOGDDBLN>k__BackingField;    // 0x0x18
    public EOJIFJGPMJJ <KBHJJFNFGGB>k__BackingField;    // 0x0x20
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x28
    public bool <OJJHCDOJNEG>k__BackingField;    // 0x0x30
    public string <BJAIHIIKGMG>k__BackingField;    // 0x0x38
    public int <ANMACNMDJIB>k__BackingField;    // 0x0x40
    public bool <ENBKOAJAIJI>k__BackingField;    // 0x0x44
    public DateTime <OGJPJAAPKCB>k__BackingField;    // 0x0x48
}
...
public class CBPHDFBJMPF
{
    public int? <PLKMBIEIKBA>k__BackingField;    // 0x0x10
    public string <ACEIGKMHKPB>k__BackingField;    // 0x0x18
    public string <DHCPCEJKMDO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CDCLHGOOEIF
//   (not directly referenced by a detected call)
public class CDCLHGOOEIF
{
    public int <FNOEIKCLJAG>k__BackingField;    // 0x0x10
    public int <BOKNNFMKKCF>k__BackingField;    // 0x0x14
    public string <APOADALIENP>k__BackingField;    // 0x0x18
    public string <EGEJEFKGACG>k__BackingField;    // 0x0x20
    public string <GBFKODLFPDF>k__BackingField;    // 0x0x28
    public string <JCCAOBKGNAO>k__BackingField;    // 0x0x30
    public AFCMJFAICOE? <KKNECNLCLMF>k__BackingField;    // 0x0x38
    public string <MKCEDABDMIO>k__BackingField;    // 0x0x40
    public string <OFJAAJIKCIK>k__BackingField;    // 0x0x48
    public bool <BPAGOPPGEFD>k__BackingField;    // 0x0x50
    public bool <GDINCEFMGPE>k__BackingField;    // 0x0x51
    public bool <MDKJBPENHFG>k__BackingField;    // 0x0x52
    public PNBNLCANAON <HFDIHGCGNBG>k__BackingField;    // 0x0x54
    public OPFFEHPJNFD <GMJPPDJBNEI>k__BackingField;    // 0x0x58
    public DFJIHNKMKPA <IKIEDJAMPLJ>k__BackingField;    // 0x0x5C
}
...
public class CNEJPFFJDNC
{
    public string <LHANMLJPFEL>k__BackingField;    // 0x0x10
    public string <BEOIFFLOOMC>k__BackingField;    // 0x0x18
    public string <NJPONFGIJJI>k__BackingField;    // 0x0x20
    public string <HFBKLOFADAI>k__BackingField;    // 0x0x28
}
...
public class CNJBNNKPGAH
{
    public int <JEHNBLLIFAA>k__BackingField;    // 0x0x10
    public GAGHDOJNJGM <DFLIODKKBGP>k__BackingField;    // 0x0x14
    public JGIEAHNJLNK <EDKHLIOLKFE>k__BackingField;    // 0x0x18
    public JGIEAHNJLNK <PJMJMIBMLOH>k__BackingField;    // 0x0x1C
    public JGIEAHNJLNK <AIKPKGFLJAM>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// CircuitsV2.Graph.ExecutionResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class ExecutionResult : ValueType
{
    public Node Node;    // 0x0x0
    public PortBase Port;    // 0x0x8
    public ExecutionResultKind Kind;    // 0x0x10
}

// --------------------------------------------------------------------------
// CircuitsV2.Graph.GetResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class GetResult : ValueType
{
    public Node LastNode;    // 0x0x0
    public PortBase LastPort;    // 0x0x8
    public CircuitSignal Value;    // 0x0x10
    public GetResultKind Kind;    // 0x0x20
}

// --------------------------------------------------------------------------
// CircuitsV2.Graph.NetworkResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class NetworkResult : ValueType
{
    public NetworkResultKind Kind;    // 0x0x0
}

// --------------------------------------------------------------------------
// CircuitsV2.Graph.Nodes.ExternalGetResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class ExternalGetResult : ValueType
{
    public CircuitSignal Value;    // 0x0x0
    public ExternalGetResultKind Kind;    // 0x0x10
}

// --------------------------------------------------------------------------
// CircuitsV2.Graph.Nodes.ExternalSetResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class ExternalSetResult : ValueType
{
    public bool DidChange;    // 0x0x0
    public ExternalSetResultKind Kind;    // 0x0x4
}

// --------------------------------------------------------------------------
// CircuitsV2.Graph.SetResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class SetResult : ValueType
{
    public bool DidChange;    // 0x0x0
    public Node LastNode;    // 0x0x8
    public PortBase LastPort;    // 0x0x10
    public SetResultKind Kind;    // 0x0x18
}
...
public class DMFCKBNBINN
{
    public DFLEKKGGGDB <NJFLKFIKIDN>k__BackingField;    // 0x0x10
    public AGIAJIKKIIB <EDDBOIODMOB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DMGHAHBDBAL
//   RESPONSE GET    api/config/   [Service.API]
public class DMGHAHBDBAL
{
    public Dictionary<int, int> <JKGEEKIHPGC>k__BackingField;    // 0x0x10
    public Objective[][] <EHPAPBPMGPE>k__BackingField;    // 0x0x18
    public NHHAIEHBGLO <PJKJHAFCFAM>k__BackingField;    // 0x0x20
    public JILJFBFMACF <KEGKLINPJBM>k__BackingField;    // 0x0x28
    public string <ALIMIKKOGOE>k__BackingField;    // 0x0x30
}
...
// EDINDBAAIAD
//   (not directly referenced by a detected call)
public class EDINDBAAIAD
{
    public string <GJOHIIFEAPB>k__BackingField;    // 0x0x10
    public ADHDPOKMGCP <DFLIODKKBGP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EGJDKHONLEO
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class EGJDKHONLEO
{
    public List<NDILEMAJFIH> <LFLCPALIHEN>k__BackingField;    // 0x0x10
    public NOCBFCKFDIM <LIIMBBNDDGC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EHMHIGADJIM
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class EHMHIGADJIM
{
    public long <PFCAGFIJGEC>k__BackingField;    // 0x0x10
    public MNNBPELBDCF <DFLIODKKBGP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EHPLHCJGFNB
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class EHPLHCJGFNB
{
    public int <COEFEFCBPBN>k__BackingField;    // 0x0x10
    public int <JNAKCEIGBJM>k__BackingField;    // 0x0x14
    public float <JHGOPKOHEGM>k__BackingField;    // 0x0x18
    public float <INMGKMCHCPJ>k__BackingField;    // 0x0x1C
    public bool <JMPEIOGDNPI>k__BackingField;    // 0x0x20
    public bool <OCDLNAHDFHC>k__BackingField;    // 0x0x21
    public bool <EDIAFCKCEKK>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// EINJGDFBBGE
//   (not directly referenced by a detected call)
public class EINJGDFBBGE
{
    public int <OLEOHEHGEBE>k__BackingField;    // 0x0x10
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x18
    public string <NJADDMLDHMO>k__BackingField;    // 0x0x20
    public string <OEBMNNJCJBN>k__BackingField;    // 0x0x28
    public string <EGEJEFKGACG>k__BackingField;    // 0x0x30
    public bool <KFPICFLLPNP>k__BackingField;    // 0x0x38
    public int <KIIKJKAFIHH>k__BackingField;    // 0x0x3C
    public GDJJPDBAAHJ <PDIFGKDBLFD>k__BackingField;    // 0x0x40
    public OFACPAGBFOP KBFPOMIKNBP;    // 0x0x48
    public OFACPAGBFOP ENJCKDICMFO;    // 0x0x50
    public OFACPAGBFOP KDIOIJMNBOM;    // 0x0x58
    public EBMCPMILEPJ HNOKMLMGKKB;    // 0x0x60
}
...
public enum EOJIFJGPMJJ
{
    ...
    FRONTIER_SQUADS = 24,
    FRONTIER_SOLOS = 25,
    CRESCENDO_OF_THE_BLOOD_MOON = 26,
    BOWLING_ALLEY = 27,
    ANIMATION_RECORDING_STUDIO = 28,
    STUNTRUNNER = 29,
    STUNTRUNNER_THE_MAIN_EVENT = 30,
    STUNTRUNNER_BASE_ROOM = 31,
    REGISTRATION = 32,
    AR_ROOM = 33,
    DRIVEIN = 34,
    CHARADES_THE_INK_SPACE = 35,
    THE_INK_SPACE_BASE_ROOM = 36,
    FRONTIER_UGC = 37,
}
...
// base   : LNBDIKOIMOB
//   (not directly referenced by a detected call)
public class FBFOEOILKGO : LNBDIKOIMOB
{
    public int <GCPJBMHFIPO>k__BackingField;    // 0x0x40
    public List<HGOEDDBHCGC> <ONEGIKCCFGL>k__BackingField;    // 0x0x48
    public List<HGOEDDBHCGC> <HKNLLCLOFAB>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// FDOLMPKOBLI
//   RESPONSE GET    api/rooms/v2/personaldetails/{nLLIJJEEEDO}   [Service.API]
public class FDOLMPKOBLI
{
    public long <CCIJOGDDBLN>k__BackingField;    // 0x0x10
    public bool NGDJKKHDEBG;    // 0x0x18
    public bool FPKHNFEOIFL;    // 0x0x19
}

// --------------------------------------------------------------------------
// FHKCGCPJLGD
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
public class FHKCGCPJLGD
{
    public List<LCBFDIJKDDD> <AHPCFBBDLMI>k__BackingField;    // 0x0x10
    public List<HMIJDIHDAPN> <MGIJOAFFIHC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FNOFHNHLEOH
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{nGMIOFOKNMN}   [Service.API]
public class FNOFHNHLEOH
{
    public string GENGHIOCCBN;    // 0x0x10
    public string DDBEDEKEMAC;    // 0x0x18
    public string GICCCEDHAAH;    // 0x0x20
    public string JMOBFNAPLHB;    // 0x0x28
    public string DMACGFPHCAM;    // 0x0x30
    public GJNGPEMFHEG POKBNKIMOPA;    // 0x0x38
    public int HKFOLMKIOMH;    // 0x0x3C
    public List<int> MOAHFKHABBL;    // 0x0x40
    public List<string> MICDIEKINDD;    // 0x0x48
    public List<string> MADOCLANDDG;    // 0x0x50
    public string FEMJKAHMBDB;    // 0x0x58
    public string EHLOAGDDLAA;    // 0x0x60
}
...
public class GHMHHBBANDH
{
    public bool <JAEAIDPCMHI>k__BackingField;    // 0x0x10
    public string <KJLIFCCGDJM>k__BackingField;    // 0x0x18
}
...
public class GJAEABNLJJF : PMMEPNILBLN
{
    public int <JNCKMLHDFNH>k__BackingField;    // 0x0x30
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x38
    public DateTime <PBIKCMHDKJN>k__BackingField;    // 0x0x40
    public DateTime <PFFACGDEOFN>k__BackingField;    // 0x0x48
    public CHPFAPMKECO <FHPCCJJDLFG>k__BackingField;    // 0x0x50
    public LNBDIKOIMOB <KFJICMBDALK>k__BackingField;    // 0x0x58
    public List<FBFOEOILKGO> <OMNJPENGNPP>k__BackingField;    // 0x0x60
    public LGDIHFKNDOH <DJMCFHIEDMF>k__BackingField;    // 0x0x68
}
...
public class GJAJFLCKONM
{
    public HKHFJMNJIFP <NJFLKFIKIDN>k__BackingField;    // 0x0x10
    public IMFIMHKCKBC <POEBAHBLLBN>k__BackingField;    // 0x0x18
    public PAGGHKJGLJA <FJOEBCEEDAG>k__BackingField;    // 0x0x20
}
...
// base   : LNBDIKOIMOB
//   (not directly referenced by a detected call)
public class HCODDAHMEOI : LNBDIKOIMOB
{
    public List<CDCLHGOOEIF> <KBMHHHMDDCK>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// HGOEDDBHCGC
//   (not directly referenced by a detected call)
public class HGOEDDBHCGC
{
    public bool <DGNIHGAGBKN>k__BackingField;    // 0x0x10
    public CDCLHGOOEIF <CFAKMILKIBL>k__BackingField;    // 0x0x18
    public float <ANFNENHPECH>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// HMDKJCCDPCI
//   RESPONSE GET    api/groups/v1/memberships/{hABADPCEPBD}   [Service.API]
public class HMDKJCCDPCI
{
    public long <ONFLICEDMGF>k__BackingField;    // 0x0x10
    public int <HEFPLIFAADD>k__BackingField;    // 0x0x18
    public GIIFEFPHGKB <AHGCLPBFOHL>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// HMIJDIHDAPN
//   (not directly referenced by a detected call)
public class HMIJDIHDAPN
{
    public LCBFDIJKDDD <KGJLJAIDILK>k__BackingField;    // 0x0x10
    public IFCEDIIDLCJ <BFMGGDKAAOL>k__BackingField;    // 0x0x18
}
...
public class HOBNNCKECOE
{
    public NOCBFCKFDIM <LIIMBBNDDGC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// ICANNDGFJFB
//   (not directly referenced by a detected call)
public class ICANNDGFJFB
{
    public CHPFAPMKECO <FHPCCJJDLFG>k__BackingField;    // 0x0x10
    public int <BILPNPMBFDD>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// IDGJHLECFFC
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class IDGJHLECFFC
{
    public string <EJPBCGELBPF>k__BackingField;    // 0x0x10
    public string <FFEHCMDLJFM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IFCEDIIDLCJ
//   (not directly referenced by a detected call)
public class IFCEDIIDLCJ
{
    public long <EPGDLALKAMH>k__BackingField;    // 0x0x10
    public long <PFCAGFIJGEC>k__BackingField;    // 0x0x18
    public int <HEFPLIFAADD>k__BackingField;    // 0x0x20
    public DateTime <EBLFPKMIJHE>k__BackingField;    // 0x0x28
    public MNNBPELBDCF <DFLIODKKBGP>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// IHODIILCMFJ
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class IHODIILCMFJ
{
    public JPKNKBDDHEE <LAINCHOOAAP>k__BackingField;    // 0x0x10
    public long <PFCAGFIJGEC>k__BackingField;    // 0x0x18
    public string <AAFNPDHJILH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ILOGODMMIIE
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class ILOGODMMIIE
{
    public int <DMDJBOBNJBC>k__BackingField;    // 0x0x10
    public string <FLMGMANLGDL>k__BackingField;    // 0x0x18
    public List<EINJGDFBBGE> <PBMGLPMCJEG>k__BackingField;    // 0x0x20
    public BFEMJODFODI <LKGAACCIHBM>k__BackingField;    // 0x0x28
    public DateTime <PBIKCMHDKJN>k__BackingField;    // 0x0x30
    public DateTime <PFFACGDEOFN>k__BackingField;    // 0x0x38
    public DateTime <HHIKAKFKLGF>k__BackingField;    // 0x0x40
    public bool <FKDGAJLOCCK>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// IMFIMHKCKBC
//   RESPONSE GET    api/inventions/   [Service.API]
public class IMFIMHKCKBC
{
    public long <JGJDFICKKJK>k__BackingField;    // 0x0x10
    public string <PEIMBKDJJMG>k__BackingField;    // 0x0x18
    public int <KNEAIDGFADE>k__BackingField;    // 0x0x20
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x28
    public string <OEBMNNJCJBN>k__BackingField;    // 0x0x30
    public string <IBLODFDLDCB>k__BackingField;    // 0x0x38
    public int <EMIINKPONIC>k__BackingField;    // 0x0x40
    public bool <GKELFPDDDAE>k__BackingField;    // 0x0x44
    public DateTime <KNPJGOKLEAD>k__BackingField;    // 0x0x48
    public DateTime <EBLFPKMIJHE>k__BackingField;    // 0x0x50
    public DateTime? <CEGEHDIOINO>k__BackingField;    // 0x0x58
    public long? <BJMBPDJLAKA>k__BackingField;    // 0x0x68
    public int <HDIPAEGJBGH>k__BackingField;    // 0x0x78
    public int <ICGKDLNHEKM>k__BackingField;    // 0x0x7C
    public int <GMEDMMGFPKO>k__BackingField;    // 0x0x80
    public JGMBNKPBFEJ <HHCMHOCBJDN>k__BackingField;    // 0x0x84
    public JGMBNKPBFEJ <HLJFEMLFELL>k__BackingField;    // 0x0x88
    public bool <ILIKPNJABKG>k__BackingField;    // 0x0x8C
    public int? <BILPNPMBFDD>k__BackingField;    // 0x0x90
    public bool <NGPOMIDPIKN>k__BackingField;    // 0x0x98
}
...
// JILJFBFMACF
//   (not directly referenced by a detected call)
public class JILJFBFMACF
{
    public float <PKFGFAMLAMP>k__BackingField;    // 0x0x10
    public float <DMMCPBDMEKH>k__BackingField;    // 0x0x14
    public float <FHBNOEFHKLO>k__BackingField;    // 0x0x18
    public float <HLOPPFHDENI>k__BackingField;    // 0x0x1C
    public float <LEEBOLLBLIJ>k__BackingField;    // 0x0x20
    public float <KFJDOFGNEID>k__BackingField;    // 0x0x24
    public float <JCOHDPCHBBN>k__BackingField;    // 0x0x28
    public float <MDCEPPDFGLN>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// JILKNLCBIAF
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class JILKNLCBIAF
{
    public int <KIIKJKAFIHH>k__BackingField;    // 0x0x10
    public string <HDPIEJOLGDF>k__BackingField;    // 0x0x18
    public string <LHANMLJPFEL>k__BackingField;    // 0x0x20
    public string <BEOIFFLOOMC>k__BackingField;    // 0x0x28
    public string <NJPONFGIJJI>k__BackingField;    // 0x0x30
    public string <HFBKLOFADAI>k__BackingField;    // 0x0x38
}
...
public class JPJMJOHCOAO
{
    public int <JNAKCEIGBJM>k__BackingField;    // 0x0x10
    public bool <JMPEIOGDNPI>k__BackingField;    // 0x0x14
    public DateTime <DKCECKDAEBI>k__BackingField;    // 0x0x18
    public bool <BAPCFCGMFJL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KCGKOANLEJG
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{nGMIOFOKNMN}   [Service.API]
public class KCGKOANLEJG
{
    public uint GENGHIOCCBN;    // 0x0x10
    public string BECNLEHIILP;    // 0x0x18
    public string JMOBFNAPLHB;    // 0x0x20
    public DateTime GGDDEDKMMNL;    // 0x0x28
    public DateTime? JCAGGNIOMAL;    // 0x0x30
    public bool MKHKFFBEFKL;    // 0x0x40
    public List<FNOFHNHLEOH> OFHAMGKBGKD;    // 0x0x48
    public List<string> MADOCLANDDG;    // 0x0x50
    public int DLLADGBCHOK;    // 0x0x58
    public int EMMCKMPLKOM;    // 0x0x5C
    public int HPIPEJINKMM;    // 0x0x60
}

// --------------------------------------------------------------------------
// KDNCAMGPBIE
//   RESPONSE GET    api/messages/v1/IOSGetNotificationPreferences   [Service.API]
public class KDNCAMGPBIE
{
    public bool <MOEPPEPIKJC>k__BackingField;    // 0x0x10
    public bool <FFEBMDAAFMM>k__BackingField;    // 0x0x11
    public bool <LCJBCMJDFPM>k__BackingField;    // 0x0x12
}

// --------------------------------------------------------------------------
// KKFGAFEENKG
//   RESPONSE GET    api/inventions/v1/creatorIds   [Service.API]
public class KKFGAFEENKG
{
    public int <KNEAIDGFADE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LCBFDIJKDDD
//   RESPONSE GET    api/playerevents/v1/{fFHLLGDDJJD}   [Service.API]
public class LCBFDIJKDDD
{
    public long <PFCAGFIJGEC>k__BackingField;    // 0x0x10
    public int <KNEAIDGFADE>k__BackingField;    // 0x0x18
    public long <CCIJOGDDBLN>k__BackingField;    // 0x0x20
    public long? <FKEDKFIFCDD>k__BackingField;    // 0x0x28
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x38
    public string <OEBMNNJCJBN>k__BackingField;    // 0x0x40
    public DateTime <DCDJJLEIKCO>k__BackingField;    // 0x0x48
    public DateTime <KGOPIALBPNB>k__BackingField;    // 0x0x50
    public int <LGOHPODJGPG>k__BackingField;    // 0x0x58
    public GFFOIJNGBAH <PJNLMBIKFJO>k__BackingField;    // 0x0x5C
}

// --------------------------------------------------------------------------
// LCINPNMFEKB
//   RESPONSE GET    api/roomplaylist/byname/   [Service.API]
//   RESPONSE GET    api/roomplaylist/{roomplaylistId}/v1/details   [Service.API]
public class LCINPNMFEKB
{
    public BCALPMDHDAJ <MIBDDEGCGAF>k__BackingField;    // 0x0x10
    public List<Room> <COAKNBNAEEJ>k__BackingField;    // 0x0x18
    public List<string> GOCBOPLCHJP;    // 0x0x20
    public int <GMEDMMGFPKO>k__BackingField;    // 0x0x28
    public int <GJCFJEJEBPB>k__BackingField;    // 0x0x2C
    public int <DOFGHOOJHDD>k__BackingField;    // 0x0x30
    public List<Room> MMIIDCMLHHE;    // 0x0x38
}

// --------------------------------------------------------------------------
// LFNFOPPGLHP
//   RESPONSE POST   api/playerevents/   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{fAGMNBNIGII}   [Service.API]
//   RESPONSE POST   api/playerevents/v2/{eventId}   [Service.API]
public class LFNFOPPGLHP
{
    public LCBFDIJKDDD <KGJLJAIDILK>k__BackingField;    // 0x0x10
    public NOCBFCKFDIM <LIIMBBNDDGC>k__BackingField;    // 0x0x18
}
...
// LGDIHFKNDOH
//   (not directly referenced by a detected call)
public class LGDIHFKNDOH
{
    public bool <CCNLKGJGIGB>k__BackingField;    // 0x0x10
    public LKEKJGMNJHJ <OOKKPCFILAN>k__BackingField;    // 0x0x14
    public int <JMDHPBNPGNA>k__BackingField;    // 0x0x18
    public DateTime <KNPJGOKLEAD>k__BackingField;    // 0x0x20
}
...
public class LLIKADOBGFB
{
    public long <CCIJOGDDBLN>k__BackingField;    // 0x0x10
    public long? <FKEDKFIFCDD>k__BackingField;    // 0x0x18
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x28
    public string <OEBMNNJCJBN>k__BackingField;    // 0x0x30
    public DateTime <DCDJJLEIKCO>k__BackingField;    // 0x0x38
    public DateTime <KGOPIALBPNB>k__BackingField;    // 0x0x40
    public GFFOIJNGBAH <PJNLMBIKFJO>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// LNBDIKOIMOB
//   (not directly referenced by a detected call)
public class LNBDIKOIMOB
{
    public int <JNCPKHKCMHG>k__BackingField;    // 0x0x10
    public MGMENCAILOE <DFLIODKKBGP>k__BackingField;    // 0x0x14
    public List<ICANNDGFJFB> <BEPPJAEHJHP>k__BackingField;    // 0x0x18
    public List<ICANNDGFJFB> <NDANDMMPAMO>k__BackingField;    // 0x0x20
    public bool <LHHMFAPHAGH>k__BackingField;    // 0x0x28
    public DateTime? <GMGLBOGOPHC>k__BackingField;    // 0x0x30
}
...
public class LPOOHDIKIFH
{
    public string <NAFLAFGBDOJ>k__BackingField;    // 0x0x10
}
...
public class MKLLMPHIAJK
{
    public Room <AGPBGCHLMMA>k__BackingField;    // 0x0x10
    public List<BPGGGGKFOFC> <LEDLIPLHIEF>k__BackingField;    // 0x0x18
    public List<ObscuredInt> <DKMEIKAOHIK>k__BackingField;    // 0x0x20
    public List<int> <BBNLBKJFKDD>k__BackingField;    // 0x0x28
    public List<ObscuredInt> <DPAAPPNDDPE>k__BackingField;    // 0x0x30
    public List<int> <LKGMIDFJMGG>k__BackingField;    // 0x0x38
    public List<ObscuredInt> <GKBNPLEMKPO>k__BackingField;    // 0x0x40
    public List<int> <AKJAHJMHOCD>k__BackingField;    // 0x0x48
    public List<string> GOCBOPLCHJP;    // 0x0x50
    public List<string> KMKOEGJGLMK;    // 0x0x58
    public List<string> DIKBHBGJNOM;    // 0x0x60
    public List<string> ILGEFNICJEC;    // 0x0x68
    public int <GMEDMMGFPKO>k__BackingField;    // 0x0x70
    public int <GJCFJEJEBPB>k__BackingField;    // 0x0x74
    public int <DOFGHOOJHDD>k__BackingField;    // 0x0x78
    public List<int> <GKPEAMONKAH>k__BackingField;    // 0x0x80
    public ObscuredInt HEDBGDNOBGP;    // 0x0x88
}
...
// NDILEMAJFIH
//   (not directly referenced by a detected call)
public class NDILEMAJFIH
{
    public int <CJLFDCFDFOI>k__BackingField;    // 0x0x10
    public NOCBFCKFDIM <LIIMBBNDDGC>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// NHHAIEHBGLO
//   (not directly referenced by a detected call)
public class NHHAIEHBGLO
{
    public int <MCFLBHNGEDC>k__BackingField;    // 0x0x10
}
...
public class NOMPHLBAJAH
{
    public OPMJMHIPOFH <PALDKLOKAKN>k__BackingField;    // 0x0x10
    public string <PGNGIHFJFID>k__BackingField;    // 0x0x18
}
...
// PAGGHKJGLJA
//   (not directly referenced by a detected call)
public class PAGGHKJGLJA
{
    public long <JGJDFICKKJK>k__BackingField;    // 0x0x10
    public string <PEIMBKDJJMG>k__BackingField;    // 0x0x18
    public int <FPHDJHLKDAG>k__BackingField;    // 0x0x20
    public int <MAMJFCHAMFO>k__BackingField;    // 0x0x24
    public int <GOCFLIEEBDC>k__BackingField;    // 0x0x28
    public string <LMOKMHAPFEO>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// PBNALAKFLFB
//   RESPONSE GET    api/inventions/v1/tagfilters   [Service.API]
public class PBNALAKFLFB
{
    public List<string> <ONPKAMAECFE>k__BackingField;    // 0x0x10
    public List<string> <IJCINLEGCAP>k__BackingField;    // 0x0x18
}
...
public class PCDABGHPPBK
{
    public BLMIOPJEPFM <LIIMBBNDDGC>k__BackingField;    // 0x0x10
    public List<string> <KFIIPOOBLHP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PCGEOMPPIDG
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class PCGEOMPPIDG
{
    public JPKNKBDDHEE <LAINCHOOAAP>k__BackingField;    // 0x0x10
    public int <IFAGBJCGDKC>k__BackingField;    // 0x0x14
    public long <OCIEAFCGHKJ>k__BackingField;    // 0x0x18
    public bool <CJBDBIELMBF>k__BackingField;    // 0x0x20
    public string <KJLIFCCGDJM>k__BackingField;    // 0x0x28
    public int? <LJLCGIFPEDN>k__BackingField;    // 0x0x30
    public bool <AKEDFLBCFNP>k__BackingField;    // 0x0x38
    public float <NHPECCABECJ>k__BackingField;    // 0x0x3C
}

// --------------------------------------------------------------------------
// PKKCDNEHGOD
//   RESPONSE POST   api/consumables/v1/transfer   [Service.API]
public class PKKCDNEHGOD
{
    public bool <JAEAIDPCMHI>k__BackingField;    // 0x0x10
    public string <JMCOCIBDOPI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PLEMGHBDKFK
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class PLEMGHBDKFK
{
    public List<EDINDBAAIAD> <KFIIPOOBLHP>k__BackingField;    // 0x0x10
}
...
{
    public HDEIHGLPFOJ ObjectiveType;    // 0x0x10
...
public class GetRankRequestDTO
{
    ...
    public GLAINJGIJEM FilterType;    // 0x0x20
    public ECLOCIHGHNB Timeframe;    // 0x0x24
...
public class NewInventionRequestDTO
{
    ...
    public int creatorPlayerRole;    // 0x0x50
    public JEOPBMGBDBJ creatorPlayerCoOwnerRoomPermission;    // 0x0x54
    public JEOPBMGBDBJ creatorPlayerModeratorRoomPermission;    // 0x0x58
    public JEOPBMGBDBJ creatorPlayerHostRoomPermission;    // 0x0x5C
}
...
public class ReportRequest
{
    ...
    public CPCJILJLOMH ReportCategory;    // 0x0x20
}

// --------------------------------------------------------------------------
// RecNet.Room
//   RESPONSE GET    api/rooms/v2/name/{nameId}   [Service.API]
//   RESPONSE GET    api/rooms/v2/{roomId}   [Service.API]
//   RESPONSE GET    api/rooms/v3/featured   [Service.API]
public class Room
{
    public long <CCIJOGDDBLN>k__BackingField;    // 0x0x10
    public string <DJNNLNGMEGD>k__BackingField;    // 0x0x18
    ...
    public bool <MNIFGMHOBNL>k__BackingField;    // 0x0x4B
    public DateTime <EBLFPKMIJHE>k__BackingField;    // 0x0x50
    public bool <CJFMCHOJLEL>k__BackingField;    // 0x0x58
    public bool <PNCPHDGELMM>k__BackingField;    // 0x0x59
    public bool <AKNMDBHFGFN>k__BackingField;    // 0x0x5A
    public bool <IKHHNCBCNDF>k__BackingField;    // 0x0x5B
    public bool <KPJFHGOFIIN>k__BackingField;    // 0x0x5C
    public bool <MIFCOAAHJFP>k__BackingField;    // 0x0x5D
    public CJOMJNKJIHO <ILLFFPAEDPK>k__BackingField;    // 0x0x60
    public string <JGIAFLDCHJP>k__BackingField;    // 0x0x68
    public bool <EDEFMJKNIKL>k__BackingField;    // 0x0x70
    public bool <HFECFKPEFOH>k__BackingField;    // 0x0x71
    public bool <GGBFBBJFFEG>k__BackingField;    // 0x0x72
    public int <KHMMNNCJHDD>k__BackingField;    // 0x0x74
}
...
{
    public DAKJBOIPAEH? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public DAKJBOIPAEH LHAJMCNNBNP;  // wrapper
...
{
    public CDMPBHMMCIJ HGHMBEAHLMB;  // wrapper
    public int? LJBDFIJNDBC;  // wrapper
...
{
    public JPKNKBDDHEE JIKAEMCIICO;  // wrapper
    public NKBBBMFFOJF KJOEHOGADLP;  // wrapper
    public object PlayerId;  // candidate
...
{
    public DFJIHNKMKPA MDADGDFNCCP;  // wrapper
    public DFJIHNKMKPA? CNKHJHHCPLB;  // wrapper
    public OCPAGMAIOHE> KJOEHOGADLP;  // wrapper
...
{
    public EINJGDFBBGE NPCCKIEGFFI;  // wrapper
...
{
    public HGDEEDFBCHJ COCGJEHLFLM;  // wrapper
    public JPKNKBDDHEE JIKAEMCIICO;  // wrapper
...
{
    public StatusResponse> KJOEHOGADLP;  // wrapper
...
{
    public KDNCAMGPBIE BMJNEFKLLHA;  // wrapper
}
...
{
    public List<long> DGANEBGBCJB;  // wrapper
    public DBDKHKILKMF DDECEOHOBAH;  // wrapper
    public long? NLLIJJEEEDO;  // wrapper
    public NKBBBMFFOJF KJOEHOGADLP;  // wrapper
...
{
    public String> KJOEHOGADLP;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{fAGMNBNIGII}  [API POST]
public class PlayereventsV2DeleteFAGMNBNIGIIRequest
{
    public LCBFDIJKDDD FAGMNBNIGII;  // wrapper
}

// api/players/v2/objectives  [API POST]
public class PlayersV2ObjectivesRequest
{
    public List<MOKPDKKBMJG> BBLFFFNDOEN;  // wrapper
...
{
    public JEOPBMGBDBJ? HGDFDDFBHBP;  // wrapper
    public JEOPBMGBDBJ? JJIKHHMCGFL;  // wrapper
    public JEOPBMGBDBJ? EMIGMPHFOJN;  // wrapper
    public object PlayerId;  // candidate
    public object RoomId;  // candidate
    public object IsOwner;  // candidate
    public object IsModerator;  // candidate
...
{
    public MatchCompleteStats JAGKJJFOIHL;  // wrapper
}

// api/storefronts/v1/objectives  [API POST]
public class StorefrontsV1ObjectivesRequest
{
    public List<OEAHFLKFAHM> BBLFFFNDOEN;  // wrapper
    public object objectiveType;  // candidate
...
{
    public GJNGPEMFHEG AHDNNGLCAMA;  // wrapper
}
