...
// --------------------------------------------------------------------------
// CCMBKDINCAH
//   RESPONSE GET    api/playerevents/v1/{mOKMJAMNEFP}   [Service.API]
public class CCMBKDINCAH
{
    ...
    public DateTime <NBPEAFMLPDJ>k__BackingField;    // 0x0x48
    public DateTime <EKCLCPFEHDB>k__BackingField;    // 0x0x50
    public int <DIFCEDOHBFA>k__BackingField;    // 0x0x58
    public CMCAFKLAHCD <OMHKPJKDFLJ>k__BackingField;    // 0x0x5C
}
...
public class CDNNKFCCONN
{
    ...
    public string <OPABFJAGBKP>k__BackingField;    // 0x0x28
...
public class GGMFNEALJGL
{
    ...
    public string <OPABFJAGBKP>k__BackingField;    // 0x0x18
...
public class HHPEKHPIABO
{
    ...
    public long? <CHPCFOKEIFM>k__BackingField;    // 0x0x18
    public string <LGACIEKBLBM>k__BackingField;    // 0x0x28
    public string <EHGJCEHECFB>k__BackingField;    // 0x0x30
    public DateTime <NBPEAFMLPDJ>k__BackingField;    // 0x0x38
    public DateTime <EKCLCPFEHDB>k__BackingField;    // 0x0x40
    public CMCAFKLAHCD <OMHKPJKDFLJ>k__BackingField;    // 0x0x48
}
...
public class HOGFDJNNMHM
{
    ...
    public float <MDKKBKFIDFI>k__BackingField;    // 0x0x3C
}
...
public class LJABJOIAAHN
{
    public int <KBFNGJBKEOP>k__BackingField;    // 0x0x10
}
...
public class MJLPNOMEFKG
{
    ...
    public int <BOEPNILALGE>k__BackingField;    // 0x0x14
    ...
    public HDMOIDKEOCM <KFFMMFIJKJM>k__BackingField;    // 0x0x58
    public LCLKAFOPBLD <KLCOFMJCFHG>k__BackingField;    // 0x0x5C
}
...
public class NewInventionRequestDTO
{
    ...
    public NALCJGAAKJK creatorPlayerCoOwnerRoomPermission;    // 0x0x54
    public NALCJGAAKJK creatorPlayerModeratorRoomPermission;    // 0x0x58
    public NALCJGAAKJK creatorPlayerHostRoomPermission;    // 0x0x5C
}
...
public class AvatarV2GiftsGenerateRequest
{
    ...
    public LOCNECLOHCA> AFLPGGJMPOE;  // wrapper
