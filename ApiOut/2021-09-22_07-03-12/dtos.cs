...
public class ABPOKCOEICE
{
    public DateTime? <PEMPOFJKADI>k__BackingField;    // 0x0x10
    public DateTime? <MCCCOPAIGIL>k__BackingField;    // 0x0x20
    public PJIJMAGDLNB <BCMKPFMGHLE>k__BackingField;    // 0x0x30
    public LKMBEDFOGGO <OMAOIMJPFNM>k__BackingField;    // 0x0x38
    public bool <NNNHDCDCBCL>k__BackingField;    // 0x0x40
}
...
// ANJANFJGNMB
//   (not directly referenced by a detected call)
public class ANJANFJGNMB
{
    public int <PCAGOEIKFGK>k__BackingField;    // 0x0x10
    public DateTime <IPLPEOMCNPJ>k__BackingField;    // 0x0x18
    public DateTime? <ALIJFNCLMMO>k__BackingField;    // 0x0x20
}
...
// CCFOGININMC
//   (not directly referenced by a detected call)
public class CCFOGININMC
{
    public Guid <DMNAJAGADHA>k__BackingField;    // 0x0x10
    public int <IFBPANODIPA>k__BackingField;    // 0x0x20
    public int <MAAELOFEKIJ>k__BackingField;    // 0x0x24
    public Guid <KPDLHKKMJKL>k__BackingField;    // 0x0x28
    public DateTime <FCEEMEMAPIA>k__BackingField;    // 0x0x38
    public FBBOCCKNILI <KMGLBLBNIMA>k__BackingField;    // 0x0x40
}
...
public class CCMBKDINCAH
{
    ...
    public bool <JLHKDJICNAP>k__BackingField;    // 0x0x78
    public bool <CLBCBOEHAMA>k__BackingField;    // 0x0x79
    public long? <HDMKEMFBHBE>k__BackingField;    // 0x0x80
}
...
public class CPFPHLINDHN
{
    ...
    public List<string> GEPOBHPJHAK;    // 0x0x40
    public List<string> PKKADKGDHNI;    // 0x0x48
    public string EGBGAKBPEBD;    // 0x0x50
    public List<PCBMFKAIBGF> CLOHABOJHLP;    // 0x0x58
}
...
public class DOMDMPKOCGC : OIHHLFKFIKG
{
    public KGAACCELMHP? <GNGOGLFNDGK>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <CGKCBDENHAF>k__BackingField;    // 0x0x20
}
...
public class EDBCMGEOAKC
{
    public int <BJJBGONAPBP>k__BackingField;    // 0x0x10
    public List<ABPOKCOEICE> <KLKDMJMFFEF>k__BackingField;    // 0x0x18
}
...
public class FBBOCCKNILI
{
    ...
    public long <LGKBIBJHNCN>k__BackingField;    // 0x0x40
    public Guid? <DJGFMJIDEKP>k__BackingField;    // 0x0x48
    public DateTime <FCEEMEMAPIA>k__BackingField;    // 0x0x60
}
...
public class HHPEKHPIABO
{
    ...
    public bool <JLHKDJICNAP>k__BackingField;    // 0x0x6C
}
...
public class JKOKKDOFKML
{
    public List<ANJANFJGNMB> <ADLIHGNHNIC>k__BackingField;    // 0x0x10
    public string <MMPCMNMNBEH>k__BackingField;    // 0x0x18
}
...
// LKMBEDFOGGO
//   (not directly referenced by a detected call)
public class LKMBEDFOGGO
{
    public int <AJDBENKCBMF>k__BackingField;    // 0x0x10
    public int <NEDKJMAFLHB>k__BackingField;    // 0x0x14
    public int <PHHKNPNNIJP>k__BackingField;    // 0x0x18
}
...
public class NOBDICDMBOP : OIHHLFKFIKG
{
    public ENIEIKMBGGE? <GNGOGLFNDGK>k__BackingField;    // 0x0x18
    public ONJGGMKDKGN <COINHLFELNA>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{aPIJHPJBANP}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{aPIJHPJBANP}   [Service.API]
...
public class OLIDCGKKENF
{
    public DPONHEILCEB HIMCGOCKLLK;    // 0x0x10
    public FBBOCCKNILI PCCJOKHNIPL;    // 0x0x18
}
...
// PCBMFKAIBGF
//   (not directly referenced by a detected call)
public class PCBMFKAIBGF
{
    public DateTime ACBFDMLHFPB;    // 0x0x10
    public string AEIIMDPEPCD;    // 0x0x18
}
...
public class PILMGBPCGIF
{
    public DPONHEILCEB HIMCGOCKLLK;    // 0x0x10
    public CCFOGININMC OJBFFDDHLCC;    // 0x0x18
}
...
public class FreeGiftRequestDTO
{
    ...
    public HJPLOCLJMDK <GiftContext>k__BackingField;    // 0x0x20
}
...
{
    public DGGFDGNFFPN CFBLIEPALHE;  // wrapper
    public object platformId;  // candidate
