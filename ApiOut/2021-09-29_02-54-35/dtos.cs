...
public class AAEOKJGFOJA
{
    public Guid <EKOLAGLOPKD>k__BackingField;    // 0x0x10
    public int <HDOMEGLPMFM>k__BackingField;    // 0x0x20
    public int <GIHDCFDFAPB>k__BackingField;    // 0x0x24
    public Guid <CKHFAKKJPIJ>k__BackingField;    // 0x0x28
    public DateTime <COPFJKGIGIK>k__BackingField;    // 0x0x38
    public IJNHOEJHPNG <DAIOAHODAKE>k__BackingField;    // 0x0x40
}
...
public class AHINBNHLNJP : HCKGPGEJNLK
{
    public DGAGDLGKPLL? <NAIBFLLJMCO>k__BackingField;    // 0x0x18
    public CFBGAEIAGMI <AJGANOHGNDA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AHOAFDPALMF
//   (not directly referenced by a detected call)
public class AHOAFDPALMF
{
    public int <NLKPMGIJCKL>k__BackingField;    // 0x0x10
    public int <IAMBBKCDAKD>k__BackingField;    // 0x0x14
    public int <NLFCILIOFCL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AIECDPJAHFJ
//   RESPONSE GET    api/inventions/v1/personaldetails/{oPPNKPEODBA}   [Service.API]
public class AIECDPJAHFJ
{
    public bool <HHICAJHHIJC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// AJBHLIMIEMJ
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class AJBHLIMIEMJ
{
    public List<GPHGCIFMEPA> <OLGPFLNHFFD>k__BackingField;    // 0x0x10
    public BGFLGKPJOLH <MPKCAAINMFN>k__BackingField;    // 0x0x18
}
...
public class ALAJDIFEJAM
{
    public long <EJCDBLOLDFI>k__BackingField;    // 0x0x10
    public string <CFLDDPOJBBC>k__BackingField;    // 0x0x18
    public string <POKMIEJLODJ>k__BackingField;    // 0x0x20
    public DateTime <NGAKLKLLGII>k__BackingField;    // 0x0x28
    public string <CMEHOIJFOKK>k__BackingField;    // 0x0x30
    public FAGLHFBKMEE <LAHPENMHKJM>k__BackingField;    // 0x0x38
    public int <DNCECENOAOA>k__BackingField;    // 0x0x3C
    public int <GMJOJCLCGMC>k__BackingField;    // 0x0x40
    public List<CDEOCIEGLKO> <FOIJDKOJMNF>k__BackingField;    // 0x0x48
}
...
public class APFGGFBJHGJ
{
    public List<IDNPPHFIDAI> <HFIMAKBAHOB>k__BackingField;    // 0x0x10
    public List<CNDMABJPEFM> <AIIHCBHBKJI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BCIAEJBIGMG
//   (not directly referenced by a detected call)
public class BCIAEJBIGMG
{
    public bool <MPDOGIFKCGA>k__BackingField;    // 0x0x10
    public HPCKMOAPBLF <FDJICACGOMO>k__BackingField;    // 0x0x14
    public int <ELCNJJADAAM>k__BackingField;    // 0x0x18
    public DateTime <COPFJKGIGIK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BCMBJJGNAJM
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class BCMBJJGNAJM
{
    public int <NMEKEBIPDFG>k__BackingField;    // 0x0x10
    public int <LGGMFNDLMKO>k__BackingField;    // 0x0x14
    public float <LEPBHOHNDMF>k__BackingField;    // 0x0x18
    public float <ILJDBAMNNMN>k__BackingField;    // 0x0x1C
    public bool <OIHNOLLIDHJ>k__BackingField;    // 0x0x20
    public bool <IGFJMOJMFNG>k__BackingField;    // 0x0x21
    public bool <KIHFGCJOJPK>k__BackingField;    // 0x0x22
}
...
// base   : HLMCBNKGDJM
//   (not directly referenced by a detected call)
public class BIDKKEDDIOG : HLMCBNKGDJM
{
    public FNPCOACFLLM <OJNGJODMECK>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// BKKOGPMFFNG
//   (not directly referenced by a detected call)
public class BKKOGPMFFNG
{
    public float <MGJPAMKLKOI>k__BackingField;    // 0x0x10
    public float <EEFPAMALNGC>k__BackingField;    // 0x0x14
    public float <CCJFLJCCOON>k__BackingField;    // 0x0x18
    public float <CJPIONLBGMM>k__BackingField;    // 0x0x1C
    public float <PBIMOILKOJP>k__BackingField;    // 0x0x20
    public float <MKGBCHIFAKM>k__BackingField;    // 0x0x24
    public float <BJLEOHHLHNJ>k__BackingField;    // 0x0x28
    public float <PPCOHHOCKCF>k__BackingField;    // 0x0x2C
}
...
public class CBLELBHPPNF
{
    public KKJNLGIMPDK <BLMGCPIBBDN>k__BackingField;    // 0x0x10
    public ELBBDCEMJOB <NEEMEBAABJB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CDEOCIEGLKO
//   RESPONSE GET    api/groups/v1/memberships/{cEFOAGNIAFO}   [Service.API]
public class CDEOCIEGLKO
{
    public long <EJCDBLOLDFI>k__BackingField;    // 0x0x10
    public int <PAJOBACKEAF>k__BackingField;    // 0x0x18
    public ECIAHAHMJEN <KLGGDKKIAKN>k__BackingField;    // 0x0x1C
}
...
public class CFBGAEIAGMI
{
    public int <HDOMEGLPMFM>k__BackingField;    // 0x0x10
    public Guid <FKHEELOCFMM>k__BackingField;    // 0x0x14
    public long <AANBEDGPMAJ>k__BackingField;    // 0x0x28
    public DateTime <COPFJKGIGIK>k__BackingField;    // 0x0x30
}
...
public class CGDEHPLPDHM
{
    public BGFLGKPJOLH <MPKCAAINMFN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CIALAJIINKO
//   (not directly referenced by a detected call)
public class CIALAJIINKO
{
    public string <GLDKFDANEEL>k__BackingField;    // 0x0x10
    public DHIDBLDFEHA <MPKELGBKAEH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CJFAMDHAJKC
//   (not directly referenced by a detected call)
public class CJFAMDHAJKC
{
    public bool <HDGPLKIEKEF>k__BackingField;    // 0x0x10
    public FNPCOACFLLM <OJNGJODMECK>k__BackingField;    // 0x0x18
    public float <OKJJALLDJEJ>k__BackingField;    // 0x0x20
}
...
public class CLIGKMNGAAI
{
    public bool <OPPONGHKOGA>k__BackingField;    // 0x0x10
    public string <HJBABOAIFNO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CLPNCBAHILI
//   (not directly referenced by a detected call)
public class CLPNCBAHILI
{
    public DateTime? <HHLGHGOIHLE>k__BackingField;    // 0x0x10
    public DateTime? <EDADNOGNJNC>k__BackingField;    // 0x0x20
    public BNNGNLPFFCH <BLMGCPIBBDN>k__BackingField;    // 0x0x30
    public AHOAFDPALMF <MMIGLGLFBNG>k__BackingField;    // 0x0x38
    public bool <CGJFPGDOKJB>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// CNDMABJPEFM
//   (not directly referenced by a detected call)
public class CNDMABJPEFM
{
    public IDNPPHFIDAI <AFGEDINGGNG>k__BackingField;    // 0x0x10
    public LNLMMDIBGMH <BCFLJCBKJJA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CPCMCFCIOGH
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class CPCMCFCIOGH
{
    public List<CIALAJIINKO> <NBOLGMNEOAB>k__BackingField;    // 0x0x10
}
...
// base   : HLMCBNKGDJM
//   (not directly referenced by a detected call)
public class DHPKNEDJEHH : HLMCBNKGDJM
{
    public int <DOFAHADIHPO>k__BackingField;    // 0x0x40
    public List<CJFAMDHAJKC> <EGFEPJJNOLO>k__BackingField;    // 0x0x48
    public List<CJFAMDHAJKC> <LGNLMHMIDME>k__BackingField;    // 0x0x50
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{mJHIFPJEBHD}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{mJHIFPJEBHD}   [Service.API]
...
public class DICFBKHGCOH
{
    public APDPKHNALMJ KNIPNGNFODJ;    // 0x0x10
    public IJNHOEJHPNG KBMKBDJKLJO;    // 0x0x18
}
...
public class DMFANBJLOJM
{
    public APDPKHNALMJ KNIPNGNFODJ;    // 0x0x10
    public AAEOKJGFOJA COAHFAACOIK;    // 0x0x18
}
...
public class ECIGCMNJELI
{
    public List<string> <OKHLPINJKCO>k__BackingField;    // 0x0x10
    public List<string> <MFGKAFHBJAM>k__BackingField;    // 0x0x18
    public List<string> <DBJKIIFPFFD>k__BackingField;    // 0x0x20
}
...
public class ECJOFCKGKIG : IHKKDILDIHG
{
    public List<BIDKKEDDIOG> BOGKHEBCGHL;    // 0x0x30
}

// --------------------------------------------------------------------------
// EGEFIJFACNA
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class EGEFIJFACNA
{
    public string <OCCCOKIDGOI>k__BackingField;    // 0x0x10
    public string <KGOKBDBALFI>k__BackingField;    // 0x0x18
}
...
public class EJMNAKMBHGB
{
    public Guid <FKHEELOCFMM>k__BackingField;    // 0x0x10
    public long? <AEFLMIDJEIP>k__BackingField;    // 0x0x20
    public string <CFLDDPOJBBC>k__BackingField;    // 0x0x30
    public string <POKMIEJLODJ>k__BackingField;    // 0x0x38
    public CFHNNNFKEBD <NEAGDOHEFJN>k__BackingField;    // 0x0x40
    public long <EACDBKJGDDC>k__BackingField;    // 0x0x48
    public DateTime <NGAKLKLLGII>k__BackingField;    // 0x0x50
    public DateTime <COPFJKGIGIK>k__BackingField;    // 0x0x58
}
...
// ELBBDCEMJOB
//   (not directly referenced by a detected call)
public class ELBBDCEMJOB
{
    public long <BBLGEGOIAGA>k__BackingField;    // 0x0x10
    public Guid <ILGBPPFLIHJ>k__BackingField;    // 0x0x18
    public long <AEFLMIDJEIP>k__BackingField;    // 0x0x28
    public string <CFLDDPOJBBC>k__BackingField;    // 0x0x30
    public string <POKMIEJLODJ>k__BackingField;    // 0x0x38
    public int <LDCKMDEKLDE>k__BackingField;    // 0x0x40
    public Guid? <CMPAIGBGEHC>k__BackingField;    // 0x0x44
    public DateTime <NGAKLKLLGII>k__BackingField;    // 0x0x58
}
...
public class ENMFHNDFEMG
{
    public Dictionary<int, int> <ILLBHGLKEGK>k__BackingField;    // 0x0x10
    public KLMCMGPAFHA[][] <AMBFBJGAIOC>k__BackingField;    // 0x0x18
    public LNHNHJCCEDC <BKKNGCEIEBI>k__BackingField;    // 0x0x20
    public BKKOGPMFFNG <PHMNGCCEBCI>k__BackingField;    // 0x0x28
    public LOICGIADAMO <BMOOKDBAEJI>k__BackingField;    // 0x0x30
    public string <JECEJOKHMPO>k__BackingField;    // 0x0x38
}
...
// FCHMOOAIHOO
//   (not directly referenced by a detected call)
public class FCHMOOAIHOO
{
    public long <AMPGMDCCALI>k__BackingField;    // 0x0x10
    public string <ILGBPPFLIHJ>k__BackingField;    // 0x0x18
    public int <IMECMHCAGME>k__BackingField;    // 0x0x20
    public string <CFLDDPOJBBC>k__BackingField;    // 0x0x28
    public string <POKMIEJLODJ>k__BackingField;    // 0x0x30
    public string <CMEHOIJFOKK>k__BackingField;    // 0x0x38
    public int <AOABIGEPGNK>k__BackingField;    // 0x0x40
    public bool <BIAGIELBIHO>k__BackingField;    // 0x0x44
    public DateTime <COPFJKGIGIK>k__BackingField;    // 0x0x48
    public DateTime <NGAKLKLLGII>k__BackingField;    // 0x0x50
    public DateTime? <MJPHHJCIGOE>k__BackingField;    // 0x0x58
    public long? <JMNDONNIJIC>k__BackingField;    // 0x0x68
    public int <LACNFLPPJFH>k__BackingField;    // 0x0x78
    public int <EHBHJBIGEAN>k__BackingField;    // 0x0x7C
    public int <LBKGNECBLCG>k__BackingField;    // 0x0x80
    public GJLEJOIOOMG <CBONGMOFKIO>k__BackingField;    // 0x0x84
    public GJLEJOIOOMG <HJOEFDPCOBO>k__BackingField;    // 0x0x88
    public bool <DFENJOGOLNM>k__BackingField;    // 0x0x8C
    public bool <AJKHJEIHHDO>k__BackingField;    // 0x0x8D
    public bool <LMNIJOEBPMN>k__BackingField;    // 0x0x8E
    public int? <LDCKMDEKLDE>k__BackingField;    // 0x0x90
    public bool <DKFLEEGCHJL>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// FGAGAMAMOLF
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class FGAGAMAMOLF
{
    public int <GBEKMBDEINO>k__BackingField;    // 0x0x10
    public string <NCAOLINDIIN>k__BackingField;    // 0x0x18
    public string <BNEOJCGOOHB>k__BackingField;    // 0x0x20
    public string <KDGKDNGNFBE>k__BackingField;    // 0x0x28
    public string <IMCCOEMMFKK>k__BackingField;    // 0x0x30
    public string <JMINPEEKGEF>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// FMJGDELKBJI
//   (not directly referenced by a detected call)
public class FMJGDELKBJI
{
    public long <AMPGMDCCALI>k__BackingField;    // 0x0x10
    public string <ILGBPPFLIHJ>k__BackingField;    // 0x0x18
    public int <NFHCOFKMLAI>k__BackingField;    // 0x0x20
    public int <ADLBGOPAKCL>k__BackingField;    // 0x0x24
    public int <HPAGOALLNEB>k__BackingField;    // 0x0x28
    public int <OFPFLCADLAH>k__BackingField;    // 0x0x2C
    public int <IOJPOJMMKHI>k__BackingField;    // 0x0x30
    public string <LLGBNLLANJK>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// FNPCOACFLLM
//   (not directly referenced by a detected call)
public class FNPCOACFLLM
{
    public int <AOKACEBFCHJ>k__BackingField;    // 0x0x10
    public string <HFCHPAEFELG>k__BackingField;    // 0x0x18
    public string <OECBHBNFCNC>k__BackingField;    // 0x0x20
    public string <MJAGGBDFAOP>k__BackingField;    // 0x0x28
    public string <NCEDNCCPLOP>k__BackingField;    // 0x0x30
    public LHLMCPIMHAP? <NADKAFKPPHO>k__BackingField;    // 0x0x38
    public string <BGIJFLNOCOA>k__BackingField;    // 0x0x40
    public string <FDBHEKDAFDE>k__BackingField;    // 0x0x48
    public bool <MJLICDFFOBB>k__BackingField;    // 0x0x50
    public bool <CKFPIPNHKFO>k__BackingField;    // 0x0x51
    public bool <MNJCLLKMNFI>k__BackingField;    // 0x0x52
    public CDJIJDBLEPJ <OAIMOJJHIDB>k__BackingField;    // 0x0x54
    public CFHNNNFKEBD <NEAGDOHEFJN>k__BackingField;    // 0x0x58
    public int <OMHCFBINMPG>k__BackingField;    // 0x0x5C
    public ADPHMDFMINM <LAPKINHEPEM>k__BackingField;    // 0x0x60
    public EKIKIBPBEDG <LNMHLLOMJMP>k__BackingField;    // 0x0x64
    public int <HCOHEHGJOMK>k__BackingField;    // 0x0x68
    public string <OHKGPIACIMA>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// GDHBGLJLFIO
//   (not directly referenced by a detected call)
public class GDHBGLJLFIO
{
    public CFHNNNFKEBD <NEAGDOHEFJN>k__BackingField;    // 0x0x10
    public int <LDCKMDEKLDE>k__BackingField;    // 0x0x14
    public OPJLPIONLLK <HNLLIEKEJDN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GGLGECIAHOO
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class GGLGECIAHOO
{
    public long <HPGGHBAJAKF>k__BackingField;    // 0x0x10
    public LIOHPNLKGFN <MPKELGBKAEH>k__BackingField;    // 0x0x18
}
...
public class GKJDIIDCBFK
{
    public int <GKENCCFAKFO>k__BackingField;    // 0x0x10
}
...
public class GKPHBOKHKEJ
{
    public Guid <IAJAEAMIMCI>k__BackingField;    // 0x0x10
    public Guid <FKHEELOCFMM>k__BackingField;    // 0x0x20
    public int <EAIMAPBBBKL>k__BackingField;    // 0x0x30
    public string <CFLDDPOJBBC>k__BackingField;    // 0x0x38
    public long <LNNDIALEIFL>k__BackingField;    // 0x0x40
    public long <LDCKMDEKLDE>k__BackingField;    // 0x0x48
    public DateTime <COPFJKGIGIK>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// GOHIGEBJPOC
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class GOHIGEBJPOC
{
    public CFBGAEIAGMI <AJGANOHGNDA>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <NGCDNFEINOH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GPHGCIFMEPA
//   (not directly referenced by a detected call)
public class GPHGCIFMEPA
{
    public int <EMLLOMKKDED>k__BackingField;    // 0x0x10
    public BGFLGKPJOLH <MPKCAAINMFN>k__BackingField;    // 0x0x14
}
...
public class HCBNOELFOPF
{
    public string <JDDECHAGMGB>k__BackingField;    // 0x0x10
}
...
public class HCENOAEPFFA
{
    public long <AEFLMIDJEIP>k__BackingField;    // 0x0x10
    public long? <PAMIFNMGMEE>k__BackingField;    // 0x0x18
    public long? <NFNHICHCCDI>k__BackingField;    // 0x0x28
    public string <CFLDDPOJBBC>k__BackingField;    // 0x0x38
    public string <POKMIEJLODJ>k__BackingField;    // 0x0x40
    public List<string> <NBOLGMNEOAB>k__BackingField;    // 0x0x48
    public string <CMEHOIJFOKK>k__BackingField;    // 0x0x50
    public DateTime <JCMFIFEBPPM>k__BackingField;    // 0x0x58
    public DateTime <MJAEANILJGN>k__BackingField;    // 0x0x60
    public BDGHDDCPMBH <OFPMJJPLIFG>k__BackingField;    // 0x0x68
    public bool <HMNNHNGMOCD>k__BackingField;    // 0x0x6C
}

// --------------------------------------------------------------------------
// HDDBLEIIGEM
//   (not directly referenced by a detected call)
public class HDDBLEIIGEM
{
    // (no instance fields in the metadata dump)
}
...
public class HDGJJMDNKIC
{
    public LPBOJJHMMNP <GGJJAOFNPFN>k__BackingField;    // 0x0x10
    public int <GKENCCFAKFO>k__BackingField;    // 0x0x14
    public long <GFNAMEPNGKA>k__BackingField;    // 0x0x18
    public bool <BCFKGJHNPCB>k__BackingField;    // 0x0x20
    public string <EALCDNCLFBD>k__BackingField;    // 0x0x28
    public int? <NEOIPOAJEEH>k__BackingField;    // 0x0x30
    public bool <DHHOONANNJN>k__BackingField;    // 0x0x38
    public string <MFFLNNLBDAP>k__BackingField;    // 0x0x40
    public float <BBCFEABFEKJ>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// HEIABLOOADO
//   (not directly referenced by a detected call)
public class HEIABLOOADO
{
    public long <AOKACEBFCHJ>k__BackingField;    // 0x0x10
    public string <MJAGGBDFAOP>k__BackingField;    // 0x0x18
    public string <DEEDPKCDLLM>k__BackingField;    // 0x0x20
    public LHLMCPIMHAP? <NADKAFKPPHO>k__BackingField;    // 0x0x28
    public string <BGIJFLNOCOA>k__BackingField;    // 0x0x30
    public string <FDBHEKDAFDE>k__BackingField;    // 0x0x38
    public OONKAINLDDK <HABEKFHJBPE>k__BackingField;    // 0x0x40
    public int <PPBGEINJFBF>k__BackingField;    // 0x0x44
    public int <ALPFNHLJMMM>k__BackingField;    // 0x0x48
    public EKIKIBPBEDG <FMCLPCCHJID>k__BackingField;    // 0x0x4C
    public CDJIJDBLEPJ <FJGJNKPMEHO>k__BackingField;    // 0x0x50
}
...
public class HFHMLBIMEFF : HCKGPGEJNLK
{
    public IAHKHHOKMKO? <NAIBFLLJMCO>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <NGCDNFEINOH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HLMCBNKGDJM
//   (not directly referenced by a detected call)
public class HLMCBNKGDJM
{
    public int <BEIHPABOACP>k__BackingField;    // 0x0x10
    public OMOKGACJOBG <MPKELGBKAEH>k__BackingField;    // 0x0x14
    public List<GDHBGLJLFIO> <LJHKICCEGHK>k__BackingField;    // 0x0x18
    public List<GDHBGLJLFIO> <NNECIJPEPHL>k__BackingField;    // 0x0x20
    public bool <KMGCCPMOLIB>k__BackingField;    // 0x0x28
    public DateTime? <OEJAPIJIPJD>k__BackingField;    // 0x0x30
}
...
// --------------------------------------------------------------------------
// IBBNFHKIDMD
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{lOOMKMDLKEO}   [Service.API]
public class IBBNFHKIDMD
{
    public string DACLCAFBMKC;    // 0x0x10
    public string GBAAKJMCCDD;    // 0x0x18
    public string IECOJINANCD;    // 0x0x20
    public string CGMGNOCEMFH;    // 0x0x28
    public string LIPKEJBNNAO;    // 0x0x30
    public ANHHBEALBDJ KNIPNGNFODJ;    // 0x0x38
    public List<string> MKADIFKLPNG;    // 0x0x40
    public List<string> IBNNCPOIMMC;    // 0x0x48
    public string KLNNMMLFDDI;    // 0x0x50
    public List<NOPDGAJJLEE> AAPNODKKMDG;    // 0x0x58
}

// --------------------------------------------------------------------------
// IDNPPHFIDAI
//   (not directly referenced by a detected call)
public class IDNPPHFIDAI
{
    public long <HPGGHBAJAKF>k__BackingField;    // 0x0x10
    public int <IMECMHCAGME>k__BackingField;    // 0x0x18
    public long <AEFLMIDJEIP>k__BackingField;    // 0x0x20
    public long? <PAMIFNMGMEE>k__BackingField;    // 0x0x28
    public long? <NFNHICHCCDI>k__BackingField;    // 0x0x38
    public string <CFLDDPOJBBC>k__BackingField;    // 0x0x48
    public string <POKMIEJLODJ>k__BackingField;    // 0x0x50
    public string <CMEHOIJFOKK>k__BackingField;    // 0x0x58
    public DateTime <JCMFIFEBPPM>k__BackingField;    // 0x0x60
    public DateTime <MJAEANILJGN>k__BackingField;    // 0x0x68
    public int <KHMGGMNFKOP>k__BackingField;    // 0x0x70
    public BDGHDDCPMBH <OFPMJJPLIFG>k__BackingField;    // 0x0x74
    public bool <HMNNHNGMOCD>k__BackingField;    // 0x0x78
    public bool <AGDGILADFHH>k__BackingField;    // 0x0x79
    public long? <BLJCGBPDCDI>k__BackingField;    // 0x0x80
}
...
public class IGMMLEABHAP
{
    public int <KCHPJBLHAFM>k__BackingField;    // 0x0x10
    public List<CLPNCBAHILI> <EMEOICJFKIC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IJNHOEJHPNG
//   (not directly referenced by a detected call)
public class IJNHOEJHPNG
{
    public Guid <EKOLAGLOPKD>k__BackingField;    // 0x0x10
    public long <AEFLMIDJEIP>k__BackingField;    // 0x0x20
    public string <CFLDDPOJBBC>k__BackingField;    // 0x0x28
    public string <POKMIEJLODJ>k__BackingField;    // 0x0x30
    public string <CMEHOIJFOKK>k__BackingField;    // 0x0x38
    public long <LDCKMDEKLDE>k__BackingField;    // 0x0x40
    public Guid? <CMPAIGBGEHC>k__BackingField;    // 0x0x48
    public DateTime <COPFJKGIGIK>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// JFILPOEPBDA
//   (not directly referenced by a detected call)
public class JFILPOEPBDA
{
    public int <BABLKDANEBH>k__BackingField;    // 0x0x10
    public DateTime <NGAKLKLLGII>k__BackingField;    // 0x0x18
    public DateTime? <OIBGCADJAPA>k__BackingField;    // 0x0x20
}
...
public class JGKMCGJEGDE : IHKKDILDIHG
{
    public int <EAPOCIHEALI>k__BackingField;    // 0x0x30
    public string <CFLDDPOJBBC>k__BackingField;    // 0x0x38
    public DateTime <EJNOBEMINDO>k__BackingField;    // 0x0x40
    public DateTime <OLILCMIAMCN>k__BackingField;    // 0x0x48
    public CFHNNNFKEBD <NEAGDOHEFJN>k__BackingField;    // 0x0x50
    public HLMCBNKGDJM <PNDIKHPDKGI>k__BackingField;    // 0x0x58
    public List<DHPKNEDJEHH> <HOJHPCDPEPA>k__BackingField;    // 0x0x60
    public BCIAEJBIGMG <HCLLLDGNCKD>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// JJPHEJCAAON
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class JJPHEJCAAON
{
    public int <OKCEHEJHPLE>k__BackingField;    // 0x0x10
    public string <GHJHEFKMEFE>k__BackingField;    // 0x0x18
    public List<OLPLMPPKAIC> <ECKNNEBJJOJ>k__BackingField;    // 0x0x20
    public HEIABLOOADO <LIBPMENBLHA>k__BackingField;    // 0x0x28
    public string <CEAGMILAFNH>k__BackingField;    // 0x0x30
    public DateTime <EJNOBEMINDO>k__BackingField;    // 0x0x38
    public DateTime <OLILCMIAMCN>k__BackingField;    // 0x0x40
    public DateTime <ALLKNFCFLMG>k__BackingField;    // 0x0x48
    public bool <AECMKIOBDFH>k__BackingField;    // 0x0x50
}
...
public class KDHBMOGGLNK
{
    public int <LGGMFNDLMKO>k__BackingField;    // 0x0x10
    public bool <OIHNOLLIDHJ>k__BackingField;    // 0x0x14
    public DateTime <AMPMGEMKPAB>k__BackingField;    // 0x0x18
    public bool <CNNKFDHBFJC>k__BackingField;    // 0x0x20
}
...
public class KIBHIFMFMKP
{
    public int <HDOMEGLPMFM>k__BackingField;    // 0x0x10
    public Guid <FKHEELOCFMM>k__BackingField;    // 0x0x14
    public long <AANBEDGPMAJ>k__BackingField;    // 0x0x28
    public long <HMODDBEOIAA>k__BackingField;    // 0x0x30
    public DateTime <MEBFFNBGFAG>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// KJJCFIBHMIO
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class KJJCFIBHMIO
{
    public CFHNNNFKEBD <NEAGDOHEFJN>k__BackingField;    // 0x0x10
    public CFHMEMDAJMH <CHKOOBGOEIB>k__BackingField;    // 0x0x14
    public int <LFCDCJPKHIK>k__BackingField;    // 0x0x18
    public int <KKNPJOFPKGE>k__BackingField;    // 0x0x1C
    public int <FBIEANIKHPD>k__BackingField;    // 0x0x20
    public PFLFAJDOHAB <PIHKJNHFDKJ>k__BackingField;    // 0x0x24
    public bool <ONOLEKKEHAH>k__BackingField;    // 0x0x28
    public float <FLPIELMMLNO>k__BackingField;    // 0x0x2C
    public int <FHJEGHKGCJN>k__BackingField;    // 0x0x30
    public bool <PHOFEHDCMKJ>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// KKJNLGIMPDK
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{nECMBOPHIJH}   [Service.API]
public enum KKJNLGIMPDK
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class KLHJCKNMGHA
{
    public int? <PCOCIOBCLHO>k__BackingField;    // 0x0x10
    public string <BJOKJIGGNDN>k__BackingField;    // 0x0x18
    public string <NMPBGJBEHKC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KLMCMGPAFHA
//   (not directly referenced by a detected call)
public class KLMCMGPAFHA
{
    public LBNGKNMIDAI BNAAFICOINJ;    // 0x0x10
    public int ENFGICNOIFD;    // 0x0x14
}
...
public class KOBAFOKHCNB
{
    public JMJPOOEDDIJ <BLMGCPIBBDN>k__BackingField;    // 0x0x10
    public FCHMOOAIHOO <GKEBPAMKPEE>k__BackingField;    // 0x0x18
    public FMJGDELKBJI <INCMKIEBEAN>k__BackingField;    // 0x0x20
}
...
public class LMOGACJICPP
{
    public bool <OPPONGHKOGA>k__BackingField;    // 0x0x10
    public string <EALCDNCLFBD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LNHNHJCCEDC
//   (not directly referenced by a detected call)
public class LNHNHJCCEDC
{
    public int <DDAMJCFHKEH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LNLMMDIBGMH
//   (not directly referenced by a detected call)
public class LNLMMDIBGMH
{
    public long <CPGGEPFFGCI>k__BackingField;    // 0x0x10
    public long <HPGGHBAJAKF>k__BackingField;    // 0x0x18
    public int <PAJOBACKEAF>k__BackingField;    // 0x0x20
    public DateTime <NGAKLKLLGII>k__BackingField;    // 0x0x28
    public LIOHPNLKGFN <MPKELGBKAEH>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// LOICGIADAMO
//   (not directly referenced by a detected call)
public class LOICGIADAMO
{
    public int <BGPOBHCMMPL>k__BackingField;    // 0x0x10
}
...
public class MMDCLHAOBBC
{
    public int <FOIBJMPANBJ>k__BackingField;    // 0x0x10
    public HPOCBLDGCAP <MPKELGBKAEH>k__BackingField;    // 0x0x14
    public HKODFCGFGLL <CDGMIIBFACO>k__BackingField;    // 0x0x18
    public HKODFCGFGLL <EBAJBNLAOGN>k__BackingField;    // 0x0x1C
    public HKODFCGFGLL <HOKBHBEBJMC>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// NIJPEJANHPD
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{lLJBEOKIKBK}   [Service.API]
public class NIJPEJANHPD
{
    public Guid <IBFPIKLCMAE>k__BackingField;    // 0x0x10
    public int <HDOMEGLPMFM>k__BackingField;    // 0x0x20
    public int <BEIHPABOACP>k__BackingField;    // 0x0x24
    public DateTime <NGAKLKLLGII>k__BackingField;    // 0x0x28
}
...
// NOPDGAJJLEE
//   (not directly referenced by a detected call)
public class NOPDGAJJLEE
{
    public DateTime CLCHAPFMKMN;    // 0x0x10
    public string PKIEHPNEAHE;    // 0x0x18
}

// --------------------------------------------------------------------------
// ODIJPJLAOPP
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class ODIJPJLAOPP
{
    public LPBOJJHMMNP <GGJJAOFNPFN>k__BackingField;    // 0x0x10
    public long <HPGGHBAJAKF>k__BackingField;    // 0x0x18
    public string <NOOIJFJGNFO>k__BackingField;    // 0x0x20
}
...
public class OLBJDKDHLAD
{
    public string <BNEOJCGOOHB>k__BackingField;    // 0x0x10
    public string <KDGKDNGNFBE>k__BackingField;    // 0x0x18
    public string <IMCCOEMMFKK>k__BackingField;    // 0x0x20
    public string <JMINPEEKGEF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// OLPLMPPKAIC
//   (not directly referenced by a detected call)
public class OLPLMPPKAIC
{
    public int <DPPLFOLLLJM>k__BackingField;    // 0x0x10
    public string <CFLDDPOJBBC>k__BackingField;    // 0x0x18
    public string <MFNCOMCGFLF>k__BackingField;    // 0x0x20
    public string <POKMIEJLODJ>k__BackingField;    // 0x0x28
    public string <OECBHBNFCNC>k__BackingField;    // 0x0x30
    public bool <GDKONPGEBGE>k__BackingField;    // 0x0x38
    public int <GBEKMBDEINO>k__BackingField;    // 0x0x3C
    public HDDBLEIIGEM <KILDGEKIMCL>k__BackingField;    // 0x0x40
    public OELKIBBLFJB NDNOLJDOHAA;    // 0x0x48
    public OELKIBBLFJB AOBPAJBAGOD;    // 0x0x50
    public OELKIBBLFJB KIMNFJIECIM;    // 0x0x58
    public OEBDFLGPFOH HPKGHCNOHAB;    // 0x0x60
}

// --------------------------------------------------------------------------
// OMHOMLCMMOL
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{aHKCOOEENLA}   [Service.API]
//   RESPONSE POST   api/playerevents/v2/{eventId}   [Service.API]
public class OMHOMLCMMOL
{
    public IDNPPHFIDAI <AFGEDINGGNG>k__BackingField;    // 0x0x10
    public BGFLGKPJOLH <MPKCAAINMFN>k__BackingField;    // 0x0x18
    public PLLIOOIMOLD <EPMFEMDCILJ>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// OPENCJHKOFO
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{lOOMKMDLKEO}   [Service.API]
public class OPENCJHKOFO
{
    public uint DACLCAFBMKC;    // 0x0x10
    public string AJBFJEGGMOH;    // 0x0x18
    public string CGMGNOCEMFH;    // 0x0x20
    public DateTime NHFJFDFCBFO;    // 0x0x28
    public DateTime? ABKJNJLHPCF;    // 0x0x30
    public bool NIBNKAEENDE;    // 0x0x40
    public List<IBBNFHKIDMD> GEGIBKHACNA;    // 0x0x48
    public List<string> IBNNCPOIMMC;    // 0x0x50
    public int NJKJLMHGPBO;    // 0x0x58
    public int AGBDHDIKBMK;    // 0x0x5C
    public int IAAGJCEELBP;    // 0x0x60
}

// --------------------------------------------------------------------------
// OPJLPIONLLK
//   (not directly referenced by a detected call)
public class OPJLPIONLLK
{
    public int <DLJFCGHPJJA>k__BackingField;    // 0x0x10
    public DateTime? <NEIPKAELNCC>k__BackingField;    // 0x0x18
    public DateTime? <BNHMDGHOMDO>k__BackingField;    // 0x0x28
}
...
public class PKLIAGMKPJF
{
    public CBJLBEHIBIH <MPKELGBKAEH>k__BackingField;    // 0x0x10
    public string <HEKIIOIKKNC>k__BackingField;    // 0x0x18
}
...
public class PLHLFDCNPDH
{
    public List<JFILPOEPBDA> <OPEMFJGGNPB>k__BackingField;    // 0x0x10
    public string <FDODBMDADLC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PLLIOOIMOLD
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class PLLIOOIMOLD
{
    public KHPKMLPCOEG <MPKCAAINMFN>k__BackingField;    // 0x0x10
    public List<string> <NBOLGMNEOAB>k__BackingField;    // 0x0x18
}
...
public class FreeGiftRequestDTO
{
    ...
    public EKIKIBPBEDG <GiftContext>k__BackingField;    // 0x0x20
}
...
public class GetRankRequestDTO
{
    ...
    public PFDFJMOJHPI FilterType;    // 0x0x20
    public MNPOANMBGCP Timeframe;    // 0x0x24
...
public class NewInventionRequestDTO
{
    ...
    public CBAFGPKANAN creatorAccountRole;    // 0x0x58
}
...
public class ReportRequest
{
    ...
    public LHFMAEGGJCJ ReportCategory;    // 0x0x20
}
...
{
    public MJPCEOPNCIL? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public MJPCEOPNCIL FANLBHOOCLD;  // wrapper
...
{
    public JMHGGLDFIJG BCBGCEBGIDF;  // wrapper
...
{
    public AGGFHHIBLBL HOBGMLIPHLK;  // wrapper
    public int? CMOMHNFKNOF;  // wrapper
...
{
    public LPBOJJHMMNP NEJJHEFCIOO;  // wrapper
    public JJBLBNLBKJG CNAECKKILBA;  // wrapper
...
{
    public PHHJNDAFIPO EHKJMBOPBGJ;  // wrapper
    public JJBLBNLBKJG CNAECKKILBA;  // wrapper
...
{
    public EKIKIBPBEDG BPEHFBCHPMI;  // wrapper
    public EKIKIBPBEDG? AMLGEHIDOGJ;  // wrapper
...
{
    public OLPLMPPKAIC GGMFADEHLLJ;  // wrapper
...
{
    public OGPJKOMKJPC NFPPIMNLHCO;  // wrapper
    public LPBOJJHMMNP NEJJHEFCIOO;  // wrapper
...
{
    public IReadOnlyList<GBCKGCBEEOC> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public FHNOHGDBMGG PNGHCJLPCLH;  // wrapper
    public EKIKIBPBEDG? HOPMFNEFADJ;  // wrapper
...
{
    public DOJKOOODNJE IHPGGFCMIOF;  // wrapper
...
{
    public StatusResponse> CNAECKKILBA;  // wrapper
...
{
    public DOCNNPHMMDI HGBCHEGJABG;  // wrapper
    public object platformId;  // candidate
...
{
    public List<long> JEOKCBDKFHL;  // wrapper
    public FOHODLIEKIO GGFGHMAKFLK;  // wrapper
    public long? EPLAMHAICHF;  // wrapper
    public JJBLBNLBKJG CNAECKKILBA;  // wrapper
...
{
    public String> CNAECKKILBA;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{aHKCOOEENLA}  [API POST]
public class PlayereventsV2DeleteAHKCOOEENLARequest
{
    public IDNPPHFIDAI AHKCOOEENLA;  // wrapper
}

// api/players/v2/objectives  [API POST]
public class PlayersV2ObjectivesRequest
{
    public List<FDJGBAFPHHE> FJPFGECAHNK;  // wrapper
...
{
    public Guid GAIEBLAMECL;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> IIBBODIFOEI;  // wrapper
...
{
    public Guid? GNJFDCOFJHN;  // wrapper
    public object RoomId;  // candidate
...
{
    public MatchCompleteStats AOHFOICPALO;  // wrapper
}
...
{
    public Guid PDLCMINMGIN;  // wrapper
    public object RoomKeyId;  // candidate
    public object RequestedPrice;  // candidate
...
{
    public List<LPGFONCBBAB> FJPFGECAHNK;  // wrapper
    public object objectiveType;  // candidate
...
{
    public ANHHBEALBDJ PFEIHCHACLP;  // wrapper
}
