...
public class AEBLJKLPLHC
{
    public string <JAFMGBDBNLJ>k__BackingField;    // 0x0x10
    public string <PODGHFMDFAH>k__BackingField;    // 0x0x18
    public string <EJKJNBGNAEE>k__BackingField;    // 0x0x20
    public string <KFAFNNDGNHF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// AHLMONPEIFK
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class AHLMONPEIFK
{
    public int <JCHCOGINOCI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// AHMDKHAHKEP
//   (not directly referenced by a detected call)
public class AHMDKHAHKEP
{
    public BNLEOFOGFEL <PEKOKAGLJGJ>k__BackingField;    // 0x0x10
    public int <GPGDEEOGPEH>k__BackingField;    // 0x0x14
    public DCNJGFJEFGE <COJGOJCCPOF>k__BackingField;    // 0x0x18
}
...
public class APHMDHJKHEH
{
    public COEEMPHDCHP IJGICKAIKJK;    // 0x0x10
    public GHEBNAJIIDP KEPPCGLHEOO;    // 0x0x18
}

// --------------------------------------------------------------------------
// BBFNDLDGOBO
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class BBFNDLDGOBO
{
    public int <DEMDMEKHEMN>k__BackingField;    // 0x0x10
    public string <CFGJCGLGAMN>k__BackingField;    // 0x0x18
    public List<KEHMIBNEBCE> <JPPKIHAFPGC>k__BackingField;    // 0x0x20
    public FEKNDELEDAA <ILBJINHFEGI>k__BackingField;    // 0x0x28
    public string <KHEEKHILAAH>k__BackingField;    // 0x0x30
    public DateTime <OHALONNGKCL>k__BackingField;    // 0x0x38
    public DateTime <DLGBFJDEGGL>k__BackingField;    // 0x0x40
    public DateTime <ALNJMPGFAJA>k__BackingField;    // 0x0x48
    public bool <IJFJPAAKHPA>k__BackingField;    // 0x0x50
}
...
// BNPAJOCHBBH
//   (not directly referenced by a detected call)
public class BNPAJOCHBBH
{
    public int <PBCNDECMBCB>k__BackingField;    // 0x0x10
    public DateTime <HBPPAOGGKDH>k__BackingField;    // 0x0x18
    public DateTime? <CEOBEMGHFBM>k__BackingField;    // 0x0x20
}
...
// base   : ELMCGGHPOLM
//   (not directly referenced by a detected call)
public class CAJHDFCIAEK : ELMCGGHPOLM
{
    public INFFGGACEED <NNANPEDCOMH>k__BackingField;    // 0x0x40
}
...
public class CEBOMCNHMBM
{
    public int <NAGENMIMDEL>k__BackingField;    // 0x0x10
    public bool <DFBMAFHHMMH>k__BackingField;    // 0x0x14
    public DateTime <EGEBFKDBHDP>k__BackingField;    // 0x0x18
    public bool <PIDCNBJGPLI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CIMJFKAJCCM
//   (not directly referenced by a detected call)
public class CIMJFKAJCCM
{
    public int <OFMNFKHGFFG>k__BackingField;    // 0x0x10
    public GMNHMOAAMGN <PPKLBCPLPJD>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// CNGPLOGEPJK
//   (not directly referenced by a detected call)
public class CNGPLOGEPJK
{
    public int <AHIDMDAHGLG>k__BackingField;    // 0x0x10
}
...
// DCNJGFJEFGE
//   (not directly referenced by a detected call)
public class DCNJGFJEFGE
{
    public int <BCHBPPOKJHH>k__BackingField;    // 0x0x10
    public DateTime? <PIMBPOPNJJC>k__BackingField;    // 0x0x18
    public DateTime? <IFGBHLFDJKE>k__BackingField;    // 0x0x28
}
...
public class DDFGPBDPIGK
{
    public long <NAPANCOKPED>k__BackingField;    // 0x0x10
    public long? <EPDKAHBEMGB>k__BackingField;    // 0x0x18
    public long? <LJCLEIALPKB>k__BackingField;    // 0x0x28
    public string <BDKKFKLMBNJ>k__BackingField;    // 0x0x38
    public string <NJIOPDEGMDD>k__BackingField;    // 0x0x40
    public List<string> <PCEEJALIHPA>k__BackingField;    // 0x0x48
    public string <IHPAONAALNG>k__BackingField;    // 0x0x50
    public DateTime <CLMLGIMFAGA>k__BackingField;    // 0x0x58
    public DateTime <IMACDPCOALH>k__BackingField;    // 0x0x60
    public EFBGHKLNLFA <PAADKGMLNGK>k__BackingField;    // 0x0x68
    public bool <EBLJEEPEKCP>k__BackingField;    // 0x0x6C
}

// --------------------------------------------------------------------------
// DEPHNJPAFLM
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class DEPHNJPAFLM
{
    public int <OOBGMFFPNLP>k__BackingField;    // 0x0x10
    public Guid <JGEMOANOFDH>k__BackingField;    // 0x0x14
    public long <BNOJFIHMABO>k__BackingField;    // 0x0x28
    public long <KGGNJONFEPG>k__BackingField;    // 0x0x30
    public DateTime <HFHADPJMIKF>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// DJDLCFEBANA
//   (not directly referenced by a detected call)
public class DJDLCFEBANA
{
    // (no instance fields in the metadata dump)
}
...
public class DKOBIIFBFGO
{
    public int <FIPDFHCBIHB>k__BackingField;    // 0x0x10
    public string <BOBGPANNNFE>k__BackingField;    // 0x0x18
    public string <JAFMGBDBNLJ>k__BackingField;    // 0x0x20
    public string <PODGHFMDFAH>k__BackingField;    // 0x0x28
    public string <EJKJNBGNAEE>k__BackingField;    // 0x0x30
    public string <KFAFNNDGNHF>k__BackingField;    // 0x0x38
}
...
public class EDNGDDPBIAP
{
    public NEAEOPGLDJJ <DBGAPAGMICH>k__BackingField;    // 0x0x10
    public int <JCHCOGINOCI>k__BackingField;    // 0x0x14
    public long <NGEEBOBGNBB>k__BackingField;    // 0x0x18
    public bool <AAHJFGEJINF>k__BackingField;    // 0x0x20
    public string <KOALCCJCEDO>k__BackingField;    // 0x0x28
    public int? <PMDCEEDHOOA>k__BackingField;    // 0x0x30
    public bool <CIELMBIIALM>k__BackingField;    // 0x0x38
    public string <OAMPGOLFNPE>k__BackingField;    // 0x0x40
    public float <LLNPHJPFBEH>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// EEPKFGDBLGI
//   RESPONSE GET    api/config/v1/amplitude   [Service.API]
public class EEPKFGDBLGI
{
    public string <FJIAPDPJLID>k__BackingField;    // 0x0x10
}
...
// EJBKPIKMMMC
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{oOLJFFHFKPA}   [Service.API]
public enum EJBKPIKMMMC
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class ELDBMJAMHFH
{
    public long <IAPAEDBAAKO>k__BackingField;    // 0x0x10
    public IOPCFHCAFGE <LKJDAFJACBN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ELMCGGHPOLM
//   (not directly referenced by a detected call)
public class ELMCGGHPOLM
{
    public int <NMABGCKHJAG>k__BackingField;    // 0x0x10
    public MAOJOLDFNIP <LKJDAFJACBN>k__BackingField;    // 0x0x14
    public List<AHMDKHAHKEP> <DFAPOMHJBAC>k__BackingField;    // 0x0x18
    public List<AHMDKHAHKEP> <MKFBBEBHHMG>k__BackingField;    // 0x0x20
    public bool <APPBNMAPLGE>k__BackingField;    // 0x0x28
    public DateTime? <DOCIEBJMFPP>k__BackingField;    // 0x0x30
}
...
// --------------------------------------------------------------------------
// FBMHPNAJHAA
//   RESPONSE GET    api/inventions/v1/personaldetails/{lEBHHNLIGFL}   [Service.API]
public class FBMHPNAJHAA
{
    public bool <OEOKDLJABHF>k__BackingField;    // 0x0x10
}
...
// FEKNDELEDAA
//   (not directly referenced by a detected call)
public class FEKNDELEDAA
{
    public long <ENDDHDNDPGH>k__BackingField;    // 0x0x10
    public string <KNLLNGKFAPJ>k__BackingField;    // 0x0x18
    public string <NBBDLDIEHFL>k__BackingField;    // 0x0x20
    public FMAFPELCNCM? <BKAOFECNOAN>k__BackingField;    // 0x0x28
    public string <AICDOKBKBAD>k__BackingField;    // 0x0x30
    public string <POLMDJIFIPN>k__BackingField;    // 0x0x38
    public LIMMHAEDLDH <KHFADPBEJLB>k__BackingField;    // 0x0x40
    public int <EOHAHLIHKJA>k__BackingField;    // 0x0x44
    public int <LPNIPNEGCCN>k__BackingField;    // 0x0x48
    public JIKKEBHHFGO <MGMEEBLOHIO>k__BackingField;    // 0x0x4C
    public ONPJFLBCAFB <GOPMGJPCGLH>k__BackingField;    // 0x0x50
}
...
// --------------------------------------------------------------------------
// FKOAJDNFNFC
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{lNAAIMLEKEK}   [Service.API]
public class FKOAJDNFNFC
{
    public Guid <EDHIJFFGHFJ>k__BackingField;    // 0x0x10
    public int <OOBGMFFPNLP>k__BackingField;    // 0x0x20
    public int <NMABGCKHJAG>k__BackingField;    // 0x0x24
    public DateTime <HBPPAOGGKDH>k__BackingField;    // 0x0x28
}
...
// --------------------------------------------------------------------------
// FLEKMDOOAKL
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{kOCMKCCBGOB}   [Service.API]
public class FLEKMDOOAKL
{
    public uint LEFAOGHHBLL;    // 0x0x10
    public string GCPJLMHALKO;    // 0x0x18
    public string FLPKHNBDOGL;    // 0x0x20
    public DateTime FPHMANBMODB;    // 0x0x28
    public DateTime? OPBFLLNNMJL;    // 0x0x30
    public bool EBGGGHLBGKE;    // 0x0x40
    public List<IINLMEHCHPP> CPELJKOKDAA;    // 0x0x48
    public List<string> ADCGMHOGGHB;    // 0x0x50
    public int LONLLDJLPAD;    // 0x0x58
    public int ICOIDGIOJHK;    // 0x0x5C
    public int FPIEAMPBDBC;    // 0x0x60
}
...
public class FMCKMGCCIBL : BANNEJCDCIA
{
    public PLBHIACCGBK? <PHPLODGCLIP>k__BackingField;    // 0x0x18
    public LOACPNDGDBA <PEEIHALEFNB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FPKPPDPMJHE
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class FPKPPDPMJHE
{
    public List<CIMJFKAJCCM> <LIBKPOMCAHC>k__BackingField;    // 0x0x10
    public GMNHMOAAMGN <PPKLBCPLPJD>k__BackingField;    // 0x0x18
}
...
public class GBEAHEOMBOH
{
    public List<MEDKCOCNBOE> <MDDLIJDLEKO>k__BackingField;    // 0x0x10
    public List<OPOMBHFPKCO> <PPKDPGNBLAH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GHEBNAJIIDP
//   (not directly referenced by a detected call)
public class GHEBNAJIIDP
{
    public Guid <HAFMNMJELEG>k__BackingField;    // 0x0x10
    public int <OOBGMFFPNLP>k__BackingField;    // 0x0x20
    public int <HPENLANPABF>k__BackingField;    // 0x0x24
    public Guid <FCIGNDAIPJD>k__BackingField;    // 0x0x28
    public DateTime <MBJFFIMMGBN>k__BackingField;    // 0x0x38
    public PNHOCEFPGLA <AAHCNOJOELD>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// GKENDAINENH
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class GKENDAINENH
{
    public List<IMEIPPBGFOK> <PCEEJALIHPA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GLDFMILPDOA
//   (not directly referenced by a detected call)
public class GLDFMILPDOA
{
    public bool <BHCEGGHNKEJ>k__BackingField;    // 0x0x10
    public FLCMGFPNDEP <INIMPLEEEAH>k__BackingField;    // 0x0x14
    public int <GPOEKINBOPB>k__BackingField;    // 0x0x18
    public DateTime <MBJFFIMMGBN>k__BackingField;    // 0x0x20
}
...
public class GLKLDDOBPGE
{
    public long <NCHEGFKIEDM>k__BackingField;    // 0x0x10
    public string <BDKKFKLMBNJ>k__BackingField;    // 0x0x18
    public string <NJIOPDEGMDD>k__BackingField;    // 0x0x20
    public DateTime <HBPPAOGGKDH>k__BackingField;    // 0x0x28
    public string <IHPAONAALNG>k__BackingField;    // 0x0x30
    public PACGMDBLIIO <CHIHCIHENCJ>k__BackingField;    // 0x0x38
    public int <KLLJCIDCBGB>k__BackingField;    // 0x0x3C
    public int <BBPKBJKKGAG>k__BackingField;    // 0x0x40
    public List<PJKJBDNNLDG> <JKDNNMPAEJG>k__BackingField;    // 0x0x48
}
...
public class GOPONJGGHOD
{
    public Guid <JGEMOANOFDH>k__BackingField;    // 0x0x10
    public long? <NAPANCOKPED>k__BackingField;    // 0x0x20
    public string <BDKKFKLMBNJ>k__BackingField;    // 0x0x30
    public string <NJIOPDEGMDD>k__BackingField;    // 0x0x38
    public BNLEOFOGFEL <PEKOKAGLJGJ>k__BackingField;    // 0x0x40
    public long <LKIILGLABII>k__BackingField;    // 0x0x48
    public DateTime <HBPPAOGGKDH>k__BackingField;    // 0x0x50
    public DateTime <MBJFFIMMGBN>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// HCBEKJKFLOO
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class HCBEKJKFLOO
{
    public LOACPNDGDBA <PEEIHALEFNB>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <LAGDDOAGONC>k__BackingField;    // 0x0x18
}
...
public class HEIBDFFKKDE
{
    public GMNHMOAAMGN <PPKLBCPLPJD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HGECMIMCEBF
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class HGECMIMCEBF
{
    public string <BJIBMHNMPIA>k__BackingField;    // 0x0x10
    public string <IFJENBLCDEC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HIEMMCPFBNH
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{fMFCGDDAMJD}   [Service.API]
//   RESPONSE POST   api/playerevents/v2/{eventId}   [Service.API]
public class HIEMMCPFBNH
{
    public MEDKCOCNBOE <EIMNKBFDFFB>k__BackingField;    // 0x0x10
    public GMNHMOAAMGN <PPKLBCPLPJD>k__BackingField;    // 0x0x18
    public KOBEJPMGILP <HIBJBDDKNOF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IINLMEHCHPP
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{kOCMKCCBGOB}   [Service.API]
public class IINLMEHCHPP
{
    public string LEFAOGHHBLL;    // 0x0x10
    public string NGAHLDIBNFD;    // 0x0x18
    public string AEDIOHAOOHG;    // 0x0x20
    public string FLPKHNBDOGL;    // 0x0x28
    public string AHAKKIIANEB;    // 0x0x30
    public LIPGGHJLMPD IJGICKAIKJK;    // 0x0x38
    public List<string> LLCHGOJMGKG;    // 0x0x40
    public List<string> ADCGMHOGGHB;    // 0x0x48
    public string ECALAFODMJO;    // 0x0x50
    public List<JEKNLPNDGGJ> JJDNEHDHBAC;    // 0x0x58
}

// --------------------------------------------------------------------------
// IMEIPPBGFOK
//   (not directly referenced by a detected call)
public class IMEIPPBGFOK
{
    public string <MHPEMIHHACN>k__BackingField;    // 0x0x10
    public DOOHOAAJNLH <LKJDAFJACBN>k__BackingField;    // 0x0x18
}
...
public class IMFGFODJAKJ
{
    public int <EFNEOFFCHPM>k__BackingField;    // 0x0x10
    public List<KPPMOENCPOP> <EKJHOOOKLMH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// INFFGGACEED
//   (not directly referenced by a detected call)
public class INFFGGACEED
{
    public int <ENDDHDNDPGH>k__BackingField;    // 0x0x10
    public string <EKOKHKHLKNK>k__BackingField;    // 0x0x18
    public string <GIKKBIOHALF>k__BackingField;    // 0x0x20
    public string <KNLLNGKFAPJ>k__BackingField;    // 0x0x28
    public string <KHINMMOHMKF>k__BackingField;    // 0x0x30
    public FMAFPELCNCM? <BKAOFECNOAN>k__BackingField;    // 0x0x38
    public string <AICDOKBKBAD>k__BackingField;    // 0x0x40
    public string <POLMDJIFIPN>k__BackingField;    // 0x0x48
    public bool <FCNNDCKNHFH>k__BackingField;    // 0x0x50
    public bool <KEBJENNCHOB>k__BackingField;    // 0x0x51
    public bool <NPBABJMGMLA>k__BackingField;    // 0x0x52
    public ONPJFLBCAFB <JFPJECLLGPE>k__BackingField;    // 0x0x54
    public BNLEOFOGFEL <PEKOKAGLJGJ>k__BackingField;    // 0x0x58
    public int <KAJFOEHJFFF>k__BackingField;    // 0x0x5C
    public FKBNKKMGLBL <LJJPOGJIADG>k__BackingField;    // 0x0x60
    public JIKKEBHHFGO <CCJCLMPPFHC>k__BackingField;    // 0x0x64
    public int <HAIFCBGPNHA>k__BackingField;    // 0x0x68
    public string <FCCJKGJOJDD>k__BackingField;    // 0x0x70
}
...
public class JAOMMEEHGCB : BANNEJCDCIA
{
    public MGLLOEDDAKA? <PHPLODGCLIP>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <LAGDDOAGONC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JEKNLPNDGGJ
//   (not directly referenced by a detected call)
public class JEKNLPNDGGJ
{
    public DateTime IJBABNKMOFP;    // 0x0x10
    public string GMACPPBBFGG;    // 0x0x18
}
...
public class JFEFNPCMJPM
{
    public int <FGBNOKLMMBO>k__BackingField;    // 0x0x10
    public BPNBDBGMIJF <LKJDAFJACBN>k__BackingField;    // 0x0x14
    public JBIGJACNCEG <GEANIGHCLPO>k__BackingField;    // 0x0x18
    public JBIGJACNCEG <MLJALALLANB>k__BackingField;    // 0x0x1C
    public JBIGJACNCEG <NONNKJEGMDM>k__BackingField;    // 0x0x20
}
...
public class JFPLAIBDEGM : GJBHPPNJJCM
{
    public int <CMAKFEKMKEI>k__BackingField;    // 0x0x30
    public string <BDKKFKLMBNJ>k__BackingField;    // 0x0x38
    public DateTime <OHALONNGKCL>k__BackingField;    // 0x0x40
    public DateTime <DLGBFJDEGGL>k__BackingField;    // 0x0x48
    public BNLEOFOGFEL <PEKOKAGLJGJ>k__BackingField;    // 0x0x50
    public ELMCGGHPOLM <PJIGLHFAEFG>k__BackingField;    // 0x0x58
    public List<NAKJHCBEJPA> <NKJHIBDOLCG>k__BackingField;    // 0x0x60
    public GLDFMILPDOA <BEGLAEMGFJH>k__BackingField;    // 0x0x68
}
...
public class JKONPKBBABN
{
    public bool <BGBHFEPLICD>k__BackingField;    // 0x0x10
    public string <FEPHMFKBELM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KEHMIBNEBCE
//   (not directly referenced by a detected call)
public class KEHMIBNEBCE
{
    public int <OJFOJKHOJEH>k__BackingField;    // 0x0x10
    public string <BDKKFKLMBNJ>k__BackingField;    // 0x0x18
    public string <OHDKKLBHLBP>k__BackingField;    // 0x0x20
    public string <NJIOPDEGMDD>k__BackingField;    // 0x0x28
    public string <GIKKBIOHALF>k__BackingField;    // 0x0x30
    public bool <PGPNHLGIEBM>k__BackingField;    // 0x0x38
    public int <FIPDFHCBIHB>k__BackingField;    // 0x0x3C
    public DJDLCFEBANA <MJJDIIBGIBN>k__BackingField;    // 0x0x40
    public CJNENDMEDIL LPKODKDHDLJ;    // 0x0x48
    public CJNENDMEDIL FIPANFMBIFI;    // 0x0x50
    public CJNENDMEDIL KKJEOBJMLLD;    // 0x0x58
    public BCMGFCGOMOK OAANINLNJNL;    // 0x0x60
}

// --------------------------------------------------------------------------
// KGAGEOFHFHP
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class KGAGEOFHFHP
{
    public BNLEOFOGFEL <PEKOKAGLJGJ>k__BackingField;    // 0x0x10
    public FAKMAPJHCMK <MIBJEGJMMDH>k__BackingField;    // 0x0x14
    public int <BDEDGJKNGPI>k__BackingField;    // 0x0x18
    public int <JOKDJBGCPCD>k__BackingField;    // 0x0x1C
    public int <PGHBGAKFMLF>k__BackingField;    // 0x0x20
    public GOLBAJOLLGM <GKFEEDCAIIK>k__BackingField;    // 0x0x24
    public bool <KFNEMIKDDLP>k__BackingField;    // 0x0x28
    public float <DJEKCFJDFNL>k__BackingField;    // 0x0x2C
    public int <PALHPIFDIKE>k__BackingField;    // 0x0x30
    public bool <CDOKHAMHFFD>k__BackingField;    // 0x0x34
}
...
// KMEBEAPFAPK
//   (not directly referenced by a detected call)
public class KMEBEAPFAPK
{
    public long <AGDLPGDEMIG>k__BackingField;    // 0x0x10
    public string <JNBHCLECPKA>k__BackingField;    // 0x0x18
    public int <CNGOLOMOKBB>k__BackingField;    // 0x0x20
    public string <BDKKFKLMBNJ>k__BackingField;    // 0x0x28
    public string <NJIOPDEGMDD>k__BackingField;    // 0x0x30
    public string <IHPAONAALNG>k__BackingField;    // 0x0x38
    public int <LLLAPDEIAIJ>k__BackingField;    // 0x0x40
    public bool <NKCDAJNENFJ>k__BackingField;    // 0x0x44
    public DateTime <MBJFFIMMGBN>k__BackingField;    // 0x0x48
    public DateTime <HBPPAOGGKDH>k__BackingField;    // 0x0x50
    public DateTime? <BPGKJCFDKEB>k__BackingField;    // 0x0x58
    public long? <BONOHKDHIJH>k__BackingField;    // 0x0x68
    public int <GHGOPFDHBNF>k__BackingField;    // 0x0x78
    public int <EKFNILLBPDN>k__BackingField;    // 0x0x7C
    public int <DMBOHIMJEBM>k__BackingField;    // 0x0x80
    public OMBHBIALJLM <INDNCCMKGPF>k__BackingField;    // 0x0x84
    public OMBHBIALJLM <AIIDNJCPFBK>k__BackingField;    // 0x0x88
    public bool <BDFLKIGKFAF>k__BackingField;    // 0x0x8C
    public bool <IIABGMFGFIF>k__BackingField;    // 0x0x8D
    public bool <NKJLJOOPHGM>k__BackingField;    // 0x0x8E
    public int? <GPGDEEOGPEH>k__BackingField;    // 0x0x90
    public bool <MHKCCMJIKCP>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// KOBEJPMGILP
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class KOBEJPMGILP
{
    public KHBGBDDPFMD <PPKLBCPLPJD>k__BackingField;    // 0x0x10
    public List<string> <PCEEJALIHPA>k__BackingField;    // 0x0x18
}
...
public class KOKLCIIPACK
{
    public EJBKPIKMMMC <HLBIPBDCKEK>k__BackingField;    // 0x0x10
    public MCDJFIHCDOM <KHLJPBGLADA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KPPMOENCPOP
//   (not directly referenced by a detected call)
public class KPPMOENCPOP
{
    public DateTime? <BDOABLDNIAB>k__BackingField;    // 0x0x10
    public DateTime? <KMNBLLELMHG>k__BackingField;    // 0x0x20
    public LLBCGIIPCBC <HLBIPBDCKEK>k__BackingField;    // 0x0x30
    public NLMKCECNPAI <INOBMDLEDLP>k__BackingField;    // 0x0x38
    public bool <KGJIPKLIPOF>k__BackingField;    // 0x0x40
}
...
public class LGILLMAMCMF
{
    public List<string> <BBHOGBHMAHP>k__BackingField;    // 0x0x10
    public List<string> <MGKEGMAADBD>k__BackingField;    // 0x0x18
    public List<string> <CKEMILKLACI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LIKFHBFKCBC
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class LIKFHBFKCBC
{
    public int <GMHPONMNJJF>k__BackingField;    // 0x0x10
    public int <NAGENMIMDEL>k__BackingField;    // 0x0x14
    public float <FGGPHGFPCMC>k__BackingField;    // 0x0x18
    public float <DOOOGPPNKNB>k__BackingField;    // 0x0x1C
    public bool <DFBMAFHHMMH>k__BackingField;    // 0x0x20
    public bool <KCOBMPIBHDL>k__BackingField;    // 0x0x21
    public bool <BOGKFMCBFNK>k__BackingField;    // 0x0x22
}
...
// LLKCHNEKPAB
//   (not directly referenced by a detected call)
public class LLKCHNEKPAB
{
    public bool <HCOFPAFDLHP>k__BackingField;    // 0x0x10
    public INFFGGACEED <NNANPEDCOMH>k__BackingField;    // 0x0x18
    public float <HLFOEMHFMJO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LNKKDEMGDIH
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class LNKKDEMGDIH
{
    public int? <ICMIBIMFHCJ>k__BackingField;    // 0x0x10
    public string <DEHPLDIBHAC>k__BackingField;    // 0x0x18
    public string <MHAEBBADLAJ>k__BackingField;    // 0x0x20
}
...
public class LOACPNDGDBA
{
    public int <OOBGMFFPNLP>k__BackingField;    // 0x0x10
    public Guid <JGEMOANOFDH>k__BackingField;    // 0x0x14
    public long <BNOJFIHMABO>k__BackingField;    // 0x0x28
    public DateTime <MBJFFIMMGBN>k__BackingField;    // 0x0x30
}
...
public class MCAKJLACLAL
{
    public NEAEOPGLDJJ <DBGAPAGMICH>k__BackingField;    // 0x0x10
    public long <IAPAEDBAAKO>k__BackingField;    // 0x0x18
    public string <GPHBGCBLNJH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MCDJFIHCDOM
//   (not directly referenced by a detected call)
public class MCDJFIHCDOM
{
    public long <BFKANNCIBCL>k__BackingField;    // 0x0x10
    public Guid <JNBHCLECPKA>k__BackingField;    // 0x0x18
    public long <NAPANCOKPED>k__BackingField;    // 0x0x28
    public string <BDKKFKLMBNJ>k__BackingField;    // 0x0x30
    public string <NJIOPDEGMDD>k__BackingField;    // 0x0x38
    public int <GPGDEEOGPEH>k__BackingField;    // 0x0x40
    public Guid? <EDBFEABALMK>k__BackingField;    // 0x0x44
    public DateTime <HBPPAOGGKDH>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// MEDKCOCNBOE
//   (not directly referenced by a detected call)
public class MEDKCOCNBOE
{
    public long <IAPAEDBAAKO>k__BackingField;    // 0x0x10
    public int <CNGOLOMOKBB>k__BackingField;    // 0x0x18
    public long <NAPANCOKPED>k__BackingField;    // 0x0x20
    public long? <EPDKAHBEMGB>k__BackingField;    // 0x0x28
    public long? <LJCLEIALPKB>k__BackingField;    // 0x0x38
    public string <BDKKFKLMBNJ>k__BackingField;    // 0x0x48
    public string <NJIOPDEGMDD>k__BackingField;    // 0x0x50
    public string <IHPAONAALNG>k__BackingField;    // 0x0x58
    public DateTime <CLMLGIMFAGA>k__BackingField;    // 0x0x60
    public DateTime <IMACDPCOALH>k__BackingField;    // 0x0x68
    public int <HGOAFHDIAHI>k__BackingField;    // 0x0x70
    public EFBGHKLNLFA <PAADKGMLNGK>k__BackingField;    // 0x0x74
    public bool <EBLJEEPEKCP>k__BackingField;    // 0x0x78
    public bool <FBIJEIKGKJN>k__BackingField;    // 0x0x79
    public long? <LCFGIDGBFAE>k__BackingField;    // 0x0x80
}
...
public class MGIGMLILJEK
{
    public Guid <KINIKCFLFDL>k__BackingField;    // 0x0x10
    public Guid <JGEMOANOFDH>k__BackingField;    // 0x0x20
    public int <ADFGFCLEJCH>k__BackingField;    // 0x0x30
    public string <BDKKFKLMBNJ>k__BackingField;    // 0x0x38
    public long <EAHFAJHJKOI>k__BackingField;    // 0x0x40
    public long <GPGDEEOGPEH>k__BackingField;    // 0x0x48
    public DateTime <MBJFFIMMGBN>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// MHPMILGOPIL
//   (not directly referenced by a detected call)
public class MHPMILGOPIL
{
    public long <AGDLPGDEMIG>k__BackingField;    // 0x0x10
    public string <JNBHCLECPKA>k__BackingField;    // 0x0x18
    public int <MBIKEAMGIPC>k__BackingField;    // 0x0x20
    public int <KMKFKFCAGIG>k__BackingField;    // 0x0x24
    public int <MKANDMEEGLL>k__BackingField;    // 0x0x28
    public int <PLHEPDPBCAI>k__BackingField;    // 0x0x2C
    public int <HDALMFEGPBG>k__BackingField;    // 0x0x30
    public string <DAFEKOICCOO>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// MKPFFILICIM
//   (not directly referenced by a detected call)
public class MKPFFILICIM
{
    public long <FGKHFNBBHOI>k__BackingField;    // 0x0x10
    public long <IAPAEDBAAKO>k__BackingField;    // 0x0x18
    public int <DLECDKGMDMC>k__BackingField;    // 0x0x20
    public DateTime <HBPPAOGGKDH>k__BackingField;    // 0x0x28
    public IOPCFHCAFGE <LKJDAFJACBN>k__BackingField;    // 0x0x30
}
...
// base   : ELMCGGHPOLM
//   (not directly referenced by a detected call)
public class NAKJHCBEJPA : ELMCGGHPOLM
{
    public int <OHGEOOLFPAG>k__BackingField;    // 0x0x40
    public List<LLKCHNEKPAB> <MCCLLBKBNFD>k__BackingField;    // 0x0x48
    public List<LLKCHNEKPAB> <JIIBEJNKMLP>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// NCOGNJMELHE
//   (not directly referenced by a detected call)
public class NCOGNJMELHE
{
    public float <NAJJJDMCDOL>k__BackingField;    // 0x0x10
    public float <GDNFNKGCNCG>k__BackingField;    // 0x0x14
    public float <GJJFDIPAJAH>k__BackingField;    // 0x0x18
    public float <IDFOCAFAOOE>k__BackingField;    // 0x0x1C
    public float <MJMMGGPJCFD>k__BackingField;    // 0x0x20
    public float <ECBMNAOJEOP>k__BackingField;    // 0x0x24
    public float <NENEPNEKEAN>k__BackingField;    // 0x0x28
    public float <ABFLKBNMJNN>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// NLMKCECNPAI
//   (not directly referenced by a detected call)
public class NLMKCECNPAI
{
    public int <DIHMLCBINEJ>k__BackingField;    // 0x0x10
    public int <OHJBDGFPCLL>k__BackingField;    // 0x0x14
    public int <PGPEHILOAKG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OEIFMMNKICD
//   RESPONSE GET    api/config/   [Service.API]
public class OEIFMMNKICD
{
    public Dictionary<int, int> <HCHLFIBEPJD>k__BackingField;    // 0x0x10
    public OOLENGCICJA[][] <KOBKFOJPOBD>k__BackingField;    // 0x0x18
    public PNGIIADGAOI <JKILKMBEIGG>k__BackingField;    // 0x0x20
    public NCOGNJMELHE <HFHIIHKCFCM>k__BackingField;    // 0x0x28
    public CNGPLOGEPJK <GFGONPAABFN>k__BackingField;    // 0x0x30
    public string <JGLHPPPBDAG>k__BackingField;    // 0x0x38
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{aPMPKFEAJIL}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{aPMPKFEAJIL}   [Service.API]
...
public class OFADAHAONIF
{
    public COEEMPHDCHP IJGICKAIKJK;    // 0x0x10
    public PNHOCEFPGLA PPCFJODDOIN;    // 0x0x18
}
...
public class OGEMIKCCPML
{
    public bool <BGBHFEPLICD>k__BackingField;    // 0x0x10
    public string <KOALCCJCEDO>k__BackingField;    // 0x0x18
}
...
public class OJBHJDLGMIB
{
    public EMDGGJNHPLI <HLBIPBDCKEK>k__BackingField;    // 0x0x10
    public KMEBEAPFAPK <GJIADBJGDJA>k__BackingField;    // 0x0x18
    public MHPMILGOPIL <CGMEFAGIGIA>k__BackingField;    // 0x0x20
}
...
// OOLENGCICJA
//   (not directly referenced by a detected call)
public class OOLENGCICJA
{
    public LNPLCJBPPFP GGKBKPGAEIH;    // 0x0x10
    public int NDPFFDDJLGI;    // 0x0x14
}
...
public class OPEJFANNMCM
{
    public List<BNPAJOCHBBH> <IHEFOIPBPAJ>k__BackingField;    // 0x0x10
    public string <AFLFGNNMKFG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OPOMBHFPKCO
//   (not directly referenced by a detected call)
public class OPOMBHFPKCO
{
    public MEDKCOCNBOE <EIMNKBFDFFB>k__BackingField;    // 0x0x10
    public MKPFFILICIM <AMGDJAMGAMB>k__BackingField;    // 0x0x18
}
...
public class PHIMMMGEGIE : GJBHPPNJJCM
{
    public List<CAJHDFCIAEK> MCKIMKINCDJ;    // 0x0x30
}

// --------------------------------------------------------------------------
// PJKJBDNNLDG
//   RESPONSE GET    api/groups/v1/memberships/{gODGEIBJPMH}   [Service.API]
public class PJKJBDNNLDG
{
    public long <NCHEGFKIEDM>k__BackingField;    // 0x0x10
    public int <DLECDKGMDMC>k__BackingField;    // 0x0x18
    public FEGKNEHCIMC <FDLDCJDAFBP>k__BackingField;    // 0x0x1C
}
...
// PNGIIADGAOI
//   (not directly referenced by a detected call)
public class PNGIIADGAOI
{
    public int <MNDAGJAEIJN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PNHOCEFPGLA
//   (not directly referenced by a detected call)
public class PNHOCEFPGLA
{
    public Guid <HAFMNMJELEG>k__BackingField;    // 0x0x10
    public long <NAPANCOKPED>k__BackingField;    // 0x0x20
    public string <BDKKFKLMBNJ>k__BackingField;    // 0x0x28
    public string <NJIOPDEGMDD>k__BackingField;    // 0x0x30
    public string <IHPAONAALNG>k__BackingField;    // 0x0x38
    public long <GPGDEEOGPEH>k__BackingField;    // 0x0x40
    public Guid? <EDBFEABALMK>k__BackingField;    // 0x0x48
    public DateTime <MBJFFIMMGBN>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// PPFMBADNOOM
//   RESPONSE GET    api/activities/charades/v1/words/{wordId}   [Service.API]
public class PPFMBADNOOM
{
    public GNLLGPCHMMD <LKJDAFJACBN>k__BackingField;    // 0x0x10
    public string <MBMGKJFOLHK>k__BackingField;    // 0x0x18
}
...
public class FreeGiftRequestDTO
{
    ...
    public JIKKEBHHFGO <GiftContext>k__BackingField;    // 0x0x20
}
...
public class GetRankRequestDTO
{
    ...
    public GDKEHDNINJP FilterType;    // 0x0x20
    public HGCOHLLHHAD Timeframe;    // 0x0x24
...
public class NewInventionRequestDTO
{
    ...
    public HDBIEEMJGJM creatorAccountRole;    // 0x0x58
}
...
public class ReportRequest
{
    ...
    public LBPGKKDMNIF ReportCategory;    // 0x0x20
}
...
{
    public DGPKPONNHNO? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public DGPKPONNHNO PMBPLBKEDAL;  // wrapper
...
{
    public FANNIOGKPEE JBIGGHKFFBJ;  // wrapper
...
{
    public LCNDHFNOBNO PBECNPPNGID;  // wrapper
    public int? IELOJGELJFB;  // wrapper
...
{
    public NEAEOPGLDJJ HNJKHHFEFKK;  // wrapper
    public JACFOLCBHJE GAMOMGCMAHI;  // wrapper
...
{
    public FGDBJLABHPI OBGKHBNPNGB;  // wrapper
    public JACFOLCBHJE GAMOMGCMAHI;  // wrapper
...
{
    public JIKKEBHHFGO IJPNDHOBKKG;  // wrapper
    public JIKKEBHHFGO? BGPAEHPKNEM;  // wrapper
...
{
    public KEHMIBNEBCE AOCGCENOBFP;  // wrapper
...
{
    public KGKPKINHFGJ NIJHOABGADE;  // wrapper
    public NEAEOPGLDJJ HNJKHHFEFKK;  // wrapper
...
{
    public IReadOnlyList<DMBHHIJBEPN> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public AHOIALBLCGB OEMPKGEGNFC;  // wrapper
    public JIKKEBHHFGO? BDLHOOLOFEH;  // wrapper
...
{
    public NONDEODOJHD NEHGIIJOFBI;  // wrapper
...
{
    public StatusResponse> GAMOMGCMAHI;  // wrapper
...
{
    public NGGIFDHDKCF OLPBBKILDMK;  // wrapper
    public object platformId;  // candidate
...
{
    public List<long> IGLIMNNNELL;  // wrapper
    public JACFOLCBHJE GAMOMGCMAHI;  // wrapper
    public KAJJKCEJKON NAKAOGLBPFC;  // wrapper
    public long? GNMLKMPBFNA;  // wrapper
...
{
    public String> GAMOMGCMAHI;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{fMFCGDDAMJD}  [API POST]
public class PlayereventsV2DeleteFMFCGDDAMJDRequest
{
    public MEDKCOCNBOE FMFCGDDAMJD;  // wrapper
}

// api/players/v2/objectives  [API POST]
public class PlayersV2ObjectivesRequest
{
    public List<BJPLJHOKCFH> MPDJPGPCDCK;  // wrapper
...
{
    public Guid PIBCJBFKDKF;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> NGGKHEOGHGE;  // wrapper
...
{
    public Guid? GGJJAEMABGC;  // wrapper
    public object RoomId;  // candidate
...
{
    public MatchCompleteStats FMFGCHKFBJF;  // wrapper
}
...
{
    public Guid LBKHANFOEOH;  // wrapper
    public object RoomKeyId;  // candidate
    public object RequestedPrice;  // candidate
...
{
    public List<OKBLKOJEIAL> MPDJPGPCDCK;  // wrapper
    public object objectiveType;  // candidate
...
{
    public LIPGGHJLMPD MNCLFBEEINI;  // wrapper
}
