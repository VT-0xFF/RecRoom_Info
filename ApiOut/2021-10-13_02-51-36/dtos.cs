...
// DTO classes: 222 (plus referenced enums)

// --------------------------------------------------------------------------
// ABEOLIAHFED
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class ABEOLIAHFED
{
    public int <JDHLMBLMDJL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// ADMJDAHHBFE
//   (not directly referenced by a detected call)
public class ADMJDAHHBFE
{
    public int <HHDEKJOMLLM>k__BackingField;    // 0x0x10
}
...
// --------------------------------------------------------------------------
// AFBPLMBBANH
//   RESPONSE GET    api/inventions/v1/personaldetails/{jMCFIJEMCGD}   [Service.API]
public class AFBPLMBBANH
{
    public bool <CELNFBOLOOB>k__BackingField;    // 0x0x10
}
...
public class ANKLDGAFKFO
{
    public List<PBIJIAPLEMB> <FADONDPFBGD>k__BackingField;    // 0x0x10
    public string <OLMLLFBGFDN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AOMGAIBHKMH
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class AOMGAIBHKMH
{
    public long <KAMBFJCLFIB>k__BackingField;    // 0x0x10
    public ELGBGFGAJED <BFHMMAMMBBM>k__BackingField;    // 0x0x18
}
...
public class AOPLNAKIEAE
{
    public bool <FOJINKDFMMN>k__BackingField;    // 0x0x10
    public string <FFOPMOIHJIP>k__BackingField;    // 0x0x18
}
...
// base   : PEDFONBMLCI
//   (not directly referenced by a detected call)
public class BDOKFLILPEH : PEDFONBMLCI
{
    public int <DAPNNKPDPLC>k__BackingField;    // 0x0x40
    public List<CONDGBAEFAI> <GIKOHFNIKBJ>k__BackingField;    // 0x0x48
    public List<CONDGBAEFAI> <MKHHNCPDIOE>k__BackingField;    // 0x0x50
    public List<CONDGBAEFAI> <HOGHLKFECCK>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// BFCFLJBEIIN
//   (not directly referenced by a detected call)
public class BFCFLJBEIIN
{
    public DateTime HMLDEIOLEOF;    // 0x0x10
    public string DNIGFAKMPGN;    // 0x0x18
}

// --------------------------------------------------------------------------
// BJDCNHBELAF
//   (not directly referenced by a detected call)
public class BJDCNHBELAF
{
    public float <BAELLIAPHBB>k__BackingField;    // 0x0x10
    public float <KGLHENBDFHD>k__BackingField;    // 0x0x14
    public float <OKKLGCKEDOF>k__BackingField;    // 0x0x18
    public float <EKFHCEPBGMH>k__BackingField;    // 0x0x1C
    public float <CABPLMFKOLJ>k__BackingField;    // 0x0x20
    public float <NHPNMPEAEAO>k__BackingField;    // 0x0x24
    public float <JPHFDFMBPAA>k__BackingField;    // 0x0x28
    public float <JGCILNHHJHM>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// BJKJIIBHOOE
//   (not directly referenced by a detected call)
public class BJKJIIBHOOE
{
    public int <HFFFCHIJFGO>k__BackingField;    // 0x0x10
    public int <LFCLPKOOFFD>k__BackingField;    // 0x0x14
    public int <MCDBEDNPDMF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BKBKDCJMLOD
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{gLOEJNOCKGC}   [Service.API]
public class BKBKDCJMLOD
{
    public string PALEOFHBJGP;    // 0x0x10
    public string ADIOLHMGEME;    // 0x0x18
    public string CCIBFFMMMNF;    // 0x0x20
    public string FEBMADPKBFH;    // 0x0x28
    public string CGJEDJLEBAJ;    // 0x0x30
    public KNNJNGJDEAG BCLNBPAGCNP;    // 0x0x38
    public List<string> EKBCDGCGBIB;    // 0x0x40
    public List<string> JDIGNOFDKGK;    // 0x0x48
    public string OIEPBIMNIIJ;    // 0x0x50
    public List<BFCFLJBEIIN> LIPJKAHHCMM;    // 0x0x58
}
...
public class CAOEDDBABKH
{
    public LENILCJPMLB <PFGBOPGCGKD>k__BackingField;    // 0x0x10
    public OFCGPHMNJKH <JLGEKLBJKCO>k__BackingField;    // 0x0x18
}
...
// CNACOFAAOFN
//   (not directly referenced by a detected call)
public class CNACOFAAOFN
{
    public int <IKMIPANAMIE>k__BackingField;    // 0x0x10
    public string <HPKDFBPAPOG>k__BackingField;    // 0x0x18
    public string <DHOPPCNKOHH>k__BackingField;    // 0x0x20
    public string <PCMAFEOKFAG>k__BackingField;    // 0x0x28
    public string <NGHGINLLLPD>k__BackingField;    // 0x0x30
    public bool <LJBFIMNCJEP>k__BackingField;    // 0x0x38
    public int <LAGCEANMPBE>k__BackingField;    // 0x0x3C
    public OHFEKKMJCIB <NNLEDEPGNCO>k__BackingField;    // 0x0x40
    public HPEEFDAOCII KGODNFPAOBM;    // 0x0x48
    public HPEEFDAOCII PJPFEFHHCOE;    // 0x0x50
    public HPEEFDAOCII ALLLEPEJMAF;    // 0x0x58
    public PJDFDAOJHDK NOCHIPJNLMA;    // 0x0x60
}

// --------------------------------------------------------------------------
// CONDGBAEFAI
//   (not directly referenced by a detected call)
public class CONDGBAEFAI
{
    public bool <ACMFDPPFJLO>k__BackingField;    // 0x0x10
    public OFCJPCMNIJC <JEIHBFHKMKM>k__BackingField;    // 0x0x18
    public float <MPOHDFDJAGO>k__BackingField;    // 0x0x20
}
...
public class DBMPAKBMJEH
{
    public string <EHDJEPEMEDI>k__BackingField;    // 0x0x10
    public string <GDHHJFNOEKL>k__BackingField;    // 0x0x18
    public string <FIHPJKLEJDN>k__BackingField;    // 0x0x20
    public string <LOOMEAAKKMA>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// DKECGHOPPHF
//   RESPONSE GET    api/config/v1/amplitude   [Service.API]
public class DKECGHOPPHF
{
    public string <LEEBBECJGDB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DKIEJFCCLLC
//   (not directly referenced by a detected call)
public class DKIEJFCCLLC
{
    public int <CJBEKIDAOMC>k__BackingField;    // 0x0x10
    public BPAOIJJALPJ <POEKDGOOCPF>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// DMGAMMDKPFF
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class DMGAMMDKPFF
{
    public int <OCPCFGFHJJC>k__BackingField;    // 0x0x10
    public Guid <PBIOIODDHJN>k__BackingField;    // 0x0x14
    public long <HIAJFFAGCPA>k__BackingField;    // 0x0x28
    public long <JLFDMIHBMII>k__BackingField;    // 0x0x30
    public DateTime <BMOHDDEPHNA>k__BackingField;    // 0x0x38
}
...
public class DOJPGLCHDCG
{
    public JKHILHKCMDI BCLNBPAGCNP;    // 0x0x10
    public MPECNAPNLMJ POCIHGDGHBJ;    // 0x0x18
}

// --------------------------------------------------------------------------
// ECNBMJEPLID
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class ECNBMJEPLID
{
    public List<FIGHMFFCAIP> <IHNDHGONMEO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EGJDHIILDHJ
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class EGJDHIILDHJ
{
    public IKLDOKGFDCF <JAEFFFAFIPN>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <JGPCDIFOOMG>k__BackingField;    // 0x0x18
}
...
public class EIAJKFLBCDL
{
    public BPAOIJJALPJ <POEKDGOOCPF>k__BackingField;    // 0x0x10
}
...
// FFNMIKOEDHM
//   (not directly referenced by a detected call)
public class FFNMIKOEDHM
{
    public float <POBMKLLJADM>k__BackingField;    // 0x0x10
}
...
public class FHDBIKGNPMA
{
    public JMKEBPNKPOM <PFGBOPGCGKD>k__BackingField;    // 0x0x10
    public NGACNKBFCFN <ANCAJNEAFPI>k__BackingField;    // 0x0x18
    public PIFCPDFPEMC <HBPIPAFMMGK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FIGHMFFCAIP
//   (not directly referenced by a detected call)
public class FIGHMFFCAIP
{
    public string <PALAJAMHJEL>k__BackingField;    // 0x0x10
    public PFCIAPFIEJK <BFHMMAMMBBM>k__BackingField;    // 0x0x18
}
...
public class FKIPKHNDPEC
{
    public int <BCBKCMOJCHM>k__BackingField;    // 0x0x10
    public List<JFBLBGBEALC> <GHHGAKHGJBM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FLNOHJAABOP
//   (not directly referenced by a detected call)
public class FLNOHJAABOP
{
    public MPIBCNGCNDK <LNNKNPDMNPE>k__BackingField;    // 0x0x10
    public int <APOPEPKCBKL>k__BackingField;    // 0x0x14
    public LHAOBCAHFHI <DNDEBDPJGNE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GFMHNGNBLKC
//   (not directly referenced by a detected call)
public class GFMHNGNBLKC
{
    public Guid <OIEGIDOLLEL>k__BackingField;    // 0x0x10
    public long <KOMOMGBKLDJ>k__BackingField;    // 0x0x20
    public string <HPKDFBPAPOG>k__BackingField;    // 0x0x28
    public string <PCMAFEOKFAG>k__BackingField;    // 0x0x30
    public string <LAJMNIDFFNG>k__BackingField;    // 0x0x38
    public long <APOPEPKCBKL>k__BackingField;    // 0x0x40
    public Guid? <POPGGNNALMA>k__BackingField;    // 0x0x48
    public DateTime <GJIAPOAJMAF>k__BackingField;    // 0x0x60
}
...
public class GGOIPGHENFF : BCHNNHLBJLP
{
    public NLLGLAMKPPE? <CGPADEHIGPH>k__BackingField;    // 0x0x18
    public IKLDOKGFDCF <JAEFFFAFIPN>k__BackingField;    // 0x0x20
}
...
public class GMKFEKDAFDP
{
    public string <MOEFPECICNL>k__BackingField;    // 0x0x10
    public string <GJCFJFPAJKK>k__BackingField;    // 0x0x18
}
...
public class HCBLEHJJKHI
{
    public bool <FOJINKDFMMN>k__BackingField;    // 0x0x10
    public string <DNMIHPCJLEL>k__BackingField;    // 0x0x18
}
...
// HIGGDGLGIDG
//   (not directly referenced by a detected call)
public class HIGGDGLGIDG
{
    public bool <MNPGBCNFJED>k__BackingField;    // 0x0x10
    public NGAKHHEBMKK <ONBAMMOFIMB>k__BackingField;    // 0x0x14
    public int <IMCIPGNECPA>k__BackingField;    // 0x0x18
    public DateTime <GJIAPOAJMAF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HJEDAHAALAL
//   (not directly referenced by a detected call)
public class HJEDAHAALAL
{
    public long <KAMBFJCLFIB>k__BackingField;    // 0x0x10
    public int <OKHPLAEAOOF>k__BackingField;    // 0x0x18
    public long <KOMOMGBKLDJ>k__BackingField;    // 0x0x20
    public long? <DMLHNHINKNC>k__BackingField;    // 0x0x28
    public long? <DJNEKIHHEIJ>k__BackingField;    // 0x0x38
    public string <HPKDFBPAPOG>k__BackingField;    // 0x0x48
    public string <PCMAFEOKFAG>k__BackingField;    // 0x0x50
    public string <LAJMNIDFFNG>k__BackingField;    // 0x0x58
    public DateTime <JHKIIEENIHA>k__BackingField;    // 0x0x60
    public DateTime <MAGNCNAONOH>k__BackingField;    // 0x0x68
    public int <NBDGBNFDNOJ>k__BackingField;    // 0x0x70
    public GHPMPILHNDB <ILMAEAGHBND>k__BackingField;    // 0x0x74
    public bool <PAAACBHPLJG>k__BackingField;    // 0x0x78
    public bool <NDAMEGNBJDK>k__BackingField;    // 0x0x79
    public long? <ICJBANBMJMP>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// HLONAFBGPCC
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class HLONAFBGPCC
{
    public CJJNHNPPABD <POEKDGOOCPF>k__BackingField;    // 0x0x10
    public List<string> <IHNDHGONMEO>k__BackingField;    // 0x0x18
}
...
public class IKLDOKGFDCF
{
    public int <OCPCFGFHJJC>k__BackingField;    // 0x0x10
    public Guid <PBIOIODDHJN>k__BackingField;    // 0x0x14
    public long <HIAJFFAGCPA>k__BackingField;    // 0x0x28
    public DateTime <GJIAPOAJMAF>k__BackingField;    // 0x0x30
}
...
public class INNNDFONIMM
{
    public List<HJEDAHAALAL> <BFBMAAMDNCM>k__BackingField;    // 0x0x10
    public List<JJBNEAPJBFP> <OKDNACPHFBF>k__BackingField;    // 0x0x18
}
...
// JFBLBGBEALC
//   (not directly referenced by a detected call)
public class JFBLBGBEALC
{
    public DateTime? <BEKBHEEGLPN>k__BackingField;    // 0x0x10
    public DateTime? <FGGFMOEPJNM>k__BackingField;    // 0x0x20
    public FDIIKEBHKAJ <PFGBOPGCGKD>k__BackingField;    // 0x0x30
    public BJKJIIBHOOE <DOFOKNHONDF>k__BackingField;    // 0x0x38
    public bool <ONNMPDBAKHP>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// JFIJCKBEMIC
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{gLOEJNOCKGC}   [Service.API]
public class JFIJCKBEMIC
{
    public uint PALEOFHBJGP;    // 0x0x10
    public string MNDPCPBJDAJ;    // 0x0x18
    public string FEBMADPKBFH;    // 0x0x20
    public DateTime CNOBJBDPBOM;    // 0x0x28
    public DateTime? BECCGKNAFGD;    // 0x0x30
    public bool HMOBCIJIIEO;    // 0x0x40
    public List<BKBKDCJMLOD> NIDELIJFGAF;    // 0x0x48
    public List<string> JDIGNOFDKGK;    // 0x0x50
    public int EFFILOJJADJ;    // 0x0x58
    public int NLEAPIOAPBK;    // 0x0x5C
    public int LDJJLMFLCCF;    // 0x0x60
}

// --------------------------------------------------------------------------
// JJBNEAPJBFP
//   (not directly referenced by a detected call)
public class JJBNEAPJBFP
{
    public HJEDAHAALAL <MCEBMLAMGGK>k__BackingField;    // 0x0x10
    public PIPAMKFJJHF <EPEOKFHPBCK>k__BackingField;    // 0x0x18
}
...
public class JJNJCPENBFH : PHDEOPOCJIM
{
    public List<KBBFFFLNDLF> EAKADJLBCKB;    // 0x0x30
    public int <KHOAEAEMGNP>k__BackingField;    // 0x0x38
}
...
public class JLCCPMPODJP
{
    public Guid <PBIOIODDHJN>k__BackingField;    // 0x0x10
    public long? <KOMOMGBKLDJ>k__BackingField;    // 0x0x20
    public string <HPKDFBPAPOG>k__BackingField;    // 0x0x30
    public string <PCMAFEOKFAG>k__BackingField;    // 0x0x38
    public MPIBCNGCNDK <LNNKNPDMNPE>k__BackingField;    // 0x0x40
    public long <BJINFEDIKLJ>k__BackingField;    // 0x0x48
    public DateTime <HLPBJFCBHFF>k__BackingField;    // 0x0x50
    public DateTime <GJIAPOAJMAF>k__BackingField;    // 0x0x58
}
...
// --------------------------------------------------------------------------
// JOGLIHDBIDM
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{iLEAOPJCJBG}   [Service.API]
public class JOGLIHDBIDM
{
    public Guid <NPBEGJCDEAD>k__BackingField;    // 0x0x10
    public int <OCPCFGFHJJC>k__BackingField;    // 0x0x20
    public int <PBEFDBKKMED>k__BackingField;    // 0x0x24
    public DateTime <HLPBJFCBHFF>k__BackingField;    // 0x0x28
}
...
public class JOHBADGLJGC : BCHNNHLBJLP
{
    public GIMAHFMIGBO? <CGPADEHIGPH>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <JGPCDIFOOMG>k__BackingField;    // 0x0x20
}
...
// base   : PEDFONBMLCI
//   (not directly referenced by a detected call)
public class KBBFFFLNDLF : PEDFONBMLCI
{
    public OFCJPCMNIJC <JEIHBFHKMKM>k__BackingField;    // 0x0x40
}
...
public class KHECPIIGPEL : PHDEOPOCJIM
{
    public int <LEJPHCNEHKE>k__BackingField;    // 0x0x30
    public string <HPKDFBPAPOG>k__BackingField;    // 0x0x38
    public DateTime <KHAHCEOHIGG>k__BackingField;    // 0x0x40
    public DateTime <IPDEKAJFGEL>k__BackingField;    // 0x0x48
    public MPIBCNGCNDK <LNNKNPDMNPE>k__BackingField;    // 0x0x50
    public PEDFONBMLCI <NBHDENEBFBK>k__BackingField;    // 0x0x58
    public List<BDOKFLILPEH> <DAMKNGADEKM>k__BackingField;    // 0x0x60
    public HIGGDGLGIDG <HODNALDNGIP>k__BackingField;    // 0x0x68
}
...
public class KNIOKCPKEHE
{
    public KPCAHHHIOHB <EPAEKJMFGHH>k__BackingField;    // 0x0x10
    public int <JDHLMBLMDJL>k__BackingField;    // 0x0x14
    public long <CNKLIHDPIEJ>k__BackingField;    // 0x0x18
    public bool <CHBFFKDHNPE>k__BackingField;    // 0x0x20
    public string <DNMIHPCJLEL>k__BackingField;    // 0x0x28
    public int? <HHCJIHGEDEC>k__BackingField;    // 0x0x30
    public bool <KOCHOEOONPJ>k__BackingField;    // 0x0x38
    public string <DONJFHHGAMO>k__BackingField;    // 0x0x40
    public float <JCHEOOGHPOA>k__BackingField;    // 0x0x48
}
...
public class LENFBAOIHNB
{
    public long <KOMOMGBKLDJ>k__BackingField;    // 0x0x10
    public long? <DMLHNHINKNC>k__BackingField;    // 0x0x18
    public long? <DJNEKIHHEIJ>k__BackingField;    // 0x0x28
    public string <HPKDFBPAPOG>k__BackingField;    // 0x0x38
    public string <PCMAFEOKFAG>k__BackingField;    // 0x0x40
    public List<string> <IHNDHGONMEO>k__BackingField;    // 0x0x48
    public string <LAJMNIDFFNG>k__BackingField;    // 0x0x50
    public DateTime <JHKIIEENIHA>k__BackingField;    // 0x0x58
    public DateTime <MAGNCNAONOH>k__BackingField;    // 0x0x60
    public GHPMPILHNDB <ILMAEAGHBND>k__BackingField;    // 0x0x68
    public bool <PAAACBHPLJG>k__BackingField;    // 0x0x6C
}

// --------------------------------------------------------------------------
// LENILCJPMLB
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{iGGELEIBIJD}   [Service.API]
public enum LENILCJPMLB
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class LGNEGOICPMF
{
    public Guid <HJFAONILCDA>k__BackingField;    // 0x0x10
    public Guid <PBIOIODDHJN>k__BackingField;    // 0x0x20
    public int <FBCKHKFBGPM>k__BackingField;    // 0x0x30
    public string <HPKDFBPAPOG>k__BackingField;    // 0x0x38
    public long <OIGGGNEILAL>k__BackingField;    // 0x0x40
    public long <APOPEPKCBKL>k__BackingField;    // 0x0x48
    public DateTime <GJIAPOAJMAF>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// LHAOBCAHFHI
//   (not directly referenced by a detected call)
public class LHAOBCAHFHI
{
    public int <BGIJAIHMDKJ>k__BackingField;    // 0x0x10
    public DateTime? <EAMCBNJLFDH>k__BackingField;    // 0x0x18
    public DateTime? <PJHIFADELCF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// LIBGHOLDDBM
//   RESPONSE GET    api/groups/v1/memberships/{fKMAGABADKL}   [Service.API]
public class LIBGHOLDDBM
{
    public long <APALMFPAADI>k__BackingField;    // 0x0x10
    public int <GCOKOLJJEJD>k__BackingField;    // 0x0x18
    public KFIAODNKILF <IMNLBKPKAEK>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// MMJCOOBANGI
//   (not directly referenced by a detected call)
public class MMJCOOBANGI
{
    public NDBJPMMAEII LNIMHDIDOKD;    // 0x0x10
    public int EJDMNBOHIHP;    // 0x0x14
    public int JPEOLCFICHI;    // 0x0x18
}

// --------------------------------------------------------------------------
// MPECNAPNLMJ
//   (not directly referenced by a detected call)
public class MPECNAPNLMJ
{
    public Guid <OIEGIDOLLEL>k__BackingField;    // 0x0x10
    public int <OCPCFGFHJJC>k__BackingField;    // 0x0x20
    public int <NHGOJDMKEIA>k__BackingField;    // 0x0x24
    public Guid <MEJJFDEHBPP>k__BackingField;    // 0x0x28
    public DateTime <GJIAPOAJMAF>k__BackingField;    // 0x0x38
    public GFMHNGNBLKC <CICKEFMNLAC>k__BackingField;    // 0x0x40
}
...
// NDHBENMANGF
//   (not directly referenced by a detected call)
public class NDHBENMANGF
{
    public long <DMKNNKBOFBC>k__BackingField;    // 0x0x10
    public string <KDGBFJJCALG>k__BackingField;    // 0x0x18
    public string <AKEEDCPBAAE>k__BackingField;    // 0x0x20
    public MGINEGMBCJB? <HNALKLAPPBM>k__BackingField;    // 0x0x28
    public string <FLBLBEBDMMC>k__BackingField;    // 0x0x30
    public string <BFKFGGNGMIA>k__BackingField;    // 0x0x38
    public KMNPAGOCOLO <AJKHJLHLDEA>k__BackingField;    // 0x0x40
    public int <MBFECFKBNKH>k__BackingField;    // 0x0x44
    public int <BEECAFAOIEC>k__BackingField;    // 0x0x48
    public KNEHFPIOIMA? <IJILKGMPOEC>k__BackingField;    // 0x0x4C
    public JJJCECDBDBK? <AAILOLJBPNK>k__BackingField;    // 0x0x54
}
...
public class NEOBHIJNKOO
{
    public long <APALMFPAADI>k__BackingField;    // 0x0x10
    public string <HPKDFBPAPOG>k__BackingField;    // 0x0x18
    public string <PCMAFEOKFAG>k__BackingField;    // 0x0x20
    public DateTime <HLPBJFCBHFF>k__BackingField;    // 0x0x28
    public string <LAJMNIDFFNG>k__BackingField;    // 0x0x30
    public MPJCPFBNMNA <BPBNFENCHAI>k__BackingField;    // 0x0x38
    public int <PNBNNPLGIMD>k__BackingField;    // 0x0x3C
    public int <FAAJDPFJIAH>k__BackingField;    // 0x0x40
    public List<LIBGHOLDDBM> <BHJDBKCKLLK>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// NGACNKBFCFN
//   (not directly referenced by a detected call)
public class NGACNKBFCFN
{
    public long <ELCJHEEELKL>k__BackingField;    // 0x0x10
    public string <DKMKIHEAFGI>k__BackingField;    // 0x0x18
    public int <OKHPLAEAOOF>k__BackingField;    // 0x0x20
    public string <HPKDFBPAPOG>k__BackingField;    // 0x0x28
    public string <PCMAFEOKFAG>k__BackingField;    // 0x0x30
    public string <LAJMNIDFFNG>k__BackingField;    // 0x0x38
    public int <IANNJHJKOGN>k__BackingField;    // 0x0x40
    public bool <IBIHDPOJFFB>k__BackingField;    // 0x0x44
    public DateTime <GJIAPOAJMAF>k__BackingField;    // 0x0x48
    public DateTime <HLPBJFCBHFF>k__BackingField;    // 0x0x50
    public DateTime? <PECEHCGFBIK>k__BackingField;    // 0x0x58
    public long? <MBDOFEAMION>k__BackingField;    // 0x0x68
    public int <MAJAAINHJGC>k__BackingField;    // 0x0x78
    public int <HGNKGDJMLIB>k__BackingField;    // 0x0x7C
    public int <FMHKKKHJFFL>k__BackingField;    // 0x0x80
    public IPEDCNHGDJP <AENFMFNMPPL>k__BackingField;    // 0x0x84
    public IPEDCNHGDJP <GHCEBGEKPCI>k__BackingField;    // 0x0x88
    public bool <LHAIMGPCLJA>k__BackingField;    // 0x0x8C
    public bool <HHLOAJPDEMP>k__BackingField;    // 0x0x8D
    public bool <FANJBOOBFPO>k__BackingField;    // 0x0x8E
    public int? <APOPEPKCBKL>k__BackingField;    // 0x0x90
    public bool <AOAKGKBOHJC>k__BackingField;    // 0x0x98
}
...
public class NJJGBJEHEDF
{
    public List<string> <ENELFHHKLIB>k__BackingField;    // 0x0x10
    public List<string> <OOMCHDENFEO>k__BackingField;    // 0x0x18
    public List<string> <IEHAAMDLFOJ>k__BackingField;    // 0x0x20
}
...
public class ODJKKKAFHPD
{
    public Dictionary<int, int> <BOBAOLLHMKC>k__BackingField;    // 0x0x10
    public List<JNKDFGDOBOE> <AMBNMMKNBJM>k__BackingField;    // 0x0x18
    public MMJCOOBANGI[][] <KILIAJFBNMB>k__BackingField;    // 0x0x20
    public ADMJDAHHBFE <AICKMJMJGEC>k__BackingField;    // 0x0x28
    public BJDCNHBELAF <PEGDGKJBHNJ>k__BackingField;    // 0x0x30
    public PNAKKFIDPNE <PBFHAEMKGIM>k__BackingField;    // 0x0x38
    public FFNMIKOEDHM <LCPEDLNBEFF>k__BackingField;    // 0x0x40
    public string <POJBLJABEGO>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// OEIELGBFHGJ
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{pPJDICIPNFD}   [Service.API]
//   RESPONSE POST   api/playerevents/v2/{eventId}   [Service.API]
public class OEIELGBFHGJ
{
    public HJEDAHAALAL <MCEBMLAMGGK>k__BackingField;    // 0x0x10
    public BPAOIJJALPJ <POEKDGOOCPF>k__BackingField;    // 0x0x18
    public HLONAFBGPCC <KMGHNMPAJIN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OFCGPHMNJKH
//   (not directly referenced by a detected call)
public class OFCGPHMNJKH
{
    public long <JPFLFLMPFGD>k__BackingField;    // 0x0x10
    public Guid <DKMKIHEAFGI>k__BackingField;    // 0x0x18
    public long <KOMOMGBKLDJ>k__BackingField;    // 0x0x28
    public string <HPKDFBPAPOG>k__BackingField;    // 0x0x30
    public string <PCMAFEOKFAG>k__BackingField;    // 0x0x38
    public int <APOPEPKCBKL>k__BackingField;    // 0x0x40
    public Guid? <POPGGNNALMA>k__BackingField;    // 0x0x44
    public DateTime <HLPBJFCBHFF>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// OFCJPCMNIJC
//   (not directly referenced by a detected call)
public class OFCJPCMNIJC
{
    public int <DMKNNKBOFBC>k__BackingField;    // 0x0x10
    public string <PCGLOPJECPE>k__BackingField;    // 0x0x18
    public string <NGHGINLLLPD>k__BackingField;    // 0x0x20
    public string <KDGBFJJCALG>k__BackingField;    // 0x0x28
    public string <PMGDFMDCDFL>k__BackingField;    // 0x0x30
    public MGINEGMBCJB? <HNALKLAPPBM>k__BackingField;    // 0x0x38
    public string <FLBLBEBDMMC>k__BackingField;    // 0x0x40
    public string <BFKFGGNGMIA>k__BackingField;    // 0x0x48
    public bool <BALPDIHNIDC>k__BackingField;    // 0x0x50
    public bool <IACBANIJFIL>k__BackingField;    // 0x0x51
    public bool <HNKGCOLCNEF>k__BackingField;    // 0x0x52
    public JJJCECDBDBK <CPPBIMHBPCL>k__BackingField;    // 0x0x54
    public MPIBCNGCNDK <LNNKNPDMNPE>k__BackingField;    // 0x0x58
    public int <GKMJGHJKLMD>k__BackingField;    // 0x0x5C
    public AKIEEIOEINO <CGJBPFCHOMJ>k__BackingField;    // 0x0x60
    public KNEHFPIOIMA <MCEDFDKDKJM>k__BackingField;    // 0x0x64
    public int? <OOIANMBCDGE>k__BackingField;    // 0x0x68
    public string <IJDDBIOMNJC>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// OHFEKKMJCIB
//   (not directly referenced by a detected call)
public class OHFEKKMJCIB
{
    // (no instance fields in the metadata dump)
}
...
public class OIOHHNDNGGC
{
    public KPCAHHHIOHB <EPAEKJMFGHH>k__BackingField;    // 0x0x10
    public long <KAMBFJCLFIB>k__BackingField;    // 0x0x18
    public string <DDODFIKEAMO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OMBCGJEOBBL
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class OMBCGJEOBBL
{
    public int <BCOKFCDPGAO>k__BackingField;    // 0x0x10
    public int <HONJKBOGHCJ>k__BackingField;    // 0x0x14
    public float <AHDNFJDFINI>k__BackingField;    // 0x0x18
    public float <PBIGHHBGKOP>k__BackingField;    // 0x0x1C
    public bool <OACDOLLKBAP>k__BackingField;    // 0x0x20
    public bool <NEPFLKNHOGN>k__BackingField;    // 0x0x21
    public bool <IOKCEHIEIHB>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// OOBKBBBKLKN
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class OOBKBBBKLKN
{
    public int? <KHFNNANELOA>k__BackingField;    // 0x0x10
    public string <ALIMIHGLOHE>k__BackingField;    // 0x0x18
    public string <BIMBMDFJGCG>k__BackingField;    // 0x0x20
}
...
public class OPMJEOGCKGL
{
    public int <HONJKBOGHCJ>k__BackingField;    // 0x0x10
    public bool <OACDOLLKBAP>k__BackingField;    // 0x0x14
    public DateTime <AJNLKLBCJHH>k__BackingField;    // 0x0x18
    public bool <JOPAMHMPCMO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OPNKCNNJIAA
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class OPNKCNNJIAA
{
    public MPIBCNGCNDK <LNNKNPDMNPE>k__BackingField;    // 0x0x10
    public PGAAJMAGAHA <MFADFMFBGJO>k__BackingField;    // 0x0x14
    public int <FCLMEBMAKKK>k__BackingField;    // 0x0x18
    public int <BBGPOLOBGPJ>k__BackingField;    // 0x0x1C
    public int <PAMBCBDBIAB>k__BackingField;    // 0x0x20
    public HFMGJCNNJPO <CDDFGMOCIKG>k__BackingField;    // 0x0x24
    public bool <AFJDMPJDCEH>k__BackingField;    // 0x0x28
    public float <KNLENOPLJEB>k__BackingField;    // 0x0x2C
    public int <BFAMNOLBEPD>k__BackingField;    // 0x0x30
    public bool <BABJPHPHCLD>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// PBIJIAPLEMB
//   (not directly referenced by a detected call)
public class PBIJIAPLEMB
{
    public int <IKELNIFBDOI>k__BackingField;    // 0x0x10
    public DateTime <HLPBJFCBHFF>k__BackingField;    // 0x0x18
    public DateTime? <JDHFIELBHKH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PEDFONBMLCI
//   (not directly referenced by a detected call)
public class PEDFONBMLCI
{
    public int <PBEFDBKKMED>k__BackingField;    // 0x0x10
    public ADPPEHMMMOE <BFHMMAMMBBM>k__BackingField;    // 0x0x14
    public List<FLNOHJAABOP> <GDOKFHGOHGG>k__BackingField;    // 0x0x18
    public List<FLNOHJAABOP> <CACHPGEBCGE>k__BackingField;    // 0x0x20
    public bool <BNFJACGEMLO>k__BackingField;    // 0x0x28
    public DateTime? <OJAAOLJAJCN>k__BackingField;    // 0x0x30
}
...
public class PFNIFNDFCFB
{
    public int <JGOIHDOLMMA>k__BackingField;    // 0x0x10
    public ENLGFOLLIKH <BFHMMAMMBBM>k__BackingField;    // 0x0x14
    public PGHEHMDIAAM <EMBBFPEALEA>k__BackingField;    // 0x0x18
    public PGHEHMDIAAM <HDDKDLNCCBI>k__BackingField;    // 0x0x1C
    public PGHEHMDIAAM <DBNMKMHMDKP>k__BackingField;    // 0x0x20
}
...
// PIFCPDFPEMC
//   (not directly referenced by a detected call)
public class PIFCPDFPEMC
{
    public long <ELCJHEEELKL>k__BackingField;    // 0x0x10
    public string <DKMKIHEAFGI>k__BackingField;    // 0x0x18
    public int <MLMCGDJJBBI>k__BackingField;    // 0x0x20
    public int <HLMMNLEJHNG>k__BackingField;    // 0x0x24
    public int <HMFFGDGGBCF>k__BackingField;    // 0x0x28
    public int <BDJIODKBBLK>k__BackingField;    // 0x0x2C
    public int <KECPNLNALEO>k__BackingField;    // 0x0x30
    public string <HMGOKNPHDCI>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// PIPAMKFJJHF
//   (not directly referenced by a detected call)
public class PIPAMKFJJHF
{
    public long <JCMHFANLDIG>k__BackingField;    // 0x0x10
    public long <KAMBFJCLFIB>k__BackingField;    // 0x0x18
    public int <GCOKOLJJEJD>k__BackingField;    // 0x0x20
    public DateTime <HLPBJFCBHFF>k__BackingField;    // 0x0x28
    public ELGBGFGAJED <BFHMMAMMBBM>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// PJIJAAPMMBE
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class PJIJAAPMMBE
{
    public int <LAGCEANMPBE>k__BackingField;    // 0x0x10
    public string <CGPMLHDHBGF>k__BackingField;    // 0x0x18
    public string <EHDJEPEMEDI>k__BackingField;    // 0x0x20
    public string <GDHHJFNOEKL>k__BackingField;    // 0x0x28
    public string <FIHPJKLEJDN>k__BackingField;    // 0x0x30
    public string <LOOMEAAKKMA>k__BackingField;    // 0x0x38
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{nMFJCBFIJCB}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{nMFJCBFIJCB}   [Service.API]
...
public class PJINHNIJCGL
{
    public JKHILHKCMDI BCLNBPAGCNP;    // 0x0x10
    public GFMHNGNBLKC EPLCDMMPOPN;    // 0x0x18
}

// --------------------------------------------------------------------------
// PNAKKFIDPNE
//   (not directly referenced by a detected call)
public class PNAKKFIDPNE
{
    public int <DKIDAKPAPCJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PNJNNAIBOGM
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class PNJNNAIBOGM
{
    public int <HHLLMDDKLND>k__BackingField;    // 0x0x10
    public string <EGHJLPABMKI>k__BackingField;    // 0x0x18
    public List<CNACOFAAOFN> <MIIKGJHCDHK>k__BackingField;    // 0x0x20
    public NDHBENMANGF <EMPCGLMOOAC>k__BackingField;    // 0x0x28
    public string <OHIGDKLAOOG>k__BackingField;    // 0x0x30
    public DateTime <KHAHCEOHIGG>k__BackingField;    // 0x0x38
    public DateTime <IPDEKAJFGEL>k__BackingField;    // 0x0x40
    public DateTime <IBMDBEHGNDJ>k__BackingField;    // 0x0x48
    public bool? <FEGHIDMFAMD>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// POJDGHLAFGM
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class POJDGHLAFGM
{
    public List<DKIEJFCCLLC> <BICPHPNCNHA>k__BackingField;    // 0x0x10
    public BPAOIJJALPJ <POEKDGOOCPF>k__BackingField;    // 0x0x18
}
...
public class FreeGiftRequestDTO
{
    ...
    public KNEHFPIOIMA <GiftContext>k__BackingField;    // 0x0x20
}
...
public class GetRankRequestDTO
{
    ...
    public DKJIIPNHEMJ FilterType;    // 0x0x20
    public OFFOMJBBDBP Timeframe;    // 0x0x24
...
public class NewInventionRequestDTO
{
    ...
    public PBOOKCPKHBA creatorAccountRole;    // 0x0x58
}
...
public class ReportRequest
{
    ...
    public JEILIGEHGFG ReportCategory;    // 0x0x20
}
...
{
    public FEMNKPGMFFF? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public FEMNKPGMFFF OALMJJOIIOJ;  // wrapper
...
{
    public CHAGBBHDBKM NHCELCPLOKJ;  // wrapper
...
{
    public MICNCAKOLIC ENGLKMHLBKG;  // wrapper
    public int? OPHMKKOPPON;  // wrapper
...
{
    public KPCAHHHIOHB EMFBMEBAOOK;  // wrapper
    public NBOCKFOHDOH MCNIGODLGGL;  // wrapper
...
{
    public PKFKCKDNDBN FMMADHCDGHL;  // wrapper
    public NBOCKFOHDOH MCNIGODLGGL;  // wrapper
...
{
    public KNEHFPIOIMA AJHMKALBGLM;  // wrapper
    public KNEHFPIOIMA? COHIAJEAMBL;  // wrapper
...
{
    public CNACOFAAOFN FJDLBAEHGCJ;  // wrapper
...
{
    public PIBOMIMGGJP EAHCDAACPCN;  // wrapper
    public KPCAHHHIOHB EMFBMEBAOOK;  // wrapper
...
{
    public IReadOnlyList<HDBJBNLHJME> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public IFOEKBHPLON ECBKIDHNDCP;  // wrapper
    public KNEHFPIOIMA? LDHOGMFKJLJ;  // wrapper
...
{
    public JPAMCAGBIBP DAAGDKBMNPN;  // wrapper
...
{
    public StatusResponse> MCNIGODLGGL;  // wrapper
...
{
    public COCEIMENFPE PPCFGHFFPDN;  // wrapper
    public object platformId;  // candidate
...
{
    public List<long> NJMGMHOHIJN;  // wrapper
    public NBOCKFOHDOH MCNIGODLGGL;  // wrapper
    public FKPHCFEOOIE HNKDCMAEJEF;  // wrapper
    public long? EPGIIICGILH;  // wrapper
...
{
    public String> MCNIGODLGGL;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{pPJDICIPNFD}  [API POST]
public class PlayereventsV2DeletePPJDICIPNFDRequest
{
    public HJEDAHAALAL PPJDICIPNFD;  // wrapper
}

// api/players/v2/objectives  [API POST]
public class PlayersV2ObjectivesRequest
{
    public List<ELBEMNGLKMO> GBNAJIEIGPC;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> IBHDHOPBHBP;  // wrapper
...
{
    public Guid? EIFGHCCAPDA;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats MPGAINLCCFL;  // wrapper
}
...
{
    public Guid BCAHADLLGCF;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<EGAEFCIKDMC> GBNAJIEIGPC;  // wrapper
    public object objectiveType;  // candidate
...
{
    public KNNJNGJDEAG FLEJKBDLMLG;  // wrapper
}
