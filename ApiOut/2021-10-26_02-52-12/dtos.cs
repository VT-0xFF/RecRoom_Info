...
public class AABLJCHLLNF
{
    public GABLNNFDIAA <ALLPFAGIOKN>k__BackingField;    // 0x0x10
    public JFJJMNLOLMI <OAOLHNODEKF>k__BackingField;    // 0x0x18
}
...
public class AEMALEKADOP
{
    public List<int> <ENNHBPNFABH>k__BackingField;    // 0x0x10
    public string <IJHEBFLEMIH>k__BackingField;    // 0x0x18
}
...
// AKDGJIJEBBH
//   (not directly referenced by a detected call)
public class AKDGJIJEBBH
{
    public long <JIECFNNAHJE>k__BackingField;    // 0x0x10
    public int <PABMHDNNKEH>k__BackingField;    // 0x0x18
    public long <ALBGNMEGBFI>k__BackingField;    // 0x0x20
    public long? <EPNKGFIGEDO>k__BackingField;    // 0x0x28
    public long? <OCGGDMNOHKO>k__BackingField;    // 0x0x38
    public string <JHCJACDOMPA>k__BackingField;    // 0x0x48
    public string <MJHIIEMLDOI>k__BackingField;    // 0x0x50
    public string <INEFLDCPEFM>k__BackingField;    // 0x0x58
    public DateTime <GIHINKDCFDC>k__BackingField;    // 0x0x60
    public DateTime <LPEPEFEJCMN>k__BackingField;    // 0x0x68
    public int <NKOOPPJFPHN>k__BackingField;    // 0x0x70
    public LMGHKHKKEEN <NJBBIMABIDH>k__BackingField;    // 0x0x74
    public bool <APIAKNCLIPH>k__BackingField;    // 0x0x78
    public bool <MBMDJBIBDFL>k__BackingField;    // 0x0x79
    public long? <KMEAKCAKFNM>k__BackingField;    // 0x0x80
}
...
public class ANPDIKBPGNB
{
    public MBGOPEBONBN <ALLPFAGIOKN>k__BackingField;    // 0x0x10
    public FLFFLOPJLLG <MCDMALMIIFE>k__BackingField;    // 0x0x18
    public GODBMFLGECJ <BILHMNHKFNF>k__BackingField;    // 0x0x20
}
...
public class BOKJBJJAGKH
{
    public List<string> <JLAKMDLGMIJ>k__BackingField;    // 0x0x10
    public List<string> <GNECAJNFECH>k__BackingField;    // 0x0x18
    public List<string> <BJGDKHKNEIN>k__BackingField;    // 0x0x20
}
...
public class CACMHOMMOOB
{
    public long <JIECFNNAHJE>k__BackingField;    // 0x0x10
    public NKOHKHMPPBM <FLKOEPLBPDG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CDCKJLNCFDK
//   (not directly referenced by a detected call)
public class CDCKJLNCFDK
{
    public MGKGBJDIFHH <CKGMGIGHPDO>k__BackingField;    // 0x0x10
    public int <KNJBFJOAFPB>k__BackingField;    // 0x0x14
    public FMCFHDPCAJM <DINJNFOGPEO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CDKJKGDNNBH
//   (not directly referenced by a detected call)
public class CDKJKGDNNBH
{
    public DateTime KLAGAIHPLCD;    // 0x0x10
    public string LHBJCJPLBIP;    // 0x0x18
}

// --------------------------------------------------------------------------
// CELDIFNBGDO
//   (not directly referenced by a detected call)
public class CELDIFNBGDO
{
    public int <JAJFFHGEFNJ>k__BackingField;    // 0x0x10
    public MNPBAMHLGFK <FLKOEPLBPDG>k__BackingField;    // 0x0x14
    public List<CDCKJLNCFDK> <COMABKEIOOI>k__BackingField;    // 0x0x18
    public List<CDCKJLNCFDK> <NBLAILANBEA>k__BackingField;    // 0x0x20
    public bool <ILJEGNPMKLG>k__BackingField;    // 0x0x28
    public DateTime? <OODKMOCMOJC>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// CFAMNHNLLGE
//   (not directly referenced by a detected call)
public class CFAMNHNLLGE
{
    public string <CALCHOMHGBG>k__BackingField;    // 0x0x10
    public AONECHLMINF <FLKOEPLBPDG>k__BackingField;    // 0x0x18
}
...
public class CHGKNAKCIJC
{
    public PJDNGGMMGAJ EKMMLPMGMKC;    // 0x0x10
    public KGLJMAEGMAE OHMOGHKMMFE;    // 0x0x18
}

// --------------------------------------------------------------------------
// CHMHMEJDBCD
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class CHMHMEJDBCD
{
    public int <AMOFJDAOADI>k__BackingField;    // 0x0x10
    public string <APHJBNAIKGF>k__BackingField;    // 0x0x18
    public List<PGAHNNFPLDL> <HFOFKNJLENC>k__BackingField;    // 0x0x20
    public CPLEODOKHGL <NBHMGNLMHBD>k__BackingField;    // 0x0x28
    public string <KKELFOPGFLN>k__BackingField;    // 0x0x30
    public DateTime <FLBKHAOLMNH>k__BackingField;    // 0x0x38
    public DateTime <KHGFKKMFLNA>k__BackingField;    // 0x0x40
    public DateTime <DEGFBMDKOAC>k__BackingField;    // 0x0x48
    public bool? <NIGJOJKNGBM>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// CPLEODOKHGL
//   (not directly referenced by a detected call)
public class CPLEODOKHGL
{
    public long <PABCJPFMCEN>k__BackingField;    // 0x0x10
    public string <MPHOBGEHJDF>k__BackingField;    // 0x0x18
    public string <OBLMDFCCIIC>k__BackingField;    // 0x0x20
    public BAEEOOGOGGN? <JJAGJLKAMKJ>k__BackingField;    // 0x0x28
    public string <BOKLPCBFMMM>k__BackingField;    // 0x0x30
    public string <EPACEKDFDEI>k__BackingField;    // 0x0x38
    public AIKEHDGLKAE <KDEOLPGPIAO>k__BackingField;    // 0x0x40
    public int <ICDOFBFHGPA>k__BackingField;    // 0x0x44
    public int <AABPIFCDCEP>k__BackingField;    // 0x0x48
    public EKFCOGEAOPC? <OKELIFIDAGB>k__BackingField;    // 0x0x4C
    public KIPHNFIIMKM? <GDDGFEOCFBJ>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// DAGFCJONEIB
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class DAGFCJONEIB
{
    public BJBJANOOCOE <KPFJBAPHBLH>k__BackingField;    // 0x0x10
    public long <JIECFNNAHJE>k__BackingField;    // 0x0x18
    public string <CCPDIACFFPG>k__BackingField;    // 0x0x20
}
...
public class DAMCEKANCEC
{
    public List<AKDGJIJEBBH> <BEKMNBFIAAB>k__BackingField;    // 0x0x10
    public List<JPBHADLKHDA> <CLGNNJOJNPJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DAPPMHOCHDB
//   (not directly referenced by a detected call)
public class DAPPMHOCHDB
{
    public float <MAMHKGHIPDE>k__BackingField;    // 0x0x10
    public float <BMLGBNGOHFK>k__BackingField;    // 0x0x14
    public float <HCMEJDJMOIO>k__BackingField;    // 0x0x18
    public float <ICMBJPPDMHG>k__BackingField;    // 0x0x1C
    public float <PHELMEAKGAL>k__BackingField;    // 0x0x20
    public float <KEFBMMFJFPK>k__BackingField;    // 0x0x24
    public float <DAGIDOHNPNP>k__BackingField;    // 0x0x28
    public float <PDNOJHDHNKE>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// DBDHIILBANL
//   (not directly referenced by a detected call)
public class DBDHIILBANL
{
    public int <HPNCJBMNLPP>k__BackingField;    // 0x0x10
}
...
public class DIBCCPGCEHP
{
    public int <FLKHDGCGDEA>k__BackingField;    // 0x0x10
    public FDODADHBLMD <FLKOEPLBPDG>k__BackingField;    // 0x0x14
    public MBCJGCEPNMN <BFDKEDNNPBH>k__BackingField;    // 0x0x18
    public MBCJGCEPNMN <FCOJCLENAOJ>k__BackingField;    // 0x0x1C
    public MBCJGCEPNMN <KAMINKIJLHM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EAOIBMKKDPK
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class EAOIBMKKDPK
{
    public BJBJANOOCOE <KPFJBAPHBLH>k__BackingField;    // 0x0x10
    public int <HIICKPEGKPO>k__BackingField;    // 0x0x14
    public long <DMBNBAICILE>k__BackingField;    // 0x0x18
    public bool <BJGLBDCCNGA>k__BackingField;    // 0x0x20
    public string <CBKCIOAINNI>k__BackingField;    // 0x0x28
    public int? <CNAEAJNMBBP>k__BackingField;    // 0x0x30
    public bool <JFCIOKNAAPP>k__BackingField;    // 0x0x38
    public string <FAFANAJBMOK>k__BackingField;    // 0x0x40
    public float <EPBFAIPKCFJ>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// EAPKKONFKPL
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class EAPKKONFKPL
{
    public JELPHNDMHJM <CNDFDLEHIOI>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <IOJDBDGIJAD>k__BackingField;    // 0x0x18
}
...
// FAHNICBLEEK
//   (not directly referenced by a detected call)
public class FAHNICBLEEK
{
    public bool <GOLGHJIOJEJ>k__BackingField;    // 0x0x10
    public JEOBPPDLDMG <OKFEONFJDFI>k__BackingField;    // 0x0x18
    public float <IDBGDEMCPKF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FAJKGNPKEBM
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class FAJKGNPKEBM
{
    public int <FGAJELAAGCL>k__BackingField;    // 0x0x10
    public Guid <FJNBOKAONMA>k__BackingField;    // 0x0x14
    public long <EHHNFOOOHII>k__BackingField;    // 0x0x28
    public long <HGMDIILIGOB>k__BackingField;    // 0x0x30
    public DateTime <JJEHJLCABGM>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// FDFCLKOJKID
//   (not directly referenced by a detected call)
public class FDFCLKOJKID
{
    public long <MLICOOOHFBG>k__BackingField;    // 0x0x10
    public long <JIECFNNAHJE>k__BackingField;    // 0x0x18
    public int <AMBMPPHMKFL>k__BackingField;    // 0x0x20
    public DateTime <KBGFHKOCEIO>k__BackingField;    // 0x0x28
    public NKOHKHMPPBM <FLKOEPLBPDG>k__BackingField;    // 0x0x30
}
...
public class FGHJEHODFDA : PJPHONOEOJN
{
    public OEENPBEGPAJ? <DMEAMFAKDGF>k__BackingField;    // 0x0x18
    public JELPHNDMHJM <CNDFDLEHIOI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FLAPLJHFJBO
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class FLAPLJHFJBO
{
    public string <JLFPJLFONIP>k__BackingField;    // 0x0x10
    public string <MHDCLHPDBJD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FLFFLOPJLLG
//   (not directly referenced by a detected call)
public class FLFFLOPJLLG
{
    public long <LKDCFFDIPBK>k__BackingField;    // 0x0x10
    public string <FHBLCNIAFHK>k__BackingField;    // 0x0x18
    public int <PABMHDNNKEH>k__BackingField;    // 0x0x20
    public string <JHCJACDOMPA>k__BackingField;    // 0x0x28
    public string <MJHIIEMLDOI>k__BackingField;    // 0x0x30
    public string <INEFLDCPEFM>k__BackingField;    // 0x0x38
    public int <BIICCDKNDKH>k__BackingField;    // 0x0x40
    public bool <AFDGHAALNMC>k__BackingField;    // 0x0x44
    public DateTime <GPCMLHBONPJ>k__BackingField;    // 0x0x48
    public DateTime <KBGFHKOCEIO>k__BackingField;    // 0x0x50
    public DateTime? <LMMFKMOLPIP>k__BackingField;    // 0x0x58
    public long? <CCPDDJEKODG>k__BackingField;    // 0x0x68
    public int <JHHFKFMDOAL>k__BackingField;    // 0x0x78
    public int <ONNFBHEPNEB>k__BackingField;    // 0x0x7C
    public int <DDIJLPHFCMK>k__BackingField;    // 0x0x80
    public FODKJMOIIPP <HCCILLBCMKO>k__BackingField;    // 0x0x84
    public FODKJMOIIPP <MCOOPHPOLND>k__BackingField;    // 0x0x88
    public bool <OJDJEBILIDE>k__BackingField;    // 0x0x8C
    public bool <AFJLNMNMHAI>k__BackingField;    // 0x0x8D
    public bool <HPCEMGECJLF>k__BackingField;    // 0x0x8E
    public int? <KNJBFJOAFPB>k__BackingField;    // 0x0x90
    public bool <MJHBOFCHNOC>k__BackingField;    // 0x0x98
}
...
public class FLHKLECCKAJ
{
    public long <BDECPBJHMHA>k__BackingField;    // 0x0x10
    public string <JHCJACDOMPA>k__BackingField;    // 0x0x18
    public string <MJHIIEMLDOI>k__BackingField;    // 0x0x20
    public DateTime <KBGFHKOCEIO>k__BackingField;    // 0x0x28
    public string <INEFLDCPEFM>k__BackingField;    // 0x0x30
    public JILJOIHICAM <KIBINOGBAIO>k__BackingField;    // 0x0x38
    public int <CMCEKLFACEJ>k__BackingField;    // 0x0x3C
    public int <NDKNDNAHGLE>k__BackingField;    // 0x0x40
    public List<LANCAPMDKBD> <KDEDEKJHKAO>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// FMCFHDPCAJM
//   (not directly referenced by a detected call)
public class FMCFHDPCAJM
{
    public int <KDAPONFHJLA>k__BackingField;    // 0x0x10
    public DateTime? <EDMCEOJDMBP>k__BackingField;    // 0x0x18
    public DateTime? <HHAELECIGBD>k__BackingField;    // 0x0x28
}
...
// GABLNNFDIAA
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{kLJPPDAPEMM}   [Service.API]
public enum GABLNNFDIAA
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
// GKELDFDDPGH
//   (not directly referenced by a detected call)
public class GKELDFDDPGH
{
    public Guid <CFNOEAGKEGJ>k__BackingField;    // 0x0x10
    public long <ALBGNMEGBFI>k__BackingField;    // 0x0x20
    public string <JHCJACDOMPA>k__BackingField;    // 0x0x28
    public string <MJHIIEMLDOI>k__BackingField;    // 0x0x30
    public string <INEFLDCPEFM>k__BackingField;    // 0x0x38
    public long <KNJBFJOAFPB>k__BackingField;    // 0x0x40
    public Guid? <HPLJJDCDCAO>k__BackingField;    // 0x0x48
    public DateTime <GPCMLHBONPJ>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// GODBMFLGECJ
//   (not directly referenced by a detected call)
public class GODBMFLGECJ
{
    public long <LKDCFFDIPBK>k__BackingField;    // 0x0x10
    public string <FHBLCNIAFHK>k__BackingField;    // 0x0x18
    public int <NNMMGMKFNOM>k__BackingField;    // 0x0x20
    public int <KPJFMECAENI>k__BackingField;    // 0x0x24
    public int <OCDKOCDKMOB>k__BackingField;    // 0x0x28
    public int <HBCPKKDNADF>k__BackingField;    // 0x0x2C
    public int <EDCNDFDCGFJ>k__BackingField;    // 0x0x30
    public string <CFDBKKHPIFH>k__BackingField;    // 0x0x38
}
...
// base   : CELDIFNBGDO
//   (not directly referenced by a detected call)
public class HAFBLJJFNGL : CELDIFNBGDO
{
    public int <MAKIMFFBDGP>k__BackingField;    // 0x0x40
    public List<FAHNICBLEEK> <POABFHLIMKE>k__BackingField;    // 0x0x48
    public List<FAHNICBLEEK> <ADGAMPOKNOO>k__BackingField;    // 0x0x50
    public List<FAHNICBLEEK> <MGLPMMCIEGK>k__BackingField;    // 0x0x58
}
...
public class HLCECAJNNJF : FCNFGCLNKPL
{
    public List<JCMKGLFPJND> CGJMCPHMGHB;    // 0x0x30
    public int <EDMJHNPHBNP>k__BackingField;    // 0x0x38
}
...
public class IBDAAFPCPMM
{
    public bool <NOIFGMDEGJF>k__BackingField;    // 0x0x10
    public string <FBFIAAKPAPI>k__BackingField;    // 0x0x18
}
...
public class IBOKNKDBNIA
{
    public Dictionary<int, int> <FHMOCEFFHOP>k__BackingField;    // 0x0x10
    public List<JONHIEINJPO> <HPENBEDPHEL>k__BackingField;    // 0x0x18
    public NBHJEEELOCM[][] <HBJKHKHLEEJ>k__BackingField;    // 0x0x20
    public IOEHJLDKDCP <NDGFMIMLONN>k__BackingField;    // 0x0x28
    public DAPPMHOCHDB <CILAHDLCJKH>k__BackingField;    // 0x0x30
    public DBDHIILBANL <OCLJLJKEMDC>k__BackingField;    // 0x0x38
    public OJEPFLEKFCO <JFBLADBEDDM>k__BackingField;    // 0x0x40
    public string <OJJGNCBENBF>k__BackingField;    // 0x0x48
}
...
public class IEIBNOHCMMM
{
    public int <BIPCCPMIKMC>k__BackingField;    // 0x0x10
    public bool <JJLLOOGEGFP>k__BackingField;    // 0x0x14
    public DateTime <IHKDLBIJKKJ>k__BackingField;    // 0x0x18
    public bool <DKMNGEHLOFG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IFFGGECGLIE
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{fBOMNGFIADN}   [Service.API]
public class IFFGGECGLIE
{
    public Guid <DAAKMGMCBLC>k__BackingField;    // 0x0x10
    public int <FGAJELAAGCL>k__BackingField;    // 0x0x20
    public int <JAJFFHGEFNJ>k__BackingField;    // 0x0x24
    public DateTime <KBGFHKOCEIO>k__BackingField;    // 0x0x28
}
...
// IOEHJLDKDCP
//   (not directly referenced by a detected call)
public class IOEHJLDKDCP
{
    public int <GMDFDDILKLM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IPJNOAFHEIG
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class IPJNOAFHEIG
{
    public int <DPFDHHGPAPH>k__BackingField;    // 0x0x10
    public string <MMGDOHEBCKF>k__BackingField;    // 0x0x18
    public string <DIDBPMNLGDM>k__BackingField;    // 0x0x20
    public string <IACMJINEPIG>k__BackingField;    // 0x0x28
    public string <BGLJMIILAOK>k__BackingField;    // 0x0x30
    public string <BFNGJAICJBP>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// JAALJDCIMBB
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class JAALJDCIMBB
{
    public MGKGBJDIFHH <CKGMGIGHPDO>k__BackingField;    // 0x0x10
    public KBJKAIHKHDI <MEKPBLKGNPC>k__BackingField;    // 0x0x14
    public int <OEFCCJNFMIB>k__BackingField;    // 0x0x18
    public int <GIMNCLJKEDM>k__BackingField;    // 0x0x1C
    public int <PONNOGPHNMJ>k__BackingField;    // 0x0x20
    public CFJLMJCCGJG <MJOCCMIMPPP>k__BackingField;    // 0x0x24
    public bool <EAJIOIEFKDO>k__BackingField;    // 0x0x28
    public float <MPIDKFGLKLJ>k__BackingField;    // 0x0x2C
    public int <FJEDNCKDJGO>k__BackingField;    // 0x0x30
    public bool <CKGBKKDNGMO>k__BackingField;    // 0x0x34
}
...
public class JBCKLKBCJDN : FCNFGCLNKPL
{
    public int <APBAMJEHHPL>k__BackingField;    // 0x0x30
    public string <JHCJACDOMPA>k__BackingField;    // 0x0x38
    public DateTime <FLBKHAOLMNH>k__BackingField;    // 0x0x40
    public DateTime <KHGFKKMFLNA>k__BackingField;    // 0x0x48
    public MGKGBJDIFHH <CKGMGIGHPDO>k__BackingField;    // 0x0x50
    public CELDIFNBGDO <NNGEJKAADHA>k__BackingField;    // 0x0x58
    public List<HAFBLJJFNGL> <BNNJJBFOJCP>k__BackingField;    // 0x0x60
    public KHHLBLFGAFO <ANLJOHDGGEE>k__BackingField;    // 0x0x68
}
...
// base   : CELDIFNBGDO
//   (not directly referenced by a detected call)
public class JCMKGLFPJND : CELDIFNBGDO
{
    public JEOBPPDLDMG <OKFEONFJDFI>k__BackingField;    // 0x0x40
}
...
public class JELPHNDMHJM
{
    public int <FGAJELAAGCL>k__BackingField;    // 0x0x10
    public Guid <FJNBOKAONMA>k__BackingField;    // 0x0x14
    public long <EHHNFOOOHII>k__BackingField;    // 0x0x28
    public DateTime <GPCMLHBONPJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// JEOBPPDLDMG
//   (not directly referenced by a detected call)
public class JEOBPPDLDMG
{
    public int <PABCJPFMCEN>k__BackingField;    // 0x0x10
    public string <OAILLJJBLAM>k__BackingField;    // 0x0x18
    public string <CCLDLKAEPAE>k__BackingField;    // 0x0x20
    public string <MPHOBGEHJDF>k__BackingField;    // 0x0x28
    public string <FIFMBKKNGPO>k__BackingField;    // 0x0x30
    public BAEEOOGOGGN? <JJAGJLKAMKJ>k__BackingField;    // 0x0x38
    public string <BOKLPCBFMMM>k__BackingField;    // 0x0x40
    public string <EPACEKDFDEI>k__BackingField;    // 0x0x48
    public bool <ABKCMKCPAAO>k__BackingField;    // 0x0x50
    public bool <CLGEFLPCFMM>k__BackingField;    // 0x0x51
    public bool <LHKNPKEMNLG>k__BackingField;    // 0x0x52
    public KIPHNFIIMKM <FEPHPIFOOLB>k__BackingField;    // 0x0x54
    public MGKGBJDIFHH <CKGMGIGHPDO>k__BackingField;    // 0x0x58
    public int <GCNKDHEMHHI>k__BackingField;    // 0x0x5C
    public JIGHAJHOBOI <FIPCFBKMNIL>k__BackingField;    // 0x0x60
    public EKFCOGEAOPC <DBFJKDALOHJ>k__BackingField;    // 0x0x64
    public int? <HEMCLPOBEGG>k__BackingField;    // 0x0x68
    public string <OMAODGCFHID>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// JFJJMNLOLMI
//   (not directly referenced by a detected call)
public class JFJJMNLOLMI
{
    public long <KNCBDONHOEN>k__BackingField;    // 0x0x10
    public Guid <FHBLCNIAFHK>k__BackingField;    // 0x0x18
    public long <ALBGNMEGBFI>k__BackingField;    // 0x0x28
    public string <JHCJACDOMPA>k__BackingField;    // 0x0x30
    public string <MJHIIEMLDOI>k__BackingField;    // 0x0x38
    public int <KNJBFJOAFPB>k__BackingField;    // 0x0x40
    public Guid? <HPLJJDCDCAO>k__BackingField;    // 0x0x44
    public DateTime <KBGFHKOCEIO>k__BackingField;    // 0x0x58
}
...
public class JFLMCNLBCOG
{
    public bool <NOIFGMDEGJF>k__BackingField;    // 0x0x10
    public string <CBKCIOAINNI>k__BackingField;    // 0x0x18
}
...
public class JHGBHBBDIML
{
    public string <DIDBPMNLGDM>k__BackingField;    // 0x0x10
    public string <IACMJINEPIG>k__BackingField;    // 0x0x18
    public string <BGLJMIILAOK>k__BackingField;    // 0x0x20
    public string <BFNGJAICJBP>k__BackingField;    // 0x0x28
}
...
public class JHPEHMMEMAB
{
    public string <EHNANMHAMME>k__BackingField;    // 0x0x10
}
...
// --------------------------------------------------------------------------
// JKCLDPAJKPP
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{hNDJNNFIENP}   [Service.API]
public class JKCLDPAJKPP
{
    public string KIHFBOAFKJN;    // 0x0x10
    public string KABLCJJGPDO;    // 0x0x18
    public string BODENMOHHGD;    // 0x0x20
    public string EOIKIMJPKDD;    // 0x0x28
    public string LHLLLFJGDCI;    // 0x0x30
    public HDIFLEFFLGE EKMMLPMGMKC;    // 0x0x38
    public List<string> EOLHCPDKCEN;    // 0x0x40
    public List<string> CEDNLABLEKN;    // 0x0x48
    public string NHDMBGLJGLB;    // 0x0x50
    public List<CDKJKGDNNBH> GKFAMMJPOEH;    // 0x0x58
}

// --------------------------------------------------------------------------
// JMBCPDGHMCH
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{hNDJNNFIENP}   [Service.API]
public class JMBCPDGHMCH
{
    public uint KIHFBOAFKJN;    // 0x0x10
    public string DGNFNNLAFAF;    // 0x0x18
    public string EOIKIMJPKDD;    // 0x0x20
    public DateTime NNGHDCPNFBA;    // 0x0x28
    public DateTime? CFPIOCOCEEP;    // 0x0x30
    public bool IOCKAEEINPB;    // 0x0x40
    public List<JKCLDPAJKPP> HCJJNNGBIJA;    // 0x0x48
    public List<string> CEDNLABLEKN;    // 0x0x50
    public int ICAKJNODDBC;    // 0x0x58
    public int GLPCAAADAJB;    // 0x0x5C
    public int JKKBPEDEOHJ;    // 0x0x60
}

// --------------------------------------------------------------------------
// JMHEILDMAAL
//   (not directly referenced by a detected call)
public class JMHEILDMAAL
{
    public int <CJFGAICLFOO>k__BackingField;    // 0x0x10
    public int <MNENFGGCHMF>k__BackingField;    // 0x0x14
    public int <KPPMPNJJNBK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JPBHADLKHDA
//   (not directly referenced by a detected call)
public class JPBHADLKHDA
{
    public AKDGJIJEBBH <LOIOIFGLBJC>k__BackingField;    // 0x0x10
    public FDFCLKOJKID <JHKMICGEAEE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JPGJMIPDMFB
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class JPGJMIPDMFB
{
    public int <HGCKJEDPIIG>k__BackingField;    // 0x0x10
    public int <BIPCCPMIKMC>k__BackingField;    // 0x0x14
    public float <KDFPCOPHHJD>k__BackingField;    // 0x0x18
    public float <FHHLDMEGGGG>k__BackingField;    // 0x0x1C
    public bool <JJLLOOGEGFP>k__BackingField;    // 0x0x20
    public bool <BDPHEGBOMEH>k__BackingField;    // 0x0x21
    public bool <PEIPBEMAKGD>k__BackingField;    // 0x0x22
}
...
public class KDMPKAJIPMO
{
    public List<CFAMNHNLLGE> <LACAJFIDPKP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KGBGMLMCDKJ
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class KGBGMLMCDKJ
{
    public List<OHIFKLDGKIA> <JAAPGIFINAA>k__BackingField;    // 0x0x10
    public PGPFCKMDJMF <NPHLDBMGPJG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KGLJMAEGMAE
//   (not directly referenced by a detected call)
public class KGLJMAEGMAE
{
    public Guid <CFNOEAGKEGJ>k__BackingField;    // 0x0x10
    public int <FGAJELAAGCL>k__BackingField;    // 0x0x20
    public int <HHGCFJBKEMM>k__BackingField;    // 0x0x24
    public Guid <KKNMENBLKLH>k__BackingField;    // 0x0x28
    public DateTime <GPCMLHBONPJ>k__BackingField;    // 0x0x38
    public GKELDFDDPGH <ILHELELCLJI>k__BackingField;    // 0x0x40
}
...
// KHHLBLFGAFO
//   (not directly referenced by a detected call)
public class KHHLBLFGAFO
{
    public bool <DAICKJKOJDD>k__BackingField;    // 0x0x10
    public KAJFOPCMMOA <AMPGEKJHPLE>k__BackingField;    // 0x0x14
    public int <DFMBBIONPKA>k__BackingField;    // 0x0x18
    public DateTime <GPCMLHBONPJ>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{aDIDCKGALFK}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{aDIDCKGALFK}   [Service.API]
...
public class KJEKLIDHHOF
{
    public PJDNGGMMGAJ EKMMLPMGMKC;    // 0x0x10
    public GKELDFDDPGH LHEMCOKHJDL;    // 0x0x18
}
...
public class KOLOFNFIKPK
{
    public Guid <GFJGBBAJGGP>k__BackingField;    // 0x0x10
    public Guid <FJNBOKAONMA>k__BackingField;    // 0x0x20
    public int <MPKHPNAIGNP>k__BackingField;    // 0x0x30
    public string <JHCJACDOMPA>k__BackingField;    // 0x0x38
    public long <HFFMDJCCFMD>k__BackingField;    // 0x0x40
    public long <KNJBFJOAFPB>k__BackingField;    // 0x0x48
    public DateTime <GPCMLHBONPJ>k__BackingField;    // 0x0x50
}
...
public class LADKBKOCFDG
{
    public Guid <FJNBOKAONMA>k__BackingField;    // 0x0x10
    public long? <ALBGNMEGBFI>k__BackingField;    // 0x0x20
    public string <JHCJACDOMPA>k__BackingField;    // 0x0x30
    public string <MJHIIEMLDOI>k__BackingField;    // 0x0x38
    public MGKGBJDIFHH <CKGMGIGHPDO>k__BackingField;    // 0x0x40
    public long <KOBPJIIKEEM>k__BackingField;    // 0x0x48
    public DateTime <KBGFHKOCEIO>k__BackingField;    // 0x0x50
    public DateTime <GPCMLHBONPJ>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// LANCAPMDKBD
//   RESPONSE GET    api/groups/v1/memberships/{kNIGAJNHBLC}   [Service.API]
public class LANCAPMDKBD
{
    public long <BDECPBJHMHA>k__BackingField;    // 0x0x10
    public int <AMBMPPHMKFL>k__BackingField;    // 0x0x18
    public LACFCODEKLM <DPGOKGIOLON>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// LDCADHAKAPN
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class LDCADHAKAPN
{
    public int <HIICKPEGKPO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LENKCHABEHD
//   RESPONSE GET    api/inventions/v1/personaldetails/{aFEKIMEODGM}   [Service.API]
public class LENKCHABEHD
{
    public bool <JDDPHCKLCLC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LHBOJNGPFCB
//   (not directly referenced by a detected call)
public class LHBOJNGPFCB
{
    // (no instance fields in the metadata dump)
}
...
public class LHPPOLLJGKD : PJPHONOEOJN
{
    public MAFNKBGGPDA? <DMEAMFAKDGF>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <IOJDBDGIJAD>k__BackingField;    // 0x0x20
}
...
public class LOCPMGBJOHM
{
    public int? <OGBAPHKKALH>k__BackingField;    // 0x0x10
    public string <OKDHADMJCEP>k__BackingField;    // 0x0x18
    public string <MPOLMCIIEOL>k__BackingField;    // 0x0x20
}
...
// MMMMLPDPOPB
//   (not directly referenced by a detected call)
public class MMMMLPDPOPB
{
    public DateTime? <IAGKNFFALKB>k__BackingField;    // 0x0x10
    public DateTime? <GKHOJMEJKCG>k__BackingField;    // 0x0x20
    public AAJGIPNBFNJ <ALLPFAGIOKN>k__BackingField;    // 0x0x30
    public JMHEILDMAAL <EAFCCKOJMDD>k__BackingField;    // 0x0x38
    public bool <MOJKHKPKEPD>k__BackingField;    // 0x0x40
}
...
// NBHJEEELOCM
//   (not directly referenced by a detected call)
public class NBHJEEELOCM
{
    public KGMAPJKFBEH PIJOFBIMLFG;    // 0x0x10
    public int JFPEAGIHDJH;    // 0x0x14
    public int ALCMDKMLGIJ;    // 0x0x18
}
...
public class NLGJHHBDFFG
{
    public List<OFNKBAJAHHH> <DBKCIEKKBFD>k__BackingField;    // 0x0x10
    public string <IJHEBFLEMIH>k__BackingField;    // 0x0x18
}
...
public class NOEMCMCDCLB
{
    public int <PKBKOCILDPH>k__BackingField;    // 0x0x10
    public List<MMMMLPDPOPB> <AJNLIDNKGBD>k__BackingField;    // 0x0x18
}
...
public class OACBAFIMKJC
{
    public PGPFCKMDJMF <NPHLDBMGPJG>k__BackingField;    // 0x0x10
}
...
// OFNKBAJAHHH
//   (not directly referenced by a detected call)
public class OFNKBAJAHHH
{
    public int <KPFPOJHLDJD>k__BackingField;    // 0x0x10
    public DateTime <KBGFHKOCEIO>k__BackingField;    // 0x0x18
    public DateTime? <PGDEFCGDJLB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OHIFKLDGKIA
//   (not directly referenced by a detected call)
public class OHIFKLDGKIA
{
    public int <IDPFDGIGALF>k__BackingField;    // 0x0x10
    public PGPFCKMDJMF <NPHLDBMGPJG>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// OJAALFPPLBI
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class OJAALFPPLBI
{
    public IHCHLNKCPCJ <NPHLDBMGPJG>k__BackingField;    // 0x0x10
    public List<string> <LACAJFIDPKP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OJEPFLEKFCO
//   (not directly referenced by a detected call)
public class OJEPFLEKFCO
{
    public float <DPPDDAFAFOC>k__BackingField;    // 0x0x10
}
...
public class PEKNJONBCJE
{
    public long <ALBGNMEGBFI>k__BackingField;    // 0x0x10
    public long? <EPNKGFIGEDO>k__BackingField;    // 0x0x18
    public long? <OCGGDMNOHKO>k__BackingField;    // 0x0x28
    public string <JHCJACDOMPA>k__BackingField;    // 0x0x38
    public string <MJHIIEMLDOI>k__BackingField;    // 0x0x40
    public List<string> <LACAJFIDPKP>k__BackingField;    // 0x0x48
    public string <INEFLDCPEFM>k__BackingField;    // 0x0x50
    public DateTime <GIHINKDCFDC>k__BackingField;    // 0x0x58
    public DateTime <LPEPEFEJCMN>k__BackingField;    // 0x0x60
    public LMGHKHKKEEN <NJBBIMABIDH>k__BackingField;    // 0x0x68
    public bool <APIAKNCLIPH>k__BackingField;    // 0x0x6C
}

// --------------------------------------------------------------------------
// PEOACNAPKDH
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{fFAGPJPLMOA}   [Service.API]
//   RESPONSE POST   api/playerevents/v2/{eventId}   [Service.API]
public class PEOACNAPKDH
{
    public AKDGJIJEBBH <LOIOIFGLBJC>k__BackingField;    // 0x0x10
    public PGPFCKMDJMF <NPHLDBMGPJG>k__BackingField;    // 0x0x18
    public OJAALFPPLBI <FPAIIAGBCOJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PGAHNNFPLDL
//   (not directly referenced by a detected call)
public class PGAHNNFPLDL
{
    public int <MBHLIEGJIJI>k__BackingField;    // 0x0x10
    public string <JHCJACDOMPA>k__BackingField;    // 0x0x18
    public string <DMIGLJJKALO>k__BackingField;    // 0x0x20
    public string <MJHIIEMLDOI>k__BackingField;    // 0x0x28
    public string <CCLDLKAEPAE>k__BackingField;    // 0x0x30
    public bool <HPCGKDBCEGA>k__BackingField;    // 0x0x38
    public int <DPFDHHGPAPH>k__BackingField;    // 0x0x3C
    public LHBOJNGPFCB <IGKADFBHAKE>k__BackingField;    // 0x0x40
    public KPINIILAFEG EBFCCDINPLK;    // 0x0x48
    public KPINIILAFEG BJMBCDCLDEN;    // 0x0x50
    public KPINIILAFEG LJCCKJMADIL;    // 0x0x58
    public JAGBBFPBCCG AOFEPDHDGAM;    // 0x0x60
}
...
public class FreeGiftRequestDTO
{
    ...
    public EKFCOGEAOPC <GiftContext>k__BackingField;    // 0x0x20
}
...
public class GetRankRequestDTO
{
    ...
    public NGFKKJENDAO FilterType;    // 0x0x20
    public HLNEGIDBKDH Timeframe;    // 0x0x24
...
public class NewInventionRequestDTO
{
    ...
    public NPAMHINLOCM creatorAccountRole;    // 0x0x58
}
...
public class ReportRequest
{
    ...
    public EJAIHGHEMAB ReportCategory;    // 0x0x20
}
...
{
    public PEALBIEBFAF? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public PEALBIEBFAF GFBHFOGOEFM;  // wrapper
...
{
    public IAFADPBDDBD JFCECMDBFCN;  // wrapper
...
{
    public BCAAGAGFECK NAFKNBEJLOH;  // wrapper
    public int? ODAHDKFNLAH;  // wrapper
...
{
    public BJBJANOOCOE PIJPHCMIPHO;  // wrapper
    public KMFOLOIDCHP JHEAOCMILMA;  // wrapper
...
{
    public CDEHJCNPELK LPPGMPGCBPJ;  // wrapper
    public KMFOLOIDCHP JHEAOCMILMA;  // wrapper
...
{
    public EKFCOGEAOPC NJJLHKPDHIC;  // wrapper
    public EKFCOGEAOPC? HDDJHHIEGNH;  // wrapper
...
{
    public PGAHNNFPLDL AFPCIIDKFHD;  // wrapper
...
{
    public OHBHOIJKMOD KNFJGCIFKAI;  // wrapper
    public BJBJANOOCOE PIJPHCMIPHO;  // wrapper
...
{
    public IReadOnlyList<IILLOLNDMHG> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public GFIIFIMCAMA HMKODIBLJNN;  // wrapper
    public EKFCOGEAOPC? NGAKPNHHAKL;  // wrapper
...
{
    public OCMJBLAEJGP CIKBCJNMAMI;  // wrapper
...
{
    public StatusResponse> JHEAOCMILMA;  // wrapper
...
{
    public IOSNotificationPreferences IOSModifyNotificationPreferences;  // wrapper
}

// api/messages/v1/IOSSaveDeviceToken  [API POST]
public class MessagesV1IOSSaveDeviceTokenRequest
{
    public JNJMEHOMNFC JEIGKFCHFCC;  // wrapper
    public object platformId;  // candidate
...
{
    public List<long> OGBFHCMHBKB;  // wrapper
    public FIBBAEJHAKF BNBBLJDGLNO;  // wrapper
    public long? JNJEOHDBACE;  // wrapper
    public KMFOLOIDCHP JHEAOCMILMA;  // wrapper
...
{
    public String> JHEAOCMILMA;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{fFAGPJPLMOA}  [API POST]
public class PlayereventsV2DeleteFFAGPJPLMOARequest
{
    public AKDGJIJEBBH FFAGPJPLMOA;  // wrapper
}

// api/players/v2/objectives  [API POST]
public class PlayersV2ObjectivesRequest
{
    public List<BMMIDJDOGOK> MJPHDEGMIKH;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> JPPILLCEILK;  // wrapper
...
{
    public Guid? EGCLBEBAOJF;  // wrapper
    public object RoomId;  // candidate
...
{
    public BJBJANOOCOE PIJPHCMIPHO;  // wrapper
    public long? KLJPPDAPEMM;  // wrapper
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
    public object ReportCategory;  // candidate
...
{
    public MatchCompleteStats INANLEIAEIP;  // wrapper
}
...
{
    public Guid MKPGFJINKOD;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<ABIBKMFFFJK> MJPHDEGMIKH;  // wrapper
    public object objectiveType;  // candidate
...
{
    public HDIFLEFFLGE JMIBPOIEJKI;  // wrapper
}
