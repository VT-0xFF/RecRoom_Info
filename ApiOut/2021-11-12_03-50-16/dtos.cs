...
public class AHFIOHIIDMM
{
    public BPIHAJDCJFI <OBNKJFIIAKC>k__BackingField;    // 0x0x10
    public List<string> <DFLKOEAMLEI>k__BackingField;    // 0x0x18
}
...
public class AIFOKLIGPBH
{
    public int <MDMLCHKPJMH>k__BackingField;    // 0x0x10
    public bool <LNAEDDGOJGB>k__BackingField;    // 0x0x14
    public DateTime <ANPLLPJGHFD>k__BackingField;    // 0x0x18
    public bool <MPFKFOBCCDA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AJMLKPIPLDO
//   (not directly referenced by a detected call)
public class AJMLKPIPLDO
{
    public Guid <PKAEJEHIHLL>k__BackingField;    // 0x0x10
    public long <BNFGIHMEHPF>k__BackingField;    // 0x0x20
    public string <BFFBAPDCCDN>k__BackingField;    // 0x0x28
    public string <LBJAOOPBBLL>k__BackingField;    // 0x0x30
    public string <FGOGONHIAFL>k__BackingField;    // 0x0x38
    public long <ONCAMJBIHFL>k__BackingField;    // 0x0x40
    public Guid? <MFMNCPAAHMH>k__BackingField;    // 0x0x48
    public DateTime <LJDOCELPEKN>k__BackingField;    // 0x0x60
}
...
public class AKLAMNNPGNJ : CEHBPFMPGJP
{
    public List<HFLEMINFPBP> OKJIDKCAHHB;    // 0x0x30
    public int <CIIKKPJCLLL>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// ANJODCALOMK
//   (not directly referenced by a detected call)
public class ANJODCALOMK
{
    public int <EHOKMPAANLB>k__BackingField;    // 0x0x10
    public int <KLBGPJIGNFD>k__BackingField;    // 0x0x14
    public int <EGHHNHFKDEL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AOPEKICBGME
//   (not directly referenced by a detected call)
public class AOPEKICBGME
{
    public bool <FPPPDHLBDHO>k__BackingField;    // 0x0x10
    public EOCHCPKHIOO <FMPDHACONEM>k__BackingField;    // 0x0x18
    public float <OBGOCKBHBCK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BALKGFCCLMI
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class BALKGFCCLMI
{
    public int <HHPIKLCMGCB>k__BackingField;    // 0x0x10
    public string <NPIKOMFJFID>k__BackingField;    // 0x0x18
    public string <FGLFMLDCNII>k__BackingField;    // 0x0x20
    public string <JGDBGFMKLCH>k__BackingField;    // 0x0x28
    public string <HLHKJMKNKCN>k__BackingField;    // 0x0x30
    public string <HENGEBEKLCB>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// BCIIDNPKFJL
//   (not directly referenced by a detected call)
public class BCIIDNPKFJL
{
    public int <GAIOPFEOGHD>k__BackingField;    // 0x0x10
    public string <BFFBAPDCCDN>k__BackingField;    // 0x0x18
    public string <LJABMLCHMCC>k__BackingField;    // 0x0x20
    public string <LBJAOOPBBLL>k__BackingField;    // 0x0x28
    public string <MNOIECJEDAI>k__BackingField;    // 0x0x30
    public bool <FLMGJHOJKJI>k__BackingField;    // 0x0x38
    public int <HHPIKLCMGCB>k__BackingField;    // 0x0x3C
    public HCBHDENMIBJ <NPJDOBDDBGN>k__BackingField;    // 0x0x40
    public ECAAMMOBNNM MHGNPGPLBHF;    // 0x0x48
    public ECAAMMOBNNM BFOPMCALOAI;    // 0x0x50
    public ECAAMMOBNNM LLNDCEGGFLO;    // 0x0x58
    public CGMHEIKIOBP MNFFGNEHKDN;    // 0x0x60
}
...
public class BEBBHCIJKEF
{
    public LKGDFDGNLNP <CDEADLGDBMF>k__BackingField;    // 0x0x10
    public MNFNLNLCHGI <IIGEKIBMLNJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BHJKPCEDICM
//   (not directly referenced by a detected call)
public class BHJKPCEDICM
{
    public long <DBNBGBMOPPO>k__BackingField;    // 0x0x10
    public string <IBHJICPMEMO>k__BackingField;    // 0x0x18
    public string <JGDOHILEBEK>k__BackingField;    // 0x0x20
    public KKGPMMJBGOO? <GOJGACFHEEH>k__BackingField;    // 0x0x28
    public string <HBEDDFMLFAC>k__BackingField;    // 0x0x30
    public string <OGDIJAIIHIK>k__BackingField;    // 0x0x38
    public CGMNJBHHLEB <IFBCOHMBADF>k__BackingField;    // 0x0x40
    public int <GNDFFPNLFHI>k__BackingField;    // 0x0x44
    public int <HBPICHDCEDF>k__BackingField;    // 0x0x48
    public DINLMEMMKHI? <LGDNALHADCO>k__BackingField;    // 0x0x4C
    public JCGIBHBMMPE? <JHOCLMKNCPK>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// BKHBCDFCENJ
//   (not directly referenced by a detected call)
public class BKHBCDFCENJ
{
    public float <HCIFBFKIBAD>k__BackingField;    // 0x0x10
}
...
public class BNEEJFFLBCA
{
    public List<CCOILEGDADL> <KLLLAJPOJFC>k__BackingField;    // 0x0x10
    public List<KCEFLGIOAFO> <MDJFBEKCNIL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BNPCICNNAGN
//   (not directly referenced by a detected call)
public class BNPCICNNAGN
{
    public Guid <PKAEJEHIHLL>k__BackingField;    // 0x0x10
    public int <CAOCCLKKJCI>k__BackingField;    // 0x0x20
    public int <CFIAHNLCBOJ>k__BackingField;    // 0x0x24
    public Guid <LLDGBHNLKOK>k__BackingField;    // 0x0x28
    public DateTime <LJDOCELPEKN>k__BackingField;    // 0x0x38
    public AJMLKPIPLDO <HOOMCIBCPKL>k__BackingField;    // 0x0x40
}
...
public class BOFNABMEKKO
{
    public long <KKGGFBPGEMB>k__BackingField;    // 0x0x10
    public string <BFFBAPDCCDN>k__BackingField;    // 0x0x18
    public string <LBJAOOPBBLL>k__BackingField;    // 0x0x20
    public DateTime <MHDGILKEKEF>k__BackingField;    // 0x0x28
    public string <FGOGONHIAFL>k__BackingField;    // 0x0x30
    public LINIPFLFKNN <EKIGJBLKGMB>k__BackingField;    // 0x0x38
    public int <GGBPNFIOALC>k__BackingField;    // 0x0x3C
    public int <AEKCMGCGPLJ>k__BackingField;    // 0x0x40
    public List<IPJINKNDCNJ> <BFJAEFEFLAP>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// BONLEDACAKI
//   (not directly referenced by a detected call)
public class BONLEDACAKI
{
    public int <IAHJLDHENHH>k__BackingField;    // 0x0x10
}
...
// --------------------------------------------------------------------------
// CBKEADPJMBI
//   RESPONSE GET    api/inventions/v1/personaldetails/{mNCABAALAIH}   [Service.API]
public class CBKEADPJMBI
{
    public bool <MLMNDEGMMLI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CCOILEGDADL
//   (not directly referenced by a detected call)
public class CCOILEGDADL
{
    public long <IJIOKMPPDNL>k__BackingField;    // 0x0x10
    public int <MDPNIKAIKMG>k__BackingField;    // 0x0x18
    public long <BNFGIHMEHPF>k__BackingField;    // 0x0x20
    public long? <JDMGKPNHNEL>k__BackingField;    // 0x0x28
    public long? <AFIOMFBILLL>k__BackingField;    // 0x0x38
    public string <BFFBAPDCCDN>k__BackingField;    // 0x0x48
    public string <LBJAOOPBBLL>k__BackingField;    // 0x0x50
    public string <FGOGONHIAFL>k__BackingField;    // 0x0x58
    public DateTime <ADLCAKHCPMN>k__BackingField;    // 0x0x60
    public DateTime <NLIJBENEPLD>k__BackingField;    // 0x0x68
    public int <DKFAHMCDCAC>k__BackingField;    // 0x0x70
    public GLKANEDLBKG <OPJECKKMNAL>k__BackingField;    // 0x0x74
    public bool <CGJGFDJCDJG>k__BackingField;    // 0x0x78
    public bool <PBAFHIPPGJP>k__BackingField;    // 0x0x79
    public long? <CCEKFIJJHIO>k__BackingField;    // 0x0x80
}
...
// --------------------------------------------------------------------------
// CHKJEECHFJF
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{pPEJJBAPEIC}   [Service.API]
public class CHKJEECHFJF
{
    public uint KMIDPIMFNNM;    // 0x0x10
    public string NIGNPLIEFKI;    // 0x0x18
    public string NAPHCJFKGPN;    // 0x0x20
    public DateTime KGDKBGAIDGL;    // 0x0x28
    public DateTime? IMDDGDDDHCF;    // 0x0x30
    public bool EKLIEBIHOKI;    // 0x0x40
    public List<LHJGOPOLEEM> APFNAKKOHNJ;    // 0x0x48
    public List<string> DFHFCAEFLFO;    // 0x0x50
    public int MPKOEIBMIFM;    // 0x0x58
    public int AAODAOJFCKI;    // 0x0x5C
    public int KKMLGCLDLMG;    // 0x0x60
}

// --------------------------------------------------------------------------
// CJPALJDHEDL
//   (not directly referenced by a detected call)
public class CJPALJDHEDL
{
    public DateTime? <CAOFGAKANCL>k__BackingField;    // 0x0x10
    public DateTime? <EEELNCLMJOC>k__BackingField;    // 0x0x20
    public MAPJFKIKFEH <CDEADLGDBMF>k__BackingField;    // 0x0x30
    public ANJODCALOMK <ODJHMJIHOIC>k__BackingField;    // 0x0x38
    public bool <KCNHJJABEDF>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// CPLBCMNDKON
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class CPLBCMNDKON
{
    public List<GOEPAPBGNNF> <OHAAOBFLHEM>k__BackingField;    // 0x0x10
    public JGDJAFLKEAG <OBNKJFIIAKC>k__BackingField;    // 0x0x18
}
...
public class DCEIIABMLKH
{
    public bool <DOKEPKMNCMJ>k__BackingField;    // 0x0x10
    public string <DHGEECNBJOI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DFBDNHILCDB
//   (not directly referenced by a detected call)
public class DFBDNHILCDB
{
    public int <BGEOKGHFIIB>k__BackingField;    // 0x0x10
    public DateTime? <LEBLFKAAILA>k__BackingField;    // 0x0x18
    public DateTime? <FPDHNGIJAMG>k__BackingField;    // 0x0x28
}
...
// DMNBLELONOC
//   (not directly referenced by a detected call)
public class DMNBLELONOC
{
    public int <KHLJPBEHKIC>k__BackingField;    // 0x0x10
    public DateTime <MHDGILKEKEF>k__BackingField;    // 0x0x18
    public DateTime? <JJHHOGAEOIE>k__BackingField;    // 0x0x20
}
...
public class DNMPBNGENJM
{
    public Dictionary<int, int> <GFKGEHOMCIC>k__BackingField;    // 0x0x10
    public List<PBLLPOEPDFB> <BLEGNGJIAKD>k__BackingField;    // 0x0x18
    public HHNMIAAECKJ[][] <GBHLONJLKLM>k__BackingField;    // 0x0x20
    public KJBMDHAIOBH <JPIDFABANNO>k__BackingField;    // 0x0x28
    public HOOHDGBMDKB <GPKKOEDGBOO>k__BackingField;    // 0x0x30
    public BONLEDACAKI <GIMHMGPGDLM>k__BackingField;    // 0x0x38
    public BKHBCDFCENJ <JMOKAAFJPGK>k__BackingField;    // 0x0x40
    public string <EMGAJAHGHNM>k__BackingField;    // 0x0x48
}
...
public class DOLDIEGJDNJ
{
    public int <OACEBPMAAOE>k__BackingField;    // 0x0x10
    public PCLGHPAKGEO <CEJFOBGDOKP>k__BackingField;    // 0x0x14
    public KOCJPEOMPOJ <FFDMDGDMJLA>k__BackingField;    // 0x0x18
    public KOCJPEOMPOJ <HHOMJLAOKHL>k__BackingField;    // 0x0x1C
    public KOCJPEOMPOJ <OKBFBGFLGDL>k__BackingField;    // 0x0x20
}
...
public class ECNCCKAJDEE
{
    public string <OGKAFGHNDLO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EDBIMGFCPII
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class EDBIMGFCPII
{
    public int <CAOCCLKKJCI>k__BackingField;    // 0x0x10
    public Guid <AJCEHHHPFCB>k__BackingField;    // 0x0x14
    public long <HLEADLNBACD>k__BackingField;    // 0x0x28
    public long <LKDHOILOKMJ>k__BackingField;    // 0x0x30
    public DateTime <KDJHCGPADPN>k__BackingField;    // 0x0x38
}
...
// EOCHCPKHIOO
//   (not directly referenced by a detected call)
public class EOCHCPKHIOO
{
    public int <DBNBGBMOPPO>k__BackingField;    // 0x0x10
    public string <OOECONJHBGA>k__BackingField;    // 0x0x18
    public string <MNOIECJEDAI>k__BackingField;    // 0x0x20
    public string <IBHJICPMEMO>k__BackingField;    // 0x0x28
    public string <CJLPGPNBHKI>k__BackingField;    // 0x0x30
    public KKGPMMJBGOO? <GOJGACFHEEH>k__BackingField;    // 0x0x38
    public string <HBEDDFMLFAC>k__BackingField;    // 0x0x40
    public string <OGDIJAIIHIK>k__BackingField;    // 0x0x48
    public bool <MPJCCHHKNOO>k__BackingField;    // 0x0x50
    public bool <ODLMODHEKED>k__BackingField;    // 0x0x51
    public bool <IPDHGGJNFFC>k__BackingField;    // 0x0x52
    public JCGIBHBMMPE <OEDMBBJHPPI>k__BackingField;    // 0x0x54
    public GCGOALGMKLL <OGPHHKNLPLG>k__BackingField;    // 0x0x58
    public int <HDJCKCPLHLA>k__BackingField;    // 0x0x5C
    public OOKBHGFGDAK <EPPGFPBGHGJ>k__BackingField;    // 0x0x60
    public DINLMEMMKHI <CIFLHKLCCAA>k__BackingField;    // 0x0x64
    public int? <CFFLPLCOBJH>k__BackingField;    // 0x0x68
    public string <NLMJCDDHNJK>k__BackingField;    // 0x0x70
}
...
// FEMEEAOCBKC
//   (not directly referenced by a detected call)
public class FEMEEAOCBKC
{
    public string <NDILBLKNHLM>k__BackingField;    // 0x0x10
    public LDFJMMHEMOF <CEJFOBGDOKP>k__BackingField;    // 0x0x18
}
...
// FKGAPDCILGK
//   (not directly referenced by a detected call)
public class FKGAPDCILGK
{
    public DateTime OJBNEIJBHNH;    // 0x0x10
    public string ODAJFEJKJFA;    // 0x0x18
}
...
public class FKKDADDPLCH
{
    public int <CAOCCLKKJCI>k__BackingField;    // 0x0x10
    public Guid <AJCEHHHPFCB>k__BackingField;    // 0x0x14
    public long <HLEADLNBACD>k__BackingField;    // 0x0x28
    public DateTime <LJDOCELPEKN>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// FLOIJOOEMHL
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class FLOIJOOEMHL
{
    public List<FEMEEAOCBKC> <DFLKOEAMLEI>k__BackingField;    // 0x0x10
}
...
public class FMJLEAKCOAP : CEHBPFMPGJP
{
    public int <LGMFJHEBAIC>k__BackingField;    // 0x0x30
    public string <BFFBAPDCCDN>k__BackingField;    // 0x0x38
    public DateTime <KDHDMHDBCHH>k__BackingField;    // 0x0x40
    public DateTime <EBKKMFIKNJH>k__BackingField;    // 0x0x48
    public GCGOALGMKLL <OGPHHKNLPLG>k__BackingField;    // 0x0x50
    public IJBDGMEKLOO <JCNBHPOKCDL>k__BackingField;    // 0x0x58
    public List<IOCPDLCMNCJ> <DHLJBLNJMHJ>k__BackingField;    // 0x0x60
    public PKNNJMOPFKN <FGKPHDHPLNO>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FMMCAAGHCOL
//   (not directly referenced by a detected call)
public class FMMCAAGHCOL
{
    public GCGOALGMKLL <OGPHHKNLPLG>k__BackingField;    // 0x0x10
    public int <ONCAMJBIHFL>k__BackingField;    // 0x0x14
    public DFBDNHILCDB <CJOHCAMFLGP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FPFPGFOBBOJ
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.API]
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{gBGCGJJEMJO}   [Service.API]
public class FPFPGFOBBOJ
{
    public long <BNFGIHMEHPF>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <FCBNNIDKLCE>k__BackingField;    // 0x0x18
    public DOOBFECIDHK <KJMLPGJBKMO>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{nHLFJMFFMIP}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{nHLFJMFFMIP}   [Service.API]
...
public class GDAJFPEPPOL
{
    public EFMDGJMMKMP HNEBENLEJBN;    // 0x0x10
    public AJMLKPIPLDO MODOOPDJHGC;    // 0x0x18
}
...
public class GGHEPCKCMKM
{
    public EFMDGJMMKMP HNEBENLEJBN;    // 0x0x10
    public BNPCICNNAGN FDBJFACBMFI;    // 0x0x18
}
...
public class GLLIECFEDIP
{
    public string <CPJHGEDOEGI>k__BackingField;    // 0x0x10
    public string <ILIAICOJFNG>k__BackingField;    // 0x0x18
}
...
public class GMCPODMLGIF
{
    public NEPLMMMNAEN <CDEADLGDBMF>k__BackingField;    // 0x0x10
    public PEJDHCHIAKG <DFPKJCDHEOP>k__BackingField;    // 0x0x18
    public LAKACFNEPIE <OGBFEKJNFNM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GOEPAPBGNNF
//   (not directly referenced by a detected call)
public class GOEPAPBGNNF
{
    public int <KNDHPHJPINB>k__BackingField;    // 0x0x10
    public JGDJAFLKEAG <OBNKJFIIAKC>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// HAAPHCCPHJD
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class HAAPHCCPHJD
{
    public FKKDADDPLCH <GFPOILEOCOJ>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <NACMIPCNLGJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HCBHDENMIBJ
//   (not directly referenced by a detected call)
public class HCBHDENMIBJ
{
    // (no instance fields in the metadata dump)
}
...
// base   : IJBDGMEKLOO
//   (not directly referenced by a detected call)
public class HFLEMINFPBP : IJBDGMEKLOO
{
    public EOCHCPKHIOO <FMPDHACONEM>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// HHNMIAAECKJ
//   (not directly referenced by a detected call)
public class HHNMIAAECKJ
{
    public IAGHJFFLJOP BLOBGBLMEHN;    // 0x0x10
    public int CMDAEFIBOKO;    // 0x0x14
    public int NOJJCEKBFBP;    // 0x0x18
}

// --------------------------------------------------------------------------
// HOOHDGBMDKB
//   (not directly referenced by a detected call)
public class HOOHDGBMDKB
{
    public float <CMICLLJLBLL>k__BackingField;    // 0x0x10
    public float <HHFDOOJPNHF>k__BackingField;    // 0x0x14
    public float <ONMJCBNNOME>k__BackingField;    // 0x0x18
    public float <ILJJCPHFNFD>k__BackingField;    // 0x0x1C
    public float <IMNFLNNEMDA>k__BackingField;    // 0x0x20
    public float <HKKDFHOODGK>k__BackingField;    // 0x0x24
    public float <LMBEIAFPKKO>k__BackingField;    // 0x0x28
    public float <ECCLAMDAHFB>k__BackingField;    // 0x0x2C
}
...
public class IHFMDNCMIBG
{
    public List<int> <GFCENODFGHC>k__BackingField;    // 0x0x10
    public string <KEBJOOLJJGF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IHIDHGMMNFM
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class IHIDHGMMNFM
{
    public int <ODPFFDPGGFH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IJBDGMEKLOO
//   (not directly referenced by a detected call)
public class IJBDGMEKLOO
{
    public int <BFDJPALEGGO>k__BackingField;    // 0x0x10
    public LOGDJEHNNJD <CEJFOBGDOKP>k__BackingField;    // 0x0x14
    public List<FMMCAAGHCOL> <MMPBGIDJJFH>k__BackingField;    // 0x0x18
    public List<FMMCAAGHCOL> <LJFKOODKHOM>k__BackingField;    // 0x0x20
    public bool <HDHFKNAOBJJ>k__BackingField;    // 0x0x28
    public DateTime? <DMNHPGLMLJJ>k__BackingField;    // 0x0x30
}
...
public class IKFPGBBNJIE
{
    public long <BNFGIHMEHPF>k__BackingField;    // 0x0x10
    public long? <JDMGKPNHNEL>k__BackingField;    // 0x0x18
    public long? <AFIOMFBILLL>k__BackingField;    // 0x0x28
    public string <BFFBAPDCCDN>k__BackingField;    // 0x0x38
    public string <LBJAOOPBBLL>k__BackingField;    // 0x0x40
    public List<string> <DFLKOEAMLEI>k__BackingField;    // 0x0x48
    public string <FGOGONHIAFL>k__BackingField;    // 0x0x50
    public DateTime <ADLCAKHCPMN>k__BackingField;    // 0x0x58
    public DateTime <NLIJBENEPLD>k__BackingField;    // 0x0x60
    public GLKANEDLBKG <OPJECKKMNAL>k__BackingField;    // 0x0x68
    public bool <CGJGFDJCDJG>k__BackingField;    // 0x0x6C
}

// --------------------------------------------------------------------------
// ILCCIAEDBND
//   (not directly referenced by a detected call)
public class ILCCIAEDBND
{
    public long <HJICKJBHNJF>k__BackingField;    // 0x0x10
    public long <IJIOKMPPDNL>k__BackingField;    // 0x0x18
    public int <NBELNKJDNFJ>k__BackingField;    // 0x0x20
    public DateTime <MHDGILKEKEF>k__BackingField;    // 0x0x28
    public KHJGHCGDBDB <CEJFOBGDOKP>k__BackingField;    // 0x0x30
}
...
// base   : IJBDGMEKLOO
//   (not directly referenced by a detected call)
public class IOCPDLCMNCJ : IJBDGMEKLOO
{
    public int <GNHJOOPCGNA>k__BackingField;    // 0x0x40
    public List<AOPEKICBGME> <EAKFGEAAJFM>k__BackingField;    // 0x0x48
    public List<AOPEKICBGME> <OGCCGIJAKMG>k__BackingField;    // 0x0x50
    public List<AOPEKICBGME> <NCPPCPMHJJI>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// IOOHBNDDOOE
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class IOOHBNDDOOE
{
    public GCGOALGMKLL <OGPHHKNLPLG>k__BackingField;    // 0x0x10
    public JFCFGDFIJKN <JFPIGDMNHLF>k__BackingField;    // 0x0x14
    public int <CPHMBJAEJAB>k__BackingField;    // 0x0x18
    public int <EODJKKCJEMO>k__BackingField;    // 0x0x1C
    public int <BNKEJPIDOKJ>k__BackingField;    // 0x0x20
    public AEAGIIHNKLC <OALEGHBMINC>k__BackingField;    // 0x0x24
    public bool <FKLEGLPIJKP>k__BackingField;    // 0x0x28
    public float <LBPMODHLNIO>k__BackingField;    // 0x0x2C
    public int <AOLJCIMMEOC>k__BackingField;    // 0x0x30
    public bool <KGJHGPCCHJG>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// IPJINKNDCNJ
//   RESPONSE GET    api/groups/v1/memberships/{nBBBNGKKGJK}   [Service.API]
public class IPJINKNDCNJ
{
    public long <KKGGFBPGEMB>k__BackingField;    // 0x0x10
    public int <NBELNKJDNFJ>k__BackingField;    // 0x0x18
    public CDNKONPBHIH <JNHIPJJJNIC>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// JAGLNJBAOJN
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class JAGLNJBAOJN
{
    public int? <GFJDPNBOMLH>k__BackingField;    // 0x0x10
    public string <GFGENEDGEHK>k__BackingField;    // 0x0x18
    public string <IBEPECMKBNM>k__BackingField;    // 0x0x20
}
...
public class JIAJBGHIIKH
{
    public List<DMNBLELONOC> <BMNHKJABLEH>k__BackingField;    // 0x0x10
    public string <KEBJOOLJJGF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JIFDLMKNJDF
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{bNKGDMIPJKP}   [Service.API]
public class JIFDLMKNJDF
{
    public Guid <CLHLHHANNGC>k__BackingField;    // 0x0x10
    public int <CAOCCLKKJCI>k__BackingField;    // 0x0x20
    public int <BFDJPALEGGO>k__BackingField;    // 0x0x24
    public DateTime <MHDGILKEKEF>k__BackingField;    // 0x0x28
}
...
public class KBNGFGIMEAM
{
    public List<string> <MMNGOADACAB>k__BackingField;    // 0x0x10
    public List<string> <GEACOCPBDOF>k__BackingField;    // 0x0x18
    public List<string> <AAOBDDIHCON>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KCEFLGIOAFO
//   (not directly referenced by a detected call)
public class KCEFLGIOAFO
{
    public CCOILEGDADL <BFAHEJGACOH>k__BackingField;    // 0x0x10
    public ILCCIAEDBND <PNBOGKAEJPP>k__BackingField;    // 0x0x18
}
...
// KJBMDHAIOBH
//   (not directly referenced by a detected call)
public class KJBMDHAIOBH
{
    public int <CDNBBCGELNK>k__BackingField;    // 0x0x10
}
...
public class KOBEBGAKHLJ : OCOGKJIFHOJ
{
    public LFBJOAHKFMP? <DLAMIKDDMJF>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <NACMIPCNLGJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LAKACFNEPIE
//   (not directly referenced by a detected call)
public class LAKACFNEPIE
{
    public long <PALLJJAKPID>k__BackingField;    // 0x0x10
    public string <ADAJDAJHMKE>k__BackingField;    // 0x0x18
    public int <LBAMPANIPAI>k__BackingField;    // 0x0x20
    public int <AOOMBHLEONC>k__BackingField;    // 0x0x24
    public int <PNFKMCBAGFH>k__BackingField;    // 0x0x28
    public int <MMKKBOIPIMI>k__BackingField;    // 0x0x2C
    public int <AOHFCICPDPG>k__BackingField;    // 0x0x30
    public string <JENGFGECGIN>k__BackingField;    // 0x0x38
}
...
public class LFOOELOODFL
{
    public string <FGLFMLDCNII>k__BackingField;    // 0x0x10
    public string <JGDBGFMKLCH>k__BackingField;    // 0x0x18
    public string <HLHKJMKNKCN>k__BackingField;    // 0x0x20
    public string <HENGEBEKLCB>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// LHJGOPOLEEM
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{pPEJJBAPEIC}   [Service.API]
public class LHJGOPOLEEM
{
    public string KMIDPIMFNNM;    // 0x0x10
    public string CHAPOCEIMFE;    // 0x0x18
    public string BPINACDCBLD;    // 0x0x20
    public string NAPHCJFKGPN;    // 0x0x28
    public string ECHOFGJDNOE;    // 0x0x30
    public OCGOPKKLCLK HNEBENLEJBN;    // 0x0x38
    public List<string> GMKJNHAMGMO;    // 0x0x40
    public List<string> DFHFCAEFLFO;    // 0x0x48
    public string KIAOOLHDPHE;    // 0x0x50
    public List<FKGAPDCILGK> IDJIIBMADOB;    // 0x0x58
}
...
// LKGDFDGNLNP
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{hHJCEJIIILH}   [Service.API]
public enum LKGDFDGNLNP
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class LNGIIAFGGFP
{
    public FDGLMIJFILH <DMJKHILMJGC>k__BackingField;    // 0x0x10
    public long <IJIOKMPPDNL>k__BackingField;    // 0x0x18
    public string <MBMLFHBFIFO>k__BackingField;    // 0x0x20
}
...
public class MAINKBFJPKB
{
    public int <GGJEJCPBJFJ>k__BackingField;    // 0x0x10
    public string <GLPIIIBGLAM>k__BackingField;    // 0x0x18
    public List<BCIIDNPKFJL> <CECFENFFIHF>k__BackingField;    // 0x0x20
    public BHJKPCEDICM <NDPAJGJFJLI>k__BackingField;    // 0x0x28
    public string <DBACNKCAFIM>k__BackingField;    // 0x0x30
    public DateTime <KDHDMHDBCHH>k__BackingField;    // 0x0x38
    public DateTime <EBKKMFIKNJH>k__BackingField;    // 0x0x40
    public DateTime <JBONAPLKAFP>k__BackingField;    // 0x0x48
    public bool? <ENMPIJDEAOL>k__BackingField;    // 0x0x50
}
...
public class MEAOJLMJEHA : OCOGKJIFHOJ
{
    public LHKOKFHIFAD? <DLAMIKDDMJF>k__BackingField;    // 0x0x18
    public FKKDADDPLCH <GFPOILEOCOJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MGNEPHJMIPK
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class MGNEPHJMIPK
{
    public int <CGBAINFMGJH>k__BackingField;    // 0x0x10
    public int <MDMLCHKPJMH>k__BackingField;    // 0x0x14
    public float <DJLDONFNAGC>k__BackingField;    // 0x0x18
    public float <OEFNFMDKDEK>k__BackingField;    // 0x0x1C
    public bool <LNAEDDGOJGB>k__BackingField;    // 0x0x20
    public bool <MCIJIJMKFHD>k__BackingField;    // 0x0x21
    public bool <OIAFJOODMBI>k__BackingField;    // 0x0x22
}
...
public class MKDJNCACFFD
{
    public Guid <HBDPDBENBHE>k__BackingField;    // 0x0x10
    public Guid <AJCEHHHPFCB>k__BackingField;    // 0x0x20
    public int <OGMHBBHGPFE>k__BackingField;    // 0x0x30
    public string <BFFBAPDCCDN>k__BackingField;    // 0x0x38
    public long <LJJIOJAILHJ>k__BackingField;    // 0x0x40
    public long <ONCAMJBIHFL>k__BackingField;    // 0x0x48
    public DateTime <LJDOCELPEKN>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// MNFNLNLCHGI
//   (not directly referenced by a detected call)
public class MNFNLNLCHGI
{
    public long <JABOEHOIFCG>k__BackingField;    // 0x0x10
    public Guid <ADAJDAJHMKE>k__BackingField;    // 0x0x18
    public long <BNFGIHMEHPF>k__BackingField;    // 0x0x28
    public string <BFFBAPDCCDN>k__BackingField;    // 0x0x30
    public string <LBJAOOPBBLL>k__BackingField;    // 0x0x38
    public int <ONCAMJBIHFL>k__BackingField;    // 0x0x40
    public Guid? <MFMNCPAAHMH>k__BackingField;    // 0x0x44
    public DateTime <MHDGILKEKEF>k__BackingField;    // 0x0x58
}
...
public class NADPHDOANGI
{
    public int <OKHFMOOLKJM>k__BackingField;    // 0x0x10
    public List<CJPALJDHEDL> <HMNPGPFNEDG>k__BackingField;    // 0x0x18
}
...
public class OGEDFJMFAKC
{
    public FDGLMIJFILH <DMJKHILMJGC>k__BackingField;    // 0x0x10
    public int <ODPFFDPGGFH>k__BackingField;    // 0x0x14
    public long <ILLDIFCCCDH>k__BackingField;    // 0x0x18
    public bool <ILBDACPGBLG>k__BackingField;    // 0x0x20
    public string <DHGEECNBJOI>k__BackingField;    // 0x0x28
    public int? <HDKJDCGAADL>k__BackingField;    // 0x0x30
    public bool <LHBCONJLCHK>k__BackingField;    // 0x0x38
    public string <HDMCINBCLBP>k__BackingField;    // 0x0x40
    public float <DCPFFPBOEJJ>k__BackingField;    // 0x0x48
}
...
public class OMEKJLBKDHL
{
    public Guid <AJCEHHHPFCB>k__BackingField;    // 0x0x10
    public long? <BNFGIHMEHPF>k__BackingField;    // 0x0x20
    public string <BFFBAPDCCDN>k__BackingField;    // 0x0x30
    public string <LBJAOOPBBLL>k__BackingField;    // 0x0x38
    public GCGOALGMKLL <OGPHHKNLPLG>k__BackingField;    // 0x0x40
    public long <MGJJPPBJKBJ>k__BackingField;    // 0x0x48
    public DateTime <MHDGILKEKEF>k__BackingField;    // 0x0x50
    public DateTime <LJDOCELPEKN>k__BackingField;    // 0x0x58
}
...
public class OPLBCKNOPPI
{
    public long <IJIOKMPPDNL>k__BackingField;    // 0x0x10
    public KHJGHCGDBDB <CEJFOBGDOKP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PEJDHCHIAKG
//   (not directly referenced by a detected call)
public class PEJDHCHIAKG
{
    public long <PALLJJAKPID>k__BackingField;    // 0x0x10
    public string <ADAJDAJHMKE>k__BackingField;    // 0x0x18
    public int <MDPNIKAIKMG>k__BackingField;    // 0x0x20
    public string <BFFBAPDCCDN>k__BackingField;    // 0x0x28
    public string <LBJAOOPBBLL>k__BackingField;    // 0x0x30
    public string <FGOGONHIAFL>k__BackingField;    // 0x0x38
    public int <HKCLIHAGDFI>k__BackingField;    // 0x0x40
    public bool <KLAOBJNHOIN>k__BackingField;    // 0x0x44
    public DateTime <LJDOCELPEKN>k__BackingField;    // 0x0x48
    public DateTime <MHDGILKEKEF>k__BackingField;    // 0x0x50
    public DateTime? <HKNNJPIJBGL>k__BackingField;    // 0x0x58
    public long? <LBNNMDGMFEB>k__BackingField;    // 0x0x68
    public int <PHHCICPLIKK>k__BackingField;    // 0x0x78
    public int <NHNFACEJELF>k__BackingField;    // 0x0x7C
    public int <FGNHJIGDAMO>k__BackingField;    // 0x0x80
    public DNIDMAAEAON <OCCFMMBOCCI>k__BackingField;    // 0x0x84
    public DNIDMAAEAON <ONIPBNAPJIH>k__BackingField;    // 0x0x88
    public bool <LIIJCIECHJL>k__BackingField;    // 0x0x8C
    public bool <KDMBMJODPDL>k__BackingField;    // 0x0x8D
    public bool <OBHAPIGMCIM>k__BackingField;    // 0x0x8E
    public int? <ONCAMJBIHFL>k__BackingField;    // 0x0x90
    public bool <FHFLNGLJPCP>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// PHOGBIECNAC
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{gFAOGIAELGE}   [Service.API]
//   RESPONSE POST   api/playerevents/v2/{eventId}   [Service.API]
public class PHOGBIECNAC
{
    public CCOILEGDADL <BFAHEJGACOH>k__BackingField;    // 0x0x10
    public JGDJAFLKEAG <OBNKJFIIAKC>k__BackingField;    // 0x0x18
    public AHFIOHIIDMM <IFFOIPGHKFF>k__BackingField;    // 0x0x20
}
...
public class PJAPMMCDEEN
{
    public bool <DOKEPKMNCMJ>k__BackingField;    // 0x0x10
    public string <HPLBHJDPILJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PKNNJMOPFKN
//   (not directly referenced by a detected call)
public class PKNNJMOPFKN
{
    public bool <GKOBCMFJJJD>k__BackingField;    // 0x0x10
    public FHBMNDMNPMP <LJFGNIGFLIC>k__BackingField;    // 0x0x14
    public int <DKENHIIHOCH>k__BackingField;    // 0x0x18
    public DateTime <LJDOCELPEKN>k__BackingField;    // 0x0x20
}
...
public class PNIMMFHKAAO
{
    public JGDJAFLKEAG <OBNKJFIIAKC>k__BackingField;    // 0x0x10
}
...
public class FreeGiftRequestDTO
{
    ...
    public DINLMEMMKHI <GiftContext>k__BackingField;    // 0x0x20
}
...
public class GetRankRequestDTO
{
    ...
    public OJICBBKOOLP FilterType;    // 0x0x20
...
public class NewInventionRequestDTO
{
    ...
    public COFHJPPBKDL creatorAccountRole;    // 0x0x58
}
...
public class ReportRequest
{
    ...
    public CLGHPBAPKGJ ReportCategory;    // 0x0x20
}
...
{
    public HBGANFMGPJL? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public HBGANFMGPJL FFDCGHLMLEL;  // wrapper
...
{
    public PHNFOAFKKBO FJGIHCCHHAC;  // wrapper
...
{
    public LHCLBHKFDLC NBODGAKLJFC;  // wrapper
    public int? FFOHNLOOOBO;  // wrapper
...
{
    public FGIFKCJMMIE UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public DINLMEMMKHI OEIFFOBMIEM;  // wrapper
    public DINLMEMMKHI? FCMDIIILOMN;  // wrapper
...
{
    public BCIIDNPKFJL EDGKJEBAONH;  // wrapper
...
{
    public FDGLMIJFILH HMBJJGDAACF;  // wrapper
...
{
    public IReadOnlyList<HGCHPEICIMJ> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public NOIPJAOCCBH ODJECLPPENG;  // wrapper
    public DINLMEMMKHI? AHMJDMLBMOE;  // wrapper
...
{
    public IMLOHNNHHHO NBMPKFPAPCG;  // wrapper
...
{
    public StatusResponse> HMCGKHCFDKN;  // wrapper
...
{
    public List<long> FIFLFLDBJOC;  // wrapper
    public MKOKCPILJLD EOPJLEAKCOK;  // wrapper
    public long? GBGCGJJEMJO;  // wrapper
    public NOJKFEHKNIL HMCGKHCFDKN;  // wrapper
...
{
    public String> HMCGKHCFDKN;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{gFAOGIAELGE}  [API POST]
public class PlayereventsV2DeleteGFAOGIAELGERequest
{
    public CCOILEGDADL GFAOGIAELGE;  // wrapper
}

// api/players/v2/objectives  [API POST]
public class PlayersV2ObjectivesRequest
{
    public List<FJGIOFDHLNH> ABOFIEOMKBN;  // wrapper
...
{
    public Guid PKMBMONJNNL;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> FELOCNLFLPI;  // wrapper
...
{
    public Guid? JOLEFBGAFBJ;  // wrapper
    public object RoomId;  // candidate
...
{
    public MatchCompleteStats IBCHINJAHOP;  // wrapper
}
...
{
    public Guid DCBMMNJBDCK;  // wrapper
    public object RoomKeyId;  // candidate
    public object RequestedPrice;  // candidate
...
{
    public List<JHEDDCKCBPB> ABOFIEOMKBN;  // wrapper
    public object objectiveType;  // candidate
...
{
    public OCGOPKKLCLK ELHEOFEKKEC;  // wrapper
}
