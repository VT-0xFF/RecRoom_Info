...
// DTO classes: 228 (plus referenced enums)

// --------------------------------------------------------------------------
// ABONHLFGLCP
//   RESPONSE POST   api/settings/v2/set   [Service.API]
public class ABONHLFGLCP
{
    public bool IPIMEBKCOKO;    // 0x0x10
    public bool JCAMNMFDPLL;    // 0x0x11
}
...
public class ALGCIBEDBJN
{
    public NBGAMCKPIOO <GDKLCPEDCKK>k__BackingField;    // 0x0x10
    public EMCNIBPDCCF <HKFAPBEPBAE>k__BackingField;    // 0x0x18
    public DDEAHPKPBMJ <EOHFOEMAOOG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ALNPPGMPAJC
//   (not directly referenced by a detected call)
public class ALNPPGMPAJC
{
    public DateTime HJCPJFEOHIG;    // 0x0x10
    public string ELKCIIKDFPP;    // 0x0x18
}
...
public class APNECDJAOAE
{
    public List<NFAPECCGACD> <MBFAKKBJOLF>k__BackingField;    // 0x0x10
    public List<CMPDCBLGEHC> <PBNKHLIGNFB>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// BCOAOPCHFJB
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{kHLGBIBIKCB}   [Service.API]
public class BCOAOPCHFJB
{
    public uint FFKMNDKOFGO;    // 0x0x10
    public string OPMLDJHPFMG;    // 0x0x18
    public string OEDCPFABIII;    // 0x0x20
    public DateTime GFPDHHFPFPM;    // 0x0x28
    public DateTime? IALIPDJDFOM;    // 0x0x30
    public bool HCAFAKFCCGC;    // 0x0x40
    public List<EOGDMJELHBG> NPKHGPCDFFE;    // 0x0x48
    public List<string> AJCLJOEOPAB;    // 0x0x50
    public int PBPKDJMGDCH;    // 0x0x58
    public int COIHIDMIECG;    // 0x0x5C
    public int DGFIBJHIEAE;    // 0x0x60
}

// --------------------------------------------------------------------------
// BECNHIOAFCC
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class BECNHIOAFCC
{
    public int? <HMBMGHIBJKL>k__BackingField;    // 0x0x10
    public string <CHCCIGHEAGK>k__BackingField;    // 0x0x18
    public string <ABIGNPIONED>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BGCBOJBFFEK
//   (not directly referenced by a detected call)
public class BGCBOJBFFEK
{
    public bool <NMHINCKDBJE>k__BackingField;    // 0x0x10
    public DIAJBLLBCAE <NHKBEPIKPGM>k__BackingField;    // 0x0x14
    public int <LFNABFKLLGC>k__BackingField;    // 0x0x18
    public DateTime <LJOBCNMKNDP>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{iPKGMJBJBEH}   [Service.API]
public class BHJJEDIBNBK
{
    public long <LNOKMFMNBDO>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <MLFGAAJBABD>k__BackingField;    // 0x0x18
    public FECBCPNOCFH <AFHLMAEDFML>k__BackingField;    // 0x0x20
}
...
// base   : IGODJFCBMJJ
//   (not directly referenced by a detected call)
public class BIADPIMELLE : IGODJFCBMJJ
{
    public FNPDADHIMHM <NFAHELDLAAH>k__BackingField;    // 0x0x40
}
...
public class BKCHHHCJFOP
{
    public int <JNEKJDAPKPJ>k__BackingField;    // 0x0x10
    public List<MIGKGMLDBMC> <JCLABNIGLHF>k__BackingField;    // 0x0x18
}
...
public class BMKKKAMCIMM
{
    public KJCAJDLJIIA <OJCIKINEKHA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BPFDPFPMDCB
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class BPFDPFPMDCB
{
    public int <GKEOIBOAJMO>k__BackingField;    // 0x0x10
    public int <MLOGKEPCMAF>k__BackingField;    // 0x0x14
    public float <BFLPNMOLNPM>k__BackingField;    // 0x0x18
    public float <PNBGIKIPKJG>k__BackingField;    // 0x0x1C
    public bool <AIIAGNAMJNK>k__BackingField;    // 0x0x20
    public bool <PJDMNGAGGBI>k__BackingField;    // 0x0x21
    public bool <MNDECCDOLNN>k__BackingField;    // 0x0x22
}
...
// CEHFDICEGNH
//   (not directly referenced by a detected call)
public class CEHFDICEGNH
{
    public long <LFJEFKFKNNG>k__BackingField;    // 0x0x10
    public string <HHFNMIIPHKI>k__BackingField;    // 0x0x18
    public string <CLHKNBMGNEE>k__BackingField;    // 0x0x20
    public GFHBIOMBICI? <JLIHEOMANCN>k__BackingField;    // 0x0x28
    public string <FHMODLNDGNP>k__BackingField;    // 0x0x30
    public string <PAHJMOBPKJJ>k__BackingField;    // 0x0x38
    public ALABAIDAMKJ <AMGILJPLCDG>k__BackingField;    // 0x0x40
    public int <DHKJANENCNJ>k__BackingField;    // 0x0x44
    public int <LHOEJPHONKA>k__BackingField;    // 0x0x48
    public OCGJINGEFMK? <PCMEEJDKEJF>k__BackingField;    // 0x0x4C
    public GLPLOAANENF? <ELAMNCBLHND>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// CKKIOMKDHNP
//   (not directly referenced by a detected call)
public class CKKIOMKDHNP
{
    public long <LPALNBKCLCF>k__BackingField;    // 0x0x10
    public long <NJGNPEADEGN>k__BackingField;    // 0x0x18
    public int <HEAHCHAIHBK>k__BackingField;    // 0x0x20
    public DateTime <JGFABENAMED>k__BackingField;    // 0x0x28
    public ENLMKDGNPKG <JIJKDLAPNJP>k__BackingField;    // 0x0x30
}
...
public class CLDFMCHHPPB
{
    public NPHCPMLPPDD <GDKLCPEDCKK>k__BackingField;    // 0x0x10
    public GGKPDADAOCD <NNOJEILOPHB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CMOKGCMGDMP
//   (not directly referenced by a detected call)
public class CMOKGCMGDMP
{
    public float <KELGFFMMOCK>k__BackingField;    // 0x0x10
    public float <EOAFAJBHBKE>k__BackingField;    // 0x0x14
    public float <KHKDGODEDEJ>k__BackingField;    // 0x0x18
    public float <LILBAEMOFFH>k__BackingField;    // 0x0x1C
    public float <JOCOPLAFLOH>k__BackingField;    // 0x0x20
    public float <HMEAGGEHMID>k__BackingField;    // 0x0x24
    public float <FJJPMOMKGDM>k__BackingField;    // 0x0x28
    public float <PJJHPNJJKCH>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// CMPDCBLGEHC
//   (not directly referenced by a detected call)
public class CMPDCBLGEHC
{
    public NFAPECCGACD <CCGIHOCDBJI>k__BackingField;    // 0x0x10
    public CKKIOMKDHNP <PDKPKLDJKAI>k__BackingField;    // 0x0x18
}
...
public class CPOJANABMGH
{
    public long <LNOKMFMNBDO>k__BackingField;    // 0x0x10
    public long? <KMHBFGEIDFF>k__BackingField;    // 0x0x18
    public long? <JAMHFNNMGKG>k__BackingField;    // 0x0x28
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x38
    public string <PJGOPCNDJME>k__BackingField;    // 0x0x40
    public List<string> <PGAAEIIIPAL>k__BackingField;    // 0x0x48
    public string <GMODIFFJCFJ>k__BackingField;    // 0x0x50
    public DateTime <IGBPHOAGAOA>k__BackingField;    // 0x0x58
    public DateTime <CIFLIIOHNHA>k__BackingField;    // 0x0x60
    public JFIPGOMOFDJ <DOPGMLJCPEN>k__BackingField;    // 0x0x68
    public bool <DEMDEONNEEP>k__BackingField;    // 0x0x6C
}

// --------------------------------------------------------------------------
// DABECDCKFHL
//   (not directly referenced by a detected call)
public class DABECDCKFHL
{
    public float <AGKINOPBJLG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DDEAHPKPBMJ
//   (not directly referenced by a detected call)
public class DDEAHPKPBMJ
{
    public long <JEGOPFAPNAH>k__BackingField;    // 0x0x10
    public string <JNKKCOCKCGE>k__BackingField;    // 0x0x18
    public int <DBHJBLHLMJN>k__BackingField;    // 0x0x20
    public int <KGLCPHOGGCI>k__BackingField;    // 0x0x24
    public int <DLLOMFFMLDF>k__BackingField;    // 0x0x28
    public int <LECEIHMHNGM>k__BackingField;    // 0x0x2C
    public int <LEBIOBOFABN>k__BackingField;    // 0x0x30
    public string <INFCNANHGGL>k__BackingField;    // 0x0x38
    public string <KMHMIEBBFJI>k__BackingField;    // 0x0x40
}
...
// DNAKHMDGGDK
//   (not directly referenced by a detected call)
public class DNAKHMDGGDK
{
    public IFBMFICKLAK IBIBBABKCIJ;    // 0x0x10
    public int HAEDIHCLIHM;    // 0x0x14
    public int PGGBIAEDAHO;    // 0x0x18
}

// --------------------------------------------------------------------------
// DOCPEJOILMC
//   (not directly referenced by a detected call)
public class DOCPEJOILMC
{
    public int <EBLGJMEJOED>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DPDGKJJLBED
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class DPDGKJJLBED
{
    public int <AMGHMPHKHME>k__BackingField;    // 0x0x10
    public Guid <CIHGFDBMDJB>k__BackingField;    // 0x0x14
    public long <NPDDCMKEIID>k__BackingField;    // 0x0x28
    public long <MICNLAOOKMA>k__BackingField;    // 0x0x30
    public DateTime <LJOADIMBNGO>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// EBNECIMJCJJ
//   (not directly referenced by a detected call)
public class EBNECIMJCJJ
{
    public int <PPIDLJEOPCN>k__BackingField;    // 0x0x10
    public DateTime? <BDLBAPBMMKK>k__BackingField;    // 0x0x18
    public DateTime? <KKPPPNBIPJA>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// EGNKNOBKGDJ
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class EGNKNOBKGDJ
{
    public int <MNGOJMNJLEE>k__BackingField;    // 0x0x10
}
...
// base   : IGODJFCBMJJ
//   (not directly referenced by a detected call)
public class EJPGKLHLHGJ : IGODJFCBMJJ
{
    public int <CDLLMBJJFKO>k__BackingField;    // 0x0x40
    public List<JMCJDAHKGMA> <FAMDFMCIOIO>k__BackingField;    // 0x0x48
    public List<JMCJDAHKGMA> <ODIAIOBNAJL>k__BackingField;    // 0x0x50
    public List<JMCJDAHKGMA> <GDMDPFGGMFG>k__BackingField;    // 0x0x58
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{aGLADMHLMFG}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{aGLADMHLMFG}   [Service.API]
...
public class EKOOGCIDKNI
{
    public LPKOPMMKAFM LPFJEPLFMPO;    // 0x0x10
    public LKPKICCHGAJ DAPHGLJFDGE;    // 0x0x18
}

// --------------------------------------------------------------------------
// EMCNIBPDCCF
//   (not directly referenced by a detected call)
public class EMCNIBPDCCF
{
    public long <JEGOPFAPNAH>k__BackingField;    // 0x0x10
    public string <JNKKCOCKCGE>k__BackingField;    // 0x0x18
    public int <OADBIFBCGKB>k__BackingField;    // 0x0x20
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x28
    public string <PJGOPCNDJME>k__BackingField;    // 0x0x30
    public string <GMODIFFJCFJ>k__BackingField;    // 0x0x38
    public int <JIJMMJEHLEO>k__BackingField;    // 0x0x40
    public bool <CFDKFFNNMKG>k__BackingField;    // 0x0x44
    public DateTime <LJOBCNMKNDP>k__BackingField;    // 0x0x48
    public DateTime <JGFABENAMED>k__BackingField;    // 0x0x50
    public DateTime? <AGGONGGMOHM>k__BackingField;    // 0x0x58
    public long? <ANNJCGDAKBM>k__BackingField;    // 0x0x68
    public int <MMIMEBPNLCI>k__BackingField;    // 0x0x78
    public int <JBKDMAPPAEC>k__BackingField;    // 0x0x7C
    public int <KDJNNAMGIAN>k__BackingField;    // 0x0x80
    public EPEOACMFNGH <BEEHBGPAOKL>k__BackingField;    // 0x0x84
    public EPEOACMFNGH <BGLKHPJDPCF>k__BackingField;    // 0x0x88
    public bool <PBOKCKIDJDJ>k__BackingField;    // 0x0x8C
    public bool <MBMKDPEOOEK>k__BackingField;    // 0x0x8D
    public bool <LKOOOBPPBMO>k__BackingField;    // 0x0x8E
    public int? <IPBBGKGOHNA>k__BackingField;    // 0x0x90
    public bool <JJOCPDCDCGG>k__BackingField;    // 0x0x98
}
...
public class EMLOJHBAKKE
{
    public int <MLOGKEPCMAF>k__BackingField;    // 0x0x10
    public bool <AIIAGNAMJNK>k__BackingField;    // 0x0x14
    public DateTime <CEGCEDNJKFB>k__BackingField;    // 0x0x18
    public bool <GNGNJPEDNII>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// EOGDMJELHBG
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{kHLGBIBIKCB}   [Service.API]
public class EOGDMJELHBG
{
    public string FFKMNDKOFGO;    // 0x0x10
    public string BIOOMABDFDF;    // 0x0x18
    public string JOANFJLNOFE;    // 0x0x20
    public string OEDCPFABIII;    // 0x0x28
    public string JLHAFMBLFHH;    // 0x0x30
    public KIDPOHCPGAA LPFJEPLFMPO;    // 0x0x38
    public List<string> NIMNJBLAKCC;    // 0x0x40
    public List<string> AJCLJOEOPAB;    // 0x0x48
    public string DHEBKILNEJJ;    // 0x0x50
    public List<ALNPPGMPAJC> ICJCEOBNKIA;    // 0x0x58
}
...
// --------------------------------------------------------------------------
// FBADOOOGCDO
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{aBEDFJMEPJK}   [Service.API]
public class FBADOOOGCDO
{
    public Guid <GJENEPBIJLN>k__BackingField;    // 0x0x10
    public int <AMGHMPHKHME>k__BackingField;    // 0x0x20
    public int <EIFDIMFMHFK>k__BackingField;    // 0x0x24
    public DateTime <JGFABENAMED>k__BackingField;    // 0x0x28
}
...
public class FKGHMHHANAB
{
    public long <MHFLLDLEMAO>k__BackingField;    // 0x0x10
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x18
    public string <PJGOPCNDJME>k__BackingField;    // 0x0x20
    public DateTime <JGFABENAMED>k__BackingField;    // 0x0x28
    public string <GMODIFFJCFJ>k__BackingField;    // 0x0x30
    public BAANGNHAFPO <KHJGPLIKIPN>k__BackingField;    // 0x0x38
    public int <GPNDFCDHJIO>k__BackingField;    // 0x0x3C
    public int <DCAFJGHGNLM>k__BackingField;    // 0x0x40
    public List<GGACLHFDEEM> <CGGDLIBGGND>k__BackingField;    // 0x0x48
}
...
// FNPDADHIMHM
//   (not directly referenced by a detected call)
public class FNPDADHIMHM
{
    public int <LFJEFKFKNNG>k__BackingField;    // 0x0x10
    public string <EJBJCNOFNJK>k__BackingField;    // 0x0x18
    public string <NGDKFHCODBF>k__BackingField;    // 0x0x20
    public string <HHFNMIIPHKI>k__BackingField;    // 0x0x28
    public string <ALEIFEBEJIL>k__BackingField;    // 0x0x30
    public GFHBIOMBICI? <JLIHEOMANCN>k__BackingField;    // 0x0x38
    public string <FHMODLNDGNP>k__BackingField;    // 0x0x40
    public string <PAHJMOBPKJJ>k__BackingField;    // 0x0x48
    public bool <JLFJHCLBKAJ>k__BackingField;    // 0x0x50
    public bool <LLPDFOCHKPL>k__BackingField;    // 0x0x51
    public bool <MLMGFBHBECH>k__BackingField;    // 0x0x52
    public GLPLOAANENF <GFNONGNHDEJ>k__BackingField;    // 0x0x54
    public FFPKFNOMDAD <JFLKCBFANJI>k__BackingField;    // 0x0x58
    public int <AAOMFDMINJP>k__BackingField;    // 0x0x5C
    public JAMKNPOKCDM <EMILNGEBAHP>k__BackingField;    // 0x0x60
    public OCGJINGEFMK <OIPEKNECBPF>k__BackingField;    // 0x0x64
    public int? <OPNBCJHLEMO>k__BackingField;    // 0x0x68
    public string <CNGANCGPIGI>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// FOFOBBINEFD
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class FOFOBBINEFD
{
    public int <GMGAIEGOPLO>k__BackingField;    // 0x0x10
    public string <BMGGMLEHGCN>k__BackingField;    // 0x0x18
    public string <CEJBFLFEEJC>k__BackingField;    // 0x0x20
    public string <IBNIMBKOMPL>k__BackingField;    // 0x0x28
    public string <PMOKFKIOHOH>k__BackingField;    // 0x0x30
    public string <IJIBLPOGJOI>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// FOJKBHOFIGA
//   (not directly referenced by a detected call)
public class FOJKBHOFIGA
{
    public int <GEHMACBCOMB>k__BackingField;    // 0x0x10
    public KJCAJDLJIIA <OJCIKINEKHA>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// FPABFKNCAIE
//   (not directly referenced by a detected call)
public class FPABFKNCAIE
{
    public Guid <IEOMLJEHGGO>k__BackingField;    // 0x0x10
    public int <AMGHMPHKHME>k__BackingField;    // 0x0x20
    public int <LCLNECGIKHB>k__BackingField;    // 0x0x24
    public Guid <OAMKNAOJMMN>k__BackingField;    // 0x0x28
    public DateTime <LJOBCNMKNDP>k__BackingField;    // 0x0x38
    public LKPKICCHGAJ <CJFEKCBOEDH>k__BackingField;    // 0x0x40
}
...
public class GDCAAPNBFLO
{
    public string <CFEHJJAGHGI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GDDBJFJKALG
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class GDDBJFJKALG
{
    public OAOLEBJGILF <LJBPPJBLCOF>k__BackingField;    // 0x0x10
    public int <MNGOJMNJLEE>k__BackingField;    // 0x0x14
    public long <FKELJIKDCGF>k__BackingField;    // 0x0x18
    public bool <DCMKHBDOGMJ>k__BackingField;    // 0x0x20
    public string <ABEBJDBNFEK>k__BackingField;    // 0x0x28
    public int? <NGINLBKMJDA>k__BackingField;    // 0x0x30
    public bool <PDFFGBAODDI>k__BackingField;    // 0x0x38
    public string <LHMHNHOFJMK>k__BackingField;    // 0x0x40
    public float <KEDPOEICFHE>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// GGACLHFDEEM
//   RESPONSE GET    api/groups/v1/memberships/{lMDHBHNCBFE}   [Service.API]
public class GGACLHFDEEM
{
    public long <MHFLLDLEMAO>k__BackingField;    // 0x0x10
    public int <HEAHCHAIHBK>k__BackingField;    // 0x0x18
    public FKPDCJHNHNN <JAPNEEIFJGL>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// GGKPDADAOCD
//   (not directly referenced by a detected call)
public class GGKPDADAOCD
{
    public long <MONDPICPKOH>k__BackingField;    // 0x0x10
    public Guid <JNKKCOCKCGE>k__BackingField;    // 0x0x18
    public long <LNOKMFMNBDO>k__BackingField;    // 0x0x28
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x30
    public string <PJGOPCNDJME>k__BackingField;    // 0x0x38
    public int <IPBBGKGOHNA>k__BackingField;    // 0x0x40
    public Guid? <NIILEOHLLIK>k__BackingField;    // 0x0x44
    public DateTime <JGFABENAMED>k__BackingField;    // 0x0x58
}
...
public class GHEHBEPHPBP : KNNGLLJLAHK
{
    public int <HAFKAFBJIKB>k__BackingField;    // 0x0x30
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x38
    public DateTime <IPLHDJAENKO>k__BackingField;    // 0x0x40
    public DateTime <JDFMKCJFNBM>k__BackingField;    // 0x0x48
    public FFPKFNOMDAD <JFLKCBFANJI>k__BackingField;    // 0x0x50
    public IGODJFCBMJJ <BKAIAPMMGAO>k__BackingField;    // 0x0x58
    public List<EJPGKLHLHGJ> <OKBBIECCGHA>k__BackingField;    // 0x0x60
    public BGCBOJBFFEK <HFKFOMHPFHD>k__BackingField;    // 0x0x68
}
...
public class GINEBFBCBGO
{
    public List<MFBNNIHAGLG> <JFLIAEKMCAD>k__BackingField;    // 0x0x10
    public string <JGMBBJNCDFE>k__BackingField;    // 0x0x18
}
...
public class GKMOOJBLHDF : HGNGKKKMAFO
{
    public DEELJCOCLFP? <PGCFCAONKID>k__BackingField;    // 0x0x18
    public HGGNIGPMNIM <KLICMCBPMFG>k__BackingField;    // 0x0x20
}
...
// GMKMAKCPANL
//   (not directly referenced by a detected call)
public class GMKMAKCPANL
{
    public int <KNJHGIAJAJG>k__BackingField;    // 0x0x10
}
...
public class GPLPIILLFNE
{
    public List<int> <FPBBHDHOCFG>k__BackingField;    // 0x0x10
    public string <JGMBBJNCDFE>k__BackingField;    // 0x0x18
}
...
public class HEIEJKMFMDF
{
    public List<OMHGPOOLLFE> <PGAAEIIIPAL>k__BackingField;    // 0x0x10
}
...
public class HGGNIGPMNIM
{
    public int <AMGHMPHKHME>k__BackingField;    // 0x0x10
    public Guid <CIHGFDBMDJB>k__BackingField;    // 0x0x14
    public long <NPDDCMKEIID>k__BackingField;    // 0x0x28
    public DateTime <LJOBCNMKNDP>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// HMKGEONDMMA
//   (not directly referenced by a detected call)
public class HMKGEONDMMA
{
    public FFPKFNOMDAD <JFLKCBFANJI>k__BackingField;    // 0x0x10
    public int <IPBBGKGOHNA>k__BackingField;    // 0x0x14
    public EBNECIMJCJJ <HEHJBHGHDNH>k__BackingField;    // 0x0x18
}
...
// IGODJFCBMJJ
//   (not directly referenced by a detected call)
public class IGODJFCBMJJ
{
    public int <EIFDIMFMHFK>k__BackingField;    // 0x0x10
    public LEJBKAMOGDL <JIJKDLAPNJP>k__BackingField;    // 0x0x14
    public List<HMKGEONDMMA> <PLDGFFEHHFN>k__BackingField;    // 0x0x18
    public List<HMKGEONDMMA> <BHDHDCPEIGM>k__BackingField;    // 0x0x20
    public bool <HHGBGKIKCAO>k__BackingField;    // 0x0x28
    public DateTime? <PAEPEKJNMGG>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// IHGMDAKOMGB
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{nDEBKBIAHHC}   [Service.API]
//   RESPONSE POST   api/playerevents/v2/{eventId}   [Service.API]
public class IHGMDAKOMGB
{
    public NFAPECCGACD <CCGIHOCDBJI>k__BackingField;    // 0x0x10
    public KJCAJDLJIIA <OJCIKINEKHA>k__BackingField;    // 0x0x18
    public KOABCEEMFAC <NBOEHCCOJGM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IOPLDAACMPP
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class IOPLDAACMPP
{
    public FFPKFNOMDAD <JFLKCBFANJI>k__BackingField;    // 0x0x10
    public DEPJFJOJJKN <ECBCPAOKDJK>k__BackingField;    // 0x0x14
    public int <JBOJELCDAHM>k__BackingField;    // 0x0x18
    public int <GFHLLHDFCMP>k__BackingField;    // 0x0x1C
    public int <INMIAFGPIJI>k__BackingField;    // 0x0x20
    public BGLMHNDAEPJ <GGDJCOMBGBE>k__BackingField;    // 0x0x24
    public bool <NHMJCCAADCL>k__BackingField;    // 0x0x28
    public float <IBHENFAHEGG>k__BackingField;    // 0x0x2C
    public int <BOANOPBNPDD>k__BackingField;    // 0x0x30
    public bool <POLBPGINONK>k__BackingField;    // 0x0x34
}
...
// JBMKFCHOJJE
//   (not directly referenced by a detected call)
public class JBMKFCHOJJE
{
    public int <GKDGGKMNLPL>k__BackingField;    // 0x0x10
    public int <MBKCBMLONPJ>k__BackingField;    // 0x0x14
    public int <IHHCOADEDAC>k__BackingField;    // 0x0x18
}
...
public class JHFNJCJOHEC
{
    public List<string> <MHKMNOBGEFF>k__BackingField;    // 0x0x10
    public List<string> <IBPEANFEGJM>k__BackingField;    // 0x0x18
    public List<string> <FLHPPFAEJCC>k__BackingField;    // 0x0x20
}
...
public class JIAGOPNMBHI
{
    public Guid <MGDMAFMHINB>k__BackingField;    // 0x0x10
    public Guid <CIHGFDBMDJB>k__BackingField;    // 0x0x20
    public int <BCGPIFNOGOE>k__BackingField;    // 0x0x30
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x38
    public long <DDLMNDHAPMK>k__BackingField;    // 0x0x40
    public long <IPBBGKGOHNA>k__BackingField;    // 0x0x48
    public DateTime <LJOBCNMKNDP>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// JMCJDAHKGMA
//   (not directly referenced by a detected call)
public class JMCJDAHKGMA
{
    public bool <AMNPGCLBHBO>k__BackingField;    // 0x0x10
    public FNPDADHIMHM <NFAHELDLAAH>k__BackingField;    // 0x0x18
    public float <BCFCMCCCLOP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JMKCLENCKFJ
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class JMKCLENCKFJ
{
    public int <LMFCKKFNJGF>k__BackingField;    // 0x0x10
    public string <FCIIBIDNJFO>k__BackingField;    // 0x0x18
    public List<JNHOAKNGEPJ> <FIHIGILNHMO>k__BackingField;    // 0x0x20
    public CEHFDICEGNH <JBENHCFLELL>k__BackingField;    // 0x0x28
    public string <IMAEFGGLDNP>k__BackingField;    // 0x0x30
    public DateTime <IPLHDJAENKO>k__BackingField;    // 0x0x38
    public DateTime <JDFMKCJFNBM>k__BackingField;    // 0x0x40
    public DateTime <KCKDHEJAAFK>k__BackingField;    // 0x0x48
    public bool? <DNPFBJLDGNK>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// JNHOAKNGEPJ
//   (not directly referenced by a detected call)
public class JNHOAKNGEPJ
{
    public int <MJOELOPMGFN>k__BackingField;    // 0x0x10
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x18
    public string <HFBHEPNBHOD>k__BackingField;    // 0x0x20
    public string <PJGOPCNDJME>k__BackingField;    // 0x0x28
    public string <NGDKFHCODBF>k__BackingField;    // 0x0x30
    public bool <GLLHOPBOHIG>k__BackingField;    // 0x0x38
    public int <GMGAIEGOPLO>k__BackingField;    // 0x0x3C
    public OPOEJHGPFMK <MKPFPFEPABH>k__BackingField;    // 0x0x40
    public MIEIEDAKDEO NGDDDMAPEIA;    // 0x0x48
    public MIEIEDAKDEO KDHMNBBHEHH;    // 0x0x50
    public MIEIEDAKDEO ICKIAPMFKHC;    // 0x0x58
    public LHLNNJGJAKA FINFLMCMIJK;    // 0x0x60
}

// --------------------------------------------------------------------------
// KEMAMALFCFH
//   (not directly referenced by a detected call)
public class KEMAMALFCFH
{
    public int <HNGPHFIIEEH>k__BackingField;    // 0x0x10
}
...
public class KJPBHAHHGHL
{
    public LPKOPMMKAFM LPFJEPLFMPO;    // 0x0x10
    public FPABFKNCAIE LGHJFDDABJP;    // 0x0x18
}
...
public class KOABCEEMFAC
{
    public KKKDPHEPNFB <OJCIKINEKHA>k__BackingField;    // 0x0x10
    public List<string> <PGAAEIIIPAL>k__BackingField;    // 0x0x18
}
...
public class LFEAIHIBHMF
{
    public string <DKDJJJCKMPG>k__BackingField;    // 0x0x10
    public string <DFJCIPNBIGJ>k__BackingField;    // 0x0x18
}
...
public class LKBIAEJOMHC
{
    public int <HELOALMPENG>k__BackingField;    // 0x0x10
    public BCNNIEJFCEC <JIJKDLAPNJP>k__BackingField;    // 0x0x14
    public CBKMALGKIBD <KIFPLIMODCO>k__BackingField;    // 0x0x18
    public CBKMALGKIBD <JCMCJJPMANH>k__BackingField;    // 0x0x1C
    public CBKMALGKIBD <ODKBKPNIOJG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LKPKICCHGAJ
//   (not directly referenced by a detected call)
public class LKPKICCHGAJ
{
    public Guid <IEOMLJEHGGO>k__BackingField;    // 0x0x10
    public long <LNOKMFMNBDO>k__BackingField;    // 0x0x20
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x28
    public string <PJGOPCNDJME>k__BackingField;    // 0x0x30
    public string <GMODIFFJCFJ>k__BackingField;    // 0x0x38
    public long <IPBBGKGOHNA>k__BackingField;    // 0x0x40
    public Guid? <NIILEOHLLIK>k__BackingField;    // 0x0x48
    public DateTime <LJOBCNMKNDP>k__BackingField;    // 0x0x60
}
...
public class MCHBPCBAGCH
{
    public List<FOJKBHOFIGA> <HCJLJDBLDEL>k__BackingField;    // 0x0x10
    public KJCAJDLJIIA <OJCIKINEKHA>k__BackingField;    // 0x0x18
}
...
// MFBNNIHAGLG
//   (not directly referenced by a detected call)
public class MFBNNIHAGLG
{
    public int <DAPLENFKIEN>k__BackingField;    // 0x0x10
    public DateTime <JGFABENAMED>k__BackingField;    // 0x0x18
    public DateTime? <LLLDBAABLMO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MGOLGOLNMGE
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class MGOLGOLNMGE
{
    public OAOLEBJGILF <LJBPPJBLCOF>k__BackingField;    // 0x0x10
    public long <NJGNPEADEGN>k__BackingField;    // 0x0x18
    public string <HAOPGCODLBC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MIGKGMLDBMC
//   (not directly referenced by a detected call)
public class MIGKGMLDBMC
{
    public DateTime? <EDDOLNBHOMK>k__BackingField;    // 0x0x10
    public DateTime? <GALOHFDGLCJ>k__BackingField;    // 0x0x20
    public OBOENGCIPHI <GDKLCPEDCKK>k__BackingField;    // 0x0x30
    public JBMKFCHOJJE <AIHBNMBAKGJ>k__BackingField;    // 0x0x38
    public bool <PCEJNKPOGDO>k__BackingField;    // 0x0x40
}
...
public class MJLKGKBHKKH
{
    public string <CEJBFLFEEJC>k__BackingField;    // 0x0x10
    public string <IBNIMBKOMPL>k__BackingField;    // 0x0x18
    public string <PMOKFKIOHOH>k__BackingField;    // 0x0x20
    public string <IJIBLPOGJOI>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// MMGKPNOIFND
//   RESPONSE GET    api/inventions/v1/personaldetails/{lLEEMHGKGKP}   [Service.API]
public class MMGKPNOIFND
{
    public bool <JCKNNNHKIKL>k__BackingField;    // 0x0x10
}
...
public class MOKILKJCACE : HGNGKKKMAFO
{
    public BEHBGLLMOIL? <PGCFCAONKID>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <MLJKGNHENIC>k__BackingField;    // 0x0x20
}
...
public class NBDMCGNMJFC
{
    public bool <NBLPLPLMLOO>k__BackingField;    // 0x0x10
    public string <ABEBJDBNFEK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NBEDJCACOJL
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class NBEDJCACOJL
{
    public long <NJGNPEADEGN>k__BackingField;    // 0x0x10
    public ENLMKDGNPKG <JIJKDLAPNJP>k__BackingField;    // 0x0x18
}
...
public class NEJJNANMCMH
{
    public bool <NBLPLPLMLOO>k__BackingField;    // 0x0x10
    public string <DOMADAOBJNE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NFAPECCGACD
//   (not directly referenced by a detected call)
public class NFAPECCGACD
{
    public long <NJGNPEADEGN>k__BackingField;    // 0x0x10
    public int <OADBIFBCGKB>k__BackingField;    // 0x0x18
    public long <LNOKMFMNBDO>k__BackingField;    // 0x0x20
    public long? <KMHBFGEIDFF>k__BackingField;    // 0x0x28
    public long? <JAMHFNNMGKG>k__BackingField;    // 0x0x38
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x48
    public string <PJGOPCNDJME>k__BackingField;    // 0x0x50
    public string <GMODIFFJCFJ>k__BackingField;    // 0x0x58
    public DateTime <IGBPHOAGAOA>k__BackingField;    // 0x0x60
    public DateTime <CIFLIIOHNHA>k__BackingField;    // 0x0x68
    public int <HABCAODPLDG>k__BackingField;    // 0x0x70
    public JFIPGOMOFDJ <DOPGMLJCPEN>k__BackingField;    // 0x0x74
    public bool <DEMDEONNEEP>k__BackingField;    // 0x0x78
    public bool <EPJMCCOPDHB>k__BackingField;    // 0x0x79
    public long? <EGJJIHFNDDH>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// NFHLNMPAPMB
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class NFHLNMPAPMB
{
    public HGGNIGPMNIM <KLICMCBPMFG>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <MLJKGNHENIC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NPHCPMLPPDD
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{kPOIBHONDPM}   [Service.API]
public enum NPHCPMLPPDD
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class OFOPLKLCBIK : KNNGLLJLAHK
{
    public List<BIADPIMELLE> LHOJEEHBDCN;    // 0x0x30
    public int <LKMEFDIKOBJ>k__BackingField;    // 0x0x38
}
...
public class OHKLOIOGHOH
{
    public Guid <CIHGFDBMDJB>k__BackingField;    // 0x0x10
    public long? <LNOKMFMNBDO>k__BackingField;    // 0x0x20
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x30
    public string <PJGOPCNDJME>k__BackingField;    // 0x0x38
    public FFPKFNOMDAD <JFLKCBFANJI>k__BackingField;    // 0x0x40
    public long <GFDGMJIJCDB>k__BackingField;    // 0x0x48
    public DateTime <JGFABENAMED>k__BackingField;    // 0x0x50
    public DateTime <LJOBCNMKNDP>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// OMHGPOOLLFE
//   (not directly referenced by a detected call)
public class OMHGPOOLLFE
{
    public string <LCLIDMNAHIK>k__BackingField;    // 0x0x10
    public MPBGJBFFMDH <JIJKDLAPNJP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OPOEJHGPFMK
//   (not directly referenced by a detected call)
public class OPOEJHGPFMK
{
    // (no instance fields in the metadata dump)
}
...
public class PAFFDBCGGBC
{
    public Dictionary<int, int> <BBOMNFFGJGE>k__BackingField;    // 0x0x10
    public List<HCPDAHHJIEJ> <DKFBKIBEMCF>k__BackingField;    // 0x0x18
    public DNAKHMDGGDK[][] <CEAKMEOAPGO>k__BackingField;    // 0x0x20
    public DOCPEJOILMC <ILFBEEKGFJA>k__BackingField;    // 0x0x28
    public CMOKGCMGDMP <MDMNGIPPGEE>k__BackingField;    // 0x0x30
    public GMKMAKCPANL <LBCNAODOLEP>k__BackingField;    // 0x0x38
    public KEMAMALFCFH <AMFOGJDPFDJ>k__BackingField;    // 0x0x40
    public DABECDCKFHL <LFDLLLGCNOC>k__BackingField;    // 0x0x48
    public string <KPIHNGHFKEF>k__BackingField;    // 0x0x50
}
...
public class GetRankRequestDTO
{
    ...
    public HKGNOJAAMNL FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public OCGJINGEFMK <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public NIPHCJPEJEL creatorAccountRole;    // 0x0x58
}
...
{
    public DPPFJDCHCIB <HJEMMMDCHIP>k__BackingField;    // 0x0x10
    public string <NFOFILGGMKD>k__BackingField;    // 0x0x18
    public bool <OPFAMCJCNID>k__BackingField;    // 0x0x20
}
...
{
    public List<DPPFJDCHCIB> <GIOMBPLNKBN>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public DJKEBCJHFME ReportCategory;    // 0x0x20
}
...
{
    public HJCLCIOEEPL? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public HJCLCIOEEPL COEBPBHNDDJ;  // wrapper
...
{
    public DJCGBLMPPAD NOOFKPKDAFM;  // wrapper
...
{
    public DEIKIHKCNGM ALJDBKKAGKE;  // wrapper
    public int? DCDNPMNLKPI;  // wrapper
...
{
    public MLPNBOMNAPA UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public OCGJINGEFMK HKKAAOILAFH;  // wrapper
    public OCGJINGEFMK? MBPPHPDKMCB;  // wrapper
...
{
    public JNHOAKNGEPJ AIEBLMJNFIE;  // wrapper
...
{
    public OAOLEBJGILF HAMPJPMCAEJ;  // wrapper
...
{
    public IReadOnlyList<ODGPEPJMAOI> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public NDNGMAMAGJA FAICPCCLMIA;  // wrapper
    public OCGJINGEFMK? FKNKHPKGACA;  // wrapper
...
{
    public EBJCDELLPCD DENOOFGKCCF;  // wrapper
...
{
    public StatusResponse> KENEHOJCGJI;  // wrapper
...
{
    public List<long> OOLLFPOHDKO;  // wrapper
    public GPJEBAOBJAB DKANIGFEEBP;  // wrapper
    public long? IPKGMJBJBEH;  // wrapper
    public IJIDCJBFNGA KENEHOJCGJI;  // wrapper
...
{
    public String> KENEHOJCGJI;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{nDEBKBIAHHC}  [API POST]
public class PlayereventsV2DeleteNDEBKBIAHHCRequest
{
    public NFAPECCGACD NDEBKBIAHHC;  // wrapper
}

// api/players/v2/objectives  [API POST]
public class PlayersV2ObjectivesRequest
{
    public List<CCOLFDCCOAE> OEOJBPFBHEL;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> GDCNJFBJGNI;  // wrapper
...
{
    public Guid? EALCBMCPDFD;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats DPKJJOLAKAG;  // wrapper
}
...
{
    public Guid OLIEDGEBMHB;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<KKJPPBHLLGF> OEOJBPFBHEL;  // wrapper
    public object objectiveType;  // candidate
...
{
    public KIDPOHCPGAA JFJKIKJIFGB;  // wrapper
}
