...
public class ACHKFLJCIGI
{
    public long <ELPNPINBAIG>k__BackingField;    // 0x0x10
    public long? <LDEFIBGICMF>k__BackingField;    // 0x0x18
    public long? <JOMDLPLDLOJ>k__BackingField;    // 0x0x28
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x38
    public string <EOLBALDOFHG>k__BackingField;    // 0x0x40
    public List<string> <NOCIMNMGJEI>k__BackingField;    // 0x0x48
    public string <DKHFCPFKKKF>k__BackingField;    // 0x0x50
    public DateTime <GLAMCMNHOJM>k__BackingField;    // 0x0x58
    public DateTime <OIFEDEJCIGA>k__BackingField;    // 0x0x60
    public JFNKAAIHOFG <FOKFDMKOPKL>k__BackingField;    // 0x0x68
    public bool <MBMGKNAGGBM>k__BackingField;    // 0x0x6C
}
...
public class ADOMADPNDLD
{
    public HTTPResponse FNDMLKCKPMM;    // 0x0x10
    public int? FGLCDHKHLHM;    // 0x0x18
    public string OLMBMDHHJEE;    // 0x0x20
    public byte[] AADMGJDCJHC;    // 0x0x28
    public string JBMBAODLFJB;    // 0x0x30
}

// --------------------------------------------------------------------------
// AFCIHMKOBDC
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class AFCIHMKOBDC
{
    public BBGIAOFFGBL <FLHCJADECHB>k__BackingField;    // 0x0x10
    public List<string> <NOCIMNMGJEI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ANCJKBIFBBE
//   (not directly referenced by a detected call)
public class ANCJKBIFBBE
{
    public bool <GPBLNBGLCBC>k__BackingField;    // 0x0x10
    public GEPFOIBNKAJ <EECLPFAAGJG>k__BackingField;    // 0x0x18
    public float <HNNKEGIIJDO>k__BackingField;    // 0x0x20
}
...
public class BANEGGGDMHD
{
    public JLMBNAKFLMJ <FDFBLFBAIGO>k__BackingField;    // 0x0x10
    public long <IJPCCGHGAFD>k__BackingField;    // 0x0x18
    public string <NMNNKHBPGDB>k__BackingField;    // 0x0x20
}
...
public class BCELFPCMKCI : IDHMOHKGJEI
{
    public IEGLMONNIOA? <PMBNDMOLDAH>k__BackingField;    // 0x0x18
    public OFOFNFNJMAC <HALIALDJGMO>k__BackingField;    // 0x0x20
}
...
public class BDAFNLPPMPE
{
    public bool <EKKJBIBIAKG>k__BackingField;    // 0x0x10
    public string <LEJIJFPNAPM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BFIDGAGEDKF
//   RESPONSE GET    api/groups/v1/memberships/{eFDNPCILCFC}   [Service.API]
//   RESPONSE GET    api/groups/v1/name/{nameId}   [Service.API]
//   RESPONSE GET    api/groups/v1/{groupId}   [Service.API]
public class BFIDGAGEDKF
{
    public long <LCKOFMILNHC>k__BackingField;    // 0x0x10
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x18
    public string <EOLBALDOFHG>k__BackingField;    // 0x0x20
    public DateTime <CAIPOJJGMHH>k__BackingField;    // 0x0x28
    public string <DKHFCPFKKKF>k__BackingField;    // 0x0x30
    public FMLDCMGJDAO <BFIMCGKLJHC>k__BackingField;    // 0x0x38
    public int <ANLJJGDFKHE>k__BackingField;    // 0x0x3C
    public int <ANCHMNNIDEP>k__BackingField;    // 0x0x40
    public List<IOKNBGOAMKG> <DNHIPGAHBGO>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// BMJIOMHKHMJ
//   (not directly referenced by a detected call)
public class BMJIOMHKHMJ
{
    public float <JLFFLPGDBBP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BOLDENAEJBK
//   (not directly referenced by a detected call)
public class BOLDENAEJBK
{
    public int <GNDBEJPOPEN>k__BackingField;    // 0x0x10
    public FKJOKGEIABM <FLHCJADECHB>k__BackingField;    // 0x0x14
}
...
public class CIALEDHKENE
{
    public List<IMIIIGNLFIH> <CMEDEEKHPLA>k__BackingField;    // 0x0x10
    public List<PMDCMNIDJKJ> <MLKJMGJPHGD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CIKLKPBOIHF
//   (not directly referenced by a detected call)
public class CIKLKPBOIHF
{
    public int <CFPHEGGMDIJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CMBJHLPDGKJ
//   (not directly referenced by a detected call)
public class CMBJHLPDGKJ
{
    public long <CKPPFNKKGEG>k__BackingField;    // 0x0x10
    public string <AHKACAEIHDI>k__BackingField;    // 0x0x18
    public string <HCKJIECGKFM>k__BackingField;    // 0x0x20
    public EEOMFACLCNA? <IGBELDCFDHH>k__BackingField;    // 0x0x28
    public string <LHKKJKONHAI>k__BackingField;    // 0x0x30
    public string <FIAJEBGDHCM>k__BackingField;    // 0x0x38
    public NGGDKIMBACF <LOANPPMPMGC>k__BackingField;    // 0x0x40
    public int <OJGLDMIDFEH>k__BackingField;    // 0x0x44
    public int <JPPODCJFHMG>k__BackingField;    // 0x0x48
    public DJBBIEMBDJJ? <PDGNNDIIPKI>k__BackingField;    // 0x0x4C
    public IMCEJOBGHLM? <GAOBDICKACN>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// CNLDJCMDKPO
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{mOANBPOIBJN}   [Service.API]
public enum CNLDJCMDKPO
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
// DACFCFDJKFL
//   (not directly referenced by a detected call)
public class DACFCFDJKFL
{
    public int <JDDDAJHGGHL>k__BackingField;    // 0x0x10
    public DateTime? <HFGHKDDBNLD>k__BackingField;    // 0x0x18
    public DateTime? <GBONOBIJGBP>k__BackingField;    // 0x0x28
}
...
public class DGOAEFDHCLL
{
    public DCEPMLKNJGL <ALNBMKLJLBB>k__BackingField;    // 0x0x10
    public ANHNIKMNJEM <LPCLAAENNDI>k__BackingField;    // 0x0x14
    public int <OKDNCMFIBDB>k__BackingField;    // 0x0x18
    public int <GAJBKJNIDEB>k__BackingField;    // 0x0x1C
    public int <CFELCINGLFH>k__BackingField;    // 0x0x20
    public OLIEKDCMKAI <LPCPJNMPDOC>k__BackingField;    // 0x0x24
    public bool <JOLDPKBHNIM>k__BackingField;    // 0x0x28
    public float <PDNPEOPCPNF>k__BackingField;    // 0x0x2C
    public int <DFPKJHIHDPA>k__BackingField;    // 0x0x30
    public bool <JOIHLNBHCAO>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// DIHKKMGDENJ
//   (not directly referenced by a detected call)
public class DIHKKMGDENJ
{
    public Guid <GDCIFJGJFLG>k__BackingField;    // 0x0x10
    public long <ELPNPINBAIG>k__BackingField;    // 0x0x20
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x28
    public string <EOLBALDOFHG>k__BackingField;    // 0x0x30
    public string <DKHFCPFKKKF>k__BackingField;    // 0x0x38
    public long <NGGHJKCDLGH>k__BackingField;    // 0x0x40
    public Guid? <OJKCJNDDDNO>k__BackingField;    // 0x0x48
    public DateTime <LAMEOLIJGHM>k__BackingField;    // 0x0x60
}
...
// --------------------------------------------------------------------------
// DKLKLJGHBEL
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{jODGPNEIOOF}   [Service.API]
public class DKLKLJGHBEL
{
    public uint BNNNLOHAPAG;    // 0x0x10
    public string EPJAPACKECE;    // 0x0x18
    public string AAKAGOFOHDJ;    // 0x0x20
    public DateTime LHMLNMGLCLP;    // 0x0x28
    public DateTime? FOCPMOPJBFG;    // 0x0x30
    public bool EDGKDMJKFJN;    // 0x0x40
    public List<NEJKMOLIOKB> FBPDNAJOONI;    // 0x0x48
    public List<string> JHBHKLGDANG;    // 0x0x50
    public int GLIPIEINIIP;    // 0x0x58
    public int ADAMCJJIOBD;    // 0x0x5C
    public int NGBJCIHOONM;    // 0x0x60
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{fOEHAFDLIHC}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{fOEHAFDLIHC}   [Service.API]
...
public class DLHDDMGNIML
{
    public KCJJKKOEIPB BAGOPAEMHJP;    // 0x0x10
    public DIHKKMGDENJ FHBHFEFLCHD;    // 0x0x18
}

// --------------------------------------------------------------------------
// ECNKLKDHIAN
//   (not directly referenced by a detected call)
public class ECNKLKDHIAN
{
    public Guid <GDCIFJGJFLG>k__BackingField;    // 0x0x10
    public int <MBDOIAPDDKP>k__BackingField;    // 0x0x20
    public int <GOHCOPMALHN>k__BackingField;    // 0x0x24
    public Guid <LKELMMOHFEC>k__BackingField;    // 0x0x28
    public DateTime <LAMEOLIJGHM>k__BackingField;    // 0x0x38
    public DIHKKMGDENJ <GONKGDCCOEK>k__BackingField;    // 0x0x40
}
...
public class EHDIEKJGDMM
{
    public string <CILHDLBEEEJ>k__BackingField;    // 0x0x10
    public string <KDPGOMLOAPE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EHOEPMABELM
//   (not directly referenced by a detected call)
public class EHOEPMABELM
{
    public int <GLPNGDDBHBE>k__BackingField;    // 0x0x10
    public DateTime <CAIPOJJGMHH>k__BackingField;    // 0x0x18
    public DateTime? <CKANKNAHJPL>k__BackingField;    // 0x0x20
}
...
public class FFMHIEEKJDJ
{
    public Dictionary<int, int> <DCLOHOPGJGG>k__BackingField;    // 0x0x10
    public List<CJIDOAIKBLL> <BLKKPHPONMC>k__BackingField;    // 0x0x18
    public PJIAMPJAAAG[][] <FPDGCKGAPLP>k__BackingField;    // 0x0x20
    public CIKLKPBOIHF <DAPEKCCKHIB>k__BackingField;    // 0x0x28
    public JMEFMOFBONL <EPMGBBAJGNK>k__BackingField;    // 0x0x30
    public IDBDLBJLHPF <LGAPMFJBDEA>k__BackingField;    // 0x0x38
    public LOJNFAAAFJD <KNIHODOFEEE>k__BackingField;    // 0x0x40
    public BMJIOMHKHMJ <ODBPJDCIAMK>k__BackingField;    // 0x0x48
    public string <HKGMBLDBIDF>k__BackingField;    // 0x0x50
}
...
public class FJCLKHFFBCF
{
    public List<BOLDENAEJBK> <LAMFKKJJIHB>k__BackingField;    // 0x0x10
    public FKJOKGEIABM <FLHCJADECHB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FJEDFPDJMLP
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class FJEDFPDJMLP
{
    public int <AHJBHMPDCHB>k__BackingField;    // 0x0x10
    public string <EHBJFHEMHDO>k__BackingField;    // 0x0x18
    public List<IOHNBBKJPLP> <LCHGNFOLNKK>k__BackingField;    // 0x0x20
    public CMBJHLPDGKJ <HKOEOECBMIG>k__BackingField;    // 0x0x28
    public string <NDJFJPJPOOA>k__BackingField;    // 0x0x30
    public DateTime <HLFGGAMKCNC>k__BackingField;    // 0x0x38
    public DateTime <GCGAMDHPIIA>k__BackingField;    // 0x0x40
    public DateTime <HEFIDKHBHJA>k__BackingField;    // 0x0x48
    public bool? <ANBNMEBANED>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// FJGPPAJAFNE
//   (not directly referenced by a detected call)
public class FJGPPAJAFNE
{
    public DateTime? <IKEDDLONMPP>k__BackingField;    // 0x0x10
    public DateTime? <IMCBAEKNOFO>k__BackingField;    // 0x0x20
    public FFPDNCMHCIO <FKKFJMENKOO>k__BackingField;    // 0x0x30
    public GONHHLCOOIA <BGGKFHAILEN>k__BackingField;    // 0x0x38
    public bool <CAJOKANHGAA>k__BackingField;    // 0x0x40
}
...
public class FNHIBHHECOI
{
    public int <PDLHAFFDNEP>k__BackingField;    // 0x0x10
    public int <NDAPNNCFIKA>k__BackingField;    // 0x0x14
    public float <NNPIBEHNANK>k__BackingField;    // 0x0x18
    public float <AKNJAGKJLPK>k__BackingField;    // 0x0x1C
    public bool <EMMEDDNBLFP>k__BackingField;    // 0x0x20
    public bool <MFFKMONHDFO>k__BackingField;    // 0x0x21
    public bool <HDMMBCCLKMO>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// GEPFOIBNKAJ
//   (not directly referenced by a detected call)
public class GEPFOIBNKAJ
{
    public int <CKPPFNKKGEG>k__BackingField;    // 0x0x10
    public string <FPMLFKGLCJH>k__BackingField;    // 0x0x18
    public string <NGBICCPMFEN>k__BackingField;    // 0x0x20
    public string <AHKACAEIHDI>k__BackingField;    // 0x0x28
    public string <LMBDOPHEDLN>k__BackingField;    // 0x0x30
    public EEOMFACLCNA? <IGBELDCFDHH>k__BackingField;    // 0x0x38
    public string <LHKKJKONHAI>k__BackingField;    // 0x0x40
    public string <FIAJEBGDHCM>k__BackingField;    // 0x0x48
    public bool <NNHAIHPMBGE>k__BackingField;    // 0x0x50
    public bool <KEOGEALLPCF>k__BackingField;    // 0x0x51
    public bool <FKEPHGPEMGP>k__BackingField;    // 0x0x52
    public IMCEJOBGHLM <HLDDLKLOFAC>k__BackingField;    // 0x0x54
    public DCEPMLKNJGL <ALNBMKLJLBB>k__BackingField;    // 0x0x58
    public int <HJDKPIBGLPB>k__BackingField;    // 0x0x5C
    public HAAODEOPNJJ <NNAAPJDNJIB>k__BackingField;    // 0x0x60
    public DJBBIEMBDJJ <MBHBIBMOIGC>k__BackingField;    // 0x0x64
    public int? <PKFFEBBPHAK>k__BackingField;    // 0x0x68
    public string <OMGBOKHLPFH>k__BackingField;    // 0x0x70
}
...
public class GGIONNELGHO
{
    public List<EHOEPMABELM> <FINJLJMFOBE>k__BackingField;    // 0x0x10
    public string <BIOOOKLGCDB>k__BackingField;    // 0x0x18
}
...
// base   : OAMJFOKLILE
//   (not directly referenced by a detected call)
public class GOCLMGMIADN : OAMJFOKLILE
{
    public GEPFOIBNKAJ <EECLPFAAGJG>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// GONHHLCOOIA
//   (not directly referenced by a detected call)
public class GONHHLCOOIA
{
    public int <LCINDAFPPDA>k__BackingField;    // 0x0x10
    public int <AHOFKFGDHBP>k__BackingField;    // 0x0x14
    public int <DBHMIJOLIFF>k__BackingField;    // 0x0x18
}
...
public class GPMOLCHGANJ
{
    public List<int> <OOKKMFBKAIO>k__BackingField;    // 0x0x10
    public string <BIOOOKLGCDB>k__BackingField;    // 0x0x18
}
...
public class HJPLKGHKFCF
{
    public CNLDJCMDKPO <FKKFJMENKOO>k__BackingField;    // 0x0x10
    public PPDFDBMECNL <HPHPMMPOFFC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HLEDPBDHCLO
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class HLEDPBDHCLO
{
    public long <IJPCCGHGAFD>k__BackingField;    // 0x0x10
    public PJLLHNFNMKI <PIKJHEALCAJ>k__BackingField;    // 0x0x18
}
...
public class HLGLGCAIIFJ : IDHMOHKGJEI
{
    public LPAFPJNKHAG? <PMBNDMOLDAH>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <GGCOKPJMINL>k__BackingField;    // 0x0x20
}
...
public class HNKJMOELJDC : HEMIMDBFGJN
{
    public int <BMCFAIMFLAN>k__BackingField;    // 0x0x30
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x38
    public DateTime <HLFGGAMKCNC>k__BackingField;    // 0x0x40
    public DateTime <GCGAMDHPIIA>k__BackingField;    // 0x0x48
    public DCEPMLKNJGL <ALNBMKLJLBB>k__BackingField;    // 0x0x50
    public OAMJFOKLILE <LBMEFKILPKB>k__BackingField;    // 0x0x58
    public List<LNMDJGAAEHP> <FIAGCPFEBIK>k__BackingField;    // 0x0x60
    public JIMCBANEGKO <DOBKINEJGLD>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// IAODDEMGHOG
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{iCJHNIBFIDM}   [Service.API]
public class IAODDEMGHOG
{
    public Guid <FJDLCDAPGLE>k__BackingField;    // 0x0x10
    public int <MBDOIAPDDKP>k__BackingField;    // 0x0x20
    public int <ENOOCKMDFCC>k__BackingField;    // 0x0x24
    public DateTime <CAIPOJJGMHH>k__BackingField;    // 0x0x28
}
...
public class ICBNBAMMOKH
{
    public NOFJMEIJJNN <FKKFJMENKOO>k__BackingField;    // 0x0x10
    public LHFDFKBJCEJ <NMMBNIIMPNH>k__BackingField;    // 0x0x18
    public NBLGCPHGIGP <BFHBDDCHBMJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ICPMEALENML
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class ICPMEALENML
{
    public OFOFNFNJMAC <HALIALDJGMO>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <GGCOKPJMINL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IDBDLBJLHPF
//   (not directly referenced by a detected call)
public class IDBDLBJLHPF
{
    public int <JHLDGMJMGLL>k__BackingField;    // 0x0x10
}
...
public class IHENDJCOBOK
{
    public int <NDAPNNCFIKA>k__BackingField;    // 0x0x10
    public bool <EMMEDDNBLFP>k__BackingField;    // 0x0x14
    public DateTime <HODNFJKELJJ>k__BackingField;    // 0x0x18
    public bool <GIOHMGAHMAN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IHMPGOEOPFJ
//   (not directly referenced by a detected call)
public class IHMPGOEOPFJ
{
    public string <FOGMLDIOOMJ>k__BackingField;    // 0x0x10
    public KAKAHBGDKPH <PIKJHEALCAJ>k__BackingField;    // 0x0x18
}
...
public class IKOLDGCFGCP
{
    public string <BEBBIAIGBDM>k__BackingField;    // 0x0x10
    public string <FGHKDGACCDN>k__BackingField;    // 0x0x18
    public string <NNNHEINIIOL>k__BackingField;    // 0x0x20
    public string <KLDFGKDAKMA>k__BackingField;    // 0x0x28
}
...
// IMIIIGNLFIH
//   (not directly referenced by a detected call)
public class IMIIIGNLFIH
{
    public long <IJPCCGHGAFD>k__BackingField;    // 0x0x10
    public int <LHICEOEMJLC>k__BackingField;    // 0x0x18
    public long <ELPNPINBAIG>k__BackingField;    // 0x0x20
    public long? <LDEFIBGICMF>k__BackingField;    // 0x0x28
    public long? <JOMDLPLDLOJ>k__BackingField;    // 0x0x38
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x48
    public string <EOLBALDOFHG>k__BackingField;    // 0x0x50
    public string <DKHFCPFKKKF>k__BackingField;    // 0x0x58
    public DateTime <GLAMCMNHOJM>k__BackingField;    // 0x0x60
    public DateTime <OIFEDEJCIGA>k__BackingField;    // 0x0x68
    public int <CGBIBIJDIBO>k__BackingField;    // 0x0x70
    public JFNKAAIHOFG <FOKFDMKOPKL>k__BackingField;    // 0x0x74
    public bool <MBMGKNAGGBM>k__BackingField;    // 0x0x78
    public bool <KBMIENHEAMO>k__BackingField;    // 0x0x79
    public long? <HJKIBDLOKPG>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// IOHNBBKJPLP
//   (not directly referenced by a detected call)
public class IOHNBBKJPLP
{
    public int <HJBFGOEGEMF>k__BackingField;    // 0x0x10
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x18
    public string <ENNPDACJCFD>k__BackingField;    // 0x0x20
    public string <EOLBALDOFHG>k__BackingField;    // 0x0x28
    public string <NGBICCPMFEN>k__BackingField;    // 0x0x30
    public bool <DONMPOAMPEB>k__BackingField;    // 0x0x38
    public int <DJKNGKFKLOM>k__BackingField;    // 0x0x3C
    public JCABLJKNGFP <DDMJODDHCGE>k__BackingField;    // 0x0x40
    public LNJGJJDMHEF IBKCMINNLCP;    // 0x0x48
    public LNJGJJDMHEF MPBFPKKIMDK;    // 0x0x50
    public LNJGJJDMHEF ONAJLNNACBA;    // 0x0x58
    public AFIIDNOJKDG POPMDEHKGNN;    // 0x0x60
}
...
public class IOJCJIEJMNB
{
    public List<string> <GIJJMDIPKKH>k__BackingField;    // 0x0x10
    public List<string> <BLJLIAJOLPG>k__BackingField;    // 0x0x18
    public List<string> <IPFBFNNKGME>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IOKJAFHPEKM
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.API]
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{kEEMCFPBEGA}   [Service.API]
public class IOKJAFHPEKM
{
    public long <ELPNPINBAIG>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <BNDEHKOEDDP>k__BackingField;    // 0x0x18
    public EOMOOPIPPCO <FPLHMFLBBJC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IOKNBGOAMKG
//   (not directly referenced by a detected call)
public class IOKNBGOAMKG
{
    public long <LCKOFMILNHC>k__BackingField;    // 0x0x10
    public int <PMJFCAHNOHF>k__BackingField;    // 0x0x18
    public CAHCOJBCIMN <EPIMLNBPIDD>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// IONNIANGDBJ
//   RESPONSE POST   api/settings/v2/set   [Service.API]
public class IONNIANGDBJ
{
    public bool IBOBBKPGIKI;    // 0x0x10
    public bool IIEEALCEGAN;    // 0x0x11
}

// --------------------------------------------------------------------------
// JCABLJKNGFP
//   (not directly referenced by a detected call)
public class JCABLJKNGFP
{
    // (no instance fields in the metadata dump)
}
...
public class JDHKEAOJGJM
{
    public FKJOKGEIABM <FLHCJADECHB>k__BackingField;    // 0x0x10
}
...
// JIMCBANEGKO
//   (not directly referenced by a detected call)
public class JIMCBANEGKO
{
    public bool <HPFPCLHFGPM>k__BackingField;    // 0x0x10
    public KPEGAACDCAH <EPLGFAOAMBH>k__BackingField;    // 0x0x14
    public int <ONKPKHENGBJ>k__BackingField;    // 0x0x18
    public DateTime <LAMEOLIJGHM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JMEFMOFBONL
//   (not directly referenced by a detected call)
public class JMEFMOFBONL
{
    public float <GLMGCPHGDNB>k__BackingField;    // 0x0x10
    public float <MGLNMLIHBHD>k__BackingField;    // 0x0x14
    public float <DKEEBFFBKFI>k__BackingField;    // 0x0x18
    public float <EKJBBJBLEBN>k__BackingField;    // 0x0x1C
    public float <LELAMMEBCMA>k__BackingField;    // 0x0x20
    public float <IHHEJLAIGGB>k__BackingField;    // 0x0x24
    public float <FJIMALPOJBK>k__BackingField;    // 0x0x28
    public float <BBDJGNGFFFG>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// JOBLCNNNAGD
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class JOBLCNNNAGD
{
    public List<IHMPGOEOPFJ> <NOCIMNMGJEI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KAEEPMMJNAH
//   (not directly referenced by a detected call)
public class KAEEPMMJNAH
{
    public DateTime PIKJPECMDMP;    // 0x0x10
    public string JJBFEOPOLDP;    // 0x0x18
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{gCNJPCMLOOF}   [Service.API]
//   RESPONSE POST   api/playerevents/v2/{eventId}   [Service.API]
public class KGBNFCMIJLK
{
    public IMIIIGNLFIH <ECBPMGLCGIH>k__BackingField;    // 0x0x10
    public FKJOKGEIABM <FLHCJADECHB>k__BackingField;    // 0x0x18
    public AFCIHMKOBDC <ECOFOOLBJEC>k__BackingField;    // 0x0x20
}
...
public class KJCLPPEEMOH
{
    public string <AOIBPDBBBGD>k__BackingField;    // 0x0x10
    public string <KEAIADAFNHC>k__BackingField;    // 0x0x18
    public bool <IPMJNFFEOBL>k__BackingField;    // 0x0x20
    public string <MOCJAEIFHFK>k__BackingField;    // 0x0x28
}
...
public class LFMEDGICILB
{
    public JLMBNAKFLMJ <FDFBLFBAIGO>k__BackingField;    // 0x0x10
    public int <FIKLKMLKAHO>k__BackingField;    // 0x0x14
    public long <CIFABGIEKPG>k__BackingField;    // 0x0x18
    public bool <AMAPBHLMOIP>k__BackingField;    // 0x0x20
    public string <OAJLAHNHKPP>k__BackingField;    // 0x0x28
    public int? <LHHGMLBCPFN>k__BackingField;    // 0x0x30
    public bool <MGPLBLGNJOM>k__BackingField;    // 0x0x38
    public string <DFFPMDJECDD>k__BackingField;    // 0x0x40
    public float <FHMOHPMDKFD>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// LHFDFKBJCEJ
//   (not directly referenced by a detected call)
public class LHFDFKBJCEJ
{
    public long <BBOHGIKAEGI>k__BackingField;    // 0x0x10
    public string <GHLFKPNBHKH>k__BackingField;    // 0x0x18
    public int <LHICEOEMJLC>k__BackingField;    // 0x0x20
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x28
    public string <EOLBALDOFHG>k__BackingField;    // 0x0x30
    public string <DKHFCPFKKKF>k__BackingField;    // 0x0x38
    public int <PNGDHIBLCKI>k__BackingField;    // 0x0x40
    public GBPOHNHHEPK <FOKFDMKOPKL>k__BackingField;    // 0x0x44
    public DateTime <LAMEOLIJGHM>k__BackingField;    // 0x0x48
    public DateTime <CAIPOJJGMHH>k__BackingField;    // 0x0x50
    public DateTime? <BINHCAMGNOL>k__BackingField;    // 0x0x58
    public long? <IACNPEBIMAD>k__BackingField;    // 0x0x68
    public int <IPMICIGJDBE>k__BackingField;    // 0x0x78
    public int <OKBDHJBNEMC>k__BackingField;    // 0x0x7C
    public int <IJFCKAMHDJP>k__BackingField;    // 0x0x80
    public NJINBJMGCAM <GCPAJMMPDAI>k__BackingField;    // 0x0x84
    public NJINBJMGCAM <IDEFAKKBOCF>k__BackingField;    // 0x0x88
    public bool <LJKDOODPAOP>k__BackingField;    // 0x0x8C
    public bool <GNOMCJDDKBK>k__BackingField;    // 0x0x8D
    public bool <IKBLOKOKCDO>k__BackingField;    // 0x0x8E
    public int? <NGGHJKCDLGH>k__BackingField;    // 0x0x90
    public bool <NJCIAEELIFO>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// LIMNANKGOEA
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class LIMNANKGOEA
{
    public int <FIKLKMLKAHO>k__BackingField;    // 0x0x10
}
...
// base   : OAMJFOKLILE
//   (not directly referenced by a detected call)
public class LNMDJGAAEHP : OAMJFOKLILE
{
    public int <OEBIMCLHGPK>k__BackingField;    // 0x0x40
    public List<ANCJKBIFBBE> <CIAFAPEDJNM>k__BackingField;    // 0x0x48
    public List<ANCJKBIFBBE> <NDMEPFIKLID>k__BackingField;    // 0x0x50
    public List<ANCJKBIFBBE> <BJPKIBGGMKJ>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// LOJNFAAAFJD
//   (not directly referenced by a detected call)
public class LOJNFAAAFJD
{
    public int <ONLFPDOHIJO>k__BackingField;    // 0x0x10
}
...
public class MHNMNEIFFGD
{
    public Guid <JLMALMEOOOA>k__BackingField;    // 0x0x10
    public long? <ELPNPINBAIG>k__BackingField;    // 0x0x20
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x30
    public string <EOLBALDOFHG>k__BackingField;    // 0x0x38
    public DCEPMLKNJGL <ALNBMKLJLBB>k__BackingField;    // 0x0x40
    public long <FNFBBHBCMNI>k__BackingField;    // 0x0x48
    public DateTime <CAIPOJJGMHH>k__BackingField;    // 0x0x50
    public DateTime <LAMEOLIJGHM>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// MJLOMBLDJIJ
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class MJLOMBLDJIJ
{
    public int? <ALBKDPEABMJ>k__BackingField;    // 0x0x10
    public string <JJLPHAJFFAC>k__BackingField;    // 0x0x18
    public string <JKAEPJPFJJC>k__BackingField;    // 0x0x20
}
...
// NBLGCPHGIGP
//   (not directly referenced by a detected call)
public class NBLGCPHGIGP
{
    public long <BBOHGIKAEGI>k__BackingField;    // 0x0x10
    public string <GHLFKPNBHKH>k__BackingField;    // 0x0x18
    public int <MCCHOGMNGAI>k__BackingField;    // 0x0x20
    public int <NLBMAKOBFLL>k__BackingField;    // 0x0x24
    public int <EPJPMGIHGOJ>k__BackingField;    // 0x0x28
    public int <HLECGMPABHC>k__BackingField;    // 0x0x2C
    public int <BMNLICNFKBG>k__BackingField;    // 0x0x30
    public string <ACENPPKNDEM>k__BackingField;    // 0x0x38
    public string <IEHBAOLJJKL>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// NEJKMOLIOKB
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{jODGPNEIOOF}   [Service.API]
public class NEJKMOLIOKB
{
    public string BNNNLOHAPAG;    // 0x0x10
    public string FCPKEJOIGFJ;    // 0x0x18
    public string HCEGGOJJMNP;    // 0x0x20
    public string AAKAGOFOHDJ;    // 0x0x28
    public string OPPKBBJANDC;    // 0x0x30
    public CDPNKAHFPJH BAGOPAEMHJP;    // 0x0x38
    public List<string> ALHJOCEBAKL;    // 0x0x40
    public List<string> JHBHKLGDANG;    // 0x0x48
    public string IFBHNLKLFEJ;    // 0x0x50
    public List<KAEEPMMJNAH> OBINIIIELHJ;    // 0x0x58
}
...
public class NGIDDDNKLJO
{
    public bool <EKKJBIBIAKG>k__BackingField;    // 0x0x10
    public string <OAJLAHNHKPP>k__BackingField;    // 0x0x18
}
...
public class NMCHJMBLNLJ
{
    public int <PJPJFGOKBPN>k__BackingField;    // 0x0x10
    public PHPANCHNLPO <PIKJHEALCAJ>k__BackingField;    // 0x0x14
    public GPNNMFDPAEM <BLKALBABADF>k__BackingField;    // 0x0x18
    public GPNNMFDPAEM <BBPNHGECKII>k__BackingField;    // 0x0x1C
    public GPNNMFDPAEM <MOEDJNPMIIE>k__BackingField;    // 0x0x20
}
...
// OAMJFOKLILE
//   (not directly referenced by a detected call)
public class OAMJFOKLILE
{
    public int <ENOOCKMDFCC>k__BackingField;    // 0x0x10
    public EDILCANBDHN <PIKJHEALCAJ>k__BackingField;    // 0x0x14
    public List<PNPEMNNLPNB> <BLBGDPEFFMM>k__BackingField;    // 0x0x18
    public List<PNPEMNNLPNB> <PENKPGNBALG>k__BackingField;    // 0x0x20
    public bool <IHOJBLPFPDM>k__BackingField;    // 0x0x28
    public DateTime? <CNINEFHJMLA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// OCIDFNGEFBC
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class OCIDFNGEFBC
{
    public int <MBDOIAPDDKP>k__BackingField;    // 0x0x10
    public Guid <JLMALMEOOOA>k__BackingField;    // 0x0x14
    public long <IFCHGDNGBAA>k__BackingField;    // 0x0x28
    public long <INONLAOJNGO>k__BackingField;    // 0x0x30
    public DateTime <GJMDIFCJJAO>k__BackingField;    // 0x0x38
}
...
public class ODKBKPHACID : HEMIMDBFGJN
{
    public List<GOCLMGMIADN> IPAGHMEMGCG;    // 0x0x30
    public int <KOPJGMIBMHI>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// OELOJGBCJHB
//   (not directly referenced by a detected call)
public class OELOJGBCJHB
{
    public Guid <GMGOJCIEMOG>k__BackingField;    // 0x0x10
    public Guid <FKNAPICPCHC>k__BackingField;    // 0x0x20
    public DateTime <HLFGGAMKCNC>k__BackingField;    // 0x0x30
    public List<GEPFOIBNKAJ> <BMNEHJDMFDO>k__BackingField;    // 0x0x38
}
...
public class OFOFNFNJMAC
{
    public int <MBDOIAPDDKP>k__BackingField;    // 0x0x10
    public Guid <JLMALMEOOOA>k__BackingField;    // 0x0x14
    public long <IFCHGDNGBAA>k__BackingField;    // 0x0x28
    public DateTime <LAMEOLIJGHM>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// OFPIIHCAEPJ
//   RESPONSE GET    api/inventions/v1/personaldetails/{jJLEIODFALO}   [Service.API]
public class OFPIIHCAEPJ
{
    public bool <ODFOJNDOMCB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OGAMMIDHAJF
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class OGAMMIDHAJF
{
    public int <DJKNGKFKLOM>k__BackingField;    // 0x0x10
    public string <LGPCLBCOIBC>k__BackingField;    // 0x0x18
    public string <BEBBIAIGBDM>k__BackingField;    // 0x0x20
    public string <FGHKDGACCDN>k__BackingField;    // 0x0x28
    public string <NNNHEINIIOL>k__BackingField;    // 0x0x30
    public string <KLDFGKDAKMA>k__BackingField;    // 0x0x38
}
...
public class OMDIMDFNMPH
{
    public Guid <MKDHFFIJCIN>k__BackingField;    // 0x0x10
    public Guid <JLMALMEOOOA>k__BackingField;    // 0x0x20
    public int <KHNHAEKOPNJ>k__BackingField;    // 0x0x30
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x38
    public long <EJOMOCNDCEP>k__BackingField;    // 0x0x40
    public long <NGGHJKCDLGH>k__BackingField;    // 0x0x48
    public DateTime <LAMEOLIJGHM>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// OOKAPIANPLM
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class OOKAPIANPLM
{
    public Guid <IGLEOJBHPCJ>k__BackingField;    // 0x0x10
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x20
    public string <DKHFCPFKKKF>k__BackingField;    // 0x0x28
    public DateTime <HLFGGAMKCNC>k__BackingField;    // 0x0x30
    public DateTime? <OGFHGHEMMFH>k__BackingField;    // 0x0x38
    public List<OELOJGBCJHB> <AHLNKDNBONG>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// PJIAMPJAAAG
//   (not directly referenced by a detected call)
public class PJIAMPJAAAG
{
    public MAEJPMKDNGK DKIHJIHHDCI;    // 0x0x10
    public int MAMEDLEOOHJ;    // 0x0x14
    public int EFJKILBNDAA;    // 0x0x18
}
...
// PMBFIHBJJMC
//   (not directly referenced by a detected call)
public class PMBFIHBJJMC
{
    public long <CFOJNKOCCMA>k__BackingField;    // 0x0x10
    public long <IJPCCGHGAFD>k__BackingField;    // 0x0x18
    public int <PMJFCAHNOHF>k__BackingField;    // 0x0x20
    public DateTime <CAIPOJJGMHH>k__BackingField;    // 0x0x28
    public PJLLHNFNMKI <PIKJHEALCAJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// PMDCMNIDJKJ
//   (not directly referenced by a detected call)
public class PMDCMNIDJKJ
{
    public IMIIIGNLFIH <ECBPMGLCGIH>k__BackingField;    // 0x0x10
    public PMBFIHBJJMC <MLOEFJHCILC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PNPEMNNLPNB
//   (not directly referenced by a detected call)
public class PNPEMNNLPNB
{
    public DCEPMLKNJGL <ALNBMKLJLBB>k__BackingField;    // 0x0x10
    public int <NGGHJKCDLGH>k__BackingField;    // 0x0x14
    public DACFCFDJKFL <CGLPNHLGMPG>k__BackingField;    // 0x0x18
}
...
public class POLHOCDEGGN
{
    public int <AJKJCMGIEBH>k__BackingField;    // 0x0x10
    public List<FJGPPAJAFNE> <MNNBNJKKAFO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PPDFDBMECNL
//   (not directly referenced by a detected call)
public class PPDFDBMECNL
{
    public long <DAOIAFNFEBG>k__BackingField;    // 0x0x10
    public Guid <GHLFKPNBHKH>k__BackingField;    // 0x0x18
    public long <ELPNPINBAIG>k__BackingField;    // 0x0x28
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x30
    public string <EOLBALDOFHG>k__BackingField;    // 0x0x38
    public int <NGGHJKCDLGH>k__BackingField;    // 0x0x40
    public Guid? <OJKCJNDDDNO>k__BackingField;    // 0x0x44
    public DateTime <CAIPOJJGMHH>k__BackingField;    // 0x0x58
}
...
public class PPGLGHHJHFG
{
    public KCJJKKOEIPB BAGOPAEMHJP;    // 0x0x10
    public ECNKLKDHIAN PKBJKEJMDIF;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public FMIOKFMADJC FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public DJBBIEMBDJJ <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public GFDOOHACKNA creatorAccountRole;    // 0x0x58
}
...
{
    public DFJKJOOGEOJ <GJLAAGLCDJK>k__BackingField;    // 0x0x10
    public string <OICBGBKPHAE>k__BackingField;    // 0x0x18
    public bool <BKCMOMJPNKM>k__BackingField;    // 0x0x20
}
...
{
    public List<DFJKJOOGEOJ> <OPBCHNKIOKH>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public KCFLCMDCPIA ReportCategory;    // 0x0x20
}
...
{
    public HEGPDHCHCMG? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public HEGPDHCHCMG OOHJEBGLKDD;  // wrapper
...
{
    public BGAFOHLECNG IHGHFKFDOEK;  // wrapper
...
{
    public LKCFCKJBPIG FKELJAJFEHC;  // wrapper
    public int? EPPFIHJDFAN;  // wrapper
...
{
    public CKJOBLJCMHB UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public DJBBIEMBDJJ HIKLIFLDMDD;  // wrapper
    public DJBBIEMBDJJ? FMGHDBEAGAJ;  // wrapper
...
{
    public IOHNBBKJPLP KFGCNIMHLLE;  // wrapper
...
{
    public JLMBNAKFLMJ DHIHHMGDCDA;  // wrapper
...
{
    public IReadOnlyList<HLEHAKFCMIB> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public MCMBAEMFFDM LAIGPDDBAKG;  // wrapper
    public DJBBIEMBDJJ? MCEICIPBBDC;  // wrapper
...
{
    public DBIGBOLLIDN PBNJADDKLJM;  // wrapper
...
{
    public StatusResponse> GMDMDOLDPBH;  // wrapper
...
{
    public List<long> ENELEAGBKAI;  // wrapper
    public OOAJIKGDHPG JLOGJEINHLM;  // wrapper
    public long? KEEMCFPBEGA;  // wrapper
    public BKPKJANENNH GMDMDOLDPBH;  // wrapper
...
{
    public String> GMDMDOLDPBH;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{gCNJPCMLOOF}  [API POST]
public class PlayereventsV2DeleteGCNJPCMLOOFRequest
{
    public IMIIIGNLFIH GCNJPCMLOOF;  // wrapper
}

// api/players/v2/objectives  [API POST]
public class PlayersV2ObjectivesRequest
{
    public List<FDGFELGHDKA> GPICAHLDOHL;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> BLOPLONILPE;  // wrapper
...
{
    public Guid? KCKGBKKGMFC;  // wrapper
    public object RoomId;  // candidate
...
{
    public MatchCompleteStats ABAJDPDAACM;  // wrapper
}
...
{
    public Guid KFOKEOCPBGD;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<CDIHPNNICHE> GPICAHLDOHL;  // wrapper
    public object objectiveType;  // candidate
...
{
    public CDPNKAHFPJH EJKMMKGBKMG;  // wrapper
}
