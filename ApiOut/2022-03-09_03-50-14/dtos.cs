...
public class AIJODDGLCKN
{
    public long <OKNCBGCJCAF>k__BackingField;    // 0x0x10
    public string <LEOAFIJANPO>k__BackingField;    // 0x0x18
    public string <NDEKMOEHDIH>k__BackingField;    // 0x0x20
    public IHFOGEBOMOJ? <FJOENKJMBLL>k__BackingField;    // 0x0x28
    public string <DMAKFPECDMJ>k__BackingField;    // 0x0x30
    public string <HOFJOKGHHOO>k__BackingField;    // 0x0x38
    public GNGJNPPHGIN <FJBMEPFIKDH>k__BackingField;    // 0x0x40
    public int <IJIBLNHJMKL>k__BackingField;    // 0x0x44
    public int <LOKDPPOLMOP>k__BackingField;    // 0x0x48
    public IKHDLNEJFBO? <KGILHBOILBD>k__BackingField;    // 0x0x4C
    public HNCIKNIIMGM? <OPOHEDLMPDH>k__BackingField;    // 0x0x54
}
...
public class AJKKIFMOHHH
{
    public OLDJEGBMBMC <DDNLJDMAPGN>k__BackingField;    // 0x0x10
    public OJGJIGAPBKN <AFOLCODKDOF>k__BackingField;    // 0x0x18
    public ENGFOHNLCNO <PDBICHBIIAF>k__BackingField;    // 0x0x20
}
...
// ANNGOGFOKFJ
//   (not directly referenced by a detected call)
public class ANNGOGFOKFJ
{
    public Guid <MLHJGIMMNEA>k__BackingField;    // 0x0x10
    public Guid <HFCKHEAFPMF>k__BackingField;    // 0x0x20
    public DateTime <KGLJEBOGNKG>k__BackingField;    // 0x0x30
    public List<NDJPHMHHHFL> <KEKANOFDAHA>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// APCCEEGFLEI
//   (not directly referenced by a detected call)
public class APCCEEGFLEI
{
    public int <AOFLPLFKKJN>k__BackingField;    // 0x0x10
}
...
// BHJOJLMKLOC
//   (not directly referenced by a detected call)
public class BHJOJLMKLOC
{
    public bool <AMGEDEIMJAC>k__BackingField;    // 0x0x10
    public ENALALOJFCP <HJGGJDIOOFM>k__BackingField;    // 0x0x14
    public int <DLELDODJDCN>k__BackingField;    // 0x0x18
    public DateTime <HJLEFAIFAMJ>k__BackingField;    // 0x0x20
}
...
public class BICCHEJAFFF : HMAHLHLMLCC
{
    public List<MLFEMJBGAOP> BIGOINEAIJE;    // 0x0x30
    public int <CJPLHKMIKKJ>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// BJGCHELBGEE
//   (not directly referenced by a detected call)
public class BJGCHELBGEE
{
    public Guid <FAMBFMHEOCO>k__BackingField;    // 0x0x10
    public int <FFCKGJDNJEP>k__BackingField;    // 0x0x20
    public int <PINKJCHKKPK>k__BackingField;    // 0x0x24
    public Guid <FAENNHFFHDF>k__BackingField;    // 0x0x28
    public DateTime <HJLEFAIFAMJ>k__BackingField;    // 0x0x38
    public ONPGFMOLGGN <FLIAKBEHBGN>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// BJMOEOACODD
//   (not directly referenced by a detected call)
public class BJMOEOACODD
{
    public int <BGLOOMDNIIH>k__BackingField;    // 0x0x10
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x18
    public string <BFLMOHMOGFI>k__BackingField;    // 0x0x20
    public string <LHHPDODNPGF>k__BackingField;    // 0x0x28
    public string <KGCKPICHPDK>k__BackingField;    // 0x0x30
    public bool <NLNNAHOCJMI>k__BackingField;    // 0x0x38
    public int <HIPLDJIDADI>k__BackingField;    // 0x0x3C
    public FPPONCPOJJE <NMMDNLGKPDM>k__BackingField;    // 0x0x40
    public KFCNAEONNAD LKIPDIIGJOI;    // 0x0x48
    public KFCNAEONNAD EOLFDIPMOCH;    // 0x0x50
    public KFCNAEONNAD GOOFAJBGFHK;    // 0x0x58
    public IGKFDCOFEIO NKDNJGFGCOL;    // 0x0x60
}
...
public class CAGJDLAHGMN : IFFFGPCMDIJ
{
    public DMILNHBLFFA? <MOLCPLNMGFK>k__BackingField;    // 0x0x18
    public NOJMBOLNPBG <APEDPMOGLCO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CDIFMEKLMAA
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class CDIFMEKLMAA
{
    public int <HIPLDJIDADI>k__BackingField;    // 0x0x10
    public string <IDDLCPGOBCP>k__BackingField;    // 0x0x18
    public string <GBEGEBGKIMK>k__BackingField;    // 0x0x20
    public string <MKMHIENNDIB>k__BackingField;    // 0x0x28
    public string <BJFHALPFNDP>k__BackingField;    // 0x0x30
    public string <IDHINAEDIAK>k__BackingField;    // 0x0x38
}
...
public class CENNNEPOBIA
{
    public int <HKIHBOFCDFF>k__BackingField;    // 0x0x10
    public MADALLCOJIN <FKIHPEEIMIG>k__BackingField;    // 0x0x14
    public NIDFCCANAEM <PIBBOAIKLNI>k__BackingField;    // 0x0x18
    public NIDFCCANAEM <FFLJAMBFDKE>k__BackingField;    // 0x0x1C
    public NIDFCCANAEM <JOJOPHAABOM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CFCODKALIPM
//   (not directly referenced by a detected call)
public class CFCODKALIPM
{
    public int <LCCGMJAHLOB>k__BackingField;    // 0x0x10
    public DateTime <GDEONEPPONB>k__BackingField;    // 0x0x18
    public DateTime? <HENGEFHHALM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CHLEGGOGMML
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class CHLEGGOGMML
{
    public string <HALMLIGGFCG>k__BackingField;    // 0x0x10
    public string <EOGCGHPFGIL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CIEMIGFLKCK
//   RESPONSE GET    api/groups/v1/memberships/{mPAEJOOFBNF}   [Service.API]
public class CIEMIGFLKCK
{
    public long <FPAKMIJDNMB>k__BackingField;    // 0x0x10
    public int <FABJFIGPDIP>k__BackingField;    // 0x0x18
    public AMFCHANHEHF <HCFDBIHPIDL>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// CJLBDMHKDFK
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class CJLBDMHKDFK
{
    public int <FFCKGJDNJEP>k__BackingField;    // 0x0x10
    public Guid <PJJDGOGGEBK>k__BackingField;    // 0x0x14
    public long <AFAPJIMMOFI>k__BackingField;    // 0x0x28
    public long <HOMFNNEILOD>k__BackingField;    // 0x0x30
    public DateTime <AJODCFAEFIG>k__BackingField;    // 0x0x38
}
...
public class CJNKEOIIHMM
{
    public int <MCKIHCEFLAB>k__BackingField;    // 0x0x10
    public bool <APMICIIPBCP>k__BackingField;    // 0x0x14
    public DateTime <HEAFAIPNMPM>k__BackingField;    // 0x0x18
    public bool <LAIDBBMOFPO>k__BackingField;    // 0x0x20
}
...
public class CLKAOAMMELO
{
    public DGADMDKKHPH <DDNLJDMAPGN>k__BackingField;    // 0x0x10
    public MJADEGFABPM <AIHFDKGACND>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CMDEHDDIJMP
//   RESPONSE POST   api/settings/v2/set   [Service.API]
public class CMDEHDDIJMP
{
    public bool ENBOFICGFAO;    // 0x0x10
    public bool LHCDIDIMMDG;    // 0x0x11
}
...
public class CNNKHANMILA : IFFFGPCMDIJ
{
    public KCMJKHJIBDM? <MOLCPLNMGFK>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <PEGKHKCIIMC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DGADMDKKHPH
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{nLNCOJDDLLD}   [Service.API]
public enum DGADMDKKHPH
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{mOPALLFCOCH}   [Service.API]
public class DJDINMKKCGN
{
    public long <GMHIFJOHEFC>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <KIHIFABFHJO>k__BackingField;    // 0x0x18
    public KOOMJIJFLMD <ECAMHEMGIMA>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// EDJDLCDKCOF
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{kJJPMBLGLPE}   [Service.API]
public class EDJDLCDKCOF
{
    public Guid <OECIEEOCBFE>k__BackingField;    // 0x0x10
    public int <FFCKGJDNJEP>k__BackingField;    // 0x0x20
    public int <GIMEOBNAFHB>k__BackingField;    // 0x0x24
    public DateTime <GDEONEPPONB>k__BackingField;    // 0x0x28
}
...
public class EHDKDHLJLMJ
{
    public Dictionary<int, int> <GFOGEHPOAHP>k__BackingField;    // 0x0x10
    public List<NMNCGNDKGCH> <MKMGKMLOEOD>k__BackingField;    // 0x0x18
    public FKOJFIHEONL[][] <HNOAEBGAOOI>k__BackingField;    // 0x0x20
    public MKHABEBIFIP <POBNHKGCLMB>k__BackingField;    // 0x0x28
    public NJIDMBKAHDJ <NDGJBNDEMKK>k__BackingField;    // 0x0x30
    public ONHHFDNKOGL <OGCOENEEGLK>k__BackingField;    // 0x0x38
    public APCCEEGFLEI <HGPFNGNGIFA>k__BackingField;    // 0x0x40
    public KMOABEJOEEN <AJOLDGJBANN>k__BackingField;    // 0x0x48
    public string <LOJFIOMONBO>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// EHLEJNNHKOD
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class EHLEJNNHKOD
{
    public List<GACPDJPLPNF> <BEOJHLLMKGL>k__BackingField;    // 0x0x10
    public OPLPEAJMPBJ <NCHNOKMIFAH>k__BackingField;    // 0x0x18
}
...
public class EIJMMOAELNH
{
    public HTTPResponse NNHENLDKMAI;    // 0x0x10
    public int? OLJGEAHJHOB;    // 0x0x18
    public string EJEOJBLGOOC;    // 0x0x20
    public byte[] KKDCPKDGDCH;    // 0x0x28
    public string OEBEIHIJEJP;    // 0x0x30
}
...
public class EMBCNLGGDMI
{
    public EBAPLPGGFIA <DDNLJDMAPGN>k__BackingField;    // 0x0x10
    public BJGCHELBGEE <BLJFHNFKCCF>k__BackingField;    // 0x0x18
}
...
public class EMPHNPANOJL
{
    public List<CFCODKALIPM> <HNOFEBLKCGB>k__BackingField;    // 0x0x10
    public string <OMOLKFPKNJJ>k__BackingField;    // 0x0x18
}
...
public class ENCIMCGMJHP
{
    public List<int> <IMAIOOCNKMO>k__BackingField;    // 0x0x10
    public string <OMOLKFPKNJJ>k__BackingField;    // 0x0x18
}
...
// ENGFOHNLCNO
//   (not directly referenced by a detected call)
public class ENGFOHNLCNO
{
    public long <JIHCMJCKGGE>k__BackingField;    // 0x0x10
    public string <CBGDJEFHCCI>k__BackingField;    // 0x0x18
    public int <DMOINHEBJAF>k__BackingField;    // 0x0x20
    public int <NOEFIKAKADI>k__BackingField;    // 0x0x24
    public int <EFKEGCDMOBB>k__BackingField;    // 0x0x28
    public int <BCEEEAIEFEM>k__BackingField;    // 0x0x2C
    public int <CEPIBMEIFDO>k__BackingField;    // 0x0x30
    public string <JGOOKFDCOOI>k__BackingField;    // 0x0x38
    public string <DIACLNCOLKG>k__BackingField;    // 0x0x40
}
...
// FFAKLEKNMNH
//   (not directly referenced by a detected call)
public class FFAKLEKNMNH
{
    public DateTime? <AHKCLICCAMF>k__BackingField;    // 0x0x10
    public DateTime? <PHLIOALNKLK>k__BackingField;    // 0x0x20
    public IACKGEDBKNG <DDNLJDMAPGN>k__BackingField;    // 0x0x30
    public KLCIKIJPKFL <PCGIPAONGBK>k__BackingField;    // 0x0x38
    public bool <IIPBOPJONEM>k__BackingField;    // 0x0x40
}
...
public class FKAKOAJBJHB
{
    public Guid <PJJDGOGGEBK>k__BackingField;    // 0x0x10
    public long? <GMHIFJOHEFC>k__BackingField;    // 0x0x20
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x30
    public string <LHHPDODNPGF>k__BackingField;    // 0x0x38
    public JHPHPOHPCLH <ONNLBBEPOMP>k__BackingField;    // 0x0x40
    public long <IFAMGEDCIJK>k__BackingField;    // 0x0x48
    public DateTime <GDEONEPPONB>k__BackingField;    // 0x0x50
    public DateTime <HJLEFAIFAMJ>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// FKOJFIHEONL
//   (not directly referenced by a detected call)
public class FKOJFIHEONL
{
    public JABNLANLEGH KBIHLLFPNDC;    // 0x0x10
    public int MADDIGCCOPJ;    // 0x0x14
    public int CGACBLOOMEI;    // 0x0x18
}

// --------------------------------------------------------------------------
// FLFDABDFOCD
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class FLFDABDFOCD
{
    public long <EIHILPNECPN>k__BackingField;    // 0x0x10
    public BFDFPDGGLCB <FKIHPEEIMIG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FPPONCPOJJE
//   (not directly referenced by a detected call)
public class FPPONCPOJJE
{
    // (no instance fields in the metadata dump)
}
...
// GACPDJPLPNF
//   (not directly referenced by a detected call)
public class GACPDJPLPNF
{
    public int <IHPKACICKGB>k__BackingField;    // 0x0x10
    public OPLPEAJMPBJ <NCHNOKMIFAH>k__BackingField;    // 0x0x14
}
...
public class GAIKDGLNLEC
{
    public Guid <LAPLAGHAHGF>k__BackingField;    // 0x0x10
    public Guid <PJJDGOGGEBK>k__BackingField;    // 0x0x20
    public int <EHINDGNPMOI>k__BackingField;    // 0x0x30
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x38
    public long <NPFHEPJPBJF>k__BackingField;    // 0x0x40
    public long <MFNCADAMJON>k__BackingField;    // 0x0x48
    public DateTime <HJLEFAIFAMJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// GDNGOOCOGFK
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class GDNGOOCOGFK
{
    public int <ILBNCNBGFKN>k__BackingField;    // 0x0x10
    public int <MCKIHCEFLAB>k__BackingField;    // 0x0x14
    public float <FNCFNEGBAEG>k__BackingField;    // 0x0x18
    public float <DFCLCHDMMCD>k__BackingField;    // 0x0x1C
    public bool <APMICIIPBCP>k__BackingField;    // 0x0x20
    public bool <LIHGKABLPJF>k__BackingField;    // 0x0x21
    public bool <AGKFBAKIHCJ>k__BackingField;    // 0x0x22
}
...
// GNJILLFIBAN
//   (not directly referenced by a detected call)
public class GNJILLFIBAN
{
    public DateTime <GDEONEPPONB>k__BackingField;    // 0x0x10
    public string <KCHKLMKHEJC>k__BackingField;    // 0x0x18
}
...
public class GODAFIAAAFC
{
    public bool <IEHEMBMHFHH>k__BackingField;    // 0x0x10
    public string <AOFKEDEBFBE>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{gJKAHAEAKMH}   [Service.API]
...
public class HFIHMFEKLEE
{
    public JAOCLMGACAH <NCGBNAMGJKD>k__BackingField;    // 0x0x10
    public OPLPEAJMPBJ <NCHNOKMIFAH>k__BackingField;    // 0x0x18
    public PNLFDGFELBH <FAHOLPCGEFB>k__BackingField;    // 0x0x20
}
...
public class HKEEMMCHAJD
{
    public int <IFLGMIHDOHB>k__BackingField;    // 0x0x10
    public List<FFAKLEKNMNH> <JMAMNDANEND>k__BackingField;    // 0x0x18
}
...
// HPAMMGAGENJ
//   (not directly referenced by a detected call)
public class HPAMMGAGENJ
{
    public string <EDJOPAHFFHK>k__BackingField;    // 0x0x10
    public GJEBHBAKCJN <FKIHPEEIMIG>k__BackingField;    // 0x0x18
}
...
public class IAMAPDAALPF
{
    public LNEGAIFHMAD <KFLIIBLDHEJ>k__BackingField;    // 0x0x10
    public long <EIHILPNECPN>k__BackingField;    // 0x0x18
    public string <OFJKOMLNLID>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ICHGCLNELHH
//   RESPONSE GET    api/inventions/v1/personaldetails/{nJPOBNPONCN}   [Service.API]
public class ICHGCLNELHH
{
    public bool <KEDPHEBNCHK>k__BackingField;    // 0x0x10
}
...
public class IJCBLJMIGFD
{
    public List<string> <MCPLOICBLMN>k__BackingField;    // 0x0x10
    public List<string> <COHNDLKNONO>k__BackingField;    // 0x0x18
    public List<string> <EEMCAACAHKK>k__BackingField;    // 0x0x20
}
...
public class IJPFFMKLMAL
{
    public bool <IEHEMBMHFHH>k__BackingField;    // 0x0x10
    public string <IPJNLDNKHEN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IKEMFNMDJLF
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class IKEMFNMDJLF
{
    public Guid <EOEIGALPDGF>k__BackingField;    // 0x0x10
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x20
    public string <FMFEOIBOCDN>k__BackingField;    // 0x0x28
    public DateTime <KGLJEBOGNKG>k__BackingField;    // 0x0x30
    public DateTime? <IDIIJOPHMHO>k__BackingField;    // 0x0x38
    public List<ANNGOGFOKFJ> <GADECBBIJLM>k__BackingField;    // 0x0x48
}
...
public class ILDFIMMLEOD
{
    public int <MEOMKOJJGIE>k__BackingField;    // 0x0x10
    public string <NOHNJIAPGDI>k__BackingField;    // 0x0x18
    public List<BJMOEOACODD> <GJMKICHCBJL>k__BackingField;    // 0x0x20
    public AIJODDGLCKN <JEPPNBAGLMH>k__BackingField;    // 0x0x28
    public string <KFCIKMOMGCL>k__BackingField;    // 0x0x30
    public DateTime <KGLJEBOGNKG>k__BackingField;    // 0x0x38
    public DateTime <EDIHGIEOPNE>k__BackingField;    // 0x0x40
    public DateTime <ICNOEOELGKG>k__BackingField;    // 0x0x48
    public bool? <FLOEELHLFIM>k__BackingField;    // 0x0x50
}
...
// JAOCLMGACAH
//   (not directly referenced by a detected call)
public class JAOCLMGACAH
{
    public long <EIHILPNECPN>k__BackingField;    // 0x0x10
    public int <FOCMPFJEALE>k__BackingField;    // 0x0x18
    public long <GMHIFJOHEFC>k__BackingField;    // 0x0x20
    public long? <HOGJKOEHOEN>k__BackingField;    // 0x0x28
    public long? <HMPDFOLICPC>k__BackingField;    // 0x0x38
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x48
    public string <LHHPDODNPGF>k__BackingField;    // 0x0x50
    public string <FMFEOIBOCDN>k__BackingField;    // 0x0x58
    public DateTime <EJPDHKPOLJK>k__BackingField;    // 0x0x60
    public DateTime <HHBBDLLHIPJ>k__BackingField;    // 0x0x68
    public int <HFBHDMDGANB>k__BackingField;    // 0x0x70
    public GPDFLEIPHGB <JJHMCGHJLMF>k__BackingField;    // 0x0x74
    public bool <OEDKIHLGDKO>k__BackingField;    // 0x0x78
    public bool <DOMHNIDIENO>k__BackingField;    // 0x0x79
    public long? <LPEOCJPFKKD>k__BackingField;    // 0x0x80
}
...
public class JMCPLCLAMCO
{
    public NOJMBOLNPBG <APEDPMOGLCO>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <PEGKHKCIIMC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KBENNBOHCDF
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class KBENNBOHCDF
{
    public int? <HBEAKNNGMLO>k__BackingField;    // 0x0x10
    public string <IPPFCLKKMOC>k__BackingField;    // 0x0x18
    public string <FMCLCJCPMMM>k__BackingField;    // 0x0x20
}
...
public class KCJCBDACOCN
{
    public OPLPEAJMPBJ <NCHNOKMIFAH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KHALDHBMAFP
//   (not directly referenced by a detected call)
public class KHALDHBMAFP
{
    public JAOCLMGACAH <NCGBNAMGJKD>k__BackingField;    // 0x0x10
    public NMGOOMFNNHB <CEJJEKELEAE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KLCIKIJPKFL
//   (not directly referenced by a detected call)
public class KLCIKIJPKFL
{
    public int <IDEOBOIOKMK>k__BackingField;    // 0x0x10
    public int <FEPNDGKCNJA>k__BackingField;    // 0x0x14
    public int <OFLABLAPGLJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KMOABEJOEEN
//   (not directly referenced by a detected call)
public class KMOABEJOEEN
{
    public float <BCDKCLBLJGG>k__BackingField;    // 0x0x10
}
...
public class LDPJCDDHDAJ
{
    public long <FPAKMIJDNMB>k__BackingField;    // 0x0x10
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x18
    public string <LHHPDODNPGF>k__BackingField;    // 0x0x20
    public DateTime <GDEONEPPONB>k__BackingField;    // 0x0x28
    public string <FMFEOIBOCDN>k__BackingField;    // 0x0x30
    public POKGEJEFLBE <DMFJDFKBPLM>k__BackingField;    // 0x0x38
    public int <HAACFKHNOMB>k__BackingField;    // 0x0x3C
    public int <BLIKLMNLLNF>k__BackingField;    // 0x0x40
    public List<CIEMIGFLKCK> <FCCOGALNDNG>k__BackingField;    // 0x0x48
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{mAPDMKLHIDL}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{mAPDMKLHIDL}   [Service.API]
...
public class LGEMNNNAMDE
{
    public EBAPLPGGFIA <DDNLJDMAPGN>k__BackingField;    // 0x0x10
    public ONPGFMOLGGN <FLIAKBEHBGN>k__BackingField;    // 0x0x18
}
...
public class LKMLONFEAKO
{
    public string <EADMBJEEAOF>k__BackingField;    // 0x0x10
    public string <KBDIKFKPNEC>k__BackingField;    // 0x0x18
    public bool <LHICMJPIDNI>k__BackingField;    // 0x0x20
    public string <ICGEHPDKOMI>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// MDFNBMAPDPI
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class MDFNBMAPDPI
{
    public int <ANHNPEAGFKH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// MICKEEFIGJO
//   (not directly referenced by a detected call)
public class MICKEEFIGJO
{
    public bool <ALLECAENJMK>k__BackingField;    // 0x0x10
    public NDJPHMHHHFL <NMEGAAOJCML>k__BackingField;    // 0x0x18
    public float <DKBLDFDPFMK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MJADEGFABPM
//   (not directly referenced by a detected call)
public class MJADEGFABPM
{
    public long <ECKLBFDBFBG>k__BackingField;    // 0x0x10
    public Guid <CBGDJEFHCCI>k__BackingField;    // 0x0x18
    public long <GMHIFJOHEFC>k__BackingField;    // 0x0x28
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x30
    public string <LHHPDODNPGF>k__BackingField;    // 0x0x38
    public int <MFNCADAMJON>k__BackingField;    // 0x0x40
    public Guid? <EBNKLLMKAHI>k__BackingField;    // 0x0x44
    public DateTime <GDEONEPPONB>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// MKHABEBIFIP
//   (not directly referenced by a detected call)
public class MKHABEBIFIP
{
    public int <CFMNKHOOFBC>k__BackingField;    // 0x0x10
}
...
// base   : PKBHOBFBPBK
//   (not directly referenced by a detected call)
public class MLFEMJBGAOP : PKBHOBFBPBK
{
    public NDJPHMHHHFL <NMEGAAOJCML>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// MLMPBBFKMPC
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{bJGDCPLBJEG}   [Service.API]
public class MLMPBBFKMPC
{
    public uint <JDMACBOMNJO>k__BackingField;    // 0x0x10
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x18
    public string <LHHPDODNPGF>k__BackingField;    // 0x0x20
    public DateTime <GOEDPHGEHMA>k__BackingField;    // 0x0x28
    public DateTime? <GGGOPKFEANF>k__BackingField;    // 0x0x30
    public bool <KIJLKIMMOJD>k__BackingField;    // 0x0x40
    public List<OKPMLDHGCCE> <BKJPJDHGCDP>k__BackingField;    // 0x0x48
    public List<string> <KGMCHLBNEIJ>k__BackingField;    // 0x0x50
    public int <ILPCEBGJBDF>k__BackingField;    // 0x0x58
    public int <FFPOJGMNDOG>k__BackingField;    // 0x0x5C
    public int <MAGNEGLPJGI>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// MOPBPMCLAPI
//   (not directly referenced by a detected call)
public class MOPBPMCLAPI
{
    public int <MLCMDNJNGOE>k__BackingField;    // 0x0x10
    public DateTime? <AGPLAEJKPDO>k__BackingField;    // 0x0x18
    public DateTime? <AKNLCKEJJDG>k__BackingField;    // 0x0x28
}
...
// NDJPHMHHHFL
//   (not directly referenced by a detected call)
public class NDJPHMHHHFL
{
    public int <OKNCBGCJCAF>k__BackingField;    // 0x0x10
    public string <ABDOONPFDIK>k__BackingField;    // 0x0x18
    public string <KGCKPICHPDK>k__BackingField;    // 0x0x20
    public string <LEOAFIJANPO>k__BackingField;    // 0x0x28
    public string <JAJFNAKEIJK>k__BackingField;    // 0x0x30
    public IHFOGEBOMOJ? <FJOENKJMBLL>k__BackingField;    // 0x0x38
    public string <DMAKFPECDMJ>k__BackingField;    // 0x0x40
    public string <HOFJOKGHHOO>k__BackingField;    // 0x0x48
    public bool <JJHOILLCCBN>k__BackingField;    // 0x0x50
    public bool <NOFHOIPJHDC>k__BackingField;    // 0x0x51
    public bool <KIMAFCOIIHN>k__BackingField;    // 0x0x52
    public HNCIKNIIMGM <MCDLNPNLJFF>k__BackingField;    // 0x0x54
    public JHPHPOHPCLH <ONNLBBEPOMP>k__BackingField;    // 0x0x58
    public int <IFLENEIMOKE>k__BackingField;    // 0x0x5C
    public BKHIKAINHKG <HKHBCCKAHEM>k__BackingField;    // 0x0x60
    public IKHDLNEJFBO <IAAJJPEFMMJ>k__BackingField;    // 0x0x64
    public int? <AAHHEEIFDHA>k__BackingField;    // 0x0x68
    public string <EBHEKNCKBJH>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// NJIDMBKAHDJ
//   (not directly referenced by a detected call)
public class NJIDMBKAHDJ
{
    public float <DFGJIFMGFMF>k__BackingField;    // 0x0x10
    public float <DICJCJNHJEC>k__BackingField;    // 0x0x14
    public float <LCFEMEFIJEB>k__BackingField;    // 0x0x18
    public float <BFMDJECIBLL>k__BackingField;    // 0x0x1C
    public float <CCPNGCILNDO>k__BackingField;    // 0x0x20
    public float <BJFKCHDMEGF>k__BackingField;    // 0x0x24
    public float <MNHHAOBFNBN>k__BackingField;    // 0x0x28
    public float <JEFINLBKMGI>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// NMGOOMFNNHB
//   (not directly referenced by a detected call)
public class NMGOOMFNNHB
{
    public long <HEAELOHJAGO>k__BackingField;    // 0x0x10
    public long <EIHILPNECPN>k__BackingField;    // 0x0x18
    public int <FABJFIGPDIP>k__BackingField;    // 0x0x20
    public DateTime <GDEONEPPONB>k__BackingField;    // 0x0x28
    public BFDFPDGGLCB <FKIHPEEIMIG>k__BackingField;    // 0x0x30
}
...
// base   : PKBHOBFBPBK
//   (not directly referenced by a detected call)
public class NNCCBENKFJC : PKBHOBFBPBK
{
    public int <FBNHBAJICBN>k__BackingField;    // 0x0x40
    public List<MICKEEFIGJO> <GHFKGMMCFOA>k__BackingField;    // 0x0x48
    public List<MICKEEFIGJO> <NCOEDHDKNHJ>k__BackingField;    // 0x0x50
    public List<MICKEEFIGJO> <FDOCCHFJKMF>k__BackingField;    // 0x0x58
}
...
public class NOJMBOLNPBG
{
    public int <FFCKGJDNJEP>k__BackingField;    // 0x0x10
    public Guid <PJJDGOGGEBK>k__BackingField;    // 0x0x14
    public long <AFAPJIMMOFI>k__BackingField;    // 0x0x28
    public DateTime <HJLEFAIFAMJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// OCFMDMOKNIL
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class OCFMDMOKNIL
{
    public JHPHPOHPCLH <ONNLBBEPOMP>k__BackingField;    // 0x0x10
    public MPABLMCMJAM <BMOGDCJHJAM>k__BackingField;    // 0x0x14
    public int <FLLGKHGMAAP>k__BackingField;    // 0x0x18
    public int <LLJOBCIHGOC>k__BackingField;    // 0x0x1C
    public int <IGCLFIHJMHD>k__BackingField;    // 0x0x20
    public PGGPHHOEFCJ <DONOCKBLIBJ>k__BackingField;    // 0x0x24
    public bool <AKEPEOMPDPB>k__BackingField;    // 0x0x28
    public float <LIIHNLEAAIO>k__BackingField;    // 0x0x2C
    public int <KINGNMOHHFC>k__BackingField;    // 0x0x30
    public bool <JCNBOBBBFJN>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// ODLFFKMAGLN
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class ODLFFKMAGLN
{
    public List<HPAMMGAGENJ> <KGMCHLBNEIJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OEPELCODLPA
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class OEPELCODLPA
{
    public LNEGAIFHMAD <KFLIIBLDHEJ>k__BackingField;    // 0x0x10
    public int <ANHNPEAGFKH>k__BackingField;    // 0x0x14
    public long <FEGPFOHIKHN>k__BackingField;    // 0x0x18
    public bool <PMPDOPECJGL>k__BackingField;    // 0x0x20
    public string <IPJNLDNKHEN>k__BackingField;    // 0x0x28
    public int? <PIFNALGJIHL>k__BackingField;    // 0x0x30
    public bool <DBLDPEJNIEA>k__BackingField;    // 0x0x38
    public string <GLGMNEPOMAF>k__BackingField;    // 0x0x40
    public float <OJBCPKDNNFB>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// OJGJIGAPBKN
//   (not directly referenced by a detected call)
public class OJGJIGAPBKN
{
    public long <JIHCMJCKGGE>k__BackingField;    // 0x0x10
    public string <CBGDJEFHCCI>k__BackingField;    // 0x0x18
    public int <FOCMPFJEALE>k__BackingField;    // 0x0x20
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x28
    public string <LHHPDODNPGF>k__BackingField;    // 0x0x30
    public string <FMFEOIBOCDN>k__BackingField;    // 0x0x38
    public int <KCOBLALJKJC>k__BackingField;    // 0x0x40
    public FOGDBMGIONI <JJHMCGHJLMF>k__BackingField;    // 0x0x44
    public DateTime <HJLEFAIFAMJ>k__BackingField;    // 0x0x48
    public DateTime <GDEONEPPONB>k__BackingField;    // 0x0x50
    public DateTime? <KAAKBIIKKIC>k__BackingField;    // 0x0x58
    public long? <IFBOFHMAMCM>k__BackingField;    // 0x0x68
    public int <JEDJPLNLHKN>k__BackingField;    // 0x0x78
    public int <GEJLNLMPNCB>k__BackingField;    // 0x0x7C
    public int <ACJMGNNNDDK>k__BackingField;    // 0x0x80
    public LDELDPEPLLM <KBGEKJFMIKF>k__BackingField;    // 0x0x84
    public LDELDPEPLLM <HDLEJOLAJLB>k__BackingField;    // 0x0x88
    public bool <DNGLGEOHMID>k__BackingField;    // 0x0x8C
    public bool <FDIDGBODPMP>k__BackingField;    // 0x0x8D
    public bool <KOHLMLAGGBB>k__BackingField;    // 0x0x8E
    public int? <MFNCADAMJON>k__BackingField;    // 0x0x90
    public bool <OPHKJGIODBD>k__BackingField;    // 0x0x98
}
...
//   RESPONSE GET    api/avatar/v2/{mJMNBGGBAKE}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{mJMNBGGBAKE}   [Service.API]
public class OKIIEDPLPGL
{
    public string <GBEGEBGKIMK>k__BackingField;    // 0x0x10
    public string <MKMHIENNDIB>k__BackingField;    // 0x0x18
    public string <BJFHALPFNDP>k__BackingField;    // 0x0x20
    public string <IDHINAEDIAK>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// OKPMLDHGCCE
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{bJGDCPLBJEG}   [Service.API]
public class OKPMLDHGCCE
{
    public string <JDMACBOMNJO>k__BackingField;    // 0x0x10
    public string <HALMLIGGFCG>k__BackingField;    // 0x0x18
    public string <MFCEHMHNBGN>k__BackingField;    // 0x0x20
    public string <LHHPDODNPGF>k__BackingField;    // 0x0x28
    public string <IPPFCLKKMOC>k__BackingField;    // 0x0x30
    public OPGIIFDCDJI <DDNLJDMAPGN>k__BackingField;    // 0x0x38
    public List<string> <DOLIPEJBOKD>k__BackingField;    // 0x0x40
    public List<string> <KGMCHLBNEIJ>k__BackingField;    // 0x0x48
    public string <GICOEGEBMJG>k__BackingField;    // 0x0x50
    public List<GNJILLFIBAN> <GEEFODHBPMO>k__BackingField;    // 0x0x58
}
...
// ONHHFDNKOGL
//   (not directly referenced by a detected call)
public class ONHHFDNKOGL
{
    public int <AEGFHBBKPIF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// ONPGFMOLGGN
//   (not directly referenced by a detected call)
public class ONPGFMOLGGN
{
    public Guid <FAMBFMHEOCO>k__BackingField;    // 0x0x10
    public long <GMHIFJOHEFC>k__BackingField;    // 0x0x20
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x28
    public string <LHHPDODNPGF>k__BackingField;    // 0x0x30
    public string <FMFEOIBOCDN>k__BackingField;    // 0x0x38
    public long <MFNCADAMJON>k__BackingField;    // 0x0x40
    public Guid? <EBNKLLMKAHI>k__BackingField;    // 0x0x48
    public DateTime <HJLEFAIFAMJ>k__BackingField;    // 0x0x60
}
...
public class OPMJCOFKHGA
{
    public long <GMHIFJOHEFC>k__BackingField;    // 0x0x10
    public long? <HOGJKOEHOEN>k__BackingField;    // 0x0x18
    public long? <HMPDFOLICPC>k__BackingField;    // 0x0x28
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x38
    public string <LHHPDODNPGF>k__BackingField;    // 0x0x40
    public List<string> <KGMCHLBNEIJ>k__BackingField;    // 0x0x48
    public string <FMFEOIBOCDN>k__BackingField;    // 0x0x50
    public DateTime <EJPDHKPOLJK>k__BackingField;    // 0x0x58
    public DateTime <HHBBDLLHIPJ>k__BackingField;    // 0x0x60
    public GPDFLEIPHGB <JJHMCGHJLMF>k__BackingField;    // 0x0x68
    public bool <OEDKIHLGDKO>k__BackingField;    // 0x0x6C
    public bool <DOMHNIDIENO>k__BackingField;    // 0x0x6D
}
...
//   RESPONSE GET    api/playerevents/v1/all/{mJMNBGGBAKE}   [Service.API]
public class PDEKJOKJJEP
{
    public List<JAOCLMGACAH> <BIJLBDPPONB>k__BackingField;    // 0x0x10
    public List<KHALDHBMAFP> <LGFHGPMEPNG>k__BackingField;    // 0x0x18
}
...
public class PEBOFIAOPDH : HMAHLHLMLCC
{
    public int <NCLKBIBFDIB>k__BackingField;    // 0x0x30
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x38
    public DateTime <KGLJEBOGNKG>k__BackingField;    // 0x0x40
    public DateTime <EDIHGIEOPNE>k__BackingField;    // 0x0x48
    public JHPHPOHPCLH <ONNLBBEPOMP>k__BackingField;    // 0x0x50
    public PKBHOBFBPBK <FKCEJFBIKHK>k__BackingField;    // 0x0x58
    public List<NNCCBENKFJC> <MIKIAFEIBDK>k__BackingField;    // 0x0x60
    public BHJOJLMKLOC <PBOAGCBINEE>k__BackingField;    // 0x0x68
}
...
// PKBHOBFBPBK
//   (not directly referenced by a detected call)
public class PKBHOBFBPBK
{
    public int <GIMEOBNAFHB>k__BackingField;    // 0x0x10
    public EPALALMODNM <FKIHPEEIMIG>k__BackingField;    // 0x0x14
    public List<PKMCKFCIJHA> <KEMFNKPOPOF>k__BackingField;    // 0x0x18
    public List<PKMCKFCIJHA> <MFHDCMCLACE>k__BackingField;    // 0x0x20
    public bool <NCDGJANDCKN>k__BackingField;    // 0x0x28
    public DateTime? <HMHHGKEDKEI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// PKMCKFCIJHA
//   (not directly referenced by a detected call)
public class PKMCKFCIJHA
{
    public JHPHPOHPCLH <ONNLBBEPOMP>k__BackingField;    // 0x0x10
    public int <MFNCADAMJON>k__BackingField;    // 0x0x14
    public MOPBPMCLAPI <OAIHKDJOIGB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PNLFDGFELBH
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class PNLFDGFELBH
{
    public CELCHCOJNEA <NCHNOKMIFAH>k__BackingField;    // 0x0x10
    public List<string> <KGMCHLBNEIJ>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public CJHNJJJLPBP FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public IKHDLNEJFBO <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public IBMDHLNCFOA creatorAccountRole;    // 0x0x58
}
...
{
    public BGBDKOPBGLJ <PBNFBMEKOMA>k__BackingField;    // 0x0x10
    public string <OMKAFMFPEDH>k__BackingField;    // 0x0x18
    public bool <AKOLCKBBNFE>k__BackingField;    // 0x0x20
}
...
{
    public List<BGBDKOPBGLJ> <BDIAENAMIIA>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public AFMKGPMHBMM ReportCategory;    // 0x0x20
}
...
{
    public DAJDDBGLNOC? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public DAJDDBGLNOC HLMLNBPKFFA;  // wrapper
...
{
    public ODLADNKBHPC HCEFIFPOBMF;  // wrapper
...
{
    public JPLIDPHIHFI FFNKIDPAEGE;  // wrapper
    public int? IGKFCCHPEAE;  // wrapper
...
{
    public MNNIJFBGNAL UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public IKHDLNEJFBO FBKBDIMBGGH;  // wrapper
    public IKHDLNEJFBO? GFGAOMPECKB;  // wrapper
...
{
    public BJMOEOACODD HHOPMFONONF;  // wrapper
...
{
    public LNEGAIFHMAD OOAMDEDFIOI;  // wrapper
...
{
    public IReadOnlyList<HJIJMBLNOAN> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public KLIAFCEKIJJ CPDMJECLHHL;  // wrapper
    public IKHDLNEJFBO? HEHEDHEDDLK;  // wrapper
...
{
    public NAGMEIDKFGG BILLGHANJJL;  // wrapper
...
{
    public StatusResponse> CGFIJPDBLBH;  // wrapper
...
{
    public List<long> DLJMPDIMHND;  // wrapper
    public FAFLLPFLOCC CGFIJPDBLBH;  // wrapper
    public KKIMILBAKHJ DPJEFCIKCCI;  // wrapper
    public long? MOPALLFCOCH;  // wrapper
...
{
    public String> CGFIJPDBLBH;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{gJKAHAEAKMH}  [API POST]
public class PlayereventsV2DeleteGJKAHAEAKMHRequest
{
    public JAOCLMGACAH GJKAHAEAKMH;  // wrapper
}
...
{
    public JAOCLMGACAH GJKAHAEAKMH;  // wrapper
    public GPDFLEIPHGB BPBCCMGOMKP;  // wrapper
...
{
    public JAOCLMGACAH GJKAHAEAKMH;  // wrapper
    public long? AHCLFFHGKGJ;  // wrapper
    public object clubId;  // candidate
}
...
{
    public JAOCLMGACAH GJKAHAEAKMH;  // wrapper
    public long? GBBLDKIAHID;  // wrapper
    public object roomId;  // candidate
...
{
    public JAOCLMGACAH GJKAHAEAKMH;  // wrapper
    public List<string> FHMHOLCLMCD;  // wrapper
...
{
    public JAOCLMGACAH GJKAHAEAKMH;  // wrapper
    public DateTime POFADICHKGN;  // wrapper
    public DateTime AAHCPIGBJBG;  // wrapper
...
{
    public List<FNEBKEFBOEM> GOKGHBJKHKL;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> NFFOAIJMGGN;  // wrapper
...
{
    public Guid? EEKKEGOILNK;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats KEFACKDOGND;  // wrapper
}
...
{
    public Guid HMPGBEOPJID;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<LBBBOMHFFKF> GOKGHBJKHKL;  // wrapper
    public object objectiveType;  // candidate
...
{
    public OPGIIFDCDJI MFEKMKAPGCO;  // wrapper
}
