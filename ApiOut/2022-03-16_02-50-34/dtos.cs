...
public class AINJKFJJEEC
{
    public int <ICLGEIFCGAJ>k__BackingField;    // 0x0x10
    public FMANOPFNMPN <LIELJCBNDOI>k__BackingField;    // 0x0x14
    public CKLKHCOBHEH <BFNFEKHAGCO>k__BackingField;    // 0x0x18
    public CKLKHCOBHEH <LGMFLINOOFN>k__BackingField;    // 0x0x1C
    public CKLKHCOBHEH <IJEACKIKFPF>k__BackingField;    // 0x0x20
}
...
public class AKCNGGCODNG
{
    public bool <ACCDEGEHAAB>k__BackingField;    // 0x0x10
    public string <PMLBEACICGJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BEDHDLAFNLH
//   (not directly referenced by a detected call)
public class BEDHDLAFNLH
{
    public long <CMKNELJPIMA>k__BackingField;    // 0x0x10
    public int <HGKADNNIJEK>k__BackingField;    // 0x0x18
    public long <MJKGEPBFFOD>k__BackingField;    // 0x0x20
    public long? <BKLMHFOEOPF>k__BackingField;    // 0x0x28
    public long? <EIFELPLJMEB>k__BackingField;    // 0x0x38
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x48
    public string <ILBCEMGAKIK>k__BackingField;    // 0x0x50
    public string <GHOEMHMBIFN>k__BackingField;    // 0x0x58
    public DateTime <CLCOBLILHEJ>k__BackingField;    // 0x0x60
    public DateTime <PGJNJHMNHOG>k__BackingField;    // 0x0x68
    public int <DBJLLEMPNJJ>k__BackingField;    // 0x0x70
    public KPLDLOCAEEA <AJGIGKLKOAH>k__BackingField;    // 0x0x74
    public bool <DHLFDGOLOKL>k__BackingField;    // 0x0x78
    public bool <LLOAHFAMBCP>k__BackingField;    // 0x0x79
    public long? <KNLLDJPFAAO>k__BackingField;    // 0x0x80
}
...
public class BGDIALMFGJB
{
    public List<int> <DECLKCJMGCM>k__BackingField;    // 0x0x10
    public string <CFAKJLEHHFP>k__BackingField;    // 0x0x18
}
...
public class BGHBBBCFBEO
{
    public IPMLKFHLGJF <LKHJDMPLNLN>k__BackingField;    // 0x0x10
    public JNEPFBNNHNA <GELDEKPNOMB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BGNKPELNHFH
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class BGNKPELNHFH
{
    public int <NDBFIHDNAAF>k__BackingField;    // 0x0x10
    public string <JJHDFIJIMKH>k__BackingField;    // 0x0x18
    public List<EACABCLEMEG> <MOKPIDEJJCC>k__BackingField;    // 0x0x20
    public LPKCCOOLGFN <FGKHJCEMEJL>k__BackingField;    // 0x0x28
    public string <BHBBOLDJIHL>k__BackingField;    // 0x0x30
    public DateTime <JLBHCGKGFJF>k__BackingField;    // 0x0x38
    public DateTime <NDEALCGECFK>k__BackingField;    // 0x0x40
    public DateTime <CPCHPDMCNEG>k__BackingField;    // 0x0x48
    public bool? <CAHKIKNPDNB>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// BKGOKCPGBGG
//   (not directly referenced by a detected call)
public class BKGOKCPGBGG
{
    public float <LOBMOOOBONI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BKNGJDLHEPJ
//   (not directly referenced by a detected call)
public class BKNGJDLHEPJ
{
    public PHNFJOBEFNG GLPEMDOMJOG;    // 0x0x10
    public int HCPPBGGAGJK;    // 0x0x14
    public int AIFNOMBOFAK;    // 0x0x18
}

// --------------------------------------------------------------------------
// BPAGLHGLNKC
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class BPAGLHGLNKC
{
    public int <CDIAPAPEILC>k__BackingField;    // 0x0x10
    public string <OELEFIBIFLN>k__BackingField;    // 0x0x18
    public string <NFLBEICKODI>k__BackingField;    // 0x0x20
    public string <FDEPAOMOJAP>k__BackingField;    // 0x0x28
    public string <ELPBEIMDLGK>k__BackingField;    // 0x0x30
    public string <EOHCAJJPGDF>k__BackingField;    // 0x0x38
}
...
public class CAMBIEKGGAL
{
    public int <MICALKBIPIC>k__BackingField;    // 0x0x10
    public Guid <PNGKONOHILP>k__BackingField;    // 0x0x14
    public long <EOAPBFDAOOF>k__BackingField;    // 0x0x28
    public long <FMCFOIKIJDL>k__BackingField;    // 0x0x30
    public DateTime <EDGAFAHOJPN>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// CCMHBPAAKDB
//   (not directly referenced by a detected call)
public class CCMHBPAAKDB
{
    public int <BJCGLEPBIIL>k__BackingField;    // 0x0x10
    public DateTime <ELGEFKFKBAF>k__BackingField;    // 0x0x18
    public DateTime? <EALPLIJMJKC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CFGCHCPBHAK
//   RESPONSE GET    api/inventions/v1/personaldetails/{hEPEMNEBOHE}   [Service.API]
public class CFGCHCPBHAK
{
    public bool <OOLIMMHMJPP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CFMAEKHFNDH
//   (not directly referenced by a detected call)
public class CFMAEKHFNDH
{
    public long <BNPINEGKEGD>k__BackingField;    // 0x0x10
    public long <CMKNELJPIMA>k__BackingField;    // 0x0x18
    public int <AAAACKBMNLH>k__BackingField;    // 0x0x20
    public DateTime <ELGEFKFKBAF>k__BackingField;    // 0x0x28
    public GHMODFKFKJG <LIELJCBNDOI>k__BackingField;    // 0x0x30
}
...
// --------------------------------------------------------------------------
// CLIAJJEOLIB
//   RESPONSE GET    api/groups/v1/memberships/{fDHEKNHILNK}   [Service.API]
//   RESPONSE GET    api/groups/v1/name/{nameId}   [Service.API]
//   RESPONSE GET    api/groups/v1/{groupId}   [Service.API]
public class CLIAJJEOLIB
{
    public long <NMLNOJDIKGK>k__BackingField;    // 0x0x10
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x18
    public string <ILBCEMGAKIK>k__BackingField;    // 0x0x20
    public DateTime <ELGEFKFKBAF>k__BackingField;    // 0x0x28
    public string <GHOEMHMBIFN>k__BackingField;    // 0x0x30
    public EMDPACCCFGI <AGJNMEPBHJF>k__BackingField;    // 0x0x38
    public int <ELGPOLNNMJC>k__BackingField;    // 0x0x3C
    public int <GPMNNCDKBBJ>k__BackingField;    // 0x0x40
    public List<EKJCOAGNALO> <MFFFMJAFPHB>k__BackingField;    // 0x0x48
}
...
public class DEIGLNEOHIB
{
    public int <PPOOPAMMEDO>k__BackingField;    // 0x0x10
    public int <FJCLOEBLMBL>k__BackingField;    // 0x0x14
    public float <HCLFHJJNNOI>k__BackingField;    // 0x0x18
    public float <AICLHKEGMDL>k__BackingField;    // 0x0x1C
    public bool <MNIJMNHPKMH>k__BackingField;    // 0x0x20
    public bool <OEMPDEILGOP>k__BackingField;    // 0x0x21
    public bool <IKPHNDFIFEC>k__BackingField;    // 0x0x22
}
...
public class DFIJMAIDOBD
{
    public OHNGNDNNOOO <LKHJDMPLNLN>k__BackingField;    // 0x0x10
    public HDCIDEIACCB <HINHGBFDHDJ>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/playerevents/v1/all/{bPOEINHJOKC}   [Service.API]
public class DNNKKEMEPDK
{
    public List<BEDHDLAFNLH> <KDGBMECGHBG>k__BackingField;    // 0x0x10
    public List<LEGCOILGCMB> <IIGBNIJKIOA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EACABCLEMEG
//   (not directly referenced by a detected call)
public class EACABCLEMEG
{
    public int <DDIDCOHJAJE>k__BackingField;    // 0x0x10
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x18
    public string <CFFILNCJHLI>k__BackingField;    // 0x0x20
    public string <ILBCEMGAKIK>k__BackingField;    // 0x0x28
    public string <CCGBHLFHPKM>k__BackingField;    // 0x0x30
    public bool <ECPDJPEFIPG>k__BackingField;    // 0x0x38
    public int <CDIAPAPEILC>k__BackingField;    // 0x0x3C
    public MKMPDODKHHO <FECKJDJBABA>k__BackingField;    // 0x0x40
    public AALDMGODBAM BKLHIFBHFMG;    // 0x0x48
    public AALDMGODBAM EPIAMKOCCHB;    // 0x0x50
    public AALDMGODBAM CLPPMONDOMI;    // 0x0x58
    public PPLJIJLIIPP LMFAMICIKMK;    // 0x0x60
}
...
// EKJCOAGNALO
//   (not directly referenced by a detected call)
public class EKJCOAGNALO
{
    public long <NMLNOJDIKGK>k__BackingField;    // 0x0x10
    public int <AAAACKBMNLH>k__BackingField;    // 0x0x18
    public HKLICBKDJJP <BHEKGOABAPK>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// EMBOMEOINBO
//   (not directly referenced by a detected call)
public class EMBOMEOINBO
{
    public DateTime <ELGEFKFKBAF>k__BackingField;    // 0x0x10
    public string <HCBKCNKMPBK>k__BackingField;    // 0x0x18
}
...
public class EPIIMGMLHPL
{
    public List<string> <GPIADCGABBI>k__BackingField;    // 0x0x10
    public List<string> <PPKLBIEIPMG>k__BackingField;    // 0x0x18
    public List<string> <GEPIMAJEMIL>k__BackingField;    // 0x0x20
}
...
public class FBLPHLCFELA
{
    public bool NHIHHJIFBJB;    // 0x0x10
    public bool PDGCECFGCNG;    // 0x0x11
}
...
public class FGMEHPBKJJF
{
    public DAOCKCDBDMD <IAPEJHJKAKL>k__BackingField;    // 0x0x10
}
...
// FHMAKJPMAIJ
//   (not directly referenced by a detected call)
public class FHMAKJPMAIJ
{
    public int <NEEACOMFFMN>k__BackingField;    // 0x0x10
    public KKJGPFAOLAD <LIELJCBNDOI>k__BackingField;    // 0x0x14
    public List<IGIHLOBMBDJ> <PGMEPLLCKKL>k__BackingField;    // 0x0x18
    public List<IGIHLOBMBDJ> <JJPELNMFHGF>k__BackingField;    // 0x0x20
    public bool <NODGOHLPGHC>k__BackingField;    // 0x0x28
    public DateTime? <BKGMNBNMPHA>k__BackingField;    // 0x0x30
    public DateTime? <IODMDEMBJGD>k__BackingField;    // 0x0x40
    public DateTime? <ODFCFGEGBNG>k__BackingField;    // 0x0x50
}
...
public class FINFAJCBMKB
{
    public Dictionary<int, int> <PHPILFAIJHF>k__BackingField;    // 0x0x10
    public List<GMDADNIHCLP> <MJEMOPELHGM>k__BackingField;    // 0x0x18
    public BKNGJDLHEPJ[][] <ODCAFGOPFEE>k__BackingField;    // 0x0x20
    public FNPFIIHODMO <CABDCMCICFL>k__BackingField;    // 0x0x28
    public LHHBFMPIHFI <OGFIOIDLBGJ>k__BackingField;    // 0x0x30
    public FNMKEPGNGJA <JAHEGDCCEDK>k__BackingField;    // 0x0x38
    public PLFADMDGCPE <CKFOBOHIIEK>k__BackingField;    // 0x0x40
    public BKGOKCPGBGG <JJOABPMDKHJ>k__BackingField;    // 0x0x48
    public string <NMMBNEIPIOI>k__BackingField;    // 0x0x50
}
...
public class FJLGOMBIEII
{
    public Guid <PNGKONOHILP>k__BackingField;    // 0x0x10
    public long? <MJKGEPBFFOD>k__BackingField;    // 0x0x20
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x30
    public string <ILBCEMGAKIK>k__BackingField;    // 0x0x38
    public KOBGBNLBLAC <JIHGPHIMOFH>k__BackingField;    // 0x0x40
    public long <KMIEMKEIKJI>k__BackingField;    // 0x0x48
    public DateTime <ELGEFKFKBAF>k__BackingField;    // 0x0x50
    public DateTime <LDOLGABHHIJ>k__BackingField;    // 0x0x58
}
...
//   RESPONSE GET    api/avatar/v2/{bPOEINHJOKC}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{bPOEINHJOKC}   [Service.API]
public class FNGKJAGFAEA
{
    public string <NFLBEICKODI>k__BackingField;    // 0x0x10
    public string <FDEPAOMOJAP>k__BackingField;    // 0x0x18
    public string <ELPBEIMDLGK>k__BackingField;    // 0x0x20
    public string <EOHCAJJPGDF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// FNMKEPGNGJA
//   (not directly referenced by a detected call)
public class FNMKEPGNGJA
{
    public int <CDBCLBFELCG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FNPFIIHODMO
//   (not directly referenced by a detected call)
public class FNPFIIHODMO
{
    public int <KMJKAFKLDIA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FOELOCNAKBF
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class FOELOCNAKBF
{
    public long <CMKNELJPIMA>k__BackingField;    // 0x0x10
    public GHMODFKFKJG <LIELJCBNDOI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FPDBMOGNKMI
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class FPDBMOGNKMI
{
    public CBKHCDEPABL <JJPILBPAPAL>k__BackingField;    // 0x0x10
    public long <CMKNELJPIMA>k__BackingField;    // 0x0x18
    public string <CFBGLFIKCPB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GANNPBJJBBF
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{nANAAKJMMKA}   [Service.API]
public class GANNPBJJBBF
{
    public string <IDPKGGINIBJ>k__BackingField;    // 0x0x10
    public string <GMHHFDNFJMJ>k__BackingField;    // 0x0x18
    public string <DCPIOILGKDB>k__BackingField;    // 0x0x20
    public string <ILBCEMGAKIK>k__BackingField;    // 0x0x28
    public string <GGPMFLAEKAO>k__BackingField;    // 0x0x30
    public CFMPKDLKMHJ <LKHJDMPLNLN>k__BackingField;    // 0x0x38
    public List<string> <HEDBIMNCPML>k__BackingField;    // 0x0x40
    public List<string> <EAOGGCHGFLK>k__BackingField;    // 0x0x48
    public string <CEALKDMBLMN>k__BackingField;    // 0x0x50
    public List<EMBOMEOINBO> <HLEMGCBFPNN>k__BackingField;    // 0x0x58
}
...
// base   : FHMAKJPMAIJ
//   (not directly referenced by a detected call)
public class GCFKMFABBFK : FHMAKJPMAIJ
{
    public int <HMGFGKLAEIF>k__BackingField;    // 0x0x60
    public List<IKPNKGNILBB> <JLFCKLFNAGK>k__BackingField;    // 0x0x68
    public List<IKPNKGNILBB> <MJMNNLDDILN>k__BackingField;    // 0x0x70
    public List<IKPNKGNILBB> <OCEPKCHFIHN>k__BackingField;    // 0x0x78
}
...
public class GIMMLEAGMAO
{
    public KJODFCDDPPG <IAKOFBOGGII>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <NLBCLFNGAPD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GKCCGDNFDCL
//   (not directly referenced by a detected call)
public class GKCCGDNFDCL
{
    public bool <OHEEHNJJLAN>k__BackingField;    // 0x0x10
    public PAMMDIOPNAA <BGEAFCPGBBD>k__BackingField;    // 0x0x14
    public int <DCKMEJJDELP>k__BackingField;    // 0x0x18
    public DateTime <LDOLGABHHIJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GNGFHEIDPGI
//   (not directly referenced by a detected call)
public class GNGFHEIDPGI
{
    public int <ANJPJGDLODG>k__BackingField;    // 0x0x10
    public DAOCKCDBDMD <IAPEJHJKAKL>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// GNNHEACKOCN
//   (not directly referenced by a detected call)
public class GNNHEACKOCN
{
    public string <FFNDOCIHNII>k__BackingField;    // 0x0x10
    public DGAFEMLGKIK <LIELJCBNDOI>k__BackingField;    // 0x0x18
}
...
public class GPECLIJJKJK : GAIEFJCCMCP
{
    public AFHFMOBIDBM? <PCBJIJFHOJP>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <NLBCLFNGAPD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HDCIDEIACCB
//   (not directly referenced by a detected call)
public class HDCIDEIACCB
{
    public Guid <AJNNLDGLPAC>k__BackingField;    // 0x0x10
    public int <MICALKBIPIC>k__BackingField;    // 0x0x20
    public int <EKHNCOFNFOP>k__BackingField;    // 0x0x24
    public Guid <ICPCENLFBPF>k__BackingField;    // 0x0x28
    public DateTime <LDOLGABHHIJ>k__BackingField;    // 0x0x38
    public LNLCOOHOFEA <PAEDJBEPAKC>k__BackingField;    // 0x0x40
}
...
public class HEDFHIAKMLJ
{
    public bool <ACCDEGEHAAB>k__BackingField;    // 0x0x10
    public string <DBPANGMAIJK>k__BackingField;    // 0x0x18
}
...
public class HGDHHGBOBKK : LEKKGFDLLGE
{
    public List<IDPEAGCKJON> LFLGFAIMIME;    // 0x0x30
    public int <HNFKCNGMEPL>k__BackingField;    // 0x0x38
}
...
public class HJFAGFNBNCL : LEKKGFDLLGE
{
    public int <PIPDGLDLCIJ>k__BackingField;    // 0x0x30
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x38
    public DateTime <JLBHCGKGFJF>k__BackingField;    // 0x0x40
    public DateTime <NDEALCGECFK>k__BackingField;    // 0x0x48
    public KOBGBNLBLAC <JIHGPHIMOFH>k__BackingField;    // 0x0x50
    public FHMAKJPMAIJ <LKKJLAPCNNE>k__BackingField;    // 0x0x58
    public List<GCFKMFABBFK> <PDPFBEBDBGA>k__BackingField;    // 0x0x60
    public GKCCGDNFDCL <BOHDLIHEGFE>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// HKACKOAAMBI
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class HKACKOAAMBI
{
    public int <AGMEHNNONDN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HKBPOHCLMOD
//   (not directly referenced by a detected call)
public class HKBPOHCLMOD
{
    public int <IENBFKCMNKA>k__BackingField;    // 0x0x10
    public DateTime? <HFBBKGJMGHB>k__BackingField;    // 0x0x18
    public DateTime? <HEPJDAKAMMH>k__BackingField;    // 0x0x28
}
...
public class HLIOPGHEPAP
{
    public List<GNGFHEIDPGI> <DKEBJPCOHHF>k__BackingField;    // 0x0x10
    public DAOCKCDBDMD <IAPEJHJKAKL>k__BackingField;    // 0x0x18
}
...
public class HMLICGJEHDK
{
    public CBKHCDEPABL <JJPILBPAPAL>k__BackingField;    // 0x0x10
    public int <AGMEHNNONDN>k__BackingField;    // 0x0x14
    public long <FIJHAGPMLND>k__BackingField;    // 0x0x18
    public bool <CHGHBNPIMGD>k__BackingField;    // 0x0x20
    public string <DBPANGMAIJK>k__BackingField;    // 0x0x28
    public int? <FKMBNJCDCJB>k__BackingField;    // 0x0x30
    public bool <GFKBPCEMMFN>k__BackingField;    // 0x0x38
    public string <FLLPONOMCOC>k__BackingField;    // 0x0x40
    public float <PJMJMEJCDLG>k__BackingField;    // 0x0x48
}
...
public class HPCDKJFGHKN
{
    public int <NOLKBLCEBNL>k__BackingField;    // 0x0x10
    public List<KEHLBNDHIOO> <FBGAANDELCP>k__BackingField;    // 0x0x18
}
...
// base   : FHMAKJPMAIJ
//   (not directly referenced by a detected call)
public class IDPEAGCKJON : FHMAKJPMAIJ
{
    public NKLPIGIBCJE <KFNDCLEKDCA>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// IGIHLOBMBDJ
//   (not directly referenced by a detected call)
public class IGIHLOBMBDJ
{
    public KOBGBNLBLAC <JIHGPHIMOFH>k__BackingField;    // 0x0x10
    public int <EBIPFBEOLLI>k__BackingField;    // 0x0x14
    public HKBPOHCLMOD <OPJHGOPKICG>k__BackingField;    // 0x0x18
}
...
public class IIPOAMCKDJN
{
    public Guid <KAMHAIHIPHF>k__BackingField;    // 0x0x10
    public Guid <PNGKONOHILP>k__BackingField;    // 0x0x20
    public int <CKLJIDOJPBO>k__BackingField;    // 0x0x30
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x38
    public long <GBJAFPEJFLE>k__BackingField;    // 0x0x40
    public long <EBIPFBEOLLI>k__BackingField;    // 0x0x48
    public DateTime <LDOLGABHHIJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// IJMCIIDKGIH
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{nANAAKJMMKA}   [Service.API]
public class IJMCIIDKGIH
{
    public uint <IDPKGGINIBJ>k__BackingField;    // 0x0x10
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x18
    public string <ILBCEMGAKIK>k__BackingField;    // 0x0x20
    public DateTime <GCKNGAJBEPI>k__BackingField;    // 0x0x28
    public DateTime? <CJCIEHJCDKN>k__BackingField;    // 0x0x30
    public bool <IANJPGICDMH>k__BackingField;    // 0x0x40
    public List<GANNPBJJBBF> <LMIPACBBGGG>k__BackingField;    // 0x0x48
    public List<string> <EAOGGCHGFLK>k__BackingField;    // 0x0x50
    public int <CMLPAKFDCLM>k__BackingField;    // 0x0x58
    public int <KLJNOGCLNOC>k__BackingField;    // 0x0x5C
    public int <HACPFMMEGMN>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// IKHEAEIKHPN
//   (not directly referenced by a detected call)
public class IKHEAEIKHPN
{
    public long <ALCHIAHDBCC>k__BackingField;    // 0x0x10
    public string <MBFGEDGPFFG>k__BackingField;    // 0x0x18
    public int <OPGHIGNELAN>k__BackingField;    // 0x0x20
    public int <NLJCOPMBEDG>k__BackingField;    // 0x0x24
    public int <INBENLHGPLG>k__BackingField;    // 0x0x28
    public int <FJLFNAFAEEO>k__BackingField;    // 0x0x2C
    public int <AJPKDCJOMHP>k__BackingField;    // 0x0x30
    public string <JLGJEHBCMJO>k__BackingField;    // 0x0x38
    public string <PFIHILCMCMK>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// IKPNKGNILBB
//   (not directly referenced by a detected call)
public class IKPNKGNILBB
{
    public bool <CAOGPGNLFIO>k__BackingField;    // 0x0x10
    public NKLPIGIBCJE <KFNDCLEKDCA>k__BackingField;    // 0x0x18
    public float <LGLEBFOCKOM>k__BackingField;    // 0x0x20
}
...
public class INNJLNBHJDC
{
    public string <PBHGNAPGFAA>k__BackingField;    // 0x0x10
    public string <EPAACBJCIJH>k__BackingField;    // 0x0x18
    public bool <IBOJLJJAJPH>k__BackingField;    // 0x0x20
    public string <MADHGBBLGLJ>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// IPMLKFHLGJF
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{dDHKCOBIKPC}   [Service.API]
public enum IPMLKFHLGJF
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class JHPOLALODDK
{
    public int <FJCLOEBLMBL>k__BackingField;    // 0x0x10
    public bool <MNIJMNHPKMH>k__BackingField;    // 0x0x14
    public DateTime <NINHPFPKLKF>k__BackingField;    // 0x0x18
    public bool <NPMHBKOGNLC>k__BackingField;    // 0x0x20
}
...
public class JMPJCBKPOLJ : GAIEFJCCMCP
{
    public HLKICEEHMFM? <PCBJIJFHOJP>k__BackingField;    // 0x0x18
    public KJODFCDDPPG <IAKOFBOGGII>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JNEPFBNNHNA
//   (not directly referenced by a detected call)
public class JNEPFBNNHNA
{
    public long <FHJHMENOFIP>k__BackingField;    // 0x0x10
    public Guid <MBFGEDGPFFG>k__BackingField;    // 0x0x18
    public long <MJKGEPBFFOD>k__BackingField;    // 0x0x28
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x30
    public string <ILBCEMGAKIK>k__BackingField;    // 0x0x38
    public int <EBIPFBEOLLI>k__BackingField;    // 0x0x40
    public Guid? <CCCCKPOMIIB>k__BackingField;    // 0x0x44
    public DateTime <ELGEFKFKBAF>k__BackingField;    // 0x0x58
}
...
public class JNOMAEOJBGO
{
    public long <MJKGEPBFFOD>k__BackingField;    // 0x0x10
    public long? <BKLMHFOEOPF>k__BackingField;    // 0x0x18
    public long? <EIFELPLJMEB>k__BackingField;    // 0x0x28
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x38
    public string <ILBCEMGAKIK>k__BackingField;    // 0x0x40
    public List<string> <EAOGGCHGFLK>k__BackingField;    // 0x0x48
    public string <GHOEMHMBIFN>k__BackingField;    // 0x0x50
    public DateTime <CLCOBLILHEJ>k__BackingField;    // 0x0x58
    public DateTime <PGJNJHMNHOG>k__BackingField;    // 0x0x60
    public KPLDLOCAEEA <AJGIGKLKOAH>k__BackingField;    // 0x0x68
    public bool <DHLFDGOLOKL>k__BackingField;    // 0x0x6C
    public bool <LLOAHFAMBCP>k__BackingField;    // 0x0x6D
}

// --------------------------------------------------------------------------
// KCNLKAJEPBL
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{mHOCOEGCIHI}   [Service.API]
public class KCNLKAJEPBL
{
    public Guid <PGIHFIHFOKL>k__BackingField;    // 0x0x10
    public int <MICALKBIPIC>k__BackingField;    // 0x0x20
    public int <NEEACOMFFMN>k__BackingField;    // 0x0x24
    public DateTime <ELGEFKFKBAF>k__BackingField;    // 0x0x28
}
...
// KEHLBNDHIOO
//   (not directly referenced by a detected call)
public class KEHLBNDHIOO
{
    public DateTime? <CCCEOLMPOOM>k__BackingField;    // 0x0x10
    public DateTime? <BJMPCAOEAMB>k__BackingField;    // 0x0x20
    public ILFHEAFPNOG <LKHJDMPLNLN>k__BackingField;    // 0x0x30
    public NFIPDDILDOC <PAHDKLDFMEC>k__BackingField;    // 0x0x38
    public bool <OEGOBDIECJJ>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// KGOEIKELDDG
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class KGOEIKELDDG
{
    public KOBGBNLBLAC <JIHGPHIMOFH>k__BackingField;    // 0x0x10
    public NCDCAALJPHI <BNDPKJHBHGD>k__BackingField;    // 0x0x14
    public int <KLOPKIHGNIC>k__BackingField;    // 0x0x18
    public int <AOEMCAFMGME>k__BackingField;    // 0x0x1C
    public int <FJEPCDHJIDL>k__BackingField;    // 0x0x20
    public MAODLLFEFKL <KBNBMLGMCLA>k__BackingField;    // 0x0x24
    public bool <JJCNADEBNIC>k__BackingField;    // 0x0x28
    public float <NIEICOGNPCG>k__BackingField;    // 0x0x2C
    public int <MAFDJBELLLN>k__BackingField;    // 0x0x30
    public bool <MNIAJNBPLKA>k__BackingField;    // 0x0x34
}
...
public class KJODFCDDPPG
{
    public int <MICALKBIPIC>k__BackingField;    // 0x0x10
    public Guid <PNGKONOHILP>k__BackingField;    // 0x0x14
    public long <EOAPBFDAOOF>k__BackingField;    // 0x0x28
    public DateTime <LDOLGABHHIJ>k__BackingField;    // 0x0x30
}
...
public class LAILHDDEBCJ
{
    public Guid <BEPAJINGEFN>k__BackingField;    // 0x0x10
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x20
    public string <GHOEMHMBIFN>k__BackingField;    // 0x0x28
    public DateTime <JLBHCGKGFJF>k__BackingField;    // 0x0x30
    public DateTime? <OEHKKBEFABP>k__BackingField;    // 0x0x38
    public List<NDMOONLGELH> <CLHEIHCEBID>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// LEGCOILGCMB
//   (not directly referenced by a detected call)
public class LEGCOILGCMB
{
    public BEDHDLAFNLH <GEILHOGAPAK>k__BackingField;    // 0x0x10
    public CFMAEKHFNDH <JCJDEDBJJNA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LHHBFMPIHFI
//   (not directly referenced by a detected call)
public class LHHBFMPIHFI
{
    public float <NDPHOHKAHML>k__BackingField;    // 0x0x10
    public float <HHEELEMOALB>k__BackingField;    // 0x0x14
    public float <EODBCFBNPEF>k__BackingField;    // 0x0x18
    public float <ACBPNONLPON>k__BackingField;    // 0x0x1C
    public float <OMHCLJLJHOJ>k__BackingField;    // 0x0x20
    public float <INFILLJHNJI>k__BackingField;    // 0x0x24
    public float <MKOIDMHNELK>k__BackingField;    // 0x0x28
    public float <HIDNHHKMKDA>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// LNLCOOHOFEA
//   (not directly referenced by a detected call)
public class LNLCOOHOFEA
{
    public Guid <AJNNLDGLPAC>k__BackingField;    // 0x0x10
    public long <MJKGEPBFFOD>k__BackingField;    // 0x0x20
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x28
    public string <ILBCEMGAKIK>k__BackingField;    // 0x0x30
    public string <GHOEMHMBIFN>k__BackingField;    // 0x0x38
    public long <EBIPFBEOLLI>k__BackingField;    // 0x0x40
    public Guid? <CCCCKPOMIIB>k__BackingField;    // 0x0x48
    public DateTime <LDOLGABHHIJ>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// LPJNAFJABNO
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class LPJNAFJABNO
{
    public List<GNNHEACKOCN> <EAOGGCHGFLK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LPKCCOOLGFN
//   (not directly referenced by a detected call)
public class LPKCCOOLGFN
{
    public long <EHAOFPIOCIM>k__BackingField;    // 0x0x10
    public string <HINMFKIAEEN>k__BackingField;    // 0x0x18
    public string <JJJNKKBJAJK>k__BackingField;    // 0x0x20
    public LDMAPLENIIK? <GOHBGEBFHIE>k__BackingField;    // 0x0x28
    public string <EIHPHIJDNJH>k__BackingField;    // 0x0x30
    public string <PJPBEENOJCJ>k__BackingField;    // 0x0x38
    public EDMHDNJOMKM <KMLDOGMICMH>k__BackingField;    // 0x0x40
    public int <COPDHJFKNBH>k__BackingField;    // 0x0x44
    public int <NLHHDPIEADN>k__BackingField;    // 0x0x48
    public NNDKJDBGGEF? <EGOEDKGPBJO>k__BackingField;    // 0x0x4C
    public FHBCIKKFGHD? <GANGHCONDGH>k__BackingField;    // 0x0x54
}
...
public class MDGIBLCPCID
{
    public EFGHJNLPDJJ <IAPEJHJKAKL>k__BackingField;    // 0x0x10
    public List<string> <EAOGGCHGFLK>k__BackingField;    // 0x0x18
}
...
public class MFIFNNFGKBC
{
    public HTTPResponse BABIEKJNMMG;    // 0x0x10
    public int? HCPCMBCFEHP;    // 0x0x18
    public string MFAHAINLCGJ;    // 0x0x20
    public byte[] KOLFINJBLNM;    // 0x0x28
    public string ILLHOPCODKK;    // 0x0x30
}

// --------------------------------------------------------------------------
// MIJCGCJKFLM
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class MIJCGCJKFLM
{
    public int? <KPJDHPICLLI>k__BackingField;    // 0x0x10
    public string <GGPMFLAEKAO>k__BackingField;    // 0x0x18
    public string <CJLPMNPPOGB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MKMPDODKHHO
//   (not directly referenced by a detected call)
public class MKMPDODKHHO
{
    // (no instance fields in the metadata dump)
}
...
// NDMOONLGELH
//   (not directly referenced by a detected call)
public class NDMOONLGELH
{
    public Guid <GKOKDKMCCHG>k__BackingField;    // 0x0x10
    public Guid <FOEDMNCCNHP>k__BackingField;    // 0x0x20
    public DateTime <JLBHCGKGFJF>k__BackingField;    // 0x0x30
    public List<NKLPIGIBCJE> <GPLAFFCIFDK>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// NFIPDDILDOC
//   (not directly referenced by a detected call)
public class NFIPDDILDOC
{
    public int <KPNJMPMLEFD>k__BackingField;    // 0x0x10
    public int <JCNJLBAACFJ>k__BackingField;    // 0x0x14
    public int <CFCBLFBANCN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NIAKBJIHOPN
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class NIAKBJIHOPN
{
    public string <GMHHFDNFJMJ>k__BackingField;    // 0x0x10
    public string <KIFILDNHGDM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NKLPIGIBCJE
//   (not directly referenced by a detected call)
public class NKLPIGIBCJE
{
    public int <EHAOFPIOCIM>k__BackingField;    // 0x0x10
    public string <KHDLBNIAFGD>k__BackingField;    // 0x0x18
    public string <CCGBHLFHPKM>k__BackingField;    // 0x0x20
    public string <HINMFKIAEEN>k__BackingField;    // 0x0x28
    public string <GOMPNFBILEC>k__BackingField;    // 0x0x30
    public LDMAPLENIIK? <GOHBGEBFHIE>k__BackingField;    // 0x0x38
    public string <EIHPHIJDNJH>k__BackingField;    // 0x0x40
    public string <PJPBEENOJCJ>k__BackingField;    // 0x0x48
    public bool <NBJFPKBMEAJ>k__BackingField;    // 0x0x50
    public bool <FNALNGBIOFI>k__BackingField;    // 0x0x51
    public bool <PDOKIPBBCEK>k__BackingField;    // 0x0x52
    public FHBCIKKFGHD <KCFJNLLPIHF>k__BackingField;    // 0x0x54
    public KOBGBNLBLAC <JIHGPHIMOFH>k__BackingField;    // 0x0x58
    public int <JBMCHCALHEF>k__BackingField;    // 0x0x5C
    public EBLOPLNBOLA <FFLNJFPPHHL>k__BackingField;    // 0x0x60
    public NNDKJDBGGEF <OAHKFPOPMPA>k__BackingField;    // 0x0x64
    public int? <ENPANGKONKE>k__BackingField;    // 0x0x68
    public string <HAKKKPNONMH>k__BackingField;    // 0x0x70
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{cBKNFJFCODD}   [Service.API]
public class OEHONMEGBOK
{
    public long <MJKGEPBFFOD>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <LGJOFKLJFAB>k__BackingField;    // 0x0x18
    public HHEEGOBGEEM <HMOHDPODDBD>k__BackingField;    // 0x0x20
}
...
public class OFCFLCFFJON
{
    public List<CCMHBPAAKDB> <HAJDLNMONDA>k__BackingField;    // 0x0x10
    public string <CFAKJLEHHFP>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{oGHAEDNHEPG}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{oGHAEDNHEPG}   [Service.API]
...
public class ONLGGBLCIOJ
{
    public OHNGNDNNOOO <LKHJDMPLNLN>k__BackingField;    // 0x0x10
    public LNLCOOHOFEA <PAEDJBEPAKC>k__BackingField;    // 0x0x18
}
...
public class PBJNDMOIKOA
{
    public GFMNMAENKLD <LKHJDMPLNLN>k__BackingField;    // 0x0x10
    public PJABPDOMCPB <PKNPPOOJCJN>k__BackingField;    // 0x0x18
    public IKHEAEIKHPN <MCNBHHBFNHP>k__BackingField;    // 0x0x20
}
...
// PJABPDOMCPB
//   (not directly referenced by a detected call)
public class PJABPDOMCPB
{
    public long <ALCHIAHDBCC>k__BackingField;    // 0x0x10
    public string <MBFGEDGPFFG>k__BackingField;    // 0x0x18
    public int <HGKADNNIJEK>k__BackingField;    // 0x0x20
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x28
    public string <ILBCEMGAKIK>k__BackingField;    // 0x0x30
    public string <GHOEMHMBIFN>k__BackingField;    // 0x0x38
    public int <KHPOJEHMBCN>k__BackingField;    // 0x0x40
    public OCOBDPBEKGC <AJGIGKLKOAH>k__BackingField;    // 0x0x44
    public DateTime <LDOLGABHHIJ>k__BackingField;    // 0x0x48
    public DateTime <ELGEFKFKBAF>k__BackingField;    // 0x0x50
    public DateTime? <JGOOPGMLPPI>k__BackingField;    // 0x0x58
    public long? <OHGHFGLDBGG>k__BackingField;    // 0x0x68
    public int <JFPFNOIDNBB>k__BackingField;    // 0x0x78
    public int <DFGPJCMKNOL>k__BackingField;    // 0x0x7C
    public int <DPBFKGMMGEF>k__BackingField;    // 0x0x80
    public MBIBCIECHLO <BDKBKFIAJNC>k__BackingField;    // 0x0x84
    public MBIBCIECHLO <DMJJEFMDHAK>k__BackingField;    // 0x0x88
    public bool <EICEIMCNDDP>k__BackingField;    // 0x0x8C
    public bool <OKMGJIPLJNI>k__BackingField;    // 0x0x8D
    public bool <NEJLIEDOOGL>k__BackingField;    // 0x0x8E
    public int? <EBIPFBEOLLI>k__BackingField;    // 0x0x90
    public bool <MEKGPPBAKHE>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// PLFADMDGCPE
//   (not directly referenced by a detected call)
public class PLFADMDGCPE
{
    public int <HIMHPHMKENI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PMFKOFBEJIN
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{lJKIPNJONEM}   [Service.API]
...
public class PMFKOFBEJIN
{
    public BEDHDLAFNLH <GEILHOGAPAK>k__BackingField;    // 0x0x10
    public DAOCKCDBDMD <IAPEJHJKAKL>k__BackingField;    // 0x0x18
    public MDGIBLCPCID <KFJEPFJGPFO>k__BackingField;    // 0x0x20
}
...
public class GetRankRequestDTO
{
    ...
    public COPHDHACHOK FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public NNDKJDBGGEF <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public JFKPPLEDPKN creatorAccountRole;    // 0x0x58
}
...
{
    public GFCIGIMHNIO <MJKBHNGIGLF>k__BackingField;    // 0x0x10
    public string <KNHFAODNKJH>k__BackingField;    // 0x0x18
    public bool <GKODCAAOFJM>k__BackingField;    // 0x0x20
}
...
{
    public List<GFCIGIMHNIO> <IJPOLDOJAMI>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public LIILCHPFDMN ReportCategory;    // 0x0x20
}
...
{
    public NNIEJOAKCND? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public NNIEJOAKCND KDMNHABPHMA;  // wrapper
...
{
    public DLCJAGIEFCE MFPPOANIHEN;  // wrapper
...
{
    public JHHKJNJKOAK IDPNMFPNBCP;  // wrapper
    public int? GENENEGNHHD;  // wrapper
...
{
    public BFOIKEHDOFL UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public NNDKJDBGGEF BKOJMLFMNLI;  // wrapper
    public NNDKJDBGGEF? AIBLDALNFEH;  // wrapper
...
{
    public EACABCLEMEG MKDFFNLKGKM;  // wrapper
...
{
    public CBKHCDEPABL OBNNCKLOCDH;  // wrapper
...
{
    public IReadOnlyList<FANMPOHBBOG> Update;  // wrapper
}
...
{
    public OKLNHGGPIAM AHDFLOJJOCF;  // wrapper
    public NNDKJDBGGEF? HAKPAPNHBKO;  // wrapper
...
{
    public MCODAGNHPJG FLMLINMBCBN;  // wrapper
...
{
    public StatusResponse> HKFANNEFPNB;  // wrapper
...
{
    public List<long> NKFDONPBEHG;  // wrapper
    public KEKIGCBJMNK HKFANNEFPNB;  // wrapper
    public LKEPENJKOBJ KHHDKGODEKJ;  // wrapper
    public long? CBKNFJFCODD;  // wrapper
...
{
    public String> HKFANNEFPNB;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{lJKIPNJONEM}  [API POST]
public class PlayereventsV2DeleteLJKIPNJONEMRequest
{
    public BEDHDLAFNLH LJKIPNJONEM;  // wrapper
}
...
{
    public BEDHDLAFNLH LJKIPNJONEM;  // wrapper
    public KPLDLOCAEEA FGACODKBDFH;  // wrapper
...
{
    public BEDHDLAFNLH LJKIPNJONEM;  // wrapper
    public long? CGBOLNMKEAD;  // wrapper
    public object clubId;  // candidate
}
...
{
    public BEDHDLAFNLH LJKIPNJONEM;  // wrapper
    public long? LPPHPCJEAAF;  // wrapper
    public object roomId;  // candidate
...
{
    public BEDHDLAFNLH LJKIPNJONEM;  // wrapper
    public List<string> CFHGAEAHMGK;  // wrapper
...
{
    public BEDHDLAFNLH LJKIPNJONEM;  // wrapper
    public DateTime HECMAMKCBHF;  // wrapper
    public DateTime HNKALNMPJOC;  // wrapper
...
{
    public List<MGODGCFKKIC> GIMJGFKGAIL;  // wrapper
...
{
    public Guid MONHFPJBLLA;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> BEIAGOKKKBD;  // wrapper
...
{
    public Guid? IPODCCBKHLP;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats KJCFABFOHOE;  // wrapper
}
...
{
    public Guid AHOLOJKBBLH;  // wrapper
    public object RoomKeyId;  // candidate
    public object RequestedPrice;  // candidate
...
{
    public List<FGICIAFDDPA> GIMJGFKGAIL;  // wrapper
    public object objectiveType;  // candidate
...
{
    public CFMPKDLKMHJ KPHAHLDGAJN;  // wrapper
}
