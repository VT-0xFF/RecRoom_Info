...
// AHGIOKIELNC
//   (not directly referenced by a detected call)
public class AHGIOKIELNC
{
    public int <GIBBAKEGNFK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// AKBGFKKPALO
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{kJGCPDMLIJO}   [Service.API]
public class AKBGFKKPALO
{
    public Guid <FIKDFINPCEK>k__BackingField;    // 0x0x10
    public int <CKEACPNNNJC>k__BackingField;    // 0x0x20
    public int <FNECIMCCDNM>k__BackingField;    // 0x0x24
    public DateTime <KHNFCKJBBNL>k__BackingField;    // 0x0x28
}
...
public class AOCLKJPLKPI
{
    public COOOPOANJAH <NAANLGJDPGF>k__BackingField;    // 0x0x10
    public long <MNJGLNKGIMN>k__BackingField;    // 0x0x18
    public string <GENAPKOPIEN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BAAMCFEINDA
//   (not directly referenced by a detected call)
public class BAAMCFEINDA
{
    public DateTime <KHNFCKJBBNL>k__BackingField;    // 0x0x10
    public string <HEHOEIIPNIO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BFDGEEPDKBE
//   (not directly referenced by a detected call)
public class BFDGEEPDKBE
{
    public float <LOJANCLBGHJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BGKHABKBLIK
//   (not directly referenced by a detected call)
public class BGKHABKBLIK
{
    public int <AAHNKNINEAD>k__BackingField;    // 0x0x10
    public DateTime <KHNFCKJBBNL>k__BackingField;    // 0x0x18
    public DateTime? <NLNOCHDMPLL>k__BackingField;    // 0x0x20
}
...
public class BJCCOFAGAMB : BBBDHOBLNBB
{
    public HGEMFFOCAJM? <JAKCFJBPCAG>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <LJCPOPHCLEB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BJDEBILBMFM
//   (not directly referenced by a detected call)
public class BJDEBILBMFM
{
    public long <KNMDFHHOHKK>k__BackingField;    // 0x0x10
    public long <MNJGLNKGIMN>k__BackingField;    // 0x0x18
    public int <HGJEAMPNGAI>k__BackingField;    // 0x0x20
    public DateTime <KHNFCKJBBNL>k__BackingField;    // 0x0x28
    public CEIAGAHHDLG <LDEDODIHMPC>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// BLGNCEKPJKG
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class BLGNCEKPJKG
{
    public int <IJCNMFPFKLD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BLPKBJOCNHM
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class BLPKBJOCNHM
{
    public COOOPOANJAH <NAANLGJDPGF>k__BackingField;    // 0x0x10
    public int <IJCNMFPFKLD>k__BackingField;    // 0x0x14
    public long <ECDIGDCGFCE>k__BackingField;    // 0x0x18
    public bool <FKELEIMDDFF>k__BackingField;    // 0x0x20
    public string <ALOIJFFBAJP>k__BackingField;    // 0x0x28
    public int? <GLFGBEPPDIE>k__BackingField;    // 0x0x30
    public bool <BPADKCBOGBK>k__BackingField;    // 0x0x38
    public string <ODOKCGLNFHP>k__BackingField;    // 0x0x40
    public float <ECDAOLCPAKA>k__BackingField;    // 0x0x48
}
...
public class BMOHLLIOFIH
{
    public int <EKMLIEAKGAJ>k__BackingField;    // 0x0x10
    public bool <MCADEFJFBDL>k__BackingField;    // 0x0x14
    public DateTime <BMIPNHBCPDP>k__BackingField;    // 0x0x18
    public bool <OFIOPNCLMDA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BNOMGNJEEMP
//   RESPONSE GET    api/groups/v1/memberships/{mOCCFLHKBBM}   [Service.API]
public class BNOMGNJEEMP
{
    public long <CCIKAOHPGKI>k__BackingField;    // 0x0x10
    public int <HGJEAMPNGAI>k__BackingField;    // 0x0x18
    public AMJGJLJGHFE <CIDILKJAGGH>k__BackingField;    // 0x0x1C
}
...
public class CDFLFJDNKNI : EBGDAICAHNJ
{
    public List<JFDOBGAJOHG> HIPIPOKEJND;    // 0x0x30
    public int <PJBLAJMBPED>k__BackingField;    // 0x0x38
}
...
public class CEPKOBALAML
{
    public HTTPResponse PKNHLHOPKNH;    // 0x0x10
    public int? KOIBPMIJNHM;    // 0x0x18
    public string NLDENKHDNNI;    // 0x0x20
    public byte[] KJNPEPDIJDB;    // 0x0x28
    public string LGLNCEOGMPH;    // 0x0x30
}

// --------------------------------------------------------------------------
// CGBLHOFOBKK
//   (not directly referenced by a detected call)
public class CGBLHOFOBKK
{
    public int <FNECIMCCDNM>k__BackingField;    // 0x0x10
    public PKOONLKCEHP <LDEDODIHMPC>k__BackingField;    // 0x0x14
    public List<DGNAODIOOMP> <EKJILNGHFHG>k__BackingField;    // 0x0x18
    public List<DGNAODIOOMP> <ONAFDEAAHCK>k__BackingField;    // 0x0x20
    public bool <OLKBMAOGMKP>k__BackingField;    // 0x0x28
    public DateTime? <HCJPODPLIAN>k__BackingField;    // 0x0x30
    public DateTime? <LGNELFMGFHK>k__BackingField;    // 0x0x40
    public DateTime? <EEJEPHEAABP>k__BackingField;    // 0x0x50
}
...
public class CGJBJCNDNKH
{
    public POKJFCHFGEO <CMMCMPMOHPJ>k__BackingField;    // 0x0x10
    public KHMIFAPPODL <KGHDEFMBBMJ>k__BackingField;    // 0x0x18
}
...
public class CHCEMHLAAOB
{
    public List<int> <FIEPCANIEFN>k__BackingField;    // 0x0x10
    public string <DGDPGHJPCGE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CICKKPELPJH
//   (not directly referenced by a detected call)
public class CICKKPELPJH
{
    public long <MNJGLNKGIMN>k__BackingField;    // 0x0x10
    public int <NOJMFKNNMHB>k__BackingField;    // 0x0x18
    public long <NPAMLHGPNKM>k__BackingField;    // 0x0x20
    public long? <HMCHNOJLBEP>k__BackingField;    // 0x0x28
    public long? <ANHHGEHHOMN>k__BackingField;    // 0x0x38
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x48
    public string <IBMKBHJOIJL>k__BackingField;    // 0x0x50
    public string <JHICCMLMMMN>k__BackingField;    // 0x0x58
    public DateTime <JIJFBJJCOJP>k__BackingField;    // 0x0x60
    public DateTime <LPMENENOLPL>k__BackingField;    // 0x0x68
    public int <EBDKDLOEFDD>k__BackingField;    // 0x0x70
    public DGBDGMBLBIM <BOHOCFJDMLB>k__BackingField;    // 0x0x74
    public bool <JLINBNNEOJN>k__BackingField;    // 0x0x78
    public bool <LEALPJOHANO>k__BackingField;    // 0x0x79
    public long? <NBGFLCLADCG>k__BackingField;    // 0x0x80
}
...
// CKEFOJEABHN
//   (not directly referenced by a detected call)
public class CKEFOJEABHN
{
    public int <KCOPLGHPCIP>k__BackingField;    // 0x0x10
    public FEEOKCGHPAP <KNNIFDBCDAF>k__BackingField;    // 0x0x14
}
...
//   RESPONSE GET    api/playerevents/v1/all/{kICPNCBNICB}   [Service.API]
public class CLFHFCCJDOO
{
    public List<CICKKPELPJH> <FOKHNNELLEE>k__BackingField;    // 0x0x10
    public List<KHDGGCEHLMK> <PLFKNPABMAA>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/avatar/v2/{kICPNCBNICB}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{kICPNCBNICB}   [Service.API]
public class COHKABONKEC
{
    public string <FAEHJECKKFL>k__BackingField;    // 0x0x10
    public string <FOFOOGIILFN>k__BackingField;    // 0x0x18
    public string <NEAMIICOPFF>k__BackingField;    // 0x0x20
    public string <CKPGPJFHOGN>k__BackingField;    // 0x0x28
}
...
public class CPKPLJHDGAN
{
    public long <CCIKAOHPGKI>k__BackingField;    // 0x0x10
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x18
    public string <IBMKBHJOIJL>k__BackingField;    // 0x0x20
    public DateTime <KHNFCKJBBNL>k__BackingField;    // 0x0x28
    public string <JHICCMLMMMN>k__BackingField;    // 0x0x30
    public ANEPJIFHFBI <PPIHADNOGON>k__BackingField;    // 0x0x38
    public int <OGJOANEAGPC>k__BackingField;    // 0x0x3C
    public int <GCMABCPPNLJ>k__BackingField;    // 0x0x40
    public List<BNOMGNJEEMP> <PFEHOKPOAEM>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// DFNGJCEIJNF
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class DFNGJCEIJNF
{
    public int <EDENICLCFIL>k__BackingField;    // 0x0x10
    public string <GELHMOLLMNJ>k__BackingField;    // 0x0x18
    public List<KABLAFIIEJO> <LKINGFJHMDE>k__BackingField;    // 0x0x20
    public KIBPPPKKGAA <LBKNNHDKPJN>k__BackingField;    // 0x0x28
    public string <MBJGKGBAAFI>k__BackingField;    // 0x0x30
    public DateTime <AHNDLLGGJKF>k__BackingField;    // 0x0x38
    public DateTime <NEPMEEILFLP>k__BackingField;    // 0x0x40
    public DateTime <BLMLFBANODN>k__BackingField;    // 0x0x48
    public bool? <CFPPINPPDKD>k__BackingField;    // 0x0x50
}
...
// DGNAODIOOMP
//   (not directly referenced by a detected call)
public class DGNAODIOOMP
{
    public DNPNLKEIKJJ <OOGGJDKPJHA>k__BackingField;    // 0x0x10
    public int <LPADEEDCNIG>k__BackingField;    // 0x0x14
    public EAJMJBJAFLK <NNENIELNNNP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DKHADJCJHNM
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{pEIAGKGLLKC}   [Service.API]
public class DKHADJCJHNM
{
    public uint <PEMILFIAJEB>k__BackingField;    // 0x0x10
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x18
    public string <IBMKBHJOIJL>k__BackingField;    // 0x0x20
    public DateTime <OAMLBALGPFA>k__BackingField;    // 0x0x28
    public DateTime? <DOFHPIBNINM>k__BackingField;    // 0x0x30
    public bool <EFOEPBNCLKL>k__BackingField;    // 0x0x40
    public List<IKEAELOJIFA> <HNHDAAFLBJN>k__BackingField;    // 0x0x48
    public List<string> <BCMBIKCAICL>k__BackingField;    // 0x0x50
    public int <KFFMODMLKNL>k__BackingField;    // 0x0x58
    public int <AEMKENLOMDF>k__BackingField;    // 0x0x5C
    public int <BOLKOCMCEHH>k__BackingField;    // 0x0x60
}
...
public class DMDAKCNIIAL
{
    public int <CKEACPNNNJC>k__BackingField;    // 0x0x10
    public Guid <HOBDOIBIBOF>k__BackingField;    // 0x0x14
    public long <IPNBJKCBNAH>k__BackingField;    // 0x0x28
    public DateTime <CKBKFEHNGBC>k__BackingField;    // 0x0x30
}
...
// EAJMJBJAFLK
//   (not directly referenced by a detected call)
public class EAJMJBJAFLK
{
    public int <OJFCCEIFCFG>k__BackingField;    // 0x0x10
    public DateTime? <NFEJIKJIOAB>k__BackingField;    // 0x0x18
    public DateTime? <IEJMKNHEION>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// EBMGHHAPAJJ
//   (not directly referenced by a detected call)
public class EBMGHHAPAJJ
{
    public Guid <GDAODLKMIKH>k__BackingField;    // 0x0x10
    public Guid <FACNLLILMNN>k__BackingField;    // 0x0x20
    public DateTime <AHNDLLGGJKF>k__BackingField;    // 0x0x30
    public List<FDFJBOCEOKI> <PIPOLHEOMEI>k__BackingField;    // 0x0x38
}
...
public class EEIKGCIDAGG
{
    public CIDAEBCEMHK <CMMCMPMOHPJ>k__BackingField;    // 0x0x10
    public IOCBEMNDALC <MOKCGBGLJAD>k__BackingField;    // 0x0x18
    public MBKKIJBELNJ <KLJNLDPELAH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EEOPBEHHCFP
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class EEOPBEHHCFP
{
    public List<CKEFOJEABHN> <GKEGDPEDGMH>k__BackingField;    // 0x0x10
    public FEEOKCGHPAP <KNNIFDBCDAF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EGAHBECKGIM
//   (not directly referenced by a detected call)
public class EGAHBECKGIM
{
    public Guid <DCMFOCDJPDP>k__BackingField;    // 0x0x10
    public long <NPAMLHGPNKM>k__BackingField;    // 0x0x20
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x28
    public string <IBMKBHJOIJL>k__BackingField;    // 0x0x30
    public string <JHICCMLMMMN>k__BackingField;    // 0x0x38
    public long <LPADEEDCNIG>k__BackingField;    // 0x0x40
    public Guid? <OPFMKHGAABI>k__BackingField;    // 0x0x48
    public DateTime <CKBKFEHNGBC>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// EJDGCJODOJM
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class EJDGCJODOJM
{
    public int <NNCGCMGFIGB>k__BackingField;    // 0x0x10
    public int <EKMLIEAKGAJ>k__BackingField;    // 0x0x14
    public float <NAKIHGDJILP>k__BackingField;    // 0x0x18
    public float <MDCMKLKPOBC>k__BackingField;    // 0x0x1C
    public bool <MCADEFJFBDL>k__BackingField;    // 0x0x20
    public bool <OHFDLABDJGD>k__BackingField;    // 0x0x21
    public bool <JAAOODPOJKC>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// EKNHOENOHMF
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class EKNHOENOHMF
{
    public DMDAKCNIIAL <OEKPGIIABGB>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <LJCPOPHCLEB>k__BackingField;    // 0x0x18
}
...
public class FBEOCAPDEDN
{
    public long <NPAMLHGPNKM>k__BackingField;    // 0x0x10
    public long? <HMCHNOJLBEP>k__BackingField;    // 0x0x18
    public long? <ANHHGEHHOMN>k__BackingField;    // 0x0x28
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x38
    public string <IBMKBHJOIJL>k__BackingField;    // 0x0x40
    public List<string> <BCMBIKCAICL>k__BackingField;    // 0x0x48
    public string <JHICCMLMMMN>k__BackingField;    // 0x0x50
    public DateTime <JIJFBJJCOJP>k__BackingField;    // 0x0x58
    public DateTime <LPMENENOLPL>k__BackingField;    // 0x0x60
    public DGBDGMBLBIM <BOHOCFJDMLB>k__BackingField;    // 0x0x68
    public bool <JLINBNNEOJN>k__BackingField;    // 0x0x6C
    public bool <LEALPJOHANO>k__BackingField;    // 0x0x6D
}

// --------------------------------------------------------------------------
// FCJMGPCECJG
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class FCJMGPCECJG
{
    public ELNHLGJPCJN <KNNIFDBCDAF>k__BackingField;    // 0x0x10
    public List<string> <BCMBIKCAICL>k__BackingField;    // 0x0x18
}
...
public class FCJNBANPLOP
{
    public List<BGKHABKBLIK> <GDJCFDLLIJL>k__BackingField;    // 0x0x10
    public string <DGDPGHJPCGE>k__BackingField;    // 0x0x18
}
...
// FDFJBOCEOKI
//   (not directly referenced by a detected call)
public class FDFJBOCEOKI
{
    public int <CMJGEEEBDBJ>k__BackingField;    // 0x0x10
    public string <BJAHNCOGNCA>k__BackingField;    // 0x0x18
    public string <BEMMOEGEILA>k__BackingField;    // 0x0x20
    public string <JNFBPHPBLKE>k__BackingField;    // 0x0x28
    public string <GIPLNBBDLIB>k__BackingField;    // 0x0x30
    public DCKIEDHFFJM? <GJGIKFFLIOF>k__BackingField;    // 0x0x38
    public string <JENJIIHHHLD>k__BackingField;    // 0x0x40
    public string <ENKIPMGDEAF>k__BackingField;    // 0x0x48
    public bool <HMHAKOBJAFB>k__BackingField;    // 0x0x50
    public bool <NJAJOBJFBBK>k__BackingField;    // 0x0x51
    public bool <MPIPEJCHPLC>k__BackingField;    // 0x0x52
    public FACIKGPCDBE <LEFEGNGNCHH>k__BackingField;    // 0x0x54
    public DNPNLKEIKJJ <OOGGJDKPJHA>k__BackingField;    // 0x0x58
    public int <LFOHHDKMBAJ>k__BackingField;    // 0x0x5C
    public DPEJFGMBIFB <EOOMDIFAAGH>k__BackingField;    // 0x0x60
    public OKKAELFAEEK <PLCKDOIFFOA>k__BackingField;    // 0x0x64
    public int? <FNDNICPPMDF>k__BackingField;    // 0x0x68
    public string <OFAONNGKBAI>k__BackingField;    // 0x0x70
}
...
public class FHGONGPDALL
{
    public bool <FJLIDJICCAH>k__BackingField;    // 0x0x10
    public string <ALOIJFFBAJP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GAHACMOEECO
//   (not directly referenced by a detected call)
public class GAHACMOEECO
{
    public int <AAJBFBLGDPD>k__BackingField;    // 0x0x10
    public int <DKCDNKLEIOE>k__BackingField;    // 0x0x14
    public int <EKCMJHMCHAB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GOCDPAHDAID
//   (not directly referenced by a detected call)
public class GOCDPAHDAID
{
    public bool <CLJEKCIKBAO>k__BackingField;    // 0x0x10
    public IGLNOEKNAKH <FBPFLDMNLGA>k__BackingField;    // 0x0x14
    public int <MNECPLLFGLC>k__BackingField;    // 0x0x18
    public DateTime <CKBKFEHNGBC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HDIGMANBHNP
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.API]
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{jFFLMGAOKIG}   [Service.API]
public class HDIGMANBHNP
{
    public long <NPAMLHGPNKM>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <EPKJIELOPBM>k__BackingField;    // 0x0x18
    public NGDINMPBJDF <KHBNIOOKGJM>k__BackingField;    // 0x0x20
}
...
public class HFDJOHIBGAO
{
    public bool <FJLIDJICCAH>k__BackingField;    // 0x0x10
    public string <BNNMHGJMCMJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HFGGPLEABGF
//   (not directly referenced by a detected call)
public class HFGGPLEABGF
{
    public MDEBPJFLNFO DNBBDCKKPHC;    // 0x0x10
    public int GEEACFEIPAM;    // 0x0x14
    public int HOILMONEDAC;    // 0x0x18
}
...
public class HLJGDCNBMJD
{
    public LFAIMDPOJGK <CMMCMPMOHPJ>k__BackingField;    // 0x0x10
    public KEALBBKLINL <LOBMFAELGFP>k__BackingField;    // 0x0x18
}
...
public class HNGELJHHMAH : EBGDAICAHNJ
{
    public int <OIMGNDCMMKN>k__BackingField;    // 0x0x30
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x38
    public DateTime <AHNDLLGGJKF>k__BackingField;    // 0x0x40
    public DateTime <NEPMEEILFLP>k__BackingField;    // 0x0x48
    public DNPNLKEIKJJ <OOGGJDKPJHA>k__BackingField;    // 0x0x50
    public CGBLHOFOBKK <AAHHNBGMOIM>k__BackingField;    // 0x0x58
    public List<MBIFBHMJDHJ> <ABFKBHMNMGD>k__BackingField;    // 0x0x60
    public GOCDPAHDAID <GNEILDPFMGG>k__BackingField;    // 0x0x68
}
...
// --------------------------------------------------------------------------
// IKEAELOJIFA
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{pEIAGKGLLKC}   [Service.API]
public class IKEAELOJIFA
{
    public string <PEMILFIAJEB>k__BackingField;    // 0x0x10
    public string <PEKCNAIEIGK>k__BackingField;    // 0x0x18
    public string <CDIFKHIEIIE>k__BackingField;    // 0x0x20
    public string <IBMKBHJOIJL>k__BackingField;    // 0x0x28
    public string <KHINOMHCOFJ>k__BackingField;    // 0x0x30
    public JIJLAFIEHMP <CMMCMPMOHPJ>k__BackingField;    // 0x0x38
    public List<string> <CJLECOAIJHB>k__BackingField;    // 0x0x40
    public List<string> <BCMBIKCAICL>k__BackingField;    // 0x0x48
    public string <GBCLADOPBJJ>k__BackingField;    // 0x0x50
    public List<BAAMCFEINDA> <CJILEPBJGHF>k__BackingField;    // 0x0x58
}
...
public class INGEKDIOHCF : BBBDHOBLNBB
{
    public IFKPGLLAPAK? <JAKCFJBPCAG>k__BackingField;    // 0x0x18
    public DMDAKCNIIAL <OEKPGIIABGB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// INHKICLEKMA
//   (not directly referenced by a detected call)
public class INHKICLEKMA
{
    public int <KLHPOKLFOJL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IOCBEMNDALC
//   (not directly referenced by a detected call)
public class IOCBEMNDALC
{
    public long <CGJCJACIADJ>k__BackingField;    // 0x0x10
    public string <CLNGCEGIHIO>k__BackingField;    // 0x0x18
    public int <NOJMFKNNMHB>k__BackingField;    // 0x0x20
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x28
    public string <IBMKBHJOIJL>k__BackingField;    // 0x0x30
    public string <JHICCMLMMMN>k__BackingField;    // 0x0x38
    public int <ELAKPFDAEEN>k__BackingField;    // 0x0x40
    public JHDLIPLKKMC <BOHOCFJDMLB>k__BackingField;    // 0x0x44
    public DateTime <CKBKFEHNGBC>k__BackingField;    // 0x0x48
    public DateTime <KHNFCKJBBNL>k__BackingField;    // 0x0x50
    public DateTime? <JHGMPABENEJ>k__BackingField;    // 0x0x58
    public long? <JFMGPNLNHIN>k__BackingField;    // 0x0x68
    public int <JIFIIJKEDNF>k__BackingField;    // 0x0x78
    public int <GJKNGADNDED>k__BackingField;    // 0x0x7C
    public int <GMBADHHPCHO>k__BackingField;    // 0x0x80
    public FDGBGBEPKFD <GGHFJMEDNIJ>k__BackingField;    // 0x0x84
    public FDGBGBEPKFD <HMGPNOHFOCD>k__BackingField;    // 0x0x88
    public bool <CFCFAOBPKLE>k__BackingField;    // 0x0x8C
    public bool <IJEEPOEJEMO>k__BackingField;    // 0x0x8D
    public bool <IJHHFMFGHJA>k__BackingField;    // 0x0x8E
    public int? <LPADEEDCNIG>k__BackingField;    // 0x0x90
    public bool <NDGDLFOKAPF>k__BackingField;    // 0x0x98
}
...
// base   : CGBLHOFOBKK
//   (not directly referenced by a detected call)
public class JFDOBGAJOHG : CGBLHOFOBKK
{
    public FDFJBOCEOKI <LJLGFDLEKDD>k__BackingField;    // 0x0x60
}
...
// KABLAFIIEJO
//   (not directly referenced by a detected call)
public class KABLAFIIEJO
{
    public int <DNLPAGGGHON>k__BackingField;    // 0x0x10
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x18
    public string <NBDGPHCNJFO>k__BackingField;    // 0x0x20
    public string <IBMKBHJOIJL>k__BackingField;    // 0x0x28
    public string <BEMMOEGEILA>k__BackingField;    // 0x0x30
    public bool <IKGNJGDPBIJ>k__BackingField;    // 0x0x38
    public int <BDCCGDBAINP>k__BackingField;    // 0x0x3C
    public AFKBJKHIFPK <GIGKNNAEMJH>k__BackingField;    // 0x0x40
    public OODMBLEJCFA COGDCNCAOMI;    // 0x0x48
    public OODMBLEJCFA NHBHNNKALIL;    // 0x0x50
    public OODMBLEJCFA DNIFPBGKLJB;    // 0x0x58
    public FPAGKONBPIO IKDGNHHJFCC;    // 0x0x60
}

// --------------------------------------------------------------------------
// KDAJPBLOPNJ
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class KDAJPBLOPNJ
{
    public DNPNLKEIKJJ <OOGGJDKPJHA>k__BackingField;    // 0x0x10
    public FDELNJGGLBL <OMLCPHOALMI>k__BackingField;    // 0x0x14
    public int <EGMPNAPLBAD>k__BackingField;    // 0x0x18
    public int <DPMGKFHPLPC>k__BackingField;    // 0x0x1C
    public int <APMEHPAJICH>k__BackingField;    // 0x0x20
    public CKIFEGBCBOP <GOMPFFBPGME>k__BackingField;    // 0x0x24
    public bool <EHIPJLIFGOO>k__BackingField;    // 0x0x28
    public float <ANPPFBEMEDO>k__BackingField;    // 0x0x2C
    public int <AKLECLKECCJ>k__BackingField;    // 0x0x30
    public bool <KGALNNKDJPP>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// KEALBBKLINL
//   (not directly referenced by a detected call)
public class KEALBBKLINL
{
    public Guid <DCMFOCDJPDP>k__BackingField;    // 0x0x10
    public int <CKEACPNNNJC>k__BackingField;    // 0x0x20
    public int <LDJJJMMFAGM>k__BackingField;    // 0x0x24
    public Guid <OGOFMIIDFDE>k__BackingField;    // 0x0x28
    public DateTime <CKBKFEHNGBC>k__BackingField;    // 0x0x38
    public EGAHBECKGIM <IKEIMHGEMBM>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// KHDGGCEHLMK
//   (not directly referenced by a detected call)
public class KHDGGCEHLMK
{
    public CICKKPELPJH <KHLOHEBCKAF>k__BackingField;    // 0x0x10
    public BJDEBILBMFM <KDJJNIIOHDL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KHMIFAPPODL
//   (not directly referenced by a detected call)
public class KHMIFAPPODL
{
    public long <JDFIPMLBABF>k__BackingField;    // 0x0x10
    public Guid <CLNGCEGIHIO>k__BackingField;    // 0x0x18
    public long <NPAMLHGPNKM>k__BackingField;    // 0x0x28
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x30
    public string <IBMKBHJOIJL>k__BackingField;    // 0x0x38
    public int <LPADEEDCNIG>k__BackingField;    // 0x0x40
    public Guid? <OPFMKHGAABI>k__BackingField;    // 0x0x44
    public DateTime <KHNFCKJBBNL>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// KIBPPPKKGAA
//   (not directly referenced by a detected call)
public class KIBPPPKKGAA
{
    public long <CMJGEEEBDBJ>k__BackingField;    // 0x0x10
    public string <JNFBPHPBLKE>k__BackingField;    // 0x0x18
    public string <LMALEDMPKEN>k__BackingField;    // 0x0x20
    public DCKIEDHFFJM? <GJGIKFFLIOF>k__BackingField;    // 0x0x28
    public string <JENJIIHHHLD>k__BackingField;    // 0x0x30
    public string <ENKIPMGDEAF>k__BackingField;    // 0x0x38
    public JAFMDBKJAAD <IHKMGCBNJKN>k__BackingField;    // 0x0x40
    public int <IKMEPGJGNGA>k__BackingField;    // 0x0x44
    public int <MNIDJNKHHOF>k__BackingField;    // 0x0x48
    public OKKAELFAEEK? <FEENAAEANLI>k__BackingField;    // 0x0x4C
    public FACIKGPCDBE? <HLBJNCFDOEF>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// KLODIMHPPLB
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{gDFNMMKDCGC}   [Service.API]
...
public class KLODIMHPPLB
{
    public CICKKPELPJH <KHLOHEBCKAF>k__BackingField;    // 0x0x10
    public FEEOKCGHPAP <KNNIFDBCDAF>k__BackingField;    // 0x0x18
    public FCJMGPCECJG <KJDAPDCNBKD>k__BackingField;    // 0x0x20
}
...
public class KMJBCPBPEIJ
{
    public Guid <ONMGLCCDJNK>k__BackingField;    // 0x0x10
    public Guid <HOBDOIBIBOF>k__BackingField;    // 0x0x20
    public int <IEMAKEHMKBD>k__BackingField;    // 0x0x30
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x38
    public long <BBBJHCAMICI>k__BackingField;    // 0x0x40
    public long <LPADEEDCNIG>k__BackingField;    // 0x0x48
    public DateTime <CKBKFEHNGBC>k__BackingField;    // 0x0x50
}
...
// LHJEDCKBKMH
//   (not directly referenced by a detected call)
public class LHJEDCKBKMH
{
    public DateTime? <AGAAPPMLAIN>k__BackingField;    // 0x0x10
    public DateTime? <IDLCKHINBBL>k__BackingField;    // 0x0x20
    public HNIAECBANJF <CMMCMPMOHPJ>k__BackingField;    // 0x0x30
    public GAHACMOEECO <AOLGANMOJEC>k__BackingField;    // 0x0x38
    public bool <ELPKPJDCAMF>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// LIBHEJIBMNC
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class LIBHEJIBMNC
{
    public string <PEKCNAIEIGK>k__BackingField;    // 0x0x10
    public string <BELBFFABOOK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LJLDKEFMDJB
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class LJLDKEFMDJB
{
    public List<LLIBEBOACJC> <BCMBIKCAICL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LLIBEBOACJC
//   (not directly referenced by a detected call)
public class LLIBEBOACJC
{
    public string <AJDKDILKKID>k__BackingField;    // 0x0x10
    public LBLKMGBAILN <LDEDODIHMPC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LMGPACCBIIB
//   RESPONSE POST   api/settings/v2/set   [Service.API]
public class LMGPACCBIIB
{
    public bool IJMALGGPIOA;    // 0x0x10
    public bool PNCOEKNDIHL;    // 0x0x11
}
...
public class LMIBNFPPOEI
{
    public int <AEDKPGJCILI>k__BackingField;    // 0x0x10
    public List<LHJEDCKBKMH> <JMNLIPEEAOE>k__BackingField;    // 0x0x18
}
...
// base   : CGBLHOFOBKK
//   (not directly referenced by a detected call)
public class MBIFBHMJDHJ : CGBLHOFOBKK
{
    public int <CBEGJAEHJBJ>k__BackingField;    // 0x0x60
    public List<PNDNHDFHABE> <KMCCCGFFFEG>k__BackingField;    // 0x0x68
    public List<PNDNHDFHABE> <GKAAFIPIJLM>k__BackingField;    // 0x0x70
    public List<PNDNHDFHABE> <IOLKNILCPMC>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// MBKKIJBELNJ
//   (not directly referenced by a detected call)
public class MBKKIJBELNJ
{
    public long <CGJCJACIADJ>k__BackingField;    // 0x0x10
    public string <CLNGCEGIHIO>k__BackingField;    // 0x0x18
    public int <IIKMLFHIIPB>k__BackingField;    // 0x0x20
    public int <CBANMKCNFIO>k__BackingField;    // 0x0x24
    public int <FGFDMKJHDKL>k__BackingField;    // 0x0x28
    public int <BODBAIECDFJ>k__BackingField;    // 0x0x2C
    public int <LLCHHGGFDEP>k__BackingField;    // 0x0x30
    public string <LDACEAGGNDF>k__BackingField;    // 0x0x38
    public string <GOAILLJELGA>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// MDBLACHHALP
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class MDBLACHHALP
{
    public int <BDCCGDBAINP>k__BackingField;    // 0x0x10
    public string <MGGEGELCNKL>k__BackingField;    // 0x0x18
    public string <FAEHJECKKFL>k__BackingField;    // 0x0x20
    public string <FOFOOGIILFN>k__BackingField;    // 0x0x28
    public string <NEAMIICOPFF>k__BackingField;    // 0x0x30
    public string <CKPGPJFHOGN>k__BackingField;    // 0x0x38
}
...
public class MGPKJGHMAKH
{
    public Dictionary<int, int> <DKFDHLJGHGC>k__BackingField;    // 0x0x10
    public List<EPMHIDMMLHB> <FKCLKBPLGAN>k__BackingField;    // 0x0x18
    public HFGGPLEABGF[][] <GEKBPIFEENM>k__BackingField;    // 0x0x20
    public AHGIOKIELNC <IPDGDKJIOAI>k__BackingField;    // 0x0x28
    public PHGLDGJNIOP <MPGMOHAENCH>k__BackingField;    // 0x0x30
    public INHKICLEKMA <AAIDDIBMCIG>k__BackingField;    // 0x0x38
    public PICGDOFNNAB <AJJNMDPEAFF>k__BackingField;    // 0x0x40
    public BFDGEEPDKBE <HEMJFBFENGP>k__BackingField;    // 0x0x48
    public string <EIKFPLANFNM>k__BackingField;    // 0x0x50
}
...
public class MJGFHEJFEED
{
    public string <MFNECCDFKBO>k__BackingField;    // 0x0x10
    public string <JECJCKKFIBC>k__BackingField;    // 0x0x18
    public bool <LEFFDFFIHEH>k__BackingField;    // 0x0x20
    public string <OIKEGHNFJNF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// MJPBOHCMBJE
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class MJPBOHCMBJE
{
    public long <MNJGLNKGIMN>k__BackingField;    // 0x0x10
    public CEIAGAHHDLG <LDEDODIHMPC>k__BackingField;    // 0x0x18
}
...
public class MNKKACGPLJE
{
    public List<string> <JDMCLJBJEFJ>k__BackingField;    // 0x0x10
    public List<string> <APNFIBOHDFD>k__BackingField;    // 0x0x18
    public List<string> <LCGJEJGGNMA>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{iPDPMDIIHNM}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{iPDPMDIIHNM}   [Service.API]
...
public class NHENOHJHEKD
{
    public LFAIMDPOJGK <CMMCMPMOHPJ>k__BackingField;    // 0x0x10
    public EGAHBECKGIM <IKEIMHGEMBM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OEFEDHJLONJ
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class OEFEDHJLONJ
{
    public int? <FMCFLHKLJPK>k__BackingField;    // 0x0x10
    public string <KHINOMHCOFJ>k__BackingField;    // 0x0x18
    public string <LEFIPKLCPEC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OFAAPCADKMK
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class OFAAPCADKMK
{
    public Guid <CLDHOEIBGOP>k__BackingField;    // 0x0x10
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x20
    public string <JHICCMLMMMN>k__BackingField;    // 0x0x28
    public DateTime <AHNDLLGGJKF>k__BackingField;    // 0x0x30
    public DateTime? <FFNFMHLODGA>k__BackingField;    // 0x0x38
    public List<EBMGHHAPAJJ> <IBAGLCJBNMA>k__BackingField;    // 0x0x48
}
...
public class OFDFFPNCPHK
{
    public int <FBNOBPOACJM>k__BackingField;    // 0x0x10
    public BJDKMHNLNBB <LDEDODIHMPC>k__BackingField;    // 0x0x14
    public FMGGNNMLPCN <HPKMLMCDCJB>k__BackingField;    // 0x0x18
    public FMGGNNMLPCN <IJJBPJALKDG>k__BackingField;    // 0x0x1C
    public FMGGNNMLPCN <NFILMKBADJO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OIDEEFBMMEG
//   RESPONSE GET    api/inventions/v1/personaldetails/{kCAJGNPNMKC}   [Service.API]
public class OIDEEFBMMEG
{
    public bool <MIPAGOELNNG>k__BackingField;    // 0x0x10
}
...
public class OPJPDCPFEIF
{
    public int <CKEACPNNNJC>k__BackingField;    // 0x0x10
    public Guid <HOBDOIBIBOF>k__BackingField;    // 0x0x14
    public long <IPNBJKCBNAH>k__BackingField;    // 0x0x28
    public long <CIOHDCAADKG>k__BackingField;    // 0x0x30
    public DateTime <FPIJOLNEPID>k__BackingField;    // 0x0x38
}
...
public class PGAINJOKNBK
{
    public Guid <HOBDOIBIBOF>k__BackingField;    // 0x0x10
    public long? <NPAMLHGPNKM>k__BackingField;    // 0x0x20
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x30
    public string <IBMKBHJOIJL>k__BackingField;    // 0x0x38
    public DNPNLKEIKJJ <OOGGJDKPJHA>k__BackingField;    // 0x0x40
    public long <IDGBMKCLIHG>k__BackingField;    // 0x0x48
    public DateTime <KHNFCKJBBNL>k__BackingField;    // 0x0x50
    public DateTime <CKBKFEHNGBC>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// PHGLDGJNIOP
//   (not directly referenced by a detected call)
public class PHGLDGJNIOP
{
    public float <PEPGNOPCKOI>k__BackingField;    // 0x0x10
    public float <KGIGLMAJHGB>k__BackingField;    // 0x0x14
    public float <OCNAOLAHDGF>k__BackingField;    // 0x0x18
    public float <HBMMNPLEHBG>k__BackingField;    // 0x0x1C
    public float <AMEMFFNKJOH>k__BackingField;    // 0x0x20
    public float <FDFMAAAHBGN>k__BackingField;    // 0x0x24
    public float <FMOBGIBJMDJ>k__BackingField;    // 0x0x28
    public float <MDALEAIHNBF>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// PICGDOFNNAB
//   (not directly referenced by a detected call)
public class PICGDOFNNAB
{
    public int <FDGPIMCEBKG>k__BackingField;    // 0x0x10
}
...
public class PNCFIIECIOK
{
    public FEEOKCGHPAP <KNNIFDBCDAF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PNDNHDFHABE
//   (not directly referenced by a detected call)
public class PNDNHDFHABE
{
    public bool <EKLJBIMGKLL>k__BackingField;    // 0x0x10
    public FDFJBOCEOKI <LJLGFDLEKDD>k__BackingField;    // 0x0x18
    public float <MEBHGFLFOKP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// POKJFCHFGEO
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{eIELNFEOFJB}   [Service.API]
public enum POKJFCHFGEO
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class GetRankRequestDTO
{
    ...
    public FJCOGBLIEMO FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public OKKAELFAEEK <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public CNNJNCFDEMD creatorAccountRole;    // 0x0x58
}
...
{
    public OCONBPBMCOC <NGPBDEMNPJN>k__BackingField;    // 0x0x10
    public string <HHOIOONEDFN>k__BackingField;    // 0x0x18
    public bool <FGKCBEHKGHM>k__BackingField;    // 0x0x20
}
...
{
    public List<OCONBPBMCOC> <MMFNBLCNDFL>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public CBECFIGHPOI ReportCategory;    // 0x0x20
}
...
{
    public JKBPAHBKMFE? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public JKBPAHBKMFE FMCBMIJAPKG;  // wrapper
...
{
    public DEJFPCODEKL FINELJCHDPJ;  // wrapper
...
{
    public GJBCMCFLFMO MIDEMNGPEAG;  // wrapper
    public int? CCLFFAIMNFJ;  // wrapper
...
{
    public JJAODDNBPKI UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public OKKAELFAEEK DAABJFEBLJF;  // wrapper
    public OKKAELFAEEK? NDBJDNHPENI;  // wrapper
...
{
    public KABLAFIIEJO FLMHBJONMJD;  // wrapper
...
{
    public COOOPOANJAH LBCNFHGKKNP;  // wrapper
...
{
    public IReadOnlyList<IAPPBPIEKOA> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public LFOFGJBOKPE ANONFBPBPIH;  // wrapper
    public OKKAELFAEEK? ANICHJEJFAL;  // wrapper
...
{
    public ENNPPNPFFIF DBMKDMEDDJI;  // wrapper
...
{
    public StatusResponse> MKGMOFPDGOO;  // wrapper
...
{
    public List<long> FJJFKDJADDD;  // wrapper
    public KJAFHDPAIFH MKGMOFPDGOO;  // wrapper
    public DGLGGNAOOAI CKHGGLLOMEO;  // wrapper
    public long? JFFLMGAOKIG;  // wrapper
...
{
    public String> MKGMOFPDGOO;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{gDFNMMKDCGC}  [API POST]
public class PlayereventsV2DeleteGDFNMMKDCGCRequest
{
    public CICKKPELPJH GDFNMMKDCGC;  // wrapper
}
...
{
    public CICKKPELPJH GDFNMMKDCGC;  // wrapper
    public DGBDGMBLBIM PLCNICLFFAA;  // wrapper
...
{
    public CICKKPELPJH GDFNMMKDCGC;  // wrapper
    public long? IHLIPLEOFCI;  // wrapper
    public object clubId;  // candidate
}
...
{
    public CICKKPELPJH GDFNMMKDCGC;  // wrapper
    public long? ACONJPIIIJL;  // wrapper
    public object roomId;  // candidate
...
{
    public CICKKPELPJH GDFNMMKDCGC;  // wrapper
    public List<string> OPEADDPGKED;  // wrapper
...
{
    public CICKKPELPJH GDFNMMKDCGC;  // wrapper
    public DateTime OLABHPJFHPO;  // wrapper
    public DateTime ACFDNFPNMGB;  // wrapper
...
{
    public List<OIKNDNKODOP> KIIKNKELFEH;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> EIKGONFCOOE;  // wrapper
...
{
    public Guid? PDBDDNFGJKB;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats AOHENMLHFDL;  // wrapper
}
...
{
    public Guid PHEKPPIKIIO;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<NJFMPOMBHAK> KIIKNKELFEH;  // wrapper
    public object objectiveType;  // candidate
...
{
    public JIJLAFIEHMP PANAHLAJFJA;  // wrapper
}
