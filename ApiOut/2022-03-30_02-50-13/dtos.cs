...
// DTO classes: 233 (plus referenced enums)

// --------------------------------------------------------------------------
// AAMKGKBBKNP
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class AAMKGKBBKNP
{
    public List<DAOEILBFGHL> <GMCNCKNCCHC>k__BackingField;    // 0x0x10
    public PIPMJOEAEPM <OJOBABOAEFE>k__BackingField;    // 0x0x18
}
...
public class AFJGBLBGDPH : NBDAPBPNMMC
{
    public OGHMOBDLDJB? <KAIILPNGHAB>k__BackingField;    // 0x0x18
    public JCNDFACNMJA <MEBCGOFAPBC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ALKEKJGOPLG
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class ALKEKJGOPLG
{
    public int <LCDFKMLJGJE>k__BackingField;    // 0x0x10
}
...
public class AOAPLJIJOFB
{
    public long <PAEBNBEKDNJ>k__BackingField;    // 0x0x10
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x18
    public string <FLHIHGCLKNF>k__BackingField;    // 0x0x20
    public DateTime <BADFFJPJLMO>k__BackingField;    // 0x0x28
    public string <HJKDNKPHCFF>k__BackingField;    // 0x0x30
    public DNMJKKNDLIF <MNONJGHMJOO>k__BackingField;    // 0x0x38
    public int <NLGPONKJHFJ>k__BackingField;    // 0x0x3C
    public int <MCCGFENGIMN>k__BackingField;    // 0x0x40
    public List<FJECGODMKKF> <LGNDGIFOKJE>k__BackingField;    // 0x0x48
}
...
public class APBCFEAGDII
{
    public int <HPPBIHPALJB>k__BackingField;    // 0x0x10
    public bool <LLJIKLMACPH>k__BackingField;    // 0x0x14
    public DateTime <EEJINMLLCGL>k__BackingField;    // 0x0x18
    public bool <JKJKLDFKEFN>k__BackingField;    // 0x0x20
}
...
public class BAKDGNCGDEM
{
    public JCNDFACNMJA <MEBCGOFAPBC>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <KJKGIKPNIKB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BCIJPCDIDKF
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{lLIGDOJCLHG}   [Service.API]
public class BCIJPCDIDKF
{
    public string <ENNGGBOIFDJ>k__BackingField;    // 0x0x10
    public string <BCJHCEGOGND>k__BackingField;    // 0x0x18
    public string <BCGBFJFAPEH>k__BackingField;    // 0x0x20
    public string <FLHIHGCLKNF>k__BackingField;    // 0x0x28
    public string <PFFJIHLPLOF>k__BackingField;    // 0x0x30
    public NFHDAPPBGLI <MGOEDKONIGL>k__BackingField;    // 0x0x38
    public List<string> <MMFANGHKHCF>k__BackingField;    // 0x0x40
    public List<string> <DDPBIKICOLC>k__BackingField;    // 0x0x48
    public string <BLBLICEOEJC>k__BackingField;    // 0x0x50
    public List<IECBLNAGNPH> <DAEHANBDLDN>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// BDKCMKABIOK
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class BDKCMKABIOK
{
    public string <BCJHCEGOGND>k__BackingField;    // 0x0x10
    public string <OGHPJCPGMAE>k__BackingField;    // 0x0x18
}
...
public class BLIEHCEDIGI
{
    public Guid <CPMFGMHKGCM>k__BackingField;    // 0x0x10
    public long? <MECJJKNBKEF>k__BackingField;    // 0x0x20
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x30
    public string <FLHIHGCLKNF>k__BackingField;    // 0x0x38
    public OEHMEIGCCDK <DBGMELAKNNF>k__BackingField;    // 0x0x40
    public long <NJHMBLPINCL>k__BackingField;    // 0x0x48
    public DateTime <BADFFJPJLMO>k__BackingField;    // 0x0x50
    public DateTime <CMHDNLPJLMP>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// BPHENKKAKKC
//   (not directly referenced by a detected call)
public class BPHENKKAKKC
{
    public long <HNGJOFFFHCK>k__BackingField;    // 0x0x10
    public Guid <NFPBMIELAEO>k__BackingField;    // 0x0x18
    public long <MECJJKNBKEF>k__BackingField;    // 0x0x28
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x30
    public string <FLHIHGCLKNF>k__BackingField;    // 0x0x38
    public int <CCNJIHCIKOD>k__BackingField;    // 0x0x40
    public Guid? <KMOGICPLCOA>k__BackingField;    // 0x0x44
    public DateTime <BADFFJPJLMO>k__BackingField;    // 0x0x58
}
...
public class CACJGIICAAG
{
    public int <DFBGAMNCGCI>k__BackingField;    // 0x0x10
    public int <HPPBIHPALJB>k__BackingField;    // 0x0x14
    public float <CGBGEGAFCMI>k__BackingField;    // 0x0x18
    public float <FFOKFFGBEEH>k__BackingField;    // 0x0x1C
    public bool <LLJIKLMACPH>k__BackingField;    // 0x0x20
    public bool <LPADLFOGHGC>k__BackingField;    // 0x0x21
    public bool <NPBLODHMDPP>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// CCABAGDJCKB
//   RESPONSE GET    api/inventions/v1/personaldetails/{pIJOLADOGIM}   [Service.API]
public class CCABAGDJCKB
{
    public bool <HOCCBEJBPHI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CFPEOABJEOF
//   (not directly referenced by a detected call)
public class CFPEOABJEOF
{
    public int <OMMNEPNBKNK>k__BackingField;    // 0x0x10
    public string <BMCNKKHIGAE>k__BackingField;    // 0x0x18
    public string <POEKOKBBCCL>k__BackingField;    // 0x0x20
    public string <MBHONCPDMGK>k__BackingField;    // 0x0x28
    public string <DPENBNDNJKF>k__BackingField;    // 0x0x30
    public PPDHOIFPOIF? <BHPAABPGAGE>k__BackingField;    // 0x0x38
    public string <HEMLGDMNEOM>k__BackingField;    // 0x0x40
    public string <IPKADKFIMLF>k__BackingField;    // 0x0x48
    public bool <LGLPPGGANOD>k__BackingField;    // 0x0x50
    public bool <KJHJBNKNONF>k__BackingField;    // 0x0x51
    public bool <BDKBNEBDANO>k__BackingField;    // 0x0x52
    public PCCJNJKJEFO <GLKMDFOIOAM>k__BackingField;    // 0x0x54
    public OEHMEIGCCDK <DBGMELAKNNF>k__BackingField;    // 0x0x58
    public int <GEFDFBEPKLK>k__BackingField;    // 0x0x5C
    public NPIMJPIKNAO <OAPEOBKMOKP>k__BackingField;    // 0x0x60
    public MLPICCBKBKB <JGIGCDDOEBB>k__BackingField;    // 0x0x64
    public int? <JNOJAPOJBOB>k__BackingField;    // 0x0x68
    public string <NJMHMLIFKCC>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// CJCCHENFAHB
//   (not directly referenced by a detected call)
public class CJCCHENFAHB
{
    public GJLMBDMNOEF <KCKONDKBMEE>k__BackingField;    // 0x0x10
    public FGMPJLEHBKE <JFNFGDHNODJ>k__BackingField;    // 0x0x18
}
...
public class CJFFLAIDDPO
{
    public string <AHNEBGENIGD>k__BackingField;    // 0x0x10
    public string <ONAIKHJJJBP>k__BackingField;    // 0x0x18
    public bool <OBFJHGHLNLD>k__BackingField;    // 0x0x20
    public string <HIILCDEIGPD>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// CMLDDOLMBLI
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{jACHAGKMDFN}   [Service.API]
public class CMLDDOLMBLI
{
    public Guid <KKGLKDCBOFP>k__BackingField;    // 0x0x10
    public int <AEIKLIHMMPA>k__BackingField;    // 0x0x20
    public int <GKEIFMMHHCL>k__BackingField;    // 0x0x24
    public DateTime <BADFFJPJLMO>k__BackingField;    // 0x0x28
}
...
// DAOEILBFGHL
//   (not directly referenced by a detected call)
public class DAOEILBFGHL
{
    public int <DAIOMAEPDGI>k__BackingField;    // 0x0x10
    public PIPMJOEAEPM <OJOBABOAEFE>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// DBHGILLFNPM
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class DBHGILLFNPM
{
    public int? <MAFEHOOHLGG>k__BackingField;    // 0x0x10
    public string <PFFJIHLPLOF>k__BackingField;    // 0x0x18
    public string <DNHIMCLFBPG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DCJECJIHNDP
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class DCJECJIHNDP
{
    public DOAJHMNOHCH <OJOBABOAEFE>k__BackingField;    // 0x0x10
    public List<string> <DDPBIKICOLC>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/playerevents/v1/all/{fDCEJGLBNKL}   [Service.API]
public class DEOKOIJJGNN
{
    public List<GJLMBDMNOEF> <INEJFEFHEJK>k__BackingField;    // 0x0x10
    public List<CJCCHENFAHB> <KECKAENEKEN>k__BackingField;    // 0x0x18
}
...
public class DHMEPMGNLPB : MLLJINHMGBD
{
    public List<LKMCEEGFBJK> EKDKHEKOLGK;    // 0x0x30
    public int <COFOOOBALOI>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// DICONDJCEJG
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class DICONDJCEJG
{
    public OEHMEIGCCDK <DBGMELAKNNF>k__BackingField;    // 0x0x10
    public INGHIIPFGIK <LPINGADFCKN>k__BackingField;    // 0x0x14
    public int <BDDLMPGKKCG>k__BackingField;    // 0x0x18
    public int <KFKFKNPCEHM>k__BackingField;    // 0x0x1C
    public int <FFPIOPBFNAA>k__BackingField;    // 0x0x20
    public MOMEOGAHABG <OENLCDGMGNP>k__BackingField;    // 0x0x24
    public bool <KNMMHOPCFNK>k__BackingField;    // 0x0x28
    public float <FMEFEDLMPGA>k__BackingField;    // 0x0x2C
    public int <DCKICICEIFH>k__BackingField;    // 0x0x30
    public bool <LKJNJHMNCKL>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// DIKFHPJEJCB
//   RESPONSE GET    api/incentivizedreferrals/   [Service.API]
public class DIKFHPJEJCB
{
    public List<KHHILGMLEBD> <GIOMIFHHBKD>k__BackingField;    // 0x0x10
    public string <DMAIBFFKCMB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DLFCDCJEIPG
//   (not directly referenced by a detected call)
public class DLFCDCJEIPG
{
    public Guid <MHNKFALKEFP>k__BackingField;    // 0x0x10
    public int <AEIKLIHMMPA>k__BackingField;    // 0x0x20
    public int <NIMELDLBINF>k__BackingField;    // 0x0x24
    public Guid <HDFDPLABLAL>k__BackingField;    // 0x0x28
    public DateTime <CMHDNLPJLMP>k__BackingField;    // 0x0x38
    public LHCIJIBLIMK <CBECGAMMHEO>k__BackingField;    // 0x0x40
}
...
// --------------------------------------------------------------------------
// EBJDKOJHOHN
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{lLIGDOJCLHG}   [Service.API]
public class EBJDKOJHOHN
{
    public uint <ENNGGBOIFDJ>k__BackingField;    // 0x0x10
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x18
    public string <FLHIHGCLKNF>k__BackingField;    // 0x0x20
    public DateTime <LIHGBAGIIKG>k__BackingField;    // 0x0x28
    public DateTime? <MJNCJBLMJEI>k__BackingField;    // 0x0x30
    public bool <OGOAPOKIAFP>k__BackingField;    // 0x0x40
    public List<BCIJPCDIDKF> <EEFJOBGODGP>k__BackingField;    // 0x0x48
    public List<string> <DDPBIKICOLC>k__BackingField;    // 0x0x50
    public int <EDCCADJBKFN>k__BackingField;    // 0x0x58
    public int <LALHHBNPHEJ>k__BackingField;    // 0x0x5C
    public int <GMPACPGPNKO>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// EDJKHGMFNGK
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class EDJKHGMFNGK
{
    public GGPIEPOANBK <BLLMBINLEIF>k__BackingField;    // 0x0x10
    public long <MEMCAAFJHFM>k__BackingField;    // 0x0x18
    public string <PGLJNCAHCHB>k__BackingField;    // 0x0x20
}
...
public class EFCKGPLGCFL
{
    public List<int> <AADHNGBMGAH>k__BackingField;    // 0x0x10
    public string <DMAIBFFKCMB>k__BackingField;    // 0x0x18
}
...
public class EJPCOLEGHLM
{
    public Dictionary<int, int> <OLJJFDINFLM>k__BackingField;    // 0x0x10
    public List<LNMOKDLEMNP> <MDDMDNALBAB>k__BackingField;    // 0x0x18
    public NMIBCELPJIF[][] <IODOJKDLABJ>k__BackingField;    // 0x0x20
    public JAOFHODCCCB <BFKIFPFBALI>k__BackingField;    // 0x0x28
    public ODCLMGIPICC <FOCPOLDAGMG>k__BackingField;    // 0x0x30
    public KCPACDNJGFL <IJGNCONBKHB>k__BackingField;    // 0x0x38
    public MLDIJBMJEBI <JFLIIPNHCHH>k__BackingField;    // 0x0x40
    public MIBCINDJGJO <NHOILNNPNFE>k__BackingField;    // 0x0x48
    public string <IDEJEDDGBBC>k__BackingField;    // 0x0x50
}
...
public class EKDEKCEDOHN
{
    public HTTPResponse NNOIKAOKMEC;    // 0x0x10
    public int? AFCJEKPPMJJ;    // 0x0x18
    public string MOIAFKGPMHO;    // 0x0x20
    public byte[] FLEJOHFCFNB;    // 0x0x28
    public string JJKGLNBLIEJ;    // 0x0x30
}
...
//   RESPONSE GET    api/avatar/v2/{fDCEJGLBNKL}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{fDCEJGLBNKL}   [Service.API]
public class ENKDCAKNDEA
{
    public string <GFJJMAOLPMB>k__BackingField;    // 0x0x10
    public string <IEAINHDJAIJ>k__BackingField;    // 0x0x18
    public string <OAJBENBFOAD>k__BackingField;    // 0x0x20
    public string <BNGGFGPJPDF>k__BackingField;    // 0x0x28
}
...
// FGMPJLEHBKE
//   (not directly referenced by a detected call)
public class FGMPJLEHBKE
{
    public long <NFLCHFONNJJ>k__BackingField;    // 0x0x10
    public long <MEMCAAFJHFM>k__BackingField;    // 0x0x18
    public int <ONBBBOPABGK>k__BackingField;    // 0x0x20
    public DateTime <BADFFJPJLMO>k__BackingField;    // 0x0x28
    public DDOGHACADIF <LOAMKGNKFLB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// FJECGODMKKF
//   RESPONSE GET    api/groups/v1/memberships/{mIHFLCECBDK}   [Service.API]
public class FJECGODMKKF
{
    public long <PAEBNBEKDNJ>k__BackingField;    // 0x0x10
    public int <ONBBBOPABGK>k__BackingField;    // 0x0x18
    public APPLMALBBOI <CKIMAJLMFFI>k__BackingField;    // 0x0x1C
}
...
public class FNFKNPDANOF
{
    public MKFGJDDIMIF <MGOEDKONIGL>k__BackingField;    // 0x0x10
    public GEFOCCLFHBF <DHNKOKOOEGP>k__BackingField;    // 0x0x18
    public PAMEDPGNMAC <CNHBKLLHGIL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GEFOCCLFHBF
//   (not directly referenced by a detected call)
public class GEFOCCLFHBF
{
    public long <GHIOJFBFKJD>k__BackingField;    // 0x0x10
    public string <NFPBMIELAEO>k__BackingField;    // 0x0x18
    public int <CBMJDGEJFPK>k__BackingField;    // 0x0x20
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x28
    public string <FLHIHGCLKNF>k__BackingField;    // 0x0x30
    public string <HJKDNKPHCFF>k__BackingField;    // 0x0x38
    public int <GFEJBFEDCKH>k__BackingField;    // 0x0x40
    public OIACHPLKFEH <CHANCKLHNHO>k__BackingField;    // 0x0x44
    public DateTime <CMHDNLPJLMP>k__BackingField;    // 0x0x48
    public DateTime <BADFFJPJLMO>k__BackingField;    // 0x0x50
    public DateTime? <HBNHKCOIOOJ>k__BackingField;    // 0x0x58
    public long? <CHNKCKPEFGP>k__BackingField;    // 0x0x68
    public int <FKAKLADGIKP>k__BackingField;    // 0x0x78
    public int <BBDBNKAPDMA>k__BackingField;    // 0x0x7C
    public int <KAEALCAGABI>k__BackingField;    // 0x0x80
    public OMNNOCOFDIE <IPAKBPJIAID>k__BackingField;    // 0x0x84
    public OMNNOCOFDIE <ACNCNBFHHDF>k__BackingField;    // 0x0x88
    public bool <KMDLIBMEHMC>k__BackingField;    // 0x0x8C
    public bool <BAHNGKBEGNC>k__BackingField;    // 0x0x8D
    public bool <KLMGLNEBMHP>k__BackingField;    // 0x0x8E
    public int? <CCNJIHCIKOD>k__BackingField;    // 0x0x90
    public bool <OOHDGLCBJLI>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// GJLMBDMNOEF
//   (not directly referenced by a detected call)
public class GJLMBDMNOEF
{
    public long <MEMCAAFJHFM>k__BackingField;    // 0x0x10
    public int <CBMJDGEJFPK>k__BackingField;    // 0x0x18
    public long <MECJJKNBKEF>k__BackingField;    // 0x0x20
    public long? <OMMKPAEPHDO>k__BackingField;    // 0x0x28
    public long? <BGJMOMLFMBH>k__BackingField;    // 0x0x38
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x48
    public string <FLHIHGCLKNF>k__BackingField;    // 0x0x50
    public string <HJKDNKPHCFF>k__BackingField;    // 0x0x58
    public DateTime <CDCCIDCGPDC>k__BackingField;    // 0x0x60
    public DateTime <PKFNHNEPGBF>k__BackingField;    // 0x0x68
    public int <LINFAFHNGIH>k__BackingField;    // 0x0x70
    public JMABDKLGIIL <CHANCKLHNHO>k__BackingField;    // 0x0x74
    public bool <HJHHLPEEDGM>k__BackingField;    // 0x0x78
    public bool <BNPOJFEBNNP>k__BackingField;    // 0x0x79
    public NFLDEDEPDKL <FJCECPMCALG>k__BackingField;    // 0x0x7C
    public NFLDEDEPDKL <GOACLNGPLNC>k__BackingField;    // 0x0x80
    public long? <DHLBIEICGJN>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// GNHLOHHIAKE
//   (not directly referenced by a detected call)
public class GNHLOHHIAKE
{
    public bool <GIJPFHBINEC>k__BackingField;    // 0x0x10
    public ADOJCKJKHGP <ILDBGHPAAJM>k__BackingField;    // 0x0x14
    public int <COFPMAJMKDF>k__BackingField;    // 0x0x18
    public DateTime <CMHDNLPJLMP>k__BackingField;    // 0x0x20
}
...
public class GOIKOJOFKJB
{
    public long <MECJJKNBKEF>k__BackingField;    // 0x0x10
    public long? <OMMKPAEPHDO>k__BackingField;    // 0x0x18
    public long? <BGJMOMLFMBH>k__BackingField;    // 0x0x28
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x38
    public string <FLHIHGCLKNF>k__BackingField;    // 0x0x40
    public List<string> <DDPBIKICOLC>k__BackingField;    // 0x0x48
    public string <HJKDNKPHCFF>k__BackingField;    // 0x0x50
    public DateTime <CDCCIDCGPDC>k__BackingField;    // 0x0x58
    public DateTime <PKFNHNEPGBF>k__BackingField;    // 0x0x60
    public JMABDKLGIIL <CHANCKLHNHO>k__BackingField;    // 0x0x68
    public bool <HJHHLPEEDGM>k__BackingField;    // 0x0x6C
    public bool <BNPOJFEBNNP>k__BackingField;    // 0x0x6D
    public NFLDEDEPDKL <FJCECPMCALG>k__BackingField;    // 0x0x70
    public NFLDEDEPDKL <GOACLNGPLNC>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// HEKODHGPHKO
//   (not directly referenced by a detected call)
public class HEKODHGPHKO
{
    public Guid <OGMFOGKOEOJ>k__BackingField;    // 0x0x10
    public Guid <EDHFCGPGMBB>k__BackingField;    // 0x0x20
    public DateTime <AIMJIBACFEL>k__BackingField;    // 0x0x30
    public List<CFPEOABJEOF> <JJFCNCOBFBH>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// HFKJLMGBKOP
//   (not directly referenced by a detected call)
public class HFKJLMGBKOP
{
    public int <JJKLHOLODCO>k__BackingField;    // 0x0x10
    public DateTime? <INPBPINCCPA>k__BackingField;    // 0x0x18
    public DateTime? <LNOENIDOJPJ>k__BackingField;    // 0x0x28
}
...
public class HKACFKKHNPE
{
    public List<string> <CMGPPIAKMLC>k__BackingField;    // 0x0x10
    public List<string> <BFMNNDELHDJ>k__BackingField;    // 0x0x18
    public List<string> <NPPODNGLHEL>k__BackingField;    // 0x0x20
}
...
public class HLNIOIMLFFN : NBDAPBPNMMC
{
    public LDPHGLPBDDF? <KAIILPNGHAB>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <KJKGIKPNIKB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HOIFPFDBFFK
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class HOIFPFDBFFK
{
    public List<NJKEEMPECLB> <DDPBIKICOLC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HOJFBMHHGHK
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class HOJFBMHHGHK
{
    public int <CEJOKMFDDGO>k__BackingField;    // 0x0x10
    public string <CEFPFAIGMAB>k__BackingField;    // 0x0x18
    public string <GFJJMAOLPMB>k__BackingField;    // 0x0x20
    public string <IEAINHDJAIJ>k__BackingField;    // 0x0x28
    public string <OAJBENBFOAD>k__BackingField;    // 0x0x30
    public string <BNGGFGPJPDF>k__BackingField;    // 0x0x38
}
...
// IECBLNAGNPH
//   (not directly referenced by a detected call)
public class IECBLNAGNPH
{
    public DateTime <BADFFJPJLMO>k__BackingField;    // 0x0x10
    public string <KLCGPJBEKJI>k__BackingField;    // 0x0x18
}
...
// IIEOFMCIDEO
//   (not directly referenced by a detected call)
public class IIEOFMCIDEO
{
    public long <OMMNEPNBKNK>k__BackingField;    // 0x0x10
    public string <MBHONCPDMGK>k__BackingField;    // 0x0x18
    public string <HEEPPEACLNO>k__BackingField;    // 0x0x20
    public PPDHOIFPOIF? <BHPAABPGAGE>k__BackingField;    // 0x0x28
    public string <HEMLGDMNEOM>k__BackingField;    // 0x0x30
    public string <IPKADKFIMLF>k__BackingField;    // 0x0x38
    public KNDNNMOOOFC <FALHMLAOBDL>k__BackingField;    // 0x0x40
    public int <OHKCIGBKKPH>k__BackingField;    // 0x0x44
    public int <DEBAAIKMMGP>k__BackingField;    // 0x0x48
    public MLPICCBKBKB? <NINAIFMMFCM>k__BackingField;    // 0x0x4C
    public PCCJNJKJEFO? <MPPADBGLLDI>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// IKMCMDGNFDM
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class IKMCMDGNFDM
{
    public long <MEMCAAFJHFM>k__BackingField;    // 0x0x10
    public DDOGHACADIF <LOAMKGNKFLB>k__BackingField;    // 0x0x18
}
...
public class INEDCNOMBLM
{
    public bool <AKBBBPAGDME>k__BackingField;    // 0x0x10
    public string <CMBBGDFKCKE>k__BackingField;    // 0x0x18
}
...
public class IOPKGCCHODO
{
    public int <AEIKLIHMMPA>k__BackingField;    // 0x0x10
    public Guid <CPMFGMHKGCM>k__BackingField;    // 0x0x14
    public long <POGCPKHPBFE>k__BackingField;    // 0x0x28
    public long <NBHDJHGMGLN>k__BackingField;    // 0x0x30
    public DateTime <PONDDMDJAKC>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// JAOFHODCCCB
//   (not directly referenced by a detected call)
public class JAOFHODCCCB
{
    public int <IKNDDLLNFNI>k__BackingField;    // 0x0x10
}
...
public class JCNDFACNMJA
{
    public int <AEIKLIHMMPA>k__BackingField;    // 0x0x10
    public Guid <CPMFGMHKGCM>k__BackingField;    // 0x0x14
    public long <POGCPKHPBFE>k__BackingField;    // 0x0x28
    public DateTime <CMHDNLPJLMP>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// JFNILJAOLGE
//   (not directly referenced by a detected call)
public class JFNILJAOLGE
{
    public int <GKEIFMMHHCL>k__BackingField;    // 0x0x10
    public AEPIFBIIBIH <LOAMKGNKFLB>k__BackingField;    // 0x0x14
    public List<JGLGIIODNAL> <MDEPMOGGLKM>k__BackingField;    // 0x0x18
    public List<JGLGIIODNAL> <EFHAMAIEAAK>k__BackingField;    // 0x0x20
    public bool <MADFCBHMHMG>k__BackingField;    // 0x0x28
    public DateTime? <JMBOMCHIAOG>k__BackingField;    // 0x0x30
    public DateTime? <IOMDEILOHEH>k__BackingField;    // 0x0x40
    public DateTime? <BDCDABCAEIA>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// JGLGIIODNAL
//   (not directly referenced by a detected call)
public class JGLGIIODNAL
{
    public OEHMEIGCCDK <DBGMELAKNNF>k__BackingField;    // 0x0x10
    public int <CCNJIHCIKOD>k__BackingField;    // 0x0x14
    public HFKJLMGBKOP <HBEFCDMIPGJ>k__BackingField;    // 0x0x18
}
...
public class JMHBLAJDBDF
{
    public int <KMAHBGIABCA>k__BackingField;    // 0x0x10
    public AJMJPDHBGHI <LOAMKGNKFLB>k__BackingField;    // 0x0x14
    public NNEDNJOJGGM <APPOGKAGDPK>k__BackingField;    // 0x0x18
    public NNEDNJOJGGM <NOEBHAPCNMC>k__BackingField;    // 0x0x1C
    public NNEDNJOJGGM <AMMIOFLFIKG>k__BackingField;    // 0x0x20
}
...
public class KBPIOFOOGNB
{
    public bool <AKBBBPAGDME>k__BackingField;    // 0x0x10
    public string <FIAOACDGKDF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KCCKAPNMDDH
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.API]
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{eCFGAKNDICJ}   [Service.API]
public class KCCKAPNMDDH
{
    public long <MECJJKNBKEF>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <GCPLHLJKGIA>k__BackingField;    // 0x0x18
    public AEPNGCKEBFC <KFHHJOJLHOF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KCPACDNJGFL
//   (not directly referenced by a detected call)
public class KCPACDNJGFL
{
    public int <BJNLNHEECOO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KHHILGMLEBD
//   (not directly referenced by a detected call)
public class KHHILGMLEBD
{
    public int <BJJOFKEBAFE>k__BackingField;    // 0x0x10
    public DateTime <BADFFJPJLMO>k__BackingField;    // 0x0x18
    public DateTime? <JIEHEGEDBIL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KKKOHILJIBA
//   RESPONSE POST   api/settings/v2/set   [Service.API]
public class KKKOHILJIBA
{
    public bool MKGBCGEHFKD;    // 0x0x10
    public bool IIODLKMOJPN;    // 0x0x11
}

// --------------------------------------------------------------------------
// KMGDMCGCLAL
//   RESPONSE GET    api/incentivizedreferrals/progress   [Service.API]
public class KMGDMCGCLAL
{
    public int <PPPIKMAOJIP>k__BackingField;    // 0x0x10
    public List<PMFOMMOLMPK> <INHLCKFDDON>k__BackingField;    // 0x0x18
}
...
public class LDOKGFIHDGL
{
    public LBKNCKBBDEG <MGOEDKONIGL>k__BackingField;    // 0x0x10
    public DLFCDCJEIPG <PMJJIPKCACH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LHCIJIBLIMK
//   (not directly referenced by a detected call)
public class LHCIJIBLIMK
{
    public Guid <MHNKFALKEFP>k__BackingField;    // 0x0x10
    public long <MECJJKNBKEF>k__BackingField;    // 0x0x20
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x28
    public string <FLHIHGCLKNF>k__BackingField;    // 0x0x30
    public string <HJKDNKPHCFF>k__BackingField;    // 0x0x38
    public long <CCNJIHCIKOD>k__BackingField;    // 0x0x40
    public Guid? <KMOGICPLCOA>k__BackingField;    // 0x0x48
    public DateTime <CMHDNLPJLMP>k__BackingField;    // 0x0x60
}
...
// base   : JFNILJAOLGE
//   (not directly referenced by a detected call)
public class LKMCEEGFBJK : JFNILJAOLGE
{
    public CFPEOABJEOF <JLMKLMNHHOJ>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// LMDNKENAFMN
// base   : System.Enum
//   RESPONSE DELETE api/roomkeys/v1/delete/{gGJGAHFIDMB}   [Service.API]
public enum LMDNKENAFMN
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
//   RESPONSE POST   api/playerevents/v2/delete/{cEIPBEJKHOM}   [Service.API]
...
public class LMDOAAOEMJP
{
    public GJLMBDMNOEF <KCKONDKBMEE>k__BackingField;    // 0x0x10
    public PIPMJOEAEPM <OJOBABOAEFE>k__BackingField;    // 0x0x18
    public DCJECJIHNDP <EFJJLBLCAHI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LOHEHMOMKJD
//   (not directly referenced by a detected call)
public class LOHEHMOMKJD
{
    public int <KEBNFAOAMJM>k__BackingField;    // 0x0x10
    public int <DAACDICBMAB>k__BackingField;    // 0x0x14
    public int <JCGPPHNLMCA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MCPPECEALKC
//   (not directly referenced by a detected call)
public class MCPPECEALKC
{
    public int <IGOJEOOEKLN>k__BackingField;    // 0x0x10
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x18
    public string <PGEAOIEJJNC>k__BackingField;    // 0x0x20
    public string <FLHIHGCLKNF>k__BackingField;    // 0x0x28
    public string <POEKOKBBCCL>k__BackingField;    // 0x0x30
    public bool <KPOMNOIJKKL>k__BackingField;    // 0x0x38
    public int <CEJOKMFDDGO>k__BackingField;    // 0x0x3C
    public OBFNJIFCDAA <OOOPOEFAPCA>k__BackingField;    // 0x0x40
    public ELGNJAJLCHC FFDOBLENBIC;    // 0x0x48
    public ELGNJAJLCHC BIGNJNGNJNI;    // 0x0x50
    public ELGNJAJLCHC NABEKOCDGNN;    // 0x0x58
    public CGLAKDPBCDK GLJPIBFBEDN;    // 0x0x60
}

// --------------------------------------------------------------------------
// MDGNALEBFEM
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class MDGNALEBFEM
{
    public Guid <IDFBEOPFLIA>k__BackingField;    // 0x0x10
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x20
    public string <HJKDNKPHCFF>k__BackingField;    // 0x0x28
    public DateTime <AIMJIBACFEL>k__BackingField;    // 0x0x30
    public DateTime? <APOGMGIEPIH>k__BackingField;    // 0x0x38
    public List<HEKODHGPHKO> <PBGMEOBENJP>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// MIBCINDJGJO
//   (not directly referenced by a detected call)
public class MIBCINDJGJO
{
    public float <AFMDOEPMDGI>k__BackingField;    // 0x0x10
}
...
// MLDIJBMJEBI
//   (not directly referenced by a detected call)
public class MLDIJBMJEBI
{
    public int <GEFLMGMIHKI>k__BackingField;    // 0x0x10
}
...
public class MPAOPICLJKH
{
    public Guid <BFGMAKCPHCN>k__BackingField;    // 0x0x10
    public Guid <CPMFGMHKGCM>k__BackingField;    // 0x0x20
    public int <GDCKNGFCKFP>k__BackingField;    // 0x0x30
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x38
    public long <GEHIAHLPAMF>k__BackingField;    // 0x0x40
    public long <CCNJIHCIKOD>k__BackingField;    // 0x0x48
    public DateTime <CMHDNLPJLMP>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// MPFMCGCKAMN
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class MPFMCGCKAMN
{
    public GGPIEPOANBK <BLLMBINLEIF>k__BackingField;    // 0x0x10
    public int <LCDFKMLJGJE>k__BackingField;    // 0x0x14
    public long <MNJGCBGOJFH>k__BackingField;    // 0x0x18
    public bool <PGDEEBNDIAG>k__BackingField;    // 0x0x20
    public string <CMBBGDFKCKE>k__BackingField;    // 0x0x28
    public int? <CODAHEGHJMB>k__BackingField;    // 0x0x30
    public bool <PCGHBFKLPPA>k__BackingField;    // 0x0x38
    public string <FBHOGBDDJBN>k__BackingField;    // 0x0x40
    public float <OAHGBKDDLDD>k__BackingField;    // 0x0x48
}
...
public class NCJLHCFOKAC
{
    public PIPMJOEAEPM <OJOBABOAEFE>k__BackingField;    // 0x0x10
}
...
// NJKEEMPECLB
//   (not directly referenced by a detected call)
public class NJKEEMPECLB
{
    public string <FFFFOEMLCJI>k__BackingField;    // 0x0x10
    public IEGACEBOEOL <LOAMKGNKFLB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NLJKGCIJAFA
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class NLJKGCIJAFA
{
    public int <JBOJAAMBBBH>k__BackingField;    // 0x0x10
    public string <CIEMCOHIGFD>k__BackingField;    // 0x0x18
    public List<MCPPECEALKC> <JEAHLFJPOFK>k__BackingField;    // 0x0x20
    public IIEOFMCIDEO <EGNJKJJBOHF>k__BackingField;    // 0x0x28
    public string <JBCNACBCFND>k__BackingField;    // 0x0x30
    public DateTime <AIMJIBACFEL>k__BackingField;    // 0x0x38
    public DateTime <LJJCMHNDKFD>k__BackingField;    // 0x0x40
    public DateTime <EFEDCIAPMPD>k__BackingField;    // 0x0x48
    public bool? <EFLBPNPOPFH>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// NMIBCELPJIF
//   (not directly referenced by a detected call)
public class NMIBCELPJIF
{
    public HPJDLCELBOP LLGCFGAJHEO;    // 0x0x10
    public int EJOCGHDJLCE;    // 0x0x14
    public int HCKCGEOGGOI;    // 0x0x18
}
...
public class NOPODOEGMDN
{
    public LMDNKENAFMN <MGOEDKONIGL>k__BackingField;    // 0x0x10
    public BPHENKKAKKC <EPDMLHCAAHK>k__BackingField;    // 0x0x18
}
...
// ODCLMGIPICC
//   (not directly referenced by a detected call)
public class ODCLMGIPICC
{
    public float <LOMFFMPOMNL>k__BackingField;    // 0x0x10
    public float <CHOMDIGKDKP>k__BackingField;    // 0x0x14
    public float <LGCJANPAOPC>k__BackingField;    // 0x0x18
    public float <PIHLLFKKLAF>k__BackingField;    // 0x0x1C
    public float <PKOPOJDPMPO>k__BackingField;    // 0x0x20
    public float <IAAAIGPDOEJ>k__BackingField;    // 0x0x24
    public float <EBDBFOHLJKD>k__BackingField;    // 0x0x28
    public float <EPOAHGPDGMJ>k__BackingField;    // 0x0x2C
}
...
public class OEEHFAKMHFF : MLLJINHMGBD
{
    public int <OHOFHMCPBMP>k__BackingField;    // 0x0x30
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x38
    public DateTime <AIMJIBACFEL>k__BackingField;    // 0x0x40
    public DateTime <LJJCMHNDKFD>k__BackingField;    // 0x0x48
    public OEHMEIGCCDK <DBGMELAKNNF>k__BackingField;    // 0x0x50
    public JFNILJAOLGE <APIDFBLLIGI>k__BackingField;    // 0x0x58
    public List<PNHJHFCGBEC> <HGGLKLJFBNL>k__BackingField;    // 0x0x60
    public GNHLOHHIAKE <OJLIDNODMJB>k__BackingField;    // 0x0x68
}
...
// OENKLHKOMOD
//   (not directly referenced by a detected call)
public class OENKLHKOMOD
{
    public bool <JLGMCDNLLMN>k__BackingField;    // 0x0x10
    public CFPEOABJEOF <JLMKLMNHHOJ>k__BackingField;    // 0x0x18
    public float <NLGDLOJDBBP>k__BackingField;    // 0x0x20
}
...
// PAMEDPGNMAC
//   (not directly referenced by a detected call)
public class PAMEDPGNMAC
{
    public long <GHIOJFBFKJD>k__BackingField;    // 0x0x10
    public string <NFPBMIELAEO>k__BackingField;    // 0x0x18
    public int <CDKLCDJCNJH>k__BackingField;    // 0x0x20
    public int <IAEOBCEKNAO>k__BackingField;    // 0x0x24
    public int <ONMOAGFBPNN>k__BackingField;    // 0x0x28
    public int <KBFHHLPOPEM>k__BackingField;    // 0x0x2C
    public int <LKCAJLPJELM>k__BackingField;    // 0x0x30
    public string <LNKKDJJMOAG>k__BackingField;    // 0x0x38
    public string <MNBGJEFBCPJ>k__BackingField;    // 0x0x40
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{aEGLDMNHMJA}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{aEGLDMNHMJA}   [Service.API]
...
public class PKPCBODJJEP
{
    public LBKNCKBBDEG <MGOEDKONIGL>k__BackingField;    // 0x0x10
    public LHCIJIBLIMK <CBECGAMMHEO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PMFOMMOLMPK
//   (not directly referenced by a detected call)
public class PMFOMMOLMPK
{
    public DateTime? <KMJCNAEMOPK>k__BackingField;    // 0x0x10
    public DateTime? <FJPHDIANDHB>k__BackingField;    // 0x0x20
    public MINOKFCHAIN <MGOEDKONIGL>k__BackingField;    // 0x0x30
    public LOHEHMOMKJD <DMLFHMHJAHE>k__BackingField;    // 0x0x38
    public bool <EMEHDKDFALE>k__BackingField;    // 0x0x40
}
...
// base   : JFNILJAOLGE
//   (not directly referenced by a detected call)
public class PNHJHFCGBEC : JFNILJAOLGE
{
    public int <BAEMBBPGALM>k__BackingField;    // 0x0x60
    public List<OENKLHKOMOD> <JBHAINEMMIH>k__BackingField;    // 0x0x68
    public List<OENKLHKOMOD> <BLLPFOIIOCE>k__BackingField;    // 0x0x70
    public List<OENKLHKOMOD> <HLHKIAKLGHC>k__BackingField;    // 0x0x78
}
...
public class GetRankRequestDTO
{
    ...
    public MONKJLIBGHL FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public MLPICCBKBKB <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public BPLNJBLFLOE creatorAccountRole;    // 0x0x58
}
...
{
    public NKDFJLMDOLI <MCPOPEALINF>k__BackingField;    // 0x0x10
    public string <ECAAHNNIBKJ>k__BackingField;    // 0x0x18
    public bool <IJGIKGBNPGB>k__BackingField;    // 0x0x20
}
...
{
    public List<NKDFJLMDOLI> <JBDPONJALNE>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public JLOJHEMHNNJ ReportCategory;    // 0x0x20
}
...
{
    public ALPFOFLPMOP? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public ALPFOFLPMOP DODLNIMKKAF;  // wrapper
...
{
    public CFHMGFDJBOI FNICCCDPJAO;  // wrapper
...
{
    public GOAMPJAHFHE IPLFCJCEGLD;  // wrapper
    public int? LBDINCKACEB;  // wrapper
...
{
    public NMFHFICMKFI UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public MLPICCBKBKB POJPEFNIBPF;  // wrapper
    public MLPICCBKBKB? GIKEEIHDHGJ;  // wrapper
...
{
    public MCPPECEALKC JDEHLFDDDGJ;  // wrapper
...
{
    public GGPIEPOANBK LAMLAPFKCIH;  // wrapper
...
{
    public IReadOnlyList<CNFFPAHBNDP> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public AGGDJFOMHNJ MDKONPLLILK;  // wrapper
    public MLPICCBKBKB? HLOOMIOPFJA;  // wrapper
...
{
    public AEOCEHOFMCB HOPMMHIDGEK;  // wrapper
...
{
    public StatusResponse> MCONDHIGJPI;  // wrapper
...
{
    public List<long> NOOHDDGPFMH;  // wrapper
    public FALKLKBAFCB MCONDHIGJPI;  // wrapper
    public GNIJIPPLMHF KNPFIPDJOIN;  // wrapper
    public long? ECFGAKNDICJ;  // wrapper
...
{
    public String> MCONDHIGJPI;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{cEIPBEJKHOM}  [API POST]
public class PlayereventsV2DeleteCEIPBEJKHOMRequest
{
    public GJLMBDMNOEF CEIPBEJKHOM;  // wrapper
}
...
{
    public GJLMBDMNOEF CEIPBEJKHOM;  // wrapper
    public JMABDKLGIIL FEHCGJMIPFB;  // wrapper
...
{
    public GJLMBDMNOEF CEIPBEJKHOM;  // wrapper
    public long? FMOIADLLJBH;  // wrapper
    public object clubId;  // candidate
}
...
{
    public GJLMBDMNOEF CEIPBEJKHOM;  // wrapper
    public NFLDEDEPDKL MCAGEDFIFKG;  // wrapper
    public NFLDEDEPDKL JJBAECDHKHP;  // wrapper
...
{
    public GJLMBDMNOEF CEIPBEJKHOM;  // wrapper
    public long? LPCMOFCDCAC;  // wrapper
    public object roomId;  // candidate
...
{
    public GJLMBDMNOEF CEIPBEJKHOM;  // wrapper
    public List<string> BOMDLPKHMCC;  // wrapper
...
{
    public GJLMBDMNOEF CEIPBEJKHOM;  // wrapper
    public DateTime GNFKIPEFFLO;  // wrapper
    public DateTime AFKNPDNLNLN;  // wrapper
...
{
    public List<BFLKIHAPAFI> JAHJEIBHOBE;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> HMGNHMCNGBD;  // wrapper
...
{
    public Guid? GLOEPHCLBOM;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats MJFGLIEBFBB;  // wrapper
}
...
{
    public Guid GGFHLFBMFBP;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<IBHJIKAGKMJ> JAHJEIBHOBE;  // wrapper
    public object objectiveType;  // candidate
...
{
    public NFHDAPPBGLI FJPOOCENOCD;  // wrapper
}
