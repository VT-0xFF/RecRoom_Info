...
public class AFBLKIADPNC
{
    public int <GGMDGIDBBGH>k__BackingField;    // 0x0x10
}
...
public class ANNIIFBGKLI
{
    public int <KABEBLNHPMP>k__BackingField;    // 0x0x10
    public List<OINKMDNHGJF> <KPKLPDEAJGE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BEGIKPKKFIA
//   (not directly referenced by a detected call)
public class BEGIKPKKFIA
{
...
// BEPDGGKFNEF
//   (not directly referenced by a detected call)
public class BEPDGGKFNEF
{
    public Guid <NJEKJAJEEID>k__BackingField;    // 0x0x10
    public Guid <IDHIMBHPCBE>k__BackingField;    // 0x0x20
    public DateTime <LBNDOBBBBDJ>k__BackingField;    // 0x0x30
    public List<LJKDDPOGIPM> <KEGAMOEDHEI>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// BJIKFDLIMKK
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{lJPMPJDOKIO}   [Service.API]
...
public class BJIKFDLIMKK
{
    public GPBNGLMACAI <JOEHLPBAGKG>k__BackingField;    // 0x0x10
    public BEODBNJDGDN <LCIJMMMAPOO>k__BackingField;    // 0x0x18
    public OCGEAGBJJKJ <NEGIMNOHDGK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BKKHPHKNNOF
//   RESPONSE GET    api/inventions/v1/personaldetails/{pBMDKPEAKGO}   [Service.API]
public class BKKHPHKNNOF
{
    public bool <HCMJKLGNAGO>k__BackingField;    // 0x0x10
}
...
// CBJBHIGBPIK
//   (not directly referenced by a detected call)
public class CBJBHIGBPIK
{
    public long <OMDPKCAKMGE>k__BackingField;    // 0x0x10
    public string <GAEDINPEGFP>k__BackingField;    // 0x0x18
    public int <DFIOAIHALBL>k__BackingField;    // 0x0x20
    public int <CBDOEGLFFCG>k__BackingField;    // 0x0x24
    public int <MODNFAFAOJM>k__BackingField;    // 0x0x28
    public int <CIFJAEACBEB>k__BackingField;    // 0x0x2C
    public int <CAJLCFLALLK>k__BackingField;    // 0x0x30
    public string <EIGMHMCHHDO>k__BackingField;    // 0x0x38
    public string <EPFBKJHOLAC>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// CEJDILGCPIB
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class CEJDILGCPIB
{
    public COPMCKHMPDP <BJGDLDMOBEC>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <GMEOJDAGHFK>k__BackingField;    // 0x0x18
}
...
public class CEKFOKODLJM : JBKJFCANCEA
{
    public MHIIAFNKMGB? <PBBHBIEGDHI>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <GMEOJDAGHFK>k__BackingField;    // 0x0x20
}
...
public class CHMHLMMBEND
{
    public Guid <GCEALHKBNAL>k__BackingField;    // 0x0x10
    public long? <KFLKBLDGBEC>k__BackingField;    // 0x0x20
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x30
    public string <HGGANMOHPEG>k__BackingField;    // 0x0x38
    public IAOJHNCDGEH <NOEPIPFNLNG>k__BackingField;    // 0x0x40
    public long <IIODFIFIDJJ>k__BackingField;    // 0x0x48
    public string <PBHOGBCJGGE>k__BackingField;    // 0x0x50
    public DateTime <EEBEOCEDDFO>k__BackingField;    // 0x0x58
    public DateTime <KGMHJPMJFMC>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// CKHJFFDDCCG
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class CKHJFFDDCCG
{
    public List<JIKDFDEFHMG> <BNMHALJNPBC>k__BackingField;    // 0x0x10
    public BEODBNJDGDN <LCIJMMMAPOO>k__BackingField;    // 0x0x18
}
...
public class CLMECBLEHAF
{
    public int? <OEHKFDGBNPK>k__BackingField;    // 0x0x10
    public string <LPGFEAIAOGN>k__BackingField;    // 0x0x18
    public string <BAGFMONIDDB>k__BackingField;    // 0x0x20
}
...
public class CMJLIDBNIEE : NCGNBHMFPMJ
{
    public int <NGJKBIPFBEO>k__BackingField;    // 0x0x30
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x38
    public DateTime <LBNDOBBBBDJ>k__BackingField;    // 0x0x40
    public DateTime <HANMNNMGMNA>k__BackingField;    // 0x0x48
    public IAOJHNCDGEH <NOEPIPFNLNG>k__BackingField;    // 0x0x50
    public OFJFOKOACFB <MJJNAHONKPL>k__BackingField;    // 0x0x58
    public List<JHDAMELIDDI> <HAPEKFJHJHF>k__BackingField;    // 0x0x60
    public HCOJFLGKBOC <BLFALGHJPEL>k__BackingField;    // 0x0x68
}
...
public class COBBLGCEIAG
{
    public int <GDDBAKLAABO>k__BackingField;    // 0x0x10
    public HPEHGKAHOHH <LBMOECJGAHM>k__BackingField;    // 0x0x14
    public FGHPOAHOGPO <LFMLHPCOCMJ>k__BackingField;    // 0x0x18
    public FGHPOAHOGPO <JMHLPOMOBLO>k__BackingField;    // 0x0x1C
    public FGHPOAHOGPO <DBBOJDOBBJJ>k__BackingField;    // 0x0x20
}
...
public class COPMCKHMPDP
{
    public int <LLBEOHEECCM>k__BackingField;    // 0x0x10
    public Guid <GCEALHKBNAL>k__BackingField;    // 0x0x14
    public long <CJNHPKAJPNF>k__BackingField;    // 0x0x28
    public DateTime <KGMHJPMJFMC>k__BackingField;    // 0x0x30
}
...
// CPHBDBFPPJK
//   (not directly referenced by a detected call)
public class CPHBDBFPPJK
{
    public Guid <BDNAKGEIAGA>k__BackingField;    // 0x0x10
    public long <KFLKBLDGBEC>k__BackingField;    // 0x0x20
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x28
    public string <HGGANMOHPEG>k__BackingField;    // 0x0x30
    public string <PBHOGBCJGGE>k__BackingField;    // 0x0x38
    public long <JCOMKFNDGBC>k__BackingField;    // 0x0x40
    public Guid? <KONKPDKJLBM>k__BackingField;    // 0x0x48
    public DateTime <KGMHJPMJFMC>k__BackingField;    // 0x0x60
}
...
public class DEHIHHLCKNF
{
    public bool EKAIJHLAPGK;    // 0x0x10
    public bool POOCBNLKMED;    // 0x0x11
}
...
// base   : OFJFOKOACFB
//   (not directly referenced by a detected call)
public class ECCJLGJIJPK : OFJFOKOACFB
{
    public LJKDDPOGIPM <FNBFHINBFKO>k__BackingField;    // 0x0x60
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{iBCFBLGDGDM}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{iBCFBLGDGDM}   [Service.API]
...
public class EHKCPILBNML
{
    public ICLCPLMHEPL <GBCIIEMIBPG>k__BackingField;    // 0x0x10
    public CPHBDBFPPJK <AJPKKGPJBDC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EMCAFMBELKE
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class EMCAFMBELKE
{
    public int <JEOJBLCNDKH>k__BackingField;    // 0x0x10
    public string <HKNMDMICODP>k__BackingField;    // 0x0x18
    public string <AHBNIGCNLCB>k__BackingField;    // 0x0x20
    public string <KGCFLPBPAIM>k__BackingField;    // 0x0x28
    public string <NHEFFHKCPCK>k__BackingField;    // 0x0x30
    public string <JCBPLPIMGHA>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// EMOKKMODLOM
//   (not directly referenced by a detected call)
public class EMOKKMODLOM
{
    public long <BGGGKOMIKIE>k__BackingField;    // 0x0x10
    public string <PBMIGAAHIBB>k__BackingField;    // 0x0x18
    public string <EPCCANNPOHE>k__BackingField;    // 0x0x20
    public ANMEKJDIJLO? <OOJMEBIGLPC>k__BackingField;    // 0x0x28
    public string <MKNKKCMHKAN>k__BackingField;    // 0x0x30
    public string <EHDHCKPIGLO>k__BackingField;    // 0x0x38
    public DAGGPOKOGFA <BPMGGBAEFOC>k__BackingField;    // 0x0x40
    public int <NGKOKNDGEIG>k__BackingField;    // 0x0x44
    public int <CHPGNEGKGMG>k__BackingField;    // 0x0x48
    public MGEPDAHEDIE? <LEKGOCGCONF>k__BackingField;    // 0x0x4C
    public NAHGHBPAKAG? <EDFEMIGFFLN>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// EOCDMHHIGFI
//   (not directly referenced by a detected call)
public class EOCDMHHIGFI
{
    public IAOJHNCDGEH <NOEPIPFNLNG>k__BackingField;    // 0x0x10
    public int <JCOMKFNDGBC>k__BackingField;    // 0x0x14
    public ODPMOGJHILL <IPDBOAEFHCE>k__BackingField;    // 0x0x18
}
...
public class EPBNFGPEMKO
{
    public AINAIGCGHDN <GBCIIEMIBPG>k__BackingField;    // 0x0x10
    public LAMNPIHJOJB <GEHLBCLDJON>k__BackingField;    // 0x0x18
}
...
// FAHLLJFCBPG
//   (not directly referenced by a detected call)
public class FAHLLJFCBPG
{
    public int <PNMMKNJDHHC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FBANKDNICLL
//   (not directly referenced by a detected call)
public class FBANKDNICLL
{
    public int <HCIDHMCKOHG>k__BackingField;    // 0x0x10
}
...
public class FDFNILAJCAE
{
    public LBALIBGPEHM <GBCIIEMIBPG>k__BackingField;    // 0x0x10
    public IIEKFPAICAA <PCOAIDMHPMH>k__BackingField;    // 0x0x18
    public CBJBHIGBPIK <KHFKPCNNMKM>k__BackingField;    // 0x0x20
}
...
public class FFHMKEOHBJM
{
    public BEODBNJDGDN <LCIJMMMAPOO>k__BackingField;    // 0x0x10
}
...
public class FFJLKJDNFHF
{
    public Guid <IHJANAHNKDI>k__BackingField;    // 0x0x10
    public Guid <GCEALHKBNAL>k__BackingField;    // 0x0x20
    public int <ABEIIBNEEBM>k__BackingField;    // 0x0x30
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x38
    public long <ALIEJJEOJHB>k__BackingField;    // 0x0x40
    public long <JCOMKFNDGBC>k__BackingField;    // 0x0x48
    public DateTime <KGMHJPMJFMC>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// FHNDHKEBNKA
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class FHNDHKEBNKA
{
    public IAOJHNCDGEH <NOEPIPFNLNG>k__BackingField;    // 0x0x10
    public EOJCKOADFNC <KHBDPJHAPNA>k__BackingField;    // 0x0x14
    public int <BNDMLOENCGK>k__BackingField;    // 0x0x18
    public int <LOILMJIJGPK>k__BackingField;    // 0x0x1C
    public int <IGFABLDNLJP>k__BackingField;    // 0x0x20
    public NNFGOONHLNA <BHLCFJMFNKM>k__BackingField;    // 0x0x24
    public bool <BNJJJKADGJD>k__BackingField;    // 0x0x28
    public float <MIMDIFBFCMJ>k__BackingField;    // 0x0x2C
    public int <KIFKEDFLACC>k__BackingField;    // 0x0x30
    public bool <KNLPDMDLNBA>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// GDLLIKAMEBE
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{kLAJMHFBNLK}   [Service.API]
public class GDLLIKAMEBE
{
    public Guid <AIFIKJFLNHO>k__BackingField;    // 0x0x10
    public int <LLBEOHEECCM>k__BackingField;    // 0x0x20
    public int <MENILJILMKI>k__BackingField;    // 0x0x24
    public DateTime <EEBEOCEDDFO>k__BackingField;    // 0x0x28
}
...
public class GHDMBEHAOND
{
    public List<string> <GIAEMGOCIML>k__BackingField;    // 0x0x10
    public List<string> <CDHEBGLDJLD>k__BackingField;    // 0x0x18
    public List<string> <FMAHGDGCBAI>k__BackingField;    // 0x0x20
}
...
public class GOEKMHOKGOI
{
    public List<NFCFALBJJOF> <LDLELCNMKMH>k__BackingField;    // 0x0x10
    public string <IEGDFBCDEOM>k__BackingField;    // 0x0x18
}
...
// GPBNGLMACAI
//   (not directly referenced by a detected call)
public class GPBNGLMACAI
{
    public long <PEKCMAKAIBD>k__BackingField;    // 0x0x10
    public int <BKPNDEGCHKA>k__BackingField;    // 0x0x18
    public long <KFLKBLDGBEC>k__BackingField;    // 0x0x20
    public long? <IHHILJLIFEO>k__BackingField;    // 0x0x28
    public long? <IGKIJCCNNCI>k__BackingField;    // 0x0x38
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x48
    public string <HGGANMOHPEG>k__BackingField;    // 0x0x50
    public string <PBHOGBCJGGE>k__BackingField;    // 0x0x58
    public DateTime <CMLNPCFPMCD>k__BackingField;    // 0x0x60
    public DateTime <MAONHOMCDGD>k__BackingField;    // 0x0x68
    public int <HKJKKAMAMPP>k__BackingField;    // 0x0x70
    public PLONNBLMDGN <FLLNMCCIGEM>k__BackingField;    // 0x0x74
    public bool <HIFCCCDGGOL>k__BackingField;    // 0x0x78
    public bool <COLGGLGMIAC>k__BackingField;    // 0x0x79
    public NKAGBGJJONO <CGEIBECEGAM>k__BackingField;    // 0x0x7C
    public NKAGBGJJONO <LAIBKOBGKAP>k__BackingField;    // 0x0x80
    public long? <CBGDMGLGPJM>k__BackingField;    // 0x0x88
}
...
public class HCCPBCLJDHA
{
    public bool <HMLBOKHCIMI>k__BackingField;    // 0x0x10
    public string <HNDBBEEIMFH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HCOJFLGKBOC
//   (not directly referenced by a detected call)
public class HCOJFLGKBOC
{
    public bool <HOEMCMEPDEP>k__BackingField;    // 0x0x10
    public HDFIEBGBMBB <PLIKKGDHDEO>k__BackingField;    // 0x0x14
    public int <IILJCFKEDAO>k__BackingField;    // 0x0x18
    public DateTime <KGMHJPMJFMC>k__BackingField;    // 0x0x20
}
...
public class HFALAGHBOPN
{
    public int <KFOMJMBGFOG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HHCLKNONAJC
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class HHCLKNONAJC
{
    public List<HKLBECGKPGO> <BKIJGONMIAJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HJIJLANKLBF
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{nKFKNPEOIHO}   [Service.API]
public class HJIJLANKLBF
{
    public string <MKGMKPHGGBH>k__BackingField;    // 0x0x10
    public string <FILCPBACIFF>k__BackingField;    // 0x0x18
    public string <GJMHBMCPOLO>k__BackingField;    // 0x0x20
    public string <HGGANMOHPEG>k__BackingField;    // 0x0x28
    public string <LPGFEAIAOGN>k__BackingField;    // 0x0x30
    public LKCFAPFHOAJ <GBCIIEMIBPG>k__BackingField;    // 0x0x38
    public List<string> <CAKPMGEPLMH>k__BackingField;    // 0x0x40
    public List<string> <BKIJGONMIAJ>k__BackingField;    // 0x0x48
    public string <BAMFMPNJBBI>k__BackingField;    // 0x0x50
    public List<IKNCPOMMKJD> <POKDEOGLDBK>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// HKLBECGKPGO
//   (not directly referenced by a detected call)
public class HKLBECGKPGO
{
    public string <MHDNJJICFJL>k__BackingField;    // 0x0x10
    public CPFNFLHMGOJ <LBMOECJGAHM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HLAKNONBKGI
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class HLAKNONBKGI
{
    public IENLCFOHFPB <IGFDLOKADPL>k__BackingField;    // 0x0x10
    public int <KFOMJMBGFOG>k__BackingField;    // 0x0x14
    public long <GHIANJGIBNL>k__BackingField;    // 0x0x18
    public bool <NNONAELGLOG>k__BackingField;    // 0x0x20
    public string <EMLDKMAAOPD>k__BackingField;    // 0x0x28
    public int? <JKNAAOKBHOH>k__BackingField;    // 0x0x30
    public bool <HKLMMCHFKIN>k__BackingField;    // 0x0x38
    public string <IDNOEPHNACL>k__BackingField;    // 0x0x40
    public float <HOENMDNJIIO>k__BackingField;    // 0x0x48
}
...
public class HPAODOCLOLN
{
    public List<int> <GHIMPEIMLHB>k__BackingField;    // 0x0x10
    public string <IEGDFBCDEOM>k__BackingField;    // 0x0x18
}
...
public class IFJCJDPOIKL
{
    public IENLCFOHFPB <IGFDLOKADPL>k__BackingField;    // 0x0x10
    public long <PEKCMAKAIBD>k__BackingField;    // 0x0x18
    public string <KFLOHDKAOPE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IICJGCLOKKD
//   (not directly referenced by a detected call)
public class IICJGCLOKKD
{
    public int <LBAKOKDAOMK>k__BackingField;    // 0x0x10
    public int <LAOMCBMGAHC>k__BackingField;    // 0x0x14
    public int <FGEHCLHOHOC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IIEKFPAICAA
//   (not directly referenced by a detected call)
public class IIEKFPAICAA
{
    public long <OMDPKCAKMGE>k__BackingField;    // 0x0x10
    public string <GAEDINPEGFP>k__BackingField;    // 0x0x18
    public int <BKPNDEGCHKA>k__BackingField;    // 0x0x20
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x28
    public string <HGGANMOHPEG>k__BackingField;    // 0x0x30
    public string <PBHOGBCJGGE>k__BackingField;    // 0x0x38
    public int <EINCLPPKHKE>k__BackingField;    // 0x0x40
    public HPEEOCDHGEI <FLLNMCCIGEM>k__BackingField;    // 0x0x44
    public DateTime <KGMHJPMJFMC>k__BackingField;    // 0x0x48
    public DateTime <EEBEOCEDDFO>k__BackingField;    // 0x0x50
    public DateTime? <JKGKNMDAPPA>k__BackingField;    // 0x0x58
    public long? <GACPDPOCBIA>k__BackingField;    // 0x0x68
    public int <NLOCDIIGLBI>k__BackingField;    // 0x0x78
    public int <CIBCIKPECCI>k__BackingField;    // 0x0x7C
    public int <DOFOFCDDKIJ>k__BackingField;    // 0x0x80
    public PGGIAMCGLGA <GOMAEKLCAPI>k__BackingField;    // 0x0x84
    public PGGIAMCGLGA <EONJMKFBCJG>k__BackingField;    // 0x0x88
    public bool <LGFPNHDBKDC>k__BackingField;    // 0x0x8C
    public bool <GMBJLPDHEHO>k__BackingField;    // 0x0x8D
    public bool <HHAFEEMKFEK>k__BackingField;    // 0x0x8E
    public int? <JCOMKFNDGBC>k__BackingField;    // 0x0x90
    public bool <FADFIGJKCLE>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// IIHGAIANIDI
//   (not directly referenced by a detected call)
public class IIHGAIANIDI
{
    public GPBNGLMACAI <JOEHLPBAGKG>k__BackingField;    // 0x0x10
    public NACKGDHKBLA <BLNJIPLKPOH>k__BackingField;    // 0x0x18
}
...
// IKNCPOMMKJD
//   (not directly referenced by a detected call)
public class IKNCPOMMKJD
{
    public DateTime <EEBEOCEDDFO>k__BackingField;    // 0x0x10
    public string <OEOHPDHFBJB>k__BackingField;    // 0x0x18
}
...
public class IOPDCKABOJD
{
    public string <JLMDJLKIKAL>k__BackingField;    // 0x0x10
    public string <COIPINLPCEJ>k__BackingField;    // 0x0x18
    public bool <KAPLOFCPHMC>k__BackingField;    // 0x0x20
    public string <DBHHODONOAO>k__BackingField;    // 0x0x28
}
...
//   RESPONSE GET    api/avatar/v2/{cMEEBCKKIKF}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{cMEEBCKKIKF}   [Service.API]
public class JDGAOJFIEIB
{
    public string <AHBNIGCNLCB>k__BackingField;    // 0x0x10
    public string <KGCFLPBPAIM>k__BackingField;    // 0x0x18
    public string <NHEFFHKCPCK>k__BackingField;    // 0x0x20
    public string <JCBPLPIMGHA>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// JEECJMACJDM
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class JEECJMACJDM
{
    public string <FILCPBACIFF>k__BackingField;    // 0x0x10
    public string <EHGGAHOOBBI>k__BackingField;    // 0x0x18
}
...
// base   : OFJFOKOACFB
//   (not directly referenced by a detected call)
public class JHDAMELIDDI : OFJFOKOACFB
{
    public int <PHIJGGFEBPA>k__BackingField;    // 0x0x60
    public List<OGGKEOAKPGO> <JCFGJGPNINH>k__BackingField;    // 0x0x68
    public List<OGGKEOAKPGO> <JBOIAIJOOCG>k__BackingField;    // 0x0x70
    public List<OGGKEOAKPGO> <DHMGPJAEDGB>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// JIKDFDEFHMG
//   (not directly referenced by a detected call)
public class JIKDFDEFHMG
{
    public int <DHOOEOOGIMP>k__BackingField;    // 0x0x10
    public BEODBNJDGDN <LCIJMMMAPOO>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// JPCGOFLMHGF
//   (not directly referenced by a detected call)
public class JPCGOFLMHGF
{
    public float <NFCDMAMELNF>k__BackingField;    // 0x0x10
}
...
public class JPFKCAAHEHF
{
    public int <IEBOOBFLPKK>k__BackingField;    // 0x0x10
    public bool <PMHCHKACHFG>k__BackingField;    // 0x0x14
    public DateTime <HFHHPPACKJG>k__BackingField;    // 0x0x18
    public bool <PEEJFMLGHDG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KGBBHKGMANI
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class KGBBHKGMANI
{
    public int <MDLILDCGALD>k__BackingField;    // 0x0x10
    public string <DBHDHEIAKKB>k__BackingField;    // 0x0x18
    public List<KJBJCKHMIBH> <HOHJNOBELGL>k__BackingField;    // 0x0x20
    public EMOKKMODLOM <IJCFHBOFPPB>k__BackingField;    // 0x0x28
    public string <DAFMCDMMJAC>k__BackingField;    // 0x0x30
    public DateTime <LBNDOBBBBDJ>k__BackingField;    // 0x0x38
    public DateTime <HANMNNMGMNA>k__BackingField;    // 0x0x40
    public DateTime <DAPJEFDKKKE>k__BackingField;    // 0x0x48
    public bool? <PMOJHEBCADI>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// KJBJCKHMIBH
//   (not directly referenced by a detected call)
public class KJBJCKHMIBH
{
    public int <JBCGFCCPNNF>k__BackingField;    // 0x0x10
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x18
    public string <JAAKKHMLJPI>k__BackingField;    // 0x0x20
    public string <HGGANMOHPEG>k__BackingField;    // 0x0x28
    public string <DAEHGPODNMH>k__BackingField;    // 0x0x30
    public bool <KJCFEBOMIOI>k__BackingField;    // 0x0x38
    public int <JEOJBLCNDKH>k__BackingField;    // 0x0x3C
    public BEGIKPKKFIA <DOOBIHGKMKN>k__BackingField;    // 0x0x40
    public OICBBKAAMGE NHGOJCOEIIJ;    // 0x0x48
    public OICBBKAAMGE FCAGLFEAKPA;    // 0x0x50
    public OICBBKAAMGE OMLAOPJGKKO;    // 0x0x58
    public FKMEGFFMMLP LFNJFAOMCCL;    // 0x0x60
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{jNDBLIENNEJ}   [Service.API]
public class KNHBIIFBOPG
{
    public long <KFLKBLDGBEC>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <KBHHCDNNPEO>k__BackingField;    // 0x0x18
    public IJANNCGDOKA <HHHPDCJOOEN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LAMNPIHJOJB
//   (not directly referenced by a detected call)
public class LAMNPIHJOJB
{
    public long <IEIAFAPHGFP>k__BackingField;    // 0x0x10
    public Guid <GAEDINPEGFP>k__BackingField;    // 0x0x18
    public long <KFLKBLDGBEC>k__BackingField;    // 0x0x28
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x30
    public string <HGGANMOHPEG>k__BackingField;    // 0x0x38
    public int <JCOMKFNDGBC>k__BackingField;    // 0x0x40
    public Guid? <KONKPDKJLBM>k__BackingField;    // 0x0x44
    public DateTime <EEBEOCEDDFO>k__BackingField;    // 0x0x58
    public string <PBHOGBCJGGE>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// LAODBBLJCAM
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{nKFKNPEOIHO}   [Service.API]
public class LAODBBLJCAM
{
    public uint <MKGMKPHGGBH>k__BackingField;    // 0x0x10
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x18
    public string <HGGANMOHPEG>k__BackingField;    // 0x0x20
    public DateTime <IIFKFAJFHEA>k__BackingField;    // 0x0x28
    public DateTime? <FPCGCHBBNJI>k__BackingField;    // 0x0x30
    public bool <BBBIDOPIKND>k__BackingField;    // 0x0x40
    public List<HJIJLANKLBF> <AKPDLCELAKK>k__BackingField;    // 0x0x48
    public List<string> <BKIJGONMIAJ>k__BackingField;    // 0x0x50
    public int <NENMDEALLNH>k__BackingField;    // 0x0x58
    public int <GNBEBKGDGLK>k__BackingField;    // 0x0x5C
    public int <NIJGBBMFCGE>k__BackingField;    // 0x0x60
}
...
public class LCMIOFDFFJJ
{
    public Guid <OAIGFPEBOMO>k__BackingField;    // 0x0x10
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x20
    public string <PBHOGBCJGGE>k__BackingField;    // 0x0x28
    public DateTime <LBNDOBBBBDJ>k__BackingField;    // 0x0x30
    public DateTime? <OJCCEAOOHOH>k__BackingField;    // 0x0x38
    public List<BEPDGGKFNEF> <HKCACLIKNPC>k__BackingField;    // 0x0x48
}
...
public class LHPMAEJMDDN
{
    public long <JNOAHPHECGN>k__BackingField;    // 0x0x10
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x18
    public string <HGGANMOHPEG>k__BackingField;    // 0x0x20
    public DateTime <EEBEOCEDDFO>k__BackingField;    // 0x0x28
    public string <PBHOGBCJGGE>k__BackingField;    // 0x0x30
    public GOHPBCGHHLN <EAGOBHKFIIM>k__BackingField;    // 0x0x38
    public int <JGAIIJIPMEO>k__BackingField;    // 0x0x3C
    public int <DNMPGGCHDFC>k__BackingField;    // 0x0x40
    public List<NIHLDJHLBGN> <PEHKEICAHOL>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// LJKDDPOGIPM
//   (not directly referenced by a detected call)
public class LJKDDPOGIPM
{
    public int <BGGGKOMIKIE>k__BackingField;    // 0x0x10
    public string <ICEGFGNEDKO>k__BackingField;    // 0x0x18
    public string <DAEHGPODNMH>k__BackingField;    // 0x0x20
    public string <PBMIGAAHIBB>k__BackingField;    // 0x0x28
    public string <ODBCLAJKGPG>k__BackingField;    // 0x0x30
    public ANMEKJDIJLO? <OOJMEBIGLPC>k__BackingField;    // 0x0x38
    public string <MKNKKCMHKAN>k__BackingField;    // 0x0x40
    public string <EHDHCKPIGLO>k__BackingField;    // 0x0x48
    public bool <JOJHOONIJKD>k__BackingField;    // 0x0x50
    public bool <IDACNGFCDAF>k__BackingField;    // 0x0x51
    public bool <LMMPHPPBDJH>k__BackingField;    // 0x0x52
    public NAHGHBPAKAG <MKDNNNHHCNN>k__BackingField;    // 0x0x54
    public IAOJHNCDGEH <NOEPIPFNLNG>k__BackingField;    // 0x0x58
    public int <MCABDCFFHPG>k__BackingField;    // 0x0x5C
    public MFGLDFCDALM <HNCMNKGPNDG>k__BackingField;    // 0x0x60
    public MGEPDAHEDIE <OCMJCEJDBPK>k__BackingField;    // 0x0x64
    public int? <COGOICODCLB>k__BackingField;    // 0x0x68
    public string <OECMBDLMOMJ>k__BackingField;    // 0x0x70
}
...
public class MJNIDNDHGLI
{
    public int <BHLCMHPJNGP>k__BackingField;    // 0x0x10
    public int <IEBOOBFLPKK>k__BackingField;    // 0x0x14
    public float <GFNKADBMNLI>k__BackingField;    // 0x0x18
    public float <CIJAONBMDBH>k__BackingField;    // 0x0x1C
    public bool <PMHCHKACHFG>k__BackingField;    // 0x0x20
    public bool <NFPMIJNGLCO>k__BackingField;    // 0x0x21
    public bool <NIDGJOEMFBN>k__BackingField;    // 0x0x22
}
...
// NACKGDHKBLA
//   (not directly referenced by a detected call)
public class NACKGDHKBLA
{
    public long <CJMBCDNMEBD>k__BackingField;    // 0x0x10
    public long <PEKCMAKAIBD>k__BackingField;    // 0x0x18
    public int <OMHJNLHOOHF>k__BackingField;    // 0x0x20
    public DateTime <EEBEOCEDDFO>k__BackingField;    // 0x0x28
    public PJHFDAEJPMJ <LBMOECJGAHM>k__BackingField;    // 0x0x30
}
...
public class NBMMCHELCFJ
{
    public Dictionary<int, int> <MKGPPCDPOCE>k__BackingField;    // 0x0x10
    public List<KCPBGCCPDFH> <IAKKANBIPAK>k__BackingField;    // 0x0x18
    public OBJBMJABDJL[][] <ICHNNFODCMB>k__BackingField;    // 0x0x20
    public FAHLLJFCBPG <DKGKJHCFHEH>k__BackingField;    // 0x0x28
    public OICKIMCFENK <JNPNFCDMILC>k__BackingField;    // 0x0x30
    public FBANKDNICLL <GLGHEHOPKML>k__BackingField;    // 0x0x38
    public AFBLKIADPNC <KKGKBPDNBHC>k__BackingField;    // 0x0x40
    public JPCGOFLMHGF <AHIHAINDIGH>k__BackingField;    // 0x0x48
    public string <FFFKPNHEMEH>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// NFCFALBJJOF
//   (not directly referenced by a detected call)
public class NFCFALBJJOF
{
    public int <PDDLFAHICHL>k__BackingField;    // 0x0x10
    public DateTime <EEBEOCEDDFO>k__BackingField;    // 0x0x18
    public DateTime? <IPLAHFBEGGL>k__BackingField;    // 0x0x20
}
...
public class NFDPGAJOAIK
{
    public HTTPResponse LAGILNOPNNM;    // 0x0x10
    public int? EBEMEGANDBL;    // 0x0x18
    public string PAEDPCPFLGF;    // 0x0x20
    public byte[] GOPJMEHBBKK;    // 0x0x28
    public string CBNHLAGMPII;    // 0x0x30
}

// --------------------------------------------------------------------------
// NIHLDJHLBGN
//   RESPONSE GET    api/groups/v1/memberships/{nEOAHJNCLIC}   [Service.API]
public class NIHLDJHLBGN
{
    public long <JNOAHPHECGN>k__BackingField;    // 0x0x10
    public int <OMHJNLHOOHF>k__BackingField;    // 0x0x18
    public IBENLOEPPLC <IELJNBDMHLO>k__BackingField;    // 0x0x1C
}
...
// NMBBFEAEEGP
//   (not directly referenced by a detected call)
public class NMBBFEAEEGP
{
    public Guid <BDNAKGEIAGA>k__BackingField;    // 0x0x10
    public int <LLBEOHEECCM>k__BackingField;    // 0x0x20
    public int <IFLMAFJPDKM>k__BackingField;    // 0x0x24
    public Guid <MPADBMAJHIN>k__BackingField;    // 0x0x28
    public DateTime <KGMHJPMJFMC>k__BackingField;    // 0x0x38
    public CPHBDBFPPJK <AJPKKGPJBDC>k__BackingField;    // 0x0x40
}
...
// OBJBMJABDJL
//   (not directly referenced by a detected call)
public class OBJBMJABDJL
{
    public IIPHPJKLBOM CJHDCICHJOA;    // 0x0x10
    public int PPIDBECCDPB;    // 0x0x14
    public int MIDNJAGCIEJ;    // 0x0x18
}

// --------------------------------------------------------------------------
// OCGEAGBJJKJ
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class OCGEAGBJJKJ
{
    public DFCNAMIHDNF <LCIJMMMAPOO>k__BackingField;    // 0x0x10
    public List<string> <BKIJGONMIAJ>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/playerevents/v1/all/{cMEEBCKKIKF}   [Service.API]
public class OCGOBNKNMBL
{
    public List<GPBNGLMACAI> <HJKPKILCBCP>k__BackingField;    // 0x0x10
    public List<IIHGAIANIDI> <DOAEFJPNENA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ODPMOGJHILL
//   (not directly referenced by a detected call)
public class ODPMOGJHILL
{
    public int <PPMJHLAIGKE>k__BackingField;    // 0x0x10
    public DateTime? <DAEKPLDPEFN>k__BackingField;    // 0x0x18
    public DateTime? <MOHCFJLMFAD>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// OFJFOKOACFB
//   (not directly referenced by a detected call)
public class OFJFOKOACFB
{
    public int <MENILJILMKI>k__BackingField;    // 0x0x10
    public KNCBKLNGGID <LBMOECJGAHM>k__BackingField;    // 0x0x14
    public List<EOCDMHHIGFI> <NOAGCBKCOGG>k__BackingField;    // 0x0x18
    public List<EOCDMHHIGFI> <JPECMCDOLBP>k__BackingField;    // 0x0x20
    public bool <HPKBKFOEMND>k__BackingField;    // 0x0x28
    public DateTime? <KPEPNHAFHMC>k__BackingField;    // 0x0x30
    public DateTime? <DPKKFLIJMNG>k__BackingField;    // 0x0x40
    public DateTime? <LBNECHILKPA>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// OGGKEOAKPGO
//   (not directly referenced by a detected call)
public class OGGKEOAKPGO
{
    public bool <APLJIMACELD>k__BackingField;    // 0x0x10
    public LJKDDPOGIPM <FNBFHINBFKO>k__BackingField;    // 0x0x18
    public float <DNFCHADGPIF>k__BackingField;    // 0x0x20
}
...
public class OHFGFGOEKMC
{
    public long <KFLKBLDGBEC>k__BackingField;    // 0x0x10
    public long? <IHHILJLIFEO>k__BackingField;    // 0x0x18
    public long? <IGKIJCCNNCI>k__BackingField;    // 0x0x28
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x38
    public string <HGGANMOHPEG>k__BackingField;    // 0x0x40
    public List<string> <BKIJGONMIAJ>k__BackingField;    // 0x0x48
    public string <PBHOGBCJGGE>k__BackingField;    // 0x0x50
    public DateTime <CMLNPCFPMCD>k__BackingField;    // 0x0x58
    public DateTime <MAONHOMCDGD>k__BackingField;    // 0x0x60
    public PLONNBLMDGN <FLLNMCCIGEM>k__BackingField;    // 0x0x68
    public bool <HIFCCCDGGOL>k__BackingField;    // 0x0x6C
    public bool <COLGGLGMIAC>k__BackingField;    // 0x0x6D
    public NKAGBGJJONO <CGEIBECEGAM>k__BackingField;    // 0x0x70
    public NKAGBGJJONO <LAIBKOBGKAP>k__BackingField;    // 0x0x74
}
...
public class OHLMGACECPM
{
    public ICLCPLMHEPL <GBCIIEMIBPG>k__BackingField;    // 0x0x10
    public NMBBFEAEEGP <OPNFBDMJPDN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OICKIMCFENK
//   (not directly referenced by a detected call)
public class OICKIMCFENK
{
    public float <IGKHFPCICIA>k__BackingField;    // 0x0x10
    public float <KOEIHODEHOM>k__BackingField;    // 0x0x14
    public float <BNKCHDJGDAN>k__BackingField;    // 0x0x18
    public float <GBFNBLCIHIE>k__BackingField;    // 0x0x1C
    public float <ONEFKNOLNCI>k__BackingField;    // 0x0x20
    public float <FDGLHFHDIBC>k__BackingField;    // 0x0x24
    public float <GJCOOOBFKDK>k__BackingField;    // 0x0x28
    public float <LJCOCFBAEEI>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// OINKMDNHGJF
//   (not directly referenced by a detected call)
public class OINKMDNHGJF
{
    public DateTime? <HJALFDCLAGM>k__BackingField;    // 0x0x10
    public DateTime? <LPALCEKICIF>k__BackingField;    // 0x0x20
    public MNFKPFLDCFM <GBCIIEMIBPG>k__BackingField;    // 0x0x30
    public IICJGCLOKKD <IBJMMDPPHKK>k__BackingField;    // 0x0x38
    public bool <EMBLPKLJBEC>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// OKCGGAEDIFO
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class OKCGGAEDIFO
{
    public long <PEKCMAKAIBD>k__BackingField;    // 0x0x10
    public PJHFDAEJPMJ <LBMOECJGAHM>k__BackingField;    // 0x0x18
}
...
public class OMJMNBHNLAH
{
    public bool <HMLBOKHCIMI>k__BackingField;    // 0x0x10
    public string <EMLDKMAAOPD>k__BackingField;    // 0x0x18
}
...
public class PDCCOJPOCNJ : NCGNBHMFPMJ
{
    public List<ECCJLGJIJPK> GOMKJOBJEKJ;    // 0x0x30
    public int <HOICKMFHHGK>k__BackingField;    // 0x0x38
}
...
public class PEOLABMDAOB : JBKJFCANCEA
{
    public OKMAOJHCNAG? <PBBHBIEGDHI>k__BackingField;    // 0x0x18
    public COPMCKHMPDP <BJGDLDMOBEC>k__BackingField;    // 0x0x20
}
...
public class PLCKEMHEJNC
{
    public int <LLBEOHEECCM>k__BackingField;    // 0x0x10
    public Guid <GCEALHKBNAL>k__BackingField;    // 0x0x14
    public long <CJNHPKAJPNF>k__BackingField;    // 0x0x28
    public long <PDIDKAKHCGM>k__BackingField;    // 0x0x30
    public DateTime <DHMEDBMNDMF>k__BackingField;    // 0x0x38
}
...
public class GetRankRequestDTO
{
    ...
    public LBJPDDCJFAC FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public MGEPDAHEDIE <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public OALEEGIHHKK creatorAccountRole;    // 0x0x58
}
...
{
    public OCFONPDFNJA <PCNKELADFFH>k__BackingField;    // 0x0x10
    public string <OCLLGPAEPGF>k__BackingField;    // 0x0x18
    public bool <AGPIDPKIEAM>k__BackingField;    // 0x0x20
}
...
{
    public List<OCFONPDFNJA> <HPIAKLDMCME>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public IAILPGPIDOF ReportCategory;    // 0x0x20
}
...
{
    public ELOLACNPIPF? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public ELOLACNPIPF CPEINLNKFGN;  // wrapper
...
{
    public CLHAEPDMEOJ PBNONILPHGJ;  // wrapper
...
{
    public DJMJIMMICLF FEGCMBEFABH;  // wrapper
    public int? HAHJLJPJBBP;  // wrapper
...
{
    public KLEDHHDFLDH UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public MGEPDAHEDIE MILHAHGHJGA;  // wrapper
    public MGEPDAHEDIE? FBOBLODEBBE;  // wrapper
...
{
    public KJBJCKHMIBH GHEIJPJENDP;  // wrapper
...
{
    public IENLCFOHFPB DMAGCNLNKLI;  // wrapper
...
{
    public IReadOnlyList<AEDINHEBCKO> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public BIJHJOPMIBP GIMELFMOAAE;  // wrapper
    public MGEPDAHEDIE? DGALKAKGPFI;  // wrapper
...
{
    public DLDDFFBFBCE NBPCMNNAMEO;  // wrapper
...
{
    public StatusResponse> IFOGDLBNNEF;  // wrapper
...
{
    public List<long> NOHNBPOHBAI;  // wrapper
    public JNBEPJLBFKC GECJJAFAKJA;  // wrapper
    public long? JNDBLIENNEJ;  // wrapper
    public NNLNNECPHAG IFOGDLBNNEF;  // wrapper
...
{
    public String> IFOGDLBNNEF;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{lJPMPJDOKIO}  [API POST]
public class PlayereventsV2DeleteLJPMPJDOKIORequest
{
    public GPBNGLMACAI LJPMPJDOKIO;  // wrapper
}
...
{
    public GPBNGLMACAI LJPMPJDOKIO;  // wrapper
    public PLONNBLMDGN MEJKHFPPGHC;  // wrapper
...
{
    public GPBNGLMACAI LJPMPJDOKIO;  // wrapper
    public long? JJNPHMECMNE;  // wrapper
    public object clubId;  // candidate
}
...
{
    public GPBNGLMACAI LJPMPJDOKIO;  // wrapper
    public NKAGBGJJONO ODNLIPLBFIC;  // wrapper
    public NKAGBGJJONO LCLONKKNAEB;  // wrapper
...
{
    public GPBNGLMACAI LJPMPJDOKIO;  // wrapper
    public long? OPODDAAAKAJ;  // wrapper
    public object roomId;  // candidate
...
{
    public GPBNGLMACAI LJPMPJDOKIO;  // wrapper
    public List<string> DEIAPIJJIIG;  // wrapper
...
{
    public GPBNGLMACAI LJPMPJDOKIO;  // wrapper
    public DateTime OEKFDDJEIJL;  // wrapper
    public DateTime LEPFEOEMOFK;  // wrapper
...
{
    public List<EHNKIBEIBNO> KFPJGOPGBFD;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> FBDPIHJPGGL;  // wrapper
...
{
    public Guid? KDONIJNBDPB;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public IENLCFOHFPB DMAGCNLNKLI;  // wrapper
    public long? IBFMLEMLAJO;  // wrapper
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
    public object ReportCategory;  // candidate
...
{
    public MatchCompleteStats EFKEBBINAOB;  // wrapper
}
...
{
    public Guid HNJDCFHAOBM;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<PDELLFNEKCG> KFPJGOPGBFD;  // wrapper
    public object objectiveType;  // candidate
...
{
    public LKCFAPFHOAJ EMOEJDECJGE;  // wrapper
}
