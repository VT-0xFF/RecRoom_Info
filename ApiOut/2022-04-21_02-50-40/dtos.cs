...
public class ACOCFHAIHFN
{
    public int <CHCAPEANLNK>k__BackingField;    // 0x0x10
    public bool <KAICIHKJOEI>k__BackingField;    // 0x0x14
    public DateTime <KGFBNLGLFOO>k__BackingField;    // 0x0x18
    public bool <EHNGFMKMEIL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AHIMPDIAKBN
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{iKMEJIEPFCI}   [Service.API]
public class AHIMPDIAKBN
{
    public uint <ACBJIGNGOGO>k__BackingField;    // 0x0x10
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x18
    public string <DKCOGMBIGJG>k__BackingField;    // 0x0x20
    public DateTime <DDJMKKFGKDJ>k__BackingField;    // 0x0x28
    public DateTime? <JMNLNJPHBKA>k__BackingField;    // 0x0x30
    public bool <IKDPABIPKIK>k__BackingField;    // 0x0x40
    public List<KNMBJCHHOJJ> <LFBEAGCKOJC>k__BackingField;    // 0x0x48
    public List<string> <ILGJONDGLJC>k__BackingField;    // 0x0x50
    public int <DCCJBCGNEPF>k__BackingField;    // 0x0x58
    public int <EMHLLHAIJLL>k__BackingField;    // 0x0x5C
    public int <GMLHDLHGEPG>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// AICPJKDFNFN
//   (not directly referenced by a detected call)
public class AICPJKDFNFN
{
    public DateTime <BHJEMCMMIDL>k__BackingField;    // 0x0x10
    public string <OEFAPJBBABO>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{fIMAPJOLFFM}   [Service.API]
public class BCJFEODDHPM
{
    public long <PIIJHLIGNOH>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <CNJEIIHDGOL>k__BackingField;    // 0x0x18
    public GKPJBLMJNCB <EDPLJOEIAEL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BGJMIAGPOKE
//   (not directly referenced by a detected call)
public class BGJMIAGPOKE
{
    public float <ICJFCIONOLA>k__BackingField;    // 0x0x10
}
...
// BHFDBAKFIFK
//   (not directly referenced by a detected call)
public class BHFDBAKFIFK
{
    public long <OGGJIAKHMHO>k__BackingField;    // 0x0x10
    public int <GABNGFJANJF>k__BackingField;    // 0x0x18
    public long <PIIJHLIGNOH>k__BackingField;    // 0x0x20
    public long? <AJGKLAPAJMP>k__BackingField;    // 0x0x28
    public long? <BBJOABEPOOF>k__BackingField;    // 0x0x38
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x48
    public string <DKCOGMBIGJG>k__BackingField;    // 0x0x50
    public string <KADKALMGDDH>k__BackingField;    // 0x0x58
    public DateTime <FDMJAHADHEF>k__BackingField;    // 0x0x60
    public DateTime <OJBFOMFHKIG>k__BackingField;    // 0x0x68
    public int <ODBBDMFDBEJ>k__BackingField;    // 0x0x70
    public NDONOBMDJGI <OMIGGFAANJN>k__BackingField;    // 0x0x74
    public bool <DPDMDMIFIMJ>k__BackingField;    // 0x0x78
    public bool <OJJHLGLGNOD>k__BackingField;    // 0x0x79
    public AJOFINGJKJB <BGLIFBGDMGD>k__BackingField;    // 0x0x7C
    public AJOFINGJKJB <DNGNHKEFBMJ>k__BackingField;    // 0x0x80
    public long? <MDPKBGOBEAI>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// BHPBDNFIHPI
//   (not directly referenced by a detected call)
public class BHPBDNFIHPI
{
    public int <ILHHBBFFJOE>k__BackingField;    // 0x0x10
    public HALMCIBNCBI <FPEDEKOHEGI>k__BackingField;    // 0x0x14
    public List<JDHHBJCLJEI> <MINAHNJODMF>k__BackingField;    // 0x0x18
    public List<JDHHBJCLJEI> <DDCJIPJHMML>k__BackingField;    // 0x0x20
    public bool <MPKHGEEFKDD>k__BackingField;    // 0x0x28
    public DateTime? <LHEIIECPBOP>k__BackingField;    // 0x0x30
    public DateTime? <EPJJDDHIKDC>k__BackingField;    // 0x0x40
    public DateTime? <NJPCHCMOEDC>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// BLKMAKIKPJP
//   RESPONSE GET    api/inventions/v1/personaldetails/{cKOHCOKGAOP}   [Service.API]
public class BLKMAKIKPJP
{
    public bool <DNFPGDCBMGF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BMBMGPDEMOG
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class BMBMGPDEMOG
{
    public List<MADHHGIJCGJ> <EHFHFEJAKGN>k__BackingField;    // 0x0x10
    public BGPNEIFPDCG <IEKAKDKNPMJ>k__BackingField;    // 0x0x18
}
...
public class CAABEDNFLJD
{
    public HBGPNHECOED <NBFIHGCPFBO>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <MBIFPPJKAEE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CALLFHEPDJN
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{mNLMCPOBBEK}   [Service.API]
public class CALLFHEPDJN
{
    public Guid <NJCNIOHMHDH>k__BackingField;    // 0x0x10
    public int <JELOCCBBHLJ>k__BackingField;    // 0x0x20
    public int <ILHHBBFFJOE>k__BackingField;    // 0x0x24
    public DateTime <BHJEMCMMIDL>k__BackingField;    // 0x0x28
}
...
public class CAPJGJJEAJI
{
    public Guid <PMJLOOPLMHG>k__BackingField;    // 0x0x10
    public Guid <MAKHILNJELL>k__BackingField;    // 0x0x20
    public int <CFILPDLHCMA>k__BackingField;    // 0x0x30
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x38
    public long <DHOLMNHEJNO>k__BackingField;    // 0x0x40
    public long <AJADDCBKNAH>k__BackingField;    // 0x0x48
    public DateTime <GJMGKJFMLAP>k__BackingField;    // 0x0x50
}
...
public class CECAGOEOKKB
{
    public int <DFFLOICAFFB>k__BackingField;    // 0x0x10
    public List<EBFEFPHMMNH> <DGBJAEOHOBB>k__BackingField;    // 0x0x18
}
...
// CJNNHOACBCL
//   (not directly referenced by a detected call)
public class CJNNHOACBCL
{
    public BHFDBAKFIFK <OAKMGNOKBFJ>k__BackingField;    // 0x0x10
    public HCMBOFIJMGP <GLONMJEPINK>k__BackingField;    // 0x0x18
}
...
public class CLLOCLKHKML
{
    public HTTPResponse HLBFCLEPONN;    // 0x0x10
    public int? CKFNDDLJFAD;    // 0x0x18
    public string HABNPBEHPND;    // 0x0x20
    public byte[] HGFBCABADBA;    // 0x0x28
    public string EAANPEGHBNN;    // 0x0x30
}
...
public class DFAIHGJDFGP
{
    public bool JKHONCDHOHO;    // 0x0x10
    public bool NMPCCLLPEAJ;    // 0x0x11
}
...
//   RESPONSE GET    api/avatar/v2/{jGPIGKFDBPO}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{jGPIGKFDBPO}   [Service.API]
public class DIAFOKMOAIP
{
    public string <KFGBMIEGBBP>k__BackingField;    // 0x0x10
    public string <MOGNMIFFPLG>k__BackingField;    // 0x0x18
    public string <GAFENLKBEPE>k__BackingField;    // 0x0x20
    public string <JAIMKIAJMFC>k__BackingField;    // 0x0x28
}
...
public class DLKMDAEKAKC
{
    public bool <LAFGAHLGLDE>k__BackingField;    // 0x0x10
    public string <DEPDDIOPING>k__BackingField;    // 0x0x18
}
...
// EBFEFPHMMNH
//   (not directly referenced by a detected call)
public class EBFEFPHMMNH
{
    public DateTime? <NKPEMPHPPEN>k__BackingField;    // 0x0x10
    public DateTime? <ICOGFNDDAOC>k__BackingField;    // 0x0x20
    public KLCBKOMJDID <IMDJMLHFMDF>k__BackingField;    // 0x0x30
    public OFKLDKJOOOK <KGKOLBHLBOL>k__BackingField;    // 0x0x38
    public bool <BNPACAFBLJG>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// EDNFBIIFKIK
//   (not directly referenced by a detected call)
public class EDNFBIIFKIK
{
    public long <LJEIMEPOCGG>k__BackingField;    // 0x0x10
    public Guid <GCGKOGFDGLP>k__BackingField;    // 0x0x18
    public long <PIIJHLIGNOH>k__BackingField;    // 0x0x28
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x30
    public string <DKCOGMBIGJG>k__BackingField;    // 0x0x38
    public int <AJADDCBKNAH>k__BackingField;    // 0x0x40
    public Guid? <OJJOOBJHLIM>k__BackingField;    // 0x0x44
    public DateTime <BHJEMCMMIDL>k__BackingField;    // 0x0x58
    public string <KADKALMGDDH>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// EDNGALGJBBH
//   (not directly referenced by a detected call)
public class EDNGALGJBBH
{
    public int <PJFKKJJOCMB>k__BackingField;    // 0x0x10
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x18
    public string <JAJFIBBEMEI>k__BackingField;    // 0x0x20
    public string <DKCOGMBIGJG>k__BackingField;    // 0x0x28
    public string <PJBHOILEEDN>k__BackingField;    // 0x0x30
    public bool <ANPKMECAPHD>k__BackingField;    // 0x0x38
    public int <NNCEJCLEHPH>k__BackingField;    // 0x0x3C
    public MNCLMBGOOFJ <CCHIAGKPGNJ>k__BackingField;    // 0x0x40
    public LJNKJOMAKLJ HBEHNLCAKKL;    // 0x0x48
    public LJNKJOMAKLJ BNGNGJOMDKE;    // 0x0x50
    public LJNKJOMAKLJ JDGGHCIMJMB;    // 0x0x58
    public AOFNOEAMGGK GOGLFHCHAEL;    // 0x0x60
}
...
// EHDIGCKJOIG
//   (not directly referenced by a detected call)
public class EHDIGCKJOIG
{
    public int <BEKEKIJAKAJ>k__BackingField;    // 0x0x10
    public string <NLBEEIHJIOG>k__BackingField;    // 0x0x18
    public string <PJBHOILEEDN>k__BackingField;    // 0x0x20
    public string <PFNPCGDOMOF>k__BackingField;    // 0x0x28
    public string <GKIMAGJAFJN>k__BackingField;    // 0x0x30
    public NNJMJOJMGEL? <GKNKONJGPFI>k__BackingField;    // 0x0x38
    public string <CEMEEJFMAOF>k__BackingField;    // 0x0x40
    public string <KALOGIAJMBA>k__BackingField;    // 0x0x48
    public bool <LFBLMGBALML>k__BackingField;    // 0x0x50
    public bool <ENPKKIBLGLE>k__BackingField;    // 0x0x51
    public bool <GJMFKFAFHBD>k__BackingField;    // 0x0x52
    public HBMOPFOICDE <FGDMEAEENBM>k__BackingField;    // 0x0x54
    public LCLONCHBBJN <BIFKPLMAHLO>k__BackingField;    // 0x0x58
    public int <NBMEAALCIDH>k__BackingField;    // 0x0x5C
    public FBFIALGEJJA <NJNNGLPGJJG>k__BackingField;    // 0x0x60
    public ANENBOMLLII <OPALNDKDCLI>k__BackingField;    // 0x0x64
    public int? <ABIJEBGJEFP>k__BackingField;    // 0x0x68
    public string <CAOKKDCHOPJ>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// EHGBOCIAOPE
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class EHGBOCIAOPE
{
    public int <HBEFHOBACLC>k__BackingField;    // 0x0x10
    public string <GNFGFLJOLDB>k__BackingField;    // 0x0x18
    public List<EDNGALGJBBH> <DGHNCGKJPDC>k__BackingField;    // 0x0x20
    public HEADOOJHJNN <BPBDNIBBCAC>k__BackingField;    // 0x0x28
    public string <IDHKKGDADOG>k__BackingField;    // 0x0x30
    public DateTime <JFLCGBHDCFA>k__BackingField;    // 0x0x38
    public DateTime <ENIPEGLEBME>k__BackingField;    // 0x0x40
    public DateTime <GJCNMHEJJNL>k__BackingField;    // 0x0x48
    public bool? <IOFLHMFAKGN>k__BackingField;    // 0x0x50
}
...
public class EKPBCFADLNP
{
    public List<int> <IHNIPMJNLNF>k__BackingField;    // 0x0x10
    public string <OLDLDKELKOE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EMBMMMMMGKJ
//   (not directly referenced by a detected call)
public class EMBMMMMMGKJ
{
    public int <DLKGCDCOGBI>k__BackingField;    // 0x0x10
}
...
public class EOHGIMCDPIB
{
    public long <ICDCOEGCDJL>k__BackingField;    // 0x0x10
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x18
    public string <DKCOGMBIGJG>k__BackingField;    // 0x0x20
    public DateTime <BHJEMCMMIDL>k__BackingField;    // 0x0x28
    public string <KADKALMGDDH>k__BackingField;    // 0x0x30
    public DPANBNBJMDK <MOAPEFGBHEC>k__BackingField;    // 0x0x38
    public int <MCLJOGIKKBM>k__BackingField;    // 0x0x3C
    public int <DAPCPADCOCN>k__BackingField;    // 0x0x40
    public List<NHEGAFPPPPH> <ABMNCNBLING>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// EOIEBNBKEGH
//   (not directly referenced by a detected call)
public class EOIEBNBKEGH
{
    public bool <EDOKKAJAKBD>k__BackingField;    // 0x0x10
    public MALLEKPGICN <ENGNEAKIHNH>k__BackingField;    // 0x0x14
    public int <LDEHEDNNFPN>k__BackingField;    // 0x0x18
    public DateTime <GJMGKJFMLAP>k__BackingField;    // 0x0x20
}
...
// FAGAGFOHIIE
//   (not directly referenced by a detected call)
public class FAGAGFOHIIE
{
    public Guid <PDJOGFKDKLF>k__BackingField;    // 0x0x10
    public int <JELOCCBBHLJ>k__BackingField;    // 0x0x20
    public int <JLAAOEGGEPN>k__BackingField;    // 0x0x24
    public Guid <AJILOFFPCIE>k__BackingField;    // 0x0x28
    public DateTime <GJMGKJFMLAP>k__BackingField;    // 0x0x38
    public GOFEDLIEEME <JBAOPODLAAO>k__BackingField;    // 0x0x40
}
...
public class FIKPECHAFIJ
{
    public Guid <MAKHILNJELL>k__BackingField;    // 0x0x10
    public long? <PIIJHLIGNOH>k__BackingField;    // 0x0x20
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x30
    public string <DKCOGMBIGJG>k__BackingField;    // 0x0x38
    public LCLONCHBBJN <BIFKPLMAHLO>k__BackingField;    // 0x0x40
    public long <DAHPNEOKDJB>k__BackingField;    // 0x0x48
    public string <KADKALMGDDH>k__BackingField;    // 0x0x50
    public DateTime <BHJEMCMMIDL>k__BackingField;    // 0x0x58
    public DateTime <GJMGKJFMLAP>k__BackingField;    // 0x0x60
}
...
// FODEABLFCEP
//   (not directly referenced by a detected call)
public class FODEABLFCEP
{
    public int <DOAPHKCKMCK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FPBFODJOCIJ
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class FPBFODJOCIJ
{
    public LFOLCLHNOGP <DBBMGONCBFL>k__BackingField;    // 0x0x10
    public int <IADBBHKKLOH>k__BackingField;    // 0x0x14
    public long <LEGIPKHGJLD>k__BackingField;    // 0x0x18
    public bool <DMFEIFOAGBB>k__BackingField;    // 0x0x20
    public string <DEPDDIOPING>k__BackingField;    // 0x0x28
    public int? <FADFGEDLDKD>k__BackingField;    // 0x0x30
    public bool <DJNNPMCNPNH>k__BackingField;    // 0x0x38
    public string <PJMJLAIACKG>k__BackingField;    // 0x0x40
    public float <CKFJJNOKDEE>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// GHMGMLPOJCO
//   (not directly referenced by a detected call)
public class GHMGMLPOJCO
{
    public bool <AKHOFKJIMNO>k__BackingField;    // 0x0x10
    public EHDIGCKJOIG <EBNDEJANIAL>k__BackingField;    // 0x0x18
    public float <JBAJICNNDMJ>k__BackingField;    // 0x0x20
}
...
public class GJDLFNELFLM
{
    public GOCPDOCJPHL <IMDJMLHFMDF>k__BackingField;    // 0x0x10
    public EDNFBIIFKIK <MLLDBDNBJEA>k__BackingField;    // 0x0x18
}
...
public class GNOJHNBKENK
{
    public NJKOGKJMPNN <IMDJMLHFMDF>k__BackingField;    // 0x0x10
    public FAGAGFOHIIE <INELILONFDO>k__BackingField;    // 0x0x18
}
...
// GOFEDLIEEME
//   (not directly referenced by a detected call)
public class GOFEDLIEEME
{
    public Guid <PDJOGFKDKLF>k__BackingField;    // 0x0x10
    public long <PIIJHLIGNOH>k__BackingField;    // 0x0x20
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x28
    public string <DKCOGMBIGJG>k__BackingField;    // 0x0x30
    public string <KADKALMGDDH>k__BackingField;    // 0x0x38
    public long <AJADDCBKNAH>k__BackingField;    // 0x0x40
    public Guid? <OJJOOBJHLIM>k__BackingField;    // 0x0x48
    public DateTime <GJMGKJFMLAP>k__BackingField;    // 0x0x60
}
...
public class HBGPNHECOED
{
    public int <JELOCCBBHLJ>k__BackingField;    // 0x0x10
    public Guid <MAKHILNJELL>k__BackingField;    // 0x0x14
    public long <INANMDDBGGH>k__BackingField;    // 0x0x28
    public DateTime <GJMGKJFMLAP>k__BackingField;    // 0x0x30
}
...
// HCMBOFIJMGP
//   (not directly referenced by a detected call)
public class HCMBOFIJMGP
{
    public long <FJGEHFNFDLG>k__BackingField;    // 0x0x10
    public long <OGGJIAKHMHO>k__BackingField;    // 0x0x18
    public int <HJDIFNAHOLD>k__BackingField;    // 0x0x20
    public DateTime <BHJEMCMMIDL>k__BackingField;    // 0x0x28
    public DDKEMMMPHKD <FPEDEKOHEGI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// HEADOOJHJNN
//   (not directly referenced by a detected call)
public class HEADOOJHJNN
{
    public long <BEKEKIJAKAJ>k__BackingField;    // 0x0x10
    public string <PFNPCGDOMOF>k__BackingField;    // 0x0x18
    public string <LLKEBIHPFHN>k__BackingField;    // 0x0x20
    public NNJMJOJMGEL? <GKNKONJGPFI>k__BackingField;    // 0x0x28
    public string <CEMEEJFMAOF>k__BackingField;    // 0x0x30
    public string <KALOGIAJMBA>k__BackingField;    // 0x0x38
    public AAELKCENJPK <BFEBGEJCIJK>k__BackingField;    // 0x0x40
    public int <PBCDGIDOHOF>k__BackingField;    // 0x0x44
    public int <BFEAIDCEEAC>k__BackingField;    // 0x0x48
    public ANENBOMLLII? <HGGIKNEMKMI>k__BackingField;    // 0x0x4C
    public HBMOPFOICDE? <EMAFPBMBKKP>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// HGOHPLOEKCO
//   (not directly referenced by a detected call)
public class HGOHPLOEKCO
{
    public Guid <GGKEGKGKOEO>k__BackingField;    // 0x0x10
    public Guid <HIELKCCBEBO>k__BackingField;    // 0x0x20
    public DateTime <JFLCGBHDCFA>k__BackingField;    // 0x0x30
    public List<EHDIGCKJOIG> <JPIGCKLABAP>k__BackingField;    // 0x0x38
}
...
public class HIMKAEFABEA
{
    public List<PGCHDJIMGEF> <ALEOJOBMIMP>k__BackingField;    // 0x0x10
    public string <OLDLDKELKOE>k__BackingField;    // 0x0x18
}
...
public class HKEMFOABCDM
{
    public DMOACHMFLEO <IMDJMLHFMDF>k__BackingField;    // 0x0x10
    public NDGHIIINCKB <OFDABKGHOHH>k__BackingField;    // 0x0x18
    public IIGMPBICMJK <GGDAHHGPKPE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HKNNMFGDADL
//   (not directly referenced by a detected call)
public class HKNNMFGDADL
{
    public int <DOHOCEPMIKE>k__BackingField;    // 0x0x10
}
...
public class HNPAMOHCFFM : INFEBPNBENK
{
    public JHLEKJJFJKE? <KDGLJPPILFH>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <MBIFPPJKAEE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HPPNHJCDEBO
//   (not directly referenced by a detected call)
public class HPPNHJCDEBO
{
    public float <BGEOGPOBLGI>k__BackingField;    // 0x0x10
    public float <CBPLBONIOIM>k__BackingField;    // 0x0x14
    public float <FLGJNOIHBCA>k__BackingField;    // 0x0x18
    public float <ECJKFIIIHFG>k__BackingField;    // 0x0x1C
    public float <CLLHBECAHCH>k__BackingField;    // 0x0x20
    public float <NDEEFDDAOOG>k__BackingField;    // 0x0x24
    public float <EHNFBJNBDOC>k__BackingField;    // 0x0x28
    public float <HGKKMKKGBIE>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// IALLGFECMKM
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{pLMICNFPHCK}   [Service.API]
...
public class IALLGFECMKM
{
    public BHFDBAKFIFK <OAKMGNOKBFJ>k__BackingField;    // 0x0x10
    public BGPNEIFPDCG <IEKAKDKNPMJ>k__BackingField;    // 0x0x18
    public LPENDJFMONM <GOEBPICEJKP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IEKFDANGHNC
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class IEKFDANGHNC
{
    public int? <DJFJFJJHCCL>k__BackingField;    // 0x0x10
    public string <HCBAOCMMBKE>k__BackingField;    // 0x0x18
    public string <HGEKLELLABJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IIGMPBICMJK
//   (not directly referenced by a detected call)
public class IIGMPBICMJK
{
    public long <KPJFNBABBLF>k__BackingField;    // 0x0x10
    public string <GCGKOGFDGLP>k__BackingField;    // 0x0x18
    public int <JKCEDDAPKFL>k__BackingField;    // 0x0x20
    public int <IMACEHIMOEF>k__BackingField;    // 0x0x24
    public int <PEGEELMHBDL>k__BackingField;    // 0x0x28
    public int <OECOLPALAPG>k__BackingField;    // 0x0x2C
    public int <LMLLGGGPBKA>k__BackingField;    // 0x0x30
    public string <MPPABKDGFIJ>k__BackingField;    // 0x0x38
    public string <FJCPDEEHEPC>k__BackingField;    // 0x0x40
}
...
public class IOKIMMANHKP : INFEBPNBENK
{
    public KHGGIILOFCB? <KDGLJPPILFH>k__BackingField;    // 0x0x18
    public HBGPNHECOED <NBFIHGCPFBO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JDHHBJCLJEI
//   (not directly referenced by a detected call)
public class JDHHBJCLJEI
{
    public LCLONCHBBJN <BIFKPLMAHLO>k__BackingField;    // 0x0x10
    public int <AJADDCBKNAH>k__BackingField;    // 0x0x14
    public NDEMDAJMACJ <ABFGEIANFPO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JFDNMHLMGPN
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class JFDNMHLMGPN
{
    public Guid <MKEGHBPJHKI>k__BackingField;    // 0x0x10
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x20
    public string <KADKALMGDDH>k__BackingField;    // 0x0x28
    public DateTime <JFLCGBHDCFA>k__BackingField;    // 0x0x30
    public DateTime? <PJBCOOEBLOF>k__BackingField;    // 0x0x38
    public List<HGOHPLOEKCO> <BFJLOCOBFBG>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// JGGIOIHAPIF
//   (not directly referenced by a detected call)
public class JGGIOIHAPIF
{
    public MPKAJIFLPEP LCLOIGDIGPC;    // 0x0x10
    public int CHAEHADJJOJ;    // 0x0x14
}
...
public class JJHIMECAABL
{
    public int <OJFPMAIFMNK>k__BackingField;    // 0x0x10
    public MOFMMFNOJCE <FPEDEKOHEGI>k__BackingField;    // 0x0x14
    public KIPBLPHOANK <BCIGMLAKCKB>k__BackingField;    // 0x0x18
    public KIPBLPHOANK <FFPAKHCNOIN>k__BackingField;    // 0x0x1C
    public KIPBLPHOANK <EHFDLGMNGKJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JOLAKEDFECC
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class JOLAKEDFECC
{
    public int <JELOCCBBHLJ>k__BackingField;    // 0x0x10
    public Guid <MAKHILNJELL>k__BackingField;    // 0x0x14
    public long <INANMDDBGGH>k__BackingField;    // 0x0x28
    public long <OHEACOCDJGL>k__BackingField;    // 0x0x30
    public DateTime <ENGILKIGFNC>k__BackingField;    // 0x0x38
}
...
// base   : BHPBDNFIHPI
//   (not directly referenced by a detected call)
public class KDMBBEFOALA : BHPBDNFIHPI
{
    public int <KIIACGJENDP>k__BackingField;    // 0x0x60
    public List<GHMGMLPOJCO> <EDCKHDOLGHE>k__BackingField;    // 0x0x68
    public List<GHMGMLPOJCO> <IKEACMKHGLG>k__BackingField;    // 0x0x70
    public List<GHMGMLPOJCO> <JFBDHPNOKBN>k__BackingField;    // 0x0x78
}
...
public class KJDHHEHKGBJ
{
    public BGPNEIFPDCG <IEKAKDKNPMJ>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{mHLOHHKNGJF}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{mHLOHHKNGJF}   [Service.API]
...
public class KKPGKCBDEKJ
{
    public NJKOGKJMPNN <IMDJMLHFMDF>k__BackingField;    // 0x0x10
    public GOFEDLIEEME <JBAOPODLAAO>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// KNMBJCHHOJJ
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{iKMEJIEPFCI}   [Service.API]
public class KNMBJCHHOJJ
{
    public string <ACBJIGNGOGO>k__BackingField;    // 0x0x10
    public string <ELDOIBPHIKD>k__BackingField;    // 0x0x18
    public string <MLKMDNBBHHB>k__BackingField;    // 0x0x20
    public string <DKCOGMBIGJG>k__BackingField;    // 0x0x28
    public string <HCBAOCMMBKE>k__BackingField;    // 0x0x30
    public HHMDNGFOOIG <IMDJMLHFMDF>k__BackingField;    // 0x0x38
    public List<string> <GJGKPACLDGE>k__BackingField;    // 0x0x40
    public List<string> <ILGJONDGLJC>k__BackingField;    // 0x0x48
    public string <EHICLJAPMAN>k__BackingField;    // 0x0x50
    public List<AICPJKDFNFN> <MOCAFDKFMHN>k__BackingField;    // 0x0x58
}
...
public class LCNCFOEDIEH
{
    public List<BHFDBAKFIFK> <JIILFKMAMLM>k__BackingField;    // 0x0x10
    public List<CJNNHOACBCL> <KMLCNMACDIN>k__BackingField;    // 0x0x18
}
...
public class LEHFCBDFDDH
{
    public List<string> <HGNKMMBDPMF>k__BackingField;    // 0x0x10
    public List<string> <HBEIHKIKGGL>k__BackingField;    // 0x0x18
    public List<string> <JEOAKKFBCNK>k__BackingField;    // 0x0x20
}
...
public class LHKONNPDIAJ
{
    public string <LGMJNOCANJH>k__BackingField;    // 0x0x10
    public string <HOCHMNMOCAF>k__BackingField;    // 0x0x18
    public bool <EIPMNBKDNIK>k__BackingField;    // 0x0x20
    public string <GLNFCHPGNFE>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// LHONHKMMANG
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class LHONHKMMANG
{
    public int <NNCEJCLEHPH>k__BackingField;    // 0x0x10
    public string <IBLDDGFCODD>k__BackingField;    // 0x0x18
    public string <KFGBMIEGBBP>k__BackingField;    // 0x0x20
    public string <MOGNMIFFPLG>k__BackingField;    // 0x0x28
    public string <GAFENLKBEPE>k__BackingField;    // 0x0x30
    public string <JAIMKIAJMFC>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// LIJAKLCENHE
//   (not directly referenced by a detected call)
public class LIJAKLCENHE
{
    public string <HCHJCCHODMM>k__BackingField;    // 0x0x10
    public EALJLBKMGEG <FPEDEKOHEGI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LLAHIGEJLGO
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class LLAHIGEJLGO
{
    public int <IADBBHKKLOH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LPENDJFMONM
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class LPENDJFMONM
{
    public EGJBBEKBKLP <IEKAKDKNPMJ>k__BackingField;    // 0x0x10
    public List<string> <ILGJONDGLJC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MADHHGIJCGJ
//   (not directly referenced by a detected call)
public class MADHHGIJCGJ
{
    public int <MODNOGCJLDD>k__BackingField;    // 0x0x10
    public BGPNEIFPDCG <IEKAKDKNPMJ>k__BackingField;    // 0x0x14
}
...
public class MAJFDAPHCNP
{
    public Dictionary<int, int> <LBPEDNPNIOD>k__BackingField;    // 0x0x10
    public List<DBPMLCKADDC> <IDGJIMPCMJM>k__BackingField;    // 0x0x18
    public JGGIOIHAPIF[][] <MNAECICBOHG>k__BackingField;    // 0x0x20
    public HKNNMFGDADL <JDAALPLOEPC>k__BackingField;    // 0x0x28
    public HPPNHJCDEBO <BNIIOHLHLGO>k__BackingField;    // 0x0x30
    public FODEABLFCEP <CKIPKCPOGLH>k__BackingField;    // 0x0x38
    public EMBMMMMMGKJ <JDDFJHCCDED>k__BackingField;    // 0x0x40
    public BGJMIAGPOKE <IGOBPDCBAEF>k__BackingField;    // 0x0x48
    public string <FJGAPLJHIPG>k__BackingField;    // 0x0x50
}
...
// base   : BHPBDNFIHPI
//   (not directly referenced by a detected call)
public class NCDPGKMCCEL : BHPBDNFIHPI
{
    public EHDIGCKJOIG <EBNDEJANIAL>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// NDEMDAJMACJ
//   (not directly referenced by a detected call)
public class NDEMDAJMACJ
{
    public int <POKNMNAMHCL>k__BackingField;    // 0x0x10
    public DateTime? <CDFNFIMIHGB>k__BackingField;    // 0x0x18
    public DateTime? <BHLNKICEAIE>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// NDGHIIINCKB
//   (not directly referenced by a detected call)
public class NDGHIIINCKB
{
    public long <KPJFNBABBLF>k__BackingField;    // 0x0x10
    public string <GCGKOGFDGLP>k__BackingField;    // 0x0x18
    public int <GABNGFJANJF>k__BackingField;    // 0x0x20
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x28
    public string <DKCOGMBIGJG>k__BackingField;    // 0x0x30
    public string <KADKALMGDDH>k__BackingField;    // 0x0x38
    public int <JPMOILDFINO>k__BackingField;    // 0x0x40
    public KPJPCGMGLGK <OMIGGFAANJN>k__BackingField;    // 0x0x44
    public DateTime <GJMGKJFMLAP>k__BackingField;    // 0x0x48
    public DateTime <BHJEMCMMIDL>k__BackingField;    // 0x0x50
    public DateTime? <OIHIMPLODGO>k__BackingField;    // 0x0x58
    public long? <BJBFJPIJEEN>k__BackingField;    // 0x0x68
    public int <OOFMJJGHCNH>k__BackingField;    // 0x0x78
    public int <EEMMOIILECE>k__BackingField;    // 0x0x7C
    public int <LAMNDILCLPM>k__BackingField;    // 0x0x80
    public GICOFCNJIEJ <JLIPMAMHMKF>k__BackingField;    // 0x0x84
    public GICOFCNJIEJ <NCKFHIBBAFB>k__BackingField;    // 0x0x88
    public bool <KGPPGAALPHL>k__BackingField;    // 0x0x8C
    public bool <FOOBFLLKBFC>k__BackingField;    // 0x0x8D
    public bool <KPLJAJEBHIG>k__BackingField;    // 0x0x8E
    public int? <AJADDCBKNAH>k__BackingField;    // 0x0x90
    public bool <MLABBILOCBI>k__BackingField;    // 0x0x98
}
...
public class NEPMHDCMLHM
{
    public string <ELDOIBPHIKD>k__BackingField;    // 0x0x10
    public string <KABCGKLBFEH>k__BackingField;    // 0x0x18
}
...
public class NFNEHMMGJAG : PGLPHPAAMOO
{
    public int <FDMHGPGHGIG>k__BackingField;    // 0x0x30
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x38
    public DateTime <JFLCGBHDCFA>k__BackingField;    // 0x0x40
    public DateTime <ENIPEGLEBME>k__BackingField;    // 0x0x48
    public LCLONCHBBJN <BIFKPLMAHLO>k__BackingField;    // 0x0x50
    public BHPBDNFIHPI <IJBDMGMPEEF>k__BackingField;    // 0x0x58
    public List<KDMBBEFOALA> <PBHECEHOFAL>k__BackingField;    // 0x0x60
    public EOIEBNBKEGH <CGHLNJGNBEM>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// NHEGAFPPPPH
//   RESPONSE GET    api/groups/v1/memberships/{gDLABGIKFMA}   [Service.API]
public class NHEGAFPPPPH
{
    public long <ICDCOEGCDJL>k__BackingField;    // 0x0x10
    public int <HJDIFNAHOLD>k__BackingField;    // 0x0x18
    public DOCJENMKNHD <JPFHNOEEDGC>k__BackingField;    // 0x0x1C
}
...
public class NOHLCKAJGOL
{
    public int <JABGCKODOAP>k__BackingField;    // 0x0x10
    public int <CHCAPEANLNK>k__BackingField;    // 0x0x14
    public float <OONEJEKBEAN>k__BackingField;    // 0x0x18
    public float <HBIFDFCOOCK>k__BackingField;    // 0x0x1C
    public bool <KAICIHKJOEI>k__BackingField;    // 0x0x20
    public bool <OLFGLNAOFOG>k__BackingField;    // 0x0x21
    public bool <JIGCFFNGOBA>k__BackingField;    // 0x0x22
}
...
public class ODAIOMECGGA
{
    public long <PIIJHLIGNOH>k__BackingField;    // 0x0x10
    public long? <AJGKLAPAJMP>k__BackingField;    // 0x0x18
    public long? <BBJOABEPOOF>k__BackingField;    // 0x0x28
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x38
    public string <DKCOGMBIGJG>k__BackingField;    // 0x0x40
    public List<string> <ILGJONDGLJC>k__BackingField;    // 0x0x48
    public string <KADKALMGDDH>k__BackingField;    // 0x0x50
    public DateTime <FDMJAHADHEF>k__BackingField;    // 0x0x58
    public DateTime <OJBFOMFHKIG>k__BackingField;    // 0x0x60
    public NDONOBMDJGI <OMIGGFAANJN>k__BackingField;    // 0x0x68
    public bool <DPDMDMIFIMJ>k__BackingField;    // 0x0x6C
    public bool <OJJHLGLGNOD>k__BackingField;    // 0x0x6D
    public AJOFINGJKJB <BGLIFBGDMGD>k__BackingField;    // 0x0x70
    public AJOFINGJKJB <DNGNHKEFBMJ>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// OFKLDKJOOOK
//   (not directly referenced by a detected call)
public class OFKLDKJOOOK
{
    public int <BKBMFNHBEKC>k__BackingField;    // 0x0x10
    public int <BGFGGAIBFJO>k__BackingField;    // 0x0x14
    public int <DMJKJMLBFKM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PDDIFBIKCDC
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class PDDIFBIKCDC
{
    public List<LIJAKLCENHE> <ILGJONDGLJC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PGCHDJIMGEF
//   (not directly referenced by a detected call)
public class PGCHDJIMGEF
{
    public int <HAFFIHBHCCO>k__BackingField;    // 0x0x10
    public DateTime <BHJEMCMMIDL>k__BackingField;    // 0x0x18
    public DateTime? <FOBBDCNDNMI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PHCJAJIEIHC
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class PHCJAJIEIHC
{
    public LFOLCLHNOGP <DBBMGONCBFL>k__BackingField;    // 0x0x10
    public long <OGGJIAKHMHO>k__BackingField;    // 0x0x18
    public string <KEAKFDLNOKC>k__BackingField;    // 0x0x20
}
...
public class PHFMCFEOBMC
{
    public bool <LAFGAHLGLDE>k__BackingField;    // 0x0x10
    public string <PNNDHPGEOKD>k__BackingField;    // 0x0x18
}
...
public class PKFEHNOMBFG : PGLPHPAAMOO
{
    public List<NCDPGKMCCEL> JCCCNMAONAL;    // 0x0x30
    public int <JHIFMOEJHFK>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// POALLIOOICP
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class POALLIOOICP
{
    public long <OGGJIAKHMHO>k__BackingField;    // 0x0x10
    public DDKEMMMPHKD <FPEDEKOHEGI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PONJFMCPANE
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class PONJFMCPANE
{
    public LCLONCHBBJN <BIFKPLMAHLO>k__BackingField;    // 0x0x10
    public CFDENEOJKML <MLBEBNJOMEH>k__BackingField;    // 0x0x14
    public int <BOKKLLFLOGI>k__BackingField;    // 0x0x18
    public int <EPEPDPNLJBK>k__BackingField;    // 0x0x1C
    public int <HINEGHIIJFD>k__BackingField;    // 0x0x20
    public FKIPMDCDEPA <NBGMFCLPKPP>k__BackingField;    // 0x0x24
    public bool <OKPDKCCNDDL>k__BackingField;    // 0x0x28
    public float <LIPHNMBAHNA>k__BackingField;    // 0x0x2C
    public int <EMBLMNALNJK>k__BackingField;    // 0x0x30
    public bool <CGANNDBOJIB>k__BackingField;    // 0x0x34
}
...
{
    public NIGOBDBPMCA <IEKAKDKNPMJ>k__BackingField;    // 0x0x10
    public string <OAANCJNEECP>k__BackingField;    // 0x0x18
    public string <GDNELJIDGLP>k__BackingField;    // 0x0x20
    public string <MPKIIMGINAJ>k__BackingField;    // 0x0x28
}
...
public class GetRankRequestDTO
{
    ...
    public BFBJHDHPHNL FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public ANENBOMLLII <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public CDHJNCDMLBE creatorAccountRole;    // 0x0x58
}
...
{
    public ODHBBAAPLKC <HBAOFILHFED>k__BackingField;    // 0x0x10
    public string <NMNEKNLBCCI>k__BackingField;    // 0x0x18
    public bool <IBCBCIIDADK>k__BackingField;    // 0x0x20
}
...
{
    public List<ODHBBAAPLKC> <EFLMPEPLDBN>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public DCJPKCJMIND ReportCategory;    // 0x0x20
}
...
{
    public FLGBJHJKKOM? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public FLGBJHJKKOM FDJKNNJBDGK;  // wrapper
...
{
    public BEJNGNNBBEL KLHHGIPBMHC;  // wrapper
...
{
    public EKLJAENJOJL LDJDMLKKJPF;  // wrapper
    public int? MAHCDABDABP;  // wrapper
...
{
    public IBGDEANOKFH UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public ANENBOMLLII JBPOCMHHIBO;  // wrapper
    public ANENBOMLLII? GCNLLOHJBAI;  // wrapper
...
{
    public EDNGALGJBBH CFHEJIEEDNP;  // wrapper
...
{
    public LFOLCLHNOGP CFOKMJKHHIB;  // wrapper
...
{
    public IReadOnlyList<EENNAHAKCKL> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public CPKLEJMKJDJ HIAPMLPAIIL;  // wrapper
    public ANENBOMLLII? PHEEONDEDBF;  // wrapper
...
{
    public CPGEMAFAHII NMEIGDFEOOI;  // wrapper
...
{
    public StatusResponse> JKHIBJGOJLH;  // wrapper
...
{
    public List<long> MKIKHKPMDAD;  // wrapper
    public EIENACIBNDA FMJOHIMOMBJ;  // wrapper
    public long? FIMAPJOLFFM;  // wrapper
    public GMLKCDKBFFH JKHIBJGOJLH;  // wrapper
...
{
    public String> JKHIBJGOJLH;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{pLMICNFPHCK}  [API POST]
public class PlayereventsV2DeletePLMICNFPHCKRequest
{
    public BHFDBAKFIFK PLMICNFPHCK;  // wrapper
}
...
{
    public BHFDBAKFIFK PLMICNFPHCK;  // wrapper
    public NDONOBMDJGI BALBDAIGDBL;  // wrapper
...
{
    public BHFDBAKFIFK PLMICNFPHCK;  // wrapper
    public long? KANGIFFBEBL;  // wrapper
    public object clubId;  // candidate
}
...
{
    public BHFDBAKFIFK PLMICNFPHCK;  // wrapper
    public AJOFINGJKJB NGMBDGIBDOJ;  // wrapper
    public AJOFINGJKJB JHPNBNNACEC;  // wrapper
...
{
    public BHFDBAKFIFK PLMICNFPHCK;  // wrapper
    public long? MHGAJOLDLDN;  // wrapper
    public object roomId;  // candidate
...
{
    public BHFDBAKFIFK PLMICNFPHCK;  // wrapper
    public List<string> NNBLFKKCNEK;  // wrapper
...
{
    public BHFDBAKFIFK PLMICNFPHCK;  // wrapper
    public DateTime KEINCKNBLHF;  // wrapper
    public DateTime LNAJMCJILKG;  // wrapper
...
{
    public Guid KACGCAHKKFK;  // wrapper
...
{
    public List<EGBLNNDKJJD> AwardCurrencyBulkAsync;  // wrapper
}
...
{
    public Guid KACGCAHKKFK;  // wrapper
    public long? CCBCHBCIBFI;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
    public object Limit;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> DLHIOLCPDPA;  // wrapper
...
{
    public Guid? BGIOHOFOFAP;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats DJOMJNJBECP;  // wrapper
}
...
{
    public Guid OPDCMAPOMML;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<EKDAGMOELOJ> GPCKFKOPDHE;  // wrapper
...
{
    public HHMDNGFOOIG GHBLGDLGAFB;  // wrapper
}
