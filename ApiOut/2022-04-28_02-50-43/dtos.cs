...
public class ACJHJIOKNGC
{
    public KGONJHCGHJF <ONPJAEEOFFL>k__BackingField;    // 0x0x10
    public JAIJHALMKPG <GBCHPKGBJDI>k__BackingField;    // 0x0x18
}
...
public class AEAOEBGCGIH : NLDMJHIKCJB
{
    public LOFNPMFBHIG? <MGFHHDHIMFG>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <CJLGNFPLDFH>k__BackingField;    // 0x0x20
}
...
// AKODHOJAFBK
//   (not directly referenced by a detected call)
public class AKODHOJAFBK
{
    public KEJCPBGJOLN PANIPGONOAB;    // 0x0x10
    public int LNJNMDFFGPM;    // 0x0x14
}
...
public class ANNNCHNPABN
{
    public GBNIGDIGKKN <LFLKAMEONHG>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <CJLGNFPLDFH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BALDLIIJHJL
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class BALDLIIJHJL
{
    public int <IPAHGALKEHP>k__BackingField;    // 0x0x10
    public int <KFIGPHMNLHP>k__BackingField;    // 0x0x14
    public float <BAANHLAHEMF>k__BackingField;    // 0x0x18
    public float <HDLCNMCELFF>k__BackingField;    // 0x0x1C
    public bool <BHNJMNGIGJH>k__BackingField;    // 0x0x20
    public bool <IEANACIDDHH>k__BackingField;    // 0x0x21
    public bool <ELAAGPALGID>k__BackingField;    // 0x0x22
}
...
// --------------------------------------------------------------------------
// BHAJKEHEBPO
//   RESPONSE GET    api/inventions/v1/personaldetails/{iADKADJLJAD}   [Service.API]
public class BHAJKEHEBPO
{
    public bool <LGLKBPFNGFP>k__BackingField;    // 0x0x10
}
...
// --------------------------------------------------------------------------
// BHLIIPLGHLB
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{lLDODNFBFON}   [Service.API]
public class BHLIIPLGHLB
{
    public uint <OGGMJLKDCLA>k__BackingField;    // 0x0x10
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x18
    public string <IBECFGGNHHN>k__BackingField;    // 0x0x20
    public DateTime <FLECHAOBBFJ>k__BackingField;    // 0x0x28
    public DateTime? <OHFMFIMADEM>k__BackingField;    // 0x0x30
    public bool <EFLDNJMOJNK>k__BackingField;    // 0x0x40
    public List<GLNNHBLMMJJ> <HMGCFCLIGGO>k__BackingField;    // 0x0x48
    public List<string> <PKNKMGHGFFN>k__BackingField;    // 0x0x50
    public int <CNBMOEJBPGO>k__BackingField;    // 0x0x58
    public int <JOGOCAPHKPE>k__BackingField;    // 0x0x5C
    public int <ABGICKDMKPG>k__BackingField;    // 0x0x60
}
...
public class BJJAOEAJCAI
{
    public HPLAPOCBPME <ONPJAEEOFFL>k__BackingField;    // 0x0x10
    public BJMDENKPFKE <LFPJGCPJAOM>k__BackingField;    // 0x0x18
    public GKPOLEHHNCI <HDCKBNKKMBI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BJMDENKPFKE
//   (not directly referenced by a detected call)
public class BJMDENKPFKE
{
    public long <IDNFCEFKHIN>k__BackingField;    // 0x0x10
    public string <PCHNDJCKGKK>k__BackingField;    // 0x0x18
    public int <CMLHCFMBPGC>k__BackingField;    // 0x0x20
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x28
    public string <IBECFGGNHHN>k__BackingField;    // 0x0x30
    public string <NFOJLEFMNML>k__BackingField;    // 0x0x38
    public int <COCKJEIMGPP>k__BackingField;    // 0x0x40
    public MMKDCDOPKDJ <FAEEGGENFAE>k__BackingField;    // 0x0x44
    public DateTime <COLDOJBECDK>k__BackingField;    // 0x0x48
    public DateTime <HOGEHHPMEJL>k__BackingField;    // 0x0x50
    public DateTime? <HFKKPEKOKLE>k__BackingField;    // 0x0x58
    public long? <IPLHOGACLFP>k__BackingField;    // 0x0x68
    public int <CAKODLHPHLE>k__BackingField;    // 0x0x78
    public int <MGPCAOILGLF>k__BackingField;    // 0x0x7C
    public int <GGNMDDAKPGA>k__BackingField;    // 0x0x80
    public LFDHPHIKHKD <GMNJFBIIFBF>k__BackingField;    // 0x0x84
    public LFDHPHIKHKD <NAEBMEKEHNL>k__BackingField;    // 0x0x88
    public bool <JMLKJAFBAAH>k__BackingField;    // 0x0x8C
    public bool <CKBDOEMAFDO>k__BackingField;    // 0x0x8D
    public bool <PNKNHABBNLJ>k__BackingField;    // 0x0x8E
    public int? <JBIJGHPECHD>k__BackingField;    // 0x0x90
    public bool <BLOPFAJOFKI>k__BackingField;    // 0x0x98
}
...
public class CLOIFGFPNEI
{
    public Dictionary<int, int> <FMKBGHNLMGM>k__BackingField;    // 0x0x10
    public List<DALJDMFBAGG> <AEOCBGLLIAN>k__BackingField;    // 0x0x18
    public AKODHOJAFBK[][] <PGOBCFDKGEP>k__BackingField;    // 0x0x20
    public JNFIMMJKPEO <BALIANDDOBE>k__BackingField;    // 0x0x28
    public NLIMFENLHDD <IGOCENMCOJC>k__BackingField;    // 0x0x30
    public KOHPJBDNJIF <BLAAEMHILIA>k__BackingField;    // 0x0x38
    public HCCMLMMJLME <JAKACBOAENE>k__BackingField;    // 0x0x40
    public IOKCPHOLALI <NAAOHDAJFKK>k__BackingField;    // 0x0x48
    public string <IHNMLKAAGMP>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// DAIAECMGCDE
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class DAIAECMGCDE
{
    public int <MGLLDMOMLAO>k__BackingField;    // 0x0x10
    public Guid <AEMFJFHKKDN>k__BackingField;    // 0x0x14
    public long <HMAEICLEHKA>k__BackingField;    // 0x0x28
    public long <IEKMGPKGDIL>k__BackingField;    // 0x0x30
    public DateTime <LOCJPDKIGFF>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// DBICFIPHPML
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class DBICFIPHPML
{
    public MIEAJIEJLOI <IJBFLEBNNIF>k__BackingField;    // 0x0x10
    public long <LBFHIHHNFOD>k__BackingField;    // 0x0x18
    public string <GMDBKAFIMCE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DFACIBKGAMJ
//   (not directly referenced by a detected call)
public class DFACIBKGAMJ
{
    public bool <GPJFKONGOHH>k__BackingField;    // 0x0x10
    public JCGPFPODHEN <KKFCNCIGMBG>k__BackingField;    // 0x0x18
    public float <KJCHPCKEFMD>k__BackingField;    // 0x0x20
}
...
public class DIDGFJLLPLG
{
    public long <BEGPLOIDOKD>k__BackingField;    // 0x0x10
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x18
    public string <IBECFGGNHHN>k__BackingField;    // 0x0x20
    public DateTime <HOGEHHPMEJL>k__BackingField;    // 0x0x28
    public string <NFOJLEFMNML>k__BackingField;    // 0x0x30
    public GCOHMIPJAHH <GDOGIACOILN>k__BackingField;    // 0x0x38
    public int <DHKJLONPGAD>k__BackingField;    // 0x0x3C
    public int <JMKKNPEEGGJ>k__BackingField;    // 0x0x40
    public List<JKMFOCBKKON> <LMDMJCNFEEC>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// DMLHPKOBCIA
//   (not directly referenced by a detected call)
public class DMLHPKOBCIA
{
    public Guid <GOKIIGKGNNJ>k__BackingField;    // 0x0x10
    public Guid <MGHNHANJNII>k__BackingField;    // 0x0x20
    public DateTime <LNAMBKNAPKD>k__BackingField;    // 0x0x30
    public List<JCGPFPODHEN> <CGJCLPJEHDD>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// DNOMDILECEM
//   RESPONSE POST   api/settings/v2/set   [Service.API]
public class DNOMDILECEM
{
    public bool HLAAACCKBIG;    // 0x0x10
    public bool OLMKGGKMJIN;    // 0x0x11
}
...
// EBJIJJNBEOM
//   (not directly referenced by a detected call)
public class EBJIJJNBEOM
{
    public bool <JLOPLEFEFHI>k__BackingField;    // 0x0x10
    public PCKMMJKHCKA <LJKFMEJGPPE>k__BackingField;    // 0x0x14
    public int <MENPFMKDMND>k__BackingField;    // 0x0x18
    public DateTime <COLDOJBECDK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EBKDPOADFHP
//   (not directly referenced by a detected call)
public class EBKDPOADFHP
{
    public OEHAHNIIMKB <FPLLOONCMKO>k__BackingField;    // 0x0x10
    public NFCBPFCBDPM <HKAKLLCFACG>k__BackingField;    // 0x0x18
}
...
public class ECPEEBKLJMD : NLDMJHIKCJB
{
    public AIIIHCNMDIO? <MGFHHDHIMFG>k__BackingField;    // 0x0x18
    public GBNIGDIGKKN <LFLKAMEONHG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EDEDGGADDAP
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{oFFDNPGJHLM}   [Service.API]
public class EDEDGGADDAP
{
    public Guid <APNHOFONCAF>k__BackingField;    // 0x0x10
    public int <MGLLDMOMLAO>k__BackingField;    // 0x0x20
    public int <KCDLMEMOHKL>k__BackingField;    // 0x0x24
    public DateTime <HOGEHHPMEJL>k__BackingField;    // 0x0x28
}
...
public class EFFMDKIPNDI
{
    public List<MHDMECCMMME> <ODGOPHMLHML>k__BackingField;    // 0x0x10
    public string <ONNFLBJHLMP>k__BackingField;    // 0x0x18
}
...
public class EIJHILIIEDM
{
    public long <DDDHFPDNAOI>k__BackingField;    // 0x0x10
    public long? <DEIIGPAJLKL>k__BackingField;    // 0x0x18
    public long? <FECEGIBFGKJ>k__BackingField;    // 0x0x28
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x38
    public string <IBECFGGNHHN>k__BackingField;    // 0x0x40
    public List<string> <PKNKMGHGFFN>k__BackingField;    // 0x0x48
    public string <NFOJLEFMNML>k__BackingField;    // 0x0x50
    public DateTime <EKABDALHIMD>k__BackingField;    // 0x0x58
    public DateTime <CPJMFGEJIOA>k__BackingField;    // 0x0x60
    public LNDNBHOFGBO <FAEEGGENFAE>k__BackingField;    // 0x0x68
    public bool <GFAHLABIEAP>k__BackingField;    // 0x0x6C
    public bool <IPEDLDEFPPB>k__BackingField;    // 0x0x6D
    public BHFJLAFAKGA <DJENONCGKHB>k__BackingField;    // 0x0x70
    public BHFJLAFAKGA <JHELOBCJKIP>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// EIJNCGLPKFD
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class EIJNCGLPKFD
{
    public string <CEPACFBFMAK>k__BackingField;    // 0x0x10
    public string <IBEDAIGFGEE>k__BackingField;    // 0x0x18
}
...
public class EJNIDOKHKJM
{
    public List<int> <GHHEMLOPOHM>k__BackingField;    // 0x0x10
    public string <ONNFLBJHLMP>k__BackingField;    // 0x0x18
}
...
public class EJNIFFCKIFI
{
    public Guid <HPHDKBNMAHK>k__BackingField;    // 0x0x10
    public Guid <AEMFJFHKKDN>k__BackingField;    // 0x0x20
    public int <BJFGJOBEBOO>k__BackingField;    // 0x0x30
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x38
    public long <MDCMFKCHKFL>k__BackingField;    // 0x0x40
    public long <JBIJGHPECHD>k__BackingField;    // 0x0x48
    public DateTime <COLDOJBECDK>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// ELEEDBCFIHJ
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class ELEEDBCFIHJ
{
    public long <LBFHIHHNFOD>k__BackingField;    // 0x0x10
    public JDNKABMFDON <FAMFEDAEFGB>k__BackingField;    // 0x0x18
}
...
// base   : LNEPJJKGIKI
//   (not directly referenced by a detected call)
public class EMMDOHHHDHA : LNEPJJKGIKI
{
    public JCGPFPODHEN <KKFCNCIGMBG>k__BackingField;    // 0x0x60
}
...
public class EOKAFDMFAED
{
    public Guid <AEMFJFHKKDN>k__BackingField;    // 0x0x10
    public long? <DDDHFPDNAOI>k__BackingField;    // 0x0x20
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x30
    public string <IBECFGGNHHN>k__BackingField;    // 0x0x38
    public JLECNLJJNIB <BMPPFDHELLJ>k__BackingField;    // 0x0x40
    public long <GLFPFLIGJJP>k__BackingField;    // 0x0x48
    public string <NFOJLEFMNML>k__BackingField;    // 0x0x50
    public DateTime <HOGEHHPMEJL>k__BackingField;    // 0x0x58
    public DateTime <COLDOJBECDK>k__BackingField;    // 0x0x60
}
...
public class FLNANKLJFNE
{
    public bool <NPCDJPPAGJH>k__BackingField;    // 0x0x10
    public string <NIABFKELDAB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FLOCFIGOOEN
//   (not directly referenced by a detected call)
public class FLOCFIGOOEN
{
    public string <EJLCEGPFINA>k__BackingField;    // 0x0x10
    public ALDKMEJMAJC <FAMFEDAEFGB>k__BackingField;    // 0x0x18
}
...
public class FPACDFIEJFB
{
    public int <AKGFMGIFBOH>k__BackingField;    // 0x0x10
    public List<NIJAPNNGOAO> <NPDLLEPBPMF>k__BackingField;    // 0x0x18
}
...
public class GBNIGDIGKKN
{
    public int <MGLLDMOMLAO>k__BackingField;    // 0x0x10
    public Guid <AEMFJFHKKDN>k__BackingField;    // 0x0x14
    public long <HMAEICLEHKA>k__BackingField;    // 0x0x28
    public DateTime <COLDOJBECDK>k__BackingField;    // 0x0x30
}
...
public class GDFPOKMHJFA
{
    public HTTPResponse LAFMHDBGJOG;    // 0x0x10
    public int? BMEBMJFKKNJ;    // 0x0x18
    public string JNAIJHCJAFE;    // 0x0x20
    public byte[] IABHDHFJIPJ;    // 0x0x28
    public string EPHINHBCDMD;    // 0x0x30
}

// --------------------------------------------------------------------------
// GKHJMOICPCJ
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class GKHJMOICPCJ
{
    public MIEAJIEJLOI <IJBFLEBNNIF>k__BackingField;    // 0x0x10
    public int <LJDMKJOGKGK>k__BackingField;    // 0x0x14
    public long <PCCDNCCACKF>k__BackingField;    // 0x0x18
    public bool <PDILNCIIJAP>k__BackingField;    // 0x0x20
    public string <NIABFKELDAB>k__BackingField;    // 0x0x28
    public int? <FCIKDDECAEJ>k__BackingField;    // 0x0x30
    public bool <EHEGIGMIOKG>k__BackingField;    // 0x0x38
    public bool <MOMAJOLAGFM>k__BackingField;    // 0x0x39
    public string <GPMKPPGLADJ>k__BackingField;    // 0x0x40
    public float <IOOMIOOFGGN>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// GKPOLEHHNCI
//   (not directly referenced by a detected call)
public class GKPOLEHHNCI
{
    public long <IDNFCEFKHIN>k__BackingField;    // 0x0x10
    public string <PCHNDJCKGKK>k__BackingField;    // 0x0x18
    public int <ICOJCJPKKEP>k__BackingField;    // 0x0x20
    public int <LJDHKFDMFEN>k__BackingField;    // 0x0x24
    public int <DPFECJDLLPF>k__BackingField;    // 0x0x28
    public int <ONKMJMMNKML>k__BackingField;    // 0x0x2C
    public int <KIBELMGJJOA>k__BackingField;    // 0x0x30
    public string <JOMDMENDEAD>k__BackingField;    // 0x0x38
    public string <NPCBJMIIEEK>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// GLNNHBLMMJJ
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{lLDODNFBFON}   [Service.API]
public class GLNNHBLMMJJ
{
    public string <OGGMJLKDCLA>k__BackingField;    // 0x0x10
    public string <CEPACFBFMAK>k__BackingField;    // 0x0x18
    public string <CGGEEDMNKJA>k__BackingField;    // 0x0x20
    public string <IBECFGGNHHN>k__BackingField;    // 0x0x28
    public string <JOAEAIHDGKI>k__BackingField;    // 0x0x30
    public BGPFDEAPNJK <ONPJAEEOFFL>k__BackingField;    // 0x0x38
    public List<string> <DBAOPMAFKNN>k__BackingField;    // 0x0x40
    public List<string> <PKNKMGHGFFN>k__BackingField;    // 0x0x48
    public string <BABECICIFFP>k__BackingField;    // 0x0x50
    public List<NCFEDCBKJPO> <IEKMIGPJABI>k__BackingField;    // 0x0x58
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{gALNDIHMKIO}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{gALNDIHMKIO}   [Service.API]
...
public class GMAOELBKCGK
{
    public KGONJHCGHJF <ONPJAEEOFFL>k__BackingField;    // 0x0x10
    public HGLDGDLPGOH <PNLEFFIJHPF>k__BackingField;    // 0x0x18
}
...
public class HAHCENILFOM : BGCBBHMNFJM
{
    public List<EMMDOHHHDHA> AJFOMNOECOO;    // 0x0x30
    public int <FAJMHAJPBKJ>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// HAKANPKCILD
//   (not directly referenced by a detected call)
public class HAKANPKCILD
{
    public int <PCCLHNCMFEB>k__BackingField;    // 0x0x10
    public int <FNHFOHBMDEJ>k__BackingField;    // 0x0x14
    public int <CHFBMKEDGPL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HCCMLMMJLME
//   (not directly referenced by a detected call)
public class HCCMLMMJLME
{
    public int <OHDOPGECICL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HCHKANFGAND
//   (not directly referenced by a detected call)
public class HCHKANFGAND
{
    // (no instance fields in the metadata dump)
}
...
public class HDAHOOKPCOC
{
    public bool <NPCDJPPAGJH>k__BackingField;    // 0x0x10
    public string <CGENOCEPBEN>k__BackingField;    // 0x0x18
}
...
public class HGDBJIPPLBA
{
    public int <KBJBNKNHIIJ>k__BackingField;    // 0x0x10
    public HBNJAIIFJLB <FAMFEDAEFGB>k__BackingField;    // 0x0x14
    public MJCENMOJLIB <JPPHHNIFCHI>k__BackingField;    // 0x0x18
    public MJCENMOJLIB <LDNKMHMJOOO>k__BackingField;    // 0x0x1C
    public MJCENMOJLIB <GNDAEDGBNHN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HGLDGDLPGOH
//   (not directly referenced by a detected call)
public class HGLDGDLPGOH
{
    public Guid <EHNDLNOANFJ>k__BackingField;    // 0x0x10
    public long <DDDHFPDNAOI>k__BackingField;    // 0x0x20
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x28
    public string <IBECFGGNHHN>k__BackingField;    // 0x0x30
    public string <NFOJLEFMNML>k__BackingField;    // 0x0x38
    public long <JBIJGHPECHD>k__BackingField;    // 0x0x40
    public Guid? <LBPGGCHLGIE>k__BackingField;    // 0x0x48
    public DateTime <COLDOJBECDK>k__BackingField;    // 0x0x60
}
...
// ICFIGJFACPO
//   (not directly referenced by a detected call)
public class ICFIGJFACPO
{
    public long <BKGIIFJBPPB>k__BackingField;    // 0x0x10
    public string <LEGAHPIGFMC>k__BackingField;    // 0x0x18
    public string <DFCFBGNBDBE>k__BackingField;    // 0x0x20
    public FMPMPLLILIC? <AHDFCEOPOAM>k__BackingField;    // 0x0x28
    public string <HFIIIJOEAJC>k__BackingField;    // 0x0x30
    public string <JDFODCEDIJI>k__BackingField;    // 0x0x38
    public KOHCBEDDKKH <BDAKOFIDCCC>k__BackingField;    // 0x0x40
    public int <BFDFKMHJMNN>k__BackingField;    // 0x0x44
    public int <HOCCAJIEHAF>k__BackingField;    // 0x0x48
    public BEPMAAANNMD? <EFMMIECNJNC>k__BackingField;    // 0x0x4C
    public PLPDGNGCIOI? <AMAODIELBOH>k__BackingField;    // 0x0x54
}
...
public class IOAKNCKFCAE
{
    public int <KFIGPHMNLHP>k__BackingField;    // 0x0x10
    public bool <BHNJMNGIGJH>k__BackingField;    // 0x0x14
    public DateTime <LMFDGNJDFPD>k__BackingField;    // 0x0x18
    public bool <MGLBKEEGDML>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IOKCPHOLALI
//   (not directly referenced by a detected call)
public class IOKCPHOLALI
{
    public float <BKOLAPKLKFP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IOLPHEIEBCE
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class IOLPHEIEBCE
{
    public AKHJDJHANIJ <IGJHLDPACDF>k__BackingField;    // 0x0x10
    public List<string> <PKNKMGHGFFN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JAIJHALMKPG
//   (not directly referenced by a detected call)
public class JAIJHALMKPG
{
    public Guid <EHNDLNOANFJ>k__BackingField;    // 0x0x10
    public int <MGLLDMOMLAO>k__BackingField;    // 0x0x20
    public int <KEKCJCLILAL>k__BackingField;    // 0x0x24
    public Guid <NGHNJJKJKOM>k__BackingField;    // 0x0x28
    public DateTime <COLDOJBECDK>k__BackingField;    // 0x0x38
    public HGLDGDLPGOH <PNLEFFIJHPF>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// JCGPFPODHEN
//   (not directly referenced by a detected call)
public class JCGPFPODHEN
{
    public int <BKGIIFJBPPB>k__BackingField;    // 0x0x10
    public string <LMJBFLOFMHM>k__BackingField;    // 0x0x18
    public string <OIGJGEJLMLM>k__BackingField;    // 0x0x20
    public string <LEGAHPIGFMC>k__BackingField;    // 0x0x28
    public string <PLLABJHHFOD>k__BackingField;    // 0x0x30
    public FMPMPLLILIC? <AHDFCEOPOAM>k__BackingField;    // 0x0x38
    public string <HFIIIJOEAJC>k__BackingField;    // 0x0x40
    public string <JDFODCEDIJI>k__BackingField;    // 0x0x48
    public bool <EJPCEIFLCPM>k__BackingField;    // 0x0x50
    public bool <GAEMDLDHAMH>k__BackingField;    // 0x0x51
    public bool <DIMNBCEKEDH>k__BackingField;    // 0x0x52
    public PLPDGNGCIOI <PIMCOKFABKO>k__BackingField;    // 0x0x54
    public JLECNLJJNIB <BMPPFDHELLJ>k__BackingField;    // 0x0x58
    public int <JEEHHGNIAFI>k__BackingField;    // 0x0x5C
    public KJLMCHNCHIB <FFHJOEODNPH>k__BackingField;    // 0x0x60
    public BEPMAAANNMD <LCJGGJBIBHC>k__BackingField;    // 0x0x64
    public int? <CBPLIAKLHDH>k__BackingField;    // 0x0x68
    public string <AIGKCHCEBCC>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// JDAKIDIOPJP
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class JDAKIDIOPJP
{
    public List<FLOCFIGOOEN> <PKNKMGHGFFN>k__BackingField;    // 0x0x10
}
...
// --------------------------------------------------------------------------
// JKMFOCBKKON
//   RESPONSE GET    api/groups/v1/memberships/{oNMDIPLOJIK}   [Service.API]
public class JKMFOCBKKON
{
    public long <BEGPLOIDOKD>k__BackingField;    // 0x0x10
    public int <AIGPLHFHFCD>k__BackingField;    // 0x0x18
    public EDOMAABDBFD <OHLBDFMMDCE>k__BackingField;    // 0x0x1C
}
...
// JNFIMMJKPEO
//   (not directly referenced by a detected call)
public class JNFIMMJKPEO
{
    public int <PDOHMCLNINL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KCNHFDJFFOJ
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{bIJLLLHMDFA}   [Service.API]
...
public class KCNHFDJFFOJ
{
    public OEHAHNIIMKB <FPLLOONCMKO>k__BackingField;    // 0x0x10
    public MAIMHOOPIBC <IGJHLDPACDF>k__BackingField;    // 0x0x18
    public IOLPHEIEBCE <IEJNFLJELAH>k__BackingField;    // 0x0x20
}
...
// KOFHEHBJGEG
//   (not directly referenced by a detected call)
public class KOFHEHBJGEG
{
    public int <OHNLMPLEBFE>k__BackingField;    // 0x0x10
    public DateTime? <OFCBIAMCDLE>k__BackingField;    // 0x0x18
    public DateTime? <OEJLNECDPIK>k__BackingField;    // 0x0x28
}
...
// KOHPJBDNJIF
//   (not directly referenced by a detected call)
public class KOHPJBDNJIF
{
    public int <MOBFNHPMCOD>k__BackingField;    // 0x0x10
}
...
//   RESPONSE GET    api/avatar/v2/{hMIJMBPJDJO}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{hMIJMBPJDJO}   [Service.API]
public class KOIALLMKCFK
{
    public string <CNFBBICGDOO>k__BackingField;    // 0x0x10
    public string <AGMGANPLCJB>k__BackingField;    // 0x0x18
    public string <LAFEEAPJOAM>k__BackingField;    // 0x0x20
    public string <LJOINEMDLCN>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// LCOCIGPPFPA
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.API]
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{gAJAEAPFLJI}   [Service.API]
public class LCOCIGPPFPA
{
    public long <DDDHFPDNAOI>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <KIAIJGKCOCM>k__BackingField;    // 0x0x18
    public PJNLJPJPHGP <NPDOHJOHIHA>k__BackingField;    // 0x0x20
}
...
public class LIPNDCOKHFH
{
    public int <OAPDHFLHKGH>k__BackingField;    // 0x0x10
    public string <PLNAFPDDKDO>k__BackingField;    // 0x0x18
    public string <CNFBBICGDOO>k__BackingField;    // 0x0x20
    public string <AGMGANPLCJB>k__BackingField;    // 0x0x28
    public string <LAFEEAPJOAM>k__BackingField;    // 0x0x30
    public string <LJOINEMDLCN>k__BackingField;    // 0x0x38
}
...
// LNEPJJKGIKI
//   (not directly referenced by a detected call)
public class LNEPJJKGIKI
{
    public int <KCDLMEMOHKL>k__BackingField;    // 0x0x10
    public DOHMJECGPMG <FAMFEDAEFGB>k__BackingField;    // 0x0x14
    public List<NCDIFHNMLPK> <BLJPNICIPHG>k__BackingField;    // 0x0x18
    public List<NCDIFHNMLPK> <LPAANLLEJMD>k__BackingField;    // 0x0x20
    public bool <ENMGLAOOGFK>k__BackingField;    // 0x0x28
    public DateTime? <IAJEPEFLBME>k__BackingField;    // 0x0x30
    public DateTime? <CBLMDPGMAGE>k__BackingField;    // 0x0x40
    public DateTime? <LCMIHADJOPL>k__BackingField;    // 0x0x50
}
...
public class LODGHCAIEKI : BGCBBHMNFJM
{
    public int <MOBAMAGJCAL>k__BackingField;    // 0x0x30
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x38
    public DateTime <LNAMBKNAPKD>k__BackingField;    // 0x0x40
    public DateTime <ENDPAEPMDIA>k__BackingField;    // 0x0x48
    public JLECNLJJNIB <BMPPFDHELLJ>k__BackingField;    // 0x0x50
    public LNEPJJKGIKI <PFDKGMJEJLP>k__BackingField;    // 0x0x58
    public List<MEPAKPJFDHF> <EEAJGJFDIHK>k__BackingField;    // 0x0x60
    public EBJIJJNBEOM <GNOLGIHCNMB>k__BackingField;    // 0x0x68
}
...
public class MAMILMAAFKA
{
    public List<OEHAHNIIMKB> <PJDBMBDBPNN>k__BackingField;    // 0x0x10
    public List<EBKDPOADFHP> <FJJCPPKGNLM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MDGLNAIOPOK
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class MDGLNAIOPOK
{
    public List<OECIGPIDCFA> <LAAJJGICKOC>k__BackingField;    // 0x0x10
    public MAIMHOOPIBC <IGJHLDPACDF>k__BackingField;    // 0x0x18
}
...
// base   : LNEPJJKGIKI
//   (not directly referenced by a detected call)
public class MEPAKPJFDHF : LNEPJJKGIKI
{
    public int <GMNLEIHBANN>k__BackingField;    // 0x0x60
    public List<DFACIBKGAMJ> <PHGDNBMCGND>k__BackingField;    // 0x0x68
    public List<DFACIBKGAMJ> <KBBIHIMBNOE>k__BackingField;    // 0x0x70
    public List<DFACIBKGAMJ> <KGJNEDDDNEF>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// MFAOMEMOBFP
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class MFAOMEMOBFP
{
    public JLECNLJJNIB <BMPPFDHELLJ>k__BackingField;    // 0x0x10
    public IHGDDBIKJAH <HGFNAMBIBEC>k__BackingField;    // 0x0x14
    public int <KFLDMOLJLNP>k__BackingField;    // 0x0x18
    public int <MKKLLCFLCAJ>k__BackingField;    // 0x0x1C
    public int <GBFCMCCLFME>k__BackingField;    // 0x0x20
    public KJNMFKFKAKN <MKDGLFIOEEO>k__BackingField;    // 0x0x24
    public bool <POMIIBDEGHH>k__BackingField;    // 0x0x28
    public float <BNMMDAOHFCN>k__BackingField;    // 0x0x2C
    public int <CKFFMOPABKF>k__BackingField;    // 0x0x30
    public bool <DJIMDAODKKA>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// MHDMECCMMME
//   (not directly referenced by a detected call)
public class MHDMECCMMME
{
    public int <OIOFOKGPPAI>k__BackingField;    // 0x0x10
    public DateTime <HOGEHHPMEJL>k__BackingField;    // 0x0x18
    public DateTime? <JIEANKILLIA>k__BackingField;    // 0x0x20
}
...
public class MHICOOGKGEO
{
    public MAIMHOOPIBC <IGJHLDPACDF>k__BackingField;    // 0x0x10
}
...
// NCDIFHNMLPK
//   (not directly referenced by a detected call)
public class NCDIFHNMLPK
{
    public JLECNLJJNIB <BMPPFDHELLJ>k__BackingField;    // 0x0x10
    public int <JBIJGHPECHD>k__BackingField;    // 0x0x14
    public KOFHEHBJGEG <DEAAEGOGLCG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NCFEDCBKJPO
//   (not directly referenced by a detected call)
public class NCFEDCBKJPO
{
    public DateTime <HOGEHHPMEJL>k__BackingField;    // 0x0x10
    public string <CCBJJAOADDB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NCIHGPNAFOL
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class NCIHGPNAFOL
{
    public int <PFLNCEPEKCN>k__BackingField;    // 0x0x10
    public string <HDHCDKCFGMB>k__BackingField;    // 0x0x18
    public List<PEDNPDEJMML> <OMPCFKNFKHM>k__BackingField;    // 0x0x20
    public ICFIGJFACPO <CBFPMKFMAFA>k__BackingField;    // 0x0x28
    public string <LLEBDFCHJPE>k__BackingField;    // 0x0x30
    public DateTime <LNAMBKNAPKD>k__BackingField;    // 0x0x38
    public DateTime <ENDPAEPMDIA>k__BackingField;    // 0x0x40
    public DateTime <IJEGJLMPNLM>k__BackingField;    // 0x0x48
    public bool? <KCLOGILONFG>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// NFCBPFCBDPM
//   (not directly referenced by a detected call)
public class NFCBPFCBDPM
{
    public long <BCLGBPPDOMP>k__BackingField;    // 0x0x10
    public long <LBFHIHHNFOD>k__BackingField;    // 0x0x18
    public int <AIGPLHFHFCD>k__BackingField;    // 0x0x20
    public DateTime <HOGEHHPMEJL>k__BackingField;    // 0x0x28
    public JDNKABMFDON <FAMFEDAEFGB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// NFFFMBFMFAO
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class NFFFMBFMFAO
{
    public int? <NONMINFPACJ>k__BackingField;    // 0x0x10
    public string <JOAEAIHDGKI>k__BackingField;    // 0x0x18
    public string <HLEBHNPKEBO>k__BackingField;    // 0x0x20
}
...
public class NGICNEAFGDN
{
    public AHFIKGDDJCM <ONPJAEEOFFL>k__BackingField;    // 0x0x10
    public NJGMHMNOELJ <KLBBAHLMMEL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NIJAPNNGOAO
//   (not directly referenced by a detected call)
public class NIJAPNNGOAO
{
    public DateTime? <NKNKEPPIAFN>k__BackingField;    // 0x0x10
    public DateTime? <PPLCDPAIJAB>k__BackingField;    // 0x0x20
    public PHELNJCJAEK <ONPJAEEOFFL>k__BackingField;    // 0x0x30
    public HAKANPKCILD <LLJPBAMJAIK>k__BackingField;    // 0x0x38
    public bool <IBDEJHONCKB>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// NJGMHMNOELJ
//   (not directly referenced by a detected call)
public class NJGMHMNOELJ
{
    public long <LKGLNLNJCCJ>k__BackingField;    // 0x0x10
    public Guid <PCHNDJCKGKK>k__BackingField;    // 0x0x18
    public long <DDDHFPDNAOI>k__BackingField;    // 0x0x28
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x30
    public string <IBECFGGNHHN>k__BackingField;    // 0x0x38
    public int <JBIJGHPECHD>k__BackingField;    // 0x0x40
    public Guid? <LBPGGCHLGIE>k__BackingField;    // 0x0x44
    public DateTime <HOGEHHPMEJL>k__BackingField;    // 0x0x58
    public string <NFOJLEFMNML>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// NLIMFENLHDD
//   (not directly referenced by a detected call)
public class NLIMFENLHDD
{
    public float <OKLGNHHOFOC>k__BackingField;    // 0x0x10
    public float <OBEPPIMGOJN>k__BackingField;    // 0x0x14
    public float <CCGEOAMLOBC>k__BackingField;    // 0x0x18
    public float <MKNLLELEFJC>k__BackingField;    // 0x0x1C
    public float <DFDJHKJFLBM>k__BackingField;    // 0x0x20
    public float <DKNMCFCOLBF>k__BackingField;    // 0x0x24
    public float <GEJAAOMGHBF>k__BackingField;    // 0x0x28
    public float <MLOBHGAABEM>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// NPJFJHJHEHB
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class NPJFJHJHEHB
{
    public int <LJDMKJOGKGK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OECIGPIDCFA
//   (not directly referenced by a detected call)
public class OECIGPIDCFA
{
    public int <NHFCGJBINKE>k__BackingField;    // 0x0x10
    public MAIMHOOPIBC <IGJHLDPACDF>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// OEHAHNIIMKB
//   (not directly referenced by a detected call)
public class OEHAHNIIMKB
{
    public long <LBFHIHHNFOD>k__BackingField;    // 0x0x10
    public int <CMLHCFMBPGC>k__BackingField;    // 0x0x18
    public long <DDDHFPDNAOI>k__BackingField;    // 0x0x20
    public long? <DEIIGPAJLKL>k__BackingField;    // 0x0x28
    public long? <FECEGIBFGKJ>k__BackingField;    // 0x0x38
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x48
    public string <IBECFGGNHHN>k__BackingField;    // 0x0x50
    public string <NFOJLEFMNML>k__BackingField;    // 0x0x58
    public DateTime <EKABDALHIMD>k__BackingField;    // 0x0x60
    public DateTime <CPJMFGEJIOA>k__BackingField;    // 0x0x68
    public int <EFCELIFHMNN>k__BackingField;    // 0x0x70
    public LNDNBHOFGBO <FAEEGGENFAE>k__BackingField;    // 0x0x74
    public bool <GFAHLABIEAP>k__BackingField;    // 0x0x78
    public bool <IPEDLDEFPPB>k__BackingField;    // 0x0x79
    public BHFJLAFAKGA <DJENONCGKHB>k__BackingField;    // 0x0x7C
    public BHFJLAFAKGA <JHELOBCJKIP>k__BackingField;    // 0x0x80
    public long? <JDKGOAPDGIB>k__BackingField;    // 0x0x88
}
...
public class OODPGMEANAL
{
    public string <FNGIAKADNLB>k__BackingField;    // 0x0x10
    public string <EKFHNBFJFDH>k__BackingField;    // 0x0x18
    public bool <HJOCDBIONHI>k__BackingField;    // 0x0x20
    public string <KEBCBAJLMBC>k__BackingField;    // 0x0x28
}
...
public class PDCMKCPOFHO
{
    public Guid <FIPKJAAIAGC>k__BackingField;    // 0x0x10
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x20
    public string <NFOJLEFMNML>k__BackingField;    // 0x0x28
    public DateTime <LNAMBKNAPKD>k__BackingField;    // 0x0x30
    public DateTime? <LICLEPGJFLH>k__BackingField;    // 0x0x38
    public List<DMLHPKOBCIA> <PNMAKCMKNLF>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// PEDNPDEJMML
//   (not directly referenced by a detected call)
public class PEDNPDEJMML
{
    public int <LCDPLLPPIFA>k__BackingField;    // 0x0x10
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x18
    public string <IJOJCHKFLBK>k__BackingField;    // 0x0x20
    public string <IBECFGGNHHN>k__BackingField;    // 0x0x28
    public string <OIGJGEJLMLM>k__BackingField;    // 0x0x30
    public bool <FNHDHPMNGBM>k__BackingField;    // 0x0x38
    public int <OAPDHFLHKGH>k__BackingField;    // 0x0x3C
    public HCHKANFGAND <PCDAFPKFGJL>k__BackingField;    // 0x0x40
    public DPPHBICIABH NAGBLEDNLPE;    // 0x0x48
    public DPPHBICIABH MJMLNIJNBHP;    // 0x0x50
    public DPPHBICIABH NKHODLEAHLP;    // 0x0x58
    public DODNPMMHEPN OOCPBLHHLHG;    // 0x0x60
}
...
public class PNENPONGNFA
{
    public List<string> <AGNCPFFANIE>k__BackingField;    // 0x0x10
    public List<string> <KPFDALNCBDK>k__BackingField;    // 0x0x18
    public List<string> <LMLLIBIIDNC>k__BackingField;    // 0x0x20
}
...
{
    public FAHHLPOFHKD <IGJHLDPACDF>k__BackingField;    // 0x0x10
    public string <GAFPDAIDOCH>k__BackingField;    // 0x0x18
    public string <LEGPBKJFPDJ>k__BackingField;    // 0x0x20
    public string <OPJAJLEOBDG>k__BackingField;    // 0x0x28
}
...
public class GetRankRequestDTO
{
    ...
    public GBCJKCOBIGD FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public BEPMAAANNMD <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public DIJOLAOMLKM creatorAccountRole;    // 0x0x58
}
...
{
    public OMNAGJFKODM <GLHNHDPPJKM>k__BackingField;    // 0x0x10
    public string <PBEBFKJNBGL>k__BackingField;    // 0x0x18
    public bool <GEPINCKNGBO>k__BackingField;    // 0x0x20
}
...
{
    public List<OMNAGJFKODM> <PIALEEBAPAH>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public GHFGJPCJKLP ReportCategory;    // 0x0x20
}
...
{
    public GDEFIAEGDOK? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public GDEFIAEGDOK ADGGFNMHEEO;  // wrapper
...
{
    public ALIAAFJHFAO HKFHNGGJEFO;  // wrapper
...
{
    public MANKAGJECML OMCCJKNHBML;  // wrapper
    public int? CHFCLOAFLCK;  // wrapper
...
{
    public OLLFEGMJKGF UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public BEPMAAANNMD EKDIFLKNOLC;  // wrapper
    public BEPMAAANNMD? ANBAKAOFINO;  // wrapper
...
{
    public PEDNPDEJMML HKPGDHIFEPF;  // wrapper
...
{
    public MIEAJIEJLOI FCGHBJLKBIL;  // wrapper
...
{
    public IReadOnlyList<NFIFICJGJAE> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public NEJJMJFNHKO PPCLHODOMAI;  // wrapper
    public BEPMAAANNMD? CPKKJFBMBJN;  // wrapper
...
{
    public MAIBHOBEAGL CMLFOAJJNMC;  // wrapper
...
{
    public StatusResponse> AGNPCLIMAAG;  // wrapper
...
{
    public List<long> DOFCCPNOEDM;  // wrapper
    public HHOAMGJPECO AGNPCLIMAAG;  // wrapper
    public KEEJIKCADJI IDKAOCNMHJM;  // wrapper
    public long? GAJAEAPFLJI;  // wrapper
...
{
    public String> AGNPCLIMAAG;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{bIJLLLHMDFA}  [API POST]
public class PlayereventsV2DeleteBIJLLLHMDFARequest
{
    public OEHAHNIIMKB BIJLLLHMDFA;  // wrapper
}
...
{
    public OEHAHNIIMKB BIJLLLHMDFA;  // wrapper
    public LNDNBHOFGBO IIOCOOJAKOJ;  // wrapper
...
{
    public OEHAHNIIMKB BIJLLLHMDFA;  // wrapper
    public long? NGLGLKLHJOK;  // wrapper
    public object clubId;  // candidate
}
...
{
    public OEHAHNIIMKB BIJLLLHMDFA;  // wrapper
    public BHFJLAFAKGA EINAFLKGJOF;  // wrapper
    public BHFJLAFAKGA HBEKNJIMFJL;  // wrapper
...
{
    public OEHAHNIIMKB BIJLLLHMDFA;  // wrapper
    public long? LHEGFBFADDE;  // wrapper
    public object roomId;  // candidate
...
{
    public OEHAHNIIMKB BIJLLLHMDFA;  // wrapper
    public List<string> GFMJKEHNKIM;  // wrapper
...
{
    public OEHAHNIIMKB BIJLLLHMDFA;  // wrapper
    public DateTime DLHMNCBNJOF;  // wrapper
    public DateTime MAKJOAMBBIJ;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> DIAMGKKPFJA;  // wrapper
...
{
    public Guid? GKFCEPBILDL;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats AEMOILHPLFG;  // wrapper
}
...
{
    public Guid GOCJBDPCLKP;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<OGKKGEJMEPJ> OOKGOPJBAFM;  // wrapper
...
{
    public BGPFDEAPNJK EPPFCLJCOMB;  // wrapper
}
