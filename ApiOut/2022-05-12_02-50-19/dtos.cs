...
// DTO classes: 234 (plus referenced enums)

// --------------------------------------------------------------------------
// AEHGNBGDGHF
//   RESPONSE GET    api/incentivizedreferrals/   [Service.API]
public class AEHGNBGDGHF
{
    public List<OJMCLHJHNFF> <DOKKGHKIDHE>k__BackingField;    // 0x0x10
    public string <KOLNGIELJMG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AFBKCNEEALO
//   (not directly referenced by a detected call)
public class AFBKCNEEALO
{
    public int <EOJHGMMEKOL>k__BackingField;    // 0x0x10
    public MLJDMOHLHON <AOGLFMNEFND>k__BackingField;    // 0x0x14
}
...
public class AHGIDJMAAKA
{
    public OIPALAHDJOI <JFIKNCAGJMK>k__BackingField;    // 0x0x10
    public GCBFJOMLHLL <PDFFHHHMDNN>k__BackingField;    // 0x0x18
    public LMGINDHCMHB <MCBKEBHIEBD>k__BackingField;    // 0x0x20
}
...
public class AIPAJMCBPLC
{
    public EDKEFKBEBOJ <JFIKNCAGJMK>k__BackingField;    // 0x0x10
    public PFGEANHDOFF <CFEMPABILNH>k__BackingField;    // 0x0x18
}
...
public class AMHADNNOKCP
{
    public Guid <IOAKGAGDNBG>k__BackingField;    // 0x0x10
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x20
    public string <KHMMOLHHAHN>k__BackingField;    // 0x0x28
    public DateTime <HDLLMIOLCKO>k__BackingField;    // 0x0x30
    public DateTime? <AAOHLLGCKGD>k__BackingField;    // 0x0x38
    public List<KKNKDOHBNBN> <CLKNAJBBLPJ>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// AOEIDHHBNEB
//   (not directly referenced by a detected call)
public class AOEIDHHBNEB
{
    public int <ECCNLOEBCGM>k__BackingField;    // 0x0x10
}
...
// APOGAPDJIPC
//   (not directly referenced by a detected call)
public class APOGAPDJIPC
{
    public IJGMIOJCDAA <FKLAKNLCBPK>k__BackingField;    // 0x0x10
    public int <PMOGMNPPBMC>k__BackingField;    // 0x0x14
    public EIEPEDFFGNC <NBMLOPMHDPA>k__BackingField;    // 0x0x18
}
...
public class BENCMEPGCJK
{
    public MMPBCHHAECM <JFIKNCAGJMK>k__BackingField;    // 0x0x10
    public MDOIALCLDII <OHFHDOHOJJO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BFPLIEPGHJF
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class BFPLIEPGHJF
{
    public OPEADODPFFB <KHJFMOIIKJK>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <HPKHCJHOJHP>k__BackingField;    // 0x0x18
}
...
public class BJDGEAJIDCE
{
    public bool <GMGJCOMNHOG>k__BackingField;    // 0x0x10
    public string <OKPEFICIGBC>k__BackingField;    // 0x0x18
}
...
// CBDMDKDKOGI
//   (not directly referenced by a detected call)
public class CBDMDKDKOGI
{
    public DCGHDOCPEFO <HKDBEICDPMG>k__BackingField;    // 0x0x10
    public OFIECOEPNNH <BFOAKDILFGI>k__BackingField;    // 0x0x18
}
...
// DCGHDOCPEFO
//   (not directly referenced by a detected call)
public class DCGHDOCPEFO
{
    public long <CFFABJDMBFI>k__BackingField;    // 0x0x10
    public int <HANOOOLCPOO>k__BackingField;    // 0x0x18
    public long <KBDJIMPFNKD>k__BackingField;    // 0x0x20
    public long? <JBGOPIKCNIO>k__BackingField;    // 0x0x28
    public long? <MMNMFAJEGEA>k__BackingField;    // 0x0x38
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x48
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x50
    public string <KHMMOLHHAHN>k__BackingField;    // 0x0x58
    public DateTime <MDHNLLENGOP>k__BackingField;    // 0x0x60
    public DateTime <FHPAFILILOD>k__BackingField;    // 0x0x68
    public int <ONGAPAKOMDM>k__BackingField;    // 0x0x70
    public HOCCIFNGFMI <BJPNPKAMKOJ>k__BackingField;    // 0x0x74
    public bool <OOFMLECABFH>k__BackingField;    // 0x0x78
    public bool <OIBFODLKEOB>k__BackingField;    // 0x0x79
    public KIHGBGGFKLI <KPKJDCMJICE>k__BackingField;    // 0x0x7C
    public KIHGBGGFKLI <DBHEIFBFELM>k__BackingField;    // 0x0x80
    public long? <KFHJAGGBMOB>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// DIGBOKJOLPH
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{iKPECCBIIOM}   [Service.API]
...
public class DIGBOKJOLPH
{
    public DCGHDOCPEFO <HKDBEICDPMG>k__BackingField;    // 0x0x10
    public MLJDMOHLHON <AOGLFMNEFND>k__BackingField;    // 0x0x18
    public KPNGKEPBGPE <FNEBBJNIOOK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DKGLDPKEOBH
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{mGMHKIPIHKD}   [Service.API]
public class DKGLDPKEOBH
{
    public uint <PBCAODGFAJM>k__BackingField;    // 0x0x10
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x18
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x20
    public DateTime <EKMHINFADEF>k__BackingField;    // 0x0x28
    public DateTime? <AGCAFOFJOJD>k__BackingField;    // 0x0x30
    public bool <APLKDDHKOPC>k__BackingField;    // 0x0x40
    public List<JAEDIPGIALF> <IOPDGGBBFGI>k__BackingField;    // 0x0x48
    public List<string> <MKEFIDKPIMD>k__BackingField;    // 0x0x50
    public int <KNOMLEHOEBK>k__BackingField;    // 0x0x58
    public int <IPKDFMACPLI>k__BackingField;    // 0x0x5C
    public int <NIGLHEPEAHP>k__BackingField;    // 0x0x60
}
...
public class DLPIOGOGNNE : KNNEMACPKBP
{
    public int <ECCEJNHFDLC>k__BackingField;    // 0x0x30
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x38
    public DateTime <HDLLMIOLCKO>k__BackingField;    // 0x0x40
    public DateTime <JEPNKDLCIJK>k__BackingField;    // 0x0x48
    public IJGMIOJCDAA <FKLAKNLCBPK>k__BackingField;    // 0x0x50
    public GEKFLPMNLAE <GAPLIJPJPMI>k__BackingField;    // 0x0x58
    public List<GNBHOIJFDKO> <MCDAHGECLNF>k__BackingField;    // 0x0x60
    public FBHFDBDJODL <KOOBPPEJKDA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// DOFPHBPEFDC
//   (not directly referenced by a detected call)
public class DOFPHBPEFDC
{
    public long <KHHNMBCAANH>k__BackingField;    // 0x0x10
    public string <JKNBBCFOBON>k__BackingField;    // 0x0x18
    public string <OMHBKFECGPB>k__BackingField;    // 0x0x20
    public OBJIOJNNLHG? <KONAEKOKHGD>k__BackingField;    // 0x0x28
    public string <CBPBCAEFAFI>k__BackingField;    // 0x0x30
    public string <AHLFGBDCBJD>k__BackingField;    // 0x0x38
    public CGNOFPPOIEB <KGJJOKBOHAB>k__BackingField;    // 0x0x40
    public int <EPKJJJKNLEK>k__BackingField;    // 0x0x44
    public int <IBLEAMAHCBF>k__BackingField;    // 0x0x48
    public OHOOCGODAFP? <NCIIBADGHGH>k__BackingField;    // 0x0x4C
    public OOEGBMKAHPJ? <PKCHHCAFOLI>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// DPOHKNFMDFG
//   (not directly referenced by a detected call)
public class DPOHKNFMDFG
{
    public int <KHHNMBCAANH>k__BackingField;    // 0x0x10
    public string <HGOPBPMKMKI>k__BackingField;    // 0x0x18
    public string <KBPBBKLGANO>k__BackingField;    // 0x0x20
    public string <JKNBBCFOBON>k__BackingField;    // 0x0x28
    public string <BCFNNPLGJCK>k__BackingField;    // 0x0x30
    public OBJIOJNNLHG? <KONAEKOKHGD>k__BackingField;    // 0x0x38
    public string <CBPBCAEFAFI>k__BackingField;    // 0x0x40
    public string <AHLFGBDCBJD>k__BackingField;    // 0x0x48
    public bool <PPKMHENFGOC>k__BackingField;    // 0x0x50
    public bool <BDLCNGNFANM>k__BackingField;    // 0x0x51
    public bool <LFKHKMBNOBI>k__BackingField;    // 0x0x52
    public OOEGBMKAHPJ <JGLKFEKLEPI>k__BackingField;    // 0x0x54
    public IJGMIOJCDAA <FKLAKNLCBPK>k__BackingField;    // 0x0x58
    public int <ACLPGEIAKDB>k__BackingField;    // 0x0x5C
    public NCCHEAPIAPM <BFGKEAPMBHN>k__BackingField;    // 0x0x60
    public OHOOCGODAFP <JHKJCCENNHP>k__BackingField;    // 0x0x64
    public int? <EHDNDEDHBOJ>k__BackingField;    // 0x0x68
    public string <HDDBJKCCHBB>k__BackingField;    // 0x0x70
}
...
public class EBLAGKLNDAF : PEOAOCKOHDF
{
    public NFPCFKMPDPM? <AEIHDIGGPEJ>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <HPKHCJHOJHP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ECGGJGBMGOP
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class ECGGJGBMGOP
{
    public int <JGPHKLAAKHL>k__BackingField;    // 0x0x10
    public string <NGGEBPDEGFN>k__BackingField;    // 0x0x18
    public string <KBFIFFENOFF>k__BackingField;    // 0x0x20
    public string <FNKAOIPJOMM>k__BackingField;    // 0x0x28
    public string <FHHEEKJJEPH>k__BackingField;    // 0x0x30
    public string <PKILBCIAELG>k__BackingField;    // 0x0x38
}
...
public class EEGDFEDEPHG
{
    public int <HBBOKPIAJPJ>k__BackingField;    // 0x0x10
    public List<MMBOBMCGLCK> <FHEIMCIMAKD>k__BackingField;    // 0x0x18
}
...
public class EFKOMEOFLGF
{
    public bool <GMGJCOMNHOG>k__BackingField;    // 0x0x10
    public string <AGBHICNKCIN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EIEPEDFFGNC
//   (not directly referenced by a detected call)
public class EIEPEDFFGNC
{
    public int <JOODOFPNKEH>k__BackingField;    // 0x0x10
    public DateTime? <FBPOODAIKEO>k__BackingField;    // 0x0x18
    public DateTime? <CBFENOMIOHC>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// EMLOIJEMMDK
//   (not directly referenced by a detected call)
public class EMLOIJEMMDK
{
    // (no instance fields in the metadata dump)
}
...
public class EMMLHDFBPBE
{
    public long <CFFABJDMBFI>k__BackingField;    // 0x0x10
    public BBDNDMGJIKF <KNACANBBLPA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ENEHAJOEPBO
//   (not directly referenced by a detected call)
public class ENEHAJOEPBO
{
    public int <OLLDIIHKMIC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EPHNMHDJGPE
//   (not directly referenced by a detected call)
public class EPHNMHDJGPE
{
    public bool <OJIPDNJFDDJ>k__BackingField;    // 0x0x10
    public DPOHKNFMDFG <MGIDLDFLGKP>k__BackingField;    // 0x0x18
    public float <BIGKJGOLOEM>k__BackingField;    // 0x0x20
}
...
// FBHFDBDJODL
//   (not directly referenced by a detected call)
public class FBHFDBDJODL
{
    public bool <BMGANOEHPEM>k__BackingField;    // 0x0x10
    public CKBGHJCPMOD <HMOHHGMFDNC>k__BackingField;    // 0x0x14
    public int <FBOGFHBFKGF>k__BackingField;    // 0x0x18
    public DateTime <MBENLJOGAFM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FHICCKDLLNB
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class FHICCKDLLNB
{
    public IJGMIOJCDAA <FKLAKNLCBPK>k__BackingField;    // 0x0x10
    public JCNMBLBOPMC <KLGJOCDIGAC>k__BackingField;    // 0x0x14
    public int <AHACBEKICLP>k__BackingField;    // 0x0x18
    public int <LBKJOHBDJNF>k__BackingField;    // 0x0x1C
    public int <HBLPFNGPKFF>k__BackingField;    // 0x0x20
    public NHCNLCHBHFI <PDIECOEEMIH>k__BackingField;    // 0x0x24
    public bool <EEJDKHJOCIC>k__BackingField;    // 0x0x28
    public float <CCDGEDKMEIM>k__BackingField;    // 0x0x2C
    public int <IOJJGJHFDLJ>k__BackingField;    // 0x0x30
    public bool <LNOJIENHFEL>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// GCBFJOMLHLL
//   (not directly referenced by a detected call)
public class GCBFJOMLHLL
{
    public long <IBJMJMHOBKC>k__BackingField;    // 0x0x10
    public string <KOPJLLBFIIL>k__BackingField;    // 0x0x18
    public int <HANOOOLCPOO>k__BackingField;    // 0x0x20
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x28
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x30
    public string <KHMMOLHHAHN>k__BackingField;    // 0x0x38
    public int <MFOLHGCMJDN>k__BackingField;    // 0x0x40
    public MFEPJJLMBEN <BJPNPKAMKOJ>k__BackingField;    // 0x0x44
    public DateTime <MBENLJOGAFM>k__BackingField;    // 0x0x48
    public DateTime <IJGAFNPGNGG>k__BackingField;    // 0x0x50
    public DateTime? <KJIMODBILKE>k__BackingField;    // 0x0x58
    public long? <CHEGCEBMBJK>k__BackingField;    // 0x0x68
    public int <MHCBACOLKCI>k__BackingField;    // 0x0x78
    public int <AJKHMPNHCPG>k__BackingField;    // 0x0x7C
    public int <OJCNHEEDMKB>k__BackingField;    // 0x0x80
    public MJOKPFOOKFO <FLOEAECEBHK>k__BackingField;    // 0x0x84
    public MJOKPFOOKFO <HPIINEMODJP>k__BackingField;    // 0x0x88
    public bool <JGJDFNPFJAJ>k__BackingField;    // 0x0x8C
    public bool <FGBNOGNNCPH>k__BackingField;    // 0x0x8D
    public bool <HOBBFFDAKPI>k__BackingField;    // 0x0x8E
    public int? <PMOGMNPPBMC>k__BackingField;    // 0x0x90
    public bool <FFEKDNGCJDG>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// GDNOHKGMJDP
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class GDNOHKGMJDP
{
    public int <EMMFELDAEPD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GEKFLPMNLAE
//   (not directly referenced by a detected call)
public class GEKFLPMNLAE
{
    public int <ECCMOALPDKN>k__BackingField;    // 0x0x10
    public IINFCIOJDHD <KNACANBBLPA>k__BackingField;    // 0x0x14
    public List<APOGAPDJIPC> <NJPPCEKAGNJ>k__BackingField;    // 0x0x18
    public List<APOGAPDJIPC> <KOPKBPDGEMI>k__BackingField;    // 0x0x20
    public bool <EIILIDNMENE>k__BackingField;    // 0x0x28
    public DateTime? <PAILAOKCIMN>k__BackingField;    // 0x0x30
    public DateTime? <HKCCIAOFNEF>k__BackingField;    // 0x0x40
    public DateTime? <NFBEENBLJKM>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// GGAJECMPKDP
//   (not directly referenced by a detected call)
public class GGAJECMPKDP
{
    public int <GHPNHFHKBBI>k__BackingField;    // 0x0x10
    public int <GMEJIKIFIOP>k__BackingField;    // 0x0x14
    public int <FEOJEGPMMOD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GJKBCECDGDG
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class GJKBCECDGDG
{
    public List<PMGHMIOCLFL> <MKEFIDKPIMD>k__BackingField;    // 0x0x10
}
...
// base   : GEKFLPMNLAE
//   (not directly referenced by a detected call)
public class GNBHOIJFDKO : GEKFLPMNLAE
{
    public int <IKOJGCLMAFC>k__BackingField;    // 0x0x60
    public List<EPHNMHDJGPE> <BNHDBGIDIHH>k__BackingField;    // 0x0x68
    public List<EPHNMHDJGPE> <OOFCDHINLCP>k__BackingField;    // 0x0x70
    public List<EPHNMHDJGPE> <LLMALMECLLH>k__BackingField;    // 0x0x78
}
...
public class GNLECPCLPLJ
{
    public HTTPResponse IEGNNBIICLA;    // 0x0x10
    public int? OJDBNADJGJH;    // 0x0x18
    public string GMDLLIOHAGG;    // 0x0x20
    public byte[] JKJABAHJJAB;    // 0x0x28
    public string IIPBLLMPODB;    // 0x0x30
}
...
public class HCAEBOKKGHI
{
    public List<int> <OHKAOPMKLLK>k__BackingField;    // 0x0x10
    public string <KOLNGIELJMG>k__BackingField;    // 0x0x18
}
...
// HMEKKHDOEON
//   (not directly referenced by a detected call)
public class HMEKKHDOEON
{
    public Guid <CDPMDAMDOIH>k__BackingField;    // 0x0x10
    public long <KBDJIMPFNKD>k__BackingField;    // 0x0x20
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x28
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x30
    public string <KHMMOLHHAHN>k__BackingField;    // 0x0x38
    public long <PMOGMNPPBMC>k__BackingField;    // 0x0x40
    public Guid? <JHNHNDKFMPN>k__BackingField;    // 0x0x48
    public DateTime <MBENLJOGAFM>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// HMNJMLDNIOM
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class HMNJMLDNIOM
{
    public GFPDAGADAGK <FCGCIJDKONJ>k__BackingField;    // 0x0x10
    public long <CFFABJDMBFI>k__BackingField;    // 0x0x18
    public string <CHAGCNPIMAC>k__BackingField;    // 0x0x20
}
...
public class HNAKFKJFONM
{
    public MLJDMOHLHON <AOGLFMNEFND>k__BackingField;    // 0x0x10
}
...
public class IHODINMJPLJ
{
    public int? <EKGBLGOPACC>k__BackingField;    // 0x0x10
    public string <DECCDBHELLB>k__BackingField;    // 0x0x18
    public string <GFNGJFOBBJC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IHPMFKHDJNM
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class IHPMFKHDJNM
{
    public List<AFBKCNEEALO> <IJNJALIMFEK>k__BackingField;    // 0x0x10
    public MLJDMOHLHON <AOGLFMNEFND>k__BackingField;    // 0x0x18
}
...
// ININAJBLBOD
//   (not directly referenced by a detected call)
public class ININAJBLBOD
{
    public int <OMMCMGMGECD>k__BackingField;    // 0x0x10
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x18
    public string <PIPHPEGDLLE>k__BackingField;    // 0x0x20
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x28
    public string <KBPBBKLGANO>k__BackingField;    // 0x0x30
    public bool <CEBJOMNFKDI>k__BackingField;    // 0x0x38
    public int <JGPHKLAAKHL>k__BackingField;    // 0x0x3C
    public EMLOIJEMMDK <HPIIIGNFCEM>k__BackingField;    // 0x0x40
    public NEMILNLGJMD LBPMNLPAHPO;    // 0x0x48
    public NEMILNLGJMD IBKGJIDCAGE;    // 0x0x50
    public NEMILNLGJMD ECMMBEDBFHE;    // 0x0x58
    public FMFAEKCMGBB NFKEMNODHAB;    // 0x0x60
}

// --------------------------------------------------------------------------
// JAEDIPGIALF
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{mGMHKIPIHKD}   [Service.API]
public class JAEDIPGIALF
{
    public string <PBCAODGFAJM>k__BackingField;    // 0x0x10
    public string <EPDHNPBEBGA>k__BackingField;    // 0x0x18
    public string <DLAIMJBHBNH>k__BackingField;    // 0x0x20
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x28
    public string <DECCDBHELLB>k__BackingField;    // 0x0x30
    public GMIJGGCNGEA <JFIKNCAGJMK>k__BackingField;    // 0x0x38
    public List<string> <OOHBGNGEFBD>k__BackingField;    // 0x0x40
    public List<string> <MKEFIDKPIMD>k__BackingField;    // 0x0x48
    public string <NGFNNPHJGJD>k__BackingField;    // 0x0x50
    public List<OOPAFHEFIFP> <CLGDGGDJHGG>k__BackingField;    // 0x0x58
}
...
//   RESPONSE GET    api/avatar/v2/{mGHNGLOFIEP}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{mGHNGLOFIEP}   [Service.API]
public class JEKNJKHGBBL
{
    public string <KBFIFFENOFF>k__BackingField;    // 0x0x10
    public string <FNKAOIPJOMM>k__BackingField;    // 0x0x18
    public string <FHHEEKJJEPH>k__BackingField;    // 0x0x20
    public string <PKILBCIAELG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// JEPMKGEMEDD
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class JEPMKGEMEDD
{
    public int <NIIBFADFCDG>k__BackingField;    // 0x0x10
    public Guid <NHNOEKDKLOK>k__BackingField;    // 0x0x14
    public long <GDCIKJBNIFI>k__BackingField;    // 0x0x28
    public long <OGNHADLDEBI>k__BackingField;    // 0x0x30
    public DateTime <BJAKKFCMJND>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// JKOJDFOJFJH
//   (not directly referenced by a detected call)
public class JKOJDFOJFJH
{
    public float <FDPKBNFLBPM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JNPNEEBLODB
//   RESPONSE GET    api/groups/v1/memberships/{bDOBLJEBCGA}   [Service.API]
public class JNPNEEBLODB
{
    public long <BIGCFOJJOOH>k__BackingField;    // 0x0x10
    public int <OODHPGPKEEH>k__BackingField;    // 0x0x18
    public AKODPJPMJFC <IDNFEKODOIH>k__BackingField;    // 0x0x1C
}
...
public class KBNIGKNLGHP : PEOAOCKOHDF
{
    public AHJJMDCLFBJ? <AEIHDIGGPEJ>k__BackingField;    // 0x0x18
    public OPEADODPFFB <KHJFMOIIKJK>k__BackingField;    // 0x0x20
}
...
public class KIIFOABLPAP : KNNEMACPKBP
{
    public List<PABICCNPCAB> OCNPDOBKKHK;    // 0x0x30
    public int <FEFABJECBGB>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// KKNKDOHBNBN
//   (not directly referenced by a detected call)
public class KKNKDOHBNBN
{
    public Guid <BCLAFJAJJNM>k__BackingField;    // 0x0x10
    public Guid <IKEFMNJOECP>k__BackingField;    // 0x0x20
    public DateTime <HDLLMIOLCKO>k__BackingField;    // 0x0x30
    public List<DPOHKNFMDFG> <DELHBFGJCIP>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// KMHNCHENMOE
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{oCGGBNIFPPJ}   [Service.API]
public class KMHNCHENMOE
{
    public Guid <PKBBJDPGOLO>k__BackingField;    // 0x0x10
    public int <NIIBFADFCDG>k__BackingField;    // 0x0x20
    public int <ECCMOALPDKN>k__BackingField;    // 0x0x24
    public DateTime <IJGAFNPGNGG>k__BackingField;    // 0x0x28
}
...
public class KNHMGPDFJIL
{
    public long <BIGCFOJJOOH>k__BackingField;    // 0x0x10
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x18
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x20
    public DateTime <IJGAFNPGNGG>k__BackingField;    // 0x0x28
    public string <KHMMOLHHAHN>k__BackingField;    // 0x0x30
    public LLCOFCFKJOE <IJCHANMFNAM>k__BackingField;    // 0x0x38
    public int <PIPBBFOPFJJ>k__BackingField;    // 0x0x3C
    public int <LAAHHGBCOPM>k__BackingField;    // 0x0x40
    public List<JNPNEEBLODB> <EMKPHOBACNF>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// KNPEIEDDIOA
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class KNPEIEDDIOA
{
    public GFPDAGADAGK <FCGCIJDKONJ>k__BackingField;    // 0x0x10
    public int <EMMFELDAEPD>k__BackingField;    // 0x0x14
    public long <ANCLAMAJPPB>k__BackingField;    // 0x0x18
    public bool <JJLAPDIGAKJ>k__BackingField;    // 0x0x20
    public string <AGBHICNKCIN>k__BackingField;    // 0x0x28
    public int? <PMCIJPIOKPD>k__BackingField;    // 0x0x30
    public bool <GABPAAGALJG>k__BackingField;    // 0x0x38
    public bool <PKPDMMHNJMD>k__BackingField;    // 0x0x39
    public string <MLFAGLKMGCG>k__BackingField;    // 0x0x40
    public float <BMKKHEBHNFD>k__BackingField;    // 0x0x48
}
...
public class KPKOIDOHAGO
{
    public Guid <CFMLFOOLONE>k__BackingField;    // 0x0x10
    public Guid <NHNOEKDKLOK>k__BackingField;    // 0x0x20
    public int <LHGLPHAJHPG>k__BackingField;    // 0x0x30
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x38
    public long <PMAONFIBLMI>k__BackingField;    // 0x0x40
    public long <PMOGMNPPBMC>k__BackingField;    // 0x0x48
    public DateTime <MBENLJOGAFM>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// KPNGKEPBGPE
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class KPNGKEPBGPE
{
    public AOJNNHNKPGG <AOGLFMNEFND>k__BackingField;    // 0x0x10
    public List<string> <MKEFIDKPIMD>k__BackingField;    // 0x0x18
}
...
public class LGGCGCFOBIP
{
    public string <EPDHNPBEBGA>k__BackingField;    // 0x0x10
    public string <LMNOJDJODLE>k__BackingField;    // 0x0x18
}
...
// LMGINDHCMHB
//   (not directly referenced by a detected call)
public class LMGINDHCMHB
{
    public long <IBJMJMHOBKC>k__BackingField;    // 0x0x10
    public string <KOPJLLBFIIL>k__BackingField;    // 0x0x18
    public int <ELBLIDAGPLG>k__BackingField;    // 0x0x20
    public int <OFBHMJGKEIM>k__BackingField;    // 0x0x24
    public int <ALNDKIHCILG>k__BackingField;    // 0x0x28
    public int <ICDDKADKPMH>k__BackingField;    // 0x0x2C
    public int <GDNPDLFPAAH>k__BackingField;    // 0x0x30
    public string <NKHOAABCPGA>k__BackingField;    // 0x0x38
    public string <JHOAIOINHLF>k__BackingField;    // 0x0x40
}
...
public class LMLAEDGLFGE
{
    public string <GGIPNADFLAI>k__BackingField;    // 0x0x10
    public string <DAHLNADFEIP>k__BackingField;    // 0x0x18
    public bool <CBICDLEIJIB>k__BackingField;    // 0x0x20
    public string <JLMJEPCLBMG>k__BackingField;    // 0x0x28
}
...
public class LNKECAKPDKN
{
    public Dictionary<int, int> <ANHOCJPIJBH>k__BackingField;    // 0x0x10
    public List<KDPOHLJCELF> <NHOJJDNMMLK>k__BackingField;    // 0x0x18
    public MAMDMKLAAGB[][] <JHBBHDBKPFB>k__BackingField;    // 0x0x20
    public PIACBDOBDDI <FCFGCLGLKFG>k__BackingField;    // 0x0x28
    public MEJJGGOIJND <LJBJJJIBEFL>k__BackingField;    // 0x0x30
    public AOEIDHHBNEB <MJNBBKJHLGC>k__BackingField;    // 0x0x38
    public ENEHAJOEPBO <JHLJPFEAIJG>k__BackingField;    // 0x0x40
    public JKOJDFOJFJH <LHELANPKBGE>k__BackingField;    // 0x0x48
    public string <HDAJHMIHMEK>k__BackingField;    // 0x0x50
}
...
public class MAEHGHJKGBG
{
    public int <KOKPOPGLPKL>k__BackingField;    // 0x0x10
    public NCDCKJIIIPI <KNACANBBLPA>k__BackingField;    // 0x0x14
    public IDCKPGJODGI <GHHADGFFDOC>k__BackingField;    // 0x0x18
    public IDCKPGJODGI <OMAMBFBCDMH>k__BackingField;    // 0x0x1C
    public IDCKPGJODGI <IEPFPNPNFMG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MAMDMKLAAGB
//   (not directly referenced by a detected call)
public class MAMDMKLAAGB
{
    public NHJEHPHIOBK BFCPHNCMOFP;    // 0x0x10
    public int PFOLDOHMPLL;    // 0x0x14
}

// --------------------------------------------------------------------------
// MDOIALCLDII
//   (not directly referenced by a detected call)
public class MDOIALCLDII
{
    public long <DIGMDMHKCEG>k__BackingField;    // 0x0x10
    public Guid <KOPJLLBFIIL>k__BackingField;    // 0x0x18
    public long <KBDJIMPFNKD>k__BackingField;    // 0x0x28
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x30
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x38
    public int <PMOGMNPPBMC>k__BackingField;    // 0x0x40
    public Guid? <JHNHNDKFMPN>k__BackingField;    // 0x0x44
    public DateTime <IJGAFNPGNGG>k__BackingField;    // 0x0x58
    public string <KHMMOLHHAHN>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// MEJJGGOIJND
//   (not directly referenced by a detected call)
public class MEJJGGOIJND
{
    public float <FDMOFECLINP>k__BackingField;    // 0x0x10
    public float <EPEPDFJMMKL>k__BackingField;    // 0x0x14
    public float <FGECFNKKILI>k__BackingField;    // 0x0x18
    public float <IEFHLLBDIMF>k__BackingField;    // 0x0x1C
    public float <IECHCKAKFPJ>k__BackingField;    // 0x0x20
    public float <KHDKDDHJEBD>k__BackingField;    // 0x0x24
    public float <KCKCFNFDJGM>k__BackingField;    // 0x0x28
    public float <FEMCEGHGDHJ>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// MGKJJJIIHLL
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.API]
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{pAAMPHJOCCJ}   [Service.API]
public class MGKJJJIIHLL
{
    public long <KBDJIMPFNKD>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <AOABNLCDCOL>k__BackingField;    // 0x0x18
    public LHNJEHKAMOM <IDMKBPAJPIK>k__BackingField;    // 0x0x20
}
...
public class MJBCCFPPOAB
{
    public List<string> <MCJAKLAKBBI>k__BackingField;    // 0x0x10
    public List<string> <AFNGHGIEEIO>k__BackingField;    // 0x0x18
    public List<string> <IMBDDAKEDNF>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{cLJIDCEPDDA}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{cLJIDCEPDDA}   [Service.API]
...
public class MJCGMNCDFDA
{
    public EDKEFKBEBOJ <JFIKNCAGJMK>k__BackingField;    // 0x0x10
    public HMEKKHDOEON <INCJNFLDLMN>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// MMBGIIMFIOD
//   RESPONSE GET    api/inventions/v1/personaldetails/{iPLHECGDGOE}   [Service.API]
public class MMBGIIMFIOD
{
    public bool <ENHKFNFGHIN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// MMBOBMCGLCK
//   (not directly referenced by a detected call)
public class MMBOBMCGLCK
{
    public DateTime? <IINNOMJBKGK>k__BackingField;    // 0x0x10
    public DateTime? <KMEKAKPKHMJ>k__BackingField;    // 0x0x20
    public CHFCGOCFJOE <JFIKNCAGJMK>k__BackingField;    // 0x0x30
    public GGAJECMPKDP <JFCJMMCMFIC>k__BackingField;    // 0x0x38
    public bool <EPAIPMFBGLB>k__BackingField;    // 0x0x40
}
...
public class MMCDGAHKBCE
{
    public int <AFEAEPHAOKM>k__BackingField;    // 0x0x10
    public bool <NBDFCPFDLLP>k__BackingField;    // 0x0x14
    public DateTime <KPCCMFMKMNH>k__BackingField;    // 0x0x18
    public bool <FIOBGJCHNNK>k__BackingField;    // 0x0x20
}
...
//   RESPONSE GET    api/playerevents/v1/all/{mGHNGLOFIEP}   [Service.API]
public class MNEFKLEGJEG
{
    public List<DCGHDOCPEFO> <FIKJFABJIHK>k__BackingField;    // 0x0x10
    public List<CBDMDKDKOGI> <NDLIHJGMNFL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MPMFOIALNJI
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class MPMFOIALNJI
{
    public int <KMJLBODFOBA>k__BackingField;    // 0x0x10
    public string <FLFHFBPDFNM>k__BackingField;    // 0x0x18
    public List<ININAJBLBOD> <IKAKLBAOECF>k__BackingField;    // 0x0x20
    public DOFPHBPEFDC <INJCBNMHFJG>k__BackingField;    // 0x0x28
    public string <PMDECKGFKBD>k__BackingField;    // 0x0x30
    public DateTime <HDLLMIOLCKO>k__BackingField;    // 0x0x38
    public DateTime <JEPNKDLCIJK>k__BackingField;    // 0x0x40
    public DateTime <BEFMHMNEDFF>k__BackingField;    // 0x0x48
    public bool? <MOLAOHIDMCK>k__BackingField;    // 0x0x50
}
...
public class NHBPPDIPPEC
{
    public Guid <NHNOEKDKLOK>k__BackingField;    // 0x0x10
    public long? <KBDJIMPFNKD>k__BackingField;    // 0x0x20
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x30
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x38
    public IJGMIOJCDAA <FKLAKNLCBPK>k__BackingField;    // 0x0x40
    public long <MJDNMINPICP>k__BackingField;    // 0x0x48
    public string <KHMMOLHHAHN>k__BackingField;    // 0x0x50
    public DateTime <IJGAFNPGNGG>k__BackingField;    // 0x0x58
    public DateTime <MBENLJOGAFM>k__BackingField;    // 0x0x60
}
...
public class NPLLKADJMDC
{
    public bool NJENFKHJHHE;    // 0x0x10
    public bool LNKDNDCIFCL;    // 0x0x11
}

// --------------------------------------------------------------------------
// OFIECOEPNNH
//   (not directly referenced by a detected call)
public class OFIECOEPNNH
{
    public long <IHGCKJNHFGH>k__BackingField;    // 0x0x10
    public long <CFFABJDMBFI>k__BackingField;    // 0x0x18
    public int <OODHPGPKEEH>k__BackingField;    // 0x0x20
    public DateTime <IJGAFNPGNGG>k__BackingField;    // 0x0x28
    public BBDNDMGJIKF <KNACANBBLPA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// OHDBLDCIHDE
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class OHDBLDCIHDE
{
    public int <CAEKOOCMDMG>k__BackingField;    // 0x0x10
    public int <AFEAEPHAOKM>k__BackingField;    // 0x0x14
    public float <IIDLDHLOFEA>k__BackingField;    // 0x0x18
    public float <GJNJEMPEKBO>k__BackingField;    // 0x0x1C
    public bool <NBDFCPFDLLP>k__BackingField;    // 0x0x20
    public bool <ABNCPONCALJ>k__BackingField;    // 0x0x21
    public bool <CCKLLBEMCEF>k__BackingField;    // 0x0x22
}
...
// OJMCLHJHNFF
//   (not directly referenced by a detected call)
public class OJMCLHJHNFF
{
    public int <APDHFKDAFNK>k__BackingField;    // 0x0x10
    public DateTime <IJGAFNPGNGG>k__BackingField;    // 0x0x18
    public DateTime? <FEJOIDFPMAL>k__BackingField;    // 0x0x20
}
...
public class ONNFOLKJOPB
{
    public long <KBDJIMPFNKD>k__BackingField;    // 0x0x10
    public long? <JBGOPIKCNIO>k__BackingField;    // 0x0x18
    public long? <MMNMFAJEGEA>k__BackingField;    // 0x0x28
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x38
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x40
    public List<string> <MKEFIDKPIMD>k__BackingField;    // 0x0x48
    public string <KHMMOLHHAHN>k__BackingField;    // 0x0x50
    public DateTime <MDHNLLENGOP>k__BackingField;    // 0x0x58
    public DateTime <FHPAFILILOD>k__BackingField;    // 0x0x60
    public HOCCIFNGFMI <BJPNPKAMKOJ>k__BackingField;    // 0x0x68
    public bool <OOFMLECABFH>k__BackingField;    // 0x0x6C
    public bool <OIBFODLKEOB>k__BackingField;    // 0x0x6D
    public KIHGBGGFKLI <KPKJDCMJICE>k__BackingField;    // 0x0x70
    public KIHGBGGFKLI <DBHEIFBFELM>k__BackingField;    // 0x0x74
}
...
// OOPAFHEFIFP
//   (not directly referenced by a detected call)
public class OOPAFHEFIFP
{
    public DateTime <IJGAFNPGNGG>k__BackingField;    // 0x0x10
    public string <DDECBJHNCNP>k__BackingField;    // 0x0x18
}
...
public class OPEADODPFFB
{
    public int <NIIBFADFCDG>k__BackingField;    // 0x0x10
    public Guid <NHNOEKDKLOK>k__BackingField;    // 0x0x14
    public long <GDCIKJBNIFI>k__BackingField;    // 0x0x28
    public DateTime <MBENLJOGAFM>k__BackingField;    // 0x0x30
}
...
// base   : GEKFLPMNLAE
//   (not directly referenced by a detected call)
public class PABICCNPCAB : GEKFLPMNLAE
{
    public DPOHKNFMDFG <MGIDLDFLGKP>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// PFGEANHDOFF
//   (not directly referenced by a detected call)
public class PFGEANHDOFF
{
    public Guid <CDPMDAMDOIH>k__BackingField;    // 0x0x10
    public int <NIIBFADFCDG>k__BackingField;    // 0x0x20
    public int <PNOAHNPBEKI>k__BackingField;    // 0x0x24
    public Guid <LEAFAHDAKFE>k__BackingField;    // 0x0x28
    public DateTime <MBENLJOGAFM>k__BackingField;    // 0x0x38
    public HMEKKHDOEON <INCJNFLDLMN>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PIACBDOBDDI
//   (not directly referenced by a detected call)
public class PIACBDOBDDI
{
    public int <IBNPCBDNAHM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PMGHMIOCLFL
//   (not directly referenced by a detected call)
public class PMGHMIOCLFL
{
    public string <BPIJMAMJDDI>k__BackingField;    // 0x0x10
    public LDGJIADNBJA <KNACANBBLPA>k__BackingField;    // 0x0x18
}
...
{
    public IFKACGLNHHM <AOGLFMNEFND>k__BackingField;    // 0x0x10
    public string <GIEKNNHFPGJ>k__BackingField;    // 0x0x18
    public string <PIIOOFCOOGF>k__BackingField;    // 0x0x20
    public string <BIGKGDAPGGI>k__BackingField;    // 0x0x28
}
...
public class GetRankRequestDTO
{
    ...
    public NFBGIDHIAPD FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public OHOOCGODAFP <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public OPPHEOHCKPE creatorAccountRole;    // 0x0x58
}
...
{
    public MINGAOPHAMN <ADJOHHNKGOB>k__BackingField;    // 0x0x10
    public NIIMONMGIMK <FOEMJAKCEGM>k__BackingField;    // 0x0x14
    public string <KPLCFIOMFJP>k__BackingField;    // 0x0x18
    public string <ODEICHAFEPK>k__BackingField;    // 0x0x20
    public bool <DCGDFOBMJHH>k__BackingField;    // 0x0x28
}
...
{
    public List<MINGAOPHAMN> <EEGFFNNOKKE>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public HNHMPBFKJDP ReportCategory;    // 0x0x20
}
...
{
    public JDFKLOEANIP? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public JDFKLOEANIP PCGMKLNIIPG;  // wrapper
...
{
    public DEJOHGPOLEE DOCOOPCHKAI;  // wrapper
...
{
    public KEKGICHADKK HHDFIJECABM;  // wrapper
    public int? BAFNIDAIPIO;  // wrapper
...
{
    public PLBHBEIOMCL UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public OHOOCGODAFP IJBCJIEGGIM;  // wrapper
    public OHOOCGODAFP? MBEDAFAAHEH;  // wrapper
...
{
    public ININAJBLBOD NCMMGEJGLMH;  // wrapper
...
{
    public GFPDAGADAGK BKGDDCMJALJ;  // wrapper
...
{
    public IReadOnlyList<JIAKAGEALAF> Update;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public NMIIOJMNNMB LINKMLHFLGC;  // wrapper
    public OHOOCGODAFP? GPKIGKLIEAJ;  // wrapper
...
{
    public HMCGLKNFPHA GAOAAAPDNEI;  // wrapper
...
{
    public StatusResponse> BKKOCCDDHJN;  // wrapper
...
{
    public List<long> GEINDFEOBNI;  // wrapper
    public NAGMMPGMPLA BKKOCCDDHJN;  // wrapper
    public HDCADLHBKBM MDNEPMJMAFD;  // wrapper
    public long? PAAMPHJOCCJ;  // wrapper
...
{
    public String> BKKOCCDDHJN;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{iKPECCBIIOM}  [API POST]
public class PlayereventsV2DeleteIKPECCBIIOMRequest
{
    public DCGHDOCPEFO IKPECCBIIOM;  // wrapper
}
...
{
    public DCGHDOCPEFO IKPECCBIIOM;  // wrapper
    public HOCCIFNGFMI ADBMIBJKFKA;  // wrapper
...
{
    public DCGHDOCPEFO IKPECCBIIOM;  // wrapper
    public long? FLKMNGDBCBG;  // wrapper
    public object clubId;  // candidate
}
...
{
    public DCGHDOCPEFO IKPECCBIIOM;  // wrapper
    public KIHGBGGFKLI LPBENECCOMK;  // wrapper
    public KIHGBGGFKLI OKOEMGGBCBG;  // wrapper
...
{
    public DCGHDOCPEFO IKPECCBIIOM;  // wrapper
    public long? EADJKMHAHLO;  // wrapper
    public object roomId;  // candidate
...
{
    public DCGHDOCPEFO IKPECCBIIOM;  // wrapper
    public List<string> BHEAHAHAEDO;  // wrapper
...
{
    public DCGHDOCPEFO IKPECCBIIOM;  // wrapper
    public DateTime OFCMGBFKFJI;  // wrapper
    public DateTime KFAECKGHBKE;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> INFLOKAIDAB;  // wrapper
...
{
    public Guid? FHOJPBDDOPA;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats MHFMNOCLHML;  // wrapper
}
...
{
    public Guid HDAGPDMBEMA;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<COIEBJPNOBG> EFOMNGBNEEO;  // wrapper
...
{
    public GMIJGGCNGEA AJHFMMICFGE;  // wrapper
}
