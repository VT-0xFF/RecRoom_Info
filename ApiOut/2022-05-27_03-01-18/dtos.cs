...
// DTO classes: 242 (plus referenced enums)

// --------------------------------------------------------------------------
// ABKMFHFHNAI
//   REQUEST  POST   api/settings/v2/set   [Service.API]
public class ABKMFHFHNAI
{
    public string <JIBIEPODPKH>k__BackingField;    // 0x0x10
    public string <LMDEBFPOPEJ>k__BackingField;    // 0x0x18
}
...
public class APFOCNAPFPK
{
    public bool HKJHGMAIDMB;    // 0x0x10
    public bool MHCPHLBHCAE;    // 0x0x11
}
