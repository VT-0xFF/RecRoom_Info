...
// --------------------------------------------------------------------------
// AABEPGIBNMJ
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{gJCCDPKJFBC}   [Service.API]
public class AABEPGIBNMJ
{
    public Guid <LMJOGMEEKGF>k__BackingField;    // 0x0x10
    public int <OOLOMPIIIIB>k__BackingField;    // 0x0x20
    public int <BMANKEKMFMC>k__BackingField;    // 0x0x24
    public DateTime <NMGNNGPFHCO>k__BackingField;    // 0x0x28
}
...
public class ACBHEELINDB
{
    public KHBDPHJFNOJ <HAPILDHPFKA>k__BackingField;    // 0x0x10
    public HALBPADDEFK <AMONADGABIK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AGOJIEINEDJ
//   (not directly referenced by a detected call)
public class AGOJIEINEDJ
{
    public long <EOEGDALCGCN>k__BackingField;    // 0x0x10
    public int <OEHJIJDFNKG>k__BackingField;    // 0x0x18
    public long <ANCGGDJHFLM>k__BackingField;    // 0x0x20
    public long? <DBBLKMNOGDM>k__BackingField;    // 0x0x28
    public long? <MKHBICPLNCP>k__BackingField;    // 0x0x38
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x48
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x50
    public string <AGGCILAGFPI>k__BackingField;    // 0x0x58
    public DateTime <MHKAPPCDLPF>k__BackingField;    // 0x0x60
    public DateTime <ABOKEFKGKLO>k__BackingField;    // 0x0x68
    public int <OFHPHNMKOKD>k__BackingField;    // 0x0x70
    public IFNLNGIDJHD <JIPLMLAJECL>k__BackingField;    // 0x0x74
    public bool <BALFBBLFJLG>k__BackingField;    // 0x0x78
    public bool <DJPJAMJIFCI>k__BackingField;    // 0x0x79
    public MNNJKCLGADP <IIIJACAJPGG>k__BackingField;    // 0x0x7C
    public MNNJKCLGADP <LBAAMAKNPNF>k__BackingField;    // 0x0x80
    public long? <CMIGPHAMNIL>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// AHPODBGBIGE
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class AHPODBGBIGE
{
    public int <OOLOMPIIIIB>k__BackingField;    // 0x0x10
    public Guid <EAJBADHLPMO>k__BackingField;    // 0x0x14
    public long <OMOCLLPACJN>k__BackingField;    // 0x0x28
    public long <JLINFIMLGBB>k__BackingField;    // 0x0x30
    public DateTime <NLNHHLDGODE>k__BackingField;    // 0x0x38
}
...
public class AJPBMLINPLJ
{
    public int <CPJEFOFCHBD>k__BackingField;    // 0x0x10
    public FPDIDFHOMLF <MLEENBKCLAK>k__BackingField;    // 0x0x14
    public NOHJJHDMDCK <HEMDAGNBHEJ>k__BackingField;    // 0x0x18
    public NOHJJHDMDCK <GNPEKBGCAEB>k__BackingField;    // 0x0x1C
    public NOHJJHDMDCK <JKBHFBIFMDN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ANAKNPFILFE
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{aKGOJHKMAIK}   [Service.API]
public class ANAKNPFILFE
{
    public string <EPAAOFABOOL>k__BackingField;    // 0x0x10
    public string <NJEAPNIFGPC>k__BackingField;    // 0x0x18
    public string <HILOEFBONEH>k__BackingField;    // 0x0x20
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x28
    public string <MOFGDBNNINI>k__BackingField;    // 0x0x30
    public FODOFOGAAKP <HAPILDHPFKA>k__BackingField;    // 0x0x38
    public List<string> <HILFCGDMPFD>k__BackingField;    // 0x0x40
    public List<string> <BFCAEOIBMKK>k__BackingField;    // 0x0x48
    public string <DMJPCLIELNP>k__BackingField;    // 0x0x50
    public List<FLJNFIMOFGO> <GEBOIGDKEAA>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// AOCLIBKMNPJ
//   (not directly referenced by a detected call)
public class AOCLIBKMNPJ
{
    public int <GDBEPFBBJPC>k__BackingField;    // 0x0x10
    public DateTime? <BGKIHHMMDBP>k__BackingField;    // 0x0x18
    public DateTime? <NIKNHHEADDP>k__BackingField;    // 0x0x28
}
...
public class BCDEBKDAKJE
{
    public PJMDKBLLAEC <JHMFGKCMIPE>k__BackingField;    // 0x0x10
    public LMOFBBFANEO <DJEPADFBIEO>k__BackingField;    // 0x0x14
    public int <NEHJBDDBPHK>k__BackingField;    // 0x0x18
    public int <AMDGMGGLMIG>k__BackingField;    // 0x0x1C
    public int <MIKKMNMMJGL>k__BackingField;    // 0x0x20
    public JKGPENNNAOO <NHBMABPJDFN>k__BackingField;    // 0x0x24
    public bool <FBLLOPDJCOM>k__BackingField;    // 0x0x28
    public float <DELAOCCFKJN>k__BackingField;    // 0x0x2C
    public int <AOAPICKBOKK>k__BackingField;    // 0x0x30
    public bool <HAOFELJFPAL>k__BackingField;    // 0x0x34
}
...
public class BJAAKGAIJGP : HPNMOMADMCA
{
    public int <BBCEFFBKFKG>k__BackingField;    // 0x0x30
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x38
    public DateTime <AJDDCEHPKKF>k__BackingField;    // 0x0x40
    public DateTime <MGNBKIBCNLG>k__BackingField;    // 0x0x48
    public PJMDKBLLAEC <JHMFGKCMIPE>k__BackingField;    // 0x0x50
    public BJFLBKAMFFD <JKMOMMEAPLF>k__BackingField;    // 0x0x58
    public List<ODHGOPICBKD> <NFEDNDCNIPI>k__BackingField;    // 0x0x60
    public HBDELPFPDLD <BHELILKGALM>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// BJFLBKAMFFD
//   (not directly referenced by a detected call)
public class BJFLBKAMFFD
{
    public int <BMANKEKMFMC>k__BackingField;    // 0x0x10
    public CLHEOKIKGCF <MLEENBKCLAK>k__BackingField;    // 0x0x14
    public List<FFKCHDPOHFB> <LCAAFCGIKMH>k__BackingField;    // 0x0x18
    public List<FFKCHDPOHFB> <CIJNOHJINJE>k__BackingField;    // 0x0x20
    public bool <MKGLHCNLGKJ>k__BackingField;    // 0x0x28
    public DateTime? <KMDJGNLNKAA>k__BackingField;    // 0x0x30
    public DateTime? <BCGLPAKDFNJ>k__BackingField;    // 0x0x40
    public DateTime? <PBOJAFBOPJN>k__BackingField;    // 0x0x50
}
...
public class BJJBHAJDNNP
{
    public List<string> <EMNOBMKHDDI>k__BackingField;    // 0x0x10
    public List<string> <CAEHJOMJPBK>k__BackingField;    // 0x0x18
    public List<string> <MIDNLMOEKIA>k__BackingField;    // 0x0x20
}
...
public class BKAHLBJLHOP
{
    public bool <HKKGMMJOLIK>k__BackingField;    // 0x0x10
    public string <NONCOFJADOD>k__BackingField;    // 0x0x18
}
...
public class BMFIEBOPCOL
{
    public bool <HKKGMMJOLIK>k__BackingField;    // 0x0x10
    public string <AGMECMKABKG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BOBJFCMIKDA
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/description   [Service.API]
public class BOBJFCMIKDA
{
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BOPCLFHCAFN
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class BOPCLFHCAFN
{
    public int? <HKFJODEPGHM>k__BackingField;    // 0x0x10
    public string <MOFGDBNNINI>k__BackingField;    // 0x0x18
    public string <PLBJOKOGBBL>k__BackingField;    // 0x0x20
}
...
public class BPHJCOLOAML
{
    public List<DFBGCBPCGDA> <EOPIMDCJFHN>k__BackingField;    // 0x0x10
    public string <LPPOKDMMPML>k__BackingField;    // 0x0x18
}
...
// CCGLKGCLDBJ
//   (not directly referenced by a detected call)
public class CCGLKGCLDBJ
{
    public long <BJACFCPNLLK>k__BackingField;    // 0x0x10
    public string <KLGNJANPBPG>k__BackingField;    // 0x0x18
    public int <AFDJBPGEPCF>k__BackingField;    // 0x0x20
    public int <MILGPDCAGFD>k__BackingField;    // 0x0x24
    public int <DFIOCELLKKI>k__BackingField;    // 0x0x28
    public int <HNBHBCCHGMA>k__BackingField;    // 0x0x2C
    public int <GIKNNBBCAOL>k__BackingField;    // 0x0x30
    public string <JHHGADACJJJ>k__BackingField;    // 0x0x38
    public string <IJJEBPCNMOH>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// CCLDBLIKFMA
//   RESPONSE GET    api/groups/v1/memberships/{pCBNLNEHADF}   [Service.API]
public class CCLDBLIKFMA
{
    public long <BMPEEPEINJO>k__BackingField;    // 0x0x10
    public int <HKFLNEOENLK>k__BackingField;    // 0x0x18
    public NPOKJLJDLKO <KPFOFDFEHKC>k__BackingField;    // 0x0x1C
}
...
// base   : BJFLBKAMFFD
//   (not directly referenced by a detected call)
public class CDOKLOGOENH : BJFLBKAMFFD
{
    public MFCKIDIOKOD <CLGCKMGFFGJ>k__BackingField;    // 0x0x60
}
...
public class CJDBEHJKAAF
{
    public LOLKLKMHCIC <HAPILDHPFKA>k__BackingField;    // 0x0x10
    public EHJNGKAEPCC <IEAEHNJNFOM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CJHLLHLFDIO
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{aKGOJHKMAIK}   [Service.API]
public class CJHLLHLFDIO
{
    public uint <EPAAOFABOOL>k__BackingField;    // 0x0x10
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x18
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x20
    public DateTime <KMLFGAEEADF>k__BackingField;    // 0x0x28
    public DateTime? <PGPPNCIPABK>k__BackingField;    // 0x0x30
    public bool <NAFOFCIJADN>k__BackingField;    // 0x0x40
    public List<ANAKNPFILFE> <LCDELEMBPII>k__BackingField;    // 0x0x48
    public List<string> <BFCAEOIBMKK>k__BackingField;    // 0x0x50
    public int <PKOHMGBCNAJ>k__BackingField;    // 0x0x58
    public int <HDMHOBAAFKO>k__BackingField;    // 0x0x5C
    public int <ELFHJPNEHPF>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// CKJLAKKPMNP
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class CKJLAKKPMNP
{
    public GFOGDJKPHHE <BOJHPEOFDMJ>k__BackingField;    // 0x0x10
    public int <BMABCDBHKCA>k__BackingField;    // 0x0x14
    public long <BBLAKIKHHIL>k__BackingField;    // 0x0x18
    public bool <JPMINEOIKAB>k__BackingField;    // 0x0x20
    public string <NONCOFJADOD>k__BackingField;    // 0x0x28
    public int? <GKGLCPOPJEB>k__BackingField;    // 0x0x30
    public bool <MOFHMJACJGO>k__BackingField;    // 0x0x38
    public bool <LIDIICKKJFI>k__BackingField;    // 0x0x39
    public string <PCNDPFDGHHD>k__BackingField;    // 0x0x40
    public float <CELEMNONPJE>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// CLFEMOJABFM
//   (not directly referenced by a detected call)
public class CLFEMOJABFM
{
    public DateTime? <GJFEEEOKGKK>k__BackingField;    // 0x0x10
    public DateTime? <CHPEPABENIL>k__BackingField;    // 0x0x20
    public DKCKFAMJKJL <HAPILDHPFKA>k__BackingField;    // 0x0x30
    public KEIOKFHDOLE <EDCAOAGEOON>k__BackingField;    // 0x0x38
    public bool <KKKEBFNIKMC>k__BackingField;    // 0x0x40
}
...
public class CPMFINMFIPD : GMCPOIGDIBL
{
    public IBPBENFJGCK? <JCLOFLHKMGC>k__BackingField;    // 0x0x18
    public LEPJOCMIEGN <BBOODDHCLLP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DFBGCBPCGDA
//   (not directly referenced by a detected call)
public class DFBGCBPCGDA
{
    public int <HDACJBMAPED>k__BackingField;    // 0x0x10
    public DateTime <NMGNNGPFHCO>k__BackingField;    // 0x0x18
    public DateTime? <KCNMBEJBDOB>k__BackingField;    // 0x0x20
}
...
public class DHBMJHGMFGG
{
    public Guid <EAJBADHLPMO>k__BackingField;    // 0x0x10
    public long? <ANCGGDJHFLM>k__BackingField;    // 0x0x20
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x30
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x38
    public PJMDKBLLAEC <JHMFGKCMIPE>k__BackingField;    // 0x0x40
    public long <JKAKBKKCIBI>k__BackingField;    // 0x0x48
    public string <AGGCILAGFPI>k__BackingField;    // 0x0x50
    public DateTime <NMGNNGPFHCO>k__BackingField;    // 0x0x58
    public DateTime <KIKJDACIDHP>k__BackingField;    // 0x0x60
}
...
// DLFPBAGPECM
//   (not directly referenced by a detected call)
public class DLFPBAGPECM
{
    public long <BJACFCPNLLK>k__BackingField;    // 0x0x10
    public string <KLGNJANPBPG>k__BackingField;    // 0x0x18
    public int <OEHJIJDFNKG>k__BackingField;    // 0x0x20
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x28
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x30
    public string <AGGCILAGFPI>k__BackingField;    // 0x0x38
    public int <PDJIBEIJKBG>k__BackingField;    // 0x0x40
    public BLLIMEIEPAM <JIPLMLAJECL>k__BackingField;    // 0x0x44
    public DateTime <KIKJDACIDHP>k__BackingField;    // 0x0x48
    public DateTime <NMGNNGPFHCO>k__BackingField;    // 0x0x50
    public DateTime? <ILAMGHKEBGF>k__BackingField;    // 0x0x58
    public long? <NCPLEBCJGNN>k__BackingField;    // 0x0x68
    public int <KAJAFEEDBIB>k__BackingField;    // 0x0x78
    public int <PNGCIGMDBBM>k__BackingField;    // 0x0x7C
    public int <DONNAEMLENF>k__BackingField;    // 0x0x80
    public GIMGDMNFAAP <GIHKJADHAEG>k__BackingField;    // 0x0x84
    public GIMGDMNFAAP <LPKJEGDIHLP>k__BackingField;    // 0x0x88
    public bool <KKFFEFEPPFK>k__BackingField;    // 0x0x8C
    public bool <FDAFMHAJAIN>k__BackingField;    // 0x0x8D
    public bool <LDAIHPAONKA>k__BackingField;    // 0x0x8E
    public int? <MFAIHNPFNLN>k__BackingField;    // 0x0x90
    public bool <INJLKMLNKLI>k__BackingField;    // 0x0x98
}
...
// DONBACOGPHN
//   (not directly referenced by a detected call)
public class DONBACOGPHN
{
    public int <KPDCGDMELFC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EABMKNIMNDP
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/price   [Service.API]
public class EABMKNIMNDP
{
    public ICNPPCAAAAC <PFKFDLECKJP>k__BackingField;    // 0x0x10
}
...
// EHJNGKAEPCC
//   (not directly referenced by a detected call)
public class EHJNGKAEPCC
{
    public Guid <JKEGADEFAJJ>k__BackingField;    // 0x0x10
    public int <OOLOMPIIIIB>k__BackingField;    // 0x0x20
    public int <GBPGDFFCFIN>k__BackingField;    // 0x0x24
    public Guid <INJJIAEIMIO>k__BackingField;    // 0x0x28
    public DateTime <KIKJDACIDHP>k__BackingField;    // 0x0x38
    public MDLACPNDJJH <OOOLLLJGFGE>k__BackingField;    // 0x0x40
}
...
public class EONANNLPBKL
{
    public int <HLLLCGFNDAF>k__BackingField;    // 0x0x10
    public bool <BDGAIKCOFBN>k__BackingField;    // 0x0x14
    public DateTime <FJGANFKPHJF>k__BackingField;    // 0x0x18
    public bool <LADHICDCNCN>k__BackingField;    // 0x0x20
}
...
public class FFBHFODAEAH
{
    public long <ANCGGDJHFLM>k__BackingField;    // 0x0x10
    public long? <DBBLKMNOGDM>k__BackingField;    // 0x0x18
    public long? <MKHBICPLNCP>k__BackingField;    // 0x0x28
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x38
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x40
    public List<string> <BFCAEOIBMKK>k__BackingField;    // 0x0x48
    public string <AGGCILAGFPI>k__BackingField;    // 0x0x50
    public DateTime <MHKAPPCDLPF>k__BackingField;    // 0x0x58
    public DateTime <ABOKEFKGKLO>k__BackingField;    // 0x0x60
    public IFNLNGIDJHD <JIPLMLAJECL>k__BackingField;    // 0x0x68
    public bool <BALFBBLFJLG>k__BackingField;    // 0x0x6C
    public bool <DJPJAMJIFCI>k__BackingField;    // 0x0x6D
    public MNNJKCLGADP <IIIJACAJPGG>k__BackingField;    // 0x0x70
    public MNNJKCLGADP <LBAAMAKNPNF>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// FFKCHDPOHFB
//   (not directly referenced by a detected call)
public class FFKCHDPOHFB
{
    public PJMDKBLLAEC <JHMFGKCMIPE>k__BackingField;    // 0x0x10
    public int <MFAIHNPFNLN>k__BackingField;    // 0x0x14
    public AOCLIBKMNPJ <GBNAPIGFNOB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FFOOEDIPPPH
//   (not directly referenced by a detected call)
public class FFOOEDIPPPH
{
    public float <FOMMBFJOAHP>k__BackingField;    // 0x0x10
    public float <JFDGLIMMKLF>k__BackingField;    // 0x0x14
    public float <BJJIFKJLFBH>k__BackingField;    // 0x0x18
    public float <LIEONBOJKFB>k__BackingField;    // 0x0x1C
    public float <BFBCIGKAFKB>k__BackingField;    // 0x0x20
    public float <GJOKBKIBMHM>k__BackingField;    // 0x0x24
    public float <FDIILCLKLHD>k__BackingField;    // 0x0x28
    public float <DCBFPLDIOLB>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// FLHCEDNFAPN
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class FLHCEDNFAPN
{
    public long <EOEGDALCGCN>k__BackingField;    // 0x0x10
    public CDHLBBAMBML <MLEENBKCLAK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FLJNFIMOFGO
//   (not directly referenced by a detected call)
public class FLJNFIMOFGO
{
    public DateTime <NMGNNGPFHCO>k__BackingField;    // 0x0x10
    public string <GJHFBJCLNAE>k__BackingField;    // 0x0x18
}
...
public class FOOFIOCEGAC
{
    public Guid? <CMPFPLOBNCP>k__BackingField;    // 0x0x10
    public Guid <OEBDMIJMKID>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// GCODKICPEAM
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class GCODKICPEAM
{
    public LEPJOCMIEGN <BBOODDHCLLP>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <GGGGEMOLKDF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GEFCPPCLKMI
//   (not directly referenced by a detected call)
public class GEFCPPCLKMI
{
    public long <EFPMDAEOOHK>k__BackingField;    // 0x0x10
    public long <EOEGDALCGCN>k__BackingField;    // 0x0x18
    public int <HKFLNEOENLK>k__BackingField;    // 0x0x20
    public DateTime <NMGNNGPFHCO>k__BackingField;    // 0x0x28
    public CDHLBBAMBML <MLEENBKCLAK>k__BackingField;    // 0x0x30
}
...
public class GJDJGKNNGBM
{
    public int <EFPOOPDLNCM>k__BackingField;    // 0x0x10
    public string <JLMGFNBNKED>k__BackingField;    // 0x0x18
    public List<PHPHBPFPMBA> <MJEAMIEFFEE>k__BackingField;    // 0x0x20
    public KKCEGCOFIFN <HGPKKPBBAEH>k__BackingField;    // 0x0x28
    public string <NBPDHOKODGI>k__BackingField;    // 0x0x30
    public DateTime <AJDDCEHPKKF>k__BackingField;    // 0x0x38
    public DateTime <MGNBKIBCNLG>k__BackingField;    // 0x0x40
    public DateTime <KFKKMAOAAEN>k__BackingField;    // 0x0x48
    public bool? <OHHEEABKEHD>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// GJKAONFGPGO
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class GJKAONFGPGO
{
    public int <BMABCDBHKCA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GJPDNIMDCOI
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class GJPDNIMDCOI
{
    public List<MFNDLDOEJJH> <EAKGOJKACKG>k__BackingField;    // 0x0x10
    public PGBOCHFIBOA <FGOHPGHKGJO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GNNKJFLHGEA
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class GNNKJFLHGEA
{
    public Guid <GIPOAFPCMAJ>k__BackingField;    // 0x0x10
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x20
    public string <AGGCILAGFPI>k__BackingField;    // 0x0x28
    public DateTime <AJDDCEHPKKF>k__BackingField;    // 0x0x30
    public DateTime? <NAAJEFCKKDD>k__BackingField;    // 0x0x38
    public List<OGKEFICHOHH> <JDEOBKIDNEG>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// HALBPADDEFK
//   (not directly referenced by a detected call)
public class HALBPADDEFK
{
    public long <EBPCAEDIENC>k__BackingField;    // 0x0x10
    public Guid <KLGNJANPBPG>k__BackingField;    // 0x0x18
    public long <ANCGGDJHFLM>k__BackingField;    // 0x0x28
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x30
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x38
    public int <MFAIHNPFNLN>k__BackingField;    // 0x0x40
    public Guid? <FFBLDFKJIAJ>k__BackingField;    // 0x0x44
    public DateTime <NMGNNGPFHCO>k__BackingField;    // 0x0x58
    public string <AGGCILAGFPI>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// HBCPAOODKMD
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class HBCPAOODKMD
{
    public GFOGDJKPHHE <BOJHPEOFDMJ>k__BackingField;    // 0x0x10
    public long <EOEGDALCGCN>k__BackingField;    // 0x0x18
    public string <ABCFHALODGM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HBDELPFPDLD
//   (not directly referenced by a detected call)
public class HBDELPFPDLD
{
    public bool <ANEICECIOKP>k__BackingField;    // 0x0x10
    public PCHPFLCGAHL <ELCMNKPPLBC>k__BackingField;    // 0x0x14
    public int <LDAHNAHOGKP>k__BackingField;    // 0x0x18
    public DateTime <KIKJDACIDHP>k__BackingField;    // 0x0x20
}
...
public class HIAIEEEFNED : GMCPOIGDIBL
{
    public AKNPMOOBLCM? <JCLOFLHKMGC>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <GGGGEMOLKDF>k__BackingField;    // 0x0x20
}
...
// ICNPPCAAAAC
//   (not directly referenced by a detected call)
public class ICNPPCAAAAC
{
    public long <MFAIHNPFNLN>k__BackingField;    // 0x0x10
    public Guid? <EAJBADHLPMO>k__BackingField;    // 0x0x18
}
...
public class IDOBBFPNKCK
{
    public Dictionary<int, int> <COEICMOIEBJ>k__BackingField;    // 0x0x10
    public List<EBBICBIANAO> <MNFGJJKEGNA>k__BackingField;    // 0x0x18
    public JCJNFLJCEAP[][] <HNLPFHJKPMA>k__BackingField;    // 0x0x20
    public KNPLIIHOHOB <CEINHNPOEKO>k__BackingField;    // 0x0x28
    public FFOOEDIPPPH <JONIFHNGPPC>k__BackingField;    // 0x0x30
    public DONBACOGPHN <NGBMCHNOCPA>k__BackingField;    // 0x0x38
    public MPEIMFANPHN <HHFDICFGFHA>k__BackingField;    // 0x0x40
    public LEMOHOJKLAJ <JNMMIAPKICN>k__BackingField;    // 0x0x48
    public string <BGBNHHLNAFC>k__BackingField;    // 0x0x50
}
...
public class INNFFPEFEKM
{
    public HTTPResponse ADIABGEPIMA;    // 0x0x10
    public int? PIJJPPLIENN;    // 0x0x18
    public string IJFPJDCLHBN;    // 0x0x20
    public byte[] DOCFHIOKMLP;    // 0x0x28
    public string MCGBNPLBHEP;    // 0x0x30
}
...
public class IPPMIDKMPJA
{
    public List<OANDNAONDOP> <BFCAEOIBMKK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JCJNFLJCEAP
//   (not directly referenced by a detected call)
public class JCJNFLJCEAP
{
    public DOGNADLNGIO IOOKDIHOJMP;    // 0x0x10
    public int EMLOEDOFNNN;    // 0x0x14
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{pDLEABGEJNJ}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{pDLEABGEJNJ}   [Service.API]
...
public class JDCPGNKBHNF
{
    public LOLKLKMHCIC <HAPILDHPFKA>k__BackingField;    // 0x0x10
    public MDLACPNDJJH <OOOLLLJGFGE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JGAFJCJBFKI
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class JGAFJCJBFKI
{
    public int <OOGGHHBLGJJ>k__BackingField;    // 0x0x10
    public string <AHMHPAPAENP>k__BackingField;    // 0x0x18
    public string <PHLCKCDKNIO>k__BackingField;    // 0x0x20
    public string <NEDIMGJCGLE>k__BackingField;    // 0x0x28
    public string <COMCPCPDHHI>k__BackingField;    // 0x0x30
    public string <ECHIOAGADMG>k__BackingField;    // 0x0x38
}
...
public class JGCNDCNNIKN : HPNMOMADMCA
{
    public List<CDOKLOGOENH> HLLEDDHCOED;    // 0x0x30
    public int <PDKPJKJCDMC>k__BackingField;    // 0x0x38
}
...
// KEIOKFHDOLE
//   (not directly referenced by a detected call)
public class KEIOKFHDOLE
{
    public int <GKGMIPCGHNO>k__BackingField;    // 0x0x10
    public int <JHKMKNBFDLG>k__BackingField;    // 0x0x14
    public int <KLLOAAFEOKO>k__BackingField;    // 0x0x18
}
...
// KKCEGCOFIFN
//   (not directly referenced by a detected call)
public class KKCEGCOFIFN
{
    public long <CFGMFICIMFM>k__BackingField;    // 0x0x10
    public string <NKBKGAAPIGF>k__BackingField;    // 0x0x18
    public string <OHPLGLGIOGH>k__BackingField;    // 0x0x20
    public MFHNOHFNGCO? <FCLOACLDIKJ>k__BackingField;    // 0x0x28
    public string <DFNFIHEEAMM>k__BackingField;    // 0x0x30
    public string <OEDLICOINKK>k__BackingField;    // 0x0x38
    public LOMGNPKBCBN <OJENJMFAPBD>k__BackingField;    // 0x0x40
    public int <MKIJNIDECDO>k__BackingField;    // 0x0x44
    public int <NKABKHPHFOC>k__BackingField;    // 0x0x48
    public APJMEBKPOLM? <LFMBMIONEFH>k__BackingField;    // 0x0x4C
    public OBNEIJGHDMG? <EJKALPIPBKF>k__BackingField;    // 0x0x54
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{gJMALLKLAFM}   [Service.API]
public class KMLOFNKNMBO
{
    public long <ANCGGDJHFLM>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <ABICGMFFNJP>k__BackingField;    // 0x0x18
    public INJAMAELBIE <KLPMFOODEIN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KNPLIIHOHOB
//   (not directly referenced by a detected call)
public class KNPLIIHOHOB
{
    public int <JGHJGKJOPGF>k__BackingField;    // 0x0x10
}
...
public class LEJOAPFBFFC
{
    public string <NLFANCAEKHM>k__BackingField;    // 0x0x10
    public string <LDFIHABPPJP>k__BackingField;    // 0x0x18
    public bool <MINIMDKAGJE>k__BackingField;    // 0x0x20
    public string <CDBDKDHMBDL>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// LEMOHOJKLAJ
//   (not directly referenced by a detected call)
public class LEMOHOJKLAJ
{
    public float <MPDDKHJDLIL>k__BackingField;    // 0x0x10
}
...
public class LEPJOCMIEGN
{
    public int <OOLOMPIIIIB>k__BackingField;    // 0x0x10
    public Guid <EAJBADHLPMO>k__BackingField;    // 0x0x14
    public long <OMOCLLPACJN>k__BackingField;    // 0x0x28
    public DateTime <KIKJDACIDHP>k__BackingField;    // 0x0x30
}
...
public class LFIOKEGMADO
{
    public PGBOCHFIBOA <FGOHPGHKGJO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LJMKBHCMLON
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class LJMKBHCMLON
{
    public ECBFHFOCDBE <FGOHPGHKGJO>k__BackingField;    // 0x0x10
    public List<string> <BFCAEOIBMKK>k__BackingField;    // 0x0x18
}
...
public class LNHGAIHOEEA
{
    public string <AGGCILAGFPI>k__BackingField;    // 0x0x10
}
...
public class MCMKMFLFEBN
{
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x10
}
...
public class MDHHKMKFDBA
{
    public IPANHBAICHE <HAPILDHPFKA>k__BackingField;    // 0x0x10
    public DLFPBAGPECM <FPECGGIOHPD>k__BackingField;    // 0x0x18
    public CCGLKGCLDBJ <IKDEGGGFFFI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MDLACPNDJJH
//   (not directly referenced by a detected call)
public class MDLACPNDJJH
{
    public Guid <JKEGADEFAJJ>k__BackingField;    // 0x0x10
    public long <ANCGGDJHFLM>k__BackingField;    // 0x0x20
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x28
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x30
    public string <AGGCILAGFPI>k__BackingField;    // 0x0x38
    public long <MFAIHNPFNLN>k__BackingField;    // 0x0x40
    public Guid? <FFBLDFKJIAJ>k__BackingField;    // 0x0x48
    public DateTime <KIKJDACIDHP>k__BackingField;    // 0x0x60
}
...
// MFCKIDIOKOD
//   (not directly referenced by a detected call)
public class MFCKIDIOKOD
{
    public int <CFGMFICIMFM>k__BackingField;    // 0x0x10
    public string <BOOLDGNDDHM>k__BackingField;    // 0x0x18
    public string <ECOFBJACDMC>k__BackingField;    // 0x0x20
    public string <NKBKGAAPIGF>k__BackingField;    // 0x0x28
    public string <KHNCGAADHNH>k__BackingField;    // 0x0x30
    public MFHNOHFNGCO? <FCLOACLDIKJ>k__BackingField;    // 0x0x38
    public string <DFNFIHEEAMM>k__BackingField;    // 0x0x40
    public string <OEDLICOINKK>k__BackingField;    // 0x0x48
    public bool <ONMKFFOPMEB>k__BackingField;    // 0x0x50
    public bool <CKCHLAGEBED>k__BackingField;    // 0x0x51
    public bool <NCEODLLAJOB>k__BackingField;    // 0x0x52
    public OBNEIJGHDMG <MEMBGOJPFCO>k__BackingField;    // 0x0x54
    public PJMDKBLLAEC <JHMFGKCMIPE>k__BackingField;    // 0x0x58
    public int <BIIGKKDLKEL>k__BackingField;    // 0x0x5C
    public DOJNFKAHIKA <NBCHGMOAGIM>k__BackingField;    // 0x0x60
    public APJMEBKPOLM <BKDGMJFADPK>k__BackingField;    // 0x0x64
    public int? <CFCEGIFAIJE>k__BackingField;    // 0x0x68
    public string <JJKJHJEMELC>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// MFNDLDOEJJH
//   (not directly referenced by a detected call)
public class MFNDLDOEJJH
{
    public int <DAIOHNMFNJP>k__BackingField;    // 0x0x10
    public PGBOCHFIBOA <FGOHPGHKGJO>k__BackingField;    // 0x0x14
}
...
public class MLLEENFMMHG
{
    public int <HEBJPIJHIGL>k__BackingField;    // 0x0x10
    public List<CLFEMOJABFM> <HEOCFJBMBFB>k__BackingField;    // 0x0x18
}
...
// MPEIMFANPHN
//   (not directly referenced by a detected call)
public class MPEIMFANPHN
{
    public int <AKCPBGPGJMG>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{gGEJFIHNJKJ}   [Service.API]
...
public class NHABEEFOKLJ
{
    public AGOJIEINEDJ <CNHJGPKJCOJ>k__BackingField;    // 0x0x10
    public PGBOCHFIBOA <FGOHPGHKGJO>k__BackingField;    // 0x0x18
    public LJMKBHCMLON <HHJBBKFMMDP>k__BackingField;    // 0x0x20
}
...
// OANDNAONDOP
//   (not directly referenced by a detected call)
public class OANDNAONDOP
{
    public string <ECPKADBGDNB>k__BackingField;    // 0x0x10
    public MJHOLJCHEGL <MLEENBKCLAK>k__BackingField;    // 0x0x18
}
...
// base   : BJFLBKAMFFD
//   (not directly referenced by a detected call)
public class ODHGOPICBKD : BJFLBKAMFFD
{
    public int <JFCDKMEGCDE>k__BackingField;    // 0x0x60
    public List<PPJFAHACEFO> <ECBOPOLFMGG>k__BackingField;    // 0x0x68
    public List<PPJFAHACEFO> <GBKPNOINHLL>k__BackingField;    // 0x0x70
    public List<PPJFAHACEFO> <FIEICKLLLMN>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// OEHCLOCEJEA
//   (not directly referenced by a detected call)
public class OEHCLOCEJEA
{
    public AGOJIEINEDJ <CNHJGPKJCOJ>k__BackingField;    // 0x0x10
    public GEFCPPCLKMI <DLKDADHKNAH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OGKEFICHOHH
//   (not directly referenced by a detected call)
public class OGKEFICHOHH
{
    public Guid <PHICGMAPFMD>k__BackingField;    // 0x0x10
    public Guid <BFOMABGPGEK>k__BackingField;    // 0x0x20
    public DateTime <AJDDCEHPKKF>k__BackingField;    // 0x0x30
    public List<MFCKIDIOKOD> <IPCGGGEDLMJ>k__BackingField;    // 0x0x38
}
...
public class OHAEEPMKFKN
{
    public FOOFIOCEGAC <FGIEHDICEKL>k__BackingField;    // 0x0x10
    public ICNPPCAAAAC <BBOGIBCIHMM>k__BackingField;    // 0x0x18
}
...
public class OIKBIBNDFGL
{
    public Guid <LIHPGCJMPAJ>k__BackingField;    // 0x0x10
    public Guid <EAJBADHLPMO>k__BackingField;    // 0x0x20
    public int <KLCOCHMKMNL>k__BackingField;    // 0x0x30
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x38
    public long <LODNOBJHGIO>k__BackingField;    // 0x0x40
    public long <MFAIHNPFNLN>k__BackingField;    // 0x0x48
    public DateTime <KIKJDACIDHP>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// OLDIIJNHJNM
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.API]
public class OLDIIJNHJNM
{
    public Guid? <JKEGADEFAJJ>k__BackingField;    // 0x0x10
    public long? <ANCGGDJHFLM>k__BackingField;    // 0x0x28
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x38
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x40
    public string <AGGCILAGFPI>k__BackingField;    // 0x0x48
    public ICNPPCAAAAC <PFKFDLECKJP>k__BackingField;    // 0x0x50
}
...
public class OLIDGHHIMNB
{
    public long <BMPEEPEINJO>k__BackingField;    // 0x0x10
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x18
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x20
    public DateTime <NMGNNGPFHCO>k__BackingField;    // 0x0x28
    public string <AGGCILAGFPI>k__BackingField;    // 0x0x30
    public NEFKKNDCMJL <PFBKBNJMNIK>k__BackingField;    // 0x0x38
    public int <GNCPCOOKABP>k__BackingField;    // 0x0x3C
    public int <NLLMDOJPFNB>k__BackingField;    // 0x0x40
    public List<CCLDBLIKFMA> <IPOGCHLHHCG>k__BackingField;    // 0x0x48
}
...
public class OLMIEJEMBBN
{
    public List<int> <HAFMHJMKKMC>k__BackingField;    // 0x0x10
    public string <LPPOKDMMPML>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/playerevents/v1/all/{lCAHHDBJIIE}   [Service.API]
public class PHNJKBNIBMN
{
    public List<AGOJIEINEDJ> <PABNFADIMNH>k__BackingField;    // 0x0x10
    public List<OEHCLOCEJEA> <KCILIIEJMOA>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/avatar/v2/{lCAHHDBJIIE}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{lCAHHDBJIIE}   [Service.API]
public class PHOGOHJOOOM
{
    public string <PHLCKCDKNIO>k__BackingField;    // 0x0x10
    public string <NEDIMGJCGLE>k__BackingField;    // 0x0x18
    public string <COMCPCPDHHI>k__BackingField;    // 0x0x20
    public string <ECHIOAGADMG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// PHPHBPFPMBA
//   (not directly referenced by a detected call)
public class PHPHBPFPMBA
{
    public int <CDHNJLJJHPL>k__BackingField;    // 0x0x10
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x18
    public string <DACHHGKHMOF>k__BackingField;    // 0x0x20
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x28
    public string <ECOFBJACDMC>k__BackingField;    // 0x0x30
    public bool <MLBMOCGEPIJ>k__BackingField;    // 0x0x38
    public int <OOGGHHBLGJJ>k__BackingField;    // 0x0x3C
    public EFMFFFKOEDG <HJEPEOKKPCF>k__BackingField;    // 0x0x40
    public NKPIPMNOKPF OLLNGCBDPMM;    // 0x0x48
    public NKPIPMNOKPF PABNEKNHHOK;    // 0x0x50
    public NKPIPMNOKPF AHNPOPHLGJC;    // 0x0x58
    public HBHOKJJHFMJ HHAHMBFFODL;    // 0x0x60
}
...
public class PKDNLBAOLCE
{
    public int <KPLBJGEINDP>k__BackingField;    // 0x0x10
    public int <HLLLCGFNDAF>k__BackingField;    // 0x0x14
    public float <LPPJKKLIPME>k__BackingField;    // 0x0x18
    public float <FFPELGLCFOI>k__BackingField;    // 0x0x1C
    public bool <BDGAIKCOFBN>k__BackingField;    // 0x0x20
    public bool <AAHGCOCNLBL>k__BackingField;    // 0x0x21
    public bool <FCMMNMAJLGK>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// PMPJHOMLJMC
//   RESPONSE GET    api/inventions/v1/personaldetails/{mDCIHEOKCMJ}   [Service.API]
public class PMPJHOMLJMC
{
    public bool <OIIHFNFOCGJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PPJFAHACEFO
//   (not directly referenced by a detected call)
public class PPJFAHACEFO
{
    public bool <BCNPKCJMFAJ>k__BackingField;    // 0x0x10
    public MFCKIDIOKOD <CLGCKMGFFGJ>k__BackingField;    // 0x0x18
    public float <GCDKPALBDKM>k__BackingField;    // 0x0x20
}
...
{
    public EEJNHDMFJPH <FGOHPGHKGJO>k__BackingField;    // 0x0x10
    public string <BIKDOPCJPOE>k__BackingField;    // 0x0x18
    public string <NEPOFPFJCPC>k__BackingField;    // 0x0x20
    public string <KNECBADBJEF>k__BackingField;    // 0x0x28
}
...
public class GetRankRequestDTO
{
    ...
    public CHEFAMMPBAP FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public APJMEBKPOLM <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public EKEBMBGFFNE creatorAccountRole;    // 0x0x58
}
...
{
    public JMKLIJLJNBH <AEEOBKDOOJC>k__BackingField;    // 0x0x10
    public GJBHJHFEFPI <ALGOAIMOFMK>k__BackingField;    // 0x0x14
    public string <KAIPFHKHGJL>k__BackingField;    // 0x0x18
    public string <GAILLIAEMJO>k__BackingField;    // 0x0x20
    public bool <BNJBGBIEHLH>k__BackingField;    // 0x0x28
}
...
{
    public List<JMKLIJLJNBH> <MKEFHCMMLCL>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public OIGELPNHJMH ReportCategory;    // 0x0x20
}
...
{
    public ONJIGMMIAIK? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public ONJIGMMIAIK NGEKNJBBLNH;  // wrapper
...
{
    public BNDOPONFHEO GGACFMLGJIF;  // wrapper
...
{
    public MEIGBJOCJDP IEADHAAGEDA;  // wrapper
    public int? LAKMFJCMKEE;  // wrapper
...
{
    public EPNGIDLLIIN UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public APJMEBKPOLM PHFLFPJELLC;  // wrapper
    public APJMEBKPOLM? PJGFGGKMEJG;  // wrapper
...
{
    public PHPHBPFPMBA OCHFMDHCIPN;  // wrapper
...
{
    public GFOGDJKPHHE BNODADLIJIK;  // wrapper
...
{
    public List<DAJKNFKKHGL> JKNOHKKJKJP;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public JADMBLAPBLO ENILABBLBED;  // wrapper
    public APJMEBKPOLM? CGGMOFAHJKO;  // wrapper
...
{
    public AJEKGLHFOJG KJBPLOKDCBN;  // wrapper
...
{
    public StatusResponse> JJBCELLHKLO;  // wrapper
...
{
    public List<long> KILGOCMKALI;  // wrapper
    public JOIDHAAGGEB JJBCELLHKLO;  // wrapper
    public EABFDOLBMMD ELLIFIIAJBN;  // wrapper
    public long? GJMALLKLAFM;  // wrapper
...
{
    public String> JJBCELLHKLO;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{gGEJFIHNJKJ}  [API POST]
public class PlayereventsV2DeleteGGEJFIHNJKJRequest
{
    public AGOJIEINEDJ GGEJFIHNJKJ;  // wrapper
}
...
{
    public AGOJIEINEDJ GGEJFIHNJKJ;  // wrapper
    public IFNLNGIDJHD AJANLALJAIO;  // wrapper
...
{
    public AGOJIEINEDJ GGEJFIHNJKJ;  // wrapper
    public long? JGKLPJIFLFF;  // wrapper
    public object clubId;  // candidate
}
...
{
    public AGOJIEINEDJ GGEJFIHNJKJ;  // wrapper
    public MNNJKCLGADP GCIBNJJKNAL;  // wrapper
    public MNNJKCLGADP CCHOMEBLHDJ;  // wrapper
...
{
    public AGOJIEINEDJ GGEJFIHNJKJ;  // wrapper
    public long? LJMJGGHIFEA;  // wrapper
    public object roomId;  // candidate
...
{
    public AGOJIEINEDJ GGEJFIHNJKJ;  // wrapper
    public List<string> LOAEACHCIGG;  // wrapper
}
...
{
    public AGOJIEINEDJ GGEJFIHNJKJ;  // wrapper
    public DateTime HDGNELLNLBK;  // wrapper
    public DateTime FGFODAOJGAA;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> KCABGBBCLOF;  // wrapper
...
{
    public Guid? BCJNGDEPNEG;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats DEHFGNLPACD;  // wrapper
}
...
{
    public Guid MALOIMKKLNP;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<AFBAJOLCLFN> AOBLPPGMEJK;  // wrapper
...
{
    public FODOFOGAAKP OJELHBDEECK;  // wrapper
}
