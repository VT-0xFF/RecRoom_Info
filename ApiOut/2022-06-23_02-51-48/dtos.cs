...
public class ADAIHJEDHNI
{
    public DateTime <BALBHHFFGBO>k__BackingField;    // 0x0x10
    public string <PEJJHEODEAI>k__BackingField;    // 0x0x18
}
...
public class AIAOMNGMKPG
{
    public OIALGOAGLPP <AFLMEBDHKJA>k__BackingField;    // 0x0x10
    public JJAJHMJPDDN <DOKAIBJGDBM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BBBIBLOLBEH
//   (not directly referenced by a detected call)
public class BBBIBLOLBEH
{
    public Guid <PKCAGELNEHP>k__BackingField;    // 0x0x10
    public byte <ECMDIKFEFJA>k__BackingField;    // 0x0x20
}
...
public class BCDIIFFMNOH
{
    public List<NGHHHGMDCNO> <JGLCMPIENCM>k__BackingField;    // 0x0x10
    public string <EKFJMIHBEOP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BFBCNNMCICH
//   (not directly referenced by a detected call)
public class BFBCNNMCICH
{
    public int <KFGJONNLLAP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BFENJICKMAC
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/description   [Service.API]
public class BFENJICKMAC
{
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BGGNKOMMKCC
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/price   [Service.API]
public class BGGNKOMMKCC
{
    public MFLIEEEBOLG <DOKPJGNIPIP>k__BackingField;    // 0x0x10
}
...
// CAGBDGIBMME
//   (not directly referenced by a detected call)
public class CAGBDGIBMME
{
    public int <IHJOAKBMMME>k__BackingField;    // 0x0x10
    public int <KGEKOIANBJJ>k__BackingField;    // 0x0x14
    public int <MFAMCJJCIKE>k__BackingField;    // 0x0x18
}
...
public class CCHFEAFHOKF
{
    public List<string> <JHLOAHBIJJI>k__BackingField;    // 0x0x10
    public List<string> <PMLONFPBJED>k__BackingField;    // 0x0x18
    public List<string> <FPGHJBGCBAM>k__BackingField;    // 0x0x20
}
...
public class CLBPJFNIBLI
{
    public Dictionary<int, int> <LFELJAADMPN>k__BackingField;    // 0x0x10
    public List<DAIPONHOGFL> <APCMLCLIHPB>k__BackingField;    // 0x0x18
    public EJPOIONNJKB[][] <OCNGANCOMJG>k__BackingField;    // 0x0x20
    public EHBMFKIAGKF <AGAOBHPHIED>k__BackingField;    // 0x0x28
    public FJMFIDJINDP <EFOBDPNNLDN>k__BackingField;    // 0x0x30
    public FIHCFCEPFDA <PDNCGNADCGP>k__BackingField;    // 0x0x38
    public BFBCNNMCICH <BAHPCCCPHHF>k__BackingField;    // 0x0x40
    public HDCANKDLKNP <NFKKNDJLEHF>k__BackingField;    // 0x0x48
    public string <BFNPHEKBEJC>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// CLGIKKJKANH
//   (not directly referenced by a detected call)
public class CLGIKKJKANH
{
    public int <EKIKKLHHNHD>k__BackingField;    // 0x0x10
    public DateTime? <DKCJHBNMHPO>k__BackingField;    // 0x0x18
    public DateTime? <BDDIPOEGHLH>k__BackingField;    // 0x0x28
}
...
public class CNHIILMAOGM
{
    public int <OGGMGKFPPGN>k__BackingField;    // 0x0x10
    public Guid <MJLHEGKKEFD>k__BackingField;    // 0x0x14
    public long <ODHDDGOCFEJ>k__BackingField;    // 0x0x28
    public DateTime <LIFGMGCOHJJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// CODADFBAFAE
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class CODADFBAFAE
{
    public int? <NAPNEDKEJNJ>k__BackingField;    // 0x0x10
    public string <IPLIMEAHNFP>k__BackingField;    // 0x0x18
    public string <JCEKEGIDIJO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CPANOGDMDKP
//   (not directly referenced by a detected call)
public class CPANOGDMDKP
{
    public int <IHBAGAALFII>k__BackingField;    // 0x0x10
    public PPNPBOFOLKM <OBGPNBPPNOM>k__BackingField;    // 0x0x14
}
...
//   RESPONSE GET    api/avatar/v2/{dIJKJKNKFBG}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{dIJKJKNKFBG}   [Service.API]
public class CPJFEIJIFMA
{
    public string <MPMDIODAIOA>k__BackingField;    // 0x0x10
    public string <OKPHJFPCEON>k__BackingField;    // 0x0x18
    public string <FBOOFMLCIOK>k__BackingField;    // 0x0x20
    public string <HGGBEIIFHNP>k__BackingField;    // 0x0x28
    public string <PBBNJIKOIOA>k__BackingField;    // 0x0x30
    public List<BBBIBLOLBEH> <AKPGKLMAJEP>k__BackingField;    // 0x0x38
}
...
// --------------------------------------------------------------------------
// DBPGANHBCPM
//   RESPONSE GET    api/groups/v1/memberships/{kFHPDJDOGDF}   [Service.API]
//   RESPONSE GET    api/groups/v1/name/{nameId}   [Service.API]
//   RESPONSE GET    api/groups/v1/{groupId}   [Service.API]
public class DBPGANHBCPM
{
    public long <DPCBOMPGBKD>k__BackingField;    // 0x0x10
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x18
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x20
    public DateTime <BALBHHFFGBO>k__BackingField;    // 0x0x28
    public string <JOLHKJPFJPK>k__BackingField;    // 0x0x30
    public DCANEAJLFNJ <HGBEELNOIDD>k__BackingField;    // 0x0x38
    public int <JDGPDJHFNOP>k__BackingField;    // 0x0x3C
    public int <JLHHIGODFIF>k__BackingField;    // 0x0x40
    public List<OBPBJEDCLBP> <BJFMCAGNDPO>k__BackingField;    // 0x0x48
}
...
public class DFCFDFHBFDI
{
    public CNHIILMAOGM <COFMPIKKOBJ>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <PGPDDIMKDNP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DGPKGOIBDGC
//   (not directly referenced by a detected call)
public class DGPKGOIBDGC
{
    public long <COJJLAINHIF>k__BackingField;    // 0x0x10
    public Guid <BJPHIHILOJI>k__BackingField;    // 0x0x18
    public long <KAPIEEPJGLM>k__BackingField;    // 0x0x28
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x30
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x38
    public int <JOFJOOPFKHF>k__BackingField;    // 0x0x40
    public Guid? <AKDMLFBHMHE>k__BackingField;    // 0x0x44
    public DateTime <BALBHHFFGBO>k__BackingField;    // 0x0x58
    public string <JOLHKJPFJPK>k__BackingField;    // 0x0x60
}
...
// DMPMCCBGKNA
//   (not directly referenced by a detected call)
public class DMPMCCBGKNA
{
    public long <HHNNFPJEMPM>k__BackingField;    // 0x0x10
    public int <GPNGCDKEMHF>k__BackingField;    // 0x0x18
    public long <KAPIEEPJGLM>k__BackingField;    // 0x0x20
    public long? <MEIPAHAIEML>k__BackingField;    // 0x0x28
    public long? <BKLPLAAPODE>k__BackingField;    // 0x0x38
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x48
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x50
    public string <JOLHKJPFJPK>k__BackingField;    // 0x0x58
    public DateTime <IAMLDOEJAOG>k__BackingField;    // 0x0x60
    public DateTime <NMBMPMGGNPF>k__BackingField;    // 0x0x68
    public int <PMNOGHDGCOE>k__BackingField;    // 0x0x70
    public CHEAEOHAIGB <FCGPKFPDHMM>k__BackingField;    // 0x0x74
    public bool <GLFPBHCNMFA>k__BackingField;    // 0x0x78
    public bool <OIOJIPCLFJM>k__BackingField;    // 0x0x79
    public NDPOHBPMDOO <FBCKHPFBEHO>k__BackingField;    // 0x0x7C
    public NDPOHBPMDOO <ALNEFPNHALJ>k__BackingField;    // 0x0x80
    public long? <GOGNNKFGJFJ>k__BackingField;    // 0x0x88
}
...
public class DNGOLHOIKBG
{
    public Guid <MJLHEGKKEFD>k__BackingField;    // 0x0x10
    public long? <KAPIEEPJGLM>k__BackingField;    // 0x0x20
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x30
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x38
    public DKGIDJLEAMG <NLCBADOHKBM>k__BackingField;    // 0x0x40
    public long <KGDNHJLJABO>k__BackingField;    // 0x0x48
    public string <JOLHKJPFJPK>k__BackingField;    // 0x0x50
    public DateTime <BALBHHFFGBO>k__BackingField;    // 0x0x58
    public DateTime <LIFGMGCOHJJ>k__BackingField;    // 0x0x60
}
...
// base   : JBAONJGACHP
//   (not directly referenced by a detected call)
public class EDDPJPHFFMN : JBAONJGACHP
{
    public OABGJEIKIDB <FLBEOBFNKOC>k__BackingField;    // 0x0x60
}
...
// EGNFGMMEJLE
//   (not directly referenced by a detected call)
public class EGNFGMMEJLE
{
    public Guid <DLAGOCDELID>k__BackingField;    // 0x0x10
    public Guid <INMFHGDMNCO>k__BackingField;    // 0x0x20
    public DateTime <MKAOAOEBEEG>k__BackingField;    // 0x0x30
    public List<OABGJEIKIDB> <CEHBNIOHCBO>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// EHBMFKIAGKF
//   (not directly referenced by a detected call)
public class EHBMFKIAGKF
{
    public int <LKGNAGLCNOB>k__BackingField;    // 0x0x10
}
...
public class EJJPFLFBKKJ : OKPCIKNMNPD
{
    public int <DBGNEPKELMJ>k__BackingField;    // 0x0x30
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x38
    public DateTime <MKAOAOEBEEG>k__BackingField;    // 0x0x40
    public DateTime <GLDNCCAFHEK>k__BackingField;    // 0x0x48
    public DKGIDJLEAMG <NLCBADOHKBM>k__BackingField;    // 0x0x50
    public JBAONJGACHP <EFONKMFOAIH>k__BackingField;    // 0x0x58
    public List<ENCLOOOBIPC> <JMGIJDPJJKG>k__BackingField;    // 0x0x60
    public ODMGCPJJMIL <FPCCNMMMEDH>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// EJPOIONNJKB
//   (not directly referenced by a detected call)
public class EJPOIONNJKB
{
    public PCCPELCLOEG DHBBKIDPHEK;    // 0x0x10
    public int GFLPGLLILOJ;    // 0x0x14
}
...
public class EKAGDPKANLI
{
    public PPNPBOFOLKM <OBGPNBPPNOM>k__BackingField;    // 0x0x10
}
...
// base   : JBAONJGACHP
//   (not directly referenced by a detected call)
public class ENCLOOOBIPC : JBAONJGACHP
{
    public int <PMOKIDACPOP>k__BackingField;    // 0x0x60
    public List<INIBPNKKBHL> <BLJJDHKNOHO>k__BackingField;    // 0x0x68
    public List<INIBPNKKBHL> <ONCDNBOPDGF>k__BackingField;    // 0x0x70
    public List<INIBPNKKBHL> <KEKCJIGHKHA>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// ENDBABIHLJA
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class ENDBABIHLJA
{
    public List<CPANOGDMDKP> <LJBCBEFFGBK>k__BackingField;    // 0x0x10
    public PPNPBOFOLKM <OBGPNBPPNOM>k__BackingField;    // 0x0x18
}
...
public class FFGIAEEKIFG
{
    public List<int> <BHPHBPHGMOC>k__BackingField;    // 0x0x10
    public string <EKFJMIHBEOP>k__BackingField;    // 0x0x18
}
...
// FIHCFCEPFDA
//   (not directly referenced by a detected call)
public class FIHCFCEPFDA
{
    public int <HKKDLINOHNE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FJMFIDJINDP
//   (not directly referenced by a detected call)
public class FJMFIDJINDP
{
    public float <HAFLJGFBCMG>k__BackingField;    // 0x0x10
    public float <AOEBGCFNBEH>k__BackingField;    // 0x0x14
    public float <IIKNMIFILLD>k__BackingField;    // 0x0x18
    public float <GPJJOIMNACE>k__BackingField;    // 0x0x1C
    public float <BLOGMIKHGMK>k__BackingField;    // 0x0x20
    public float <BENHCNGOFKD>k__BackingField;    // 0x0x24
    public float <DOAPHOJBCHF>k__BackingField;    // 0x0x28
    public float <BJJHFLHCMLG>k__BackingField;    // 0x0x2C
}
...
public class FKODBOCNJGO
{
    public bool <KECHPBEDMGC>k__BackingField;    // 0x0x10
    public string <BJADJIBAAKD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FMJOODKPHDM
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{hAMKLMCJFNP}   [Service.API]
public class FMJOODKPHDM
{
    public uint <PILPAAEHLMC>k__BackingField;    // 0x0x10
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x18
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x20
    public DateTime <PDBKDIMKKGJ>k__BackingField;    // 0x0x28
    public DateTime? <EBMLDNBNFLP>k__BackingField;    // 0x0x30
    public bool <PHKALFEENDN>k__BackingField;    // 0x0x40
    public List<NGGGCFOEBAL> <OFBALPAOIBO>k__BackingField;    // 0x0x48
    public List<string> <GFDBPHCLPII>k__BackingField;    // 0x0x50
    public int <FPNEGEFFFJK>k__BackingField;    // 0x0x58
    public int <BCFNELKIJDB>k__BackingField;    // 0x0x5C
    public int <CHDDKLKIJDM>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// GDNNHEJDFGA
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class GDNNHEJDFGA
{
    public List<HCLMNGFCHHG> <GFDBPHCLPII>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GGFLJPFGMGJ
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class GGFLJPFGMGJ
{
    public int <CHAHIBNAMOP>k__BackingField;    // 0x0x10
    public string <OBMLEAMCPEC>k__BackingField;    // 0x0x18
    public List<PJAGLCHHEJC> <OKMLPIFGLBI>k__BackingField;    // 0x0x20
    public JFCGJNGDHHM <DLGBPMOCPEN>k__BackingField;    // 0x0x28
    public string <CPDCJAEKKGJ>k__BackingField;    // 0x0x30
    public DateTime <MKAOAOEBEEG>k__BackingField;    // 0x0x38
    public DateTime <GLDNCCAFHEK>k__BackingField;    // 0x0x40
    public DateTime <IBPNDDDINAP>k__BackingField;    // 0x0x48
    public bool? <JAEEKPGCDCH>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// GINDLPLMGHB
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.API]
public class GINDLPLMGHB
{
    public Guid? <NNCLEDIAKAE>k__BackingField;    // 0x0x10
    public long? <KAPIEEPJGLM>k__BackingField;    // 0x0x28
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x38
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x40
    public string <JOLHKJPFJPK>k__BackingField;    // 0x0x48
    public MFLIEEEBOLG <DOKPJGNIPIP>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// GNPEDEDLMBN
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class GNPEDEDLMBN
{
    public int <OGGMGKFPPGN>k__BackingField;    // 0x0x10
    public Guid <MJLHEGKKEFD>k__BackingField;    // 0x0x14
    public long <ODHDDGOCFEJ>k__BackingField;    // 0x0x28
    public long <KMPMKADDIAI>k__BackingField;    // 0x0x30
    public DateTime <HFOMALJNGBP>k__BackingField;    // 0x0x38
}
...
public class HACJGEODPGB
{
    public HTTPResponse IMAPAHKFKFF;    // 0x0x10
    public int? OFADHBOFFFK;    // 0x0x18
    public string ODMKNCHJPKK;    // 0x0x20
    public byte[] GLJMJPJFAIE;    // 0x0x28
    public string NBJKANIDMHF;    // 0x0x30
}

// --------------------------------------------------------------------------
// HCLMNGFCHHG
//   (not directly referenced by a detected call)
public class HCLMNGFCHHG
{
    public string <AOBFHOHKLDO>k__BackingField;    // 0x0x10
    public NHNPMICMKIC <PKBENCNEJDL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HDCANKDLKNP
//   (not directly referenced by a detected call)
public class HDCANKDLKNP
{
    public float <PLGMHOKMGCK>k__BackingField;    // 0x0x10
}
...
public class HDOHEBHPCNO : OKPCIKNMNPD
{
    public List<EDDPJPHFFMN> DIJJLAICJCE;    // 0x0x30
    public int <GICONDCBJNF>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// HFHJDKNNCNJ
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/image   [Service.API]
public class HFHJDKNNCNJ
{
    public string <JOLHKJPFJPK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HKFPEHJKJGC
//   REQUEST  POST   api/customAvatarItems/v1/{customAvatarItemId}/report   [Service.API]
public class HKFPEHJKJGC
{
    public OGONCKFNNID <LLOJOHJNDCA>k__BackingField;    // 0x0x10
    public string <KLNFMOGNDFJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HPLANACGEDJ
// base   : FAOINAGGGAH<NGGBEMIPKAG>
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{mOMHIBONMCG}   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v2/fromCreator/{mOMHIBONMCG}   [Service.API]
public class HPLANACGEDJ
{
    // (no instance fields in the metadata dump)
}
...
// INIBPNKKBHL
//   (not directly referenced by a detected call)
public class INIBPNKKBHL
{
    public bool <ICMEHLEADPG>k__BackingField;    // 0x0x10
    public OABGJEIKIDB <FLBEOBFNKOC>k__BackingField;    // 0x0x18
    public float <FOBCHCBNIKI>k__BackingField;    // 0x0x20
}
...
public class IOAGPHAABLG
{
    public long <KAPIEEPJGLM>k__BackingField;    // 0x0x10
    public long? <MEIPAHAIEML>k__BackingField;    // 0x0x18
    public long? <BKLPLAAPODE>k__BackingField;    // 0x0x28
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x38
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x40
    public List<string> <GFDBPHCLPII>k__BackingField;    // 0x0x48
    public string <JOLHKJPFJPK>k__BackingField;    // 0x0x50
    public DateTime <IAMLDOEJAOG>k__BackingField;    // 0x0x58
    public DateTime <NMBMPMGGNPF>k__BackingField;    // 0x0x60
    public CHEAEOHAIGB <FCGPKFPDHMM>k__BackingField;    // 0x0x68
    public bool <GLFPBHCNMFA>k__BackingField;    // 0x0x6C
    public bool <OIOJIPCLFJM>k__BackingField;    // 0x0x6D
    public NDPOHBPMDOO <FBCKHPFBEHO>k__BackingField;    // 0x0x70
    public NDPOHBPMDOO <ALNEFPNHALJ>k__BackingField;    // 0x0x74
}
...
public class IOGKPGMPGAE
{
    public int <JGFKKABNDLC>k__BackingField;    // 0x0x10
    public bool <JEDOAFCAFOG>k__BackingField;    // 0x0x14
    public DateTime <MGFBONLPPFP>k__BackingField;    // 0x0x18
    public bool <KLIECFCMFGD>k__BackingField;    // 0x0x20
}
...
public class JADNJALMBOI
{
    public int <GMNPAGCGPGP>k__BackingField;    // 0x0x10
    public int? <FGDFECICANB>k__BackingField;    // 0x0x14
    public string <PMLAJHDIKBB>k__BackingField;    // 0x0x20
    public string <AIDLHLANJBL>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// JBAONJGACHP
//   (not directly referenced by a detected call)
public class JBAONJGACHP
{
    public int <PEFDHKHKLNM>k__BackingField;    // 0x0x10
    public AIAHJGIDEGJ <PKBENCNEJDL>k__BackingField;    // 0x0x14
    public List<LJMPMECLOMF> <EDAOKMBGCMA>k__BackingField;    // 0x0x18
    public List<LJMPMECLOMF> <KENALFHNHJL>k__BackingField;    // 0x0x20
    public bool <FCJOBKCGFHD>k__BackingField;    // 0x0x28
    public DateTime? <MEHBHHJMNFP>k__BackingField;    // 0x0x30
    public DateTime? <BECDKAAGKIJ>k__BackingField;    // 0x0x40
    public DateTime? <FIOPAMDFJAB>k__BackingField;    // 0x0x50
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{dNKIEFBNINH}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{dNKIEFBNINH}   [Service.API]
...
public class JDJEHJLNOKL
{
    public OIALGOAGLPP <AFLMEBDHKJA>k__BackingField;    // 0x0x10
    public JJCEGIAACHO <NKFJNGHNMDK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JFCGJNGDHHM
//   (not directly referenced by a detected call)
public class JFCGJNGDHHM
{
    public long <POPBKLIALAC>k__BackingField;    // 0x0x10
    public string <ANEEDOLGLKL>k__BackingField;    // 0x0x18
    public string <LKOJMCMPKNA>k__BackingField;    // 0x0x20
    public OKCHOEAGBFF? <FIFIFHNEOMF>k__BackingField;    // 0x0x28
    public string <AIBDEOJLNIE>k__BackingField;    // 0x0x30
    public string <KNKJOCCMMIF>k__BackingField;    // 0x0x38
    public GOEBLBNPMNJ <OHIOFDKGOEO>k__BackingField;    // 0x0x40
    public int <BEEIIAMCEML>k__BackingField;    // 0x0x44
    public int <CIMMBGKDKKE>k__BackingField;    // 0x0x48
    public EEFAPOMABIE? <IAFKGGDLMBI>k__BackingField;    // 0x0x4C
    public OEGODINIKCK? <ODJBBMFIDHN>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// JGFNLIJKOJM
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class JGFNLIJKOJM
{
    public int <LNCCPMADHDP>k__BackingField;    // 0x0x10
    public int <JGFKKABNDLC>k__BackingField;    // 0x0x14
    public float <FMCHDJALHCC>k__BackingField;    // 0x0x18
    public float <MPCICBFFJGL>k__BackingField;    // 0x0x1C
    public bool <JEDOAFCAFOG>k__BackingField;    // 0x0x20
    public bool <MECHDJACKEI>k__BackingField;    // 0x0x21
    public bool <FKHCDPJJFIH>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// JIJLKOJLIAH
//   (not directly referenced by a detected call)
public class JIJLKOJLIAH
{
    public DMPMCCBGKNA <AJPCMGAPMLD>k__BackingField;    // 0x0x10
    public MLLGOJOPKPI <OJPGHNNFLMC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JJAJHMJPDDN
//   (not directly referenced by a detected call)
public class JJAJHMJPDDN
{
    public Guid <NNCLEDIAKAE>k__BackingField;    // 0x0x10
    public int <OGGMGKFPPGN>k__BackingField;    // 0x0x20
    public int <LBGAEGEOEHG>k__BackingField;    // 0x0x24
    public Guid <BDJNMCMMEPD>k__BackingField;    // 0x0x28
    public DateTime <LIFGMGCOHJJ>k__BackingField;    // 0x0x38
    public JJCEGIAACHO <NKFJNGHNMDK>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// JJCEGIAACHO
//   (not directly referenced by a detected call)
public class JJCEGIAACHO
{
    public Guid <NNCLEDIAKAE>k__BackingField;    // 0x0x10
    public long <KAPIEEPJGLM>k__BackingField;    // 0x0x20
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x28
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x30
    public string <JOLHKJPFJPK>k__BackingField;    // 0x0x38
    public long <JOFJOOPFKHF>k__BackingField;    // 0x0x40
    public Guid? <AKDMLFBHMHE>k__BackingField;    // 0x0x48
    public DateTime <LIFGMGCOHJJ>k__BackingField;    // 0x0x60
}
...
public class JKNCJHKIGIE
{
    public CDJLBLLEPPC <OBGPNBPPNOM>k__BackingField;    // 0x0x10
    public List<string> <GFDBPHCLPII>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JLFEHHMGIGL
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{eFDLJBJBGLC}   [Service.API]
...
public class JLFEHHMGIGL
{
    public DMPMCCBGKNA <AJPCMGAPMLD>k__BackingField;    // 0x0x10
    public PPNPBOFOLKM <OBGPNBPPNOM>k__BackingField;    // 0x0x18
    public JKNCJHKIGIE <BEIFAGCJCIN>k__BackingField;    // 0x0x20
}
...
public class JOJALBLNENM
{
    public PMMDGLBLLIP <AFLMEBDHKJA>k__BackingField;    // 0x0x10
    public PIFEIGDPEIH <IJKLEAMPCDL>k__BackingField;    // 0x0x18
    public PNCLCFLHDHI <PLPHLKMBLAA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KDFPGIJPLGK
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class KDFPGIJPLGK
{
    public int <PFHDEPNLBPG>k__BackingField;    // 0x0x10
    public string <PMOGOJGMEPP>k__BackingField;    // 0x0x18
    public string <MPMDIODAIOA>k__BackingField;    // 0x0x20
    public string <OKPHJFPCEON>k__BackingField;    // 0x0x28
    public string <FBOOFMLCIOK>k__BackingField;    // 0x0x30
    public string <HGGBEIIFHNP>k__BackingField;    // 0x0x38
    public string <PBBNJIKOIOA>k__BackingField;    // 0x0x40
    public List<BBBIBLOLBEH> <AKPGKLMAJEP>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// KEEPNLHEJAD
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class KEEPNLHEJAD
{
    public long <HHNNFPJEMPM>k__BackingField;    // 0x0x10
    public NELIFOBODLO <PKBENCNEJDL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KGIKHOHMNHL
//   (not directly referenced by a detected call)
public class KGIKHOHMNHL
{
    // (no instance fields in the metadata dump)
}
...
public class KHFIAIHKAEA
{
    public LGMMAHCLELD <AFLMEBDHKJA>k__BackingField;    // 0x0x10
    public DGPKGOIBDGC <GMDLLNHMHAI>k__BackingField;    // 0x0x18
}
...
public class KLHFJNMDJIG
{
    public bool <KECHPBEDMGC>k__BackingField;    // 0x0x10
    public string <EELAFAIDCJK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LCOOAAADIOG
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class LCOOAAADIOG
{
    public Guid <FBCFDHEGBLL>k__BackingField;    // 0x0x10
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x20
    public string <JOLHKJPFJPK>k__BackingField;    // 0x0x28
    public DateTime <MKAOAOEBEEG>k__BackingField;    // 0x0x30
    public DateTime? <OEJIHPENBNC>k__BackingField;    // 0x0x38
    public List<EGNFGMMEJLE> <OMOACLMJNNC>k__BackingField;    // 0x0x48
}
...
// LJMPMECLOMF
//   (not directly referenced by a detected call)
public class LJMPMECLOMF
{
    public DKGIDJLEAMG <NLCBADOHKBM>k__BackingField;    // 0x0x10
    public int <JOFJOOPFKHF>k__BackingField;    // 0x0x14
    public CLGIKKJKANH <KDPENADLNHP>k__BackingField;    // 0x0x18
}
...
public class LLHCCIGPDOD
{
    public OBNIFDFAIBP <KMABGBKIBEO>k__BackingField;    // 0x0x10
    public MFLIEEEBOLG <MOOMBINELFF>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{fMLOJIDJGBJ}   [Service.API]
public class LMCNLGGCDAP
{
    public long <KAPIEEPJGLM>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <JIOALHNEKPM>k__BackingField;    // 0x0x18
    public IGIKEABBOJP <MEFGKJJFGDF>k__BackingField;    // 0x0x20
}
...
public class LMDCFGLLCOC
{
    public string <AECDLNLLEKN>k__BackingField;    // 0x0x10
    public string <OHMJDNIPMEM>k__BackingField;    // 0x0x18
    public bool <OLDAOAIEHDO>k__BackingField;    // 0x0x20
    public string <NFHKEBGMDLK>k__BackingField;    // 0x0x28
}
...
public class LPFCJJEPBNN
{
    public Guid <GOFOBFJMEMK>k__BackingField;    // 0x0x10
    public Guid <MJLHEGKKEFD>k__BackingField;    // 0x0x20
    public int <CDDLHIEHCNL>k__BackingField;    // 0x0x30
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x38
    public long <OGGKDIDKALA>k__BackingField;    // 0x0x40
    public long <JOFJOOPFKHF>k__BackingField;    // 0x0x48
    public DateTime <LIFGMGCOHJJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// LPPCCIKGEDC
//   RESPONSE GET    api/inventions/v1/personaldetails/{hLCKACAMAOF}   [Service.API]
public class LPPCCIKGEDC
{
    public bool <KBOMDKMOFHI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// MAFKLOHLPEG
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class MAFKLOHLPEG
{
    public EMHKEGGNCMO <LLOJOHJNDCA>k__BackingField;    // 0x0x10
    public int <PDPNAKFMKKC>k__BackingField;    // 0x0x14
    public long <HLHMOPHDMOI>k__BackingField;    // 0x0x18
    public bool <KEPNOGADNHN>k__BackingField;    // 0x0x20
    public string <EELAFAIDCJK>k__BackingField;    // 0x0x28
    public int? <JLJPFGOOCDF>k__BackingField;    // 0x0x30
    public bool <MDPAPKHFJDK>k__BackingField;    // 0x0x38
    public bool <AMIOMCNLABH>k__BackingField;    // 0x0x39
    public string <JHLHPFPPJEN>k__BackingField;    // 0x0x40
    public DateTime? <MOEBBPHGJHA>k__BackingField;    // 0x0x48
    public float <BJKMOKIFCGP>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// MFLIEEEBOLG
//   (not directly referenced by a detected call)
public class MFLIEEEBOLG
{
    public long <JOFJOOPFKHF>k__BackingField;    // 0x0x10
    public Guid? <MJLHEGKKEFD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MHJLAPMNAJC
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class MHJLAPMNAJC
{
    public DKGIDJLEAMG <NLCBADOHKBM>k__BackingField;    // 0x0x10
    public IPODFNDEGLF <ABMHOIHJHEF>k__BackingField;    // 0x0x14
    public int <GOPMALKNKMK>k__BackingField;    // 0x0x18
    public int <LMDJPLNLCIH>k__BackingField;    // 0x0x1C
    public int <BLNCBABBPHD>k__BackingField;    // 0x0x20
    public NIDFFJEAJIJ <GFHOMBCGLND>k__BackingField;    // 0x0x24
    public bool <CPNEBIOPFFK>k__BackingField;    // 0x0x28
    public float <ICGOHEBKGHI>k__BackingField;    // 0x0x2C
    public int <DDIPJJHFEEN>k__BackingField;    // 0x0x30
    public bool <HNAJOPOGBGN>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// MLLGOJOPKPI
//   (not directly referenced by a detected call)
public class MLLGOJOPKPI
{
    public long <LGALCILLKEN>k__BackingField;    // 0x0x10
    public long <HHNNFPJEMPM>k__BackingField;    // 0x0x18
    public int <OFENCGMLCHJ>k__BackingField;    // 0x0x20
    public DateTime <BALBHHFFGBO>k__BackingField;    // 0x0x28
    public NELIFOBODLO <PKBENCNEJDL>k__BackingField;    // 0x0x30
}
...
public class NCKJIDIIOAB
{
    public EMHKEGGNCMO <LLOJOHJNDCA>k__BackingField;    // 0x0x10
    public long <HHNNFPJEMPM>k__BackingField;    // 0x0x18
    public string <KLNFMOGNDFJ>k__BackingField;    // 0x0x20
}
...
public class NGGBEMIPKAG
{
    public Guid <PKCAGELNEHP>k__BackingField;    // 0x0x10
    public int <GMNPAGCGPGP>k__BackingField;    // 0x0x20
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x28
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x30
    public int <JOFJOOPFKHF>k__BackingField;    // 0x0x38
    public ADKDIIAGPMF <FCGPKFPDHMM>k__BackingField;    // 0x0x3C
    public bool <FCJOBKCGFHD>k__BackingField;    // 0x0x40
    public int? <FGDFECICANB>k__BackingField;    // 0x0x44
    public string <AIDLHLANJBL>k__BackingField;    // 0x0x50
    public string <PMLAJHDIKBB>k__BackingField;    // 0x0x58
    public string <EHEILPHIHLF>k__BackingField;    // 0x0x60
    public DateTime <BALBHHFFGBO>k__BackingField;    // 0x0x68
    public DateTime <LIFGMGCOHJJ>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// NGGGCFOEBAL
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{hAMKLMCJFNP}   [Service.API]
public class NGGGCFOEBAL
{
    public string <PILPAAEHLMC>k__BackingField;    // 0x0x10
    public string <HPDCFCDAIGL>k__BackingField;    // 0x0x18
    public string <BNPCKOBOGJA>k__BackingField;    // 0x0x20
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x28
    public string <IPLIMEAHNFP>k__BackingField;    // 0x0x30
    public DAOGGOGDMHJ <AFLMEBDHKJA>k__BackingField;    // 0x0x38
    public List<string> <OCPOOAOILHE>k__BackingField;    // 0x0x40
    public List<string> <GFDBPHCLPII>k__BackingField;    // 0x0x48
    public string <HEKMPLNHIGK>k__BackingField;    // 0x0x50
    public List<ADAIHJEDHNI> <DFDLELODAKB>k__BackingField;    // 0x0x58
}
...
public class NGHGMGDPIKN
{
    public int <CJNFDLINMMK>k__BackingField;    // 0x0x10
    public List<PACCLCJAACA> <MOPMELJELFM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NGHHHGMDCNO
//   (not directly referenced by a detected call)
public class NGHHHGMDCNO
{
    public int <NGLPFCEENMD>k__BackingField;    // 0x0x10
    public DateTime <BALBHHFFGBO>k__BackingField;    // 0x0x18
    public DateTime? <MBBEPBINPCJ>k__BackingField;    // 0x0x20
}
...
public class NJMFHCOLKIL
{
    public int <PDPNAKFMKKC>k__BackingField;    // 0x0x10
}
...
public class NKAEBDELMCN
{
    public int <DDKFHJLBAEP>k__BackingField;    // 0x0x10
    public GCGNHPAJJDJ <PKBENCNEJDL>k__BackingField;    // 0x0x14
    public MNKOKJKCKBB <HKGPBDAFJNE>k__BackingField;    // 0x0x18
    public MNKOKJKCKBB <KAMBBHJPDIG>k__BackingField;    // 0x0x1C
    public MNKOKJKCKBB <MFPFJFDPJDG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OABGJEIKIDB
//   (not directly referenced by a detected call)
public class OABGJEIKIDB
{
    public int <POPBKLIALAC>k__BackingField;    // 0x0x10
    public string <DAHHKBFHKIO>k__BackingField;    // 0x0x18
    public string <LCMBLIHFEMP>k__BackingField;    // 0x0x20
    public string <ANEEDOLGLKL>k__BackingField;    // 0x0x28
    public string <LECKNGFGAKD>k__BackingField;    // 0x0x30
    public OKCHOEAGBFF? <FIFIFHNEOMF>k__BackingField;    // 0x0x38
    public string <AIBDEOJLNIE>k__BackingField;    // 0x0x40
    public string <KNKJOCCMMIF>k__BackingField;    // 0x0x48
    public bool <HKEDODEINMP>k__BackingField;    // 0x0x50
    public bool <PKOEGGJIKCO>k__BackingField;    // 0x0x51
    public bool <FEEPPAKIBDH>k__BackingField;    // 0x0x52
    public OEGODINIKCK <IAJCFNFHFIK>k__BackingField;    // 0x0x54
    public DKGIDJLEAMG <NLCBADOHKBM>k__BackingField;    // 0x0x58
    public int <PBCODPJJKAO>k__BackingField;    // 0x0x5C
    public OCFJODBOGAD <AHJMAKNOKNE>k__BackingField;    // 0x0x60
    public EEFAPOMABIE <LEDNPIBEBLB>k__BackingField;    // 0x0x64
    public int? <PEOGBAOEKPB>k__BackingField;    // 0x0x68
    public string <DKFDPEDLDKG>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// OBNIFDFAIBP
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/consume   [Service.API]
public class OBNIFDFAIBP
{
    public Guid? <NMBNGNGGEMC>k__BackingField;    // 0x0x10
    public Guid <IODMBNJNOMN>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// OBPBJEDCLBP
//   (not directly referenced by a detected call)
public class OBPBJEDCLBP
{
    public long <DPCBOMPGBKD>k__BackingField;    // 0x0x10
    public int <OFENCGMLCHJ>k__BackingField;    // 0x0x18
    public PPJBOEBPIIO <MJDNLJECPIH>k__BackingField;    // 0x0x1C
}
...
// ODMGCPJJMIL
//   (not directly referenced by a detected call)
public class ODMGCPJJMIL
{
    public bool <MJDNLGOHDEP>k__BackingField;    // 0x0x10
    public INHDOFCOJFO <ACMCCDJKJLN>k__BackingField;    // 0x0x14
    public int <COHFCIHMNML>k__BackingField;    // 0x0x18
    public DateTime <LIFGMGCOHJJ>k__BackingField;    // 0x0x20
}
...
// PACCLCJAACA
//   (not directly referenced by a detected call)
public class PACCLCJAACA
{
    public DateTime? <BBNEONJAPNF>k__BackingField;    // 0x0x10
    public DateTime? <HAGNFNNEMEM>k__BackingField;    // 0x0x20
    public IMCPLODLIFP <AFLMEBDHKJA>k__BackingField;    // 0x0x30
    public CAGBDGIBMME <MIHPJLFBHAA>k__BackingField;    // 0x0x38
    public bool <LDDOGCICIEO>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PAHEEDIHIDC
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/name   [Service.API]
public class PAHEEDIHIDC
{
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x10
}
...
public class PDDEIJEANAN
{
    public List<DMPMCCBGKNA> <PIFJNGOFLPP>k__BackingField;    // 0x0x10
    public List<JIJLKOJLIAH> <HPNBDIFICNA>k__BackingField;    // 0x0x18
}
...
public class PGIGJLPEOCG : HHKECOALMIK
{
    public JEPOCMLANHP? <BHFKJMCFACI>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <PGPDDIMKDNP>k__BackingField;    // 0x0x20
}
...
public class PIDGPJDKHHC : HHKECOALMIK
{
    public BGIBDOEAHAP? <BHFKJMCFACI>k__BackingField;    // 0x0x18
    public CNHIILMAOGM <COFMPIKKOBJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PIFEIGDPEIH
//   (not directly referenced by a detected call)
public class PIFEIGDPEIH
{
    public long <LLIDOCIPILI>k__BackingField;    // 0x0x10
    public string <BJPHIHILOJI>k__BackingField;    // 0x0x18
    public int <GPNGCDKEMHF>k__BackingField;    // 0x0x20
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x28
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x30
    public string <JOLHKJPFJPK>k__BackingField;    // 0x0x38
    public int <JPAFFGLFMIP>k__BackingField;    // 0x0x40
    public ADKDIIAGPMF <FCGPKFPDHMM>k__BackingField;    // 0x0x44
    public DateTime <LIFGMGCOHJJ>k__BackingField;    // 0x0x48
    public DateTime <BALBHHFFGBO>k__BackingField;    // 0x0x50
    public DateTime? <MDIJPNKHIFE>k__BackingField;    // 0x0x58
    public long? <IKMFCBIDHOK>k__BackingField;    // 0x0x68
    public int <MBNDDOCIHPA>k__BackingField;    // 0x0x78
    public int <EGKLPGPGKMG>k__BackingField;    // 0x0x7C
    public int <AFBIMMKEHDD>k__BackingField;    // 0x0x80
    public ONPNOMIGJEE <JHMMAFCGDHM>k__BackingField;    // 0x0x84
    public ONPNOMIGJEE <KKCIOADPOMO>k__BackingField;    // 0x0x88
    public bool <PDLNCKPFOOG>k__BackingField;    // 0x0x8C
    public bool <GNIODMPIIGJ>k__BackingField;    // 0x0x8D
    public bool <AJAGNGBABDN>k__BackingField;    // 0x0x8E
    public int? <JOFJOOPFKHF>k__BackingField;    // 0x0x90
    public bool <BKLIOKIJHIF>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// PJAGLCHHEJC
//   (not directly referenced by a detected call)
public class PJAGLCHHEJC
{
    public int <GFBMGBLNNDJ>k__BackingField;    // 0x0x10
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x18
    public string <ELMLIEFLAMN>k__BackingField;    // 0x0x20
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x28
    public string <LCMBLIHFEMP>k__BackingField;    // 0x0x30
    public bool <BLPADANNLBO>k__BackingField;    // 0x0x38
    public int <PFHDEPNLBPG>k__BackingField;    // 0x0x3C
    public KGIKHOHMNHL <OONGCKLKHMB>k__BackingField;    // 0x0x40
    public HOJKHCPHNPA KKFCIEJHPCD;    // 0x0x48
    public HOJKHCPHNPA EIBAEMKIOKP;    // 0x0x50
    public HOJKHCPHNPA ICBHDCJPHBO;    // 0x0x58
    public BFIANHNMALL MJOKIMFBNMI;    // 0x0x60
}
...
// PNCLCFLHDHI
//   (not directly referenced by a detected call)
public class PNCLCFLHDHI
{
    public long <LLIDOCIPILI>k__BackingField;    // 0x0x10
    public string <BJPHIHILOJI>k__BackingField;    // 0x0x18
    public int <DLIFHAPAJFH>k__BackingField;    // 0x0x20
    public int <OEILGAFFPII>k__BackingField;    // 0x0x24
    public int <FBJJPCMMILA>k__BackingField;    // 0x0x28
    public int <KNELMIBLMDP>k__BackingField;    // 0x0x2C
    public int <BMLCALGCDJI>k__BackingField;    // 0x0x30
    public string <JIFKOLPHBNH>k__BackingField;    // 0x0x38
    public string <OMCIPIHOMHO>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PNLNDJFLJHP
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{oKACAFMAKMP}   [Service.API]
public class PNLNDJFLJHP
{
    public Guid <PLACPELFGPB>k__BackingField;    // 0x0x10
    public int <OGGMGKFPPGN>k__BackingField;    // 0x0x20
    public int <PEFDHKHKLNM>k__BackingField;    // 0x0x24
    public DateTime <BALBHHFFGBO>k__BackingField;    // 0x0x28
}
...
{
    public ABOOPGMFKAC <OBGPNBPPNOM>k__BackingField;    // 0x0x10
    public string <PHIOCOMNOED>k__BackingField;    // 0x0x18
    public string <IPNGIJHLHDJ>k__BackingField;    // 0x0x20
    public string <PMBLNJPIGEL>k__BackingField;    // 0x0x28
}
...
{
    public long <HHNNFPJEMPM>k__BackingField;    // 0x0x10
    public long? <ANKIGEJLPAM>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public ECCGGJNOKMO FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public EEFAPOMABIE <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public PINCGNNMLPM creatorAccountRole;    // 0x0x58
}
...
{
    public BNBEBHFFMFC <DMMLJEOKHKH>k__BackingField;    // 0x0x10
    public CBCJFFJOLFC <FKDBOHPOIKH>k__BackingField;    // 0x0x14
    public string <KHCHEAKCFLP>k__BackingField;    // 0x0x18
    public string <GJDNPFNEIMH>k__BackingField;    // 0x0x20
    public bool <FHLMNPPBDED>k__BackingField;    // 0x0x28
}
...
{
    public List<BNBEBHFFMFC> <HLDBPJCJCGI>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public HGDIJHAJKDE ReportCategory;    // 0x0x20
}
...
{
    public HBKLPFGMCHN? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public HBKLPFGMCHN KIIIAPLJNAA;  // wrapper
...
{
    public MHLAGICGDNJ BGJGGKKJMFD;  // wrapper
...
{
    public DIKHNGFGIEP DEJAEMDNDIC;  // wrapper
    public int? PCIHHAJOBHO;  // wrapper
...
{
    public LLONPOHPCEN UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public EEFAPOMABIE JOBPOOEPEBN;  // wrapper
    public EEFAPOMABIE? FMBGHPLMGBF;  // wrapper
...
{
    public PJAGLCHHEJC LJNJAPHDDFL;  // wrapper
...
{
    public EMHKEGGNCMO KOCNPJBFFHJ;  // wrapper
...
{
    public List<BCNDGPEBGGE> JIONHACFKKH;  // wrapper
}
...
{
    public MCLMDCPOJCK MBLFOBMEEGE;  // wrapper
    public EEFAPOMABIE? FIOBNMNJCLK;  // wrapper
...
{
    public CMFNMDEAFIM BHDMLLHKBMP;  // wrapper
...
{
    public StatusResponse> KMEGFPKBBHD;  // wrapper
...
{
    public List<long> LADCJJJPEAE;  // wrapper
    public ONGJCFGMJLB KMEGFPKBBHD;  // wrapper
    public IHKMONBFCKO FPNBMAGANEJ;  // wrapper
    public long? FMLOJIDJGBJ;  // wrapper
...
{
    public String> KMEGFPKBBHD;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{eFDLJBJBGLC}  [API POST]
public class PlayereventsV2DeleteEFDLJBJBGLCRequest
{
    public DMPMCCBGKNA EFDLJBJBGLC;  // wrapper
}
...
{
    public DMPMCCBGKNA EFDLJBJBGLC;  // wrapper
    public CHEAEOHAIGB JFGNAPPNJCC;  // wrapper
...
{
    public DMPMCCBGKNA EFDLJBJBGLC;  // wrapper
    public long? ELEMDDADOJI;  // wrapper
    public object clubId;  // candidate
}
...
{
    public DMPMCCBGKNA EFDLJBJBGLC;  // wrapper
    public NDPOHBPMDOO GPGENNFDAHH;  // wrapper
    public NDPOHBPMDOO LJONBFNCJPC;  // wrapper
...
{
    public DMPMCCBGKNA EFDLJBJBGLC;  // wrapper
    public long? OHKPOEEEKLM;  // wrapper
    public object roomId;  // candidate
...
{
    public DMPMCCBGKNA EFDLJBJBGLC;  // wrapper
    public List<string> KDNBEMLJAOL;  // wrapper
}
...
{
    public DMPMCCBGKNA EFDLJBJBGLC;  // wrapper
    public DateTime CLFJOOMOGKF;  // wrapper
    public DateTime PLENPNFIGMP;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> KBKLLMLPIOJ;  // wrapper
...
{
    public Guid? PHGEIHMNJIC;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats EMBIFLGILBC;  // wrapper
}
...
{
    public Guid BMOHAEFDKGH;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<IEDIJABNPIF> BNOOPODAMDO;  // wrapper
...
{
    public DAOGGOGDMHJ HDFOPKJJKMJ;  // wrapper
}
