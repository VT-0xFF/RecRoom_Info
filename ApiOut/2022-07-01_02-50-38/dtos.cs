...
public class AAAMPLFFEGP
{
    public BIFKFOLPFKD <OMBHMIMPOMH>k__BackingField;    // 0x0x10
    public int <DPABAJMDKPK>k__BackingField;    // 0x0x14
    public long <ACNPHOKEGOC>k__BackingField;    // 0x0x18
    public bool <PDGPPMICBIF>k__BackingField;    // 0x0x20
    public string <GIFLEMDKODA>k__BackingField;    // 0x0x28
    public int? <NNMKECMEIDB>k__BackingField;    // 0x0x30
    public bool <OIOFMEGHHIP>k__BackingField;    // 0x0x38
    public bool <LLOFFFGIIIP>k__BackingField;    // 0x0x39
    public string <MDGLKFHFNPI>k__BackingField;    // 0x0x40
    public DateTime? <BADMPKOEOLE>k__BackingField;    // 0x0x48
    public float <NPENHBMHMFN>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// ABFMALKDOBG
//   (not directly referenced by a detected call)
public class ABFMALKDOBG
{
    public float <IKHMIPBDBFC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// AHFJIEGIEHA
//   RESPONSE GET    api/groups/v1/memberships/{eJCGNDMDIHH}   [Service.API]
public class AHFJIEGIEHA
{
    public long <PGJKEPHNCFO>k__BackingField;    // 0x0x10
    public int <FGJIEHJBHFM>k__BackingField;    // 0x0x18
    public KBABMFJPAKM <KCKNLLBBGBB>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// AHNAGDAMBME
//   (not directly referenced by a detected call)
public class AHNAGDAMBME
{
    public int <GBBPLMBJMHP>k__BackingField;    // 0x0x10
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x18
    public string <NIEHNHNKPBP>k__BackingField;    // 0x0x20
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x28
    public string <CMGMFMDHPAL>k__BackingField;    // 0x0x30
    public bool <NBHADGFFJKG>k__BackingField;    // 0x0x38
    public int <MILDOCDCPEM>k__BackingField;    // 0x0x3C
    public DMDHKCEHMBK <DPEDJIOENPN>k__BackingField;    // 0x0x40
    public LMELJIEJKMO MLNKJKDDHPE;    // 0x0x48
    public LMELJIEJKMO FGFFOADMIFH;    // 0x0x50
    public LMELJIEJKMO NAPNADNAMLI;    // 0x0x58
    public CKBAOAPCKIM ILPMENHLKLN;    // 0x0x60
}
...
// APGICNJEIOB
//   (not directly referenced by a detected call)
public class APGICNJEIOB
{
    public DateTime? <FJFAFOGJPNI>k__BackingField;    // 0x0x10
    public DateTime? <JAHPKPADOJA>k__BackingField;    // 0x0x20
    public ALFKEOJMODD <JGOMNBGHHPF>k__BackingField;    // 0x0x30
    public FEPHPJJEMCP <ENAPFMJFMID>k__BackingField;    // 0x0x38
    public bool <JNGJNECONHC>k__BackingField;    // 0x0x40
}
...
public class BFCGDOOGLHO
{
    public int <IKFBELPJDMG>k__BackingField;    // 0x0x10
    public int? <LABIPKCDNIL>k__BackingField;    // 0x0x14
    public string <BNDBMEJCDBD>k__BackingField;    // 0x0x20
    public string <CDMJDNACINF>k__BackingField;    // 0x0x28
}
...
public class CACGLIDEELL
{
    public int <DGCCNNBMPPB>k__BackingField;    // 0x0x10
    public Guid <IKEPOIKJDFI>k__BackingField;    // 0x0x14
    public long <IPMFGCGBKLL>k__BackingField;    // 0x0x28
    public long <LBMNDHPPIIH>k__BackingField;    // 0x0x30
    public DateTime <PAEFIPPPGLN>k__BackingField;    // 0x0x38
}
...
public class CCCJDPABKDL
{
    public BIFKFOLPFKD <OMBHMIMPOMH>k__BackingField;    // 0x0x10
    public long <FJEPAHEDMCO>k__BackingField;    // 0x0x18
    public string <HCJKNACOKIO>k__BackingField;    // 0x0x20
}
...
public class CDFIAKMOIHL : KJDEGCKLOAL
{
    public HLBAPOHNLEF? <IKMOELDOEPB>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <NMMICCOKMBI>k__BackingField;    // 0x0x20
}
...
public class CIHODGJMFAB
{
    public HTTPResponse BKCFICDJEAC;    // 0x0x10
    public int? CIIDECLEAKJ;    // 0x0x18
    public string IGFLLAJJDPJ;    // 0x0x20
    public byte[] MGIELFFHLII;    // 0x0x28
    public string EJOPLADJGFH;    // 0x0x30
}
...
public class CILNFEBNHAH : KJDEGCKLOAL
{
    public BDDCPLKDIID? <IKMOELDOEPB>k__BackingField;    // 0x0x18
    public FOJHGGAEMFJ <JKLKDELJCBP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CNCLFBICFPO
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class CNCLFBICFPO
{
    public int <BOFNGPKBONG>k__BackingField;    // 0x0x10
    public int <BLNCPPLOHMO>k__BackingField;    // 0x0x14
    public float <NBAEKLLIDJC>k__BackingField;    // 0x0x18
    public float <APFALENBJDI>k__BackingField;    // 0x0x1C
    public bool <BEFFPHKCPKN>k__BackingField;    // 0x0x20
    public bool <FLGLCFOAGOM>k__BackingField;    // 0x0x21
    public bool <LNHLHILCICL>k__BackingField;    // 0x0x22
}
...
// CPDMHBIOJJO
//   (not directly referenced by a detected call)
public class CPDMHBIOJJO
{
    public int <NBCKIBMGBIJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DBHLAODLCEC
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class DBHLAODLCEC
{
    public CADOGIIPHGP <MPDDMCPOOLP>k__BackingField;    // 0x0x10
    public List<string> <PBODNOPPABD>k__BackingField;    // 0x0x18
}
...
public class DGHKMMBCBPB
{
    public MAKHGOHCLIN <MPDDMCPOOLP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DMDHKCEHMBK
//   (not directly referenced by a detected call)
public class DMDHKCEHMBK
{
    // (no instance fields in the metadata dump)
}
...
// DMJANHDGIGH
//   (not directly referenced by a detected call)
public class DMJANHDGIGH
{
    public long <AGOOEMGHGCO>k__BackingField;    // 0x0x10
    public string <IAJOBFOCIOP>k__BackingField;    // 0x0x18
    public int <HBKBCNHPEDE>k__BackingField;    // 0x0x20
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x28
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x30
    public string <PPOBGKPDJOM>k__BackingField;    // 0x0x38
    public int <ODPAHKIDPAH>k__BackingField;    // 0x0x40
    public GMPNMAPMBMN <MMHPKGJKBPF>k__BackingField;    // 0x0x44
    public DateTime <PMICKHBFDEH>k__BackingField;    // 0x0x48
    public DateTime <KANMELCMCEF>k__BackingField;    // 0x0x50
    public DateTime? <KLEKBGBDMKC>k__BackingField;    // 0x0x58
    public long? <FGKGOLDCLEK>k__BackingField;    // 0x0x68
    public int <DJNKCNGDJKG>k__BackingField;    // 0x0x78
    public int <CNDKNNGBOJD>k__BackingField;    // 0x0x7C
    public int <OFBEAINFOLA>k__BackingField;    // 0x0x80
    public EFOLLFMJPPK <OPHODBOBMFM>k__BackingField;    // 0x0x84
    public EFOLLFMJPPK <BPFKAKBEMFL>k__BackingField;    // 0x0x88
    public bool <JPILHCCOCED>k__BackingField;    // 0x0x8C
    public bool <AOEMMAPFKHB>k__BackingField;    // 0x0x8D
    public bool <DLAFNCCOACJ>k__BackingField;    // 0x0x8E
    public int? <PDGCPPDNCAJ>k__BackingField;    // 0x0x90
    public bool <LIFGLAPABBI>k__BackingField;    // 0x0x98
}
...
public class DPJLPBHAGEA
{
    public int <NBEGJOLANHN>k__BackingField;    // 0x0x10
    public List<APGICNJEIOB> <FKKHFDCOCBP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EEOGGBCAGGN
//   REQUEST  POST   api/customAvatarItems/v1/{customAvatarItemId}/report   [Service.API]
public class EEOGGBCAGGN
{
    public BGHCBNILIBH <OMBHMIMPOMH>k__BackingField;    // 0x0x10
    public string <HCJKNACOKIO>k__BackingField;    // 0x0x18
}
...
public class EHHLCHDLNJN
{
    public int <BLNCPPLOHMO>k__BackingField;    // 0x0x10
    public bool <BEFFPHKCPKN>k__BackingField;    // 0x0x14
    public DateTime <JOOEKPENKDO>k__BackingField;    // 0x0x18
    public bool <KBKHFMMBPLP>k__BackingField;    // 0x0x20
}
...
public class EJLODKHGIGB
{
    public long <FJEPAHEDMCO>k__BackingField;    // 0x0x10
    public DOHELBFGPHH <HJONEPFEIBI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EKBMOAOJLCF
//   (not directly referenced by a detected call)
public class EKBMOAOJLCF
{
    public long <OCKFMONGPFC>k__BackingField;    // 0x0x10
    public long <FJEPAHEDMCO>k__BackingField;    // 0x0x18
    public int <FGJIEHJBHFM>k__BackingField;    // 0x0x20
    public DateTime <KANMELCMCEF>k__BackingField;    // 0x0x28
    public DOHELBFGPHH <HJONEPFEIBI>k__BackingField;    // 0x0x30
}
...
public class EPONONFFIKA
{
    public List<string> <GPBHMEADCAG>k__BackingField;    // 0x0x10
    public List<string> <CDJCDCBKODJ>k__BackingField;    // 0x0x18
    public List<string> <PPMKKGLFJMP>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// FDMDKKLKKLO
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{bKOGMFPFOOA}   [Service.API]
public class FDMDKKLKKLO
{
    public uint <BHJGGBGPLNL>k__BackingField;    // 0x0x10
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x18
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x20
    public DateTime <MEIJMIDDLOB>k__BackingField;    // 0x0x28
    public DateTime? <EOMMEHEJCED>k__BackingField;    // 0x0x30
    public bool <MMFJFAHJGHF>k__BackingField;    // 0x0x40
    public List<GHGBABCJNNP> <LHICLAFOMDH>k__BackingField;    // 0x0x48
    public List<string> <PBODNOPPABD>k__BackingField;    // 0x0x50
    public int <DMMBPMPNIKL>k__BackingField;    // 0x0x58
    public int <IKDNFFHMJFO>k__BackingField;    // 0x0x5C
    public int <NFIOPEGKKJP>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// FEPHPJJEMCP
//   (not directly referenced by a detected call)
public class FEPHPJJEMCP
{
    public int <MPFHJPGJNAA>k__BackingField;    // 0x0x10
    public int <HEMLKLPAFKH>k__BackingField;    // 0x0x14
    public int <POCHEFIGOIE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FIJFGAKMACE
//   (not directly referenced by a detected call)
public class FIJFGAKMACE
{
    public bool <DFPGDELADHP>k__BackingField;    // 0x0x10
    public MPEHCGLGBPP <KLKMFMFJMDC>k__BackingField;    // 0x0x18
    public float <HAOCLHOCAOP>k__BackingField;    // 0x0x20
}
...
public class FOJHGGAEMFJ
{
    public int <DGCCNNBMPPB>k__BackingField;    // 0x0x10
    public Guid <IKEPOIKJDFI>k__BackingField;    // 0x0x14
    public long <IPMFGCGBKLL>k__BackingField;    // 0x0x28
    public DateTime <PMICKHBFDEH>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GBCOGJFMFEM
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class GBCOGJFMFEM
{
    public int <DHHLNBMJOJK>k__BackingField;    // 0x0x10
    public string <INEGKFGFGEI>k__BackingField;    // 0x0x18
    public List<AHNAGDAMBME> <GCMIEPOMAMI>k__BackingField;    // 0x0x20
    public JBIIBCJLKAI <JPJCMDCLIGH>k__BackingField;    // 0x0x28
    public string <LMOAHFILBCN>k__BackingField;    // 0x0x30
    public DateTime <OAHOBKPAGHJ>k__BackingField;    // 0x0x38
    public DateTime <EBCFABJAOGE>k__BackingField;    // 0x0x40
    public DateTime <HGCLLPDHAGE>k__BackingField;    // 0x0x48
    public bool? <HELNDGAAEIP>k__BackingField;    // 0x0x50
}
...
// GDKFLIKICMG
//   (not directly referenced by a detected call)
public class GDKFLIKICMG
{
    public long <AGOOEMGHGCO>k__BackingField;    // 0x0x10
    public string <IAJOBFOCIOP>k__BackingField;    // 0x0x18
    public int <CHIMNFLMBDF>k__BackingField;    // 0x0x20
    public int <HMLENEAIJKO>k__BackingField;    // 0x0x24
    public int <MLODAIIIFGD>k__BackingField;    // 0x0x28
    public int <FDKPNEMLGEI>k__BackingField;    // 0x0x2C
    public int <DJMPKJLMPLL>k__BackingField;    // 0x0x30
    public string <MKLGIKJFMFC>k__BackingField;    // 0x0x38
    public string <LMIBOIFLPDA>k__BackingField;    // 0x0x40
}
...
public class GEDFPBLGOCL
{
    public bool <EDHNFGCFLHE>k__BackingField;    // 0x0x10
    public string <GIFLEMDKODA>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// GHGBABCJNNP
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{bKOGMFPFOOA}   [Service.API]
public class GHGBABCJNNP
{
    public string <BHJGGBGPLNL>k__BackingField;    // 0x0x10
    public string <JLODNOBBIDA>k__BackingField;    // 0x0x18
    public string <PKBLOOHGJGO>k__BackingField;    // 0x0x20
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x28
    public string <PHMJGBILDEJ>k__BackingField;    // 0x0x30
    public LJIGGPFLLND <JGOMNBGHHPF>k__BackingField;    // 0x0x38
    public List<string> <CCIDEHNFCCH>k__BackingField;    // 0x0x40
    public List<string> <PBODNOPPABD>k__BackingField;    // 0x0x48
    public string <BJJNLIOJMKC>k__BackingField;    // 0x0x50
    public List<HLKBKMBIGDO> <EAOOMFJBAKO>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// GICDAINBCAK
//   (not directly referenced by a detected call)
public class GICDAINBCAK
{
    public float <AGBHIIMDEHN>k__BackingField;    // 0x0x10
    public float <BLBMCFDJHGP>k__BackingField;    // 0x0x14
    public float <GOPLCJIBHEI>k__BackingField;    // 0x0x18
    public float <MFEDFDGDLHJ>k__BackingField;    // 0x0x1C
    public float <FDHCOAINDPC>k__BackingField;    // 0x0x20
    public float <GCCAFLMIEAE>k__BackingField;    // 0x0x24
    public float <CAIMKHCFNID>k__BackingField;    // 0x0x28
    public float <FKDKNINDGMC>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// GIDLPLJCOAN
//   (not directly referenced by a detected call)
public class GIDLPLJCOAN
{
    public int <EJOPIBNNOGM>k__BackingField;    // 0x0x10
    public HEPNOIJGMLJ <HJONEPFEIBI>k__BackingField;    // 0x0x14
    public List<IKOAGBNGMKM> <HFIKKAFLAKH>k__BackingField;    // 0x0x18
    public List<IKOAGBNGMKM> <OMIKPMPGLMF>k__BackingField;    // 0x0x20
    public bool <NLFBKOJHOLG>k__BackingField;    // 0x0x28
    public DateTime? <AMDDMIAPEGN>k__BackingField;    // 0x0x30
    public DateTime? <OAAFDMPDGIA>k__BackingField;    // 0x0x40
    public DateTime? <PJPPAMGLNOI>k__BackingField;    // 0x0x50
}
...
public class GJHEIAMHDBC
{
    public string <PPOBGKPDJOM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GNLCAKJFEJJ
//   (not directly referenced by a detected call)
public class GNLCAKJFEJJ
{
    public LNIBKLPAAED <NIEAPNFCFNB>k__BackingField;    // 0x0x10
    public EKBMOAOJLCF <BOKJLOBOHGK>k__BackingField;    // 0x0x18
}
...
public class GPLLJFHHDEF
{
    public Guid <IKEPOIKJDFI>k__BackingField;    // 0x0x10
    public long? <FHKKONLMLCO>k__BackingField;    // 0x0x20
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x30
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x38
    public CNMLFGBMPCO <NHCJJCMCBHP>k__BackingField;    // 0x0x40
    public long <ANCPAMJHFFC>k__BackingField;    // 0x0x48
    public string <PPOBGKPDJOM>k__BackingField;    // 0x0x50
    public DateTime <KANMELCMCEF>k__BackingField;    // 0x0x58
    public DateTime <PMICKHBFDEH>k__BackingField;    // 0x0x60
}
...
public class GPNBAKMGIFM
{
    public Guid <JPIFEMPPOHB>k__BackingField;    // 0x0x10
    public int <IKFBELPJDMG>k__BackingField;    // 0x0x20
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x28
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x30
    public int <PDGCPPDNCAJ>k__BackingField;    // 0x0x38
    public GMPNMAPMBMN <MMHPKGJKBPF>k__BackingField;    // 0x0x3C
    public bool <NLFBKOJHOLG>k__BackingField;    // 0x0x40
    public int? <LABIPKCDNIL>k__BackingField;    // 0x0x44
    public string <CDMJDNACINF>k__BackingField;    // 0x0x50
    public string <BNDBMEJCDBD>k__BackingField;    // 0x0x58
    public string <JJDCLJPNDJC>k__BackingField;    // 0x0x60
    public DateTime <KANMELCMCEF>k__BackingField;    // 0x0x68
    public DateTime <PMICKHBFDEH>k__BackingField;    // 0x0x70
}
...
public class HKGLNNKCPOM
{
    public int <MILDOCDCPEM>k__BackingField;    // 0x0x10
    public string <MMLLJEODNHH>k__BackingField;    // 0x0x18
    public string <KEIEMFBGFCH>k__BackingField;    // 0x0x20
    public string <IBEGPFNJIKC>k__BackingField;    // 0x0x28
    public string <LPECCAMFNDN>k__BackingField;    // 0x0x30
    public string <PCBACMFNCMH>k__BackingField;    // 0x0x38
    public string <GCIMAJDIFCE>k__BackingField;    // 0x0x40
    public List<LHKGAOLKFNN> <LNOAIFBPBCB>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// HLKBKMBIGDO
//   (not directly referenced by a detected call)
public class HLKBKMBIGDO
{
    public DateTime <KANMELCMCEF>k__BackingField;    // 0x0x10
    public string <ABBPGGMKEFO>k__BackingField;    // 0x0x18
}
...
// HOCDHJPCGFA
//   (not directly referenced by a detected call)
public class HOCDHJPCGFA
{
    public GGOMJIFDFGM EGIKPOLGBHH;    // 0x0x10
    public int FANGDDOCMOM;    // 0x0x14
}
...
//   RESPONSE GET    api/playerevents/v1/all/{jNGECMMJHBF}   [Service.API]
public class HPGMHCKNHPN
{
    public List<LNIBKLPAAED> <EGFOCJOLJBM>k__BackingField;    // 0x0x10
    public List<GNLCAKJFEJJ> <GMKJKOJNOEA>k__BackingField;    // 0x0x18
}
...
public class IAIIDLJDMOI
{
    public long <FHKKONLMLCO>k__BackingField;    // 0x0x10
    public long? <DKKLEBGFCGD>k__BackingField;    // 0x0x18
    public long? <CJCKINOLLBJ>k__BackingField;    // 0x0x28
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x38
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x40
    public List<string> <PBODNOPPABD>k__BackingField;    // 0x0x48
    public string <PPOBGKPDJOM>k__BackingField;    // 0x0x50
    public DateTime <LNBEMPICGPB>k__BackingField;    // 0x0x58
    public DateTime <OELCAEFIEAP>k__BackingField;    // 0x0x60
    public MEIHOPKFGDD <MMHPKGJKBPF>k__BackingField;    // 0x0x68
    public bool <APLHIFKCNKJ>k__BackingField;    // 0x0x6C
    public bool <LCJPFABABIH>k__BackingField;    // 0x0x6D
    public LHKNNBADHPE <HEHCFMBKLFD>k__BackingField;    // 0x0x70
    public LHKNNBADHPE <EELJNAFBPHH>k__BackingField;    // 0x0x74
}
...
public class IHICCGBLODE
{
    public List<MLMAGKGHLOF> <GNADDLFNKPK>k__BackingField;    // 0x0x10
    public string <FGEKIHLJCPI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IHNNHHMBPCP
//   (not directly referenced by a detected call)
public class IHNNHHMBPCP
{
    public int <HPIDDBIDBBG>k__BackingField;    // 0x0x10
    public MAKHGOHCLIN <MPDDMCPOOLP>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// IHOEBDMJJJL
//   RESPONSE GET    api/inventions/v1/personaldetails/{bFLJEMFCAPH}   [Service.API]
public class IHOEBDMJJJL
{
    public bool <ACHJNHBHCJL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IICAOKMCDFI
//   (not directly referenced by a detected call)
public class IICAOKMCDFI
{
    public Guid <DLNKKHFKMDE>k__BackingField;    // 0x0x10
    public long <FHKKONLMLCO>k__BackingField;    // 0x0x20
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x28
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x30
    public string <PPOBGKPDJOM>k__BackingField;    // 0x0x38
    public long <PDGCPPDNCAJ>k__BackingField;    // 0x0x40
    public Guid? <EDLHMHNOLLD>k__BackingField;    // 0x0x48
    public DateTime <PMICKHBFDEH>k__BackingField;    // 0x0x60
}
...
public class IKFIKKFGIIB
{
    public List<int> <MMKMIFPJLMJ>k__BackingField;    // 0x0x10
    public string <FGEKIHLJCPI>k__BackingField;    // 0x0x18
}
...
// IKLICOMKJPG
//   (not directly referenced by a detected call)
public class IKLICOMKJPG
{
    public bool <DBIACDJLGCM>k__BackingField;    // 0x0x10
    public JACPAPIKAGE <IMALHFBPGJH>k__BackingField;    // 0x0x14
    public int <ELNMHPKCINO>k__BackingField;    // 0x0x18
    public DateTime <PMICKHBFDEH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IKOAGBNGMKM
//   (not directly referenced by a detected call)
public class IKOAGBNGMKM
{
    public CNMLFGBMPCO <NHCJJCMCBHP>k__BackingField;    // 0x0x10
    public int <PDGCPPDNCAJ>k__BackingField;    // 0x0x14
    public MJLCBFDILJB <OBNPKCGEDBD>k__BackingField;    // 0x0x18
}
...
public class IPAONNBHIAI
{
    public HNKGGEIBFFN <JGOMNBGHHPF>k__BackingField;    // 0x0x10
    public DMJANHDGIGH <EEFOOJLDBAD>k__BackingField;    // 0x0x18
    public GDKFLIKICMG <LLPPLJFHOND>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IPNGCLJGFJN
// base   : DNPDBLJPMDG<GPNBAKMGIFM>
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{gEPOPFBDBJI}   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v2/fromCreator/{gEPOPFBDBJI}   [Service.API]
public class IPNGCLJGFJN
{
    // (no instance fields in the metadata dump)
}
...
// JAAFOHMIBLN
//   (not directly referenced by a detected call)
public class JAAFOHMIBLN
{
    public long <PDGCPPDNCAJ>k__BackingField;    // 0x0x10
    public Guid? <IKEPOIKJDFI>k__BackingField;    // 0x0x18
}
...
// JBIIBCJLKAI
//   (not directly referenced by a detected call)
public class JBIIBCJLKAI
{
    public long <DDAINNJNLLD>k__BackingField;    // 0x0x10
    public string <MFECANFHJEP>k__BackingField;    // 0x0x18
    public string <BGMGNNDKOOM>k__BackingField;    // 0x0x20
    public OBMGLOCLBHB? <GDDAEOGGONF>k__BackingField;    // 0x0x28
    public string <HPPPOCFBBHO>k__BackingField;    // 0x0x30
    public string <DFCONNPEKIO>k__BackingField;    // 0x0x38
    public KDCHFHHDKEN <DONOJEEJMAA>k__BackingField;    // 0x0x40
    public int <EIBCHGMKPCL>k__BackingField;    // 0x0x44
    public int <AIDGMGLJHBN>k__BackingField;    // 0x0x48
    public EHFJPEANBFN? <APOBOBNJFGL>k__BackingField;    // 0x0x4C
    public NIAFOILGOJI? <CKINDMAMGGF>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// JEIFDKOKAFK
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class JEIFDKOKAFK
{
    public FOJHGGAEMFJ <JKLKDELJCBP>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <NMMICCOKMBI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JEJIJKMINKF
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class JEJIJKMINKF
{
    public int <DPABAJMDKPK>k__BackingField;    // 0x0x10
}
...
public class JJMEIBPAHCH
{
    public long <PGJKEPHNCFO>k__BackingField;    // 0x0x10
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x18
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x20
    public DateTime <KANMELCMCEF>k__BackingField;    // 0x0x28
    public string <PPOBGKPDJOM>k__BackingField;    // 0x0x30
    public CGDFKDBBGKM <HGLNIHIBLIB>k__BackingField;    // 0x0x38
    public int <BNIKMFDJKNM>k__BackingField;    // 0x0x3C
    public int <ILDEMBCBHPG>k__BackingField;    // 0x0x40
    public List<AHFJIEGIEHA> <MGILGNKNIOG>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// JLBNLOHFLBM
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/consume   [Service.API]
public class JLBNLOHFLBM
{
    public Guid? <ADOPAPBBOLO>k__BackingField;    // 0x0x10
    public Guid <GIKCFPPMBAP>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// JLEKLFEGNLF
//   (not directly referenced by a detected call)
public class JLEKLFEGNLF
{
    public long <BDOKMNNKFIL>k__BackingField;    // 0x0x10
    public Guid <IAJOBFOCIOP>k__BackingField;    // 0x0x18
    public long <FHKKONLMLCO>k__BackingField;    // 0x0x28
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x30
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x38
    public int <PDGCPPDNCAJ>k__BackingField;    // 0x0x40
    public Guid? <EDLHMHNOLLD>k__BackingField;    // 0x0x44
    public DateTime <KANMELCMCEF>k__BackingField;    // 0x0x58
    public string <PPOBGKPDJOM>k__BackingField;    // 0x0x60
}
...
//   RESPONSE GET    api/avatar/v2/{jNGECMMJHBF}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{jNGECMMJHBF}   [Service.API]
public class JLGKAJBGINJ
{
    public string <KEIEMFBGFCH>k__BackingField;    // 0x0x10
    public string <IBEGPFNJIKC>k__BackingField;    // 0x0x18
    public string <LPECCAMFNDN>k__BackingField;    // 0x0x20
    public string <PCBACMFNCMH>k__BackingField;    // 0x0x28
    public string <GCIMAJDIFCE>k__BackingField;    // 0x0x30
    public List<LHKGAOLKFNN> <LNOAIFBPBCB>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// JMPGAJFCHAP
//   (not directly referenced by a detected call)
public class JMPGAJFCHAP
{
    public int <PMLCBCBEOBF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KAMOJLLGNLF
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class KAMOJLLGNLF
{
    public Guid <MJDGJFDFHEA>k__BackingField;    // 0x0x10
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x20
    public string <PPOBGKPDJOM>k__BackingField;    // 0x0x28
    public DateTime <OAHOBKPAGHJ>k__BackingField;    // 0x0x30
    public DateTime? <ADNDDDNGFJP>k__BackingField;    // 0x0x38
    public List<LNGBNBCMEIK> <JPEDGPAELAI>k__BackingField;    // 0x0x48
}
...
public class KENAOKEGOIJ
{
    public string <GICPIBDEBNK>k__BackingField;    // 0x0x10
    public string <CNIGMDGJFFC>k__BackingField;    // 0x0x18
    public bool <CEGJCFEEDID>k__BackingField;    // 0x0x20
    public string <GALDIPNBCPJ>k__BackingField;    // 0x0x28
}
...
public class KMHMBANAPHC
{
    public Dictionary<int, int> <JGHCGPNLHDJ>k__BackingField;    // 0x0x10
    public List<EFOCJLAMLEC> <JCKFIKJAGCA>k__BackingField;    // 0x0x18
    public HOCDHJPCGFA[][] <LCMDKGJKNIA>k__BackingField;    // 0x0x20
    public CPDMHBIOJJO <PPFKCCFLOCH>k__BackingField;    // 0x0x28
    public GICDAINBCAK <FNIPPEJBGMO>k__BackingField;    // 0x0x30
    public JMPGAJFCHAP <IAACBCGPLHG>k__BackingField;    // 0x0x38
    public NBBICCCKHJN <BKLOBEFPAPJ>k__BackingField;    // 0x0x40
    public ABFMALKDOBG <KJAJDPJEEKI>k__BackingField;    // 0x0x48
    public string <ECDCPMMOIIB>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// KMPGBHBIOHA
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class KMPGBHBIOHA
{
    public int? <BPFGGBKOGHK>k__BackingField;    // 0x0x10
    public string <PHMJGBILDEJ>k__BackingField;    // 0x0x18
    public string <LJDFKFLJBHF>k__BackingField;    // 0x0x20
}
...
public class KPGIBMAADMN
{
    public bool <EDHNFGCFLHE>k__BackingField;    // 0x0x10
    public string <HHPLAJBDKID>k__BackingField;    // 0x0x18
}
...
public class LBIMJMAHJOO
{
    public Guid <FFLDCHFFPCP>k__BackingField;    // 0x0x10
    public Guid <IKEPOIKJDFI>k__BackingField;    // 0x0x20
    public int <DDHONKKJOFC>k__BackingField;    // 0x0x30
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x38
    public long <KJCGDEEKHJM>k__BackingField;    // 0x0x40
    public long <PDGCPPDNCAJ>k__BackingField;    // 0x0x48
    public DateTime <PMICKHBFDEH>k__BackingField;    // 0x0x50
}
...
public class LFFOAKPMDPK
{
    public EIKNHDPGAFI <JGOMNBGHHPF>k__BackingField;    // 0x0x10
    public JLEKLFEGNLF <DIALECCPNAI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LHKGAOLKFNN
//   (not directly referenced by a detected call)
public class LHKGAOLKFNN
{
    public Guid <JPIFEMPPOHB>k__BackingField;    // 0x0x10
    public byte <FCBIOCHPOBJ>k__BackingField;    // 0x0x20
}
...
public class LKJMKFPLNLN
{
    public Guid? <DLNKKHFKMDE>k__BackingField;    // 0x0x10
    public long? <FHKKONLMLCO>k__BackingField;    // 0x0x28
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x38
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x40
    public string <PPOBGKPDJOM>k__BackingField;    // 0x0x48
    public JAAFOHMIBLN <CEILHIMMGPP>k__BackingField;    // 0x0x50
}
...
public class LLHEFDNNDGL
{
    public List<IHNNHHMBPCP> <EIAKBHDHJPH>k__BackingField;    // 0x0x10
    public MAKHGOHCLIN <MPDDMCPOOLP>k__BackingField;    // 0x0x18
}
...
public class LNEPOKKAPKD
{
    public JLBNLOHFLBM <PKIPHDDBLHE>k__BackingField;    // 0x0x10
    public JAAFOHMIBLN <MJNNKMFAECG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LNGBNBCMEIK
//   (not directly referenced by a detected call)
public class LNGBNBCMEIK
{
    public Guid <AOOHCCODDGO>k__BackingField;    // 0x0x10
    public Guid <EOMCJPBMMAD>k__BackingField;    // 0x0x20
    public DateTime <OAHOBKPAGHJ>k__BackingField;    // 0x0x30
    public List<MPEHCGLGBPP> <GOFMEJAFNFP>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// LNIBKLPAAED
//   (not directly referenced by a detected call)
public class LNIBKLPAAED
{
    public long <FJEPAHEDMCO>k__BackingField;    // 0x0x10
    public int <HBKBCNHPEDE>k__BackingField;    // 0x0x18
    public long <FHKKONLMLCO>k__BackingField;    // 0x0x20
    public long? <DKKLEBGFCGD>k__BackingField;    // 0x0x28
    public long? <CJCKINOLLBJ>k__BackingField;    // 0x0x38
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x48
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x50
    public string <PPOBGKPDJOM>k__BackingField;    // 0x0x58
    public DateTime <LNBEMPICGPB>k__BackingField;    // 0x0x60
    public DateTime <OELCAEFIEAP>k__BackingField;    // 0x0x68
    public int <CCECCHBEBMB>k__BackingField;    // 0x0x70
    public MEIHOPKFGDD <MMHPKGJKBPF>k__BackingField;    // 0x0x74
    public bool <APLHIFKCNKJ>k__BackingField;    // 0x0x78
    public bool <LCJPFABABIH>k__BackingField;    // 0x0x79
    public LHKNNBADHPE <HEHCFMBKLFD>k__BackingField;    // 0x0x7C
    public LHKNNBADHPE <EELJNAFBPHH>k__BackingField;    // 0x0x80
    public long? <PCLLLFKLCOO>k__BackingField;    // 0x0x88
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{hPMCCIAFOHF}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{hPMCCIAFOHF}   [Service.API]
...
public class MDACFPHDMHL
{
    public BDAEFHDCKAM <JGOMNBGHHPF>k__BackingField;    // 0x0x10
    public IICAOKMCDFI <GJAOCOIFBIJ>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{kAJFPAFLIDI}   [Service.API]
public class MDJOJEDAKKI
{
    public long <FHKKONLMLCO>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <OEPNLABIKCC>k__BackingField;    // 0x0x18
    public IDCGIPOPJLN <CHNABGOEMAO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MEDLCILBOML
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{cHNACHJJPIJ}   [Service.API]
...
public class MEDLCILBOML
{
    public LNIBKLPAAED <NIEAPNFCFNB>k__BackingField;    // 0x0x10
    public MAKHGOHCLIN <MPDDMCPOOLP>k__BackingField;    // 0x0x18
    public DBHLAODLCEC <MJMOJLDMGNE>k__BackingField;    // 0x0x20
}
...
public class MEGNPJFOCEK
{
    public int <DFLFEAAOJPO>k__BackingField;    // 0x0x10
    public DECLLJNINIH <HJONEPFEIBI>k__BackingField;    // 0x0x14
    public HLAJEBOPAOO <DBJOFPLGBFI>k__BackingField;    // 0x0x18
    public HLAJEBOPAOO <IBLOJHHIDAJ>k__BackingField;    // 0x0x1C
    public HLAJEBOPAOO <KKCKGKOHOBP>k__BackingField;    // 0x0x20
}
...
// MJLCBFDILJB
//   (not directly referenced by a detected call)
public class MJLCBFDILJB
{
    public int <BGBHCPPAKGD>k__BackingField;    // 0x0x10
    public DateTime? <LNAPLMIMMNO>k__BackingField;    // 0x0x18
    public DateTime? <OCFOKKAAFGH>k__BackingField;    // 0x0x28
}
...
// base   : GIDLPLJCOAN
//   (not directly referenced by a detected call)
public class MKKCIMFIPKA : GIDLPLJCOAN
{
    public MPEHCGLGBPP <KLKMFMFJMDC>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// MLMAGKGHLOF
//   (not directly referenced by a detected call)
public class MLMAGKGHLOF
{
    public int <BKEMLKMHMCD>k__BackingField;    // 0x0x10
    public DateTime <KANMELCMCEF>k__BackingField;    // 0x0x18
    public DateTime? <BPOMDBGEIMD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MPEHCGLGBPP
//   (not directly referenced by a detected call)
public class MPEHCGLGBPP
{
    public int <DDAINNJNLLD>k__BackingField;    // 0x0x10
    public string <CIEEFOFBAEJ>k__BackingField;    // 0x0x18
    public string <CMGMFMDHPAL>k__BackingField;    // 0x0x20
    public string <MFECANFHJEP>k__BackingField;    // 0x0x28
    public string <HICNMKHCKLL>k__BackingField;    // 0x0x30
    public OBMGLOCLBHB? <GDDAEOGGONF>k__BackingField;    // 0x0x38
    public string <HPPPOCFBBHO>k__BackingField;    // 0x0x40
    public string <DFCONNPEKIO>k__BackingField;    // 0x0x48
    public bool <LNJOOABONGK>k__BackingField;    // 0x0x50
    public bool <FLJPHJANALC>k__BackingField;    // 0x0x51
    public bool <EHODGMOPCJC>k__BackingField;    // 0x0x52
    public NIAFOILGOJI <JGHKCOLHOEC>k__BackingField;    // 0x0x54
    public CNMLFGBMPCO <NHCJJCMCBHP>k__BackingField;    // 0x0x58
    public int <HHPOMFJPBBB>k__BackingField;    // 0x0x5C
    public GODFPMOIOID <DECMJHBKNFP>k__BackingField;    // 0x0x60
    public EHFJPEANBFN <HOLGDOMCKCI>k__BackingField;    // 0x0x64
    public int? <PHJKLENGNHE>k__BackingField;    // 0x0x68
    public string <PPPLOGJMOOI>k__BackingField;    // 0x0x70
}
...
// NBBICCCKHJN
//   (not directly referenced by a detected call)
public class NBBICCCKHJN
{
    public int <IIOPFOJCKFB>k__BackingField;    // 0x0x10
}
...
public class NKFNFLLFHPH : DDDIJCOGOCM
{
    public int <KBFMPNLLDFN>k__BackingField;    // 0x0x30
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x38
    public DateTime <OAHOBKPAGHJ>k__BackingField;    // 0x0x40
    public DateTime <EBCFABJAOGE>k__BackingField;    // 0x0x48
    public CNMLFGBMPCO <NHCJJCMCBHP>k__BackingField;    // 0x0x50
    public GIDLPLJCOAN <LBFOGGFCMIN>k__BackingField;    // 0x0x58
    public List<PKPAEGKJIBC> <OMOJHIPJJKB>k__BackingField;    // 0x0x60
    public IKLICOMKJPG <DIOEHBBLMPC>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// NMDHIDFJGMG
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class NMDHIDFJGMG
{
    public List<PBJEGFFPKMB> <PBODNOPPABD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OGPBOEMAAKM
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/description   [Service.API]
public class OGPBOEMAAKM
{
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OOCPOKCMJIE
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{hOHGMGPLIKN}   [Service.API]
public class OOCPOKCMJIE
{
    public Guid <HHJINJEOJFJ>k__BackingField;    // 0x0x10
    public int <DGCCNNBMPPB>k__BackingField;    // 0x0x20
    public int <EJOPIBNNOGM>k__BackingField;    // 0x0x24
    public DateTime <KANMELCMCEF>k__BackingField;    // 0x0x28
}
...
// OPKINGIOFDO
//   (not directly referenced by a detected call)
public class OPKINGIOFDO
{
    public Guid <DLNKKHFKMDE>k__BackingField;    // 0x0x10
    public int <DGCCNNBMPPB>k__BackingField;    // 0x0x20
    public int <HBDKFPAJFLN>k__BackingField;    // 0x0x24
    public Guid <BPJIGOGEFIK>k__BackingField;    // 0x0x28
    public DateTime <PMICKHBFDEH>k__BackingField;    // 0x0x38
    public IICAOKMCDFI <GJAOCOIFBIJ>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PAEHMEFMLEN
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class PAEHMEFMLEN
{
    public CNMLFGBMPCO <NHCJJCMCBHP>k__BackingField;    // 0x0x10
    public LKNIELGDNOC <MAMCOPJFOII>k__BackingField;    // 0x0x14
    public int <CLHBNPMPELN>k__BackingField;    // 0x0x18
    public int <OFDMMJDGGDM>k__BackingField;    // 0x0x1C
    public int <MFLNJKGFPHP>k__BackingField;    // 0x0x20
    public GBNBOAJEPAF <DMLLECKHFBJ>k__BackingField;    // 0x0x24
    public bool <ABOAFLCPKAD>k__BackingField;    // 0x0x28
    public float <NMJGGGILLCO>k__BackingField;    // 0x0x2C
    public int <ODDJNGGHBDO>k__BackingField;    // 0x0x30
    public bool <HOBOELINBLN>k__BackingField;    // 0x0x34
}
...
public class PALGIHDNEAG : DDDIJCOGOCM
{
    public List<MKKCIMFIPKA> LPBGNFIGCKK;    // 0x0x30
    public int <JCKENMIAEHH>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// PBJEGFFPKMB
//   (not directly referenced by a detected call)
public class PBJEGFFPKMB
{
    public string <EJLNAHIBAEL>k__BackingField;    // 0x0x10
    public GIMLJPCBHLF <HJONEPFEIBI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PCCKMNPPCDH
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/name   [Service.API]
public class PCCKMNPPCDH
{
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PDGKAEEGAAJ
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/price   [Service.API]
public class PDGKAEEGAAJ
{
    public JAAFOHMIBLN <CEILHIMMGPP>k__BackingField;    // 0x0x10
}
...
public class PIECABHPIEN
{
    public BDAEFHDCKAM <JGOMNBGHHPF>k__BackingField;    // 0x0x10
    public OPKINGIOFDO <JCACLEEDKLC>k__BackingField;    // 0x0x18
}
...
// base   : GIDLPLJCOAN
//   (not directly referenced by a detected call)
public class PKPAEGKJIBC : GIDLPLJCOAN
{
    public int <IGOEJPNPIAK>k__BackingField;    // 0x0x60
    public List<FIJFGAKMACE> <KLBKOJOEFBF>k__BackingField;    // 0x0x68
    public List<FIJFGAKMACE> <GNCPPPNAIGN>k__BackingField;    // 0x0x70
    public List<FIJFGAKMACE> <GFOJNBEDPJI>k__BackingField;    // 0x0x78
}
...
{
    public EECOENBMGDE <MPDDMCPOOLP>k__BackingField;    // 0x0x10
    public string <NIHNIFLPAJN>k__BackingField;    // 0x0x18
    public string <MKKAABLPHMO>k__BackingField;    // 0x0x20
    public string <KLIBKANKCGM>k__BackingField;    // 0x0x28
}
...
{
    public long <FJEPAHEDMCO>k__BackingField;    // 0x0x10
    public long? <PDFFFAOBKBD>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public MCHFKPIFHEN FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public EHFJPEANBFN <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public LAOFIDANAAI creatorAccountRole;    // 0x0x58
}
...
{
    public HCGKOLJIDJN <GPFMLFPCCKJ>k__BackingField;    // 0x0x10
    public JKHKHLKCNIM <ALKKAAHCFKG>k__BackingField;    // 0x0x14
    public string <FPFEJCEFANP>k__BackingField;    // 0x0x18
    public string <LDFICOKPLDF>k__BackingField;    // 0x0x20
    public bool <GCCMBMDPFJL>k__BackingField;    // 0x0x28
}
...
{
    public List<HCGKOLJIDJN> <LJOLOLBIJHN>k__BackingField;    // 0x0x10
}
...
public class ReportRequest
{
    ...
    public NJNBNAHJBGI ReportCategory;    // 0x0x20
}
...
{
    public EOMMBMOKNBF? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public EOMMBMOKNBF JMNPMGPFHLO;  // wrapper
...
{
    public LCBAJLKPCDJ IPGOHNKKEOL;  // wrapper
...
{
    public NHBMLMAIEFJ LIBGCFIILKM;  // wrapper
    public int? LPHMHPGLOMA;  // wrapper
...
{
    public PGPADHLIEJG UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public EHFJPEANBFN JPCKENBNJIJ;  // wrapper
    public EHFJPEANBFN? KPKFNLECOAE;  // wrapper
...
{
    public AHNAGDAMBME HDKPMODKDMP;  // wrapper
...
{
    public BIFKFOLPFKD GHJBKGHKPOP;  // wrapper
...
{
    public List<LHLKJPEFBCF> GCIECLMKICC;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public HDAJBDNAONP AIDOJAGKMGH;  // wrapper
    public EHFJPEANBFN? IOPPCILDFPL;  // wrapper
...
{
    public JBBIHCAOIDA AKDHGGLAHAD;  // wrapper
...
{
    public StatusResponse> HNMFGPCGPOH;  // wrapper
...
{
    public List<long> MNIEGMELIMC;  // wrapper
    public DAPLIJKMODC BDNPLHPBACI;  // wrapper
    public long? KAJFPAFLIDI;  // wrapper
    public PGLEFHDGCNJ HNMFGPCGPOH;  // wrapper
...
{
    public String> HNMFGPCGPOH;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{cHNACHJJPIJ}  [API POST]
public class PlayereventsV2DeleteCHNACHJJPIJRequest
{
    public LNIBKLPAAED CHNACHJJPIJ;  // wrapper
}
...
{
    public LNIBKLPAAED CHNACHJJPIJ;  // wrapper
    public MEIHOPKFGDD MLODHKOAGPG;  // wrapper
...
{
    public LNIBKLPAAED CHNACHJJPIJ;  // wrapper
    public long? MOOOCEOMIBG;  // wrapper
    public object clubId;  // candidate
}
...
{
    public LNIBKLPAAED CHNACHJJPIJ;  // wrapper
    public LHKNNBADHPE FOMKOHPJECK;  // wrapper
    public LHKNNBADHPE KCFHGMPFHOC;  // wrapper
...
{
    public LNIBKLPAAED CHNACHJJPIJ;  // wrapper
    public long? IFAMBCNGDGP;  // wrapper
    public object roomId;  // candidate
...
{
    public LNIBKLPAAED CHNACHJJPIJ;  // wrapper
    public List<string> LKKPGLCMHBK;  // wrapper
}
...
{
    public LNIBKLPAAED CHNACHJJPIJ;  // wrapper
    public DateTime BENPEPIEKNO;  // wrapper
    public DateTime PFHIEPHCPGL;  // wrapper
...
{
    public Guid COJHLNEFJPH;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> JJNHHBEBHIB;  // wrapper
...
{
    public Guid? DPABLLANOIB;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats LKGEDELBKFP;  // wrapper
}
...
{
    public Guid MMBMIGLAGHL;  // wrapper
    public object RoomKeyId;  // candidate
    public object RequestedPrice;  // candidate
...
{
    public List<GCMGEEIJAAE> MJMFOAEOALE;  // wrapper
...
{
    public LJIGGPFLLND JKOMFECLDMP;  // wrapper
}
