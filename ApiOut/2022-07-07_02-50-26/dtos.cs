...
// DTO classes: 248 (plus referenced enums)

// --------------------------------------------------------------------------
// ABECDEGMHIC
//   RESPONSE GET    api/influencerpartnerprogram/   [Service.API]
//   REQUEST  POST   api/influencerpartnerprogram/   [Service.API]
public class ABECDEGMHIC
{
    public List<int> <KPJOELEOCGO>k__BackingField;    // 0x0x10
    public string <MHCAIEIPHPG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AHBIGFOGELA
//   (not directly referenced by a detected call)
public class AHBIGFOGELA
{
    public long <PEBOFEFLGOE>k__BackingField;    // 0x0x10
    public long <MEPKFMBFKNI>k__BackingField;    // 0x0x18
    public int <ALCAOHDEDHN>k__BackingField;    // 0x0x20
    public DateTime <PKEPAHKGLBI>k__BackingField;    // 0x0x28
    public KPLAJFKFMJD <IAKBLHGDBGK>k__BackingField;    // 0x0x30
}
...
public class BCPCAOAPMOJ
{
    public int <MHPAGCNIGML>k__BackingField;    // 0x0x10
    public Guid <FECJICIFGNL>k__BackingField;    // 0x0x14
    public long <FKHLBBEBGKC>k__BackingField;    // 0x0x28
    public long <LMOPDFBHBJL>k__BackingField;    // 0x0x30
    public DateTime <IEADLNCKFMM>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// BDOCOJAGMCJ
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/price   [Service.API]
public class BDOCOJAGMCJ
{
    public BOLGMKGEHDB <JEOKDFAFIBI>k__BackingField;    // 0x0x10
}
...
public class BEFLAGGKAJD
{
    public bool <OIFOFCKAMLN>k__BackingField;    // 0x0x10
    public string <LDELKAEAHGK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BFBBEIHDIBP
//   (not directly referenced by a detected call)
public class BFBBEIHDIBP
{
    public int <OLGKDNKNCLB>k__BackingField;    // 0x0x10
    public DateTime <PKEPAHKGLBI>k__BackingField;    // 0x0x18
    public DateTime? <FNNHEPEGMJI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BGFIKAAFKGG
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{nLCFEJFHICG}   [Service.API]
public class BGFIKAAFKGG
{
    public Guid <BONEFLHJBMK>k__BackingField;    // 0x0x10
    public int <MHPAGCNIGML>k__BackingField;    // 0x0x20
    public int <ECFOLBDCKAD>k__BackingField;    // 0x0x24
    public DateTime <PKEPAHKGLBI>k__BackingField;    // 0x0x28
}
...
// BHBMLLDEPFM
//   (not directly referenced by a detected call)
public class BHBMLLDEPFM
{
    public bool <GGHCFIHBCAH>k__BackingField;    // 0x0x10
    public EIIPOKHOJHO <KPLGLCNKOCF>k__BackingField;    // 0x0x14
    public int <ENIKNOKGEDK>k__BackingField;    // 0x0x18
    public DateTime <BEINLOCDMLM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BIJHDKEDHGK
//   (not directly referenced by a detected call)
public class BIJHDKEDHGK
{
    public int <KOEKONEKPFK>k__BackingField;    // 0x0x10
}
...
public class BLJGCKDAHMH
{
    public int <KOMFOCDJHOM>k__BackingField;    // 0x0x10
    public MLJJEKLKKDM <IAKBLHGDBGK>k__BackingField;    // 0x0x14
    public OOMLOPEHAME <DEPBCIANAGK>k__BackingField;    // 0x0x18
    public OOMLOPEHAME <IFBAIFCDFMP>k__BackingField;    // 0x0x1C
    public OOMLOPEHAME <AKPFNNKEIFJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BLJLFACGCIF
//   (not directly referenced by a detected call)
public class BLJLFACGCIF
{
    public long <CGMINBJNIIC>k__BackingField;    // 0x0x10
    public string <EBCHAGFJNJA>k__BackingField;    // 0x0x18
    public int <LGCLGIICMNP>k__BackingField;    // 0x0x20
    public int <CLIHEEKEJLM>k__BackingField;    // 0x0x24
    public int <DMMDKAMPGOH>k__BackingField;    // 0x0x28
    public int <MOCNBDFPBED>k__BackingField;    // 0x0x2C
    public int <NNCCAMEBDKF>k__BackingField;    // 0x0x30
    public string <FIPPCLIHNAL>k__BackingField;    // 0x0x38
    public string <LCCOALEDLJJ>k__BackingField;    // 0x0x40
}
...
public class BNMFJCPPBCC
{
    public ELBMJPGAHMH <CAIODMAFOGJ>k__BackingField;    // 0x0x10
    public DNNJINIHDPA <CNEMGHEKPJD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BOLGMKGEHDB
//   (not directly referenced by a detected call)
public class BOLGMKGEHDB
{
    public long <DAMIHNLCGIE>k__BackingField;    // 0x0x10
    public Guid? <FECJICIFGNL>k__BackingField;    // 0x0x18
}
...
public class CFEFBLAFKAL
{
    public Guid <IEPFBMKOFPK>k__BackingField;    // 0x0x10
    public int <CCAMBOMGCMG>k__BackingField;    // 0x0x20
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x28
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x30
    public int <DAMIHNLCGIE>k__BackingField;    // 0x0x38
    public NLAIDDJKPGF <LABCPJPAGEO>k__BackingField;    // 0x0x3C
    public bool <OAGAOGMLDJI>k__BackingField;    // 0x0x40
    public int? <BLCNMDDCPPI>k__BackingField;    // 0x0x44
    public string <DAOELLIOBOH>k__BackingField;    // 0x0x50
    public string <DMNGANHBMDG>k__BackingField;    // 0x0x58
    public string <OMDFMLJBPFE>k__BackingField;    // 0x0x60
    public DateTime <PKEPAHKGLBI>k__BackingField;    // 0x0x68
    public DateTime <BEINLOCDMLM>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// CLLNMCMFGDG
//   REQUEST  POST   api/customAvatarItems/v1/{customAvatarItemId}/report   [Service.API]
public class CLLNMCMFGDG
{
    public KEHMBLODFGD <FGKLLMFEGJE>k__BackingField;    // 0x0x10
    public string <ICOPNHICAOE>k__BackingField;    // 0x0x18
}
...
public class COEALBDGABE
{
    public Guid <FECJICIFGNL>k__BackingField;    // 0x0x10
    public long? <GFLAJKILLMF>k__BackingField;    // 0x0x20
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x30
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x38
    public JHBHAPJPFEP <PFHKMDGNKLO>k__BackingField;    // 0x0x40
    public long <PCCKHACMFCI>k__BackingField;    // 0x0x48
    public string <EONANGFNAPH>k__BackingField;    // 0x0x50
    public DateTime <PKEPAHKGLBI>k__BackingField;    // 0x0x58
    public DateTime <BEINLOCDMLM>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// COLBLDGECGN
//   (not directly referenced by a detected call)
public class COLBLDGECGN
{
    public int <KKPKPOLLCFJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DCIGDOEDNHE
//   (not directly referenced by a detected call)
public class DCIGDOEDNHE
{
    public bool <PLGABJPMGAI>k__BackingField;    // 0x0x10
    public JBLBBBDOBJD <IPEMNHKFNLO>k__BackingField;    // 0x0x18
    public float <HNFKIAHKEIO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DCJEEIJJAHF
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class DCJEEIJJAHF
{
    public List<EIECLELINEL> <MAIKDLKMBOI>k__BackingField;    // 0x0x10
    public PMIAEIDAAPG <JPOMGGFBEAD>k__BackingField;    // 0x0x18
}
...
// DLILBAAAAAL
//   (not directly referenced by a detected call)
public class DLILBAAAAAL
{
    public Guid <IEPFBMKOFPK>k__BackingField;    // 0x0x10
    public byte <FNFLELKKEKK>k__BackingField;    // 0x0x20
}
...
public class DLLAMMFDMAD
{
    public int <KJJBKLDDCHE>k__BackingField;    // 0x0x10
    public List<ECCGGDEJKMI> <MOOHJNDLPCL>k__BackingField;    // 0x0x18
}
...
public class DMPDGDFNACK
{
    public DHEEIDJIPFD <CAIODMAFOGJ>k__BackingField;    // 0x0x10
    public KMIJFJECCHJ <AKPEMEHMHKB>k__BackingField;    // 0x0x18
    public BLJLFACGCIF <EMILEFPFLLJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DNNJINIHDPA
//   (not directly referenced by a detected call)
public class DNNJINIHDPA
{
    public long <NFIIFNNOPDB>k__BackingField;    // 0x0x10
    public Guid <EBCHAGFJNJA>k__BackingField;    // 0x0x18
    public long <GFLAJKILLMF>k__BackingField;    // 0x0x28
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x30
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x38
    public int <DAMIHNLCGIE>k__BackingField;    // 0x0x40
    public Guid? <GCANOIKCLCL>k__BackingField;    // 0x0x44
    public DateTime <PKEPAHKGLBI>k__BackingField;    // 0x0x58
    public string <EONANGFNAPH>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// EBKLBLELKOM
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class EBKLBLELKOM
{
    public JHBHAPJPFEP <PFHKMDGNKLO>k__BackingField;    // 0x0x10
    public FECDNKKGFFE <GHAODOIFEGE>k__BackingField;    // 0x0x14
    public int <NFALHHBBGFP>k__BackingField;    // 0x0x18
    public int <MKDAPNJICAC>k__BackingField;    // 0x0x1C
    public int <JBDPDFCPFNM>k__BackingField;    // 0x0x20
    public NHAKAMIKKOK <FEKDFNHIGIO>k__BackingField;    // 0x0x24
    public bool <HLHENLOKGOD>k__BackingField;    // 0x0x28
    public float <AIOBMIACOAG>k__BackingField;    // 0x0x2C
    public int <OGJPOBDKJIH>k__BackingField;    // 0x0x30
    public bool <JPICEFJGFJM>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// ECCGGDEJKMI
//   (not directly referenced by a detected call)
public class ECCGGDEJKMI
{
    public DateTime? <LDEDHBEPAEI>k__BackingField;    // 0x0x10
    public DateTime? <ENCLIAIMEMP>k__BackingField;    // 0x0x20
    public FFNLFIDPECA <CAIODMAFOGJ>k__BackingField;    // 0x0x30
    public HIDCBPLEMDM <GOLPNPLBOFF>k__BackingField;    // 0x0x38
    public bool <KEPAKNDFIGD>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// EDGIDGJMCCE
//   (not directly referenced by a detected call)
public class EDGIDGJMCCE
{
    public int <NGHCOKBHLPP>k__BackingField;    // 0x0x10
    public DateTime? <CFFEPKCBHEK>k__BackingField;    // 0x0x18
    public DateTime? <GNNFMJBGNJM>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// EHEMHKIMLND
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/name   [Service.API]
public class EHEMHKIMLND
{
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EIECLELINEL
//   (not directly referenced by a detected call)
public class EIECLELINEL
{
    public int <FIBPJJNGJJA>k__BackingField;    // 0x0x10
    public PMIAEIDAAPG <JPOMGGFBEAD>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// EIHIJJOJAIO
//   (not directly referenced by a detected call)
public class EIHIJJOJAIO
{
    public int <IIOAGGMFDML>k__BackingField;    // 0x0x10
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x18
    public string <EHHPFIODFGC>k__BackingField;    // 0x0x20
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x28
    public string <PNOHJGIDCJH>k__BackingField;    // 0x0x30
    public bool <FDKNOOKGFMK>k__BackingField;    // 0x0x38
    public int <PMOFILDBIGH>k__BackingField;    // 0x0x3C
    public PDDDGEJEICA <PCBJAHAGBCG>k__BackingField;    // 0x0x40
    public BIFIFOLAKNK PFECPBMDJKO;    // 0x0x48
    public BIFIFOLAKNK NNBCOFJFGAK;    // 0x0x50
    public BIFIFOLAKNK HENEJHICOGC;    // 0x0x58
    public OBCAEACLPBI HDIKGIIJIHB;    // 0x0x60
}
...
public class FEACANBLMKH
{
    public long <JEJFHJDMKDA>k__BackingField;    // 0x0x10
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x18
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x20
    public DateTime <PKEPAHKGLBI>k__BackingField;    // 0x0x28
    public string <EONANGFNAPH>k__BackingField;    // 0x0x30
    public MCHLKHCNMOH <KLMFIBDJEFM>k__BackingField;    // 0x0x38
    public int <JICLAGCGMPJ>k__BackingField;    // 0x0x3C
    public int <KGICNPDALBB>k__BackingField;    // 0x0x40
    public List<GBHPMKGOLPG> <EOLNJPHNACM>k__BackingField;    // 0x0x48
}
...
public class FGPAMMHPOJD
{
    public Guid? <JLBPKOGFMJB>k__BackingField;    // 0x0x10
    public Guid <BHOPPOONOOI>k__BackingField;    // 0x0x24
}
...
//   RESPONSE GET    api/avatar/v2/{jGKOGNMIBMP}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{jGKOGNMIBMP}   [Service.API]
public class FHHBNBGBKAD
{
    public string <CEIEBEBEBMM>k__BackingField;    // 0x0x10
    public string <CPKPCOECNMN>k__BackingField;    // 0x0x18
    public string <NKAJFENFHDH>k__BackingField;    // 0x0x20
    public string <PMAHAKIOALB>k__BackingField;    // 0x0x28
    public string <CPJDFINEOHA>k__BackingField;    // 0x0x30
    public List<DLILBAAAAAL> <GMLKKKKCJNE>k__BackingField;    // 0x0x38
}
...
public class FHKENOOAGEP
{
    public HTTPResponse FOEICMNNLKN;    // 0x0x10
    public int? FMAFKCGAFDM;    // 0x0x18
    public string JADMJHKOOED;    // 0x0x20
    public byte[] GHFDLDLHHIP;    // 0x0x28
    public string HGFPGHILMGM;    // 0x0x30
}

// --------------------------------------------------------------------------
// FKAKBIFABFE
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{aHIADCPIPAH}   [Service.API]
public class FKAKBIFABFE
{
    public uint <GMMHAHFJEKH>k__BackingField;    // 0x0x10
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x18
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x20
    public DateTime <JDFMCMENBCD>k__BackingField;    // 0x0x28
    public DateTime? <EPFCFOEMLJM>k__BackingField;    // 0x0x30
    public bool <MCEJFEJODIG>k__BackingField;    // 0x0x40
    public List<MCEKECPJIKN> <NMJAHGHADHD>k__BackingField;    // 0x0x48
    public List<string> <POJBKDPBEHO>k__BackingField;    // 0x0x50
    public int <HIFABNAILPD>k__BackingField;    // 0x0x58
    public int <PGONIOMFHEF>k__BackingField;    // 0x0x5C
    public int <DGANCKPAKMI>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// FKPEMAKHPAN
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class FKPEMAKHPAN
{
    public int <PMOFILDBIGH>k__BackingField;    // 0x0x10
    public string <KAKAJNKELLP>k__BackingField;    // 0x0x18
    public string <CEIEBEBEBMM>k__BackingField;    // 0x0x20
    public string <CPKPCOECNMN>k__BackingField;    // 0x0x28
    public string <NKAJFENFHDH>k__BackingField;    // 0x0x30
    public string <PMAHAKIOALB>k__BackingField;    // 0x0x38
    public string <CPJDFINEOHA>k__BackingField;    // 0x0x40
    public List<DLILBAAAAAL> <GMLKKKKCJNE>k__BackingField;    // 0x0x48
}
...
// GADIIDMENPG
//   (not directly referenced by a detected call)
public class GADIIDMENPG
{
    public Guid <EMIJFOFCMJP>k__BackingField;    // 0x0x10
    public int <MHPAGCNIGML>k__BackingField;    // 0x0x20
    public int <POGPNAPIPCH>k__BackingField;    // 0x0x24
    public Guid <GDPGNFHJHBJ>k__BackingField;    // 0x0x28
    public DateTime <BEINLOCDMLM>k__BackingField;    // 0x0x38
    public ICDENAIHOGD <FCMBKIBBKAM>k__BackingField;    // 0x0x40
}
...
// base   : ODCGCCEIBBA
//   (not directly referenced by a detected call)
public class GANGJFBJGHK : ODCGCCEIBBA
{
    public JBLBBBDOBJD <IPEMNHKFNLO>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// GBHPMKGOLPG
//   RESPONSE GET    api/groups/v1/memberships/{fDFCFKGBNFD}   [Service.API]
public class GBHPMKGOLPG
{
    public long <JEJFHJDMKDA>k__BackingField;    // 0x0x10
    public int <ALCAOHDEDHN>k__BackingField;    // 0x0x18
    public PPMDJKLHDLC <JMBAHIODEPG>k__BackingField;    // 0x0x1C
}
...
public class GDNAKPLPEFM
{
    public string <GMKFJHFEMAA>k__BackingField;    // 0x0x10
    public string <EGCHKMGFKAM>k__BackingField;    // 0x0x18
    public bool <KLCLBFOHMKM>k__BackingField;    // 0x0x20
    public string <HLAMEPPMDEJ>k__BackingField;    // 0x0x28
}
...
public class GFKCMFMFIBC
{
    public bool <OIFOFCKAMLN>k__BackingField;    // 0x0x10
    public string <BIDKDPPCAEH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GGIDIHGCAKN
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class GGIDIHGCAKN
{
    public List<JMGJHBKCGMM> <POJBKDPBEHO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GHDGHPJHBKH
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class GHDGHPJHBKH
{
    public int <EANCDMFKOFH>k__BackingField;    // 0x0x10
    public int <HFBKEBIEFKE>k__BackingField;    // 0x0x14
    public float <JFODEOLAKJK>k__BackingField;    // 0x0x18
    public float <LMLBLPOFEKI>k__BackingField;    // 0x0x1C
    public bool <BBCAOGKFBAL>k__BackingField;    // 0x0x20
    public bool <GIFILCCKBEJ>k__BackingField;    // 0x0x21
    public bool <PLIBCIAAAGD>k__BackingField;    // 0x0x22
}
...
public class GJICMIDMGBO : AFJLLOFDBAB
{
    public DBEBPOAHIBA? <JCNHKEJDKGI>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <NFCIDGMPBOJ>k__BackingField;    // 0x0x20
}
...
public class GOKGNNLKLMG
{
    public List<string> <ADMKKDNLLHF>k__BackingField;    // 0x0x10
    public List<string> <PGFMBHDJEAJ>k__BackingField;    // 0x0x18
    public List<string> <BPJCBIAKEMP>k__BackingField;    // 0x0x20
}
...
public class HCJMHIDBKNM
{
    public List<BFBBEIHDIBP> <OFDBEHBKPIM>k__BackingField;    // 0x0x10
    public string <MHCAIEIPHPG>k__BackingField;    // 0x0x18
}
...
// HIDCBPLEMDM
//   (not directly referenced by a detected call)
public class HIDCBPLEMDM
{
    public int <CJBCIBCFCLD>k__BackingField;    // 0x0x10
    public int <HMMEEDDENDI>k__BackingField;    // 0x0x14
    public int <PPLPPCAJLMK>k__BackingField;    // 0x0x18
}
...
public class HIIHKEKEHEA
{
    public PMIAEIDAAPG <JPOMGGFBEAD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HKPLIOEAMHF
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class HKPLIOEAMHF
{
    public int <HFOIGADNHNN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HMIOOOFACGA
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class HMIOOOFACGA
{
    public long <MEPKFMBFKNI>k__BackingField;    // 0x0x10
    public KPLAJFKFMJD <IAKBLHGDBGK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HNCCNPHAOJJ
//   (not directly referenced by a detected call)
public class HNCCNPHAOJJ
{
    public DateTime <PKEPAHKGLBI>k__BackingField;    // 0x0x10
    public string <BCKLDGJDFNB>k__BackingField;    // 0x0x18
}
...
public class HPIFGFDFPDD : CLLOCJFMHGD
{
    public List<GANGJFBJGHK> LEPADNNBMGH;    // 0x0x30
    public int <GKHDADFOPCH>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// IBOBPMPNMFF
//   (not directly referenced by a detected call)
public class IBOBPMPNMFF
{
    public JHBHAPJPFEP <PFHKMDGNKLO>k__BackingField;    // 0x0x10
    public int <DAMIHNLCGIE>k__BackingField;    // 0x0x14
    public EDGIDGJMCCE <MIFGGGOCIAG>k__BackingField;    // 0x0x18
}
...
public class ICAGPKCJPMB
{
    public IEINODPGINI <CAIODMAFOGJ>k__BackingField;    // 0x0x10
    public GADIIDMENPG <DHNHDGADDJG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ICDENAIHOGD
//   (not directly referenced by a detected call)
public class ICDENAIHOGD
{
    public Guid <EMIJFOFCMJP>k__BackingField;    // 0x0x10
    public long <GFLAJKILLMF>k__BackingField;    // 0x0x20
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x28
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x30
    public string <EONANGFNAPH>k__BackingField;    // 0x0x38
    public long <DAMIHNLCGIE>k__BackingField;    // 0x0x40
    public Guid? <GCANOIKCLCL>k__BackingField;    // 0x0x48
    public DateTime <BEINLOCDMLM>k__BackingField;    // 0x0x60
}
...
// JBLBBBDOBJD
//   (not directly referenced by a detected call)
public class JBLBBBDOBJD
{
    public int <LCEAEJNFHJN>k__BackingField;    // 0x0x10
    public string <HHJLOBPCIJK>k__BackingField;    // 0x0x18
    public string <PNOHJGIDCJH>k__BackingField;    // 0x0x20
    public string <EMGBBKIFOAM>k__BackingField;    // 0x0x28
    public string <LDEANJPJBAG>k__BackingField;    // 0x0x30
    public ABGJEFNILIA? <HLILAKGBLIB>k__BackingField;    // 0x0x38
    public string <AEBAGAFPLMO>k__BackingField;    // 0x0x40
    public string <EPBHJJEGBGF>k__BackingField;    // 0x0x48
    public bool <CLNDIPMMJLN>k__BackingField;    // 0x0x50
    public bool <JGIBCCFPJOL>k__BackingField;    // 0x0x51
    public bool <NOCJBGOIJFK>k__BackingField;    // 0x0x52
    public CEFABOHEFPK <MKAGMGNAPGL>k__BackingField;    // 0x0x54
    public JHBHAPJPFEP <PFHKMDGNKLO>k__BackingField;    // 0x0x58
    public int <PJHENJAFLDE>k__BackingField;    // 0x0x5C
    public PGAJDOEEBKN <JAKIGLCHCHL>k__BackingField;    // 0x0x60
    public IFMOMDDBPEO <AFFMJIKLGGA>k__BackingField;    // 0x0x64
    public int? <EFIJBKKOEJC>k__BackingField;    // 0x0x68
    public string <BECJDMIGACA>k__BackingField;    // 0x0x70
}
...
public class JIECEJLLJNL
{
    public Dictionary<int, int> <JBMHIKNADKH>k__BackingField;    // 0x0x10
    public List<LHGOHIOBMDH> <ILJPKBKGDHE>k__BackingField;    // 0x0x18
    public JLNDIKEGELE[][] <MAEEJIJLGCE>k__BackingField;    // 0x0x20
    public COLBLDGECGN <LFEIPAPNOPC>k__BackingField;    // 0x0x28
    public JOOIAJAHEMA <JBIODPAPCON>k__BackingField;    // 0x0x30
    public MJMIPECOLHM <NEONGPCMJII>k__BackingField;    // 0x0x38
    public BIJHDKEDHGK <BIILPHCDEAB>k__BackingField;    // 0x0x40
    public LIMLHIOPNFD <HLCCHDMDDMC>k__BackingField;    // 0x0x48
    public string <FGIOBEDCODF>k__BackingField;    // 0x0x50
}
...
public class JIIFJEBKPFK
{
    public int <HFBKEBIEFKE>k__BackingField;    // 0x0x10
    public bool <BBCAOGKFBAL>k__BackingField;    // 0x0x14
    public DateTime <LAMMJEJCCFE>k__BackingField;    // 0x0x18
    public bool <PDDJEMAELBE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JJMEMHILHDH
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class JJMEMHILHDH
{
    public int <LFMHKGKGAEK>k__BackingField;    // 0x0x10
    public string <MMCPBOCFELE>k__BackingField;    // 0x0x18
    public List<EIHIJJOJAIO> <HFJOINNAGPB>k__BackingField;    // 0x0x20
    public NDDCDNBFGID <AOCDBDIKHPM>k__BackingField;    // 0x0x28
    public string <JNHIJJICAIJ>k__BackingField;    // 0x0x30
    public DateTime <FBPMFPMAIJA>k__BackingField;    // 0x0x38
    public DateTime <HGAHGDBHKBE>k__BackingField;    // 0x0x40
    public DateTime <EJPPAAMEDID>k__BackingField;    // 0x0x48
    public bool? <JIFIMGCJHOO>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// JLNDIKEGELE
//   (not directly referenced by a detected call)
public class JLNDIKEGELE
{
    public MEEMNCLAIIM FAOEODLCALP;    // 0x0x10
    public int LLOFMJICMLP;    // 0x0x14
}

// --------------------------------------------------------------------------
// JMGJHBKCGMM
//   (not directly referenced by a detected call)
public class JMGJHBKCGMM
{
    public string <CFCBNGMKALI>k__BackingField;    // 0x0x10
    public APDFDENBNLC <IAKBLHGDBGK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JMHIDGPJKIJ
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class JMHIDGPJKIJ
{
    public DENHIKJMMBE <FGKLLMFEGJE>k__BackingField;    // 0x0x10
    public int <HFOIGADNHNN>k__BackingField;    // 0x0x14
    public long <JOBFPCBGBED>k__BackingField;    // 0x0x18
    public bool <MFPDNFGJFEJ>k__BackingField;    // 0x0x20
    public string <BIDKDPPCAEH>k__BackingField;    // 0x0x28
    public int? <BFHDBOEJFCM>k__BackingField;    // 0x0x30
    public bool <MGKHOEFPJKB>k__BackingField;    // 0x0x38
    public bool <ICFHAGLIBLA>k__BackingField;    // 0x0x39
    public string <ACLMFBPCPAB>k__BackingField;    // 0x0x40
    public DateTime? <CICABDGHEPG>k__BackingField;    // 0x0x48
    public float <JMOCGNAMHBC>k__BackingField;    // 0x0x58
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{kBCANONAKPK}   [Service.API]
public class JMMGFFJGDGD
{
    public long <GFLAJKILLMF>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <IHFDCICGAME>k__BackingField;    // 0x0x18
    public DDINEEHLHAO <AALDMKHFCLA>k__BackingField;    // 0x0x20
}
...
public class JOJELNHHJLM
{
    public List<MECJMKMPNHG> <GFMBMGLKONF>k__BackingField;    // 0x0x10
    public List<PHFFHCOAEFI> <IAMJOJPCGGK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JOOIAJAHEMA
//   (not directly referenced by a detected call)
public class JOOIAJAHEMA
{
    public float <FHGCEMMBHCP>k__BackingField;    // 0x0x10
    public float <DKFOKOKCFOD>k__BackingField;    // 0x0x14
    public float <ANLOKDHNDNH>k__BackingField;    // 0x0x18
    public float <HCOFKLHFNGF>k__BackingField;    // 0x0x1C
    public float <OPIDNFDJOEM>k__BackingField;    // 0x0x20
    public float <FPNJNDLMLID>k__BackingField;    // 0x0x24
    public float <CPIGBHFMMNB>k__BackingField;    // 0x0x28
    public float <BPCPEEEECPH>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// KCBJEGHFGMM
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/description   [Service.API]
public class KCBJEGHFGMM
{
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x10
}
...
// base   : ODCGCCEIBBA
//   (not directly referenced by a detected call)
public class KCKLCMJHLLH : ODCGCCEIBBA
{
    public int <LPOBKKHCEMP>k__BackingField;    // 0x0x60
    public List<DCIGDOEDNHE> <AHOICJLPEJO>k__BackingField;    // 0x0x68
    public List<DCIGDOEDNHE> <INHKLIIOOCC>k__BackingField;    // 0x0x70
    public List<DCIGDOEDNHE> <JLBPJIIJELM>k__BackingField;    // 0x0x78
}
...
public class KHJKMNDDHGI
{
    public Guid <LONFNBHBELH>k__BackingField;    // 0x0x10
    public Guid <FECJICIFGNL>k__BackingField;    // 0x0x20
    public int <LKIDPANNILG>k__BackingField;    // 0x0x30
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x38
    public long <JCEIHOJPJIC>k__BackingField;    // 0x0x40
    public long <DAMIHNLCGIE>k__BackingField;    // 0x0x48
    public DateTime <BEINLOCDMLM>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// KLALDGIFNOB
//   (not directly referenced by a detected call)
public class KLALDGIFNOB
{
    public Guid <ONOBGIOAMOB>k__BackingField;    // 0x0x10
    public Guid <LNLFHBBKHKG>k__BackingField;    // 0x0x20
    public DateTime <FBPMFPMAIJA>k__BackingField;    // 0x0x30
    public List<JBLBBBDOBJD> <PHMABEPLHFB>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// KMIJFJECCHJ
//   (not directly referenced by a detected call)
public class KMIJFJECCHJ
{
    public long <CGMINBJNIIC>k__BackingField;    // 0x0x10
    public string <EBCHAGFJNJA>k__BackingField;    // 0x0x18
    public int <FLOCLFBDFFD>k__BackingField;    // 0x0x20
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x28
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x30
    public string <EONANGFNAPH>k__BackingField;    // 0x0x38
    public int <IJFBPLNLIJF>k__BackingField;    // 0x0x40
    public NLAIDDJKPGF <LABCPJPAGEO>k__BackingField;    // 0x0x44
    public DateTime <BEINLOCDMLM>k__BackingField;    // 0x0x48
    public DateTime <PKEPAHKGLBI>k__BackingField;    // 0x0x50
    public DateTime? <LCHGECJGHJP>k__BackingField;    // 0x0x58
    public long? <MIHFBAOLAJH>k__BackingField;    // 0x0x68
    public int <HMBJCAIGBKL>k__BackingField;    // 0x0x78
    public int <KAOFLCIDBCB>k__BackingField;    // 0x0x7C
    public int <LKCIJGBPOMG>k__BackingField;    // 0x0x80
    public FNILBNCCIOM <KDFMOMKDMMN>k__BackingField;    // 0x0x84
    public FNILBNCCIOM <CHCKAONHBOI>k__BackingField;    // 0x0x88
    public bool <DJKFKEPEHEJ>k__BackingField;    // 0x0x8C
    public bool <GAAIJNMJKEG>k__BackingField;    // 0x0x8D
    public bool <IMCGLGHCNAD>k__BackingField;    // 0x0x8E
    public int? <DAMIHNLCGIE>k__BackingField;    // 0x0x90
    public bool <HEMABAPLBDA>k__BackingField;    // 0x0x98
}
...
public class LFKINHEHFMJ : CLLOCJFMHGD
{
    public int <KNCJLPFFAHL>k__BackingField;    // 0x0x30
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x38
    public DateTime <FBPMFPMAIJA>k__BackingField;    // 0x0x40
    public DateTime <HGAHGDBHKBE>k__BackingField;    // 0x0x48
    public JHBHAPJPFEP <PFHKMDGNKLO>k__BackingField;    // 0x0x50
    public ODCGCCEIBBA <BBDHBONAOGO>k__BackingField;    // 0x0x58
    public List<KCKLCMJHLLH> <EDJKMKJDOFH>k__BackingField;    // 0x0x60
    public BHBMLLDEPFM <PJPHBKPDBPD>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// LGOADCNPBKE
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class LGOADCNPBKE
{
    public OKCCGMKPMMB <GEELMCEPAFL>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <NFCIDGMPBOJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LIMLHIOPNFD
//   (not directly referenced by a detected call)
public class LIMLHIOPNFD
{
    public float <DGOBPBHEBII>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LJGAINCABNH
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class LJGAINCABNH
{
    public int? <LFFEHEIJEHE>k__BackingField;    // 0x0x10
    public string <PGHDCKAFPPA>k__BackingField;    // 0x0x18
    public string <IDMNBMHOAHE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LMEBJKGEAII
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class LMEBJKGEAII
{
    public DENHIKJMMBE <FGKLLMFEGJE>k__BackingField;    // 0x0x10
    public long <MEPKFMBFKNI>k__BackingField;    // 0x0x18
    public string <ICOPNHICAOE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MCEKECPJIKN
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{aHIADCPIPAH}   [Service.API]
public class MCEKECPJIKN
{
    public string <GMMHAHFJEKH>k__BackingField;    // 0x0x10
    public string <ACJHGDPHOPA>k__BackingField;    // 0x0x18
    public string <LBDBFJOJOPC>k__BackingField;    // 0x0x20
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x28
    public string <PGHDCKAFPPA>k__BackingField;    // 0x0x30
    public MHBPKMMEMGF <CAIODMAFOGJ>k__BackingField;    // 0x0x38
    public List<string> <LHMMLBCEJEP>k__BackingField;    // 0x0x40
    public List<string> <POJBKDPBEHO>k__BackingField;    // 0x0x48
    public string <LJADANCFLEB>k__BackingField;    // 0x0x50
    public List<HNCCNPHAOJJ> <AAMDGNONBKP>k__BackingField;    // 0x0x58
}
...
// MECJMKMPNHG
//   (not directly referenced by a detected call)
public class MECJMKMPNHG
{
    public long <MEPKFMBFKNI>k__BackingField;    // 0x0x10
    public int <FLOCLFBDFFD>k__BackingField;    // 0x0x18
    public long <GFLAJKILLMF>k__BackingField;    // 0x0x20
    public long? <KOHPMFMECKD>k__BackingField;    // 0x0x28
    public long? <CLAGIHKDAGI>k__BackingField;    // 0x0x38
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x48
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x50
    public string <EONANGFNAPH>k__BackingField;    // 0x0x58
    public DateTime <PAIIFDNBMFG>k__BackingField;    // 0x0x60
    public DateTime <DOFGLNJFOLF>k__BackingField;    // 0x0x68
    public int <ODGOPMDEHKH>k__BackingField;    // 0x0x70
    public MGGMCPGGFKN <LABCPJPAGEO>k__BackingField;    // 0x0x74
    public bool <AMMDJLPLMEL>k__BackingField;    // 0x0x78
    public bool <IKLOHBOJJPJ>k__BackingField;    // 0x0x79
    public NHDPFJPPCGM <AGALNAPHGBK>k__BackingField;    // 0x0x7C
    public NHDPFJPPCGM <AKJOKDAJEEH>k__BackingField;    // 0x0x80
    public long? <CBMMMIFIHHH>k__BackingField;    // 0x0x88
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{iGHBMLJOJOF}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{iGHBMLJOJOF}   [Service.API]
...
public class MJHKAPNMCBF
{
    public IEINODPGINI <CAIODMAFOGJ>k__BackingField;    // 0x0x10
    public ICDENAIHOGD <FCMBKIBBKAM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MJMIPECOLHM
//   (not directly referenced by a detected call)
public class MJMIPECOLHM
{
    public int <NJCNOGLIIPE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// MKODOGEGMIA
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable/{roomconsumableId}/image   [Service.API]
public class MKODOGEGMIA
{
    public string <EONANGFNAPH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// MLGHDAADOFL
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{hKJOCCFJBGK}   [Service.API]
...
public class MLGHDAADOFL
{
    public MECJMKMPNHG <LDLLMNLGNAB>k__BackingField;    // 0x0x10
    public PMIAEIDAAPG <JPOMGGFBEAD>k__BackingField;    // 0x0x18
    public ONKDFCIJMDB <CHNJKKJIHAN>k__BackingField;    // 0x0x20
}
...
// NDDCDNBFGID
//   (not directly referenced by a detected call)
public class NDDCDNBFGID
{
    public long <LCEAEJNFHJN>k__BackingField;    // 0x0x10
    public string <EMGBBKIFOAM>k__BackingField;    // 0x0x18
    public string <AMFAALGLLNA>k__BackingField;    // 0x0x20
    public ABGJEFNILIA? <HLILAKGBLIB>k__BackingField;    // 0x0x28
    public string <AEBAGAFPLMO>k__BackingField;    // 0x0x30
    public string <EPBHJJEGBGF>k__BackingField;    // 0x0x38
    public KHDECKBDLNB <BDACFOKOGLC>k__BackingField;    // 0x0x40
    public int <KCELNECBJCH>k__BackingField;    // 0x0x44
    public int <LIPKANEDFJO>k__BackingField;    // 0x0x48
    public IFMOMDDBPEO? <OIHCKDGCPGK>k__BackingField;    // 0x0x4C
    public CEFABOHEFPK? <MNPKIIHHKMM>k__BackingField;    // 0x0x54
}
...
public class NHINCGIGMJE
{
    public long <GFLAJKILLMF>k__BackingField;    // 0x0x10
    public long? <KOHPMFMECKD>k__BackingField;    // 0x0x18
    public long? <CLAGIHKDAGI>k__BackingField;    // 0x0x28
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x38
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x40
    public List<string> <POJBKDPBEHO>k__BackingField;    // 0x0x48
    public string <EONANGFNAPH>k__BackingField;    // 0x0x50
    public DateTime <PAIIFDNBMFG>k__BackingField;    // 0x0x58
    public DateTime <DOFGLNJFOLF>k__BackingField;    // 0x0x60
    public MGGMCPGGFKN <LABCPJPAGEO>k__BackingField;    // 0x0x68
    public bool <AMMDJLPLMEL>k__BackingField;    // 0x0x6C
    public bool <IKLOHBOJJPJ>k__BackingField;    // 0x0x6D
    public NHDPFJPPCGM <AGALNAPHGBK>k__BackingField;    // 0x0x70
    public NHDPFJPPCGM <AKJOKDAJEEH>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// NLEOOMPCINP
//   RESPONSE GET    api/inventions/v1/personaldetails/{mLJNPDIAPGD}   [Service.API]
public class NLEOOMPCINP
{
    public bool <MBGIAPLKAML>k__BackingField;    // 0x0x10
}
...
public class NMFJJCEHKDF
{
    public int <CCAMBOMGCMG>k__BackingField;    // 0x0x10
    public int? <BLCNMDDCPPI>k__BackingField;    // 0x0x14
    public string <DMNGANHBMDG>k__BackingField;    // 0x0x20
    public string <DAOELLIOBOH>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// ODCGCCEIBBA
//   (not directly referenced by a detected call)
public class ODCGCCEIBBA
{
    public int <ECFOLBDCKAD>k__BackingField;    // 0x0x10
    public PBBHDFOBPIE <IAKBLHGDBGK>k__BackingField;    // 0x0x14
    public List<IBOBPMPNMFF> <LMIDNGFADNE>k__BackingField;    // 0x0x18
    public List<IBOBPMPNMFF> <PDKAMDMPGNC>k__BackingField;    // 0x0x20
    public bool <OAGAOGMLDJI>k__BackingField;    // 0x0x28
    public DateTime? <ALMLLLMMAGA>k__BackingField;    // 0x0x30
    public DateTime? <IMLOLHAHDNC>k__BackingField;    // 0x0x40
    public DateTime? <DPLEAONGMEN>k__BackingField;    // 0x0x50
}
...
public class OEKDAAFODLD
{
    public FGPAMMHPOJD <DMJHEMMIDDH>k__BackingField;    // 0x0x10
    public BOLGMKGEHDB <IFOAIINHEPM>k__BackingField;    // 0x0x18
}
...
public class OKCCGMKPMMB
{
    public int <MHPAGCNIGML>k__BackingField;    // 0x0x10
    public Guid <FECJICIFGNL>k__BackingField;    // 0x0x14
    public long <FKHLBBEBGKC>k__BackingField;    // 0x0x28
    public DateTime <BEINLOCDMLM>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// ONKDFCIJMDB
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class ONKDFCIJMDB
{
    public FEOHGJOOIEL <JPOMGGFBEAD>k__BackingField;    // 0x0x10
    public List<string> <POJBKDPBEHO>k__BackingField;    // 0x0x18
}
...
public class PBMGBLMMMHD : AFJLLOFDBAB
{
    public MHGOCBHDIMF? <JCNHKEJDKGI>k__BackingField;    // 0x0x18
    public OKCCGMKPMMB <GEELMCEPAFL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PCPIMKMFHEE
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class PCPIMKMFHEE
{
    public Guid <MPNIIACGFCJ>k__BackingField;    // 0x0x10
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x20
    public string <EONANGFNAPH>k__BackingField;    // 0x0x28
    public DateTime <FBPMFPMAIJA>k__BackingField;    // 0x0x30
    public DateTime? <NKAGHNIHPHL>k__BackingField;    // 0x0x38
    public List<KLALDGIFNOB> <OJJBNDBEHCC>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// PDDDGEJEICA
//   (not directly referenced by a detected call)
public class PDDDGEJEICA
{
    // (no instance fields in the metadata dump)
}
...
public class PEHPBPEBEGF
{
    public Guid? <EMIJFOFCMJP>k__BackingField;    // 0x0x10
    public long? <GFLAJKILLMF>k__BackingField;    // 0x0x28
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x38
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x40
    public string <EONANGFNAPH>k__BackingField;    // 0x0x48
    public BOLGMKGEHDB <JEOKDFAFIBI>k__BackingField;    // 0x0x50
}
...
// PHFFHCOAEFI
//   (not directly referenced by a detected call)
public class PHFFHCOAEFI
{
    public MECJMKMPNHG <LDLLMNLGNAB>k__BackingField;    // 0x0x10
    public AHBIGFOGELA <GKJGLAAFNJL>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// PMJFEHGIOOF
// base   : BCCEBIKOMJI<CFEFBLAFKAL>
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{bFDEBADIMBP}   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v2/fromCreator/{bFDEBADIMBP}   [Service.API]
public class PMJFEHGIOOF
{
    // (no instance fields in the metadata dump)
}
...
{
    public LCLNKHFOBHL <JPOMGGFBEAD>k__BackingField;    // 0x0x10
    public string <GFCBKINBGOP>k__BackingField;    // 0x0x18
    public string <ENGPKGCBION>k__BackingField;    // 0x0x20
    public string <HBLKHPOAMGD>k__BackingField;    // 0x0x28
}
...
{
    public long <MEPKFMBFKNI>k__BackingField;    // 0x0x10
    public long? <FNDGEIEDFAG>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public PBFMPLHPIEJ FilterType;    // 0x0x20
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public IFMOMDDBPEO <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public OOPCEELHIOM creatorAccountRole;    // 0x0x58
}
...
{
    public BHCHBONALPJ <KNHEGAJLFCP>k__BackingField;    // 0x0x10
    public AHLJFGCAFOE <MBGMADOLPDM>k__BackingField;    // 0x0x14
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x18
    public string <PLJDNJAJALE>k__BackingField;    // 0x0x20
    public bool <LHIEDONGIJM>k__BackingField;    // 0x0x28
}
...
{
    public List<BHCHBONALPJ> <JNEHACOBOBM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents/event/{kOFMKJNGCOL}   [Service.API]
public class ProgressionEventDTO
{
    public long <HIDKIIFPICO>k__BackingField;    // 0x0x10
    public string <KFMJCOEDHKK>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <JLBPJIIJELM>k__BackingField;    // 0x0x20
    public DateTime <PAIIFDNBMFG>k__BackingField;    // 0x0x28
    public DateTime <DOFGLNJFOLF>k__BackingField;    // 0x0x30
    public DateTime <PDGIBCOMDON>k__BackingField;    // 0x0x38
    public bool <LJEMIAACCGF>k__BackingField;    // 0x0x40
    public int <DGKAJFCODEP>k__BackingField;    // 0x0x44
    public float <OIPOAFMDPIM>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE GET    api/progressionEvents/record/{kOFMKJNGCOL}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <MHPAGCNIGML>k__BackingField;    // 0x0x10
    public int <KCELNECBJCH>k__BackingField;    // 0x0x14
    public int <CIABLEBOCOH>k__BackingField;    // 0x0x18
    public int <AGLNCMOBNOO>k__BackingField;    // 0x0x1C
}
...
{
    public long <ENNPAAFONMF>k__BackingField;    // 0x0x10
    public int <LCEAEJNFHJN>k__BackingField;    // 0x0x18
    public string <EONANGFNAPH>k__BackingField;    // 0x0x20
    public int <KCELNECBJCH>k__BackingField;    // 0x0x28
    public int <GCKPJEKBHFG>k__BackingField;    // 0x0x2C
}
...
public class ReportRequest
{
    ...
    public FHFDJBOGHEB ReportCategory;    // 0x0x20
}
...
{
    public FPHHCLNEBNA? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public FPHHCLNEBNA DJECNFACFMO;  // wrapper
...
{
    public LOEHCCJLAAO CFHBJDPKGOD;  // wrapper
...
{
    public KIKAOKEDCKD ALJEFDPBPKG;  // wrapper
    public int? EMKGHOJMMLJ;  // wrapper
...
{
    public GKIADMNLLFJ UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public IFMOMDDBPEO FFACCLDEOCL;  // wrapper
    public IFMOMDDBPEO? NGKDALPDIEP;  // wrapper
...
{
    public EIHIJJOJAIO HFONEDDDGNK;  // wrapper
...
{
    public DENHIKJMMBE CHAPMDOOFCC;  // wrapper
...
{
    public List<EBBHFLPMPJK> CIHAEICOMCH;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public PDELOPGEAFG MGOMNFNHPNK;  // wrapper
    public IFMOMDDBPEO? COEJKPIPIPO;  // wrapper
...
{
    public GPIGHKBDGIH DBPIOMEIIKK;  // wrapper
...
{
    public StatusResponse> JNJKIKIBHIN;  // wrapper
...
{
    public List<long> BOKDMCPKOIH;  // wrapper
    public LGHAGIJIKKG BBPFPLBFKJO;  // wrapper
    public long? KBCANONAKPK;  // wrapper
    public BKPPJLIKFNH JNJKIKIBHIN;  // wrapper
...
{
    public String> JNJKIKIBHIN;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{hKJOCCFJBGK}  [API POST]
public class PlayereventsV2DeleteHKJOCCFJBGKRequest
{
    public MECJMKMPNHG HKJOCCFJBGK;  // wrapper
}
...
{
    public MECJMKMPNHG HKJOCCFJBGK;  // wrapper
    public MGGMCPGGFKN NJFDEKJAELD;  // wrapper
...
{
    public MECJMKMPNHG HKJOCCFJBGK;  // wrapper
    public long? JLOFMLNGDHM;  // wrapper
    public object clubId;  // candidate
}
...
{
    public MECJMKMPNHG HKJOCCFJBGK;  // wrapper
    public NHDPFJPPCGM HMDEFFCBMPK;  // wrapper
    public NHDPFJPPCGM FPENOHIHLEL;  // wrapper
...
{
    public MECJMKMPNHG HKJOCCFJBGK;  // wrapper
    public long? DECAODAOIFM;  // wrapper
    public object roomId;  // candidate
...
{
    public MECJMKMPNHG HKJOCCFJBGK;  // wrapper
    public List<string> DHOFOPGEMHO;  // wrapper
}
...
{
    public MECJMKMPNHG HKJOCCFJBGK;  // wrapper
    public DateTime AODJBFFJCNI;  // wrapper
    public DateTime AEFHHMDNDNE;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> KAHMNDPAILI;  // wrapper
...
{
    public Guid? DFJFGNKHEFB;  // wrapper
    public object RoomId;  // candidate
    public object Name;  // candidate
    public object Description;  // candidate
...
{
    public MatchCompleteStats FKHGNPLHDJI;  // wrapper
}
...
{
    public Guid AIGALNJDGOI;  // wrapper
    public object RoomKeyId;  // candidate
...
{
    public List<HCJJJCGNDPG> PDENCBGGAEK;  // wrapper
...
{
    public MHBPKMMEMGF GIAMGPEDDEM;  // wrapper
}
