...
public class AALDCLGPMDD
{
    public int <OFLFOBMNMEH>k__BackingField;    // 0x0x10
    public int <NGPIEIBODFK>k__BackingField;    // 0x0x14
    public float <NCENMJNMBAO>k__BackingField;    // 0x0x18
    public float <NKLABBMGMHI>k__BackingField;    // 0x0x1C
    public bool <KMODJDHGMBO>k__BackingField;    // 0x0x20
    public bool <EAOICAPCILI>k__BackingField;    // 0x0x21
    public bool <HEPKOEPMNNF>k__BackingField;    // 0x0x22
}
...
public class AEMDDCBNDJA
{
    public List<KMKFOPFHBBI> <CIBPCCOLHDG>k__BackingField;    // 0x0x10
}
...
public class AHBAKNFNFDN
{
    public bool <EJOCMGFPOFB>k__BackingField;    // 0x0x10
    public string <OMBJLNPLIAO>k__BackingField;    // 0x0x18
    public string <PAEHLAJEBDE>k__BackingField;    // 0x0x20
}
...
public class ALJOODFLGIJ
{
    public long <KPIGFNGONKC>k__BackingField;    // 0x0x10
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x18
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x20
    public DateTime <HGPNCABNLCL>k__BackingField;    // 0x0x28
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x30
    public CJLAADJNMOB <ADNDEOGIAKA>k__BackingField;    // 0x0x38
    public int <BGICEAGOJHA>k__BackingField;    // 0x0x3C
    public int <MFPMKDNKPBN>k__BackingField;    // 0x0x40
    public List<HKBPHCFLHMA> <BONIFMJOHLM>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// ANAHIGPMACD
//   (not directly referenced by a detected call)
public class ANAHIGPMACD
{
    public long <ENODAAPNFEA>k__BackingField;    // 0x0x10
    public Guid? <BKMIEJANPNB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BBDJOLHFGOA
//   (not directly referenced by a detected call)
public class BBDJOLHFGOA
{
    public long <FBEBMMFNICB>k__BackingField;    // 0x0x10
    public Guid <HNAICADFLCE>k__BackingField;    // 0x0x18
    public long <FIOPLHKGDEN>k__BackingField;    // 0x0x28
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x30
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x38
    public int <ENODAAPNFEA>k__BackingField;    // 0x0x40
    public Guid? <LMBGMNLOAAK>k__BackingField;    // 0x0x44
    public DateTime <HGPNCABNLCL>k__BackingField;    // 0x0x58
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x60
}
...
public class BBOMFOKFOLO
{
    public Guid <BKMIEJANPNB>k__BackingField;    // 0x0x10
    public long? <FIOPLHKGDEN>k__BackingField;    // 0x0x20
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x30
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x38
    public FCNKBCCBFAO <AKBEHENADHD>k__BackingField;    // 0x0x40
    public long <GPNCMAACELP>k__BackingField;    // 0x0x48
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x50
    public DateTime <HGPNCABNLCL>k__BackingField;    // 0x0x58
    public DateTime <CLMDDANIECI>k__BackingField;    // 0x0x60
}
...
public class BPJPGEPJOFI
{
    public bool <AMKHJBCKOEO>k__BackingField;    // 0x0x10
    public string <AHNMIJLHIOL>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// CAFOPPOHKOM
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{dGFBLJMJMFI}   [Service.API]
public class CAFOPPOHKOM
{
    public string <PKGEMHHMFFO>k__BackingField;    // 0x0x10
    public string <OMBJLNPLIAO>k__BackingField;    // 0x0x18
    public string <DEMDOKHHGCI>k__BackingField;    // 0x0x20
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x28
    public string <NLEPFCDENKD>k__BackingField;    // 0x0x30
    public CJIMIKFCEDJ <KCOFJNHPGAP>k__BackingField;    // 0x0x38
    public List<string> <MOHGPBNBPND>k__BackingField;    // 0x0x40
    public List<string> <CIBPCCOLHDG>k__BackingField;    // 0x0x48
    public string <EIGKEDIBNNG>k__BackingField;    // 0x0x50
    public List<CHPFLMJKIEB> <OHEOOMDPNHC>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// CDOCLIFGEPO
//   (not directly referenced by a detected call)
public class CDOCLIFGEPO
{
    public int <GODHJJFIFBL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CENANJKHFKI
//   (not directly referenced by a detected call)
public class CENANJKHFKI
{
    public float <FALKGMABJGO>k__BackingField;    // 0x0x10
}
...
public class CHNEGOIDPOD
{
    public AAPGBIPAMEA <KCOFJNHPGAP>k__BackingField;    // 0x0x10
    public BBDJOLHFGOA <FBEEFIDDMPL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CHPFLMJKIEB
//   (not directly referenced by a detected call)
public class CHPFLMJKIEB
{
    public DateTime <HGPNCABNLCL>k__BackingField;    // 0x0x10
    public string <JKPDJGIAOBL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CINJPDKKDGP
//   (not directly referenced by a detected call)
public class CINJPDKKDGP
{
    public int <GNBGJHOEHDE>k__BackingField;    // 0x0x10
}
...
// CNOPDJNBEOJ
//   (not directly referenced by a detected call)
public class CNOPDJNBEOJ
{
    public long <ODMEMPJMIGM>k__BackingField;    // 0x0x10
    public string <HNAICADFLCE>k__BackingField;    // 0x0x18
    public int <BILHBGDDBJH>k__BackingField;    // 0x0x20
    public int <AKAHIFJFAKB>k__BackingField;    // 0x0x24
    public int <CIBINPNAKBP>k__BackingField;    // 0x0x28
    public int <NHKJNCGHHLH>k__BackingField;    // 0x0x2C
    public int <FJPMHCNKPBK>k__BackingField;    // 0x0x30
    public string <CNAOHPPEGGL>k__BackingField;    // 0x0x38
    public string <BLOGDCJIIAJ>k__BackingField;    // 0x0x40
}
...
public class CPLLGNDPHIM : FAKPGFBNEPN
{
    public ELNDDCHEBEC? <CHFCOOFBCMJ>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <BEFMKFBNFJJ>k__BackingField;    // 0x0x20
}
...
// DFKFDLJKNNM
//   (not directly referenced by a detected call)
public class DFKFDLJKNNM
{
    public FCNKBCCBFAO <AKBEHENADHD>k__BackingField;    // 0x0x10
    public int <ENODAAPNFEA>k__BackingField;    // 0x0x14
    public GGJCMMPFMEI <GEONAJCHMOM>k__BackingField;    // 0x0x18
}
...
// DMAPJLNJMLF
//   (not directly referenced by a detected call)
public class DMAPJLNJMLF
{
    public int <BFGOLLGEFEE>k__BackingField;    // 0x0x10
    public DateTime <HGPNCABNLCL>k__BackingField;    // 0x0x18
    public DateTime? <GCCNINCCJND>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DPMNNFLILIA
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class DPMNNFLILIA
{
    public AGIHFHEFHKL <IKLFCKBBKLO>k__BackingField;    // 0x0x10
    public long <IFACPPKKBGD>k__BackingField;    // 0x0x18
    public string <OKHGOJCHMIL>k__BackingField;    // 0x0x20
}
...
public class EDDEPOABODE
{
    public List<string> <HGIGNNLJNOC>k__BackingField;    // 0x0x10
    public List<string> <IDLIKJBHMJD>k__BackingField;    // 0x0x18
    public List<string> <NPKPOLFNKHG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EFCBNMCNDCA
//   (not directly referenced by a detected call)
public class EFCBNMCNDCA
{
    public long <IFACPPKKBGD>k__BackingField;    // 0x0x10
    public int <MAGLNBLHMGC>k__BackingField;    // 0x0x18
    public long <FIOPLHKGDEN>k__BackingField;    // 0x0x20
    public long? <AANEOFPMEBE>k__BackingField;    // 0x0x28
    public long? <HCMGDBDNLGD>k__BackingField;    // 0x0x38
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x48
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x50
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x58
    public DateTime <BJPFOALCHBK>k__BackingField;    // 0x0x60
    public DateTime <OCDHNFOJOGI>k__BackingField;    // 0x0x68
    public int <MONANEBLACN>k__BackingField;    // 0x0x70
    public GELIJHCNHEO <GNMFLJBLHBP>k__BackingField;    // 0x0x74
    public bool <IKPNJBIHJPA>k__BackingField;    // 0x0x78
    public bool <FNIDODIMCAL>k__BackingField;    // 0x0x79
    public KIHACDCEEMK <MGLLLMLJIFH>k__BackingField;    // 0x0x7C
    public KIHACDCEEMK <DOHEJKDAFIJ>k__BackingField;    // 0x0x80
    public long? <AFOOPFELIFC>k__BackingField;    // 0x0x88
}
...
// base   : KDNKEMKKEIL
//   (not directly referenced by a detected call)
public class EFDGKKDINGG : KDNKEMKKEIL
{
    public int <OHNDHHMFLLC>k__BackingField;    // 0x0x60
    public List<MECPEGANOFL> <ONOALNMGJBE>k__BackingField;    // 0x0x68
    public List<MECPEGANOFL> <EMAPHNCBMPF>k__BackingField;    // 0x0x70
    public List<MECPEGANOFL> <PPNAMNGIHGO>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// EHNLMDOPLEF
//   (not directly referenced by a detected call)
public class EHNLMDOPLEF
{
    public EFCBNMCNDCA <AHJMLNMDGDM>k__BackingField;    // 0x0x10
    public GLIKFJHPLOD <FIHAIGFEIIL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EIEGFPENCIP
// base   : ADAFMCLNIGB<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class EIEGFPENCIP
{
    // (no instance fields in the metadata dump)
}
...
public class EKEBJNLHDCE
{
    public Guid <OPPJNFMFHJA>k__BackingField;    // 0x0x10
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x20
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x28
    public DateTime <DHCMCAGNHBP>k__BackingField;    // 0x0x30
    public DateTime? <LNHLCGENOCG>k__BackingField;    // 0x0x38
    public List<NGIBLHAFLHF> <OOHJBJPMHBF>k__BackingField;    // 0x0x48
}
...
public class EMDOIDHCDCH
{
    public HLJFMIOOKLE <FODHEKFMHGG>k__BackingField;    // 0x0x10
    public ANAHIGPMACD <JAACGDPCNEM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EOFDIFCIONF
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class EOFDIFCIONF
{
    public int <MGFAKNIHHGG>k__BackingField;    // 0x0x10
    public Guid <BKMIEJANPNB>k__BackingField;    // 0x0x14
    public long <GDGLJNAIHIA>k__BackingField;    // 0x0x28
    public long <JJDHNJKAJCK>k__BackingField;    // 0x0x30
    public DateTime <DAJMBINKOOJ>k__BackingField;    // 0x0x38
}
...
public class FCCMNBECFEO
{
    public List<EFCBNMCNDCA> <KEJPHJOJDKA>k__BackingField;    // 0x0x10
    public List<EHNLMDOPLEF> <AEJLGAICLNF>k__BackingField;    // 0x0x18
}
...
public class FEBJLAOFIBI
{
    public Guid <MFJACLJFJMA>k__BackingField;    // 0x0x10
    public int <LCPPIJNEDJG>k__BackingField;    // 0x0x20
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x28
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x30
    public int <ENODAAPNFEA>k__BackingField;    // 0x0x38
    public KHHHIDMFHNK <GNMFLJBLHBP>k__BackingField;    // 0x0x3C
    public bool <FIDJJJCNGPL>k__BackingField;    // 0x0x40
    public int? <LBNFJBDJIKK>k__BackingField;    // 0x0x44
    public string <APJAHGICIKH>k__BackingField;    // 0x0x50
    public string <BMFDEIKKICK>k__BackingField;    // 0x0x58
    public string <FIANCCCFCCI>k__BackingField;    // 0x0x60
    public DateTime <HGPNCABNLCL>k__BackingField;    // 0x0x68
    public DateTime <CLMDDANIECI>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// FFAMLNPHKLP
//   (not directly referenced by a detected call)
public class FFAMLNPHKLP
{
    public int <DLNBCAJIFGG>k__BackingField;    // 0x0x10
    public KMNBHKBFEFK <LMACMKAIFOH>k__BackingField;    // 0x0x14
}
...
// FIJFHJJOKEL
//   (not directly referenced by a detected call)
public class FIJFHJJOKEL
{
    public int <BLCCBPCMPMM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FLADGGODPIJ
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{kHNEMHFINBD}   [Service.API]
public class FLADGGODPIJ
{
    public Guid <EJNBPNDLDMC>k__BackingField;    // 0x0x10
    public int <MGFAKNIHHGG>k__BackingField;    // 0x0x20
    public int <AFMKMFJJHMC>k__BackingField;    // 0x0x24
    public DateTime <HGPNCABNLCL>k__BackingField;    // 0x0x28
}
...
// FOIMDCEAJAD
//   (not directly referenced by a detected call)
public class FOIMDCEAJAD
{
    public Guid <MFAKIPFKALJ>k__BackingField;    // 0x0x10
    public int <MGFAKNIHHGG>k__BackingField;    // 0x0x20
    public int <JKMJMENDEMF>k__BackingField;    // 0x0x24
    public Guid <GOFLIPOBKKN>k__BackingField;    // 0x0x28
    public DateTime <CLMDDANIECI>k__BackingField;    // 0x0x38
    public IKCMFNNPHOD <MHIOKOONCDH>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// GCKNIDLBOOG
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class GCKNIDLBOOG
{
    public FCNKBCCBFAO <AKBEHENADHD>k__BackingField;    // 0x0x10
    public DHHDMIIBCEI <BDEEDLIKHLD>k__BackingField;    // 0x0x14
    public int <FFKGLLGLLPH>k__BackingField;    // 0x0x18
    public int <LJGPFNJMOOI>k__BackingField;    // 0x0x1C
    public int <LILCKFIOKJO>k__BackingField;    // 0x0x20
    public KJBJOIHPKBJ <GBLKGJANLDK>k__BackingField;    // 0x0x24
    public bool <OADIPAEOHME>k__BackingField;    // 0x0x28
    public float <CGMFGMOCKGD>k__BackingField;    // 0x0x2C
    public int <HHGMFKNLIPP>k__BackingField;    // 0x0x30
    public bool <MNLIHLKKAPP>k__BackingField;    // 0x0x34
}
...
//   RESPONSE GET    api/avatar/v2/{dNHODCCDDPH}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{dNHODCCDDPH}   [Service.API]
public class GGBJBAIDFDN
{
    public string <EMDNKFMNLNM>k__BackingField;    // 0x0x10
    public string <GLICLNMCFDB>k__BackingField;    // 0x0x18
    public string <PGEAPMDFBEO>k__BackingField;    // 0x0x20
    public string <EBNKKDLPBNE>k__BackingField;    // 0x0x28
    public string <AKPGLKEJKEL>k__BackingField;    // 0x0x30
    public List<PHPOLPFMHJA> <DAKMDKOIMIL>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// GGJCMMPFMEI
//   (not directly referenced by a detected call)
public class GGJCMMPFMEI
{
    public int <DEAODJLFPEB>k__BackingField;    // 0x0x10
    public DateTime? <KMAMANBBGPF>k__BackingField;    // 0x0x18
    public DateTime? <JMNADLKIDFJ>k__BackingField;    // 0x0x28
}
...
public class GLICNPLPEAF
{
    public JKLNHHINGGO <IKLFCKBBKLO>k__BackingField;    // 0x0x10
    public string <OKHGOJCHMIL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GLIKFJHPLOD
//   (not directly referenced by a detected call)
public class GLIKFJHPLOD
{
    public long <MEHHPCFNLOE>k__BackingField;    // 0x0x10
    public long <IFACPPKKBGD>k__BackingField;    // 0x0x18
    public int <HGEPIJACLJB>k__BackingField;    // 0x0x20
    public DateTime <HGPNCABNLCL>k__BackingField;    // 0x0x28
    public FBPNBMGFCBC <NIHDDJPOEBB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GOHOIPPCECJ
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{oHEOPCKIJPJ}   [Service.API]
...
public class GOHOIPPCECJ
{
    public EFCBNMCNDCA <AHJMLNMDGDM>k__BackingField;    // 0x0x10
    public KMNBHKBFEFK <LMACMKAIFOH>k__BackingField;    // 0x0x18
    public KAIAALHHIJO <FCAMPDNKHJB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GPKOCNINDBA
//   (not directly referenced by a detected call)
public class GPKOCNINDBA
{
    public int <OFKKFDNKJOG>k__BackingField;    // 0x0x10
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x18
    public string <PEJIPICOOGG>k__BackingField;    // 0x0x20
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x28
    public string <AKFEPMPHGFP>k__BackingField;    // 0x0x30
    public bool <INGBCCDOHED>k__BackingField;    // 0x0x38
    public int <IJJBOKNNMME>k__BackingField;    // 0x0x3C
    public OMGJBAFOBCG <OLAAMMMDAAN>k__BackingField;    // 0x0x40
    public INCMHIKDIBH IADEPGGDGIP;    // 0x0x48
    public INCMHIKDIBH EJHFCABDAOC;    // 0x0x50
    public INCMHIKDIBH IDJFKLPMCHO;    // 0x0x58
    public LEDHFPJOOOA NPNDBEMMNKJ;    // 0x0x60
}
...
public class HBLMEGDIKKK
{
    public int <NGPIEIBODFK>k__BackingField;    // 0x0x10
    public bool <KMODJDHGMBO>k__BackingField;    // 0x0x14
    public DateTime <JAHPDMIFHFN>k__BackingField;    // 0x0x18
    public bool <GFABKACLAHA>k__BackingField;    // 0x0x20
}
...
public class HIGBIMEPDOA
{
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HKBPHCFLHMA
//   RESPONSE GET    api/groups/v1/memberships/{gDOGDBJHLHP}   [Service.API]
public class HKBPHCFLHMA
{
    public long <KPIGFNGONKC>k__BackingField;    // 0x0x10
    public int <HGEPIJACLJB>k__BackingField;    // 0x0x18
    public ODDGNPAOKNG <HACIOLLBCND>k__BackingField;    // 0x0x1C
}
...
public class HLJFMIOOKLE
{
    public Guid? <KFPAPMLHCME>k__BackingField;    // 0x0x10
    public Guid <BFIJMPMCDAG>k__BackingField;    // 0x0x24
}
...
public class HOKIDGDLKOG
{
    public int <AAMHJPJCBMN>k__BackingField;    // 0x0x10
    public List<HPPLKADADJI> <NLOKKJOJJEK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HPFDAFJJJIJ
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class HPFDAFJJJIJ
{
    public NBHHPOFMEPG <AMEOOKBDADP>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <BEFMKFBNFJJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HPPLKADADJI
//   (not directly referenced by a detected call)
public class HPPLKADADJI
{
    public DateTime? <MCMINEDONHM>k__BackingField;    // 0x0x10
    public DateTime? <ECDDPGLDAJM>k__BackingField;    // 0x0x20
    public PGFMKAGEGNE <KCOFJNHPGAP>k__BackingField;    // 0x0x30
    public KFKLANHAAHM <IFCFFMODANN>k__BackingField;    // 0x0x38
    public bool <GJMKDDLAAHN>k__BackingField;    // 0x0x40
}
...
public class ICBFPLKIEEM
{
    public ANAHIGPMACD <OIMDHHNOFCC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IHCFABIFMPN
//   (not directly referenced by a detected call)
public class IHCFABIFMPN
{
    public bool <JJKMPHOCCHI>k__BackingField;    // 0x0x10
    public MKHALMPJKLG <PCKFGIGALIM>k__BackingField;    // 0x0x14
    public int <PLGNPNNNGPD>k__BackingField;    // 0x0x18
    public DateTime <CLMDDANIECI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IKCMFNNPHOD
//   (not directly referenced by a detected call)
public class IKCMFNNPHOD
{
    public Guid <MFAKIPFKALJ>k__BackingField;    // 0x0x10
    public long <FIOPLHKGDEN>k__BackingField;    // 0x0x20
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x28
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x30
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x38
    public long <ENODAAPNFEA>k__BackingField;    // 0x0x40
    public Guid? <LMBGMNLOAAK>k__BackingField;    // 0x0x48
    public DateTime <CLMDDANIECI>k__BackingField;    // 0x0x60
}
...
public class JCINEDJFOFC
{
    public int <GAEJFCJILOI>k__BackingField;    // 0x0x10
}
...
public class KAGKCDMLMJL
{
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KAIAALHHIJO
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class KAIAALHHIJO
{
    public JKECBFHHEPN <LMACMKAIFOH>k__BackingField;    // 0x0x10
    public List<string> <CIBPCCOLHDG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KDNKEMKKEIL
//   (not directly referenced by a detected call)
public class KDNKEMKKEIL
{
    public int <AFMKMFJJHMC>k__BackingField;    // 0x0x10
    public MMJIOIDGNDB <NIHDDJPOEBB>k__BackingField;    // 0x0x14
    public List<DFKFDLJKNNM> <IEKILDKLHGO>k__BackingField;    // 0x0x18
    public List<DFKFDLJKNNM> <IKCLEENFOAM>k__BackingField;    // 0x0x20
    public bool <FIDJJJCNGPL>k__BackingField;    // 0x0x28
    public DateTime? <PPBCPGOMLBA>k__BackingField;    // 0x0x30
    public DateTime? <DDFEDPIODKE>k__BackingField;    // 0x0x40
    public DateTime? <HBPMCKCJNFO>k__BackingField;    // 0x0x50
}
...
// KFKLANHAAHM
//   (not directly referenced by a detected call)
public class KFKLANHAAHM
{
    public int <PNENPMNJMJA>k__BackingField;    // 0x0x10
    public int <LNGLNBCFIIG>k__BackingField;    // 0x0x14
    public int <CFNMAKBBAFO>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{bDNAKAPNAFM}   [Service.API]
public class KMAGIDBCDDM
{
    public long <FIOPLHKGDEN>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <EJGEPAPMCDN>k__BackingField;    // 0x0x18
    public BDGLAOBGEAC <EAPLOGHDBBH>k__BackingField;    // 0x0x20
}
...
// KMKFOPFHBBI
//   (not directly referenced by a detected call)
public class KMKFOPFHBBI
{
    public string <FJDGDPIFPKO>k__BackingField;    // 0x0x10
    public AALBGBLIEOM <NIHDDJPOEBB>k__BackingField;    // 0x0x18
}
...
public class KMMMMLHJLFP
{
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x10
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x18
    public int? <ENODAAPNFEA>k__BackingField;    // 0x0x20
    public KHHHIDMFHNK? <GNMFLJBLHBP>k__BackingField;    // 0x0x28
}
...
// --------------------------------------------------------------------------
// KNGOIKALGNC
// base   : ADAFMCLNIGB<FEBJLAOFIBI>
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{aFFHIJJKEDJ}   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v2/fromCreator/{aFFHIJJKEDJ}   [Service.API]
public class KNGOIKALGNC
{
    // (no instance fields in the metadata dump)
}
...
public class KOAHCCBDOBP
{
    public Guid? <MFAKIPFKALJ>k__BackingField;    // 0x0x10
    public long? <FIOPLHKGDEN>k__BackingField;    // 0x0x28
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x38
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x40
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x48
    public ANAHIGPMACD <OIMDHHNOFCC>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// LACALGKOLNK
//   (not directly referenced by a detected call)
public class LACALGKOLNK
{
    public FGBDCFOKMPF OEFAFHOEBLL;    // 0x0x10
    public int LHBDIFCHLGP;    // 0x0x14
}
...
public class LGLGCAPBGCG
{
    public List<FFAMLNPHKLP> <KJDNFHNCBBB>k__BackingField;    // 0x0x10
    public KMNBHKBFEFK <LMACMKAIFOH>k__BackingField;    // 0x0x18
}
...
public class LIMPKFFOLIG
{
    public List<int> <PBCBDLPFMDE>k__BackingField;    // 0x0x10
    public string <LOJPOPKIAKE>k__BackingField;    // 0x0x18
}
...
public class LMCHGHHIGIF
{
    public int <PDAKCLCNMJA>k__BackingField;    // 0x0x10
    public int <LEOPACFHJPD>k__BackingField;    // 0x0x14
    public float <GPPGNCDICKD>k__BackingField;    // 0x0x18
    public int <NJLJCLKFHGC>k__BackingField;    // 0x0x1C
    public int <GGJAEJCBLBN>k__BackingField;    // 0x0x20
    public int <ABHEEADMFAO>k__BackingField;    // 0x0x24
    public int <HGJJNLJCHCK>k__BackingField;    // 0x0x28
    public string <GFNKEALNEII>k__BackingField;    // 0x0x30
    public string <HGGBAMDCLHK>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// MACIOJJPPCI
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class MACIOJJPPCI
{
    public int <EKHACGLFEIC>k__BackingField;    // 0x0x10
    public string <AKBFCEGFEAF>k__BackingField;    // 0x0x18
    public List<GPKOCNINDBA> <IOPJDCKPPJP>k__BackingField;    // 0x0x20
    public PDMKFDMNKLO <PAIBDJHFGHI>k__BackingField;    // 0x0x28
    public string <ALHEMDIAPJM>k__BackingField;    // 0x0x30
    public DateTime <DHCMCAGNHBP>k__BackingField;    // 0x0x38
    public DateTime <NAKIONJGJCN>k__BackingField;    // 0x0x40
    public DateTime <KKCGMMBCIII>k__BackingField;    // 0x0x48
    public bool? <FBPCEEGLAPA>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// MBJFBPHIEBA
//   (not directly referenced by a detected call)
public class MBJFBPHIEBA
{
    public ObscuredLong <ODMEMPJMIGM>k__BackingField;    // 0x0x10
    public string <HNAICADFLCE>k__BackingField;    // 0x0x38
    public ObscuredInt <MAGLNBLHMGC>k__BackingField;    // 0x0x40
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x58
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x60
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x68
    public int <FFGLLENCIFL>k__BackingField;    // 0x0x70
    public KHHHIDMFHNK <GNMFLJBLHBP>k__BackingField;    // 0x0x74
    public DateTime <CLMDDANIECI>k__BackingField;    // 0x0x78
    public DateTime <HGPNCABNLCL>k__BackingField;    // 0x0x80
    public DateTime? <FFHJFOEBCKC>k__BackingField;    // 0x0x88
    public long? <AEMHKJOEIFJ>k__BackingField;    // 0x0x98
    public int <DONAPOICELB>k__BackingField;    // 0x0xA8
    public int <HLDDKKFFOCI>k__BackingField;    // 0x0xAC
    public int <DJHKILGBIBG>k__BackingField;    // 0x0xB0
    public LFKFOBGPCGE <FPKLMFBDAHI>k__BackingField;    // 0x0xB4
    public LFKFOBGPCGE <HPFADHPNMIA>k__BackingField;    // 0x0xB8
    public ObscuredBool <FHEOCIHACFF>k__BackingField;    // 0x0xBC
    public ObscuredBool <GNOBOPPJNEP>k__BackingField;    // 0x0xC8
    public ObscuredBool <COBOHDMFIMB>k__BackingField;    // 0x0xD4
    public int? <ENODAAPNFEA>k__BackingField;    // 0x0xE0
    public bool <OKIPABKLEPK>k__BackingField;    // 0x0xE8
}

// --------------------------------------------------------------------------
// MEBEIHMJFGH
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class MEBEIHMJFGH
{
    public AGIHFHEFHKL <IKLFCKBBKLO>k__BackingField;    // 0x0x10
    public int <GAEJFCJILOI>k__BackingField;    // 0x0x14
    public long <NDFLINADKAJ>k__BackingField;    // 0x0x18
    public bool <LDFIHJDFDAG>k__BackingField;    // 0x0x20
    public string <AHNMIJLHIOL>k__BackingField;    // 0x0x28
    public int? <DGKBLMCKGNE>k__BackingField;    // 0x0x30
    public bool <IGCIIJJGNFE>k__BackingField;    // 0x0x38
    public bool <AFBNPIGHPBI>k__BackingField;    // 0x0x39
    public bool <LNAIIKPPOKM>k__BackingField;    // 0x0x3A
    public string <NJFEGCCEABA>k__BackingField;    // 0x0x40
    public DateTime? <FAOAMMADNGB>k__BackingField;    // 0x0x48
    public float <GJOCNFMJLPL>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// MECPEGANOFL
//   (not directly referenced by a detected call)
public class MECPEGANOFL
{
    public bool <DHLGJPGOIDM>k__BackingField;    // 0x0x10
    public NKLAEFFIMFK <INGNCNJDPCP>k__BackingField;    // 0x0x18
    public float <NPEFFIPMDCE>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{oMGOLOAJIPJ}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{oMGOLOAJIPJ}   [Service.API]
...
public class MEEMKKLGKKK
{
    public KHEDPGGCIEK <KCOFJNHPGAP>k__BackingField;    // 0x0x10
    public IKCMFNNPHOD <MHIOKOONCDH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MFBCBGHMCNL
//   (not directly referenced by a detected call)
public class MFBCBGHMCNL
{
    public float <FIFIFHCEHCC>k__BackingField;    // 0x0x10
    public float <CJHKDJIDOLO>k__BackingField;    // 0x0x14
    public float <MFEJMMAAMIP>k__BackingField;    // 0x0x18
    public float <ONFCMIEHECA>k__BackingField;    // 0x0x1C
    public float <AHKBFPJIDAK>k__BackingField;    // 0x0x20
    public float <KHCKOKKECNB>k__BackingField;    // 0x0x24
    public float <PAMIFAOICMC>k__BackingField;    // 0x0x28
    public float <MIBFJENCIOK>k__BackingField;    // 0x0x2C
}
...
public class MLJHEELOIGL
{
    public KHEDPGGCIEK <KCOFJNHPGAP>k__BackingField;    // 0x0x10
    public FOIMDCEAJAD <OJMOFCAHLMK>k__BackingField;    // 0x0x18
}
...
public class MMIEEGFEKGJ : FAKPGFBNEPN
{
    public FBHKBLJOHCC? <CHFCOOFBCMJ>k__BackingField;    // 0x0x18
    public NBHHPOFMEPG <AMEOOKBDADP>k__BackingField;    // 0x0x20
}
...
public class MPLHIADDJGK
{
    public string <PPMCBCOFDCK>k__BackingField;    // 0x0x10
    public string <JBCIPFPOPHP>k__BackingField;    // 0x0x18
    public bool <NPPLBENDCEI>k__BackingField;    // 0x0x20
    public string <GPHPHGDLABF>k__BackingField;    // 0x0x28
}
...
// base   : KDNKEMKKEIL
//   (not directly referenced by a detected call)
public class NAGIIKAHDNL : KDNKEMKKEIL
{
    public NKLAEFFIMFK <INGNCNJDPCP>k__BackingField;    // 0x0x60
}
...
public class NBHHPOFMEPG
{
    public int <MGFAKNIHHGG>k__BackingField;    // 0x0x10
    public Guid <BKMIEJANPNB>k__BackingField;    // 0x0x14
    public long <GDGLJNAIHIA>k__BackingField;    // 0x0x28
    public DateTime <CLMDDANIECI>k__BackingField;    // 0x0x30
}
...
public class NCOKACIBALK : ValueType
{
    public int <EOEADOLIDFC>k__BackingField;    // 0x0x0
}

// --------------------------------------------------------------------------
// NDPPLOAOAMN
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class NDPPLOAOAMN
{
    public int <IJJBOKNNMME>k__BackingField;    // 0x0x10
    public string <HOCICENHNGB>k__BackingField;    // 0x0x18
    public string <EMDNKFMNLNM>k__BackingField;    // 0x0x20
    public string <GLICLNMCFDB>k__BackingField;    // 0x0x28
    public string <PGEAPMDFBEO>k__BackingField;    // 0x0x30
    public string <EBNKKDLPBNE>k__BackingField;    // 0x0x38
    public string <AKPGLKEJKEL>k__BackingField;    // 0x0x40
    public List<PHPOLPFMHJA> <DAKMDKOIMIL>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// NFGAKLPGPJH
//   RESPONSE GET    api/inventions/v1/personaldetails/{gLMAOIGAOGN}   [Service.API]
public class NFGAKLPGPJH
{
    public bool <ABAJMBJDBLL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NGIBLHAFLHF
//   (not directly referenced by a detected call)
public class NGIBLHAFLHF
{
    public Guid <OONGCCEEKEI>k__BackingField;    // 0x0x10
    public Guid <NGHDFFGLIDD>k__BackingField;    // 0x0x20
    public DateTime <DHCMCAGNHBP>k__BackingField;    // 0x0x30
    public List<NKLAEFFIMFK> <MNPDCJCICOF>k__BackingField;    // 0x0x38
}
...
public class NIEOIAMJHHC
{
    public List<DMAPJLNJMLF> <JMGIJPKOEGL>k__BackingField;    // 0x0x10
    public string <LOJPOPKIAKE>k__BackingField;    // 0x0x18
}
...
// NKLAEFFIMFK
//   (not directly referenced by a detected call)
public class NKLAEFFIMFK
{
    public int <JELEDMMLPOK>k__BackingField;    // 0x0x10
    public string <DNANJNKGJMA>k__BackingField;    // 0x0x18
    public string <AKFEPMPHGFP>k__BackingField;    // 0x0x20
    public string <FMIDKNNBCED>k__BackingField;    // 0x0x28
    public string <ENEHMKCIONB>k__BackingField;    // 0x0x30
    public string <BBOJONOCFGM>k__BackingField;    // 0x0x38
    public MMPIACNOKDO? <GAHJMPGDLNG>k__BackingField;    // 0x0x40
    public string <EKLEJECBBNB>k__BackingField;    // 0x0x48
    public string <GBFOEMDENAH>k__BackingField;    // 0x0x50
    public bool <PGKBJGMPDIK>k__BackingField;    // 0x0x58
    public bool <LKICBHEBJBO>k__BackingField;    // 0x0x59
    public bool <BILOIMMDIDO>k__BackingField;    // 0x0x5A
    public MHPLKDMOJKF <FBDLFBGAEIJ>k__BackingField;    // 0x0x5C
    public int <GKEKFAEDPLG>k__BackingField;    // 0x0x60
    public FCNKBCCBFAO <AKBEHENADHD>k__BackingField;    // 0x0x64
    public int <DDLMCOCCHKE>k__BackingField;    // 0x0x68
    public KFBIBKHLEGO <JEINKOGLOLL>k__BackingField;    // 0x0x6C
    public KMGOJIDNKKC <LCEDCNBEEBB>k__BackingField;    // 0x0x70
    public int? <NDMMDEAPHJH>k__BackingField;    // 0x0x74
    public string <GHJKDDJCLFB>k__BackingField;    // 0x0x80
}
...
public class NKNCEGFIGAM
{
    public KMNBHKBFEFK <LMACMKAIFOH>k__BackingField;    // 0x0x10
}
...
public class NLEJLOHJLBH : MHJMFAFBCLB
{
    public List<NAGIIKAHDNL> JADCBOOKMHI;    // 0x0x30
    public int <EBOJCOHFDLP>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// NMHDDJLLEDL
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{dGFBLJMJMFI}   [Service.API]
public class NMHDDJLLEDL
{
    public uint <PKGEMHHMFFO>k__BackingField;    // 0x0x10
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x18
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x20
    public DateTime <DNOJDFCIJJM>k__BackingField;    // 0x0x28
    public DateTime? <CPNKCECMNNI>k__BackingField;    // 0x0x30
    public bool <ICDAAIKBGID>k__BackingField;    // 0x0x40
    public List<CAFOPPOHKOM> <BALHELOHFDC>k__BackingField;    // 0x0x48
    public List<string> <CIBPCCOLHDG>k__BackingField;    // 0x0x50
    public int <ALAIKJCABKF>k__BackingField;    // 0x0x58
    public int <OJPGPPNBDDG>k__BackingField;    // 0x0x5C
    public int <NILIKNLOAHG>k__BackingField;    // 0x0x60
}
...
public class NNEBNLDGFGF
{
    public long <FIOPLHKGDEN>k__BackingField;    // 0x0x10
    public long? <AANEOFPMEBE>k__BackingField;    // 0x0x18
    public long? <HCMGDBDNLGD>k__BackingField;    // 0x0x28
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x38
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x40
    public List<string> <CIBPCCOLHDG>k__BackingField;    // 0x0x48
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x50
    public DateTime <BJPFOALCHBK>k__BackingField;    // 0x0x58
    public DateTime <OCDHNFOJOGI>k__BackingField;    // 0x0x60
    public GELIJHCNHEO <GNMFLJBLHBP>k__BackingField;    // 0x0x68
    public bool <IKPNJBIHJPA>k__BackingField;    // 0x0x6C
    public bool <FNIDODIMCAL>k__BackingField;    // 0x0x6D
    public KIHACDCEEMK <MGLLLMLJIFH>k__BackingField;    // 0x0x70
    public KIHACDCEEMK <DOHEJKDAFIJ>k__BackingField;    // 0x0x74
}
...
public class OALMAECOAMJ : MHJMFAFBCLB
{
    public int <JKEJPEEPHGB>k__BackingField;    // 0x0x30
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x38
    public DateTime <DHCMCAGNHBP>k__BackingField;    // 0x0x40
    public DateTime <NAKIONJGJCN>k__BackingField;    // 0x0x48
    public FCNKBCCBFAO <AKBEHENADHD>k__BackingField;    // 0x0x50
    public KDNKEMKKEIL <BOCDBIOGLOK>k__BackingField;    // 0x0x58
    public List<EFDGKKDINGG> <BOOIFFLCNOH>k__BackingField;    // 0x0x60
    public IHCFABIFMPN <MLLEABCKOLA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// OBFCIKDJFHJ
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class OBFCIKDJFHJ
{
    public long <IFACPPKKBGD>k__BackingField;    // 0x0x10
    public FBPNBMGFCBC <NIHDDJPOEBB>k__BackingField;    // 0x0x18
}
...
public class OBOENKEMFCD
{
    public Dictionary<int, int> <KIALMMBEHPB>k__BackingField;    // 0x0x10
    public List<NPNJMEFFFNA> <CBHIHEMKEGP>k__BackingField;    // 0x0x18
    public LACALGKOLNK[][] <CMGFFAGHHBN>k__BackingField;    // 0x0x20
    public CINJPDKKDGP <NMLMFBFGPLA>k__BackingField;    // 0x0x28
    public MFBCBGHMCNL <LCODJDODELK>k__BackingField;    // 0x0x30
    public CDOCLIFGEPO <LDJMFLFELIO>k__BackingField;    // 0x0x38
    public FIJFHJJOKEL <FFAPEABOMJP>k__BackingField;    // 0x0x40
    public CENANJKHFKI <OEFHMDFDAKD>k__BackingField;    // 0x0x48
    public string <OCBCGJKOABL>k__BackingField;    // 0x0x50
}
...
public class OEEFFNAEGJK
{
    public int <LCPPIJNEDJG>k__BackingField;    // 0x0x10
    public int? <LBNFJBDJIKK>k__BackingField;    // 0x0x14
    public string <BMFDEIKKICK>k__BackingField;    // 0x0x20
    public string <APJAHGICIKH>k__BackingField;    // 0x0x28
}
...
public class OEKAOCLBNHA
{
    public HTTPResponse BDFEHMIAIOD;    // 0x0x10
    public int? FGFCGDICOOA;    // 0x0x18
    public string NLDLHKHEGOD;    // 0x0x20
    public byte[] GGMAFMNLMEB;    // 0x0x28
    public string JJGJIFOHKIC;    // 0x0x30
}
...
public class OEOFJOBGGHO
{
    public int <HDGONOMPDEP>k__BackingField;    // 0x0x10
    public GEHBHCOLKND <NIHDDJPOEBB>k__BackingField;    // 0x0x14
    public JOJLEOEOKCM <GAAECCKBBPH>k__BackingField;    // 0x0x18
    public JOJLEOEOKCM <AIGACGNCJGD>k__BackingField;    // 0x0x1C
    public JOJLEOEOKCM <BGNFIENNFCA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OINEFGLKPMG
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class OINEFGLKPMG
{
    public int? <PFHPFFAFIEC>k__BackingField;    // 0x0x10
    public string <NLEPFCDENKD>k__BackingField;    // 0x0x18
    public string <IBOFKDCMMBD>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/keepsakes/{cNIAEHONKDI}   [Service.API]
//   RESPONSE POST   api/keepsakes/{cNIAEHONKDI}/collect   [Service.API]
...
public class OLEODONJPLG
{
    public bool <AMKHJBCKOEO>k__BackingField;    // 0x0x10
    public string <KFMBCBBBBIE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OMGJBAFOBCG
//   (not directly referenced by a detected call)
public class OMGJBAFOBCG
{
    // (no instance fields in the metadata dump)
}
...
// PDMKFDMNKLO
//   (not directly referenced by a detected call)
public class PDMKFDMNKLO
{
    public long <JELEDMMLPOK>k__BackingField;    // 0x0x10
    public string <ENEHMKCIONB>k__BackingField;    // 0x0x18
    public string <AOLADODMCNB>k__BackingField;    // 0x0x20
    public MMPIACNOKDO? <GAHJMPGDLNG>k__BackingField;    // 0x0x28
    public string <EKLEJECBBNB>k__BackingField;    // 0x0x30
    public string <GBFOEMDENAH>k__BackingField;    // 0x0x38
    public PKDMIHGLLON <FKIGFDICPIG>k__BackingField;    // 0x0x40
    public int <BLGAILMHCKG>k__BackingField;    // 0x0x44
    public int <OMOHGAMGADG>k__BackingField;    // 0x0x48
    public KMGOJIDNKKC? <INACHIFGHJH>k__BackingField;    // 0x0x4C
    public MHPLKDMOJKF? <BCAGLHAJIOG>k__BackingField;    // 0x0x54
}
...
public class PGDGPKCGFEI
{
    public LGOKKKMOIEH <KCOFJNHPGAP>k__BackingField;    // 0x0x10
    public MBJFBPHIEBA <LLPBCLKNECI>k__BackingField;    // 0x0x18
    public CNOPDJNBEOJ <DHOMPBDCOIL>k__BackingField;    // 0x0x20
}
...
// PHPOLPFMHJA
//   (not directly referenced by a detected call)
public class PHPOLPFMHJA
{
    public Guid <MFJACLJFJMA>k__BackingField;    // 0x0x10
    public byte <LJGBMOABGGH>k__BackingField;    // 0x0x20
}
...
public class PKKCILBHLBH
{
    public Guid <IFIMEMHMMEN>k__BackingField;    // 0x0x10
    public Guid <BKMIEJANPNB>k__BackingField;    // 0x0x20
    public int <LKKDPLKODDD>k__BackingField;    // 0x0x30
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x38
    public long <BFKMPJNHDLO>k__BackingField;    // 0x0x40
    public long <ENODAAPNFEA>k__BackingField;    // 0x0x48
    public DateTime <CLMDDANIECI>k__BackingField;    // 0x0x50
}
...
public class AddKeepsakeInstanceRequest
{
    public long <FIOPLHKGDEN>k__BackingField;    // 0x0x10
    public long? <AANEOFPMEBE>k__BackingField;    // 0x0x18
    public FAOJNBNJNKJ <IDOBDDIHFPI>k__BackingField;    // 0x0x28
}
...
{
    public LOBGLMGGHHJ <LMACMKAIFOH>k__BackingField;    // 0x0x10
    public string <EOJOABPCIKL>k__BackingField;    // 0x0x18
    public string <EJNJAOFHKBM>k__BackingField;    // 0x0x20
    public string <MCNLDPCHEAC>k__BackingField;    // 0x0x28
}
...
{
    public long <IFACPPKKBGD>k__BackingField;    // 0x0x10
    public long? <AGINNAKMCEE>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public KADMOJHHCFK FilterType;    // 0x0x20
...
{
    public FAOJNBNJNKJ <CJAPGMBHIHA>k__BackingField;    // 0x0x10
    public string <NJNGHOMEABE>k__BackingField;    // 0x0x18
    public int <IANJOFOPBHB>k__BackingField;    // 0x0x20
    public int <GBPKKLBPIPB>k__BackingField;    // 0x0x24
}
...
{
    public int <MGFAKNIHHGG>k__BackingField;    // 0x0x10
    public Guid <EAOLDDJEAGP>k__BackingField;    // 0x0x14
    public DateTime <CIDJPEFNCHL>k__BackingField;    // 0x0x28
}
...
{
    public bool <IMMBEAHAOEL>k__BackingField;    // 0x0x10
    public int <JCHMPAPFGNC>k__BackingField;    // 0x0x14
}
...
{
    public Guid <EAOLDDJEAGP>k__BackingField;    // 0x0x10
    public FAOJNBNJNKJ <IBPCPPPFGJF>k__BackingField;    // 0x0x20
    public int <PMKBOLLLJGH>k__BackingField;    // 0x0x24
    public long <FIOPLHKGDEN>k__BackingField;    // 0x0x28
    public long? <AANEOFPMEBE>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes/events/{gFDICPFBPDP}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <HNLAKOJBKEN>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <IEBCONBEOMF>k__BackingField;    // 0x0x18
}
...
{
    public long <ANAOAEELIAN>k__BackingField;    // 0x0x10
    public long <FIOPLHKGDEN>k__BackingField;    // 0x0x18
    public long <DAMBFMFLANE>k__BackingField;    // 0x0x20
    public AJNIJFGMOFB <NIHDDJPOEBB>k__BackingField;    // 0x0x28
    public int <LKKDPLKODDD>k__BackingField;    // 0x0x2C
}
...
{
    public long <FIOPLHKGDEN>k__BackingField;    // 0x0x10
    public List<Guid> <DGBGJNBIHGG>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <HNLAKOJBKEN>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <IEBCONBEOMF>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <LDLOJICPGDL>k__BackingField;    // 0x0x20
}
...
{
    public long <DAMBFMFLANE>k__BackingField;    // 0x0x10
    public long <OAKOHBMNGBA>k__BackingField;    // 0x0x18
    public int? <KPCLHFCDEKF>k__BackingField;    // 0x0x20
    public int? <MDMDECHIJKP>k__BackingField;    // 0x0x28
    public long? <DDLIKKKICJF>k__BackingField;    // 0x0x30
    public long <KEPNGMBALBL>k__BackingField;    // 0x0x40
    public long <NPCOAJIKMGC>k__BackingField;    // 0x0x48
    public int <HFGGLALHPEL>k__BackingField;    // 0x0x50
    public AJNIJFGMOFB <NBDLIGLJLOJ>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <JNGBBOOFELM>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public KMGOJIDNKKC <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public MEACKONEKFB creatorAccountRole;    // 0x0x58
}
...
{
    public EFAFGBGPLIJ <MLCLAEMDJML>k__BackingField;    // 0x0x10
    public BMMIKCJCLII <BJCJKJKFOHC>k__BackingField;    // 0x0x14
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x18
    public string <ODDIMENOHEI>k__BackingField;    // 0x0x20
    public bool <JICMCADDHJP>k__BackingField;    // 0x0x28
}
...
{
    public List<EFAFGBGPLIJ> <APHDNKODLIK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents/event/{lFGDKJFNCOK}   [Service.API]
public class ProgressionEventDTO
{
    public long <OAKOHBMNGBA>k__BackingField;    // 0x0x10
    public string <CAPFPAMHLCH>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <PPNAMNGIHGO>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <KCBJCELNMPO>k__BackingField;    // 0x0x28
    public DateTime <BJPFOALCHBK>k__BackingField;    // 0x0x30
    public DateTime <OCDHNFOJOGI>k__BackingField;    // 0x0x38
    public DateTime <HHFKKHEHAPL>k__BackingField;    // 0x0x40
    public bool <JFBLNLEOOBF>k__BackingField;    // 0x0x48
    public int <IBAANMHOHGG>k__BackingField;    // 0x0x4C
    public float <GODKHHNAAAO>k__BackingField;    // 0x0x50
    public Guid? <OCLMOGJJOIF>k__BackingField;    // 0x0x54
    public string <BOGEEDJKIOP>k__BackingField;    // 0x0x68
    public string <GFNPDGOJEHK>k__BackingField;    // 0x0x70
    public string <KCHOOECAGAD>k__BackingField;    // 0x0x78
    public string <LFANDJONMPM>k__BackingField;    // 0x0x80
}
...
{
    public Guid <GAEFAKBNEOF>k__BackingField;    // 0x0x10
    public int <NHJEKKENHJL>k__BackingField;    // 0x0x20
    public int <APMGADFLMCN>k__BackingField;    // 0x0x24
    public long <ICJLEDDHDLP>k__BackingField;    // 0x0x28
    public long <DHNINBCEBDF>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE GET    api/progressionEvents/record/{lFGDKJFNCOK}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <MGFAKNIHHGG>k__BackingField;    // 0x0x10
    public int <BLGAILMHCKG>k__BackingField;    // 0x0x14
    public int <FEKKLJNGLDN>k__BackingField;    // 0x0x18
    public int <CMBNDEBEMOA>k__BackingField;    // 0x0x1C
    public int <BIKMPLNHDAM>k__BackingField;    // 0x0x20
    public DateTime? <HPGEJJCODBM>k__BackingField;    // 0x0x28
}
...
{
    public long <CCALEMKKGPD>k__BackingField;    // 0x0x10
    public int <JELEDMMLPOK>k__BackingField;    // 0x0x18
    public string <LGEPKBHKLLC>k__BackingField;    // 0x0x20
    public int <BLGAILMHCKG>k__BackingField;    // 0x0x28
    public int <CNFLOMNNNFA>k__BackingField;    // 0x0x2C
    public bool <NOKBGNKKHIA>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public GBDKADNGOFH ReportCategory;    // 0x0x20
}
...
{
    public AEJHKLBHJPK? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public AEJHKLBHJPK JCHHKCHPJOC;  // wrapper
...
{
    public CNOCFDPMLGM IBDAGGAIFAD;  // wrapper
...
{
    public FCDDCEPDBEB BCFKLEGAMEO;  // wrapper
    public int? ODNJMFHDEIH;  // wrapper
...
{
    public IJJBJLGNOOE UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public KMGOJIDNKKC IGBOEABBEHO;  // wrapper
    public KMGOJIDNKKC? NJDBAOECEAL;  // wrapper
...
{
    public GPKOCNINDBA FAJGNNEPEMO;  // wrapper
...
{
    public AGIHFHEFHKL BIGLMNODCPN;  // wrapper
...
{
    public List<PCDCHHPALPB> DLCNIDGAKAB;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public DLBLHFIJEGG KBMEAAILOAC;  // wrapper
    public KMGOJIDNKKC? DCOIILBCHDP;  // wrapper
...
{
    public KFKHAEJHKGK MNAMJCAHDHH;  // wrapper
...
{
    public StatusResponse> FNAODFKKBJA;  // wrapper
...
// api/keepsakes/{cNIAEHONKDI}/collect  [API POST]
public class KeepsakesCNIAEHONKDICollectRequest
{
    public Guid CNIAEHONKDI;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> EKCLIHBMEBP;  // wrapper
    public JNOBFKADFEJ EPOOHEDBODM;  // wrapper
    public long? BDNAKAPNAFM;  // wrapper
    public OGJALEADJOI FNAODFKKBJA;  // wrapper
...
{
    public String> FNAODFKKBJA;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{oHEOPCKIJPJ}  [API POST]
public class PlayereventsV2DeleteOHEOPCKIJPJRequest
{
    public EFCBNMCNDCA OHEOPCKIJPJ;  // wrapper
}
...
{
    public EFCBNMCNDCA OHEOPCKIJPJ;  // wrapper
    public GELIJHCNHEO ACLCHJLBKKJ;  // wrapper
...
{
    public EFCBNMCNDCA OHEOPCKIJPJ;  // wrapper
    public long? AMNHBAHCBDJ;  // wrapper
    public object clubId;  // candidate
}
...
{
    public EFCBNMCNDCA OHEOPCKIJPJ;  // wrapper
    public KIHACDCEEMK GDKOMNPMLOL;  // wrapper
    public KIHACDCEEMK APAOAGBGHKA;  // wrapper
...
{
    public EFCBNMCNDCA OHEOPCKIJPJ;  // wrapper
    public long? DLEPFFFDBEN;  // wrapper
...
{
    public EFCBNMCNDCA OHEOPCKIJPJ;  // wrapper
    public List<string> PHPBMEGGMOK;  // wrapper
}
...
{
    public EFCBNMCNDCA OHEOPCKIJPJ;  // wrapper
    public DateTime KEPCCLCIAPO;  // wrapper
    public DateTime GNLADPNLBGO;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> EPEIMBEMAJE;  // wrapper
...
{
    public Guid? LMBEKHDODCC;  // wrapper
...
{
    public IReadOnlyList<BFGHJKFCKOD> ODMLHFLHIBO;  // wrapper
}
...
{
    public MatchCompleteStats JMPCDLBBCPE;  // wrapper
}
...
{
    public Guid JLJEEPEOPMK;  // wrapper
...
{
    public CJIMIKFCEDJ LCMPFILLFPM;  // wrapper
}
