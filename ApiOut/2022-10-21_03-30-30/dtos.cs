...
// DTO classes: 266 (plus referenced enums)

// --------------------------------------------------------------------------
// AACPLAABIFP
// base   : System.Enum
//   (not directly referenced by a detected call)
public enum AACPLAABIFP
{
    Interval = 0,
    PerDay = 1,
}
...
// ABBODJFHPJF
//   (not directly referenced by a detected call)
public class ABBODJFHPJF
{
    public Guid <DKGOFHNBBFD>k__BackingField;    // 0x0x10
    public Guid <KJPDGGECCDM>k__BackingField;    // 0x0x20
    public DateTime <PGOODJFMKIA>k__BackingField;    // 0x0x30
    public List<FIEIEDKJONJ> <JNAEPOLBPDM>k__BackingField;    // 0x0x38
}
...
// AHFGINOHLGH
//   (not directly referenced by a detected call)
public class AHFGINOHLGH
{
    public bool <BILNIBEOCEH>k__BackingField;    // 0x0x10
    public LGJACIPPOHE <JIBGABBKIII>k__BackingField;    // 0x0x14
    public int <LGHHGCPAFHD>k__BackingField;    // 0x0x18
    public DateTime <EOLBGMEFGKG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AJLKAAIANFL
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class AJLKAAIANFL
{
    public OHHJEPHMAMF <BAAGAKCPGEI>k__BackingField;    // 0x0x10
    public int <CEOMCFMDCPB>k__BackingField;    // 0x0x14
    public long <ECMMNJHAKJD>k__BackingField;    // 0x0x18
    public bool <KLHPHFPOEPJ>k__BackingField;    // 0x0x20
    public string <JBNBBENKAPG>k__BackingField;    // 0x0x28
    public int? <AFDKAMOKOGK>k__BackingField;    // 0x0x30
    public bool <ILFJKMEPJDB>k__BackingField;    // 0x0x38
    public bool <AGFGEIJGELC>k__BackingField;    // 0x0x39
    public bool <NLAJKOHPDFG>k__BackingField;    // 0x0x3A
    public string <LKOIANGDIJG>k__BackingField;    // 0x0x40
    public DateTime? <LCJIBMEFMOM>k__BackingField;    // 0x0x48
    public float <MEJCOEJNCKN>k__BackingField;    // 0x0x58
}
...
// BANCFHPLGLA
//   (not directly referenced by a detected call)
public class BANCFHPLGLA
{
    public long <AAAHAPMOENI>k__BackingField;    // 0x0x10
    public string <AGEHDJDCKCJ>k__BackingField;    // 0x0x18
    public int <FLDFAOHCHDC>k__BackingField;    // 0x0x20
    public int <CNFDKMOFJJO>k__BackingField;    // 0x0x24
    public int <FEBOPGJIKDF>k__BackingField;    // 0x0x28
    public int <CLDBPEHJNMB>k__BackingField;    // 0x0x2C
    public int <MBALBPHCGOI>k__BackingField;    // 0x0x30
    public string <KAHCJOMFLOK>k__BackingField;    // 0x0x38
    public string <LBLGOKDIOEG>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// BDEEBIKPANH
//   (not directly referenced by a detected call)
public class BDEEBIKPANH
{
    public long <IENMFOIPOLP>k__BackingField;    // 0x0x10
    public string <OAHGPGCIJLA>k__BackingField;    // 0x0x18
    public string <JAIPEBJLKAP>k__BackingField;    // 0x0x20
    public FIDIJNBBKAM? <IKCHLNOLAHG>k__BackingField;    // 0x0x28
    public string <JOBEHDIJMKA>k__BackingField;    // 0x0x30
    public string <NJACIKLCNCL>k__BackingField;    // 0x0x38
    public BEJHAPAEOIP <FAPNHOOJBFL>k__BackingField;    // 0x0x40
    public int <INHADNHDIOK>k__BackingField;    // 0x0x44
    public int <EJPNKOLFJLG>k__BackingField;    // 0x0x48
    public ABKAGAECJLP? <JGAAOOIHCPL>k__BackingField;    // 0x0x4C
    public JHMKIADHINM? <EHFGAIBPPID>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// BDFECBDFCBG
//   (not directly referenced by a detected call)
public class BDFECBDFCBG
{
    public float <AHAAHEIJDJK>k__BackingField;    // 0x0x10
    public float <PDPKDFGPKFK>k__BackingField;    // 0x0x14
    public float <MGFMDEADHEB>k__BackingField;    // 0x0x18
    public float <IGIBEBPOPKJ>k__BackingField;    // 0x0x1C
    public float <POGDKPGFMFI>k__BackingField;    // 0x0x20
    public float <HHJEBJCEBCE>k__BackingField;    // 0x0x24
    public float <GPIOFMOGEGO>k__BackingField;    // 0x0x28
    public float <AFMEDHCIBKL>k__BackingField;    // 0x0x2C
}
...
// --------------------------------------------------------------------------
// BIILCGMCCOM
// base   : GKICOOLOICJ<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class BIILCGMCCOM
{
...
public class BJOGDPEHMMI
{
    public List<MAAPJOLJKNK> <FNJPIFNPKGK>k__BackingField;    // 0x0x10
    public List<GABFPEPPKEM> <BGOIKECPFLB>k__BackingField;    // 0x0x18
}
...
// BNNDEDNIPJB
//   (not directly referenced by a detected call)
public class BNNDEDNIPJB
{
    public ADDMAKJJBFC EJGMIHFLMNN;    // 0x0x10
    public int IPNKMFIEIED;    // 0x0x14
}
...
public class CBJKBOJOCJH
{
    public long <OCGABCJKAND>k__BackingField;    // 0x0x10
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x18
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x20
    public DateTime <DGDEEIPDNPK>k__BackingField;    // 0x0x28
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x30
    public EFMMGDPLNPL <JAHMECDNONG>k__BackingField;    // 0x0x38
    public int <JODOIFHAPJE>k__BackingField;    // 0x0x3C
    public int <BOIPMLLODPK>k__BackingField;    // 0x0x40
    public List<EHOFBMCLNHF> <BMKFMNEBOBO>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// CCMPAMFKAGC
//   (not directly referenced by a detected call)
public class CCMPAMFKAGC
{
    public int <CLGFJMEFFAG>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/roomconsumables/v1/roomconsumable/{roomconsumableId}/purchase/tokens   [Service.API]
public class CDLAPLCDPIC : NINFLKAMGMM
{
    public GHLAGENAGBD? <GKDMMJJILOI>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <CFHPCKHFGDJ>k__BackingField;    // 0x0x20
}
...
public class CFAGHDKEDJE
{
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CFDJKCLEJGB
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class CFDJKCLEJGB
{
    public int <CEOMCFMDCPB>k__BackingField;    // 0x0x10
}
...
// CPAJCMMNIEE
//   (not directly referenced by a detected call)
public class CPAJCMMNIEE
{
    public int <EIHLPAABDOC>k__BackingField;    // 0x0x10
    public int <PIMHHNLEKJK>k__BackingField;    // 0x0x14
    public int <KCIOBJCOCFJ>k__BackingField;    // 0x0x18
}
...
// DAGMJCAGEKG
//   (not directly referenced by a detected call)
public class DAGMJCAGEKG
{
    public int <DFAPOLABLFE>k__BackingField;    // 0x0x10
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x18
    public string <JFKOAHJDCFB>k__BackingField;    // 0x0x20
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x28
    public string <HGPAABFIKFA>k__BackingField;    // 0x0x30
    public bool <IJNBNCNMNLA>k__BackingField;    // 0x0x38
    public int <LJEAGFJGHHH>k__BackingField;    // 0x0x3C
    public FHLANKMGLDD <IOONEKNCJKB>k__BackingField;    // 0x0x40
    public DGBIGNOOEOL DELCBDJBPFO;    // 0x0x48
    public DGBIGNOOEOL HIKBDDKHMMM;    // 0x0x50
    public DGBIGNOOEOL EPAGBCLOHGK;    // 0x0x58
    public CGDMCHPDGFE PBBDGPJCFCJ;    // 0x0x60
}
...
public class DEIDHDDNDFF : ValueType
{
    public int <IEEBFLLCIIN>k__BackingField;    // 0x0x0
}

// --------------------------------------------------------------------------
// DFPFJMMPJLB
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class DFPFJMMPJLB
{
    public OHHJEPHMAMF <BAAGAKCPGEI>k__BackingField;    // 0x0x10
    public long <JAJNGFANBKK>k__BackingField;    // 0x0x18
    public string <BENIEMOFFAN>k__BackingField;    // 0x0x20
}
...
public class DJGCDBEKAHL : JADKONHBPCB
{
    public int <BGPKDNHHKHI>k__BackingField;    // 0x0x30
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x38
    public DateTime <PGOODJFMKIA>k__BackingField;    // 0x0x40
    public DateTime <EFBGACFHCPL>k__BackingField;    // 0x0x48
    public HNCEGMNINNP <DHFDFKNDEOF>k__BackingField;    // 0x0x50
    public JFMDKAFFLNE <AHBJLHDPPOM>k__BackingField;    // 0x0x58
    public List<ENDHBMNMEEC> <PACMMAJKBMP>k__BackingField;    // 0x0x60
    public AHFGINOHLGH <CKKGEOFPJBD>k__BackingField;    // 0x0x68
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{iOIMMJFMHCE}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{iOIMMJFMHCE}   [Service.API]
...
public class DJPGEMPHBPB
{
    public CALANKLKCDP <HHLLOPJEEAH>k__BackingField;    // 0x0x10
    public GANLNMHPIAA <JKMNLMOFMMM>k__BackingField;    // 0x0x18
}
...
public class EGFEEAJAKIK
{
    public MKGBGOFHJAL <BAAGAKCPGEI>k__BackingField;    // 0x0x10
    public string <BENIEMOFFAN>k__BackingField;    // 0x0x18
}
...
public class EGGOMHPFCIB
{
    public HCNCELMADDG <HHLLOPJEEAH>k__BackingField;    // 0x0x10
    public LIJDDJOBBCP <GEJMFOFOEAH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EHOFBMCLNHF
//   RESPONSE GET    api/groups/v1/memberships/{bCGICHENIFM}   [Service.API]
public class EHOFBMCLNHF
{
    public long <OCGABCJKAND>k__BackingField;    // 0x0x10
    public int <LBDHAKDHBAH>k__BackingField;    // 0x0x18
    public GLLNGIJAIFM <PGDHFPNOEBN>k__BackingField;    // 0x0x1C
}
...
public class EJKHEEEHNBP
{
    public ELIKFKKOCNF <EFHOKLBHNPM>k__BackingField;    // 0x0x10
}
...
// base   : JFMDKAFFLNE
//   (not directly referenced by a detected call)
public class ENDHBMNMEEC : JFMDKAFFLNE
{
    public int <LGEAGNPPJIH>k__BackingField;    // 0x0x60
    public List<IDKLLHODMPC> <KNPDOMEILMN>k__BackingField;    // 0x0x68
    public List<IDKLLHODMPC> <KCFBLCIIDNP>k__BackingField;    // 0x0x70
    public List<IDKLLHODMPC> <HOCCMJDJLLL>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// EOCDNJHCCMD
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class EOCDNJHCCMD
{
    public int? <ABJHPJEHGJE>k__BackingField;    // 0x0x10
    public string <JEGDNCAJIPK>k__BackingField;    // 0x0x18
    public string <CGKKIIOCFIC>k__BackingField;    // 0x0x20
}
...
public class EOHAICOIKHH
{
    public int <GNANDLJLBHO>k__BackingField;    // 0x0x10
    public bool <IACIDGMOOJN>k__BackingField;    // 0x0x14
    public DateTime <NJFFKFAMAML>k__BackingField;    // 0x0x18
    public bool <NMDAJCEOJLI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EOIKKAGCMHD
//   (not directly referenced by a detected call)
public class EOIKKAGCMHD
{
    public HNCEGMNINNP <DHFDFKNDEOF>k__BackingField;    // 0x0x10
    public int <GHEMCKHIFAP>k__BackingField;    // 0x0x14
    public IOFENKBFFAD <DOFINAOJIEE>k__BackingField;    // 0x0x18
}
...
public class FAPPDMMMEPI
{
    public PAFBHLFFKPD <JOJIGMPDEGK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FDOMCBHIBKF
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{kMAOJFMLNPP}   [Service.API]
public class FDOMCBHIBKF
{
    public Guid <MAOGFHFNNAM>k__BackingField;    // 0x0x10
    public int <IKMEKDAHNCP>k__BackingField;    // 0x0x20
    public int <LCKIMHLKIDH>k__BackingField;    // 0x0x24
    public DateTime <DGDEEIPDNPK>k__BackingField;    // 0x0x28
}
...
public class FHFMJCGJPCK
{
    public Guid <DAHNFBBMJOK>k__BackingField;    // 0x0x10
    public long? <AAKGABCCEBO>k__BackingField;    // 0x0x20
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x30
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x38
    public HNCEGMNINNP <DHFDFKNDEOF>k__BackingField;    // 0x0x40
    public long <HDPJNJHCCPD>k__BackingField;    // 0x0x48
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x50
    public DateTime <DGDEEIPDNPK>k__BackingField;    // 0x0x58
    public DateTime <EOLBGMEFGKG>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// FHLANKMGLDD
//   (not directly referenced by a detected call)
public class FHLANKMGLDD
{
    // (no instance fields in the metadata dump)
}
...
// FIEIEDKJONJ
//   (not directly referenced by a detected call)
public class FIEIEDKJONJ
{
    public int <IENMFOIPOLP>k__BackingField;    // 0x0x10
    public string <FHIHBNJNFGF>k__BackingField;    // 0x0x18
    public string <HGPAABFIKFA>k__BackingField;    // 0x0x20
    public string <NPPJOMFPHDK>k__BackingField;    // 0x0x28
    public string <OAHGPGCIJLA>k__BackingField;    // 0x0x30
    public string <GAMMJAEIAAN>k__BackingField;    // 0x0x38
    public FIDIJNBBKAM? <IKCHLNOLAHG>k__BackingField;    // 0x0x40
    public string <JOBEHDIJMKA>k__BackingField;    // 0x0x48
    public string <NJACIKLCNCL>k__BackingField;    // 0x0x50
    public bool <DAMCKMDPIEG>k__BackingField;    // 0x0x58
    public bool <GJKIAGGBDCE>k__BackingField;    // 0x0x59
    public bool <HMGPOPHPEGI>k__BackingField;    // 0x0x5A
    public JHMKIADHINM <DHHOPEJMCLE>k__BackingField;    // 0x0x5C
    public int <BGLBADKKPOA>k__BackingField;    // 0x0x60
    public HNCEGMNINNP <DHFDFKNDEOF>k__BackingField;    // 0x0x64
    public int <LMCKOEFOPBE>k__BackingField;    // 0x0x68
    public CGIPCLBJBLG <FICBEKNHOGC>k__BackingField;    // 0x0x6C
    public ABKAGAECJLP <PPOGMCLIFHK>k__BackingField;    // 0x0x70
    public int? <JCDCNHEBKBJ>k__BackingField;    // 0x0x74
    public string <AJJKJIELFAL>k__BackingField;    // 0x0x80
}
...
public class FJGNCINMLJN
{
    public List<string> <OCMFCGDIHGA>k__BackingField;    // 0x0x10
    public List<string> <HJFHIKGFMLI>k__BackingField;    // 0x0x18
    public List<string> <NMMJDPBOJNO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FMNGLBCAAJD
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.API]
public class FMNGLBCAAJD
{
    public Guid? <EPJGBACOJII>k__BackingField;    // 0x0x10
    public long? <AAKGABCCEBO>k__BackingField;    // 0x0x28
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x38
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x40
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x48
    public PAFBHLFFKPD <JOJIGMPDEGK>k__BackingField;    // 0x0x50
}
...
public class FNHLECGJELK
{
    public int <IGPBCCPAEOD>k__BackingField;    // 0x0x10
    public NJECKHKBOPA <JGNCODMICMB>k__BackingField;    // 0x0x14
    public ABHFENIIJBK <FHEFBADKFDP>k__BackingField;    // 0x0x18
    public ABHFENIIJBK <ODODEKHEDFC>k__BackingField;    // 0x0x1C
    public ABHFENIIJBK <BKLEIBDEAAF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GABFPEPPKEM
//   (not directly referenced by a detected call)
public class GABFPEPPKEM
{
    public MAAPJOLJKNK <DFPKMNIFIPK>k__BackingField;    // 0x0x10
    public HPIGBKBPIII <GDNBEIDNFOJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GANLNMHPIAA
//   (not directly referenced by a detected call)
public class GANLNMHPIAA
{
    public Guid <EPJGBACOJII>k__BackingField;    // 0x0x10
    public long <AAKGABCCEBO>k__BackingField;    // 0x0x20
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x28
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x30
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x38
    public long <GHEMCKHIFAP>k__BackingField;    // 0x0x40
    public Guid? <NICMHOCGGAO>k__BackingField;    // 0x0x48
    public DateTime <EOLBGMEFGKG>k__BackingField;    // 0x0x60
}
...
public class GEDHKCCDLEK
{
    public int <FGLIHNOHMGC>k__BackingField;    // 0x0x10
    public List<HBMDKKJKACH> <GKLHLFLHJNC>k__BackingField;    // 0x0x18
}
...
public class GEJODALFNHP
{
    public Guid <CMBHGFAEDNA>k__BackingField;    // 0x0x10
    public Guid <DAHNFBBMJOK>k__BackingField;    // 0x0x20
    public int <BGJBHBDEFMP>k__BackingField;    // 0x0x30
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x38
    public long <PJFJPJLIDCC>k__BackingField;    // 0x0x40
    public long <GHEMCKHIFAP>k__BackingField;    // 0x0x48
    public DateTime <EOLBGMEFGKG>k__BackingField;    // 0x0x50
}
...
public class GFJIHHEGKHC
{
    public CALANKLKCDP <HHLLOPJEEAH>k__BackingField;    // 0x0x10
    public JFBMNPGFFFC <MKFINCHCBFH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GHIAKFINLEH
//   (not directly referenced by a detected call)
public class GHIAKFINLEH
{
    public int <CEMHAEBJDKI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GJIMPPPACMC
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class GJIMPPPACMC
{
    public IKPPFDADBON <EFHOKLBHNPM>k__BackingField;    // 0x0x10
    public List<string> <PIJGIFHJAPB>k__BackingField;    // 0x0x18
}
...
// HBMDKKJKACH
//   (not directly referenced by a detected call)
public class HBMDKKJKACH
{
    public DateTime? <LLGKEBGCKJL>k__BackingField;    // 0x0x10
    public DateTime? <PGGMAHMHKPJ>k__BackingField;    // 0x0x20
    public NHLOIAJEEIJ <HHLLOPJEEAH>k__BackingField;    // 0x0x30
    public CPAJCMMNIEE <NDCHHCFBLMA>k__BackingField;    // 0x0x38
    public bool <OLMGHGGOKHL>k__BackingField;    // 0x0x40
}
...
public class HEJAJDBJDNO
{
    public int <FFJGJLIFKBN>k__BackingField;    // 0x0x10
    public int? <JNKJICLGACD>k__BackingField;    // 0x0x14
    public string <FPKALCHGMII>k__BackingField;    // 0x0x20
    public string <BHNHEJCCFGJ>k__BackingField;    // 0x0x28
}
...
public class HFKFCOGINNO
{
    public Guid? <EMOMLGBHGCP>k__BackingField;    // 0x0x10
    public Guid <NJNJMFGICOL>k__BackingField;    // 0x0x24
}
...
public class HJHKPEJDCKO
{
    public List<int> <KEOLCNLHGMA>k__BackingField;    // 0x0x10
    public string <IGHDPCFMEHF>k__BackingField;    // 0x0x18
}
...
public class HLDCPOFACIG : JADKONHBPCB
{
    public List<PFHODLAEFOD> PPEKMKOADHO;    // 0x0x30
    public int <CGMCLNCOGCF>k__BackingField;    // 0x0x38
}
...
// HPIGBKBPIII
//   (not directly referenced by a detected call)
public class HPIGBKBPIII
{
    public long <MJGEICCHENM>k__BackingField;    // 0x0x10
    public long <JAJNGFANBKK>k__BackingField;    // 0x0x18
    public int <LBDHAKDHBAH>k__BackingField;    // 0x0x20
    public DateTime <DGDEEIPDNPK>k__BackingField;    // 0x0x28
    public MHFEMJBCJJJ <JGNCODMICMB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// IDKLLHODMPC
//   (not directly referenced by a detected call)
public class IDKLLHODMPC
{
    public bool <POJJCNHDMHF>k__BackingField;    // 0x0x10
    public FIEIEDKJONJ <LFDNCNHAIDH>k__BackingField;    // 0x0x18
    public float <LBPENIGEJLD>k__BackingField;    // 0x0x20
}
...
public class IEMJPLFAJMI
{
    public List<KPEIJKHFGGF> <HDKKPCLMGEG>k__BackingField;    // 0x0x10
    public string <IGHDPCFMEHF>k__BackingField;    // 0x0x18
}
...
public class ILAJFMHAANL
{
    public int <IKMEKDAHNCP>k__BackingField;    // 0x0x10
    public Guid <DAHNFBBMJOK>k__BackingField;    // 0x0x14
    public long <EJPIFHAKLJO>k__BackingField;    // 0x0x28
    public DateTime <EOLBGMEFGKG>k__BackingField;    // 0x0x30
}
...
// ILLAHLHCIEB
//   (not directly referenced by a detected call)
public class ILLAHLHCIEB
{
    public float <JNLFLKCADJP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IOFENKBFFAD
//   (not directly referenced by a detected call)
public class IOFENKBFFAD
{
    public int <NDCPDCCLPPK>k__BackingField;    // 0x0x10
    public DateTime? <IGAIIPNOHJP>k__BackingField;    // 0x0x18
    public DateTime? <MNBBLHHOOLM>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// JBNAICFEIND
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class JBNAICFEIND
{
    public List<JIPGMIFJOPI> <PIJGIFHJAPB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JCAGPNIBMNK
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class JCAGPNIBMNK
{
    public long <JAJNGFANBKK>k__BackingField;    // 0x0x10
    public MHFEMJBCJJJ <JGNCODMICMB>k__BackingField;    // 0x0x18
}
...
public class JDDFPCCIDEG
{
    public string <PKKCBDMPNNL>k__BackingField;    // 0x0x10
    public string <OJCINOIEEAA>k__BackingField;    // 0x0x18
    public bool <MFFFAHFBFDM>k__BackingField;    // 0x0x20
    public string <GBGKILPBNNK>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// JFBMNPGFFFC
//   (not directly referenced by a detected call)
public class JFBMNPGFFFC
{
    public Guid <EPJGBACOJII>k__BackingField;    // 0x0x10
    public int <IKMEKDAHNCP>k__BackingField;    // 0x0x20
    public int <FABOGFEADEJ>k__BackingField;    // 0x0x24
    public Guid <KGAMDBCECEI>k__BackingField;    // 0x0x28
    public DateTime <EOLBGMEFGKG>k__BackingField;    // 0x0x38
    public GANLNMHPIAA <JKMNLMOFMMM>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// JFMDKAFFLNE
//   (not directly referenced by a detected call)
public class JFMDKAFFLNE
{
    public int <LCKIMHLKIDH>k__BackingField;    // 0x0x10
    public LHEMNBGMDDI <JGNCODMICMB>k__BackingField;    // 0x0x14
    public List<EOIKKAGCMHD> <NNICICMKIGF>k__BackingField;    // 0x0x18
    public List<EOIKKAGCMHD> <IILFJHHFFOE>k__BackingField;    // 0x0x20
    public bool <MEPIPNLHDHA>k__BackingField;    // 0x0x28
    public DateTime? <AKPDBBHCOOA>k__BackingField;    // 0x0x30
    public DateTime? <FILIFPHAODI>k__BackingField;    // 0x0x40
    public DateTime? <DBAENODOIGL>k__BackingField;    // 0x0x50
}
...
public class JFOGFOFNHNG
{
    public int <HBFEIOKBHFM>k__BackingField;    // 0x0x10
    public int <PMLKOHFJNPL>k__BackingField;    // 0x0x14
    public float <BHDBHMGPDFB>k__BackingField;    // 0x0x18
    public int <DLCAAIBPHFK>k__BackingField;    // 0x0x1C
    public int <HDCOJBCGCPG>k__BackingField;    // 0x0x20
    public int <MFJOMEJKONN>k__BackingField;    // 0x0x24
    public int <KDDKAADOFDC>k__BackingField;    // 0x0x28
    public string <FAJBOLHGILG>k__BackingField;    // 0x0x30
    public string <KAPDNOCAOFH>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// JHLAAHCNDEO
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class JHLAAHCNDEO
{
    public List<NBCBNAEBEGC> <NDLLDGPONCH>k__BackingField;    // 0x0x10
    public ELIKFKKOCNF <EFHOKLBHNPM>k__BackingField;    // 0x0x18
}
...
// JIPGMIFJOPI
//   (not directly referenced by a detected call)
public class JIPGMIFJOPI
{
    public string <FCFGFBDMHMP>k__BackingField;    // 0x0x10
    public ANCMIIOKFEI <JGNCODMICMB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JJGJHEIPFKA
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class JJGJHEIPFKA
{
    public int <HBIIJHINGKM>k__BackingField;    // 0x0x10
    public string <AMHEMPABPLA>k__BackingField;    // 0x0x18
    public List<DAGMJCAGEKG> <HBKGGCGPEPD>k__BackingField;    // 0x0x20
    public BDEEBIKPANH <AECGAKHPECA>k__BackingField;    // 0x0x28
    public string <NHILFBMLIAM>k__BackingField;    // 0x0x30
    public DateTime <PGOODJFMKIA>k__BackingField;    // 0x0x38
    public DateTime <EFBGACFHCPL>k__BackingField;    // 0x0x40
    public DateTime <OBPGBMFBCNA>k__BackingField;    // 0x0x48
    public bool? <BCFECGIGCDM>k__BackingField;    // 0x0x50
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{mOLCFNPABNJ}   [Service.API]
public class KAHHBIELDKL
{
    public long <AAKGABCCEBO>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <PDPLNAMOHMB>k__BackingField;    // 0x0x18
    public ILBDKIHMLHN <NMCIHMGKPKC>k__BackingField;    // 0x0x20
}
...
public class KFCDINOOEDB
{
    public bool <DEGNHEKEPEC>k__BackingField;    // 0x0x10
    public string <JBNBBENKAPG>k__BackingField;    // 0x0x18
}
...
public class KIPOKGFCJCO
{
    public long <AAKGABCCEBO>k__BackingField;    // 0x0x10
    public long? <JKICPHLJADI>k__BackingField;    // 0x0x18
    public long? <HGAADOLHLJC>k__BackingField;    // 0x0x28
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x38
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x40
    public List<string> <PIJGIFHJAPB>k__BackingField;    // 0x0x48
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x50
    public DateTime <PCICIKALFIG>k__BackingField;    // 0x0x58
    public DateTime <DCOFBLLCOCL>k__BackingField;    // 0x0x60
    public BLKNMAPODOB <DIGHMEGIKPM>k__BackingField;    // 0x0x68
    public bool <DOAFPPIJFDG>k__BackingField;    // 0x0x6C
    public bool <MEPFDDADJPA>k__BackingField;    // 0x0x6D
    public EDLAFJLBMHP <ILNIOFEJLHI>k__BackingField;    // 0x0x70
    public EDLAFJLBMHP <NKGENJENOBJ>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// KKABEMFLJHG
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class KKABEMFLJHG
{
    public int <IKMEKDAHNCP>k__BackingField;    // 0x0x10
    public Guid <DAHNFBBMJOK>k__BackingField;    // 0x0x14
    public long <EJPIFHAKLJO>k__BackingField;    // 0x0x28
    public long <KFEEOFJKNPA>k__BackingField;    // 0x0x30
    public DateTime <BJCGCONGECM>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// KPEIJKHFGGF
//   (not directly referenced by a detected call)
public class KPEIJKHFGGF
{
    public int <LDKIOMNHGCN>k__BackingField;    // 0x0x10
    public DateTime <DGDEEIPDNPK>k__BackingField;    // 0x0x18
    public DateTime? <PMCIFOOIGCP>k__BackingField;    // 0x0x20
}
...
public class KPPGGDOJHFN
{
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LANPLGOFGEA
//   (not directly referenced by a detected call)
public class LANPLGOFGEA
{
    public DateTime <DGDEEIPDNPK>k__BackingField;    // 0x0x10
    public string <CDEIDCEHIKB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LEDDGJHFKKH
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class LEDDGJHFKKH
{
    public ILAJFMHAANL <CICLLIMEODB>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <CFHPCKHFGDJ>k__BackingField;    // 0x0x18
}
...
public class LGNKKEAJGNB
{
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x10
}
...
// LIJDDJOBBCP
//   (not directly referenced by a detected call)
public class LIJDDJOBBCP
{
    public long <EDOIGLGEIEB>k__BackingField;    // 0x0x10
    public Guid <AGEHDJDCKCJ>k__BackingField;    // 0x0x18
    public long <AAKGABCCEBO>k__BackingField;    // 0x0x28
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x30
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x38
    public int <GHEMCKHIFAP>k__BackingField;    // 0x0x40
    public Guid? <NICMHOCGGAO>k__BackingField;    // 0x0x44
    public DateTime <DGDEEIPDNPK>k__BackingField;    // 0x0x58
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// LJEAHHHPMAL
//   (not directly referenced by a detected call)
public class LJEAHHHPMAL
{
    public Guid <GACMFBGLHJN>k__BackingField;    // 0x0x10
    public byte <LIABFJCKEMO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MAAPJOLJKNK
//   (not directly referenced by a detected call)
public class MAAPJOLJKNK
{
    public long <JAJNGFANBKK>k__BackingField;    // 0x0x10
    public int <CMEAOFJNMEM>k__BackingField;    // 0x0x18
    public long <AAKGABCCEBO>k__BackingField;    // 0x0x20
    public long? <JKICPHLJADI>k__BackingField;    // 0x0x28
    public long? <HGAADOLHLJC>k__BackingField;    // 0x0x38
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x48
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x50
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x58
    public DateTime <PCICIKALFIG>k__BackingField;    // 0x0x60
    public DateTime <DCOFBLLCOCL>k__BackingField;    // 0x0x68
    public int <AHMCOLKADBE>k__BackingField;    // 0x0x70
    public BLKNMAPODOB <DIGHMEGIKPM>k__BackingField;    // 0x0x74
    public bool <DOAFPPIJFDG>k__BackingField;    // 0x0x78
    public bool <MEPFDDADJPA>k__BackingField;    // 0x0x79
    public EDLAFJLBMHP <ILNIOFEJLHI>k__BackingField;    // 0x0x7C
    public EDLAFJLBMHP <NKGENJENOBJ>k__BackingField;    // 0x0x80
    public long? <KGLPPDEPHND>k__BackingField;    // 0x0x88
}
...
public class MDCFEFJOPCL
{
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x10
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x18
    public int? <GHEMCKHIFAP>k__BackingField;    // 0x0x20
    public NLFKNKIMCEC? <DIGHMEGIKPM>k__BackingField;    // 0x0x28
}
...
//   RESPONSE GET    api/avatar/v2/{bGKPECJNKFO}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{bGKPECJNKFO}   [Service.API]
public class MDCGOAKGMAN
{
    public string <DCJDIGMMBOA>k__BackingField;    // 0x0x10
    public string <NLOHMNOAOGO>k__BackingField;    // 0x0x18
    public string <DKODKKPFODP>k__BackingField;    // 0x0x20
    public string <FNOPHNPMMKF>k__BackingField;    // 0x0x28
    public string <CLHANNMLDGH>k__BackingField;    // 0x0x30
    public List<LJEAHHHPMAL> <MPOOAINFHMD>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// MEAMDNNEDON
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class MEAMDNNEDON
{
    public int <LJEAGFJGHHH>k__BackingField;    // 0x0x10
    public string <JNHDGHIGEHJ>k__BackingField;    // 0x0x18
    public string <DCJDIGMMBOA>k__BackingField;    // 0x0x20
    public string <NLOHMNOAOGO>k__BackingField;    // 0x0x28
    public string <DKODKKPFODP>k__BackingField;    // 0x0x30
    public string <FNOPHNPMMKF>k__BackingField;    // 0x0x38
    public string <CLHANNMLDGH>k__BackingField;    // 0x0x40
    public List<LJEAHHHPMAL> <MPOOAINFHMD>k__BackingField;    // 0x0x48
}
...
public class MIOBOIOMHMJ
{
    public BNKABKHAHGJ <HHLLOPJEEAH>k__BackingField;    // 0x0x10
    public NECJIHLIOPK <NEKHDJGNKBM>k__BackingField;    // 0x0x18
    public BANCFHPLGLA <LDGIKKOIJFC>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// NBBHLJEHFEH
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{fCDKMJOKGIE}   [Service.API]
public class NBBHLJEHFEH
{
    public uint <FMOINOCDPDC>k__BackingField;    // 0x0x10
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x18
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x20
    public DateTime <PBIMKAPCNDI>k__BackingField;    // 0x0x28
    public DateTime? <LIGACGJEPNA>k__BackingField;    // 0x0x30
    public bool <HOMBCHINOHJ>k__BackingField;    // 0x0x40
    public List<PINFCIIDEEN> <EJBDJFFCHNJ>k__BackingField;    // 0x0x48
    public List<string> <PIJGIFHJAPB>k__BackingField;    // 0x0x50
    public int <LKLBDOLACBK>k__BackingField;    // 0x0x58
    public int <KHFAFGLGLME>k__BackingField;    // 0x0x5C
    public int <BHKMMMFGHPA>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// NBCBNAEBEGC
//   (not directly referenced by a detected call)
public class NBCBNAEBEGC
{
    public int <PGMLLPGGLKG>k__BackingField;    // 0x0x10
    public ELIKFKKOCNF <EFHOKLBHNPM>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// NDGCGLNNOGD
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class NDGCGLNNOGD
{
    public int <DNANDDKECJD>k__BackingField;    // 0x0x10
    public int <GNANDLJLBHO>k__BackingField;    // 0x0x14
    public float <BKAIDHGJKJE>k__BackingField;    // 0x0x18
    public float <DNNHONGGCEA>k__BackingField;    // 0x0x1C
    public bool <IACIDGMOOJN>k__BackingField;    // 0x0x20
    public bool <PBMONJBIPBE>k__BackingField;    // 0x0x21
    public bool <LCOOAMEKFGM>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// NECJIHLIOPK
//   (not directly referenced by a detected call)
public class NECJIHLIOPK
{
    public ObscuredLong <AAAHAPMOENI>k__BackingField;    // 0x0x10
    public string <AGEHDJDCKCJ>k__BackingField;    // 0x0x38
    public ObscuredInt <CMEAOFJNMEM>k__BackingField;    // 0x0x40
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x58
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x60
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x68
    public int <EBLECJFNKDH>k__BackingField;    // 0x0x70
    public NLFKNKIMCEC <DIGHMEGIKPM>k__BackingField;    // 0x0x74
    public DateTime <EOLBGMEFGKG>k__BackingField;    // 0x0x78
    public DateTime <DGDEEIPDNPK>k__BackingField;    // 0x0x80
    public DateTime? <CKFGBIGJIJO>k__BackingField;    // 0x0x88
    public long? <LCCOCKCGHBH>k__BackingField;    // 0x0x98
    public int <CLCMCGNGKEH>k__BackingField;    // 0x0xA8
    public int <LNPBCKMNCGF>k__BackingField;    // 0x0xAC
    public int <OBBJIJPIILH>k__BackingField;    // 0x0xB0
    public GMCICNJIFGG <INMLAFGCDHK>k__BackingField;    // 0x0xB4
    public GMCICNJIFGG <HIKEOJPOEHB>k__BackingField;    // 0x0xB8
    public ObscuredBool <ANCKDFDLNJA>k__BackingField;    // 0x0xBC
    public ObscuredBool <NDGLPPOGJCK>k__BackingField;    // 0x0xC8
    public ObscuredBool <HNAJICEJOHK>k__BackingField;    // 0x0xD4
    public int? <GHEMCKHIFAP>k__BackingField;    // 0x0xE0
    public bool <AGFGDFCOABF>k__BackingField;    // 0x0xE8
}
...
//   RESPONSE DELETE api/keepsakes/{jPCNFEICICC}   [Service.API]
//   RESPONSE POST   api/keepsakes/{jPCNFEICICC}/collect   [Service.API]
...
public class NHDEMOONFNH
{
    public bool <DEGNHEKEPEC>k__BackingField;    // 0x0x10
    public string <GNMLMFBLDPA>k__BackingField;    // 0x0x18
}
...
// NHNIKHPINDA
//   (not directly referenced by a detected call)
public class NHNIKHPINDA
{
    public int <LCNBGJKMFKB>k__BackingField;    // 0x0x10
}
...
public class NOPGDCMOKKD
{
    public Guid <GACMFBGLHJN>k__BackingField;    // 0x0x10
    public int <FFJGJLIFKBN>k__BackingField;    // 0x0x20
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x28
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x30
    public int <GHEMCKHIFAP>k__BackingField;    // 0x0x38
    public NLFKNKIMCEC <DIGHMEGIKPM>k__BackingField;    // 0x0x3C
    public bool <MEPIPNLHDHA>k__BackingField;    // 0x0x40
    public int? <JNKJICLGACD>k__BackingField;    // 0x0x44
    public string <BHNHEJCCFGJ>k__BackingField;    // 0x0x50
    public string <FPKALCHGMII>k__BackingField;    // 0x0x58
    public string <AAIGDJCBMFD>k__BackingField;    // 0x0x60
    public DateTime <DGDEEIPDNPK>k__BackingField;    // 0x0x68
    public DateTime <EOLBGMEFGKG>k__BackingField;    // 0x0x70
}
...
public class ODPCEPKLDBO
{
    public bool <LOKGIMMJLNN>k__BackingField;    // 0x0x10
    public string <JHDEOAHAFDF>k__BackingField;    // 0x0x18
    public string <PIGDIDDJAOB>k__BackingField;    // 0x0x20
}
...
public class OJAMINDGFMC
{
    public HTTPResponse HNCAMIOHJBD;    // 0x0x10
    public int? MNJNDMFBDMI;    // 0x0x18
    public string KNEOOBKBNMI;    // 0x0x20
    public byte[] IEBEIGPHFAG;    // 0x0x28
    public string PBOCAEEOPIN;    // 0x0x30
}

// --------------------------------------------------------------------------
// ONCDFBNKKDI
//   RESPONSE GET    api/inventions/v1/personaldetails/{eCAKNGLNNMB}   [Service.API]
public class ONCDFBNKKDI
{
    public bool <FFHKOMFFFJH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// ONJHHBLFIDK
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class ONJHHBLFIDK
{
    public Guid <MCOHOJPCAMO>k__BackingField;    // 0x0x10
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x20
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x28
    public DateTime <PGOODJFMKIA>k__BackingField;    // 0x0x30
    public DateTime? <ICPHFJAOPFN>k__BackingField;    // 0x0x38
    public List<ABBODJFHPJF> <AKIINOGMLIH>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// OPEMAEMCAFJ
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{mKCDIEMKKMA}   [Service.API]
...
public class OPEMAEMCAFJ
{
    public MAAPJOLJKNK <DFPKMNIFIPK>k__BackingField;    // 0x0x10
    public ELIKFKKOCNF <EFHOKLBHNPM>k__BackingField;    // 0x0x18
    public GJIMPPPACMC <DHKCALMPEAP>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/roomconsumables/v1/roomconsumable/{roomconsumableId}/purchase/currency   [Service.API]
public class OPMIIDMEKKD : NINFLKAMGMM
{
    public PODIHEKFNNA? <GKDMMJJILOI>k__BackingField;    // 0x0x18
    public ILAJFMHAANL <CICLLIMEODB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PAFBHLFFKPD
//   (not directly referenced by a detected call)
public class PAFBHLFFKPD
{
    public long <GHEMCKHIFAP>k__BackingField;    // 0x0x10
    public Guid? <DAHNFBBMJOK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PANKGLAKFNK
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class PANKGLAKFNK
{
    public HNCEGMNINNP <DHFDFKNDEOF>k__BackingField;    // 0x0x10
    public BAHMJFDOHPE <NKPELONCNCM>k__BackingField;    // 0x0x14
    public int <GINPLLPJKAD>k__BackingField;    // 0x0x18
    public int <NGOBIIIFFCN>k__BackingField;    // 0x0x1C
    public int <BOBAAHLGHPN>k__BackingField;    // 0x0x20
    public AACPLAABIFP <PLLLIHPLBCH>k__BackingField;    // 0x0x24
    public bool <IDHJBEFDBEL>k__BackingField;    // 0x0x28
    public float <GKIKIDBBFIN>k__BackingField;    // 0x0x2C
    public int <AFHMFFCEGKN>k__BackingField;    // 0x0x30
    public bool <NDFPELCLFJL>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// PCFFNFAFJKA
// base   : GKICOOLOICJ<NOPGDCMOKKD>
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{eHKFIABKAMD}   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v2/fromCreator/{eHKFIABKAMD}   [Service.API]
public class PCFFNFAFJKA
{
    // (no instance fields in the metadata dump)
}
...
public class PEACMOHLIIH
{
    public Dictionary<int, int> <CIGDIHAKPID>k__BackingField;    // 0x0x10
    public List<NCAPBEPJJPL> <GIGJJDNAENB>k__BackingField;    // 0x0x18
    public BNNDEDNIPJB[][] <KJMOBJFPLBB>k__BackingField;    // 0x0x20
    public GHIAKFINLEH <JHPKPBFIMPC>k__BackingField;    // 0x0x28
    public BDFECBDFCBG <ENIGJJKMFEE>k__BackingField;    // 0x0x30
    public NHNIKHPINDA <IACGLLFFBNJ>k__BackingField;    // 0x0x38
    public CCMPAMFKAGC <MKIDLJIGMIC>k__BackingField;    // 0x0x40
    public ILLAHLHCIEB <GGGPGBKIHCO>k__BackingField;    // 0x0x48
    public string <MPDNDKNKHON>k__BackingField;    // 0x0x50
}
...
// base   : JFMDKAFFLNE
//   (not directly referenced by a detected call)
public class PFHODLAEFOD : JFMDKAFFLNE
{
    public FIEIEDKJONJ <LFDNCNHAIDH>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// PINFCIIDEEN
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{fCDKMJOKGIE}   [Service.API]
public class PINFCIIDEEN
{
    public string <FMOINOCDPDC>k__BackingField;    // 0x0x10
    public string <JHDEOAHAFDF>k__BackingField;    // 0x0x18
    public string <AODBFJCIMGM>k__BackingField;    // 0x0x20
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x28
    public string <JEGDNCAJIPK>k__BackingField;    // 0x0x30
    public HBMJCGFJADO <HHLLOPJEEAH>k__BackingField;    // 0x0x38
    public List<string> <ICFPGIGHHDB>k__BackingField;    // 0x0x40
    public List<string> <PIJGIFHJAPB>k__BackingField;    // 0x0x48
    public string <IGBKONMAJEH>k__BackingField;    // 0x0x50
    public List<LANPLGOFGEA> <GINEBCIDAEF>k__BackingField;    // 0x0x58
}
...
public class AddKeepsakeInstanceRequest
{
    public long <AAKGABCCEBO>k__BackingField;    // 0x0x10
    public long? <JKICPHLJADI>k__BackingField;    // 0x0x18
    public BLDCOLANFKH <GDPNLNJFDIL>k__BackingField;    // 0x0x28
}
...
{
    public INJNLHBPLFJ <EFHOKLBHNPM>k__BackingField;    // 0x0x10
    public string <IMGOIFHNJGF>k__BackingField;    // 0x0x18
    public string <BNPHOLLDLPN>k__BackingField;    // 0x0x20
    public string <FCOGFKAHPPC>k__BackingField;    // 0x0x28
}
...
{
    public long <JAJNGFANBKK>k__BackingField;    // 0x0x10
    public long? <ABEMGCLAPJG>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public AFDLINMDFPF FilterType;    // 0x0x20
...
{
    public BLDCOLANFKH <GKHKCHNLOFD>k__BackingField;    // 0x0x10
    public string <BMAGFEINDJE>k__BackingField;    // 0x0x18
    public int <DKIKILDCDLJ>k__BackingField;    // 0x0x20
    public int <PAEJPIHGGAM>k__BackingField;    // 0x0x24
}
...
{
    public int <IKMEKDAHNCP>k__BackingField;    // 0x0x10
    public Guid <GIGFDPIEINL>k__BackingField;    // 0x0x14
    public DateTime <FCCGOJGHNEL>k__BackingField;    // 0x0x28
}
...
{
    public bool <HEPEENLDMGK>k__BackingField;    // 0x0x10
    public int <GGCJCCKGACO>k__BackingField;    // 0x0x14
}
...
{
    public Guid <GIGFDPIEINL>k__BackingField;    // 0x0x10
    public BLDCOLANFKH <FHNMKDOOKIE>k__BackingField;    // 0x0x20
    public int <APCGNBOJMIN>k__BackingField;    // 0x0x24
    public long <AAKGABCCEBO>k__BackingField;    // 0x0x28
    public long? <JKICPHLJADI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes/events/{dFDHNNECIIL}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <JMABENNIHPE>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <OFLJOIKKHLK>k__BackingField;    // 0x0x18
}
...
{
    public long <LFJCDHECDPC>k__BackingField;    // 0x0x10
    public long <AAKGABCCEBO>k__BackingField;    // 0x0x18
    public long <NDAPGDMADKF>k__BackingField;    // 0x0x20
    public MJPGAPPFPAP <JGNCODMICMB>k__BackingField;    // 0x0x28
    public int <BGJBHBDEFMP>k__BackingField;    // 0x0x2C
}
...
{
    public long <AAKGABCCEBO>k__BackingField;    // 0x0x10
    public List<Guid> <HEFKOMFBAMC>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <JMABENNIHPE>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <OFLJOIKKHLK>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <OMEHIBOOOCH>k__BackingField;    // 0x0x20
}
...
{
    public long <NDAPGDMADKF>k__BackingField;    // 0x0x10
    public long <KBIJIAHNIAI>k__BackingField;    // 0x0x18
    public int? <FDMFEGCBBAE>k__BackingField;    // 0x0x20
    public int? <DLKLCOIAFJN>k__BackingField;    // 0x0x28
    public long? <GLPAHFJDGDE>k__BackingField;    // 0x0x30
    public long <AOEJIIIIJEM>k__BackingField;    // 0x0x40
    public long <FKPNHDBKHOJ>k__BackingField;    // 0x0x48
    public int <OLFPGLAKCFG>k__BackingField;    // 0x0x50
    public MJPGAPPFPAP <HGPMNBFPMEH>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <JAMNHKIELHA>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public ABKAGAECJLP <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public GBCGHBOLONH creatorAccountRole;    // 0x0x58
}
...
{
    public FLBIMFNHGED <ELJJCFANEFF>k__BackingField;    // 0x0x10
    public ACNGPIFBAEM <NEELMJPHKDD>k__BackingField;    // 0x0x14
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x18
    public string <HPNFFMPNBFB>k__BackingField;    // 0x0x20
    public bool <BJEIIDAKHNG>k__BackingField;    // 0x0x28
}
...
{
    public List<FLBIMFNHGED> <LMJHGMLLGPI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents/event/{hAGHJDCOEKN}   [Service.API]
public class ProgressionEventDTO
{
    public long <KBIJIAHNIAI>k__BackingField;    // 0x0x10
    public string <JCIHFCMBNAF>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <HOCCMJDJLLL>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <GCCDKAIOILI>k__BackingField;    // 0x0x28
    public DateTime <PCICIKALFIG>k__BackingField;    // 0x0x30
    public DateTime <DCOFBLLCOCL>k__BackingField;    // 0x0x38
    public DateTime <KCOGEGGCINO>k__BackingField;    // 0x0x40
    public bool <AFHJDMEFOOJ>k__BackingField;    // 0x0x48
    public int <JDGHCABHGFK>k__BackingField;    // 0x0x4C
    public float <OKNKKIGGCJJ>k__BackingField;    // 0x0x50
    public Guid? <LEHPJBEOOJM>k__BackingField;    // 0x0x54
    public string <EBIBKCEHLHD>k__BackingField;    // 0x0x68
    public string <LIEEDAMGLGB>k__BackingField;    // 0x0x70
    public string <BBCDHEKNABA>k__BackingField;    // 0x0x78
    public string <GCCLFEGPGMF>k__BackingField;    // 0x0x80
}
...
{
    public Guid <GLHBOOKIJOH>k__BackingField;    // 0x0x10
    public int <AMAIENLILGA>k__BackingField;    // 0x0x20
    public int <FPDJHHPGNKH>k__BackingField;    // 0x0x24
    public long <LGFEMAOPHFJ>k__BackingField;    // 0x0x28
    public long <LBLPEHHOKEJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE GET    api/progressionEvents/record/{hAGHJDCOEKN}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <IKMEKDAHNCP>k__BackingField;    // 0x0x10
    public int <INHADNHDIOK>k__BackingField;    // 0x0x14
    public int <LEHNIGCMBCM>k__BackingField;    // 0x0x18
    public int <AHABMHHCLFE>k__BackingField;    // 0x0x1C
    public int <LIMBPLEOCPO>k__BackingField;    // 0x0x20
    public DateTime? <OIJKEDJHGBP>k__BackingField;    // 0x0x28
}
...
{
    public long <MEBLILBHDKB>k__BackingField;    // 0x0x10
    public int <IENMFOIPOLP>k__BackingField;    // 0x0x18
    public string <LCGHJMDPLNF>k__BackingField;    // 0x0x20
    public int <INHADNHDIOK>k__BackingField;    // 0x0x28
    public int <HEOJIBMMDGN>k__BackingField;    // 0x0x2C
    public bool <HBDJDDPHBML>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public FJLNAMJGMCB ReportCategory;    // 0x0x20
}
...
{
    public OPIACJODECP? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public OPIACJODECP DINAJIOMBKK;  // wrapper
...
{
    public OJFBACJAEIP BILPJABKHFG;  // wrapper
...
{
    public DEENNFCDPID NKICFHCCMMH;  // wrapper
    public int? GBPBJNNCDBB;  // wrapper
...
{
    public FHNDOLGOBPP UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public ABKAGAECJLP NAHJDDBGMOA;  // wrapper
    public ABKAGAECJLP? CMPOLMPPHBD;  // wrapper
...
{
    public DAGMJCAGEKG KILNEJJJEFF;  // wrapper
...
{
    public OHHJEPHMAMF EMLCNMKNNNO;  // wrapper
...
{
    public List<EJJMHJHMNDG> IFMLHPLDGLP;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public NCIGKIJGKMF PLNFICKGKGE;  // wrapper
    public ABKAGAECJLP? IDJMKKJGPNJ;  // wrapper
...
{
    public IHHODOIFGGE OLNOIKMGLHG;  // wrapper
...
{
    public StatusResponse> GKAOJENLDLL;  // wrapper
...
// api/keepsakes/{jPCNFEICICC}/collect  [API POST]
public class KeepsakesJPCNFEICICCCollectRequest
{
    public Guid JPCNFEICICC;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> ENEOBBDIFNB;  // wrapper
    public HNDEHIPIHJD NEHOBMGHPAL;  // wrapper
    public long? MOLCFNPABNJ;  // wrapper
    public GNDPNCPEKGM GKAOJENLDLL;  // wrapper
...
{
    public String> GKAOJENLDLL;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{mKCDIEMKKMA}  [API POST]
public class PlayereventsV2DeleteMKCDIEMKKMARequest
{
    public MAAPJOLJKNK MKCDIEMKKMA;  // wrapper
}
...
{
    public MAAPJOLJKNK MKCDIEMKKMA;  // wrapper
    public BLKNMAPODOB NJEICPBJPFG;  // wrapper
...
{
    public MAAPJOLJKNK MKCDIEMKKMA;  // wrapper
    public long? AEFPPNIPAGK;  // wrapper
    public object clubId;  // candidate
}
...
{
    public MAAPJOLJKNK MKCDIEMKKMA;  // wrapper
    public EDLAFJLBMHP AOJIIJEPFEF;  // wrapper
    public EDLAFJLBMHP CFEPBHJMDLA;  // wrapper
...
{
    public MAAPJOLJKNK MKCDIEMKKMA;  // wrapper
    public long? ENINCDEMGDA;  // wrapper
...
{
    public MAAPJOLJKNK MKCDIEMKKMA;  // wrapper
    public List<string> PMLKLEMCDJG;  // wrapper
}
...
{
    public MAAPJOLJKNK MKCDIEMKKMA;  // wrapper
    public DateTime AOHDJCFKMCK;  // wrapper
    public DateTime DHLIPEJJCCE;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> PJGALDPNBKH;  // wrapper
...
{
    public Guid? DFJAFECNGFL;  // wrapper
...
{
    public IReadOnlyList<NFAGPPBNEDD> LKFBPLJNJNG;  // wrapper
}
...
{
    public MatchCompleteStats AIKFMEPDEFF;  // wrapper
}
...
{
    public Guid CPFDNGKMMPB;  // wrapper
...
{
    public HBMJCGFJADO BPEPEGNEBGD;  // wrapper
}
