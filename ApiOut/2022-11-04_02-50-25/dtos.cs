...
// DTO classes: 269 (plus referenced enums)

// --------------------------------------------------------------------------
// ABALDMODIKC
//   (not directly referenced by a detected call)
public class ABALDMODIKC
{
    public long <DFBCDBPAKGG>k__BackingField;    // 0x0x10
    public Guid? <CEFGKIDIOFL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ABBKAPAEFAO
//   (not directly referenced by a detected call)
public class ABBKAPAEFAO
{
    public long <POCIIOHOKCM>k__BackingField;    // 0x0x10
    public string <NADNNKNOEBD>k__BackingField;    // 0x0x18
    public int <AKKEBPMDAHB>k__BackingField;    // 0x0x20
    public int <AIAENIAIFPO>k__BackingField;    // 0x0x24
    public int <CCJIEJECCFN>k__BackingField;    // 0x0x28
    public int <KEHCNIDDAHP>k__BackingField;    // 0x0x2C
    public int <DKNOOAGECIC>k__BackingField;    // 0x0x30
    public string <DGNAGICMOEL>k__BackingField;    // 0x0x38
    public string <OLAINGPAMKB>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// ABPMPEEHLLA
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{fBDAFGPAOAL}   [Service.API]
public class ABPMPEEHLLA
{
    public uint <OCGGDEFBABF>k__BackingField;    // 0x0x10
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x18
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x20
    public DateTime <GKHAHKJKCMP>k__BackingField;    // 0x0x28
    public DateTime? <GKMONNJEDPG>k__BackingField;    // 0x0x30
    public bool <BCFCJBJPNHD>k__BackingField;    // 0x0x40
    public List<AOALOOLBPBJ> <OKJJNDKDAHJ>k__BackingField;    // 0x0x48
    public List<string> <HLMDGPONKAO>k__BackingField;    // 0x0x50
    public int <FBEHIGMJOKL>k__BackingField;    // 0x0x58
    public int <OJCDOEJFKIP>k__BackingField;    // 0x0x5C
    public int <MJEJBAKPKCF>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// ADLIHAHDBLC
//   (not directly referenced by a detected call)
public class ADLIHAHDBLC
{
    public bool <PKOBFCMNDGJ>k__BackingField;    // 0x0x10
    public AIBIGDHFHPI <GHDPIKAJIOB>k__BackingField;    // 0x0x14
    public int <CHMKHMADANE>k__BackingField;    // 0x0x18
    public DateTime <EMOCMJEGBJG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AEILKELDMIO
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class AEILKELDMIO
{
    public OAHNKIHOCLI <DPKNDKKFNPM>k__BackingField;    // 0x0x10
    public long <AKLBCADPAAN>k__BackingField;    // 0x0x18
    public string <LBFGNDGPBGE>k__BackingField;    // 0x0x20
}
...
public class AHJGHEBKIDC
{
    public int <LIJIMHFFJML>k__BackingField;    // 0x0x10
    public int? <AAMOLAIELBI>k__BackingField;    // 0x0x14
    public string <DIFLNGBGGHK>k__BackingField;    // 0x0x20
    public string <NCCMADEECPL>k__BackingField;    // 0x0x28
}
...
public class AIGJLELFJME
{
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x10
}
...
public class AKCHEJBDBAK
{
    public Guid? <CPIFKMGPDNL>k__BackingField;    // 0x0x10
    public Guid <CHIDKNDGIPN>k__BackingField;    // 0x0x24
}
...
public class AKHOPINHODD : HPIGNCPKPKB
{
    public MPOHDHKGJDB? <CIDHGFBNKDB>k__BackingField;    // 0x0x18
    public FDBJHHNAJNB <IIPNICNIALN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AOALOOLBPBJ
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{fBDAFGPAOAL}   [Service.API]
public class AOALOOLBPBJ
{
    public string <OCGGDEFBABF>k__BackingField;    // 0x0x10
    public string <MBBBEHNNMEL>k__BackingField;    // 0x0x18
    public string <JBKDIDMIBGN>k__BackingField;    // 0x0x20
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x28
    public string <AHHILDOIGEJ>k__BackingField;    // 0x0x30
    public ODBOFNEMGMP <BEENDKEJKIO>k__BackingField;    // 0x0x38
    public List<string> <MDEIDKGPCEI>k__BackingField;    // 0x0x40
    public List<string> <HLMDGPONKAO>k__BackingField;    // 0x0x48
    public string <EMPEOMCNEPD>k__BackingField;    // 0x0x50
    public List<CNKLAFMNAOK> <LBJAJICDDCN>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// BEEBOCCPEFI
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class BEEBOCCPEFI
{
    public BKELFPBHABB <DEPEGGGEPCN>k__BackingField;    // 0x0x10
    public List<string> <HLMDGPONKAO>k__BackingField;    // 0x0x18
}
...
// BNJBDKDMAKG
//   (not directly referenced by a detected call)
public class BNJBDKDMAKG
{
    public DateTime? <PBLNKPICGMB>k__BackingField;    // 0x0x10
    public DateTime? <AIJMIJJFMGN>k__BackingField;    // 0x0x20
    public JBLBNOKEHGM <BEENDKEJKIO>k__BackingField;    // 0x0x30
    public IDDEOIPLCOF <DBKBOEJFCKL>k__BackingField;    // 0x0x38
    public bool <GFFLIHECCFJ>k__BackingField;    // 0x0x40
}
...
public class BPBHADIIIHC
{
    public LBPOFPHJMEE <DEPEGGGEPCN>k__BackingField;    // 0x0x10
}
...
public class CBIHMEBKJPJ
{
    public HAIKLACCOIE <BEENDKEJKIO>k__BackingField;    // 0x0x10
    public IDOEMECGLFC <HGCLLCFAJEO>k__BackingField;    // 0x0x18
}
...
public class CDKHDGLPLPJ
{
    public int <ACGOPMHGPDA>k__BackingField;    // 0x0x10
    public List<BNJBDKDMAKG> <OPAPAHPEAHF>k__BackingField;    // 0x0x18
}
...
public class CDPLEFALCNA
{
    public int <NPIJGBLOLJI>k__BackingField;    // 0x0x10
    public bool <LEICEEHDPIO>k__BackingField;    // 0x0x14
    public DateTime <EFNKHOMCAHJ>k__BackingField;    // 0x0x18
    public bool <KHILHOBEAGN>k__BackingField;    // 0x0x20
}
...
public class CFAMFEAGHDK : ValueType
{
    public int <OFIIIADEPPJ>k__BackingField;    // 0x0x0
}
...
public class CIFDLHDMHKF
{
    public bool <LJNJCBKDPNE>k__BackingField;    // 0x0x10
    public string <MKGDJLMPFAG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CJJJJGMIAGL
//   (not directly referenced by a detected call)
public class CJJJJGMIAGL
{
    public long <MKFLCMIGLIM>k__BackingField;    // 0x0x10
    public long <AKLBCADPAAN>k__BackingField;    // 0x0x18
    public int <BPOPHMIPDKF>k__BackingField;    // 0x0x20
    public DateTime <KMLPHPNNDKM>k__BackingField;    // 0x0x28
    public LGIPJLJOIDA <GOCCDHKBCCO>k__BackingField;    // 0x0x30
}
...
public class CKEBGCDFDBN
{
    public GEGHIGFFCMD <DPKNDKKFNPM>k__BackingField;    // 0x0x10
    public string <LBFGNDGPBGE>k__BackingField;    // 0x0x18
    public int? <LGJLIILNOPA>k__BackingField;    // 0x0x20
}
...
public class CNGLPECCFJL
{
    public ABALDMODIKC <ODFJKDFKKCK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CNKLAFMNAOK
//   (not directly referenced by a detected call)
public class CNKLAFMNAOK
{
    public DateTime <KMLPHPNNDKM>k__BackingField;    // 0x0x10
    public string <EJLPMODFLFP>k__BackingField;    // 0x0x18
}
...
// DILFCEBHJFB
//   (not directly referenced by a detected call)
public class DILFCEBHJFB
{
    public int <MEOGIKACOKB>k__BackingField;    // 0x0x10
    public DateTime <KMLPHPNNDKM>k__BackingField;    // 0x0x18
    public DateTime? <NBKIIFFNJEE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DJJIMKMKACL
//   (not directly referenced by a detected call)
public class DJJIMKMKACL
{
    public long <NGEJIKCMJJG>k__BackingField;    // 0x0x10
    public string <JCOAOCHMGKC>k__BackingField;    // 0x0x18
    public string <GFGJPIHPPGM>k__BackingField;    // 0x0x20
    public OGDKLCEIKAB? <POFJLKBJBBA>k__BackingField;    // 0x0x28
    public string <OCAMDABDLEP>k__BackingField;    // 0x0x30
    public string <APEFGOLNIDN>k__BackingField;    // 0x0x38
    public INMHFGODJLA <DIOKCMOJCBI>k__BackingField;    // 0x0x40
    public int <EJBHLBNEBOG>k__BackingField;    // 0x0x44
    public int <ONBJCFENDMG>k__BackingField;    // 0x0x48
    public DLKPHMHCBDE? <MDKAACDCGFB>k__BackingField;    // 0x0x4C
    public EKOAAHFKCGE? <HJFCMBPLMKB>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// DLANDIKHABN
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class DLANDIKHABN
{
    public OAHNKIHOCLI <DPKNDKKFNPM>k__BackingField;    // 0x0x10
    public int <LKAOJJHOCIL>k__BackingField;    // 0x0x14
    public long <AIEKNMGMEFL>k__BackingField;    // 0x0x18
    public bool <HOONFEEINII>k__BackingField;    // 0x0x20
    public string <MKGDJLMPFAG>k__BackingField;    // 0x0x28
    public int? <AINKCBINKKB>k__BackingField;    // 0x0x30
    public bool <MDDMJPGFOOI>k__BackingField;    // 0x0x38
    public bool <BKHCLBNOFNP>k__BackingField;    // 0x0x39
    public bool <HGNMPIDEHIC>k__BackingField;    // 0x0x3A
    public string <AGNDMMBJMBF>k__BackingField;    // 0x0x40
    public DateTime? <HFBJCONOACK>k__BackingField;    // 0x0x48
    public float <JCMKAPKPCNN>k__BackingField;    // 0x0x58
}
...
public class DLOJMOBPCNF
{
    public List<string> <CLALKJLINHC>k__BackingField;    // 0x0x10
    public List<string> <OOGEIEDIKAM>k__BackingField;    // 0x0x18
    public List<string> <GEHELODCPPE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DOOAHNBJHLI
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class DOOAHNBJHLI
{
    public List<HFIJNGFANBE> <HBONBNELEHF>k__BackingField;    // 0x0x10
    public LBPOFPHJMEE <DEPEGGGEPCN>k__BackingField;    // 0x0x18
}
...
public class DPCKJKPIGBB
{
    public bool <NNPBMDOHKKL>k__BackingField;    // 0x0x10
    public string <MBBBEHNNMEL>k__BackingField;    // 0x0x18
    public string <AHOJFPIAPAM>k__BackingField;    // 0x0x20
}
...
public class EEEGMKALHID
{
    public long <FJCOKLCFHCD>k__BackingField;    // 0x0x10
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x18
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x20
    public DateTime <KMLPHPNNDKM>k__BackingField;    // 0x0x28
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x30
    public HJKNFAJJFDD <BDDLNMOKBGA>k__BackingField;    // 0x0x38
    public int <HGNHBJHIGGD>k__BackingField;    // 0x0x3C
    public int <KLIIAFEMPEJ>k__BackingField;    // 0x0x40
    public List<GMIGJLCPOIM> <HEDGDNDALKL>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// EFJAMHGPOAL
//   (not directly referenced by a detected call)
public class EFJAMHGPOAL
{
    public int <ECEHDNEGMCG>k__BackingField;    // 0x0x10
    public DateTime? <OLNJLHFGDKH>k__BackingField;    // 0x0x18
    public DateTime? <FCIKFKPACKD>k__BackingField;    // 0x0x28
}
...
public class EILCHNGGKAK
{
    public Dictionary<int, int> <DJKKDOCPHAD>k__BackingField;    // 0x0x10
    public List<CDEGJNCHKGN> <BKMLEGAAGEF>k__BackingField;    // 0x0x18
    public LGJDONFIJNK[][] <NLJLINLNNFH>k__BackingField;    // 0x0x20
    public JIHMFBACOPL <DMNBEEEGNEJ>k__BackingField;    // 0x0x28
    public MEDJKIOKCGG <LJOIABHOFMC>k__BackingField;    // 0x0x30
    public HENOBNIFDKD <OMHLBGHDMFH>k__BackingField;    // 0x0x38
    public NJPNHCBGIJM <DJMGHGGAGLE>k__BackingField;    // 0x0x40
    public OBAKGKBMJJO <HBHCDJPFLGG>k__BackingField;    // 0x0x48
    public string <IHIPFHLHPAH>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// EKKGBKOBMHG
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class EKKGBKOBMHG
{
    public int? <DLJPAFPOAGJ>k__BackingField;    // 0x0x10
    public string <AHHILDOIGEJ>k__BackingField;    // 0x0x18
    public string <OLDGCLLGKJH>k__BackingField;    // 0x0x20
}
...
public class EONPMLJOGPG
{
    public Guid <DCJEOKPMLID>k__BackingField;    // 0x0x10
    public Guid <CEFGKIDIOFL>k__BackingField;    // 0x0x20
    public int <JAHKPKNMJOB>k__BackingField;    // 0x0x30
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x38
    public long <MKDKPHNABML>k__BackingField;    // 0x0x40
    public long <DFBCDBPAKGG>k__BackingField;    // 0x0x48
    public DateTime <EMOCMJEGBJG>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// EPBKAEDJFOO
//   (not directly referenced by a detected call)
public class EPBKAEDJFOO
{
    // (no instance fields in the metadata dump)
}
...
public class FDBJHHNAJNB
{
    public int <DAKNNHIMHKC>k__BackingField;    // 0x0x10
    public Guid <CEFGKIDIOFL>k__BackingField;    // 0x0x14
    public long <EPFDNALLJND>k__BackingField;    // 0x0x28
    public DateTime <EMOCMJEGBJG>k__BackingField;    // 0x0x30
}
...
public class FFCINNICMOA
{
    public long <HMHLNHGKLGN>k__BackingField;    // 0x0x10
    public long? <MBKNMKEDJBH>k__BackingField;    // 0x0x18
    public long? <KHNIOBFGCJI>k__BackingField;    // 0x0x28
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x38
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x40
    public List<string> <HLMDGPONKAO>k__BackingField;    // 0x0x48
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x50
    public DateTime <MAKEDCLOCFG>k__BackingField;    // 0x0x58
    public DateTime <KFPGOAFKHIO>k__BackingField;    // 0x0x60
    public CHENGFCJKKC <BNBGLHLGJMM>k__BackingField;    // 0x0x68
    public bool <FJMCADCHMKB>k__BackingField;    // 0x0x6C
    public bool <IHGKOCEPDKA>k__BackingField;    // 0x0x6D
    public IPHFDHOENEF <BGBPNDGOPAD>k__BackingField;    // 0x0x70
    public IPHFDHOENEF <HNDKJLEJMJE>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// FJBGAOHAHCN
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.API]
public class FJBGAOHAHCN
{
    public Guid? <BMJODHDLIBL>k__BackingField;    // 0x0x10
    public long? <HMHLNHGKLGN>k__BackingField;    // 0x0x28
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x38
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x40
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x48
    public ABALDMODIKC <ODFJKDFKKCK>k__BackingField;    // 0x0x50
}
...
// base   : JCHPLDIJIPF
//   (not directly referenced by a detected call)
public class FOLMHLLJAJJ : JCHPLDIJIPF
{
    public int <GEBEGGOLCDO>k__BackingField;    // 0x0x60
    public List<IBOPAAMHDND> <EJLFDBNDJAP>k__BackingField;    // 0x0x68
    public List<IBOPAAMHDND> <BJPINCMDENA>k__BackingField;    // 0x0x70
    public List<IBOPAAMHDND> <GGABHNCPLDD>k__BackingField;    // 0x0x78
}
...
// GJFIKDCMIDE
//   (not directly referenced by a detected call)
public class GJFIKDCMIDE
{
    public int <NGEJIKCMJJG>k__BackingField;    // 0x0x10
    public string <BJJFPDAGOBG>k__BackingField;    // 0x0x18
    public string <FAKHPHLHHMN>k__BackingField;    // 0x0x20
    public string <FEAKFKPDNCC>k__BackingField;    // 0x0x28
    public string <JCOAOCHMGKC>k__BackingField;    // 0x0x30
    public string <NFPAGOAMBEF>k__BackingField;    // 0x0x38
    public OGDKLCEIKAB? <POFJLKBJBBA>k__BackingField;    // 0x0x40
    public string <OCAMDABDLEP>k__BackingField;    // 0x0x48
    public string <APEFGOLNIDN>k__BackingField;    // 0x0x50
    public bool <CANGDOCHAGH>k__BackingField;    // 0x0x58
    public bool <ALALFDMNKCP>k__BackingField;    // 0x0x59
    public bool <GOOELLKKNNL>k__BackingField;    // 0x0x5A
    public EKOAAHFKCGE <LNHJHPMPBAM>k__BackingField;    // 0x0x5C
    public int <ANPFIFPKMNA>k__BackingField;    // 0x0x60
    public NGNAAGGMGAE <ELFEMCBOHOM>k__BackingField;    // 0x0x64
    public int <IJGPAOCNOMC>k__BackingField;    // 0x0x68
    public HNHFBPEDKFO <AAJPDKLBFMN>k__BackingField;    // 0x0x6C
    public DLKPHMHCBDE <POPNBMAMLAK>k__BackingField;    // 0x0x70
    public int? <NLNEMGCGPKA>k__BackingField;    // 0x0x74
    public string <FBBOHOHENNL>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// GMIGJLCPOIM
//   RESPONSE GET    api/groups/v1/memberships/{cFFPFDDOHIM}   [Service.API]
public class GMIGJLCPOIM
{
    public long <FJCOKLCFHCD>k__BackingField;    // 0x0x10
    public int <BPOPHMIPDKF>k__BackingField;    // 0x0x18
    public MMHNBJGBIAI <LFINHCDKJML>k__BackingField;    // 0x0x1C
}
...
public class GOJDIKBEFBJ
{
    public List<DILFCEBHJFB> <AEEDDOKPLKN>k__BackingField;    // 0x0x10
    public string <FFCIPKDFKNF>k__BackingField;    // 0x0x18
}
...
public class GPCADMGPNHI
{
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x10
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x18
    public int? <DFBCDBPAKGG>k__BackingField;    // 0x0x20
    public IOFBCCCAJFA? <BNBGLHLGJMM>k__BackingField;    // 0x0x28
}
...
public class HAMAMMGBCOC
{
    public LKOKEDKHMHJ <BEENDKEJKIO>k__BackingField;    // 0x0x10
    public MCEJKKIDJLD <NOFHHKPIMBL>k__BackingField;    // 0x0x18
    public ABBKAPAEFAO <MJDPMCHGDAC>k__BackingField;    // 0x0x20
}
...
// HENOBNIFDKD
//   (not directly referenced by a detected call)
public class HENOBNIFDKD
{
    public int <CMAHDDLELFD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HFIJNGFANBE
//   (not directly referenced by a detected call)
public class HFIJNGFANBE
{
    public int <CCBHBDAKOIN>k__BackingField;    // 0x0x10
    public LBPOFPHJMEE <DEPEGGGEPCN>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// HIAMHODLFBI
//   REQUEST  POST   api/players/v4/current/contact   [Service.API]
public class HIAMHODLFBI
{
    public HTTPResponse PGFOOPFEPHF;    // 0x0x10
    public int? KIOIHKCHGGN;    // 0x0x18
    public string AKOKHFDOCGB;    // 0x0x20
    public byte[] ICMGNIIGCBO;    // 0x0x28
    public string OBPHHOHBHHM;    // 0x0x30
}

// --------------------------------------------------------------------------
// HIMBIMCOBDF
//   (not directly referenced by a detected call)
public class HIMBIMCOBDF
{
    public Guid <BMJODHDLIBL>k__BackingField;    // 0x0x10
    public int <DAKNNHIMHKC>k__BackingField;    // 0x0x20
    public int <AHAFGMBOEDP>k__BackingField;    // 0x0x24
    public Guid <KPBIABJBPNE>k__BackingField;    // 0x0x28
    public DateTime <EMOCMJEGBJG>k__BackingField;    // 0x0x38
    public LNCJCDCHDBA <PAKKOCGFINP>k__BackingField;    // 0x0x40
}
...
public class HJCMDEIJFFO : HPIGNCPKPKB
{
    public MBMHBKAOGJC? <CIDHGFBNKDB>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <IAECKOKGEBD>k__BackingField;    // 0x0x20
}
...
public class HJOABFADDGG
{
    public int <DAKNNHIMHKC>k__BackingField;    // 0x0x10
    public Guid <CEFGKIDIOFL>k__BackingField;    // 0x0x14
    public long <EPFDNALLJND>k__BackingField;    // 0x0x28
    public long <BHEAAHLALAH>k__BackingField;    // 0x0x30
    public DateTime <LABHFGLMLPN>k__BackingField;    // 0x0x38
}
...
// IBHGKOLAHAE
//   (not directly referenced by a detected call)
public class IBHGKOLAHAE
{
    public int <KCFNHADBJJL>k__BackingField;    // 0x0x10
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x18
    public string <IJFPJAAAPDF>k__BackingField;    // 0x0x20
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x28
    public string <FAKHPHLHHMN>k__BackingField;    // 0x0x30
    public bool <PNOPKFCJOFD>k__BackingField;    // 0x0x38
    public int <MFNELMPOPNA>k__BackingField;    // 0x0x3C
    public EPBKAEDJFOO <BHNDBGCHCMJ>k__BackingField;    // 0x0x40
    public ILKKLKPPOFB JIODJEMGDMI;    // 0x0x48
    public ILKKLKPPOFB OIFEFMAJHFH;    // 0x0x50
    public ILKKLKPPOFB HPPKECGGJPN;    // 0x0x58
    public PNGOJJDMNMJ LAMGJCJPINN;    // 0x0x60
}

// --------------------------------------------------------------------------
// IBOPAAMHDND
//   (not directly referenced by a detected call)
public class IBOPAAMHDND
{
    public bool <PFFAGPLBNBF>k__BackingField;    // 0x0x10
    public GJFIKDCMIDE <BNBLKAKMMDI>k__BackingField;    // 0x0x18
    public float <OJDNKEOIJGP>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/keepsakes/{dKOLAHEMHJG}   [Service.API]
//   RESPONSE POST   api/keepsakes/{dKOLAHEMHJG}/collect   [Service.API]
...
public class ICNEOJHBOKK
{
    public bool <LJNJCBKDPNE>k__BackingField;    // 0x0x10
    public string <NOHLHFAGLCE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IDDEOIPLCOF
//   (not directly referenced by a detected call)
public class IDDEOIPLCOF
{
    public int <FPKAADFHCHI>k__BackingField;    // 0x0x10
    public int <PHMLKNNFPIG>k__BackingField;    // 0x0x14
    public int <PDCFKFGFGON>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IDOEMECGLFC
//   (not directly referenced by a detected call)
public class IDOEMECGLFC
{
    public long <CGBOAGNGBFK>k__BackingField;    // 0x0x10
    public Guid <NADNNKNOEBD>k__BackingField;    // 0x0x18
    public long <HMHLNHGKLGN>k__BackingField;    // 0x0x28
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x30
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x38
    public int <DFBCDBPAKGG>k__BackingField;    // 0x0x40
    public Guid? <DKODJFNOCGH>k__BackingField;    // 0x0x44
    public DateTime <KMLPHPNNDKM>k__BackingField;    // 0x0x58
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// IHBGFDFMDGO
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class IHBGFDFMDGO
{
    public long <AKLBCADPAAN>k__BackingField;    // 0x0x10
    public LGIPJLJOIDA <GOCCDHKBCCO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IHFIFGHLNID
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class IHFIFGHLNID
{
    public int <MFNELMPOPNA>k__BackingField;    // 0x0x10
    public string <EEPOFKCONDA>k__BackingField;    // 0x0x18
    public string <EHCADOFNPIF>k__BackingField;    // 0x0x20
    public string <MGGLNEIHMDM>k__BackingField;    // 0x0x28
    public string <JOPEIJBAJFF>k__BackingField;    // 0x0x30
    public string <EFMCMLLIGAJ>k__BackingField;    // 0x0x38
    public string <MAANJECOMKD>k__BackingField;    // 0x0x40
    public List<PCEJEENINGO> <OAMFCAEFJNO>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// IHLJMNPBPJO
//   (not directly referenced by a detected call)
public class IHLJMNPBPJO
{
    public NGNAAGGMGAE <ELFEMCBOHOM>k__BackingField;    // 0x0x10
    public int <DFBCDBPAKGG>k__BackingField;    // 0x0x14
    public EFJAMHGPOAL <BBCBBFFCKNA>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{bGKCKMMJBBA}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{bGKCKMMJBBA}   [Service.API]
...
public class IIGFPFGOPDA
{
    public GCGADLHKPBL <BEENDKEJKIO>k__BackingField;    // 0x0x10
    public LNCJCDCHDBA <PAKKOCGFINP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IIJNGBNILEM
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class IIJNGBNILEM
{
    public Guid <KKDFFFECJOE>k__BackingField;    // 0x0x10
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x20
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x28
    public DateTime <EMJOFPEKDOJ>k__BackingField;    // 0x0x30
    public DateTime? <CFGCBADKIGC>k__BackingField;    // 0x0x38
    public List<NMLOIGLOLLH> <DJHJOBEAEGB>k__BackingField;    // 0x0x48
}
...
public class IJEPFHDOAFD
{
    public string <EALHFNNFONJ>k__BackingField;    // 0x0x10
    public string <AEAABBECPAN>k__BackingField;    // 0x0x18
    public bool <IGDCLMGLNEI>k__BackingField;    // 0x0x20
    public string <JPDKBJEMCEL>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// IMDCEEFCHFO
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class IMDCEEFCHFO
{
    public FDBJHHNAJNB <IIPNICNIALN>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <IAECKOKGEBD>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{cNEPCDGFLLD}   [Service.API]
public class IMDKBLGNILK
{
    public long <HMHLNHGKLGN>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <DPBICLBEKEG>k__BackingField;    // 0x0x18
    public KFOJBNNPLII <LAOOEDDPKIA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// INBADCCHENA
//   (not directly referenced by a detected call)
public class INBADCCHENA
{
    public string <MCDOPJCBMCB>k__BackingField;    // 0x0x10
    public KDPAKODKNMJ <GOCCDHKBCCO>k__BackingField;    // 0x0x18
}
...
public class IPINGIEINBJ
{
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x10
}
...
// JCHPLDIJIPF
//   (not directly referenced by a detected call)
public class JCHPLDIJIPF
{
    public int <JDFPGCKBEFL>k__BackingField;    // 0x0x10
    public GFHGMCGHIJC <GOCCDHKBCCO>k__BackingField;    // 0x0x14
    public List<IHLJMNPBPJO> <EIEAPHLKCLM>k__BackingField;    // 0x0x18
    public List<IHLJMNPBPJO> <GPOKDPNMJOO>k__BackingField;    // 0x0x20
    public bool <FBOJEHMJDPN>k__BackingField;    // 0x0x28
    public DateTime? <LOHPFOELLFB>k__BackingField;    // 0x0x30
    public DateTime? <NGDLMBJFOJC>k__BackingField;    // 0x0x40
    public DateTime? <EFGDDELNAAE>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// JDKOAHHJBLJ
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{iCKJONDFDIG}   [Service.API]
public class JDKOAHHJBLJ
{
    public Guid <AFKGBEICNBI>k__BackingField;    // 0x0x10
    public int <DAKNNHIMHKC>k__BackingField;    // 0x0x20
    public int <JDFPGCKBEFL>k__BackingField;    // 0x0x24
    public DateTime <KMLPHPNNDKM>k__BackingField;    // 0x0x28
}
...
// JIHMFBACOPL
//   (not directly referenced by a detected call)
public class JIHMFBACOPL
{
    public int <IAFMENELELL>k__BackingField;    // 0x0x10
}
...
public class JMLIBACGFIE : LIBJBOEAPLD
{
    public List<LHCGLJGDBDE> KDHNIHOEIIK;    // 0x0x30
    public int <APJGOJJKOOM>k__BackingField;    // 0x0x38
}
...
public class JNAFPPDDCMM
{
    public Guid <IALNBDNIKIC>k__BackingField;    // 0x0x10
    public int <LIJIMHFFJML>k__BackingField;    // 0x0x20
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x28
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x30
    public int <DFBCDBPAKGG>k__BackingField;    // 0x0x38
    public IOFBCCCAJFA <BNBGLHLGJMM>k__BackingField;    // 0x0x3C
    public bool <FBOJEHMJDPN>k__BackingField;    // 0x0x40
    public int? <AAMOLAIELBI>k__BackingField;    // 0x0x44
    public string <NCCMADEECPL>k__BackingField;    // 0x0x50
    public string <DIFLNGBGGHK>k__BackingField;    // 0x0x58
    public string <JGFCGIMICLD>k__BackingField;    // 0x0x60
    public DateTime <KMLPHPNNDKM>k__BackingField;    // 0x0x68
    public DateTime <EMOCMJEGBJG>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// JNJHNIOCEMJ
//   (not directly referenced by a detected call)
public class JNJHNIOCEMJ
{
    public LNOAMMIKNKE <FDIIHCOLLFL>k__BackingField;    // 0x0x10
    public CJJJJGMIAGL <GENLMEKHDMG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JOOPHAEFMPM
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class JOOPHAEFMPM
{
    public NGNAAGGMGAE <ELFEMCBOHOM>k__BackingField;    // 0x0x10
    public JJDDDONBNJE <HCKMJLDFNIN>k__BackingField;    // 0x0x14
    public int <NDCIKNJOLGE>k__BackingField;    // 0x0x18
    public int <CCLMLDEPIOB>k__BackingField;    // 0x0x1C
    public int <GFECMPBJLDK>k__BackingField;    // 0x0x20
    public OJCAPILDHMB <EIBLAOPCPLE>k__BackingField;    // 0x0x24
    public bool <EDGBHNJKIEG>k__BackingField;    // 0x0x28
    public float <JGBNHANMADJ>k__BackingField;    // 0x0x2C
    public int <DGMGBDOMOML>k__BackingField;    // 0x0x30
    public bool <LADNNILNCEB>k__BackingField;    // 0x0x34
}
...
public class KAOONEDLDHD
{
    public int <BOOGOOONGDD>k__BackingField;    // 0x0x10
    public JLLMCCPJBPN <GOCCDHKBCCO>k__BackingField;    // 0x0x14
    public IINEHIONGOD <CIHKEIFCNCB>k__BackingField;    // 0x0x18
    public IINEHIONGOD <GBFAFKHMCMP>k__BackingField;    // 0x0x1C
    public IINEHIONGOD <FNMIPLIAOKO>k__BackingField;    // 0x0x20
}
...
public class KJCHPDINEKI
{
    public Guid <CEFGKIDIOFL>k__BackingField;    // 0x0x10
    public long? <HMHLNHGKLGN>k__BackingField;    // 0x0x20
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x30
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x38
    public NGNAAGGMGAE <ELFEMCBOHOM>k__BackingField;    // 0x0x40
    public long <CNOCKPJABGA>k__BackingField;    // 0x0x48
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x50
    public DateTime <KMLPHPNNDKM>k__BackingField;    // 0x0x58
    public DateTime <EMOCMJEGBJG>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// KOCDPKCNLNM
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{mIALFGJNIAO}   [Service.API]
...
public class KOCDPKCNLNM
{
    public LNOAMMIKNKE <FDIIHCOLLFL>k__BackingField;    // 0x0x10
    public LBPOFPHJMEE <DEPEGGGEPCN>k__BackingField;    // 0x0x18
    public BEEBOCCPEFI <AICCMEOPPIE>k__BackingField;    // 0x0x20
}
...
public class KPOLKDGOBBN
{
    public List<int> <KDMDHOEPAHA>k__BackingField;    // 0x0x10
    public string <FFCIPKDFKNF>k__BackingField;    // 0x0x18
}
...
public class LADIMGPPAIM
{
    public List<LNOAMMIKNKE> <BLODFILHCEO>k__BackingField;    // 0x0x10
    public List<JNJHNIOCEMJ> <FKFBANPBMME>k__BackingField;    // 0x0x18
}
...
public class LEINDOLBBGI
{
    public int <IPHNBBBCGFK>k__BackingField;    // 0x0x10
    public int <NPIJGBLOLJI>k__BackingField;    // 0x0x14
    public float <DMEJLJIOGNC>k__BackingField;    // 0x0x18
    public float <KHAHJCKFMIE>k__BackingField;    // 0x0x1C
    public bool <LEICEEHDPIO>k__BackingField;    // 0x0x20
    public bool <LKFCJNCOFGO>k__BackingField;    // 0x0x21
    public bool <FHPCIIKMNMB>k__BackingField;    // 0x0x22
}
...
// LGJDONFIJNK
//   (not directly referenced by a detected call)
public class LGJDONFIJNK
{
    public DBLILAIBBGD KFCCPHDOAIN;    // 0x0x10
    public int PDJKAPNOFHJ;    // 0x0x14
}
...
// base   : JCHPLDIJIPF
//   (not directly referenced by a detected call)
public class LHCGLJGDBDE : JCHPLDIJIPF
{
    public GJFIKDCMIDE <BNBLKAKMMDI>k__BackingField;    // 0x0x60
}
...
// LNCJCDCHDBA
//   (not directly referenced by a detected call)
public class LNCJCDCHDBA
{
    public Guid <BMJODHDLIBL>k__BackingField;    // 0x0x10
    public long <HMHLNHGKLGN>k__BackingField;    // 0x0x20
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x28
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x30
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x38
    public long <DFBCDBPAKGG>k__BackingField;    // 0x0x40
    public Guid? <DKODJFNOCGH>k__BackingField;    // 0x0x48
    public DateTime <EMOCMJEGBJG>k__BackingField;    // 0x0x60
}
...
// LNOAMMIKNKE
//   (not directly referenced by a detected call)
public class LNOAMMIKNKE
{
    public long <AKLBCADPAAN>k__BackingField;    // 0x0x10
    public int <DLPKDOICGHA>k__BackingField;    // 0x0x18
    public long <HMHLNHGKLGN>k__BackingField;    // 0x0x20
    public long? <MBKNMKEDJBH>k__BackingField;    // 0x0x28
    public long? <KHNIOBFGCJI>k__BackingField;    // 0x0x38
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x48
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x50
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x58
    public DateTime <MAKEDCLOCFG>k__BackingField;    // 0x0x60
    public DateTime <KFPGOAFKHIO>k__BackingField;    // 0x0x68
    public int <MMFDEPPCJNF>k__BackingField;    // 0x0x70
    public CHENGFCJKKC <BNBGLHLGJMM>k__BackingField;    // 0x0x74
    public bool <FJMCADCHMKB>k__BackingField;    // 0x0x78
    public bool <IHGKOCEPDKA>k__BackingField;    // 0x0x79
    public IPHFDHOENEF <BGBPNDGOPAD>k__BackingField;    // 0x0x7C
    public IPHFDHOENEF <HNDKJLEJMJE>k__BackingField;    // 0x0x80
    public long? <NJIAOMHLNOG>k__BackingField;    // 0x0x88
}
...
public class MBAJBLHKOCH
{
    public int <NMEFFKAPJJI>k__BackingField;    // 0x0x10
    public int <HKFHKPCFDMD>k__BackingField;    // 0x0x14
    public float <LLLGMEFAFKL>k__BackingField;    // 0x0x18
    public int <IKEJPOKHFAP>k__BackingField;    // 0x0x1C
    public int <GLPFCNGDOBO>k__BackingField;    // 0x0x20
    public int <JANEAAFJJDL>k__BackingField;    // 0x0x24
    public int <HBPGLGDBDKA>k__BackingField;    // 0x0x28
    public string <MPGLKDLHFNN>k__BackingField;    // 0x0x30
    public string <EOLPJBFLPKA>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// MCEJKKIDJLD
//   (not directly referenced by a detected call)
public class MCEJKKIDJLD
{
    public ObscuredLong <POCIIOHOKCM>k__BackingField;    // 0x0x10
    public string <NADNNKNOEBD>k__BackingField;    // 0x0x38
    public ObscuredInt <DLPKDOICGHA>k__BackingField;    // 0x0x40
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x58
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x60
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x68
    public int <PPCCBKOGABG>k__BackingField;    // 0x0x70
    public IOFBCCCAJFA <BNBGLHLGJMM>k__BackingField;    // 0x0x74
    public DateTime <EMOCMJEGBJG>k__BackingField;    // 0x0x78
    public DateTime <KMLPHPNNDKM>k__BackingField;    // 0x0x80
    public DateTime? <BCJAJNHANGA>k__BackingField;    // 0x0x88
    public long? <DBNAAOLCMMM>k__BackingField;    // 0x0x98
    public int <KLLEADOFNAL>k__BackingField;    // 0x0xA8
    public int <JNHJMEADFNO>k__BackingField;    // 0x0xAC
    public int <CPCLAGDOJGC>k__BackingField;    // 0x0xB0
    public FPOPDHMPMDH <EENAKLJKMFE>k__BackingField;    // 0x0xB4
    public FPOPDHMPMDH <DDLDELMKKNA>k__BackingField;    // 0x0xB8
    public ObscuredBool <PKEBIPBJNOG>k__BackingField;    // 0x0xBC
    public ObscuredBool <FHFNKMEIGAJ>k__BackingField;    // 0x0xC8
    public ObscuredBool <LMOFEBINCNG>k__BackingField;    // 0x0xD4
    public int? <DFBCDBPAKGG>k__BackingField;    // 0x0xE0
    public bool <LBHDHHKJBKI>k__BackingField;    // 0x0xE8
}

// --------------------------------------------------------------------------
// MEDJKIOKCGG
//   (not directly referenced by a detected call)
public class MEDJKIOKCGG
{
    public float <FEKGGABGBIF>k__BackingField;    // 0x0x10
    public float <PCAOPFGALGN>k__BackingField;    // 0x0x14
    public float <JJAGEBAHFMN>k__BackingField;    // 0x0x18
    public float <GOMNGIILBMF>k__BackingField;    // 0x0x1C
    public float <OFPFNMADAPJ>k__BackingField;    // 0x0x20
    public float <JDEBGFDBHEK>k__BackingField;    // 0x0x24
    public float <LAHNALEAMOP>k__BackingField;    // 0x0x28
    public float <PEEAPIILBEN>k__BackingField;    // 0x0x2C
}
...
public class MJBPHEKBPDL : LIBJBOEAPLD
{
    public int <COCPFEGDDPM>k__BackingField;    // 0x0x30
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x38
    public DateTime <EMJOFPEKDOJ>k__BackingField;    // 0x0x40
    public DateTime <MBHGHMKNDBH>k__BackingField;    // 0x0x48
    public NGNAAGGMGAE <ELFEMCBOHOM>k__BackingField;    // 0x0x50
    public JCHPLDIJIPF <CIGCEOKEFBP>k__BackingField;    // 0x0x58
    public List<FOLMHLLJAJJ> <OAEAAGJLOPC>k__BackingField;    // 0x0x60
    public ADLIHAHDBLC <OCMMDKPFLBG>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// MJNGJENDDHH
//   RESPONSE GET    api/inventions/v1/personaldetails/{oFNJKGALAEF}   [Service.API]
public class MJNGJENDDHH
{
    public bool <DAFFDADKDGN>k__BackingField;    // 0x0x10
}
...
// NJPNHCBGIJM
//   (not directly referenced by a detected call)
public class NJPNHCBGIJM
{
    public int <LMCOCDAEBBM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NMLOIGLOLLH
//   (not directly referenced by a detected call)
public class NMLOIGLOLLH
{
    public Guid <FJCFKGFANKJ>k__BackingField;    // 0x0x10
    public Guid <KCDCEECFBCD>k__BackingField;    // 0x0x20
    public DateTime <EMJOFPEKDOJ>k__BackingField;    // 0x0x30
    public List<GJFIKDCMIDE> <NFPIEDOMPFM>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// OAKOJIMPPCL
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class OAKOJIMPPCL
{
    public int <POGNGAGNIBO>k__BackingField;    // 0x0x10
    public string <FPCMBPHLHAE>k__BackingField;    // 0x0x18
    public List<IBHGKOLAHAE> <JEPMGJBFMDM>k__BackingField;    // 0x0x20
    public DJJIMKMKACL <PDHEJGEAIBL>k__BackingField;    // 0x0x28
    public string <HGHBGCPMKOB>k__BackingField;    // 0x0x30
    public DateTime <EMJOFPEKDOJ>k__BackingField;    // 0x0x38
    public DateTime <MBHGHMKNDBH>k__BackingField;    // 0x0x40
    public DateTime <HHEALIOCDJL>k__BackingField;    // 0x0x48
    public bool? <GKABDKLOAGG>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// OBAKGKBMJJO
//   (not directly referenced by a detected call)
public class OBAKGKBMJJO
{
    public float <ONALOPDNHFK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OCBGLCNGCIC
// base   : IIIGNJABNAF<JNAFPPDDCMM>
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{lFHFBCPJIHG}   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v2/fromCreator/{lFHFBCPJIHG}   [Service.API]
public class OCBGLCNGCIC
{
    // (no instance fields in the metadata dump)
}
...
//   RESPONSE GET    api/avatar/v2/{cAANLPABKCG}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{cAANLPABKCG}   [Service.API]
public class OEFOABJBEKP
{
    public string <EHCADOFNPIF>k__BackingField;    // 0x0x10
    public string <MGGLNEIHMDM>k__BackingField;    // 0x0x18
    public string <JOPEIJBAJFF>k__BackingField;    // 0x0x20
    public string <EFMCMLLIGAJ>k__BackingField;    // 0x0x28
    public string <MAANJECOMKD>k__BackingField;    // 0x0x30
    public List<PCEJEENINGO> <OAMFCAEFJNO>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// OEMEHCBLNMP
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class OEMEHCBLNMP
{
    public int <LKAOJJHOCIL>k__BackingField;    // 0x0x10
}
...
public class PBLICMPJCEJ
{
    public AKCHEJBDBAK <KPLGDKJDOCK>k__BackingField;    // 0x0x10
    public ABALDMODIKC <LFLCDGDFCGP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PCEJEENINGO
//   (not directly referenced by a detected call)
public class PCEJEENINGO
{
    public Guid <IALNBDNIKIC>k__BackingField;    // 0x0x10
    public byte <IAHJHMPGIOA>k__BackingField;    // 0x0x20
}
...
public class PMHOGFFGELA
{
    public GCGADLHKPBL <BEENDKEJKIO>k__BackingField;    // 0x0x10
    public HIMBIMCOBDF <NEKFGHPKPJA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PPMJNBEECDI
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class PPMJNBEECDI
{
    public List<INBADCCHENA> <HLMDGPONKAO>k__BackingField;    // 0x0x10
}
...
public class AddKeepsakeInstanceRequest
{
    public long <HMHLNHGKLGN>k__BackingField;    // 0x0x10
    public long? <MBKNMKEDJBH>k__BackingField;    // 0x0x18
    public KOOALFKNJOH <ENKINGBAIAN>k__BackingField;    // 0x0x28
}
...
{
    public DPGHOECEBPB <DEPEGGGEPCN>k__BackingField;    // 0x0x10
    public string <EMCHAOCCIBH>k__BackingField;    // 0x0x18
    public string <KDKLNAHMAFB>k__BackingField;    // 0x0x20
    public string <FKMIFLJGCHI>k__BackingField;    // 0x0x28
}
...
{
    public long <AKLBCADPAAN>k__BackingField;    // 0x0x10
    public long? <OFMLGOIFAFK>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public ONGCNHCFGHG FilterType;    // 0x0x20
...
{
    public KOOALFKNJOH <EICMFFHONFD>k__BackingField;    // 0x0x10
    public string <BAJNOOEICHC>k__BackingField;    // 0x0x18
    public int <KCABICALPCH>k__BackingField;    // 0x0x20
    public int <KJMMGGKECBL>k__BackingField;    // 0x0x24
}
...
{
    public int <DAKNNHIMHKC>k__BackingField;    // 0x0x10
    public Guid <FIKANKJBMNA>k__BackingField;    // 0x0x14
    public DateTime <PGENGJLBAEM>k__BackingField;    // 0x0x28
}
...
{
    public bool <EBJHHPFEDMI>k__BackingField;    // 0x0x10
    public int <HEIIECFCKJC>k__BackingField;    // 0x0x14
}
...
{
    public Guid <FIKANKJBMNA>k__BackingField;    // 0x0x10
    public KOOALFKNJOH <HJAOGOHANLL>k__BackingField;    // 0x0x20
    public int <KINLKLILKGN>k__BackingField;    // 0x0x24
    public long <HMHLNHGKLGN>k__BackingField;    // 0x0x28
    public long? <MBKNMKEDJBH>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes/events/{eDNCECBBAAD}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <KOJADGDOAME>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <MOJPBFCLDII>k__BackingField;    // 0x0x18
}
...
{
    public long <JPADABOBKFA>k__BackingField;    // 0x0x10
    public long <HMHLNHGKLGN>k__BackingField;    // 0x0x18
    public long <GIMPPKJGCDN>k__BackingField;    // 0x0x20
    public CIAIDPKOGPG <GOCCDHKBCCO>k__BackingField;    // 0x0x28
    public int <JAHKPKNMJOB>k__BackingField;    // 0x0x2C
}
...
{
    public long <HMHLNHGKLGN>k__BackingField;    // 0x0x10
    public List<Guid> <FDDPFMGLEJF>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <KOJADGDOAME>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <MOJPBFCLDII>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <LMGOCPAFCKD>k__BackingField;    // 0x0x20
}
...
{
    public long <GIMPPKJGCDN>k__BackingField;    // 0x0x10
    public long <BNJDJALOBMB>k__BackingField;    // 0x0x18
    public int? <HCEEFLFDPNG>k__BackingField;    // 0x0x20
    public int? <IFFOCCNAMDA>k__BackingField;    // 0x0x28
    public long? <CENKPPAABKC>k__BackingField;    // 0x0x30
    public long <IHFAMNNAKCD>k__BackingField;    // 0x0x40
    public long <FPIJNOPPEEJ>k__BackingField;    // 0x0x48
    public int <BFMGCAOIDNC>k__BackingField;    // 0x0x50
    public CIAIDPKOGPG <FFFMNGGMADN>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <NBJCDKILFEO>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public DLKPHMHCBDE <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public HPLKAGBJLGF creatorAccountRole;    // 0x0x58
}
...
{
    public GHKNMFFPPJM <LOJNLCDDGFN>k__BackingField;    // 0x0x10
    public IIAONJHOKBJ <FHGBKDPJPAE>k__BackingField;    // 0x0x14
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x18
    public string <ENADEFNOHCE>k__BackingField;    // 0x0x20
    public bool <FDLEMCJDFON>k__BackingField;    // 0x0x28
}
...
{
    public List<GHKNMFFPPJM> <IAFJNBEFION>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents/event/{mPJDLDBEJMO}   [Service.API]
public class ProgressionEventDTO
{
    public long <BNJDJALOBMB>k__BackingField;    // 0x0x10
    public string <DLFPFACBLKC>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <GGABHNCPLDD>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <MKDGHHADJEH>k__BackingField;    // 0x0x28
    public DateTime <MAKEDCLOCFG>k__BackingField;    // 0x0x30
    public DateTime <KFPGOAFKHIO>k__BackingField;    // 0x0x38
    public DateTime <EPMIIEAEPOI>k__BackingField;    // 0x0x40
    public bool <OLFFODCCHMH>k__BackingField;    // 0x0x48
    public int <OPBDKICPLNO>k__BackingField;    // 0x0x4C
    public float <MGALPPNGFLO>k__BackingField;    // 0x0x50
    public Guid? <MLNBHCMHBLA>k__BackingField;    // 0x0x54
    public string <DIPJGGCIMAP>k__BackingField;    // 0x0x68
    public string <DFJIOPHAJGJ>k__BackingField;    // 0x0x70
    public string <HHLOICGALLE>k__BackingField;    // 0x0x78
    public string <FACOCPKEJGE>k__BackingField;    // 0x0x80
}
...
{
    public Guid <DLAJGHIIJGA>k__BackingField;    // 0x0x10
    public int <COBEPEOLAAO>k__BackingField;    // 0x0x20
    public int <PFAGHGEGFOI>k__BackingField;    // 0x0x24
    public long <IEIOGNOHHLB>k__BackingField;    // 0x0x28
    public long <JMACFFHNKID>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE GET    api/progressionEvents/record/{mPJDLDBEJMO}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <DAKNNHIMHKC>k__BackingField;    // 0x0x10
    public int <EJBHLBNEBOG>k__BackingField;    // 0x0x14
    public int <LDNHBMDCKFP>k__BackingField;    // 0x0x18
    public int <CGNACBELKMO>k__BackingField;    // 0x0x1C
    public int <BPLIPKFAJGA>k__BackingField;    // 0x0x20
    public DateTime? <LDDMCLMGLEK>k__BackingField;    // 0x0x28
}
...
{
    public long <LDONCOAOPPN>k__BackingField;    // 0x0x10
    public int <NGEJIKCMJJG>k__BackingField;    // 0x0x18
    public string <PNOEHGPPMAB>k__BackingField;    // 0x0x20
    public int <EJBHLBNEBOG>k__BackingField;    // 0x0x28
    public int <IFNIOOHKBPL>k__BackingField;    // 0x0x2C
    public bool <HBEOMCPCEFL>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public DNFPJBJNHLK ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool BKLBKBEPEMF;    // 0x0x28
}
...
{
    public HONNDJEJAAK? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public HONNDJEJAAK AHJBLKCMMHL;  // wrapper
...
{
    public PFMBKIGEGDG DNFHAOMBNGJ;  // wrapper
...
{
    public BMNLLHIEFJB NLAFPPIOFPG;  // wrapper
    public int? CMLEPECJCHB;  // wrapper
...
{
    public FINOEAAGNOC UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public DLKPHMHCBDE IDEIPFIOJKJ;  // wrapper
    public DLKPHMHCBDE? KCAJHDFGHCC;  // wrapper
...
{
    public IBHGKOLAHAE BBOMKPKMKAK;  // wrapper
...
{
    public OAHNKIHOCLI IJBALCGHEPJ;  // wrapper
...
{
    public List<EKBPJNNNIAK> LCLDKDLEMAF;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public NOKCJBIBKMA CBMPLLNOAGG;  // wrapper
    public DLKPHMHCBDE? LDDAKJKCCDP;  // wrapper
...
{
    public KFDEJIDLLFN KHLHNICPOBI;  // wrapper
...
{
    public StatusResponse> EGLKIOCIBPB;  // wrapper
...
// api/keepsakes/{dKOLAHEMHJG}/collect  [API POST]
public class KeepsakesDKOLAHEMHJGCollectRequest
{
    public Guid DKOLAHEMHJG;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> FHDNLNILLPI;  // wrapper
    public ALPANBPHCDA ACGFJIOMCCH;  // wrapper
    public long? CNEPCDGFLLD;  // wrapper
    public OMBJMANPGBB EGLKIOCIBPB;  // wrapper
...
{
    public String> EGLKIOCIBPB;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{mIALFGJNIAO}  [API POST]
public class PlayereventsV2DeleteMIALFGJNIAORequest
{
    public LNOAMMIKNKE MIALFGJNIAO;  // wrapper
}
...
{
    public LNOAMMIKNKE MIALFGJNIAO;  // wrapper
    public CHENGFCJKKC MBKODPPIMPH;  // wrapper
...
{
    public LNOAMMIKNKE MIALFGJNIAO;  // wrapper
    public long? JEPAOADANIB;  // wrapper
    public object clubId;  // candidate
}
...
{
    public LNOAMMIKNKE MIALFGJNIAO;  // wrapper
    public IPHFDHOENEF MKFELAMHKDG;  // wrapper
    public IPHFDHOENEF KCOJCBBPPFL;  // wrapper
...
{
    public LNOAMMIKNKE MIALFGJNIAO;  // wrapper
    public long? KBJNEHOPFKF;  // wrapper
...
{
    public LNOAMMIKNKE MIALFGJNIAO;  // wrapper
    public List<string> FCIKMFNNDNO;  // wrapper
}
...
{
    public LNOAMMIKNKE MIALFGJNIAO;  // wrapper
    public DateTime JNKAEKGPEKE;  // wrapper
    public DateTime EFLPPBHEDNM;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> DALCKALNCCE;  // wrapper
...
{
    public Guid? BKIBEJPOMIE;  // wrapper
...
{
    public IReadOnlyList<CIDIDFGDMEF> CHLEAJADKPP;  // wrapper
}
...
{
    public MatchCompleteStats BANCPKELKNK;  // wrapper
}
...
{
    public Guid APOKGGJNNKE;  // wrapper
...
{
    public ODBOFNEMGMP NFIGFJDBLHM;  // wrapper
}
