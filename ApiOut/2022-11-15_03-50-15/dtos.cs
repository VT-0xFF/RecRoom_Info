...
public class ADMFPDBBKNC
{
    public Guid <NJGGLHANKGO>k__BackingField;    // 0x0x10
    public long? <EHHNEHMCHBP>k__BackingField;    // 0x0x20
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x30
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x38
    public CKKNPCPPLBB <LPNBOLOBKDC>k__BackingField;    // 0x0x40
    public long <OCNDFBPGCEG>k__BackingField;    // 0x0x48
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x50
    public DateTime <JMEHOHBJEOP>k__BackingField;    // 0x0x58
    public DateTime <DEJBNMKDJDG>k__BackingField;    // 0x0x60
}
...
public class AHFHFEONKFN
{
    public int <JBOJBJENDBN>k__BackingField;    // 0x0x10
    public bool <NOIMOIAGBHK>k__BackingField;    // 0x0x14
    public DateTime <AGGPJLNMBBL>k__BackingField;    // 0x0x18
    public bool <ECDDKLHCBJJ>k__BackingField;    // 0x0x20
}
...
public class AIFIBIKODON
{
    public long <LPDNCFCLEOM>k__BackingField;    // 0x0x10
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x18
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x20
    public DateTime <JMEHOHBJEOP>k__BackingField;    // 0x0x28
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x30
    public OADOEOOJCOP <DFOMDHLHKBK>k__BackingField;    // 0x0x38
    public int <JEELEFPEGNI>k__BackingField;    // 0x0x3C
    public int <GAMFDBPFOBC>k__BackingField;    // 0x0x40
    public List<PMEBKOBDLDO> <NPHDPIDBGPG>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// ANJBNOEKDHL
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class ANJBNOEKDHL
{
    public NEPGNOBBBPL <NMPAOGCKDJF>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <HHHEOBHJBDA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BABCKJOGEBM
//   RESPONSE POST   api/customAvatarItems/v1   [Service.API]
public class BABCKJOGEBM
{
    public Guid <PEBIJHFDOKB>k__BackingField;    // 0x0x10
    public int <PDPOEEJDOIO>k__BackingField;    // 0x0x20
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x28
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x30
    public int <KCNNLLIAFBN>k__BackingField;    // 0x0x38
    public AFKJEBEDDEP <PPLLKGOMHNH>k__BackingField;    // 0x0x3C
    public bool <CANFEMPGCCN>k__BackingField;    // 0x0x40
    public int? <IHHJMFMFMKB>k__BackingField;    // 0x0x44
    public string <NNEMMCJKAKJ>k__BackingField;    // 0x0x50
    public string <MMIMDDFDIOG>k__BackingField;    // 0x0x58
    public string <HOIGMEBPGCK>k__BackingField;    // 0x0x60
    public DateTime <JMEHOHBJEOP>k__BackingField;    // 0x0x68
    public DateTime <DEJBNMKDJDG>k__BackingField;    // 0x0x70
}
...
// BJHAIJFIEKE
//   (not directly referenced by a detected call)
public class BJHAIJFIEKE
{
    public CKKNPCPPLBB <LPNBOLOBKDC>k__BackingField;    // 0x0x10
    public int <KCNNLLIAFBN>k__BackingField;    // 0x0x14
    public EHFMOGAKFHN <LILHNGOCPJM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BJKBBJKBPOE
//   (not directly referenced by a detected call)
public class BJKBBJKBPOE
{
    public bool <DJBPPEGLFNN>k__BackingField;    // 0x0x10
    public NNOLNDPAGMJ <EHEBIMCIJEO>k__BackingField;    // 0x0x18
    public float <EBNIKBAMACG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BNMACJBDMHB
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{eNFGKNDHLNI}   [Service.API]
public class BNMACJBDMHB
{
    public uint <IODDHMBCJDI>k__BackingField;    // 0x0x10
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x18
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x20
    public DateTime <PHBPHCDMOOO>k__BackingField;    // 0x0x28
    public DateTime? <KDGBDHHIJHM>k__BackingField;    // 0x0x30
    public bool <POGFPCBCLBK>k__BackingField;    // 0x0x40
    public List<LKCDAPLHAHN> <KNFLAKKGHCM>k__BackingField;    // 0x0x48
    public List<string> <DEBBHCIOBII>k__BackingField;    // 0x0x50
    public int <KJHHFBJJONM>k__BackingField;    // 0x0x58
    public int <LDOBOHDCHBA>k__BackingField;    // 0x0x5C
    public int <DFCAINBMGKN>k__BackingField;    // 0x0x60
}
...
public class CCAFCGPKFEN : PKJAHGDNNAC
{
    public BEEBPJOBEJB? <MBFDGEFJOJL>k__BackingField;    // 0x0x18
    public NEPGNOBBBPL <NMPAOGCKDJF>k__BackingField;    // 0x0x20
}
...
public class CEAGFNAFNEE
{
    public List<DGECOMICBKJ> <PEBAOEGBNND>k__BackingField;    // 0x0x10
    public List<KMAOFCLIFJK> <AELLPFALAAE>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// CGLOFANAMNG
// base   : AMBGOJHFABF<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class CGLOFANAMNG
{
    // (no instance fields in the metadata dump)
}
...
// CILHNBDNHNJ
//   (not directly referenced by a detected call)
public class CILHNBDNHNJ
{
    public long <DOBBNPBGFGM>k__BackingField;    // 0x0x10
    public Guid <IOIIBKHDEAN>k__BackingField;    // 0x0x18
    public long <EHHNEHMCHBP>k__BackingField;    // 0x0x28
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x30
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x38
    public int <KCNNLLIAFBN>k__BackingField;    // 0x0x40
    public Guid? <KGOKEDALBIE>k__BackingField;    // 0x0x44
    public DateTime <JMEHOHBJEOP>k__BackingField;    // 0x0x58
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// CJCAPJCOPGG
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class CJCAPJCOPGG
{
    public int <JEJCBGLBCGF>k__BackingField;    // 0x0x10
    public string <GNAKIBILILD>k__BackingField;    // 0x0x18
    public List<FKCBLPALOJO> <BOOFCIKOJIC>k__BackingField;    // 0x0x20
    public PEJGHCHEMDO <FGCBCGECIIL>k__BackingField;    // 0x0x28
    public string <FIMFLMIHCOD>k__BackingField;    // 0x0x30
    public DateTime <NAGAEIGMNJC>k__BackingField;    // 0x0x38
    public DateTime <BNMGDCFEFHE>k__BackingField;    // 0x0x40
    public DateTime <OAFNCACIHPP>k__BackingField;    // 0x0x48
    public bool? <BDAIOFDEGOK>k__BackingField;    // 0x0x50
}
...
public class CJCBHEAMFJA
{
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x10
}
...
public class CKJKLMAKOFO
{
    public int <IEOALCMHNEF>k__BackingField;    // 0x0x10
    public List<PBKHKOMDODP> <APGGEBPPMDF>k__BackingField;    // 0x0x18
}
...
public class CKMKPHEEKBD
{
    public int <KKMNAPKCCBJ>k__BackingField;    // 0x0x10
    public int <LCDOEIENADO>k__BackingField;    // 0x0x14
    public float <BDOFCDJIDNL>k__BackingField;    // 0x0x18
    public int <JGNNDNDKNFO>k__BackingField;    // 0x0x1C
    public int <DOMPKNGABFC>k__BackingField;    // 0x0x20
    public int <HBBFKCPIELJ>k__BackingField;    // 0x0x24
    public int <KKJAGLIAHHH>k__BackingField;    // 0x0x28
    public string <OCGKFOLDOCB>k__BackingField;    // 0x0x30
    public string <HOJEJJPHDIC>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// CLPPIHPBJCI
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class CLPPIHPBJCI
{
    public Guid <EKCGPGKLFKN>k__BackingField;    // 0x0x10
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x20
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x28
    public DateTime <NAGAEIGMNJC>k__BackingField;    // 0x0x30
    public DateTime? <LPJNPOKAMKH>k__BackingField;    // 0x0x38
    public List<GHEHDOLPMNI> <LKFBDHPMOOG>k__BackingField;    // 0x0x48
}
...
public class CNHFPPCDIOF
{
    public NCDFOGDBBKB <ECGIACBLHKE>k__BackingField;    // 0x0x10
}
...
public class COAJANMCBDH
{
    public List<JNIHBECDOJK> <CBLDBMFCCPP>k__BackingField;    // 0x0x10
    public string <IMCHPNDMIBC>k__BackingField;    // 0x0x18
}
...
public class DEBKFMDGGBK : PKJAHGDNNAC
{
    public HNPFLBEILAP? <MBFDGEFJOJL>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <HHHEOBHJBDA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DFFGOPOKLEA
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class DFFGOPOKLEA
{
    public int <GFPPGBMHHPM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DGECOMICBKJ
//   (not directly referenced by a detected call)
public class DGECOMICBKJ
{
    public long <AAIDMODMGIF>k__BackingField;    // 0x0x10
    public int <CJMOCJEEEBB>k__BackingField;    // 0x0x18
    public long <EHHNEHMCHBP>k__BackingField;    // 0x0x20
    public long? <DLIBIEOMDMG>k__BackingField;    // 0x0x28
    public long? <EBODLMADHHH>k__BackingField;    // 0x0x38
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x48
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x50
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x58
    public DateTime <JMCHFGEFIPP>k__BackingField;    // 0x0x60
    public DateTime <OLAMJGFCKFD>k__BackingField;    // 0x0x68
    public int <FIAPPNIGCKC>k__BackingField;    // 0x0x70
    public FGBOCPCEBCC <PPLLKGOMHNH>k__BackingField;    // 0x0x74
    public bool <DJFEMAEIJCA>k__BackingField;    // 0x0x78
    public bool <MOBGJIOHLBP>k__BackingField;    // 0x0x79
    public LFDEPAIDPCL <JINLCCLNPNN>k__BackingField;    // 0x0x7C
    public LFDEPAIDPCL <JIONADDKELH>k__BackingField;    // 0x0x80
    public long? <OLNHAAJDNMH>k__BackingField;    // 0x0x88
}
...
public class DOHGDILCHJF
{
    public List<int> <JMEGBJPPCJJ>k__BackingField;    // 0x0x10
    public string <IMCHPNDMIBC>k__BackingField;    // 0x0x18
}
...
// DPPOIFEIIKN
//   (not directly referenced by a detected call)
public class DPPOIFEIIKN
{
    public bool <EIMMBJCLHNJ>k__BackingField;    // 0x0x10
    public DGJJKGIMGKP <IJJJKELGJEO>k__BackingField;    // 0x0x14
    public int <AHNFOAHILEF>k__BackingField;    // 0x0x18
    public DateTime <DEJBNMKDJDG>k__BackingField;    // 0x0x20
}
...
public class ECPAFILLMPD
{
    public Guid? <JKOEDGEDDGG>k__BackingField;    // 0x0x10
    public Guid <KHJDEFGGHCC>k__BackingField;    // 0x0x24
}
...
public class EDFHJFGNIJO
{
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x10
}
...
public class EDHEGLFJFKK
{
    public JEPANCHLFMC <CGBFLLCBCMA>k__BackingField;    // 0x0x10
    public string <FGPDLODLGKA>k__BackingField;    // 0x0x18
    public int? <BMNFDLAMOBN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EFEACGLKFMG
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class EFEACGLKFMG
{
    public int? <OPGJPNLBIKL>k__BackingField;    // 0x0x10
    public string <JOJNPPLBFOB>k__BackingField;    // 0x0x18
    public string <MJEBNKMPFDP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EHFMOGAKFHN
//   (not directly referenced by a detected call)
public class EHFMOGAKFHN
{
    public int <DMNCBDIJEJD>k__BackingField;    // 0x0x10
    public DateTime? <PBEJHPACOAO>k__BackingField;    // 0x0x18
    public DateTime? <ONICIPHFLIJ>k__BackingField;    // 0x0x28
}
...
// EMFONHKAJJO
//   (not directly referenced by a detected call)
public class EMFONHKAJJO
{
    public int <LBKEGIFHMBK>k__BackingField;    // 0x0x10
}
...
public class FAKOPKOJLAI
{
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FDOECKDBBCF
//   RESPONSE POST   api/playerevents/v2   [Service.API]
//   RESPONSE POST   api/playerevents/v2/delete/{iGOJJFNLCAL}   [Service.API]
...
public class FDOECKDBBCF
{
    public DGECOMICBKJ <KPJCMOPABIM>k__BackingField;    // 0x0x10
    public KEGGJMPAECE <JJBDGBKEEPP>k__BackingField;    // 0x0x18
    public GJLNBFIKLMF <EDDAIFFAAME>k__BackingField;    // 0x0x20
}
...
// FKCBLPALOJO
//   (not directly referenced by a detected call)
public class FKCBLPALOJO
{
    public int <BGFOJDFNJNL>k__BackingField;    // 0x0x10
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x18
    public string <PHPEOLHOBGM>k__BackingField;    // 0x0x20
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x28
    public string <POOMOOAOIHF>k__BackingField;    // 0x0x30
    public bool <KNJLNHHANCH>k__BackingField;    // 0x0x38
    public int <NDGNJCCENHF>k__BackingField;    // 0x0x3C
    public DDDFPLIADIO <AEPFOLIEDLP>k__BackingField;    // 0x0x40
    public AODKKHLJDGD LLJNGDCNLJP;    // 0x0x48
    public AODKKHLJDGD LKEPGIGEEMB;    // 0x0x50
    public AODKKHLJDGD FCHCBCLBNMA;    // 0x0x58
    public ANEIFALJHMG NDFHHCNFENK;    // 0x0x60
}
...
public class GCBPDMCEEHL
{
    public long <EHHNEHMCHBP>k__BackingField;    // 0x0x10
    public long? <DLIBIEOMDMG>k__BackingField;    // 0x0x18
    public long? <EBODLMADHHH>k__BackingField;    // 0x0x28
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x38
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x40
    public List<string> <DEBBHCIOBII>k__BackingField;    // 0x0x48
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x50
    public DateTime <JMCHFGEFIPP>k__BackingField;    // 0x0x58
    public DateTime <OLAMJGFCKFD>k__BackingField;    // 0x0x60
    public FGBOCPCEBCC <PPLLKGOMHNH>k__BackingField;    // 0x0x68
    public bool <DJFEMAEIJCA>k__BackingField;    // 0x0x6C
    public bool <MOBGJIOHLBP>k__BackingField;    // 0x0x6D
    public LFDEPAIDPCL <JINLCCLNPNN>k__BackingField;    // 0x0x70
    public LFDEPAIDPCL <JIONADDKELH>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// GFCKNGEPDEG
//   (not directly referenced by a detected call)
public class GFCKNGEPDEG
{
    public float <NLHHJKHGMJG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GHEHDOLPMNI
//   (not directly referenced by a detected call)
public class GHEHDOLPMNI
{
    public Guid <CDNPODMKMOB>k__BackingField;    // 0x0x10
    public Guid <KOOBPJHKMLB>k__BackingField;    // 0x0x20
    public DateTime <NAGAEIGMNJC>k__BackingField;    // 0x0x30
    public List<NNOLNDPAGMJ> <ABFGCBKMKCH>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// GJCOFEIMPKJ
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class GJCOFEIMPKJ
{
    public List<NIKHPGFCPFL> <DEBBHCIOBII>k__BackingField;    // 0x0x10
}
...
public class GJDCAJFBMEH
{
    public BHDPAMIDNGB <DHDLNHJIBBB>k__BackingField;    // 0x0x10
    public LHNDNMFAEHK <FHCPBBAOOHK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GJLNBFIKLMF
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class GJLNBFIKLMF
{
    public DPJIPLOBCAC <JJBDGBKEEPP>k__BackingField;    // 0x0x10
    public List<string> <DEBBHCIOBII>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GOGCAEBMPDF
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class GOGCAEBMPDF
{
    public long <AAIDMODMGIF>k__BackingField;    // 0x0x10
    public CEBKNJLKOLJ <IHBGJKCFBOD>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/keepsakes/{mOFMFKKIPEO}   [Service.API]
//   RESPONSE POST   api/keepsakes/{mOFMFKKIPEO}/collect   [Service.API]
...
public class HAIFJPJNGEH
{
    public bool <POKAJOIEMKE>k__BackingField;    // 0x0x10
    public string <FKJMJFDBBIH>k__BackingField;    // 0x0x18
}
...
public class HDEJNJDKGOI
{
    public string <HDOOMJGGLNF>k__BackingField;    // 0x0x10
    public string <EGKPJNCABGD>k__BackingField;    // 0x0x18
    public bool <AGKIOKNPIIA>k__BackingField;    // 0x0x20
    public string <LOJHMEEJDIP>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// HENKJDMFEII
//   (not directly referenced by a detected call)
public class HENKJDMFEII
{
    public Guid <AIKKFHEKOPO>k__BackingField;    // 0x0x10
    public long <EHHNEHMCHBP>k__BackingField;    // 0x0x20
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x28
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x30
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x38
    public long <KCNNLLIAFBN>k__BackingField;    // 0x0x40
    public Guid? <KGOKEDALBIE>k__BackingField;    // 0x0x48
    public DateTime <DEJBNMKDJDG>k__BackingField;    // 0x0x60
}
...
public class HFKFCNNANBC
{
    public int <DEMACECJFDE>k__BackingField;    // 0x0x10
    public BKEAIPKKPGC <IHBGJKCFBOD>k__BackingField;    // 0x0x14
    public FICFOEILFDF <AIIMMGCAIFF>k__BackingField;    // 0x0x18
    public FICFOEILFDF <NECGNJJOHHB>k__BackingField;    // 0x0x1C
    public FICFOEILFDF <EJGKMJKLIMF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HIPHCBGEIIB
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class HIPHCBGEIIB
{
    public int <BKAJNGLKKFC>k__BackingField;    // 0x0x10
    public int <JBOJBJENDBN>k__BackingField;    // 0x0x14
    public float <KKGCMFLEGNL>k__BackingField;    // 0x0x18
    public float <HDCAEFKGGML>k__BackingField;    // 0x0x1C
    public bool <NOIMOIAGBHK>k__BackingField;    // 0x0x20
    public bool <NHBHPMDLBNJ>k__BackingField;    // 0x0x21
    public bool <OOABPADCGHI>k__BackingField;    // 0x0x22
}
...
public class HOIFABFCNCH
{
    public MJCJCPPFOGF <CGBFLLCBCMA>k__BackingField;    // 0x0x10
    public int <GFPPGBMHHPM>k__BackingField;    // 0x0x14
    public long <EFEANBPNJBE>k__BackingField;    // 0x0x18
    public bool <DCMKLEBGPOG>k__BackingField;    // 0x0x20
    public string <FAPCOBNCMKL>k__BackingField;    // 0x0x28
    public int? <DFMMMNHHFLL>k__BackingField;    // 0x0x30
    public bool <JHCELNCJKFM>k__BackingField;    // 0x0x38
    public bool <MLNFMPBOBDK>k__BackingField;    // 0x0x39
    public bool <KPGLNOIGBEJ>k__BackingField;    // 0x0x3A
    public string <LDOMNJPEJBO>k__BackingField;    // 0x0x40
    public DateTime? <CJJCBDDIBNC>k__BackingField;    // 0x0x48
    public float <EBCBAGEJODK>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// HPDKEELMHDP
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class HPDKEELMHDP
{
    public MJCJCPPFOGF <CGBFLLCBCMA>k__BackingField;    // 0x0x10
    public long <AAIDMODMGIF>k__BackingField;    // 0x0x18
    public string <FGPDLODLGKA>k__BackingField;    // 0x0x20
}
...
public class ICPAGLCDCPI
{
    public int <NDGNJCCENHF>k__BackingField;    // 0x0x10
    public string <AODMOKBMDAO>k__BackingField;    // 0x0x18
    public string <COJDHGBAHEL>k__BackingField;    // 0x0x20
    public string <OIFKAOHMIFE>k__BackingField;    // 0x0x28
    public string <HPGEKDGLGIK>k__BackingField;    // 0x0x30
    public string <FOIOPJKPKJC>k__BackingField;    // 0x0x38
    public string <JDBFACCHNLC>k__BackingField;    // 0x0x40
    public List<IHIDJPDIALD> <JOEAELDANGM>k__BackingField;    // 0x0x48
}
...
public class IFGNNDIKCAG
{
    public KEGGJMPAECE <JJBDGBKEEPP>k__BackingField;    // 0x0x10
}
...
public class IGCBCFEIBPM
{
    public List<string> <NPPMBHJHEHB>k__BackingField;    // 0x0x10
    public List<string> <ACJNCCFEHBN>k__BackingField;    // 0x0x18
    public List<string> <MFKMBMHFOCG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IGFNDFBGIHC
//   (not directly referenced by a detected call)
public class IGFNDFBGIHC
{
    public int <DKHAINFOBBE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IHIDJPDIALD
//   (not directly referenced by a detected call)
public class IHIDJPDIALD
{
    public Guid <PEBIJHFDOKB>k__BackingField;    // 0x0x10
    public byte <HGKKNHNACHN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IHLNMOKFPMD
//   (not directly referenced by a detected call)
public class IHLNMOKFPMD
{
    public int <IIMHKFPGGPO>k__BackingField;    // 0x0x10
}
...
public class ILMJKOFKJBG : ValueType
{
    public int <PHGBBIBHHIC>k__BackingField;    // 0x0x0
}
...
public class JCAHEGDLPLB
{
    public int <PDPOEEJDOIO>k__BackingField;    // 0x0x10
    public int? <IHHJMFMFMKB>k__BackingField;    // 0x0x14
    public string <MMIMDDFDIOG>k__BackingField;    // 0x0x20
    public string <NNEMMCJKAKJ>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// JNIHBECDOJK
//   (not directly referenced by a detected call)
public class JNIHBECDOJK
{
    public int <BJKGNMJDPFN>k__BackingField;    // 0x0x10
    public DateTime <JMEHOHBJEOP>k__BackingField;    // 0x0x18
    public DateTime? <BDEGFHAKGAG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JPBMLPAFEDG
//   (not directly referenced by a detected call)
public class JPBMLPAFEDG
{
    public int <JCDNCEJLIMI>k__BackingField;    // 0x0x10
    public int <PHDBKMHDBOE>k__BackingField;    // 0x0x14
    public int <NGINHOCIAIJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KDINHNOIDCI
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class KDINHNOIDCI
{
    public int <LLIDIOOCJLN>k__BackingField;    // 0x0x10
    public Guid <NJGGLHANKGO>k__BackingField;    // 0x0x14
    public long <NEBMJDAFKMF>k__BackingField;    // 0x0x28
    public long <IAFGBJMPEKD>k__BackingField;    // 0x0x30
    public DateTime <EPILLGDABCI>k__BackingField;    // 0x0x38
}
...
public class KFMEKDCKALP
{
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x10
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x18
    public int? <KCNNLLIAFBN>k__BackingField;    // 0x0x20
    public AFKJEBEDDEP? <PPLLKGOMHNH>k__BackingField;    // 0x0x28
}
...
public class KFPCGGHIKKJ : FCLHFBOCAJF
{
    public List<PNPLPGBJHDO> JDJMDPMAABF;    // 0x0x30
    public int <MBNEOKBOIBF>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// KHAPNHHMFIJ
//   (not directly referenced by a detected call)
public class KHAPNHHMFIJ
{
    public float <LCIMPCMJOGC>k__BackingField;    // 0x0x10
    public float <EDGOILKHGGE>k__BackingField;    // 0x0x14
    public float <DDFBPABECAC>k__BackingField;    // 0x0x18
    public float <BGKDPCDONNN>k__BackingField;    // 0x0x1C
    public float <CFIODDEPIHD>k__BackingField;    // 0x0x20
    public float <MNNKMIBOHME>k__BackingField;    // 0x0x24
    public float <MAFEEMFEING>k__BackingField;    // 0x0x28
    public float <DCFFCAHKAGM>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// KKHAONIAMIL
//   (not directly referenced by a detected call)
public class KKHAONIAMIL
{
    public DateTime <JMEHOHBJEOP>k__BackingField;    // 0x0x10
    public string <BDDPIIJDJFE>k__BackingField;    // 0x0x18
}
...
// KMAOFCLIFJK
//   (not directly referenced by a detected call)
public class KMAOFCLIFJK
{
    public DGECOMICBKJ <KPJCMOPABIM>k__BackingField;    // 0x0x10
    public LIAPAPNKEHC <AEAGMOMHJCA>k__BackingField;    // 0x0x18
}
...
public class KMLEOHNOICF
{
    public bool <DIEJCNINOFO>k__BackingField;    // 0x0x10
    public string <LJEHEJDPHJG>k__BackingField;    // 0x0x18
    public string <MNKIFFLIDAC>k__BackingField;    // 0x0x20
}
...
// LFMOGLEBEHL
//   (not directly referenced by a detected call)
public class LFMOGLEBEHL
{
    public long <MLAMJHHLJJK>k__BackingField;    // 0x0x10
    public string <IOIIBKHDEAN>k__BackingField;    // 0x0x18
    public int <KLEDOHPPPEL>k__BackingField;    // 0x0x20
    public int <PNDIHKJLEKO>k__BackingField;    // 0x0x24
    public int <GNNPFBMMNGE>k__BackingField;    // 0x0x28
    public int <PLPIBAAEMJB>k__BackingField;    // 0x0x2C
    public int <BGCGKAPBJIM>k__BackingField;    // 0x0x30
    public string <CEECODFDDHB>k__BackingField;    // 0x0x38
    public string <LMNFPMCOKGH>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// LHNDNMFAEHK
//   (not directly referenced by a detected call)
public class LHNDNMFAEHK
{
    public Guid <AIKKFHEKOPO>k__BackingField;    // 0x0x10
    public int <LLIDIOOCJLN>k__BackingField;    // 0x0x20
    public int <FLIHADKOEDN>k__BackingField;    // 0x0x24
    public Guid <NDHLFAPKIOH>k__BackingField;    // 0x0x28
    public DateTime <DEJBNMKDJDG>k__BackingField;    // 0x0x38
    public HENKJDMFEII <PBOOCDILINC>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// LIAPAPNKEHC
//   (not directly referenced by a detected call)
public class LIAPAPNKEHC
{
    public long <JBLCICGABGI>k__BackingField;    // 0x0x10
    public long <AAIDMODMGIF>k__BackingField;    // 0x0x18
    public int <FNMELJFJGIK>k__BackingField;    // 0x0x20
    public DateTime <JMEHOHBJEOP>k__BackingField;    // 0x0x28
    public CEBKNJLKOLJ <IHBGJKCFBOD>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// LKCDAPLHAHN
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{eNFGKNDHLNI}   [Service.API]
public class LKCDAPLHAHN
{
    public string <IODDHMBCJDI>k__BackingField;    // 0x0x10
    public string <LJEHEJDPHJG>k__BackingField;    // 0x0x18
    public string <JPIJPDHKOMP>k__BackingField;    // 0x0x20
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x28
    public string <JOJNPPLBFOB>k__BackingField;    // 0x0x30
    public CDDPHFNIOAO <DHDLNHJIBBB>k__BackingField;    // 0x0x38
    public List<string> <JEKBAENJOMF>k__BackingField;    // 0x0x40
    public List<string> <DEBBHCIOBII>k__BackingField;    // 0x0x48
    public string <OBBMDIDBFKK>k__BackingField;    // 0x0x50
    public List<KKHAONIAMIL> <HJOHKDLAMIB>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// LPIMMCNCNPE
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{cJHIBBMKEKH}   [Service.API]
public class LPIMMCNCNPE
{
    public Guid <OCNDBNMEEHN>k__BackingField;    // 0x0x10
    public int <LLIDIOOCJLN>k__BackingField;    // 0x0x20
    public int <IBDGJGEONJI>k__BackingField;    // 0x0x24
    public DateTime <JMEHOHBJEOP>k__BackingField;    // 0x0x28
}
...
public class LPNFGNKIHDG
{
    public Guid? <AIKKFHEKOPO>k__BackingField;    // 0x0x10
    public long? <EHHNEHMCHBP>k__BackingField;    // 0x0x28
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x38
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x40
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x48
    public NCDFOGDBBKB <ECGIACBLHKE>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// MAPJAOHENLA
//   (not directly referenced by a detected call)
public class MAPJAOHENLA
{
    public int <IBDGJGEONJI>k__BackingField;    // 0x0x10
    public FJKGCPDLICO <IHBGJKCFBOD>k__BackingField;    // 0x0x14
    public List<BJHAIJFIEKE> <HDIBDOHKIBH>k__BackingField;    // 0x0x18
    public List<BJHAIJFIEKE> <FOILINHIEAI>k__BackingField;    // 0x0x20
    public bool <CANFEMPGCCN>k__BackingField;    // 0x0x28
    public DateTime? <FNEMAJHFEAI>k__BackingField;    // 0x0x30
    public DateTime? <PHOKJKOJMKM>k__BackingField;    // 0x0x40
    public DateTime? <MDJIAJFHEMK>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// MBFHHGLDGEF
// base   : AMBGOJHFABF<BABCKJOGEBM>
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{oGEOJHBABFD}   [Service.API]
public class MBFHHGLDGEF
{
    // (no instance fields in the metadata dump)
}
...
//   RESPONSE GET    api/avatar/v2/{cOMBNLMNAFP}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{cOMBNLMNAFP}   [Service.API]
public class MDNEJKOBEBO
{
    public string <COJDHGBAHEL>k__BackingField;    // 0x0x10
    public string <OIFKAOHMIFE>k__BackingField;    // 0x0x18
    public string <HPGEKDGLGIK>k__BackingField;    // 0x0x20
    public string <FOIOPJKPKJC>k__BackingField;    // 0x0x28
    public string <JDBFACCHNLC>k__BackingField;    // 0x0x30
    public List<IHIDJPDIALD> <JOEAELDANGM>k__BackingField;    // 0x0x38
}
...
public class MECPCLLKOOE
{
    public IJFBLPOBIHC <DHDLNHJIBBB>k__BackingField;    // 0x0x10
    public NPFEIEGMHPD <KKDCBGJGHBC>k__BackingField;    // 0x0x18
    public LFMOGLEBEHL <KJPMOBKIKCD>k__BackingField;    // 0x0x20
}
...
// NBBNCEIICBI
//   (not directly referenced by a detected call)
public class NBBNCEIICBI
{
    public NBDAHMKIDBO OBBMPLJFMIG;    // 0x0x10
    public int LBIPLLJKOFK;    // 0x0x14
}
...
public class NBFNBDKNNAM
{
    public CKKNPCPPLBB <LPNBOLOBKDC>k__BackingField;    // 0x0x10
    public HMLMKLLHLBE <NDILEINOBIN>k__BackingField;    // 0x0x14
    public int <FPOPFHFEFMN>k__BackingField;    // 0x0x18
    public int <HPBNLHEIHPB>k__BackingField;    // 0x0x1C
    public int <CECDPDDPFHA>k__BackingField;    // 0x0x20
    public GOHNOKHLEPK <PABFOJKAPCA>k__BackingField;    // 0x0x24
    public bool <KCFDFPPPACO>k__BackingField;    // 0x0x28
    public float <GJFFDDINFLD>k__BackingField;    // 0x0x2C
    public int <OCKOHNJCLKC>k__BackingField;    // 0x0x30
    public bool <EPMKLFKKAAO>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// NCDFOGDBBKB
//   (not directly referenced by a detected call)
public class NCDFOGDBBKB
{
    public long <KCNNLLIAFBN>k__BackingField;    // 0x0x10
    public Guid? <NJGGLHANKGO>k__BackingField;    // 0x0x18
}
...
public class NEPGNOBBBPL
{
    public int <LLIDIOOCJLN>k__BackingField;    // 0x0x10
    public Guid <NJGGLHANKGO>k__BackingField;    // 0x0x14
    public long <NEBMJDAFKMF>k__BackingField;    // 0x0x28
    public DateTime <DEJBNMKDJDG>k__BackingField;    // 0x0x30
}
...
// NIKHPGFCPFL
//   (not directly referenced by a detected call)
public class NIKHPGFCPFL
{
    public string <IHEMAPAJKGN>k__BackingField;    // 0x0x10
    public CEBMFHKHIOD <IHBGJKCFBOD>k__BackingField;    // 0x0x18
}
...
public class NLNLDHJLECM : FCLHFBOCAJF
{
    public int <DBDMFGHBELF>k__BackingField;    // 0x0x30
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x38
    public DateTime <NAGAEIGMNJC>k__BackingField;    // 0x0x40
    public DateTime <BNMGDCFEFHE>k__BackingField;    // 0x0x48
    public CKKNPCPPLBB <LPNBOLOBKDC>k__BackingField;    // 0x0x50
    public MAPJAOHENLA <APCDGLJNANF>k__BackingField;    // 0x0x58
    public List<PHFCDONEOLB> <JKENJKOBCJN>k__BackingField;    // 0x0x60
    public DPPOIFEIIKN <PEDAPBMOKJD>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// NNOLNDPAGMJ
//   (not directly referenced by a detected call)
public class NNOLNDPAGMJ
{
    public int <JGLJGKHBDJJ>k__BackingField;    // 0x0x10
    public string <CFAABPPMPEL>k__BackingField;    // 0x0x18
    public string <POOMOOAOIHF>k__BackingField;    // 0x0x20
    public string <NBCODMKOPIP>k__BackingField;    // 0x0x28
    public string <JOJGAGPBBFO>k__BackingField;    // 0x0x30
    public string <MDCMHPLOILI>k__BackingField;    // 0x0x38
    public DKBEHEKECNH? <FIEDIFCCPON>k__BackingField;    // 0x0x40
    public string <PADMJBOPAAG>k__BackingField;    // 0x0x48
    public string <CJOIDOADDGL>k__BackingField;    // 0x0x50
    public bool <KOHJDGGIACA>k__BackingField;    // 0x0x58
    public bool <OADPOGFIOAH>k__BackingField;    // 0x0x59
    public bool <IIAMCJLELLH>k__BackingField;    // 0x0x5A
    public HKLHKPPAKMO <NMKFPNIHCID>k__BackingField;    // 0x0x5C
    public int <BFOAPIOEOBC>k__BackingField;    // 0x0x60
    public CKKNPCPPLBB <LPNBOLOBKDC>k__BackingField;    // 0x0x64
    public int <BIDIDPKPAOD>k__BackingField;    // 0x0x68
    public HPJGLCCDAPF <GDLFMPIBFJP>k__BackingField;    // 0x0x6C
    public LFMFOCNKBFD <FPEIAFCICAH>k__BackingField;    // 0x0x70
    public int? <BHMOLNBGEIC>k__BackingField;    // 0x0x74
    public string <MBPCKIEMJEC>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// NPFEIEGMHPD
//   (not directly referenced by a detected call)
public class NPFEIEGMHPD
{
    public ObscuredLong <MLAMJHHLJJK>k__BackingField;    // 0x0x10
    public string <IOIIBKHDEAN>k__BackingField;    // 0x0x38
    public ObscuredInt <CJMOCJEEEBB>k__BackingField;    // 0x0x40
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x58
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x60
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x68
    public int <FKNANFCJPFP>k__BackingField;    // 0x0x70
    public AFKJEBEDDEP <PPLLKGOMHNH>k__BackingField;    // 0x0x74
    public DateTime <DEJBNMKDJDG>k__BackingField;    // 0x0x78
    public DateTime <JMEHOHBJEOP>k__BackingField;    // 0x0x80
    public DateTime? <LCDCAACHPIF>k__BackingField;    // 0x0x88
    public long? <EJBCAAHPGDN>k__BackingField;    // 0x0x98
    public int <NJBBFPBKNDM>k__BackingField;    // 0x0xA8
    public int <DJKJEPHGADD>k__BackingField;    // 0x0xAC
    public int <KHHOPLGCBAO>k__BackingField;    // 0x0xB0
    public LEGBDAHAKNJ <FMHCADOKONI>k__BackingField;    // 0x0xB4
    public LEGBDAHAKNJ <NFKCOKDNGDE>k__BackingField;    // 0x0xB8
    public ObscuredBool <PDDLFILEFIE>k__BackingField;    // 0x0xBC
    public ObscuredBool <KBIKNGCIGKE>k__BackingField;    // 0x0xC8
    public ObscuredBool <JLDOEFJGPAE>k__BackingField;    // 0x0xD4
    public int? <KCNNLLIAFBN>k__BackingField;    // 0x0xE0
    public bool <AHMMMMCCHAE>k__BackingField;    // 0x0xE8
}
...
public class OBICOPCLNIC
{
    public ECPAFILLMPD <ABOBGBELEJN>k__BackingField;    // 0x0x10
    public NCDFOGDBBKB <CHPHECNDFGD>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{nHLFHKNMPKF}   [Service.API]
public class OJEADICLMLH
{
    public long <EHHNEHMCHBP>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <PKAMHBIMOHO>k__BackingField;    // 0x0x18
    public HFAFLANKPME <CJIJJELMMCD>k__BackingField;    // 0x0x20
}
...
public class OJGJELKIEHG
{
    public Dictionary<int, int> <HFKAHJLOOOC>k__BackingField;    // 0x0x10
    public List<LMIAFCNHLCI> <OOHMAIKKDGA>k__BackingField;    // 0x0x18
    public NBBNCEIICBI[][] <JBENOAOIFNO>k__BackingField;    // 0x0x20
    public EMFONHKAJJO <PMLCOGCNHOA>k__BackingField;    // 0x0x28
    public KHAPNHHMFIJ <CMPMDIPBNKJ>k__BackingField;    // 0x0x30
    public IGFNDFBGIHC <NPMJEGGDLCL>k__BackingField;    // 0x0x38
    public IHLNMOKFPMD <FNPBNMGFKKK>k__BackingField;    // 0x0x40
    public GFCKNGEPDEG <JDIDPNGBMAB>k__BackingField;    // 0x0x48
    public string <GAOLKBLMBPD>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// OJJMGJBNNFM
//   REQUEST  POST   api/players/v4/current/contact   [Service.API]
public class OJJMGJBNNFM
{
    public HTTPResponse CDICMPJIAAG;    // 0x0x10
    public int? LPOMKHEJEKP;    // 0x0x18
    public string ADMAPDLCDHJ;    // 0x0x20
    public byte[] CMCNGFOHLIE;    // 0x0x28
    public string MGJBCCKEAGD;    // 0x0x30
}
...
public class OKNFEPNNHCK
{
    public bool <POKAJOIEMKE>k__BackingField;    // 0x0x10
    public string <FAPCOBNCMKL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OLBOJJDDABF
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class OLBOJJDDABF
{
    public List<PCPHLAEFGFE> <EKNDENIKDCC>k__BackingField;    // 0x0x10
    public KEGGJMPAECE <JJBDGBKEEPP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OMPFADAPGFH
//   RESPONSE GET    api/inventions/v1/personaldetails/{kLDPPFMECLF}   [Service.API]
public class OMPFADAPGFH
{
    public bool <GKHPOCELJBG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PBKHKOMDODP
//   (not directly referenced by a detected call)
public class PBKHKOMDODP
{
    public DateTime? <HEJBDFOMCJN>k__BackingField;    // 0x0x10
    public DateTime? <LPPOCEMBHIC>k__BackingField;    // 0x0x20
    public NKEDLIDFFIP <DHDLNHJIBBB>k__BackingField;    // 0x0x30
    public JPBMLPAFEDG <KLLKBLIPIEH>k__BackingField;    // 0x0x38
    public bool <ACALDABCNGF>k__BackingField;    // 0x0x40
}
...
public class PCIJGLBNELF
{
    public NFDADAHGFEA <DHDLNHJIBBB>k__BackingField;    // 0x0x10
    public CILHNBDNHNJ <NPFKIIFEBNA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PCPHLAEFGFE
//   (not directly referenced by a detected call)
public class PCPHLAEFGFE
{
    public int <HLBEOLODNGH>k__BackingField;    // 0x0x10
    public KEGGJMPAECE <JJBDGBKEEPP>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// PEJGHCHEMDO
//   (not directly referenced by a detected call)
public class PEJGHCHEMDO
{
    public long <JGLJGKHBDJJ>k__BackingField;    // 0x0x10
    public string <JOJGAGPBBFO>k__BackingField;    // 0x0x18
    public string <NNLECDPJNJE>k__BackingField;    // 0x0x20
    public DKBEHEKECNH? <FIEDIFCCPON>k__BackingField;    // 0x0x28
    public string <PADMJBOPAAG>k__BackingField;    // 0x0x30
    public string <CJOIDOADDGL>k__BackingField;    // 0x0x38
    public EKOPLNLPIDK <DNEALBIGAEG>k__BackingField;    // 0x0x40
    public int <DOPOPJOPLCE>k__BackingField;    // 0x0x44
    public int <JJMNIBMHHAC>k__BackingField;    // 0x0x48
    public LFMFOCNKBFD? <IIJICDGBCNF>k__BackingField;    // 0x0x4C
    public HKLHKPPAKMO? <DLODOMGGHIK>k__BackingField;    // 0x0x54
}
...
public class PFKFLDMANMO
{
    public Guid <OIBLCMKFPNM>k__BackingField;    // 0x0x10
    public Guid <NJGGLHANKGO>k__BackingField;    // 0x0x20
    public int <DPDLCEJLFMP>k__BackingField;    // 0x0x30
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x38
    public long <HGBPAFLNMPK>k__BackingField;    // 0x0x40
    public long <KCNNLLIAFBN>k__BackingField;    // 0x0x48
    public DateTime <DEJBNMKDJDG>k__BackingField;    // 0x0x50
}
...
// base   : MAPJAOHENLA
//   (not directly referenced by a detected call)
public class PHFCDONEOLB : MAPJAOHENLA
{
    public int <JKIGCMMMDBL>k__BackingField;    // 0x0x60
    public List<BJKBBJKBPOE> <EMMEAHCIKBL>k__BackingField;    // 0x0x68
    public List<BJKBBJKBPOE> <OKBDJHNCLKC>k__BackingField;    // 0x0x70
    public List<BJKBBJKBPOE> <ADGFOBLBFBP>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// PMEBKOBDLDO
//   RESPONSE GET    api/groups/v1/memberships/{gGLJLEEFAFM}   [Service.API]
public class PMEBKOBDLDO
{
    public long <LPDNCFCLEOM>k__BackingField;    // 0x0x10
    public int <FNMELJFJGIK>k__BackingField;    // 0x0x18
    public KLMPEEOCEEE <KIBOONMMIJN>k__BackingField;    // 0x0x1C
}
...
// base   : MAPJAOHENLA
//   (not directly referenced by a detected call)
public class PNPLPGBJHDO : MAPJAOHENLA
{
    public NNOLNDPAGMJ <EHEBIMCIJEO>k__BackingField;    // 0x0x60
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{hDLMEHMALMF}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{hDLMEHMALMF}   [Service.API]
...
public class PPOAMJDLOEJ
{
    public BHDPAMIDNGB <DHDLNHJIBBB>k__BackingField;    // 0x0x10
    public HENKJDMFEII <PBOOCDILINC>k__BackingField;    // 0x0x18
}
...
public class AddKeepsakeInstanceRequest
{
    public long <EHHNEHMCHBP>k__BackingField;    // 0x0x10
    public long? <DLIBIEOMDMG>k__BackingField;    // 0x0x18
    public IMJJPBJDHEF <INIKEHMPCHD>k__BackingField;    // 0x0x28
}
...
{
    public KKAAINCJOBO <JJBDGBKEEPP>k__BackingField;    // 0x0x10
    public string <IMOPJMLGHAG>k__BackingField;    // 0x0x18
    public string <NCOOGPAGDDO>k__BackingField;    // 0x0x20
    public string <KJCKMKJALBO>k__BackingField;    // 0x0x28
}
...
{
    public long <AAIDMODMGIF>k__BackingField;    // 0x0x10
    public long? <KAGPFDGEKLK>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public PFHNGCLDOKP FilterType;    // 0x0x20
...
{
    public IMJJPBJDHEF <BIEGMIOHHBN>k__BackingField;    // 0x0x10
    public string <NMLEFFNNHLF>k__BackingField;    // 0x0x18
    public int <DHHGINNHFPG>k__BackingField;    // 0x0x20
    public int <GNGMGADNIAD>k__BackingField;    // 0x0x24
}
...
{
    public int <LLIDIOOCJLN>k__BackingField;    // 0x0x10
    public Guid <LLGEFHGCCHG>k__BackingField;    // 0x0x14
    public DateTime <JEIJOFENALF>k__BackingField;    // 0x0x28
}
...
{
    public bool <IEMFFBFNLOG>k__BackingField;    // 0x0x10
    public int <CPGPMLEDBHE>k__BackingField;    // 0x0x14
}
...
{
    public Guid <LLGEFHGCCHG>k__BackingField;    // 0x0x10
    public IMJJPBJDHEF <EOEHFGIMNCD>k__BackingField;    // 0x0x20
    public int <NFKCBJIBMNG>k__BackingField;    // 0x0x24
    public long <EHHNEHMCHBP>k__BackingField;    // 0x0x28
    public long? <DLIBIEOMDMG>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes/events/{hLAHJLOGDFH}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <BIDDPDGBLFK>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <JIMHEJDNACC>k__BackingField;    // 0x0x18
}
...
{
    public long <ABAJBDMPDJK>k__BackingField;    // 0x0x10
    public long <EHHNEHMCHBP>k__BackingField;    // 0x0x18
    public long <GPEMFJENHHB>k__BackingField;    // 0x0x20
    public IIPKOGHPJIG <IHBGJKCFBOD>k__BackingField;    // 0x0x28
    public int <DPDLCEJLFMP>k__BackingField;    // 0x0x2C
}
...
{
    public long <EHHNEHMCHBP>k__BackingField;    // 0x0x10
    public List<Guid> <DPKAGNOCMKE>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <BIDDPDGBLFK>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <JIMHEJDNACC>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <OJKOEJLDMHH>k__BackingField;    // 0x0x20
}
...
{
    public long <GPEMFJENHHB>k__BackingField;    // 0x0x10
    public long <ABCPAKDEGCC>k__BackingField;    // 0x0x18
    public int? <LAMKCFLOMNG>k__BackingField;    // 0x0x20
    public int? <IIMKEEHFAEN>k__BackingField;    // 0x0x28
    public long? <ICMEAMPMJMP>k__BackingField;    // 0x0x30
    public long <AGLNHJJDLCH>k__BackingField;    // 0x0x40
    public long <HIEHEEKKJLF>k__BackingField;    // 0x0x48
    public int <DJGOBJLLOOC>k__BackingField;    // 0x0x50
    public IIPKOGHPJIG <NNMGIJLKGBM>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <ONMGIJMBNIG>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public LFMFOCNKBFD <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public MGNCKAKNOCA creatorAccountRole;    // 0x0x58
}
...
{
    public FMLIIMPKLJN <GOLLBEBDCGF>k__BackingField;    // 0x0x10
    public HHJCJMBJKJF <NDHEABBJJGO>k__BackingField;    // 0x0x14
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x18
    public string <BIIMNBAFPMD>k__BackingField;    // 0x0x20
    public bool <FEGNJLCEBJN>k__BackingField;    // 0x0x28
}
...
{
    public List<FMLIIMPKLJN> <JDGOHGLAECE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents/event/{dGLGKBJFOLN}   [Service.API]
public class ProgressionEventDTO
{
    public long <ABCPAKDEGCC>k__BackingField;    // 0x0x10
    public string <EMINEMLEFBG>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <ADGFOBLBFBP>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <BLDLNBCFKDF>k__BackingField;    // 0x0x28
    public DateTime <JMCHFGEFIPP>k__BackingField;    // 0x0x30
    public DateTime <OLAMJGFCKFD>k__BackingField;    // 0x0x38
    public DateTime <HBKMBIJAPFL>k__BackingField;    // 0x0x40
    public bool <OBKJAJKLFGM>k__BackingField;    // 0x0x48
    public int <JHLPJNPKLAK>k__BackingField;    // 0x0x4C
    public float <LGNKDHCALGN>k__BackingField;    // 0x0x50
    public Guid? <COFNOOFOFJO>k__BackingField;    // 0x0x54
    public string <OKENJBLMECG>k__BackingField;    // 0x0x68
    public string <DMGEJMLFLME>k__BackingField;    // 0x0x70
    public string <DOILHJLIKJH>k__BackingField;    // 0x0x78
    public string <HFGICDPKPPL>k__BackingField;    // 0x0x80
}
...
{
    public Guid <DNNJJAADJCL>k__BackingField;    // 0x0x10
    public int <BGCENOFFLEJ>k__BackingField;    // 0x0x20
    public int <OOCJBGHKAFL>k__BackingField;    // 0x0x24
    public long <CCFMMOJFEGF>k__BackingField;    // 0x0x28
    public long <NBMKEDBKEKH>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE GET    api/progressionEvents/record/{dGLGKBJFOLN}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <LLIDIOOCJLN>k__BackingField;    // 0x0x10
    public int <DOPOPJOPLCE>k__BackingField;    // 0x0x14
    public int <JNJNJHCPFMO>k__BackingField;    // 0x0x18
    public int <GEJGABJKPKM>k__BackingField;    // 0x0x1C
    public int <CDFAHAOCFFK>k__BackingField;    // 0x0x20
    public DateTime? <ADDLMKMEBLA>k__BackingField;    // 0x0x28
}
...
{
    public long <MHHNFFJDILC>k__BackingField;    // 0x0x10
    public int <JGLJGKHBDJJ>k__BackingField;    // 0x0x18
    public string <BBKLDHLLFID>k__BackingField;    // 0x0x20
    public int <DOPOPJOPLCE>k__BackingField;    // 0x0x28
    public int <JOGPEFIFLMJ>k__BackingField;    // 0x0x2C
    public bool <PMHIMGIPIHL>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public MEDAMCPNJBL ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool AKCKLPCPDJE;    // 0x0x28
}
...
{
    public GEOLGBMAGKG? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public GEOLGBMAGKG KIMMOOPPHKL;  // wrapper
...
{
    public GGEPLIONNAG NHNAGMFNPAP;  // wrapper
...
{
    public LAOELGJNHCI NFMPIOLJBMO;  // wrapper
    public int? AIIJAFCPGLL;  // wrapper
...
{
    public AEJPAPMHGFE UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public LFMFOCNKBFD ABFHDOGCMDC;  // wrapper
    public LFMFOCNKBFD? MOGJIBBDICG;  // wrapper
...
{
    public FKCBLPALOJO OEGHPCFKCKB;  // wrapper
...
{
    public MJCJCPPFOGF CADFBDDMDPJ;  // wrapper
...
{
    public AFKJEBEDDEP GEKKOHEOIPA;  // wrapper
    public byte[] KNCPNAEJFKO;  // wrapper
    public byte[] HCGBNGKMBMA;  // wrapper
    public Color FDMANEGJPBO;  // wrapper
...
{
    public List<HBLEPHAAOOD> CFFGELEMBGF;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public GLDFPBHKPIJ CPMLDGKENHF;  // wrapper
    public LFMFOCNKBFD? BFLDAHBPGHB;  // wrapper
...
{
    public DJPIFBMCIDE EIGHOCBFOHE;  // wrapper
...
{
    public StatusResponse> MLFGBBGKHEO;  // wrapper
...
// api/keepsakes/{mOFMFKKIPEO}/collect  [API POST]
public class KeepsakesMOFMFKKIPEOCollectRequest
{
    public Guid MOFMFKKIPEO;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> GIPKGBKOFHG;  // wrapper
    public POPAHLOLKGF LCLDKKNBOLG;  // wrapper
    public long? NHLFHKNMPKF;  // wrapper
    public GJIGJFINLFE MLFGBBGKHEO;  // wrapper
...
{
    public String> MLFGBBGKHEO;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{iGOJJFNLCAL}  [API POST]
public class PlayereventsV2DeleteIGOJJFNLCALRequest
{
    public DGECOMICBKJ IGOJJFNLCAL;  // wrapper
}
...
{
    public DGECOMICBKJ IGOJJFNLCAL;  // wrapper
    public FGBOCPCEBCC ONJGHHHPPJG;  // wrapper
...
{
    public DGECOMICBKJ IGOJJFNLCAL;  // wrapper
    public long? FADKIKCBJEF;  // wrapper
    public object clubId;  // candidate
}
...
{
    public DGECOMICBKJ IGOJJFNLCAL;  // wrapper
    public LFDEPAIDPCL PFECFNNOKCC;  // wrapper
    public LFDEPAIDPCL DBOKHBMKCFI;  // wrapper
...
{
    public DGECOMICBKJ IGOJJFNLCAL;  // wrapper
    public long? HCDNMCFPFJH;  // wrapper
...
{
    public DGECOMICBKJ IGOJJFNLCAL;  // wrapper
    public List<string> JMIBDECJPFF;  // wrapper
}
...
{
    public DGECOMICBKJ IGOJJFNLCAL;  // wrapper
    public DateTime LPNGFHFMDDN;  // wrapper
    public DateTime KKIJCKLPIHN;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> INOCFKIFMHI;  // wrapper
...
{
    public Guid? MHPJCOLOHMP;  // wrapper
...
{
    public IReadOnlyList<NEGBANCLJOF> AKDAPKFNOLN;  // wrapper
}
...
{
    public MatchCompleteStats MMMNACPAPLN;  // wrapper
}
...
{
    public Guid PMAKLJMJGGE;  // wrapper
...
{
    public Guid DAOFKLFMMOM;  // wrapper
}
...
{
    public CDDPHFNIOAO EFBDKDJBNIN;  // wrapper
}
