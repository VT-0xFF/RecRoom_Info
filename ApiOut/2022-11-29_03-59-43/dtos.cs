...
public class AAEAMPNFEOL
{
    public List<EEICNGMEIEJ> <FDEGIEPCMPG>k__BackingField;    // 0x0x10
    public string <EOIMNNPJKLL>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// AFBENJPIGHD
//   RESPONSE GET    api/groups/v1/memberships/{dEPHGHGHIPL}   [Service.API]
public class AFBENJPIGHD
{
    public long <PNOHCLGLMHA>k__BackingField;    // 0x0x10
    public int <HJONOLPIFCD>k__BackingField;    // 0x0x18
    public FHKPOPPEPIB <FNIIFNNFOCP>k__BackingField;    // 0x0x1C
}
...
// AIIABLFMIFD
//   (not directly referenced by a detected call)
public class AIIABLFMIFD
{
    public bool <HFCOJKMENFG>k__BackingField;    // 0x0x10
    public HJNOODNNDGF <BAKFBPAJCJO>k__BackingField;    // 0x0x14
    public int <CMNEKCAAIOP>k__BackingField;    // 0x0x18
    public DateTime <ANMIILEDNNN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AMFMCPELBKP
// base   : OFNNIEMLIIH<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class AMFMCPELBKP
{
...
public class APINBFCKEHN
{
    public Dictionary<int, int> <KGDLBPOFIFO>k__BackingField;    // 0x0x10
    public List<LMIPKEGFFGH> <JKPIDNCCJNJ>k__BackingField;    // 0x0x18
    public KEDOHNHDNBP[][] <LIEBPCECNFB>k__BackingField;    // 0x0x20
    public GHFNCALOMJH <JPJEDOHGHOC>k__BackingField;    // 0x0x28
    public LNHJIDOFBBM <INGBGKHKOCL>k__BackingField;    // 0x0x30
    public BFGMANPKEAC <CHNKOAJDION>k__BackingField;    // 0x0x38
    public LMHNILELCHF <LFFJEDFKMEE>k__BackingField;    // 0x0x40
    public OLBGBJPAGFM <IFFPODKBHEP>k__BackingField;    // 0x0x48
    public string <JGHCLFJKFJG>k__BackingField;    // 0x0x50
}
...
// BEHEGCEDCMJ
//   (not directly referenced by a detected call)
public class BEHEGCEDCMJ
{
    public int <AEKHFELMBKI>k__BackingField;    // 0x0x10
    public AHCILNFKJPL <OGBBCGKLGLE>k__BackingField;    // 0x0x14
    public List<EBNFJGFBPGF> <PGJGPIPKMDB>k__BackingField;    // 0x0x18
    public List<EBNFJGFBPGF> <NPPIFCGJGFI>k__BackingField;    // 0x0x20
    public bool <FADOIKEDJEB>k__BackingField;    // 0x0x28
    public DateTime? <EAAHLMKENJN>k__BackingField;    // 0x0x30
    public DateTime? <GHPFGCLGLIJ>k__BackingField;    // 0x0x40
    public DateTime? <GCJOOOBKHOD>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// BFGMANPKEAC
//   (not directly referenced by a detected call)
public class BFGMANPKEAC
{
    public int <NJMPBNHDCEP>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{dFLCPKILJNF}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{dFLCPKILJNF}   [Service.API]
...
public class BKEHDFHFLNG
{
    public FFEJABHKEDK <EGLOPHFFLBB>k__BackingField;    // 0x0x10
    public JPDGLNBPDPA <LCCKEIMGOFI>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/avatar/v2/{dKMNGHALNGE}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{dKMNGHALNGE}   [Service.API]
public class BKIPBJAMGBD
{
    public string <OBEEMHECMEP>k__BackingField;    // 0x0x10
    public string <JPGBKJBIOCL>k__BackingField;    // 0x0x18
    public string <DFOCJFHMNDO>k__BackingField;    // 0x0x20
    public string <GDMINKKHMLJ>k__BackingField;    // 0x0x28
    public string <NIJIBKGCKMJ>k__BackingField;    // 0x0x30
    public List<KHNGPCENKHH> <EPLNNHIKIOD>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// BNDKPFJHMMD
//   (not directly referenced by a detected call)
public class BNDKPFJHMMD
{
    public int <HEPOBFAKIID>k__BackingField;    // 0x0x10
    public string <NKMHCKCPBEK>k__BackingField;    // 0x0x18
    public string <KMKHBLDIJDJ>k__BackingField;    // 0x0x20
    public string <GIMIIOGPIKH>k__BackingField;    // 0x0x28
    public string <BNMKBCDCJLB>k__BackingField;    // 0x0x30
    public string <PLMDMLCDGLO>k__BackingField;    // 0x0x38
    public HNMOHBEMEOB? <LIFOLBFHOKG>k__BackingField;    // 0x0x40
    public string <CIBPJIBLIJL>k__BackingField;    // 0x0x48
    public string <ODEOAOHJCAE>k__BackingField;    // 0x0x50
    public bool <HEKDENKBLIJ>k__BackingField;    // 0x0x58
    public bool <LPIFKMFEOKL>k__BackingField;    // 0x0x59
    public bool <FFHEDMIFDLC>k__BackingField;    // 0x0x5A
    public IFCHLMJAPBA <EFCGMKNNEGE>k__BackingField;    // 0x0x5C
    public int <DNIBKCGGFOJ>k__BackingField;    // 0x0x60
    public EEDPHHMNAJJ <CJCAPOKNOJN>k__BackingField;    // 0x0x64
    public int <PEDHNENLKNE>k__BackingField;    // 0x0x68
    public DIOBBBLJDBF <CPBNBFIDPLD>k__BackingField;    // 0x0x6C
    public DBMHGJHJDJN <LPEAOEPAAAK>k__BackingField;    // 0x0x70
    public int? <ECAGOALDMNN>k__BackingField;    // 0x0x74
    public string <BMBNKDCNKMG>k__BackingField;    // 0x0x80
}
...
public class CCMHEKMMCFF
{
    public HLDOKMHGAJI <NHFBPAHCBMN>k__BackingField;    // 0x0x10
}
...
// CIBICEKFPEO
//   (not directly referenced by a detected call)
public class CIBICEKFPEO
{
    public Guid <HHDFFPFFBEL>k__BackingField;    // 0x0x10
    public Guid <HJNKKMDMPFG>k__BackingField;    // 0x0x20
    public DateTime <HIKEEIHIENL>k__BackingField;    // 0x0x30
    public List<BNDKPFJHMMD> <PGHLIPNOMFA>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// CIHPBGOHGFC
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.API]
public class CIHPBGOHGFC
{
    public Guid? <GEMAAEFPJOL>k__BackingField;    // 0x0x10
    public long? <BHKJEBNPIKH>k__BackingField;    // 0x0x28
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x38
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x40
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x48
    public HLDOKMHGAJI <NHFBPAHCBMN>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// CLCANHKIIHG
//   (not directly referenced by a detected call)
public class CLCANHKIIHG
{
    public long <HEPOBFAKIID>k__BackingField;    // 0x0x10
    public string <BNMKBCDCJLB>k__BackingField;    // 0x0x18
    public string <BJJONNJJGHK>k__BackingField;    // 0x0x20
    public HNMOHBEMEOB? <LIFOLBFHOKG>k__BackingField;    // 0x0x28
    public string <CIBPJIBLIJL>k__BackingField;    // 0x0x30
    public string <ODEOAOHJCAE>k__BackingField;    // 0x0x38
    public BBGHIBFOJLB <MCPLOHEAABP>k__BackingField;    // 0x0x40
    public int <JHGLLANHJIC>k__BackingField;    // 0x0x44
    public int <LLAPPIFNMLJ>k__BackingField;    // 0x0x48
    public DBMHGJHJDJN? <FDMEBADFPIL>k__BackingField;    // 0x0x4C
    public IFCHLMJAPBA? <MHMEMIANMMK>k__BackingField;    // 0x0x54
}
...
public class CPGGDEKCJCP
{
    public Guid? <DBCGGDBIBJA>k__BackingField;    // 0x0x10
    public Guid <EIBHBCNCIOI>k__BackingField;    // 0x0x24
}
...
public class DELPKOBJACE
{
    public EEDPHHMNAJJ <CJCAPOKNOJN>k__BackingField;    // 0x0x10
    public LGMPJFNBPPK <NAJFDPGJFJH>k__BackingField;    // 0x0x14
    public int <DOGHCHPMHBP>k__BackingField;    // 0x0x18
    public int <CFOEIGAECFH>k__BackingField;    // 0x0x1C
    public int <BFFOLHLNICL>k__BackingField;    // 0x0x20
    public PEOAEPOPMFA <BHKNCKEOKAG>k__BackingField;    // 0x0x24
    public bool <JAJBIEJHJCP>k__BackingField;    // 0x0x28
    public float <GEEBHJIKLJC>k__BackingField;    // 0x0x2C
    public int <PGPNAFMMPPG>k__BackingField;    // 0x0x30
    public bool <GCPOEMFFOPD>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// DGIFBPDFPAC
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class DGIFBPDFPAC
{
    public HONHIJBODHI <KGKANIAFLCL>k__BackingField;    // 0x0x10
    public long <MCNEBCJOIMM>k__BackingField;    // 0x0x18
    public string <LGKIJHGNJOF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DHIPFMDGAMG
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class DHIPFMDGAMG
{
    public HONHIJBODHI <KGKANIAFLCL>k__BackingField;    // 0x0x10
    public int <EBOHBDALEDF>k__BackingField;    // 0x0x14
    public long <GOEPBABODKK>k__BackingField;    // 0x0x18
    public bool <IIMINFCFEOC>k__BackingField;    // 0x0x20
    public string <IHJJKADFFND>k__BackingField;    // 0x0x28
    public int? <BCJGCHGGCFL>k__BackingField;    // 0x0x30
    public bool <HFFLKAPBIFH>k__BackingField;    // 0x0x38
    public bool <KHANHIIOEBE>k__BackingField;    // 0x0x39
    public bool <LFKJDCFAMNN>k__BackingField;    // 0x0x3A
    public string <MDIBNLNNNCB>k__BackingField;    // 0x0x40
    public DateTime? <DDBDFMOOGCP>k__BackingField;    // 0x0x48
    public float <DHCFLKCJJBC>k__BackingField;    // 0x0x58
}
...
public class DIKOBOFOIHI
{
    public Guid <NBHKHEHDECH>k__BackingField;    // 0x0x10
    public Guid <HGKFAKIHMNB>k__BackingField;    // 0x0x20
    public int <PACKNPBMEPI>k__BackingField;    // 0x0x30
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x38
    public long <CKHOGPPHEPG>k__BackingField;    // 0x0x40
    public long <EKELKCMOKCB>k__BackingField;    // 0x0x48
    public DateTime <ANMIILEDNNN>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// DINJPJCIPNA
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class DINJPJCIPNA
{
    public int <LFJMIPPBHOO>k__BackingField;    // 0x0x10
    public int <EOAGJOPEHEI>k__BackingField;    // 0x0x14
    public float <DGABKIMMKGO>k__BackingField;    // 0x0x18
    public float <NMAFMDALHNI>k__BackingField;    // 0x0x1C
    public bool <LGEAIDBJOLF>k__BackingField;    // 0x0x20
    public bool <GBHIHFGLKME>k__BackingField;    // 0x0x21
    public bool <ECHDDIHIGJH>k__BackingField;    // 0x0x22
}
...
public class DMEDPNIBHJL
{
    public MPANFLMNIMH <EGLOPHFFLBB>k__BackingField;    // 0x0x10
    public JEHPIGPGHNG <CNKKGJMNHHK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DPKCDBKOMOM
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class DPKCDBKOMOM
{
    public List<MIPAMNLJJFC> <IPMIIJCBHPG>k__BackingField;    // 0x0x10
    public FKGKFLMDFCB <ODHGFDELKLP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EABNDDJGMMI
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class EABNDDJGMMI
{
    public int <EBOHBDALEDF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EBNFJGFBPGF
//   (not directly referenced by a detected call)
public class EBNFJGFBPGF
{
    public EEDPHHMNAJJ <CJCAPOKNOJN>k__BackingField;    // 0x0x10
    public int <EKELKCMOKCB>k__BackingField;    // 0x0x14
    public JHHAGJLLLAF <JOFFEKEPLNB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ECOGIOMJKHJ
//   (not directly referenced by a detected call)
public class ECOGIOMJKHJ
{
    public int <CPEKDBNKIIC>k__BackingField;    // 0x0x10
    public int <FAMGMCPBHBD>k__BackingField;    // 0x0x14
    public int <PBBLCCHKHFA>k__BackingField;    // 0x0x18
}
...
// EEICNGMEIEJ
//   (not directly referenced by a detected call)
public class EEICNGMEIEJ
{
    public int <JBOAANDFJLF>k__BackingField;    // 0x0x10
    public DateTime <JAGFFKNGHJM>k__BackingField;    // 0x0x18
    public DateTime? <NDAMJGECJNB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EFCANFNKCIK
//   (not directly referenced by a detected call)
public class EFCANFNKCIK
{
    public bool <HEGFEBMEPNH>k__BackingField;    // 0x0x10
    public BNDKPFJHMMD <FHNDIFHHLAL>k__BackingField;    // 0x0x18
    public float <ADDNNFGICDM>k__BackingField;    // 0x0x20
}
...
public class EFDOAFFJMJF
{
    public long <PNOHCLGLMHA>k__BackingField;    // 0x0x10
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x18
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x20
    public DateTime <JAGFFKNGHJM>k__BackingField;    // 0x0x28
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x30
    public MFMODLECFHK <ODPNFMJNGKL>k__BackingField;    // 0x0x38
    public int <GIAOFHGNFFF>k__BackingField;    // 0x0x3C
    public int <CPDIEGGECGF>k__BackingField;    // 0x0x40
    public List<AFBENJPIGHD> <GBGHENJAELK>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// EJNENFGLMGO
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class EJNENFGLMGO
{
    public Guid <NLBHPLGHBBL>k__BackingField;    // 0x0x10
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x20
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x28
    public DateTime <HIKEEIHIENL>k__BackingField;    // 0x0x30
    public DateTime? <MIJEOLAFKKJ>k__BackingField;    // 0x0x38
    public List<CIBICEKFPEO> <JPKIHJOCGCM>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// ENHFDMENKIP
//   REQUEST  POST   api/players/v4/current/contact   [Service.API]
public class ENHFDMENKIP
{
    public HTTPResponse BEBKNJIBILO;    // 0x0x10
    public int? BCMKIBECNAJ;    // 0x0x18
    public string ENFOIKGGAFJ;    // 0x0x20
    public byte[] PEBLJIJKIEF;    // 0x0x28
    public string PCMFAFGEBDA;    // 0x0x30
}
...
public class FAAHBPAEDPC
{
    public int? <BFEMFEJCDAM>k__BackingField;    // 0x0x10
    public string <BKLCOCCPDLA>k__BackingField;    // 0x0x18
    public string <CBAOIKKCGLB>k__BackingField;    // 0x0x20
}
...
public class FBJLMHNMFJH
{
    public bool <NPLNAFEBEPG>k__BackingField;    // 0x0x10
    public string <CKPMALBEFDP>k__BackingField;    // 0x0x18
    public string <FDFDMIKLFKG>k__BackingField;    // 0x0x20
}
...
public class FGBCBLOOHCJ
{
    public NNDAFDFICMB <EGLOPHFFLBB>k__BackingField;    // 0x0x10
    public KFBBJKDENEH <CMCIJEAPLFE>k__BackingField;    // 0x0x18
    public OECAIMEJPPL <JIOLEFIIJJP>k__BackingField;    // 0x0x20
}
...
public class FNPIGOGDPCH
{
    public MCFMFACCPHN <ODHGFDELKLP>k__BackingField;    // 0x0x10
    public List<string> <PAGOGJOINHF>k__BackingField;    // 0x0x18
}
...
public class FOAPPEJHACD : GNLGKLGCPAP
{
    public GAGHHALNLMC? <OBCCGPIDNDE>k__BackingField;    // 0x0x18
    public NHKDBGNEAEP <OHPMAFAODBI>k__BackingField;    // 0x0x20
}
...
public class GEOKFMIDBEE
{
    public FKGKFLMDFCB <ODHGFDELKLP>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/keepsakes/{iNIMMFPCLGP}   [Service.API]
...
public class GGCMJABLOCB
{
    public bool <NFICAENDFEC>k__BackingField;    // 0x0x10
    public string <FLANONDGAGN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GHFNCALOMJH
//   (not directly referenced by a detected call)
public class GHFNCALOMJH
{
    public int <LCPLCCFPPKK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GHGIONGPGAB
//   (not directly referenced by a detected call)
public class GHGIONGPGAB
{
    public PAOKIBEPPBK <GFONDLODLEO>k__BackingField;    // 0x0x10
    public IPNCNNFJHDF <GNLNGEBNCCD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GKJHHKLIFIL
//   (not directly referenced by a detected call)
public class GKJHHKLIFIL
{
    public DateTime <JAGFFKNGHJM>k__BackingField;    // 0x0x10
    public string <COBGABDMBOM>k__BackingField;    // 0x0x18
}
...
public class GNHJGPMCHMK
{
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x10
}
...
public class GPDPLCLFODL
{
    public List<PAOKIBEPPBK> <OINMCBHNLFD>k__BackingField;    // 0x0x10
    public List<GHGIONGPGAB> <CGHCKKFMPAD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HCHLCHAGMPH
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{gEFKKNNCELK}   [Service.API]
public class HCHLCHAGMPH
{
    public Guid <DJCJMMICGHK>k__BackingField;    // 0x0x10
    public int <IJMDPIOCBIH>k__BackingField;    // 0x0x20
    public int <AEKHFELMBKI>k__BackingField;    // 0x0x24
    public DateTime <JAGFFKNGHJM>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// HCPDGGAPNDC
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{gLGEGPNMJGF}   [Service.API]
public class HCPDGGAPNDC
{
    public string <OJCCACAKIHB>k__BackingField;    // 0x0x10
    public string <CKPMALBEFDP>k__BackingField;    // 0x0x18
    public string <AGIOMMAKION>k__BackingField;    // 0x0x20
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x28
    public string <BKLCOCCPDLA>k__BackingField;    // 0x0x30
    public ADIGAJFNAPL <EGLOPHFFLBB>k__BackingField;    // 0x0x38
    public List<string> <BANIINHHCJM>k__BackingField;    // 0x0x40
    public List<string> <PAGOGJOINHF>k__BackingField;    // 0x0x48
    public string <DIOGOFFILFC>k__BackingField;    // 0x0x50
    public List<GKJHHKLIFIL> <AIICPIMGKAF>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// HDNOEKJLEOK
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class HDNOEKJLEOK
{
    public int <IJMDPIOCBIH>k__BackingField;    // 0x0x10
    public Guid <HGKFAKIHMNB>k__BackingField;    // 0x0x14
    public long <AJIBMPJGHCK>k__BackingField;    // 0x0x28
    public long <IGIGKNFHHFI>k__BackingField;    // 0x0x30
    public DateTime <OFGPKIPDCKH>k__BackingField;    // 0x0x38
}
...
public class HEADOCDDNIC
{
    public int <FCLKPNAPLKB>k__BackingField;    // 0x0x10
    public List<HNNOOEEFNGC> <INMACMHMAHG>k__BackingField;    // 0x0x18
}
...
public class HGNMBCMNHHA
{
    public bool <NFICAENDFEC>k__BackingField;    // 0x0x10
    public string <IHJJKADFFND>k__BackingField;    // 0x0x18
}
...
public class HHJDAEFAPLF
{
    public List<int> <EGDIGMCCGOH>k__BackingField;    // 0x0x10
    public string <EOIMNNPJKLL>k__BackingField;    // 0x0x18
}
...
public class HIGPIEDDMDG
{
    public Guid <HGKFAKIHMNB>k__BackingField;    // 0x0x10
    public long? <BHKJEBNPIKH>k__BackingField;    // 0x0x20
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x30
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x38
    public EEDPHHMNAJJ <CJCAPOKNOJN>k__BackingField;    // 0x0x40
    public long <OHGIAAHNKAG>k__BackingField;    // 0x0x48
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x50
    public DateTime <JAGFFKNGHJM>k__BackingField;    // 0x0x58
    public DateTime <ANMIILEDNNN>k__BackingField;    // 0x0x60
}
...
// HLDOKMHGAJI
//   (not directly referenced by a detected call)
public class HLDOKMHGAJI
{
    public long <EKELKCMOKCB>k__BackingField;    // 0x0x10
    public Guid? <HGKFAKIHMNB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HNNOOEEFNGC
//   (not directly referenced by a detected call)
public class HNNOOEEFNGC
{
    public DateTime? <HPOKIAMJJBG>k__BackingField;    // 0x0x10
    public DateTime? <CDOHELFCEOP>k__BackingField;    // 0x0x20
    public JKPBCIHFMMI <EGLOPHFFLBB>k__BackingField;    // 0x0x30
    public ECOGIOMJKHJ <DFKPNBIELMP>k__BackingField;    // 0x0x38
    public bool <JJGCPOENEOF>k__BackingField;    // 0x0x40
}
...
// base   : BEHEGCEDCMJ
//   (not directly referenced by a detected call)
public class HONINAFLANN : BEHEGCEDCMJ
{
    public BNDKPFJHMMD <FHNDIFHHLAL>k__BackingField;    // 0x0x60
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{hMOGFNMOLJM}   [Service.API]
public class IFPILMLNKOJ
{
    public long <BHKJEBNPIKH>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <GOHLGKOGKCO>k__BackingField;    // 0x0x18
    public OEBDAEPDOPM <LFNNOLENJJK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IFPMDECGKME
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class IFPMDECGKME
{
    public List<NLPIHFNEAHD> <PAGOGJOINHF>k__BackingField;    // 0x0x10
}
...
public class IMANCPPAJCG : ValueType
{
    public int <ELJOBGEAABF>k__BackingField;    // 0x0x0
}
...
public class IOCPBEPJAJF
{
    public int <GCOLKBCGGOE>k__BackingField;    // 0x0x10
    public int? <LGLBCPLJPJL>k__BackingField;    // 0x0x14
    public string <DFELOEPLPLB>k__BackingField;    // 0x0x20
    public string <HCBAGKGKGHI>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// IPFINMPOLOM
//   RESPONSE GET    api/inventions/v1/personaldetails/{bMOIAOGGPGP}   [Service.API]
public class IPFINMPOLOM
{
    public bool <EEGAHJHNFAF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IPNCNNFJHDF
//   (not directly referenced by a detected call)
public class IPNCNNFJHDF
{
    public long <JOAOJNAECLG>k__BackingField;    // 0x0x10
    public long <MCNEBCJOIMM>k__BackingField;    // 0x0x18
    public int <HJONOLPIFCD>k__BackingField;    // 0x0x20
    public DateTime <JAGFFKNGHJM>k__BackingField;    // 0x0x28
    public AMKHMGPFNMK <OGBBCGKLGLE>k__BackingField;    // 0x0x30
}
...
public class JCNKEFDJPCG
{
    public CPGGDEKCJCP <KFIODJLLBDK>k__BackingField;    // 0x0x10
    public HLDOKMHGAJI <FDNECCALBOM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JEHPIGPGHNG
//   (not directly referenced by a detected call)
public class JEHPIGPGHNG
{
    public long <OAKELJAKHIE>k__BackingField;    // 0x0x10
    public Guid <CMFMEBOHCHN>k__BackingField;    // 0x0x18
    public long <BHKJEBNPIKH>k__BackingField;    // 0x0x28
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x30
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x38
    public int <EKELKCMOKCB>k__BackingField;    // 0x0x40
    public Guid? <LDJEDDKECNH>k__BackingField;    // 0x0x44
    public DateTime <JAGFFKNGHJM>k__BackingField;    // 0x0x58
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// JHHAGJLLLAF
//   (not directly referenced by a detected call)
public class JHHAGJLLLAF
{
    public int <EPBANDGBBIJ>k__BackingField;    // 0x0x10
    public DateTime? <FIMLNJAGNNJ>k__BackingField;    // 0x0x18
    public DateTime? <MFJLJILBKEG>k__BackingField;    // 0x0x28
}
...
public class JHHCPFDCJJG
{
    public int <ICOPHCPKMID>k__BackingField;    // 0x0x10
    public BOCEFCKOBOA <OGBBCGKLGLE>k__BackingField;    // 0x0x14
    public LJOCJFOCJLB <AIAGLPADFGN>k__BackingField;    // 0x0x18
    public LJOCJFOCJLB <AFMDIPFBOJA>k__BackingField;    // 0x0x1C
    public LJOCJFOCJLB <DDIDJAJOBON>k__BackingField;    // 0x0x20
}
...
// JPDGLNBPDPA
//   (not directly referenced by a detected call)
public class JPDGLNBPDPA
{
    public Guid <GEMAAEFPJOL>k__BackingField;    // 0x0x10
    public long <BHKJEBNPIKH>k__BackingField;    // 0x0x20
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x28
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x30
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x38
    public long <EKELKCMOKCB>k__BackingField;    // 0x0x40
    public Guid? <LDJEDDKECNH>k__BackingField;    // 0x0x48
    public DateTime <ANMIILEDNNN>k__BackingField;    // 0x0x60
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{mAIHJKPLNEE}   [Service.API]
...
public class KCDPFHCLHBD
{
    public PAOKIBEPPBK <GFONDLODLEO>k__BackingField;    // 0x0x10
    public FKGKFLMDFCB <ODHGFDELKLP>k__BackingField;    // 0x0x18
    public FNPIGOGDPCH <MNCAOIPOIDE>k__BackingField;    // 0x0x20
}
...
public class KCEDDPNPIKN
{
    public FDCGCIGOECN <KGKANIAFLCL>k__BackingField;    // 0x0x10
    public string <LGKIJHGNJOF>k__BackingField;    // 0x0x18
    public int? <GHCDBLPEOJH>k__BackingField;    // 0x0x20
}
...
public class KDIMOHPDKLE
{
    public FFEJABHKEDK <EGLOPHFFLBB>k__BackingField;    // 0x0x10
    public LHEFEJHDFJH <JHMFDMHKJGD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KEDOHNHDNBP
//   (not directly referenced by a detected call)
public class KEDOHNHDNBP
{
    public CLOEFEKHMMP LDJJLAGOIED;    // 0x0x10
    public int MHNNLHMIJHO;    // 0x0x14
}

// --------------------------------------------------------------------------
// KFBBJKDENEH
//   (not directly referenced by a detected call)
public class KFBBJKDENEH
{
    public ObscuredLong <GFCBHNFCDFG>k__BackingField;    // 0x0x10
    public string <CMFMEBOHCHN>k__BackingField;    // 0x0x38
    public ObscuredInt <PCMKHBILELL>k__BackingField;    // 0x0x40
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x58
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x60
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x68
    public int <LAAMPLMNKGL>k__BackingField;    // 0x0x70
    public BBLHOCGLDOG <MIALMDAEDIC>k__BackingField;    // 0x0x74
    public DateTime <ANMIILEDNNN>k__BackingField;    // 0x0x78
    public DateTime <JAGFFKNGHJM>k__BackingField;    // 0x0x80
    public DateTime? <NILKFOKGAED>k__BackingField;    // 0x0x88
    public long? <MOOIEICNHCP>k__BackingField;    // 0x0x98
    public int <DGAFDOIJGGO>k__BackingField;    // 0x0xA8
    public int <PEFFBHAOADM>k__BackingField;    // 0x0xAC
    public int <MNHCMFGMJLJ>k__BackingField;    // 0x0xB0
    public MOFEHJPEKOG <HFGJOCAFOJB>k__BackingField;    // 0x0xB4
    public MOFEHJPEKOG <BFIJICCHBHK>k__BackingField;    // 0x0xB8
    public ObscuredBool <IFFCGHLIIFG>k__BackingField;    // 0x0xBC
    public ObscuredBool <DPJMKELCBAP>k__BackingField;    // 0x0xC8
    public ObscuredBool <NOJPFNJCNCD>k__BackingField;    // 0x0xD4
    public int? <EKELKCMOKCB>k__BackingField;    // 0x0xE0
    public bool <FABDOHLCCFI>k__BackingField;    // 0x0xE8
}

// --------------------------------------------------------------------------
// KHNGPCENKHH
//   (not directly referenced by a detected call)
public class KHNGPCENKHH
{
    public Guid <OIOIJMCLNPC>k__BackingField;    // 0x0x10
    public byte <HHNOLFEBJOI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KJODMAGPFCP
// base   : OFNNIEMLIIH<PCJODELGKBG>
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{nEALLIJEPBM}   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v2/fromCreator/{nEALLIJEPBM}   [Service.API]
public class KJODMAGPFCP
{
    // (no instance fields in the metadata dump)
}
...
// KMHBCCFPCIA
//   (not directly referenced by a detected call)
public class KMHBCCFPCIA
{
    public int <DMFEAHALCNA>k__BackingField;    // 0x0x10
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x18
    public string <DMMCGLAJNDH>k__BackingField;    // 0x0x20
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x28
    public string <KMKHBLDIJDJ>k__BackingField;    // 0x0x30
    public bool <NDNEJENJGFN>k__BackingField;    // 0x0x38
    public int <ODFPHFBBPIB>k__BackingField;    // 0x0x3C
    public CNFGKDGFAHK <NCDLKDCGELN>k__BackingField;    // 0x0x40
    public IONHJJNFJCK DEOEAKJLFID;    // 0x0x48
    public IONHJJNFJCK HBBCBAMIGNB;    // 0x0x50
    public IONHJJNFJCK EGAGCDPACLE;    // 0x0x58
    public NGHNADMMGOM GBJKDIGNGFP;    // 0x0x60
}

// --------------------------------------------------------------------------
// KPMAHHGDHLL
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{gLGEGPNMJGF}   [Service.API]
public class KPMAHHGDHLL
{
    public uint <OJCCACAKIHB>k__BackingField;    // 0x0x10
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x18
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x20
    public DateTime <ONKFCONECLO>k__BackingField;    // 0x0x28
    public DateTime? <GBJADNAHHHH>k__BackingField;    // 0x0x30
    public bool <MGADJCNLLDO>k__BackingField;    // 0x0x40
    public List<HCPDGGAPNDC> <KGDJHMIBHHA>k__BackingField;    // 0x0x48
    public List<string> <PAGOGJOINHF>k__BackingField;    // 0x0x50
    public int <ICNNJNADEJN>k__BackingField;    // 0x0x58
    public int <CBFABHGLLOH>k__BackingField;    // 0x0x5C
    public int <BOHPJJILEMM>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// LBMCFGPGHGI
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class LBMCFGPGHGI
{
    public NHKDBGNEAEP <OHPMAFAODBI>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <NGKAGAEIAHI>k__BackingField;    // 0x0x18
}
...
public class LCOAENOAFME : HMPBINKOHIA
{
    public int <KMPKCOPIFAJ>k__BackingField;    // 0x0x30
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x38
    public DateTime <HIKEEIHIENL>k__BackingField;    // 0x0x40
    public DateTime <IGJOGOKIBOL>k__BackingField;    // 0x0x48
    public EEDPHHMNAJJ <CJCAPOKNOJN>k__BackingField;    // 0x0x50
    public BEHEGCEDCMJ <PMNFDIGMBKB>k__BackingField;    // 0x0x58
    public List<LIHJCAMIPEP> <GOOOOCCPLJH>k__BackingField;    // 0x0x60
    public AIIABLFMIFD <FGJLFGOGDOC>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// LEKCEKOILIL
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.API]
public class LEKCEKOILIL
{
    public int <ELFNDLPLKOM>k__BackingField;    // 0x0x10
    public string <KFIMCNCDHFM>k__BackingField;    // 0x0x18
    public List<KMHBCCFPCIA> <HIHCDCIJCIM>k__BackingField;    // 0x0x20
    public CLCANHKIIHG <OBCKINFNFMF>k__BackingField;    // 0x0x28
    public string <HMDOCPJFMFK>k__BackingField;    // 0x0x30
    public DateTime <HIKEEIHIENL>k__BackingField;    // 0x0x38
    public DateTime <IGJOGOKIBOL>k__BackingField;    // 0x0x40
    public DateTime <IHFOCBIFFCF>k__BackingField;    // 0x0x48
    public bool? <LNMHBAGFHMN>k__BackingField;    // 0x0x50
}
...
// LHEFEJHDFJH
//   (not directly referenced by a detected call)
public class LHEFEJHDFJH
{
    public Guid <GEMAAEFPJOL>k__BackingField;    // 0x0x10
    public int <IJMDPIOCBIH>k__BackingField;    // 0x0x20
    public int <ICKHKBDOJCP>k__BackingField;    // 0x0x24
    public Guid <FGKKBGLINAK>k__BackingField;    // 0x0x28
    public DateTime <ANMIILEDNNN>k__BackingField;    // 0x0x38
    public JPDGLNBPDPA <LCCKEIMGOFI>k__BackingField;    // 0x0x40
}
...
// base   : BEHEGCEDCMJ
//   (not directly referenced by a detected call)
public class LIHJCAMIPEP : BEHEGCEDCMJ
{
    public int <PEKMIHCCBAB>k__BackingField;    // 0x0x60
    public List<EFCANFNKCIK> <NCGKCBFDGCH>k__BackingField;    // 0x0x68
    public List<EFCANFNKCIK> <FJPPKLPPEOM>k__BackingField;    // 0x0x70
    public List<EFCANFNKCIK> <PONOAECGIFL>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// LMHNILELCHF
//   (not directly referenced by a detected call)
public class LMHNILELCHF
{
    public int <DFFBAHGEPGO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LNHJIDOFBBM
//   (not directly referenced by a detected call)
public class LNHJIDOFBBM
{
    public float <MELOOPNKOLK>k__BackingField;    // 0x0x10
    public float <BPCFIKGHCAD>k__BackingField;    // 0x0x14
    public float <JCLJJKHHFEC>k__BackingField;    // 0x0x18
    public float <DNLOOLNGDPG>k__BackingField;    // 0x0x1C
    public float <ADPCDJAFAGI>k__BackingField;    // 0x0x20
    public float <MOBIHKGDLPM>k__BackingField;    // 0x0x24
    public float <BCJJPCOHIPF>k__BackingField;    // 0x0x28
    public float <ONBJDMCJKBB>k__BackingField;    // 0x0x2C
}
...
public class LNILOMNEPBD : HMPBINKOHIA
{
    public List<HONINAFLANN> FFLKMHDHOKI;    // 0x0x30
    public int <LIJCIDFAPIP>k__BackingField;    // 0x0x38
}
...
public class LNPOODNMBCN
{
    public long <BHKJEBNPIKH>k__BackingField;    // 0x0x10
    public long? <GNFNDLCHCJA>k__BackingField;    // 0x0x18
    public long? <EAHOEHOGOOE>k__BackingField;    // 0x0x28
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x38
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x40
    public List<string> <PAGOGJOINHF>k__BackingField;    // 0x0x48
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x50
    public DateTime <BOOOPHKCHLJ>k__BackingField;    // 0x0x58
    public DateTime <LHJNDKJCNPI>k__BackingField;    // 0x0x60
    public FFDMBDINBBJ <MIALMDAEDIC>k__BackingField;    // 0x0x68
    public bool <KJCCJCPPHLF>k__BackingField;    // 0x0x6C
    public bool <PJHOMPLFJBN>k__BackingField;    // 0x0x6D
    public LPADGJIECCB <PKOLEEMOAKG>k__BackingField;    // 0x0x70
    public LPADGJIECCB <PFDJDCFILID>k__BackingField;    // 0x0x74
}
...
public class MCCAGFIJFPI
{
    public long <MCNEBCJOIMM>k__BackingField;    // 0x0x10
    public AMKHMGPFNMK <OGBBCGKLGLE>k__BackingField;    // 0x0x18
}
...
public class MIHGPBCCIJN
{
    public int <EOAGJOPEHEI>k__BackingField;    // 0x0x10
    public bool <LGEAIDBJOLF>k__BackingField;    // 0x0x14
    public DateTime <CODGEAAFKPP>k__BackingField;    // 0x0x18
    public bool <AIOCPPJGEHD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MIPAMNLJJFC
//   (not directly referenced by a detected call)
public class MIPAMNLJJFC
{
    public int <KPHHAFPFNMH>k__BackingField;    // 0x0x10
    public FKGKFLMDFCB <ODHGFDELKLP>k__BackingField;    // 0x0x14
}
...
public class MJKJHDEGKOC
{
    public string <OFEGJJCLGEL>k__BackingField;    // 0x0x10
    public string <BFMIKEMOCDO>k__BackingField;    // 0x0x18
    public bool <GAPPJBGIOAD>k__BackingField;    // 0x0x20
    public string <AICOEGODDLK>k__BackingField;    // 0x0x28
}
...
public class MNIOOAPACCM
{
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x10
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x18
    public int? <EKELKCMOKCB>k__BackingField;    // 0x0x20
    public BBLHOCGLDOG? <MIALMDAEDIC>k__BackingField;    // 0x0x28
}
...
public class MONENBNGFAC : GNLGKLGCPAP
{
    public KAJAFCHHDBB? <OBCCGPIDNDE>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <NGKAGAEIAHI>k__BackingField;    // 0x0x20
}
...
public class NHKDBGNEAEP
{
    public int <IJMDPIOCBIH>k__BackingField;    // 0x0x10
    public Guid <HGKFAKIHMNB>k__BackingField;    // 0x0x14
    public long <AJIBMPJGHCK>k__BackingField;    // 0x0x28
    public DateTime <ANMIILEDNNN>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// NLPIHFNEAHD
//   (not directly referenced by a detected call)
public class NLPIHFNEAHD
{
    public string <DOBAKNEGGNC>k__BackingField;    // 0x0x10
    public CGCGJNGCAIO <OGBBCGKLGLE>k__BackingField;    // 0x0x18
}
...
// OECAIMEJPPL
//   (not directly referenced by a detected call)
public class OECAIMEJPPL
{
    public long <GFCBHNFCDFG>k__BackingField;    // 0x0x10
    public string <CMFMEBOHCHN>k__BackingField;    // 0x0x18
    public int <CNEGDFKIIHI>k__BackingField;    // 0x0x20
    public int <PEGLGKDKGPE>k__BackingField;    // 0x0x24
    public int <NMPGAKCLDMF>k__BackingField;    // 0x0x28
    public int <NBMGPNPLKEH>k__BackingField;    // 0x0x2C
    public int <HDFMJDMCJFA>k__BackingField;    // 0x0x30
    public string <EFIKFEJMIII>k__BackingField;    // 0x0x38
    public string <POMJPIDFBON>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// OLBGBJPAGFM
//   (not directly referenced by a detected call)
public class OLBGBJPAGFM
{
    public float <DLNLGEJNPLO>k__BackingField;    // 0x0x10
}
...
public class OMEOMBJGOMI
{
    public List<string> <GGMOMPNCHBA>k__BackingField;    // 0x0x10
    public List<string> <KJKPNNEAHCI>k__BackingField;    // 0x0x18
    public List<string> <CKCHLPHIGKK>k__BackingField;    // 0x0x20
}
...
public class PAFILCPDLJL
{
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PAOKIBEPPBK
//   (not directly referenced by a detected call)
public class PAOKIBEPPBK
{
    public long <MCNEBCJOIMM>k__BackingField;    // 0x0x10
    public int <PCMKHBILELL>k__BackingField;    // 0x0x18
    public long <BHKJEBNPIKH>k__BackingField;    // 0x0x20
    public long? <GNFNDLCHCJA>k__BackingField;    // 0x0x28
    public long? <EAHOEHOGOOE>k__BackingField;    // 0x0x38
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x48
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x50
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x58
    public DateTime <BOOOPHKCHLJ>k__BackingField;    // 0x0x60
    public DateTime <LHJNDKJCNPI>k__BackingField;    // 0x0x68
    public int <HMBKLLLEGGL>k__BackingField;    // 0x0x70
    public FFDMBDINBBJ <MIALMDAEDIC>k__BackingField;    // 0x0x74
    public bool <KJCCJCPPHLF>k__BackingField;    // 0x0x78
    public bool <PJHOMPLFJBN>k__BackingField;    // 0x0x79
    public LPADGJIECCB <PKOLEEMOAKG>k__BackingField;    // 0x0x7C
    public LPADGJIECCB <PFDJDCFILID>k__BackingField;    // 0x0x80
    public long? <KDOPNHCKJGJ>k__BackingField;    // 0x0x88
}
...
public class PCJODELGKBG
{
    public Guid <OIOIJMCLNPC>k__BackingField;    // 0x0x10
    public int <GCOLKBCGGOE>k__BackingField;    // 0x0x20
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x28
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x30
    public int <EKELKCMOKCB>k__BackingField;    // 0x0x38
    public BBLHOCGLDOG <MIALMDAEDIC>k__BackingField;    // 0x0x3C
    public bool <FADOIKEDJEB>k__BackingField;    // 0x0x40
    public int? <LGLBCPLJPJL>k__BackingField;    // 0x0x44
    public string <HCBAGKGKGHI>k__BackingField;    // 0x0x50
    public string <DFELOEPLPLB>k__BackingField;    // 0x0x58
    public string <JMNJNANEGIP>k__BackingField;    // 0x0x60
    public DateTime <JAGFFKNGHJM>k__BackingField;    // 0x0x68
    public DateTime <ANMIILEDNNN>k__BackingField;    // 0x0x70
}
...
public class PGLBMCGPOJC
{
    public int <MJMGLNLDPJI>k__BackingField;    // 0x0x10
    public int <CMMIKIIIPEO>k__BackingField;    // 0x0x14
    public float <CDMFNELBELC>k__BackingField;    // 0x0x18
    public int <LNPAENPLMCC>k__BackingField;    // 0x0x1C
    public int <EDKHCCHANEG>k__BackingField;    // 0x0x20
    public int <FHFFLOFBMGA>k__BackingField;    // 0x0x24
    public int <JGAMKGDMGPG>k__BackingField;    // 0x0x28
    public string <BEJIKIFFOPC>k__BackingField;    // 0x0x30
    public string <CDEHLLCDCLB>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// PKCPBIIMMKD
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class PKCPBIIMMKD
{
    public int <ODFPHFBBPIB>k__BackingField;    // 0x0x10
    public string <KNHBBDLIHHA>k__BackingField;    // 0x0x18
    public string <OBEEMHECMEP>k__BackingField;    // 0x0x20
    public string <JPGBKJBIOCL>k__BackingField;    // 0x0x28
    public string <DFOCJFHMNDO>k__BackingField;    // 0x0x30
    public string <GDMINKKHMLJ>k__BackingField;    // 0x0x38
    public string <NIJIBKGCKMJ>k__BackingField;    // 0x0x40
    public List<KHNGPCENKHH> <EPLNNHIKIOD>k__BackingField;    // 0x0x48
}
...
public class AddKeepsakeInstanceRequest
{
    public long <BHKJEBNPIKH>k__BackingField;    // 0x0x10
    public long? <GNFNDLCHCJA>k__BackingField;    // 0x0x18
    public PLFIICNMFDK <KOOIHGLOMBO>k__BackingField;    // 0x0x28
}
...
{
    public IFEEIKKICDI <ODHGFDELKLP>k__BackingField;    // 0x0x10
    public string <MJEODDOIMCL>k__BackingField;    // 0x0x18
    public string <GIPCJNCAMNO>k__BackingField;    // 0x0x20
    public string <JOBNCGFGFDP>k__BackingField;    // 0x0x28
}
...
{
    public long <MCNEBCJOIMM>k__BackingField;    // 0x0x10
    public long? <BHJBKLDHLBC>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public LLBKPCBMBBH FilterType;    // 0x0x20
...
{
    public PLFIICNMFDK <BKCMNLGFKCP>k__BackingField;    // 0x0x10
    public string <HFOHDDDAAGA>k__BackingField;    // 0x0x18
    public int <ENFCGLPCGLF>k__BackingField;    // 0x0x20
    public int <LHGMIBJHOPL>k__BackingField;    // 0x0x24
}
...
{
    public int <IJMDPIOCBIH>k__BackingField;    // 0x0x10
    public Guid <EAONJGMFOED>k__BackingField;    // 0x0x14
    public DateTime <GMJCHLHOMPG>k__BackingField;    // 0x0x28
}
...
{
    public bool <KCPGEMHJPCM>k__BackingField;    // 0x0x10
    public int <DAMKADCMFAB>k__BackingField;    // 0x0x14
    public bool <CLANAIANFLJ>k__BackingField;    // 0x0x18
}
...
{
    public Guid <EAONJGMFOED>k__BackingField;    // 0x0x10
    public PLFIICNMFDK <PFFLNBIHLBA>k__BackingField;    // 0x0x20
    public int <PHNOCADNAEH>k__BackingField;    // 0x0x24
    public long <BHKJEBNPIKH>k__BackingField;    // 0x0x28
    public long? <GNFNDLCHCJA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes/events/{bJMLBGLDMDL}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <NBJFKALAENF>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <EEAOCIFFEKE>k__BackingField;    // 0x0x18
}
...
{
    public long <DKGNCFBCMKN>k__BackingField;    // 0x0x10
    public long <BHKJEBNPIKH>k__BackingField;    // 0x0x18
    public long <DPKELAJDMPJ>k__BackingField;    // 0x0x20
    public ADDAOAJPEJN <OGBBCGKLGLE>k__BackingField;    // 0x0x28
    public int <PACKNPBMEPI>k__BackingField;    // 0x0x2C
}
...
{
    public long <BHKJEBNPIKH>k__BackingField;    // 0x0x10
    public List<Guid> <BBBEJEAEEFE>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <NBJFKALAENF>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <EEAOCIFFEKE>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <GMBGCIHFFFB>k__BackingField;    // 0x0x20
}
...
{
    public long <DPKELAJDMPJ>k__BackingField;    // 0x0x10
    public long <DFPFEJEHGGG>k__BackingField;    // 0x0x18
    public int? <LFBFFHGLDIA>k__BackingField;    // 0x0x20
    public int? <PBBHFNEAPNK>k__BackingField;    // 0x0x28
    public long? <GPGLILNNMCA>k__BackingField;    // 0x0x30
    public long <OOPCCDKEOHA>k__BackingField;    // 0x0x40
    public long <OCLPDNLKOIL>k__BackingField;    // 0x0x48
    public int <LANNJOGMBLK>k__BackingField;    // 0x0x50
    public ADDAOAJPEJN <OBCLMOKBLNK>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <AELDFFFJAKI>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public DBMHGJHJDJN <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public FDILDHPIMMC creatorAccountRole;    // 0x0x58
}
...
{
    public EJOKKKMIBDJ <LECBDBMJFFO>k__BackingField;    // 0x0x10
    public NDPHLFJBEEE <FBDOIEHEDHH>k__BackingField;    // 0x0x14
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x18
    public string <MCENLOEGNFL>k__BackingField;    // 0x0x20
    public bool <CEIHOCGLCHJ>k__BackingField;    // 0x0x28
}
...
{
    public List<EJOKKKMIBDJ> <JDDEFGJPPOF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents/event/{pAIMFNPBCBD}   [Service.API]
public class ProgressionEventDTO
{
    public long <DFPFEJEHGGG>k__BackingField;    // 0x0x10
    public string <LJFHNBFLMJG>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <PONOAECGIFL>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <IGOCILBMHMG>k__BackingField;    // 0x0x28
    public DateTime <BOOOPHKCHLJ>k__BackingField;    // 0x0x30
    public DateTime <LHJNDKJCNPI>k__BackingField;    // 0x0x38
    public DateTime <FCJHBBACOLG>k__BackingField;    // 0x0x40
    public bool <DCHHAPCLGBP>k__BackingField;    // 0x0x48
    public int <NJPEDNFLKML>k__BackingField;    // 0x0x4C
    public float <PGBNEEIEKDA>k__BackingField;    // 0x0x50
    public Guid? <JDCMAPIHEJI>k__BackingField;    // 0x0x54
    public string <PIHNJNPBDFG>k__BackingField;    // 0x0x68
    public string <CGNNKJOJEFH>k__BackingField;    // 0x0x70
    public string <IBBDDNOLDAM>k__BackingField;    // 0x0x78
    public string <HFBKJGFALGP>k__BackingField;    // 0x0x80
}
...
{
    public Guid <OIMFMCMAONE>k__BackingField;    // 0x0x10
    public int <JPAIKGJMGPP>k__BackingField;    // 0x0x20
    public int <DODFJAKILGP>k__BackingField;    // 0x0x24
    public long <INCLLNEHBEP>k__BackingField;    // 0x0x28
    public long <DGNOLECDGHP>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE GET    api/progressionEvents/record/{pAIMFNPBCBD}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <IJMDPIOCBIH>k__BackingField;    // 0x0x10
    public int <JHGLLANHJIC>k__BackingField;    // 0x0x14
    public int <NINFDCINBDB>k__BackingField;    // 0x0x18
    public int <OHJOECFMMNM>k__BackingField;    // 0x0x1C
    public int <HPAAAOJCIEN>k__BackingField;    // 0x0x20
    public DateTime? <GIAJFGHFNHH>k__BackingField;    // 0x0x28
}
...
{
    public long <NEBHKGGICPF>k__BackingField;    // 0x0x10
    public int <HEPOBFAKIID>k__BackingField;    // 0x0x18
    public string <BJCPINDGJFM>k__BackingField;    // 0x0x20
    public int <JHGLLANHJIC>k__BackingField;    // 0x0x28
    public int <LKJLOBMJHBN>k__BackingField;    // 0x0x2C
    public bool <LJAJJODOAHF>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public LLEDDHDMILC ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool EKNELIBCHCM;    // 0x0x28
}
...
{
    public AAJNOFNJAHM? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public AAJNOFNJAHM ECBLKOFEKEN;  // wrapper
...
{
    public AAFDDHKKBIO DCJLONKPIDI;  // wrapper
...
{
    public BPPAIIIKEAI BIEGICDMJCM;  // wrapper
    public int? LEBABMBMLCE;  // wrapper
...
{
    public FPAKCALHDEF UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public DBMHGJHJDJN EDPENIGJGLF;  // wrapper
    public DBMHGJHJDJN? GJJEELOKOHM;  // wrapper
...
{
    public KMHBCCFPCIA GFJALCPAELN;  // wrapper
...
{
    public HONHIJBODHI NHFJGMLOCPC;  // wrapper
...
{
    public List<HKHHAOMNEFI> IEFHGFPAKIO;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public NLILFMDJLIL NFMKKOMGNHL;  // wrapper
    public DBMHGJHJDJN? IJFLABHGHAD;  // wrapper
...
{
    public MDFMICFADNB PHPHLJEJKOF;  // wrapper
...
{
    public StatusResponse> PKPGAEOFIGD;  // wrapper
...
// api/keepsakes/{iNIMMFPCLGP}/collect  [API POST]
public class KeepsakesINIMMFPCLGPCollectRequest
{
    public Guid INIMMFPCLGP;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> APPHFAIFCLC;  // wrapper
    public IDODNANGLJH CPNPHCDDMAL;  // wrapper
    public long? HMOGFNMOLJM;  // wrapper
    public ICHKIKBDGEA PKPGAEOFIGD;  // wrapper
...
{
    public String> PKPGAEOFIGD;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{mAIHJKPLNEE}  [API POST]
public class PlayereventsV2DeleteMAIHJKPLNEERequest
{
    public PAOKIBEPPBK MAIHJKPLNEE;  // wrapper
}
...
{
    public PAOKIBEPPBK MAIHJKPLNEE;  // wrapper
    public FFDMBDINBBJ BAPGHGHGHIL;  // wrapper
...
{
    public PAOKIBEPPBK MAIHJKPLNEE;  // wrapper
    public long? GEIMNKJDFGL;  // wrapper
    public object clubId;  // candidate
}
...
{
    public PAOKIBEPPBK MAIHJKPLNEE;  // wrapper
    public LPADGJIECCB DEBECHJGAFP;  // wrapper
    public LPADGJIECCB MIELJLHILLB;  // wrapper
...
{
    public PAOKIBEPPBK MAIHJKPLNEE;  // wrapper
    public long? COIDCDPPGMD;  // wrapper
...
{
    public PAOKIBEPPBK MAIHJKPLNEE;  // wrapper
    public List<string> AHDLNLPHFAF;  // wrapper
}
...
{
    public PAOKIBEPPBK MAIHJKPLNEE;  // wrapper
    public DateTime EFFEEHLJGOH;  // wrapper
    public DateTime NKLLMHMJBFE;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> ENIALHNPBKC;  // wrapper
...
{
    public Guid? ODKKDEPBGDA;  // wrapper
...
{
    public IReadOnlyList<AKDJGBHOHBK> JILJPCMNMPO;  // wrapper
}
...
{
    public MatchCompleteStats AABHBLLHPPK;  // wrapper
}
...
{
    public Guid CCCKBHENDBK;  // wrapper
...
{
    public ADIGAJFNAPL HHBKCAFLFKD;  // wrapper
}
