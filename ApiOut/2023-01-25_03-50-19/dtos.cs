...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{fLAFLEEAOBO}   [Service.API]
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/{fLAFLEEAOBO}   [Service.API]
...
public class AIBBADGNEOO
{
    public FOKGDMIAFHM <LNMDAGAJLHO>k__BackingField;    // 0x0x10
    public OFHOFLICDHI <MAAKNHKOHML>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AIIDGNHODBE
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.API]
public class AIIDGNHODBE
{
    public int <CDLPPCJCLHH>k__BackingField;    // 0x0x10
}
...
public class AMMMFAGDJOB
{
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// ANMELDBCGEJ
//   (not directly referenced by a detected call)
public class ANMELDBCGEJ
{
    public float <JMBFEBIPGGK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// ANNDALCEFHA
//   (not directly referenced by a detected call)
public class ANNDALCEFHA
{
    public KEEOKBAOBAB <AFBGOBPOENH>k__BackingField;    // 0x0x10
    public int <CGINKNDKPOK>k__BackingField;    // 0x0x14
    public KEOMLMBJLEF <EOBHLBIJIBM>k__BackingField;    // 0x0x18
}
...
public class APPBPNHPEJK
{
    public Guid? <MIJHIAFFDEO>k__BackingField;    // 0x0x10
    public Guid <MPGBILEKNJF>k__BackingField;    // 0x0x24
}
...
public class BBGFMJGBADP : HHJKJKFDLCJ
{
    public AOGBKCJNHCE? <EHDLKHELPJC>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <HFGCIKIOGLP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BBKCHIAJLPP
//   (not directly referenced by a detected call)
public class BBKCHIAJLPP
{
    public Guid <ELDMMOOOFKH>k__BackingField;    // 0x0x10
    public byte <NMGFFDFFBGE>k__BackingField;    // 0x0x20
}
...
public class BKNOOIGOOJO
{
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BKPPKKFAKCO
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class BKPPKKFAKCO
{
    public LCNBMOLBIKJ <AHCOELMNDCD>k__BackingField;    // 0x0x10
    public int <CDLPPCJCLHH>k__BackingField;    // 0x0x14
    public long <JMGIEMDPHLN>k__BackingField;    // 0x0x18
    public bool <DJDNJIGIOIK>k__BackingField;    // 0x0x20
    public string <PJEMKDGALNN>k__BackingField;    // 0x0x28
    public int? <BKIDIFEELID>k__BackingField;    // 0x0x30
    public bool <NMKJLLECCLE>k__BackingField;    // 0x0x38
    public bool <JJLJGNENFAA>k__BackingField;    // 0x0x39
    public bool <AAGKPKHECDF>k__BackingField;    // 0x0x3A
    public string <LCOGOODFFEH>k__BackingField;    // 0x0x40
    public DateTime? <KMMAHNMJNLM>k__BackingField;    // 0x0x48
    public float <FDOLJNDMMOB>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// BMGDCLLALNG
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.API]
public class BMGDCLLALNG
{
    public int <DJEMGDCKEFB>k__BackingField;    // 0x0x10
    public string <EHHHMODOHIP>k__BackingField;    // 0x0x18
    public string <HMMGMJEJOEL>k__BackingField;    // 0x0x20
    public string <JJHMBHDBENI>k__BackingField;    // 0x0x28
    public string <PPBPNEKOHOG>k__BackingField;    // 0x0x30
    public string <JPAJFDDMBMG>k__BackingField;    // 0x0x38
    public string <MHHKILCMMKO>k__BackingField;    // 0x0x40
    public List<BBKCHIAJLPP> <ALAHKJCCGIE>k__BackingField;    // 0x0x48
}
...
public class CACIMHEJNHM
{
    public long <FKPJIOKPFBD>k__BackingField;    // 0x0x10
    public LGOBALCKNPC <AGDMHNBMAEE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CANPBCNAKEH
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.API]
public class CANPBCNAKEH
{
    public Guid <EPMNCLNKNLK>k__BackingField;    // 0x0x10
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x20
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x28
    public DateTime <ENDDDGAEKAK>k__BackingField;    // 0x0x30
    public DateTime? <LECICIIKNNA>k__BackingField;    // 0x0x38
    public List<NPJBBGFCHBP> <NBGFNGCOJIE>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// CCBMKMIBMMK
//   RESPONSE GET    api/inventions/v1/personaldetails/{bOFINGCHKIO}   [Service.API]
public class CCBMKMIBMMK
{
    public bool <DMNKMNPILFD>k__BackingField;    // 0x0x10
}
...
public class CDBFNFDFNEC
{
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x10
    public string <EANLFKACLIN>k__BackingField;    // 0x0x18
    public int? <CGINKNDKPOK>k__BackingField;    // 0x0x20
    public GFDGOEBBCOA? <AKJFBHBFAOM>k__BackingField;    // 0x0x28
}
...
public class CDGJJGPPBHO
{
    public string <KODPOHGEPGO>k__BackingField;    // 0x0x10
    public string <LPCMNLEKFBO>k__BackingField;    // 0x0x18
    public bool <KHIHIJCAKBO>k__BackingField;    // 0x0x20
    public string <INMCHCKOIIC>k__BackingField;    // 0x0x28
}
...
public class CEDNECFKHEG
{
    public int <OICONAGAHEO>k__BackingField;    // 0x0x10
    public int <ONFDDOONFJI>k__BackingField;    // 0x0x14
    public float <EAOHLFFGBLD>k__BackingField;    // 0x0x18
    public int <APJPIOKCLDD>k__BackingField;    // 0x0x1C
    public int <OGEPEAPOILA>k__BackingField;    // 0x0x20
    public int <PEKENNCKFCC>k__BackingField;    // 0x0x24
    public int <OIIMBLFCLKK>k__BackingField;    // 0x0x28
    public string <JGDMDFFOFAM>k__BackingField;    // 0x0x30
    public string <NAIMOPLBAPD>k__BackingField;    // 0x0x38
}
...
public class CHKDKOLBMON
{
    public int <NIFODELBLBO>k__BackingField;    // 0x0x10
    public List<NJBBAIDCEPE> <LNOCBBODOOE>k__BackingField;    // 0x0x18
}
...
public class CJLMFPBMJEI
{
    public int <PDHPGNEHAMG>k__BackingField;    // 0x0x10
    public Guid <KMGENEFEAPF>k__BackingField;    // 0x0x14
    public long <OFHLLPPBIOG>k__BackingField;    // 0x0x28
    public DateTime <OACGIOJPHBI>k__BackingField;    // 0x0x30
}
...
public class CLFAFLAKBOJ
{
    public HLGIFADFMHL <PABOONNHCOM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CLFFOMDENPE
//   (not directly referenced by a detected call)
public class CLFFOMDENPE
{
    public int <FEKGPJIIELJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CLGBHMHPGLE
//   (not directly referenced by a detected call)
public class CLGBHMHPGLE
{
    public int <OCJPDLGIKCO>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/roomEarningsDistributions/v1/earningsDistribution/{kPBGCMCAECK}   [Service.API]
public class CMOGJIDKLIM
{
    public long <KFLKKPDNOHL>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <LIFFEOKGMDF>k__BackingField;    // 0x0x18
    public PGFHLLDNHOK <CABLFLGCNDC>k__BackingField;    // 0x0x20
}
...
// base   : DCKHKMEGHEJ
//   (not directly referenced by a detected call)
public class DAAPOLMNGFD : DCKHKMEGHEJ
{
    public int <DMNLOFJGAFE>k__BackingField;    // 0x0x60
    public List<HEBIIBLEDAC> <KABNEHNPPFC>k__BackingField;    // 0x0x68
    public List<HEBIIBLEDAC> <FIPAFOPDNBJ>k__BackingField;    // 0x0x70
    public List<HEBIIBLEDAC> <DFIJMCFHEIP>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// DCKHKMEGHEJ
//   (not directly referenced by a detected call)
public class DCKHKMEGHEJ
{
    public int <OKALLPIAHGD>k__BackingField;    // 0x0x10
    public KDEBCNIOEKC <AGDMHNBMAEE>k__BackingField;    // 0x0x14
    public List<ANNDALCEFHA> <GEDEEFLJKDH>k__BackingField;    // 0x0x18
    public List<ANNDALCEFHA> <MMKJMDLMCLI>k__BackingField;    // 0x0x20
    public bool <JBLKFOKPLCM>k__BackingField;    // 0x0x28
    public DateTime? <NGLCPOIMOAK>k__BackingField;    // 0x0x30
    public DateTime? <MCPHHINFCAI>k__BackingField;    // 0x0x40
    public DateTime? <KDDJLEBEKEL>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// DDEKCNLHDHF
//   (not directly referenced by a detected call)
public class DDEKCNLHDHF
{
    public int <OJNIKFOMMAL>k__BackingField;    // 0x0x10
    public DateTime <HINPFLLGFJN>k__BackingField;    // 0x0x18
    public DateTime? <IIPPIPABALC>k__BackingField;    // 0x0x20
}
...
public class DDGGHNKNIEI
{
    public int <BEELENJKONA>k__BackingField;    // 0x0x10
    public int? <KNAGHPCBMCL>k__BackingField;    // 0x0x14
    public string <DFADFFFEPAD>k__BackingField;    // 0x0x20
    public string <MDJMNPACPEF>k__BackingField;    // 0x0x28
}
...
public class DFGCEOIDBNF
{
    public long <MLDANAAKDDM>k__BackingField;    // 0x0x10
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x18
    public string <EANLFKACLIN>k__BackingField;    // 0x0x20
    public DateTime <HINPFLLGFJN>k__BackingField;    // 0x0x28
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x30
    public ALMEMAGCHAB <ADNPMAOGKDA>k__BackingField;    // 0x0x38
    public int <KJBCEGKBPAC>k__BackingField;    // 0x0x3C
    public int <EAKJJPDJLMC>k__BackingField;    // 0x0x40
    public List<LPJAFAFILDB> <JPOBNCODMBC>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// DHMNICNOCNM
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class DHMNICNOCNM
{
    public int? <OKECFOGFDKP>k__BackingField;    // 0x0x10
    public string <HLGEFMGHHPJ>k__BackingField;    // 0x0x18
    public string <BNINIIGPDON>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DJPFCCHJAJB
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/{id1}   [Service.API]
public class DJPFCCHJAJB
{
    public KEEOKBAOBAB <AFBGOBPOENH>k__BackingField;    // 0x0x10
    public NJOJIKFAEKI <AKNMDKCEIFF>k__BackingField;    // 0x0x14
    public int <MKBNJLKHOFP>k__BackingField;    // 0x0x18
    public int <GPJNPMDIDIG>k__BackingField;    // 0x0x1C
    public int <ALHLNDDMOHP>k__BackingField;    // 0x0x20
    public HLCNGIIMKBA <KAANCNCAHFO>k__BackingField;    // 0x0x24
    public bool <AENPELDCJBL>k__BackingField;    // 0x0x28
    public float <GLGKMOCMCFI>k__BackingField;    // 0x0x2C
    public int <FMPIAPNNLCG>k__BackingField;    // 0x0x30
    public bool <PGGJFKNBPGE>k__BackingField;    // 0x0x34
}
...
// EJANLODHBDB
//   (not directly referenced by a detected call)
public class EJANLODHBDB
{
    public string <CLEEAOLEGPM>k__BackingField;    // 0x0x10
    public GHGFCBMLIMG <AGDMHNBMAEE>k__BackingField;    // 0x0x18
}
...
public class EKBPPIAHGDM
{
    public List<string> <ACMOHLAPMOG>k__BackingField;    // 0x0x10
    public List<string> <FNAJMOOBIOK>k__BackingField;    // 0x0x18
    public List<string> <BOAANIFLFFM>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{bIGPCENMNIE}   [Service.API]
...
public class EMNLPIELHOF
{
    public HANJICEAHPJ <JIOMMAHANIA>k__BackingField;    // 0x0x10
    public INLPPKMAOLL <CAPPBADGMGH>k__BackingField;    // 0x0x18
    public MLBGAJDLAKF <JEACCDMEKPO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EPBPPGALDIO
//   (not directly referenced by a detected call)
public class EPBPPGALDIO
{
    public long <LDLIBDJEEOH>k__BackingField;    // 0x0x10
    public Guid <JPAKHANNNPJ>k__BackingField;    // 0x0x18
    public long <KFLKKPDNOHL>k__BackingField;    // 0x0x28
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x30
    public string <EANLFKACLIN>k__BackingField;    // 0x0x38
    public int <CGINKNDKPOK>k__BackingField;    // 0x0x40
    public Guid? <JANPCJMNOJP>k__BackingField;    // 0x0x44
    public DateTime <HINPFLLGFJN>k__BackingField;    // 0x0x58
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x60
}
...
// base   : DCKHKMEGHEJ
//   (not directly referenced by a detected call)
public class FNNLHKKBLLI : DCKHKMEGHEJ
{
    public HJDPDAKNNCN <DCNDDLIJHEP>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// FOEAMKEDEFC
//   (not directly referenced by a detected call)
public class FOEAMKEDEFC
{
    public int <ANKMLMGJGDC>k__BackingField;    // 0x0x10
    public INLPPKMAOLL <CAPPBADGMGH>k__BackingField;    // 0x0x14
}
...
// FPKDFLIAPMI
//   (not directly referenced by a detected call)
public class FPKDFLIAPMI
{
    public ObscuredLong <MNDBIIJPIAN>k__BackingField;    // 0x0x10
    public string <JPAKHANNNPJ>k__BackingField;    // 0x0x38
    public ObscuredInt <NEKAEDPEBCP>k__BackingField;    // 0x0x40
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x58
    public string <EANLFKACLIN>k__BackingField;    // 0x0x60
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x68
    public int <DADMMHIMMOH>k__BackingField;    // 0x0x70
    public GFDGOEBBCOA <AKJFBHBFAOM>k__BackingField;    // 0x0x74
    public DateTime <OACGIOJPHBI>k__BackingField;    // 0x0x78
    public DateTime <HINPFLLGFJN>k__BackingField;    // 0x0x80
    public DateTime? <CFMMNCFGGCP>k__BackingField;    // 0x0x88
    public long? <PMKGJOOAALG>k__BackingField;    // 0x0x98
    public int <LILEDICFLJJ>k__BackingField;    // 0x0xA8
    public int <KMNIDKFNNLI>k__BackingField;    // 0x0xAC
    public int <ENFDKBDCGKP>k__BackingField;    // 0x0xB0
    public OECFJECDJEA <OAAKOEILIFM>k__BackingField;    // 0x0xB4
    public OECFJECDJEA <KKKCHHKFGGL>k__BackingField;    // 0x0xB8
    public ObscuredBool <KMBDOEJMFCE>k__BackingField;    // 0x0xBC
    public ObscuredBool <MFGBDLIEALE>k__BackingField;    // 0x0xC8
    public ObscuredBool <PDIDOKALHKC>k__BackingField;    // 0x0xD4
    public int? <CGINKNDKPOK>k__BackingField;    // 0x0xE0
    public bool <NOILBKDDHPK>k__BackingField;    // 0x0xE8
}
...
public class GBCBBFMJEDP
{
    public IMEAODEBCJM <LNMDAGAJLHO>k__BackingField;    // 0x0x10
    public FPKDFLIAPMI <FHPPEOALIMI>k__BackingField;    // 0x0x18
    public LPLCMKOGGKI <FDLOPLOJELG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GDHCOINFGGL
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.API]
public class GDHCOINFGGL
{
    public Guid? <MOFKKGIJLAD>k__BackingField;    // 0x0x10
    public long? <KFLKKPDNOHL>k__BackingField;    // 0x0x28
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x38
    public string <EANLFKACLIN>k__BackingField;    // 0x0x40
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x48
    public HLGIFADFMHL <PABOONNHCOM>k__BackingField;    // 0x0x50
}
...
public class GEKLONKILBC
{
    public long <KFLKKPDNOHL>k__BackingField;    // 0x0x10
    public long? <IDAFLDKNOHI>k__BackingField;    // 0x0x18
    public long? <BOFANFBOHPG>k__BackingField;    // 0x0x28
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x38
    public string <EANLFKACLIN>k__BackingField;    // 0x0x40
    public List<string> <DICJFBJALAD>k__BackingField;    // 0x0x48
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x50
    public DateTime <KPGNBNBOBPJ>k__BackingField;    // 0x0x58
    public DateTime <EFKJDEBPOMH>k__BackingField;    // 0x0x60
    public EJFJGPENMHO <AKJFBHBFAOM>k__BackingField;    // 0x0x68
    public bool <IJLDLHEPEIL>k__BackingField;    // 0x0x6C
    public bool <PACPPPKGMMI>k__BackingField;    // 0x0x6D
    public JFHMFNCLDDL <KAJHFECGJCK>k__BackingField;    // 0x0x70
    public JFHMFNCLDDL <OFPPOMENHPN>k__BackingField;    // 0x0x74
}
...
public class GIGBHMCNGHG
{
    public KABJHLIOJIE <AHCOELMNDCD>k__BackingField;    // 0x0x10
    public string <KPJLPNKGEEM>k__BackingField;    // 0x0x18
    public int? <BCPNFAFDEHD>k__BackingField;    // 0x0x20
}
...
public class GJEFJOAPGEL
{
    public int <KIKJANOECJF>k__BackingField;    // 0x0x10
    public BJGBDJKDAAL <AGDMHNBMAEE>k__BackingField;    // 0x0x14
    public OEFDIAJNKFE <MIOEODDBILA>k__BackingField;    // 0x0x18
    public OEFDIAJNKFE <IFBGICIHGKJ>k__BackingField;    // 0x0x1C
    public OEFDIAJNKFE <LCDLPNOJMPK>k__BackingField;    // 0x0x20
}
...
public class GKEBOKFPFLE
{
    public string <EANLFKACLIN>k__BackingField;    // 0x0x10
}
...
public class GKOFMEONMNK
{
    public KIMACMPHECK <LNMDAGAJLHO>k__BackingField;    // 0x0x10
    public EPBPPGALDIO <OFBLKNDLDJF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HAEAIHHMHLE
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class HAEAIHHMHLE
{
    public LCNBMOLBIKJ <AHCOELMNDCD>k__BackingField;    // 0x0x10
    public long <FKPJIOKPFBD>k__BackingField;    // 0x0x18
    public string <KPJLPNKGEEM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HANJICEAHPJ
//   (not directly referenced by a detected call)
public class HANJICEAHPJ
{
    public long <FKPJIOKPFBD>k__BackingField;    // 0x0x10
    public int <NEKAEDPEBCP>k__BackingField;    // 0x0x18
    public long <KFLKKPDNOHL>k__BackingField;    // 0x0x20
    public long? <IDAFLDKNOHI>k__BackingField;    // 0x0x28
    public long? <BOFANFBOHPG>k__BackingField;    // 0x0x38
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x48
    public string <EANLFKACLIN>k__BackingField;    // 0x0x50
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x58
    public DateTime <KPGNBNBOBPJ>k__BackingField;    // 0x0x60
    public DateTime <EFKJDEBPOMH>k__BackingField;    // 0x0x68
    public int <DEOLCOBFMHH>k__BackingField;    // 0x0x70
    public EJFJGPENMHO <AKJFBHBFAOM>k__BackingField;    // 0x0x74
    public bool <IJLDLHEPEIL>k__BackingField;    // 0x0x78
    public bool <PACPPPKGMMI>k__BackingField;    // 0x0x79
    public JFHMFNCLDDL <KAJHFECGJCK>k__BackingField;    // 0x0x7C
    public JFHMFNCLDDL <OFPPOMENHPN>k__BackingField;    // 0x0x80
    public long? <MBBAICCIMDA>k__BackingField;    // 0x0x88
}
...
public class HBLPPAHCNBK
{
    public Dictionary<int, int> <NEBAOLHEOBA>k__BackingField;    // 0x0x10
    public List<OBLDHFIHMJC> <CFKHDENNMKA>k__BackingField;    // 0x0x18
    public NBFOLKFIACK[][] <ADIEKDACNHF>k__BackingField;    // 0x0x20
    public CLGBHMHPGLE <DFCOCMLBAAM>k__BackingField;    // 0x0x28
    public POCAKEGJLLL <DHIDBNCMAHO>k__BackingField;    // 0x0x30
    public CLFFOMDENPE <NIDNIBMICEH>k__BackingField;    // 0x0x38
    public PKHGOMICJNE <EEJLHHIFPDD>k__BackingField;    // 0x0x40
    public ANMELDBCGEJ <IAEKBGGPMON>k__BackingField;    // 0x0x48
    public string <EOCHKDJCLCK>k__BackingField;    // 0x0x50
}
...
public class HCDNDHJJIPP
{
    public APPBPNHPEJK <PCDLBMGFHBJ>k__BackingField;    // 0x0x10
    public HLGIFADFMHL <GLPJDDPJFIH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HEBIIBLEDAC
//   (not directly referenced by a detected call)
public class HEBIIBLEDAC
{
    public bool <INPNKLJBFGH>k__BackingField;    // 0x0x10
    public HJDPDAKNNCN <DCNDDLIJHEP>k__BackingField;    // 0x0x18
    public float <FHJLHDMGOFH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HIHJDPDIECK
//   RESPONSE GET    api/testcasemanagement/v1/testcase/{kCHLIHHPAKF}   [Service.API]
public class HIHJDPDIECK
{
    public string <OKLBOJLNMLI>k__BackingField;    // 0x0x10
    public string <PLHEJDBFDGL>k__BackingField;    // 0x0x18
    public string <KOGAHNCCOPF>k__BackingField;    // 0x0x20
    public string <EANLFKACLIN>k__BackingField;    // 0x0x28
    public string <HLGEFMGHHPJ>k__BackingField;    // 0x0x30
    public AMEBFONOPBL <LNMDAGAJLHO>k__BackingField;    // 0x0x38
    public List<string> <IDEFGJPIHFE>k__BackingField;    // 0x0x40
    public List<string> <DICJFBJALAD>k__BackingField;    // 0x0x48
    public string <GHBPDLOGKBD>k__BackingField;    // 0x0x50
    public List<LENEFKHKJEN> <NNJIMMMACJO>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// HJDPDAKNNCN
//   (not directly referenced by a detected call)
public class HJDPDAKNNCN
{
    public int <PDMFFGENHEH>k__BackingField;    // 0x0x10
    public string <CECNLCCEILP>k__BackingField;    // 0x0x18
    public string <CAAMLMECNNK>k__BackingField;    // 0x0x20
    public string <FJILDEONFAJ>k__BackingField;    // 0x0x28
    public string <JONPBENHKBB>k__BackingField;    // 0x0x30
    public string <AJNOPLIMDPK>k__BackingField;    // 0x0x38
    public OCKFEKFHDKG? <AOKBEPFCJNL>k__BackingField;    // 0x0x40
    public string <FBACHDKHEHG>k__BackingField;    // 0x0x48
    public string <BHMBMIAPKCG>k__BackingField;    // 0x0x50
    public bool <JBJMNMAJEPJ>k__BackingField;    // 0x0x58
    public bool <GDGLOJBBGMI>k__BackingField;    // 0x0x59
    public bool <LAJDEGKOAFB>k__BackingField;    // 0x0x5A
    public ABLCJMGBGLO <LOOIDMCAJMP>k__BackingField;    // 0x0x5C
    public int <JDADMFECMBF>k__BackingField;    // 0x0x60
    public KEEOKBAOBAB <AFBGOBPOENH>k__BackingField;    // 0x0x64
    public int <DKKGHDOCGBG>k__BackingField;    // 0x0x68
    public BIPCOPFFCCP <LMKOCGKPIKH>k__BackingField;    // 0x0x6C
    public EKDDOLIMBHN <BDCODODAOCG>k__BackingField;    // 0x0x70
    public int? <JBCAGLHAOKJ>k__BackingField;    // 0x0x74
    public string <MNIJGFMOEMP>k__BackingField;    // 0x0x80
}
...
// HLGIFADFMHL
//   (not directly referenced by a detected call)
public class HLGIFADFMHL
{
    public long <CGINKNDKPOK>k__BackingField;    // 0x0x10
    public Guid? <KMGENEFEAPF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HNBHAGALMFE
//   (not directly referenced by a detected call)
public class HNBHAGALMFE
{
    public bool <JMICINALCJK>k__BackingField;    // 0x0x10
    public EMFJKOFJGIC <OEPEEPBDPJP>k__BackingField;    // 0x0x14
    public int <HBPFEFHCHFP>k__BackingField;    // 0x0x18
    public DateTime <OACGIOJPHBI>k__BackingField;    // 0x0x20
}
...
public class IDBNPKMECCK
{
    public Guid <KMGENEFEAPF>k__BackingField;    // 0x0x10
    public long? <KFLKKPDNOHL>k__BackingField;    // 0x0x20
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x30
    public string <EANLFKACLIN>k__BackingField;    // 0x0x38
    public KEEOKBAOBAB <AFBGOBPOENH>k__BackingField;    // 0x0x40
    public long <GGNHIIJOLAH>k__BackingField;    // 0x0x48
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x50
    public DateTime <HINPFLLGFJN>k__BackingField;    // 0x0x58
    public DateTime <OACGIOJPHBI>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// ILKPLKHKJIC
//   RESPONSE POST   api/roomCurrencies/v2/purchase   [Service.API]
public class ILKPLKHKJIC
{
    public CJLMFPBMJEI <BELJKPCIOJL>k__BackingField;    // 0x0x10
    public BalanceResponseDTO <HFGCIKIOGLP>k__BackingField;    // 0x0x18
}
...
// INMINPHHIEH
//   (not directly referenced by a detected call)
public class INMINPHHIEH
{
    public int <PODGGLIEPKC>k__BackingField;    // 0x0x10
    public int <AFMCCMNFFAB>k__BackingField;    // 0x0x14
    public int <HDPBKBJFHDL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IOONFEMMMEH
//   (not directly referenced by a detected call)
public class IOONFEMMMEH
{
    public HANJICEAHPJ <JIOMMAHANIA>k__BackingField;    // 0x0x10
    public NCINODKKAKE <NILOOEMHNFO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JDKJGPKCNLN
//   REQUEST  POST   api/players/v4/current/contact   [Service.API]
public class JDKJGPKCNLN
{
    public HTTPResponse BDONLCFJJOC;    // 0x0x10
    public int? KLCIOIEHBAN;    // 0x0x18
    public string EDFHIILHLBP;    // 0x0x20
    public byte[] KMKMLOMNDDM;    // 0x0x28
    public string KONEMGMLMCC;    // 0x0x30
}

// --------------------------------------------------------------------------
// JFAJNFFGGMP
//   (not directly referenced by a detected call)
public class JFAJNFFGGMP
{
    public long <PDMFFGENHEH>k__BackingField;    // 0x0x10
    public string <JONPBENHKBB>k__BackingField;    // 0x0x18
    public string <HOPNIAIGFEK>k__BackingField;    // 0x0x20
    public OCKFEKFHDKG? <AOKBEPFCJNL>k__BackingField;    // 0x0x28
    public string <FBACHDKHEHG>k__BackingField;    // 0x0x30
    public string <BHMBMIAPKCG>k__BackingField;    // 0x0x38
    public FKIKKBJPIGH <JJJIHOCAMAK>k__BackingField;    // 0x0x40
    public int <CGENBGEMBPB>k__BackingField;    // 0x0x44
    public int <JPOBCAPBAHN>k__BackingField;    // 0x0x48
    public EKDDOLIMBHN? <AMOHOPHLLMB>k__BackingField;    // 0x0x4C
    public ABLCJMGBGLO? <HFINJMLLDHF>k__BackingField;    // 0x0x54
}
...
public class JFFMHKKBILE
{
    public List<HANJICEAHPJ> <CHKHBCDJJGA>k__BackingField;    // 0x0x10
    public List<IOONFEMMMEH> <NNHDOLNMPAL>k__BackingField;    // 0x0x18
}
...
public class JFGEMDLBCFE
{
    public Guid <JLMOBACLOJA>k__BackingField;    // 0x0x10
    public Guid <KMGENEFEAPF>k__BackingField;    // 0x0x20
    public int <BACLIFBDFOA>k__BackingField;    // 0x0x30
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x38
    public long <DLOEFAKINKE>k__BackingField;    // 0x0x40
    public long <CGINKNDKPOK>k__BackingField;    // 0x0x48
    public DateTime <OACGIOJPHBI>k__BackingField;    // 0x0x50
}
...
public class JIFAJDDELCL
{
    public INLPPKMAOLL <CAPPBADGMGH>k__BackingField;    // 0x0x10
}
...
public class JLHAACCHJEA
{
    public bool <LMCOIEHJNPI>k__BackingField;    // 0x0x10
    public string <PJEMKDGALNN>k__BackingField;    // 0x0x18
}
...
public class JOAIAKGIPGN : ValueType
{
    public int <PMAMFPNNPFH>k__BackingField;    // 0x0x0
}
...
public class KDPFDOOCOCF : GJNIMHGDILJ
{
    public List<FNNLHKKBLLI> KFLBCEAIGGA;    // 0x0x30
    public int <PBOEGGBCMMN>k__BackingField;    // 0x0x38
}
...
// KEOMLMBJLEF
//   (not directly referenced by a detected call)
public class KEOMLMBJLEF
{
    public int <CDEENKKCCPL>k__BackingField;    // 0x0x10
    public DateTime? <HKJCODMKKHE>k__BackingField;    // 0x0x18
    public DateTime? <LAEMJLPCPHH>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// KFOPFPAEFLH
//   RESPONSE POST   api/roomcurrencies/v1/awardCurrency   [Service.API]
public class KFOPFPAEFLH
{
    public int <PDHPGNEHAMG>k__BackingField;    // 0x0x10
    public Guid <KMGENEFEAPF>k__BackingField;    // 0x0x14
    public long <OFHLLPPBIOG>k__BackingField;    // 0x0x28
    public long <LLLJMINDDMB>k__BackingField;    // 0x0x30
    public DateTime <GJILLBDMBKI>k__BackingField;    // 0x0x38
}
...
//   RESPONSE DELETE api/keepsakes/{fBCFPPOECDJ}   [Service.API]
...
public class KIBHFMPGDLE
{
    public bool <LMCOIEHJNPI>k__BackingField;    // 0x0x10
    public string <AECDJJMAJKJ>k__BackingField;    // 0x0x18
}
...
public class KNBHELBFABF
{
    public bool <AGBEFOOOFOC>k__BackingField;    // 0x0x10
    public string <PLHEJDBFDGL>k__BackingField;    // 0x0x18
    public string <CFJOFMKHBNK>k__BackingField;    // 0x0x20
}
...
public class KOODFCIGPHM
{
    public List<int> <ABKHDNPFCEJ>k__BackingField;    // 0x0x10
    public string <FIFOIELMNHF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LBIJCGICKBG
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class LBIJCGICKBG
{
    public List<FOEAMKEDEFC> <EILKDHJJCIN>k__BackingField;    // 0x0x10
    public INLPPKMAOLL <CAPPBADGMGH>k__BackingField;    // 0x0x18
}
...
// LENEFKHKJEN
//   (not directly referenced by a detected call)
public class LENEFKHKJEN
{
    public DateTime <HINPFLLGFJN>k__BackingField;    // 0x0x10
    public string <MGLMMCINFIK>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// LHMPNBPJKJD
// base   : PAIFNMPNFEI<PHBDKOFEBKL>
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{dPKIGCENAFL}   [Service.API]
//   REQUEST  POST   api/customAvatarItems/v2/fromCreator/{dPKIGCENAFL}   [Service.API]
public class LHMPNBPJKJD
{
    // (no instance fields in the metadata dump)
}
...
public class LLJAADLKMPG
{
    public int <JJHIPIOKEEF>k__BackingField;    // 0x0x10
    public string <COPNADJBGMF>k__BackingField;    // 0x0x18
    public List<MIHNCPNEJEM> <JMHJBOKKPEJ>k__BackingField;    // 0x0x20
    public JFAJNFFGGMP <NGIIJPOFDEN>k__BackingField;    // 0x0x28
    public string <PKJHFNNFLPM>k__BackingField;    // 0x0x30
    public DateTime <ENDDDGAEKAK>k__BackingField;    // 0x0x38
    public DateTime <NEKFOOOKLIM>k__BackingField;    // 0x0x40
    public DateTime <MKJCMKFOLCG>k__BackingField;    // 0x0x48
    public bool? <ADFMBCHECKG>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// LMPPBHIEOCA
//   (not directly referenced by a detected call)
public class LMPPBHIEOCA
{
    public Guid <MOFKKGIJLAD>k__BackingField;    // 0x0x10
    public int <PDHPGNEHAMG>k__BackingField;    // 0x0x20
    public int <EPKAKHDNIPO>k__BackingField;    // 0x0x24
    public Guid <AOLEAFEOJDN>k__BackingField;    // 0x0x28
    public DateTime <OACGIOJPHBI>k__BackingField;    // 0x0x38
    public OFHOFLICDHI <MAAKNHKOHML>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// LPJAFAFILDB
//   RESPONSE GET    api/groups/v1/memberships/{iFEILBLHHPO}   [Service.API]
public class LPJAFAFILDB
{
    public long <MLDANAAKDDM>k__BackingField;    // 0x0x10
    public int <IPMCHJGCAFM>k__BackingField;    // 0x0x18
    public ECCKIFIBMKM <PCBOHIHDCNO>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// LPLCMKOGGKI
//   (not directly referenced by a detected call)
public class LPLCMKOGGKI
{
    public long <MNDBIIJPIAN>k__BackingField;    // 0x0x10
    public string <JPAKHANNNPJ>k__BackingField;    // 0x0x18
    public int <DHIENMIKPKE>k__BackingField;    // 0x0x20
    public int <KNEHOPAOKLD>k__BackingField;    // 0x0x24
    public int <BFOIGFCKDPD>k__BackingField;    // 0x0x28
    public int <NONLEDFMBLB>k__BackingField;    // 0x0x2C
    public int <NFPDDEDCBBN>k__BackingField;    // 0x0x30
    public string <OFONBDBPAII>k__BackingField;    // 0x0x38
    public string <IDOGIPCFHKE>k__BackingField;    // 0x0x40
}
...
public class MEOPLGAPCKB : GJNIMHGDILJ
{
    public int <MLLNILHOIMM>k__BackingField;    // 0x0x30
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x38
    public DateTime <ENDDDGAEKAK>k__BackingField;    // 0x0x40
    public DateTime <NEKFOOOKLIM>k__BackingField;    // 0x0x48
    public KEEOKBAOBAB <AFBGOBPOENH>k__BackingField;    // 0x0x50
    public DCKHKMEGHEJ <LNHHKMEJCAG>k__BackingField;    // 0x0x58
    public List<DAAPOLMNGFD> <ENDCBKBGPAM>k__BackingField;    // 0x0x60
    public HNBHAGALMFE <DPODBJOBLLA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// MIHNCPNEJEM
//   (not directly referenced by a detected call)
public class MIHNCPNEJEM
{
    public int <HCGMDOGMOPB>k__BackingField;    // 0x0x10
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x18
    public string <CEAHECKADBO>k__BackingField;    // 0x0x20
    public string <EANLFKACLIN>k__BackingField;    // 0x0x28
    public string <CAAMLMECNNK>k__BackingField;    // 0x0x30
    public bool <FMNKEFGCBCH>k__BackingField;    // 0x0x38
    public int <DJEMGDCKEFB>k__BackingField;    // 0x0x3C
    public LKHPAMIMDHE <FKEIPEELJKN>k__BackingField;    // 0x0x40
    public GJPFOGIPFGH ENHKPPCNPNC;    // 0x0x48
    public GJPFOGIPFGH MBOJDMMCLIM;    // 0x0x50
    public GJPFOGIPFGH NIPOPBDEHCB;    // 0x0x58
    public ADMOBNLOGDB HCPKOHNLCLP;    // 0x0x60
}
...
//   RESPONSE GET    api/avatar/v2/{hPIFBKJNDCC}   [Service.API]
//   REQUEST  POST   api/avatar/v2/{hPIFBKJNDCC}   [Service.API]
public class MKGDEMBKMLL
{
    public string <HMMGMJEJOEL>k__BackingField;    // 0x0x10
    public string <JJHMBHDBENI>k__BackingField;    // 0x0x18
    public string <PPBPNEKOHOG>k__BackingField;    // 0x0x20
    public string <JPAJFDDMBMG>k__BackingField;    // 0x0x28
    public string <MHHKILCMMKO>k__BackingField;    // 0x0x30
    public List<BBKCHIAJLPP> <ALAHKJCCGIE>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// MLBGAJDLAKF
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class MLBGAJDLAKF
{
    public PNCHBHEEKFB <CAPPBADGMGH>k__BackingField;    // 0x0x10
    public List<string> <DICJFBJALAD>k__BackingField;    // 0x0x18
}
...
public class MLMNNOFFNKJ
{
    public int <CGJJECCOIBJ>k__BackingField;    // 0x0x10
    public bool <AJFKGPEDDEE>k__BackingField;    // 0x0x14
    public DateTime <GFJGJPEDPLP>k__BackingField;    // 0x0x18
    public bool <FMJFOKLJDFP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MNDJEFLJKDC
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class MNDJEFLJKDC
{
    public List<EJANLODHBDB> <DICJFBJALAD>k__BackingField;    // 0x0x10
}
...
// NBFOLKFIACK
//   (not directly referenced by a detected call)
public class NBFOLKFIACK
{
    public FKHDCHCNJIE FIJAFEGJPFN;    // 0x0x10
    public int IDDOFOICHGO;    // 0x0x14
}

// --------------------------------------------------------------------------
// NCINODKKAKE
//   (not directly referenced by a detected call)
public class NCINODKKAKE
{
    public long <HGIDMHFKNEJ>k__BackingField;    // 0x0x10
    public long <FKPJIOKPFBD>k__BackingField;    // 0x0x18
    public int <IPMCHJGCAFM>k__BackingField;    // 0x0x20
    public DateTime <HINPFLLGFJN>k__BackingField;    // 0x0x28
    public LGOBALCKNPC <AGDMHNBMAEE>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// NFJEAKKEDCI
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.API]
public class NFJEAKKEDCI
{
    public int <GHJNBLFPIEM>k__BackingField;    // 0x0x10
    public int <CGJJECCOIBJ>k__BackingField;    // 0x0x14
    public float <LLFPEJLJLNO>k__BackingField;    // 0x0x18
    public float <IGCNHHALDII>k__BackingField;    // 0x0x1C
    public bool <AJFKGPEDDEE>k__BackingField;    // 0x0x20
    public bool <EGOLCEKANND>k__BackingField;    // 0x0x21
    public bool <FPDJPEBBBHO>k__BackingField;    // 0x0x22
}
...
public class NGIMCFJMJPF : HHJKJKFDLCJ
{
    public NILENEPEEGJ? <EHDLKHELPJC>k__BackingField;    // 0x0x18
    public CJLMFPBMJEI <BELJKPCIOJL>k__BackingField;    // 0x0x20
}
...
// NJBBAIDCEPE
//   (not directly referenced by a detected call)
public class NJBBAIDCEPE
{
    public DateTime? <NJEKDBKHPHD>k__BackingField;    // 0x0x10
    public DateTime? <IIIKLHIBFIF>k__BackingField;    // 0x0x20
    public FCGDPGNFAKH <LNMDAGAJLHO>k__BackingField;    // 0x0x30
    public INMINPHHIEH <PAEPNCANHIO>k__BackingField;    // 0x0x38
    public bool <ONEIDHFHAAH>k__BackingField;    // 0x0x40
}
...
// --------------------------------------------------------------------------
// NNOOBAMCMPA
//   RESPONSE POST   api/itemWishlists/v1/wishlist/me/{pBMDEGPHILE}   [Service.API]
public class NNOOBAMCMPA
{
    public Guid <MOEFJNAOCFO>k__BackingField;    // 0x0x10
    public int <PDHPGNEHAMG>k__BackingField;    // 0x0x20
    public int <OKALLPIAHGD>k__BackingField;    // 0x0x24
    public DateTime <HINPFLLGFJN>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// NOPDCGBMEDD
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{kCHLIHHPAKF}   [Service.API]
public class NOPDCGBMEDD
{
    public uint <OKLBOJLNMLI>k__BackingField;    // 0x0x10
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x18
    public string <EANLFKACLIN>k__BackingField;    // 0x0x20
    public DateTime <GDDICABANFN>k__BackingField;    // 0x0x28
    public DateTime? <KGGNOAGEHEM>k__BackingField;    // 0x0x30
    public bool <ONGEPOOLLDN>k__BackingField;    // 0x0x40
    public List<HIHJDPDIECK> <LGFAAACBKJM>k__BackingField;    // 0x0x48
    public List<string> <DICJFBJALAD>k__BackingField;    // 0x0x50
    public int <OLLPFELGOEE>k__BackingField;    // 0x0x58
    public int <IIJBCOAIAFJ>k__BackingField;    // 0x0x5C
    public int <GIKEHOIIEAO>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// NPJBBGFCHBP
//   (not directly referenced by a detected call)
public class NPJBBGFCHBP
{
    public Guid <EEBLPLLNDKG>k__BackingField;    // 0x0x10
    public Guid <JEKKIJPLAGP>k__BackingField;    // 0x0x20
    public DateTime <ENDDDGAEKAK>k__BackingField;    // 0x0x30
    public List<HJDPDAKNNCN> <INNOBKECMCB>k__BackingField;    // 0x0x38
}
...
public class OBAOCCFOFEK
{
    public List<DDEKCNLHDHF> <ANPMMAJAOIJ>k__BackingField;    // 0x0x10
    public string <FIFOIELMNHF>k__BackingField;    // 0x0x18
}
...
// OFHOFLICDHI
//   (not directly referenced by a detected call)
public class OFHOFLICDHI
{
    public Guid <MOFKKGIJLAD>k__BackingField;    // 0x0x10
    public long <KFLKKPDNOHL>k__BackingField;    // 0x0x20
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x28
    public string <EANLFKACLIN>k__BackingField;    // 0x0x30
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x38
    public long <CGINKNDKPOK>k__BackingField;    // 0x0x40
    public Guid? <JANPCJMNOJP>k__BackingField;    // 0x0x48
    public DateTime <OACGIOJPHBI>k__BackingField;    // 0x0x60
}
...
public class PBFLAPONACA
{
    public FOKGDMIAFHM <LNMDAGAJLHO>k__BackingField;    // 0x0x10
    public LMPPBHIEOCA <PKMMJDGGPHN>k__BackingField;    // 0x0x18
}
...
public class PHBDKOFEBKL
{
    public Guid <ELDMMOOOFKH>k__BackingField;    // 0x0x10
    public int <BEELENJKONA>k__BackingField;    // 0x0x20
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x28
    public string <EANLFKACLIN>k__BackingField;    // 0x0x30
    public int <CGINKNDKPOK>k__BackingField;    // 0x0x38
    public GFDGOEBBCOA <AKJFBHBFAOM>k__BackingField;    // 0x0x3C
    public bool <JBLKFOKPLCM>k__BackingField;    // 0x0x40
    public int? <KNAGHPCBMCL>k__BackingField;    // 0x0x44
    public string <MDJMNPACPEF>k__BackingField;    // 0x0x50
    public string <DFADFFFEPAD>k__BackingField;    // 0x0x58
    public string <KFBHKHPKMEE>k__BackingField;    // 0x0x60
    public DateTime <HINPFLLGFJN>k__BackingField;    // 0x0x68
    public DateTime <OACGIOJPHBI>k__BackingField;    // 0x0x70
}

// --------------------------------------------------------------------------
// PKHGOMICJNE
//   (not directly referenced by a detected call)
public class PKHGOMICJNE
{
    public int <EMFOFNIKGIE>k__BackingField;    // 0x0x10
}
...
// POCAKEGJLLL
//   (not directly referenced by a detected call)
public class POCAKEGJLLL
{
    public float <LMPAPBJPKJC>k__BackingField;    // 0x0x10
    public float <FJPGKADFFCH>k__BackingField;    // 0x0x14
    public float <BNCMDLEBFBC>k__BackingField;    // 0x0x18
    public float <JMGLOMOCBML>k__BackingField;    // 0x0x1C
    public float <DOIMMJCPJFI>k__BackingField;    // 0x0x20
    public float <KIFLPBILPHO>k__BackingField;    // 0x0x24
    public float <KILHOBIBFCG>k__BackingField;    // 0x0x28
    public float <CGJGDODLCMP>k__BackingField;    // 0x0x2C
}
...
public class AddKeepsakeInstanceRequest
{
    public long <KFLKKPDNOHL>k__BackingField;    // 0x0x10
    public long? <IDAFLDKNOHI>k__BackingField;    // 0x0x18
    public NBDKHFKDKMC <BJJCFDKCBML>k__BackingField;    // 0x0x28
}
...
{
    public FLEKKFLMFOI <CAPPBADGMGH>k__BackingField;    // 0x0x10
    public string <FPMFOIJNPJK>k__BackingField;    // 0x0x18
    public string <HHLIDAJKKAJ>k__BackingField;    // 0x0x20
    public string <PEEAFIGOGPG>k__BackingField;    // 0x0x28
}
...
{
    public long <FKPJIOKPFBD>k__BackingField;    // 0x0x10
    public long? <HDHJGLHFJBG>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public DFFGEHKOKCM FilterType;    // 0x0x20
...
{
    public NBDKHFKDKMC <CGNNIDHCGKA>k__BackingField;    // 0x0x10
    public string <JJLNMKJLMAD>k__BackingField;    // 0x0x18
    public int <OLIOCMMFKGF>k__BackingField;    // 0x0x20
    public int <MFDBDLNFDFE>k__BackingField;    // 0x0x24
}
...
{
    public int <PDHPGNEHAMG>k__BackingField;    // 0x0x10
    public Guid <OFLJGBNGAJD>k__BackingField;    // 0x0x14
    public DateTime <PHCINCICNFN>k__BackingField;    // 0x0x28
}
...
{
    public bool <HKAMLGBLOFE>k__BackingField;    // 0x0x10
    public int <HCOLDONBKPJ>k__BackingField;    // 0x0x14
    public bool <OJCOKAAAGCL>k__BackingField;    // 0x0x18
}
...
{
    public Guid <OFLJGBNGAJD>k__BackingField;    // 0x0x10
    public NBDKHFKDKMC <OKHFELIJJKK>k__BackingField;    // 0x0x20
    public int <OOHKIAJEFEE>k__BackingField;    // 0x0x24
    public long <KFLKKPDNOHL>k__BackingField;    // 0x0x28
    public long? <IDAFLDKNOHI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes/events/{cLJBDGPMMEM}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <GBDPKPHDLFN>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <ODGOHPCKNHJ>k__BackingField;    // 0x0x18
}
...
{
    public long <ILFAPMBINPD>k__BackingField;    // 0x0x10
    public long <KFLKKPDNOHL>k__BackingField;    // 0x0x18
    public long <ILPIBPJPGOK>k__BackingField;    // 0x0x20
    public HDFNENAAOGE <AGDMHNBMAEE>k__BackingField;    // 0x0x28
    public int <BACLIFBDFOA>k__BackingField;    // 0x0x2C
}
...
{
    public long <KFLKKPDNOHL>k__BackingField;    // 0x0x10
    public List<Guid> <NGKDAFPDAOG>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <GBDPKPHDLFN>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <ODGOHPCKNHJ>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <FGJNGCEDNDO>k__BackingField;    // 0x0x20
}
...
{
    public long <ILPIBPJPGOK>k__BackingField;    // 0x0x10
    public long <PPNGGKGPIAF>k__BackingField;    // 0x0x18
    public int? <CKKJKNAPLFO>k__BackingField;    // 0x0x20
    public int? <DKKFCAMKLBO>k__BackingField;    // 0x0x28
    public long? <HMPMHBKHKKA>k__BackingField;    // 0x0x30
    public long <FLLMBBLFKFB>k__BackingField;    // 0x0x40
    public long <LFDHNNAPLPO>k__BackingField;    // 0x0x48
    public int <AGNHHPJBMLH>k__BackingField;    // 0x0x50
    public HDFNENAAOGE <CFIAHLCDDHN>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <DFLPMGCNFCF>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public EKDDOLIMBHN <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public BGLFMDEFGHJ creatorAccountRole;    // 0x0x58
}
...
{
    public DAEGPCIAMDO <DABMLALEKJK>k__BackingField;    // 0x0x10
    public DIMLMLMLLGD <GJFMFPCNGBK>k__BackingField;    // 0x0x14
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x18
    public string <EANLFKACLIN>k__BackingField;    // 0x0x20
    public bool <IFBFOICNOKN>k__BackingField;    // 0x0x28
}
...
{
    public List<DAEGPCIAMDO> <HGJKJOEMFMO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents/event/{cOOPBAPPPMB}   [Service.API]
public class ProgressionEventDTO
{
    public long <PPNGGKGPIAF>k__BackingField;    // 0x0x10
    public string <NBICOBPCFBJ>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <DFIJMCFHEIP>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <CPPHNCBJGFO>k__BackingField;    // 0x0x28
    public DateTime <KPGNBNBOBPJ>k__BackingField;    // 0x0x30
    public DateTime <EFKJDEBPOMH>k__BackingField;    // 0x0x38
    public DateTime <KCJGMNBPHMD>k__BackingField;    // 0x0x40
    public bool <KINCNEBAJMA>k__BackingField;    // 0x0x48
    public int <ICBKGIAPOLB>k__BackingField;    // 0x0x4C
    public float <MFENECLFOHL>k__BackingField;    // 0x0x50
    public Guid? <BNMPGBDIPNN>k__BackingField;    // 0x0x54
    public string <LGNKBDJBJAF>k__BackingField;    // 0x0x68
    public string <EFFBIGMBOGI>k__BackingField;    // 0x0x70
    public string <MGBIIJAEIGM>k__BackingField;    // 0x0x78
    public string <FPMIJBLFHAK>k__BackingField;    // 0x0x80
}
...
{
    public Guid <JNGLFBBJJNF>k__BackingField;    // 0x0x10
    public int <HMHDDMKMCPG>k__BackingField;    // 0x0x20
    public int <LPHGFJBCIMH>k__BackingField;    // 0x0x24
    public long <BJELDHDEMJI>k__BackingField;    // 0x0x28
    public long <KFMMIEKPNKJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE GET    api/progressionEvents/record/{cOOPBAPPPMB}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <PDHPGNEHAMG>k__BackingField;    // 0x0x10
    public int <CGENBGEMBPB>k__BackingField;    // 0x0x14
    public int <IOKAHOACDIJ>k__BackingField;    // 0x0x18
    public int <GLHDNAFKBJP>k__BackingField;    // 0x0x1C
    public int <PEBGOEGPDKM>k__BackingField;    // 0x0x20
    public DateTime? <EJCEDABOGHH>k__BackingField;    // 0x0x28
}
...
{
    public long <KPLKNJOMHJM>k__BackingField;    // 0x0x10
    public int <PDMFFGENHEH>k__BackingField;    // 0x0x18
    public string <EFEDKKCCMCC>k__BackingField;    // 0x0x20
    public int <CGENBGEMBPB>k__BackingField;    // 0x0x28
    public int <MLPPECEJBOD>k__BackingField;    // 0x0x2C
    public bool <EJJCIBOHGNO>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public GLHGPBHKEOB ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool CDMLPCCKEOO;    // 0x0x28
}
...
{
    public IPBDLFKLLHJ? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public IPBDLFKLLHJ IDGALAJGAKI;  // wrapper
...
{
    public EPIKAMAPMAF JEIMILALLIC;  // wrapper
...
{
    public MGNOFCAMLNB IGEIBCJNCHF;  // wrapper
    public int? CDFGNHLEIMO;  // wrapper
...
{
    public OMIHGKMMFBM UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [API POST]
public class AvatarV2GiftsGenerateRequest
{
    public EKDDOLIMBHN KPJEGNGKPOH;  // wrapper
    public EKDDOLIMBHN? BHLFPJAMNNK;  // wrapper
...
{
    public MIHNCPNEJEM KLBMEPLMBDM;  // wrapper
...
{
    public LCNBMOLBIKJ AFHLANOFFOE;  // wrapper
...
{
    public List<LBCFPODIDMK> NABFGPADKHI;  // wrapper
}

// api/gamerewards/v1/request  [API POST]
public class GamerewardsV1RequestRequest
{
    public HIJMGFFHPKP OCDMCNJDNDC;  // wrapper
    public EKDDOLIMBHN? NCBFOOOOPCB;  // wrapper
...
{
    public LCHLJBAKDKN JBBKHGPMCME;  // wrapper
...
{
    public StatusResponse> KDDLOKAHKOL;  // wrapper
...
// api/keepsakes/{fBCFPPOECDJ}/collect  [API POST]
public class KeepsakesFBCFPPOECDJCollectRequest
{
    public Guid FBCFPPOECDJ;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> AFEKIMHCKAA;  // wrapper
    public BOPFGONKBDJ LFMNCHIKPNP;  // wrapper
    public long? KPBGCMCAECK;  // wrapper
    public MCABCIFPDBC KDDLOKAHKOL;  // wrapper
...
{
    public String> KDDLOKAHKOL;  // wrapper
    public object PlayerId;  // candidate
}

// api/playerevents/v2/delete/{bIGPCENMNIE}  [API POST]
public class PlayereventsV2DeleteBIGPCENMNIERequest
{
    public HANJICEAHPJ BIGPCENMNIE;  // wrapper
}
...
{
    public HANJICEAHPJ BIGPCENMNIE;  // wrapper
    public EJFJGPENMHO HLFEGEECIKC;  // wrapper
...
{
    public HANJICEAHPJ BIGPCENMNIE;  // wrapper
    public long? KNDHHLGBFBF;  // wrapper
    public object clubId;  // candidate
}
...
{
    public HANJICEAHPJ BIGPCENMNIE;  // wrapper
    public JFHMFNCLDDL CNIMDDNFHGN;  // wrapper
    public JFHMFNCLDDL HJNAKEPDCEO;  // wrapper
...
{
    public HANJICEAHPJ BIGPCENMNIE;  // wrapper
    public long? BAPPHHJCOAI;  // wrapper
...
{
    public HANJICEAHPJ BIGPCENMNIE;  // wrapper
    public List<string> MNAAGCEHHON;  // wrapper
}
...
{
    public HANJICEAHPJ BIGPCENMNIE;  // wrapper
    public DateTime KLAOIMDLEPG;  // wrapper
    public DateTime LJLBADLABPJ;  // wrapper
...
{
    public IEnumerable<KeyValuePair<string, string>> FHLNMMPFILI;  // wrapper
...
{
    public Guid? KKONJFFNDDD;  // wrapper
...
{
    public IReadOnlyList<FCCIMLHPCJE> BHJKOLNICOJ;  // wrapper
}
...
{
    public MatchCompleteStats HGEGPDCFKOH;  // wrapper
}
...
{
    public Guid FGAOMFAOEAK;  // wrapper
...
{
    public AMEBFONOPBL KLJCGHDCBHC;  // wrapper
}
