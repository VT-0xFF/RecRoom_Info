...
// DTO classes: 252 (plus referenced enums)
...
// --------------------------------------------------------------------------
// AIBBADGNEOO
//   RESPONSE ?      api/roomconsumables   [Service.API]
...
// --------------------------------------------------------------------------
// DJPFCCHJAJB
//   RESPONSE ?      api/storefronts/   [Service.API]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{balanceaddtypeId}/False   [Service.API]
...
// --------------------------------------------------------------------------
// EMNLPIELHOF
//   RESPONSE ?      api/playerevents/   [Service.API]
...
// --------------------------------------------------------------------------
// GEKLONKILBC
//   REQUEST  ?      api/playerevents/   [Service.API]
...
// --------------------------------------------------------------------------
// GKOFMEONMNK
//   RESPONSE ?      api/roomkeys/v1/   [Service.API]
...
//   RESPONSE GET    api/playerevents/v1/all/{hPIFBKJNDCC}   [Service.API]
...
// KIMACMPHECK
// base   : System.Enum
//   RESPONSE ?      api/roomkeys/   [Service.API]
...
// --------------------------------------------------------------------------
// KOODFCIGPHM
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.API]
...
// base   : GJNIMHGDILJ
//   RESPONSE ?      api/storefronts/   [Service.API]
//   RESPONSE GET    api/storefronts/v1/season/{pDGKFHMBCIC}   [Service.API]
...
// --------------------------------------------------------------------------
// MIKIOOPDHBL
// base   : PAIFNMPNFEI<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class MIKIOOPDHBL
{
    // (no instance fields in the metadata dump)
}
...
// --------------------------------------------------------------------------
// MKGDEMBKMLL
//   RESPONSE ?      api/avatar/   [Service.API]
//   RESPONSE GET    api/avatar/v2   [Service.API]
...
// --------------------------------------------------------------------------
// NFJEAKKEDCI
//   REQUEST  POST   api/objectives/v1/completegroup   [Service.API]
...
// --------------------------------------------------------------------------
// OBAOCCFOFEK
//   RESPONSE ?      api/incentivizedreferrals/   [Service.API]
...
public class PlayerReportingV3CreateRequest
{
    ...
    public float? LACCGJOCPGJ;  // wrapper
...
// api/avatar/v1/lockeditems  [API GET]
...
{
    public GFDGOEBBCOA ADOLFCKEBAI;  // wrapper
    public byte[] CMFCMOMHJOO;  // wrapper
    public byte[] HEELANLIDNF;  // wrapper
    public Color OEGNINEOMFI;  // wrapper
...
// api/incentivizedreferrals/  [API GET]
...
{
    public FPKDFLIAPMI inventionId;  // wrapper
}
...
{
    public object includeDetails;  // candidate
    public object clubId;  // candidate
}
...
// api/roomCurrencies/v2/purchase  [API POST]
public class RoomCurrenciesV2PurchaseRequest
{
    public Guid GPMJDAMHJNL;  // wrapper
...
{
    public Guid GONOGGJJKCB;  // wrapper
...
{
    public List<PFBPJKAKOOH> BEHGOILGDFB;  // wrapper
}
...
// api/roomcurrencies/v1/createPurchaseOffer  [API POST]
...
{
    public Guid GONOGGJJKCB;  // wrapper
    public long? JKBADKCAACF;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Limit;  // candidate
...
// api/roomcurrencies/v1/updatePurchaseOffer  [API POST]
public class RoomcurrenciesV1UpdatePurchaseOfferRequest
{
    public Guid GPMJDAMHJNL;  // wrapper
    public long? GHGDJENFKIK;  // wrapper
    public long? LFGAMIAOKIP;  // wrapper
    public int? AGFBKKLEANA;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public LCNBMOLBIKJ AFHLANOFFOE;  // wrapper
    public long? DECAIAGFAHD;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
// api/storefronts/v1/buyPurchaseReminder  [API POST]
...
// api/storefronts/v1/buyRoomKey  [API GET]
...
// api/storefronts/v1/trialInvention  [API POST]
public class StorefrontsV1TrialInventionRequest
{
    public long inventionId;  // wrapper
}

// api/storefronts/v2/buyInvention  [API GET]
