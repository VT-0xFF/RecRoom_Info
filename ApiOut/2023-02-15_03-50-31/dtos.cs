...
public class AKPEFKECMKA
{
    ...
    public FPNBJJEACDL <EMMKBIIOPGH>k__BackingField;    // 0x0x74
    public bool <DOMGMNALKJK>k__BackingField;    // 0x0x78
    public bool <MPEBKGFKPGA>k__BackingField;    // 0x0x79
    public JAIJGHFKCOF <HIADLCHMLGE>k__BackingField;    // 0x0x7C
    public JAIJGHFKCOF <JJKCHECPNNI>k__BackingField;    // 0x0x80
...
public class BMELIAMIOMN
{
    public long <KKFJEACMCCB>k__BackingField;    // 0x0x10
    public EMFKDDKOBHB <JPJEAIJAOBL>k__BackingField;    // 0x0x18
}
...
// DCCFIOAEBDC
//   (not directly referenced by a detected call)
public class DCCFIOAEBDC
{
    public int <DJHMIGNKBFB>k__BackingField;    // 0x0x10
    public HKBAKEGOLHG <NOFOAFGKDAM>k__BackingField;    // 0x0x14
}
...
public class DJDHBBBMPLL
{
    ...
    public string <MLGOOBIMBKG>k__BackingField;    // 0x0x50
    public DateTime <NKHJALGDBKJ>k__BackingField;    // 0x0x58
    public DateTime <NKFIGMDOIEL>k__BackingField;    // 0x0x60
    public FPNBJJEACDL <EMMKBIIOPGH>k__BackingField;    // 0x0x68
    public bool <DOMGMNALKJK>k__BackingField;    // 0x0x6C
    public bool <MPEBKGFKPGA>k__BackingField;    // 0x0x6D
    public JAIJGHFKCOF <HIADLCHMLGE>k__BackingField;    // 0x0x70
    public JAIJGHFKCOF <JJKCHECPNNI>k__BackingField;    // 0x0x74
}
...
public class FAIOEKNLHAN
{
    ...
    public EMFKDDKOBHB <JPJEAIJAOBL>k__BackingField;    // 0x0x30
}
...
// GIKMMJPHALJ
//   (not directly referenced by a detected call)
public class GIKMMJPHALJ
{
    public AKPEFKECMKA <ICGFOEKCBLJ>k__BackingField;    // 0x0x10
    public FAIOEKNLHAN <NLFIEFNBFMO>k__BackingField;    // 0x0x18
}
...
public class LIPIDLDJFBL
{
    public HKBAKEGOLHG <NOFOAFGKDAM>k__BackingField;    // 0x0x10
}
...
public class LLBCMKMPHCC
{
    public List<AKPEFKECMKA> <HHFHHEIHCBI>k__BackingField;    // 0x0x10
    public List<GIKMMJPHALJ> <FHEFMHDAJJH>k__BackingField;    // 0x0x18
}
...
public class LPNKMINMHAB
{
    public JBDEDFIALNL <NDNMLBGMIHB>k__BackingField;    // 0x0x10
    public long <KKFJEACMCCB>k__BackingField;    // 0x0x18
    public string <HONAPBBDLJC>k__BackingField;    // 0x0x20
}
...
public class OIPCDNLINPA
{
    public List<DCCFIOAEBDC> <CJANMIPNACP>k__BackingField;    // 0x0x10
    public HKBAKEGOLHG <NOFOAFGKDAM>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{lOMFHBBICAP}   [Service.API]
...
// api/playerevents/v2/delete/{lOMFHBBICAP}  [API POST]
public class PlayereventsV2DeleteLOMFHBBICAPRequest
{
    public AKPEFKECMKA LOMFHBBICAP;  // wrapper
}
...
{
    public AKPEFKECMKA LOMFHBBICAP;  // wrapper
    public FPNBJJEACDL IOIHKHAPMDH;  // wrapper
    public object accessibility;  // candidate
}
...
{
    public AKPEFKECMKA LOMFHBBICAP;  // wrapper
    public long? KHPHPFGOHDG;  // wrapper
    public object clubId;  // candidate
}
...
{
    public AKPEFKECMKA LOMFHBBICAP;  // wrapper
    public JAIJGHFKCOF NONNPJONPLK;  // wrapper
    public JAIJGHFKCOF LDCEDLPNKBM;  // wrapper
...
{
    public AKPEFKECMKA LOMFHBBICAP;  // wrapper
    public long? EPHFNOAOEMK;  // wrapper
...
{
    public AKPEFKECMKA LOMFHBBICAP;  // wrapper
    public List<string> JMNLHIIIFKO;  // wrapper
}
...
{
    public AKPEFKECMKA LOMFHBBICAP;  // wrapper
    public DateTime MHBFMGFPPGI;  // wrapper
    public DateTime PDPNPNJLGDA;  // wrapper
