...
public class AEDILOEPMFC
{
    public Guid <JFICENDELKH>k__BackingField;    // 0x0x10
    public Guid <IAOBIPLAHIC>k__BackingField;    // 0x0x20
    public DateTime <EIGDOBDKJLI>k__BackingField;    // 0x0x30
    public List<EFFIEFEFHHB> <BNNKAPLCBLI>k__BackingField;    // 0x0x38
}
...
public class AKCLLEJNFFD
{
    public List<string> <IPJFJCOJLHO>k__BackingField;    // 0x0x10
    public List<string> <ADMPEAMIBOO>k__BackingField;    // 0x0x18
    public List<string> <FBFCBIPGAEC>k__BackingField;    // 0x0x20
}
...
public class BDNCJIPHHOK
{
    public CFHBHALNFKC <GBLIFKHPBNE>k__BackingField;    // 0x0x10
    public IFJONDCAKKM <MBANEAGPJEA>k__BackingField;    // 0x0x18
    public PLIKEBBPJGI <MPLIIFNIKOB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BEJIGKIACJM
//   (not directly referenced by a detected call)
public class BEJIGKIACJM
{
    public int <AGBJMIOPPHH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BEPMJICDNDD
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.Econ]
public class BEPMJICDNDD
{
    public int <PCJLNFGGOGD>k__BackingField;    // 0x0x10
    public string <ELFEMPKLGGH>k__BackingField;    // 0x0x18
    public string <HDJOEMFFEIL>k__BackingField;    // 0x0x20
    public string <IALMEDBGNMK>k__BackingField;    // 0x0x28
    public string <KLINMPDPJEK>k__BackingField;    // 0x0x30
    public string <MNKMBOKNOPE>k__BackingField;    // 0x0x38
    public string <FJGMEJCEEDG>k__BackingField;    // 0x0x40
    public List<BGNNOMBFMLH> <OGDPFLFJIFH>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// BFMDFCEEAGL
//   (not directly referenced by a detected call)
public class BFMDFCEEAGL
{
    public long <MFCEMFBCLLO>k__BackingField;    // 0x0x10
    public string <HPNJFAHJAKP>k__BackingField;    // 0x0x18
    public string <LJOCFENMPDI>k__BackingField;    // 0x0x20
    public ONHCNMLCFMN? <COBHFGIOKAB>k__BackingField;    // 0x0x28
    public string <AGGGKNCGELL>k__BackingField;    // 0x0x30
    public string <PONJAOCLMFE>k__BackingField;    // 0x0x38
    public BJGDDFLENAO <KMNPMGEGECM>k__BackingField;    // 0x0x40
    public int <AGKFPBNGOFA>k__BackingField;    // 0x0x44
    public int <LEPBHIEJHKF>k__BackingField;    // 0x0x48
    public IFKEEPDDNBC? <ALDBJAMIILP>k__BackingField;    // 0x0x4C
    public BGDEDNBFOCH? <LPFAHAIHAMH>k__BackingField;    // 0x0x54
}
...
public class BGHBAILNNJJ
{
    public DLDNGEDFMOJ <GBLIFKHPBNE>k__BackingField;    // 0x0x10
    public HOMJKAOHGDG <NBAADJFEANI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BGNNOMBFMLH
//   (not directly referenced by a detected call)
public class BGNNOMBFMLH
{
    public Guid <FFHEPNPPLLO>k__BackingField;    // 0x0x10
    public byte <EPDJKMIDBNJ>k__BackingField;    // 0x0x20
}
...
// BOMJCPNECFG
//   (not directly referenced by a detected call)
public class BOMJCPNECFG
{
    public bool <HGFEMMMDDEM>k__BackingField;    // 0x0x10
    public OFBAIFKAKPG <MCKKGKDGBNO>k__BackingField;    // 0x0x14
    public int <BLBHBEPLIKP>k__BackingField;    // 0x0x18
    public DateTime <CGAIDFBDOEI>k__BackingField;    // 0x0x20
}
...
//   RESPONSE GET    api/inventions/v1/personaldetails/{dANLAFLHDII}   [Service.API]
public class CEAFHBOOBKL
{
    public bool <CJNAANPJAJI>k__BackingField;    // 0x0x10
}
...
public class CEKABGOIOAF
{
    public BNCFHOOCHAI <HLJFMKKADFH>k__BackingField;    // 0x0x10
}
...
public class CFOBCEPBBHA
{
    public Guid? <MFLFPMIADMK>k__BackingField;    // 0x0x10
    public Guid <DCDFDKJMPNK>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// CKFLFJCNEPH
// base   : GJDIKIMLCHA<NOAAFNFJPFB>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{dJLEACOFAPL}   [Service.API]
public class CKFLFJCNEPH
{
    // (no instance fields in the metadata dump)
}
...
// COAGAJPELCG
//   (not directly referenced by a detected call)
public class COAGAJPELCG
{
    public HPIOAGDJHDH <JIIHNPKNJHC>k__BackingField;    // 0x0x10
    public JPIKCIGABBI <HNCJLNFIJLD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// COKFIBNABDP
//   (not directly referenced by a detected call)
public class COKFIBNABDP
{
    public float <LACAOHEICDG>k__BackingField;    // 0x0x10
    public float <FAEMLDLKEMG>k__BackingField;    // 0x0x14
    public float <AONJLCNNDFJ>k__BackingField;    // 0x0x18
    public float <HNCOBAPOAMN>k__BackingField;    // 0x0x1C
    public float <IGDHEIMAMKJ>k__BackingField;    // 0x0x20
    public float <GNLBEJEGJOF>k__BackingField;    // 0x0x24
    public float <EBLHENKAHKJ>k__BackingField;    // 0x0x28
    public float <NEBIIMHLPNM>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// CONDPLKKBPI
//   RESPONSE GET    api/config/v2   [Service.API]
public class CONDPLKKBPI
{
    public Dictionary<int, int> <JLPGOHKIIBD>k__BackingField;    // 0x0x10
    public List<IOOGGIFGEFL> <HIDEHIMINFL>k__BackingField;    // 0x0x18
    public OIMDBINAEGE[][] <OHJEAOFNIMN>k__BackingField;    // 0x0x20
    public KIAPPEFHHLJ <AEPMEGBPBKL>k__BackingField;    // 0x0x28
    public COKFIBNABDP <FEANJPIIDKL>k__BackingField;    // 0x0x30
    public KDFKPJDEKJL <BMPCDOAJGME>k__BackingField;    // 0x0x38
    public BEJIGKIACJM <IIHFBBJFHCE>k__BackingField;    // 0x0x40
    public GAHKFOMDGHN <DBEANKNBIHN>k__BackingField;    // 0x0x48
    public string <KBKOLKCGAIK>k__BackingField;    // 0x0x50
}
...
// DAOCKKLMOBA
//   (not directly referenced by a detected call)
public class DAOCKKLMOBA
{
    public EAFDEJBEFJB <IBLMHANGJDH>k__BackingField;    // 0x0x10
    public int <GEFFJOJJHJE>k__BackingField;    // 0x0x14
    public JCIEDHMBAOH <CLJMPMFOGAG>k__BackingField;    // 0x0x18
}
...
public class DEILBLCDNEA : OKHNOPLBOFP
{
    public GACBLALELBP? <CMLDGCOHJJC>k__BackingField;    // 0x0x18
    public LGAMPMJNGFH <BHKHOJHPDII>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DIPHILPNLAN
//   (not directly referenced by a detected call)
public class DIPHILPNLAN
{
    public int <CHLKGNPDPNM>k__BackingField;    // 0x0x10
    public MDCCOLGHBMN <IOLNEDJDMAI>k__BackingField;    // 0x0x14
    public List<DAOCKKLMOBA> <MFLIPNJBHPH>k__BackingField;    // 0x0x18
    public List<DAOCKKLMOBA> <KNDLHCJMJLD>k__BackingField;    // 0x0x20
    public bool <NPLLGFBGAFC>k__BackingField;    // 0x0x28
    public DateTime? <NJBBFLKJHDG>k__BackingField;    // 0x0x30
    public DateTime? <FCKPDOEDIIL>k__BackingField;    // 0x0x40
    public DateTime? <IFFJIKPKGMK>k__BackingField;    // 0x0x50
}
...
//   RESPONSE DELETE api/keepsakes/{eLLBCGLMDAA}   [Service.API]
...
public class DJMHAFPGLLN
{
    public bool <FDBEOEBDKNM>k__BackingField;    // 0x0x10
    public string <BPJGBOMCKAF>k__BackingField;    // 0x0x18
}
...
public class ECGNEHMCGCN
{
    public int <KKEMEPMIENL>k__BackingField;    // 0x0x10
    public KGFDKIKPIFO <IOLNEDJDMAI>k__BackingField;    // 0x0x14
    public NHGGDOABFLP <EINIHNFLDGK>k__BackingField;    // 0x0x18
    public NHGGDOABFLP <OCAPNCCIKOJ>k__BackingField;    // 0x0x1C
    public NHGGDOABFLP <EOLHBMDELDB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EFFIEFEFHHB
//   (not directly referenced by a detected call)
public class EFFIEFEFHHB
{
    public int <MFCEMFBCLLO>k__BackingField;    // 0x0x10
    public string <KANJKDKPDEO>k__BackingField;    // 0x0x18
    public string <GMNJMDKLJMO>k__BackingField;    // 0x0x20
    public string <KFGDNBJCMDH>k__BackingField;    // 0x0x28
    public string <HPNJFAHJAKP>k__BackingField;    // 0x0x30
    public string <BCBKOJKAOLC>k__BackingField;    // 0x0x38
    public ONHCNMLCFMN? <COBHFGIOKAB>k__BackingField;    // 0x0x40
    public string <AGGGKNCGELL>k__BackingField;    // 0x0x48
    public string <PONJAOCLMFE>k__BackingField;    // 0x0x50
    public bool <GIEIFPGGOOM>k__BackingField;    // 0x0x58
    public bool <PBOKLEHFOGP>k__BackingField;    // 0x0x59
    public bool <EOAJEBHKHBB>k__BackingField;    // 0x0x5A
    public BGDEDNBFOCH <BBAALNDCKIK>k__BackingField;    // 0x0x5C
    public int <DLDHGOKPGJP>k__BackingField;    // 0x0x60
    public EAFDEJBEFJB <IBLMHANGJDH>k__BackingField;    // 0x0x64
    public int <MNMINMBADCB>k__BackingField;    // 0x0x68
    public GFANAHOCPHN <BEODHNKOALP>k__BackingField;    // 0x0x6C
    public IFKEEPDDNBC <EDOKLAOJMBJ>k__BackingField;    // 0x0x70
    public int? <JLIHBFBJDDH>k__BackingField;    // 0x0x74
    public string <GJPNGCJNIMP>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// EIABPHAEFPJ
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{mKEJJPNNCOG}   [Service.API]
public class EIABPHAEFPJ
{
    public uint <IDOGBJCDBOD>k__BackingField;    // 0x0x10
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x18
    public string <DHCODGPNLPM>k__BackingField;    // 0x0x20
    public DateTime <NEOEOLIDKDC>k__BackingField;    // 0x0x28
    public DateTime? <DJEJLFIKAND>k__BackingField;    // 0x0x30
    public bool <KJGMGHKECAA>k__BackingField;    // 0x0x40
    public List<JOKHLOPJBLN> <MGJJIAFFOOI>k__BackingField;    // 0x0x48
    public List<string> <EGHIDMNEPBI>k__BackingField;    // 0x0x50
    public int <GMEAIFMIGGJ>k__BackingField;    // 0x0x58
    public int <GMFICGMDEMC>k__BackingField;    // 0x0x5C
    public int <OGPLBINCPHK>k__BackingField;    // 0x0x60
}
...
public class FDEGPICBIHO
{
    public int <BGOJFGNNGPB>k__BackingField;    // 0x0x10
    public int <KPBOFCNJDGE>k__BackingField;    // 0x0x14
    public float <DFHHDDGAMPG>k__BackingField;    // 0x0x18
    public int <CPBJFOHLHPH>k__BackingField;    // 0x0x1C
    public int <FEGGKPEHNDF>k__BackingField;    // 0x0x20
    public int <EBFAHCFIKGN>k__BackingField;    // 0x0x24
    public int <EIHCHGCKJPL>k__BackingField;    // 0x0x28
    public string <GNEHNAANBFL>k__BackingField;    // 0x0x30
    public string <DECHIMOHLLJ>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// FEAJJMACBMF
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class FEAJJMACBMF
{
    public List<int> <IBADOGEHPGJ>k__BackingField;    // 0x0x10
    public string <KHCDDNHNAHE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FEKIGPMGFLH
//   (not directly referenced by a detected call)
public class FEKIGPMGFLH
{
    // (no instance fields in the metadata dump)
}
...
// FFNAJGOJJKF
//   (not directly referenced by a detected call)
public class FFNAJGOJJKF
{
    public int <NHKKDADAKKL>k__BackingField;    // 0x0x10
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x18
    public string <APKIFKMAHOK>k__BackingField;    // 0x0x20
    public string <DHCODGPNLPM>k__BackingField;    // 0x0x28
    public string <GMNJMDKLJMO>k__BackingField;    // 0x0x30
    public bool <EJKEFGOLFNF>k__BackingField;    // 0x0x38
    public int <PCJLNFGGOGD>k__BackingField;    // 0x0x3C
    public FEKIGPMGFLH <EDBIIKFOEMB>k__BackingField;    // 0x0x40
    public KCABCBPPJCI LODDHFFNBMC;    // 0x0x48
    public KCABCBPPJCI BGKMOAFENKG;    // 0x0x50
    public KCABCBPPJCI LIAPKLJPAGD;    // 0x0x58
    public DJNHDJOOMKD IJDEBENJNBE;    // 0x0x60
}

// --------------------------------------------------------------------------
// FGJMMNJGDKB
//   RESPONSE GET    api/config/v1/amplitude   [Service.API]
public class FGJMMNJGDKB
{
    public string <HJCOCJEKGCC>k__BackingField;    // 0x0x10
    public string <FMNIKBHDHOG>k__BackingField;    // 0x0x18
    public bool <JLOJBCKFOGH>k__BackingField;    // 0x0x20
    public string <GANFDLLKIKD>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// FJDNPAJIJIP
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class FJDNPAJIJIP
{
    public int <HGLKKNAABHJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FKANDKKBEPM
//   (not directly referenced by a detected call)
public class FKANDKKBEPM
{
    public string <KKOCKJPMFAL>k__BackingField;    // 0x0x10
    public KIKIEHKBHNM <IOLNEDJDMAI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FOOJAOBCLBA
//   (not directly referenced by a detected call)
public class FOOJAOBCLBA
{
    public int <BCBLJHJCAPG>k__BackingField;    // 0x0x10
    public BNCFHOOCHAI <HLJFMKKADFH>k__BackingField;    // 0x0x14
}
...
// GAHKFOMDGHN
//   (not directly referenced by a detected call)
public class GAHKFOMDGHN
{
    public float <DBIFKHGJNJO>k__BackingField;    // 0x0x10
}
...
//   RESPONSE GET    api/storefronts/v1/season/{dIOCJPMPAPJ}   [Service.Econ]
public class GEEMFIMOPBH : KNCCPBAAOKA
{
    public int <CJEECPLOFLF>k__BackingField;    // 0x0x30
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x38
    public DateTime <EIGDOBDKJLI>k__BackingField;    // 0x0x40
    public DateTime <IMFFALHBMPF>k__BackingField;    // 0x0x48
    public EAFDEJBEFJB <IBLMHANGJDH>k__BackingField;    // 0x0x50
    public DIPHILPNLAN <LFPMHMNIOBL>k__BackingField;    // 0x0x58
    public List<HCPCDAHABKI> <ACCMJNIIJDC>k__BackingField;    // 0x0x60
    public BOMJCPNECFG <KECIMOHICPH>k__BackingField;    // 0x0x68
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{jAHEBHKLNNM}   [Service.Econ]
public class GFKDAADENEE
{
    public DLDNGEDFMOJ <GBLIFKHPBNE>k__BackingField;    // 0x0x10
    public MOONCMIECPL <BBMCGOIONHM>k__BackingField;    // 0x0x18
}
...
public class GNHLNGJOKBH
{
    public int <JEGFKCAONGD>k__BackingField;    // 0x0x10
    public int <DDIPMEBLPOA>k__BackingField;    // 0x0x14
    public float <BLOHIKFHDIG>k__BackingField;    // 0x0x18
    public float <FGCGMCFAGFE>k__BackingField;    // 0x0x1C
    public bool <EIPNKJDIFGN>k__BackingField;    // 0x0x20
    public bool <GOBBKNNAFKO>k__BackingField;    // 0x0x21
    public bool <NFOFIJEKHAI>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// GPJIMAHMAIO
//   RESPONSE ?      api/incentivizedreferrals/   [Service.Econ]
public class GPJIMAHMAIO
{
    public List<JIMHNOHLOFM> <MAGELFFKPFK>k__BackingField;    // 0x0x10
    public string <KHCDDNHNAHE>k__BackingField;    // 0x0x18
}
...
// base   : DIPHILPNLAN
//   (not directly referenced by a detected call)
public class HCPCDAHABKI : DIPHILPNLAN
{
    public int <CCBIHAODDAN>k__BackingField;    // 0x0x60
    public List<IOMHMIGABAH> <JNPEHNFNPMM>k__BackingField;    // 0x0x68
    public List<IOMHMIGABAH> <PMHAMOAHALF>k__BackingField;    // 0x0x70
    public List<IOMHMIGABAH> <BGJDNFEHNCG>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// HGEPLGDEKKD
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class HGEPLGDEKKD
{
    public long <MEBJCOKMLCF>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <IBHLLPNJLCI>k__BackingField;    // 0x0x18
    public PHHDNCHIJDP <ALBHIHOLEHA>k__BackingField;    // 0x0x20
}
...
//   RESPONSE GET    api/avatar/v2/{kHAEJOOBCJG}   [Service.Econ]
public class HHDLNAPEMGP
{
    public string <HDJOEMFFEIL>k__BackingField;    // 0x0x10
    public string <IALMEDBGNMK>k__BackingField;    // 0x0x18
    public string <KLINMPDPJEK>k__BackingField;    // 0x0x20
    public string <MNKMBOKNOPE>k__BackingField;    // 0x0x28
    public string <FJGMEJCEEDG>k__BackingField;    // 0x0x30
    public List<BGNNOMBFMLH> <OGDPFLFJIFH>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// HJNAOMJJEGJ
//   (not directly referenced by a detected call)
public class HJNAOMJJEGJ
{
    public DateTime <LFGEENHJMAI>k__BackingField;    // 0x0x10
    public string <ODDJNLAMGNA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HOMJKAOHGDG
//   (not directly referenced by a detected call)
public class HOMJKAOHGDG
{
    public Guid <GBLMEEFONMM>k__BackingField;    // 0x0x10
    public int <IEOJAEAILMG>k__BackingField;    // 0x0x20
    public int <GBODIMPBGGK>k__BackingField;    // 0x0x24
    public Guid <BCLDIOBHACB>k__BackingField;    // 0x0x28
    public DateTime <CGAIDFBDOEI>k__BackingField;    // 0x0x38
    public MOONCMIECPL <BBMCGOIONHM>k__BackingField;    // 0x0x40
}
...
public class HPIOAGDJHDH
{
    public long <MBAMDMELCEH>k__BackingField;    // 0x0x10
    public int <HEIGFJGJGEJ>k__BackingField;    // 0x0x18
    public long <MEBJCOKMLCF>k__BackingField;    // 0x0x20
    public long? <BIMKBFLBCJI>k__BackingField;    // 0x0x28
    public long? <HEAPLBDKFFC>k__BackingField;    // 0x0x38
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x48
    public string <DHCODGPNLPM>k__BackingField;    // 0x0x50
    public string <PEKKCAGLCOP>k__BackingField;    // 0x0x58
    public DateTime <DEACIEPLFMN>k__BackingField;    // 0x0x60
    public DateTime <LNIDHMDLLOE>k__BackingField;    // 0x0x68
    public int <OMPJCHKJPDD>k__BackingField;    // 0x0x70
    public BAMLHAODDOG <NCCMBCLIJNG>k__BackingField;    // 0x0x74
    public bool <FLJFDGICAEL>k__BackingField;    // 0x0x78
    public bool <NEEDDMPOLNG>k__BackingField;    // 0x0x79
    public AKFCIMLMAKA <PIAPLNDKCPE>k__BackingField;    // 0x0x7C
    public AKFCIMLMAKA <IFFNPHFNECK>k__BackingField;    // 0x0x80
    public long? <LNAHODDEFJM>k__BackingField;    // 0x0x88
}
...
public class IAJBHMAHPGK
{
    public int <DDIPMEBLPOA>k__BackingField;    // 0x0x10
    public bool <EIPNKJDIFGN>k__BackingField;    // 0x0x14
    public DateTime <MKGDCMHJMFK>k__BackingField;    // 0x0x18
    public bool <NDMAGDPEBCN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IDELKAJIOLI
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class IDELKAJIOLI
{
    public List<FOOJAOBCLBA> <EAPPJEBPMGP>k__BackingField;    // 0x0x10
    public BNCFHOOCHAI <HLJFMKKADFH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IFJONDCAKKM
//   (not directly referenced by a detected call)
public class IFJONDCAKKM
{
    public ObscuredLong <HKEELLDOJBB>k__BackingField;    // 0x0x10
    public string <HIPGBCFFFFL>k__BackingField;    // 0x0x38
    public ObscuredInt <HEIGFJGJGEJ>k__BackingField;    // 0x0x40
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x58
    public string <DHCODGPNLPM>k__BackingField;    // 0x0x60
    public string <PEKKCAGLCOP>k__BackingField;    // 0x0x68
    public int <PDBMMNCCLPC>k__BackingField;    // 0x0x70
    public GGEKBCHLINO <NCCMBCLIJNG>k__BackingField;    // 0x0x74
    public DateTime <CGAIDFBDOEI>k__BackingField;    // 0x0x78
    public DateTime <LFGEENHJMAI>k__BackingField;    // 0x0x80
    public DateTime? <GLFFMEFPMMC>k__BackingField;    // 0x0x88
    public long? <BLICMGKBMAJ>k__BackingField;    // 0x0x98
    public int <AFFFOLMFNLL>k__BackingField;    // 0x0xA8
    public int <LNANLJBJFDK>k__BackingField;    // 0x0xAC
    public int <PCMNFHGGBBF>k__BackingField;    // 0x0xB0
    public JJDFPDDKLMO <AICKPEHNMBG>k__BackingField;    // 0x0xB4
    public JJDFPDDKLMO <JHJGPMHHJDI>k__BackingField;    // 0x0xB8
    public ObscuredBool <MGAHKLCCFHP>k__BackingField;    // 0x0xBC
    public ObscuredBool <IGGAAMLOKJP>k__BackingField;    // 0x0xC8
    public ObscuredBool <FMDEAJGDKJD>k__BackingField;    // 0x0xD4
    public int? <GEFFJOJJHJE>k__BackingField;    // 0x0xE0
    public bool <HOAHBIENBLM>k__BackingField;    // 0x0xE8
}
...
public class IGBGJKMGDDK
{
    public Guid <BIHJIADDNDH>k__BackingField;    // 0x0x10
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x20
    public string <PEKKCAGLCOP>k__BackingField;    // 0x0x28
    public DateTime <EIGDOBDKJLI>k__BackingField;    // 0x0x30
    public DateTime? <ABGFKCBFIML>k__BackingField;    // 0x0x38
    public List<AEDILOEPMFC> <NAJGKEJJPJH>k__BackingField;    // 0x0x48
}
...
public class ILNJDMFNOCD
{
    public CFOBCEPBBHA <IPPAKFADGHB>k__BackingField;    // 0x0x10
    public NMPEBLECEFI <HNBANDFFCOG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IOKLNPFOLGI
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class IOKLNPFOLGI
{
    public List<HPIOAGDJHDH> <COPIPEPPAON>k__BackingField;    // 0x0x10
    public string <KHCDDNHNAHE>k__BackingField;    // 0x0x18
}
...
// IOMHMIGABAH
//   (not directly referenced by a detected call)
public class IOMHMIGABAH
{
    public bool <KJCLGPPMJEB>k__BackingField;    // 0x0x10
    public EFFIEFEFHHB <JDDIAGAOKIM>k__BackingField;    // 0x0x18
    public float <JMMBGCAEIPE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JBOBOABIEBN
//   (not directly referenced by a detected call)
public class JBOBOABIEBN
{
    public long <FAKBOLNMPBP>k__BackingField;    // 0x0x10
    public Guid <HIPGBCFFFFL>k__BackingField;    // 0x0x18
    public long <MEBJCOKMLCF>k__BackingField;    // 0x0x28
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x30
    public string <DHCODGPNLPM>k__BackingField;    // 0x0x38
    public int <GEFFJOJJHJE>k__BackingField;    // 0x0x40
    public Guid? <FKDGKFHDGLE>k__BackingField;    // 0x0x44
    public DateTime <LFGEENHJMAI>k__BackingField;    // 0x0x58
    public string <PEKKCAGLCOP>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// JCIEDHMBAOH
//   (not directly referenced by a detected call)
public class JCIEDHMBAOH
{
    public int <MKAOPGEEDNH>k__BackingField;    // 0x0x10
    public DateTime? <GDNPENMMIMJ>k__BackingField;    // 0x0x18
    public DateTime? <ADBLILCMKOA>k__BackingField;    // 0x0x28
}
...
public class JEHCPEEKMML
{
    public MCIJKOEJDIC <OEPKPEKMCHI>k__BackingField;    // 0x0x10
    public string <FBKANHBLDIH>k__BackingField;    // 0x0x18
    public int? <EDOCBAPIGKO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JIMHNOHLOFM
//   (not directly referenced by a detected call)
public class JIMHNOHLOFM
{
    public int <OFLAIHGFEAF>k__BackingField;    // 0x0x10
    public DateTime <LFGEENHJMAI>k__BackingField;    // 0x0x18
    public DateTime? <BKHCHNIJHHM>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// JKDJBOOINGA
// base   : GJDIKIMLCHA<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class JKDJBOOINGA
{
    // (no instance fields in the metadata dump)
}
...
public class JOKHLOPJBLN
{
    public string <IDOGBJCDBOD>k__BackingField;    // 0x0x10
    public string <DPLILEOMOML>k__BackingField;    // 0x0x18
    public string <NPNJDGODFBN>k__BackingField;    // 0x0x20
    public string <DHCODGPNLPM>k__BackingField;    // 0x0x28
    public string <NMDAEPGCBIC>k__BackingField;    // 0x0x30
    public LIHDCCJNKGC <GBLIFKHPBNE>k__BackingField;    // 0x0x38
    public List<string> <BEMCPMPABEN>k__BackingField;    // 0x0x40
    public List<string> <EGHIDMNEPBI>k__BackingField;    // 0x0x48
    public string <DAAIPPFMAKA>k__BackingField;    // 0x0x50
    public List<HJNAOMJJEGJ> <EPKLAFMKBGM>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// JPFDLKMGKHF
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class JPFDLKMGKHF
{
    public Guid? <GBLMEEFONMM>k__BackingField;    // 0x0x10
    public long? <MEBJCOKMLCF>k__BackingField;    // 0x0x28
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x38
    public string <DHCODGPNLPM>k__BackingField;    // 0x0x40
    public string <PEKKCAGLCOP>k__BackingField;    // 0x0x48
    public NMPEBLECEFI <JLALJJBILBO>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// JPIKCIGABBI
//   (not directly referenced by a detected call)
public class JPIKCIGABBI
{
    public long <KNAKFDPFHDP>k__BackingField;    // 0x0x10
    public long <MBAMDMELCEH>k__BackingField;    // 0x0x18
    public int <BHCGMBKNIPL>k__BackingField;    // 0x0x20
    public DateTime <LFGEENHJMAI>k__BackingField;    // 0x0x28
    public CAMMJINEJFD <IOLNEDJDMAI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// KDFKPJDEKJL
//   (not directly referenced by a detected call)
public class KDFKPJDEKJL
{
    public int <GHHMPFMHNJH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KIAPPEFHHLJ
//   (not directly referenced by a detected call)
public class KIAPPEFHHLJ
{
    public int <HKGLECMDNPO>k__BackingField;    // 0x0x10
}
...
public class LAKPIECKPOO
{
    public bool <HPMMPOFDPBD>k__BackingField;    // 0x0x10
    public string <DPLILEOMOML>k__BackingField;    // 0x0x18
    public string <EKHOEDEDPIG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LGAMPMJNGFH
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class LGAMPMJNGFH
{
    public int <IEOJAEAILMG>k__BackingField;    // 0x0x10
    public Guid <MMNEOGOOHOI>k__BackingField;    // 0x0x14
    public long <IHIJCONECLO>k__BackingField;    // 0x0x28
    public DateTime <CGAIDFBDOEI>k__BackingField;    // 0x0x30
}
...
public class MAIDCOKBBFE
{
    public EAFDEJBEFJB <IBLMHANGJDH>k__BackingField;    // 0x0x10
    public HPCEGKLGPHC <JEMGLNFHAMI>k__BackingField;    // 0x0x14
    public int <IFKPLEOHJNB>k__BackingField;    // 0x0x18
    public int <DCPLFNLGJAD>k__BackingField;    // 0x0x1C
    public int <BIMFLLLNNEG>k__BackingField;    // 0x0x20
    public BBDGKLGCHIA <DKDBBNEEPFC>k__BackingField;    // 0x0x24
    public bool <EMFHHFJEPPE>k__BackingField;    // 0x0x28
    public float <PJLOJIAJOCD>k__BackingField;    // 0x0x2C
    public int <EOAJBCJBFDE>k__BackingField;    // 0x0x30
    public bool <ILLMIPBDIMC>k__BackingField;    // 0x0x34
}
...
// base   : HPIOAGDJHDH
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class MDCBEPJCJPO : HPIOAGDJHDH
{
    public List<FKANDKKBEPM> <EGHIDMNEPBI>k__BackingField;    // 0x0x98
}
...
public class MJKFEHPIDME : OKHNOPLBOFP
{
    public CABBDKFODEC? <CMLDGCOHJJC>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <HIOHPKCPPEL>k__BackingField;    // 0x0x20
}
...
public class MOBHOFPIIIJ
{
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x10
    public string <DHCODGPNLPM>k__BackingField;    // 0x0x18
    public int? <GEFFJOJJHJE>k__BackingField;    // 0x0x20
    public GGEKBCHLINO? <NCCMBCLIJNG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// MOONCMIECPL
//   (not directly referenced by a detected call)
public class MOONCMIECPL
{
    public Guid <GBLMEEFONMM>k__BackingField;    // 0x0x10
    public long <MEBJCOKMLCF>k__BackingField;    // 0x0x20
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x28
    public string <DHCODGPNLPM>k__BackingField;    // 0x0x30
    public string <PEKKCAGLCOP>k__BackingField;    // 0x0x38
    public long <GEFFJOJJHJE>k__BackingField;    // 0x0x40
    public Guid? <FKDGKFHDGLE>k__BackingField;    // 0x0x48
    public DateTime <CGAIDFBDOEI>k__BackingField;    // 0x0x60
}
...
public class NCMMAGDIBND
{
    public int <COAMIDLCEPD>k__BackingField;    // 0x0x10
    public int? <NNFBMBICGLL>k__BackingField;    // 0x0x14
    public string <BAGLOHGOLMK>k__BackingField;    // 0x0x20
    public string <KLKMOHJPLAB>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// NMPEBLECEFI
//   (not directly referenced by a detected call)
public class NMPEBLECEFI
{
    public long <GEFFJOJJHJE>k__BackingField;    // 0x0x10
    public Guid? <MMNEOGOOHOI>k__BackingField;    // 0x0x18
}
...
public class OIABGAKJABE
{
    public List<FKANDKKBEPM> <EGHIDMNEPBI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OIFCOJCADEC
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class OIFCOJCADEC
{
    public int? <LGFDCNIDPEB>k__BackingField;    // 0x0x10
    public string <NMDAEPGCBIC>k__BackingField;    // 0x0x18
    public string <HGFJDELCNDJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OIMDBINAEGE
//   (not directly referenced by a detected call)
public class OIMDBINAEGE
{
    public DKDALBLOAOF HDFCLOCFKIN;    // 0x0x10
    public int IDGKBNODFPM;    // 0x0x14
}

// --------------------------------------------------------------------------
// OLFLOBIBDOP
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.Econ]
public class OLFLOBIBDOP
{
    public int <HFLAKCMHDLK>k__BackingField;    // 0x0x10
    public string <OAAKIDBKCGL>k__BackingField;    // 0x0x18
    public List<FFNAJGOJJKF> <FIHFDHABPLN>k__BackingField;    // 0x0x20
    public BFMDFCEEAGL <AHPPKOJOFJL>k__BackingField;    // 0x0x28
    public string <BKJFMLNFNAM>k__BackingField;    // 0x0x30
    public DateTime <EIGDOBDKJLI>k__BackingField;    // 0x0x38
    public DateTime <IMFFALHBMPF>k__BackingField;    // 0x0x40
    public DateTime <DNDLJPFOKPJ>k__BackingField;    // 0x0x48
    public bool? <JFFIKCKNMEB>k__BackingField;    // 0x0x50
}
...
public class ONLIDBLNMCC
{
    public GDIOEPIOPEE <GBLIFKHPBNE>k__BackingField;    // 0x0x10
    public JBOBOABIEBN <CILKEFCLOJN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PCELKKHNPHJ
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{kHAEJOOBCJG}   [Service.API]
public class PCELKKHNPHJ
{
    public List<HPIOAGDJHDH> <PBPMJPJCHAO>k__BackingField;    // 0x0x10
    public List<COAGAJPELCG> <EDPEJLJGBJI>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{eKIGCFIILOB}   [Service.API]
...
public class PHHAKLPGNGC
{
    public MDCBEPJCJPO <JIIHNPKNJHC>k__BackingField;    // 0x0x10
    public BNCFHOOCHAI <HLJFMKKADFH>k__BackingField;    // 0x0x18
    public PNGLFHEAJIH <AJPAOKMJEAO>k__BackingField;    // 0x0x20
}
...
public class PHMHCPEMABG
{
    public bool <FDBEOEBDKNM>k__BackingField;    // 0x0x10
    public string <FDMMHPFDOAL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PIBLFGPOCIB
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class PIBLFGPOCIB
{
    public BDOGOIGCKMK <OEPKPEKMCHI>k__BackingField;    // 0x0x10
    public int <HGLKKNAABHJ>k__BackingField;    // 0x0x14
    public long <JNIIJIGMDJE>k__BackingField;    // 0x0x18
    public bool <FKGDCJDDIFD>k__BackingField;    // 0x0x20
    public string <FDMMHPFDOAL>k__BackingField;    // 0x0x28
    public int? <MLEJAMCLBGA>k__BackingField;    // 0x0x30
    public bool <FCNOHHHINON>k__BackingField;    // 0x0x38
    public bool <LDDEAIKLGBF>k__BackingField;    // 0x0x39
    public bool <HLIBGFLAADL>k__BackingField;    // 0x0x3A
    public string <IINAICLCEII>k__BackingField;    // 0x0x40
    public DateTime? <HPJHIMMHIML>k__BackingField;    // 0x0x48
    public float <OCNHLDDEBCF>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// PLIKEBBPJGI
//   (not directly referenced by a detected call)
public class PLIKEBBPJGI
{
    public long <HKEELLDOJBB>k__BackingField;    // 0x0x10
    public string <HIPGBCFFFFL>k__BackingField;    // 0x0x18
    public int <EMIAEGGJIAL>k__BackingField;    // 0x0x20
    public int <EDLPFLIBBAP>k__BackingField;    // 0x0x24
    public int <HOBLCNEJFMI>k__BackingField;    // 0x0x28
    public int <PLFHOBDGANC>k__BackingField;    // 0x0x2C
    public int <IMKCOPLEDIJ>k__BackingField;    // 0x0x30
    public string <JBCMODJMFIB>k__BackingField;    // 0x0x38
    public string <DIBEMGJFDHL>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PNGLFHEAJIH
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class PNGLFHEAJIH
{
    public OFLPPEFGGOP <HLJFMKKADFH>k__BackingField;    // 0x0x10
    public List<string> <EGHIDMNEPBI>k__BackingField;    // 0x0x18
}
...
{
    public long <MEBJCOKMLCF>k__BackingField;    // 0x0x10
    public long? <BIMKBFLBCJI>k__BackingField;    // 0x0x18
    public HMECHOKOCBB <PEAIKNOINKD>k__BackingField;    // 0x0x28
}
...
{
    public CABJNOJGGJF <HLJFMKKADFH>k__BackingField;    // 0x0x10
    public string <HIOGJFFDGAH>k__BackingField;    // 0x0x18
    public string <HMDACBOLLIG>k__BackingField;    // 0x0x20
    public string <GCAIBOBONBA>k__BackingField;    // 0x0x28
}
...
{
    public long <MBAMDMELCEH>k__BackingField;    // 0x0x10
    public long? <KEHDBBDMOOH>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public EDFJMHCGIKM FilterType;    // 0x0x20
...
{
    public HMECHOKOCBB <FDIMJLPDNNF>k__BackingField;    // 0x0x10
    public string <HGIBLHJFNDC>k__BackingField;    // 0x0x18
    public int <EPIGEMAHEJG>k__BackingField;    // 0x0x20
    public int <NAFEAEBBLOL>k__BackingField;    // 0x0x24
    public string <OHPJHKIMOHA>k__BackingField;    // 0x0x28
    public string <KKGIMHFEPJK>k__BackingField;    // 0x0x30
}
...
{
    public int <IEOJAEAILMG>k__BackingField;    // 0x0x10
    public Guid <KBOJCNMAPKO>k__BackingField;    // 0x0x14
    public DateTime <ADEKHGOJLIF>k__BackingField;    // 0x0x28
}
...
{
    public bool <PABCLHBJPHE>k__BackingField;    // 0x0x10
    public int <NECNNFBJHLE>k__BackingField;    // 0x0x14
    public bool <COFCLLFMLPA>k__BackingField;    // 0x0x18
}
...
{
    public Guid <KBOJCNMAPKO>k__BackingField;    // 0x0x10
    public HMECHOKOCBB <BCBFDGCJEAP>k__BackingField;    // 0x0x20
    public int <JEHOIKMOGPE>k__BackingField;    // 0x0x24
    public long <MEBJCOKMLCF>k__BackingField;    // 0x0x28
    public long? <BIMKBFLBCJI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{fMDBOIEDJKN}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <BDOJOCAFDPA>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <ELBEMBJIAMG>k__BackingField;    // 0x0x18
}
...
{
    public long <CAAPIKKDFKH>k__BackingField;    // 0x0x10
    public long <MEBJCOKMLCF>k__BackingField;    // 0x0x18
    public long <FFHIOIHKNEJ>k__BackingField;    // 0x0x20
    public CPIFAEPGAPE <IOLNEDJDMAI>k__BackingField;    // 0x0x28
    public int <HDHFMMMDJIL>k__BackingField;    // 0x0x2C
}
...
{
    public long <MEBJCOKMLCF>k__BackingField;    // 0x0x10
    public List<Guid> <DOGCKPDFOFP>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <BDOJOCAFDPA>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <ELBEMBJIAMG>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <DJJFKNDLIKN>k__BackingField;    // 0x0x20
}
...
{
    public long <FFHIOIHKNEJ>k__BackingField;    // 0x0x10
    public long <GJMJNIHDAMK>k__BackingField;    // 0x0x18
    public int? <MCPNMIPJCOC>k__BackingField;    // 0x0x20
    public int? <AGJAJBIDIFP>k__BackingField;    // 0x0x28
    public long? <GCGFELBLPLA>k__BackingField;    // 0x0x30
    public long <OPLHNNCJHDN>k__BackingField;    // 0x0x40
    public long <OFNCEIFJDCM>k__BackingField;    // 0x0x48
    public int <BBLKNIIJFKD>k__BackingField;    // 0x0x50
    public CPIFAEPGAPE <ONFGMLCAOIA>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <OPHCIOJDLKO>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public IFKEEPDDNBC <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public OMMBGJMJJPN creatorAccountRole;    // 0x0x58
}
...
{
    public CCOKJMJOIJF <DPNIFDLMEDL>k__BackingField;    // 0x0x10
    public ODEOILNDKIO <KBGIIFHLJMG>k__BackingField;    // 0x0x14
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x18
    public string <DHCODGPNLPM>k__BackingField;    // 0x0x20
    public bool <BMCNMKDBGCG>k__BackingField;    // 0x0x28
}
...
{
    public List<CCOKJMJOIJF> <BGJGLJCLFLD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{eKIGCFIILOB}   [Service.API]
public class ProgressionEventDTO
{
    public long <GJMJNIHDAMK>k__BackingField;    // 0x0x10
    public string <COLMPJPGJAD>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <BGJDNFEHNCG>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <CBDCJBMHEAC>k__BackingField;    // 0x0x28
    public DateTime <DEACIEPLFMN>k__BackingField;    // 0x0x30
    public DateTime <LNIDHMDLLOE>k__BackingField;    // 0x0x38
    public DateTime <OGGJMKBNPMC>k__BackingField;    // 0x0x40
    public bool <GKBHGLCFGKB>k__BackingField;    // 0x0x48
    public int <OBPAIOIDJKB>k__BackingField;    // 0x0x4C
    public float <BLNFIPFOFOI>k__BackingField;    // 0x0x50
    public Guid? <AAAEAOOECIC>k__BackingField;    // 0x0x54
    public string <LJNDOHOBJFJ>k__BackingField;    // 0x0x68
    public string <ENINMFDKOJN>k__BackingField;    // 0x0x70
    public string <DJJNEPJJPAO>k__BackingField;    // 0x0x78
    public string <MDOPHDCLMFM>k__BackingField;    // 0x0x80
}
...
{
    public Guid <CGPHGIHEBGK>k__BackingField;    // 0x0x10
    public int <OFDJKLNFJJO>k__BackingField;    // 0x0x20
    public int <DIJHKKJLMPG>k__BackingField;    // 0x0x24
    public int <LMFDGCAEBJB>k__BackingField;    // 0x0x28
    public long <PAACHLLIIOD>k__BackingField;    // 0x0x30
    public long <PMCAEGJGFHN>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/record/{eKIGCFIILOB}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <IEOJAEAILMG>k__BackingField;    // 0x0x10
    public int <AGKFPBNGOFA>k__BackingField;    // 0x0x14
    public int <MLOAALPJNOF>k__BackingField;    // 0x0x18
    public int <IJOOIBFKNDK>k__BackingField;    // 0x0x1C
    public int <NKCMKOKKGJC>k__BackingField;    // 0x0x20
    public DateTime? <MDEIOPLOANJ>k__BackingField;    // 0x0x28
}
...
{
    public long <LJFKCNFOAIL>k__BackingField;    // 0x0x10
    public int <MFCEMFBCLLO>k__BackingField;    // 0x0x18
    public string <PEKKCAGLCOP>k__BackingField;    // 0x0x20
    public int <AGKFPBNGOFA>k__BackingField;    // 0x0x28
    public int <HEPGHLNDMHG>k__BackingField;    // 0x0x2C
    public bool <IMMMEHNJJGE>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public EIHGOODFAOG ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool IEEAJDAIIAC;    // 0x0x28
}
...
{
    public AOMFJDFOCOM? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public AOMFJDFOCOM HJANMKJBJNG;  // wrapper
...
{
    public HHJIBNMLOAC KOAJJNJAKHJ;  // wrapper
...
{
    public HHKINDNBLEE EHPFPOFFCEJ;  // wrapper
    public int? BNCEPENKLDF;  // wrapper
...
{
    public BDOGOIGCKMK OAIKKEBGDEA;  // wrapper
    public float? IAPKHCHOOMK;  // wrapper
...
{
    public FHMABOHAEED UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public IFKEEPDDNBC CDBJCAAPIOD;  // wrapper
    public IFKEEPDDNBC? NAPNJJMDECJ;  // wrapper
...
{
    public FFNAJGOJJKF CKDNNCKGOAE;  // wrapper
...
{
    public GGEKBCHLINO PPPIBEOOJIP;  // wrapper
    public byte[] HHJFLKKNHEB;  // wrapper
    public byte[] LPNKOCMCEJO;  // wrapper
    public Color LCCPJBCAOGP;  // wrapper
...
{
    public List<BCINJINBBHG> EABAAGDLOEL;  // wrapper
}
...
{
    public LJGADMBNNMC OKMAJDMABMP;  // wrapper
    public IFKEEPDDNBC? PLHIBLLDCBH;  // wrapper
...
{
    public GLOFCEJBIGB JFMHKCBBGHM;  // wrapper
...
{
    public IFJONDCAKKM inventionId;  // wrapper
}
...
// api/keepsakes/{eLLBCGLMDAA}/collect  [API POST]
public class KeepsakesELLBCGLMDAACollectRequest
{
    public Guid ELLBCGLMDAA;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> NIAPGKEDFNJ;  // wrapper
    public MEPCALGGMJC CEHOPDGAGCD;  // wrapper
    public long? JJIOFAMOIJP;  // wrapper
...
{
    public long? NLMOHAPLAPN;  // wrapper
    public long? JKGEJOFDODI;  // wrapper
    public List<string> HBGOMGGKBLB;  // wrapper
    public DateTime DMNOELPOJOF;  // wrapper
    public DateTime OBOPMEEOJLK;  // wrapper
    public BAMLHAODDOG PPPIBEOOJIP;  // wrapper
    public AKFCIMLMAKA NGFLDHAIGIF;  // wrapper
    public AKFCIMLMAKA CLOLKCBBDKD;  // wrapper
}
...
{
    public AKFCIMLMAKA NGFLDHAIGIF;  // wrapper
    public AKFCIMLMAKA AAHELEEDJHC;  // wrapper
}
...
{
    public Guid LDCDEILCNJN;  // wrapper
...
{
    public List<KOEIABFLEPM> OAFNCAAPACG;  // wrapper
}
...
{
    public Guid PEIEFJBJJBH;  // wrapper
    public object Price;  // candidate
...
{
    public Guid PEIEFJBJJBH;  // wrapper
    public long? MLHCGNPDAIG;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Limit;  // candidate
...
{
    public Guid LDCDEILCNJN;  // wrapper
    public long? GAPLKCGCKNL;  // wrapper
    public long? BMBLHEBAFOJ;  // wrapper
    public int? DFFIJEBHEAC;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> NDEGHHCMGIN;  // wrapper
...
{
    public Guid? HFEALNKKOEO;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object RoomId;  // candidate
...
{
    public BDOGOIGCKMK OAIKKEBGDEA;  // wrapper
    public long? NOIKJELJLHI;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats MEPELEPJIJL;  // wrapper
}
...
{
    public Guid GGBFBEJGOEI;  // wrapper
...
{
    public Guid OOCLHAGDMOD;  // wrapper
...
{
    public List<CBLAIHDIBLN> EIHIKNCJHDC;  // wrapper
    public object roomId;  // candidate
...
{
    public LIHDCCJNKGC JBJLLKCKKBJ;  // wrapper
}
