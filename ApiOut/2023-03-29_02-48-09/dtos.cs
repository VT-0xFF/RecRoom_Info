...
public class AHNNGJMCKIJ
{
    public long <PEPELONOAAF>k__BackingField;    // 0x0x10
    public Guid <MIMHMFMACPI>k__BackingField;    // 0x0x18
    public long <FKKBLIPOKOL>k__BackingField;    // 0x0x28
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x30
    public string <MHFFMHIBIPK>k__BackingField;    // 0x0x38
    public int <LMLJHIDIGPO>k__BackingField;    // 0x0x40
    public Guid? <POLALFLPNBP>k__BackingField;    // 0x0x44
    public DateTime <LNHFKFGMIBN>k__BackingField;    // 0x0x58
    public string <KNJFJPBCNNN>k__BackingField;    // 0x0x60
}
...
// AJPOLDLHCEI
//   (not directly referenced by a detected call)
public class AJPOLDLHCEI
{
    public int <KGPLJMIIBFD>k__BackingField;    // 0x0x10
    public DateTime? <FMEMMEKKPMC>k__BackingField;    // 0x0x18
    public DateTime? <OEPGJCACKJG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// BALNIDNLAOJ
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class BALNIDNLAOJ
{
    public List<NAKMFKDCHBA> <ELILOBJBNFF>k__BackingField;    // 0x0x10
    public OHALHLGKPGK <KEHCIEBIJHG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BDLAJBPEJJH
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class BDLAJBPEJJH
{
    public int? <OOFOJOEJBOL>k__BackingField;    // 0x0x10
    public string <MMJAMONCHJC>k__BackingField;    // 0x0x18
    public string <GEDPLOMFMPD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BEPLNDABNJD
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{lLCBCAFBFBO}   [Service.API]
public class BEPLNDABNJD
{
    public List<MPHGAFCMKDN> <HFFPDOMKLGA>k__BackingField;    // 0x0x10
    public List<GBIAFOBJCHK> <CPNPBNHHGGJ>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{mHABMOPFKAH}   [Service.Econ]
public class BFKNGNFDPOG
{
    public EIBAMEGDCCO <OKKKDOFJBOO>k__BackingField;    // 0x0x10
    public JCBNJINJLCC <FEEIOHFKBMG>k__BackingField;    // 0x0x18
}
...
public class BLNJOGBAJIG
{
    public EIBAMEGDCCO <OKKKDOFJBOO>k__BackingField;    // 0x0x10
    public IFPFAPEIOPE <LDBGBPOKCPO>k__BackingField;    // 0x0x18
}
...
// CBEFCCMMBLD
//   (not directly referenced by a detected call)
public class CBEFCCMMBLD
{
    public int <KFGJJHJDLKH>k__BackingField;    // 0x0x10
}
...
// CIOOPDFMPBG
//   (not directly referenced by a detected call)
public class CIOOPDFMPBG
{
    public Guid <PFNPFGGPODJ>k__BackingField;    // 0x0x10
    public Guid <JKPCLEPBEAD>k__BackingField;    // 0x0x20
    public DateTime <POBDCNJMKNN>k__BackingField;    // 0x0x30
    public List<KCMOEJCPJHD> <MMDHFBDFJNB>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// CLNNMGPPBGA
// base   : FFGPIOOIMBF<EDNGKBLCIND>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{gDJHDDPHDJC}   [Service.API]
public class CLNNMGPPBGA
{
    // (no instance fields in the metadata dump)
}
...
// DDMHMKELNBH
//   (not directly referenced by a detected call)
public class DDMHMKELNBH
{
    public long <PELBPHBHNJC>k__BackingField;    // 0x0x10
    public string <ELDEHDPCFFD>k__BackingField;    // 0x0x18
    public string <ANHAIKGOIGO>k__BackingField;    // 0x0x20
    public DHIAIDNKBPK? <FDCLFHGBFAC>k__BackingField;    // 0x0x28
    public string <EJMICLFPJBI>k__BackingField;    // 0x0x30
    public string <HLPMLPOGDIH>k__BackingField;    // 0x0x38
    public KEAHMCPFPLN <DKGEJLHAOED>k__BackingField;    // 0x0x40
    public int <LLPOGPBFJLI>k__BackingField;    // 0x0x44
    public int <NIECHEPHJNA>k__BackingField;    // 0x0x48
    public COGNIFACPAI? <PHPOKGALNPC>k__BackingField;    // 0x0x4C
    public HFEBNIHBFPK? <FELECJDNHOM>k__BackingField;    // 0x0x54
}
...
public class DFKNBALNEJF
{
    public long <FKKBLIPOKOL>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <KGAGONKHHNF>k__BackingField;    // 0x0x18
    public EGMMLGILIOC <PKFAPPIKFHI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DFMFKCEEBFH
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class DFMFKCEEBFH
{
    public int <FPOPCNCCFNF>k__BackingField;    // 0x0x10
    public int? <MNKEFLOKKMF>k__BackingField;    // 0x0x14
    public string <ELINIOLGDPD>k__BackingField;    // 0x0x20
    public string <ADBMDPDKLCH>k__BackingField;    // 0x0x28
}
...
// DPBKOKJGKKN
//   (not directly referenced by a detected call)
public class DPBKOKJGKKN
{
    public DFEJENLMKDJ <KNPAGHGPACO>k__BackingField;    // 0x0x10
    public int <LMLJHIDIGPO>k__BackingField;    // 0x0x14
    public AJPOLDLHCEI <OKHHBMLOEPL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EAICFOJGLPE
//   (not directly referenced by a detected call)
public class EAICFOJGLPE
{
    public string <LIIDAPLNPLN>k__BackingField;    // 0x0x10
    public EIGKEGEKNGH <LOOPGBNIKND>k__BackingField;    // 0x0x18
}
...
public class EEENIIBGNKL
{
    public int <BIKIFPHEMGG>k__BackingField;    // 0x0x10
    public bool <AKGGGKAKJOE>k__BackingField;    // 0x0x14
    public DateTime <CDHGDDAKAPN>k__BackingField;    // 0x0x18
    public bool <CJNFFCLLNOE>k__BackingField;    // 0x0x20
}
...
public class EEMFAKOBOKA
{
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x10
    public string <MHFFMHIBIPK>k__BackingField;    // 0x0x18
    public int? <LMLJHIDIGPO>k__BackingField;    // 0x0x20
    public DGMIANMLLBL? <FANJLPHPOFL>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// EFHKCKMOCNB
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{nEMDNBLCKKH}   [Service.API]
public class EFHKCKMOCNB
{
    public uint <MFOJDFLFLPL>k__BackingField;    // 0x0x10
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x18
    public string <MHFFMHIBIPK>k__BackingField;    // 0x0x20
    public DateTime <NDBAGAOGJLE>k__BackingField;    // 0x0x28
    public DateTime? <KCANIPJPOKJ>k__BackingField;    // 0x0x30
    public bool <KJFBFIJCJEC>k__BackingField;    // 0x0x40
    public List<KAPJEJEIKGC> <IDCBJFEBIAC>k__BackingField;    // 0x0x48
    public List<string> <AKDDHJAEHNP>k__BackingField;    // 0x0x50
    public int <LLHAPMEECCN>k__BackingField;    // 0x0x58
    public int <BNNMIIHEBMC>k__BackingField;    // 0x0x5C
    public int <PJNJJOJBEPF>k__BackingField;    // 0x0x60
}
...
public class EIDDEHPMPDG
{
    public OHALHLGKPGK <KEHCIEBIJHG>k__BackingField;    // 0x0x10
}
...
public class EOAIPJKNMJI
{
    public int <JJLHJLMEPLI>k__BackingField;    // 0x0x10
}
...
public class EPGCKMDKICG : KEMJBFIIFNG
{
    public LFBNCGCLCPH? <KNHNKFKIBCP>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <MFFPLLCEKKC>k__BackingField;    // 0x0x20
}
...
// base   : IDLCMMLKJCH
//   (not directly referenced by a detected call)
public class FCJAOHDHGPD : IDLCMMLKJCH
{
    public int <FFJOOHHADOD>k__BackingField;    // 0x0x60
    public List<HFIKMJOEBME> <AIOKAANGDLH>k__BackingField;    // 0x0x68
    public List<HFIKMJOEBME> <OFABNHJPKNG>k__BackingField;    // 0x0x70
    public List<HFIKMJOEBME> <EAGFNOHNCFI>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// FGAGGOJJNEI
//   (not directly referenced by a detected call)
public class FGAGGOJJNEI
{
    public float <NGPAHMBLODK>k__BackingField;    // 0x0x10
    public float <CIOANNCMMDN>k__BackingField;    // 0x0x14
    public float <PMBJJFICHOG>k__BackingField;    // 0x0x18
    public float <PBECMLFCMBK>k__BackingField;    // 0x0x1C
    public float <AJJJDJFNPNE>k__BackingField;    // 0x0x20
    public float <DHDJOCPHOOF>k__BackingField;    // 0x0x24
    public float <KAPLOOGOKHL>k__BackingField;    // 0x0x28
    public float <OMDNDLGKJCA>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// FLAPMMJJLHJ
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class FLAPMMJJLHJ
{
    public int <IAHHOOACAON>k__BackingField;    // 0x0x10
    public int <HAELOMFMOKD>k__BackingField;    // 0x0x14
    public float <NLKANHEMCEH>k__BackingField;    // 0x0x18
    public int <FBGMKDGHJIJ>k__BackingField;    // 0x0x1C
    public int <HGLBKCBEJJA>k__BackingField;    // 0x0x20
    public int <DAIDMAIAGBI>k__BackingField;    // 0x0x24
    public int <DFLGLJAFDCL>k__BackingField;    // 0x0x28
    public string <KNBHPCLKIFM>k__BackingField;    // 0x0x30
    public string <GBNFCHOIDMC>k__BackingField;    // 0x0x38
}
...
public class GAJPBECJJJJ
{
    public List<string> <MCALAIPCAOH>k__BackingField;    // 0x0x10
    public List<string> <GAPKOJEKBLD>k__BackingField;    // 0x0x18
    public List<string> <JBMEJGPBDNK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GBIAFOBJCHK
//   (not directly referenced by a detected call)
public class GBIAFOBJCHK
{
    public MPHGAFCMKDN <GAHPMGFAKBA>k__BackingField;    // 0x0x10
    public JLPDMKCENFC <NKKDLHKBOPG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GFBDAKLLACA
//   RESPONSE GET    api/config/v2   [Service.API]
public class GFBDAKLLACA
{
    public Dictionary<int, int> <IMLAICFECKO>k__BackingField;    // 0x0x10
    public List<JGMBGAALHIN> <AKELDIKJAMM>k__BackingField;    // 0x0x18
    public JJOCADIABEA[][] <OIJFLNDFJBH>k__BackingField;    // 0x0x20
    public KELBLFFJLOF <IHKLJGBBHML>k__BackingField;    // 0x0x28
    public FGAGGOJJNEI <KGOCBKPDPIO>k__BackingField;    // 0x0x30
    public HFMBIOKNBLN <POCEMMBINLG>k__BackingField;    // 0x0x38
    public CBEFCCMMBLD <FPLFPFKGGHL>k__BackingField;    // 0x0x40
    public LGBCNGENACE <KNFAKDGHPOO>k__BackingField;    // 0x0x48
    public string <LGHPCJJAPGB>k__BackingField;    // 0x0x50
}
...
public class GJLHGLDGCNO
{
    public int <CPMBDCLLAMG>k__BackingField;    // 0x0x10
    public KFHCFLBPEPL <LOOPGBNIKND>k__BackingField;    // 0x0x14
    public DKACIAMCOHG <GJDAPHAIGHF>k__BackingField;    // 0x0x18
    public DKACIAMCOHG <EHGLFOMKLCB>k__BackingField;    // 0x0x1C
    public DKACIAMCOHG <PMJNFGNPPOB>k__BackingField;    // 0x0x20
}
...
public class GJNINCOJLIN : MPHGAFCMKDN
{
    public List<EAICFOJGLPE> <AKDDHJAEHNP>k__BackingField;    // 0x0x98
}
...
//   RESPONSE DELETE api/keepsakes/{lOLLNBGLCPK}   [Service.API]
...
public class GNEFAHBADFB
{
    public bool <EIJCNFCBOBJ>k__BackingField;    // 0x0x10
    public string <LDHOBNNOJII>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HBMCCPGNIEI
//   (not directly referenced by a detected call)
public class HBMCCPGNIEI
{
    public Guid <EFEIOPBHMCL>k__BackingField;    // 0x0x10
    public byte <JDJADFGIMCB>k__BackingField;    // 0x0x20
}
...
// HFIKMJOEBME
//   (not directly referenced by a detected call)
public class HFIKMJOEBME
{
    public bool <IOAFFGIFGML>k__BackingField;    // 0x0x10
    public KCMOEJCPJHD <EPOOPBLOCNG>k__BackingField;    // 0x0x18
    public float <IDIIPJIOKAE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HFKGOFNOEBK
//   RESPONSE ?      api/incentivizedreferrals/   [Service.Econ]
public class HFKGOFNOEBK
{
    public List<LODNNNNFKGD> <FMJKGKKCBNM>k__BackingField;    // 0x0x10
    public string <LDFFADOAEPP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HFMBIOKNBLN
//   (not directly referenced by a detected call)
public class HFMBIOKNBLN
{
    public int <PIIGOAHBIIN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HHIICPJLODF
//   (not directly referenced by a detected call)
public class HHIICPJLODF
{
    public long <PIFNBHFONBO>k__BackingField;    // 0x0x10
    public string <MIMHMFMACPI>k__BackingField;    // 0x0x18
    public int <NDBOINCHMAN>k__BackingField;    // 0x0x20
    public int <ABIGNDIHOGG>k__BackingField;    // 0x0x24
    public int <ADEMKPADGNH>k__BackingField;    // 0x0x28
    public int <PJLLPOCAFNM>k__BackingField;    // 0x0x2C
    public int <NLLCIHHDFDK>k__BackingField;    // 0x0x30
    public string <HNLOLDBHKDC>k__BackingField;    // 0x0x38
    public string <AFODNCMNIFI>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// HJDPCICPBCN
//   (not directly referenced by a detected call)
public class HJDPCICPBCN
{
    public long <LMLJHIDIGPO>k__BackingField;    // 0x0x10
    public Guid? <DEKFDIJLKPC>k__BackingField;    // 0x0x18
}
...
public class HNLJHIJEPMJ
{
    public Guid? <NGCNCCOMJEP>k__BackingField;    // 0x0x10
    public Guid <KJAOOHIMJBM>k__BackingField;    // 0x0x24
}
...
// IDLCMMLKJCH
//   (not directly referenced by a detected call)
public class IDLCMMLKJCH
{
    public int <IBIMJIIELJF>k__BackingField;    // 0x0x10
    public HLCPHIPJJDJ <LOOPGBNIKND>k__BackingField;    // 0x0x14
    public List<DPBKOKJGKKN> <MCHADLOCOFC>k__BackingField;    // 0x0x18
    public List<DPBKOKJGKKN> <EHMFDPJLANP>k__BackingField;    // 0x0x20
    public bool <LGBILKJPOLO>k__BackingField;    // 0x0x28
    public DateTime? <HPAECIPKGKG>k__BackingField;    // 0x0x30
    public DateTime? <IMGKIFEIKFM>k__BackingField;    // 0x0x40
    public DateTime? <IFDENDFCJKI>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// IFPFAPEIOPE
//   (not directly referenced by a detected call)
public class IFPFAPEIOPE
{
    public Guid <MFLFBPGHEBJ>k__BackingField;    // 0x0x10
    public int <LLODALGPCPD>k__BackingField;    // 0x0x20
    public int <JELFBKIIMKC>k__BackingField;    // 0x0x24
    public Guid <PFOOPHCMGJL>k__BackingField;    // 0x0x28
    public DateTime <HMMPFEHOACH>k__BackingField;    // 0x0x38
    public JCBNJINJLCC <FEEIOHFKBMG>k__BackingField;    // 0x0x40
}
...
public class ILKOFMDNJPB : KEMJBFIIFNG
{
    public DMDMGLEDAOO? <KNHNKFKIBCP>k__BackingField;    // 0x0x18
    public JKHMOOOFLIE <CNGBEHFCBKH>k__BackingField;    // 0x0x20
}
...
public class IOEPLGABLOB
{
    public HNLJHIJEPMJ <EJNFBHINPBJ>k__BackingField;    // 0x0x10
    public HJDPCICPBCN <CINIKEPJKEI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JCBNJINJLCC
//   (not directly referenced by a detected call)
public class JCBNJINJLCC
{
    public Guid <MFLFBPGHEBJ>k__BackingField;    // 0x0x10
    public long <FKKBLIPOKOL>k__BackingField;    // 0x0x20
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x28
    public string <MHFFMHIBIPK>k__BackingField;    // 0x0x30
    public string <KNJFJPBCNNN>k__BackingField;    // 0x0x38
    public long <LMLJHIDIGPO>k__BackingField;    // 0x0x40
    public Guid? <POLALFLPNBP>k__BackingField;    // 0x0x48
    public DateTime <HMMPFEHOACH>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// JCEDJMEFBHP
//   RESPONSE ?      api/inventions/   [Service.API]
//   RESPONSE GET    api/inventions/v1/personaldetails/{kLALDKIEKEP}   [Service.API]
public class JCEDJMEFBHP
{
    public bool <BLMEPHBPHDO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JJOCADIABEA
//   (not directly referenced by a detected call)
public class JJOCADIABEA
{
    public OEGDMMCJPNM IKBMKCDAKFC;    // 0x0x10
    public int COKICPKJEAM;    // 0x0x14
}

// --------------------------------------------------------------------------
// JKHMOOOFLIE
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class JKHMOOOFLIE
{
    public int <LLODALGPCPD>k__BackingField;    // 0x0x10
    public Guid <DEKFDIJLKPC>k__BackingField;    // 0x0x14
    public long <HOJAIPKDOAL>k__BackingField;    // 0x0x28
    public DateTime <HMMPFEHOACH>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// JLPDMKCENFC
//   (not directly referenced by a detected call)
public class JLPDMKCENFC
{
    public long <EFJLABMEABM>k__BackingField;    // 0x0x10
    public long <IFLGGEPMGBN>k__BackingField;    // 0x0x18
    public int <EAGKDNDDILL>k__BackingField;    // 0x0x20
    public DateTime <LNHFKFGMIBN>k__BackingField;    // 0x0x28
    public BMBMBJCFNDK <LOOPGBNIKND>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// KAPJEJEIKGC
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class KAPJEJEIKGC
{
    public string <MFOJDFLFLPL>k__BackingField;    // 0x0x10
    public string <GAHFMHGOLIG>k__BackingField;    // 0x0x18
    public string <DJJDKHPKAAN>k__BackingField;    // 0x0x20
    public string <MHFFMHIBIPK>k__BackingField;    // 0x0x28
    public string <MMJAMONCHJC>k__BackingField;    // 0x0x30
    public FLCIBPNODMN <OKKKDOFJBOO>k__BackingField;    // 0x0x38
    public List<string> <EDMCIBCPENB>k__BackingField;    // 0x0x40
    public List<string> <AKDDHJAEHNP>k__BackingField;    // 0x0x48
    public string <FJKCHFJPOLJ>k__BackingField;    // 0x0x50
    public List<MPGIBCGBOLD> <CLKKFPFNLIO>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// KCMOEJCPJHD
//   (not directly referenced by a detected call)
public class KCMOEJCPJHD
{
    public int <PELBPHBHNJC>k__BackingField;    // 0x0x10
    public string <MNEPOGJLCBG>k__BackingField;    // 0x0x18
    public string <BKLDAFJLKKK>k__BackingField;    // 0x0x20
    public string <CBLHIOMKOAI>k__BackingField;    // 0x0x28
    public string <ELDEHDPCFFD>k__BackingField;    // 0x0x30
    public string <KCHAKPDBNAA>k__BackingField;    // 0x0x38
    public DHIAIDNKBPK? <FDCLFHGBFAC>k__BackingField;    // 0x0x40
    public string <EJMICLFPJBI>k__BackingField;    // 0x0x48
    public string <HLPMLPOGDIH>k__BackingField;    // 0x0x50
    public bool <CDFEGOOEHHN>k__BackingField;    // 0x0x58
    public bool <HAONPKMHBIM>k__BackingField;    // 0x0x59
    public bool <AAFFIPBKPIC>k__BackingField;    // 0x0x5A
    public HFEBNIHBFPK <LCBIMJJCOGB>k__BackingField;    // 0x0x5C
    public int <JKJBNMHPKIO>k__BackingField;    // 0x0x60
    public DFEJENLMKDJ <KNPAGHGPACO>k__BackingField;    // 0x0x64
    public int <KPODODGLFBA>k__BackingField;    // 0x0x68
    public MBALBCIPKOL <PEGFOHEINMJ>k__BackingField;    // 0x0x6C
    public COGNIFACPAI <JOFBPJHACEC>k__BackingField;    // 0x0x70
    public int? <NBPDHAGJFCE>k__BackingField;    // 0x0x74
    public string <CONNDMLFOEO>k__BackingField;    // 0x0x80
}
...
// KELBLFFJLOF
//   (not directly referenced by a detected call)
public class KELBLFFJLOF
{
    public int <HKMDHFCHAPC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KKIHOMDDPCE
//   (not directly referenced by a detected call)
public class KKIHOMDDPCE
{
    // (no instance fields in the metadata dump)
}
...
public class LCLGFFBJKHE
{
    public List<MPHGAFCMKDN> <ILCINGBMJNJ>k__BackingField;    // 0x0x10
    public string <LDFFADOAEPP>k__BackingField;    // 0x0x18
}
...
// LGBCNGENACE
//   (not directly referenced by a detected call)
public class LGBCNGENACE
{
    public float <IHEFDOFNONG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LGPJADMCLMC
//   (not directly referenced by a detected call)
public class LGPJADMCLMC
{
    public bool <MKOJLCOJIHF>k__BackingField;    // 0x0x10
    public PHGEJCPANNF <IBBJMKKCGFP>k__BackingField;    // 0x0x14
    public int <BLHLJHONNAM>k__BackingField;    // 0x0x18
    public DateTime <HMMPFEHOACH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LIOAOLCPEGC
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class LIOAOLCPEGC
{
    public Guid? <MFLFBPGHEBJ>k__BackingField;    // 0x0x10
    public long? <FKKBLIPOKOL>k__BackingField;    // 0x0x28
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x38
    public string <MHFFMHIBIPK>k__BackingField;    // 0x0x40
    public string <KNJFJPBCNNN>k__BackingField;    // 0x0x48
    public HJDPCICPBCN <AADHFAHDCNJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// LMGGIIGNONK
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class LMGGIIGNONK
{
    public PCFDKAHBGKA <DNHLIKBPFNJ>k__BackingField;    // 0x0x10
    public int <JJLHJLMEPLI>k__BackingField;    // 0x0x14
    public long <IDAKCKOEDMO>k__BackingField;    // 0x0x18
    public bool <NNDHILDCNNC>k__BackingField;    // 0x0x20
    public string <HHMMBDBLDMB>k__BackingField;    // 0x0x28
    public int? <FHMCEMOOPOO>k__BackingField;    // 0x0x30
    public bool <MIJAFKNIGMA>k__BackingField;    // 0x0x38
    public bool <MECALLMCNCB>k__BackingField;    // 0x0x39
    public bool <OGFBJDJFFPD>k__BackingField;    // 0x0x3A
    public string <BNBOCIHHBHD>k__BackingField;    // 0x0x40
    public DateTime? <HINKCKPLPPD>k__BackingField;    // 0x0x48
    public float <CBJDOBNIILP>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// LODNNNNFKGD
//   (not directly referenced by a detected call)
public class LODNNNNFKGD
{
    public int <APCCKJHKJKP>k__BackingField;    // 0x0x10
    public DateTime <LNHFKFGMIBN>k__BackingField;    // 0x0x18
    public DateTime? <PLJCNAJFDDA>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{aGHAPHOCGMD}   [Service.API]
...
public class MBOAOIIEHAO
{
    public GJNINCOJLIN <GAHPMGFAKBA>k__BackingField;    // 0x0x10
    public OHALHLGKPGK <KEHCIEBIJHG>k__BackingField;    // 0x0x18
    public PJKIJFHFKHC <MGLIGONJFDC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MIEPAEIBHAH
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.Econ]
public class MIEPAEIBHAH
{
    public int <BGEOGGAKKCC>k__BackingField;    // 0x0x10
    public string <JIFKOBGHPGO>k__BackingField;    // 0x0x18
    public List<NJLAKDIKBEF> <PBGKDBFMNOG>k__BackingField;    // 0x0x20
    public DDMHMKELNBH <GEIBLAFKJGN>k__BackingField;    // 0x0x28
    public string <IILLJNACPCM>k__BackingField;    // 0x0x30
    public DateTime <POBDCNJMKNN>k__BackingField;    // 0x0x38
    public DateTime <NJHKDFNABAK>k__BackingField;    // 0x0x40
    public DateTime <MHIHDIHPMGP>k__BackingField;    // 0x0x48
    public bool? <OELHNDMINOK>k__BackingField;    // 0x0x50
}
...
public class MMNFMEMKJLA
{
    public int <KFOFIFNPLFM>k__BackingField;    // 0x0x10
    public int <BIKIFPHEMGG>k__BackingField;    // 0x0x14
    public float <CJJCOCGICAD>k__BackingField;    // 0x0x18
    public float <GDCOBHDDCJD>k__BackingField;    // 0x0x1C
    public bool <AKGGGKAKJOE>k__BackingField;    // 0x0x20
    public bool <NMJIAPIJGAK>k__BackingField;    // 0x0x21
    public bool <CLAFLLIHCMJ>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// MOCDIADMAFG
//   (not directly referenced by a detected call)
public class MOCDIADMAFG
{
    public ObscuredLong <PIFNBHFONBO>k__BackingField;    // 0x0x10
    public string <MIMHMFMACPI>k__BackingField;    // 0x0x38
    public ObscuredInt <KDLACHKKKMA>k__BackingField;    // 0x0x40
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x58
    public string <MHFFMHIBIPK>k__BackingField;    // 0x0x60
    public string <KNJFJPBCNNN>k__BackingField;    // 0x0x68
    public int <PIFBENOIOEM>k__BackingField;    // 0x0x70
    public DGMIANMLLBL <FANJLPHPOFL>k__BackingField;    // 0x0x74
    public DateTime <HMMPFEHOACH>k__BackingField;    // 0x0x78
    public DateTime <LNHFKFGMIBN>k__BackingField;    // 0x0x80
    public DateTime? <FNJAJMPPHJE>k__BackingField;    // 0x0x88
    public long? <JLFFKFHOEML>k__BackingField;    // 0x0x98
    public int <NMEIIPADFHF>k__BackingField;    // 0x0xA8
    public int <NJOIBHHAGPJ>k__BackingField;    // 0x0xAC
    public int <CNIHEBOEKAG>k__BackingField;    // 0x0xB0
    public IBOIGDJIHKO <EKHIMHIGBEO>k__BackingField;    // 0x0xB4
    public IBOIGDJIHKO <FDEPEPAHCKL>k__BackingField;    // 0x0xB8
    public ObscuredBool <PJDGFHPMEGD>k__BackingField;    // 0x0xBC
    public ObscuredBool <COIBKLPBBLO>k__BackingField;    // 0x0xC8
    public ObscuredBool <JCAJNNDEFBI>k__BackingField;    // 0x0xD4
    public int? <LMLJHIDIGPO>k__BackingField;    // 0x0xE0
    public bool <EOBGJPNKMGA>k__BackingField;    // 0x0xE8
}
...
public class MPDPFCGNLNN
{
    public DJICACPKOIE <DNHLIKBPFNJ>k__BackingField;    // 0x0x10
    public string <GLEOCOEBMEP>k__BackingField;    // 0x0x18
    public int? <DLFDKKCGJDN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MPGIBCGBOLD
//   (not directly referenced by a detected call)
public class MPGIBCGBOLD
{
    public DateTime <LNHFKFGMIBN>k__BackingField;    // 0x0x10
    public string <MLHCPNOBDKO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MPHGAFCMKDN
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class MPHGAFCMKDN
{
    public long <IFLGGEPMGBN>k__BackingField;    // 0x0x10
    public int <KDLACHKKKMA>k__BackingField;    // 0x0x18
    public long <FKKBLIPOKOL>k__BackingField;    // 0x0x20
    public long? <GJGODEOBEKI>k__BackingField;    // 0x0x28
    public long? <MMGCGHMPNDL>k__BackingField;    // 0x0x38
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x48
    public string <MHFFMHIBIPK>k__BackingField;    // 0x0x50
    public string <KNJFJPBCNNN>k__BackingField;    // 0x0x58
    public DateTime <HILMCFMMJOP>k__BackingField;    // 0x0x60
    public DateTime <NMMGNPEAEEH>k__BackingField;    // 0x0x68
    public int <ONMNONOBKOF>k__BackingField;    // 0x0x70
    public AJKKGGDFEJB <FANJLPHPOFL>k__BackingField;    // 0x0x74
    public bool <EBGHPALPHBH>k__BackingField;    // 0x0x78
    public bool <BBOKAJCJCAP>k__BackingField;    // 0x0x79
    public CCLILJNJGLI <HFAGKFBLKNA>k__BackingField;    // 0x0x7C
    public CCLILJNJGLI <LBLKEIBFHLB>k__BackingField;    // 0x0x80
    public long? <PMNMOFDJAMI>k__BackingField;    // 0x0x88
}
...
// NAKMFKDCHBA
//   (not directly referenced by a detected call)
public class NAKMFKDCHBA
{
    public int <CKLPLADDDGL>k__BackingField;    // 0x0x10
    public OHALHLGKPGK <KEHCIEBIJHG>k__BackingField;    // 0x0x14
}
...
//   RESPONSE GET    api/avatar/v2/{lLCBCAFBFBO}   [Service.Econ]
public class NDCBIHMPFFD
{
    public string <GDEBHFFGPIK>k__BackingField;    // 0x0x10
    public string <GLHHBMNPKLH>k__BackingField;    // 0x0x18
    public string <EACBOKDOLFJ>k__BackingField;    // 0x0x20
    public string <BKJLMCHLGDA>k__BackingField;    // 0x0x28
    public string <IJGNNLLBOKM>k__BackingField;    // 0x0x30
    public List<HBMCCPGNIEI> <EKFNIIAHNMN>k__BackingField;    // 0x0x38
}
...
public class NEMNOKOJFPK
{
    public GLOMMPCDBFE <OKKKDOFJBOO>k__BackingField;    // 0x0x10
    public MOCDIADMAFG <IHBHNLJKBBF>k__BackingField;    // 0x0x18
    public HHIICPJLODF <PJJAAOCAMNL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NIDOHEKGPCP
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class NIDOHEKGPCP
{
    public bool <PNELGANJCEE>k__BackingField;    // 0x0x10
    public string <GAHFMHGOLIG>k__BackingField;    // 0x0x18
    public string <ONOKBEKKOOI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NIJNIBIDOGF
//   REQUEST  POST   api/avatar/v3/saved/set   [Service.Econ]
public class NIJNIBIDOGF
{
    public int <MFEKICLDBPE>k__BackingField;    // 0x0x10
    public string <MKAJBIJBMFJ>k__BackingField;    // 0x0x18
    public string <GDEBHFFGPIK>k__BackingField;    // 0x0x20
    public string <GLHHBMNPKLH>k__BackingField;    // 0x0x28
    public string <EACBOKDOLFJ>k__BackingField;    // 0x0x30
    public string <BKJLMCHLGDA>k__BackingField;    // 0x0x38
    public string <IJGNNLLBOKM>k__BackingField;    // 0x0x40
    public List<HBMCCPGNIEI> <EKFNIIAHNMN>k__BackingField;    // 0x0x48
}
...
public class NJDPEFIAIDG
{
    public bool <EIJCNFCBOBJ>k__BackingField;    // 0x0x10
    public string <HHMMBDBLDMB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NJLAKDIKBEF
//   (not directly referenced by a detected call)
public class NJLAKDIKBEF
{
    public int <OLIOIMBGAIO>k__BackingField;    // 0x0x10
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x18
    public string <BDPOJDNGDBL>k__BackingField;    // 0x0x20
    public string <MHFFMHIBIPK>k__BackingField;    // 0x0x28
    public string <BKLDAFJLKKK>k__BackingField;    // 0x0x30
    public bool <LPKMHPHEEBO>k__BackingField;    // 0x0x38
    public int <MFEKICLDBPE>k__BackingField;    // 0x0x3C
    public KKIHOMDDPCE <LIEANMLNKJF>k__BackingField;    // 0x0x40
    public NPNNGAFGGFE LODANBLAKLB;    // 0x0x48
    public NPNNGAFGGFE EEKLCDCBMOF;    // 0x0x50
    public NPNNGAFGGFE BAAONNOGIPL;    // 0x0x58
    public NLOGPPNKPIJ JEAHKKBHAMA;    // 0x0x60
}

// --------------------------------------------------------------------------
// NOOPGHFDIJK
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Econ]
public class NOOPGHFDIJK
{
    public Guid <CBDALHKKHJJ>k__BackingField;    // 0x0x10
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x20
    public string <KNJFJPBCNNN>k__BackingField;    // 0x0x28
    public DateTime <POBDCNJMKNN>k__BackingField;    // 0x0x30
    public DateTime? <GEJHHICEPBB>k__BackingField;    // 0x0x38
    public List<CIOOPDFMPBG> <AKNPHPLGKJO>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// OBMFMPABLLK
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class OBMFMPABLLK
{
    public List<EAICFOJGLPE> <AKDDHJAEHNP>k__BackingField;    // 0x0x10
}
...
//   RESPONSE GET    api/storefronts/v1/season/{oOINLFGAOKK}   [Service.Econ]
public class OBPBCCDMHCA : LLGJACLNLEK
{
    public int <MHCFKGPDJKK>k__BackingField;    // 0x0x30
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x38
    public DateTime <POBDCNJMKNN>k__BackingField;    // 0x0x40
    public DateTime <NJHKDFNABAK>k__BackingField;    // 0x0x48
    public DFEJENLMKDJ <KNPAGHGPACO>k__BackingField;    // 0x0x50
    public IDLCMMLKJCH <EEJHCCFHPEG>k__BackingField;    // 0x0x58
    public List<FCJAOHDHGPD> <EIPIDOBNOPN>k__BackingField;    // 0x0x60
    public LGPJADMCLMC <LDLPJACAJND>k__BackingField;    // 0x0x68
}
...
// --------------------------------------------------------------------------
// OEGLPKMAEAC
// base   : FFGPIOOIMBF<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class OEGLPKMAEAC
{
    // (no instance fields in the metadata dump)
}
...
public class OOEJMGGHDBK
{
    public string <FLDBHOIDPOJ>k__BackingField;    // 0x0x10
    public string <GOHOCBGNHLK>k__BackingField;    // 0x0x18
    public bool <OEKOHGHPLDD>k__BackingField;    // 0x0x20
    public string <APCCGECEDOP>k__BackingField;    // 0x0x28
}
...
public class PBAKMLAPFCO
{
    public OELCEHIFAEC <OKKKDOFJBOO>k__BackingField;    // 0x0x10
    public AHNNGJMCKIJ <EIOEDCEEJNI>k__BackingField;    // 0x0x18
}
...
public class PENHCMCKIFN
{
    public DFEJENLMKDJ <KNPAGHGPACO>k__BackingField;    // 0x0x10
    public BMCOGNHHBDJ <FPOCNMNMLEL>k__BackingField;    // 0x0x14
    public int <BNHIPCEJNJK>k__BackingField;    // 0x0x18
    public int <NEDACDKMKIM>k__BackingField;    // 0x0x1C
    public int <IBBLLBPGLOF>k__BackingField;    // 0x0x20
    public DNMHEHDPGEP <MCGBGAIMFKA>k__BackingField;    // 0x0x24
    public bool <FPCADJAIKLM>k__BackingField;    // 0x0x28
    public float <JBNPAPPHIOO>k__BackingField;    // 0x0x2C
    public int <BCCBHNCMPMO>k__BackingField;    // 0x0x30
    public bool <NONBICMCGCK>k__BackingField;    // 0x0x34
}
...
public class PJKIJFHFKHC
{
    public FOJGAGGAMPG <KEHCIEBIJHG>k__BackingField;    // 0x0x10
    public List<string> <AKDDHJAEHNP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PPOFLBAHGPJ
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class PPOFLBAHGPJ
{
    public List<int> <CBKGOGKCAFN>k__BackingField;    // 0x0x10
    public string <LDFFADOAEPP>k__BackingField;    // 0x0x18
}
...
{
    public long <FKKBLIPOKOL>k__BackingField;    // 0x0x10
    public long? <GJGODEOBEKI>k__BackingField;    // 0x0x18
    public HKHJHFEFCAI <KMDIFNGOENH>k__BackingField;    // 0x0x28
}
...
{
    public HKFAIAFCMAN <KEHCIEBIJHG>k__BackingField;    // 0x0x10
    public string <MBHPAEBNELN>k__BackingField;    // 0x0x18
    public string <OIEKBBBPOFJ>k__BackingField;    // 0x0x20
    public string <EGMLDABMOOC>k__BackingField;    // 0x0x28
}
...
{
    public long <IFLGGEPMGBN>k__BackingField;    // 0x0x10
    public long? <IPBENAHKDIP>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public HBHOMPFCKGK FilterType;    // 0x0x20
...
{
    public HKHJHFEFCAI <KNCGMDCAHHN>k__BackingField;    // 0x0x10
    public string <GILFPLNEEKH>k__BackingField;    // 0x0x18
    public int <IPBOIDNGLEI>k__BackingField;    // 0x0x20
    public int <AKJNGFMNGPE>k__BackingField;    // 0x0x24
    public string <AFJNNJHJBIA>k__BackingField;    // 0x0x28
    public string <PDLNMBJNPDO>k__BackingField;    // 0x0x30
}
...
{
    public int <LLODALGPCPD>k__BackingField;    // 0x0x10
    public Guid <CEJNEEBONML>k__BackingField;    // 0x0x14
    public DateTime <FPIOMNDLPJK>k__BackingField;    // 0x0x28
}
...
{
    public bool <KELCCFHEMGI>k__BackingField;    // 0x0x10
    public int <FNJMMNPFGPH>k__BackingField;    // 0x0x14
    public bool <HNNIAIBCPAM>k__BackingField;    // 0x0x18
}
...
{
    public Guid <CEJNEEBONML>k__BackingField;    // 0x0x10
    public HKHJHFEFCAI <JOMEJHPFCBP>k__BackingField;    // 0x0x20
    public int <FOJCLJFLLIN>k__BackingField;    // 0x0x24
    public long <FKKBLIPOKOL>k__BackingField;    // 0x0x28
    public long? <GJGODEOBEKI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{cBMNOMNPHCG}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <EAGGOGNMLGN>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <OHGAEHJKDFO>k__BackingField;    // 0x0x18
}
...
{
    public long <EIEGHCOPPED>k__BackingField;    // 0x0x10
    public long <FKKBLIPOKOL>k__BackingField;    // 0x0x18
    public long <DPIAKBOLPLM>k__BackingField;    // 0x0x20
    public JEDPECJCFGP <LOOPGBNIKND>k__BackingField;    // 0x0x28
    public int <LEHKOMCGNCG>k__BackingField;    // 0x0x2C
}
...
{
    public long <FKKBLIPOKOL>k__BackingField;    // 0x0x10
    public List<Guid> <DCIJIMDHCJM>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <EAGGOGNMLGN>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <OHGAEHJKDFO>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <KAPBDLDKNEH>k__BackingField;    // 0x0x20
}
...
{
    public long <DPIAKBOLPLM>k__BackingField;    // 0x0x10
    public long <LGODAOLOEDH>k__BackingField;    // 0x0x18
    public int? <DANGODAGMCP>k__BackingField;    // 0x0x20
    public int? <POMFNIPNJGK>k__BackingField;    // 0x0x28
    public long? <GNEBCCALCLN>k__BackingField;    // 0x0x30
    public long <KMNENAMFEEJ>k__BackingField;    // 0x0x40
    public long <NNAMJCPNOAA>k__BackingField;    // 0x0x48
    public int <OCDMPGAKAMA>k__BackingField;    // 0x0x50
    public JEDPECJCFGP <HFHHJFEKGAA>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <JOECEHKAKNB>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public COGNIFACPAI <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public KKCLEFJALJE creatorAccountRole;    // 0x0x58
}
...
{
    public ICJJAMHPIGI <FNKANIPLPIA>k__BackingField;    // 0x0x10
    public AHCKCIJDBAK <PPNKLCCNOND>k__BackingField;    // 0x0x14
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x18
    public string <MHFFMHIBIPK>k__BackingField;    // 0x0x20
    public bool <GBIKLLFIMFI>k__BackingField;    // 0x0x28
}
...
{
    public List<ICJJAMHPIGI> <LEIOOAJNBOP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{aGHAPHOCGMD}   [Service.API]
public class ProgressionEventDTO
{
    public long <LGODAOLOEDH>k__BackingField;    // 0x0x10
    public string <NHBEHMHOIJM>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <EAGFNOHNCFI>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <HIOJGBCJEAF>k__BackingField;    // 0x0x28
    public DateTime <HILMCFMMJOP>k__BackingField;    // 0x0x30
    public DateTime <NMMGNPEAEEH>k__BackingField;    // 0x0x38
    public DateTime <PAAMLBCKBAM>k__BackingField;    // 0x0x40
    public bool <BGNMDLEBGLI>k__BackingField;    // 0x0x48
    public int <MFHMMBIAPHL>k__BackingField;    // 0x0x4C
    public float <ILADIBFGKGM>k__BackingField;    // 0x0x50
    public Guid? <LDBKPINAANK>k__BackingField;    // 0x0x54
    public string <IIJIOLAMBGJ>k__BackingField;    // 0x0x68
    public string <BCBEMFLJHPC>k__BackingField;    // 0x0x70
    public string <CFPOHILMLIA>k__BackingField;    // 0x0x78
    public string <HGPLIKJFAFF>k__BackingField;    // 0x0x80
}
...
{
    public Guid <LAKAFKBHJKG>k__BackingField;    // 0x0x10
    public int <APCHDJKMLIH>k__BackingField;    // 0x0x20
    public int <KJCGLFHOFHL>k__BackingField;    // 0x0x24
    public int <HIBNKAHFAMH>k__BackingField;    // 0x0x28
    public long <CLKDAGBHBJP>k__BackingField;    // 0x0x30
    public long <LCMEFIIDIJG>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/record/{aGHAPHOCGMD}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <LLODALGPCPD>k__BackingField;    // 0x0x10
    public int <LLPOGPBFJLI>k__BackingField;    // 0x0x14
    public int <CKDLJIFLNDH>k__BackingField;    // 0x0x18
    public int <EMDCGNGMIBO>k__BackingField;    // 0x0x1C
    public int <MDAAIBNEGEL>k__BackingField;    // 0x0x20
    public DateTime? <DBIIIALBMKB>k__BackingField;    // 0x0x28
}
...
{
    public long <GJDJMLGKCDD>k__BackingField;    // 0x0x10
    public int <PELBPHBHNJC>k__BackingField;    // 0x0x18
    public string <KNJFJPBCNNN>k__BackingField;    // 0x0x20
    public int <LLPOGPBFJLI>k__BackingField;    // 0x0x28
    public int <KCBFGEBGJCD>k__BackingField;    // 0x0x2C
    public bool <IOJMAIFELDF>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public PPIMANLIHNF ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool ALGAFHIAMLI;    // 0x0x28
}
...
{
    public PACHKDGMMLK? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public PACHKDGMMLK JFHIMEFMEJP;  // wrapper
...
{
    public BGCMCLJOHOO JIKLHGKOPKM;  // wrapper
...
{
    public ODIIJKGIJND MAIOHDHBGKE;  // wrapper
    public int? BMPKAOLCOLC;  // wrapper
...
{
    public PCFDKAHBGKA NDIMKEGEPOA;  // wrapper
    public float? IAEDPBLIOBG;  // wrapper
...
{
    public LCBOJLNFDJO UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public COGNIFACPAI KPEPJOHCOMD;  // wrapper
    public COGNIFACPAI? MFNGDCJMBMN;  // wrapper
...
{
    public NJLAKDIKBEF FNFGKJKNBNP;  // wrapper
...
{
    public DGMIANMLLBL OCIIPIMBFDO;  // wrapper
    public byte[] AFEIKJPFIFG;  // wrapper
    public byte[] JPDGPJFGOMF;  // wrapper
    public Color HCHGJCCJIHO;  // wrapper
...
{
    public List<EIAMCCGPHOM> DNPLNDGCEAK;  // wrapper
}
...
{
    public EFLMMOPANGC KMCKLICBKBG;  // wrapper
    public COGNIFACPAI? BAICFHEJNAG;  // wrapper
...
{
    public ILMFMMHDIMJ FBEHAPIAPHF;  // wrapper
...
{
    public MOCDIADMAFG inventionId;  // wrapper
}
...
// api/keepsakes/{lOLLNBGLCPK}/collect  [API POST]
public class KeepsakesLOLLNBGLCPKCollectRequest
{
    public Guid LOLLNBGLCPK;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> FILGANKAPDI;  // wrapper
    public HOHIBMJHOEO PFHGCANFDLN;  // wrapper
    public long? JNEOKPAKAMP;  // wrapper
...
{
    public long? GINOMKDCFML;  // wrapper
    public long? AJMPIOAEHBE;  // wrapper
    public List<string> OOKALKNOANK;  // wrapper
    public DateTime MIJNONLKFAG;  // wrapper
    public DateTime HACJBAPFMGG;  // wrapper
    public AJKKGGDFEJB OCIIPIMBFDO;  // wrapper
    public CCLILJNJGLI KGGEJBBLPDJ;  // wrapper
    public CCLILJNJGLI FLJOJGJFGDF;  // wrapper
}
...
{
    public CCLILJNJGLI KGGEJBBLPDJ;  // wrapper
    public CCLILJNJGLI ODIKCJLDHAM;  // wrapper
}
...
{
    public Guid POCEEBHEICK;  // wrapper
...
{
    public List<FCNKOMBGGCD> HLBGLFJEOML;  // wrapper
}
...
{
    public Guid NCCNPDEFFFK;  // wrapper
    public object Price;  // candidate
...
{
    public Guid NCCNPDEFFFK;  // wrapper
    public long? EKHKCCDCCNK;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Limit;  // candidate
...
{
    public Guid POCEEBHEICK;  // wrapper
    public long? MFICLFGJOCO;  // wrapper
    public long? CEAMBJLLCML;  // wrapper
    public int? JJGGEMMMIDG;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> FGGPHJMDLJN;  // wrapper
...
{
    public Guid? DOBPLFKJHMI;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object RoomId;  // candidate
...
{
    public PCFDKAHBGKA NDIMKEGEPOA;  // wrapper
    public long? GJLAFGLLCJM;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats DDEBMHKEAOF;  // wrapper
}
...
{
    public Guid JEFBEBIKIAG;  // wrapper
...
{
    public Guid DBIEGOHDCPD;  // wrapper
...
{
    public List<PPHDGNKAHBD> MIIPMNGGOKG;  // wrapper
    public object roomId;  // candidate
...
{
    public FLCIBPNODMN KGHELNIONHE;  // wrapper
}
