...
public class ADPBGDNEIGI
{
    public OEPBHDOHLLJ <CLOKECLALCN>k__BackingField;    // 0x0x10
    public ONOPNIHGHBP <GHGNDMEGPGE>k__BackingField;    // 0x0x14
    public int <BDKNLGNJDGD>k__BackingField;    // 0x0x18
    public int <HIMKCPHJGKM>k__BackingField;    // 0x0x1C
    public int <PMAKDJLJBAM>k__BackingField;    // 0x0x20
    public ABJNNJCDEAO <KKBBHBJIALK>k__BackingField;    // 0x0x24
    public bool <BBBJOFGCODC>k__BackingField;    // 0x0x28
    public float <KOJEIAHBFBG>k__BackingField;    // 0x0x2C
    public int <NLACGJHKJIN>k__BackingField;    // 0x0x30
    public bool <EOKGCHJPOKB>k__BackingField;    // 0x0x34
}
...
public class AGKEIAGGCPB
{
    public PLBKFOGDDEJ <DFBCHEMKJDM>k__BackingField;    // 0x0x10
}
...
public class BDOFPAFDBIE
{
    public string <FFHIJDCPGJP>k__BackingField;    // 0x0x10
    public string <CLJIMGPFOEO>k__BackingField;    // 0x0x18
    public string <JMIPKJFAKNI>k__BackingField;    // 0x0x20
    public string <HLONFFAMEPK>k__BackingField;    // 0x0x28
    public string <MCDFENCAKAN>k__BackingField;    // 0x0x30
    public OPDLNPOBNFB <EIEGEJODGMF>k__BackingField;    // 0x0x38
    public List<string> <OCCKJEAGGBJ>k__BackingField;    // 0x0x40
    public List<string> <PEGGLGNHEAH>k__BackingField;    // 0x0x48
    public string <HOGJNAEIKHN>k__BackingField;    // 0x0x50
    public List<KIJFFMNHGIL> <GDPKMKIGGGI>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// BEICFJCPAHJ
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.Econ]
public class BEICFJCPAHJ
{
    public int <IHOMKAAOOKI>k__BackingField;    // 0x0x10
    public string <COCMMOENBGM>k__BackingField;    // 0x0x18
    public List<PFPNIBOPABP> <CMAPBGHELBG>k__BackingField;    // 0x0x20
    public PLLPKGHGPCJ <IAAKLLGGNGB>k__BackingField;    // 0x0x28
    public string <JAIBLEFFDKN>k__BackingField;    // 0x0x30
    public DateTime <PNDNELBIEMM>k__BackingField;    // 0x0x38
    public DateTime <MAAPJDLFPED>k__BackingField;    // 0x0x40
    public DateTime <KKOGJGAGBCJ>k__BackingField;    // 0x0x48
    public bool? <CNCJFONOEOG>k__BackingField;    // 0x0x50
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{dPEHGEKABMF}   [Service.API]
...
public class BFNPECBOHOL
{
    public HIMKFNBEAEK <DBKALMLBNJB>k__BackingField;    // 0x0x10
    public PLBKFOGDDEJ <DFBCHEMKJDM>k__BackingField;    // 0x0x18
    public MPADJGEAPCL <PPCPJOJEBOA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BKJBFNAJMCO
//   (not directly referenced by a detected call)
public class BKJBFNAJMCO
{
    public int <ELNGCOAIBNF>k__BackingField;    // 0x0x10
    public DateTime? <MJCDADECCKF>k__BackingField;    // 0x0x18
    public DateTime? <GLPCPGHHFFG>k__BackingField;    // 0x0x28
}
...
public class BLOHHONKAIC
{
    public int <CNOKFHMOFEK>k__BackingField;    // 0x0x10
    public LEJHKHDGMEN <BLINNIONLAJ>k__BackingField;    // 0x0x14
    public FHNIHFNBOGP <BDIGDPLNDML>k__BackingField;    // 0x0x18
    public FHNIHFNBOGP <EJDACNBAEIN>k__BackingField;    // 0x0x1C
    public FHNIHFNBOGP <KAMFDJPCELE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BOHMODCOCMF
//   (not directly referenced by a detected call)
public class BOHMODCOCMF
{
    public Guid <IOMPONNHCEK>k__BackingField;    // 0x0x10
    public int <CNPCHDHOAPJ>k__BackingField;    // 0x0x20
    public int <AKIKNENMIDL>k__BackingField;    // 0x0x24
    public Guid <EOBMBJBJBLL>k__BackingField;    // 0x0x28
    public DateTime <ACKHGPAPEHM>k__BackingField;    // 0x0x38
    public MNEBBMHJIAJ <DHPPGFCKOAH>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// BPHFCLGGPBJ
//   (not directly referenced by a detected call)
public class BPHFCLGGPBJ
{
    public int <NKBIBAEOLOP>k__BackingField;    // 0x0x10
}
...
// CCLFKIPGEIG
//   (not directly referenced by a detected call)
public class CCLFKIPGEIG
{
    public long <AODLBMBPOJB>k__BackingField;    // 0x0x10
    public long <ENCPGPLMNNL>k__BackingField;    // 0x0x18
    public int <CHHHOMNKHAP>k__BackingField;    // 0x0x20
    public DateTime <MPFHJILALMF>k__BackingField;    // 0x0x28
    public HKKPLLGAAOH <BLINNIONLAJ>k__BackingField;    // 0x0x30
}
...
public class CEAGAHGKPJE
{
    public Guid? <OKLNHAFALCB>k__BackingField;    // 0x0x10
    public Guid <DADDPGJPKCL>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// CFJMFEKMCIH
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class CFJMFEKMCIH
{
    public Guid? <IOMPONNHCEK>k__BackingField;    // 0x0x10
    public long? <MAAAIIIBFLP>k__BackingField;    // 0x0x28
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x38
    public string <HLONFFAMEPK>k__BackingField;    // 0x0x40
    public string <NDIKKLKAIFC>k__BackingField;    // 0x0x48
    public FHKLKEEJBDM <FDMICLHEGEF>k__BackingField;    // 0x0x50
}
...
//   RESPONSE GET    api/avatar/v2/{fKAHKHEFNKK}   [Service.Econ]
public class CGJBIPAEAOJ
{
    public string <OGFOONHKDHN>k__BackingField;    // 0x0x10
    public string <PCLBPLMBAEB>k__BackingField;    // 0x0x18
    public string <FBNJFKDJCAB>k__BackingField;    // 0x0x20
    public string <PBOKIPGALKM>k__BackingField;    // 0x0x28
    public string <AGJHIJCFEGK>k__BackingField;    // 0x0x30
    public List<GLIBAGCCLFD> <JFOBCBJKMGJ>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// CHOMGGCFBMB
//   (not directly referenced by a detected call)
public class CHOMGGCFBMB
{
    public int <PMHBPPMOCJO>k__BackingField;    // 0x0x10
    public PLBKFOGDDEJ <DFBCHEMKJDM>k__BackingField;    // 0x0x14
}
...
public class CJDACKGJLNM
{
    public int <HDDDCBAMGKE>k__BackingField;    // 0x0x10
    public bool <HPDAKLFLJOB>k__BackingField;    // 0x0x14
    public DateTime <LPCNJDFIBCP>k__BackingField;    // 0x0x18
    public bool <ANONCKADDMH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CJHGBFCNLBI
//   (not directly referenced by a detected call)
public class CJHGBFCNLBI
{
    public OEPBHDOHLLJ <CLOKECLALCN>k__BackingField;    // 0x0x10
    public int <LLCMOLOIBFF>k__BackingField;    // 0x0x14
    public BKJBFNAJMCO <GOPFCCDMLEP>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/playerevents/v1/all/{fKAHKHEFNKK}   [Service.API]
public class DBGODFBCDLI
{
    public List<IFBOHPHODNG> <LJJKDHHLGNM>k__BackingField;    // 0x0x10
    public List<KAJBFJCCLAK> <ACILKMKOBNG>k__BackingField;    // 0x0x18
}
...
public class DCABJJIMIKN
{
    public List<string> <HCNDIDGIKPE>k__BackingField;    // 0x0x10
    public List<string> <KIAHMMAGBGA>k__BackingField;    // 0x0x18
    public List<string> <BPPIDLEGLHJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DGDNOFJJPNI
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class DGDNOFJJPNI
{
    public int <CNPCHDHOAPJ>k__BackingField;    // 0x0x10
    public Guid <JLJBKGACNFG>k__BackingField;    // 0x0x14
    public long <JNOPKGKBDGD>k__BackingField;    // 0x0x28
    public DateTime <ACKHGPAPEHM>k__BackingField;    // 0x0x30
}
...
// --------------------------------------------------------------------------
// DIBFJPMNDJE
// base   : AAEFDCECCFC<MMPDNPLNFLF>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{iCINGKHNEEP}   [Service.API]
public class DIBFJPMNDJE
{
    // (no instance fields in the metadata dump)
}
...
// DJCAGLKIIGP
//   (not directly referenced by a detected call)
public class DJCAGLKIIGP
{
    public bool <EOGEJEFBFFH>k__BackingField;    // 0x0x10
    public GEEKDBNABDD <BDICEAAGAAF>k__BackingField;    // 0x0x14
    public int <LAFNDEJKKIP>k__BackingField;    // 0x0x18
    public DateTime <ACKHGPAPEHM>k__BackingField;    // 0x0x20
}
...
public class DMMOHHDICIJ
{
    public List<int> <PIOMAPLMMLE>k__BackingField;    // 0x0x10
    public string <IFMPJOIDLIB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EAPIHABOMHB
//   (not directly referenced by a detected call)
public class EAPIHABOMHB
{
    public GMDOGDFKIIH FLCKIMDLHBH;    // 0x0x10
    public int LKHMHFNBCLB;    // 0x0x14
}

// --------------------------------------------------------------------------
// EEKKKLACCOO
//   (not directly referenced by a detected call)
public class EEKKKLACCOO
{
    public Guid <EAHLPGBEFHH>k__BackingField;    // 0x0x10
    public Guid <LBIBBENMCAG>k__BackingField;    // 0x0x20
    public DateTime <PNDNELBIEMM>k__BackingField;    // 0x0x30
    public List<OKJLDNJDFCH> <KHOJJIINMIA>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// EGPGABPODDO
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class EGPGABPODDO
{
    public int <IBGEEAALGIO>k__BackingField;    // 0x0x10
    public int <BJALLKLHDNH>k__BackingField;    // 0x0x14
    public float <GEBNKOFHPEN>k__BackingField;    // 0x0x18
    public int <DOCJGNAAMPP>k__BackingField;    // 0x0x1C
    public int <APOCHNCHBLD>k__BackingField;    // 0x0x20
    public int <PAIKKEJLJOJ>k__BackingField;    // 0x0x24
    public int <FGBJHBEKDOD>k__BackingField;    // 0x0x28
    public string <JLBMFPBOCDB>k__BackingField;    // 0x0x30
    public string <CHIHIBHMBOI>k__BackingField;    // 0x0x38
}
...
public class EIACFNBLBPI
{
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x10
    public string <HLONFFAMEPK>k__BackingField;    // 0x0x18
    public int? <LLCMOLOIBFF>k__BackingField;    // 0x0x20
    public EHMKNPKFFJM? <KLBEJHPEMGH>k__BackingField;    // 0x0x28
}
...
public class ELPGFCCPOHP
{
    public long <EELIHGKKGKJ>k__BackingField;    // 0x0x10
    public int <CNPCHDHOAPJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EPEBPHHADLD
//   (not directly referenced by a detected call)
public class EPEBPHHADLD
{
    public float <LDKAHNLBIKG>k__BackingField;    // 0x0x10
    public float <AFPEMFAJKEB>k__BackingField;    // 0x0x14
    public float <FJPJFICDOHB>k__BackingField;    // 0x0x18
    public float <CCHJENPCJLB>k__BackingField;    // 0x0x1C
    public float <BPCNBHNLDEC>k__BackingField;    // 0x0x20
    public float <JIPKFILKLHB>k__BackingField;    // 0x0x24
    public float <APOOEIMFDKG>k__BackingField;    // 0x0x28
    public float <HBOLFOJEMPE>k__BackingField;    // 0x0x2C
}
...
public class FDICNNMKHFK
{
    public int <FIPCKIFKDDN>k__BackingField;    // 0x0x10
    public int <HDDDCBAMGKE>k__BackingField;    // 0x0x14
    public float <EJJCGPDIHDN>k__BackingField;    // 0x0x18
    public float <IOLAHEBIDJN>k__BackingField;    // 0x0x1C
    public bool <HPDAKLFLJOB>k__BackingField;    // 0x0x20
    public bool <LHGBAKHCDOP>k__BackingField;    // 0x0x21
    public bool <IEPJJNCACEH>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// FHKLKEEJBDM
//   (not directly referenced by a detected call)
public class FHKLKEEJBDM
{
    public long <LLCMOLOIBFF>k__BackingField;    // 0x0x10
    public Guid? <JLJBKGACNFG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FHMFABEAPML
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class FHMFABEAPML
{
    public Dictionary<Guid, NACIKOBMKAF> <COCOPOCIEIK>k__BackingField;    // 0x0x10
}
...
// base   : DFMPHCHAOCP
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{nAOBILBPNNP}   [Service.Econ]
public class FPKOCGHCDON : DFMPHCHAOCP
{
    public int <DPNEJMBBPJD>k__BackingField;    // 0x0x30
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x38
    public DateTime <PNDNELBIEMM>k__BackingField;    // 0x0x40
    public DateTime <MAAPJDLFPED>k__BackingField;    // 0x0x48
    public OEPBHDOHLLJ <CLOKECLALCN>k__BackingField;    // 0x0x50
    public IFOGDPCPAHA <NFAJELBHIMD>k__BackingField;    // 0x0x58
    public List<JCJFODADAKO> <DPLFJALGLBM>k__BackingField;    // 0x0x60
    public DJCAGLKIIGP <AAGLLGPFDAN>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// GBCFJOFHABC
//   (not directly referenced by a detected call)
public class GBCFJOFHABC
{
    public int <JLGHJPBEPKO>k__BackingField;    // 0x0x10
    public CEAGAHGKPJE <FEMFMDMFKEH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GCPNMACHADG
//   (not directly referenced by a detected call)
public class GCPNMACHADG
{
    // (no instance fields in the metadata dump)
}
...
public class GDEFIGGJCGK
{
    public bool <IBIOMOKNNAM>k__BackingField;    // 0x0x10
    public string <KOCAIOFOPBD>k__BackingField;    // 0x0x18
}
...
public class GHEMJKEKMEN
{
    public List<CHOMGGCFBMB> <NONCHLPELGN>k__BackingField;    // 0x0x10
    public PLBKFOGDDEJ <DFBCHEMKJDM>k__BackingField;    // 0x0x18
}
...
public class GICKGDPIEIM
{
    public long <MAAAIIIBFLP>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <EHOPFNPAONL>k__BackingField;    // 0x0x18
    public CADIJJDDGPK <MMKPCCPLHCE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GLIBAGCCLFD
//   (not directly referenced by a detected call)
public class GLIBAGCCLFD
{
    public Guid <EPGODGMKGKG>k__BackingField;    // 0x0x10
    public byte <LOKHNGPFDCA>k__BackingField;    // 0x0x20
}
...
public class HDHBKECOEIJ
{
    public ELCBGGLGKAB <EIEGEJODGMF>k__BackingField;    // 0x0x10
    public ILCCMAACEHH <AONMKLDKGKG>k__BackingField;    // 0x0x18
}
...
public class HIMKFNBEAEK : IFBOHPHODNG
{
    public List<LBACAMFPLMM> <PEGGLGNHEAH>k__BackingField;    // 0x0x98
}
...
public class ICKFHOLPFHF
{
    public Guid <IMPLBEALNMK>k__BackingField;    // 0x0x10
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x20
    public string <NDIKKLKAIFC>k__BackingField;    // 0x0x28
    public DateTime <PNDNELBIEMM>k__BackingField;    // 0x0x30
    public DateTime? <DPJAECHDGJP>k__BackingField;    // 0x0x38
    public List<EEKKKLACCOO> <ONHPAMHNPIE>k__BackingField;    // 0x0x48
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{aAHOLOFLNEH}   [Service.Econ]
public class IDCBNNIEFOG
{
    public OIPIDEMIECJ <EIEGEJODGMF>k__BackingField;    // 0x0x10
    public MNEBBMHJIAJ <DHPPGFCKOAH>k__BackingField;    // 0x0x18
}
...
// IFBOHPHODNG
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class IFBOHPHODNG
{
    public long <ENCPGPLMNNL>k__BackingField;    // 0x0x10
    public int <IBDLGCDKBIK>k__BackingField;    // 0x0x18
    public long <MAAAIIIBFLP>k__BackingField;    // 0x0x20
    public long? <AJOMPIACLGA>k__BackingField;    // 0x0x28
    public long? <BJFDHCOPNDA>k__BackingField;    // 0x0x38
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x48
    public string <HLONFFAMEPK>k__BackingField;    // 0x0x50
    public string <NDIKKLKAIFC>k__BackingField;    // 0x0x58
    public DateTime <HNOLNFHDIKH>k__BackingField;    // 0x0x60
    public DateTime <ANAJBHGFHLB>k__BackingField;    // 0x0x68
    public int <OBOPLJCJLEI>k__BackingField;    // 0x0x70
    public FOEBOMBAEPP <KLBEJHPEMGH>k__BackingField;    // 0x0x74
    public bool <OPKKKGEFJHK>k__BackingField;    // 0x0x78
    public bool <HOBDKBLPBEL>k__BackingField;    // 0x0x79
    public DLHHAKELKOH <LLLFDMGAIIE>k__BackingField;    // 0x0x7C
    public DLHHAKELKOH <FKDFOOEMDAE>k__BackingField;    // 0x0x80
    public long? <GKPFEHLKGCN>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// IFOGDPCPAHA
//   (not directly referenced by a detected call)
public class IFOGDPCPAHA
{
    public int <GDMELKMCMNH>k__BackingField;    // 0x0x10
    public DGJCBAHMCIK <BLINNIONLAJ>k__BackingField;    // 0x0x14
    public List<CJHGBFCNLBI> <BPNKDIEAIML>k__BackingField;    // 0x0x18
    public List<CJHGBFCNLBI> <BGBHPHDCEFB>k__BackingField;    // 0x0x20
    public bool <PHGODPOINOH>k__BackingField;    // 0x0x28
    public DateTime? <BPIKDFEJCCP>k__BackingField;    // 0x0x30
    public DateTime? <JFNNLAMEPCI>k__BackingField;    // 0x0x40
    public DateTime? <HMHMKEDIJAG>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// IGCKAKGMBCF
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class IGCKAKGMBCF
{
    public int <DOOKLHDCEEF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IGGOIPDFLDP
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class IGGOIPDFLDP
{
    public int? <AGLAMCALLBA>k__BackingField;    // 0x0x10
    public string <MCDFENCAKAN>k__BackingField;    // 0x0x18
    public string <KDHJNJBDNFO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IKCEPDEDCNG
//   RESPONSE ?      api/incentivizedreferrals/   [Service.Econ]
public class IKCEPDEDCNG
{
    public List<NHDKDEHPEKG> <NIKJFALNDIA>k__BackingField;    // 0x0x10
    public string <IFMPJOIDLIB>k__BackingField;    // 0x0x18
}
...
// ILCCMAACEHH
//   (not directly referenced by a detected call)
public class ILCCMAACEHH
{
    public long <EELIHGKKGKJ>k__BackingField;    // 0x0x10
    public Guid <FOONFEPHPJL>k__BackingField;    // 0x0x18
    public long <MAAAIIIBFLP>k__BackingField;    // 0x0x28
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x30
    public string <HLONFFAMEPK>k__BackingField;    // 0x0x38
    public int <LLCMOLOIBFF>k__BackingField;    // 0x0x40
    public Guid? <COBKGAEPKMG>k__BackingField;    // 0x0x44
    public DateTime <MPFHJILALMF>k__BackingField;    // 0x0x58
    public string <NDIKKLKAIFC>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// IMAJHKOEPMF
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class IMAJHKOEPMF
{
    public int <AJEJCNGNGLI>k__BackingField;    // 0x0x10
    public int? <GBFBBKBGHND>k__BackingField;    // 0x0x14
    public string <DHJEFOGGPHM>k__BackingField;    // 0x0x20
    public string <APIPFFDOIEP>k__BackingField;    // 0x0x28
}
...
//   RESPONSE DELETE api/keepsakes/{hJMKLGECFPL}   [Service.API]
...
public class IPNBEFCPOJI
{
    public bool <IBIOMOKNNAM>k__BackingField;    // 0x0x10
    public string <CJIAGOMOALC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JAPKCEBKPCP
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class JAPKCEBKPCP
{
    public List<IFBOHPHODNG> <IAFEIAFMEAI>k__BackingField;    // 0x0x10
    public string <IFMPJOIDLIB>k__BackingField;    // 0x0x18
}
...
// JBOFDIJGPBG
//   (not directly referenced by a detected call)
public class JBOFDIJGPBG
{
    public long <BPJIBCIGOBP>k__BackingField;    // 0x0x10
    public string <FOONFEPHPJL>k__BackingField;    // 0x0x18
    public int <KBFICEPPIEG>k__BackingField;    // 0x0x20
    public int <MOGOEJDBEBC>k__BackingField;    // 0x0x24
    public int <DPHICPHMLOB>k__BackingField;    // 0x0x28
    public int <ILBHDDFJOOG>k__BackingField;    // 0x0x2C
    public int <IFPJBKCJBDJ>k__BackingField;    // 0x0x30
    public string <IKFIHIEEIKH>k__BackingField;    // 0x0x38
    public string <CLIBBBFNIHL>k__BackingField;    // 0x0x40
}
...
// base   : IFOGDPCPAHA
//   (not directly referenced by a detected call)
public class JCJFODADAKO : IFOGDPCPAHA
{
    public int <BFDBNBGKANI>k__BackingField;    // 0x0x60
    public List<OFGGBNAAJOO> <EBOPJMKBIDF>k__BackingField;    // 0x0x68
    public List<OFGGBNAAJOO> <PHKLBGDGJIO>k__BackingField;    // 0x0x70
    public List<OFGGBNAAJOO> <BFLKEMJLOAP>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// JEKDFKCHNNF
//   (not directly referenced by a detected call)
public class JEKDFKCHNNF
{
    public int <OBOPAPJPKKJ>k__BackingField;    // 0x0x10
}
...
public class JLGCCNMFFPL
{
    public EFMBJLICIPE <ONJACGPMFEP>k__BackingField;    // 0x0x10
    public string <OODJAPFJEKH>k__BackingField;    // 0x0x18
    public int? <DKOLHKKKLIM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KAJBFJCCLAK
//   (not directly referenced by a detected call)
public class KAJBFJCCLAK
{
    public IFBOHPHODNG <DBKALMLBNJB>k__BackingField;    // 0x0x10
    public CCLFKIPGEIG <JNODGOPGBCM>k__BackingField;    // 0x0x18
}
...
public class KCOAAIPIPEO
{
    public CEAGAHGKPJE <FEMFMDMFKEH>k__BackingField;    // 0x0x10
    public FHKLKEEJBDM <OHLBJDOOAMI>k__BackingField;    // 0x0x18
}
...
public class KDKMEKAAINL : FFJLAIDLKKE
{
    public HBJKNGDDJIF? <MEJBINNEKGC>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <KMIIAJMHNHF>k__BackingField;    // 0x0x20
}
...
public class KFIAOCELMAN
{
    public Guid <ODHIFHOBDML>k__BackingField;    // 0x0x10
    public long <DBHANBPPEOH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KIJFFMNHGIL
//   (not directly referenced by a detected call)
public class KIJFFMNHGIL
{
    public DateTime <MPFHJILALMF>k__BackingField;    // 0x0x10
    public string <ECIEKDNMFBD>k__BackingField;    // 0x0x18
}
...
public class KKGINLJMOAM : FFJLAIDLKKE
{
    public KBNEHCPMFPM? <MEJBINNEKGC>k__BackingField;    // 0x0x18
    public DGDNOFJJPNI <OAHCJHABCJP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LANGLMCPOEG
//   RESPONSE ?      api/inventions/   [Service.API]
//   RESPONSE GET    api/inventions/v1/personaldetails/{fIMPEDIPEJC}   [Service.API]
public class LANGLMCPOEG
{
    public bool <DJOEHHHFPNK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LBACAMFPLMM
//   (not directly referenced by a detected call)
public class LBACAMFPLMM
{
    public string <NMNMHJBAKJN>k__BackingField;    // 0x0x10
    public INAAEFOONIA <BLINNIONLAJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LCPIPDGCDOA
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class LCPIPDGCDOA
{
    public List<LBACAMFPLMM> <PEGGLGNHEAH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LDILGCGAOKK
//   (not directly referenced by a detected call)
public class LDILGCGAOKK
{
    public int <JHKGBONMGJC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LEMACOOKCLL
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class LEMACOOKCLL
{
    public LDJHBMMNGJO <ONJACGPMFEP>k__BackingField;    // 0x0x10
    public int <DOOKLHDCEEF>k__BackingField;    // 0x0x14
    public long <NOGBCFCFCKM>k__BackingField;    // 0x0x18
    public bool <MKOELHHEJOM>k__BackingField;    // 0x0x20
    public string <KOCAIOFOPBD>k__BackingField;    // 0x0x28
    public int? <GIOAGHKDHCJ>k__BackingField;    // 0x0x30
    public bool <MECIIMKKOIB>k__BackingField;    // 0x0x38
    public bool <GAHDDDIGMON>k__BackingField;    // 0x0x39
    public bool <MNAENBGHHJE>k__BackingField;    // 0x0x3A
    public string <ENENDMDPDHK>k__BackingField;    // 0x0x40
    public DateTime? <IMOAILBOBDO>k__BackingField;    // 0x0x48
    public float <FBLLLILOLAP>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// LLCOBOOCHBG
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{cLOAPFCHKDE}   [Service.API]
public class LLCOBOOCHBG
{
    public uint <FFHIJDCPGJP>k__BackingField;    // 0x0x10
    public uint? <PALGODFOCPL>k__BackingField;    // 0x0x14
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x20
    public string <HLONFFAMEPK>k__BackingField;    // 0x0x28
    public DateTime <PHIDCGNKNJC>k__BackingField;    // 0x0x30
    public DateTime? <EPJJBDLCNHD>k__BackingField;    // 0x0x38
    public bool <FBAKOJNJNDL>k__BackingField;    // 0x0x48
    public List<BDOFPAFDBIE> <OAELLABKGIO>k__BackingField;    // 0x0x50
    public List<string> <PEGGLGNHEAH>k__BackingField;    // 0x0x58
    public int <NFEICLFEPIC>k__BackingField;    // 0x0x60
    public int <IFGAKJBIAPH>k__BackingField;    // 0x0x64
    public int <MEAKBIOJCJG>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// MJECFNEOIDO
//   (not directly referenced by a detected call)
public class MJECFNEOIDO
{
    public ObscuredLong <BPJIBCIGOBP>k__BackingField;    // 0x0x10
    public string <FOONFEPHPJL>k__BackingField;    // 0x0x38
    public ObscuredInt <IBDLGCDKBIK>k__BackingField;    // 0x0x40
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x58
    public string <HLONFFAMEPK>k__BackingField;    // 0x0x60
    public string <NDIKKLKAIFC>k__BackingField;    // 0x0x68
    public int <FEHPDKCLAIL>k__BackingField;    // 0x0x70
    public EHMKNPKFFJM <KLBEJHPEMGH>k__BackingField;    // 0x0x74
    public DateTime <ACKHGPAPEHM>k__BackingField;    // 0x0x78
    public DateTime <MPFHJILALMF>k__BackingField;    // 0x0x80
    public DateTime? <PDFMODJGMPA>k__BackingField;    // 0x0x88
    public long? <PEBNOIKFBII>k__BackingField;    // 0x0x98
    public int <ABIEABPBEFO>k__BackingField;    // 0x0xA8
    public int <APHODODMOOC>k__BackingField;    // 0x0xAC
    public int <JHDNEPNEHGA>k__BackingField;    // 0x0xB0
    public AEBMLPPCPJI <DDIMCAMDKJH>k__BackingField;    // 0x0xB4
    public AEBMLPPCPJI <DMAOFGEIGOB>k__BackingField;    // 0x0xB8
    public ObscuredBool <EMOOBOBCFAN>k__BackingField;    // 0x0xBC
    public ObscuredBool <NJKGHLOOLKM>k__BackingField;    // 0x0xC8
    public ObscuredBool <EDADEFONCFO>k__BackingField;    // 0x0xD4
    public int? <LLCMOLOIBFF>k__BackingField;    // 0x0xE0
    public bool <IBCFFPMPDLD>k__BackingField;    // 0x0xE8
}
...
// MNEBBMHJIAJ
//   (not directly referenced by a detected call)
public class MNEBBMHJIAJ
{
    public Guid <IOMPONNHCEK>k__BackingField;    // 0x0x10
    public long <MAAAIIIBFLP>k__BackingField;    // 0x0x20
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x28
    public string <HLONFFAMEPK>k__BackingField;    // 0x0x30
    public string <NDIKKLKAIFC>k__BackingField;    // 0x0x38
    public long <LLCMOLOIBFF>k__BackingField;    // 0x0x40
    public Guid? <COBKGAEPKMG>k__BackingField;    // 0x0x48
    public DateTime <ACKHGPAPEHM>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// MPADJGEAPCL
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class MPADJGEAPCL
{
    public BBAOFOBILLA <DFBCHEMKJDM>k__BackingField;    // 0x0x10
    public List<string> <PEGGLGNHEAH>k__BackingField;    // 0x0x18
}
...
public class NACIKOBMKAF
{
    public OIPIDEMIECJ <EIEGEJODGMF>k__BackingField;    // 0x0x10
    public BOHMODCOCMF <NFAJHFCNJKD>k__BackingField;    // 0x0x18
}
...
public class NGNGOPDGKBP
{
    public Dictionary<Guid, GBCFJOFHABC> <EIGJOCJNBNK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NHDKDEHPEKG
//   (not directly referenced by a detected call)
public class NHDKDEHPEKG
{
    public int <ONFIKFEGNOK>k__BackingField;    // 0x0x10
    public DateTime <MPFHJILALMF>k__BackingField;    // 0x0x18
    public DateTime? <PGPKHLACMLG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NJLEABNPNIP
//   REQUEST  POST   api/avatar/v4/saved/set   [Service.Econ]
public class NJLEABNPNIP
{
    public int <HEHFLPLDPBA>k__BackingField;    // 0x0x10
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x18
    public string <NBBFIPMELBH>k__BackingField;    // 0x0x20
    public string <OGFOONHKDHN>k__BackingField;    // 0x0x28
    public string <PCLBPLMBAEB>k__BackingField;    // 0x0x30
    public string <FBNJFKDJCAB>k__BackingField;    // 0x0x38
    public string <PBOKIPGALKM>k__BackingField;    // 0x0x40
    public string <AGJHIJCFEGK>k__BackingField;    // 0x0x48
    public List<GLIBAGCCLFD> <JFOBCBJKMGJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// NKBLGFIAINM
//   RESPONSE GET    api/config/v2   [Service.API]
public class NKBLGFIAINM
{
    public Dictionary<int, int> <OHPMBEAHFED>k__BackingField;    // 0x0x10
    public List<DJHKLIKBBBA> <CHLHLJBKPMB>k__BackingField;    // 0x0x18
    public EAPIHABOMHB[][] <PBDMBIBGJIH>k__BackingField;    // 0x0x20
    public JEKDFKCHNNF <AIBJGDHPMBO>k__BackingField;    // 0x0x28
    public EPEBPHHADLD <KEMOPLNPAFD>k__BackingField;    // 0x0x30
    public BPHFCLGGPBJ <LFHLDBJDDHD>k__BackingField;    // 0x0x38
    public LDILGCGAOKK <MIDKHKHLEBD>k__BackingField;    // 0x0x40
    public PFJBAGKPIED <CMNFGMBHDKJ>k__BackingField;    // 0x0x48
    public string <AJAENDDLMNC>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// ODCGDLABOJE
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class ODCGDLABOJE
{
    public bool <JLGPKMDHLKN>k__BackingField;    // 0x0x10
    public string <CLJIMGPFOEO>k__BackingField;    // 0x0x18
    public string <ADNOEJIKLLH>k__BackingField;    // 0x0x20
}
...
public class ODJINNOKCFA
{
    public HBLCAMLGMEM <EIEGEJODGMF>k__BackingField;    // 0x0x10
    public MJECFNEOIDO <FLIFDMBPIKO>k__BackingField;    // 0x0x18
    public JBOFDIJGPBG <DKGCFIAJOFH>k__BackingField;    // 0x0x20
}
...
// OFGGBNAAJOO
//   (not directly referenced by a detected call)
public class OFGGBNAAJOO
{
    public bool <MAFLLFDKDFF>k__BackingField;    // 0x0x10
    public OKJLDNJDFCH <APHMDCMLFLE>k__BackingField;    // 0x0x18
    public float <EFLAPMNLCGP>k__BackingField;    // 0x0x20
}
...
public class OJAINPOFFEB
{
    public string <KFLIDOIMKOI>k__BackingField;    // 0x0x10
    public string <CAGOABOGIPN>k__BackingField;    // 0x0x18
    public bool <OEKOCHBMCHO>k__BackingField;    // 0x0x20
    public string <PHDOALBHEND>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// OKJLDNJDFCH
//   (not directly referenced by a detected call)
public class OKJLDNJDFCH
{
    public int <LAHMDLHICLK>k__BackingField;    // 0x0x10
    public string <JBPGIHHDBJN>k__BackingField;    // 0x0x18
    public string <JLAIJEFOMPD>k__BackingField;    // 0x0x20
    public string <MELEOKOPENL>k__BackingField;    // 0x0x28
    public string <MGHIKEMILKL>k__BackingField;    // 0x0x30
    public string <JGMICBDEELL>k__BackingField;    // 0x0x38
    public IBPDKKJPCID? <NJLOKMLNKKB>k__BackingField;    // 0x0x40
    public string <NMGNIELDBFI>k__BackingField;    // 0x0x48
    public string <FGCDBIBNDCM>k__BackingField;    // 0x0x50
    public bool <CPFPIHOOCFF>k__BackingField;    // 0x0x58
    public bool <NEPKHMEAEKD>k__BackingField;    // 0x0x59
    public bool <EKNIODDPKGP>k__BackingField;    // 0x0x5A
    public MJPIFFMJLNF <NODACLCNOPM>k__BackingField;    // 0x0x5C
    public int <JGANLPDPNNA>k__BackingField;    // 0x0x60
    public OEPBHDOHLLJ <CLOKECLALCN>k__BackingField;    // 0x0x64
    public int <GPKABGEECLA>k__BackingField;    // 0x0x68
    public IDMABFLIGFF <FKBCKIGONBJ>k__BackingField;    // 0x0x6C
    public NAMJIIGMBJO <BANALGNMJBA>k__BackingField;    // 0x0x70
    public int? <IEIKBBIPCII>k__BackingField;    // 0x0x74
    public string <BLGCCLNNGMN>k__BackingField;    // 0x0x80
}
...
// --------------------------------------------------------------------------
// OPCIHMJLKDE
// base   : AAEFDCECCFC<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class OPCIHMJLKDE
{
    // (no instance fields in the metadata dump)
}
...
// PFJBAGKPIED
//   (not directly referenced by a detected call)
public class PFJBAGKPIED
{
    public float <IJPPPHCOPJI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PFPNIBOPABP
//   (not directly referenced by a detected call)
public class PFPNIBOPABP
{
    public int <KMILJPHHAID>k__BackingField;    // 0x0x10
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x18
    public string <HEJCDLCCFCE>k__BackingField;    // 0x0x20
    public string <HLONFFAMEPK>k__BackingField;    // 0x0x28
    public string <JLAIJEFOMPD>k__BackingField;    // 0x0x30
    public bool <ANJLFCMLMLD>k__BackingField;    // 0x0x38
    public int <HEHFLPLDPBA>k__BackingField;    // 0x0x3C
    public GCPNMACHADG <CGDNGALDHGL>k__BackingField;    // 0x0x40
    public PIGMGPCCEFG OOLOOPGBOIO;    // 0x0x48
    public PIGMGPCCEFG LPMBFOOJKOH;    // 0x0x50
    public PIGMGPCCEFG JHFNFPPCPKN;    // 0x0x58
    public JFFICEFKIKF LOEGEAGOJLK;    // 0x0x60
}
...
// PLLPKGHGPCJ
//   (not directly referenced by a detected call)
public class PLLPKGHGPCJ
{
    public long <LAHMDLHICLK>k__BackingField;    // 0x0x10
    public string <MGHIKEMILKL>k__BackingField;    // 0x0x18
    public string <OBKAKJCFCHL>k__BackingField;    // 0x0x20
    public IBPDKKJPCID? <NJLOKMLNKKB>k__BackingField;    // 0x0x28
    public string <NMGNIELDBFI>k__BackingField;    // 0x0x30
    public string <FGCDBIBNDCM>k__BackingField;    // 0x0x38
    public HEGKFDLFABO <NFCGLJNAICG>k__BackingField;    // 0x0x40
    public int <JANEMFLPDBK>k__BackingField;    // 0x0x44
    public int <AGAHNIIDNFD>k__BackingField;    // 0x0x48
    public NAMJIIGMBJO? <PNICDJANLJA>k__BackingField;    // 0x0x4C
    public MJPIFFMJLNF? <JBEKDIEIEPA>k__BackingField;    // 0x0x54
}
...
{
    public long <MAAAIIIBFLP>k__BackingField;    // 0x0x10
    public long? <AJOMPIACLGA>k__BackingField;    // 0x0x18
    public FBNLAPOEIEP <LEJJLILFKJH>k__BackingField;    // 0x0x28
}
...
{
    public PKNFDABOBPB <DFBCHEMKJDM>k__BackingField;    // 0x0x10
    public string <DPHGKEFLCPP>k__BackingField;    // 0x0x18
    public string <LIPDHDBHINE>k__BackingField;    // 0x0x20
    public string <PIEGJFDNDMF>k__BackingField;    // 0x0x28
}
...
{
    public long <ENCPGPLMNNL>k__BackingField;    // 0x0x10
    public long? <DELJCILDKKA>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public JCHFMOLEEFO FilterType;    // 0x0x20
...
{
    public FBNLAPOEIEP <BDEHLCPMFEN>k__BackingField;    // 0x0x10
    public string <CMHEIBODCPB>k__BackingField;    // 0x0x18
    public int <OLFHHCNDGHK>k__BackingField;    // 0x0x20
    public int <CMIGDBBMGEB>k__BackingField;    // 0x0x24
    public string <OKLACFCKKJF>k__BackingField;    // 0x0x28
    public string <KLMOCOLFAMB>k__BackingField;    // 0x0x30
}
...
{
    public int <CNPCHDHOAPJ>k__BackingField;    // 0x0x10
    public Guid <IIMMHMCDEKC>k__BackingField;    // 0x0x14
    public DateTime <FDHILPKIEII>k__BackingField;    // 0x0x28
}
...
{
    public bool <AIAIGBAPFMN>k__BackingField;    // 0x0x10
    public int <HAFKBAJCFHH>k__BackingField;    // 0x0x14
    public bool <JNPGDEKIPAH>k__BackingField;    // 0x0x18
}
...
{
    public Guid <IIMMHMCDEKC>k__BackingField;    // 0x0x10
    public FBNLAPOEIEP <EDIGMECCJCA>k__BackingField;    // 0x0x20
    public int <GNFCCEOJKAN>k__BackingField;    // 0x0x24
    public long <MAAAIIIBFLP>k__BackingField;    // 0x0x28
    public long? <AJOMPIACLGA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{dMOCKHNJMOB}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <GGLMIPNNKMP>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <ANCBJAOEGPB>k__BackingField;    // 0x0x18
}
...
{
    public long <LHKNEDFKJOL>k__BackingField;    // 0x0x10
    public long <MAAAIIIBFLP>k__BackingField;    // 0x0x18
    public long <NCAJFHANPAP>k__BackingField;    // 0x0x20
    public MJODDCFAIHO <BLINNIONLAJ>k__BackingField;    // 0x0x28
    public int <IEHPJBNDIBD>k__BackingField;    // 0x0x2C
}
...
{
    public long <MAAAIIIBFLP>k__BackingField;    // 0x0x10
    public List<Guid> <IDCFBGHABKG>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <GGLMIPNNKMP>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <ANCBJAOEGPB>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <GKFLEMFIAGK>k__BackingField;    // 0x0x20
}
...
{
    public long <NCAJFHANPAP>k__BackingField;    // 0x0x10
    public long <MFLEBGHADKN>k__BackingField;    // 0x0x18
    public int? <FPBBECCOBLJ>k__BackingField;    // 0x0x20
    public int? <EGNLPINJOKM>k__BackingField;    // 0x0x28
    public long? <BEIGOGDEIKA>k__BackingField;    // 0x0x30
    public long <GBHDICCFAPG>k__BackingField;    // 0x0x40
    public long <LLLBOGNHOPO>k__BackingField;    // 0x0x48
    public int <PPAFFPOMJAC>k__BackingField;    // 0x0x50
    public MJODDCFAIHO <NBMDHJAPMGC>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <BAHOIGAANOM>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public NAMJIIGMBJO <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public JJBOGHIAHHF creatorAccountRole;    // 0x0x58
}
...
{
    public GOBGEFHFIFB <FCOBEAIMGCO>k__BackingField;    // 0x0x10
    public HNLMKGOKKAL <NKBPJNEAGEA>k__BackingField;    // 0x0x14
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x18
    public string <HLONFFAMEPK>k__BackingField;    // 0x0x20
    public bool <HHIBEMFMJLO>k__BackingField;    // 0x0x28
}
...
{
    public List<GOBGEFHFIFB> <JLPCHOMEDJN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{dPEHGEKABMF}   [Service.API]
public class ProgressionEventDTO
{
    public long <MFLEBGHADKN>k__BackingField;    // 0x0x10
    public string <AAIEEGMFLCN>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <BFLKEMJLOAP>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <BMLAKNNLCPH>k__BackingField;    // 0x0x28
    public DateTime <HNOLNFHDIKH>k__BackingField;    // 0x0x30
    public DateTime <ANAJBHGFHLB>k__BackingField;    // 0x0x38
    public DateTime <MIEPKBLPCLD>k__BackingField;    // 0x0x40
    public bool <HJMDEGPLIEP>k__BackingField;    // 0x0x48
    public int <JOPKBBPGDBG>k__BackingField;    // 0x0x4C
    public float <LGHNKACFOMH>k__BackingField;    // 0x0x50
    public Guid? <MEKLELGNCEK>k__BackingField;    // 0x0x54
    public string <JPPKBNNKBLD>k__BackingField;    // 0x0x68
    public string <LCBMJMGIPON>k__BackingField;    // 0x0x70
    public string <BLFBHLDKMKG>k__BackingField;    // 0x0x78
    public string <CLDMBOHMLLP>k__BackingField;    // 0x0x80
}
...
{
    public Guid <FIMGPCNNNEL>k__BackingField;    // 0x0x10
    public int <OKEHEBNOCKA>k__BackingField;    // 0x0x20
    public int <OPGKDLNBCCN>k__BackingField;    // 0x0x24
    public int <DNBHFPKCFEB>k__BackingField;    // 0x0x28
    public long <FNKHLLBFMOG>k__BackingField;    // 0x0x30
    public long <ANNOLOHGNNJ>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/record/{dPEHGEKABMF}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <CNPCHDHOAPJ>k__BackingField;    // 0x0x10
    public int <JANEMFLPDBK>k__BackingField;    // 0x0x14
    public int <NKGJDJPFEOI>k__BackingField;    // 0x0x18
    public int <BHDLGCCHOGM>k__BackingField;    // 0x0x1C
    public int <JLNHHFLPCEC>k__BackingField;    // 0x0x20
    public DateTime? <JDLJBDJBEDH>k__BackingField;    // 0x0x28
}
...
{
    public long <MFJLIDLMBBH>k__BackingField;    // 0x0x10
    public int <LAHMDLHICLK>k__BackingField;    // 0x0x18
    public string <NDIKKLKAIFC>k__BackingField;    // 0x0x20
    public int <JANEMFLPDBK>k__BackingField;    // 0x0x28
    public int <IEODGNHICLN>k__BackingField;    // 0x0x2C
    public bool <JGKAEBHAHDO>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public DMEKPLJMCCK ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool CPJMBEOKHHF;    // 0x0x28
}
...
{
    public DPJLPHHIKEA? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public DPJLPHHIKEA DIMOCBDDLIK;  // wrapper
...
{
    public OJKJMCENHFI GOAPPJKEMHO;  // wrapper
...
{
    public GKJLLMDCHBK HAOFNDAEGFJ;  // wrapper
    public int? CNDEKKAIOLD;  // wrapper
...
{
    public LDJHBMMNGJO NPJKENLGBPH;  // wrapper
    public float? DLBMCOBIPJG;  // wrapper
...
{
    public KPGGKMCNNPM UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public NAMJIIGMBJO MFEOJPNCOBA;  // wrapper
    public NAMJIIGMBJO? DFPMLNLDKOI;  // wrapper
...
{
    public PFPNIBOPABP KGCLIJHGHNH;  // wrapper
...
{
    public EHMKNPKFFJM EOEPKDALBFK;  // wrapper
    public byte[] DLDDKDDNMHN;  // wrapper
    public byte[] MDAMNIEABDB;  // wrapper
    public Color LDFNLMPJEDN;  // wrapper
...
{
    public List<IHMMIJMLKFC> OLNHJHHJEFA;  // wrapper
}
...
{
    public NHEMNAJDEDD HKCKDBLHEKC;  // wrapper
    public NAMJIIGMBJO? HLFEMNAGOBB;  // wrapper
...
{
    public MNGMELLBPGH GGBKBJBKPNN;  // wrapper
...
{
    public MJECFNEOIDO inventionId;  // wrapper
}
...
// api/keepsakes/{hJMKLGECFPL}/collect  [API POST]
public class KeepsakesHJMKLGECFPLCollectRequest
{
    public Guid HJMKLGECFPL;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> JOELDNPGFEK;  // wrapper
    public OFGPKGEGOOI EIMMACFHPBI;  // wrapper
    public long? BAOKNFPKMNE;  // wrapper
...
{
    public long? OJIIEAKAHEB;  // wrapper
    public long? LPIPBICBFPP;  // wrapper
    public List<string> MEIAODFHINB;  // wrapper
    public DateTime ADFLOADHGMB;  // wrapper
    public DateTime LLEHFFKCDCM;  // wrapper
    public FOEBOMBAEPP EOEPKDALBFK;  // wrapper
    public DLHHAKELKOH JAIAEJANAHF;  // wrapper
    public DLHHAKELKOH IBIELMJNOJN;  // wrapper
}
...
{
    public DLHHAKELKOH JAIAEJANAHF;  // wrapper
    public DLHHAKELKOH NCLIIMKNIAJ;  // wrapper
}
...
{
    public Guid NJCJCFAGLCC;  // wrapper
...
{
    public List<BEOGGDPKHJO> NJIMCNACCII;  // wrapper
}
...
{
    public Guid KMLGPMDJFLF;  // wrapper
    public object Price;  // candidate
...
{
    public Guid KMLGPMDJFLF;  // wrapper
    public long? BHDOKDBCGNI;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Limit;  // candidate
...
{
    public Guid NJCJCFAGLCC;  // wrapper
    public long? CPFNGBEBEDB;  // wrapper
    public long? CBGLDNOIILE;  // wrapper
    public int? MNCCGFIOPNO;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> DGCNIAGLPMA;  // wrapper
...
{
    public IEnumerable<PLJEODMMOML> IJKJCCCMNOD;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public Guid? OBKGPOIIOFK;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object RoomId;  // candidate
...
{
    public LDJHBMMNGJO NPJKENLGBPH;  // wrapper
    public long? MFBMAGCPECL;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats PIJKCOFDJPN;  // wrapper
}
...
{
    public Guid NNKNNLLNNDF;  // wrapper
...
{
    public Guid AFHHAHKFPNE;  // wrapper
...
{
    public List<NOALEIJHDCJ> LMAAMAOHKGF;  // wrapper
    public object roomId;  // candidate
...
{
    public OPDLNPOBNFB LNOOBMKILKJ;  // wrapper
}
