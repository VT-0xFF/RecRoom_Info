...
public class ACEABLIBBEC
{
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x10
    public string <KNCECKNFCIC>k__BackingField;    // 0x0x18
    public int? <IKOAIOHEGFE>k__BackingField;    // 0x0x20
    public LKJFEJHJBAN? <AIIHFNPFBNH>k__BackingField;    // 0x0x28
}
...
public class ACODDCFJLBN
{
    public Guid? <NKIMOHDIDFL>k__BackingField;    // 0x0x10
    public Guid <KMBOPBJELJJ>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// AFDHOJNMALM
//   (not directly referenced by a detected call)
public class AFDHOJNMALM
{
    public int <BACMLBDHGMJ>k__BackingField;    // 0x0x10
    public DateTime <DFDBOFCNHKP>k__BackingField;    // 0x0x18
    public DateTime? <OIHOCMKGBEI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AHKCOMPKMJD
//   (not directly referenced by a detected call)
public class AHKCOMPKMJD
{
    public int <JEHAEJMNLBL>k__BackingField;    // 0x0x10
    public DateTime? <NIJGOGDOPMA>k__BackingField;    // 0x0x18
    public DateTime? <OJLAHCMOAHD>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// ALGBCBHPICC
//   (not directly referenced by a detected call)
public class ALGBCBHPICC
{
    public string <EMIMBCBBIGB>k__BackingField;    // 0x0x10
    public IHJBBBIJIDH <KEPJAEKMFIJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ALONAFPFMKD
//   RESPONSE ?      api/inventions/   [Service.API]
//   RESPONSE GET    api/inventions/v1/personaldetails/{kBPFKPGOCFN}   [Service.API]
public class ALONAFPFMKD
{
    public bool <KDMPDMPHDKK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// APIJLJINIEC
//   (not directly referenced by a detected call)
public class APIJLJINIEC
{
    public float <JEBKFMKHMLF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BHFCHGGAMPL
//   (not directly referenced by a detected call)
public class BHFCHGGAMPL
{
    public int <OJFLNKLBLDP>k__BackingField;    // 0x0x10
}
...
public class BJMGAOAAKMM
{
    public bool <FAGKEPDPACF>k__BackingField;    // 0x0x10
    public string <BCKDJEDDKID>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BKEPKHDHPBA
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class BKEPKHDHPBA
{
    public int <KCNGPBCFOJH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BLBJMECFGJE
//   (not directly referenced by a detected call)
public class BLBJMECFGJE
{
    public int <GKKBKJBNKMK>k__BackingField;    // 0x0x10
    public ACODDCFJLBN <JPABGHDKMPP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BNMEGKPHFPA
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class BNMEGKPHFPA
{
    public string <MACAHHPDDID>k__BackingField;    // 0x0x10
    public string <PGEEKNMIOIA>k__BackingField;    // 0x0x18
    public string <FJMEJNEHPBM>k__BackingField;    // 0x0x20
    public string <KNCECKNFCIC>k__BackingField;    // 0x0x28
    public string <FJJFKJCLDFA>k__BackingField;    // 0x0x30
    public OMODFGPFHEH <LLDKGCMIKBM>k__BackingField;    // 0x0x38
    public List<string> <LKDDMDMHCEM>k__BackingField;    // 0x0x40
    public List<string> <EAHDAGAJEAA>k__BackingField;    // 0x0x48
    public string <ODBOPGHOBCH>k__BackingField;    // 0x0x50
    public List<MBPHDPMELBC> <NIMIEKPIHFL>k__BackingField;    // 0x0x58
}
...
//   RESPONSE GET    api/playerevents/v1/all/{eJIHLJJMOBD}   [Service.API]
public class CCHJMBNNCPE
{
    public List<IMIJPHJKLIM> <ILMGLPAGNFE>k__BackingField;    // 0x0x10
    public List<GBLNNKGOPFP> <KBJEDIIMGHP>k__BackingField;    // 0x0x18
}
...
public class CDMDAFGHMBK : CAPIKAHMPLA
{
    public MJCNIFBNGHM? <FPILOCLGELF>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <FOJEBEOMLHI>k__BackingField;    // 0x0x20
}
...
public class CDNDHAMKCLJ
{
    public int <MNOFNLJDEKJ>k__BackingField;    // 0x0x10
    public int <IFLDNPDLEJD>k__BackingField;    // 0x0x14
    public float <LJKMEKFIFJL>k__BackingField;    // 0x0x18
    public float <HFCCDJMCOME>k__BackingField;    // 0x0x1C
    public bool <JBLPKLPNEEK>k__BackingField;    // 0x0x20
    public bool <HFFLIABAPLD>k__BackingField;    // 0x0x21
    public bool <ONMELCJADCP>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// CGGDEFPDNNN
//   (not directly referenced by a detected call)
public class CGGDEFPDNNN
{
    public bool <FNNOLDFMAHK>k__BackingField;    // 0x0x10
    public DBFJJLIGAFA <DABOGGHLBII>k__BackingField;    // 0x0x18
    public float <KADCIKFDJIK>k__BackingField;    // 0x0x20
}
...
// CKLCFFGDCLA
//   (not directly referenced by a detected call)
public class CKLCFFGDCLA
{
    public int <LPAFCGGGEGF>k__BackingField;    // 0x0x10
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x18
    public string <NPAJOBLDAHB>k__BackingField;    // 0x0x20
    public string <KNCECKNFCIC>k__BackingField;    // 0x0x28
    public string <JMIKEJKICPF>k__BackingField;    // 0x0x30
    public bool <JLEJAGFGODH>k__BackingField;    // 0x0x38
    public int <IIFBCJGBLAJ>k__BackingField;    // 0x0x3C
    public NJPAADFEEJB <BKEFOILPCGM>k__BackingField;    // 0x0x40
    public MJLIAAHLFAC JDGJAPBHHLM;    // 0x0x48
    public MJLIAAHLFAC ECEEHFLNJGC;    // 0x0x50
    public MJLIAAHLFAC LEIBFANAFGF;    // 0x0x58
    public FIHOCOBADNH JOGMCINDOBE;    // 0x0x60
}

// --------------------------------------------------------------------------
// COMHCCBONLA
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class COMHCCBONLA
{
    public OMLBCKDFMHL <LPMNMIEMOLO>k__BackingField;    // 0x0x10
    public int <KCNGPBCFOJH>k__BackingField;    // 0x0x14
    public long <BMOECJFADBE>k__BackingField;    // 0x0x18
    public bool <PMBDAPHHHDP>k__BackingField;    // 0x0x20
    public string <BCKDJEDDKID>k__BackingField;    // 0x0x28
    public int? <LFFAHDMAGJD>k__BackingField;    // 0x0x30
    public bool <IBGFCIIGOOG>k__BackingField;    // 0x0x38
    public bool <HFCOPJEEIGD>k__BackingField;    // 0x0x39
    public bool <GBGHDDHOLCN>k__BackingField;    // 0x0x3A
    public string <CDGAPIKCPIP>k__BackingField;    // 0x0x40
    public DateTime? <HLCJLNAGEGH>k__BackingField;    // 0x0x48
    public float <GMPFEMOHNDE>k__BackingField;    // 0x0x58
}
...
// DBFJJLIGAFA
//   (not directly referenced by a detected call)
public class DBFJJLIGAFA
{
    public int <BNJIHNJANED>k__BackingField;    // 0x0x10
    public string <LNLMEBFIHMF>k__BackingField;    // 0x0x18
    public string <JMIKEJKICPF>k__BackingField;    // 0x0x20
    public string <PDHGEAEJELC>k__BackingField;    // 0x0x28
    public string <ALJBEJOGIKH>k__BackingField;    // 0x0x30
    public string <GHAAJKLLGEF>k__BackingField;    // 0x0x38
    public NIEKOAENMLL? <EJICGOPEDMA>k__BackingField;    // 0x0x40
    public string <JMGKKLPFLFH>k__BackingField;    // 0x0x48
    public string <LCGNIDLAIAI>k__BackingField;    // 0x0x50
    public bool <EGDKKEIOEEE>k__BackingField;    // 0x0x58
    public bool <MFMAIPGDHLA>k__BackingField;    // 0x0x59
    public bool <BHBNNHMPDOD>k__BackingField;    // 0x0x5A
    public DOOBOJIHNDF <FICMBMAFAMP>k__BackingField;    // 0x0x5C
    public int <DKINHFBEAPJ>k__BackingField;    // 0x0x60
    public GKPEKOLBBJL <LHAOPFKLDDM>k__BackingField;    // 0x0x64
    public int <JEEAFKKECGB>k__BackingField;    // 0x0x68
    public DKLKDCNIDLI <BCAHMECJNCH>k__BackingField;    // 0x0x6C
    public IIGLDDDANPN <JEAGFEPMLIJ>k__BackingField;    // 0x0x70
    public int? <IGPMDLOJNHH>k__BackingField;    // 0x0x74
    public string <KNIMJNHBDID>k__BackingField;    // 0x0x80
}
...
public class DGCDCJHBKAF
{
    public CJDHONMNJNA <DKKJMBNAKPK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DIEJFIAOMHJ
//   RESPONSE GET    api/config/v1/amplitude   [Service.API]
public class DIEJFIAOMHJ
{
    public string <JFFGDJJCEKM>k__BackingField;    // 0x0x10
    public string <EDJNPGDJCFL>k__BackingField;    // 0x0x18
    public bool <INBJMDPFGIP>k__BackingField;    // 0x0x20
    public string <IDIOHFLOPFM>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// DKHDJHHHLPI
// base   : KBKOPBBHCHK<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class DKHDJHHHLPI
{
    // (no instance fields in the metadata dump)
}
...
public class DLCBGFLGNLN
{
    public int <IIFBCJGBLAJ>k__BackingField;    // 0x0x10
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x18
    public string <OBCGDDEDJDM>k__BackingField;    // 0x0x20
    public string <KOCPEJKEKJL>k__BackingField;    // 0x0x28
    public string <OGDGALNECFB>k__BackingField;    // 0x0x30
    public string <ELOHFGCCDIN>k__BackingField;    // 0x0x38
    public string <JJGHBKDGMEK>k__BackingField;    // 0x0x40
    public string <DBJDPBIFNAL>k__BackingField;    // 0x0x48
    public List<MODNIGHDDHE> <BLNDMOPABLF>k__BackingField;    // 0x0x50
}
...
public class EECBPIFHMJF
{
    public bool <LKOFMAILHDL>k__BackingField;    // 0x0x10
    public string <PGEEKNMIOIA>k__BackingField;    // 0x0x18
    public string <JJHKFGPIOGA>k__BackingField;    // 0x0x20
}
...
public class EGGNOENNPCA
{
    public GKPEKOLBBJL <LHAOPFKLDDM>k__BackingField;    // 0x0x10
    public EPJJLKAOOLD <BIAKMHMPLMF>k__BackingField;    // 0x0x14
    public int <DGNFHAPIJHI>k__BackingField;    // 0x0x18
    public int <BPBDIJDIIMA>k__BackingField;    // 0x0x1C
    public int <HGLKOEIABNP>k__BackingField;    // 0x0x20
    public JJJKPDLEOEB <OPDKMLACKJK>k__BackingField;    // 0x0x24
    public bool <NJBFJMMJPCJ>k__BackingField;    // 0x0x28
    public float <OEPKJNBGMAI>k__BackingField;    // 0x0x2C
    public int <OKONAAJEHIN>k__BackingField;    // 0x0x30
    public bool <POIHKBLGIMM>k__BackingField;    // 0x0x34
}
...
//   RESPONSE GET    api/avatar/v2/{eJIHLJJMOBD}   [Service.Econ]
public class EJPEDHHDHEH
{
    public string <KOCPEJKEKJL>k__BackingField;    // 0x0x10
    public string <OGDGALNECFB>k__BackingField;    // 0x0x18
    public string <ELOHFGCCDIN>k__BackingField;    // 0x0x20
    public string <JJGHBKDGMEK>k__BackingField;    // 0x0x28
    public string <DBJDPBIFNAL>k__BackingField;    // 0x0x30
    public List<MODNIGHDDHE> <BLNDMOPABLF>k__BackingField;    // 0x0x38
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{jNHIIPBPEOB}   [Service.Econ]
public class EKACNGGFGNM
{
    public PLPKONMJAFM <LLDKGCMIKBM>k__BackingField;    // 0x0x10
    public KFGPIBFKOAK <NOBNIKDLNLL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EOHADGOEBOD
//   (not directly referenced by a detected call)
public class EOHADGOEBOD
{
    public long <DJOJMIDBABE>k__BackingField;    // 0x0x10
    public Guid <OCDAPHHCAHM>k__BackingField;    // 0x0x18
    public long <MCMOLLCNPHO>k__BackingField;    // 0x0x28
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x30
    public string <KNCECKNFCIC>k__BackingField;    // 0x0x38
    public int <IKOAIOHEGFE>k__BackingField;    // 0x0x40
    public Guid? <MEOKPICABIK>k__BackingField;    // 0x0x44
    public DateTime <DFDBOFCNHKP>k__BackingField;    // 0x0x58
    public string <FFHHFCOKJHL>k__BackingField;    // 0x0x60
}
...
public class EOKKPHLOBBD
{
    public int <CHGMGHBFEOH>k__BackingField;    // 0x0x10
    public PNHBLPCCIAE <KEPJAEKMFIJ>k__BackingField;    // 0x0x14
    public CBNDIGJKKOE <FMHIIJMGEAN>k__BackingField;    // 0x0x18
    public CBNDIGJKKOE <CIKPCMCOIGA>k__BackingField;    // 0x0x1C
    public CBNDIGJKKOE <ODOGHMNJFPE>k__BackingField;    // 0x0x20
}
...
// FCAOHDFPEAP
//   (not directly referenced by a detected call)
public class FCAOHDFPEAP
{
    public PNLFAAAPEID AFHOOPPPKKJ;    // 0x0x10
    public int DIIHDPAIIMJ;    // 0x0x14
}

// --------------------------------------------------------------------------
// FEPKCEKFBJN
// base   : KBKOPBBHCHK<LINLOKECLME>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{eBPEOEONPMJ}   [Service.API]
public class FEPKCEKFBJN
{
    // (no instance fields in the metadata dump)
}
...
public class FGPJPLFOMIM
{
    public long <DJOJMIDBABE>k__BackingField;    // 0x0x10
    public int <BCBIFFAJPAN>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/keepsakes/{oPOMJNNALCB}   [Service.API]
...
public class FOKGKPOPJPF
{
    public bool <FAGKEPDPACF>k__BackingField;    // 0x0x10
    public string <GPBEMJHMFPI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GBLNNKGOPFP
//   (not directly referenced by a detected call)
public class GBLNNKGOPFP
{
    public IMIJPHJKLIM <LMCGJAMDGPJ>k__BackingField;    // 0x0x10
    public IEEOJIDNBLP <FLKNOAPLHBA>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{jJLIIOCLCNA}   [Service.API]
...
public class GDCLLKJIJPJ
{
    public NCBAEFEDLMK <LMCGJAMDGPJ>k__BackingField;    // 0x0x10
    public CJDHONMNJNA <DKKJMBNAKPK>k__BackingField;    // 0x0x18
    public HPMDKMBJDDE <MFDGJOOMMNJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GJBCKEHFLFM
//   (not directly referenced by a detected call)
public class GJBCKEHFLFM
{
    public int <GBKICMKAJOJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GKGPHCFIODI
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class GKGPHCFIODI
{
    public List<IMIJPHJKLIM> <IIPAPJGELJM>k__BackingField;    // 0x0x10
    public string <NFCDNLDDPPG>k__BackingField;    // 0x0x18
}
...
public class HGCDHPBNHGP
{
    public int? <OOJCPDOHFEB>k__BackingField;    // 0x0x10
    public string <FJJFKJCLDFA>k__BackingField;    // 0x0x18
    public string <FACJBBMOCAM>k__BackingField;    // 0x0x20
}
...
public class HHICAINGOMC
{
    public List<int> <MIFKMHBGMHB>k__BackingField;    // 0x0x10
    public string <NFCDNLDDPPG>k__BackingField;    // 0x0x18
}
...
public class HJOPIFKJIAI
{
    public Guid? <LAMPFEEGDJC>k__BackingField;    // 0x0x10
    public long? <MCMOLLCNPHO>k__BackingField;    // 0x0x28
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x38
    public string <KNCECKNFCIC>k__BackingField;    // 0x0x40
    public string <FFHHFCOKJHL>k__BackingField;    // 0x0x48
    public HLHCALOHBDM <GMIAIMGHMCB>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// HLHCALOHBDM
//   (not directly referenced by a detected call)
public class HLHCALOHBDM
{
    public long <IKOAIOHEGFE>k__BackingField;    // 0x0x10
    public Guid? <PNKPEHFPJLM>k__BackingField;    // 0x0x18
}
...
// HNJJEAFLMFO
//   (not directly referenced by a detected call)
public class HNJJEAFLMFO
{
    public bool <KFKPAKMJEMN>k__BackingField;    // 0x0x10
    public OJCAJBAODPP <DDFFHKMFINC>k__BackingField;    // 0x0x14
    public int <HDPJPMAGBGI>k__BackingField;    // 0x0x18
    public DateTime <FKMNKIJGDKM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HPMDKMBJDDE
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class HPMDKMBJDDE
{
    public OLCMHCHELAH <DKKJMBNAKPK>k__BackingField;    // 0x0x10
    public List<string> <EAHDAGAJEAA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IBKACDLFPML
//   (not directly referenced by a detected call)
public class IBKACDLFPML
{
    public int <FNKCKGNAJGF>k__BackingField;    // 0x0x10
    public KEFAMMCFDPC <KEPJAEKMFIJ>k__BackingField;    // 0x0x14
    public List<PLPBICCPKGI> <KGLKPNEHHEH>k__BackingField;    // 0x0x18
    public List<PLPBICCPKGI> <LHGHDFBDGKH>k__BackingField;    // 0x0x20
    public bool <HDDCGPAEAKH>k__BackingField;    // 0x0x28
    public DateTime? <FOEGCKFOBAF>k__BackingField;    // 0x0x30
    public DateTime? <OKGKOJHOICB>k__BackingField;    // 0x0x40
    public DateTime? <GFIHFBELLPG>k__BackingField;    // 0x0x50
}
...
// IEEOJIDNBLP
//   (not directly referenced by a detected call)
public class IEEOJIDNBLP
{
    public long <AEKECMDDEKJ>k__BackingField;    // 0x0x10
    public long <HNCNGNCJOCO>k__BackingField;    // 0x0x18
    public int <JGBLBKPGMFB>k__BackingField;    // 0x0x20
    public DateTime <DFDBOFCNHKP>k__BackingField;    // 0x0x28
    public HHAPNEKGMEP <KEPJAEKMFIJ>k__BackingField;    // 0x0x30
}
...
public class IIALPEHLDJP
{
    public Guid <KBBLAGGJNIN>k__BackingField;    // 0x0x10
    public long <FIFLCBNPPJN>k__BackingField;    // 0x0x20
}
...
// IIJLKAPNFHH
//   (not directly referenced by a detected call)
public class IIJLKAPNFHH
{
    public Guid <FANFHPOFKKN>k__BackingField;    // 0x0x10
    public Guid <FOMOPBKEHEL>k__BackingField;    // 0x0x20
    public DateTime <GFCEOHFEBOF>k__BackingField;    // 0x0x30
    public List<DBFJJLIGAFA> <FHHPBPAIJGO>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// IMIJPHJKLIM
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class IMIJPHJKLIM
{
    public long <HNCNGNCJOCO>k__BackingField;    // 0x0x10
    public int <MBEPJPMLKAF>k__BackingField;    // 0x0x18
    public long <MCMOLLCNPHO>k__BackingField;    // 0x0x20
    public long? <DGGPJNMDBKN>k__BackingField;    // 0x0x28
    public long? <AJGPCPPJOBD>k__BackingField;    // 0x0x38
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x48
    public string <KNCECKNFCIC>k__BackingField;    // 0x0x50
    public string <FFHHFCOKJHL>k__BackingField;    // 0x0x58
    public DateTime <BAEKJKIKAEK>k__BackingField;    // 0x0x60
    public DateTime <GKINHIFBCNE>k__BackingField;    // 0x0x68
    public int <OAMIPGLGEIP>k__BackingField;    // 0x0x70
    public AAOMIMIAKGO <AIIHFNPFBNH>k__BackingField;    // 0x0x74
    public bool <PDBKIBJJPDO>k__BackingField;    // 0x0x78
    public bool <KOPFDPKJMFK>k__BackingField;    // 0x0x79
    public HNIAHAIDJAC <FKCHPJGEECP>k__BackingField;    // 0x0x7C
    public HNIAHAIDJAC <FDGFGCMDHMH>k__BackingField;    // 0x0x80
    public long? <KPCEGJOCHDE>k__BackingField;    // 0x0x88
}
...
public class JDFEGACJGOK
{
    public ACODDCFJLBN <JPABGHDKMPP>k__BackingField;    // 0x0x10
    public HLHCALOHBDM <JEGICBLNGFO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JFIJOIPACGC
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class JFIJOIPACGC
{
    public int <CIAFMAALIFE>k__BackingField;    // 0x0x10
    public int? <CAPHCPEIGFE>k__BackingField;    // 0x0x14
    public string <ENFFPBNBJOB>k__BackingField;    // 0x0x20
    public string <EGPKCKDOBJH>k__BackingField;    // 0x0x28
}
...
public class JLGDECHJNNO
{
    public List<ALGBCBHPICC> <EAHDAGAJEAA>k__BackingField;    // 0x0x10
}
...
public class JLLIAMENNLJ
{
    public OGAJLEFDLBK <LLDKGCMIKBM>k__BackingField;    // 0x0x10
    public OEBAEGDPBLA <DBPLCLEDMLJ>k__BackingField;    // 0x0x18
    public PJGPNHMNHPH <LIMBEMKBMNK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KBJBGLGGNKF
//   (not directly referenced by a detected call)
public class KBJBGLGGNKF
{
    public float <EINNDBEOAPF>k__BackingField;    // 0x0x10
    public float <AGOIBIAPBPC>k__BackingField;    // 0x0x14
    public float <NPIKNEANBJP>k__BackingField;    // 0x0x18
    public float <ADJLMHAINEK>k__BackingField;    // 0x0x1C
    public float <PMCNNCIMALD>k__BackingField;    // 0x0x20
    public float <PMFBANMHFPK>k__BackingField;    // 0x0x24
    public float <OAHHPGAKGLL>k__BackingField;    // 0x0x28
    public float <FLHKLKLLCOJ>k__BackingField;    // 0x0x2C
}
...
// KFGPIBFKOAK
//   (not directly referenced by a detected call)
public class KFGPIBFKOAK
{
    public Guid <LAMPFEEGDJC>k__BackingField;    // 0x0x10
    public long <MCMOLLCNPHO>k__BackingField;    // 0x0x20
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x28
    public string <KNCECKNFCIC>k__BackingField;    // 0x0x30
    public string <FFHHFCOKJHL>k__BackingField;    // 0x0x38
    public long <IKOAIOHEGFE>k__BackingField;    // 0x0x40
    public Guid? <MEOKPICABIK>k__BackingField;    // 0x0x48
    public DateTime <FKMNKIJGDKM>k__BackingField;    // 0x0x60
}
...
// base   : IBKACDLFPML
//   (not directly referenced by a detected call)
public class KGFLMPJOODP : IBKACDLFPML
{
    public int <LLAAGCOJFBJ>k__BackingField;    // 0x0x60
    public List<CGGDEFPDNNN> <KKIPHOHFLPA>k__BackingField;    // 0x0x68
    public List<CGGDEFPDNNN> <GAEEGJMNAAG>k__BackingField;    // 0x0x70
    public List<CGGDEFPDNNN> <JCAOPOGENAJ>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// KNHHGOIIJHG
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class KNHHGOIIJHG
{
    public int <GFIDIGIJMJH>k__BackingField;    // 0x0x10
    public int <BKHFLILKLBD>k__BackingField;    // 0x0x14
    public float <OBFCMMJKPCG>k__BackingField;    // 0x0x18
    public int <PBNDBNEKDJN>k__BackingField;    // 0x0x1C
    public int <JBINPKPLKCB>k__BackingField;    // 0x0x20
    public int <HBNLJCFHHGC>k__BackingField;    // 0x0x24
    public int <ICEKGLANELO>k__BackingField;    // 0x0x28
    public string <BBACAAOBNEH>k__BackingField;    // 0x0x30
    public string <IGKOIIFKGFF>k__BackingField;    // 0x0x38
}
...
public class KONGMMNFJHI
{
    public GAMCHJBFGDG <LPMNMIEMOLO>k__BackingField;    // 0x0x10
    public string <DHDOFHGGGHI>k__BackingField;    // 0x0x18
    public int? <GHEKEIOGPMO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LCPOOJEAMJA
//   RESPONSE GET    api/config/v2   [Service.API]
public class LCPOOJEAMJA
{
    public Dictionary<int, int> <JINMNDJAOHO>k__BackingField;    // 0x0x10
    public List<BJHAFELDHDD> <NBJPGCNMJOL>k__BackingField;    // 0x0x18
    public FCAOHDFPEAP[][] <LEJAGCBLNPP>k__BackingField;    // 0x0x20
    public GJBCKEHFLFM <DHGIMDNBJGI>k__BackingField;    // 0x0x28
    public KBJBGLGGNKF <LCGOEHIOJJC>k__BackingField;    // 0x0x30
    public PEADNOECLLA <PILDJCCDIHC>k__BackingField;    // 0x0x38
    public BHFCHGGAMPL <CBPHGDFMKOL>k__BackingField;    // 0x0x40
    public APIJLJINIEC <OAENNOECDDE>k__BackingField;    // 0x0x48
    public string <DMDMGDFGHBI>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// LKNAOGKFCAF
//   (not directly referenced by a detected call)
public class LKNAOGKFCAF
{
    public long <BNJIHNJANED>k__BackingField;    // 0x0x10
    public string <ALJBEJOGIKH>k__BackingField;    // 0x0x18
    public string <PEFBPEEMFGG>k__BackingField;    // 0x0x20
    public NIEKOAENMLL? <EJICGOPEDMA>k__BackingField;    // 0x0x28
    public string <JMGKKLPFLFH>k__BackingField;    // 0x0x30
    public string <LCGNIDLAIAI>k__BackingField;    // 0x0x38
    public FHPHMBKPLCC <EPHBBJIOJLA>k__BackingField;    // 0x0x40
    public int <ABCMKCHKAHN>k__BackingField;    // 0x0x44
    public int <NLJNDJDBMHI>k__BackingField;    // 0x0x48
    public IIGLDDDANPN? <NDNOCAHHBJE>k__BackingField;    // 0x0x4C
    public DOOBOJIHNDF? <HBIFCDDKBFG>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// MBPHDPMELBC
//   (not directly referenced by a detected call)
public class MBPHDPMELBC
{
    public DateTime <DFDBOFCNHKP>k__BackingField;    // 0x0x10
    public string <NONIEPIMOPB>k__BackingField;    // 0x0x18
}
...
public class MKEJIKOPGJP
{
    public List<string> <EJKKNGOCLGI>k__BackingField;    // 0x0x10
    public List<string> <OOPKPPCEBKA>k__BackingField;    // 0x0x18
    public List<string> <JCMNGHOIGIA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MODNIGHDDHE
//   (not directly referenced by a detected call)
public class MODNIGHDDHE
{
    public Guid <LBOJJICKJDG>k__BackingField;    // 0x0x10
    public byte <CBOKJKKMELD>k__BackingField;    // 0x0x20
}
...
public class MOJJJCCHPLE
{
    public FLOBEEJEPJO <LLDKGCMIKBM>k__BackingField;    // 0x0x10
    public EOHADGOEBOD <BHECBAFNPEM>k__BackingField;    // 0x0x18
}
...
// base   : IMIJPHJKLIM
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class NCBAEFEDLMK : IMIJPHJKLIM
{
    public List<ALGBCBHPICC> <EAHDAGAJEAA>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// NCDGHHNNDAD
//   RESPONSE ?      api/incentivizedreferrals/   [Service.Econ]
public class NCDGHHNNDAD
{
    public List<AFDHOJNMALM> <NDEJPGAIJLD>k__BackingField;    // 0x0x10
    public string <NFCDNLDDPPG>k__BackingField;    // 0x0x18
}
...
public class NEBMBAPKNNF
{
    public long <MCMOLLCNPHO>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <FLEPJLJFMIL>k__BackingField;    // 0x0x18
    public ICEICLJGMIK <GNEPLLNNIDE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NGHFNDNBCGL
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class NGHFNDNBCGL
{
    public int <BCBIFFAJPAN>k__BackingField;    // 0x0x10
    public Guid <PNKPEHFPJLM>k__BackingField;    // 0x0x14
    public long <NIEMLAPBKMA>k__BackingField;    // 0x0x28
    public DateTime <FKMNKIJGDKM>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// NJPAADFEEJB
//   (not directly referenced by a detected call)
public class NJPAADFEEJB
{
    // (no instance fields in the metadata dump)
}
...
public class NLBMGABMNDD : CAPIKAHMPLA
{
    public HMNANAGIKJF? <FPILOCLGELF>k__BackingField;    // 0x0x18
    public NGHFNDNBCGL <AHPLBLPMHKP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NLGDEBPNCIN
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.Econ]
public class NLGDEBPNCIN
{
    public int <JFACEEILJAF>k__BackingField;    // 0x0x10
    public string <NFGKBJIBDBA>k__BackingField;    // 0x0x18
    public List<CKLCFFGDCLA> <KMNBMHNMFAN>k__BackingField;    // 0x0x20
    public LKNAOGKFCAF <EJKMLFDNONL>k__BackingField;    // 0x0x28
    public string <BNLHPENJLAC>k__BackingField;    // 0x0x30
    public DateTime <GFCEOHFEBOF>k__BackingField;    // 0x0x38
    public DateTime <PICJKKAHJPJ>k__BackingField;    // 0x0x40
    public DateTime <FJAGOPABMAM>k__BackingField;    // 0x0x48
    public bool? <LNPEDPGGKAP>k__BackingField;    // 0x0x50
}
...
public class NLOBPGDAHAN
{
    public int <IFLDNPDLEJD>k__BackingField;    // 0x0x10
    public bool <JBLPKLPNEEK>k__BackingField;    // 0x0x14
    public DateTime <CDPKHDDHFIE>k__BackingField;    // 0x0x18
    public bool <KICCMJICMDD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NPGJAFKHJHI
//   (not directly referenced by a detected call)
public class NPGJAFKHJHI
{
    public int <OODPOJIKPBO>k__BackingField;    // 0x0x10
    public CJDHONMNJNA <DKKJMBNAKPK>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// OBNLIHDIEIE
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Econ]
public class OBNLIHDIEIE
{
    public Guid <FIOBDMILINN>k__BackingField;    // 0x0x10
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x20
    public string <FFHHFCOKJHL>k__BackingField;    // 0x0x28
    public DateTime <GFCEOHFEBOF>k__BackingField;    // 0x0x30
    public DateTime? <EJLDHBPMAOM>k__BackingField;    // 0x0x38
    public List<IIJLKAPNFHH> <OEMFPHFLKIJ>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// OEBAEGDPBLA
//   (not directly referenced by a detected call)
public class OEBAEGDPBLA
{
    public ObscuredLong <ALLDPFIHAJG>k__BackingField;    // 0x0x10
    public string <OCDAPHHCAHM>k__BackingField;    // 0x0x38
    public ObscuredInt <MBEPJPMLKAF>k__BackingField;    // 0x0x40
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x58
    public string <KNCECKNFCIC>k__BackingField;    // 0x0x60
    public string <FFHHFCOKJHL>k__BackingField;    // 0x0x68
    public int <EFIKECBCDKB>k__BackingField;    // 0x0x70
    public LKJFEJHJBAN <AIIHFNPFBNH>k__BackingField;    // 0x0x74
    public DateTime <FKMNKIJGDKM>k__BackingField;    // 0x0x78
    public DateTime <DFDBOFCNHKP>k__BackingField;    // 0x0x80
    public DateTime? <PGFDOEBLBAJ>k__BackingField;    // 0x0x88
    public long? <GFMCOAPFGDA>k__BackingField;    // 0x0x98
    public int <GDPLAEGEAEF>k__BackingField;    // 0x0xA8
    public int <LBIDGKGDIEC>k__BackingField;    // 0x0xAC
    public int <LBJNAECCLKC>k__BackingField;    // 0x0xB0
    public DNCOGHGDMAF <JKDCLGIMFCO>k__BackingField;    // 0x0xB4
    public DNCOGHGDMAF <MGEAOHAHCPI>k__BackingField;    // 0x0xB8
    public ObscuredBool <NNCPNFKEMLG>k__BackingField;    // 0x0xBC
    public ObscuredBool <FPCFOIBLGAM>k__BackingField;    // 0x0xC8
    public ObscuredBool <AHCJOEFCKBC>k__BackingField;    // 0x0xD4
    public int? <IKOAIOHEGFE>k__BackingField;    // 0x0xE0
    public bool <CPLIMLKEJIM>k__BackingField;    // 0x0xE8
}

// --------------------------------------------------------------------------
// OEJABPGBMLH
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class OEJABPGBMLH
{
    public Dictionary<Guid, BLBJMECFGJE> <OAOGKHODKKC>k__BackingField;    // 0x0x10
}
...
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{iKHNIJKGJFD}   [Service.API]
public class ONCHFLDGGCK
{
    public uint <MACAHHPDDID>k__BackingField;    // 0x0x10
    public uint? <OIJKKAGDPFJ>k__BackingField;    // 0x0x14
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x20
    public string <KNCECKNFCIC>k__BackingField;    // 0x0x28
    public DateTime <HAGPNGOGOPD>k__BackingField;    // 0x0x30
    public DateTime? <MJDLFLCIBAN>k__BackingField;    // 0x0x38
    public bool <HDEGEIOIGJL>k__BackingField;    // 0x0x48
    public List<BNMEGKPHFPA> <NNAMNKNHBBG>k__BackingField;    // 0x0x50
    public List<string> <EAHDAGAJEAA>k__BackingField;    // 0x0x58
    public int <GMJBOBEJPBB>k__BackingField;    // 0x0x60
    public int <DIHAFBJBNGP>k__BackingField;    // 0x0x64
    public int <IPBFPNEIBGO>k__BackingField;    // 0x0x68
}
...
// base   : JJAJHFHIHIO
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{nJCNIFJHLNK}   [Service.Econ]
public class OOLOKEOHJPG : JJAJHFHIHIO
{
    public int <FMFIMIGMMEL>k__BackingField;    // 0x0x30
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x38
    public DateTime <GFCEOHFEBOF>k__BackingField;    // 0x0x40
    public DateTime <PICJKKAHJPJ>k__BackingField;    // 0x0x48
    public GKPEKOLBBJL <LHAOPFKLDDM>k__BackingField;    // 0x0x50
    public IBKACDLFPML <CFFAJNKDIME>k__BackingField;    // 0x0x58
    public List<KGFLMPJOODP> <ONLIDFAEBAC>k__BackingField;    // 0x0x60
    public HNJJEAFLMFO <AHNFOJEMCKK>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// PAOMHJBMEIN
//   (not directly referenced by a detected call)
public class PAOMHJBMEIN
{
    public Guid <LAMPFEEGDJC>k__BackingField;    // 0x0x10
    public int <BCBIFFAJPAN>k__BackingField;    // 0x0x20
    public int <BNMLJPPPEBI>k__BackingField;    // 0x0x24
    public Guid <EKJGFAPLAKH>k__BackingField;    // 0x0x28
    public DateTime <FKMNKIJGDKM>k__BackingField;    // 0x0x38
    public KFGPIBFKOAK <NOBNIKDLNLL>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PEADNOECLLA
//   (not directly referenced by a detected call)
public class PEADNOECLLA
{
    public int <EJKMAICHBMJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PGEGPFNLFGL
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class PGEGPFNLFGL
{
    public List<NPGJAFKHJHI> <OHFOOCOAGJF>k__BackingField;    // 0x0x10
    public CJDHONMNJNA <DKKJMBNAKPK>k__BackingField;    // 0x0x18
}
...
public class PGPMEPFEIGL
{
    public Dictionary<Guid, PHIBIAGLCBG> <HAGDDMGMFDL>k__BackingField;    // 0x0x10
}
...
public class PHIBIAGLCBG
{
    public PLPKONMJAFM <LLDKGCMIKBM>k__BackingField;    // 0x0x10
    public PAOMHJBMEIN <DNHMDBFIMKM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PJGPNHMNHPH
//   (not directly referenced by a detected call)
public class PJGPNHMNHPH
{
    public long <ALLDPFIHAJG>k__BackingField;    // 0x0x10
    public string <OCDAPHHCAHM>k__BackingField;    // 0x0x18
    public int <EGOKJADOHLD>k__BackingField;    // 0x0x20
    public int <GFKEICFOKEH>k__BackingField;    // 0x0x24
    public int <KCAPLPLPOEG>k__BackingField;    // 0x0x28
    public int <BJADGABLPFF>k__BackingField;    // 0x0x2C
    public int <LMLBLBMEJKA>k__BackingField;    // 0x0x30
    public string <KFIBKALIBNA>k__BackingField;    // 0x0x38
    public string <PGGHPIADFGP>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PLPBICCPKGI
//   (not directly referenced by a detected call)
public class PLPBICCPKGI
{
    public GKPEKOLBBJL <LHAOPFKLDDM>k__BackingField;    // 0x0x10
    public int <IKOAIOHEGFE>k__BackingField;    // 0x0x14
    public AHKCOMPKMJD <BFOFNMNIHAI>k__BackingField;    // 0x0x18
}
...
{
    public long <MCMOLLCNPHO>k__BackingField;    // 0x0x10
    public long? <DGGPJNMDBKN>k__BackingField;    // 0x0x18
    public BLIIKHLKHJA <PIJLLLLJFMG>k__BackingField;    // 0x0x28
}
...
{
    public HCDCFEGOFEP <DKKJMBNAKPK>k__BackingField;    // 0x0x10
    public string <ECHMDFHMHBP>k__BackingField;    // 0x0x18
    public string <HBIDFIGIJDB>k__BackingField;    // 0x0x20
    public string <EMAGLJJJHPE>k__BackingField;    // 0x0x28
}
...
{
    public long <HNCNGNCJOCO>k__BackingField;    // 0x0x10
    public long? <HLLJDEODNPC>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public LHJOAPKMPKC FilterType;    // 0x0x20
...
{
    public BLIIKHLKHJA <HEEOCIGBNAM>k__BackingField;    // 0x0x10
    public string <LLDLDPFIHBE>k__BackingField;    // 0x0x18
    public int <FLPHBOGIOBF>k__BackingField;    // 0x0x20
    public int <FLMJNEPNMOD>k__BackingField;    // 0x0x24
    public string <COBGIOKACIE>k__BackingField;    // 0x0x28
    public string <NLPIEILGHKJ>k__BackingField;    // 0x0x30
}
...
{
    public int <BCBIFFAJPAN>k__BackingField;    // 0x0x10
    public Guid <MKEILPMCKNH>k__BackingField;    // 0x0x14
    public DateTime <LGIKBEBBBEK>k__BackingField;    // 0x0x28
}
...
{
    public bool <IOABLANMHKN>k__BackingField;    // 0x0x10
    public int <CKLHABFKFKN>k__BackingField;    // 0x0x14
    public bool <KFEMICJJHPL>k__BackingField;    // 0x0x18
}
...
{
    public Guid <MKEILPMCKNH>k__BackingField;    // 0x0x10
    public BLIIKHLKHJA <KLJCNGJICNO>k__BackingField;    // 0x0x20
    public int <DMFEAKDLPNA>k__BackingField;    // 0x0x24
    public long <MCMOLLCNPHO>k__BackingField;    // 0x0x28
    public long? <DGGPJNMDBKN>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{lEBNGAGIGPK}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <KAHOFPMCMFH>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <LDHFANEGKNK>k__BackingField;    // 0x0x18
}
...
{
    public long <JMAAMNOHGDK>k__BackingField;    // 0x0x10
    public long <MCMOLLCNPHO>k__BackingField;    // 0x0x18
    public long <EMGCGOJDNND>k__BackingField;    // 0x0x20
    public KPEEPMGPOIB <KEPJAEKMFIJ>k__BackingField;    // 0x0x28
    public int <HGHJPBJOJMK>k__BackingField;    // 0x0x2C
}
...
{
    public long <MCMOLLCNPHO>k__BackingField;    // 0x0x10
    public List<Guid> <FFDFOHCNPAK>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <KAHOFPMCMFH>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <LDHFANEGKNK>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <PNLKCHPOHIM>k__BackingField;    // 0x0x20
}
...
{
    public long <EMGCGOJDNND>k__BackingField;    // 0x0x10
    public long <EFJDKHNAODL>k__BackingField;    // 0x0x18
    public int? <GGGFMMLONNJ>k__BackingField;    // 0x0x20
    public int? <KNKDHLHCCFI>k__BackingField;    // 0x0x28
    public long? <MCNBMBBFADL>k__BackingField;    // 0x0x30
    public long <KLPDHDHLJAI>k__BackingField;    // 0x0x40
    public long <EMCOPGAJNHG>k__BackingField;    // 0x0x48
    public int <PIDJLMFIPBI>k__BackingField;    // 0x0x50
    public KPEEPMGPOIB <DCEBKJBOMJM>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <GEBDPAFJEKN>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public IIGLDDDANPN <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public KPNOJENBPDL creatorAccountRole;    // 0x0x58
}
...
{
    public FFAEIJPHMAG <NKJIOBJJGCL>k__BackingField;    // 0x0x10
    public BIAMCKEGLDJ <NMAJBGICNEG>k__BackingField;    // 0x0x14
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x18
    public string <KNCECKNFCIC>k__BackingField;    // 0x0x20
    public bool <OODABIABOBC>k__BackingField;    // 0x0x28
}
...
{
    public List<FFAEIJPHMAG> <OHGKDKKLCJG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{jJLIIOCLCNA}   [Service.API]
public class ProgressionEventDTO
{
    public long <EFJDKHNAODL>k__BackingField;    // 0x0x10
    public string <OAGDGNIJPJL>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <JCAOPOGENAJ>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <BBPPJPNLHIB>k__BackingField;    // 0x0x28
    public DateTime <BAEKJKIKAEK>k__BackingField;    // 0x0x30
    public DateTime <GKINHIFBCNE>k__BackingField;    // 0x0x38
    public DateTime <COIEHCHBMCN>k__BackingField;    // 0x0x40
    public bool <CBPDFFEKAEC>k__BackingField;    // 0x0x48
    public int <JCPMAEFIHDI>k__BackingField;    // 0x0x4C
    public float <DGAEGHDNPBG>k__BackingField;    // 0x0x50
    public Guid? <NOFHBBPJLFF>k__BackingField;    // 0x0x54
    public string <CANOFFGMKDD>k__BackingField;    // 0x0x68
    public string <OCFDBHGOLJM>k__BackingField;    // 0x0x70
    public string <CJFHNKAGNGD>k__BackingField;    // 0x0x78
    public string <GPMPDKMBNGG>k__BackingField;    // 0x0x80
}
...
{
    public Guid <LCHMGHGDLKI>k__BackingField;    // 0x0x10
    public int <HCEBLBMMDFC>k__BackingField;    // 0x0x20
    public int <NKDJEHFIEHD>k__BackingField;    // 0x0x24
    public int <BOPKOIAMDPB>k__BackingField;    // 0x0x28
    public long <FKHCPHMFEKB>k__BackingField;    // 0x0x30
    public long <HCAPEKEGKJE>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventRecordDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/record/{jJLIIOCLCNA}   [Service.API]
public class ProgressionEventRecordDTO
{
    public int <BCBIFFAJPAN>k__BackingField;    // 0x0x10
    public int <ABCMKCHKAHN>k__BackingField;    // 0x0x14
    public int <ENCICDBDBMP>k__BackingField;    // 0x0x18
    public int <ADHIENODHDP>k__BackingField;    // 0x0x1C
    public int <ANKNHBGMPCH>k__BackingField;    // 0x0x20
    public DateTime? <JCBEDKKJKPB>k__BackingField;    // 0x0x28
}
...
{
    public long <AEKPPLJFNIB>k__BackingField;    // 0x0x10
    public int <BNJIHNJANED>k__BackingField;    // 0x0x18
    public string <FFHHFCOKJHL>k__BackingField;    // 0x0x20
    public int <ABCMKCHKAHN>k__BackingField;    // 0x0x28
    public int <KEFHJHFPLJG>k__BackingField;    // 0x0x2C
    public bool <FCLGADCBHON>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public CBBKADNEBGN ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool HDFPBBBFIPE;    // 0x0x28
}
...
{
    public MMCGOCLBAEG? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public MMCGOCLBAEG KGEBKKHKJGD;  // wrapper
...
{
    public EAFLPCNDJNK PKEFBHINBDE;  // wrapper
...
{
    public MCFHHMMIEHP NIFOGEBEDNG;  // wrapper
    public int? AFBGIPGHBMO;  // wrapper
...
{
    public OMLBCKDFMHL EOMKPEADCNH;  // wrapper
    public float? EELEHOHHOMA;  // wrapper
...
{
    public GMBCAMAAPMN UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public IIGLDDDANPN DELCOFCGDFF;  // wrapper
    public IIGLDDDANPN? OOLNIMDJKLJ;  // wrapper
...
{
    public CKLCFFGDCLA ANABCFJHOFA;  // wrapper
...
{
    public LKJFEJHJBAN NCJPNJKEEHD;  // wrapper
    public byte[] KHNFGNKHGGG;  // wrapper
    public byte[] MHNNKIBKIGD;  // wrapper
    public Color HMCAFGCGFJF;  // wrapper
...
{
    public List<FFNCPFGBPND> CKAPBBGHJEC;  // wrapper
}
...
{
    public FMDBPNFFJAH OFBKHHAOBNO;  // wrapper
    public IIGLDDDANPN? NLDFHOPLCAL;  // wrapper
...
{
    public GNBEMBCEKHE HCIBGFPNHCJ;  // wrapper
...
{
    public OEBAEGDPBLA inventionId;  // wrapper
}
...
// api/keepsakes/{oPOMJNNALCB}/collect  [API POST]
public class KeepsakesOPOMJNNALCBCollectRequest
{
    public Guid OPOMJNNALCB;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> DCCNDPPOHOG;  // wrapper
    public ELPJJPDDKCD MCGAJGCMAAK;  // wrapper
    public long? EPOBIFCHLNM;  // wrapper
...
{
    public long? FJGKDBAFAGH;  // wrapper
    public long? AFPHABFLEBN;  // wrapper
    public List<string> CMBMOBEBGIN;  // wrapper
    public DateTime HDGFHFCPNPD;  // wrapper
    public DateTime FJKIDPPLMMJ;  // wrapper
    public AAOMIMIAKGO NCJPNJKEEHD;  // wrapper
    public HNIAHAIDJAC JCICPIGFFNF;  // wrapper
    public HNIAHAIDJAC JIMFECFFOBK;  // wrapper
}
...
{
    public HNIAHAIDJAC JCICPIGFFNF;  // wrapper
    public HNIAHAIDJAC CONKBIBEBED;  // wrapper
}
...
{
    public Guid FJBOFHHJDBF;  // wrapper
...
{
    public List<KFGGACIHDIN> MANHMJGKFFB;  // wrapper
}
...
{
    public Guid LFNGEFEDKJM;  // wrapper
    public object Price;  // candidate
...
{
    public Guid LFNGEFEDKJM;  // wrapper
    public long? CKKJBLGGKKM;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Limit;  // candidate
...
{
    public Guid FJBOFHHJDBF;  // wrapper
    public long? BECMELKBGCA;  // wrapper
    public long? PJJFBBBIFOP;  // wrapper
    public int? MHAKGFHBBPF;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> HMJOKPKOPCN;  // wrapper
...
{
    public IEnumerable<OIMKCBGAAFN> BADGDMICNJB;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public Guid? OAELEOGJFOL;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object RoomId;  // candidate
...
{
    public OMLBCKDFMHL EOMKPEADCNH;  // wrapper
    public long? LLKNDIDFNDB;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats KJDCNDHHDPB;  // wrapper
}
...
{
    public Guid IAONHAIPOME;  // wrapper
...
{
    public Guid HOLGLFFOCIN;  // wrapper
...
{
    public List<MHEJMGIDMNM> JHHIDBEMGFC;  // wrapper
    public object roomId;  // candidate
...
{
    public OMODFGPFHEH JMPCHLFKPHK;  // wrapper
}
