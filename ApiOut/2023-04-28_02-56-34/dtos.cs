...
//   RESPONSE GET    api/avatar/v2/{dKMBEMBDAMI}   [Service.Econ]
public class ADMOFMIBGIP
{
    public string <IFGALCKAOLA>k__BackingField;    // 0x0x10
    public string <KONCEKNHHJN>k__BackingField;    // 0x0x18
    public string <DLFAPBIAFLG>k__BackingField;    // 0x0x20
    public string <BHDMIPPIFCE>k__BackingField;    // 0x0x28
    public string <FHLPJHPNBEG>k__BackingField;    // 0x0x30
    public List<BENAOBLFPMJ> <FMIHAMEFMJP>k__BackingField;    // 0x0x38
}
...
// AIMAPGABJPK
//   (not directly referenced by a detected call)
public class AIMAPGABJPK
{
    public int <CLDLGDCEKEC>k__BackingField;    // 0x0x10
    public DateTime <FLELPCODCHM>k__BackingField;    // 0x0x18
    public DateTime? <MOFNAOEOFLN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AKCEBIBMAGB
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class AKCEBIBMAGB
{
    public Dictionary<Guid, LLEHPFCNHDC> <APKCHOEOJNH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// APGFKBHCNID
// base   : ADBFIODFKKF<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class APGFKBHCNID
{
...
public class BAFOKBOBPKK
{
    public List<AIMAPGABJPK> <INEBMHLCCCC>k__BackingField;    // 0x0x10
    public string <NEIHELJCHKC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BENAOBLFPMJ
//   (not directly referenced by a detected call)
public class BENAOBLFPMJ
{
    public Guid <DNKHJNLFIPM>k__BackingField;    // 0x0x10
    public byte <ILFOBIEPCOH>k__BackingField;    // 0x0x20
}
...
public class BFABHFINKCL
{
    public List<string> <IANFJDBCDNF>k__BackingField;    // 0x0x10
    public List<string> <HCGMCHJDEDB>k__BackingField;    // 0x0x18
    public List<string> <BOMLNJBJIFL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BFKOGJLBEFA
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class BFKOGJLBEFA
{
    public long <GBJBIHJDJBI>k__BackingField;    // 0x0x10
    public int <KGOOBILJMGJ>k__BackingField;    // 0x0x18
    public long <DJGIIAPKFJF>k__BackingField;    // 0x0x20
    public long? <BINLLJHGMII>k__BackingField;    // 0x0x28
    public long? <LPLLFIODHKG>k__BackingField;    // 0x0x38
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x48
    public string <GKBMOJMJLNH>k__BackingField;    // 0x0x50
    public string <EPFHLMAABIM>k__BackingField;    // 0x0x58
    public DateTime <PBAJGKDEHNO>k__BackingField;    // 0x0x60
    public DateTime <NPKNMAKCANC>k__BackingField;    // 0x0x68
    public int <EODMGCMJHKE>k__BackingField;    // 0x0x70
    public AFGHMLCJKJD <DPKMEPKGAPF>k__BackingField;    // 0x0x74
    public bool <APAKDJPBNDA>k__BackingField;    // 0x0x78
    public bool <AEKJECKMFCF>k__BackingField;    // 0x0x79
    public ECFNGBJFPLK <NEHBDOGGNMH>k__BackingField;    // 0x0x7C
    public ECFNGBJFPLK <NJGCCMGGMNK>k__BackingField;    // 0x0x80
    public long? <CODKGEKEPOO>k__BackingField;    // 0x0x88
}
...
// BIIHBFGAGOP
//   (not directly referenced by a detected call)
public class BIIHBFGAGOP
{
    public long <JGCFOGAEJFK>k__BackingField;    // 0x0x10
    public Guid <MAMPCPJIOBD>k__BackingField;    // 0x0x18
    public long <DJGIIAPKFJF>k__BackingField;    // 0x0x28
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x30
    public string <GKBMOJMJLNH>k__BackingField;    // 0x0x38
    public int <JHBKMIHNNHK>k__BackingField;    // 0x0x40
    public Guid? <CMFLNPMGMAG>k__BackingField;    // 0x0x44
    public DateTime <FLELPCODCHM>k__BackingField;    // 0x0x58
    public string <EPFHLMAABIM>k__BackingField;    // 0x0x60
}
...
public class BKGPGIEDMIN : KHPCOFNDGEO
{
    public CLEJLHMFCOJ? <NICCEPCICLN>k__BackingField;    // 0x0x18
    public CFHFPLFEFGG <IJECNINCDLF>k__BackingField;    // 0x0x20
}
...
public class BPOJIOBOHMN
{
    public bool <EPCEFAMDFCP>k__BackingField;    // 0x0x10
    public string <EHMIIEJCKHH>k__BackingField;    // 0x0x18
}
...
public class CAGFJAGBKGO
{
    public int <FNNNPIJMIKF>k__BackingField;    // 0x0x10
}
...
public class CDKCMHHBGBF
{
    public List<BFKOGJLBEFA> <KBHMMIENDPB>k__BackingField;    // 0x0x10
    public string <NEIHELJCHKC>k__BackingField;    // 0x0x18
}
...
public class CFHFPLFEFGG
{
    public int <MDOBLCMOLMB>k__BackingField;    // 0x0x10
    public Guid <LBAMNJKOBCD>k__BackingField;    // 0x0x14
    public long <KGGOBOKGCLN>k__BackingField;    // 0x0x28
    public DateTime <JLEMDBENFFL>k__BackingField;    // 0x0x30
}
...
// base   : BFKOGJLBEFA
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class CPFOLDEDFEJ : BFKOGJLBEFA
{
    public List<NGEEIMNPFBE> <HANCGBJPGBH>k__BackingField;    // 0x0x98
}
...
// DBLHMGFBFHA
//   (not directly referenced by a detected call)
public class DBLHMGFBFHA
{
    public bool <EAECENBIBII>k__BackingField;    // 0x0x10
    public ELJLPEBHMBM <MELCJNBIMLE>k__BackingField;    // 0x0x18
    public float <DMNBCNMDOJK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DBPBNALKGDM
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class DBPBNALKGDM
{
    public int <NIAGOCMACLG>k__BackingField;    // 0x0x10
    public int <EFLMGPKJLHO>k__BackingField;    // 0x0x14
    public float <FKCJKENLNHJ>k__BackingField;    // 0x0x18
    public int <JMGBILEIPGC>k__BackingField;    // 0x0x1C
    public int <PDBPLDGDJIF>k__BackingField;    // 0x0x20
    public int <KPDIIFONJNB>k__BackingField;    // 0x0x24
    public int <PFBNNBOINFK>k__BackingField;    // 0x0x28
    public string <GGHMLFJHFJN>k__BackingField;    // 0x0x30
    public string <AMFCHKCGIAJ>k__BackingField;    // 0x0x38
}
...
public class DCLBAGDLIKE
{
    public int <DFCEDNAAOGI>k__BackingField;    // 0x0x10
    public PKDPIPJPOJI <AEDMHMHADOF>k__BackingField;    // 0x0x14
    public NEEAKKBFCJP <AOHHFAKLHLL>k__BackingField;    // 0x0x18
    public NEEAKKBFCJP <BMILCJMAHHJ>k__BackingField;    // 0x0x1C
    public NEEAKKBFCJP <CEINFHKKJEE>k__BackingField;    // 0x0x20
}
...
// DMHIGOKNGPL
//   (not directly referenced by a detected call)
public class DMHIGOKNGPL
{
    public float <ABEODFAPMPE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DMMOHAECOKB
//   (not directly referenced by a detected call)
public class DMMOHAECOKB
{
    public POIMILPGFGJ <FGJPIMEMHPH>k__BackingField;    // 0x0x10
    public int <JHBKMIHNNHK>k__BackingField;    // 0x0x14
    public PIFCMKPGGNA <GCPEDNBLECH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DPFAAONNKOM
//   (not directly referenced by a detected call)
public class DPFAAONNKOM
{
    public float <EMIAEADBDHK>k__BackingField;    // 0x0x10
    public float <POMLFPLPEOB>k__BackingField;    // 0x0x14
    public float <AADDCGDADGL>k__BackingField;    // 0x0x18
    public float <ALDCDGMFDGP>k__BackingField;    // 0x0x1C
    public float <MJNIADNJINK>k__BackingField;    // 0x0x20
    public float <EEMECGMOIGM>k__BackingField;    // 0x0x24
    public float <HLOCDBFMAII>k__BackingField;    // 0x0x28
    public float <DLOEBPNGKBC>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// DPJDONIOBJD
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class DPJDONIOBJD
{
    public bool <LLKIGCFBABK>k__BackingField;    // 0x0x10
    public string <AOHNMKEDENK>k__BackingField;    // 0x0x18
    public string <BMMGDPLMPOH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EAPPCCIFHGP
//   (not directly referenced by a detected call)
public class EAPPCCIFHGP
{
    public long <KPCPONFPJNB>k__BackingField;    // 0x0x10
    public string <MAMPCPJIOBD>k__BackingField;    // 0x0x18
    public int <FMFAKBLOIFH>k__BackingField;    // 0x0x20
    public int <PILCBCMCCPF>k__BackingField;    // 0x0x24
    public int <BMEGLMCBDCJ>k__BackingField;    // 0x0x28
    public int <GKBIFMDLGCL>k__BackingField;    // 0x0x2C
    public int <IFBLNACEAAL>k__BackingField;    // 0x0x30
    public string <DPLHAEBNBNG>k__BackingField;    // 0x0x38
    public string <KIEFNHEDLJM>k__BackingField;    // 0x0x40
}
...
public class ECGJCFFNDCO
{
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x10
    public string <GKBMOJMJLNH>k__BackingField;    // 0x0x18
    public int? <JHBKMIHNNHK>k__BackingField;    // 0x0x20
    public POJACDFEGKB? <DPKMEPKGAPF>k__BackingField;    // 0x0x28
}
...
// base   : KPCEHEDFDDP
//   (not directly referenced by a detected call)
public class EIBPLOOODCO : KPCEHEDFDDP
{
    public int <PHKEIJLIMIG>k__BackingField;    // 0x0x60
    public List<DBLHMGFBFHA> <IDFNNHCGIMB>k__BackingField;    // 0x0x68
    public List<DBLHMGFBFHA> <IAAEGBGPGFL>k__BackingField;    // 0x0x70
    public List<DBLHMGFBFHA> <JKDEKDOABJP>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// ELJLPEBHMBM
//   (not directly referenced by a detected call)
public class ELJLPEBHMBM
{
    public int <MNINOININMI>k__BackingField;    // 0x0x10
    public string <KBJGKMKAPKF>k__BackingField;    // 0x0x18
    public string <KFNNEOKBJKF>k__BackingField;    // 0x0x20
    public string <FLNDAJKACMN>k__BackingField;    // 0x0x28
    public string <CGCIIGJFPEF>k__BackingField;    // 0x0x30
    public string <BOKIHFPLCFC>k__BackingField;    // 0x0x38
    public NONCKHFIJGD? <KANHJOGHNKG>k__BackingField;    // 0x0x40
    public string <KGIDEEJLLBH>k__BackingField;    // 0x0x48
    public string <HEADBIMNPNA>k__BackingField;    // 0x0x50
    public bool <HDEMFDFEEBH>k__BackingField;    // 0x0x58
    public bool <KLADMEBFGCG>k__BackingField;    // 0x0x59
    public bool <GDIBMKCDMLK>k__BackingField;    // 0x0x5A
    public HPNECILCPIC <HFLKKGPMHEL>k__BackingField;    // 0x0x5C
    public int <HPFKOJOBBPI>k__BackingField;    // 0x0x60
    public POIMILPGFGJ <FGJPIMEMHPH>k__BackingField;    // 0x0x64
    public int <EEDNGOFPBNE>k__BackingField;    // 0x0x68
    public GDHENONOGLE <KAMMKGMEEBB>k__BackingField;    // 0x0x6C
    public MOKLNBOCPGF <GBEFHIPMILF>k__BackingField;    // 0x0x70
    public int? <KCLMPBPNLFN>k__BackingField;    // 0x0x74
    public string <OPKEHEJHKOK>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// EMNPFKOHCJA
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class EMNPFKOHCJA
{
    public int <NFEJHLOLDHC>k__BackingField;    // 0x0x10
    public int? <KONDIHAALJJ>k__BackingField;    // 0x0x14
    public string <EMELCHBLDAD>k__BackingField;    // 0x0x20
    public string <GFMNHGJGOAE>k__BackingField;    // 0x0x28
}
...
public class FCDKFKNBHKE
{
    public int? <OMLKFDLMEPO>k__BackingField;    // 0x0x10
    public string <ADPHCNKIECL>k__BackingField;    // 0x0x18
    public string <OIFGLFAIAFB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FCKMGGKMOHA
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.Econ]
public class FCKMGGKMOHA
{
    public int <DIDNHIFMPJE>k__BackingField;    // 0x0x10
    public string <MLIOCFMMOAE>k__BackingField;    // 0x0x18
    public List<KFBBNGPLBLI> <PBAIEFNLNJI>k__BackingField;    // 0x0x20
    public PMIMOBKHDHL <NLGDFIAHKLN>k__BackingField;    // 0x0x28
    public string <OBFHKKFGAAL>k__BackingField;    // 0x0x30
    public DateTime <MEHDFFGFJFK>k__BackingField;    // 0x0x38
    public DateTime <EHDGDDJNNPF>k__BackingField;    // 0x0x40
    public DateTime <HKPKECMDCIO>k__BackingField;    // 0x0x48
    public bool? <FHMJBHBIPDO>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// FHIKNMHFMCB
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class FHIKNMHFMCB
{
    public Guid? <GMNELMMLDKL>k__BackingField;    // 0x0x10
    public long? <DJGIIAPKFJF>k__BackingField;    // 0x0x28
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x38
    public string <GKBMOJMJLNH>k__BackingField;    // 0x0x40
    public string <EPFHLMAABIM>k__BackingField;    // 0x0x48
    public IEEJINAPBLI <DMHEHGDMDIO>k__BackingField;    // 0x0x50
}
...
// FJOIMJLKFFK
//   (not directly referenced by a detected call)
public class FJOIMJLKFFK
{
    public int <BDEFGCJAHCH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FKLHKLKHNOK
//   (not directly referenced by a detected call)
public class FKLHKLKHNOK
{
    public DateTime <FLELPCODCHM>k__BackingField;    // 0x0x10
    public string <IGAPODPBPJI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FPFNEJKKOLL
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class FPFNEJKKOLL
{
    public POMGPAFMMKA <PECKHPBCEDE>k__BackingField;    // 0x0x10
    public int <FNNNPIJMIKF>k__BackingField;    // 0x0x14
    public long <BHDEKADDPBI>k__BackingField;    // 0x0x18
    public bool <PBBAMEIDHFD>k__BackingField;    // 0x0x20
    public string <EHMIIEJCKHH>k__BackingField;    // 0x0x28
    public int? <FNOJGJMICNB>k__BackingField;    // 0x0x30
    public bool <OFFCIKJMNHE>k__BackingField;    // 0x0x38
    public bool <LPMNMCNDCEG>k__BackingField;    // 0x0x39
    public bool <GKLFDDENFAO>k__BackingField;    // 0x0x3A
    public string <ALKHPJBIFPL>k__BackingField;    // 0x0x40
    public DateTime? <LDKHCBINCJA>k__BackingField;    // 0x0x48
    public float <LCMGHELMPCI>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// GAOHALPJGML
//   (not directly referenced by a detected call)
public class GAOHALPJGML
{
    public Guid <GGGMOFJPGOP>k__BackingField;    // 0x0x10
    public Guid <MCGPMMBBCMJ>k__BackingField;    // 0x0x20
    public DateTime <MEHDFFGFJFK>k__BackingField;    // 0x0x30
    public List<ELJLPEBHMBM> <AAIOPEHKDMC>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// GCKPMAEOJBM
//   RESPONSE ?      api/inventions/   [Service.API]
//   RESPONSE GET    api/inventions/v1/personaldetails/{hPIAIILPMNF}   [Service.API]
public class GCKPMAEOJBM
{
    public bool <DLKHLFBDLAD>k__BackingField;    // 0x0x10
}
...
public class GEDAHMMMHFD
{
    public int <DKEGKPEHGBN>k__BackingField;    // 0x0x10
    public int <MBKMFFECJGC>k__BackingField;    // 0x0x14
    public float <APBIIHCIINO>k__BackingField;    // 0x0x18
    public float <CKNHEMCNAAN>k__BackingField;    // 0x0x1C
    public bool <AEBMAOAAKED>k__BackingField;    // 0x0x20
    public bool <FJFFBEDHHLB>k__BackingField;    // 0x0x21
    public bool <LPJPPACEOEP>k__BackingField;    // 0x0x22
}
...
public class GFBNLHOKGKF
{
    public POIMILPGFGJ <FGJPIMEMHPH>k__BackingField;    // 0x0x10
    public PNNLELELGIN <GINANAINGCI>k__BackingField;    // 0x0x14
    public int <FMBDBBDKDOC>k__BackingField;    // 0x0x18
    public int <FGIGNGAJBBI>k__BackingField;    // 0x0x1C
    public int <AEKJCMFHIDC>k__BackingField;    // 0x0x20
    public FINFCBFIONF <OCEKBCPOBBH>k__BackingField;    // 0x0x24
    public bool <NIOLBNOCICB>k__BackingField;    // 0x0x28
    public float <FDDJIBLJOND>k__BackingField;    // 0x0x2C
    public int <JEIMLEKCAJP>k__BackingField;    // 0x0x30
    public bool <JHLAGMBMNPK>k__BackingField;    // 0x0x34
}
...
public class GGNJLFEHNCN
{
    public string <PIPOPOJABIG>k__BackingField;    // 0x0x10
    public string <PDMKOHOAMFP>k__BackingField;    // 0x0x18
    public bool <NNLPJCDNAKD>k__BackingField;    // 0x0x20
    public string <NNIKCENAJNG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// GJCGANMGLFG
//   (not directly referenced by a detected call)
public class GJCGANMGLFG
{
    public int <GOPOFFDOPOL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GJJPBMICPDM
// base   : ADBFIODFKKF<IFMBCBAPEDO>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{pJOMKABIOBB}   [Service.API]
public class GJJPBMICPDM
{
    // (no instance fields in the metadata dump)
}
...
// GJLFJNGNKKN
//   (not directly referenced by a detected call)
public class GJLFJNGNKKN
{
    public Guid <GMNELMMLDKL>k__BackingField;    // 0x0x10
    public long <DJGIIAPKFJF>k__BackingField;    // 0x0x20
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x28
    public string <GKBMOJMJLNH>k__BackingField;    // 0x0x30
    public string <EPFHLMAABIM>k__BackingField;    // 0x0x38
    public long <JHBKMIHNNHK>k__BackingField;    // 0x0x40
    public Guid? <CMFLNPMGMAG>k__BackingField;    // 0x0x48
    public DateTime <JLEMDBENFFL>k__BackingField;    // 0x0x60
}
...
public class GNCGEHNDLDH
{
    public CABFENBLCAJ <PECKHPBCEDE>k__BackingField;    // 0x0x10
    public string <KNLLLFKKABJ>k__BackingField;    // 0x0x18
    public int? <AMNLFLMCLEF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HCNBHIFFFDI
//   (not directly referenced by a detected call)
public class HCNBHIFFFDI
{
    public Guid <GMNELMMLDKL>k__BackingField;    // 0x0x10
    public int <MDOBLCMOLMB>k__BackingField;    // 0x0x20
    public int <DNMAPFAJCIE>k__BackingField;    // 0x0x24
    public Guid <BHCFBGPIPJL>k__BackingField;    // 0x0x28
    public DateTime <JLEMDBENFFL>k__BackingField;    // 0x0x38
    public GJLFJNGNKKN <ODDECNJPHJM>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// HHKJHDMDKOM
//   RESPONSE ?      api/inventions/v1/settags   [Service.API]
public class HHKJHDMDKOM
{
    public JMGIJLCBEIL <LJHODEHIOPP>k__BackingField;    // 0x0x10
    public List<string> <HANCGBJPGBH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HIIMBKCFOAH
//   REQUEST  POST   api/avatar/v4/saved/set   [Service.Econ]
public class HIIMBKCFOAH
{
    public int <ODIFCGDGAAP>k__BackingField;    // 0x0x10
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x18
    public string <EMHKNDFMNNP>k__BackingField;    // 0x0x20
    public string <IFGALCKAOLA>k__BackingField;    // 0x0x28
    public string <KONCEKNHHJN>k__BackingField;    // 0x0x30
    public string <DLFAPBIAFLG>k__BackingField;    // 0x0x38
    public string <BHDMIPPIFCE>k__BackingField;    // 0x0x40
    public string <FHLPJHPNBEG>k__BackingField;    // 0x0x48
    public List<BENAOBLFPMJ> <FMIHAMEFMJP>k__BackingField;    // 0x0x50
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{bLDHPNBFBOI}   [Service.API]
...
public class IBIDMKBMMLE
{
    public CPFOLDEDFEJ <FLJFAPANCJM>k__BackingField;    // 0x0x10
    public CCNHJPFKNCJ <LJHODEHIOPP>k__BackingField;    // 0x0x18
    public HHKJHDMDKOM <ADKANFAPNEC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IBMHFGIPBKH
//   (not directly referenced by a detected call)
public class IBMHFGIPBKH
{
    public int <FLBDBFKGPML>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IDCOMIGCCFE
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class IDCOMIGCCFE
{
    public List<int> <GKLLBMGIAGI>k__BackingField;    // 0x0x10
    public string <NEIHELJCHKC>k__BackingField;    // 0x0x18
}
...
public class IECAMFGIGLH
{
    public Dictionary<int, int> <AMEGJPFPEDO>k__BackingField;    // 0x0x10
    public List<KBGAPGJFCBO> <DFFIEIFNKOL>k__BackingField;    // 0x0x18
    public MEPHMEOHNCL[][] <OAGLBIIOKHP>k__BackingField;    // 0x0x20
    public IBMHFGIPBKH <HNFMBMOMHHC>k__BackingField;    // 0x0x28
    public DPFAAONNKOM <AFHBPOPENEP>k__BackingField;    // 0x0x30
    public FJOIMJLKFFK <ELCPGEAMIGE>k__BackingField;    // 0x0x38
    public GJCGANMGLFG <JFLKBDFCHNM>k__BackingField;    // 0x0x40
    public DMHIGOKNGPL <DPBILFELEOI>k__BackingField;    // 0x0x48
    public string <LEJHDDLLEAM>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// IEEJINAPBLI
//   (not directly referenced by a detected call)
public class IEEJINAPBLI
{
    public long <JHBKMIHNNHK>k__BackingField;    // 0x0x10
    public Guid? <LBAMNJKOBCD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IHBCKKDCAMI
//   (not directly referenced by a detected call)
public class IHBCKKDCAMI
{
    public long <LNGJKGPGGCD>k__BackingField;    // 0x0x10
    public long <GBJBIHJDJBI>k__BackingField;    // 0x0x18
    public int <LNOABHFEADL>k__BackingField;    // 0x0x20
    public DateTime <FLELPCODCHM>k__BackingField;    // 0x0x28
    public HOKKCJBPGJK <AEDMHMHADOF>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// ILKMBODLOJL
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class ILKMBODLOJL
{
    public List<OIGNKGENIGO> <PCKMBHPLEAN>k__BackingField;    // 0x0x10
    public CCNHJPFKNCJ <LJHODEHIOPP>k__BackingField;    // 0x0x18
}
...
public class ILOJEPHILMO
{
    public List<NGEEIMNPFBE> <HANCGBJPGBH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IPKEFMJJACD
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{pKNOIGMENLD}   [Service.API]
public class IPKEFMJJACD
{
    public uint <DCDPDBADNFM>k__BackingField;    // 0x0x10
    public uint? <IFLFPFMFBMN>k__BackingField;    // 0x0x14
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x20
    public string <GKBMOJMJLNH>k__BackingField;    // 0x0x28
    public DateTime <ONLPPJLAHHG>k__BackingField;    // 0x0x30
    public DateTime? <OKFKLFBCKLD>k__BackingField;    // 0x0x38
    public bool <PPCICLKGHFC>k__BackingField;    // 0x0x48
    public List<JIKAADPGOBO> <ADJDGBAMHCD>k__BackingField;    // 0x0x50
    public List<string> <HANCGBJPGBH>k__BackingField;    // 0x0x58
    public int <GOAHJFLLFEP>k__BackingField;    // 0x0x60
    public int <BNOFAPHGNMI>k__BackingField;    // 0x0x64
    public int <PMOCIJDGOHL>k__BackingField;    // 0x0x68
}
...
public class JAAFOHKFIKC
{
    public LAJNGFIOCBB <IMEKOJOLGEH>k__BackingField;    // 0x0x10
    public IEEJINAPBLI <IPJMPAPPNNO>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{mOPLICHKAGO}   [Service.Econ]
public class JAKAOJJHALI
{
    public BFPAKMJDDCA <KJELOMMKJHI>k__BackingField;    // 0x0x10
    public GJLFJNGNKKN <ODDECNJPHJM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JBABEOODLBH
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class JBABEOODLBH
{
    public long <DJGIIAPKFJF>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <LPBMMEHBPJK>k__BackingField;    // 0x0x18
    public AHCJKFEIKNC <CEEGJKPOBCK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JIKAADPGOBO
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class JIKAADPGOBO
{
    public string <DCDPDBADNFM>k__BackingField;    // 0x0x10
    public string <AOHNMKEDENK>k__BackingField;    // 0x0x18
    public string <AAGFLKBECKM>k__BackingField;    // 0x0x20
    public string <GKBMOJMJLNH>k__BackingField;    // 0x0x28
    public string <ADPHCNKIECL>k__BackingField;    // 0x0x30
    public NDOJLPJFPOE <KJELOMMKJHI>k__BackingField;    // 0x0x38
    public List<string> <BIFECNAHIIC>k__BackingField;    // 0x0x40
    public List<string> <HANCGBJPGBH>k__BackingField;    // 0x0x48
    public string <PGOBOCCINEG>k__BackingField;    // 0x0x50
    public List<FKLHKLKHNOK> <JPKLBOPMAEA>k__BackingField;    // 0x0x58
}
...
// base   : PHMAPLLDKOK
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{kEBLFODOGOK}   [Service.Econ]
public class JPCLNKILHHM : PHMAPLLDKOK
{
    public int <OMMOGICFFJF>k__BackingField;    // 0x0x30
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x38
    public DateTime <MEHDFFGFJFK>k__BackingField;    // 0x0x40
    public DateTime <EHDGDDJNNPF>k__BackingField;    // 0x0x48
    public POIMILPGFGJ <FGJPIMEMHPH>k__BackingField;    // 0x0x50
    public KPCEHEDFDDP <CNLENJOAHBB>k__BackingField;    // 0x0x58
    public List<EIBPLOOODCO> <LDNFPHPMGML>k__BackingField;    // 0x0x60
    public MJAHEPPEDEN <JFMPGDBOIFO>k__BackingField;    // 0x0x68
}
...
public class KDCEEBNNLJE
{
    public CCNHJPFKNCJ <LJHODEHIOPP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KFBBNGPLBLI
//   (not directly referenced by a detected call)
public class KFBBNGPLBLI
{
    public int <DBHDICIKIAH>k__BackingField;    // 0x0x10
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x18
    public string <HKFPINLKKGM>k__BackingField;    // 0x0x20
    public string <GKBMOJMJLNH>k__BackingField;    // 0x0x28
    public string <KFNNEOKBJKF>k__BackingField;    // 0x0x30
    public bool <ODOLJMHGOHF>k__BackingField;    // 0x0x38
    public int <ODIFCGDGAAP>k__BackingField;    // 0x0x3C
    public LEHGKPEPKNK <HDBNCMIPPGI>k__BackingField;    // 0x0x40
    public PAEPJAEIJMO CAPIEBOGPKE;    // 0x0x48
    public PAEPJAEIJMO IAKGDOJCIAE;    // 0x0x50
    public PAEPJAEIJMO MPGILHKIHED;    // 0x0x58
    public FAFDPFHMENO BLONPHGKPEB;    // 0x0x60
}
...
// KPCEHEDFDDP
//   (not directly referenced by a detected call)
public class KPCEHEDFDDP
{
    public int <NAAMAIMJPGH>k__BackingField;    // 0x0x10
    public DGEBPEMHOKO <AEDMHMHADOF>k__BackingField;    // 0x0x14
    public List<DMMOHAECOKB> <HEIFLNMGNMI>k__BackingField;    // 0x0x18
    public List<DMMOHAECOKB> <LMKEILHJPOG>k__BackingField;    // 0x0x20
    public bool <CEJEPPCCKGK>k__BackingField;    // 0x0x28
    public DateTime? <HOMPFKABCPM>k__BackingField;    // 0x0x30
    public DateTime? <ONDNDMFGKIC>k__BackingField;    // 0x0x40
    public DateTime? <GHIHMKICKHD>k__BackingField;    // 0x0x50
}
...
public class LAJNGFIOCBB
{
    public Guid? <OAMDJJHEFCE>k__BackingField;    // 0x0x10
    public Guid <HNNONGMFFPM>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// LEHGKPEPKNK
//   (not directly referenced by a detected call)
public class LEHGKPEPKNK
{
    // (no instance fields in the metadata dump)
}
...
// LFOFEAJKACB
//   (not directly referenced by a detected call)
public class LFOFEAJKACB
{
    public BFKOGJLBEFA <FLJFAPANCJM>k__BackingField;    // 0x0x10
    public IHBCKKDCAMI <PGDFHCBLAIB>k__BackingField;    // 0x0x18
}
...
public class LKDFDBMKEPP
{
    public Guid <ILCDAOAKANK>k__BackingField;    // 0x0x10
    public long <PHMFGMIEPFB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LLEHPFCNHDC
//   (not directly referenced by a detected call)
public class LLEHPFCNHDC
{
    public int <GPGBPEIKEND>k__BackingField;    // 0x0x10
    public LAJNGFIOCBB <IMEKOJOLGEH>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/keepsakes/{kOAIMKDICGM}   [Service.API]
...
public class MAIFBBDFKLF
{
    public bool <EPCEFAMDFCP>k__BackingField;    // 0x0x10
    public string <OPMAIEPANHO>k__BackingField;    // 0x0x18
}
...
public class MDNJJABHELE
{
    public PILMHFDOEAJ <KJELOMMKJHI>k__BackingField;    // 0x0x10
    public BIIHBFGAGOP <AMBIMIELGFH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MEPHMEOHNCL
//   (not directly referenced by a detected call)
public class MEPHMEOHNCL
{
    public KHFPEFBOEHG GEFOKCLNCNA;    // 0x0x10
    public int PNJILCPBGBB;    // 0x0x14
}
...
public class MHAODJONDGG : KHPCOFNDGEO
{
    public PFBPABBIEFI? <NICCEPCICLN>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <BPBDHCDOAFC>k__BackingField;    // 0x0x20
}
...
//   RESPONSE ?      api/inventions/v1/delete   [Service.API]
...
public class MIJNNKDHMLO
{
    public MIICNCNKLLD <KJELOMMKJHI>k__BackingField;    // 0x0x10
    public PEADNKNDAFE <DDHANEHIHNE>k__BackingField;    // 0x0x18
    public EAPPCCIFHGP <IFCKFPGPFGG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MJAHEPPEDEN
//   (not directly referenced by a detected call)
public class MJAHEPPEDEN
{
    public bool <BNCDCFEMDCC>k__BackingField;    // 0x0x10
    public GFMDLCKIOMA <JCMADICJNGP>k__BackingField;    // 0x0x14
    public int <DCPHNEEOONF>k__BackingField;    // 0x0x18
    public DateTime <JLEMDBENFFL>k__BackingField;    // 0x0x20
}
...
public class NAAJNCBCBDE
{
    public BFPAKMJDDCA <KJELOMMKJHI>k__BackingField;    // 0x0x10
    public HCNBHIFFFDI <IFEOBAEDIPH>k__BackingField;    // 0x0x18
}
...
public class NDBDJCBGOIB
{
    public int <MBKMFFECJGC>k__BackingField;    // 0x0x10
    public bool <AEBMAOAAKED>k__BackingField;    // 0x0x14
    public DateTime <CCKEHEEGAIB>k__BackingField;    // 0x0x18
    public bool <JIKLKCEONOL>k__BackingField;    // 0x0x20
}
...
// NGEEIMNPFBE
//   (not directly referenced by a detected call)
public class NGEEIMNPFBE
{
    public string <MOAHHNHPEJE>k__BackingField;    // 0x0x10
    public DLGPKABPPPP <AEDMHMHADOF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NKOGMGJHJEP
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{dKMBEMBDAMI}   [Service.API]
public class NKOGMGJHJEP
{
    public List<BFKOGJLBEFA> <AANALDCBOAF>k__BackingField;    // 0x0x10
    public List<LFOFEAJKACB> <PKEMKEFNBGH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OHAJEJCKPBC
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Econ]
public class OHAJEJCKPBC
{
    public Guid <FABMDEMOOGL>k__BackingField;    // 0x0x10
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x20
    public string <EPFHLMAABIM>k__BackingField;    // 0x0x28
    public DateTime <MEHDFFGFJFK>k__BackingField;    // 0x0x30
    public DateTime? <LBGDEGHPCPP>k__BackingField;    // 0x0x38
    public List<GAOHALPJGML> <NACLDFAPKOL>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// OIGNKGENIGO
//   (not directly referenced by a detected call)
public class OIGNKGENIGO
{
    public int <JOMPDLLKIAO>k__BackingField;    // 0x0x10
    public CCNHJPFKNCJ <LJHODEHIOPP>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// PCBDCBDMMBP
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class PCBDCBDMMBP
{
    public Dictionary<Guid, NAAJNCBCBDE> <KCNDMOKDGDC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PEADNKNDAFE
//   (not directly referenced by a detected call)
public class PEADNKNDAFE
{
    public ObscuredLong <KPCPONFPJNB>k__BackingField;    // 0x0x10
    public string <MAMPCPJIOBD>k__BackingField;    // 0x0x38
    public ObscuredInt <KGOOBILJMGJ>k__BackingField;    // 0x0x40
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x58
    public string <GKBMOJMJLNH>k__BackingField;    // 0x0x60
    public string <EPFHLMAABIM>k__BackingField;    // 0x0x68
    public int <FONNJMBDHAM>k__BackingField;    // 0x0x70
    public POJACDFEGKB <DPKMEPKGAPF>k__BackingField;    // 0x0x74
    public DateTime <JLEMDBENFFL>k__BackingField;    // 0x0x78
    public DateTime <FLELPCODCHM>k__BackingField;    // 0x0x80
    public DateTime? <GPPAMOCIOJO>k__BackingField;    // 0x0x88
    public long? <ELAMGGFLHKK>k__BackingField;    // 0x0x98
    public int <BNAMBNBHPMF>k__BackingField;    // 0x0xA8
    public int <MFAJBINCMEN>k__BackingField;    // 0x0xAC
    public int <HMNEGLKBEJG>k__BackingField;    // 0x0xB0
    public KONGNOCHKDB <JCEENOGODJH>k__BackingField;    // 0x0xB4
    public KONGNOCHKDB <KMFFJJFMDIG>k__BackingField;    // 0x0xB8
    public ObscuredBool <ECMEHLCMOAL>k__BackingField;    // 0x0xBC
    public ObscuredBool <DIOHCHKGFHA>k__BackingField;    // 0x0xC8
    public ObscuredBool <ALBHBMJMFMP>k__BackingField;    // 0x0xD4
    public int? <JHBKMIHNNHK>k__BackingField;    // 0x0xE0
    public bool <BPIHJDIPHJM>k__BackingField;    // 0x0xE8
}

// --------------------------------------------------------------------------
// PIFCMKPGGNA
//   (not directly referenced by a detected call)
public class PIFCMKPGGNA
{
    public int <JFNBIHJLJJH>k__BackingField;    // 0x0x10
    public DateTime? <PJOPNFJFKLP>k__BackingField;    // 0x0x18
    public DateTime? <FHHMAKPFOED>k__BackingField;    // 0x0x28
}
...
public class PKPKPDAGLMI
{
    public long <JGCFOGAEJFK>k__BackingField;    // 0x0x10
    public int <MDOBLCMOLMB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PMIMOBKHDHL
//   (not directly referenced by a detected call)
public class PMIMOBKHDHL
{
    public long <MNINOININMI>k__BackingField;    // 0x0x10
    public string <CGCIIGJFPEF>k__BackingField;    // 0x0x18
    public string <OLPMAGBNHHP>k__BackingField;    // 0x0x20
    public NONCKHFIJGD? <KANHJOGHNKG>k__BackingField;    // 0x0x28
    public string <KGIDEEJLLBH>k__BackingField;    // 0x0x30
    public string <HEADBIMNPNA>k__BackingField;    // 0x0x38
    public JOJMMIMNIKI <EECNJGCEOGD>k__BackingField;    // 0x0x40
    public int <FPNECBIJFHA>k__BackingField;    // 0x0x44
    public int <HPMHPLGGNAG>k__BackingField;    // 0x0x48
    public MOKLNBOCPGF? <JPBPKODOAEO>k__BackingField;    // 0x0x4C
    public HPNECILCPIC? <KKMMDABJJHB>k__BackingField;    // 0x0x54
}
...
{
    public long <DJGIIAPKFJF>k__BackingField;    // 0x0x10
    public long? <BINLLJHGMII>k__BackingField;    // 0x0x18
    public MOMDKDLAOIH <GBKJLADGLFG>k__BackingField;    // 0x0x28
}
...
{
    public ELPAJIIHJBE <LJHODEHIOPP>k__BackingField;    // 0x0x10
    public string <GFCPJGKJIIL>k__BackingField;    // 0x0x18
    public string <JCHNNDLMJIL>k__BackingField;    // 0x0x20
    public string <AOGGAHNHJFN>k__BackingField;    // 0x0x28
}
...
{
    public long <GBJBIHJDJBI>k__BackingField;    // 0x0x10
    public long? <PEJJKMJOLNF>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public PFPPMGGCMHJ FilterType;    // 0x0x20
...
{
    public MOMDKDLAOIH <OANBMKHABIK>k__BackingField;    // 0x0x10
    public string <OADCDCIICAE>k__BackingField;    // 0x0x18
    public int <JEOPDJCMBFG>k__BackingField;    // 0x0x20
    public int <CJKEMCIINNK>k__BackingField;    // 0x0x24
    public string <GEMDOIIDLKJ>k__BackingField;    // 0x0x28
    public string <PLLEOMIMOJG>k__BackingField;    // 0x0x30
}
...
{
    public int <MDOBLCMOLMB>k__BackingField;    // 0x0x10
    public Guid <LJIKHJADIBC>k__BackingField;    // 0x0x14
    public DateTime <KEIIAKBNKBL>k__BackingField;    // 0x0x28
}
...
{
    public bool <HDNGHGNEGCA>k__BackingField;    // 0x0x10
    public int <IGACFHMILKC>k__BackingField;    // 0x0x14
    public bool <JAMCBLDHHLG>k__BackingField;    // 0x0x18
}
...
{
    public Guid <LJIKHJADIBC>k__BackingField;    // 0x0x10
    public MOMDKDLAOIH <BNFBCJONJEG>k__BackingField;    // 0x0x20
    public int <MHMGMCKHOHD>k__BackingField;    // 0x0x24
    public long <DJGIIAPKFJF>k__BackingField;    // 0x0x28
    public long? <BINLLJHGMII>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{nIGCMMACIIM}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <HCIFHJECBGK>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <EFLBOHJBEHH>k__BackingField;    // 0x0x18
}
...
{
    public long <BCGBODEFBAD>k__BackingField;    // 0x0x10
    public long <DJGIIAPKFJF>k__BackingField;    // 0x0x18
    public long <KMNPJODFIEM>k__BackingField;    // 0x0x20
    public KJEONFEMIIC <AEDMHMHADOF>k__BackingField;    // 0x0x28
    public int <LCHIDFIICOM>k__BackingField;    // 0x0x2C
}
...
{
    public long <DJGIIAPKFJF>k__BackingField;    // 0x0x10
    public List<Guid> <BCONKILFOCB>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <HCIFHJECBGK>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <EFLBOHJBEHH>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <JCMIOPLNJBL>k__BackingField;    // 0x0x20
}
...
{
    public long <KMNPJODFIEM>k__BackingField;    // 0x0x10
    public long <GPICOKHBKLK>k__BackingField;    // 0x0x18
    public int? <GFEGALPKJBM>k__BackingField;    // 0x0x20
    public int? <KAEGJIJCGPJ>k__BackingField;    // 0x0x28
    public long? <DGKLPGMJMDB>k__BackingField;    // 0x0x30
    public long <GCPBMLDMPJD>k__BackingField;    // 0x0x40
    public long <CJMLEODGJEL>k__BackingField;    // 0x0x48
    public int <HMBJMDPINKG>k__BackingField;    // 0x0x50
    public KJEONFEMIIC <CIMJELLGGEL>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <JLMFEFMMBNA>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public MOKLNBOCPGF <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public AALDFAGJKHE creatorAccountRole;    // 0x0x58
}
...
{
    public NFMBOMOJENB <MDHNFMNPMAC>k__BackingField;    // 0x0x10
    public NLEFFJLJPLG <AAILHLIMPDN>k__BackingField;    // 0x0x14
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x18
    public string <GKBMOJMJLNH>k__BackingField;    // 0x0x20
    public bool <GBDHEHIGPBO>k__BackingField;    // 0x0x28
}
...
{
    public List<NFMBOMOJENB> <AGMJMENLLEJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{bLDHPNBFBOI}   [Service.API]
public class ProgressionEventDTO
{
    public long <GPICOKHBKLK>k__BackingField;    // 0x0x10
    public string <HCPCMOGCNLI>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <JKDEKDOABJP>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <MDICIGPKADJ>k__BackingField;    // 0x0x28
    public DateTime <PBAJGKDEHNO>k__BackingField;    // 0x0x30
    public DateTime <NPKNMAKCANC>k__BackingField;    // 0x0x38
    public DateTime <DEOMOPLFOIF>k__BackingField;    // 0x0x40
    public bool <DGCDDGPEFDB>k__BackingField;    // 0x0x48
    public int <MEJCHBPNNBN>k__BackingField;    // 0x0x4C
    public float <IMPEFPFLGAG>k__BackingField;    // 0x0x50
    public Guid? <FLOOEDPGLGI>k__BackingField;    // 0x0x54
    public string <DMOLKNNMJCG>k__BackingField;    // 0x0x68
    public string <GJPANOGGGNB>k__BackingField;    // 0x0x70
    public string <BHEMINLGKMG>k__BackingField;    // 0x0x78
    public string <APCLEPBNPIL>k__BackingField;    // 0x0x80
}
...
{
    public Guid <LMIJMNFPCJL>k__BackingField;    // 0x0x10
    public int <DNIAMHJDKHG>k__BackingField;    // 0x0x20
    public int <IHGODKCABHK>k__BackingField;    // 0x0x24
    public int <FGHJOLECJON>k__BackingField;    // 0x0x28
    public long <PGOMAFFFINA>k__BackingField;    // 0x0x30
    public long <CGEIOKIGCCD>k__BackingField;    // 0x0x38
}
...
{
    public int <MDOBLCMOLMB>k__BackingField;    // 0x0x10
    public int <FPNECBIJFHA>k__BackingField;    // 0x0x14
    public int <OEOBBBCJMGD>k__BackingField;    // 0x0x18
    public int <FDDAEHHFEFG>k__BackingField;    // 0x0x1C
    public int <LAPDGJALBAD>k__BackingField;    // 0x0x20
    public DateTime? <IJPMNBILDNH>k__BackingField;    // 0x0x28
}
...
{
    public long <CNAGHOACBPE>k__BackingField;    // 0x0x10
    public int <MNINOININMI>k__BackingField;    // 0x0x18
    public string <EPFHLMAABIM>k__BackingField;    // 0x0x20
    public int <FPNECBIJFHA>k__BackingField;    // 0x0x28
    public int <ALLANOOABNO>k__BackingField;    // 0x0x2C
    public bool <HIKCENCOEPH>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public EJKEHGNLIIO ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool GNCLGCOIBPB;    // 0x0x28
}
...
{
    public INCMCNOIOMF? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public INCMCNOIOMF JJABFFDFEAA;  // wrapper
...
{
    public DJPJCNGKLKK KLCFHJALAHJ;  // wrapper
...
{
    public OGLDJMJGPJB OGILDIMGIOH;  // wrapper
    public int? AJEDHNCFDDB;  // wrapper
...
{
    public POMGPAFMMKA EFLHJAKIFMH;  // wrapper
    public float? LCCDDEBGCAO;  // wrapper
...
{
    public NEGBELDNGFF UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public MOKLNBOCPGF PKDAKJPDDGD;  // wrapper
    public MOKLNBOCPGF? PIGENMEHCNE;  // wrapper
...
{
    public KFBBNGPLBLI COECDFGKAPO;  // wrapper
...
{
    public POJACDFEGKB JHCOENLJNGF;  // wrapper
    public byte[] AIFEHFMACJK;  // wrapper
    public byte[] HMOOGPDJBPC;  // wrapper
    public Color HAFGGBNGKBN;  // wrapper
...
{
    public List<NEFEDCHAGOE> CPHKFKKPGAA;  // wrapper
}
...
{
    public NFLNHEAKMEA JCAPPMOFJML;  // wrapper
    public MOKLNBOCPGF? OIFMDDIEHHM;  // wrapper
...
{
    public ANDFFGMLGOB COBJDICJBIK;  // wrapper
...
{
    public PEADNKNDAFE inventionId;  // wrapper
}
...
// api/keepsakes/{kOAIMKDICGM}/collect  [API POST]
public class KeepsakesKOAIMKDICGMCollectRequest
{
    public Guid KOAIMKDICGM;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> CEACMLKHEKK;  // wrapper
    public INMGPKOKJFC KNMFJPIGOBN;  // wrapper
    public long? LCIEPBGBKGO;  // wrapper
...
{
    public long? HJCAHMBDEEM;  // wrapper
    public long? KEMEALJDHKL;  // wrapper
    public List<string> EDJKIENMCNI;  // wrapper
    public DateTime DELPKOCBGIP;  // wrapper
    public DateTime CEPELLGJCAI;  // wrapper
    public AFGHMLCJKJD JHCOENLJNGF;  // wrapper
    public ECFNGBJFPLK JMABMEFMFAA;  // wrapper
    public ECFNGBJFPLK MPBDJLEMDKB;  // wrapper
}
...
{
    public ECFNGBJFPLK JMABMEFMFAA;  // wrapper
    public ECFNGBJFPLK DNPANCCNCCC;  // wrapper
}
...
{
    public Guid BBMHAPAEKPC;  // wrapper
...
{
    public List<PFJCGLKMNME> EFMECCDKMNG;  // wrapper
}
...
{
    public Guid FOCHMPAMPND;  // wrapper
    public object Price;  // candidate
...
{
    public Guid FOCHMPAMPND;  // wrapper
    public long? NEFPGEKBMMN;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Limit;  // candidate
...
{
    public Guid BBMHAPAEKPC;  // wrapper
    public long? JMFLGKFHENF;  // wrapper
    public long? IJCGIOJJICK;  // wrapper
    public int? CFMDHIBPANO;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> BHGFJLDJJON;  // wrapper
...
{
    public IEnumerable<NEMFFCBDGEL> GCHJKFNIMJK;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public Guid? FKPCFPLGPGM;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object RoomId;  // candidate
...
{
    public POMGPAFMMKA EFLHJAKIFMH;  // wrapper
    public long? HONKHHNNKIF;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats LMHPFJLAOMM;  // wrapper
}
...
{
    public Guid EMBMBIKJJNH;  // wrapper
...
{
    public Guid PGCEIDFEHLB;  // wrapper
...
{
    public List<OCGHGPAHIAJ> MCOOLAKDMLF;  // wrapper
    public object roomId;  // candidate
...
{
    public NDOJLPJFPOE NFCPEFCJFGO;  // wrapper
}
