...
public class ADLCOFKLEMA
{
    public long <BABNPFKECAF>k__BackingField;    // 0x0x10
    public string <CHAPPBMGIHM>k__BackingField;    // 0x0x18
    public int <MEPOBAMHANN>k__BackingField;    // 0x0x20
    public int <LDNNPFKICJL>k__BackingField;    // 0x0x24
    public int <IGAKDMNFCCL>k__BackingField;    // 0x0x28
    public int <EDFNHMPGJEH>k__BackingField;    // 0x0x2C
    public int <GCJLPNJDPAN>k__BackingField;    // 0x0x30
    public string <GNPKHAOKBHO>k__BackingField;    // 0x0x38
    public string <AJJLCCDMIHO>k__BackingField;    // 0x0x40
}
...
public class AIEMPGHIJGP
{
    public Guid? <HHBIBKAJCHM>k__BackingField;    // 0x0x10
    public Guid <JKHEMGNNBMM>k__BackingField;    // 0x0x24
}
...
public class AJMPFMFBMEG
{
    public IAKKMBDGDBG <OJBMEFLHCEI>k__BackingField;    // 0x0x10
    public EEGFNNGAEEE <DNLAEEDOBLE>k__BackingField;    // 0x0x14
    public int <FBFDAFPNGFF>k__BackingField;    // 0x0x18
    public int <OMNPCFMOJBE>k__BackingField;    // 0x0x1C
    public int <IHIEKFGNMFN>k__BackingField;    // 0x0x20
    public LNNPCBOEPBG <PBAGCODFFHF>k__BackingField;    // 0x0x24
    public bool <HNANBFGEAAF>k__BackingField;    // 0x0x28
    public float <ICEICODEIHK>k__BackingField;    // 0x0x2C
    public int <HANMIKDBMFK>k__BackingField;    // 0x0x30
    public bool <DIJJINHOHLI>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// ALKDDEJECOA
//   (not directly referenced by a detected call)
public class ALKDDEJECOA
{
...
public class BBNPGDMINIB
{
    public int? <AEFGFGFFLCG>k__BackingField;    // 0x0x10
    public string <JGHEALGMCPI>k__BackingField;    // 0x0x18
    public string <KCBICLFJILP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BBPCEIGOHIN
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class BBPCEIGOHIN
{
    public bool <JLDDIKFJDOO>k__BackingField;    // 0x0x10
    public string <DMFMIDEKAMB>k__BackingField;    // 0x0x18
    public string <MMMMDBFCJKF>k__BackingField;    // 0x0x20
}
...
public class BKLMOPFKNGJ
{
    public IDGMNLHAEED <IMFPBFFHFME>k__BackingField;    // 0x0x10
    public string <MGPJMHGOIMP>k__BackingField;    // 0x0x18
    public int? <CFNCHDJEHFC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BMKHNEDGIOI
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class BMKHNEDGIOI
{
    public int <NOPPOEAPOMA>k__BackingField;    // 0x0x10
    public Guid <CJJDKLLCDPI>k__BackingField;    // 0x0x14
    public long <FPBOENAILBD>k__BackingField;    // 0x0x28
    public DateTime <GHDBJIKHMKG>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// BMMNLMGHPPH
// base   : DHMCGHIAEAK<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class BMMNLMGHPPH
{
    // (no instance fields in the metadata dump)
}
...
public class CBBNFIEEKPJ
{
    public Guid? <CEFMDANENIB>k__BackingField;    // 0x0x10
    public long? <HODHOJOGHOE>k__BackingField;    // 0x0x28
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x38
    public string <ECEJDHGIDNK>k__BackingField;    // 0x0x40
    public string <FIBFAJPKBLP>k__BackingField;    // 0x0x48
    public ELBMAHDKIFF <IPEOOFFOAMJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// CBHAJCAKGME
//   (not directly referenced by a detected call)
public class CBHAJCAKGME
{
    public int <OCHOCOFHNAC>k__BackingField;    // 0x0x10
    public FIIIILEFKEL <FPPCCDABIMH>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// CBHNIHPEEOM
//   (not directly referenced by a detected call)
public class CBHNIHPEEOM
{
    public int <GKMEKAEEHMA>k__BackingField;    // 0x0x10
    public DateTime? <IPDIPBAKMEL>k__BackingField;    // 0x0x18
    public DateTime? <JGOGICPMLPP>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// COMCINGFIFH
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{gCMFMJNNEBK}   [Service.API]
public class COMCINGFIFH
{
    public List<HCCLOEKIBAF> <LAKBBEKJOAL>k__BackingField;    // 0x0x10
    public List<IKJLPBDMBOJ> <PNEGIHCIGHI>k__BackingField;    // 0x0x18
}
...
public class DFACIKJNNBA
{
    public string <KFMBHEMGMMO>k__BackingField;    // 0x0x10
    public string <DMFMIDEKAMB>k__BackingField;    // 0x0x18
    public string <FPPMNDEONKH>k__BackingField;    // 0x0x20
    public string <ECEJDHGIDNK>k__BackingField;    // 0x0x28
    public string <JGHEALGMCPI>k__BackingField;    // 0x0x30
    public MLHKFLBLAHH <POILFPHJCEO>k__BackingField;    // 0x0x38
    public List<string> <BJFOKCDJLKO>k__BackingField;    // 0x0x40
    public List<string> <MDDKNJCBONM>k__BackingField;    // 0x0x48
    public string <MLGKAFCIHCE>k__BackingField;    // 0x0x50
    public List<ECHCPLHOHHK> <GKKNNEONHKF>k__BackingField;    // 0x0x58
}
...
// base   : JAHCDOGAHPE
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{cFGGDAEPGDO}   [Service.Econ]
public class DHAEFLJGMDG : JAHCDOGAHPE
{
    public int <KACHPFMAHIG>k__BackingField;    // 0x0x30
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x38
    public DateTime <NNMNKKACMDB>k__BackingField;    // 0x0x40
    public DateTime <BCHFFJDFIBL>k__BackingField;    // 0x0x48
    public IAKKMBDGDBG <OJBMEFLHCEI>k__BackingField;    // 0x0x50
    public EBNMBPHGKFL <AOJABDFEJIN>k__BackingField;    // 0x0x58
    public List<PODDJFFLLCC> <GLFFHDGPLFA>k__BackingField;    // 0x0x60
    public EPKLJKLKMML <MNEACEOJGHM>k__BackingField;    // 0x0x68
}
...
// DJIBAEPDCLL
//   (not directly referenced by a detected call)
public class DJIBAEPDCLL
{
    public int <EJINIFJCIOK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DPEFCCJMJED
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class DPEFCCJMJED
{
    public int <LGLHGKGECAE>k__BackingField;    // 0x0x10
    public int <PFBHGPPKLDP>k__BackingField;    // 0x0x14
    public float <HHFJBCJMEDL>k__BackingField;    // 0x0x18
    public int <NENEFLJMLCI>k__BackingField;    // 0x0x1C
    public int <DFJMEKMEOLJ>k__BackingField;    // 0x0x20
    public int <EAHPDCMLCMM>k__BackingField;    // 0x0x24
    public int <MBFKBMKPMFB>k__BackingField;    // 0x0x28
    public string <KFBFGNFLAFE>k__BackingField;    // 0x0x30
    public string <KPAHJJIBMAA>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// EBNMBPHGKFL
//   (not directly referenced by a detected call)
public class EBNMBPHGKFL
{
    public int <EJNNBONJNCE>k__BackingField;    // 0x0x10
    public DJFDEKDDJFJ <NHDLKDPEMFP>k__BackingField;    // 0x0x14
    public List<FKMCKMOLMJP> <MGHBHCJEMJK>k__BackingField;    // 0x0x18
    public List<FKMCKMOLMJP> <AHAHALPPEIB>k__BackingField;    // 0x0x20
    public bool <BLPBGHBIPAN>k__BackingField;    // 0x0x28
    public DateTime? <BGGEPEFAPFC>k__BackingField;    // 0x0x30
    public DateTime? <DBPPEGOCEBH>k__BackingField;    // 0x0x40
    public DateTime? <CAFGKPFGEOB>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// ECHCPLHOHHK
//   (not directly referenced by a detected call)
public class ECHCPLHOHHK
{
    public DateTime <BHLMJIBHJNL>k__BackingField;    // 0x0x10
    public string <ADOEGANLPDK>k__BackingField;    // 0x0x18
}
...
public class EKEIJHGBHOB
{
    public int <COLBCGNKECN>k__BackingField;    // 0x0x10
    public int? <CHABHHCGOLE>k__BackingField;    // 0x0x14
    public string <CNANJKEOJMI>k__BackingField;    // 0x0x20
    public string <IEMKEIAODJG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// ELBMAHDKIFF
//   (not directly referenced by a detected call)
public class ELBMAHDKIFF
{
    public long <IEDPECGICPL>k__BackingField;    // 0x0x10
    public Guid? <CJJDKLLCDPI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EOLFDFBJHOF
//   RESPONSE GET    api/config/v2   [Service.API]
public class EOLFDFBJHOF
{
    public Dictionary<int, int> <AFLCNOHJIIB>k__BackingField;    // 0x0x10
    public List<CELCMEMENMG> <LGKJJIMNPBP>k__BackingField;    // 0x0x18
    public MJHNIOMMHDE[][] <CACKIEEICFH>k__BackingField;    // 0x0x20
    public DJIBAEPDCLL <ANDCNCOEMJO>k__BackingField;    // 0x0x28
    public OJHPLBIBBLG <GPIKMJOOKKK>k__BackingField;    // 0x0x30
    public GKPJADIOHOD <NGHMJCHJMBN>k__BackingField;    // 0x0x38
    public FBJEBPFKFCP <KHIAFOMGHHA>k__BackingField;    // 0x0x40
    public IPPCCJFJOMI <GEGOIJLEOEO>k__BackingField;    // 0x0x48
    public string <PENJJKOJKNE>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// EPKLJKLKMML
//   (not directly referenced by a detected call)
public class EPKLJKLKMML
{
    public bool <LMLCBLCLGNH>k__BackingField;    // 0x0x10
    public INEKKGCADEN <OIOIDOFCABF>k__BackingField;    // 0x0x14
    public int <DAOLJIHNJEP>k__BackingField;    // 0x0x18
    public DateTime <GHDBJIKHMKG>k__BackingField;    // 0x0x20
}
...
// FBJEBPFKFCP
//   (not directly referenced by a detected call)
public class FBJEBPFKFCP
{
    public int <JIEKHDMBGKM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FCCFHFEGCFO
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class FCCFHFEGCFO
{
    public Dictionary<Guid, OKLHEAOCOKP> <BFPPJANMJGA>k__BackingField;    // 0x0x10
}
...
public class FGDICJILAMG
{
    public int <CEBHDLONHNE>k__BackingField;    // 0x0x10
    public bool <MLMJDNOKCLB>k__BackingField;    // 0x0x14
    public DateTime <KNCHBFEFAPC>k__BackingField;    // 0x0x18
    public bool <NCLMJFEPEGM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FICDLMKKJEO
//   (not directly referenced by a detected call)
public class FICDLMKKJEO
{
    public Guid <CEFMDANENIB>k__BackingField;    // 0x0x10
    public long <HODHOJOGHOE>k__BackingField;    // 0x0x20
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x28
    public string <ECEJDHGIDNK>k__BackingField;    // 0x0x30
    public string <FIBFAJPKBLP>k__BackingField;    // 0x0x38
    public long <IEDPECGICPL>k__BackingField;    // 0x0x40
    public Guid? <OJELJIPGKCB>k__BackingField;    // 0x0x48
    public DateTime <GHDBJIKHMKG>k__BackingField;    // 0x0x60
}
...
public class FIFKPLBMFEN
{
    public NNLOKELJHFJ <POILFPHJCEO>k__BackingField;    // 0x0x10
    public KFGGEBOFKOO <GJJAMHJKDEP>k__BackingField;    // 0x0x18
}
...
// FKMCKMOLMJP
//   (not directly referenced by a detected call)
public class FKMCKMOLMJP
{
    public IAKKMBDGDBG <OJBMEFLHCEI>k__BackingField;    // 0x0x10
    public int <IEDPECGICPL>k__BackingField;    // 0x0x14
    public CBHNIHPEEOM <KCFBPGPHNNI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FLLKAHHAKMG
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class FLLKAHHAKMG
{
    public JIHDINOGOLK <FPPCCDABIMH>k__BackingField;    // 0x0x10
    public List<string> <MDDKNJCBONM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FMMEGEJPHCF
//   (not directly referenced by a detected call)
public class FMMEGEJPHCF
{
    public string <PFLFPOJHPBE>k__BackingField;    // 0x0x10
    public PJGPKMKDKKF <NHDLKDPEMFP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FNKBAHNAMPP
//   (not directly referenced by a detected call)
public class FNKBAHNAMPP
{
    public bool <JKKEAHMELAC>k__BackingField;    // 0x0x10
    public NJDFOAPCCNJ <ONBEJGOFLJB>k__BackingField;    // 0x0x18
    public float <FEECDNFGEJJ>k__BackingField;    // 0x0x20
}
...
public class GBJCIBLNMLH : IOIBPDCPDCA
{
    public LKMACEGJCLO? <OIDBIPNMOIB>k__BackingField;    // 0x0x18
    public BMKHNEDGIOI <AENGDAAPDDE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GDMEPLMEIHO
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class GDMEPLMEIHO
{
    public List<CBHAJCAKGME> <GKGFIDCPNCM>k__BackingField;    // 0x0x10
    public FIIIILEFKEL <FPPCCDABIMH>k__BackingField;    // 0x0x18
}
...
// GKPJADIOHOD
//   (not directly referenced by a detected call)
public class GKPJADIOHOD
{
    public int <KEGCOJJCAOM>k__BackingField;    // 0x0x10
}
...
public class HBHGLOBOLGM : IOIBPDCPDCA
{
    public PJFLEOOOJOO? <OIDBIPNMOIB>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <IODHEDDIBNM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HCBGPJFFMDK
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class HCBGPJFFMDK
{
    public int <BFIBKOEACEJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HCCLOEKIBAF
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class HCCLOEKIBAF
{
    public long <ODGIBJOKJIP>k__BackingField;    // 0x0x10
    public int <JNENFFOOIKI>k__BackingField;    // 0x0x18
    public long <HODHOJOGHOE>k__BackingField;    // 0x0x20
    public long? <ANJPCCENBCG>k__BackingField;    // 0x0x28
    public long? <LADJOKJEIML>k__BackingField;    // 0x0x38
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x48
    public string <ECEJDHGIDNK>k__BackingField;    // 0x0x50
    public string <FIBFAJPKBLP>k__BackingField;    // 0x0x58
    public DateTime <OEMFMLAFCFM>k__BackingField;    // 0x0x60
    public DateTime <AIIILNHBMHK>k__BackingField;    // 0x0x68
    public int <HCGEBJHKHMJ>k__BackingField;    // 0x0x70
    public GKJPIIBGPDB <PDHGKFHCODI>k__BackingField;    // 0x0x74
    public bool <JPEPIEFILGA>k__BackingField;    // 0x0x78
    public bool <LBBJKMBGMKJ>k__BackingField;    // 0x0x79
    public EEANOCHAEIC <BMAJNDKBDHD>k__BackingField;    // 0x0x7C
    public EEANOCHAEIC <JHGNCEFAAHE>k__BackingField;    // 0x0x80
    public long? <JFDOPBCLDLL>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// HHHABFONGAE
//   (not directly referenced by a detected call)
public class HHHABFONGAE
{
    public int <DGPCEBIBHCP>k__BackingField;    // 0x0x10
    public DateTime <BHLMJIBHJNL>k__BackingField;    // 0x0x18
    public DateTime? <IIOGDKJJGOJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HICJPACNFPA
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.Econ]
public class HICJPACNFPA
{
    public int <OAIABDCLBAL>k__BackingField;    // 0x0x10
    public string <NONMKCCLALL>k__BackingField;    // 0x0x18
    public List<NBNBPBPHBIO> <NIDIIELCLFF>k__BackingField;    // 0x0x20
    public JDNFHGHHOEH <EAMHGEJDJJG>k__BackingField;    // 0x0x28
    public string <MEDNCJGHOKP>k__BackingField;    // 0x0x30
    public DateTime <NNMNKKACMDB>k__BackingField;    // 0x0x38
    public DateTime <BCHFFJDFIBL>k__BackingField;    // 0x0x40
    public DateTime <DKBCOOGKOBN>k__BackingField;    // 0x0x48
    public bool? <PCAGKBAPCHE>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// HIKOFDHNGDD
//   RESPONSE GET    api/config/v1/amplitude   [Service.API]
public class HIKOFDHNGDD
{
    public string <NPMPKCIMKFC>k__BackingField;    // 0x0x10
    public string <CDPHPFCKENP>k__BackingField;    // 0x0x18
    public bool <BBMBFAGNGLI>k__BackingField;    // 0x0x20
    public string <LIEMGNNLCPK>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// HLFMHNONKFI
//   (not directly referenced by a detected call)
public class HLFMHNONKFI
{
    public ObscuredLong <BABNPFKECAF>k__BackingField;    // 0x0x10
    public string <CHAPPBMGIHM>k__BackingField;    // 0x0x38
    public ObscuredInt <JNENFFOOIKI>k__BackingField;    // 0x0x40
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x58
    public string <ECEJDHGIDNK>k__BackingField;    // 0x0x60
    public string <FIBFAJPKBLP>k__BackingField;    // 0x0x68
    public int <ABCMPNEKONG>k__BackingField;    // 0x0x70
    public DIDNDGOFIEN <PDHGKFHCODI>k__BackingField;    // 0x0x74
    public DateTime <GHDBJIKHMKG>k__BackingField;    // 0x0x78
    public DateTime <BHLMJIBHJNL>k__BackingField;    // 0x0x80
    public DateTime? <JENBPGGKEKI>k__BackingField;    // 0x0x88
    public long? <FHNPAFIPNKB>k__BackingField;    // 0x0x98
    public int <JMOGNFDEIMN>k__BackingField;    // 0x0xA8
    public int <CCPBKEJJJLB>k__BackingField;    // 0x0xAC
    public int <DPPNFMJKFKK>k__BackingField;    // 0x0xB0
    public PPNPLHOAFKL <BEIPHNMBIHK>k__BackingField;    // 0x0xB4
    public PPNPLHOAFKL <HFCFJEOHGAB>k__BackingField;    // 0x0xB8
    public ObscuredBool <CBPAIIKCEIJ>k__BackingField;    // 0x0xBC
    public ObscuredBool <IKKFHFFHLKO>k__BackingField;    // 0x0xC8
    public ObscuredBool <PKLNEMKEFFK>k__BackingField;    // 0x0xD4
    public int? <IEDPECGICPL>k__BackingField;    // 0x0xE0
    public bool <IAEAOKFMJHC>k__BackingField;    // 0x0xE8
}
...
public class HMNJEGLGLFN
{
    public OFMOHLMEPIH <POILFPHJCEO>k__BackingField;    // 0x0x10
    public JIDBGPGJOPD <LOBJELLMJLE>k__BackingField;    // 0x0x18
}
...
public class HNAOAOFABJM
{
    public PFDMKMKKHLN <POILFPHJCEO>k__BackingField;    // 0x0x10
    public HLFMHNONKFI <PNDPHIJFKFJ>k__BackingField;    // 0x0x18
    public ADLCOFKLEMA <MPBOPAFLOJE>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{nDGGGENEMNA}   [Service.API]
...
public class HNMIDPGBNAC
{
    public NFJHICDECEJ <PALAGMEFMOI>k__BackingField;    // 0x0x10
    public FIIIILEFKEL <FPPCCDABIMH>k__BackingField;    // 0x0x18
    public FLLKAHHAKMG <AHFGJCONDKC>k__BackingField;    // 0x0x20
}
...
// IEIAIBOMHJF
//   (not directly referenced by a detected call)
public class IEIAIBOMHJF
{
    public Guid <CCEONAHNLPI>k__BackingField;    // 0x0x10
    public Guid <NKNLANIJJIP>k__BackingField;    // 0x0x20
    public DateTime <NNMNKKACMDB>k__BackingField;    // 0x0x30
    public List<NJDFOAPCCNJ> <JGAGFNKEFKN>k__BackingField;    // 0x0x38
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{aAKAGPEONKL}   [Service.Econ]
public class IHNBAGADMGE
{
    public NNLOKELJHFJ <POILFPHJCEO>k__BackingField;    // 0x0x10
    public FICDLMKKJEO <JAJDBODHFPN>k__BackingField;    // 0x0x18
}
...
// IKJLPBDMBOJ
//   (not directly referenced by a detected call)
public class IKJLPBDMBOJ
{
    public HCCLOEKIBAF <PALAGMEFMOI>k__BackingField;    // 0x0x10
    public PMCKMGEKJIO <BEIJNFNADDD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IKLIBLLKKME
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class IKLIBLLKKME
{
    public List<FMMEGEJPHCF> <MDDKNJCBONM>k__BackingField;    // 0x0x10
}
...
public class INIHLCNHMNA
{
    public Dictionary<Guid, FIFKPLBMFEN> <FLJPGOMKJNI>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/keepsakes/{eBLAFADKOLC}   [Service.API]
...
public class IPMCNIEIKJL
{
    public bool <NNKICHEFBJA>k__BackingField;    // 0x0x10
    public string <HBBKOJLBLNL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IPPCCJFJOMI
//   (not directly referenced by a detected call)
public class IPPCCJFJOMI
{
    public float <NHBKBNLJMMH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JDNFHGHHOEH
//   (not directly referenced by a detected call)
public class JDNFHGHHOEH
{
    public long <BJAIBDIDMML>k__BackingField;    // 0x0x10
    public string <HJLEIMPPHKP>k__BackingField;    // 0x0x18
    public string <IPMKILFNIJD>k__BackingField;    // 0x0x20
    public POONJLHMKBE? <AIIBAFKKBMG>k__BackingField;    // 0x0x28
    public string <JJKFGIALAKI>k__BackingField;    // 0x0x30
    public string <DMPOLDEBALE>k__BackingField;    // 0x0x38
    public JEHDIGPKGPN <CBABJHIHCJG>k__BackingField;    // 0x0x40
    public int <LIGAGGFABMO>k__BackingField;    // 0x0x44
    public int <IJJLMAELJNL>k__BackingField;    // 0x0x48
    public BIKBALCGPLB? <AHAOMOOKLHA>k__BackingField;    // 0x0x4C
    public MDEDMPBOEIA? <EAFAODECBHL>k__BackingField;    // 0x0x54
}
...
public class JGKCLBCJLPB
{
    public List<int> <MFNFLLNIOPO>k__BackingField;    // 0x0x10
    public string <IEJKMJLJHDP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JIDBGPGJOPD
//   (not directly referenced by a detected call)
public class JIDBGPGJOPD
{
    public long <MACNFNINMHF>k__BackingField;    // 0x0x10
    public Guid <CHAPPBMGIHM>k__BackingField;    // 0x0x18
    public long <HODHOJOGHOE>k__BackingField;    // 0x0x28
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x30
    public string <ECEJDHGIDNK>k__BackingField;    // 0x0x38
    public int <IEDPECGICPL>k__BackingField;    // 0x0x40
    public Guid? <OJELJIPGKCB>k__BackingField;    // 0x0x44
    public DateTime <BHLMJIBHJNL>k__BackingField;    // 0x0x58
    public string <FIBFAJPKBLP>k__BackingField;    // 0x0x60
}
...
//   RESPONSE GET    api/inventions/v1/personaldetails/{eACCBOLAMEL}   [Service.API]
public class JMAAEKDFCMC
{
    public bool <POIDCJKNKFP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JMDGNKPFIMC
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Econ]
public class JMDGNKPFIMC
{
    public Guid <FIHDLOEIIJJ>k__BackingField;    // 0x0x10
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x20
    public string <FIBFAJPKBLP>k__BackingField;    // 0x0x28
    public DateTime <NNMNKKACMDB>k__BackingField;    // 0x0x30
    public DateTime? <MAKGKBGPADE>k__BackingField;    // 0x0x38
    public List<IEIAIBOMHJF> <IBNIGKONDID>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// KAPMNBHPEDB
//   (not directly referenced by a detected call)
public class KAPMNBHPEDB
{
    public Guid <LPKMCKKHCJM>k__BackingField;    // 0x0x10
    public byte <CDENPLFLILP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KBEFDEDNDLB
//   RESPONSE GET    api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class KBEFDEDNDLB
{
    public LPLFALOBFFJ <IMFPBFFHFME>k__BackingField;    // 0x0x10
    public int <BFIBKOEACEJ>k__BackingField;    // 0x0x14
    public long <KHOCFDPMNEK>k__BackingField;    // 0x0x18
    public bool <FMCDJKMLOML>k__BackingField;    // 0x0x20
    public string <OEDIMBJLMCP>k__BackingField;    // 0x0x28
    public int? <IEFMDBHKIBM>k__BackingField;    // 0x0x30
    public bool <PIAFGMCKKFC>k__BackingField;    // 0x0x38
    public bool <PELKOGMOJJA>k__BackingField;    // 0x0x39
    public bool <BDIBAKPFJIK>k__BackingField;    // 0x0x3A
    public string <LFKLMJGPMJP>k__BackingField;    // 0x0x40
    public DateTime? <EMCANNMCPNI>k__BackingField;    // 0x0x48
    public float <LKJMPGLOMGP>k__BackingField;    // 0x0x58
}
...
public class KDAMIGAGHLH
{
    public FIIIILEFKEL <FPPCCDABIMH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KFGGEBOFKOO
//   (not directly referenced by a detected call)
public class KFGGEBOFKOO
{
    public Guid <CEFMDANENIB>k__BackingField;    // 0x0x10
    public int <NOPPOEAPOMA>k__BackingField;    // 0x0x20
    public int <DDNKJHEKGDA>k__BackingField;    // 0x0x24
    public Guid <LDHNBBHEIJH>k__BackingField;    // 0x0x28
    public DateTime <GHDBJIKHMKG>k__BackingField;    // 0x0x38
    public FICDLMKKJEO <JAJDBODHFPN>k__BackingField;    // 0x0x40
}
...
public class LAGEBLJMNKK
{
    public int <APDPDIFKJOA>k__BackingField;    // 0x0x10
    public int <CEBHDLONHNE>k__BackingField;    // 0x0x14
    public float <MIBAPOOJLIC>k__BackingField;    // 0x0x18
    public float <PAMNDODOACB>k__BackingField;    // 0x0x1C
    public bool <MLMJDNOKCLB>k__BackingField;    // 0x0x20
    public bool <FKAPMFADIHK>k__BackingField;    // 0x0x21
    public bool <IIDJEMLNHFD>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// LBJNOIFKAHJ
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class LBJNOIFKAHJ
{
    public long <MACNFNINMHF>k__BackingField;    // 0x0x10
    public int <NOPPOEAPOMA>k__BackingField;    // 0x0x18
}
...
public class LDLPGPDHGCP
{
    public List<string> <KNFNDNOFGEK>k__BackingField;    // 0x0x10
    public List<string> <KOHEGCDIIJM>k__BackingField;    // 0x0x18
    public List<string> <CIBOHMNKAKJ>k__BackingField;    // 0x0x20
}
...
//   RESPONSE GET    api/avatar/v2/{gCMFMJNNEBK}   [Service.Econ]
public class LLDDCNMEBAH
{
    public string <HJIKDNEJBEE>k__BackingField;    // 0x0x10
    public string <DNLCJMKKEMG>k__BackingField;    // 0x0x18
    public string <EDELCHFNBDM>k__BackingField;    // 0x0x20
    public string <BOCOJLLMHHH>k__BackingField;    // 0x0x28
    public string <DMGBFBPGDON>k__BackingField;    // 0x0x30
    public List<KAPMNBHPEDB> <HJFBLJEHPME>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// LNIFKOKCOIA
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class LNIFKOKCOIA
{
    public List<HCCLOEKIBAF> <IGNHLJGFOPB>k__BackingField;    // 0x0x10
    public string <IEJKMJLJHDP>k__BackingField;    // 0x0x18
}
...
public class MDNCNAHGPLG
{
    public long <HODHOJOGHOE>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <CPHGPJGKLBN>k__BackingField;    // 0x0x18
    public MHHADNFEKLL <NFJGKGJOEJM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MGPICLLHFKM
// base   : DHMCGHIAEAK<COFEDDJALBA>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{lKLDLPBELGC}   [Service.API]
public class MGPICLLHFKM
{
    // (no instance fields in the metadata dump)
}
...
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{bEEBALICHLA}   [Service.API]
public class MHALNACAHPB
{
    public uint <KFMBHEMGMMO>k__BackingField;    // 0x0x10
    public uint? <OFJJHFIJAEB>k__BackingField;    // 0x0x14
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x20
    public string <ECEJDHGIDNK>k__BackingField;    // 0x0x28
    public DateTime <BOFBLAJOHGE>k__BackingField;    // 0x0x30
    public DateTime? <IAIPDAONGFD>k__BackingField;    // 0x0x38
    public bool <NDDIDAKAMMF>k__BackingField;    // 0x0x48
    public List<DFACIKJNNBA> <AJHFCGOFPHM>k__BackingField;    // 0x0x50
    public List<string> <MDDKNJCBONM>k__BackingField;    // 0x0x58
    public int <AJGKKCKAIJB>k__BackingField;    // 0x0x60
    public int <CPLLEKAFCNP>k__BackingField;    // 0x0x64
    public int <PBDNBNOFPLB>k__BackingField;    // 0x0x68
}
...
// MJHNIOMMHDE
//   (not directly referenced by a detected call)
public class MJHNIOMMHDE
{
    public NAJAPIBAOLK PLHAHJKMEIM;    // 0x0x10
    public int CKKNGOLNFLK;    // 0x0x14
}
...
public class MPANBBBJKLF
{
    public int <LIINHELMGGC>k__BackingField;    // 0x0x10
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x18
    public string <ECHIKDLADEK>k__BackingField;    // 0x0x20
    public string <HJIKDNEJBEE>k__BackingField;    // 0x0x28
    public string <DNLCJMKKEMG>k__BackingField;    // 0x0x30
    public string <EDELCHFNBDM>k__BackingField;    // 0x0x38
    public string <BOCOJLLMHHH>k__BackingField;    // 0x0x40
    public string <DMGBFBPGDON>k__BackingField;    // 0x0x48
    public List<KAPMNBHPEDB> <HJFBLJEHPME>k__BackingField;    // 0x0x50
}
...
public class NAHIFDKMNKI
{
    public List<HHHABFONGAE> <LIHMCIDMJCD>k__BackingField;    // 0x0x10
    public string <IEJKMJLJHDP>k__BackingField;    // 0x0x18
}
...
// NBNBPBPHBIO
//   (not directly referenced by a detected call)
public class NBNBPBPHBIO
{
    public int <NLCEAFCOKCG>k__BackingField;    // 0x0x10
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x18
    public string <LHMMPMJMGPH>k__BackingField;    // 0x0x20
    public string <ECEJDHGIDNK>k__BackingField;    // 0x0x28
    public string <CPMJFJFGAOM>k__BackingField;    // 0x0x30
    public bool <IKDIELOBDPF>k__BackingField;    // 0x0x38
    public int <LIINHELMGGC>k__BackingField;    // 0x0x3C
    public ALKDDEJECOA <JFFKJNJFLHM>k__BackingField;    // 0x0x40
    public KFOCPAHDOHN LBLNEOJPNHO;    // 0x0x48
    public KFOCPAHDOHN CPNHIKKOCGM;    // 0x0x50
    public KFOCPAHDOHN KIIHNIFEPAJ;    // 0x0x58
    public MEONLJEHJFG BDLLJLKKMHL;    // 0x0x60
}
...
// base   : HCCLOEKIBAF
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class NFJHICDECEJ : HCCLOEKIBAF
{
    public List<FMMEGEJPHCF> <MDDKNJCBONM>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// NJDFOAPCCNJ
//   (not directly referenced by a detected call)
public class NJDFOAPCCNJ
{
    public int <BJAIBDIDMML>k__BackingField;    // 0x0x10
    public string <JLNHIMDCMME>k__BackingField;    // 0x0x18
    public string <CPMJFJFGAOM>k__BackingField;    // 0x0x20
    public string <JADGBOCGCFH>k__BackingField;    // 0x0x28
    public string <HJLEIMPPHKP>k__BackingField;    // 0x0x30
    public string <CFABLKLGJMH>k__BackingField;    // 0x0x38
    public POONJLHMKBE? <AIIBAFKKBMG>k__BackingField;    // 0x0x40
    public string <JJKFGIALAKI>k__BackingField;    // 0x0x48
    public string <DMPOLDEBALE>k__BackingField;    // 0x0x50
    public bool <KECDIOHMIFB>k__BackingField;    // 0x0x58
    public bool <JDBBONPBMNH>k__BackingField;    // 0x0x59
    public bool <FAMELMKLBFI>k__BackingField;    // 0x0x5A
    public MDEDMPBOEIA <MCJHHOELKGJ>k__BackingField;    // 0x0x5C
    public int <PNCHHHKDLKE>k__BackingField;    // 0x0x60
    public IAKKMBDGDBG <OJBMEFLHCEI>k__BackingField;    // 0x0x64
    public int <LIIPGJDNOOE>k__BackingField;    // 0x0x68
    public IIBGGCFINLO <GPBBAKFHGEJ>k__BackingField;    // 0x0x6C
    public BIKBALCGPLB <HBBBCPGOPND>k__BackingField;    // 0x0x70
    public int? <LEODCABAFMH>k__BackingField;    // 0x0x74
    public string <FEDGJMIJEKD>k__BackingField;    // 0x0x80
}
...
public class NMPOCOOKHLL
{
    public Guid <NNBMMDKBJOE>k__BackingField;    // 0x0x10
    public long <FIDKPBGPICA>k__BackingField;    // 0x0x20
}
...
public class OGCCFHPEBEP
{
    public bool <NNKICHEFBJA>k__BackingField;    // 0x0x10
    public string <OEDIMBJLMCP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OJHPLBIBBLG
//   (not directly referenced by a detected call)
public class OJHPLBIBBLG
{
    public float <BDMMKJHIIMC>k__BackingField;    // 0x0x10
    public float <AIPBHBCNDAK>k__BackingField;    // 0x0x14
    public float <ENGDLKMLBNI>k__BackingField;    // 0x0x18
    public float <GFJMLKDNMLC>k__BackingField;    // 0x0x1C
    public float <NJJMMGBOAGP>k__BackingField;    // 0x0x20
    public float <GJNKPINDHKP>k__BackingField;    // 0x0x24
    public float <MDPFJNMDPKD>k__BackingField;    // 0x0x28
    public float <HMCFFKINMHH>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// OKLHEAOCOKP
//   (not directly referenced by a detected call)
public class OKLHEAOCOKP
{
    public int <EBNDAHCMNAK>k__BackingField;    // 0x0x10
    public AIEMPGHIJGP <LDEAMNJKAMA>k__BackingField;    // 0x0x18
}
...
public class PEPOLCEHBLN
{
    public AIEMPGHIJGP <LDEAMNJKAMA>k__BackingField;    // 0x0x10
    public ELBMAHDKIFF <DLJDPGCBNPO>k__BackingField;    // 0x0x18
}
...
public class PGNACDDKJNA
{
    public int <ELHJEKLIMBM>k__BackingField;    // 0x0x10
    public MPJMINEGAAL <NHDLKDPEMFP>k__BackingField;    // 0x0x14
    public IEPHIEHGGLM <AGBBEFKIOLL>k__BackingField;    // 0x0x18
    public IEPHIEHGGLM <LEMPODPNAMJ>k__BackingField;    // 0x0x1C
    public IEPHIEHGGLM <GPOOFGMNKOI>k__BackingField;    // 0x0x20
}
...
// PMCKMGEKJIO
//   (not directly referenced by a detected call)
public class PMCKMGEKJIO
{
    public long <BFIAHMLDIGK>k__BackingField;    // 0x0x10
    public long <ODGIBJOKJIP>k__BackingField;    // 0x0x18
    public int <AGCANEOGDDD>k__BackingField;    // 0x0x20
    public DateTime <BHLMJIBHJNL>k__BackingField;    // 0x0x28
    public PEGAAIKNKNC <NHDLKDPEMFP>k__BackingField;    // 0x0x30
}
...
public class PNGHOJDAINF
{
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x10
    public string <ECEJDHGIDNK>k__BackingField;    // 0x0x18
    public int? <IEDPECGICPL>k__BackingField;    // 0x0x20
    public DIDNDGOFIEN? <PDHGKFHCODI>k__BackingField;    // 0x0x28
}
...
// base   : EBNMBPHGKFL
//   (not directly referenced by a detected call)
public class PODDJFFLLCC : EBNMBPHGKFL
{
    public int <JMBCDDPLKLK>k__BackingField;    // 0x0x60
    public List<FNKBAHNAMPP> <ODPCFHNNLHE>k__BackingField;    // 0x0x68
    public List<FNKBAHNAMPP> <EDDDFAPMEJF>k__BackingField;    // 0x0x70
    public List<FNKBAHNAMPP> <HOIDHIAELGK>k__BackingField;    // 0x0x78
}
...
{
    public long <HODHOJOGHOE>k__BackingField;    // 0x0x10
    public long? <ANJPCCENBCG>k__BackingField;    // 0x0x18
    public CJFKFPHLBGA <DOLGNPCEFNO>k__BackingField;    // 0x0x28
}
...
{
    public LODKNPINFPN <FPPCCDABIMH>k__BackingField;    // 0x0x10
    public string <AKLALLHFGBG>k__BackingField;    // 0x0x18
    public string <PHHABKMPMEP>k__BackingField;    // 0x0x20
    public string <AOAPKPDLMCF>k__BackingField;    // 0x0x28
}
...
{
    public long <ODGIBJOKJIP>k__BackingField;    // 0x0x10
    public long? <FAKOLMCAAOP>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public OBCFBJJHOAL FilterType;    // 0x0x20
...
{
    public CJFKFPHLBGA <HGGJJAIIDPH>k__BackingField;    // 0x0x10
    public string <CCIOFENGNLM>k__BackingField;    // 0x0x18
    public int <NNHDNBKBKCM>k__BackingField;    // 0x0x20
    public int <MBIDKICAOML>k__BackingField;    // 0x0x24
    public string <KJHIFMBBHCL>k__BackingField;    // 0x0x28
    public string <PMAPJDOJGGN>k__BackingField;    // 0x0x30
}
...
{
    public int <NOPPOEAPOMA>k__BackingField;    // 0x0x10
    public Guid <HJIPPJMJKNA>k__BackingField;    // 0x0x14
    public DateTime <NNAPAFNPFOF>k__BackingField;    // 0x0x28
}
...
{
    public bool <FPMNKLAEDEO>k__BackingField;    // 0x0x10
    public int <GCILJGJKLMB>k__BackingField;    // 0x0x14
    public bool <LFMDHFMCDJH>k__BackingField;    // 0x0x18
}
...
{
    public Guid <HJIPPJMJKNA>k__BackingField;    // 0x0x10
    public CJFKFPHLBGA <NKFALGKHELI>k__BackingField;    // 0x0x20
    public int <FKDNJCCLMEI>k__BackingField;    // 0x0x24
    public long <HODHOJOGHOE>k__BackingField;    // 0x0x28
    public long? <ANJPCCENBCG>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{aKANJBGBLEM}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <DGMJDAGCINN>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <NBDIJFHLOBL>k__BackingField;    // 0x0x18
}
...
{
    public long <KOJPGDOHAFM>k__BackingField;    // 0x0x10
    public long <HODHOJOGHOE>k__BackingField;    // 0x0x18
    public long <CINFBKIHHKK>k__BackingField;    // 0x0x20
    public FAHLKNHLFCG <NHDLKDPEMFP>k__BackingField;    // 0x0x28
    public int <MJBMAEBLABD>k__BackingField;    // 0x0x2C
}
...
{
    public long <HODHOJOGHOE>k__BackingField;    // 0x0x10
    public List<Guid> <PKBBGNOIHAC>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <DGMJDAGCINN>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <NBDIJFHLOBL>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <FFCHPDHHBKF>k__BackingField;    // 0x0x20
}
...
{
    public long <CINFBKIHHKK>k__BackingField;    // 0x0x10
    public long <KJCAIADKCKG>k__BackingField;    // 0x0x18
    public int? <ODKICMIGOML>k__BackingField;    // 0x0x20
    public int? <KMAAKKONBBB>k__BackingField;    // 0x0x28
    public long? <CIEDJOJAINB>k__BackingField;    // 0x0x30
    public long <EFAFHCJADFL>k__BackingField;    // 0x0x40
    public long <NCAGIJMMEND>k__BackingField;    // 0x0x48
    public int <MIGPAAPMMEN>k__BackingField;    // 0x0x50
    public FAHLKNHLFCG <CDBKPCGEBDO>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <BMIEFMKMLGJ>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public BIKBALCGPLB <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public FJEEACACIFP creatorAccountRole;    // 0x0x58
}
...
{
    public FILMLGJFBKP <HEHHMPENGIA>k__BackingField;    // 0x0x10
    public DGPAOOEPIJC <CECOGMKBFMG>k__BackingField;    // 0x0x14
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x18
    public string <ECEJDHGIDNK>k__BackingField;    // 0x0x20
    public bool <KBALBJJLEBM>k__BackingField;    // 0x0x28
}
...
{
    public List<FILMLGJFBKP> <NOJGEIOCFHL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{nDGGGENEMNA}   [Service.API]
public class ProgressionEventDTO
{
    public long <KJCAIADKCKG>k__BackingField;    // 0x0x10
    public string <PONOEAKKMEE>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <HOIDHIAELGK>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <OBKAFFCNJMO>k__BackingField;    // 0x0x28
    public DateTime <OEMFMLAFCFM>k__BackingField;    // 0x0x30
    public DateTime <AIIILNHBMHK>k__BackingField;    // 0x0x38
    public DateTime <CAEBOMDLECH>k__BackingField;    // 0x0x40
    public bool <AIDMMAHAPCE>k__BackingField;    // 0x0x48
    public int <FHKPFDPJCLC>k__BackingField;    // 0x0x4C
    public float <OOOODNPBLDH>k__BackingField;    // 0x0x50
    public Guid? <FPMBBJFHKCD>k__BackingField;    // 0x0x54
    public string <KPNJODAFEGB>k__BackingField;    // 0x0x68
    public string <FJILFDILCBM>k__BackingField;    // 0x0x70
    public string <AKGDLJNEINC>k__BackingField;    // 0x0x78
    public string <IAGFPDMFGDP>k__BackingField;    // 0x0x80
}
...
{
    public Guid <NLGLHPHLFIP>k__BackingField;    // 0x0x10
    public int <DNGMEOAIBOM>k__BackingField;    // 0x0x20
    public int <CKBNCLCCAIH>k__BackingField;    // 0x0x24
    public int <CDLJMCIPKPE>k__BackingField;    // 0x0x28
    public long <BHLNKHCGGJI>k__BackingField;    // 0x0x30
    public long <LKPAGMJMIKI>k__BackingField;    // 0x0x38
}
...
{
    public int <NOPPOEAPOMA>k__BackingField;    // 0x0x10
    public int <LIGAGGFABMO>k__BackingField;    // 0x0x14
    public int <GAGCCLJFBDD>k__BackingField;    // 0x0x18
    public int <JDPMAEKAHHL>k__BackingField;    // 0x0x1C
    public int <JECOHOGOBAO>k__BackingField;    // 0x0x20
    public DateTime? <GFJJJHBFDNH>k__BackingField;    // 0x0x28
}
...
{
    public long <BGNEAOGBALB>k__BackingField;    // 0x0x10
    public int <BJAIBDIDMML>k__BackingField;    // 0x0x18
    public string <FIBFAJPKBLP>k__BackingField;    // 0x0x20
    public int <LIGAGGFABMO>k__BackingField;    // 0x0x28
    public int <EFEAIPPDPEO>k__BackingField;    // 0x0x2C
    public bool <FDBGKNOLJBJ>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public DEBBBBOACCK ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool PJAKHNCNILK;    // 0x0x28
}
...
{
    public HABLFBECLAF? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public HABLFBECLAF IPKLACIEPHB;  // wrapper
...
{
    public CCGJLBEFIEC HIALOAJALMF;  // wrapper
...
{
    public FKAEJHGJKGI EMKINACMDLO;  // wrapper
    public int? NLACDFOHGDM;  // wrapper
...
{
    public LPLFALOBFFJ HDALFDMPFJH;  // wrapper
    public float? FHHCOFFDNMC;  // wrapper
...
{
    public NDDDICNGAEO UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public BIKBALCGPLB BKJKDPLKCNE;  // wrapper
    public BIKBALCGPLB? MKINBBAAOHB;  // wrapper
...
{
    public NBNBPBPHBIO CMLAGFHLCEL;  // wrapper
...
{
    public DIDNDGOFIEN JMECEANCFKO;  // wrapper
    public byte[] GLOMGIFMEOI;  // wrapper
    public byte[] KFHIKNNBCAE;  // wrapper
    public Color CPPINAHFMCO;  // wrapper
...
{
    public List<JBDECLOLFJD> GNENJLKEJFF;  // wrapper
}
...
{
    public HFDKKGJCOIG NPNJFJIPHDM;  // wrapper
    public BIKBALCGPLB? OLFFBINEHFH;  // wrapper
...
{
    public JOKCPJFNMAK JKBEKFKGONI;  // wrapper
...
{
    public HLFMHNONKFI inventionId;  // wrapper
}
...
// api/keepsakes/{eBLAFADKOLC}/collect  [API POST]
public class KeepsakesEBLAFADKOLCCollectRequest
{
    public Guid EBLAFADKOLC;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> MPPKFFHHAOF;  // wrapper
    public PLBKKGPGEGP AFOABEPJLCM;  // wrapper
    public long? GPCCPBNNCAG;  // wrapper
...
{
    public long? MFAFLMKPGKO;  // wrapper
    public long? CBPMFPKHDEO;  // wrapper
    public List<string> NCBKBCGBFGM;  // wrapper
    public DateTime FCHMDEEIDME;  // wrapper
    public DateTime PLJKNFOHMHF;  // wrapper
    public GKJPIIBGPDB JMECEANCFKO;  // wrapper
    public EEANOCHAEIC OFMAJPMGGLO;  // wrapper
    public EEANOCHAEIC HACPLBCBMJI;  // wrapper
}
...
{
    public EEANOCHAEIC OFMAJPMGGLO;  // wrapper
    public EEANOCHAEIC JJMJODEOKKK;  // wrapper
}
...
{
    public Guid BHPIOJFPLEP;  // wrapper
...
{
    public List<LNEHPCBEFBM> GKENLFJKPBB;  // wrapper
}
...
{
    public Guid CPIAGHBFJHI;  // wrapper
    public object Price;  // candidate
...
{
    public Guid CPIAGHBFJHI;  // wrapper
    public long? HLMFMOKIKIN;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Limit;  // candidate
...
{
    public Guid BHPIOJFPLEP;  // wrapper
    public long? AGJEEONGEBC;  // wrapper
    public long? EIFMNHLLLMP;  // wrapper
    public int? OHKFKOLCLCP;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> PJBJFAJEGCC;  // wrapper
...
{
    public IEnumerable<LABGDABOCLK> BEANMDGLIAJ;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public Guid? DHHCLMAOFPB;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object RoomId;  // candidate
...
{
    public LPLFALOBFFJ HDALFDMPFJH;  // wrapper
    public long? HIKLNJNCCAO;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats EFHCJMMGACD;  // wrapper
}
...
{
    public Guid LMAGKFOJECM;  // wrapper
...
{
    public Guid LKBLENBGGMF;  // wrapper
...
{
    public List<MIAJCMEOPEH> LCEPIBGIGCM;  // wrapper
    public object roomId;  // candidate
...
{
    public MLHKFLBLAHH MIJNCJHAJPF;  // wrapper
}
