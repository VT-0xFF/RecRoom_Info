...
public class AANMOIOLDLH
{
    public int <ANHJIKEFBKN>k__BackingField;    // 0x0x10
    public OJJGJBHOGJM <BCIAPNNOLDN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AAPBPOADOKA
//   (not directly referenced by a detected call)
public class AAPBPOADOKA
{
    public bool <KKOEHLMACAP>k__BackingField;    // 0x0x10
    public HPEPNECFHLE <LLGLLLHNOEE>k__BackingField;    // 0x0x14
    public int <AAJJHGLBNFI>k__BackingField;    // 0x0x18
    public DateTime <NFKCDHJKPMC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ABGHJHAICOJ
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class ABGHJHAICOJ
{
    public string <MGBKPPGBPMD>k__BackingField;    // 0x0x10
    public string <NICEBKKCDML>k__BackingField;    // 0x0x18
    public string <GAPNBANALON>k__BackingField;    // 0x0x20
    public string <KHGFKBBCAGH>k__BackingField;    // 0x0x28
    public string <CDPLOCBKHKH>k__BackingField;    // 0x0x30
    public BEEDLGKAFFB <EMJPCGFIFGC>k__BackingField;    // 0x0x38
    public List<string> <PFAJBDJCJGE>k__BackingField;    // 0x0x40
    public List<string> <JLIFLIAJPOB>k__BackingField;    // 0x0x48
    public string <KEPCHILFFON>k__BackingField;    // 0x0x50
    public List<LHJHPLLGKLP> <HLKOFIKIKGC>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// ACELECJLPLO
//   (not directly referenced by a detected call)
public class ACELECJLPLO
{
    public string <KIOCAAHMFOB>k__BackingField;    // 0x0x10
    public HJJKOLIIIGB <OCLHKICLJBO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ACKBKEOHOGG
//   REQUEST  PUT    api/avatar/v4/saved/name   [Service.Econ]
public class ACKBKEOHOGG
{
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x10
    public int <LMFGJDODGPF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AEFGONBFHPB
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class AEFGONBFHPB
{
    public List<AGDNPDGDGCF> <KFEPIKPMBHN>k__BackingField;    // 0x0x10
    public NOHFHMMMNPB <ICKIHEEGPJL>k__BackingField;    // 0x0x18
}
...
public class AFIEAKBPJFD
{
    public int <OEAJHBPHHEJ>k__BackingField;    // 0x0x10
    public JNMNNCPKBPA <OCLHKICLJBO>k__BackingField;    // 0x0x14
    public FKJOJLLJDKN <BMGHMNKIFPG>k__BackingField;    // 0x0x18
    public FKJOJLLJDKN <CCILDAMBNAI>k__BackingField;    // 0x0x1C
    public FKJOJLLJDKN <BAIPNCCKDNH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AGDNPDGDGCF
//   (not directly referenced by a detected call)
public class AGDNPDGDGCF
{
    public int <MIDLNLKJMIL>k__BackingField;    // 0x0x10
    public NOHFHMMMNPB <ICKIHEEGPJL>k__BackingField;    // 0x0x14
}
...
public class AIHBOCBIHGF
{
    public OJJGJBHOGJM <BCIAPNNOLDN>k__BackingField;    // 0x0x10
    public MOHMEDOFKBE <JLEJLBLGPFM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AMAGEGCGMAE
//   (not directly referenced by a detected call)
public class AMAGEGCGMAE
{
...
public class AMDJLCACHPG
{
    public List<int> <OCFDEDNKKPB>k__BackingField;    // 0x0x10
    public string <JJAOLJDLDIB>k__BackingField;    // 0x0x18
}
...
public class AOEMBKOJPGF
{
    public Guid <APLHMDHBFMN>k__BackingField;    // 0x0x10
    public long <GCJKGFJMBPA>k__BackingField;    // 0x0x20
}
...
public class BEAMLHKFDNA
{
    public int <GMDAKPNFPHC>k__BackingField;    // 0x0x10
    public int <LCLFAJKEFHJ>k__BackingField;    // 0x0x14
    public float <IPBKKDCGICN>k__BackingField;    // 0x0x18
    public float <OIDEDBNPAFP>k__BackingField;    // 0x0x1C
    public bool <MADHJDFMPMN>k__BackingField;    // 0x0x20
    public bool <KIFCJMCPGDI>k__BackingField;    // 0x0x21
    public bool <FDNIJDAKDHE>k__BackingField;    // 0x0x22
}
...
public class BFNJDNIENJB
{
    public long <NJPGLGPHGGL>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <BFIPPCGGGEF>k__BackingField;    // 0x0x18
    public PJLCLKOFPOC <JBGJAFJODOL>k__BackingField;    // 0x0x20
}
...
//   RESPONSE GET    api/avatar/v2/{fLKHDEBHMHD}   [Service.Econ]
public class BGILFDFPKJP
{
    public string <EHLNJJEJGOG>k__BackingField;    // 0x0x10
    public string <FAOEMEJJHMG>k__BackingField;    // 0x0x18
    public string <HHGHOCNDIGP>k__BackingField;    // 0x0x20
    public string <CKIAGJNLDHN>k__BackingField;    // 0x0x28
    public string <AFJMNFEBFHH>k__BackingField;    // 0x0x30
    public List<HEGPIEPJHKA> <IDHEKDJBBJF>k__BackingField;    // 0x0x38
}
...
//   RESPONSE DELETE api/keepsakes/{nLEOMGLIGJK}   [Service.API]
...
public class BJAPNOPJGPH
{
    public bool <LGDJIECDCOD>k__BackingField;    // 0x0x10
    public string <LPFHFCIHALD>k__BackingField;    // 0x0x18
}
...
public class BOJACNLOFGC
{
    public NOHFHMMMNPB <ICKIHEEGPJL>k__BackingField;    // 0x0x10
}
...
// CCIEMPBKJDO
//   (not directly referenced by a detected call)
public class CCIEMPBKJDO
{
    public int <PPHDBDFOEDF>k__BackingField;    // 0x0x10
    public DateTime <ACKOKJIAIFJ>k__BackingField;    // 0x0x18
    public DateTime? <MLABHEIHMAD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CKJLEAFJIMD
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class CKJLEAFJIMD
{
    public int <LHBLFOKNCGI>k__BackingField;    // 0x0x10
    public int <MNPDNGJOCGP>k__BackingField;    // 0x0x14
    public float <PPPOOPOBHOJ>k__BackingField;    // 0x0x18
    public int <CCBFFBOBKPK>k__BackingField;    // 0x0x1C
    public int <AKMBKBJHJOJ>k__BackingField;    // 0x0x20
    public int <CEAHFPLANLL>k__BackingField;    // 0x0x24
    public int <NHBHBDHGNMK>k__BackingField;    // 0x0x28
    public string <GPCJOGENDMM>k__BackingField;    // 0x0x30
    public string <MGBOGCGCBFK>k__BackingField;    // 0x0x38
}
...
// base   : FPLFACEDLBG
//   (not directly referenced by a detected call)
public class CLAMBFJHOBO : FPLFACEDLBG
{
    public int <OLGCKOLENAO>k__BackingField;    // 0x0x60
    public List<LJIBBAMIKLL> <PMDCAFLIBDO>k__BackingField;    // 0x0x68
    public List<LJIBBAMIKLL> <NAFMAPFHFEC>k__BackingField;    // 0x0x70
    public List<LJIBBAMIKLL> <BDCAGPMIKOI>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// CNPOLFINHLI
//   (not directly referenced by a detected call)
public class CNPOLFINHLI
{
    public LHCBLFMPNCI <MGIIGEJAFAM>k__BackingField;    // 0x0x10
    public int <JGOICPFEGGG>k__BackingField;    // 0x0x14
    public PAAODLPEEHP <BHELJJCLKOG>k__BackingField;    // 0x0x18
}
...
public class DHENLDMBMBN
{
    public List<JOMMLBDHDAM> <JLFGLOJOMEE>k__BackingField;    // 0x0x10
    public string <JJAOLJDLDIB>k__BackingField;    // 0x0x18
}
...
public class DIJJBABENNC : PPIKANKPKJM
{
    public ANIHNCFNCJO? <MGENNFGNBGP>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <BBLCPCIAEGK>k__BackingField;    // 0x0x20
}
...
// EAKFPMOGABI
//   (not directly referenced by a detected call)
public class EAKFPMOGABI
{
    public float <NFAMPONHKGM>k__BackingField;    // 0x0x10
    public float <KOADIENBGKH>k__BackingField;    // 0x0x14
    public float <IJAOJCFOCIL>k__BackingField;    // 0x0x18
    public float <IFDEAOONLIL>k__BackingField;    // 0x0x1C
    public float <FPDLFMDPJAP>k__BackingField;    // 0x0x20
    public float <EHPFAHGPGHN>k__BackingField;    // 0x0x24
    public float <BJBEMIGIOMM>k__BackingField;    // 0x0x28
    public float <CGPHCHENKCD>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// ELOPNNGBDIH
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class ELOPNNGBDIH
{
    public int <FHAICGOJGPO>k__BackingField;    // 0x0x10
    public int? <BENHPAAPDNF>k__BackingField;    // 0x0x14
    public string <LEGKGEBFPHJ>k__BackingField;    // 0x0x20
    public string <AMFHEMDACNA>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// EOJNIOANAAA
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class EOJNIOANAAA
{
    public int <DAHAAELAJJB>k__BackingField;    // 0x0x10
}
...
// --------------------------------------------------------------------------
// FBIDEIFGOGJ
// base   : JICGKCMEAHA<JLGBEJCDEDJ>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{lKPFFPDIAKB}   [Service.API]
public class FBIDEIFGOGJ
{
    // (no instance fields in the metadata dump)
}
...
// FEMGMOKPLNI
//   (not directly referenced by a detected call)
public class FEMGMOKPLNI
{
    public int <PHDGPILGDHP>k__BackingField;    // 0x0x10
    public string <ALMKIJKFMHE>k__BackingField;    // 0x0x18
    public string <BNLLJCFFPLE>k__BackingField;    // 0x0x20
    public string <OHDCFJECLJH>k__BackingField;    // 0x0x28
    public string <JOGFALLNLHN>k__BackingField;    // 0x0x30
    public string <NPMLEEJNFPF>k__BackingField;    // 0x0x38
    public PHAKFMBODPH? <GGIGGOEMKGM>k__BackingField;    // 0x0x40
    public string <NOIJNCNOAFJ>k__BackingField;    // 0x0x48
    public string <CAAHPDKMJFA>k__BackingField;    // 0x0x50
    public bool <DLJNOPIDFNN>k__BackingField;    // 0x0x58
    public bool <HKEKGIALFEE>k__BackingField;    // 0x0x59
    public bool <NOFHHNJOMLB>k__BackingField;    // 0x0x5A
    public OBBBANPCPME <AEDLPDBPIKC>k__BackingField;    // 0x0x5C
    public int <PCAFBFMAGDB>k__BackingField;    // 0x0x60
    public LHCBLFMPNCI <MGIIGEJAFAM>k__BackingField;    // 0x0x64
    public int <BEPOEGGFGKN>k__BackingField;    // 0x0x68
    public DJOIGBPNIOI <IGMLLDMDCJI>k__BackingField;    // 0x0x6C
    public COGPJIFOJOE <HAHKALHLNKD>k__BackingField;    // 0x0x70
    public int? <DDJPLPPMDMB>k__BackingField;    // 0x0x74
    public string <OILFPCIHLCC>k__BackingField;    // 0x0x80
}
...
public class FFFIMELMJBE : JOMMLBDHDAM
{
    public List<ACELECJLPLO> <JLIFLIAJPOB>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// FJOIBGBGOMG
// base   : JICGKCMEAHA<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class FJOIBGBGOMG
{
    // (no instance fields in the metadata dump)
}
...
public class FLGJGKBJDJI
{
    public int? <OICBHOMMEJL>k__BackingField;    // 0x0x10
    public string <CDPLOCBKHKH>k__BackingField;    // 0x0x18
    public string <IJOENMJJKNL>k__BackingField;    // 0x0x20
}
...
public class FNIPOMPKINJ
{
    public OGMBOOHEEIK <MEPPCDGGMGN>k__BackingField;    // 0x0x10
    public int <DAHAAELAJJB>k__BackingField;    // 0x0x14
    public long <HEKIGGGMEMC>k__BackingField;    // 0x0x18
    public bool <GCOILMPGOIG>k__BackingField;    // 0x0x20
    public string <DHICBHJOOHM>k__BackingField;    // 0x0x28
    public int? <NBFLAAGMOAO>k__BackingField;    // 0x0x30
    public bool <KNHDHDAOGJF>k__BackingField;    // 0x0x38
    public bool <DKGAFLLBBMG>k__BackingField;    // 0x0x39
    public bool <JOGNGHMLOPI>k__BackingField;    // 0x0x3A
    public bool <GHBAPNOKIGD>k__BackingField;    // 0x0x3B
    public string <GHBFIOGAKEI>k__BackingField;    // 0x0x40
    public DateTime? <PEHCFPPFPFG>k__BackingField;    // 0x0x48
    public float <PBOIOLEKDME>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// FPLFACEDLBG
//   (not directly referenced by a detected call)
public class FPLFACEDLBG
{
    public int <IKAFHKOJNLG>k__BackingField;    // 0x0x10
    public BBOBOLKLBPL <OCLHKICLJBO>k__BackingField;    // 0x0x14
    public List<CNPOLFINHLI> <KHCNHKEJEHH>k__BackingField;    // 0x0x18
    public List<CNPOLFINHLI> <OPBHIIKIPNE>k__BackingField;    // 0x0x20
    public bool <FOCJBGJGOFK>k__BackingField;    // 0x0x28
    public DateTime? <HHBLBBNAKAA>k__BackingField;    // 0x0x30
    public DateTime? <HEOGLNABKIN>k__BackingField;    // 0x0x40
    public DateTime? <GOILCAONPHA>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// GCHGBJEOHFK
//   (not directly referenced by a detected call)
public class GCHGBJEOHFK
{
    public long <PHDGPILGDHP>k__BackingField;    // 0x0x10
    public string <JOGFALLNLHN>k__BackingField;    // 0x0x18
    public string <FPPNHADEGKH>k__BackingField;    // 0x0x20
    public PHAKFMBODPH? <GGIGGOEMKGM>k__BackingField;    // 0x0x28
    public string <NOIJNCNOAFJ>k__BackingField;    // 0x0x30
    public string <CAAHPDKMJFA>k__BackingField;    // 0x0x38
    public IBMIPJDJJDM <CJMNANKAOBP>k__BackingField;    // 0x0x40
    public int <MDFFFJCCEOM>k__BackingField;    // 0x0x44
    public int <GFLHLNJKCGH>k__BackingField;    // 0x0x48
    public COGPJIFOJOE? <EOLMMENKFAK>k__BackingField;    // 0x0x4C
    public OBBBANPCPME? <GHBBCLFLNFA>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// GDDDPIEAPFM
//   (not directly referenced by a detected call)
public class GDDDPIEAPFM
{
    public JOMMLBDHDAM <NAOJAIIGNLP>k__BackingField;    // 0x0x10
    public GFAMNIDAKKC <LNBPLADKFFK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GEJCCAGCFKJ
//   (not directly referenced by a detected call)
public class GEJCCAGCFKJ
{
    public long <JHBGGGEDFCH>k__BackingField;    // 0x0x10
    public string <EAGGNODIAJP>k__BackingField;    // 0x0x18
    public int <COJLDHMPLGF>k__BackingField;    // 0x0x20
    public int <LCKEDHPOCPC>k__BackingField;    // 0x0x24
    public int <NEMLMCBIOIF>k__BackingField;    // 0x0x28
    public int <ENLMNGJDGNJ>k__BackingField;    // 0x0x2C
    public int <KLCFGPPGPPB>k__BackingField;    // 0x0x30
    public string <DBEGKNJGDBK>k__BackingField;    // 0x0x38
    public string <KBJBFIAEICL>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// GENACECOAAO
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class GENACECOAAO
{
    public bool <MFCKMELIEMA>k__BackingField;    // 0x0x10
    public string <NICEBKKCDML>k__BackingField;    // 0x0x18
    public string <EOOFKNCICDC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GFAMNIDAKKC
//   (not directly referenced by a detected call)
public class GFAMNIDAKKC
{
    public long <ILCCBGGCFBA>k__BackingField;    // 0x0x10
    public long <COCMLFDOOBL>k__BackingField;    // 0x0x18
    public int <KNEAFLADFJA>k__BackingField;    // 0x0x20
    public DateTime <ACKOKJIAIFJ>k__BackingField;    // 0x0x28
    public ODOOFLMKCIF <OCLHKICLJBO>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GOAIJDMLIML
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class GOAIJDMLIML
{
    public int <EHLFOADONCM>k__BackingField;    // 0x0x10
    public Guid <HBCFCMMDHGF>k__BackingField;    // 0x0x14
    public long <ALFKOOIKOOF>k__BackingField;    // 0x0x28
    public DateTime <NFKCDHJKPMC>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GOBNIKPLHME
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class GOBNIKPLHME
{
    public Guid? <AHDGMHFDHPM>k__BackingField;    // 0x0x10
    public long? <NJPGLGPHGGL>k__BackingField;    // 0x0x28
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x38
    public string <KHGFKBBCAGH>k__BackingField;    // 0x0x40
    public string <OGODKCFGNJN>k__BackingField;    // 0x0x48
    public MOHMEDOFKBE <LDGAMNPEIOJ>k__BackingField;    // 0x0x50
}
...
public class GPAFEPOINNA : PPIKANKPKJM
{
    public KHMEEFHOFDI? <MGENNFGNBGP>k__BackingField;    // 0x0x18
    public GOAIJDMLIML <CHGLCJKKBPH>k__BackingField;    // 0x0x20
}
...
public class HCIMJFEFFNN
{
    public List<CCIEMPBKJDO> <KOMPBIPIPOM>k__BackingField;    // 0x0x10
    public string <JJAOLJDLDIB>k__BackingField;    // 0x0x18
}
...
// HEGPIEPJHKA
//   (not directly referenced by a detected call)
public class HEGPIEPJHKA
{
    public Guid <JDBBEHGJBOA>k__BackingField;    // 0x0x10
    public byte <KBIAPLIJIKH>k__BackingField;    // 0x0x20
}
...
public class HNHJAKMLEFM
{
    public List<ACELECJLPLO> <JLIFLIAJPOB>k__BackingField;    // 0x0x10
}
...
// HPHNENPPOCC
//   (not directly referenced by a detected call)
public class HPHNENPPOCC
{
    public int <ILEILJNHIDF>k__BackingField;    // 0x0x10
}
...
// IJFGPFLIILP
//   (not directly referenced by a detected call)
public class IJFGPFLIILP
{
    public ObscuredLong <JHBGGGEDFCH>k__BackingField;    // 0x0x10
    public string <EAGGNODIAJP>k__BackingField;    // 0x0x38
    public ObscuredInt <PHIICEAPJGK>k__BackingField;    // 0x0x40
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x58
    public string <KHGFKBBCAGH>k__BackingField;    // 0x0x60
    public string <OGODKCFGNJN>k__BackingField;    // 0x0x68
    public int <HCNPHKPGFHE>k__BackingField;    // 0x0x70
    public PGIPANMPFNM <EKLEHKGCMIE>k__BackingField;    // 0x0x74
    public DateTime <NFKCDHJKPMC>k__BackingField;    // 0x0x78
    public DateTime <ACKOKJIAIFJ>k__BackingField;    // 0x0x80
    public DateTime? <BBMKKFFFDHD>k__BackingField;    // 0x0x88
    public long? <OIFNCDHAJME>k__BackingField;    // 0x0x98
    public int <NEHJMMBKBBN>k__BackingField;    // 0x0xA8
    public int <KAJIDOGLHPC>k__BackingField;    // 0x0xAC
    public int <HDNFKKELEBI>k__BackingField;    // 0x0xB0
    public FFBPANPICJJ <HBHLKIDOIPL>k__BackingField;    // 0x0xB4
    public FFBPANPICJJ <PJHMEOBEHOM>k__BackingField;    // 0x0xB8
    public ObscuredBool <LCNEOOBCKBD>k__BackingField;    // 0x0xBC
    public ObscuredBool <OGPKPNJDPEK>k__BackingField;    // 0x0xC8
    public ObscuredBool <AAOIANMFCOK>k__BackingField;    // 0x0xD4
    public int? <JGOICPFEGGG>k__BackingField;    // 0x0xE0
    public bool <OANADFDOAFA>k__BackingField;    // 0x0xE8
}
...
public class IOEGAHMCDPO
{
    public IJPONEEBEAH <EMJPCGFIFGC>k__BackingField;    // 0x0x10
    public IJFGPFLIILP <KEHLODCLHOM>k__BackingField;    // 0x0x18
    public GEJCCAGCFKJ <CFDEGJGOKAA>k__BackingField;    // 0x0x20
}
...
//   RESPONSE GET    api/storefronts/v1/season/{aGNNJDMCHJD}   [Service.Econ]
public class JNIHLIJPNBK : BDFNGPFMNAM
{
    public int <DOIHBEANBIJ>k__BackingField;    // 0x0x30
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x38
    public DateTime <ECEABGKGDBN>k__BackingField;    // 0x0x40
    public DateTime <KBDGNJHDMEB>k__BackingField;    // 0x0x48
    public LHCBLFMPNCI <MGIIGEJAFAM>k__BackingField;    // 0x0x50
    public FPLFACEDLBG <EFADFABLBPO>k__BackingField;    // 0x0x58
    public List<CLAMBFJHOBO> <ELHJHPHGPFK>k__BackingField;    // 0x0x60
    public AAPBPOADOKA <DOPONKCDDBP>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// JOMMLBDHDAM
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class JOMMLBDHDAM
{
    public long <COCMLFDOOBL>k__BackingField;    // 0x0x10
    public int <PHIICEAPJGK>k__BackingField;    // 0x0x18
    public long <NJPGLGPHGGL>k__BackingField;    // 0x0x20
    public long? <DGHOEPJDBFK>k__BackingField;    // 0x0x28
    public long? <GHKBEDCJLMN>k__BackingField;    // 0x0x38
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x48
    public string <KHGFKBBCAGH>k__BackingField;    // 0x0x50
    public string <OGODKCFGNJN>k__BackingField;    // 0x0x58
    public DateTime <EHOGJDEAFDD>k__BackingField;    // 0x0x60
    public DateTime <GLAOHBIPKLB>k__BackingField;    // 0x0x68
    public int <DAFBPCMAHBO>k__BackingField;    // 0x0x70
    public MJLDGHJDDEJ <EKLEHKGCMIE>k__BackingField;    // 0x0x74
    public bool <KCIBDCIJECK>k__BackingField;    // 0x0x78
    public bool <NPNPEONBPGE>k__BackingField;    // 0x0x79
    public KABECEOOOOJ <DPPPLGJJJNF>k__BackingField;    // 0x0x7C
    public KABECEOOOOJ <CMJOOHMGEHK>k__BackingField;    // 0x0x80
    public long? <AIHNOHCMPPD>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// JOPJPNKMKKA
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class JOPJPNKMKKA
{
    public long <MPCGHDHBDMJ>k__BackingField;    // 0x0x10
    public int <EHLFOADONCM>k__BackingField;    // 0x0x18
}
...
public class KACJFKHIJJO
{
    public int <LCLFAJKEFHJ>k__BackingField;    // 0x0x10
    public bool <MADHJDFMPMN>k__BackingField;    // 0x0x14
    public DateTime <BCEBDKJGMMI>k__BackingField;    // 0x0x18
    public bool <IODBNHBAKCI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KAHFEMDODIM
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class KAHFEMDODIM
{
    public FEGIIKAEIOF <ICKIHEEGPJL>k__BackingField;    // 0x0x10
    public List<string> <JLIFLIAJPOB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KEMECFLBILO
//   (not directly referenced by a detected call)
public class KEMECFLBILO
{
    public int <IFFAKGJGCGH>k__BackingField;    // 0x0x10
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x18
    public string <EJLLCBBFLIA>k__BackingField;    // 0x0x20
    public string <KHGFKBBCAGH>k__BackingField;    // 0x0x28
    public string <BNLLJCFFPLE>k__BackingField;    // 0x0x30
    public bool <LLHPENOFNIL>k__BackingField;    // 0x0x38
    public int <LMFGJDODGPF>k__BackingField;    // 0x0x3C
    public AMAGEGCGMAE <GJIGJEBGBGF>k__BackingField;    // 0x0x40
    public CAOMKDELKIN PPGIJLGIGEB;    // 0x0x48
    public CAOMKDELKIN HOJLLNJCGAP;    // 0x0x50
    public CAOMKDELKIN EAFCJGMOEKG;    // 0x0x58
    public LGKOGENGNFM FJODGLJNFOK;    // 0x0x60
}

// --------------------------------------------------------------------------
// KFPOCEOCFFM
//   RESPONSE ?      api/inventions/   [Service.API]
//   RESPONSE GET    api/inventions/v1/personaldetails/{gKIMGIJJECE}   [Service.API]
public class KFPOCEOCFFM
{
    public bool <GJIAPHOJLGI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KGDDNMADPBC
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class KGDDNMADPBC
{
    public Dictionary<Guid, AANMOIOLDLH> <NMEOGLNPOKH>k__BackingField;    // 0x0x10
}
...
// base   : FPLFACEDLBG
//   (not directly referenced by a detected call)
public class KIGMPEIPEHJ : FPLFACEDLBG
{
    public FEMGMOKPLNI <MOPDFBIOBMI>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// LDJFPFICPKF
//   (not directly referenced by a detected call)
public class LDJFPFICPKF
{
    public int <AICMPEEDGHJ>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{hONPNPFLLEA}   [Service.Econ]
public class LFFKDIAJJLH
{
    public NJAPKONDIDO <EMJPCGFIFGC>k__BackingField;    // 0x0x10
    public POMDDKDHDKF <FIGKDOIJHPA>k__BackingField;    // 0x0x18
}
...
// LHJHPLLGKLP
//   (not directly referenced by a detected call)
public class LHJHPLLGKLP
{
    public DateTime <ACKOKJIAIFJ>k__BackingField;    // 0x0x10
    public string <JLDFFHCOGEH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LJIBBAMIKLL
//   (not directly referenced by a detected call)
public class LJIBBAMIKLL
{
    public bool <OECMJCBCHEB>k__BackingField;    // 0x0x10
    public FEMGMOKPLNI <MOPDFBIOBMI>k__BackingField;    // 0x0x18
    public float <KKNLPLBJNLO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LNOKJIKCNAM
//   (not directly referenced by a detected call)
public class LNOKJIKCNAM
{
    public Guid <AHDGMHFDHPM>k__BackingField;    // 0x0x10
    public int <EHLFOADONCM>k__BackingField;    // 0x0x20
    public int <OCDNFIJAGIN>k__BackingField;    // 0x0x24
    public Guid <ACODHGGFOMC>k__BackingField;    // 0x0x28
    public DateTime <NFKCDHJKPMC>k__BackingField;    // 0x0x38
    public POMDDKDHDKF <FIGKDOIJHPA>k__BackingField;    // 0x0x40
}
...
public class MBHLPIGJHBO
{
    public AGMKJJEHBDN <MEPPCDGGMGN>k__BackingField;    // 0x0x10
    public string <IIHNAPNLGMB>k__BackingField;    // 0x0x18
    public int? <FCLKDFFCCMM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MCCBAEPPLDN
//   (not directly referenced by a detected call)
public class MCCBAEPPLDN
{
    public long <MPCGHDHBDMJ>k__BackingField;    // 0x0x10
    public Guid <EAGGNODIAJP>k__BackingField;    // 0x0x18
    public long <NJPGLGPHGGL>k__BackingField;    // 0x0x28
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x30
    public string <KHGFKBBCAGH>k__BackingField;    // 0x0x38
    public int <JGOICPFEGGG>k__BackingField;    // 0x0x40
    public Guid? <JBNJOKOHMML>k__BackingField;    // 0x0x44
    public DateTime <ACKOKJIAIFJ>k__BackingField;    // 0x0x58
    public string <OGODKCFGNJN>k__BackingField;    // 0x0x60
    public HAFMLLKOJPF <OCLHKICLJBO>k__BackingField;    // 0x0x68
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{cCHMAOAMHGJ}   [Service.Econ]
public enum MEHMBFAPMKL
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class MJFMGGMBKDL
{
    public List<string> <OPGBCAPEMOI>k__BackingField;    // 0x0x10
    public List<string> <FPKOCCIBOJO>k__BackingField;    // 0x0x18
    public List<string> <BEJADFDBMEH>k__BackingField;    // 0x0x20
}
...
public class MKGGNMECOEN
{
    public int <LJLOHGJILID>k__BackingField;    // 0x0x10
    public string <MPKDDALCAON>k__BackingField;    // 0x0x18
    public List<KEMECFLBILO> <ONHEOFNCJBB>k__BackingField;    // 0x0x20
    public GCHGBJEOHFK <AGADACFGOBG>k__BackingField;    // 0x0x28
    public string <AEKJJKCNDIL>k__BackingField;    // 0x0x30
    public DateTime <ECEABGKGDBN>k__BackingField;    // 0x0x38
    public DateTime <KBDGNJHDMEB>k__BackingField;    // 0x0x40
    public DateTime <EMDPNLMFEEI>k__BackingField;    // 0x0x48
    public bool? <NIAKKBADDMM>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// MLOACDBMFDK
//   (not directly referenced by a detected call)
public class MLOACDBMFDK
{
    public Guid <MHOIILPEPMO>k__BackingField;    // 0x0x10
    public Guid <NIOKBOLDIKF>k__BackingField;    // 0x0x20
    public DateTime <ECEABGKGDBN>k__BackingField;    // 0x0x30
    public List<FEMGMOKPLNI> <HJJCJEKPGPN>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// MOHMEDOFKBE
//   (not directly referenced by a detected call)
public class MOHMEDOFKBE
{
    public long <JGOICPFEGGG>k__BackingField;    // 0x0x10
    public Guid? <HBCFCMMDHGF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MPFGMEEJCCB
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{fLKHDEBHMHD}   [Service.API]
public class MPFGMEEJCCB
{
    public List<JOMMLBDHDAM> <APLNNHDIPEB>k__BackingField;    // 0x0x10
    public List<GDDDPIEAPFM> <LJGCLDNIPPF>k__BackingField;    // 0x0x18
}
...
public class NDGIAOGODAI
{
    public bool <LGDJIECDCOD>k__BackingField;    // 0x0x10
    public string <DHICBHJOOHM>k__BackingField;    // 0x0x18
}
...
public class NNBHGKGOJJB
{
    public LHCBLFMPNCI <MGIIGEJAFAM>k__BackingField;    // 0x0x10
    public MPGIODFKBKL <LCHILDFGOPJ>k__BackingField;    // 0x0x14
    public int <IDIDCCFBGMH>k__BackingField;    // 0x0x18
    public int <HNHNBIJDAFO>k__BackingField;    // 0x0x1C
    public int <FCDFPJEDECF>k__BackingField;    // 0x0x20
    public HFKNBFMNMDL <FNKLEFAJEIP>k__BackingField;    // 0x0x24
    public bool <HPFFJMFELDJ>k__BackingField;    // 0x0x28
    public float <IDLLGGGABOG>k__BackingField;    // 0x0x2C
    public int <OCBPPICDFEH>k__BackingField;    // 0x0x30
    public bool <HJGNKDGHJNC>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// NOBCHIHIBMA
//   (not directly referenced by a detected call)
public class NOBCHIHIBMA
{
    public float <JDFDHKEGICK>k__BackingField;    // 0x0x10
}
...
public class NPEFPOOKNJA
{
    public NJAPKONDIDO <EMJPCGFIFGC>k__BackingField;    // 0x0x10
    public LNOKJIKCNAM <MDIMOEHNOIH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OABPKHMPPGI
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class OABPKHMPPGI
{
    public Dictionary<Guid, NPEFPOOKNJA> <FGGPLFDCPLP>k__BackingField;    // 0x0x10
}
...
public class OAPMBFFCINJ
{
    public MEHMBFAPMKL <EMJPCGFIFGC>k__BackingField;    // 0x0x10
    public MCCBAEPPLDN <GLMILNOGEKI>k__BackingField;    // 0x0x18
}
...
public class OICLMICFCMG : BDFNGPFMNAM
{
    public List<KIGMPEIPEHJ> EMMCGDOELHN;    // 0x0x30
    public int <PABACHKMFEG>k__BackingField;    // 0x0x38
}
...
public class OINHAMHAHNI
{
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x10
    public string <KHGFKBBCAGH>k__BackingField;    // 0x0x18
    public int? <JGOICPFEGGG>k__BackingField;    // 0x0x20
    public PGIPANMPFNM? <EKLEHKGCMIE>k__BackingField;    // 0x0x28
}
...
public class OJJGJBHOGJM
{
    public Guid? <DCMCOHNNGKD>k__BackingField;    // 0x0x10
    public Guid <GBEMEGGALOH>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// OLOKFEMALNK
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Econ]
public class OLOKFEMALNK
{
    public Guid <NEHJDGKHCIJ>k__BackingField;    // 0x0x10
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x20
    public string <OGODKCFGNJN>k__BackingField;    // 0x0x28
    public DateTime <ECEABGKGDBN>k__BackingField;    // 0x0x30
    public DateTime? <PLGJMPFBCHB>k__BackingField;    // 0x0x38
    public List<MLOACDBMFDK> <APMAMLBEACP>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// PAAODLPEEHP
//   (not directly referenced by a detected call)
public class PAAODLPEEHP
{
    public int <ICGAMELMPHO>k__BackingField;    // 0x0x10
    public DateTime? <ICAMJPMKJED>k__BackingField;    // 0x0x18
    public DateTime? <GLOCLFEJEIA>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// PAEILHEFJDO
//   (not directly referenced by a detected call)
public class PAEILHEFJDO
{
    public FLNCLDLGLGO ANEOHMKBDNJ;    // 0x0x10
    public int CLCCLDGNFAM;    // 0x0x14
}

// --------------------------------------------------------------------------
// PGKENNFLBEG
//   REQUEST  POST   api/avatar/v4/saved/set   [Service.Econ]
public class PGKENNFLBEG
{
    public int <LMFGJDODGPF>k__BackingField;    // 0x0x10
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x18
    public string <PPDMINIBDCN>k__BackingField;    // 0x0x20
    public string <EHLNJJEJGOG>k__BackingField;    // 0x0x28
    public string <FAOEMEJJHMG>k__BackingField;    // 0x0x30
    public string <HHGHOCNDIGP>k__BackingField;    // 0x0x38
    public string <CKIAGJNLDHN>k__BackingField;    // 0x0x40
    public string <AFJMNFEBFHH>k__BackingField;    // 0x0x48
    public PGIPANMPFNM <EKLEHKGCMIE>k__BackingField;    // 0x0x50
    public List<HEGPIEPJHKA> <IDHEKDJBBJF>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// PJBEKPAJPPO
//   (not directly referenced by a detected call)
public class PJBEKPAJPPO
{
    public int <DCGIHFKNCON>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{oDOGOKINCGP}   [Service.API]
...
public class PKJEGOOLBCA
{
    public FFFIMELMJBE <NAOJAIIGNLP>k__BackingField;    // 0x0x10
    public NOHFHMMMNPB <ICKIHEEGPJL>k__BackingField;    // 0x0x18
    public KAHFEMDODIM <AHPAEMPPJPH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PKOFBFOFOOJ
//   RESPONSE GET    api/config/v2   [Service.API]
public class PKOFBFOFOOJ
{
    public Dictionary<int, int> <DMCJGEPAKLE>k__BackingField;    // 0x0x10
    public List<IJHHPGGHOCM> <PENEBDFNFJC>k__BackingField;    // 0x0x18
    public PAEILHEFJDO[][] <EIODNLBNLPD>k__BackingField;    // 0x0x20
    public LDJFPFICPKF <IDGGFLHPLJO>k__BackingField;    // 0x0x28
    public EAKFPMOGABI <FDNBBJILLMB>k__BackingField;    // 0x0x30
    public PJBEKPAJPPO <BJMIMICFNGN>k__BackingField;    // 0x0x38
    public HPHNENPPOCC <LOLNOINIKJL>k__BackingField;    // 0x0x40
    public NOBCHIHIBMA <KABPABIJIBB>k__BackingField;    // 0x0x48
    public string <GJBKJKMGMLO>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// PMNFKKMBAMC
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{iDFOGLKIIHM}   [Service.API]
public class PMNFKKMBAMC
{
    public uint <MGBKPPGBPMD>k__BackingField;    // 0x0x10
    public uint? <MMGBGLNMGJJ>k__BackingField;    // 0x0x14
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x20
    public string <KHGFKBBCAGH>k__BackingField;    // 0x0x28
    public DateTime <ALPJJDANAKA>k__BackingField;    // 0x0x30
    public DateTime? <DFPILCNMEHB>k__BackingField;    // 0x0x38
    public bool <MMNEKGIEGBL>k__BackingField;    // 0x0x48
    public List<ABGHJHAICOJ> <ODMJJIBAGAC>k__BackingField;    // 0x0x50
    public List<string> <JLIFLIAJPOB>k__BackingField;    // 0x0x58
    public int <DKCCGCAALAM>k__BackingField;    // 0x0x60
    public int <ILGKHKBHFNM>k__BackingField;    // 0x0x64
    public int <HKBOOJMCBIP>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// PNAPGECMKNN
//   RESPONSE GET    api/config/v1/amplitude   [Service.API]
public class PNAPGECMKNN
{
    public string <PNACJCDECGM>k__BackingField;    // 0x0x10
    public string <AFEKHCOOHKL>k__BackingField;    // 0x0x18
    public bool <IKJJPFNIOEI>k__BackingField;    // 0x0x20
    public string <CPHBNLOKJDH>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// POMDDKDHDKF
//   (not directly referenced by a detected call)
public class POMDDKDHDKF
{
    public Guid <AHDGMHFDHPM>k__BackingField;    // 0x0x10
    public long <NJPGLGPHGGL>k__BackingField;    // 0x0x20
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x28
    public string <KHGFKBBCAGH>k__BackingField;    // 0x0x30
    public string <OGODKCFGNJN>k__BackingField;    // 0x0x38
    public long <JGOICPFEGGG>k__BackingField;    // 0x0x40
    public Guid? <JBNJOKOHMML>k__BackingField;    // 0x0x48
    public DateTime <NFKCDHJKPMC>k__BackingField;    // 0x0x60
}
...
{
    public long <NJPGLGPHGGL>k__BackingField;    // 0x0x10
    public long? <DGHOEPJDBFK>k__BackingField;    // 0x0x18
    public CCLDPBPGLEA <HEBLAKOEIPH>k__BackingField;    // 0x0x28
}
...
{
    public IKHKJHHDMEI <ICKIHEEGPJL>k__BackingField;    // 0x0x10
    public string <NLOLENHNLEO>k__BackingField;    // 0x0x18
    public string <ONCEIDCDPCP>k__BackingField;    // 0x0x20
    public string <KCBDPMJCCHP>k__BackingField;    // 0x0x28
}
...
{
    public long <COCMLFDOOBL>k__BackingField;    // 0x0x10
    public long? <OPIEDIANNNM>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public DEBGKFGMNKA FilterType;    // 0x0x20
...
{
    public CCLDPBPGLEA <NGAEAHKAPEI>k__BackingField;    // 0x0x10
    public string <FBMKMKNMPDE>k__BackingField;    // 0x0x18
    public int <EFGBPPGFPHH>k__BackingField;    // 0x0x20
    public int <CKEMEMAHCKP>k__BackingField;    // 0x0x24
    public string <CKLBJNAOBND>k__BackingField;    // 0x0x28
    public string <IBDKJJBNLCI>k__BackingField;    // 0x0x30
}
...
{
    public int <EHLFOADONCM>k__BackingField;    // 0x0x10
    public Guid <FHJKBJPEBGD>k__BackingField;    // 0x0x14
    public DateTime <ADCCMDPKGIN>k__BackingField;    // 0x0x28
}
...
{
    public bool <COPHKGBJKDA>k__BackingField;    // 0x0x10
    public int <KJJMGGEMAJI>k__BackingField;    // 0x0x14
    public bool <DJNBPIEEJGB>k__BackingField;    // 0x0x18
}
...
{
    public Guid <FHJKBJPEBGD>k__BackingField;    // 0x0x10
    public CCLDPBPGLEA <EDGHKGHNBHP>k__BackingField;    // 0x0x20
    public int <MJDCGALBDIK>k__BackingField;    // 0x0x24
    public long <NJPGLGPHGGL>k__BackingField;    // 0x0x28
    public long? <DGHOEPJDBFK>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{nOAKJPLALPD}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <NKFOOPOIAGH>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <HKOLOKMKHLF>k__BackingField;    // 0x0x18
}
...
{
    public long <GBABJJDMEMF>k__BackingField;    // 0x0x10
    public long <NJPGLGPHGGL>k__BackingField;    // 0x0x18
    public long <KGBPGJOIKFO>k__BackingField;    // 0x0x20
    public IKBJAHBNGHB <OCLHKICLJBO>k__BackingField;    // 0x0x28
    public int <HKHJCLKKLGK>k__BackingField;    // 0x0x2C
}
...
{
    public long <NJPGLGPHGGL>k__BackingField;    // 0x0x10
    public List<Guid> <BKBFHNFEAMC>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <NKFOOPOIAGH>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <HKOLOKMKHLF>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <FCKFAIINCIC>k__BackingField;    // 0x0x20
}
...
{
    public long <KGBPGJOIKFO>k__BackingField;    // 0x0x10
    public long <JJBEOODONPJ>k__BackingField;    // 0x0x18
    public int? <HEIAAHABHID>k__BackingField;    // 0x0x20
    public int? <JOCBEENBNCD>k__BackingField;    // 0x0x28
    public long? <JCEIPDMFHAE>k__BackingField;    // 0x0x30
    public long <PPJICOHMFIP>k__BackingField;    // 0x0x40
    public long <LMIIKPKIEAB>k__BackingField;    // 0x0x48
    public int <LOPHAPNOHPO>k__BackingField;    // 0x0x50
    public IKBJAHBNGHB <ABFJPDGKAIE>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <OADJJPIIGGE>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public COGPJIFOJOE <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public CJPJAKBBEBK creatorAccountRole;    // 0x0x58
}
...
{
    public GADOJAMPOEF <PLOOJMMIPKF>k__BackingField;    // 0x0x10
    public LBDIKDEPMPD <BMADKMJMJKF>k__BackingField;    // 0x0x14
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x18
    public string <KHGFKBBCAGH>k__BackingField;    // 0x0x20
    public bool <IOPODKNKCNE>k__BackingField;    // 0x0x28
}
...
{
    public List<GADOJAMPOEF> <PAPMHJJHLAN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{oDOGOKINCGP}   [Service.API]
public class ProgressionEventDTO
{
    public long <JJBEOODONPJ>k__BackingField;    // 0x0x10
    public string <NNNJMLIKBKE>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <BDCAGPMIKOI>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <NPIHJHHNICB>k__BackingField;    // 0x0x28
    public DateTime <EHOGJDEAFDD>k__BackingField;    // 0x0x30
    public DateTime <GLAOHBIPKLB>k__BackingField;    // 0x0x38
    public DateTime <GFLIIPMCNPL>k__BackingField;    // 0x0x40
    public bool <JFNAJLACFBL>k__BackingField;    // 0x0x48
    public int <PCLBJECLFEE>k__BackingField;    // 0x0x4C
    public float <NDHNBMMDNEI>k__BackingField;    // 0x0x50
    public Guid? <FKNCCMDNEKH>k__BackingField;    // 0x0x54
    public string <HDJFHDCFFKB>k__BackingField;    // 0x0x68
    public string <KMKNKEBHFEE>k__BackingField;    // 0x0x70
    public string <MBFGHAMHELN>k__BackingField;    // 0x0x78
    public string <FDIEJAGGAKA>k__BackingField;    // 0x0x80
}
...
{
    public Guid <EIJNPCADNLL>k__BackingField;    // 0x0x10
    public int <KNGIJFHDPGF>k__BackingField;    // 0x0x20
    public int <GENJHIICBGA>k__BackingField;    // 0x0x24
    public int <MGGDHGFIPHO>k__BackingField;    // 0x0x28
    public long <FPDOJOBOPLA>k__BackingField;    // 0x0x30
    public long <CFKBLCHABJG>k__BackingField;    // 0x0x38
}
...
{
    public int <EHLFOADONCM>k__BackingField;    // 0x0x10
    public int <MDFFFJCCEOM>k__BackingField;    // 0x0x14
    public int <JOCPPCGOKPC>k__BackingField;    // 0x0x18
    public int <FPGELNJALLC>k__BackingField;    // 0x0x1C
    public int <AGDFMIJINCL>k__BackingField;    // 0x0x20
    public DateTime? <LLNEFIFFBEG>k__BackingField;    // 0x0x28
}
...
{
    public long <CKILMGDKEIE>k__BackingField;    // 0x0x10
    public int <PHDGPILGDHP>k__BackingField;    // 0x0x18
    public string <OGODKCFGNJN>k__BackingField;    // 0x0x20
    public int <MDFFFJCCEOM>k__BackingField;    // 0x0x28
    public int <JDAGGNEIPKE>k__BackingField;    // 0x0x2C
    public bool <MAGBDBEFHNM>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public OBCPGELNHPP ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool PNAIPJMJKNL;    // 0x0x28
}
...
{
    public NAOCJCLLMEJ? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public NAOCJCLLMEJ JNMBCKDBKHB;  // wrapper
...
{
    public PDNPCJMDGDJ BNCDEELOEHP;  // wrapper
...
{
    public DPPLAPPKPGE ONBHBHIHHNE;  // wrapper
    public int? GDOPLGFJOMC;  // wrapper
...
{
    public OGMBOOHEEIK JPCDMGAPBMC;  // wrapper
    public float? CLOADHJKMOA;  // wrapper
...
{
    public CPFAHICIAEK UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public COGPJIFOJOE GEKPLLKAIKG;  // wrapper
    public COGPJIFOJOE? BEFAHPHIFCJ;  // wrapper
...
{
    public KEMECFLBILO GEEKGLGLELG;  // wrapper
...
{
    public PGIPANMPFNM KIDIMHJIEJF;  // wrapper
    public LFKMKDGAMGF FEOALNFBBGE;  // wrapper
    public byte[] MHICGONEAAI;  // wrapper
    public byte[] HJKHJPNCMBI;  // wrapper
    public Color OGGMNJPGMJE;  // wrapper
...
{
    public List<DMAIHLEPIGN> PFLMLJBFIHP;  // wrapper
}
...
{
    public IIIPJDDJCFI LKGOENJMBDN;  // wrapper
    public COGPJIFOJOE? PLMPDKNDKCP;  // wrapper
...
{
    public IICKPKMPDHM GALDCJEHHPN;  // wrapper
...
{
    public IJFGPFLIILP inventionId;  // wrapper
}
...
// api/keepsakes/{nLEOMGLIGJK}/collect  [API POST]
public class KeepsakesNLEOMGLIGJKCollectRequest
{
    public Guid NLEOMGLIGJK;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> PJCLGFKCDIC;  // wrapper
    public PNOHODGJPDN DHBBPHGIDGP;  // wrapper
    public long? MEFEJANAPKD;  // wrapper
...
{
    public long? MFNJJPPEJPE;  // wrapper
}
...
{
    public long? KKEHNOMAPGJ;  // wrapper
    public long? HGPHNNELJIG;  // wrapper
    public List<string> ONELIJGMLGK;  // wrapper
    public DateTime FCHEKHELBEL;  // wrapper
    public DateTime FIMHKGEAHJH;  // wrapper
    public MJLDGHJDDEJ KIDIMHJIEJF;  // wrapper
    public KABECEOOOOJ BCCIOLLBKJI;  // wrapper
    public KABECEOOOOJ CJIHLBGDDKD;  // wrapper
}
...
{
    public KABECEOOOOJ BCCIOLLBKJI;  // wrapper
    public KABECEOOOOJ OEJJBJEALAI;  // wrapper
}
...
{
    public Guid FKNHEFABHFB;  // wrapper
...
{
    public List<NIPCFAOOHKI> FLPFJHGCMJG;  // wrapper
}
...
{
    public Guid EJABKKGHNHI;  // wrapper
    public object Price;  // candidate
...
{
    public Guid EJABKKGHNHI;  // wrapper
    public long? PHACGCLPFFH;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Limit;  // candidate
...
{
    public Guid FKNHEFABHFB;  // wrapper
    public long? HDENPDLCCBG;  // wrapper
    public long? DIKABKKIPEC;  // wrapper
    public int? FAMPLPLOJMN;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> IHHAIAFPENO;  // wrapper
...
{
    public IEnumerable<BENIBBGKGJO> BFBCOIOJBGD;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public HAFMLLKOJPF ONBHBHIHHNE;  // wrapper
    public Guid? OMAFGAFLEMP;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public OGMBOOHEEIK JPCDMGAPBMC;  // wrapper
    public long? EIKJLOEFKDD;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats JJLBOAAJLEO;  // wrapper
}
...
{
    public Guid LONLLHJEDCJ;  // wrapper
...
{
    public Guid NPKEJLCBOLG;  // wrapper
...
{
    public List<PDBEGPFMLAO> ONLIFINMJFN;  // wrapper
    public object roomId;  // candidate
...
{
    public BEEDLGKAFFB OMJAMLHDAEM;  // wrapper
}
