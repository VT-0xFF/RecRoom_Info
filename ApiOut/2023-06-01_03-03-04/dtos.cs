...
// DTO classes: 254 (plus referenced enums)

// --------------------------------------------------------------------------
// ABLGMLNNEAE
//   (not directly referenced by a detected call)
public class ABLGMLNNEAE
{
    public long <MNKCOIMCPIM>k__BackingField;    // 0x0x10
    public Guid <KNCBHFJCJPP>k__BackingField;    // 0x0x18
    public long <NDBIJMBMPAI>k__BackingField;    // 0x0x28
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x30
    public string <DLAMMGCMEDK>k__BackingField;    // 0x0x38
    public int <LBFMPLLEDFC>k__BackingField;    // 0x0x40
    public Guid? <CPDGPIGODJM>k__BackingField;    // 0x0x44
    public DateTime <PLLMKFGPCIA>k__BackingField;    // 0x0x58
    public string <AKJICMANMAC>k__BackingField;    // 0x0x60
    public NLAKFAOKIGM <BDMHMDAGBMJ>k__BackingField;    // 0x0x68
}
...
public class ADBNPMLAMIP
{
    public ANKMPPIHLAG <HKEIMDEEEBB>k__BackingField;    // 0x0x10
    public string <GJBHPHHJDBA>k__BackingField;    // 0x0x18
    public int? <JKOIKBKCFAM>k__BackingField;    // 0x0x20
}
...
public class ADLDDCDIABC : PHIIDAOMAAO
{
    public List<NPJEOEOIJJE> ICHBHJOOANL;    // 0x0x30
    public int <FENDIGHCICJ>k__BackingField;    // 0x0x38
}
...
//   RESPONSE DELETE api/keepsakes/{nCDLOEBMMGD}   [Service.API]
...
public class ADPDMDHILEM
{
    public bool <MBHKCHMCLBF>k__BackingField;    // 0x0x10
    public string <LIKHDPHNADL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AHPFPOOHAEN
//   (not directly referenced by a detected call)
public class AHPFPOOHAEN
{
    public int <BHLFMCCOAGF>k__BackingField;    // 0x0x10
    public string <KAPCHBLLCNO>k__BackingField;    // 0x0x18
    public string <BMDLPGPMAIN>k__BackingField;    // 0x0x20
    public string <PCLJEMHBLCL>k__BackingField;    // 0x0x28
    public string <HDFDILAONLA>k__BackingField;    // 0x0x30
    public string <AEHGLDOEHJG>k__BackingField;    // 0x0x38
    public JAIFEOINDJM? <MIOGHAANPGN>k__BackingField;    // 0x0x40
    public string <LGJAAHJEFCI>k__BackingField;    // 0x0x48
    public string <FGOIGHOCNOE>k__BackingField;    // 0x0x50
    public bool <NBGPBLKMKMP>k__BackingField;    // 0x0x58
    public bool <APLCJJCJLJE>k__BackingField;    // 0x0x59
    public bool <DJBLBMCNAIP>k__BackingField;    // 0x0x5A
    public LDBLOONLBHI <DGGNMOELHMM>k__BackingField;    // 0x0x5C
    public int <KFHAODLHCNB>k__BackingField;    // 0x0x60
    public KNOCFMAJCEA <LMCKADNKKBL>k__BackingField;    // 0x0x64
    public int <PAMHMGGMHED>k__BackingField;    // 0x0x68
    public ELPHCPLFBEN <CNAGIOOEAPP>k__BackingField;    // 0x0x6C
    public OBGEFKADHEA <FLNHJOEGEBJ>k__BackingField;    // 0x0x70
    public int? <JIEGCDLAOGF>k__BackingField;    // 0x0x74
    public string <JAJALKBCJMG>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// AJAGPAKDOMB
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class AJAGPAKDOMB
{
    public int <LKOPHBBOHPL>k__BackingField;    // 0x0x10
    public int <MNOAMBHDKFE>k__BackingField;    // 0x0x14
    public float <BOIHPFOIPFP>k__BackingField;    // 0x0x18
    public int <GJOGLEHJIGO>k__BackingField;    // 0x0x1C
    public int <FCNOIJHAENN>k__BackingField;    // 0x0x20
    public int <CNFNLLKBODM>k__BackingField;    // 0x0x24
    public int <APIHMNOGOCG>k__BackingField;    // 0x0x28
    public string <MCBHOCKKJOG>k__BackingField;    // 0x0x30
    public string <ALJLJGAOJAP>k__BackingField;    // 0x0x38
}
...
public class AJEFNCCLMGF
{
    public int <CKNDEIMLOLH>k__BackingField;    // 0x0x10
    public bool <HOHBGGFEIHE>k__BackingField;    // 0x0x14
    public DateTime <OLMJECAKGBF>k__BackingField;    // 0x0x18
    public bool <KEKPBCMOOLC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ALEMIKEIADN
//   (not directly referenced by a detected call)
public class ALEMIKEIADN
{
    public float <BNFLEDGHHMK>k__BackingField;    // 0x0x10
    public float <MBKHAHLBJEL>k__BackingField;    // 0x0x14
    public float <JFNFOGHFDGI>k__BackingField;    // 0x0x18
    public float <JGCJKPNJBOL>k__BackingField;    // 0x0x1C
    public float <GPFMBINFPHB>k__BackingField;    // 0x0x20
    public float <OJIAIELJGEJ>k__BackingField;    // 0x0x24
    public float <DLHDDDMFFPM>k__BackingField;    // 0x0x28
    public float <NEIMPLGIDLJ>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// ANLMGMBHKPO
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class ANLMGMBHKPO
{
    public int <FNABKPOBKDL>k__BackingField;    // 0x0x10
    public Guid <LNLCNEBLFGK>k__BackingField;    // 0x0x14
    public long <FHIMMIIGDPL>k__BackingField;    // 0x0x28
    public DateTime <JCODLMCJPOF>k__BackingField;    // 0x0x30
}
...
// BBOHMIBIJKH
//   (not directly referenced by a detected call)
public class BBOHMIBIJKH
{
    public ObscuredLong <EAIMPDJNEJC>k__BackingField;    // 0x0x10
    public string <KNCBHFJCJPP>k__BackingField;    // 0x0x38
    public ObscuredInt <OJNIMFCFIBM>k__BackingField;    // 0x0x40
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x58
    public string <DLAMMGCMEDK>k__BackingField;    // 0x0x60
    public string <AKJICMANMAC>k__BackingField;    // 0x0x68
    public int <KOCKIALLJFH>k__BackingField;    // 0x0x70
    public EJAIMKODDOJ <KJEJGNOFIHA>k__BackingField;    // 0x0x74
    public DateTime <JCODLMCJPOF>k__BackingField;    // 0x0x78
    public DateTime <PLLMKFGPCIA>k__BackingField;    // 0x0x80
    public DateTime? <NECKJFGFFEP>k__BackingField;    // 0x0x88
    public long? <CCDGDLMEKOI>k__BackingField;    // 0x0x98
    public int <CDMLMBCHGFB>k__BackingField;    // 0x0xA8
    public int <NLPEBHGALCO>k__BackingField;    // 0x0xAC
    public int <DDFLOPPKFKB>k__BackingField;    // 0x0xB0
    public EOLKHIKCLOK <AHNAAMLONHH>k__BackingField;    // 0x0xB4
    public EOLKHIKCLOK <HLEDAHEHGPE>k__BackingField;    // 0x0xB8
    public ObscuredBool <CDJAMOKHKKF>k__BackingField;    // 0x0xBC
    public ObscuredBool <ENLNCIILOFH>k__BackingField;    // 0x0xC8
    public ObscuredBool <GFOBFMNHJBM>k__BackingField;    // 0x0xD4
    public int? <LBFMPLLEDFC>k__BackingField;    // 0x0xE0
    public bool <DDKDINADBFA>k__BackingField;    // 0x0xE8
}

// --------------------------------------------------------------------------
// BCJAKBIEKKI
//   (not directly referenced by a detected call)
public class BCJAKBIEKKI
{
    public CMOLCBIJANO NLPIDMKFKGL;    // 0x0x10
    public int FEFLLFFFCBO;    // 0x0x14
}
...
public class BDKNGNMBADO : EFPJGGLIGDF
{
    public List<IAIBEANLMCM> <HOEEAFMIGJK>k__BackingField;    // 0x0x98
}
...
public class BEANMMNNBAG
{
    public GJPLKKLABGF <JIPGBGOBGMB>k__BackingField;    // 0x0x10
    public IPIABECNDFO <ANKLLGHLJJF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BENODADIFPC
//   (not directly referenced by a detected call)
public class BENODADIFPC
{
    public int <HAELDBOOAFI>k__BackingField;    // 0x0x10
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x18
    public string <LFCKFHNJOFI>k__BackingField;    // 0x0x20
    public string <DLAMMGCMEDK>k__BackingField;    // 0x0x28
    public string <BMDLPGPMAIN>k__BackingField;    // 0x0x30
    public bool <BPCPMOFOAMO>k__BackingField;    // 0x0x38
    public int <JHEJLKDPGMC>k__BackingField;    // 0x0x3C
    public DKPLLHMEFAM <IGKDNNBCLBK>k__BackingField;    // 0x0x40
    public FGNOMGPHGEC CHBAOBMGGHB;    // 0x0x48
    public FGNOMGPHGEC BLEDMNFINGH;    // 0x0x50
    public FGNOMGPHGEC HNPAEPOKHND;    // 0x0x58
    public HHOINNKLEAH OMNCKPNLLBO;    // 0x0x60
}

// --------------------------------------------------------------------------
// BHKFKIPHFFM
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class BHKFKIPHFFM
{
    public List<EFPJGGLIGDF> <BAJNEFAJPKD>k__BackingField;    // 0x0x10
    public string <BHPFEMADFMO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BIGLLNGIHAI
//   (not directly referenced by a detected call)
public class BIGLLNGIHAI
{
    public Guid <NGCCHEDOBFB>k__BackingField;    // 0x0x10
    public long <NDBIJMBMPAI>k__BackingField;    // 0x0x20
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x28
    public string <DLAMMGCMEDK>k__BackingField;    // 0x0x30
    public string <AKJICMANMAC>k__BackingField;    // 0x0x38
    public long <LBFMPLLEDFC>k__BackingField;    // 0x0x40
    public Guid? <CPDGPIGODJM>k__BackingField;    // 0x0x48
    public DateTime <JCODLMCJPOF>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// BIHHGDJDOEC
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class BIHHGDJDOEC
{
    public int <PJCHNFOOOLD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BIPNAKDIPAC
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class BIPNAKDIPAC
{
    public List<IAIBEANLMCM> <HOEEAFMIGJK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BJHLBPPNLFI
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class BJHLBPPNLFI
{
    public Dictionary<Guid, HLDNEIGANBH> <JPJCMBMHKLB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BLIHDDOJHLO
// base   : LFEMLMBOIIA`1<CDBHCNMGOKC>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{bHKIGFDAFOO}   [Service.API]
public class BLIHDDOJHLO
{
...
public class BLONCDDLCAD
{
    public JGGIKCNDKDN <IHOEPGOGCLF>k__BackingField;    // 0x0x10
    public ABLGMLNNEAE <MJIOLNJPDFA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BMICILIJINN
//   (not directly referenced by a detected call)
public class BMICILIJINN
{
    public bool <DBDJHEEGHCC>k__BackingField;    // 0x0x10
    public NPIHBEOEJME <POAFGBNLNFM>k__BackingField;    // 0x0x14
    public int <EDNCNHDKNLB>k__BackingField;    // 0x0x18
    public DateTime <JCODLMCJPOF>k__BackingField;    // 0x0x20
}
...
// CCDJJCHGFEG
//   (not directly referenced by a detected call)
public class CCDJJCHGFEG
{
    public Guid <BEJEJJFGKGA>k__BackingField;    // 0x0x10
    public byte <PKJOEHCHOPN>k__BackingField;    // 0x0x20
}
...
public class CEAMNLHJLDP
{
    public List<string> <NNOFBBOPNLH>k__BackingField;    // 0x0x10
    public List<string> <CNPKHJAJIOD>k__BackingField;    // 0x0x18
    public List<string> <KCFBBAAKOJJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CFMLOPCDLFJ
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class CFMLOPCDLFJ
{
    public long <NDBIJMBMPAI>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <EKIHPLPPMFO>k__BackingField;    // 0x0x18
    public BNNFPHOFOMJ <IGOPCJEEAAP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CGCMKCJICCA
//   RESPONSE ?      api/incentivizedreferrals/   [Service.Econ]
public class CGCMKCJICCA
{
    public List<OFCCDIPEJFO> <MFAJBMJDMPB>k__BackingField;    // 0x0x10
    public string <BHPFEMADFMO>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/avatar/v2/{aGMAMFDBLIO}   [Service.Econ]
public class DAKOBJGIILP
{
    public string <FDMFIDHPFNB>k__BackingField;    // 0x0x10
    public string <ENAPJLLOMAH>k__BackingField;    // 0x0x18
    public string <OFHNPOGJDLK>k__BackingField;    // 0x0x20
    public string <JOCIHKLJAGL>k__BackingField;    // 0x0x28
    public string <BPKICDPFJFF>k__BackingField;    // 0x0x30
    public List<CCDJJCHGFEG> <GPJBNIDCDJD>k__BackingField;    // 0x0x38
}
...
// DCNDPGKGMLA
//   (not directly referenced by a detected call)
public class DCNDPGKGMLA
{
    public int <IJACJLADIBL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DEGIAPLDGDH
//   (not directly referenced by a detected call)
public class DEGIAPLDGDH
{
    public KNOCFMAJCEA <LMCKADNKKBL>k__BackingField;    // 0x0x10
    public int <LBFMPLLEDFC>k__BackingField;    // 0x0x14
    public JCJFNDFNIKB <IPJPICENDHH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DGOGCDBEGLC
//   REQUEST  POST   api/avatar/v4/saved/set   [Service.Econ]
public class DGOGCDBEGLC
{
    public int <JHEJLKDPGMC>k__BackingField;    // 0x0x10
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x18
    public string <IKPOMDCBKGE>k__BackingField;    // 0x0x20
    public string <FDMFIDHPFNB>k__BackingField;    // 0x0x28
    public string <ENAPJLLOMAH>k__BackingField;    // 0x0x30
    public string <OFHNPOGJDLK>k__BackingField;    // 0x0x38
    public string <JOCIHKLJAGL>k__BackingField;    // 0x0x40
    public string <BPKICDPFJFF>k__BackingField;    // 0x0x48
    public EJAIMKODDOJ <KJEJGNOFIHA>k__BackingField;    // 0x0x50
    public List<CCDJJCHGFEG> <GPJBNIDCDJD>k__BackingField;    // 0x0x58
}
...
public class DHIGCBHNHJK
{
    public LLEDNDGOELK <NFDOEIAHOKA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DIHKIJNBGHP
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class DIHKIJNBGHP
{
    public int? <IHHHJMLJIFL>k__BackingField;    // 0x0x10
    public string <IMDNDNHFKBI>k__BackingField;    // 0x0x18
    public string <IILGKDDNFGM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DJBBNMLJINI
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class DJBBNMLJINI
{
    public Dictionary<Guid, FEBJOOOEBJL> <AGEJKHAMDMK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DKPLLHMEFAM
//   (not directly referenced by a detected call)
public class DKPLLHMEFAM
{
    // (no instance fields in the metadata dump)
}
...
public class DPOJBJCKNBK
{
    public string <PFHCDIOKFAK>k__BackingField;    // 0x0x10
    public string <BGKINKDNEGI>k__BackingField;    // 0x0x18
    public string <IDAKONIDMLM>k__BackingField;    // 0x0x20
    public string <DLAMMGCMEDK>k__BackingField;    // 0x0x28
    public string <IMDNDNHFKBI>k__BackingField;    // 0x0x30
    public DPFKIHAOJKN <IHOEPGOGCLF>k__BackingField;    // 0x0x38
    public List<string> <KNHCODPKLDP>k__BackingField;    // 0x0x40
    public List<string> <HOEEAFMIGJK>k__BackingField;    // 0x0x48
    public string <PGAGCKENDJL>k__BackingField;    // 0x0x50
    public List<MGDFEDACAMH> <FIBANADHKAK>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// EBFECHEAHDL
//   (not directly referenced by a detected call)
public class EBFECHEAHDL
{
    public int <EMOLKFJAIOL>k__BackingField;    // 0x0x10
}
...
public class EDHPMLAFJLL
{
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x10
    public string <DLAMMGCMEDK>k__BackingField;    // 0x0x18
    public int? <LBFMPLLEDFC>k__BackingField;    // 0x0x20
    public EJAIMKODDOJ? <KJEJGNOFIHA>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// EFPJGGLIGDF
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class EFPJGGLIGDF
{
    public long <DPONDGNEHBP>k__BackingField;    // 0x0x10
    public int <OJNIMFCFIBM>k__BackingField;    // 0x0x18
    public long <NDBIJMBMPAI>k__BackingField;    // 0x0x20
    public long? <GGBEPNJAPNJ>k__BackingField;    // 0x0x28
    public long? <PECOKJOHHNM>k__BackingField;    // 0x0x38
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x48
    public string <DLAMMGCMEDK>k__BackingField;    // 0x0x50
    public string <AKJICMANMAC>k__BackingField;    // 0x0x58
    public DateTime <FNECJAHOJBD>k__BackingField;    // 0x0x60
    public DateTime <IAFPFIBBFPM>k__BackingField;    // 0x0x68
    public int <CJPMNHIAPHG>k__BackingField;    // 0x0x70
    public ACGKHHPOEDK <KJEJGNOFIHA>k__BackingField;    // 0x0x74
    public bool <LIFLGAPCFNE>k__BackingField;    // 0x0x78
    public bool <LOCNNDIAJNA>k__BackingField;    // 0x0x79
    public GAFKGKHBGHP <KDJCILBLIBA>k__BackingField;    // 0x0x7C
    public GAFKGKHBGHP <DPOFEFDANAH>k__BackingField;    // 0x0x80
    public long? <LMMLANNABKA>k__BackingField;    // 0x0x88
}
...
public class FEBJOOOEBJL
{
    public IAPGOBKFOFH <IHOEPGOGCLF>k__BackingField;    // 0x0x10
    public MNCFGEJNMHE <NKLPMHGDMHB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FGBKCHCGGDB
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{eDPPELMHBFA}   [Service.API]
public class FGBKCHCGGDB
{
    public uint <PFHCDIOKFAK>k__BackingField;    // 0x0x10
    public uint? <PIJNMENFPNL>k__BackingField;    // 0x0x14
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x20
    public string <DLAMMGCMEDK>k__BackingField;    // 0x0x28
    public DateTime <EFCAIGDEIDP>k__BackingField;    // 0x0x30
    public DateTime? <AGAJDLGGBLI>k__BackingField;    // 0x0x38
    public bool <EMECEFDCGBC>k__BackingField;    // 0x0x48
    public List<DPOJBJCKNBK> <CFHLKECBOEH>k__BackingField;    // 0x0x50
    public List<string> <HOEEAFMIGJK>k__BackingField;    // 0x0x58
    public int <FNFJKOBJANH>k__BackingField;    // 0x0x60
    public int <LMKDNFLBNGH>k__BackingField;    // 0x0x64
    public int <FBFIIEMCJDC>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FGEEAHALDGM
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Econ]
public class FGEEAHALDGM
{
    public Guid <JNHLGECMCHJ>k__BackingField;    // 0x0x10
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x20
    public string <AKJICMANMAC>k__BackingField;    // 0x0x28
    public DateTime <EHJEEEGONGH>k__BackingField;    // 0x0x30
    public DateTime? <JHCMNKOMGLO>k__BackingField;    // 0x0x38
    public List<NBAOAHIMPGN> <PJIGOKECMBA>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// FMGPAMBOACB
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class FMGPAMBOACB
{
    public int <MKIICHNOHCE>k__BackingField;    // 0x0x10
    public int? <IGJGHIOGMII>k__BackingField;    // 0x0x14
    public string <AMKHOOPHLGH>k__BackingField;    // 0x0x20
    public string <AHOEOPIMNOI>k__BackingField;    // 0x0x28
}
...
public class GALHFKDGCBL
{
    public long <MNKCOIMCPIM>k__BackingField;    // 0x0x10
    public int <FNABKPOBKDL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GJPLKKLABGF
//   (not directly referenced by a detected call)
public class GJPLKKLABGF
{
    public Guid? <JFCAOLPHKKB>k__BackingField;    // 0x0x10
    public Guid <NODNHENJIAM>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// HIEBFPJJBBF
//   (not directly referenced by a detected call)
public class HIEBFPJJBBF
{
    public EFPJGGLIGDF <IEONCPGNJCC>k__BackingField;    // 0x0x10
    public ODFMKCOCLIN <HJADEBJDFIE>k__BackingField;    // 0x0x18
}
...
// base   : KGKPCKCOEAA
//   (not directly referenced by a detected call)
public class HKOKGCHAPKB : KGKPCKCOEAA
{
    public int <FHEHBMAPMNH>k__BackingField;    // 0x0x60
    public List<ILLLPNFCPFJ> <BHMGOPOBIJC>k__BackingField;    // 0x0x68
    public List<ILLLPNFCPFJ> <BJHNIHGJGEI>k__BackingField;    // 0x0x70
    public List<ILLLPNFCPFJ> <KKNNGCDAAPO>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// HKPMENGENNH
//   (not directly referenced by a detected call)
public class HKPMENGENNH
{
    public int <HPOEPIIJPJI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HLDNEIGANBH
//   (not directly referenced by a detected call)
public class HLDNEIGANBH
{
    public int <IAFBHGBBGLN>k__BackingField;    // 0x0x10
    public GJPLKKLABGF <JIPGBGOBGMB>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{dMAOCMDFEBC}   [Service.API]
...
public class IAAHAFPCKOE
{
    public BDKNGNMBADO <IEONCPGNJCC>k__BackingField;    // 0x0x10
    public LLEDNDGOELK <NFDOEIAHOKA>k__BackingField;    // 0x0x18
    public PFOPBFLAIFN <OLBPMOEDKOJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IAIBEANLMCM
//   (not directly referenced by a detected call)
public class IAIBEANLMCM
{
    public string <CEJJBPNFCGJ>k__BackingField;    // 0x0x10
    public LDMHMDHGDJN <BDMHMDAGBMJ>k__BackingField;    // 0x0x18
}
...
// IBMIBHDOMLD
//   (not directly referenced by a detected call)
public class IBMIBHDOMLD
{
    public int <KALNONLCDOH>k__BackingField;    // 0x0x10
    public LLEDNDGOELK <NFDOEIAHOKA>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// IGEMAFOMMOH
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class IGEMAFOMMOH
{
    public List<IBMIBHDOMLD> <LCEAKFNJBGK>k__BackingField;    // 0x0x10
    public LLEDNDGOELK <NFDOEIAHOKA>k__BackingField;    // 0x0x18
}
...
public class ILBIJBCPCKL
{
    public KNOCFMAJCEA <LMCKADNKKBL>k__BackingField;    // 0x0x10
    public JMAMLNEGBIA <HKMCICDLAOP>k__BackingField;    // 0x0x14
    public int <FKCCPJFELLE>k__BackingField;    // 0x0x18
    public int <LNBHACBNOMN>k__BackingField;    // 0x0x1C
    public int <MAMEEOMLKPN>k__BackingField;    // 0x0x20
    public FAOGCLLOEIC <MLFKADELFLE>k__BackingField;    // 0x0x24
    public bool <DAMBAAPOFHM>k__BackingField;    // 0x0x28
    public float <EBNCMAHLHPF>k__BackingField;    // 0x0x2C
    public int <MOPFKONDMPL>k__BackingField;    // 0x0x30
    public bool <PACADDPIMLF>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// ILLLPNFCPFJ
//   (not directly referenced by a detected call)
public class ILLLPNFCPFJ
{
    public bool <FACOECPGEJB>k__BackingField;    // 0x0x10
    public AHPFPOOHAEN <OMJBDPLNLHO>k__BackingField;    // 0x0x18
    public float <DIMAKFAMOIA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IPIABECNDFO
//   (not directly referenced by a detected call)
public class IPIABECNDFO
{
    public long <LBFMPLLEDFC>k__BackingField;    // 0x0x10
    public Guid? <LNLCNEBLFGK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JCJFNDFNIKB
//   (not directly referenced by a detected call)
public class JCJFNDFNIKB
{
    public int <BJBGLNPDMHB>k__BackingField;    // 0x0x10
    public DateTime? <EPDAFPKJLGE>k__BackingField;    // 0x0x18
    public DateTime? <BMHDPBMEACI>k__BackingField;    // 0x0x28
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{aACAHJNFBDP}   [Service.Econ]
public enum JGGIKCNDKDN
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
// --------------------------------------------------------------------------
// JPHDIMMKAJE
// base   : LFEMLMBOIIA`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class JPHDIMMKAJE
{
    // (no instance fields in the metadata dump)
}
...
public class KCBHGIKMBEK
{
    public Dictionary<int, int> <BIJBECFNALM>k__BackingField;    // 0x0x10
    public List<JGMJCEOCHHI> <OAKFNCDONCF>k__BackingField;    // 0x0x18
    public BCJAKBIEKKI[][] <HJPODFCONEH>k__BackingField;    // 0x0x20
    public EBFECHEAHDL <AKKMHCCAAAG>k__BackingField;    // 0x0x28
    public ALEMIKEIADN <MMEKEDBOCPD>k__BackingField;    // 0x0x30
    public HKPMENGENNH <JPOPFADOLFL>k__BackingField;    // 0x0x38
    public DCNDPGKGMLA <EHIJMHAONBG>k__BackingField;    // 0x0x40
    public NDJKLLNIOCF <LFCDNIMEOJD>k__BackingField;    // 0x0x48
    public string <GJLAOHIOEOF>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// KGKPCKCOEAA
//   (not directly referenced by a detected call)
public class KGKPCKCOEAA
{
    public int <ACFEALMJKIG>k__BackingField;    // 0x0x10
    public OCEOKGDHCNN <BDMHMDAGBMJ>k__BackingField;    // 0x0x14
    public List<DEGIAPLDGDH> <DIDLHKKNAPC>k__BackingField;    // 0x0x18
    public List<DEGIAPLDGDH> <AFNLNIKFAPJ>k__BackingField;    // 0x0x20
    public bool <KAMEHOJGOGA>k__BackingField;    // 0x0x28
    public DateTime? <MHPAAFGELKA>k__BackingField;    // 0x0x30
    public DateTime? <FDBHAPOLKMP>k__BackingField;    // 0x0x40
    public DateTime? <EFDAMHJBDMB>k__BackingField;    // 0x0x50
}
...
public class KICJDMLPFNG
{
    public APGCGDJGNAM <IHOEPGOGCLF>k__BackingField;    // 0x0x10
    public BBOHMIBIJKH <EOJHIGJICLO>k__BackingField;    // 0x0x18
    public NEINGIBIDEP <AMPMALFFOII>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KNNGHKAFNOO
//   RESPONSE ?      api/inventions/   [Service.API]
//   RESPONSE GET    api/inventions/v1/personaldetails/{aKPMFFOKIBA}   [Service.API]
public class KNNGHKAFNOO
{
    public bool <KLIPLEOCECG>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{hIKJFKJCFAJ}   [Service.Econ]
public class LEOBDCKDALJ
{
    public IAPGOBKFOFH <IHOEPGOGCLF>k__BackingField;    // 0x0x10
    public BIGLLNGIHAI <CLHINGCCDCH>k__BackingField;    // 0x0x18
}
...
public class LLGNBIPJDDN
{
    public EFDJDJAABCN <HKEIMDEEEBB>k__BackingField;    // 0x0x10
    public int <PJCHNFOOOLD>k__BackingField;    // 0x0x14
    public long <LHHFFOOIDJN>k__BackingField;    // 0x0x18
    public bool <FHFCAFKIMOH>k__BackingField;    // 0x0x20
    public string <GDHIMEFINFJ>k__BackingField;    // 0x0x28
    public int? <MDANAABIAKA>k__BackingField;    // 0x0x30
    public bool <CGMMODGBMEB>k__BackingField;    // 0x0x38
    public bool <FDIKGHDPLMO>k__BackingField;    // 0x0x39
    public bool <DJJPCGMBIDI>k__BackingField;    // 0x0x3A
    public bool <CAFGLOEBFAK>k__BackingField;    // 0x0x3B
    public string <DAKEOIAJPAA>k__BackingField;    // 0x0x40
    public DateTime? <GLPHMEGPMHO>k__BackingField;    // 0x0x48
    public float <MBNABAFCBAL>k__BackingField;    // 0x0x58
}
...
// base   : PHIIDAOMAAO
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{oDDDDNGJFJC}   [Service.Econ]
public class LMGCNHADIBC : PHIIDAOMAAO
{
    public int <BGPBEJFBLAA>k__BackingField;    // 0x0x30
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x38
    public DateTime <EHJEEEGONGH>k__BackingField;    // 0x0x40
    public DateTime <FJFGPHBIELM>k__BackingField;    // 0x0x48
    public KNOCFMAJCEA <LMCKADNKKBL>k__BackingField;    // 0x0x50
    public KGKPCKCOEAA <LCPGOGDKOIB>k__BackingField;    // 0x0x58
    public List<HKOKGCHAPKB> <KLLEIKNJBMG>k__BackingField;    // 0x0x60
    public BMICILIJINN <AMECMBMBIOO>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// MCOIOECEHDG
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{aGMAMFDBLIO}   [Service.API]
public class MCOIOECEHDG
{
    public List<EFPJGGLIGDF> <EPOIJGILJHH>k__BackingField;    // 0x0x10
    public List<HIEBFPJJBBF> <NICENDOBPFI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MGDFEDACAMH
//   (not directly referenced by a detected call)
public class MGDFEDACAMH
{
    public DateTime <PLLMKFGPCIA>k__BackingField;    // 0x0x10
    public string <HKMAPLGLCMB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MICEFJILOOK
//   REQUEST  PUT    api/avatar/v4/saved/name   [Service.Econ]
public class MICEFJILOOK
{
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x10
    public int <JHEJLKDPGMC>k__BackingField;    // 0x0x18
}
...
public class MJGBNBJLFKO
{
    public int <HNMLJDGPNBL>k__BackingField;    // 0x0x10
    public int <CKNDEIMLOLH>k__BackingField;    // 0x0x14
    public float <MEEHECCKDIK>k__BackingField;    // 0x0x18
    public float <FFPPOOBHOCK>k__BackingField;    // 0x0x1C
    public bool <HOHBGGFEIHE>k__BackingField;    // 0x0x20
    public bool <JKFBOPMEHIF>k__BackingField;    // 0x0x21
    public bool <KPIEENKNEOG>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// MNCFGEJNMHE
//   (not directly referenced by a detected call)
public class MNCFGEJNMHE
{
    public Guid <NGCCHEDOBFB>k__BackingField;    // 0x0x10
    public int <FNABKPOBKDL>k__BackingField;    // 0x0x20
    public int <KAJLGDGPBEJ>k__BackingField;    // 0x0x24
    public Guid <GOEJFNPOIBA>k__BackingField;    // 0x0x28
    public DateTime <JCODLMCJPOF>k__BackingField;    // 0x0x38
    public BIGLLNGIHAI <CLHINGCCDCH>k__BackingField;    // 0x0x40
}
...
// NBAOAHIMPGN
//   (not directly referenced by a detected call)
public class NBAOAHIMPGN
{
    public Guid <EIBEMCMAIGA>k__BackingField;    // 0x0x10
    public Guid <FFNIDIJOEGK>k__BackingField;    // 0x0x20
    public DateTime <EHJEEEGONGH>k__BackingField;    // 0x0x30
    public List<AHPFPOOHAEN> <CJDOCMIFALL>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// NDJKLLNIOCF
//   (not directly referenced by a detected call)
public class NDJKLLNIOCF
{
    public float <KOJEACJMMOA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NEINGIBIDEP
//   (not directly referenced by a detected call)
public class NEINGIBIDEP
{
    public long <EAIMPDJNEJC>k__BackingField;    // 0x0x10
    public string <KNCBHFJCJPP>k__BackingField;    // 0x0x18
    public int <CEMGKDIAKGL>k__BackingField;    // 0x0x20
    public int <KFAAEIOOKNE>k__BackingField;    // 0x0x24
    public int <BAEAICELALG>k__BackingField;    // 0x0x28
    public int <LPINPHNMDFN>k__BackingField;    // 0x0x2C
    public int <PCKNIHJEBLM>k__BackingField;    // 0x0x30
    public string <AKGEHEEFIAF>k__BackingField;    // 0x0x38
    public string <NJNPBKJMNKM>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// NELBOBMNELJ
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class NELBOBMNELJ
{
    public bool <HKMKGEIDHIG>k__BackingField;    // 0x0x10
    public string <BGKINKDNEGI>k__BackingField;    // 0x0x18
    public string <LLMNNOJPJEL>k__BackingField;    // 0x0x20
}
...
public class NOHFMJLJBMM
{
    public int <PPNHHFEPBHK>k__BackingField;    // 0x0x10
    public HCJNPIIOJPI <BDMHMDAGBMJ>k__BackingField;    // 0x0x14
    public AGPKOCPCBHH <ECACBANPKJI>k__BackingField;    // 0x0x18
    public AGPKOCPCBHH <CEPEHJJPHOJ>k__BackingField;    // 0x0x1C
    public AGPKOCPCBHH <OFLMGIFILNB>k__BackingField;    // 0x0x20
}
...
public class NPBHAGDMLCC
{
    public bool <MBHKCHMCLBF>k__BackingField;    // 0x0x10
    public string <GDHIMEFINFJ>k__BackingField;    // 0x0x18
}
...
// base   : KGKPCKCOEAA
//   (not directly referenced by a detected call)
public class NPJEOEOIJJE : KGKPCKCOEAA
{
    public AHPFPOOHAEN <OMJBDPLNLHO>k__BackingField;    // 0x0x60
}
...
// ODFMKCOCLIN
//   (not directly referenced by a detected call)
public class ODFMKCOCLIN
{
    public long <INHEGIDJAIP>k__BackingField;    // 0x0x10
    public long <DPONDGNEHBP>k__BackingField;    // 0x0x18
    public int <BMJLABNGHJG>k__BackingField;    // 0x0x20
    public DateTime <PLLMKFGPCIA>k__BackingField;    // 0x0x28
    public CHHPGGCLBAC <BDMHMDAGBMJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// OEIHFMNFPKO
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class OEIHFMNFPKO
{
    public List<int> <HMMIHOAECNH>k__BackingField;    // 0x0x10
    public string <BHPFEMADFMO>k__BackingField;    // 0x0x18
}
...
public class OEOKHDADDIF
{
    public int <MJAMKMLLIFH>k__BackingField;    // 0x0x10
    public string <AMIFHFPFOIF>k__BackingField;    // 0x0x18
    public List<BENODADIFPC> <CFCKHPNOCFJ>k__BackingField;    // 0x0x20
    public PGAOGLAJJGM <LNJGBDJADKN>k__BackingField;    // 0x0x28
    public string <JJABGLBCEJF>k__BackingField;    // 0x0x30
    public DateTime <EHJEEEGONGH>k__BackingField;    // 0x0x38
    public DateTime <FJFGPHBIELM>k__BackingField;    // 0x0x40
    public DateTime <DDFHPHPAPLP>k__BackingField;    // 0x0x48
    public bool? <JOEDFGNGOPJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// OFCCDIPEJFO
//   (not directly referenced by a detected call)
public class OFCCDIPEJFO
{
    public int <HCBMOLKIIEE>k__BackingField;    // 0x0x10
    public DateTime <PLLMKFGPCIA>k__BackingField;    // 0x0x18
    public DateTime? <COMCDBBOKCJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OHEEPIDINBA
//   RESPONSE GET    api/config/v1/amplitude   [Service.API]
public class OHEEPIDINBA
{
    public string <DBJDJIILDJM>k__BackingField;    // 0x0x10
    public string <IAFFPLNEBEM>k__BackingField;    // 0x0x18
    public bool <AMIEIMHLOBE>k__BackingField;    // 0x0x20
    public string <LLCPDBCEFLD>k__BackingField;    // 0x0x28
}
...
public class OPFODFHLEPN : LMCFGNAGFOM
{
    public EIFPLNJBECL? <LOLFANECGFE>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <BOONJEPJCJD>k__BackingField;    // 0x0x20
}
...
public class PCNIGLJHEPE : LMCFGNAGFOM
{
    public DBHCOEGOOHJ? <LOLFANECGFE>k__BackingField;    // 0x0x18
    public ANLMGMBHKPO <LKIOJKEHENE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PFOPBFLAIFN
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class PFOPBFLAIFN
{
    public JOJAGEPMLHC <NFDOEIAHOKA>k__BackingField;    // 0x0x10
    public List<string> <HOEEAFMIGJK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PGAOGLAJJGM
//   (not directly referenced by a detected call)
public class PGAOGLAJJGM
{
    public long <BHLFMCCOAGF>k__BackingField;    // 0x0x10
    public string <HDFDILAONLA>k__BackingField;    // 0x0x18
    public string <MMIKIJPCEFG>k__BackingField;    // 0x0x20
    public JAIFEOINDJM? <MIOGHAANPGN>k__BackingField;    // 0x0x28
    public string <LGJAAHJEFCI>k__BackingField;    // 0x0x30
    public string <FGOIGHOCNOE>k__BackingField;    // 0x0x38
    public JMGNBFPFIPA <IBCNKOJEPOO>k__BackingField;    // 0x0x40
    public int <POLCLDNJIAE>k__BackingField;    // 0x0x44
    public int <FGNJBAKBMEL>k__BackingField;    // 0x0x48
    public OBGEFKADHEA? <FFKEIPBIADG>k__BackingField;    // 0x0x4C
    public LDBLOONLBHI? <FEHHAFANPDC>k__BackingField;    // 0x0x54
}
...
{
    public long <NDBIJMBMPAI>k__BackingField;    // 0x0x10
    public long? <GGBEPNJAPNJ>k__BackingField;    // 0x0x18
    public LNCLLEGDNJK <BNJEPNNLELB>k__BackingField;    // 0x0x28
}
...
{
    public HFFKLLAFGLH <NFDOEIAHOKA>k__BackingField;    // 0x0x10
    public string <EENBBHKJBCK>k__BackingField;    // 0x0x18
    public string <CBMDPJFBNJP>k__BackingField;    // 0x0x20
    public string <OFCEKENCKOF>k__BackingField;    // 0x0x28
}
...
{
    public long <DPONDGNEHBP>k__BackingField;    // 0x0x10
    public long? <EKNDKKGMAIE>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public ICBJANMMBPO FilterType;    // 0x0x20
...
{
    public LNCLLEGDNJK <EFDHMFOMGDN>k__BackingField;    // 0x0x10
    public string <NNBBLAAJAAN>k__BackingField;    // 0x0x18
    public int <ONJNLFHEKEP>k__BackingField;    // 0x0x20
    public int <FIMIFINOPFE>k__BackingField;    // 0x0x24
    public string <DIENFICKLMB>k__BackingField;    // 0x0x28
    public string <OMANEOCNBKJ>k__BackingField;    // 0x0x30
}
...
{
    public int <FNABKPOBKDL>k__BackingField;    // 0x0x10
    public Guid <ABKMFOGJAGJ>k__BackingField;    // 0x0x14
    public DateTime <EKHLOGDNGAE>k__BackingField;    // 0x0x28
}
...
{
    public bool <AIDEBEHMNOK>k__BackingField;    // 0x0x10
    public int <EDBKDHBCDCI>k__BackingField;    // 0x0x14
    public bool <EADLCEMNCAN>k__BackingField;    // 0x0x18
}
...
{
    public Guid <ABKMFOGJAGJ>k__BackingField;    // 0x0x10
    public LNCLLEGDNJK <NBNLGDEDGLD>k__BackingField;    // 0x0x20
    public int <MPPFGABMPDJ>k__BackingField;    // 0x0x24
    public long <NDBIJMBMPAI>k__BackingField;    // 0x0x28
    public long? <GGBEPNJAPNJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{jEBGGHOLKHJ}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <PNCDCJGBOIJ>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <MBMIIBGMOLA>k__BackingField;    // 0x0x18
}
...
{
    public long <EMIMEENPFGD>k__BackingField;    // 0x0x10
    public long <NDBIJMBMPAI>k__BackingField;    // 0x0x18
    public long <HMICIGKIIMI>k__BackingField;    // 0x0x20
    public HEOEDEOKAAF <BDMHMDAGBMJ>k__BackingField;    // 0x0x28
    public int <CCBPDDGCKPF>k__BackingField;    // 0x0x2C
}
...
{
    public long <NDBIJMBMPAI>k__BackingField;    // 0x0x10
    public List<Guid> <AOHPPPABIPG>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <PNCDCJGBOIJ>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <MBMIIBGMOLA>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <EMIJCFFINKP>k__BackingField;    // 0x0x20
}
...
{
    public long <HMICIGKIIMI>k__BackingField;    // 0x0x10
    public long <BBIJPOACKKN>k__BackingField;    // 0x0x18
    public int? <OJMLAKHCHEL>k__BackingField;    // 0x0x20
    public int? <NPHNNNBCJOF>k__BackingField;    // 0x0x28
    public long? <LJCEMCDEKHK>k__BackingField;    // 0x0x30
    public long <AIHKBKLJDGH>k__BackingField;    // 0x0x40
    public long <IFJIHOBDNKH>k__BackingField;    // 0x0x48
    public int <JPMANDIHCMO>k__BackingField;    // 0x0x50
    public HEOEDEOKAAF <MIDAHBJOCED>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <BFGBICHKCNE>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public OBGEFKADHEA <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public AOGHFIIJPGK creatorAccountRole;    // 0x0x58
}
...
{
    public FFCDBPGBNFL <JNLMHMJLCMM>k__BackingField;    // 0x0x10
    public BLKMMJKJBIJ <PDNAMHNIAFG>k__BackingField;    // 0x0x14
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x18
    public string <DLAMMGCMEDK>k__BackingField;    // 0x0x20
    public bool <FAPDGDFCPJN>k__BackingField;    // 0x0x28
}
...
{
    public List<FFCDBPGBNFL> <JAMPKAJLAIA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{dMAOCMDFEBC}   [Service.API]
public class ProgressionEventDTO
{
    public long <BBIJPOACKKN>k__BackingField;    // 0x0x10
    public string <LNABCPHBPHN>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <KKNNGCDAAPO>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <BKPFHKEABCD>k__BackingField;    // 0x0x28
    public DateTime <FNECJAHOJBD>k__BackingField;    // 0x0x30
    public DateTime <IAFPFIBBFPM>k__BackingField;    // 0x0x38
    public DateTime <IGBIMOMNEIL>k__BackingField;    // 0x0x40
    public bool <OICMOABHIOC>k__BackingField;    // 0x0x48
    public int <HAFCABIDLAJ>k__BackingField;    // 0x0x4C
    public float <KKDGNMEMNCK>k__BackingField;    // 0x0x50
    public Guid? <BEOPEJNMGPE>k__BackingField;    // 0x0x54
    public string <NEBGCONJBEC>k__BackingField;    // 0x0x68
    public string <CHGFMCBAOMM>k__BackingField;    // 0x0x70
    public string <HDOPGMBCNBP>k__BackingField;    // 0x0x78
    public string <EINMDEDODMJ>k__BackingField;    // 0x0x80
}
...
{
    public Guid <ENGDGGEKAJH>k__BackingField;    // 0x0x10
    public int <OLCJOMMMLEI>k__BackingField;    // 0x0x20
    public int <DAMGENIPJMK>k__BackingField;    // 0x0x24
    public int <BOHCLGEKEBL>k__BackingField;    // 0x0x28
    public long <JAMDAEGEKNC>k__BackingField;    // 0x0x30
    public long <JBPANOAJECB>k__BackingField;    // 0x0x38
}
...
{
    public int <FNABKPOBKDL>k__BackingField;    // 0x0x10
    public int <POLCLDNJIAE>k__BackingField;    // 0x0x14
    public int <PGICDCMCILG>k__BackingField;    // 0x0x18
    public int <PDPEIJJONAG>k__BackingField;    // 0x0x1C
    public int <FLGGABCEBGC>k__BackingField;    // 0x0x20
    public DateTime? <PFHOACEECAN>k__BackingField;    // 0x0x28
}
...
{
    public long <GGOENGIFIKF>k__BackingField;    // 0x0x10
    public int <BHLFMCCOAGF>k__BackingField;    // 0x0x18
    public string <AKJICMANMAC>k__BackingField;    // 0x0x20
    public int <POLCLDNJIAE>k__BackingField;    // 0x0x28
    public int <NMOHCJECDHP>k__BackingField;    // 0x0x2C
    public bool <CINBNONPDNO>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public BOMPKBHIAAK ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool APIPKLHKIEB;    // 0x0x28
}
...
{
    public GJKAHBKNMAP? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public GJKAHBKNMAP FIILFNFJKJN;  // wrapper
...
{
    public ELODCOFCJAF PADOLPFAJKG;  // wrapper
...
{
    public KILBMHIFLCG FIJCKHKKDCC;  // wrapper
    public int? OLEEOCLIKCD;  // wrapper
...
{
    public EFDJDJAABCN JGNEFOBFPHD;  // wrapper
    public float? MDGKLENCMPO;  // wrapper
...
{
    public DDNJILBOKPB UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public OBGEFKADHEA JFDMKPDIBDL;  // wrapper
    public OBGEFKADHEA? ECHFABEJKHP;  // wrapper
...
{
    public BENODADIFPC LFDCEOOOGKA;  // wrapper
...
{
    public EJAIMKODDOJ AJGAOFPNKCN;  // wrapper
    public OLJOPCMAMGM AJLGMIFFGKM;  // wrapper
    public byte[] ODOLKFILDPO;  // wrapper
    public byte[] GFIMEFEKJCO;  // wrapper
    public Color OPOEPBAFNOG;  // wrapper
...
{
    public List<JEABPICAKCN> FNEKAHHKHIC;  // wrapper
}
...
{
    public PJCKGHABKNI EHDBEMIPKGG;  // wrapper
    public OBGEFKADHEA? KBKLFDKEJLE;  // wrapper
...
{
    public DOLKEECFOAI DPFLLGCBAKF;  // wrapper
...
{
    public BBOHMIBIJKH inventionId;  // wrapper
}
...
// api/inventions/v2/batch  [API GET]
...
// api/keepsakes/{nCDLOEBMMGD}/collect  [API POST]
public class KeepsakesNCDLOEBMMGDCollectRequest
{
    public Guid NCDLOEBMMGD;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> DHCKBGLHNCP;  // wrapper
    public NFHBAIIGMBG FEMKINMMCOI;  // wrapper
    public long? HAMIEGOKEJC;  // wrapper
...
{
    public long? ALJPKGLNJEE;  // wrapper
}
...
{
    public long? KIBMHJEFMKG;  // wrapper
    public long? HJJABAPOCEG;  // wrapper
    public List<string> PHNPHBFADIP;  // wrapper
    public DateTime JINIMOJBGDF;  // wrapper
    public DateTime LMCEDNNCHKG;  // wrapper
    public ACGKHHPOEDK AJGAOFPNKCN;  // wrapper
    public GAFKGKHBGHP INBLDDGGBCL;  // wrapper
    public GAFKGKHBGHP AFPJLKKNFMN;  // wrapper
}
...
{
    public GAFKGKHBGHP INBLDDGGBCL;  // wrapper
    public GAFKGKHBGHP JIHBMNIJJFK;  // wrapper
}
...
{
    public Guid FMDDHGGEHPH;  // wrapper
    public object PurchaseOfferId;  // candidate
    public object RequestedPrice;  // candidate
    public object RequestedAmount;  // candidate
}

// api/roomconsumables/v1/roomConsumable  [Econ PUT]
public class RoomconsumablesV1RoomConsumableRequest
{
    public Guid HIKJFKJCFAJ;  // wrapper
    public Guid? GDNCFDLJNFM;  // wrapper
}

// api/roomconsumables/v1/roomConsumable/{roomconsumableId}/consume  [Econ PUT]
public class RoomconsumablesV1RoomConsumableRoomconsumableIdConsumeRequest
{
    public Guid HIKJFKJCFAJ;  // wrapper
    public Guid? MMAPFAOGADK;  // wrapper
}

// api/roomcurrencies/v1/awardCurrency/bulk  [Econ POST]
public class RoomcurrenciesV1AwardCurrencyBulkRequest
{
    public List<KIHCNBIKDKC> FBFJDJOLOAA;  // wrapper
}
...
{
    public Guid GDNCFDLJNFM;  // wrapper
    public long? BOFKKMOCJDN;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Limit;  // candidate
...
{
    public Guid FMDDHGGEHPH;  // wrapper
    public long? BIGOLAIOAAK;  // wrapper
    public long? BPEHCJPHLAG;  // wrapper
    public int? JKKDJFGIECI;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
// api/roomcurrencies/v1/{roomCurrencyId}/setBalance  [Econ POST]
public class RoomcurrenciesV1RoomCurrencyIdSetBalanceRequest
{
    public Guid GDNCFDLJNFM;  // wrapper
}
...
{
    public IEnumerable<KeyValuePair<string, string>> DAKKAABHBLK;  // wrapper
...
{
    public IEnumerable<DGCMFJNAOGA> JODCKCBIDAP;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public NLAKFAOKIGM FIJCKHKKDCC;  // wrapper
    public Guid? KEKFLLNDNGK;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public EFDJDJAABCN JGNEFOBFPHD;  // wrapper
    public long? PDIAPGPLDKM;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats GNDODLKLFMC;  // wrapper
}
...
{
    public Guid LIGDFJJAGDE;  // wrapper
...
{
    public Guid PPIEKBBOJFL;  // wrapper
...
{
    public List<KFFOFAJMIAO> JLEIOECLKNG;  // wrapper
    public object roomId;  // candidate
...
{
    public DPFKIHAOJKN ODCOOPJBGOM;  // wrapper
}
