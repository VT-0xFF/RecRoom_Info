...
public class AGNOJPGPMHD
{
    public List<int> <KMPFHDIFIPO>k__BackingField;    // 0x0x10
    public string <BKALDIOCEEM>k__BackingField;    // 0x0x18
}
...
public class AGPHDPAGKMJ
{
    public HFOAANCEOPH <COAGFCKEKGK>k__BackingField;    // 0x0x10
}
...
// AOKEPNDBFLH
//   (not directly referenced by a detected call)
public class AOKEPNDBFLH
{
    public int <KBCLHNMEBGC>k__BackingField;    // 0x0x10
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x18
    public string <KMAJOJABHBB>k__BackingField;    // 0x0x20
    public string <MMFPFAALGMD>k__BackingField;    // 0x0x28
    public string <CMPHKHBKIMH>k__BackingField;    // 0x0x30
    public bool <OOONCHOKDNO>k__BackingField;    // 0x0x38
    public int <EFLJDBPNPHG>k__BackingField;    // 0x0x3C
    public MDBBENELJND <DDANLOHEHKK>k__BackingField;    // 0x0x40
    public CGINLJLBDBF EJNBMNPMAMM;    // 0x0x48
    public CGINLJLBDBF GOEOPPPNAGJ;    // 0x0x50
    public CGINLJLBDBF JLDCLICAFMD;    // 0x0x58
    public GKMPCNJDCLO PKAJIPKDAHJ;    // 0x0x60
}

// --------------------------------------------------------------------------
// AOMAICEADIM
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class AOMAICEADIM
{
    public long <BKDFEMHKIEP>k__BackingField;    // 0x0x10
    public int <LOFLIJAMAHM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BBEGJLCJBDG
//   (not directly referenced by a detected call)
public class BBEGJLCJBDG
{
    public int <IJHHFGODOMC>k__BackingField;    // 0x0x10
    public string <ODOMCPMOENA>k__BackingField;    // 0x0x18
    public string <CMPHKHBKIMH>k__BackingField;    // 0x0x20
    public string <HNGNMLOEHKB>k__BackingField;    // 0x0x28
    public string <LHPIJFNMCPP>k__BackingField;    // 0x0x30
    public string <MNPNPCFDDPP>k__BackingField;    // 0x0x38
    public LGFCBDFPHME? <PJBOHAFDKIJ>k__BackingField;    // 0x0x40
    public string <IDEEPAOMEFP>k__BackingField;    // 0x0x48
    public string <JPCKMEHBICM>k__BackingField;    // 0x0x50
    public bool <GMDFOPLFMLF>k__BackingField;    // 0x0x58
    public bool <NALNCBBGNJN>k__BackingField;    // 0x0x59
    public bool <IALMKPOLOLH>k__BackingField;    // 0x0x5A
    public GOKMIAEEEEK <BAEOFMFLBDG>k__BackingField;    // 0x0x5C
    public int <CKDFNIMEGPD>k__BackingField;    // 0x0x60
    public OHPIJKAGIOB <KCNGFEGPGGK>k__BackingField;    // 0x0x64
    public int <HGNHMDHJEIK>k__BackingField;    // 0x0x68
    public FAEKPODGCGG <FCDBMIHHDHG>k__BackingField;    // 0x0x6C
    public LHOIMHGEGHD <OEDOCOOAHOD>k__BackingField;    // 0x0x70
    public int? <IKCLBMCLLAK>k__BackingField;    // 0x0x74
    public string <ONIGLHBFFCA>k__BackingField;    // 0x0x80
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{hKPKBLDCKAJ}   [Service.Econ]
public enum BGJKCHIAKOB
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
// BHHOCOPHCIC
//   (not directly referenced by a detected call)
public class BHHOCOPHCIC
{
    public Guid <KHBLDJAFLPB>k__BackingField;    // 0x0x10
    public Guid <DIHLBINGIGG>k__BackingField;    // 0x0x20
    public DateTime <IMAAONFCLDM>k__BackingField;    // 0x0x30
    public List<BBEGJLCJBDG> <BAPHLADKENA>k__BackingField;    // 0x0x38
}
...
public class BJBIMIAMOHD
{
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x10
    public string <MMFPFAALGMD>k__BackingField;    // 0x0x18
    public int? <DHFFIJJFAGI>k__BackingField;    // 0x0x20
    public NNNKPFANIIO? <BOBMJLDNLIB>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// BLKBEEGOLLP
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class BLKBEEGOLLP
{
    public int <LOFLIJAMAHM>k__BackingField;    // 0x0x10
    public Guid <DLEONLFIINL>k__BackingField;    // 0x0x14
    public long <AJHILLGHHIJ>k__BackingField;    // 0x0x28
    public DateTime <CNENFBIJHGO>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// BMLFPFGEPHN
//   (not directly referenced by a detected call)
public class BMLFPFGEPHN
{
    public int <FOFGBNOPHDI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BOINAKJFJFE
//   (not directly referenced by a detected call)
public class BOINAKJFJFE
{
    public BICDCONMJBN KCJIIEHEKKO;    // 0x0x10
    public int GJGGIJMOMDL;    // 0x0x14
}
...
// CCKNOILOGPM
//   (not directly referenced by a detected call)
public class CCKNOILOGPM
{
    public Guid <GMMPNNAGJJF>k__BackingField;    // 0x0x10
    public long <OAGLNMDIOKI>k__BackingField;    // 0x0x20
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x28
    public string <MMFPFAALGMD>k__BackingField;    // 0x0x30
    public string <HCPIIBNHHBC>k__BackingField;    // 0x0x38
    public long <DHFFIJJFAGI>k__BackingField;    // 0x0x40
    public Guid? <DGEGDGPCFHP>k__BackingField;    // 0x0x48
    public DateTime <CNENFBIJHGO>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// CDDNCOMKJMA
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class CDDNCOMKJMA
{
    public DKNDKDAIPLI <ODNFHGDAIOE>k__BackingField;    // 0x0x10
    public int <GOAEBLIPNDP>k__BackingField;    // 0x0x14
    public long <LLJLHEHEKDJ>k__BackingField;    // 0x0x18
    public bool <PDKKOCPHOLM>k__BackingField;    // 0x0x20
    public string <MPJECNCAJHA>k__BackingField;    // 0x0x28
    public int? <GOKOMHGGOKG>k__BackingField;    // 0x0x30
    public bool <EBJACGJONBJ>k__BackingField;    // 0x0x38
    public bool <IDHHFGJPFPM>k__BackingField;    // 0x0x39
    public bool <KMCELGLPKBE>k__BackingField;    // 0x0x3A
    public bool <DNMCCIEGGLB>k__BackingField;    // 0x0x3B
    public string <PPNIPMEEGPI>k__BackingField;    // 0x0x40
    public DateTime? <NPHMDPBKHPB>k__BackingField;    // 0x0x48
    public float <KBCGEOOENBI>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// CDMJMIBCNKJ
//   (not directly referenced by a detected call)
public class CDMJMIBCNKJ
{
    public bool <OKDFPEBAFEH>k__BackingField;    // 0x0x10
    public FKOPJAAPDDD <HALNLKNPDFE>k__BackingField;    // 0x0x14
    public int <ALHDDNAKGBG>k__BackingField;    // 0x0x18
    public DateTime <CNENFBIJHGO>k__BackingField;    // 0x0x20
}
...
public class CHMFEIJDBKE
{
    public int <IDKMIFEIJDG>k__BackingField;    // 0x0x10
    public int <KFONBHEEMJA>k__BackingField;    // 0x0x14
    public float <KFGMAACDPHB>k__BackingField;    // 0x0x18
    public float <OHPLHKMPEJG>k__BackingField;    // 0x0x1C
    public bool <JLMPEIIIHNE>k__BackingField;    // 0x0x20
    public bool <FFMPCDIHMEE>k__BackingField;    // 0x0x21
    public bool <AHDPGPLFENE>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// CIOMKGDCJMG
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Econ]
public class CIOMKGDCJMG
{
    public Guid <NJCPPFLNBON>k__BackingField;    // 0x0x10
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x20
    public string <HCPIIBNHHBC>k__BackingField;    // 0x0x28
    public DateTime <IMAAONFCLDM>k__BackingField;    // 0x0x30
    public DateTime? <ICHILKENMBA>k__BackingField;    // 0x0x38
    public List<BHHOCOPHCIC> <BPMHNEGCBNG>k__BackingField;    // 0x0x48
}
...
public class DFNGBBLKKGN
{
    public long <GNIEJANJPDO>k__BackingField;    // 0x0x10
    public int <CCEBHIKPNFN>k__BackingField;    // 0x0x18
    public long <OAGLNMDIOKI>k__BackingField;    // 0x0x20
    public long? <MOOKOFHENAA>k__BackingField;    // 0x0x28
    public long? <HIKHPEIKCBG>k__BackingField;    // 0x0x38
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x48
    public string <MMFPFAALGMD>k__BackingField;    // 0x0x50
    public string <HCPIIBNHHBC>k__BackingField;    // 0x0x58
    public DateTime <MIJCGPHFGPC>k__BackingField;    // 0x0x60
    public DateTime <JBFFMBHDMEM>k__BackingField;    // 0x0x68
    public int <BANODIINBGL>k__BackingField;    // 0x0x70
    public MNJFJMAJHBI <BOBMJLDNLIB>k__BackingField;    // 0x0x74
    public bool <GDPLOMGFEHA>k__BackingField;    // 0x0x78
    public bool <LDNKDMAJEDC>k__BackingField;    // 0x0x79
    public GGFLHJIAHKM <EBFMMMHDLFC>k__BackingField;    // 0x0x7C
    public GGFLHJIAHKM <AAIFPAPPBGE>k__BackingField;    // 0x0x80
    public long? <AEHMPNCDPCI>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// DJFHJIDLOEO
//   (not directly referenced by a detected call)
public class DJFHJIDLOEO
{
    public bool <DCOMCFGMMDD>k__BackingField;    // 0x0x10
    public BBEGJLCJBDG <HIILPDGHDIP>k__BackingField;    // 0x0x18
    public float <JPGJIJHALKD>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/keepsakes/{lMKJBONLEIO}   [Service.API]
...
public class DJIDCMLEPBE
{
    public bool <GCNKJPMDPHM>k__BackingField;    // 0x0x10
    public string <LIOEJACOANF>k__BackingField;    // 0x0x18
}
...
public class EABMHPODKOA : KLHOIAKGFJK
{
    public DCJLBOOGPKI? <EMACJICOEPH>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <LBGOBDIHDJG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EBIJIFLHLHP
//   RESPONSE ?      api/inventions/   [Service.API]
//   RESPONSE GET    api/inventions/v1/personaldetails/{oCLGJFEOJMC}   [Service.API]
public class EBIJIFLHLHP
{
    public bool <HMDKGHECFJL>k__BackingField;    // 0x0x10
}
...
public class EBMIFHJIBCA
{
    public AAADDBNDCLG <ODNFHGDAIOE>k__BackingField;    // 0x0x10
    public string <MFDABPCGABI>k__BackingField;    // 0x0x18
    public int? <MKCLLOFIKND>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EHLEHIELPDJ
//   (not directly referenced by a detected call)
public class EHLEHIELPDJ
{
    public int <DLIEOMEPNMA>k__BackingField;    // 0x0x10
    public JLNMLEBEHIF <PNNPKBHHIIE>k__BackingField;    // 0x0x14
    public List<EKMIEALCKGH> <LMHCANKHHIJ>k__BackingField;    // 0x0x18
    public List<EKMIEALCKGH> <JEEALMIHLJO>k__BackingField;    // 0x0x20
    public bool <PBNKHFCILKI>k__BackingField;    // 0x0x28
    public DateTime? <LJBALMNNKGI>k__BackingField;    // 0x0x30
    public DateTime? <JIFCLOIJHMK>k__BackingField;    // 0x0x40
    public DateTime? <CEGPDMLAFNF>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// EIKMPCKMIAA
//   (not directly referenced by a detected call)
public class EIKMPCKMIAA
{
    public ObscuredLong <NCBBFACCNDD>k__BackingField;    // 0x0x10
    public string <PFLAJMPACPN>k__BackingField;    // 0x0x38
    public ObscuredInt <CCEBHIKPNFN>k__BackingField;    // 0x0x40
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x58
    public string <MMFPFAALGMD>k__BackingField;    // 0x0x60
    public string <HCPIIBNHHBC>k__BackingField;    // 0x0x68
    public int <HDKAGEFMHEO>k__BackingField;    // 0x0x70
    public NNNKPFANIIO <BOBMJLDNLIB>k__BackingField;    // 0x0x74
    public DateTime <CNENFBIJHGO>k__BackingField;    // 0x0x78
    public DateTime <FLPBMAGCOHH>k__BackingField;    // 0x0x80
    public DateTime? <FCANEEMBOKD>k__BackingField;    // 0x0x88
    public long? <OMKDGBABLIG>k__BackingField;    // 0x0x98
    public int <NMPCNFLPFLB>k__BackingField;    // 0x0xA8
    public int <ANEHEIJPBGO>k__BackingField;    // 0x0xAC
    public int <DNBNAFOBNLK>k__BackingField;    // 0x0xB0
    public AOEOFIIEFIG <GBAGLFDMLKJ>k__BackingField;    // 0x0xB4
    public AOEOFIIEFIG <IICKLAHIAKM>k__BackingField;    // 0x0xB8
    public ObscuredBool <JIIOMOEMNJM>k__BackingField;    // 0x0xBC
    public ObscuredBool <NDDKAHGPMGA>k__BackingField;    // 0x0xC8
    public ObscuredBool <NBFLDMJBKJA>k__BackingField;    // 0x0xD4
    public int? <DHFFIJJFAGI>k__BackingField;    // 0x0xE0
    public bool <FHLBJFKLGPH>k__BackingField;    // 0x0xE8
}
...
// EKMIEALCKGH
//   (not directly referenced by a detected call)
public class EKMIEALCKGH
{
    public OHPIJKAGIOB <KCNGFEGPGGK>k__BackingField;    // 0x0x10
    public int <DHFFIJJFAGI>k__BackingField;    // 0x0x14
    public OGKHNBMAKAE <HOKCMCLLLCE>k__BackingField;    // 0x0x18
}
...
public class EMONKJINMFM
{
    public Guid? <NMLKHLBDMHH>k__BackingField;    // 0x0x10
    public Guid <ADNKMLOAGIJ>k__BackingField;    // 0x0x24
}
...
// FBHAHLKLHLN
//   (not directly referenced by a detected call)
public class FBHAHLKLHLN
{
    public long <BKDFEMHKIEP>k__BackingField;    // 0x0x10
    public Guid <PFLAJMPACPN>k__BackingField;    // 0x0x18
    public long <OAGLNMDIOKI>k__BackingField;    // 0x0x28
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x30
    public string <MMFPFAALGMD>k__BackingField;    // 0x0x38
    public int <DHFFIJJFAGI>k__BackingField;    // 0x0x40
    public Guid? <DGEGDGPCFHP>k__BackingField;    // 0x0x44
    public DateTime <FLPBMAGCOHH>k__BackingField;    // 0x0x58
    public string <HCPIIBNHHBC>k__BackingField;    // 0x0x60
    public DDLDMKEMNIO <PNNPKBHHIIE>k__BackingField;    // 0x0x68
}
...
public class FKMBCJPOBLB : KLHOIAKGFJK
{
    public JHEFMKHAGOH? <EMACJICOEPH>k__BackingField;    // 0x0x18
    public BLKBEEGOLLP <ABDGKAODOKH>k__BackingField;    // 0x0x20
}
...
//   RESPONSE GET    api/storefronts/v1/season/{eCBKENGLICA}   [Service.Econ]
public class FLDKGEAHHOE : GCENCEJOJBI
{
    public int <HFMECCIDANO>k__BackingField;    // 0x0x30
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x38
    public DateTime <IMAAONFCLDM>k__BackingField;    // 0x0x40
    public DateTime <MBHMIKDDFBD>k__BackingField;    // 0x0x48
    public OHPIJKAGIOB <KCNGFEGPGGK>k__BackingField;    // 0x0x50
    public EHLEHIELPDJ <KDNEEKLJMJG>k__BackingField;    // 0x0x58
    public List<POFEJKAJDIO> <JMFGMDNCJAF>k__BackingField;    // 0x0x60
    public CDMJMIBCNKJ <ABNPLNAKFNP>k__BackingField;    // 0x0x68
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{cNPBBHOEDKJ}   [Service.Econ]
public class FPDPMHGNLJB
{
    public FIJLFHHGGCL <AFNAMBMFPLM>k__BackingField;    // 0x0x10
    public CCKNOILOGPM <LJJPJOKKBAL>k__BackingField;    // 0x0x18
}
...
public class GDCKKHMLBAF
{
    public List<KAONFEHHBDG> <CKKGLMADBIN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GDFKPCEFOII
//   (not directly referenced by a detected call)
public class GDFKPCEFOII
{
    public long <DHFFIJJFAGI>k__BackingField;    // 0x0x10
    public Guid? <DLEONLFIINL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GEMIEENEIHE
//   (not directly referenced by a detected call)
public class GEMIEENEIHE
{
    public long <LHCIAPAJEAP>k__BackingField;    // 0x0x10
    public long <GNIEJANJPDO>k__BackingField;    // 0x0x18
    public int <FFPAGDKCNOA>k__BackingField;    // 0x0x20
    public DateTime <FLPBMAGCOHH>k__BackingField;    // 0x0x28
    public HNCOKMDCPFH <PNNPKBHHIIE>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GFJCJNLPNAO
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.Econ]
public class GFJCJNLPNAO
{
    public int <JMHNEFONFGM>k__BackingField;    // 0x0x10
    public string <AIFAOALKDFP>k__BackingField;    // 0x0x18
    public List<AOKEPNDBFLH> <ICCEFPAIJDN>k__BackingField;    // 0x0x20
    public OBLKICLAEHG <GMMELEPIJEH>k__BackingField;    // 0x0x28
    public string <LDECNGAJBED>k__BackingField;    // 0x0x30
    public DateTime <IMAAONFCLDM>k__BackingField;    // 0x0x38
    public DateTime <MBHMIKDDFBD>k__BackingField;    // 0x0x40
    public DateTime <GOOLPBBJMBH>k__BackingField;    // 0x0x48
    public bool? <AMJOPHHKAGE>k__BackingField;    // 0x0x50
}
...
public class GGPMLJKCNIA
{
    public Guid? <GMMPNNAGJJF>k__BackingField;    // 0x0x10
    public long? <OAGLNMDIOKI>k__BackingField;    // 0x0x28
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x38
    public string <MMFPFAALGMD>k__BackingField;    // 0x0x40
    public string <HCPIIBNHHBC>k__BackingField;    // 0x0x48
    public GDFKPCEFOII <IHCOOHKDOGM>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// GHCLMFOCFMC
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class GHCLMFOCFMC
{
    public int? <FDIKIBECGEN>k__BackingField;    // 0x0x10
    public string <IJICLIOFGEC>k__BackingField;    // 0x0x18
    public string <FPPAHMBCIKA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GHPAICGJKCH
//   (not directly referenced by a detected call)
public class GHPAICGJKCH
{
    public Guid <GMMPNNAGJJF>k__BackingField;    // 0x0x10
    public int <LOFLIJAMAHM>k__BackingField;    // 0x0x20
    public int <MEFOKOLMHIF>k__BackingField;    // 0x0x24
    public Guid <KLNDILJAPDM>k__BackingField;    // 0x0x28
    public DateTime <CNENFBIJHGO>k__BackingField;    // 0x0x38
    public CCKNOILOGPM <LJJPJOKKBAL>k__BackingField;    // 0x0x40
}
...
public class GKGPEPBPKPK
{
    public int <KFONBHEEMJA>k__BackingField;    // 0x0x10
    public bool <JLMPEIIIHNE>k__BackingField;    // 0x0x14
    public DateTime <JJHLKKDNGLJ>k__BackingField;    // 0x0x18
    public bool <MMODCOCEOIG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GMLCJHBCHBD
// base   : MPNALOFPFFK`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class GMLCJHBCHBD
{
    // (no instance fields in the metadata dump)
}
...
// base   : EHLEHIELPDJ
//   (not directly referenced by a detected call)
public class HALLPKDOJMP : EHLEHIELPDJ
{
    public BBEGJLCJBDG <HIILPDGHDIP>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// HCFFACBNECI
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class HCFFACBNECI
{
    public List<LBMPHELJMON> <ECANDNGIMOF>k__BackingField;    // 0x0x10
    public string <BKALDIOCEEM>k__BackingField;    // 0x0x18
}
...
public class HDBMOJNKLMC
{
    public List<JFCDKHIPPFG> <KFNBDOPBNEN>k__BackingField;    // 0x0x10
    public HFOAANCEOPH <COAGFCKEKGK>k__BackingField;    // 0x0x18
}
...
public class HFAOKONMNCM
{
    public int <LFOFCFECFHG>k__BackingField;    // 0x0x10
    public DKFPDAIHDKC <PNNPKBHHIIE>k__BackingField;    // 0x0x14
    public CBDIOKMNHLG <MAPPPDPFCKN>k__BackingField;    // 0x0x18
    public CBDIOKMNHLG <HOBPNGBLLFH>k__BackingField;    // 0x0x1C
    public CBDIOKMNHLG <LCHHGOFHMHI>k__BackingField;    // 0x0x20
}
...
public class HGEFPFLHOPJ
{
    public long <OAGLNMDIOKI>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <FHPJOAPFLAJ>k__BackingField;    // 0x0x18
    public KGJDBACLFEO <OKPAJMKHNOE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HHHCLHLKIMD
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class HHHCLHLKIMD
{
    public Dictionary<Guid, IEJNKPIBIAB> <HMMENJBDLLG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HIOOKPIHNJK
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class HIOOKPIHNJK
{
    public bool <HCPKGNIFKMD>k__BackingField;    // 0x0x10
    public string <LGKEOGGMIMA>k__BackingField;    // 0x0x18
    public string <KCOGHLPAHJC>k__BackingField;    // 0x0x20
}
...
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{iACOMDKJFAL}   [Service.API]
public class HPIJDFMGOKA
{
    public uint <GDGLOPJKJJM>k__BackingField;    // 0x0x10
    public uint? <GMNFFEEKCPJ>k__BackingField;    // 0x0x14
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x20
    public string <MMFPFAALGMD>k__BackingField;    // 0x0x28
    public DateTime <OHBJAFJGKGI>k__BackingField;    // 0x0x30
    public DateTime? <ODMOHGLFBJH>k__BackingField;    // 0x0x38
    public bool <DLBKCKJBEDP>k__BackingField;    // 0x0x48
    public List<PGKFGFCAIMG> <CMGPIGDNOBM>k__BackingField;    // 0x0x50
    public List<string> <CKKGLMADBIN>k__BackingField;    // 0x0x58
    public int <NFPAMBCIAGH>k__BackingField;    // 0x0x60
    public int <HBLKBEGKGNH>k__BackingField;    // 0x0x64
    public int <JOALCNMDOFL>k__BackingField;    // 0x0x68
}
...
public class IDGGMFHNOBD : GCENCEJOJBI
{
    public List<HALLPKDOJMP> FENIAEHPJHD;    // 0x0x30
    public int <EEJAINFAOHC>k__BackingField;    // 0x0x38
}
...
public class IEJNKPIBIAB
{
    public FIJLFHHGGCL <AFNAMBMFPLM>k__BackingField;    // 0x0x10
    public GHPAICGJKCH <IKGBHADOENG>k__BackingField;    // 0x0x18
}
...
public class IGINDKJDEGN
{
    public bool <GCNKJPMDPHM>k__BackingField;    // 0x0x10
    public string <MPJECNCAJHA>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/avatar/v2/{cPBBCPFIMJO}   [Service.Econ]
public class JBOJGCBNAEA
{
    public string <EBCMEIDFFNL>k__BackingField;    // 0x0x10
    public string <FGGHIMKGGFH>k__BackingField;    // 0x0x18
    public string <OHJDPAAPCOI>k__BackingField;    // 0x0x20
    public string <IEHDGNPJHDC>k__BackingField;    // 0x0x28
    public string <CFBHHJAFMCL>k__BackingField;    // 0x0x30
    public List<OCIOLHBKFIC> <GIDDNPJNHLA>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// JCIFJJCGOEF
//   RESPONSE GET    api/config/v1/amplitude   [Service.API]
public class JCIFJJCGOEF
{
    public string <BOPMGJCHDDE>k__BackingField;    // 0x0x10
    public string <JLAAFPKBLKF>k__BackingField;    // 0x0x18
    public bool <NIEMIOMIGAM>k__BackingField;    // 0x0x20
    public string <NEIPFBHPNGM>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// JFCDKHIPPFG
//   (not directly referenced by a detected call)
public class JFCDKHIPPFG
{
    public int <KLABCPLJCNF>k__BackingField;    // 0x0x10
    public HFOAANCEOPH <COAGFCKEKGK>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// JFOOONHBGNF
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class JFOOONHBGNF
{
    public NDAKDGKBGKL <COAGFCKEKGK>k__BackingField;    // 0x0x10
    public List<string> <CKKGLMADBIN>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/playerevents/v1/all/{cPBBCPFIMJO}   [Service.API]
public class JMGCIMEGLGO
{
    public List<DFNGBBLKKGN> <HEELILPGBHJ>k__BackingField;    // 0x0x10
    public List<NMNMPLHCMBB> <AIAHCHFMCED>k__BackingField;    // 0x0x18
}
...
public class JOLKBIODEKE
{
    public IPMFFDHMFLP <AFNAMBMFPLM>k__BackingField;    // 0x0x10
    public EIKMPCKMIAA <PECDLIIJBHA>k__BackingField;    // 0x0x18
    public MINPFJLBCLO <LLIEKJMPONL>k__BackingField;    // 0x0x20
}
...
public class KACOLGJMDEO
{
    public EMONKJINMFM <KLHDOOKOFCJ>k__BackingField;    // 0x0x10
    public GDFKPCEFOII <ABDOMKIIBAF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KAONFEHHBDG
//   (not directly referenced by a detected call)
public class KAONFEHHBDG
{
    public string <HDEFBHEFOLO>k__BackingField;    // 0x0x10
    public NMGENACNCLJ <PNNPKBHHIIE>k__BackingField;    // 0x0x18
}
...
// base   : DFNGBBLKKGN
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class KEJFJFHIFLG : DFNGBBLKKGN
{
    public List<KAONFEHHBDG> <CKKGLMADBIN>k__BackingField;    // 0x0x98
}
...
// KIFIAACKFGI
//   (not directly referenced by a detected call)
public class KIFIAACKFGI
{
    public int <DFDNOOHINLG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LBMPHELJMON
//   (not directly referenced by a detected call)
public class LBMPHELJMON
{
    public int <OIAOMFCAKCL>k__BackingField;    // 0x0x10
    public DateTime <FLPBMAGCOHH>k__BackingField;    // 0x0x18
    public DateTime? <POHIOBOEDFD>k__BackingField;    // 0x0x20
}
...
public class LDEMFKKHAGN
{
    public Guid <OJEADHILMHJ>k__BackingField;    // 0x0x10
    public long <CCBKPKBJHMA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LEFGIBJDOMD
//   RESPONSE GET    api/config/v2   [Service.API]
public class LEFGIBJDOMD
{
    public Dictionary<int, int> <AJFPCEPAMFE>k__BackingField;    // 0x0x10
    public List<GJBPHAMFNOL> <NLBCHOIHCEK>k__BackingField;    // 0x0x18
    public BOINAKJFJFE[][] <HKPEOLJHJFP>k__BackingField;    // 0x0x20
    public KIFIAACKFGI <ENJCLPKKBIM>k__BackingField;    // 0x0x28
    public MKIODAKDFKC <AEEGDPHOGJK>k__BackingField;    // 0x0x30
    public BMLFPFGEPHN <OMBKEDDMPJC>k__BackingField;    // 0x0x38
    public NCHPEJBMHPE <OCBKOHIPLDL>k__BackingField;    // 0x0x40
    public MHIHPOLOEGC <MOPIAAAJICN>k__BackingField;    // 0x0x48
    public string <NKKMLPMKBCI>k__BackingField;    // 0x0x50
}
...
// MCCOHHJHDCH
//   (not directly referenced by a detected call)
public class MCCOHHJHDCH
{
    public DateTime <FLPBMAGCOHH>k__BackingField;    // 0x0x10
    public string <GPAHGEBBNLN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MDBBENELJND
//   (not directly referenced by a detected call)
public class MDBBENELJND
{
    // (no instance fields in the metadata dump)
}
...
// MFFJCNNIBAD
//   (not directly referenced by a detected call)
public class MFFJCNNIBAD
{
    public int <EKCMNJJDONP>k__BackingField;    // 0x0x10
    public EMONKJINMFM <KLHDOOKOFCJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MHIHPOLOEGC
//   (not directly referenced by a detected call)
public class MHIHPOLOEGC
{
    public float <DPLGEDKODCG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// MINPFJLBCLO
//   (not directly referenced by a detected call)
public class MINPFJLBCLO
{
    public long <NCBBFACCNDD>k__BackingField;    // 0x0x10
    public string <PFLAJMPACPN>k__BackingField;    // 0x0x18
    public int <HEJMNGMADLD>k__BackingField;    // 0x0x20
    public int <LGLMMBNDCBH>k__BackingField;    // 0x0x24
    public int <MAHMIOLEKFP>k__BackingField;    // 0x0x28
    public int <IACFNDJDBIH>k__BackingField;    // 0x0x2C
    public int <FNNBKCNJMLF>k__BackingField;    // 0x0x30
    public string <NGCILMGKPBA>k__BackingField;    // 0x0x38
    public string <HHGHPEEMGJG>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// MKIODAKDFKC
//   (not directly referenced by a detected call)
public class MKIODAKDFKC
{
    public float <KJINGOBLODK>k__BackingField;    // 0x0x10
    public float <EFFAOOODJBL>k__BackingField;    // 0x0x14
    public float <DOJDAJMDDNM>k__BackingField;    // 0x0x18
    public float <PCFDPGMFAHN>k__BackingField;    // 0x0x1C
    public float <FJINMEPPKMI>k__BackingField;    // 0x0x20
    public float <MCIMNLMKDMF>k__BackingField;    // 0x0x24
    public float <LKKLFBFINIA>k__BackingField;    // 0x0x28
    public float <KEIAMKPKNDC>k__BackingField;    // 0x0x2C
}
...
public class MNEALFMOLMP
{
    public List<string> <CBMNDGCPNKL>k__BackingField;    // 0x0x10
    public List<string> <EFBLOHJLGCJ>k__BackingField;    // 0x0x18
    public List<string> <JFNBJHHMDIC>k__BackingField;    // 0x0x20
}
...
public class MPILKOBINFE
{
    public Dictionary<Guid, MFFJCNNIBAD> <PHOFHGLMILK>k__BackingField;    // 0x0x10
}
...
// NCHPEJBMHPE
//   (not directly referenced by a detected call)
public class NCHPEJBMHPE
{
    public int <CAMEADDBMID>k__BackingField;    // 0x0x10
}
...
public class NIEDAEEJEPL
{
    public int <DGMFCGFHGCL>k__BackingField;    // 0x0x10
    public int <DDFFJIHMDMK>k__BackingField;    // 0x0x14
    public float <ICEOMGOCDBJ>k__BackingField;    // 0x0x18
    public int <BNCHJIEGBAO>k__BackingField;    // 0x0x1C
    public int <FBHHLELLJIP>k__BackingField;    // 0x0x20
    public int <LODMMGGGCKA>k__BackingField;    // 0x0x24
    public int <GNOEAHIHOBN>k__BackingField;    // 0x0x28
    public string <AGIEFEGEKLE>k__BackingField;    // 0x0x30
    public string <APKEPEHNOBF>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// NJFANAGFNGE
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class NJFANAGFNGE
{
    public int <GOAEBLIPNDP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NLFNKJMGACF
// base   : MPNALOFPFFK`1<PGEKEHHMDMG>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{aNHNOCHPGNC}   [Service.API]
public class NLFNKJMGACF
{
    // (no instance fields in the metadata dump)
}
...
public class NMIHPKGECBB
{
    public int <OFJGCKHDFGE>k__BackingField;    // 0x0x10
    public int? <EEBMDCOBKJO>k__BackingField;    // 0x0x14
    public string <FKNELHOKEFM>k__BackingField;    // 0x0x20
    public string <EADAAMPJAGF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// NMNMPLHCMBB
//   (not directly referenced by a detected call)
public class NMNMPLHCMBB
{
    public DFNGBBLKKGN <ACMELJMLCPK>k__BackingField;    // 0x0x10
    public GEMIEENEIHE <GMOPMEBNOKA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NOKPLICANEM
//   REQUEST  POST   api/avatar/v4/saved/set   [Service.Econ]
public class NOKPLICANEM
{
    public int <EFLJDBPNPHG>k__BackingField;    // 0x0x10
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x18
    public string <GELPLIOKFIC>k__BackingField;    // 0x0x20
    public string <EBCMEIDFFNL>k__BackingField;    // 0x0x28
    public string <FGGHIMKGGFH>k__BackingField;    // 0x0x30
    public string <OHJDPAAPCOI>k__BackingField;    // 0x0x38
    public string <IEHDGNPJHDC>k__BackingField;    // 0x0x40
    public string <CFBHHJAFMCL>k__BackingField;    // 0x0x48
    public NNNKPFANIIO <BOBMJLDNLIB>k__BackingField;    // 0x0x50
    public List<OCIOLHBKFIC> <GIDDNPJNHLA>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// OBLKICLAEHG
//   (not directly referenced by a detected call)
public class OBLKICLAEHG
{
    public long <IJHHFGODOMC>k__BackingField;    // 0x0x10
    public string <LHPIJFNMCPP>k__BackingField;    // 0x0x18
    public string <AAINFKMNACO>k__BackingField;    // 0x0x20
    public LGFCBDFPHME? <PJBOHAFDKIJ>k__BackingField;    // 0x0x28
    public string <IDEEPAOMEFP>k__BackingField;    // 0x0x30
    public string <JPCKMEHBICM>k__BackingField;    // 0x0x38
    public GCAELICBDJO <OGEALBBABEM>k__BackingField;    // 0x0x40
    public int <JELBLKKNCDA>k__BackingField;    // 0x0x44
    public int <JAGPBOPKDJD>k__BackingField;    // 0x0x48
    public LHOIMHGEGHD? <GHONPADBHJJ>k__BackingField;    // 0x0x4C
    public GOKMIAEEEEK? <OEKIFMCIEGP>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// OCIOLHBKFIC
//   (not directly referenced by a detected call)
public class OCIOLHBKFIC
{
    public Guid <KPKNPIHJGFL>k__BackingField;    // 0x0x10
    public byte <HHFDLJHOGDK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OGKHNBMAKAE
//   (not directly referenced by a detected call)
public class OGKHNBMAKAE
{
    public int <BPBJNAGPMDL>k__BackingField;    // 0x0x10
    public DateTime? <IFEJBOIPFCE>k__BackingField;    // 0x0x18
    public DateTime? <DMCPNJLOHEJ>k__BackingField;    // 0x0x28
}
...
public class OJCBOPCJCEB
{
    public BGJKCHIAKOB <AFNAMBMFPLM>k__BackingField;    // 0x0x10
    public FBHAHLKLHLN <BJHBLLCKCBP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ONBHDEKHIIG
//   REQUEST  PUT    api/avatar/v4/saved/name   [Service.Econ]
public class ONBHDEKHIIG
{
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x10
    public int <EFLJDBPNPHG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OPEEAOLBMIA
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class OPEEAOLBMIA
{
    public List<DFNGBBLKKGN> <MBIAAGMHHJD>k__BackingField;    // 0x0x10
    public string <BKALDIOCEEM>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{mLDMDFFFKKN}   [Service.API]
...
public class PDOAFAFPHBE
{
    public KEJFJFHIFLG <ACMELJMLCPK>k__BackingField;    // 0x0x10
    public HFOAANCEOPH <COAGFCKEKGK>k__BackingField;    // 0x0x18
    public JFOOONHBGNF <EHBEJFCGPNN>k__BackingField;    // 0x0x20
}
...
public class PEEIMHMOOEF
{
    public OHPIJKAGIOB <KCNGFEGPGGK>k__BackingField;    // 0x0x10
    public FCJFCEGLIGB <LEEFJMDGPHA>k__BackingField;    // 0x0x14
    public int <HBEDBAAALGB>k__BackingField;    // 0x0x18
    public int <JDNMNMEEPGE>k__BackingField;    // 0x0x1C
    public int <MNENGOFIMDA>k__BackingField;    // 0x0x20
    public NADALJFCAIA <PKCLNNALMKK>k__BackingField;    // 0x0x24
    public bool <GIMJCGMOIHA>k__BackingField;    // 0x0x28
    public float <HBBIOFMHMIG>k__BackingField;    // 0x0x2C
    public int <EPGPNFOGMGK>k__BackingField;    // 0x0x30
    public bool <HDIJPOFDNNB>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// PGKFGFCAIMG
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class PGKFGFCAIMG
{
    public string <GDGLOPJKJJM>k__BackingField;    // 0x0x10
    public string <LGKEOGGMIMA>k__BackingField;    // 0x0x18
    public string <JDJIOLHOKGD>k__BackingField;    // 0x0x20
    public string <MMFPFAALGMD>k__BackingField;    // 0x0x28
    public string <IJICLIOFGEC>k__BackingField;    // 0x0x30
    public EJBLKOEPHDG <AFNAMBMFPLM>k__BackingField;    // 0x0x38
    public List<string> <KHOCOJIGOMP>k__BackingField;    // 0x0x40
    public List<string> <CKKGLMADBIN>k__BackingField;    // 0x0x48
    public string <LMAKPOLOELL>k__BackingField;    // 0x0x50
    public List<MCCOHHJHDCH> <EAHAHJNBIND>k__BackingField;    // 0x0x58
}
...
// base   : EHLEHIELPDJ
//   (not directly referenced by a detected call)
public class POFEJKAJDIO : EHLEHIELPDJ
{
    public int <LNDHPKIMGAC>k__BackingField;    // 0x0x60
    public List<DJFHJIDLOEO> <JNHMCMADOFO>k__BackingField;    // 0x0x68
    public List<DJFHJIDLOEO> <KCDFJNJIANN>k__BackingField;    // 0x0x70
    public List<DJFHJIDLOEO> <IHGPHIKFONM>k__BackingField;    // 0x0x78
}
...
{
    public long <OAGLNMDIOKI>k__BackingField;    // 0x0x10
    public long? <MOOKOFHENAA>k__BackingField;    // 0x0x18
    public KMEGHOEMOEP <MPAJEPEEKOE>k__BackingField;    // 0x0x28
}
...
{
    public ACPBPMEKHCN <COAGFCKEKGK>k__BackingField;    // 0x0x10
    public string <JDJLLOLLHPC>k__BackingField;    // 0x0x18
    public string <DOPLIOLCFPI>k__BackingField;    // 0x0x20
    public string <LHPKNANGNMP>k__BackingField;    // 0x0x28
}
...
{
    public long <GNIEJANJPDO>k__BackingField;    // 0x0x10
    public long? <JIOIPJDIJPF>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public FPKCNOPLKGK FilterType;    // 0x0x20
...
{
    public KMEGHOEMOEP <BJPPIPGFDIA>k__BackingField;    // 0x0x10
    public string <MDFFKCCDBKH>k__BackingField;    // 0x0x18
    public int <BFBJMFMNGEF>k__BackingField;    // 0x0x20
    public int <JOPBPBKMMCO>k__BackingField;    // 0x0x24
    public string <BFGJLMJCGNH>k__BackingField;    // 0x0x28
    public string <DONHAMPPPKC>k__BackingField;    // 0x0x30
}
...
{
    public int <LOFLIJAMAHM>k__BackingField;    // 0x0x10
    public Guid <DOPEJFMIMHL>k__BackingField;    // 0x0x14
    public DateTime <IEFPPIANFOJ>k__BackingField;    // 0x0x28
}
...
{
    public bool <KKGFDAMHKMC>k__BackingField;    // 0x0x10
    public int <HGGIBHDLDKI>k__BackingField;    // 0x0x14
    public bool <ELKCFFBCACF>k__BackingField;    // 0x0x18
}
...
{
    public Guid <DOPEJFMIMHL>k__BackingField;    // 0x0x10
    public KMEGHOEMOEP <EEKCGHDKHKA>k__BackingField;    // 0x0x20
    public int <JABHKKAAODM>k__BackingField;    // 0x0x24
    public long <OAGLNMDIOKI>k__BackingField;    // 0x0x28
    public long? <MOOKOFHENAA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{oMDBFLIACPJ}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <CMNBGIAMMPF>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <KBKKPLHKLJK>k__BackingField;    // 0x0x18
}
...
{
    public long <HAOJCNLAPHB>k__BackingField;    // 0x0x10
    public long <OAGLNMDIOKI>k__BackingField;    // 0x0x18
    public long <EOLKJOHGNGI>k__BackingField;    // 0x0x20
    public JNEMIFKFLGO <PNNPKBHHIIE>k__BackingField;    // 0x0x28
    public int <KNADDLJMOLF>k__BackingField;    // 0x0x2C
}
...
{
    public long <OAGLNMDIOKI>k__BackingField;    // 0x0x10
    public List<Guid> <ENIJLLOHDCI>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <CMNBGIAMMPF>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <KBKKPLHKLJK>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <GFPJFDEJMCJ>k__BackingField;    // 0x0x20
}
...
{
    public long <EOLKJOHGNGI>k__BackingField;    // 0x0x10
    public long <DDKFBOECCJF>k__BackingField;    // 0x0x18
    public int? <FDJKMLACAJA>k__BackingField;    // 0x0x20
    public int? <GGJNNKHGCAK>k__BackingField;    // 0x0x28
    public long? <JKMIODPNIJN>k__BackingField;    // 0x0x30
    public long <INLHDCCIPEA>k__BackingField;    // 0x0x40
    public long <NGJPOILDIOG>k__BackingField;    // 0x0x48
    public int <KCLCHNNCDAF>k__BackingField;    // 0x0x50
    public JNEMIFKFLGO <HDFGFDODJMO>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <KELNJONGICC>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public LHOIMHGEGHD <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public GHEPHOPAIBD creatorAccountRole;    // 0x0x58
}
...
{
    public EIOLGCAIOCG <BNBMJLIEIOM>k__BackingField;    // 0x0x10
    public NPCCNJEMMCM <LDPKFKCONBL>k__BackingField;    // 0x0x14
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x18
    public string <MMFPFAALGMD>k__BackingField;    // 0x0x20
    public bool <JIPCAENOMLG>k__BackingField;    // 0x0x28
}
...
{
    public List<EIOLGCAIOCG> <DKJDDILBEKD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{mLDMDFFFKKN}   [Service.API]
public class ProgressionEventDTO
{
    public long <DDKFBOECCJF>k__BackingField;    // 0x0x10
    public string <HMCEABMCEDA>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <IHGPHIKFONM>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <JOLCLGFGMGC>k__BackingField;    // 0x0x28
    public DateTime <MIJCGPHFGPC>k__BackingField;    // 0x0x30
    public DateTime <JBFFMBHDMEM>k__BackingField;    // 0x0x38
    public DateTime <CNKCINOJFDB>k__BackingField;    // 0x0x40
    public bool <DNLLHEPFHIF>k__BackingField;    // 0x0x48
    public int <KDGBOJJPJBJ>k__BackingField;    // 0x0x4C
    public float <EGDMENFCLJP>k__BackingField;    // 0x0x50
    public Guid? <OMJIHLEGNEC>k__BackingField;    // 0x0x54
    public string <DAIPDFBFFGL>k__BackingField;    // 0x0x68
    public string <CNHIHNHEPMH>k__BackingField;    // 0x0x70
    public string <JMELIDDEDJL>k__BackingField;    // 0x0x78
    public string <DHNDBIMAFED>k__BackingField;    // 0x0x80
}
...
{
    public Guid <MNMNJHGMFDA>k__BackingField;    // 0x0x10
    public int <JEGMFAOLHDK>k__BackingField;    // 0x0x20
    public int <ALBDKGBLLGH>k__BackingField;    // 0x0x24
    public int <DMBOOAHEMDE>k__BackingField;    // 0x0x28
    public long <HHIKAGICALE>k__BackingField;    // 0x0x30
    public long <AALJBPADALP>k__BackingField;    // 0x0x38
}
...
{
    public int <LOFLIJAMAHM>k__BackingField;    // 0x0x10
    public int <JELBLKKNCDA>k__BackingField;    // 0x0x14
    public int <CABDEPADCMG>k__BackingField;    // 0x0x18
    public int <MNCFDIALPPC>k__BackingField;    // 0x0x1C
    public int <PKJKADBPDND>k__BackingField;    // 0x0x20
    public DateTime? <GBOPOBLOLJM>k__BackingField;    // 0x0x28
}
...
{
    public long <CCIEKHLLGBI>k__BackingField;    // 0x0x10
    public int <IJHHFGODOMC>k__BackingField;    // 0x0x18
    public string <HCPIIBNHHBC>k__BackingField;    // 0x0x20
    public int <JELBLKKNCDA>k__BackingField;    // 0x0x28
    public int <EMHALLPBFAJ>k__BackingField;    // 0x0x2C
    public bool <ODDLJPPNMHN>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public MENGNOLJMPP ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool BJKEJNELHHK;    // 0x0x28
}
...
{
    public KJMDDPLFCAC? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public KJMDDPLFCAC NELBEGGOGIK;  // wrapper
...
{
    public BLAENFHHGKG FCEKAJIGBNK;  // wrapper
...
{
    public DDFODEAFFKC DPPJBLOOGOO;  // wrapper
    public int? CHNJMGMKFOO;  // wrapper
...
{
    public DKNDKDAIPLI MIGJDCDHHCF;  // wrapper
    public float? DOIHKMOAOGF;  // wrapper
...
{
    public ONPDJCACIOB UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public LHOIMHGEGHD AEOEKGNDHFM;  // wrapper
    public LHOIMHGEGHD? PLOLPHCHCPA;  // wrapper
...
{
    public AOKEPNDBFLH OEHJBKCLLBM;  // wrapper
...
{
    public NNNKPFANIIO CPHFPKPPIEO;  // wrapper
    public CBPKPCMHDJG KMJAJHLPAFH;  // wrapper
    public byte[] EACINPPINEF;  // wrapper
    public byte[] HAMLPCJLNCN;  // wrapper
    public Color IFAEOGGHLKI;  // wrapper
...
{
    public List<MEKIMBEMDGJ> AGCJDFGOGGF;  // wrapper
}
...
{
    public LBOOLBNGHFC IODHODEHEGA;  // wrapper
    public LHOIMHGEGHD? EINACPANAMH;  // wrapper
...
{
    public KLGBCPBBDIN ECMFJAIIFFM;  // wrapper
...
{
    public EIKMPCKMIAA inventionId;  // wrapper
}
...
// api/keepsakes/{lMKJBONLEIO}/collect  [API POST]
public class KeepsakesLMKJBONLEIOCollectRequest
{
    public Guid LMKJBONLEIO;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> IHJIODLNFMP;  // wrapper
    public LDKBFOHAPBN DIDJJFLKHHJ;  // wrapper
    public long? IHGIEILPMCA;  // wrapper
...
{
    public long? JMKLOFFGMKA;  // wrapper
}
...
{
    public long? BPCDOJMJPPI;  // wrapper
    public long? DPIAPNNHJHP;  // wrapper
    public List<string> CNGCHIMICOL;  // wrapper
    public DateTime ONMGEGGIKGD;  // wrapper
    public DateTime DAHJPKHEDMA;  // wrapper
    public MNJFJMAJHBI CPHFPKPPIEO;  // wrapper
    public GGFLHJIAHKM OPHFFNDBPJM;  // wrapper
    public GGFLHJIAHKM FNILKFOGFGK;  // wrapper
}
...
{
    public GGFLHJIAHKM OPHFFNDBPJM;  // wrapper
    public GGFLHJIAHKM GFKDODOJPFL;  // wrapper
}
...
{
    public Guid GOBEKHJDDBM;  // wrapper
...
{
    public List<PFHDAGGHHKK> FGPDFIDDLEB;  // wrapper
}
...
{
    public Guid IEOGELIMGBC;  // wrapper
    public object Price;  // candidate
...
{
    public Guid IEOGELIMGBC;  // wrapper
    public long? PGLINEMCGBO;  // wrapper
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Limit;  // candidate
...
{
    public Guid GOBEKHJDDBM;  // wrapper
    public long? BKGMDJNEIPD;  // wrapper
    public long? FEFBNIMPDMC;  // wrapper
    public int? PPIJPBOJHCI;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> BPFIFAEKGCN;  // wrapper
...
{
    public IEnumerable<BFGINPDINNG> GJMFJBEAFOO;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public DDLDMKEMNIO DPPJBLOOGOO;  // wrapper
    public Guid? ALHABMGLMAG;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public DKNDKDAIPLI MIGJDCDHHCF;  // wrapper
    public long? IKDDAGBNPMJ;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats ALIIDNKBDMK;  // wrapper
}
...
{
    public Guid CALEOJCPILO;  // wrapper
...
{
    public Guid LHMODGJOGBH;  // wrapper
...
{
    public List<ENGKAPBKGFF> GAPKGDJNOJL;  // wrapper
    public object roomId;  // candidate
...
{
    public EJBLKOEPHDG ODPMNHAMLIM;  // wrapper
}
