...
// DTO classes: 262 (plus referenced enums)
...
public class ACFLJMNJNMF
{
    public Guid? <DOFNMIDFGOG>k__BackingField;    // 0x0x10
    public Guid <PEGFAAOINNH>k__BackingField;    // 0x0x24
}
...
public class ADINAFAEAKK
{
    public HMGAJFLIKBM <CFIFCJJPBFB>k__BackingField;    // 0x0x10
}
...
public class AEPFABAGKIE : NLOFIMIAMBL
{
    public List<NIHLANCGKHO> EGOEEDELAEJ;    // 0x0x30
    public int <KJMKHJDJEKH>k__BackingField;    // 0x0x38
}
...
public class AFNOEKDJEIA : LCADPLBBIEF
{
    public int <KCKAAAPMHDP>k__BackingField;    // 0x0x60
    public List<CJDEJHKGJJL> <AIBIMNLCHIG>k__BackingField;    // 0x0x68
    public List<CJDEJHKGJJL> <MIGFCIKGKAO>k__BackingField;    // 0x0x70
    public List<CJDEJHKGJJL> <HFAGLJBHHHK>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// AGJBBDGCEKL
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class AGJBBDGCEKL
{
    public string <COIJKBIEBAG>k__BackingField;    // 0x0x10
    public string <PPOCFKLNADH>k__BackingField;    // 0x0x18
    public string <NANKJOANJOL>k__BackingField;    // 0x0x20
    public string <HLPJEKEEDPD>k__BackingField;    // 0x0x28
    public string <DFCAHKPKKOD>k__BackingField;    // 0x0x30
    public MJHFMEDMDHD <NJJEAODCIOL>k__BackingField;    // 0x0x38
    public List<string> <GAODBLNJINL>k__BackingField;    // 0x0x40
    public List<string> <EBNGJHNKKPO>k__BackingField;    // 0x0x48
    public string <FAAAEAIONPC>k__BackingField;    // 0x0x50
    public List<JOIBMJOBGBF> <ELAAPDLCCEA>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// BAMBMLHGELE
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class BAMBMLHGELE
{
    public long <AGEGKFGLJKB>k__BackingField;    // 0x0x10
    public int <MDAAHAOFPHB>k__BackingField;    // 0x0x18
    public long <LACENPCECNF>k__BackingField;    // 0x0x20
    public long? <ABPIDKFNLNG>k__BackingField;    // 0x0x28
    public long? <CMNOIOHKILA>k__BackingField;    // 0x0x38
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x48
    public string <HLPJEKEEDPD>k__BackingField;    // 0x0x50
    public string <HODKPAMBGPP>k__BackingField;    // 0x0x58
    public DateTime <NNJMJFKFCAP>k__BackingField;    // 0x0x60
    public DateTime <JCMPFCKNIDK>k__BackingField;    // 0x0x68
    public int <ABHKIJFLOBI>k__BackingField;    // 0x0x70
    public FHHOIBCGPDB <JEKFAJLLMOF>k__BackingField;    // 0x0x74
    public bool <FAKLGGBHADK>k__BackingField;    // 0x0x78
    public bool <NNPPMKBPFHA>k__BackingField;    // 0x0x79
    public PDMGLJINNBG <FAKNCKMOICF>k__BackingField;    // 0x0x7C
    public PDMGLJINNBG <JEEHHEAEOOC>k__BackingField;    // 0x0x80
    public long? <HGJCNENJLEM>k__BackingField;    // 0x0x88
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{eJAAHJNCJDO}   [Service.Econ]
public class BAOJEFGGICA
{
    public ENADANMAKLM <NJJEAODCIOL>k__BackingField;    // 0x0x10
    public OJLIJEHNLIC <AIDEINHLGCN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BBCHJEBNNED
//   (not directly referenced by a detected call)
public class BBCHJEBNNED
{
    public int <EEJDLECAIIM>k__BackingField;    // 0x0x10
    public string <ILJALONIBKF>k__BackingField;    // 0x0x18
    public string <LHOGINPEEHA>k__BackingField;    // 0x0x20
    public string <LEBEGLPJGLM>k__BackingField;    // 0x0x28
    public string <EONFJMDFFLB>k__BackingField;    // 0x0x30
    public string <PEBEBGKCGJB>k__BackingField;    // 0x0x38
    public HCPFBNDAENN? <GCBMNDKPBMJ>k__BackingField;    // 0x0x40
    public string <FCJGKIILIJL>k__BackingField;    // 0x0x48
    public string <EOLEIOLFEPE>k__BackingField;    // 0x0x50
    public bool <BEHACENNJNP>k__BackingField;    // 0x0x58
    public bool <BJLKMPFBLNA>k__BackingField;    // 0x0x59
    public bool <JJCFBONJNEA>k__BackingField;    // 0x0x5A
    public DLFKMDGOBHG <JPADMOGPAIK>k__BackingField;    // 0x0x5C
    public int <ADCJPDKNHAH>k__BackingField;    // 0x0x60
    public NLCCJKKOPIN <JNCHGHGCGDI>k__BackingField;    // 0x0x64
    public int <DOHNMBHGKOP>k__BackingField;    // 0x0x68
    public NNCGIIHEHLN <KDADCHNPPKL>k__BackingField;    // 0x0x6C
    public HHIOPGHABDA <KJGENMGCDFP>k__BackingField;    // 0x0x70
    public int? <HNMDLNLEFLJ>k__BackingField;    // 0x0x74
    public string <LDDEBEFBEJH>k__BackingField;    // 0x0x80
    public HJKDJBKBJGC? KFFMBIDPJBD;    // 0x0x88
}
...
// base   : BAMBMLHGELE
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class BCCMGFMJEAI : BAMBMLHGELE
{
    public List<HEALOFAEEFI> <EBNGJHNKKPO>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// BCLOADDEDIK
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class BCLOADDEDIK
{
    public List<int> <LLOAJNBCDGI>k__BackingField;    // 0x0x10
    public string <KBBJFCKMIEG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BDODDNCKPMO
//   (not directly referenced by a detected call)
public class BDODDNCKPMO
{
    public long <DHEIMEDPOMA>k__BackingField;    // 0x0x10
    public Guid <KIELLPOAPBJ>k__BackingField;    // 0x0x18
    public long <LACENPCECNF>k__BackingField;    // 0x0x28
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x30
    public string <HLPJEKEEDPD>k__BackingField;    // 0x0x38
    public int <IBDCAHHELBJ>k__BackingField;    // 0x0x40
    public Guid? <PKPNMDJGDGD>k__BackingField;    // 0x0x44
    public DateTime <BEIDEJCBHOE>k__BackingField;    // 0x0x58
    public string <HODKPAMBGPP>k__BackingField;    // 0x0x60
    public KHNOONABOMI <FLCEHEOICCO>k__BackingField;    // 0x0x68
}
...
public class BFDHALPEFJI
{
    public CAMCDOEKIHD <AMNCNHDNBEG>k__BackingField;    // 0x0x10
    public string <OBLDLGPHPAE>k__BackingField;    // 0x0x18
    public int? <DGLEAHBKHOA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BGACNNHHEKH
//   (not directly referenced by a detected call)
public class BGACNNHHEKH
{
    public long <EEJDLECAIIM>k__BackingField;    // 0x0x10
    public string <EONFJMDFFLB>k__BackingField;    // 0x0x18
    public string <LHFBIIFKMHC>k__BackingField;    // 0x0x20
    public HCPFBNDAENN? <GCBMNDKPBMJ>k__BackingField;    // 0x0x28
    public string <FCJGKIILIJL>k__BackingField;    // 0x0x30
    public string <EOLEIOLFEPE>k__BackingField;    // 0x0x38
    public BMGBGDGNPPP <KALIMEGAGKB>k__BackingField;    // 0x0x40
    public int <PAKMOABECGC>k__BackingField;    // 0x0x44
    public int <OGEAJCHBBAN>k__BackingField;    // 0x0x48
    public HHIOPGHABDA? <AMEJLKNNFFB>k__BackingField;    // 0x0x4C
    public DLFKMDGOBHG? <CDMBNEIEGGA>k__BackingField;    // 0x0x54
}
...
public class BJLKIKKCADB
{
    public List<NLJGECJKBCA> <FJKIOPKHPEG>k__BackingField;    // 0x0x10
    public string <KBBJFCKMIEG>k__BackingField;    // 0x0x18
}
...
public class BNPFBKNDLKG
{
    public List<BAMBMLHGELE> <LLINLDMAFHP>k__BackingField;    // 0x0x10
    public string <KBBJFCKMIEG>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/inventions/v1/personaldetails/{aILDJDELMIF}   [Service.API]
public class CABJFPNGKPJ
{
    public bool <GPLHOAGELKM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CDIHKIHOGJP
// base   : GJLKPNHFOGL`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class CDIHKIHOGJP
{
    // (no instance fields in the metadata dump)
}
...
public class CFDPEFGNLDJ : EOLNBFJPCOI
{
    public BJANPBKMFEA? <AFPGFBCEFNJ>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <AIMAKBMLEPA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CIFJMHANBPN
//   (not directly referenced by a detected call)
public class CIFJMHANBPN
{
    public Guid <MDEDFNAEAAK>k__BackingField;    // 0x0x10
    public byte <OPFHIGCDLJN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CJDEJHKGJJL
//   (not directly referenced by a detected call)
public class CJDEJHKGJJL
{
    public bool <GCJGCGBKHID>k__BackingField;    // 0x0x10
    public BBCHJEBNNED <CCLHMBHACLH>k__BackingField;    // 0x0x18
    public float <ONODGIGIIAI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CLJFEFJNDNA
//   (not directly referenced by a detected call)
public class CLJFEFJNDNA
{
    public int <MMNOIKAJDOJ>k__BackingField;    // 0x0x10
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x18
    public string <AKEKBFJKENK>k__BackingField;    // 0x0x20
    public string <HLPJEKEEDPD>k__BackingField;    // 0x0x28
    public string <LHOGINPEEHA>k__BackingField;    // 0x0x30
    public bool <DDEOKEGMCIC>k__BackingField;    // 0x0x38
    public int <FIEENGGKCBF>k__BackingField;    // 0x0x3C
    public DIHHDEEANIH <MFNHFOLOKAA>k__BackingField;    // 0x0x40
    public IHLDNEBPGDG HHMJAHECKMG;    // 0x0x48
    public IHLDNEBPGDG DPHHBMBHKCF;    // 0x0x50
    public IHLDNEBPGDG MPOKEBNNLMC;    // 0x0x58
    public ACKOCHFAFMM FNMPCIADJPO;    // 0x0x60
}
...
//   RESPONSE DELETE api/keepsakes/{dOFNMNEMDFH}   [Service.API]
...
public class COBDAHIKECI
{
    public bool <HLJDFKLNILA>k__BackingField;    // 0x0x10
    public string <AACMFGJGNPJ>k__BackingField;    // 0x0x18
}
...
// DBABBMLDCEM
//   (not directly referenced by a detected call)
public class DBABBMLDCEM
{
    public bool <GAIMLHDBNIA>k__BackingField;    // 0x0x10
    public PGEBACNHODP <MMPAEBHFHCG>k__BackingField;    // 0x0x14
    public int <NFHBEKMHFHD>k__BackingField;    // 0x0x18
    public DateTime <KOPMDOLNODB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DBFHFJLFKPA
//   (not directly referenced by a detected call)
public class DBFHFJLFKPA
{
    public Guid <ODEGEDBNMIG>k__BackingField;    // 0x0x10
    public int <CGHECBOKIEP>k__BackingField;    // 0x0x20
    public int <GJFDNFDCLMD>k__BackingField;    // 0x0x24
    public Guid <EPHNPJKJNMG>k__BackingField;    // 0x0x28
    public DateTime <KOPMDOLNODB>k__BackingField;    // 0x0x38
    public OJLIJEHNLIC <AIDEINHLGCN>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// DIHHDEEANIH
//   (not directly referenced by a detected call)
public class DIHHDEEANIH
{
    // (no instance fields in the metadata dump)
}
...
public class DKPGMLCDKGE
{
    public Dictionary<int, int> <DDDAAGDNFAD>k__BackingField;    // 0x0x10
    public List<EAPDJPDCNLD> <KJCCFOEBMIO>k__BackingField;    // 0x0x18
    public NEDJBAABPGG[][] <CLEPANMDLKF>k__BackingField;    // 0x0x20
    public GPIHHHEGPNM <MEKMKPBAFEI>k__BackingField;    // 0x0x28
    public MLNOOAJNFCB <JCLCHDPKACH>k__BackingField;    // 0x0x30
    public HLBPNFBFIDH <LNDGALAEODP>k__BackingField;    // 0x0x38
    public LPPELBGMHAH <CPMMAPLAEEK>k__BackingField;    // 0x0x40
    public LKCPPCINKKE <CKDGFDCCGLL>k__BackingField;    // 0x0x48
    public string <BGAJKGDABNE>k__BackingField;    // 0x0x50
}
...
public class DPJBLGKLILO
{
    public long <DHEIMEDPOMA>k__BackingField;    // 0x0x10
    public int <CGHECBOKIEP>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// EADPGENIHLI
// base   : GJLKPNHFOGL`1<JKIFBNPCELM>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{gJGKJAGEFAH}   [Service.API]
public class EADPGENIHLI
{
    // (no instance fields in the metadata dump)
}
...
public class ECGOMFMFMJN
{
    public int <CBBNFDMPEDB>k__BackingField;    // 0x0x10
    public ODBELDIAMMH <FLCEHEOICCO>k__BackingField;    // 0x0x14
    public INCIHLCKADD <LFNFLLMMIOB>k__BackingField;    // 0x0x18
    public INCIHLCKADD <NLAOMHAHGCF>k__BackingField;    // 0x0x1C
    public INCIHLCKADD <NJIDNHKLELJ>k__BackingField;    // 0x0x20
}
...
public class EFLIONNPJKO
{
    public int <KMCJGBOKEKO>k__BackingField;    // 0x0x10
    public bool <KCIKLDPJAPB>k__BackingField;    // 0x0x14
    public DateTime <IJDKMJBMAOD>k__BackingField;    // 0x0x18
    public bool <NLDBCAAFGEM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EGHOOJAKGPF
//   REQUEST  PUT    api/avatar/v4/saved/name   [Service.Econ]
public class EGHOOJAKGPF
{
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x10
    public int <FIEENGGKCBF>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{lGOOKNGIFGD}   [Service.Econ]
public enum EHBAPHJKPJM
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class EJMPPIHDENA
{
    public int <CGHECBOKIEP>k__BackingField;    // 0x0x10
    public Guid <CJNOEAADGLB>k__BackingField;    // 0x0x14
    public long <EMJCNNFPEGC>k__BackingField;    // 0x0x28
    public DateTime <KOPMDOLNODB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// ELHJGAHALKK
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class ELHJGAHALKK
{
    public bool <EJMHPHEKDDI>k__BackingField;    // 0x0x10
    public string <PPOCFKLNADH>k__BackingField;    // 0x0x18
    public string <IMNDCKBPLAO>k__BackingField;    // 0x0x20
}
...
public class EPMPCBIMOBA
{
    public int <MILLDPNLNDM>k__BackingField;    // 0x0x10
    public int <FCLCEGECNHB>k__BackingField;    // 0x0x14
    public float <BHKKJAGMNCA>k__BackingField;    // 0x0x18
    public int <IELKJPIGLAP>k__BackingField;    // 0x0x1C
    public int <LCKLEELJFJD>k__BackingField;    // 0x0x20
    public int <LCOMNHGPIJN>k__BackingField;    // 0x0x24
    public int <GCNAMMDCHDB>k__BackingField;    // 0x0x28
    public string <CPPIAONEKBD>k__BackingField;    // 0x0x30
    public string <JAGGMLAICKH>k__BackingField;    // 0x0x38
}
...
public class FBMHCBIBLDL
{
    public FFFOALHEDLD <AMNCNHDNBEG>k__BackingField;    // 0x0x10
    public int <BJDEHIMLLKP>k__BackingField;    // 0x0x14
    public long <CAECBDAFENC>k__BackingField;    // 0x0x18
    public bool <FLDHOKEHLFB>k__BackingField;    // 0x0x20
    public string <BOJHAMJIMHG>k__BackingField;    // 0x0x28
    public int? <CBBDKHKDPKG>k__BackingField;    // 0x0x30
    public bool <FGNEOIGAGIH>k__BackingField;    // 0x0x38
    public bool <BOEPPIGEECC>k__BackingField;    // 0x0x39
    public bool <NJIGHOHCFFP>k__BackingField;    // 0x0x3A
    public bool <NNMHHDMKDBB>k__BackingField;    // 0x0x3B
    public string <HPCJNNGGGJK>k__BackingField;    // 0x0x40
    public DateTime? <JNLMJOFBFBJ>k__BackingField;    // 0x0x48
    public float <OODBBKPNPDN>k__BackingField;    // 0x0x58
}
...
public class FGMBACADHOG
{
    public Dictionary<Guid, JCDDAHNMKGN> <KICFAGANIHH>k__BackingField;    // 0x0x10
}
...
public class FPBPDGFCING
{
    public NLCCJKKOPIN <JNCHGHGCGDI>k__BackingField;    // 0x0x10
    public MEHEIJBGIDK <IFHFGOGDLFD>k__BackingField;    // 0x0x14
    public int <CDICDFAGNDN>k__BackingField;    // 0x0x18
    public int <OOPLBEGAPOE>k__BackingField;    // 0x0x1C
    public int <PIBLPHLLENJ>k__BackingField;    // 0x0x20
    public KFNOGKGDEOI <GIFPEANKFGH>k__BackingField;    // 0x0x24
    public bool <HDLIABLDOFP>k__BackingField;    // 0x0x28
    public float <PKAOHEJGHLB>k__BackingField;    // 0x0x2C
    public int <PFOEGPPILDM>k__BackingField;    // 0x0x30
    public bool <EIKDGONHDKI>k__BackingField;    // 0x0x34
}
...
public class GCEMBHBPNBM
{
    public ACFLJMNJNMF <IOGCEAKKOEH>k__BackingField;    // 0x0x10
    public GEOIJNIGHBB <GHFINMLPDMN>k__BackingField;    // 0x0x18
    public int <IKBGFOONLKP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GCIPDBHDOEJ
//   (not directly referenced by a detected call)
public class GCIPDBHDOEJ
{
    public ObscuredLong <DEOHJLMELEB>k__BackingField;    // 0x0x10
    public string <KIELLPOAPBJ>k__BackingField;    // 0x0x38
    public ObscuredInt <MDAAHAOFPHB>k__BackingField;    // 0x0x40
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x58
    public string <HLPJEKEEDPD>k__BackingField;    // 0x0x60
    public string <HODKPAMBGPP>k__BackingField;    // 0x0x68
    public int <BJLAJGGMCAF>k__BackingField;    // 0x0x70
    public PBNNOBIKGMB <JEKFAJLLMOF>k__BackingField;    // 0x0x74
    public DateTime <KOPMDOLNODB>k__BackingField;    // 0x0x78
    public DateTime <BEIDEJCBHOE>k__BackingField;    // 0x0x80
    public DateTime? <ALPMDPIABIG>k__BackingField;    // 0x0x88
    public long? <FDOGPNLHDEE>k__BackingField;    // 0x0x98
    public int <FPHLAFLMBLJ>k__BackingField;    // 0x0xA8
    public int <BIFHCGJMKND>k__BackingField;    // 0x0xAC
    public int <POHGEAJJBBH>k__BackingField;    // 0x0xB0
    public GAGOADNOFAH <PLLGFJDGPMK>k__BackingField;    // 0x0xB4
    public GAGOADNOFAH <HJOPOPBIPKM>k__BackingField;    // 0x0xB8
    public ObscuredBool <BLIKLAOINHG>k__BackingField;    // 0x0xBC
    public ObscuredBool <BABNMPDMIJB>k__BackingField;    // 0x0xC8
    public ObscuredBool <FDIFIJIEADL>k__BackingField;    // 0x0xD4
    public int? <IBDCAHHELBJ>k__BackingField;    // 0x0xE0
    public bool <NHJKCAOCMBO>k__BackingField;    // 0x0xE8
}

// --------------------------------------------------------------------------
// GEOIJNIGHBB
//   (not directly referenced by a detected call)
public class GEOIJNIGHBB
{
    public long <IBDCAHHELBJ>k__BackingField;    // 0x0x10
    public Guid? <CJNOEAADGLB>k__BackingField;    // 0x0x18
}
...
public class GHKLHOKAPFH
{
    public string <GKMCIECPMGP>k__BackingField;    // 0x0x10
    public string <HFGLBMNCGHM>k__BackingField;    // 0x0x18
    public bool <NAHAGEEKGFC>k__BackingField;    // 0x0x20
    public string <HHLHPNHIICO>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// GPAJDIBFCMK
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItems   [Service.API]
public class GPAJDIBFCMK
{
    public byte <PMKNBJEDGKI>k__BackingField;    // 0x0x10
    public int <NHLENEGGEPI>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// GPIHHHEGPNM
//   (not directly referenced by a detected call)
public class GPIHHHEGPNM
{
    public int <PLMCLPKMFAP>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{gJAHLFBOLMI}   [Service.API]
...
public class HCFKPPIIPFN
{
    public BCCMGFMJEAI <LANLOLMNKKO>k__BackingField;    // 0x0x10
    public HMGAJFLIKBM <CFIFCJJPBFB>k__BackingField;    // 0x0x18
    public NOABFCINFNH <IMPFJLEDIMJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HDPKLBOJCBA
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{cAMPNMNOPAE}   [Service.API]
public class HDPKLBOJCBA
{
    public List<BAMBMLHGELE> <KELLADOIBPM>k__BackingField;    // 0x0x10
    public List<HJIMOCLFMIK> <ANMEDCNDIJO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HEALOFAEEFI
//   (not directly referenced by a detected call)
public class HEALOFAEEFI
{
    public string <AFMMEKPOFBL>k__BackingField;    // 0x0x10
    public DPPACANEIBK <FLCEHEOICCO>k__BackingField;    // 0x0x18
}
...
public class HENMKGJPKMC
{
    public List<string> <EGOPEFDIMJA>k__BackingField;    // 0x0x10
    public List<string> <KJGGJDPPMBG>k__BackingField;    // 0x0x18
    public List<string> <HHAGPMEBDIK>k__BackingField;    // 0x0x20
}
...
// HJIMOCLFMIK
//   (not directly referenced by a detected call)
public class HJIMOCLFMIK
{
    public BAMBMLHGELE <LANLOLMNKKO>k__BackingField;    // 0x0x10
    public IDHCFPBOALB <PDCFGNAECHP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HJKDJBKBJGC
// base   : System.ValueType
//   REQUEST  GET    api/avatar/v1/lockeditems   [Service.Econ]
public class HJKDJBKBJGC : ValueType
{
    public string KLNMCADLFBM;    // 0x0x0
    public PGFEMCEKGHI BBAAONMMEIC;    // 0x0x8
    public Guid MEAPCEEPOGO;    // 0x0x10
    public Color? CGJKEPGDJMB;    // 0x0x20
}

// --------------------------------------------------------------------------
// HKPCLFFBKNF
//   (not directly referenced by a detected call)
public class HKPCLFFBKNF
{
    public Guid <FDCOGHMCBBE>k__BackingField;    // 0x0x10
    public Guid <DDFFMBBBNBM>k__BackingField;    // 0x0x20
    public DateTime <PHEMICBHEIM>k__BackingField;    // 0x0x30
    public List<BBCHJEBNNED> <KPECAOIHNCC>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// HLBPNFBFIDH
//   (not directly referenced by a detected call)
public class HLBPNFBFIDH
{
    public int <CNIHDLGBMFB>k__BackingField;    // 0x0x10
}
...
public class IBIFLMFKAJL
{
    public int <BFIDNOLLCEH>k__BackingField;    // 0x0x10
    public string <PEOPFKCDBLJ>k__BackingField;    // 0x0x18
    public List<CLJFEFJNDNA> <OLECFBDJEMJ>k__BackingField;    // 0x0x20
    public BGACNNHHEKH <ONKIGPIJDAN>k__BackingField;    // 0x0x28
    public string <CKLNJBKJFDL>k__BackingField;    // 0x0x30
    public DateTime <PHEMICBHEIM>k__BackingField;    // 0x0x38
    public DateTime <OEMIGJEIDGB>k__BackingField;    // 0x0x40
    public DateTime <PKJGKCGFMMI>k__BackingField;    // 0x0x48
    public bool? <AEEPPCIGKFP>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// IDHCFPBOALB
//   (not directly referenced by a detected call)
public class IDHCFPBOALB
{
    public long <PDPNBKHEBIH>k__BackingField;    // 0x0x10
    public long <AGEGKFGLJKB>k__BackingField;    // 0x0x18
    public int <LNADFHFKGKJ>k__BackingField;    // 0x0x20
    public DateTime <BEIDEJCBHOE>k__BackingField;    // 0x0x28
    public KMPIODHKFHE <FLCEHEOICCO>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// IFJJIAALNKA
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class IFJJIAALNKA
{
    public int <GACEIIACNCI>k__BackingField;    // 0x0x10
    public int? <PGNHKGHHNKM>k__BackingField;    // 0x0x14
    public string <CLAMMEGIAMA>k__BackingField;    // 0x0x20
    public string <BGEFIFEIDHF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// INLPHLMOIBB
//   REQUEST  POST   api/avatar/v4/saved/set   [Service.Econ]
public class INLPHLMOIBB
{
    public int <FIEENGGKCBF>k__BackingField;    // 0x0x10
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x18
    public string <AOLBMDJAPMB>k__BackingField;    // 0x0x20
    public string <KFJFHFPCJAL>k__BackingField;    // 0x0x28
    public string <AFIDIHICCGK>k__BackingField;    // 0x0x30
    public string <MLHOBILIFOP>k__BackingField;    // 0x0x38
    public string <EOACMCJEMOP>k__BackingField;    // 0x0x40
    public string <EKNJFOECIIL>k__BackingField;    // 0x0x48
    public PBNNOBIKGMB <JEKFAJLLMOF>k__BackingField;    // 0x0x50
    public List<CIFJMHANBPN> <JEFHFKFLGKB>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// IOAFFOKHFPF
//   (not directly referenced by a detected call)
public class IOAFFOKHFPF
{
    public long <OHEAPJKDGDM>k__BackingField;    // 0x0x10
    public Guid <MDEDFNAEAAK>k__BackingField;    // 0x0x18
    public Guid <EOMLMAKJCPH>k__BackingField;    // 0x0x28
    public DateTime <BEIDEJCBHOE>k__BackingField;    // 0x0x38
    public string <AAKNOJPKNJA>k__BackingField;    // 0x0x40
    public string <MFBOFJGALOE>k__BackingField;    // 0x0x48
    public string <NJFHKIAKHFL>k__BackingField;    // 0x0x50
    public string <EOPLNOOBPKD>k__BackingField;    // 0x0x58
}
...
public class IOHCOLHOCKG
{
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x10
    public string <HLPJEKEEDPD>k__BackingField;    // 0x0x18
    public int? <IBDCAHHELBJ>k__BackingField;    // 0x0x20
    public PBNNOBIKGMB? <JEKFAJLLMOF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// JCDDAHNMKGN
//   (not directly referenced by a detected call)
public class JCDDAHNMKGN
{
    public int <IKBGFOONLKP>k__BackingField;    // 0x0x10
    public ACFLJMNJNMF <IOGCEAKKOEH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JIGFAMGHEPN
//   (not directly referenced by a detected call)
public class JIGFAMGHEPN
{
    public NLCCJKKOPIN <JNCHGHGCGDI>k__BackingField;    // 0x0x10
    public int <IBDCAHHELBJ>k__BackingField;    // 0x0x14
    public NDBHNJFELMO <CAICPGOBBPF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JJPHFAICMLJ
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItemDescs   [Service.API]
public class JJPHFAICMLJ
{
    public List<string> <PIKDFOHCMKK>k__BackingField;    // 0x0x10
    public byte <PMKNBJEDGKI>k__BackingField;    // 0x0x18
    public int <NHLENEGGEPI>k__BackingField;    // 0x0x1C
}
...
public class JKMINOEDFMC
{
    public EHBAPHJKPJM <NJJEAODCIOL>k__BackingField;    // 0x0x10
    public BDODDNCKPMO <CGHFCDJNHDI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JMCCINPPDMH
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class JMCCINPPDMH
{
    public int <BJDEHIMLLKP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JOIBMJOBGBF
//   (not directly referenced by a detected call)
public class JOIBMJOBGBF
{
    public DateTime <BEIDEJCBHOE>k__BackingField;    // 0x0x10
    public string <ILKMNKDHGGH>k__BackingField;    // 0x0x18
}
...
public class KHOBEKMLAKP
{
    public int <HFOAPOPKHAE>k__BackingField;    // 0x0x10
    public int <KMCJGBOKEKO>k__BackingField;    // 0x0x14
    public float <MDMDKCGMEKG>k__BackingField;    // 0x0x18
    public float <OCKCKLNBICL>k__BackingField;    // 0x0x1C
    public bool <KCIKLDPJAPB>k__BackingField;    // 0x0x20
    public bool <ENPNDCIGCMK>k__BackingField;    // 0x0x21
    public bool <EMJJHFONBHB>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// KJFHLBGJOCA
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class KJFHLBGJOCA
{
    public List<HEALOFAEEFI> <EBNGJHNKKPO>k__BackingField;    // 0x0x10
}
...
// base   : NLOFIMIAMBL
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{kEKLDOJOKFC}   [Service.Econ]
public class KKBGHOIFHFH : NLOFIMIAMBL
{
    public int <IFKAKDAGKLA>k__BackingField;    // 0x0x30
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x38
    public DateTime <PHEMICBHEIM>k__BackingField;    // 0x0x40
    public DateTime <OEMIGJEIDGB>k__BackingField;    // 0x0x48
    public NLCCJKKOPIN <JNCHGHGCGDI>k__BackingField;    // 0x0x50
    public LCADPLBBIEF <PMHBGOBGMNI>k__BackingField;    // 0x0x58
    public List<AFNOEKDJEIA> <BOIJDIKKAGH>k__BackingField;    // 0x0x60
    public DBABBMLDCEM <HNJBPEAOFMF>k__BackingField;    // 0x0x68
}
...
public class KNGBOEIMAKC
{
    public Guid <FHKDLPHEIPO>k__BackingField;    // 0x0x10
    public long <IIIKAHDFOPN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LCADPLBBIEF
//   (not directly referenced by a detected call)
public class LCADPLBBIEF
{
    public int <PBDFBACFMEC>k__BackingField;    // 0x0x10
    public BHLFJHHDBKG <FLCEHEOICCO>k__BackingField;    // 0x0x14
    public List<JIGFAMGHEPN> <KAIEPFIKHMG>k__BackingField;    // 0x0x18
    public List<JIGFAMGHEPN> <OCDKOGLOAPF>k__BackingField;    // 0x0x20
    public bool <ECKPHNCPBHJ>k__BackingField;    // 0x0x28
    public DateTime? <OBNEFJCFCDM>k__BackingField;    // 0x0x30
    public DateTime? <MKMNHCALJGA>k__BackingField;    // 0x0x40
    public DateTime? <AONMFMEOPMJ>k__BackingField;    // 0x0x50
}
...
//   RESPONSE GET    api/avatar/v2/{cAMPNMNOPAE}   [Service.Econ]
public class LFOAPPGPFOI
{
    public string <KFJFHFPCJAL>k__BackingField;    // 0x0x10
    public string <AFIDIHICCGK>k__BackingField;    // 0x0x18
    public string <MLHOBILIFOP>k__BackingField;    // 0x0x20
    public string <EOACMCJEMOP>k__BackingField;    // 0x0x28
    public string <EKNJFOECIIL>k__BackingField;    // 0x0x30
    public List<CIFJMHANBPN> <JEFHFKFLGKB>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// LKCPPCINKKE
//   (not directly referenced by a detected call)
public class LKCPPCINKKE
{
    public float <JHOHDIHGMAN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LLODIMOGIKM
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class LLODIMOGIKM
{
    public Dictionary<Guid, PMMEAIABKIP> <EJLDBPKDIIJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LPPELBGMHAH
//   (not directly referenced by a detected call)
public class LPPELBGMHAH
{
    public int <CEBPGGJBFNK>k__BackingField;    // 0x0x10
}
...
public class MLMIPCFBCEG
{
    public Dictionary<string, IOAFFOKHFPF> <BAOODPHJJDP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// MLNOOAJNFCB
//   (not directly referenced by a detected call)
public class MLNOOAJNFCB
{
    public float <OAHAJPOHEJD>k__BackingField;    // 0x0x10
    public float <NJPHPOGDMNE>k__BackingField;    // 0x0x14
    public float <MGJGPECGNAO>k__BackingField;    // 0x0x18
    public float <MHIAKAJFAKI>k__BackingField;    // 0x0x1C
    public float <IBFCCLCAPHL>k__BackingField;    // 0x0x20
    public float <KHBOALHHDIM>k__BackingField;    // 0x0x24
    public float <NLACBMHOMHA>k__BackingField;    // 0x0x28
    public float <MAGMHINEENA>k__BackingField;    // 0x0x2C
}
...
public class NBALBFNINPO
{
    public long <LACENPCECNF>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <NCJKJLGKPKO>k__BackingField;    // 0x0x18
    public NHKOAJKDDBN <ODOAHMKHKGE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NDBHNJFELMO
//   (not directly referenced by a detected call)
public class NDBHNJFELMO
{
    public int <LGFNBMOCNBI>k__BackingField;    // 0x0x10
    public DateTime? <NGDFIPLDBOE>k__BackingField;    // 0x0x18
    public DateTime? <EMPLHDJENHH>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// NEDJBAABPGG
//   (not directly referenced by a detected call)
public class NEDJBAABPGG
{
    public FEKHENMHGPA MODLAFOJJLI;    // 0x0x10
    public int ICLNIIGFMBE;    // 0x0x14
}
...
// base   : LCADPLBBIEF
//   (not directly referenced by a detected call)
public class NIHLANCGKHO : LCADPLBBIEF
{
    public BBCHJEBNNED <CCLHMBHACLH>k__BackingField;    // 0x0x60
}
...
// NLJGECJKBCA
//   (not directly referenced by a detected call)
public class NLJGECJKBCA
{
    public int <JBFPKOBIKNO>k__BackingField;    // 0x0x10
    public DateTime <BEIDEJCBHOE>k__BackingField;    // 0x0x18
    public DateTime? <OFCBDAJLPGM>k__BackingField;    // 0x0x20
}
...
public class NOABFCINFNH
{
    public GGCGKBLAOCE <CFIFCJJPBFB>k__BackingField;    // 0x0x10
    public List<string> <EBNGJHNKKPO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NPNFIAECKFB
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{oACHBLHDAOM}   [Service.API]
public class NPNFIAECKFB
{
    public uint <COIJKBIEBAG>k__BackingField;    // 0x0x10
    public uint? <AKBKFFFNLFN>k__BackingField;    // 0x0x14
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x20
    public string <HLPJEKEEDPD>k__BackingField;    // 0x0x28
    public DateTime <BPJELNBENDN>k__BackingField;    // 0x0x30
    public DateTime? <ALBBALEOOFC>k__BackingField;    // 0x0x38
    public bool <OHPEAHFCGNL>k__BackingField;    // 0x0x48
    public List<AGJBBDGCEKL> <DNFHMIHHIOB>k__BackingField;    // 0x0x50
    public List<string> <EBNGJHNKKPO>k__BackingField;    // 0x0x58
    public int <DGMNHGIDJAP>k__BackingField;    // 0x0x60
    public int <EPNBDKPONCJ>k__BackingField;    // 0x0x64
    public int <DDGJOIFIIBK>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// OEGLJDNNPOA
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class OEGLJDNNPOA
{
    public List<OLIFKIHJCGP> <CDDJCOCPGIM>k__BackingField;    // 0x0x10
    public HMGAJFLIKBM <CFIFCJJPBFB>k__BackingField;    // 0x0x18
}
...
public class OGBKPAGFNEA
{
    public Guid? <ODEGEDBNMIG>k__BackingField;    // 0x0x10
    public long? <LACENPCECNF>k__BackingField;    // 0x0x28
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x38
    public string <HLPJEKEEDPD>k__BackingField;    // 0x0x40
    public string <HODKPAMBGPP>k__BackingField;    // 0x0x48
    public GEOIJNIGHBB <EEMPHLENMJD>k__BackingField;    // 0x0x50
}
...
public class OGBMBHNJEDO : EOLNBFJPCOI
{
    public BJINPGHFELN? <AFPGFBCEFNJ>k__BackingField;    // 0x0x18
    public EJMPPIHDENA <HLCDMEAPIMN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OJLIJEHNLIC
//   (not directly referenced by a detected call)
public class OJLIJEHNLIC
{
    public Guid <ODEGEDBNMIG>k__BackingField;    // 0x0x10
    public long <LACENPCECNF>k__BackingField;    // 0x0x20
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x28
    public string <HLPJEKEEDPD>k__BackingField;    // 0x0x30
    public string <HODKPAMBGPP>k__BackingField;    // 0x0x38
    public long <IBDCAHHELBJ>k__BackingField;    // 0x0x40
    public Guid? <PKPNMDJGDGD>k__BackingField;    // 0x0x48
    public DateTime <KOPMDOLNODB>k__BackingField;    // 0x0x60
    public int <HAMCCDOHBIC>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// OLIFKIHJCGP
//   (not directly referenced by a detected call)
public class OLIFKIHJCGP
{
    public int <GIHAECFLCPM>k__BackingField;    // 0x0x10
    public HMGAJFLIKBM <CFIFCJJPBFB>k__BackingField;    // 0x0x14
}
...
public class OMIFECECJBI
{
    public bool <HLJDFKLNILA>k__BackingField;    // 0x0x10
    public string <BOJHAMJIMHG>k__BackingField;    // 0x0x18
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class PGFEMCEKGHI : ValueType
{
    public string[] MAFIHHPPOBB;    // 0x0x0
}

// --------------------------------------------------------------------------
// PGHDCFIPPJP
//   (not directly referenced by a detected call)
public class PGHDCFIPPJP
{
    public long <DEOHJLMELEB>k__BackingField;    // 0x0x10
    public string <KIELLPOAPBJ>k__BackingField;    // 0x0x18
    public int <EDPFHHIJNCG>k__BackingField;    // 0x0x20
    public int <DBPGHPDLJPA>k__BackingField;    // 0x0x24
    public int <FIAKHMKOJMH>k__BackingField;    // 0x0x28
    public int <IEHJPGBKJND>k__BackingField;    // 0x0x2C
    public int <FNKBCHCLLDB>k__BackingField;    // 0x0x30
    public string <JHKLIHHEKBA>k__BackingField;    // 0x0x38
    public string <DBBMBIBHKKG>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PJDCCEKGKFC
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Econ]
public class PJDCCEKGKFC
{
    public Guid <OMOLFCNIFOG>k__BackingField;    // 0x0x10
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x20
    public string <HODKPAMBGPP>k__BackingField;    // 0x0x28
    public DateTime <PHEMICBHEIM>k__BackingField;    // 0x0x30
    public DateTime? <IDAOOEMIIHI>k__BackingField;    // 0x0x38
    public List<HKPCLFFBKNF> <HHFLPCFGHEO>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// PKPMCIKKJGP
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class PKPMCIKKJGP
{
    public int? <JJJEMEPHJBJ>k__BackingField;    // 0x0x10
    public string <DFCAHKPKKOD>k__BackingField;    // 0x0x18
    public string <AKEJKANFFCN>k__BackingField;    // 0x0x20
}
...
public class PMMEAIABKIP
{
    public ENADANMAKLM <NJJEAODCIOL>k__BackingField;    // 0x0x10
    public DBFHFJLFKPA <COPJAGKAFHF>k__BackingField;    // 0x0x18
}
...
public class POHPFIIKFFB
{
    public BGNLEPHHMID <NJJEAODCIOL>k__BackingField;    // 0x0x10
    public GCIPDBHDOEJ <FNBGICLEONJ>k__BackingField;    // 0x0x18
    public PGHDCFIPPJP <DCHHJBJCBHC>k__BackingField;    // 0x0x20
}
...
{
    public long <LACENPCECNF>k__BackingField;    // 0x0x10
    public long? <ABPIDKFNLNG>k__BackingField;    // 0x0x18
    public POHMPBPHJDB <MIDCFBELPKC>k__BackingField;    // 0x0x28
}
...
{
    public DABINMCNMLG <CFIFCJJPBFB>k__BackingField;    // 0x0x10
    public string <HHBBFOEKGLM>k__BackingField;    // 0x0x18
    public string <NNBNAHKCCMN>k__BackingField;    // 0x0x20
    public string <ILBLNEHCCLK>k__BackingField;    // 0x0x28
}
...
{
    public long <AGEGKFGLJKB>k__BackingField;    // 0x0x10
    public long? <DKDBEODKABC>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public HEIBKJMACEK FilterType;    // 0x0x20
...
{
    public POHMPBPHJDB <JOAEHHEPEGA>k__BackingField;    // 0x0x10
    public string <CANKNJKAMNF>k__BackingField;    // 0x0x18
    public int <JOLIGALGBDO>k__BackingField;    // 0x0x20
    public int <EHJLFOLEMLD>k__BackingField;    // 0x0x24
    public string <LIJMOBLDJKD>k__BackingField;    // 0x0x28
    public string <PPLDFELBCMN>k__BackingField;    // 0x0x30
}
...
{
    public int <CGHECBOKIEP>k__BackingField;    // 0x0x10
    public Guid <BHLIINIHOCB>k__BackingField;    // 0x0x14
    public DateTime <NNMEBBLBBKP>k__BackingField;    // 0x0x28
}
...
{
    public bool <PPLGKFEBKPN>k__BackingField;    // 0x0x10
    public int <KIPGGIHPNIA>k__BackingField;    // 0x0x14
    public bool <PEONLJHDBMI>k__BackingField;    // 0x0x18
}
...
{
    public Guid <BHLIINIHOCB>k__BackingField;    // 0x0x10
    public POHMPBPHJDB <ONNCDIAFFHE>k__BackingField;    // 0x0x20
    public int <NBCCIIGEIAD>k__BackingField;    // 0x0x24
    public long <LACENPCECNF>k__BackingField;    // 0x0x28
    public long? <ABPIDKFNLNG>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{kJGGLMIPDJB}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <NBLHCOCGAOD>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <BLKFPIBGIEE>k__BackingField;    // 0x0x18
}
...
{
    public long <DPCLBAAFKJO>k__BackingField;    // 0x0x10
    public long <LACENPCECNF>k__BackingField;    // 0x0x18
    public long <MLLCEGDFFAJ>k__BackingField;    // 0x0x20
    public AFDFCMIBJMN <FLCEHEOICCO>k__BackingField;    // 0x0x28
    public int <FNDCDPMGMOD>k__BackingField;    // 0x0x2C
}
...
{
    public long <LACENPCECNF>k__BackingField;    // 0x0x10
    public List<Guid> <CPFDALKCPPJ>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <NBLHCOCGAOD>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <BLKFPIBGIEE>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <JHGAIPHDHOI>k__BackingField;    // 0x0x20
}
...
{
    public long <MLLCEGDFFAJ>k__BackingField;    // 0x0x10
    public long <FBOEICEOJPN>k__BackingField;    // 0x0x18
    public int? <IADHHFCFEKA>k__BackingField;    // 0x0x20
    public int? <HPFEPNFNKPL>k__BackingField;    // 0x0x28
    public long? <CPGIOIKBCIJ>k__BackingField;    // 0x0x30
    public long <AIHLKKIJDHH>k__BackingField;    // 0x0x40
    public long <OFKABEHHJKE>k__BackingField;    // 0x0x48
    public int <HOMLPACADFH>k__BackingField;    // 0x0x50
    public AFDFCMIBJMN <DCFKLDJFOBA>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <BFCOHDCKABE>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public HHIOPGHABDA <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public PMFLBIIBDDN creatorAccountRole;    // 0x0x58
}
...
{
    public HDBBOIHKAEK <KOOHJCMJMIJ>k__BackingField;    // 0x0x10
    public AOCKDICDGMA <NIJCJOILGIJ>k__BackingField;    // 0x0x14
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x18
    public string <HLPJEKEEDPD>k__BackingField;    // 0x0x20
    public bool <DBHOFLODLLM>k__BackingField;    // 0x0x28
}
...
{
    public List<HDBBOIHKAEK> <BPBPCCGKKDN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{gJAHLFBOLMI}   [Service.API]
public class ProgressionEventDTO
{
    public long <FBOEICEOJPN>k__BackingField;    // 0x0x10
    public string <ONHAFKNHMJB>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <HFAGLJBHHHK>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <BNLNFJDGFEG>k__BackingField;    // 0x0x28
    public DateTime <NNJMJFKFCAP>k__BackingField;    // 0x0x30
    public DateTime <JCMPFCKNIDK>k__BackingField;    // 0x0x38
    public DateTime <FEOFBNDAHBB>k__BackingField;    // 0x0x40
    public bool <BLGEIOHFEJJ>k__BackingField;    // 0x0x48
    public int <CBEFIDPPHON>k__BackingField;    // 0x0x4C
    public float <JNHHHJGFEMD>k__BackingField;    // 0x0x50
    public Guid? <GKFAMFGOHLD>k__BackingField;    // 0x0x54
    public string <HPAPAHKLGAP>k__BackingField;    // 0x0x68
    public string <MLOLODBCAHI>k__BackingField;    // 0x0x70
    public string <HINDDNMLNGH>k__BackingField;    // 0x0x78
    public string <DHDNHHIIALL>k__BackingField;    // 0x0x80
}
...
{
    public Guid <MLMPMPFHEBK>k__BackingField;    // 0x0x10
    public int <ONBFFLKEMMP>k__BackingField;    // 0x0x20
    public int <BCNMGLBNGDO>k__BackingField;    // 0x0x24
    public int <HLBGFFFHBKE>k__BackingField;    // 0x0x28
    public long <OAEHMJANFLE>k__BackingField;    // 0x0x30
    public long <PCINLKGMKJH>k__BackingField;    // 0x0x38
}
...
{
    public int <CGHECBOKIEP>k__BackingField;    // 0x0x10
    public int <PAKMOABECGC>k__BackingField;    // 0x0x14
    public int <IFFKDFAIEIN>k__BackingField;    // 0x0x18
    public int <FBEPCPJFINJ>k__BackingField;    // 0x0x1C
    public int <GIMHMJFOGDM>k__BackingField;    // 0x0x20
    public DateTime? <PMOCLELLOLC>k__BackingField;    // 0x0x28
}
...
{
    public long <AHOBDDMFJOA>k__BackingField;    // 0x0x10
    public int <EEJDLECAIIM>k__BackingField;    // 0x0x18
    public string <HODKPAMBGPP>k__BackingField;    // 0x0x20
    public int <PAKMOABECGC>k__BackingField;    // 0x0x28
    public int <NJFNNHNGMHE>k__BackingField;    // 0x0x2C
    public bool <LMGMDDPBBHH>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public IEABJPGNKHF ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool LMCPFLHILOC;    // 0x0x28
}
...
{
    public EFNBGFHLAFG? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public EFNBGFHLAFG DEDNDIAMPBP;  // wrapper
...
{
    public FBCCPDGNONB EOJKODNABMP;  // wrapper
...
{
    public GEFDCDDBMII FLAJIGGIBOB;  // wrapper
    public int? LENBAFPDIJJ;  // wrapper
...
{
    public FFFOALHEDLD MCHOKFCPLOJ;  // wrapper
    public float? GGBKGIPFLNM;  // wrapper
...
{
    public GAHEFPHCMHB UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public HHIOPGHABDA HBLIBBFCHOD;  // wrapper
    public HHIOPGHABDA? LKOLDINOMOK;  // wrapper
...
{
    public CLJFEFJNDNA KFAIKLEOPNB;  // wrapper
...
{
    public PBNNOBIKGMB HOLFPMILAMI;  // wrapper
    public JIGHJMOEEPO IJPCDHNNBGA;  // wrapper
    public byte[] FHEFCMICINP;  // wrapper
    public byte[] NCCFKODFLDC;  // wrapper
    public Color OAIMCLIJEAP;  // wrapper
...
{
    public List<BKDGDGJJECD> DBDFFMKLAMJ;  // wrapper
}
...
{
    public MEOKBGEAMKE PJJGHAOCHPA;  // wrapper
    public HHIOPGHABDA? OAJJLCJNJHG;  // wrapper
...
{
    public MPNFKINMFNJ LKBLGLPCCIA;  // wrapper
...
{
    public GCIPDBHDOEJ inventionId;  // wrapper
}
...
// api/keepsakes/{dOFNMNEMDFH}/collect  [API POST]
public class KeepsakesDOFNMNEMDFHCollectRequest
{
    public Guid DOFNMNEMDFH;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> AOCIOPPIICK;  // wrapper
    public LODDIOOFHND CCHNCDDMPMG;  // wrapper
    public long? IIKHCGCAMCH;  // wrapper
...
{
    public long? EMPCHKOMHOJ;  // wrapper
}
...
{
    public long? EMFFAEIKHBM;  // wrapper
    public long? LKJIJNFNPOI;  // wrapper
    public List<string> OLBDHEIAFIF;  // wrapper
    public DateTime LCHBLBGEFHN;  // wrapper
    public DateTime NDPBILIPNAJ;  // wrapper
    public FHHOIBCGPDB HOLFPMILAMI;  // wrapper
    public PDMGLJINNBG KBPEPPAFMBB;  // wrapper
    public PDMGLJINNBG KLNIODFKNAF;  // wrapper
}
...
{
    public PDMGLJINNBG KBPEPPAFMBB;  // wrapper
    public PDMGLJINNBG HKJLGNAOEEK;  // wrapper
}
...
{
    public Guid FEOJJCBAKLB;  // wrapper
...
{
    public List<LPBGKMNEIBC> BFKDJIMLOAD;  // wrapper
}
...
{
    public Guid OAFOEKCLACA;  // wrapper
    public object Price;  // candidate
...
{
    public Guid OAFOEKCLACA;  // wrapper
    public long? BAEBPOOGBLE;  // wrapper
    public byte? MMMIJMMKPFM;  // wrapper
    public int? OAIMCLIJEAP;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid FEOJJCBAKLB;  // wrapper
    public long? AINJHDKHJKE;  // wrapper
    public long? LDBFJEELGJO;  // wrapper
    public int? DBPBAPJGANO;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> OBPACCONAMD;  // wrapper
...
{
    public IEnumerable<OHFKDJGAICN> DMHOIFKPDKO;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public KHNOONABOMI FLAJIGGIBOB;  // wrapper
    public Guid? BKPAHNOLENF;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public FFFOALHEDLD MCHOKFCPLOJ;  // wrapper
    public long? IDCGMIJEINE;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats MHCNACAKLPE;  // wrapper
}
...
{
    public Guid IDBLPPCOLAK;  // wrapper
...
{
    public Guid HPKPPNGHNMK;  // wrapper
...
{
    public List<FLKCBHGIFIM> KEFAHLODJOK;  // wrapper
    public object roomId;  // candidate
...
{
    public MJHFMEDMDHD POCIALGFBNC;  // wrapper
}
