...
public class AAKPFONDPBD
{
    public bool <FOEPIOFOJDP>k__BackingField;    // 0x0x10
    public JLKBJDLOJLP <MCBLGMEEEIN>k__BackingField;    // 0x0x14
    public int <MICIPCHOOPI>k__BackingField;    // 0x0x18
    public DateTime <HHIPOLOOBKD>k__BackingField;    // 0x0x20
}
...
// AGJAPILBCLE
//   (not directly referenced by a detected call)
public class AGJAPILBCLE
{
    public long <CNPCBIKNLOC>k__BackingField;    // 0x0x10
    public Guid <FFONGNLMLPG>k__BackingField;    // 0x0x18
    public Guid <AKHFBBFAMKB>k__BackingField;    // 0x0x28
    public DateTime <FNACAIFOBOC>k__BackingField;    // 0x0x38
    public string <ONMLBCIBJPP>k__BackingField;    // 0x0x40
    public string <HPNPIBDPOFO>k__BackingField;    // 0x0x48
    public string <BBHFOLNBAJJ>k__BackingField;    // 0x0x50
    public string <JGAACLAJMMF>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// AIHCAJFKEPK
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class AIHCAJFKEPK
{
    public Dictionary<Guid, JODGINNEDOM> <AMIDDEKNCPD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// AMAKCLDOGMB
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class AMAKCLDOGMB
{
    public int <OEPPHAKPFGG>k__BackingField;    // 0x0x10
    public int? <CEMCEFIEBGG>k__BackingField;    // 0x0x14
    public string <BFANNEDPKCG>k__BackingField;    // 0x0x20
    public string <LINMPDDPCMH>k__BackingField;    // 0x0x28
}
...
public class BAKGPNBLLKG : NGKFNDGECFA
{
    public List<CLPIPEKIDFM> EBDLNKHNKNB;    // 0x0x30
    public int <OLJCFOMFHDH>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// BBGDJMGKABE
// base   : AMNBLJNKAPJ`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class BBGDJMGKABE
{
...
// BEEMIIGJJAF
//   (not directly referenced by a detected call)
public class BEEMIIGJJAF
{
    public int <DBJGDKOJFCO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BHFOEODDLOE
//   (not directly referenced by a detected call)
public class BHFOEODDLOE
{
    public int <KHGANCABEOK>k__BackingField;    // 0x0x10
    public DDIEGFOCAJI <NAGNJEOPKBP>k__BackingField;    // 0x0x14
    public List<HJMCGMPENDA> <CGEANMHLLDG>k__BackingField;    // 0x0x18
    public List<HJMCGMPENDA> <OPJAHMGHGCF>k__BackingField;    // 0x0x20
    public bool <CNMMBIPCDOJ>k__BackingField;    // 0x0x28
    public DateTime? <KOOIJHKNKDE>k__BackingField;    // 0x0x30
    public DateTime? <JHDEBEFBNOH>k__BackingField;    // 0x0x40
    public DateTime? <GDFALAIOBFJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// BLOMLKPDEBN
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class BLOMLKPDEBN
{
    public List<int> <PLBOMPLPBIG>k__BackingField;    // 0x0x10
    public string <DJCEJHEMDLB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BOMIFHGAADM
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class BOMIFHGAADM
{
    public List<KJHMEALGMPM> <MAEHPDPKENL>k__BackingField;    // 0x0x10
    public string <DJCEJHEMDLB>k__BackingField;    // 0x0x18
}
...
public class CBBMPMMMMAM
{
    public KONFOBCJBIB <INMOHCOEBGI>k__BackingField;    // 0x0x10
    public PNNHBAKJMDB <MEJNLPNFJOL>k__BackingField;    // 0x0x14
    public int <MKIFAAAIIIE>k__BackingField;    // 0x0x18
    public int <MLNLONHMFNF>k__BackingField;    // 0x0x1C
    public int <FKNNEEECJII>k__BackingField;    // 0x0x20
    public KOJPAIGCEEH <KGCPGFKPHIG>k__BackingField;    // 0x0x24
    public bool <HLAEEANCKGN>k__BackingField;    // 0x0x28
    public float <PPPNCLHEAEF>k__BackingField;    // 0x0x2C
    public int <AGGABCFGMEI>k__BackingField;    // 0x0x30
    public bool <NJHMGFMIEIP>k__BackingField;    // 0x0x34
}
...
public class CCCDPDEKDLD
{
    public CHEFNLCAKAJ <BJDAJPJNHHE>k__BackingField;    // 0x0x10
    public IOHBOFGEIPG <GBDECALJCJK>k__BackingField;    // 0x0x18
    public int <GBJOOLBLOLL>k__BackingField;    // 0x0x20
}
...
public class CCICMOEEOMD : CFFDOHDFMDJ
{
    public OJFJDJAFJDG? <AIGNHDLAJHB>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <IJEKHPAJMLG>k__BackingField;    // 0x0x20
}
...
public class CEMINAAOADD
{
    public List<IFNJIFPPJPD> <NDJGBEEDJEL>k__BackingField;    // 0x0x10
    public BAKBIHJHJEG <OBDOAJMALCD>k__BackingField;    // 0x0x18
}
...
public class CHEFNLCAKAJ
{
    public Guid? <EHBALGEKCCL>k__BackingField;    // 0x0x10
    public Guid <HGEPJFIAEGM>k__BackingField;    // 0x0x24
}
...
public class CHLOCIEMAHC
{
    public int <NJFJFNNIFNA>k__BackingField;    // 0x0x10
    public bool <NMFBCANFNBJ>k__BackingField;    // 0x0x14
    public DateTime <CCONOKLBFED>k__BackingField;    // 0x0x18
    public bool <GJPNPFMCILK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CJLIFJAFKPL
//   (not directly referenced by a detected call)
public class CJLIFJAFKPL
{
    // (no instance fields in the metadata dump)
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{mIKHDHMEOJH}   [Service.Econ]
public enum CLLIODNDJFJ
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
// base   : BHFOEODDLOE
//   (not directly referenced by a detected call)
public class CLPIPEKIDFM : BHFOEODDLOE
{
    public FOOBHHMJFEF <ADJEJBAFNEJ>k__BackingField;    // 0x0x60
}
...
public class DBNBLLIOEBL
{
    public List<MMDOCAPIAKC> <AGABFKKJHPH>k__BackingField;    // 0x0x10
    public string <DJCEJHEMDLB>k__BackingField;    // 0x0x18
}
...
// base   : NGKFNDGECFA
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{cDHOOLAJKFB}   [Service.Econ]
public class DEJFBJLHJHM : NGKFNDGECFA
{
    public int <FPKDMILCAGG>k__BackingField;    // 0x0x30
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x38
    public DateTime <BJGEPCHNKCB>k__BackingField;    // 0x0x40
    public DateTime <FBLPAEJNPLL>k__BackingField;    // 0x0x48
    public KONFOBCJBIB <INMOHCOEBGI>k__BackingField;    // 0x0x50
    public BHFOEODDLOE <PHLBHMBHLLK>k__BackingField;    // 0x0x58
    public List<HLLECMMAGIP> <CMAFCLHPHFF>k__BackingField;    // 0x0x60
    public AAKPFONDPBD <ICJCPJMLONA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// DMMDJDEEHBF
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class DMMDJDEEHBF
{
    public int? <CEGCJDKFCAH>k__BackingField;    // 0x0x10
    public string <BGCEJINIENN>k__BackingField;    // 0x0x18
    public string <PLJEMBOHFLA>k__BackingField;    // 0x0x20
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class DOIHBOGAJBD : ValueType
{
    public string[] DBAPCCFMOKK;    // 0x0x0
}

// --------------------------------------------------------------------------
// ECMINMFCBPJ
//   (not directly referenced by a detected call)
public class ECMINMFCBPJ
{
    public Guid <FFONGNLMLPG>k__BackingField;    // 0x0x10
    public byte <HIONAFEHDIJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EHBCLBHHOJK
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class EHBCLBHHOJK
{
    public bool <EOABPDCMKNI>k__BackingField;    // 0x0x10
    public string <KHDMPAOAEGE>k__BackingField;    // 0x0x18
    public string <AAAMIOIFMJG>k__BackingField;    // 0x0x20
}
...
public class ELALHNGDAJO
{
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x10
    public int <GONOPNEEGGN>k__BackingField;    // 0x0x18
}
...
public class FGBJIBCOKLP
{
    public int <NGNIDNNFGCL>k__BackingField;    // 0x0x10
    public string <EIPJMGGJOOE>k__BackingField;    // 0x0x18
    public List<MJGPLAILANG> <DJKCFEAGAKN>k__BackingField;    // 0x0x20
    public MMBCJOKDIOD <DKKKDHCCGBG>k__BackingField;    // 0x0x28
    public string <IJMOGMGJNKI>k__BackingField;    // 0x0x30
    public DateTime <BJGEPCHNKCB>k__BackingField;    // 0x0x38
    public DateTime <FBLPAEJNPLL>k__BackingField;    // 0x0x40
    public DateTime <PIAANANIFAB>k__BackingField;    // 0x0x48
    public bool? <CJCGFEPGIBN>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// FHEJGKCIHBP
//   (not directly referenced by a detected call)
public class FHEJGKCIHBP
{
    public BPMIFNAAOOA FIHDELKOLHF;    // 0x0x10
    public int EGPMKGPIJOB;    // 0x0x14
}

// --------------------------------------------------------------------------
// FIGHHCLCJKB
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{mJBJADACIFB}   [Service.API]
public class FIGHHCLCJKB
{
    public uint <FPNNLBJGMML>k__BackingField;    // 0x0x10
    public uint? <JFKBLDFBMLI>k__BackingField;    // 0x0x14
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x20
    public string <PJLNFNAPCJP>k__BackingField;    // 0x0x28
    public DateTime <KIMEGMLGCIK>k__BackingField;    // 0x0x30
    public DateTime? <DNOMGGAEAGM>k__BackingField;    // 0x0x38
    public bool <PNBDPAIMNLL>k__BackingField;    // 0x0x48
    public List<LFOINLBHODL> <MHKDNACMLBP>k__BackingField;    // 0x0x50
    public List<string> <FAGBKKFEENG>k__BackingField;    // 0x0x58
    public int <NCECNJMMNEP>k__BackingField;    // 0x0x60
    public int <HMAMGEGGLHJ>k__BackingField;    // 0x0x64
    public int <DBDLPIMNCHC>k__BackingField;    // 0x0x68
}
...
// FMFOLEBCJPE
//   (not directly referenced by a detected call)
public class FMFOLEBCJPE
{
    public Guid <IELKLGHNMJC>k__BackingField;    // 0x0x10
    public int <CELENNMEFPO>k__BackingField;    // 0x0x20
    public int <HBDGPKCJLAC>k__BackingField;    // 0x0x24
    public Guid <INIFIDNBOEG>k__BackingField;    // 0x0x28
    public DateTime <HHIPOLOOBKD>k__BackingField;    // 0x0x38
    public IDEBIGENHDC <FBGGGEGFCIE>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// FMLLMDLDLEC
//   (not directly referenced by a detected call)
public class FMLLMDLDLEC
{
    public Guid <MIJJOBAFNLB>k__BackingField;    // 0x0x10
    public Guid <POMAHNJKADC>k__BackingField;    // 0x0x20
    public DateTime <BJGEPCHNKCB>k__BackingField;    // 0x0x30
    public List<FOOBHHMJFEF> <OGCMKLAAGGM>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// FOOBHHMJFEF
//   (not directly referenced by a detected call)
public class FOOBHHMJFEF
{
    public int <KNLLHBHBJKN>k__BackingField;    // 0x0x10
    public string <BJELCICPIOJ>k__BackingField;    // 0x0x18
    public string <CHDAOLCMOBN>k__BackingField;    // 0x0x20
    public string <PIBGAKMFKOD>k__BackingField;    // 0x0x28
    public string <BFEGHNCAMAN>k__BackingField;    // 0x0x30
    public string <ACAHDDBFKFF>k__BackingField;    // 0x0x38
    public BFIIOKEMLNI? <EDHPNNPDJDA>k__BackingField;    // 0x0x40
    public string <EGGDIBELINO>k__BackingField;    // 0x0x48
    public string <GJJBCAAKBPP>k__BackingField;    // 0x0x50
    public bool <NNEEOFBKCKF>k__BackingField;    // 0x0x58
    public bool <GOEKCPNDLHF>k__BackingField;    // 0x0x59
    public bool <GICCCEGMICH>k__BackingField;    // 0x0x5A
    public KHLDADMPKAJ <HEMHDPELNBN>k__BackingField;    // 0x0x5C
    public int <NMHFBPDENMF>k__BackingField;    // 0x0x60
    public KONFOBCJBIB <INMOHCOEBGI>k__BackingField;    // 0x0x64
    public int <GJCBNNEAECA>k__BackingField;    // 0x0x68
    public JOMEELEPJMG <GJONFEOODCL>k__BackingField;    // 0x0x6C
    public JIOJCDLOEJO <GNODLAJKEOE>k__BackingField;    // 0x0x70
    public int? <IJHLPJDJKID>k__BackingField;    // 0x0x74
    public string <GEAAONOEFDM>k__BackingField;    // 0x0x80
    public PPNMLJOOCCN? OAHLONIMIEI;    // 0x0x88
}
...
public class GACBKLGKAPF
{
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x10
    public string <PJLNFNAPCJP>k__BackingField;    // 0x0x18
    public int? <FFAFFGAHCIA>k__BackingField;    // 0x0x20
    public GPIBEEIINPN? <JJBPOPHHFFP>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// GAMKAEECNHD
//   (not directly referenced by a detected call)
public class GAMKAEECNHD
{
    public long <MBFMBEKJKAE>k__BackingField;    // 0x0x10
    public Guid <AHLLBFIABGF>k__BackingField;    // 0x0x18
    public long <MALOGBFOGCL>k__BackingField;    // 0x0x28
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x30
    public string <PJLNFNAPCJP>k__BackingField;    // 0x0x38
    public int <FFAFFGAHCIA>k__BackingField;    // 0x0x40
    public Guid? <KIKINEJOMHL>k__BackingField;    // 0x0x44
    public DateTime <FNACAIFOBOC>k__BackingField;    // 0x0x58
    public string <KLFPOHCFCNO>k__BackingField;    // 0x0x60
    public KNNBHOGEAOP <NAGNJEOPKBP>k__BackingField;    // 0x0x68
}
...
public class GFKJLEHBALP
{
    public byte <EPNNJEIJALF>k__BackingField;    // 0x0x10
    public int <KMBCAGJCNHH>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// GGLCBCAFNCN
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class GGLCBCAFNCN
{
    public int <CELENNMEFPO>k__BackingField;    // 0x0x10
    public Guid <BGJBBBDBCJM>k__BackingField;    // 0x0x14
    public long <GINKHHAMHFF>k__BackingField;    // 0x0x28
    public DateTime <HHIPOLOOBKD>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GNCMALNOCIG
//   (not directly referenced by a detected call)
public class GNCMALNOCIG
{
    public int <NHHEOFEONMP>k__BackingField;    // 0x0x10
}
...
public class HHNLNEGAGHH
{
    public ELBLOFKHJMM <IDBDCPOIKDC>k__BackingField;    // 0x0x10
    public FMFOLEBCJPE <GNLOHJHEIKB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HJMCGMPENDA
//   (not directly referenced by a detected call)
public class HJMCGMPENDA
{
    public KONFOBCJBIB <INMOHCOEBGI>k__BackingField;    // 0x0x10
    public int <FFAFFGAHCIA>k__BackingField;    // 0x0x14
    public MFBJBAHOEPK <LAPKOFKHLLL>k__BackingField;    // 0x0x18
}
...
// base   : BHFOEODDLOE
//   (not directly referenced by a detected call)
public class HLLECMMAGIP : BHFOEODDLOE
{
    public int <BNFDNLKOMMG>k__BackingField;    // 0x0x60
    public List<JHEMDCIFIDL> <IKHNKDAMJMM>k__BackingField;    // 0x0x68
    public List<JHEMDCIFIDL> <LJENEOPIOBJ>k__BackingField;    // 0x0x70
    public List<JHEMDCIFIDL> <CBAIKNOAOFE>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// IBJGGKAHICN
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class IBJGGKAHICN
{
    public int <ILIBOIJCKNG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IDEBIGENHDC
//   (not directly referenced by a detected call)
public class IDEBIGENHDC
{
    public Guid <IELKLGHNMJC>k__BackingField;    // 0x0x10
    public long <MALOGBFOGCL>k__BackingField;    // 0x0x20
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x28
    public string <PJLNFNAPCJP>k__BackingField;    // 0x0x30
    public string <KLFPOHCFCNO>k__BackingField;    // 0x0x38
    public long <FFAFFGAHCIA>k__BackingField;    // 0x0x40
    public Guid? <KIKINEJOMHL>k__BackingField;    // 0x0x48
    public DateTime <HHIPOLOOBKD>k__BackingField;    // 0x0x60
    public int <HKCCFHIKLOB>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// IFNJIFPPJPD
//   (not directly referenced by a detected call)
public class IFNJIFPPJPD
{
    public int <GHFBOCMMADP>k__BackingField;    // 0x0x10
    public BAKBIHJHJEG <OBDOAJMALCD>k__BackingField;    // 0x0x14
}
...
public class INNPCCAGMLE
{
    public GBBKADHBDGC <OBDOAJMALCD>k__BackingField;    // 0x0x10
    public List<string> <FAGBKKFEENG>k__BackingField;    // 0x0x18
}
...
public class IOFOFAHALPA
{
    public BAKBIHJHJEG <OBDOAJMALCD>k__BackingField;    // 0x0x10
}
...
public class IOGGFIMLLCK : KJHMEALGMPM
{
    public List<JBEHBIEDIGO> <FAGBKKFEENG>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// IOHBOFGEIPG
//   (not directly referenced by a detected call)
public class IOHBOFGEIPG
{
    public long <FFAFFGAHCIA>k__BackingField;    // 0x0x10
    public Guid? <BGJBBBDBCJM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JBEHBIEDIGO
//   (not directly referenced by a detected call)
public class JBEHBIEDIGO
{
    public string <NABLCFGHCFI>k__BackingField;    // 0x0x10
    public CEIEFMENFAH <NAGNJEOPKBP>k__BackingField;    // 0x0x18
}
...
public class JDAMOHFPEPK
{
    public int <CIDCENLPHBC>k__BackingField;    // 0x0x10
    public JENFDBFAKCP <NAGNJEOPKBP>k__BackingField;    // 0x0x14
    public BACNPEPOCAP <FAIIPOLCCCF>k__BackingField;    // 0x0x18
    public BACNPEPOCAP <OHOEMAKIDEM>k__BackingField;    // 0x0x1C
    public BACNPEPOCAP <LHBJDMLCAHK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JHEMDCIFIDL
//   (not directly referenced by a detected call)
public class JHEMDCIFIDL
{
    public bool <HPMDKGFJFPK>k__BackingField;    // 0x0x10
    public FOOBHHMJFEF <ADJEJBAFNEJ>k__BackingField;    // 0x0x18
    public float <EGNPGHGFCCI>k__BackingField;    // 0x0x20
}
...
public class JLBFFPDDPJN
{
    public Guid <PDKDLNKEPLI>k__BackingField;    // 0x0x10
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x20
    public string <KLFPOHCFCNO>k__BackingField;    // 0x0x28
    public DateTime <BJGEPCHNKCB>k__BackingField;    // 0x0x30
    public DateTime? <OMAAJIJBJGK>k__BackingField;    // 0x0x38
    public List<FMLLMDLDLEC> <LHEGIBIIGAM>k__BackingField;    // 0x0x48
}
...
public class JMCFPGEPMBO
{
    public Guid <DELCLPKBNMN>k__BackingField;    // 0x0x10
    public long <ALJJOOAMPIF>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{fPJHBGHDILM}   [Service.API]
...
public class JMCPJNKNKBE
{
    public IOGGFIMLLCK <KHCKGNCCNJO>k__BackingField;    // 0x0x10
    public BAKBIHJHJEG <OBDOAJMALCD>k__BackingField;    // 0x0x18
    public INNPCCAGMLE <GLLMNEGJBAP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JNGADGKDEOD
//   (not directly referenced by a detected call)
public class JNGADGKDEOD
{
    public DateTime <FNACAIFOBOC>k__BackingField;    // 0x0x10
    public string <GLLMBAFLBHB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JODGINNEDOM
//   (not directly referenced by a detected call)
public class JODGINNEDOM
{
    public int <GBJOOLBLOLL>k__BackingField;    // 0x0x10
    public CHEFNLCAKAJ <BJDAJPJNHHE>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/playerevents/v1/all/{jKKKELOONBO}   [Service.API]
public class KDBECALAJJI
{
    public List<KJHMEALGMPM> <MLKABJGAIMP>k__BackingField;    // 0x0x10
    public List<PKKFJHIOPON> <PCGMLIFIHIA>k__BackingField;    // 0x0x18
}
...
// KJHMEALGMPM
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class KJHMEALGMPM
{
    public long <AMEDLIAJLJL>k__BackingField;    // 0x0x10
    public int <JNIGBMAAHDD>k__BackingField;    // 0x0x18
    public long <MALOGBFOGCL>k__BackingField;    // 0x0x20
    public long? <PALJNELHJAG>k__BackingField;    // 0x0x28
    public long? <IGHCJIAEDJL>k__BackingField;    // 0x0x38
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x48
    public string <PJLNFNAPCJP>k__BackingField;    // 0x0x50
    public string <KLFPOHCFCNO>k__BackingField;    // 0x0x58
    public DateTime <IKCCFJMBAEO>k__BackingField;    // 0x0x60
    public DateTime <BBHNLFJAEHD>k__BackingField;    // 0x0x68
    public int <HBCPPJHMEBC>k__BackingField;    // 0x0x70
    public NCPCFBJIGOF <JJBPOPHHFFP>k__BackingField;    // 0x0x74
    public bool <LANCGOFJLMH>k__BackingField;    // 0x0x78
    public bool <PGGCDGPGFJJ>k__BackingField;    // 0x0x79
    public EHMOCMDEOJG <HKADIPHHEKG>k__BackingField;    // 0x0x7C
    public EHMOCMDEOJG <AHJGGNIGKDI>k__BackingField;    // 0x0x80
    public long? <ILAKENGHCHL>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// KLCEGLPPOFO
//   REQUEST  POST   api/avatar/v4/saved/set   [Service.Econ]
public class KLCEGLPPOFO
{
    public int <GONOPNEEGGN>k__BackingField;    // 0x0x10
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x18
    public string <FMMCPBKHHKM>k__BackingField;    // 0x0x20
    public string <EIEBKADNFKA>k__BackingField;    // 0x0x28
    public string <NBLLJMKGMOB>k__BackingField;    // 0x0x30
    public string <MPLLKNGLPPB>k__BackingField;    // 0x0x38
    public string <EPJKONGGELG>k__BackingField;    // 0x0x40
    public string <FNMAJDIJAJJ>k__BackingField;    // 0x0x48
    public GPIBEEIINPN <JJBPOPHHFFP>k__BackingField;    // 0x0x50
    public List<ECMINMFCBPJ> <GCDEBIADGCN>k__BackingField;    // 0x0x58
}
...
public class LAJHDPFCMBA
{
    public int <FFGAKEJAADC>k__BackingField;    // 0x0x10
    public int <DDIFENBOEME>k__BackingField;    // 0x0x14
    public float <AOINNHFKHMF>k__BackingField;    // 0x0x18
    public int <CCELMMCDIFG>k__BackingField;    // 0x0x1C
    public int <LEKMBDFBKLM>k__BackingField;    // 0x0x20
    public int <BDGKFIKJJOE>k__BackingField;    // 0x0x24
    public int <FCBIMBOLKFG>k__BackingField;    // 0x0x28
    public string <NACDJOKHPIO>k__BackingField;    // 0x0x30
    public string <JBDJOGDBJAK>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// LFOINLBHODL
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class LFOINLBHODL
{
    public string <FPNNLBJGMML>k__BackingField;    // 0x0x10
    public string <KHDMPAOAEGE>k__BackingField;    // 0x0x18
    public string <IDFPONNKANH>k__BackingField;    // 0x0x20
    public string <PJLNFNAPCJP>k__BackingField;    // 0x0x28
    public string <BGCEJINIENN>k__BackingField;    // 0x0x30
    public MJPIMACANDC <IDBDCPOIKDC>k__BackingField;    // 0x0x38
    public List<string> <MGPKKEEECLE>k__BackingField;    // 0x0x40
    public List<string> <FAGBKKFEENG>k__BackingField;    // 0x0x48
    public string <GCECLJJEEOI>k__BackingField;    // 0x0x50
    public List<JNGADGKDEOD> <PDCGLHJGPCP>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// LMCNLEGLCFL
// base   : AMNBLJNKAPJ`1<GNHJLPLMMDB>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{oAPPJKOMDMD}   [Service.API]
public class LMCNLEGLCFL
{
    // (no instance fields in the metadata dump)
}
...
public class LMODPANFALC
{
    public List<string> <CPBBOPMOOKL>k__BackingField;    // 0x0x10
    public List<string> <EGPEAADEFHI>k__BackingField;    // 0x0x18
    public List<string> <KPFFPGPBCKM>k__BackingField;    // 0x0x20
}
...
public class LNBEDDAJMLG
{
    public HFILGOKINAC <GFFFODMFNJM>k__BackingField;    // 0x0x10
    public string <GOPDPDHDJJD>k__BackingField;    // 0x0x18
    public int? <DEHPBIKINPC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LNJLIPEAECD
//   RESPONSE GET    api/config/v1/amplitude   [Service.API]
public class LNJLIPEAECD
{
    public string <GHKOHJHOLAG>k__BackingField;    // 0x0x10
    public string <GICIABMKJMM>k__BackingField;    // 0x0x18
    public bool <MJJJGAGHJDC>k__BackingField;    // 0x0x20
    public string <CEAGNALOIKP>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// LPJMPCIIINP
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class LPJMPCIIINP
{
    public Guid? <IELKLGHNMJC>k__BackingField;    // 0x0x10
    public long? <MALOGBFOGCL>k__BackingField;    // 0x0x28
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x38
    public string <PJLNFNAPCJP>k__BackingField;    // 0x0x40
    public string <KLFPOHCFCNO>k__BackingField;    // 0x0x48
    public IOHBOFGEIPG <BENGODFBMMJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// MDEFLFCBHAE
//   RESPONSE GET    api/config/v2   [Service.API]
public class MDEFLFCBHAE
{
    public Dictionary<int, int> <DFDBINGCHIM>k__BackingField;    // 0x0x10
    public List<JJOBLDIIAOG> <BCHMOGLLEJP>k__BackingField;    // 0x0x18
    public FHEJGKCIHBP[][] <NMAPGGJDMPL>k__BackingField;    // 0x0x20
    public GNCMALNOCIG <AHMLCNPGJLG>k__BackingField;    // 0x0x28
    public ONKICGOJKPE <OIBGLIMEDIO>k__BackingField;    // 0x0x30
    public PIKMEGPAOAH <HOKOHAFAMAI>k__BackingField;    // 0x0x38
    public BEEMIIGJJAF <NDBBCGNBBKM>k__BackingField;    // 0x0x40
    public OCDAGMOKIIE <EFLCOGFHCHL>k__BackingField;    // 0x0x48
    public string <NCLBBGMLNBC>k__BackingField;    // 0x0x50
}
...
public class MEECPHLEINO
{
    public int <GCLJCMLIEHN>k__BackingField;    // 0x0x10
    public int <NJFJFNNIFNA>k__BackingField;    // 0x0x14
    public float <DMLNGBOECON>k__BackingField;    // 0x0x18
    public float <FIPJFJMKHLD>k__BackingField;    // 0x0x1C
    public bool <NMFBCANFNBJ>k__BackingField;    // 0x0x20
    public bool <FHBMFNACPNE>k__BackingField;    // 0x0x21
    public bool <ALBFADAINBI>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// MFBJBAHOEPK
//   (not directly referenced by a detected call)
public class MFBJBAHOEPK
{
    public int <AKFNGABIKEO>k__BackingField;    // 0x0x10
    public DateTime? <KOEIDOBEHFJ>k__BackingField;    // 0x0x18
    public DateTime? <IABPLPDBMCP>k__BackingField;    // 0x0x28
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{eKLJPJNHLFK}   [Service.Econ]
public class MICBMIHCOIF
{
    public ELBLOFKHJMM <IDBDCPOIKDC>k__BackingField;    // 0x0x10
    public IDEBIGENHDC <FBGGGEGFCIE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MICFLGBCLID
//   (not directly referenced by a detected call)
public class MICFLGBCLID
{
    public long <KLBFMLGOAEC>k__BackingField;    // 0x0x10
    public long <AMEDLIAJLJL>k__BackingField;    // 0x0x18
    public int <KLDIDENLIAI>k__BackingField;    // 0x0x20
    public DateTime <FNACAIFOBOC>k__BackingField;    // 0x0x28
    public FKBFHOGDFFC <NAGNJEOPKBP>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// MIDECCDPELH
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class MIDECCDPELH
{
    public IOPPAIKINNC <GFFFODMFNJM>k__BackingField;    // 0x0x10
    public int <ILIBOIJCKNG>k__BackingField;    // 0x0x14
    public long <JCBMHBOMNPM>k__BackingField;    // 0x0x18
    public bool <HONMFDNKAFG>k__BackingField;    // 0x0x20
    public string <LCCKMPPGDOL>k__BackingField;    // 0x0x28
    public int? <LPDKGACLMIA>k__BackingField;    // 0x0x30
    public bool <FDIHMAIEDEF>k__BackingField;    // 0x0x38
    public bool <OHJHGAMAHLJ>k__BackingField;    // 0x0x39
    public bool <APFLDDIPOFD>k__BackingField;    // 0x0x3A
    public bool <KJPDBPECHJA>k__BackingField;    // 0x0x3B
    public string <DJKIGIBPHNB>k__BackingField;    // 0x0x40
    public DateTime? <KGPAEFGHEKD>k__BackingField;    // 0x0x48
    public float <HGDNDBDMJOK>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// MJGPLAILANG
//   (not directly referenced by a detected call)
public class MJGPLAILANG
{
    public int <HGKKLKBJGNA>k__BackingField;    // 0x0x10
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x18
    public string <OJNEFINGHNN>k__BackingField;    // 0x0x20
    public string <PJLNFNAPCJP>k__BackingField;    // 0x0x28
    public string <CHDAOLCMOBN>k__BackingField;    // 0x0x30
    public bool <CDMMCLMCDBG>k__BackingField;    // 0x0x38
    public int <GONOPNEEGGN>k__BackingField;    // 0x0x3C
    public CJLIFJAFKPL <DGHLCKOFKKK>k__BackingField;    // 0x0x40
    public DGGJNNMGCIE NFIGOAIBGAD;    // 0x0x48
    public DGGJNNMGCIE OHGEFOHCEBG;    // 0x0x50
    public DGGJNNMGCIE PPOIMNDLPBF;    // 0x0x58
    public ECEIALAGJKL CKGAMEDLOKO;    // 0x0x60
}
...
public class MLKIBKNOAGG
{
    public long <MALOGBFOGCL>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <JMJDCBOLMMK>k__BackingField;    // 0x0x18
    public KEHADJBDNGE <AKPBHCCEMHP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MMBCJOKDIOD
//   (not directly referenced by a detected call)
public class MMBCJOKDIOD
{
    public long <KNLLHBHBJKN>k__BackingField;    // 0x0x10
    public string <BFEGHNCAMAN>k__BackingField;    // 0x0x18
    public string <IMDENOFIBLI>k__BackingField;    // 0x0x20
    public BFIIOKEMLNI? <EDHPNNPDJDA>k__BackingField;    // 0x0x28
    public string <EGGDIBELINO>k__BackingField;    // 0x0x30
    public string <GJJBCAAKBPP>k__BackingField;    // 0x0x38
    public FEKKMLHJEDE <CDILGNHNCAP>k__BackingField;    // 0x0x40
    public int <CDJMCGIHHEO>k__BackingField;    // 0x0x44
    public int <EFIJKCLNDJL>k__BackingField;    // 0x0x48
    public JIOJCDLOEJO? <DCPCBKOBAJH>k__BackingField;    // 0x0x4C
    public KHLDADMPKAJ? <EGKIINGOPBO>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// MMDOCAPIAKC
//   (not directly referenced by a detected call)
public class MMDOCAPIAKC
{
    public int <EAFDFDLNBMM>k__BackingField;    // 0x0x10
    public DateTime <FNACAIFOBOC>k__BackingField;    // 0x0x18
    public DateTime? <NDIOGHGJAPB>k__BackingField;    // 0x0x20
}
...
public class MNFNNAAEGMF
{
    public CEOCJCHHOGA <IDBDCPOIKDC>k__BackingField;    // 0x0x10
    public OOKMEMANBOL <NHJLFEKCFJF>k__BackingField;    // 0x0x18
    public PPPIDEHNPJB <OMNJOLOINGD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MNIEJECIECO
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class MNIEJECIECO
{
    public List<JBEHBIEDIGO> <FAGBKKFEENG>k__BackingField;    // 0x0x10
}
...
public class NFJAEDGOABP
{
    public Dictionary<string, AGJAPILBCLE> <LIPFIBBHJLA>k__BackingField;    // 0x0x10
}
...
public class NNPNFNHMIJI
{
    public CLLIODNDJFJ <IDBDCPOIKDC>k__BackingField;    // 0x0x10
    public GAMKAEECNHD <MBGIIKGHEEP>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/avatar/v2/{jKKKELOONBO}   [Service.Econ]
public class NOLHHBMDEBK
{
    public string <EIEBKADNFKA>k__BackingField;    // 0x0x10
    public string <NBLLJMKGMOB>k__BackingField;    // 0x0x18
    public string <MPLLKNGLPPB>k__BackingField;    // 0x0x20
    public string <EPJKONGGELG>k__BackingField;    // 0x0x28
    public string <FNMAJDIJAJJ>k__BackingField;    // 0x0x30
    public List<ECMINMFCBPJ> <GCDEBIADGCN>k__BackingField;    // 0x0x38
}
...
public class OBAGNEMBAFK : CFFDOHDFMDJ
{
    public ABNILMJBGKG? <AIGNHDLAJHB>k__BackingField;    // 0x0x18
    public GGLCBCAFNCN <LDJIMBCBGAE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OCDAGMOKIIE
//   (not directly referenced by a detected call)
public class OCDAGMOKIIE
{
    public float <JFKKEMHIAFP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OIPGFEHPHGC
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class OIPGFEHPHGC
{
    public Dictionary<Guid, HHNLNEGAGHH> <EKNEJFFOHLP>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/keepsakes/{aBCJLNPFGLC}   [Service.API]
...
public class OMJLLFDFEJL
{
    public bool <ALOCDGMHFKA>k__BackingField;    // 0x0x10
    public string <FBILGKFKFJE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ONKICGOJKPE
//   (not directly referenced by a detected call)
public class ONKICGOJKPE
{
    public float <CJBLGNDANCL>k__BackingField;    // 0x0x10
    public float <MLJDIBKMMCH>k__BackingField;    // 0x0x14
    public float <CJDIHAMEBDK>k__BackingField;    // 0x0x18
    public float <OCEEHMIDNOH>k__BackingField;    // 0x0x1C
    public float <CGIIALPPPLH>k__BackingField;    // 0x0x20
    public float <JECDLHMANNB>k__BackingField;    // 0x0x24
    public float <AJFIBPIDCKO>k__BackingField;    // 0x0x28
    public float <IMKMFIMDHCO>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// OOKMEMANBOL
//   (not directly referenced by a detected call)
public class OOKMEMANBOL
{
    public ObscuredLong <ODBMFGJCDKP>k__BackingField;    // 0x0x10
    public string <AHLLBFIABGF>k__BackingField;    // 0x0x38
    public ObscuredInt <JNIGBMAAHDD>k__BackingField;    // 0x0x40
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x58
    public string <PJLNFNAPCJP>k__BackingField;    // 0x0x60
    public string <KLFPOHCFCNO>k__BackingField;    // 0x0x68
    public int <PINKJHHJLBI>k__BackingField;    // 0x0x70
    public GPIBEEIINPN <JJBPOPHHFFP>k__BackingField;    // 0x0x74
    public DateTime <HHIPOLOOBKD>k__BackingField;    // 0x0x78
    public DateTime <FNACAIFOBOC>k__BackingField;    // 0x0x80
    public DateTime? <LPBJKLMGHIJ>k__BackingField;    // 0x0x88
    public long? <CHBLBALHMNA>k__BackingField;    // 0x0x98
    public int <DNLKHECEFOA>k__BackingField;    // 0x0xA8
    public int <BIKPOKCHLNI>k__BackingField;    // 0x0xAC
    public int <OMIEDODBIFG>k__BackingField;    // 0x0xB0
    public IJGDLOLLMKD <HAOADPMDMCK>k__BackingField;    // 0x0xB4
    public IJGDLOLLMKD <ONCFOHPNJJL>k__BackingField;    // 0x0xB8
    public ObscuredBool <ONGLKCAPPBG>k__BackingField;    // 0x0xBC
    public ObscuredBool <GKMBMNPDBII>k__BackingField;    // 0x0xC8
    public ObscuredBool <LEAGKMIMKAG>k__BackingField;    // 0x0xD4
    public int? <FFAFFGAHCIA>k__BackingField;    // 0x0xE0
    public bool <NAHMBPLHLHC>k__BackingField;    // 0x0xE8
}

// --------------------------------------------------------------------------
// OPKCPIEJPLE
//   RESPONSE ?      api/inventions/   [Service.API]
//   RESPONSE GET    api/inventions/v1/personaldetails/{lLCJLJICMDE}   [Service.API]
public class OPKCPIEJPLE
{
    public bool <EDINHJJNKNE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PCCIMAOKBCG
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class PCCIMAOKBCG
{
    public long <MBFMBEKJKAE>k__BackingField;    // 0x0x10
    public int <CELENNMEFPO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PIKMEGPAOAH
//   (not directly referenced by a detected call)
public class PIKMEGPAOAH
{
    public int <OGGIICFPLHO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PINLNENHECF
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItemDescs   [Service.API]
public class PINLNENHECF
{
    public List<string> <NEAKLFPEAEB>k__BackingField;    // 0x0x10
    public byte <EPNNJEIJALF>k__BackingField;    // 0x0x18
    public int <KMBCAGJCNHH>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// PKKFJHIOPON
//   (not directly referenced by a detected call)
public class PKKFJHIOPON
{
    public KJHMEALGMPM <KHCKGNCCNJO>k__BackingField;    // 0x0x10
    public MICFLGBCLID <CBOCLIKKJLF>k__BackingField;    // 0x0x18
}
...
public class POLGBIBJLCK
{
    public bool <ALOCDGMHFKA>k__BackingField;    // 0x0x10
    public string <LCCKMPPGDOL>k__BackingField;    // 0x0x18
}
...
public class PPNMLJOOCCN : ValueType
{
    public string JMIKMHFCDCN;    // 0x0x0
    public DOIHBOGAJBD HCGPIMKINLH;    // 0x0x8
    public Guid DBGOJCAHCHN;    // 0x0x10
    public Color? AGKEJFDIPAD;    // 0x0x20
}

// --------------------------------------------------------------------------
// PPPIDEHNPJB
//   (not directly referenced by a detected call)
public class PPPIDEHNPJB
{
    public long <ODBMFGJCDKP>k__BackingField;    // 0x0x10
    public string <AHLLBFIABGF>k__BackingField;    // 0x0x18
    public int <BDBBOAFKJMP>k__BackingField;    // 0x0x20
    public int <DGDGOBBNFPF>k__BackingField;    // 0x0x24
    public int <KJDGFJLMAPG>k__BackingField;    // 0x0x28
    public int <MGJIGPAGCCK>k__BackingField;    // 0x0x2C
    public int <ALFJCNOPHFM>k__BackingField;    // 0x0x30
    public string <GMAMBIDMJPB>k__BackingField;    // 0x0x38
    public string <JNCMNKPCMBK>k__BackingField;    // 0x0x40
}
...
{
    public long <MALOGBFOGCL>k__BackingField;    // 0x0x10
    public long? <PALJNELHJAG>k__BackingField;    // 0x0x18
    public KNBGGKHAOAH <FDDLHJEBAHF>k__BackingField;    // 0x0x28
}
...
{
    public IIPGCNFADAE <OBDOAJMALCD>k__BackingField;    // 0x0x10
    public string <PCKLLNMOJPE>k__BackingField;    // 0x0x18
    public string <CIFIGLLACKE>k__BackingField;    // 0x0x20
    public string <IPGFABBCODO>k__BackingField;    // 0x0x28
}
...
{
    public long <AMEDLIAJLJL>k__BackingField;    // 0x0x10
    public long? <LKAKMCNMCJC>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public LEJFEIOIGIL FilterType;    // 0x0x20
...
{
    public KNBGGKHAOAH <IPKOBDNLHHI>k__BackingField;    // 0x0x10
    public string <ICKGIEOMBDE>k__BackingField;    // 0x0x18
    public int <CDNONKNLHMM>k__BackingField;    // 0x0x20
    public int <BBKNEBEKPOG>k__BackingField;    // 0x0x24
    public string <LEALJEBHDJC>k__BackingField;    // 0x0x28
    public string <OKPPLIHKPIM>k__BackingField;    // 0x0x30
}
...
{
    public int <CELENNMEFPO>k__BackingField;    // 0x0x10
    public Guid <GGOEJKLJLIG>k__BackingField;    // 0x0x14
    public DateTime <LNCGFMLEPGG>k__BackingField;    // 0x0x28
}
...
{
    public bool <BNHEIJDALHH>k__BackingField;    // 0x0x10
    public int <DKCBDBLMFNJ>k__BackingField;    // 0x0x14
    public bool <AKOEAGLHJAD>k__BackingField;    // 0x0x18
}
...
{
    public Guid <GGOEJKLJLIG>k__BackingField;    // 0x0x10
    public KNBGGKHAOAH <AOILFKEKOHB>k__BackingField;    // 0x0x20
    public int <CMNMFLDGPJO>k__BackingField;    // 0x0x24
    public long <MALOGBFOGCL>k__BackingField;    // 0x0x28
    public long? <PALJNELHJAG>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{oHAAGCLGODK}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <FLLAFCOLGIM>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <DLGFMJIKCEP>k__BackingField;    // 0x0x18
}
...
{
    public long <BGJANBLBACF>k__BackingField;    // 0x0x10
    public long <MALOGBFOGCL>k__BackingField;    // 0x0x18
    public long <GMPDIILLEPE>k__BackingField;    // 0x0x20
    public AJBAOAFEGGP <NAGNJEOPKBP>k__BackingField;    // 0x0x28
    public int <IGMBHLKCHIG>k__BackingField;    // 0x0x2C
}
...
{
    public long <MALOGBFOGCL>k__BackingField;    // 0x0x10
    public List<Guid> <FPCKNOEIDBP>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <FLLAFCOLGIM>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <DLGFMJIKCEP>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <GHNFKPLLDPA>k__BackingField;    // 0x0x20
}
...
{
    public long <GMPDIILLEPE>k__BackingField;    // 0x0x10
    public long <JBJHJFCKCFI>k__BackingField;    // 0x0x18
    public int? <KECGMEJCENP>k__BackingField;    // 0x0x20
    public int? <GABIFDKOBAH>k__BackingField;    // 0x0x28
    public long? <MBJACIABABA>k__BackingField;    // 0x0x30
    public long <FJLPIDOFMFB>k__BackingField;    // 0x0x40
    public long <JLHKHFKDICE>k__BackingField;    // 0x0x48
    public int <CLFDENGCJFD>k__BackingField;    // 0x0x50
    public AJBAOAFEGGP <MBGAMLKGOHI>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <PIBNGMCMOBG>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public JIOJCDLOEJO <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public DJAGGKCHHII creatorAccountRole;    // 0x0x58
}
...
{
    public FPHPOGEKEDI <KDCJKHKMGCO>k__BackingField;    // 0x0x10
    public NPIHJCFOODC <LENBLFNCEEF>k__BackingField;    // 0x0x14
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x18
    public string <PJLNFNAPCJP>k__BackingField;    // 0x0x20
    public bool <PIMFJECAENI>k__BackingField;    // 0x0x28
}
...
{
    public List<FPHPOGEKEDI> <NJMOBFFOKEI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{fPJHBGHDILM}   [Service.API]
public class ProgressionEventDTO
{
    public long <JBJHJFCKCFI>k__BackingField;    // 0x0x10
    public string <CBGPHCLCALN>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <CBAIKNOAOFE>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <CGPGHHGFINJ>k__BackingField;    // 0x0x28
    public DateTime <IKCCFJMBAEO>k__BackingField;    // 0x0x30
    public DateTime <BBHNLFJAEHD>k__BackingField;    // 0x0x38
    public DateTime <KOFNKFGFAEI>k__BackingField;    // 0x0x40
    public bool <LOELNODNIHA>k__BackingField;    // 0x0x48
    public int <CONDHMLPAGC>k__BackingField;    // 0x0x4C
    public float <GODKDKAECJD>k__BackingField;    // 0x0x50
    public Guid? <KFGNOBAKCAL>k__BackingField;    // 0x0x54
    public string <KFIMEDKFCHN>k__BackingField;    // 0x0x68
    public string <NIIOMOKGIBG>k__BackingField;    // 0x0x70
    public string <PFCKPBKPKBF>k__BackingField;    // 0x0x78
    public string <FHHAEKBAIKE>k__BackingField;    // 0x0x80
}
...
{
    public Guid <EFJHDMJDGFA>k__BackingField;    // 0x0x10
    public int <MAKEOCFAPFP>k__BackingField;    // 0x0x20
    public int <CNJOGCCPFEC>k__BackingField;    // 0x0x24
    public int <MKNJNBPLAEH>k__BackingField;    // 0x0x28
    public long <BAMKOJPPBIN>k__BackingField;    // 0x0x30
    public long <NJKLNFHFNJL>k__BackingField;    // 0x0x38
}
...
{
    public int <CELENNMEFPO>k__BackingField;    // 0x0x10
    public int <CDJMCGIHHEO>k__BackingField;    // 0x0x14
    public int <CKHDABOJAID>k__BackingField;    // 0x0x18
    public int <FBGIBOJBBHE>k__BackingField;    // 0x0x1C
    public int <GFEAFBFJIBM>k__BackingField;    // 0x0x20
    public DateTime? <GBHNMKAFKAN>k__BackingField;    // 0x0x28
}
...
{
    public long <BBFHPAGPDNB>k__BackingField;    // 0x0x10
    public int <KNLLHBHBJKN>k__BackingField;    // 0x0x18
    public string <KLFPOHCFCNO>k__BackingField;    // 0x0x20
    public int <CDJMCGIHHEO>k__BackingField;    // 0x0x28
    public int <OKNMKIAMCPK>k__BackingField;    // 0x0x2C
    public bool <BEMALBABDIF>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public PKHGIAIMIAI ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool JFEFMIMGKOM;    // 0x0x28
}
...
{
    public HIHOIGJDJGB? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public HIHOIGJDJGB MNDDHOIBPGB;  // wrapper
...
{
    public OJGJIKEDJMJ NAEDLFLFMHF;  // wrapper
...
{
    public LPODKCHAKHO KLGGKKGCLHM;  // wrapper
    public int? GPADNIMPCPO;  // wrapper
...
{
    public IOPPAIKINNC OOFNICHEBNC;  // wrapper
    public float? IHKALEAEEMO;  // wrapper
...
{
    public PBHLEAONFFP UnlockedLevel;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public JIOJCDLOEJO MFPELEJLJLD;  // wrapper
    public JIOJCDLOEJO? CIEHFJEIOJJ;  // wrapper
...
{
    public MJGPLAILANG BHOCFFAHJKM;  // wrapper
...
{
    public GPIBEEIINPN GNNOLBBLPHD;  // wrapper
    public DLFHNDJMCHJ JAOGEKDFKHD;  // wrapper
    public byte[] NHJPLBEPJJE;  // wrapper
    public byte[] JNNPJKJLAHF;  // wrapper
    public Color CMDNLIJPJJE;  // wrapper
...
{
    public List<OKIAHOMDNHJ> NFIABLALJAD;  // wrapper
}
...
{
    public KDADPNNKFBD PPDMACMDHDN;  // wrapper
    public JIOJCDLOEJO? AOMFAFHLCAM;  // wrapper
...
{
    public AGOELBKIOMB IOHBGLMJGJE;  // wrapper
...
{
    public OOKMEMANBOL inventionId;  // wrapper
}
...
// api/keepsakes/{aBCJLNPFGLC}/collect  [API POST]
public class KeepsakesABCJLNPFGLCCollectRequest
{
    public Guid ABCJLNPFGLC;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> DGAADDBOCCF;  // wrapper
    public MOHGFNBDKJI JKNFMBJLGAC;  // wrapper
    public long? AHLGFJPMMNL;  // wrapper
...
{
    public long? CHMKFKMFODN;  // wrapper
}
...
{
    public long? HCBHLEILMNO;  // wrapper
    public long? NIFOJAAMDGB;  // wrapper
    public List<string> ALGJKBFMOHF;  // wrapper
    public DateTime AOBHKJKOOND;  // wrapper
    public DateTime KJGNCKBPPEI;  // wrapper
    public NCPCFBJIGOF GNNOLBBLPHD;  // wrapper
    public EHMOCMDEOJG GEAMPIAICJO;  // wrapper
    public EHMOCMDEOJG PODICHICDIG;  // wrapper
}
...
{
    public EHMOCMDEOJG GEAMPIAICJO;  // wrapper
    public EHMOCMDEOJG EFMEHOFMMFO;  // wrapper
}
...
{
    public Guid LNFCNDBJDGG;  // wrapper
...
{
    public List<IGGMEMLNDFN> AMEFJPKFMPG;  // wrapper
}
...
{
    public Guid POBPLPIOAEB;  // wrapper
    public object Price;  // candidate
...
{
    public Guid POBPLPIOAEB;  // wrapper
    public long? NOGAJHKCNJC;  // wrapper
    public byte? OJOHDLMJFCC;  // wrapper
    public int? CMDNLIJPJJE;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid LNFCNDBJDGG;  // wrapper
    public long? MBDJOKIBPCM;  // wrapper
    public long? IHHAAIICBKH;  // wrapper
    public int? NCDJCLLFOIF;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> FKGPFMNALNI;  // wrapper
...
{
    public IEnumerable<GNICDLJGLBM> GOHJLKBPGLE;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public KNNBHOGEAOP KLGGKKGCLHM;  // wrapper
    public Guid? BILGIIFIBMJ;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public IOPPAIKINNC OOFNICHEBNC;  // wrapper
    public long? IIHMNIGCGAK;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats DFCNBFGBHNG;  // wrapper
}
...
{
    public Guid AIACMKAAEIO;  // wrapper
...
{
    public Guid MNJCHANODJM;  // wrapper
...
{
    public List<FNDGLKNGPLC> PIIHMCLAHHD;  // wrapper
    public object roomId;  // candidate
...
{
    public MJPIMACANDC JCDJLOHJPNN;  // wrapper
}
