...
public class AAIKMIMLOIP
{
    public int <DAKBNLOHHGH>k__BackingField;    // 0x0x10
    public string <BPCICACJIBI>k__BackingField;    // 0x0x18
    public string <HBPGEBCFFMA>k__BackingField;    // 0x0x20
    public string <LGOPFMMDIDF>k__BackingField;    // 0x0x28
    public string <KMAAJHCIODE>k__BackingField;    // 0x0x30
    public bool <EPJKECMHKIB>k__BackingField;    // 0x0x38
    public int <NKKDBENODCF>k__BackingField;    // 0x0x3C
    public LEKEFJDPBNL <KELPKEHCAMI>k__BackingField;    // 0x0x40
    public KHAAGNJENCO IJJHIFMHIJD;    // 0x0x48
    public KHAAGNJENCO HMKFNBBDEFL;    // 0x0x50
    public KHAAGNJENCO FOGAGBGBNFE;    // 0x0x58
    public CDJHPDOEIPF DOBKAJKECKP;    // 0x0x60
}

// --------------------------------------------------------------------------
// ADJABLIAMKF
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class ADJABLIAMKF
{
    public List<FLEIPIOMCAM> <ICOKBPPIECB>k__BackingField;    // 0x0x10
}
...
public class AGJCBKBCEKF
{
    public int <MPMDGHJHJJE>k__BackingField;    // 0x0x10
    public int <IMPJKILAHNO>k__BackingField;    // 0x0x14
    public float <LDPBHIIBAIL>k__BackingField;    // 0x0x18
    public float <FPCJILGMOCI>k__BackingField;    // 0x0x1C
    public bool <MANDDHEPDCA>k__BackingField;    // 0x0x20
    public bool <CCOMCCJNNEB>k__BackingField;    // 0x0x21
    public bool <OHEKGNPFKMK>k__BackingField;    // 0x0x22
}
...
public class AJKHLANBAGP
{
    public KJFLMAMHFBL <DHFHCFFJAOP>k__BackingField;    // 0x0x10
    public LDFACEIGCHD <DOOFNODPJKL>k__BackingField;    // 0x0x18
    public int <OJMJEKHJCFO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ALGDPMHOPGG
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Econ]
public class ALGDPMHOPGG
{
    public Guid <IPHDOBJIHBN>k__BackingField;    // 0x0x10
    public string <BPCICACJIBI>k__BackingField;    // 0x0x20
    public string <BGKGFOLFHAH>k__BackingField;    // 0x0x28
    public DateTime <HJPJAOKKIFH>k__BackingField;    // 0x0x30
    public DateTime? <FKMKNKGEBDB>k__BackingField;    // 0x0x38
    public List<EJFEBKBCIPP> <KIDDPKJIBOF>k__BackingField;    // 0x0x48
}
...
public class APECKBDEABB
{
    public List<int> <OFLCCGIPCBJ>k__BackingField;    // 0x0x10
    public string <OBBBIMINBFL>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/keepsakes/{hODMOHOMIKF}   [Service.API]
...
public class BFHHKEIBHJN
{
    public bool <AGKLOCNCGMM>k__BackingField;    // 0x0x10
    public string <MEJIELNMDLJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BGKFNELONJI
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class BGKFNELONJI
{
    public bool <FCOODEACIJI>k__BackingField;    // 0x0x10
    public string <PJCFNFKHPFB>k__BackingField;    // 0x0x18
    public string <DGEKDLFJJHH>k__BackingField;    // 0x0x20
}
...
public class BJHGJPGDGJO
{
    public Guid <JBININEAPFJ>k__BackingField;    // 0x0x10
    public long <IHCCMLGFLLN>k__BackingField;    // 0x0x20
}
...
public class BJNIPAANDLB
{
    public DFMGAIDFDLG <FODAHLGOLHA>k__BackingField;    // 0x0x10
    public OIOKCFDNDMI <ILHKGDMNOBC>k__BackingField;    // 0x0x18
}
...
public class BKGGJPODKOF
{
    public int <OPHKCLCMFMI>k__BackingField;    // 0x0x10
    public DGNMMDOMAKB <EMHEOKACCLA>k__BackingField;    // 0x0x14
    public IEGNPBNGMDG <DDGADFGDFIN>k__BackingField;    // 0x0x18
    public IEGNPBNGMDG <OMGPMOBKLJE>k__BackingField;    // 0x0x1C
    public IEGNPBNGMDG <IGCIGPBELFC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BKGHAIHJBHK
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class BKGHAIHJBHK
{
    public long <DJHEPPPAILM>k__BackingField;    // 0x0x10
    public int <MDGNLKGHGMI>k__BackingField;    // 0x0x18
}
...
// BMKLONHENII
//   (not directly referenced by a detected call)
public class BMKLONHENII
{
    public ObscuredLong <EBDAMDBFCDO>k__BackingField;    // 0x0x10
    public string <OLAACCKMIBF>k__BackingField;    // 0x0x38
    public ObscuredInt <EHLAGIDJLEA>k__BackingField;    // 0x0x40
    public string <BPCICACJIBI>k__BackingField;    // 0x0x58
    public string <LGOPFMMDIDF>k__BackingField;    // 0x0x60
    public string <BGKGFOLFHAH>k__BackingField;    // 0x0x68
    public int <NEBCGDCKADH>k__BackingField;    // 0x0x70
    public LILCONHACAJ <MMNABPCHILN>k__BackingField;    // 0x0x74
    public DateTime <LFHANBPNHFM>k__BackingField;    // 0x0x78
    public DateTime <BLMCDFNKIPG>k__BackingField;    // 0x0x80
    public DateTime? <KPIIMMDKPHF>k__BackingField;    // 0x0x88
    public long? <DIBNHHDKLPC>k__BackingField;    // 0x0x98
    public int <MBJDCLOHFMJ>k__BackingField;    // 0x0xA8
    public int <KLGPAPNIIHF>k__BackingField;    // 0x0xAC
    public int <JLODIOEGHCI>k__BackingField;    // 0x0xB0
    public HJDIPBDPJHH <BDDLHFJAALI>k__BackingField;    // 0x0xB4
    public HJDIPBDPJHH <COLNOKIEKGH>k__BackingField;    // 0x0xB8
    public ObscuredBool <FGJONOIEJBF>k__BackingField;    // 0x0xBC
    public ObscuredBool <ANIEILIKMJH>k__BackingField;    // 0x0xC8
    public ObscuredBool <PIPCMCCKNKK>k__BackingField;    // 0x0xD4
    public int? <HLICFIEADHO>k__BackingField;    // 0x0xE0
    public bool <GDICJGGPFHD>k__BackingField;    // 0x0xE8
}
...
// CDNPJCMFNEM
//   (not directly referenced by a detected call)
public class CDNPJCMFNEM
{
    public bool <CIIHIPGBFPC>k__BackingField;    // 0x0x10
    public DFCAAKPHCNA <PAIBKHNNOGK>k__BackingField;    // 0x0x18
    public float <JCNJEDEMBHB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CIDPNPPIJKD
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.Econ]
public class CIDPNPPIJKD
{
    public int <MPPIMGGNKPM>k__BackingField;    // 0x0x10
    public string <FNJDAFKGELD>k__BackingField;    // 0x0x18
    public List<AAIKMIMLOIP> <NAIFDMOIKIL>k__BackingField;    // 0x0x20
    public EEGPNNOGEFF <HOMOOFOONNK>k__BackingField;    // 0x0x28
    public string <MFAPGPIAHKN>k__BackingField;    // 0x0x30
    public DateTime <HJPJAOKKIFH>k__BackingField;    // 0x0x38
    public DateTime <MODAJPEFMND>k__BackingField;    // 0x0x40
    public DateTime <OKPGJDEOBCO>k__BackingField;    // 0x0x48
    public bool? <KBJPBHOPBIL>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// CIEFKIAJMEF
//   (not directly referenced by a detected call)
public class CIEFKIAJMEF
{
    public int <BDNOEBCIFHA>k__BackingField;    // 0x0x10
    public DOHCMEOCADN <HFFNABDJLNC>k__BackingField;    // 0x0x14
}
...
public class CIKMPFJOGEM
{
    public int <IMPJKILAHNO>k__BackingField;    // 0x0x10
    public bool <MANDDHEPDCA>k__BackingField;    // 0x0x14
    public DateTime <EBMFECAPHBH>k__BackingField;    // 0x0x18
    public bool <LJKPLHLKHGM>k__BackingField;    // 0x0x20
}
...
public class CNMJIPNAEON
{
    public Dictionary<Guid, DAKFKDDFLAO> <DFAOHNBGMBI>k__BackingField;    // 0x0x10
}
...
// DAKFKDDFLAO
//   (not directly referenced by a detected call)
public class DAKFKDDFLAO
{
    public int <OJMJEKHJCFO>k__BackingField;    // 0x0x10
    public KJFLMAMHFBL <DHFHCFFJAOP>k__BackingField;    // 0x0x18
}
...
public class DDMEEGBPNAD
{
    public PKGBCENBCAA <FODAHLGOLHA>k__BackingField;    // 0x0x10
    public BMKLONHENII <BADBGFHOPIG>k__BackingField;    // 0x0x18
    public NEJOIHPICBP <GNFGMGNODBA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DFCAAKPHCNA
//   (not directly referenced by a detected call)
public class DFCAAKPHCNA
{
    public int <AAAJPHJCCHG>k__BackingField;    // 0x0x10
    public string <HLENINJNBDA>k__BackingField;    // 0x0x18
    public string <KMAAJHCIODE>k__BackingField;    // 0x0x20
    public string <CEIJAJHPPDI>k__BackingField;    // 0x0x28
    public string <LBIKINEOBBM>k__BackingField;    // 0x0x30
    public string <HIKFMLMBBLO>k__BackingField;    // 0x0x38
    public AGJAHJDNKLP? <HNHIECNHJKL>k__BackingField;    // 0x0x40
    public string <IANHFNDFDPM>k__BackingField;    // 0x0x48
    public string <KHEKEIKGKCA>k__BackingField;    // 0x0x50
    public bool <HEBHGIHFEDH>k__BackingField;    // 0x0x58
    public bool <MOLPFOGEODH>k__BackingField;    // 0x0x59
    public bool <KGGENBAIMLC>k__BackingField;    // 0x0x5A
    public MEKIEPIMHLK <KABOMEOOFOI>k__BackingField;    // 0x0x5C
    public int <AAHIJGIPLIA>k__BackingField;    // 0x0x60
    public JDKKAMPPAOA <JGPIIEJPCHI>k__BackingField;    // 0x0x64
    public int <FPLLDDKGNPF>k__BackingField;    // 0x0x68
    public PBGKNAKPFLO <DFGOEDNFGGO>k__BackingField;    // 0x0x6C
    public ANOFOIHNFLA <NOPEJNNBOMB>k__BackingField;    // 0x0x70
    public int? <ANDGDJPGHJC>k__BackingField;    // 0x0x74
    public string <KDMFJNMGHAK>k__BackingField;    // 0x0x80
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{nCMNDPGNCJE}   [Service.Econ]
public enum DFMGAIDFDLG
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class DIBHLLKLBIK
{
    public AGJAHJDNKLP <HNHIECNHJKL>k__BackingField;    // 0x0x10
    public string <AHBDLOJGCNP>k__BackingField;    // 0x0x18
    public string <HLENINJNBDA>k__BackingField;    // 0x0x20
    public string <KMAAJHCIODE>k__BackingField;    // 0x0x28
    public MEKIEPIMHLK <KABOMEOOFOI>k__BackingField;    // 0x0x30
    public string <CEIJAJHPPDI>k__BackingField;    // 0x0x38
    public int <AAHIJGIPLIA>k__BackingField;    // 0x0x40
    public bool <ALKJMGEKIGF>k__BackingField;    // 0x0x44
}
...
// ECEGHGPPKIA
//   (not directly referenced by a detected call)
public class ECEGHGPPKIA
{
    public float <NMIDPOGEAGO>k__BackingField;    // 0x0x10
    public float <NNIOKGPHBEF>k__BackingField;    // 0x0x14
    public float <BMGDJHBKLPI>k__BackingField;    // 0x0x18
    public float <KAMNAEGELJL>k__BackingField;    // 0x0x1C
    public float <FHIFKANJOHN>k__BackingField;    // 0x0x20
    public float <EAEMOAHLJGI>k__BackingField;    // 0x0x24
    public float <JFDEKCENKHJ>k__BackingField;    // 0x0x28
    public float <PBAMDCDNIEF>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// EEGPNNOGEFF
//   (not directly referenced by a detected call)
public class EEGPNNOGEFF
{
    public long <AAAJPHJCCHG>k__BackingField;    // 0x0x10
    public string <LBIKINEOBBM>k__BackingField;    // 0x0x18
    public string <IIPBPLPIOGK>k__BackingField;    // 0x0x20
    public AGJAHJDNKLP? <HNHIECNHJKL>k__BackingField;    // 0x0x28
    public string <IANHFNDFDPM>k__BackingField;    // 0x0x30
    public string <KHEKEIKGKCA>k__BackingField;    // 0x0x38
    public FMPAIFAKGLH <HMPGNGHBHFD>k__BackingField;    // 0x0x40
    public int <FBJPKHGOPDB>k__BackingField;    // 0x0x44
    public int <GNFICAACJAM>k__BackingField;    // 0x0x48
    public ANOFOIHNFLA? <CMIIJDLHJDI>k__BackingField;    // 0x0x4C
    public MEKIEPIMHLK? <AEAILBKHJLD>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// EJFEBKBCIPP
//   (not directly referenced by a detected call)
public class EJFEBKBCIPP
{
    public Guid <CIEABHLNKMK>k__BackingField;    // 0x0x10
    public Guid <CKLFADCPEEP>k__BackingField;    // 0x0x20
    public DateTime <HJPJAOKKIFH>k__BackingField;    // 0x0x30
    public List<DFCAAKPHCNA> <GOHJPLPMKNA>k__BackingField;    // 0x0x38
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{hJDENONHJGG}   [Service.Econ]
public class EKGEOJCODDK
{
    public OOMJDNCNPAJ <FODAHLGOLHA>k__BackingField;    // 0x0x10
    public FHJPKCMFPGA <LBENMMENKGP>k__BackingField;    // 0x0x18
}
...
// FAHCJDMLJLE
//   (not directly referenced by a detected call)
public class FAHCJDMLJLE
{
    public Guid <AAMEHPOMLJG>k__BackingField;    // 0x0x10
    public int <MDGNLKGHGMI>k__BackingField;    // 0x0x20
    public int <HCFCGHJBFAO>k__BackingField;    // 0x0x24
    public Guid <FOGLOMAHNCH>k__BackingField;    // 0x0x28
    public DateTime <LFHANBPNHFM>k__BackingField;    // 0x0x38
    public FHJPKCMFPGA <LBENMMENKGP>k__BackingField;    // 0x0x40
}
...
public class FBOLMFCFLLP
{
    public long? <MGDONIFHCDP>k__BackingField;    // 0x0x10
    public int? <PGLGMIOBNLL>k__BackingField;    // 0x0x20
    public string <LBIKINEOBBM>k__BackingField;    // 0x0x28
    public AGJAHJDNKLP? <HNHIECNHJKL>k__BackingField;    // 0x0x30
    public string <HIKFMLMBBLO>k__BackingField;    // 0x0x38
    public string <IANHFNDFDPM>k__BackingField;    // 0x0x40
    public string <KHEKEIKGKCA>k__BackingField;    // 0x0x48
    public JDKKAMPPAOA <JGPIIEJPCHI>k__BackingField;    // 0x0x50
    public int <FPLLDDKGNPF>k__BackingField;    // 0x0x54
    public int <FBJPKHGOPDB>k__BackingField;    // 0x0x58
    public ANOFOIHNFLA <CMIIJDLHJDI>k__BackingField;    // 0x0x5C
    public MEKIEPIMHLK <AEAILBKHJLD>k__BackingField;    // 0x0x60
    public string <CPPKNGFJKAK>k__BackingField;    // 0x0x68
    public FABCIKBPEHF <JMMIPODCGGD>k__BackingField;    // 0x0x70
    public AIBCMMNJDOI <IPMDCADMJGH>k__BackingField;    // 0x0x74
    public IKMGFBLPNGK? <GMBLCFDNNIG>k__BackingField;    // 0x0x78
    public bool <KJGCIBHCIEH>k__BackingField;    // 0x0x80
    public bool <IBCDNAGHPLN>k__BackingField;    // 0x0x81
    public string <NDOBFPGMAJE>k__BackingField;    // 0x0x88
    public bool <GJPAICCNFJM>k__BackingField;    // 0x0x90
    public bool OLNPLAHFIDO;    // 0x0x91
}

// --------------------------------------------------------------------------
// FCBJPMIGKFN
//   RESPONSE GET    api/config/v1/amplitude   [Service.API]
public class FCBJPMIGKFN
{
    public string <LCKOJPKAHNK>k__BackingField;    // 0x0x10
    public string <NGCKEPKDICJ>k__BackingField;    // 0x0x18
    public bool <DKAADEDAMON>k__BackingField;    // 0x0x20
    public string <NKLFFPIPNNJ>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// FDHANBGAPMJ
//   (not directly referenced by a detected call)
public class FDHANBGAPMJ
{
    public float <KCKLGFEJOJD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FHJPKCMFPGA
//   (not directly referenced by a detected call)
public class FHJPKCMFPGA
{
    public Guid <AAMEHPOMLJG>k__BackingField;    // 0x0x10
    public long <NBGPPKCEFGP>k__BackingField;    // 0x0x20
    public string <BPCICACJIBI>k__BackingField;    // 0x0x28
    public string <LGOPFMMDIDF>k__BackingField;    // 0x0x30
    public string <BGKGFOLFHAH>k__BackingField;    // 0x0x38
    public long <HLICFIEADHO>k__BackingField;    // 0x0x40
    public Guid? <CNMIHKBPHPB>k__BackingField;    // 0x0x48
    public DateTime <LFHANBPNHFM>k__BackingField;    // 0x0x60
    public int <EMNIADNOONE>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FLEIPIOMCAM
//   (not directly referenced by a detected call)
public class FLEIPIOMCAM
{
    public string <OBJFEINJEFO>k__BackingField;    // 0x0x10
    public DBAINDCGLBO <EMHEOKACCLA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FLPJLEHKNIL
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class FLPJLEHKNIL
{
    public int <KPJLENBCEIF>k__BackingField;    // 0x0x10
    public int? <GCBAFLACNOD>k__BackingField;    // 0x0x14
    public string <EBKGBAPFMBG>k__BackingField;    // 0x0x20
    public string <IOLMOOJEHAG>k__BackingField;    // 0x0x28
}
...
// FPGKNNLGIHF
//   (not directly referenced by a detected call)
public class FPGKNNLGIHF
{
    public long <HIOFJAEGBKM>k__BackingField;    // 0x0x10
    public long <KFBKOGCNCMP>k__BackingField;    // 0x0x18
    public int <CEHBAFHAIDE>k__BackingField;    // 0x0x20
    public DateTime <BLMCDFNKIPG>k__BackingField;    // 0x0x28
    public CJJENAMEGLN <EMHEOKACCLA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GAIMNJOONIP
//   (not directly referenced by a detected call)
public class GAIMNJOONIP
{
    public int <ELOMFKDLJEK>k__BackingField;    // 0x0x10
    public DateTime <BLMCDFNKIPG>k__BackingField;    // 0x0x18
    public DateTime? <JKLIEGPECOD>k__BackingField;    // 0x0x20
}
...
public class GEGCENKGMEB
{
    public LKENKCLIKFM <EPEBFIKFODI>k__BackingField;    // 0x0x10
    public string <EHLKNDNFNIE>k__BackingField;    // 0x0x18
    public int? <NMPGDHDBPPH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GIPCFBHJPLF
//   (not directly referenced by a detected call)
public class GIPCFBHJPLF
{
    public ODNOBHIAPAM JFMONIDIEMO;    // 0x0x10
    public int ALJJNLFOCAK;    // 0x0x14
}
...
public class GLIOMFJOJNA
{
    public DOHCMEOCADN <HFFNABDJLNC>k__BackingField;    // 0x0x10
}
...
public class GLPAFBLJPKD : NMBNKIGLCLI
{
    public List<FLEIPIOMCAM> <ICOKBPPIECB>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// GNKHBPIPBKH
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class GNKHBPIPBKH
{
    public int? <KDGHDKDBLPP>k__BackingField;    // 0x0x10
    public string <JIFNDFHABJB>k__BackingField;    // 0x0x18
    public string <BJAGKMGECJD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GOLJGJHMODD
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItems   [Service.API]
public class GOLJGJHMODD
{
    public byte <LGOCKBFKLKH>k__BackingField;    // 0x0x10
    public int <MKKKNPBJBLL>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// GPHPODLLBAL
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class GPHPODLLBAL
{
    public HPJAODGIDCA <EPEBFIKFODI>k__BackingField;    // 0x0x10
    public int <CHOJOKJNCKD>k__BackingField;    // 0x0x14
    public long <IPMDFFNLPBI>k__BackingField;    // 0x0x18
    public bool <GOJPLBAKCGJ>k__BackingField;    // 0x0x20
    public string <IMGCDIMEJDE>k__BackingField;    // 0x0x28
    public int? <HGCHDOFMNOH>k__BackingField;    // 0x0x30
    public bool <GKMNPHIFHDP>k__BackingField;    // 0x0x38
    public bool <OPIDOHGLMNI>k__BackingField;    // 0x0x39
    public bool <NKLIJCCLEDO>k__BackingField;    // 0x0x3A
    public bool <FJPFCCEHJFL>k__BackingField;    // 0x0x3B
    public string <AIIBHPECFJP>k__BackingField;    // 0x0x40
    public DateTime? <KKEPOAADIIM>k__BackingField;    // 0x0x48
    public float <CKDBFIPBLOL>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// HBLEEGDOBKE
//   (not directly referenced by a detected call)
public class HBLEEGDOBKE
{
    public JDKKAMPPAOA <JGPIIEJPCHI>k__BackingField;    // 0x0x10
    public int <HLICFIEADHO>k__BackingField;    // 0x0x14
    public MOFDADNAAFB <IHFBCCNNIAB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HFNJPBANFHG
//   (not directly referenced by a detected call)
public class HFNJPBANFHG
{
    public int <ECIDPJBOEMC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HHLPLJGAFEN
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class HHLPLJGAFEN
{
    public List<GAIMNJOONIP> <JLNPLGFMBKN>k__BackingField;    // 0x0x10
    public string <OBBBIMINBFL>k__BackingField;    // 0x0x18
}
...
// HJBMPLPOKAI
//   (not directly referenced by a detected call)
public class HJBMPLPOKAI
{
    public bool <LIEHEGEDAHJ>k__BackingField;    // 0x0x10
    public AIBCMMNJDOI <LCALNOFCNPB>k__BackingField;    // 0x0x14
    public int <OJLAHOGLODO>k__BackingField;    // 0x0x18
    public DateTime <LFHANBPNHFM>k__BackingField;    // 0x0x20
}
...
public class HLPGEEMNPFN
{
    public PDABMEFDJLD <HFFNABDJLNC>k__BackingField;    // 0x0x10
    public List<string> <ICOKBPPIECB>k__BackingField;    // 0x0x18
}
...
public class HMPBAGLOOLO
{
    public string <BPCICACJIBI>k__BackingField;    // 0x0x10
    public string <LGOPFMMDIDF>k__BackingField;    // 0x0x18
    public int? <HLICFIEADHO>k__BackingField;    // 0x0x20
    public LILCONHACAJ? <MMNABPCHILN>k__BackingField;    // 0x0x28
}
...
// base   : NDGCLOIHAII
//   (not directly referenced by a detected call)
public class HNCBGFIKPEL : NDGCLOIHAII
{
    public DFCAAKPHCNA <PAIBKHNNOGK>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// IAFCIJNFOKH
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class IAFCIJNFOKH
{
    public Guid? <AAMEHPOMLJG>k__BackingField;    // 0x0x10
    public long? <NBGPPKCEFGP>k__BackingField;    // 0x0x28
    public string <BPCICACJIBI>k__BackingField;    // 0x0x38
    public string <LGOPFMMDIDF>k__BackingField;    // 0x0x40
    public string <BGKGFOLFHAH>k__BackingField;    // 0x0x48
    public LDFACEIGCHD <FMGNGHFAJHJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// IBLONBLNHPD
//   (not directly referenced by a detected call)
public class IBLONBLNHPD
{
    public NMBNKIGLCLI <KPLKPGNDNFO>k__BackingField;    // 0x0x10
    public FPGKNNLGIHF <IFKCLHNINDE>k__BackingField;    // 0x0x18
}
...
public class IGBHJMKDOKG
{
    public bool <AGKLOCNCGMM>k__BackingField;    // 0x0x10
    public string <IMGCDIMEJDE>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/inventions/v1/personaldetails/{nHCFGINLFGP}   [Service.API]
public class ILBDCEOFNNO
{
    public bool <HDHKMLGLAJO>k__BackingField;    // 0x0x10
}
...
public class IMKKKINMNFJ : DFMEAJNGDBH
{
    public List<HNCBGFIKPEL> HPLEHJJHHCP;    // 0x0x30
    public int <PPIOBEKPCCF>k__BackingField;    // 0x0x38
}
...
public class JBGDHBJKPAO
{
    public int <CHOJOKJNCKD>k__BackingField;    // 0x0x10
}
...
public class JEPBPOAEDIE
{
    public int <MDGNLKGHGMI>k__BackingField;    // 0x0x10
    public Guid <PBHMNGGJHKA>k__BackingField;    // 0x0x14
    public long <IGBGPJDOANL>k__BackingField;    // 0x0x28
    public DateTime <LFHANBPNHFM>k__BackingField;    // 0x0x30
}
...
public class JOBLJABCAJP
{
    public string <MGDONIFHCDP>k__BackingField;    // 0x0x10
    public string <PJCFNFKHPFB>k__BackingField;    // 0x0x18
    public string <HAGCJAMJKLL>k__BackingField;    // 0x0x20
    public string <LGOPFMMDIDF>k__BackingField;    // 0x0x28
    public string <JIFNDFHABJB>k__BackingField;    // 0x0x30
    public JBADIIKHNIH <FODAHLGOLHA>k__BackingField;    // 0x0x38
    public List<string> <HEKPCCFIFGO>k__BackingField;    // 0x0x40
    public List<string> <ICOKBPPIECB>k__BackingField;    // 0x0x48
    public string <FDIMKEPHBEC>k__BackingField;    // 0x0x50
    public List<OFFJLCIMFPG> <FACHODFDLFG>k__BackingField;    // 0x0x58
}
...
public class KBBKBABGMHE : KGCPHMLHGEK
{
    public MNIGBGLOCGB? <KFPILLEEDPI>k__BackingField;    // 0x0x18
    public JEPBPOAEDIE <MENNJCAIPGJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KCFAKCLHBPM
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class KCFAKCLHBPM
{
    public int <NHEAKHJPPPO>k__BackingField;    // 0x0x10
    public int <KNLFBFELBPB>k__BackingField;    // 0x0x14
    public float <IJFCAAIANDC>k__BackingField;    // 0x0x18
    public int <NKBJOEMKFOM>k__BackingField;    // 0x0x1C
    public int <EOLMHBHLMMG>k__BackingField;    // 0x0x20
    public int <CENKPIMBCAI>k__BackingField;    // 0x0x24
    public int <IKHHPGBBBJE>k__BackingField;    // 0x0x28
    public string <CBDFNLHDPCK>k__BackingField;    // 0x0x30
    public string <NJMKMOJLPIL>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// KEOGLFBNCEC
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class KEOGLFBNCEC
{
    public List<NMBNKIGLCLI> <HOEEALLLGOK>k__BackingField;    // 0x0x10
    public string <OBBBIMINBFL>k__BackingField;    // 0x0x18
}
...
public class KFIKLALLBEF
{
    public JDKKAMPPAOA <JGPIIEJPCHI>k__BackingField;    // 0x0x10
    public JKODACFNGAJ <PHMJEPCLMLH>k__BackingField;    // 0x0x14
    public int <OGCGEJOFHAG>k__BackingField;    // 0x0x18
    public int <GPICACDCMCJ>k__BackingField;    // 0x0x1C
    public int <EIMCGHHJGCM>k__BackingField;    // 0x0x20
    public BDCCHNAKNNO <MOFLBFDCONG>k__BackingField;    // 0x0x24
    public bool <KPMFNJPELEE>k__BackingField;    // 0x0x28
    public float <OAAFHNKOFNP>k__BackingField;    // 0x0x2C
    public int <IANDNDPNEJN>k__BackingField;    // 0x0x30
    public bool <KGAIBKINHPL>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// KFMGANOOKNF
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class KFMGANOOKNF
{
    public long <NBGPPKCEFGP>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <JKOJPPPLDGE>k__BackingField;    // 0x0x18
    public BMAHCNDMPLI <FGNLMOCMHEH>k__BackingField;    // 0x0x20
}
...
public class KJFLMAMHFBL
{
    public Guid? <BEGJCGJHOMK>k__BackingField;    // 0x0x10
    public Guid <IADCJPNNKLI>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// KKDICLPAKEN
// base   : BPEAEEINGOP`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class KKDICLPAKEN
{
    // (no instance fields in the metadata dump)
}
...
public class LBEABGCFOEJ
{
    public OOMJDNCNPAJ <FODAHLGOLHA>k__BackingField;    // 0x0x10
    public FAHCJDMLJLE <AFKNFAJPAIF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LDFACEIGCHD
//   (not directly referenced by a detected call)
public class LDFACEIGCHD
{
    public long <HLICFIEADHO>k__BackingField;    // 0x0x10
    public Guid? <PBHMNGGJHKA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LEIDLPNCHOC
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{bGDDDLJMKIB}   [Service.API]
public class LEIDLPNCHOC
{
    public List<NMBNKIGLCLI> <KILBAMAFGDC>k__BackingField;    // 0x0x10
    public List<IBLONBLNHPD> <CCBOBLHFKMB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LEKEFJDPBNL
//   (not directly referenced by a detected call)
public class LEKEFJDPBNL
{
    // (no instance fields in the metadata dump)
}
...
// base   : DFMEAJNGDBH
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{cBPDOBAGPFP}   [Service.Econ]
public class LMHJCOEPMEG : DFMEAJNGDBH
{
    public int <PLOKEJLPDIL>k__BackingField;    // 0x0x30
    public string <BPCICACJIBI>k__BackingField;    // 0x0x38
    public DateTime <HJPJAOKKIFH>k__BackingField;    // 0x0x40
    public DateTime <MODAJPEFMND>k__BackingField;    // 0x0x48
    public JDKKAMPPAOA <JGPIIEJPCHI>k__BackingField;    // 0x0x50
    public NDGCLOIHAII <LHMKFNAOGBG>k__BackingField;    // 0x0x58
    public List<PCEACNDEFEI> <IBMMHEOMJHI>k__BackingField;    // 0x0x60
    public HJBMPLPOKAI <KAHJBLOMIEI>k__BackingField;    // 0x0x68
}
...
public class MJLNNPKLEBF
{
    public Dictionary<Guid, LBEABGCFOEJ> <NFLHACENEDA>k__BackingField;    // 0x0x10
}
...
// MOFDADNAAFB
//   (not directly referenced by a detected call)
public class MOFDADNAAFB
{
    public int <ALEDJAJDPFO>k__BackingField;    // 0x0x10
    public DateTime? <ILPOMKLEAFD>k__BackingField;    // 0x0x18
    public DateTime? <PPPNMOEMAKF>k__BackingField;    // 0x0x28
}
...
// NDGCLOIHAII
//   (not directly referenced by a detected call)
public class NDGCLOIHAII
{
    public int <LBNJMDMPDGG>k__BackingField;    // 0x0x10
    public OAKCAFGKODH <EMHEOKACCLA>k__BackingField;    // 0x0x14
    public List<HBLEEGDOBKE> <GDGKKEPCJLI>k__BackingField;    // 0x0x18
    public List<HBLEEGDOBKE> <GMOAOAKANMN>k__BackingField;    // 0x0x20
    public bool <IGGEBDFACKA>k__BackingField;    // 0x0x28
    public DateTime? <ICBCNDPLKOI>k__BackingField;    // 0x0x30
    public DateTime? <IMCIJLJMCEB>k__BackingField;    // 0x0x40
    public DateTime? <JMGICNFNFNK>k__BackingField;    // 0x0x50
}
...
public class NEGGCGNMLEF : KGCPHMLHGEK
{
    public LDPMHHKOELN? <KFPILLEEDPI>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <NOMCPLEKOEK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NEJOIHPICBP
//   (not directly referenced by a detected call)
public class NEJOIHPICBP
{
    public long <EBDAMDBFCDO>k__BackingField;    // 0x0x10
    public string <OLAACCKMIBF>k__BackingField;    // 0x0x18
    public int <GGLKMNABBJJ>k__BackingField;    // 0x0x20
    public int <FBEKIMCEAID>k__BackingField;    // 0x0x24
    public int <HDMNPCNJOOC>k__BackingField;    // 0x0x28
    public int <CLKAHGHOFHC>k__BackingField;    // 0x0x2C
    public int <JGKNFNIBBNO>k__BackingField;    // 0x0x30
    public string <LNECKOMEALH>k__BackingField;    // 0x0x38
    public string <CCKLBCEBJOB>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// NKFALJLDDAC
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class NKFALJLDDAC
{
    public List<CIEFKIAJMEF> <HNMEMCDFAFB>k__BackingField;    // 0x0x10
    public DOHCMEOCADN <HFFNABDJLNC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NMBNKIGLCLI
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class NMBNKIGLCLI
{
    public long <KFBKOGCNCMP>k__BackingField;    // 0x0x10
    public int <EHLAGIDJLEA>k__BackingField;    // 0x0x18
    public long <NBGPPKCEFGP>k__BackingField;    // 0x0x20
    public long? <KKJOOILEGPN>k__BackingField;    // 0x0x28
    public long? <LFEAHNGBIJJ>k__BackingField;    // 0x0x38
    public string <BPCICACJIBI>k__BackingField;    // 0x0x48
    public string <LGOPFMMDIDF>k__BackingField;    // 0x0x50
    public string <BGKGFOLFHAH>k__BackingField;    // 0x0x58
    public DateTime <KEPLBFLIOPB>k__BackingField;    // 0x0x60
    public DateTime <GJEPOODAIDN>k__BackingField;    // 0x0x68
    public int <PHHMBMGLIHD>k__BackingField;    // 0x0x70
    public GAOEAMHHOLF <MMNABPCHILN>k__BackingField;    // 0x0x74
    public bool <DCMJJDGEAFA>k__BackingField;    // 0x0x78
    public bool <FHDPGNFLPNB>k__BackingField;    // 0x0x79
    public DHKCHCBLGDL <JGKKNKICDNN>k__BackingField;    // 0x0x7C
    public DHKCHCBLGDL <HNEHINDCONN>k__BackingField;    // 0x0x80
    public long? <KMPGLCPOLPI>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// NMLLEGNFGHG
//   (not directly referenced by a detected call)
public class NMLLEGNFGHG
{
    public int <KGFOHCLNGEE>k__BackingField;    // 0x0x10
}
...
public class OAIFKGAIGBJ
{
    public Dictionary<string, OPBMKIDJLIG> <JGEEIJBEPNK>k__BackingField;    // 0x0x10
}
...
// OFFJLCIMFPG
//   (not directly referenced by a detected call)
public class OFFJLCIMFPG
{
    public DateTime <BLMCDFNKIPG>k__BackingField;    // 0x0x10
    public string <LELLJNLPLGA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OIOKCFDNDMI
//   (not directly referenced by a detected call)
public class OIOKCFDNDMI
{
    public long <DJHEPPPAILM>k__BackingField;    // 0x0x10
    public Guid <OLAACCKMIBF>k__BackingField;    // 0x0x18
    public long <NBGPPKCEFGP>k__BackingField;    // 0x0x28
    public string <BPCICACJIBI>k__BackingField;    // 0x0x30
    public string <LGOPFMMDIDF>k__BackingField;    // 0x0x38
    public int <HLICFIEADHO>k__BackingField;    // 0x0x40
    public Guid? <CNMIHKBPHPB>k__BackingField;    // 0x0x44
    public DateTime <BLMCDFNKIPG>k__BackingField;    // 0x0x58
    public string <BGKGFOLFHAH>k__BackingField;    // 0x0x60
    public DHOILGABBHJ <EMHEOKACCLA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// OKEAFDNAEAM
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{jNHCLKAAKHA}   [Service.API]
public class OKEAFDNAEAM
{
    public uint <MGDONIFHCDP>k__BackingField;    // 0x0x10
    public uint? <AKCALKNDIDH>k__BackingField;    // 0x0x14
    public string <BPCICACJIBI>k__BackingField;    // 0x0x20
    public string <LGOPFMMDIDF>k__BackingField;    // 0x0x28
    public DateTime <LGEDBKPPCAF>k__BackingField;    // 0x0x30
    public DateTime? <EHKBDCFGGJH>k__BackingField;    // 0x0x38
    public bool <PHBHDHPBAKH>k__BackingField;    // 0x0x48
    public List<JOBLJABCAJP> <BKMDFACCHMJ>k__BackingField;    // 0x0x50
    public List<string> <ICOKBPPIECB>k__BackingField;    // 0x0x58
    public int <GFKFBBAJBKA>k__BackingField;    // 0x0x60
    public int <BHPBCJFFPGI>k__BackingField;    // 0x0x64
    public int <NIELFFHKJFB>k__BackingField;    // 0x0x68
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{lDNINBEIDPE}   [Service.API]
...
public class ONFEMJBCKDI
{
    public GLPAFBLJPKD <KPLKPGNDNFO>k__BackingField;    // 0x0x10
    public DOHCMEOCADN <HFFNABDJLNC>k__BackingField;    // 0x0x18
    public HLPGEEMNPFN <BAKNDONBDAL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ONMHAOHKCOB
// base   : BPEAEEINGOP`1<HNBBHIBDFGE>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{iOJJEEHJKHC}   [Service.API]
public class ONMHAOHKCOB
{
    // (no instance fields in the metadata dump)
}
...
// OPBMKIDJLIG
//   (not directly referenced by a detected call)
public class OPBMKIDJLIG
{
    public long <DEJADKMNCNO>k__BackingField;    // 0x0x10
    public Guid <MLMCEKGOOCC>k__BackingField;    // 0x0x18
    public Guid <LMHDJPMKODL>k__BackingField;    // 0x0x28
    public DateTime <BLMCDFNKIPG>k__BackingField;    // 0x0x38
    public string <ILEJODAMDBH>k__BackingField;    // 0x0x40
    public string <JGGOBNKIBCN>k__BackingField;    // 0x0x48
    public string <DBGOMCMONCP>k__BackingField;    // 0x0x50
    public string <IMKJFEGLAEG>k__BackingField;    // 0x0x58
}
...
// base   : NDGCLOIHAII
//   (not directly referenced by a detected call)
public class PCEACNDEFEI : NDGCLOIHAII
{
    public int <DIKOBLHLPHG>k__BackingField;    // 0x0x60
    public List<CDNPJCMFNEM> <JDAODOMOGCL>k__BackingField;    // 0x0x68
    public List<CDNPJCMFNEM> <MFECHEMFIAA>k__BackingField;    // 0x0x70
    public List<CDNPJCMFNEM> <NDGJDANCFIG>k__BackingField;    // 0x0x78
}
...
public class PEMGLPMPENM
{
    public List<string> <KMKDGFLMKMG>k__BackingField;    // 0x0x10
    public byte <LGOCKBFKLKH>k__BackingField;    // 0x0x18
    public int <MKKKNPBJBLL>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// PFFFEMFDDDJ
//   (not directly referenced by a detected call)
public class PFFFEMFDDDJ
{
    public int <KAHLJHDGCGN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PIIGLKCNLBP
//   RESPONSE GET    api/config/v2   [Service.API]
public class PIIGLKCNLBP
{
    public Dictionary<int, int> <AHKGPCCDHIG>k__BackingField;    // 0x0x10
    public List<GOMKKMJGAHN> <KOLGLGKKAAD>k__BackingField;    // 0x0x18
    public GIPCFBHJPLF[][] <ANJLAENLIGP>k__BackingField;    // 0x0x20
    public NMLLEGNFGHG <BGJIJKEJPID>k__BackingField;    // 0x0x28
    public ECEGHGPPKIA <JLFICNFGKON>k__BackingField;    // 0x0x30
    public PFFFEMFDDDJ <OCFPMGIJCEC>k__BackingField;    // 0x0x38
    public HFNJPBANFHG <ACINHJDMDAI>k__BackingField;    // 0x0x40
    public FDHANBGAPMJ <DDLLFEPJCBJ>k__BackingField;    // 0x0x48
    public string <OLBDOJKBBFF>k__BackingField;    // 0x0x50
}
...
public class POOFCMAIDLG
{
    public List<string> <IAMFEEGLPFE>k__BackingField;    // 0x0x10
    public List<string> <KJDDAPGLNCO>k__BackingField;    // 0x0x18
    public List<string> <IIHMCEIEPCJ>k__BackingField;    // 0x0x20
}
...
{
    public long <NBGPPKCEFGP>k__BackingField;    // 0x0x10
    public long? <KKJOOILEGPN>k__BackingField;    // 0x0x18
    public GMHDHODCNMC <DKCIGOEPBPB>k__BackingField;    // 0x0x28
}
...
{
    public LDAIPFAENAN <HFFNABDJLNC>k__BackingField;    // 0x0x10
    public string <CJOCFLIMMDK>k__BackingField;    // 0x0x18
    public string <DMNEOCPBEPA>k__BackingField;    // 0x0x20
    public string <JNKPBALIMNG>k__BackingField;    // 0x0x28
}
...
{
    public long <KFBKOGCNCMP>k__BackingField;    // 0x0x10
    public long? <CBNNCEDAMIF>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public NDLPDHIKDFM FilterType;    // 0x0x20
...
{
    public GMHDHODCNMC <CPPFBOOMKCA>k__BackingField;    // 0x0x10
    public string <LCEAOGMGJNL>k__BackingField;    // 0x0x18
    public int <LCPKJPKKLCG>k__BackingField;    // 0x0x20
    public int <PKOAJMFPDJA>k__BackingField;    // 0x0x24
    public string <KJBFPADHCFB>k__BackingField;    // 0x0x28
    public string <EMAGEMLOGKN>k__BackingField;    // 0x0x30
}
...
{
    public int <MDGNLKGHGMI>k__BackingField;    // 0x0x10
    public Guid <AKHEFAOGLJD>k__BackingField;    // 0x0x14
    public DateTime <EHMOJLMOGKB>k__BackingField;    // 0x0x28
}
...
{
    public bool <CCDKHOMBBGL>k__BackingField;    // 0x0x10
    public int <DGGHNPPMJGN>k__BackingField;    // 0x0x14
    public bool <FBJHNJLKNNI>k__BackingField;    // 0x0x18
}
...
{
    public Guid <AKHEFAOGLJD>k__BackingField;    // 0x0x10
    public GMHDHODCNMC <FMALPPFFJHB>k__BackingField;    // 0x0x20
    public int <DPAGIHKGAKB>k__BackingField;    // 0x0x24
    public long <NBGPPKCEFGP>k__BackingField;    // 0x0x28
    public long? <KKJOOILEGPN>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{hEMEJJGNILE}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <DMBLFNIKCCM>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <PFGAONLHKFE>k__BackingField;    // 0x0x18
}
...
{
    public long <BGBAFIABPGK>k__BackingField;    // 0x0x10
    public long <NBGPPKCEFGP>k__BackingField;    // 0x0x18
    public long <DLHKBGFDCFM>k__BackingField;    // 0x0x20
    public IPMBFGHPPHB <EMHEOKACCLA>k__BackingField;    // 0x0x28
    public int <KIMENCCOCPF>k__BackingField;    // 0x0x2C
}
...
{
    public long <NBGPPKCEFGP>k__BackingField;    // 0x0x10
    public List<Guid> <JIMADDIIOKI>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <DMBLFNIKCCM>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <PFGAONLHKFE>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <PABPOCLPOEI>k__BackingField;    // 0x0x20
}
...
{
    public long <DLHKBGFDCFM>k__BackingField;    // 0x0x10
    public long <BGMFPJFBJCN>k__BackingField;    // 0x0x18
    public int? <JFNNFPMLPNO>k__BackingField;    // 0x0x20
    public int? <GLIINGCGEBH>k__BackingField;    // 0x0x28
    public long? <HPEBNMLFNCM>k__BackingField;    // 0x0x30
    public long <CGHMPPEGLKI>k__BackingField;    // 0x0x40
    public long <MIKOOGBNIPE>k__BackingField;    // 0x0x48
    public int <EGEGGADLIDG>k__BackingField;    // 0x0x50
    public IPMBFGHPPHB <OAADKAIMAGE>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <EGHPOCAODEC>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public ANOFOIHNFLA <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public JMDCIJEEDJD creatorAccountRole;    // 0x0x58
}
...
{
    public LLOJNBHBCJC <LALDGGIPFCE>k__BackingField;    // 0x0x10
    public KFFPJDIEDII <CHLALEPGJGM>k__BackingField;    // 0x0x14
    public string <BPCICACJIBI>k__BackingField;    // 0x0x18
    public string <LGOPFMMDIDF>k__BackingField;    // 0x0x20
    public bool <BACOJAFIAMH>k__BackingField;    // 0x0x28
}
...
{
    public List<LLOJNBHBCJC> <MOCCOJBOBIC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{lDNINBEIDPE}   [Service.API]
public class ProgressionEventDTO
{
    public long <BGMFPJFBJCN>k__BackingField;    // 0x0x10
    public string <BPCICACJIBI>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <NDGJDANCFIG>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <FGEGKMMDLEM>k__BackingField;    // 0x0x28
    public DateTime <KEPLBFLIOPB>k__BackingField;    // 0x0x30
    public DateTime <GJEPOODAIDN>k__BackingField;    // 0x0x38
    public DateTime <HLNEOCKJHHP>k__BackingField;    // 0x0x40
    public bool <GBCIEEFJPMJ>k__BackingField;    // 0x0x48
    public int <FKJOGHFEIAL>k__BackingField;    // 0x0x4C
    public float <FMMHOHFMMNM>k__BackingField;    // 0x0x50
    public Guid? <CBPHFMMGCPI>k__BackingField;    // 0x0x54
    public string <HKDBIHNPKCE>k__BackingField;    // 0x0x68
    public string <NNNPLEJALFN>k__BackingField;    // 0x0x70
    public string <CLCHOGIAEKP>k__BackingField;    // 0x0x78
    public string <NHIPBNKEHOB>k__BackingField;    // 0x0x80
}
...
{
    public Guid <NDADPNPEJKD>k__BackingField;    // 0x0x10
    public int <MPFGLGDJCMN>k__BackingField;    // 0x0x20
    public int <LKIIHALHAHJ>k__BackingField;    // 0x0x24
    public int <PGHEGPOOPKD>k__BackingField;    // 0x0x28
    public long <IHPNDHKNKJD>k__BackingField;    // 0x0x30
    public long <GBOMHCGFHHI>k__BackingField;    // 0x0x38
}
...
{
    public int <MDGNLKGHGMI>k__BackingField;    // 0x0x10
    public int <FBJPKHGOPDB>k__BackingField;    // 0x0x14
    public int <JKEFEGBAHPE>k__BackingField;    // 0x0x18
    public int <FIHKIHEJBOA>k__BackingField;    // 0x0x1C
    public int <AGGGANOFOJJ>k__BackingField;    // 0x0x20
    public DateTime? <DAHFMKOJBNF>k__BackingField;    // 0x0x28
}
...
{
    public long <OOONPFBIKJK>k__BackingField;    // 0x0x10
    public int <AAAJPHJCCHG>k__BackingField;    // 0x0x18
    public string <BGKGFOLFHAH>k__BackingField;    // 0x0x20
    public int <FBJPKHGOPDB>k__BackingField;    // 0x0x28
    public int <EBKEIONPHOH>k__BackingField;    // 0x0x2C
    public bool <NMCFBGDNFGG>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public DKIBECNNPED ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool PPKJBKJBDGJ;    // 0x0x28
}
...
{
    public PPFOLBMMKPI? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public PPFOLBMMKPI DPGDGHKAEIH;  // wrapper
...
{
    public FABCIKBPEHF HAENEGJLEBG;  // wrapper
...
{
    public HPJAODGIDCA NNIGKJJKMHG;  // wrapper
    public float? GEMGGFGPPEI;  // wrapper
...
{
    public AAIKMIMLOIP KFIIAAIHCFA;  // wrapper
...
{
    public LILCONHACAJ AIBOPONHKNJ;  // wrapper
    public PHIDPHEMNCC IIINMIDPPGP;  // wrapper
    public byte[] JIINMCLGPKD;  // wrapper
    public byte[] COAJJEDAOAA;  // wrapper
    public Color DEJOCIOKOBF;  // wrapper
...
{
    public List<EHPHGDIPLEK> OPFEBOHDIDO;  // wrapper
}
...
{
    public NFACOEHLBBF CBIEAGEJFEJ;  // wrapper
    public ANOFOIHNFLA? GBIKOHBCHJD;  // wrapper
...
{
    public PBHIJEBFDCP APFPFMHABHE;  // wrapper
...
// api/images/v5/cheered/bulk  [API GET]
...
{
    public BMKLONHENII inventionId;  // wrapper
}
...
// api/keepsakes/{hODMOHOMIKF}/collect  [API POST]
public class KeepsakesHODMOHOMIKFCollectRequest
{
    public Guid HODMOHOMIKF;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> BINACICMOBD;  // wrapper
    public DLDAOJALINA MNAFCHCPDFJ;  // wrapper
    public long? KFHMHOFPIPN;  // wrapper
...
{
    public long? JDHCHAAPBGJ;  // wrapper
}
...
{
    public long? BCJGCHKGEMF;  // wrapper
    public long? HLLLHCGJCOG;  // wrapper
    public List<string> MMFGOAMGOII;  // wrapper
    public DateTime OFCMFJJGAGN;  // wrapper
    public DateTime FLGGJOKCCOM;  // wrapper
    public GAOEAMHHOLF AIBOPONHKNJ;  // wrapper
    public DHKCHCBLGDL KACBACFEPBJ;  // wrapper
    public DHKCHCBLGDL JLGAFIBILBO;  // wrapper
}
...
{
    public DHKCHCBLGDL KACBACFEPBJ;  // wrapper
    public DHKCHCBLGDL PPFKGCDFJFC;  // wrapper
}
...
{
    public Guid MAGKPBDGBMJ;  // wrapper
...
{
    public List<OKCKGNEINGB> ABJOMMJLANJ;  // wrapper
}
...
{
    public Guid KAGBFEMFKPH;  // wrapper
    public object Price;  // candidate
...
{
    public Guid KAGBFEMFKPH;  // wrapper
    public long? JLADAFFKMIE;  // wrapper
    public byte? FJDLLHJPBKD;  // wrapper
    public int? DEJOCIOKOBF;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid MAGKPBDGBMJ;  // wrapper
    public long? PKMJFHFEIMN;  // wrapper
    public long? JPMDEAEKLGB;  // wrapper
    public int? NFENHBLMAKH;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> NPOLKGPPPJC;  // wrapper
...
{
    public IEnumerable<DPGKCDAKHBI> CLLFOGINDGF;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public DHOILGABBHJ GANFKPHKNKH;  // wrapper
    public Guid? EOMLHMGAFEE;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public HPJAODGIDCA NNIGKJJKMHG;  // wrapper
    public long? HKIAEIKLEOP;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats DFEBCMDBBHC;  // wrapper
}
...
{
    public Guid NJKPICKMAHH;  // wrapper
...
{
    public Guid IDCNLMBHGCK;  // wrapper
...
{
    public List<LLGJOAFDGBK> OJOBNLENFLO;  // wrapper
    public object roomId;  // candidate
...
{
    public JBADIIKHNIH HINJAHMBONB;  // wrapper
}
