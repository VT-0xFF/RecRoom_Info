...
public class ABMMBBMPKPC
{
    public List<string> <POFEBCMMKFF>k__BackingField;    // 0x0x10
    public List<string> <LMAFGMIGGKP>k__BackingField;    // 0x0x18
    public List<string> <HKHBOGNGGML>k__BackingField;    // 0x0x20
}
...
public class ACIFBKKHJDK
{
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x10
    public string <PMONOMCKNJL>k__BackingField;    // 0x0x18
    public int? <KAOLHCFHNKJ>k__BackingField;    // 0x0x20
    public FAFGHGIKAKI? <OPBHLHIKCOG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// ADHHEKHFCCM
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{kOJKDECJOKK}   [Service.API]
public class ADHHEKHFCCM
{
    public uint <NOJGKADDJHI>k__BackingField;    // 0x0x10
    public uint? <FBACHAGLHPK>k__BackingField;    // 0x0x14
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x20
    public string <PMONOMCKNJL>k__BackingField;    // 0x0x28
    public DateTime <GLJPCMBNDGM>k__BackingField;    // 0x0x30
    public DateTime? <HIABJEHKJIE>k__BackingField;    // 0x0x38
    public bool <BKPAOJOHBLK>k__BackingField;    // 0x0x48
    public List<CIPBHMEMNHF> <AJCPCFJAHHC>k__BackingField;    // 0x0x50
    public List<string> <FOGAOEKHDBL>k__BackingField;    // 0x0x58
    public int <LFEKBHINNEN>k__BackingField;    // 0x0x60
    public int <ABGCKEBELAC>k__BackingField;    // 0x0x64
    public int <AJFDGDPFLNI>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// AEANMFAJIMC
//   (not directly referenced by a detected call)
public class AEANMFAJIMC
{
    public int <PGPLNEMJEKJ>k__BackingField;    // 0x0x10
}
...
//   RESPONSE GET    api/storefronts/v1/season/{oPMEIDEALPN}   [Service.Econ]
public class AGNKCLHGENO : INBACCIFCKP
{
    public int <DPOEIDJJLCN>k__BackingField;    // 0x0x30
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x38
    public DateTime <MGHCJCFFNDE>k__BackingField;    // 0x0x40
    public DateTime <NAHNHEGENHP>k__BackingField;    // 0x0x48
    public JMLBMNFJKBC <HHCEGJBOCBI>k__BackingField;    // 0x0x50
    public BBOEOPFKCIG <OBBDBJCIGJA>k__BackingField;    // 0x0x58
    public List<HAFPBJDNBNC> <ELGBMLKOLHD>k__BackingField;    // 0x0x60
    public IPPCICMEFJK <HGKHMMPMOPB>k__BackingField;    // 0x0x68
}
...
public class AHFMMMPDAPM
{
    public BHPCPHLNAAN <KAJCGIJMEIL>k__BackingField;    // 0x0x10
    public BJNKCEKDNEL <EIMEFKJKEAC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AHOLLFOMECH
//   (not directly referenced by a detected call)
public class AHOLLFOMECH
{
    public bool <BGMKNADJKDK>k__BackingField;    // 0x0x10
    public HEOJKIIIMPP <MLAEMKIEIJN>k__BackingField;    // 0x0x18
    public float <KFDBCLMMNNH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AIDAGCPBDPC
//   (not directly referenced by a detected call)
public class AIDAGCPBDPC
{
    public Guid <JGIMMMAMGCE>k__BackingField;    // 0x0x10
    public int <KFIIFEAJBKO>k__BackingField;    // 0x0x20
    public int <FBDHFPGCANO>k__BackingField;    // 0x0x24
    public Guid <LJPMIOMLPPL>k__BackingField;    // 0x0x28
    public DateTime <GBJCKJLMLHE>k__BackingField;    // 0x0x38
    public DJHAECFBADF <CDIKLDMOBMG>k__BackingField;    // 0x0x40
}
...
// AKNHJGBMMBP
//   (not directly referenced by a detected call)
public class AKNHJGBMMBP
{
    public AEBKHOGILEO CFGJDKAKHNC;    // 0x0x10
    public int JLNIHAPCCBG;    // 0x0x14
}
...
public class APOFOHCKOKC
{
    public int <IHDAJEEJJGP>k__BackingField;    // 0x0x10
    public int <JGLJFBLFFBO>k__BackingField;    // 0x0x14
    public float <KNNAPAPLLKP>k__BackingField;    // 0x0x18
    public int <IFHMDNAFMGE>k__BackingField;    // 0x0x1C
    public int <IGHJHPIILFH>k__BackingField;    // 0x0x20
    public int <NEOENAOHGDN>k__BackingField;    // 0x0x24
    public int <OHOBCCOFHGK>k__BackingField;    // 0x0x28
    public string <BCONKDOFANE>k__BackingField;    // 0x0x30
    public string <DOLPBIMNHBA>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// BBOEOPFKCIG
//   (not directly referenced by a detected call)
public class BBOEOPFKCIG
{
    public int <PCMELHBDKMH>k__BackingField;    // 0x0x10
    public BOBPOMJJLHB <NCGMNHJEPMK>k__BackingField;    // 0x0x14
    public List<KLMIDIKPAIB> <MMAABIHEIHF>k__BackingField;    // 0x0x18
    public List<KLMIDIKPAIB> <BHCJPOHFBOG>k__BackingField;    // 0x0x20
    public bool <BGCLCIDKJJG>k__BackingField;    // 0x0x28
    public DateTime? <NDBBMHFGNKC>k__BackingField;    // 0x0x30
    public DateTime? <KJLFDMFFHIH>k__BackingField;    // 0x0x40
    public DateTime? <POFPJDOPMGK>k__BackingField;    // 0x0x50
}
...
public class BEOMPBHPFFJ
{
    public IENPNMDDJPC <FBOPKFPDHEJ>k__BackingField;    // 0x0x10
    public string <CNJKKCAPOCE>k__BackingField;    // 0x0x18
    public string <NPNMAFPHDHE>k__BackingField;    // 0x0x20
    public string <JIMKHFFFOLO>k__BackingField;    // 0x0x28
    public FFBECNDCDKE <CJKKJLJGGPH>k__BackingField;    // 0x0x30
    public string <NHPMFGNKAIN>k__BackingField;    // 0x0x38
    public int <ALCCNOLHLLK>k__BackingField;    // 0x0x40
    public bool <OKGHBBHDBEG>k__BackingField;    // 0x0x44
}

// --------------------------------------------------------------------------
// BFDAPOIHGAG
//   (not directly referenced by a detected call)
public class BFDAPOIHGAG
{
    public DateTime <LIDAELHGCFF>k__BackingField;    // 0x0x10
    public string <PMOHJPLJMBC>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{gLLDONEGIHA}   [Service.Econ]
public enum BHPCPHLNAAN
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class BJILILMLBEL
{
    public int <FCONLHHCCKJ>k__BackingField;    // 0x0x10
    public int? <PBODEPKFKCG>k__BackingField;    // 0x0x14
    public string <JCHOOJJIFNH>k__BackingField;    // 0x0x20
    public string <BJKBIPMECDD>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// BJNKCEKDNEL
//   (not directly referenced by a detected call)
public class BJNKCEKDNEL
{
    public long <DPAONHHKKAK>k__BackingField;    // 0x0x10
    public Guid <AHJPNHFNMPP>k__BackingField;    // 0x0x18
    public long <NNNDMFADNLC>k__BackingField;    // 0x0x28
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x30
    public string <PMONOMCKNJL>k__BackingField;    // 0x0x38
    public int <KAOLHCFHNKJ>k__BackingField;    // 0x0x40
    public Guid? <EHGGJMFECCE>k__BackingField;    // 0x0x44
    public DateTime <LIDAELHGCFF>k__BackingField;    // 0x0x58
    public string <KPOHGLLLMEL>k__BackingField;    // 0x0x60
    public IHNNKKJFHMD <NCGMNHJEPMK>k__BackingField;    // 0x0x68
}
...
public class BLHLKMIOGIJ
{
    public string <CBGBOLBOPPI>k__BackingField;    // 0x0x10
    public string <MFKKEIOKFNL>k__BackingField;    // 0x0x18
    public bool <CAHCMPNGOFC>k__BackingField;    // 0x0x20
    public string <NAGPCJOGIIL>k__BackingField;    // 0x0x28
}
...
public class CEEOAPHOCBB
{
    public List<int> <DDKEJBHFJHC>k__BackingField;    // 0x0x10
    public string <EGOOGGHIIMG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CIECDKMBPON
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class CIECDKMBPON
{
    public List<DAIFBCEANDC> <PDPFGPNECJC>k__BackingField;    // 0x0x10
    public string <EGOOGGHIIMG>k__BackingField;    // 0x0x18
}
...
public class CIGKDPEGHKO
{
    public int? <HBLMMICAFKD>k__BackingField;    // 0x0x10
    public string <PPAJLEFJNLD>k__BackingField;    // 0x0x18
    public string <DPNDFPIIGAN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CIPBHMEMNHF
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class CIPBHMEMNHF
{
    public string <NOJGKADDJHI>k__BackingField;    // 0x0x10
    public string <MJLGOKFJEFL>k__BackingField;    // 0x0x18
    public string <EIGHDOGNEOB>k__BackingField;    // 0x0x20
    public string <PMONOMCKNJL>k__BackingField;    // 0x0x28
    public string <PPAJLEFJNLD>k__BackingField;    // 0x0x30
    public BKIHKFEBFGF <KAJCGIJMEIL>k__BackingField;    // 0x0x38
    public List<string> <MIHNAGGAEGH>k__BackingField;    // 0x0x40
    public List<string> <FOGAOEKHDBL>k__BackingField;    // 0x0x48
    public string <LHHFNMFMPIA>k__BackingField;    // 0x0x50
    public List<BFDAPOIHGAG> <OODNCGEABMF>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// CKLLLOHOMKK
//   (not directly referenced by a detected call)
public class CKLLLOHOMKK
{
    public int <DLBHNNCHKOL>k__BackingField;    // 0x0x10
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x18
    public string <ONDKFDJNFJH>k__BackingField;    // 0x0x20
    public string <PMONOMCKNJL>k__BackingField;    // 0x0x28
    public string <JIMKHFFFOLO>k__BackingField;    // 0x0x30
    public bool <CFMELMKPPIJ>k__BackingField;    // 0x0x38
    public int <NOKBMLMGJBJ>k__BackingField;    // 0x0x3C
    public CMFIEBPJPEE <APNAHGELFPJ>k__BackingField;    // 0x0x40
    public DLPFBPGBJMD OGGJFHDGGAA;    // 0x0x48
    public DLPFBPGBJMD FJLPAMLOCAJ;    // 0x0x50
    public DLPFBPGBJMD ECEKNIKKDKJ;    // 0x0x58
    public GJEPFCPJFCO LMKJPFAGIID;    // 0x0x60
}

// --------------------------------------------------------------------------
// CMFIEBPJPEE
//   (not directly referenced by a detected call)
public class CMFIEBPJPEE
{
    // (no instance fields in the metadata dump)
}
...
public class DAEAOPJIDID
{
    public List<string> <ANOFIHHBADJ>k__BackingField;    // 0x0x10
    public byte <POAHMGJKOCF>k__BackingField;    // 0x0x18
    public int <KPPGMBMFDID>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// DAIFBCEANDC
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class DAIFBCEANDC
{
    public long <IKECBAANHOP>k__BackingField;    // 0x0x10
    public int <ALCHCILICEJ>k__BackingField;    // 0x0x18
    public long <NNNDMFADNLC>k__BackingField;    // 0x0x20
    public long? <FCJJFNHOKBJ>k__BackingField;    // 0x0x28
    public long? <CAMHGOJHNFD>k__BackingField;    // 0x0x38
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x48
    public string <PMONOMCKNJL>k__BackingField;    // 0x0x50
    public string <KPOHGLLLMEL>k__BackingField;    // 0x0x58
    public DateTime <CNOMCLICKPD>k__BackingField;    // 0x0x60
    public DateTime <OMICFAIOPEF>k__BackingField;    // 0x0x68
    public int <FHNMAHPGEAE>k__BackingField;    // 0x0x70
    public AIDFCDAHFKH <OPBHLHIKCOG>k__BackingField;    // 0x0x74
    public bool <HLEPFOEGMOP>k__BackingField;    // 0x0x78
    public bool <NABGLMMPCDH>k__BackingField;    // 0x0x79
    public PEJMEEOCFLG <NNMBLPKKNBJ>k__BackingField;    // 0x0x7C
    public PEJMEEOCFLG <OKEGKAOCFNH>k__BackingField;    // 0x0x80
    public long? <DOBGDAHPBGH>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// DENNJKGPDHF
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class DENNJKGPDHF
{
    public List<ENMODCABAFC> <ELAAOPDLCPP>k__BackingField;    // 0x0x10
    public EBMDDBADIPA <MOALDALAIHK>k__BackingField;    // 0x0x18
}
...
// DHKGIEFFNAA
//   (not directly referenced by a detected call)
public class DHKGIEFFNAA
{
    public int <HOBNPHIPCAF>k__BackingField;    // 0x0x10
    public DateTime? <KNMHGJKHKGF>k__BackingField;    // 0x0x18
    public DateTime? <DKPEPMFGKIG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// DJHAECFBADF
//   (not directly referenced by a detected call)
public class DJHAECFBADF
{
    public Guid <JGIMMMAMGCE>k__BackingField;    // 0x0x10
    public long <NNNDMFADNLC>k__BackingField;    // 0x0x20
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x28
    public string <PMONOMCKNJL>k__BackingField;    // 0x0x30
    public string <KPOHGLLLMEL>k__BackingField;    // 0x0x38
    public long <KAOLHCFHNKJ>k__BackingField;    // 0x0x40
    public Guid? <EHGGJMFECCE>k__BackingField;    // 0x0x48
    public DateTime <GBJCKJLMLHE>k__BackingField;    // 0x0x60
    public int <OMMNEJMAOOL>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// DLHMAJOGNME
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItems   [Service.API]
public class DLHMAJOGNME
{
    public byte <POAHMGJKOCF>k__BackingField;    // 0x0x10
    public int <KPPGMBMFDID>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// DPGLJCCMJIF
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{kHAOBMIAMHJ}   [Service.API]
public class DPGLJCCMJIF
{
    public List<DAIFBCEANDC> <JDOKDNIPINN>k__BackingField;    // 0x0x10
    public List<PPPJMGLLLLK> <HBONFEGGOLP>k__BackingField;    // 0x0x18
}
...
public class ECPBODFMNFO
{
    public int <NMNBHNNJIHM>k__BackingField;    // 0x0x10
    public bool <LNCKFHBEPOC>k__BackingField;    // 0x0x14
    public DateTime <PGMGKEHGGIH>k__BackingField;    // 0x0x18
    public bool <NEDIGGDJABL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ECPNIHLAEEI
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class ECPNIHLAEEI
{
    public List<FMBHFLCOJFE> <KENEDMJOHCP>k__BackingField;    // 0x0x10
    public string <EGOOGGHIIMG>k__BackingField;    // 0x0x18
}
...
public class EDLOLOMBIJN
{
    public Guid <KHBMFMHANJA>k__BackingField;    // 0x0x10
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x20
    public string <KPOHGLLLMEL>k__BackingField;    // 0x0x28
    public DateTime <MGHCJCFFNDE>k__BackingField;    // 0x0x30
    public DateTime? <JECKIHAHPKM>k__BackingField;    // 0x0x38
    public List<PJJADCBKEAH> <LGNIPLGDAKD>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// EEHGDDJLFAM
// base   : NOLBEJDJBOL`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class EEHGDDJLFAM
{
    // (no instance fields in the metadata dump)
}
...
public class EIKFKGJEHGD
{
    public long? <NOJGKADDJHI>k__BackingField;    // 0x0x10
    public int? <GEJNJECNPHC>k__BackingField;    // 0x0x20
    public string <HGIIPPOPCGJ>k__BackingField;    // 0x0x28
    public IENPNMDDJPC? <FBOPKFPDHEJ>k__BackingField;    // 0x0x30
    public string <IPBCMGADBIA>k__BackingField;    // 0x0x38
    public string <NFNIFILNBIJ>k__BackingField;    // 0x0x40
    public string <LJKIIHCDLFA>k__BackingField;    // 0x0x48
    public JMLBMNFJKBC <HHCEGJBOCBI>k__BackingField;    // 0x0x50
    public int <MMIJPMPINID>k__BackingField;    // 0x0x54
    public int <GBOJJAEIPKK>k__BackingField;    // 0x0x58
    public NMIAJDNBHGN <IDFJBOABJGK>k__BackingField;    // 0x0x5C
    public FFBECNDCDKE <JNGOMMHNHKB>k__BackingField;    // 0x0x60
    public string <IEKAGPBKHPI>k__BackingField;    // 0x0x68
    public EPKMJFMGJBP <OIJODMLPOME>k__BackingField;    // 0x0x70
    public ICIJIAJKKOC <DBHPGLLLMME>k__BackingField;    // 0x0x74
    public FLCKKMHMLGG? <ICFMGPGHAEG>k__BackingField;    // 0x0x78
    public bool <JJDDEIEIEMH>k__BackingField;    // 0x0x80
    public bool <GNFEABGAAHE>k__BackingField;    // 0x0x81
    public string <FIODBAEDLOB>k__BackingField;    // 0x0x88
    public bool <MNEMICKMMJO>k__BackingField;    // 0x0x90
    public bool HNBMBMADIFN;    // 0x0x91
}

// --------------------------------------------------------------------------
// ENMODCABAFC
//   (not directly referenced by a detected call)
public class ENMODCABAFC
{
    public int <HBOFOEPGGPH>k__BackingField;    // 0x0x10
    public EBMDDBADIPA <MOALDALAIHK>k__BackingField;    // 0x0x14
}
...
public class EOOJNLDBCGA
{
    public EBMDDBADIPA <MOALDALAIHK>k__BackingField;    // 0x0x10
}
...
public class FJBGCHPFJGI
{
    public int <CBMDGFMJMAE>k__BackingField;    // 0x0x10
    public string <HJNNHLECJNG>k__BackingField;    // 0x0x18
    public List<CKLLLOHOMKK> <DFPDJHJFDNJ>k__BackingField;    // 0x0x20
    public LPFOKBFLMCC <KLKKOEDBHLI>k__BackingField;    // 0x0x28
    public string <CMAKIMJHPKP>k__BackingField;    // 0x0x30
    public DateTime <MGHCJCFFNDE>k__BackingField;    // 0x0x38
    public DateTime <NAHNHEGENHP>k__BackingField;    // 0x0x40
    public DateTime <BNIAEILJOMF>k__BackingField;    // 0x0x48
    public bool? <APONDBPGNNC>k__BackingField;    // 0x0x50
}
...
// base   : DAIFBCEANDC
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class FJDACBPLJMG : DAIFBCEANDC
{
    public List<IFHIMFOFHJE> <FOGAOEKHDBL>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// FKMKEDOMLBK
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class FKMKEDOMLBK
{
    public int <KADEJKNAEBD>k__BackingField;    // 0x0x10
}
...
// FMBHFLCOJFE
//   (not directly referenced by a detected call)
public class FMBHFLCOJFE
{
    public int <BAIACAPOIIG>k__BackingField;    // 0x0x10
    public DateTime <LIDAELHGCFF>k__BackingField;    // 0x0x18
    public DateTime? <DGFBFJBHNBE>k__BackingField;    // 0x0x20
}
...
public class GBCOADDBCBG
{
    public Dictionary<int, int> <JKFHNOILKBG>k__BackingField;    // 0x0x10
    public List<CNBPOFCGJNJ> <AHPIFPCJKBJ>k__BackingField;    // 0x0x18
    public AKNHJGBMMBP[][] <DMDPCDNCIIE>k__BackingField;    // 0x0x20
    public KHNKJOMPOCD <PBOKCALJNDM>k__BackingField;    // 0x0x28
    public KPOIMDCLOAM <HBDENCCKLFC>k__BackingField;    // 0x0x30
    public AEANMFAJIMC <HBBBKIHNHLP>k__BackingField;    // 0x0x38
    public MLPPHJOODML <BEPJKFADLEH>k__BackingField;    // 0x0x40
    public HIONJMAIGPN <HICNPLHDBID>k__BackingField;    // 0x0x48
    public string <DHDGJPFNOOH>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// GDJCLJGAAHH
//   (not directly referenced by a detected call)
public class GDJCLJGAAHH
{
    public ObscuredLong <BNCNCEJMCHH>k__BackingField;    // 0x0x10
    public string <AHJPNHFNMPP>k__BackingField;    // 0x0x38
    public ObscuredInt <ALCHCILICEJ>k__BackingField;    // 0x0x40
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x58
    public string <PMONOMCKNJL>k__BackingField;    // 0x0x60
    public string <KPOHGLLLMEL>k__BackingField;    // 0x0x68
    public int <IMLGMNBHBMC>k__BackingField;    // 0x0x70
    public FAFGHGIKAKI <OPBHLHIKCOG>k__BackingField;    // 0x0x74
    public DateTime <GBJCKJLMLHE>k__BackingField;    // 0x0x78
    public DateTime <LIDAELHGCFF>k__BackingField;    // 0x0x80
    public DateTime? <IFMINIAPKGL>k__BackingField;    // 0x0x88
    public long? <HDHOCMHDKCE>k__BackingField;    // 0x0x98
    public int <LNACKCEMBJK>k__BackingField;    // 0x0xA8
    public int <KCCKGHHEGPL>k__BackingField;    // 0x0xAC
    public int <BOJOMNFINLD>k__BackingField;    // 0x0xB0
    public BKKNMCIOAAD <ALOPPCHAOAO>k__BackingField;    // 0x0xB4
    public BKKNMCIOAAD <LLJJLOBNNBN>k__BackingField;    // 0x0xB8
    public ObscuredBool <FMALDKGALNO>k__BackingField;    // 0x0xBC
    public ObscuredBool <GPKBLLKFODN>k__BackingField;    // 0x0xC8
    public ObscuredBool <LCFBPLOCGAB>k__BackingField;    // 0x0xD4
    public int? <KAOLHCFHNKJ>k__BackingField;    // 0x0xE0
    public bool <BLJMEOOEACP>k__BackingField;    // 0x0xE8
}

// --------------------------------------------------------------------------
// GDKJBCJDLLP
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class GDKJBCJDLLP
{
    public Dictionary<Guid, LPCEABLMEFK> <LLPADELCAJA>k__BackingField;    // 0x0x10
}
...
public class GIIBNJELNGC
{
    public Guid <BOMFMPFCOOF>k__BackingField;    // 0x0x10
    public long <JHBJFFPLHMN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GOIMICDCOPJ
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class GOIMICDCOPJ
{
    public IELDJFEHOMD <MOALDALAIHK>k__BackingField;    // 0x0x10
    public List<string> <FOGAOEKHDBL>k__BackingField;    // 0x0x18
}
...
// base   : BBOEOPFKCIG
//   (not directly referenced by a detected call)
public class HAFPBJDNBNC : BBOEOPFKCIG
{
    public int <FJPGKGDKNAA>k__BackingField;    // 0x0x60
    public List<AHOLLFOMECH> <LOKKAKFHIFH>k__BackingField;    // 0x0x68
    public List<AHOLLFOMECH> <ONCNBDOGIBE>k__BackingField;    // 0x0x70
    public List<AHOLLFOMECH> <IEPAMBCEKFF>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// HEOJKIIIMPP
//   (not directly referenced by a detected call)
public class HEOJKIIIMPP
{
    public int <FPPPAPFNJJL>k__BackingField;    // 0x0x10
    public string <NPNMAFPHDHE>k__BackingField;    // 0x0x18
    public string <JIMKHFFFOLO>k__BackingField;    // 0x0x20
    public string <NHPMFGNKAIN>k__BackingField;    // 0x0x28
    public string <HGIIPPOPCGJ>k__BackingField;    // 0x0x30
    public string <IPBCMGADBIA>k__BackingField;    // 0x0x38
    public IENPNMDDJPC? <FBOPKFPDHEJ>k__BackingField;    // 0x0x40
    public string <NFNIFILNBIJ>k__BackingField;    // 0x0x48
    public string <LJKIIHCDLFA>k__BackingField;    // 0x0x50
    public bool <OMGPOANJNIF>k__BackingField;    // 0x0x58
    public bool <COELLLHOCHF>k__BackingField;    // 0x0x59
    public bool <GJCALJEKPDP>k__BackingField;    // 0x0x5A
    public FFBECNDCDKE <CJKKJLJGGPH>k__BackingField;    // 0x0x5C
    public int <ALCCNOLHLLK>k__BackingField;    // 0x0x60
    public JMLBMNFJKBC <HHCEGJBOCBI>k__BackingField;    // 0x0x64
    public int <MMIJPMPINID>k__BackingField;    // 0x0x68
    public ALJOHPBKGEO <EBGNLCLNGGL>k__BackingField;    // 0x0x6C
    public NMIAJDNBHGN <GBPFEPCAFAA>k__BackingField;    // 0x0x70
    public int? <FFLJDCONJGB>k__BackingField;    // 0x0x74
    public string <KBAJHEMOFHI>k__BackingField;    // 0x0x80
}
...
// HIONJMAIGPN
//   (not directly referenced by a detected call)
public class HIONJMAIGPN
{
    public float <PCFKHEKEOLO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HNAFIODMHGK
//   (not directly referenced by a detected call)
public class HNAFIODMHGK
{
    public long <GGBBGOKEIPK>k__BackingField;    // 0x0x10
    public Guid <NODHFEELKNB>k__BackingField;    // 0x0x18
    public Guid <PDCOLHJODFH>k__BackingField;    // 0x0x28
    public DateTime <LIDAELHGCFF>k__BackingField;    // 0x0x38
    public string <MHLDOPIHEPA>k__BackingField;    // 0x0x40
    public string <GBDHBHHAFLF>k__BackingField;    // 0x0x48
    public string <EDCKFNLGIHL>k__BackingField;    // 0x0x50
    public string <KEKLGNGADML>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// HPJPNINIPOG
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{eNFDIKBFAHD}/{fEECAGALHEM}   [Service.Econ]
public class HPJPNINIPOG
{
    public JMLBMNFJKBC <HHCEGJBOCBI>k__BackingField;    // 0x0x10
    public NIPJKPOPGID <JILHGNHCPMD>k__BackingField;    // 0x0x14
    public int <ECKHMJKIMGL>k__BackingField;    // 0x0x18
    public int <KGHNPFLBOAJ>k__BackingField;    // 0x0x1C
    public int <CGNMPOCMFDA>k__BackingField;    // 0x0x20
    public ACGMGGLODMP <KPMLMGFFABI>k__BackingField;    // 0x0x24
    public bool <DNPCNINNHBA>k__BackingField;    // 0x0x28
    public float <PLANHMGJIFL>k__BackingField;    // 0x0x2C
    public int <DIIPFLJNLHE>k__BackingField;    // 0x0x30
    public bool <EILPJANBLAO>k__BackingField;    // 0x0x34
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{eLOLECHAJGO}   [Service.API]
...
public class IAPCGHMEIOI
{
    public FJDACBPLJMG <FONKIPLGCFL>k__BackingField;    // 0x0x10
    public EBMDDBADIPA <MOALDALAIHK>k__BackingField;    // 0x0x18
    public GOIMICDCOPJ <BHIPLIFMPEP>k__BackingField;    // 0x0x20
}
...
// IFHIMFOFHJE
//   (not directly referenced by a detected call)
public class IFHIMFOFHJE
{
    public string <LJJEICNDJCM>k__BackingField;    // 0x0x10
    public HGGLPJJCPLP <NCGMNHJEPMK>k__BackingField;    // 0x0x18
}
...
// IKEKBEBFLBM
//   (not directly referenced by a detected call)
public class IKEKBEBFLBM
{
    public long <BFGAIEJLLOM>k__BackingField;    // 0x0x10
    public long <IKECBAANHOP>k__BackingField;    // 0x0x18
    public int <KDPOHAFHMML>k__BackingField;    // 0x0x20
    public DateTime <LIDAELHGCFF>k__BackingField;    // 0x0x28
    public LJHEGGHLHKL <NCGMNHJEPMK>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// ILCLKKIGMLD
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class ILCLKKIGMLD
{
    public CONKNPMIDCO <IJLBHKJEKHB>k__BackingField;    // 0x0x10
    public int <KADEJKNAEBD>k__BackingField;    // 0x0x14
    public long <PEFOONIMBAI>k__BackingField;    // 0x0x18
    public bool <MDMCEBAMMGA>k__BackingField;    // 0x0x20
    public string <CBDLMOPAGKC>k__BackingField;    // 0x0x28
    public int? <PJEPKGHOIEI>k__BackingField;    // 0x0x30
    public bool <KEKDODMHGHP>k__BackingField;    // 0x0x38
    public bool <OFMPNDAKBHO>k__BackingField;    // 0x0x39
    public bool <FPJEBGBIKEJ>k__BackingField;    // 0x0x3A
    public bool <PCLIMKLNKKF>k__BackingField;    // 0x0x3B
    public string <MMJGPDNADOD>k__BackingField;    // 0x0x40
    public DateTime? <HOAOKCLAGKF>k__BackingField;    // 0x0x48
    public float <NJOAEOJLCND>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// IPPCICMEFJK
//   (not directly referenced by a detected call)
public class IPPCICMEFJK
{
    public bool <BNLPHBMBDAJ>k__BackingField;    // 0x0x10
    public ICIJIAJKKOC <ADHCJACAPAB>k__BackingField;    // 0x0x14
    public int <JHAEGPGHFMK>k__BackingField;    // 0x0x18
    public DateTime <GBJCKJLMLHE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JBIKNPECEMF
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class JBIKNPECEMF
{
    public long <NNNDMFADNLC>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <HFAKHMLBNPA>k__BackingField;    // 0x0x18
    public FPCKMCFIDAL <FAKBAJPGKLN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JFAFKAJNCNN
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class JFAFKAJNCNN
{
    public List<IFHIMFOFHJE> <FOGAOEKHDBL>k__BackingField;    // 0x0x10
}
...
public class JGECFCAHNJN
{
    public Dictionary<string, HNAFIODMHGK> <HPILGDJFPGL>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{iKOGMJGDNJH}   [Service.Econ]
public class JNPBCJFAEHH
{
    public KGMLMHKEPBA <KAJCGIJMEIL>k__BackingField;    // 0x0x10
    public DJHAECFBADF <CDIKLDMOBMG>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/keepsakes/{aMLCIGODEFN}   [Service.API]
...
public class KBNDOELMFNI
{
    public bool <EBIAGLPOOFL>k__BackingField;    // 0x0x10
    public string <FGGMJIAOEFC>k__BackingField;    // 0x0x18
}
...
// KHNKJOMPOCD
//   (not directly referenced by a detected call)
public class KHNKJOMPOCD
{
    public int <BOBGNIJNCNJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KIEJKFIDHCI
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class KIEJKFIDHCI
{
    public long <DPAONHHKKAK>k__BackingField;    // 0x0x10
    public int <KFIIFEAJBKO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KLMIDIKPAIB
//   (not directly referenced by a detected call)
public class KLMIDIKPAIB
{
    public JMLBMNFJKBC <HHCEGJBOCBI>k__BackingField;    // 0x0x10
    public int <KAOLHCFHNKJ>k__BackingField;    // 0x0x14
    public DHKGIEFFNAA <OEBNBHJEIEL>k__BackingField;    // 0x0x18
}
...
public class KNKCADEMGCM : LAAPLCEJLPI
{
    public DGAMONJPONG? <EHIMIDHDHKG>k__BackingField;    // 0x0x18
    public MALGIIODNLM <AMNIDPAILEM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KOMHLKJKHPP
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class KOMHLKJKHPP
{
    public Guid? <JGIMMMAMGCE>k__BackingField;    // 0x0x10
    public long? <NNNDMFADNLC>k__BackingField;    // 0x0x28
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x38
    public string <PMONOMCKNJL>k__BackingField;    // 0x0x40
    public string <KPOHGLLLMEL>k__BackingField;    // 0x0x48
    public OJMOOHJGKNG <JPLEEMIJMCN>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// KOPGDIABIMO
//   (not directly referenced by a detected call)
public class KOPGDIABIMO
{
    public long <BNCNCEJMCHH>k__BackingField;    // 0x0x10
    public string <AHJPNHFNMPP>k__BackingField;    // 0x0x18
    public int <ELBBNONFNGD>k__BackingField;    // 0x0x20
    public int <BGMMLGOIJBO>k__BackingField;    // 0x0x24
    public int <PLLKFEIDAKI>k__BackingField;    // 0x0x28
    public int <OGNMBBNAPOA>k__BackingField;    // 0x0x2C
    public int <ALDOHDEPOPJ>k__BackingField;    // 0x0x30
    public string <LPPAGEIJBHM>k__BackingField;    // 0x0x38
    public string <LFBIFGBNPAM>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// KPOIMDCLOAM
//   (not directly referenced by a detected call)
public class KPOIMDCLOAM
{
    public float <OBDLODBCACC>k__BackingField;    // 0x0x10
    public float <IPEAHHBKKIF>k__BackingField;    // 0x0x14
    public float <EKIOHGFNFMA>k__BackingField;    // 0x0x18
    public float <JLBHABILKPD>k__BackingField;    // 0x0x1C
    public float <MJMDLIJAOOE>k__BackingField;    // 0x0x20
    public float <CCFMJPOKECI>k__BackingField;    // 0x0x24
    public float <EEONFGOFMMB>k__BackingField;    // 0x0x28
    public float <CPADGLNDJDD>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// LCAAHEPBHGN
//   RESPONSE ?      api/roomconsumables   [Service.Econ]
public class LCAAHEPBHGN
{
    public KGMLMHKEPBA <KAJCGIJMEIL>k__BackingField;    // 0x0x10
    public AIDAGCPBDPC <FOBICMCKOHC>k__BackingField;    // 0x0x18
}
...
public class LJNCIGGPEED
{
    public bool <APAMOPOPDCF>k__BackingField;    // 0x0x10
    public string <MJLGOKFJEFL>k__BackingField;    // 0x0x18
    public string <PLPOGKICFJC>k__BackingField;    // 0x0x20
}
...
public class LNAANHLJIGK
{
    public JHMGHHDEDOF <IJLBHKJEKHB>k__BackingField;    // 0x0x10
    public string <MCDAFMAKEID>k__BackingField;    // 0x0x18
    public int? <BGFOIKGJOAE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LPCEABLMEFK
//   (not directly referenced by a detected call)
public class LPCEABLMEFK
{
    public int <NCJLNNOMCCM>k__BackingField;    // 0x0x10
    public PGIIJEIJOKF <KDKMBFHCNDH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LPFOKBFLMCC
//   (not directly referenced by a detected call)
public class LPFOKBFLMCC
{
    public long <FPPPAPFNJJL>k__BackingField;    // 0x0x10
    public string <HGIIPPOPCGJ>k__BackingField;    // 0x0x18
    public string <IJBAJOMFFOD>k__BackingField;    // 0x0x20
    public IENPNMDDJPC? <FBOPKFPDHEJ>k__BackingField;    // 0x0x28
    public string <NFNIFILNBIJ>k__BackingField;    // 0x0x30
    public string <LJKIIHCDLFA>k__BackingField;    // 0x0x38
    public GEEHLNOCAKO <OPEPACLNLDG>k__BackingField;    // 0x0x40
    public int <GBOJJAEIPKK>k__BackingField;    // 0x0x44
    public int <JGMNALODLML>k__BackingField;    // 0x0x48
    public NMIAJDNBHGN? <IDFJBOABJGK>k__BackingField;    // 0x0x4C
    public FFBECNDCDKE? <JNGOMMHNHKB>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// MALGIIODNLM
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class MALGIIODNLM
{
    public int <KFIIFEAJBKO>k__BackingField;    // 0x0x10
    public Guid <IAFALFPKFID>k__BackingField;    // 0x0x14
    public long <OKCHKHNGNHC>k__BackingField;    // 0x0x28
    public DateTime <GBJCKJLMLHE>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// MLPPHJOODML
//   (not directly referenced by a detected call)
public class MLPPHJOODML
{
    public int <FJLAGAKIDBJ>k__BackingField;    // 0x0x10
}
...
public class MMPOEOAKIIJ
{
    public bool <EBIAGLPOOFL>k__BackingField;    // 0x0x10
    public string <CBDLMOPAGKC>k__BackingField;    // 0x0x18
}
...
public class MNOJGPGIGPE : LAAPLCEJLPI
{
    public BPNGOOMBKOI? <EHIMIDHDHKG>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <HJJLKLEJIED>k__BackingField;    // 0x0x20
}
...
public class NBACEBPCBGE
{
    public int <LEGCFLFBEOD>k__BackingField;    // 0x0x10
    public int <NMNBHNNJIHM>k__BackingField;    // 0x0x14
    public float <LCJMJFDHFFE>k__BackingField;    // 0x0x18
    public float <CGFCDFMIDDI>k__BackingField;    // 0x0x1C
    public bool <LNCKFHBEPOC>k__BackingField;    // 0x0x20
    public bool <HHJOENNNHII>k__BackingField;    // 0x0x21
    public bool <DKEEBJHDKAL>k__BackingField;    // 0x0x22
}
...
public class NCMNCKODGOM : INBACCIFCKP
{
    public List<NHFELIDEPEE> ILKIDNBMOFD;    // 0x0x30
    public int <CKMGFBDFFAG>k__BackingField;    // 0x0x38
}
...
// base   : BBOEOPFKCIG
//   (not directly referenced by a detected call)
public class NHFELIDEPEE : BBOEOPFKCIG
{
    public HEOJKIIIMPP <MLAEMKIEIJN>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// NIAIBCCDMAB
// base   : NOLBEJDJBOL`1<FMDBBMOJOBF>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{dLJEKKIBFGE}   [Service.API]
public class NIAIBCCDMAB
{
    // (no instance fields in the metadata dump)
}
...
// OJMOOHJGKNG
//   (not directly referenced by a detected call)
public class OJMOOHJGKNG
{
    public long <KAOLHCFHNKJ>k__BackingField;    // 0x0x10
    public Guid? <IAFALFPKFID>k__BackingField;    // 0x0x18
}
...
public class ONMGCDPNJLI
{
    public int <LMKIIAKHLMA>k__BackingField;    // 0x0x10
    public HBHPPLELGML <NCGMNHJEPMK>k__BackingField;    // 0x0x14
    public CCNJCIPEGKB <BKHPFLMPJJI>k__BackingField;    // 0x0x18
    public CCNJCIPEGKB <LBFKEKAMHBD>k__BackingField;    // 0x0x1C
    public CCNJCIPEGKB <JFNGDGANGFD>k__BackingField;    // 0x0x20
}
...
// PGIIJEIJOKF
//   (not directly referenced by a detected call)
public class PGIIJEIJOKF
{
    public Guid? <APMCHJPMNEL>k__BackingField;    // 0x0x10
    public Guid <IIIEDPDANCN>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// PIMECBNHLAH
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class PIMECBNHLAH
{
    public Dictionary<Guid, LCAAHEPBHGN> <NFODIOJDDIP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PJJADCBKEAH
//   (not directly referenced by a detected call)
public class PJJADCBKEAH
{
    public Guid <LGBGBNJJGKM>k__BackingField;    // 0x0x10
    public Guid <GKJNPCEEINK>k__BackingField;    // 0x0x20
    public DateTime <MGHCJCFFNDE>k__BackingField;    // 0x0x30
    public List<HEOJKIIIMPP> <EGOPLEMDJEN>k__BackingField;    // 0x0x38
}
...
public class PLCMDMLGEEC
{
    public CDAKPFPLNHO <KAJCGIJMEIL>k__BackingField;    // 0x0x10
    public GDJCLJGAAHH <LENNMCMBOKC>k__BackingField;    // 0x0x18
    public KOPGDIABIMO <HCADBMKMCKO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PPPJMGLLLLK
//   (not directly referenced by a detected call)
public class PPPJMGLLLLK
{
    public DAIFBCEANDC <FONKIPLGCFL>k__BackingField;    // 0x0x10
    public IKEKBEBFLBM <HCMJGGGNCBO>k__BackingField;    // 0x0x18
}
...
{
    public long <NNNDMFADNLC>k__BackingField;    // 0x0x10
    public long? <FCJJFNHOKBJ>k__BackingField;    // 0x0x18
    public AHMBGFPAINI <IFPFPEDNKIP>k__BackingField;    // 0x0x28
}
...
{
    public IHDPMKCFGJM <MOALDALAIHK>k__BackingField;    // 0x0x10
    public string <AFBHLFMNLID>k__BackingField;    // 0x0x18
    public string <EDGCMGDHJJI>k__BackingField;    // 0x0x20
    public string <ONCPPJJOHPJ>k__BackingField;    // 0x0x28
}
...
{
    public long <IKECBAANHOP>k__BackingField;    // 0x0x10
    public long? <BBBCBOANNKJ>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public JNELDMLDMML FilterType;    // 0x0x20
...
{
    public AHMBGFPAINI <DJGPJFJKIIK>k__BackingField;    // 0x0x10
    public string <APECJPIGPKJ>k__BackingField;    // 0x0x18
    public int <JMJEKLDOFBF>k__BackingField;    // 0x0x20
    public int <MOEIABDHMMM>k__BackingField;    // 0x0x24
    public string <BBMFLIPGBEP>k__BackingField;    // 0x0x28
    public string <OCNFBECFECJ>k__BackingField;    // 0x0x30
}
...
{
    public int <KFIIFEAJBKO>k__BackingField;    // 0x0x10
    public Guid <HMPDNAIPAKF>k__BackingField;    // 0x0x14
    public DateTime <IMLFKBAKLEM>k__BackingField;    // 0x0x28
}
...
{
    public bool <AEBHDEGHCJM>k__BackingField;    // 0x0x10
    public int <MJIHOGAONBN>k__BackingField;    // 0x0x14
    public bool <PBNLGOLHKBP>k__BackingField;    // 0x0x18
}
...
{
    public Guid <HMPDNAIPAKF>k__BackingField;    // 0x0x10
    public AHMBGFPAINI <AGMNIDDFJOL>k__BackingField;    // 0x0x20
    public int <FNECFHDHFML>k__BackingField;    // 0x0x24
    public long <NNNDMFADNLC>k__BackingField;    // 0x0x28
    public long? <FCJJFNHOKBJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{gCHCNJJCGLG}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <HOLNEEGBIKH>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <AMHBJGADEHI>k__BackingField;    // 0x0x18
}
...
{
    public long <NGJMMAEOLDB>k__BackingField;    // 0x0x10
    public long <NNNDMFADNLC>k__BackingField;    // 0x0x18
    public long <EGLNMLALNHM>k__BackingField;    // 0x0x20
    public IPBNCMNPMCE <NCGMNHJEPMK>k__BackingField;    // 0x0x28
    public int <FBBOOPDNBAE>k__BackingField;    // 0x0x2C
}
...
{
    public long <NNNDMFADNLC>k__BackingField;    // 0x0x10
    public List<Guid> <PNAPICDENCD>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <HOLNEEGBIKH>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <AMHBJGADEHI>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <GPHFNMMHNMC>k__BackingField;    // 0x0x20
}
...
{
    public long <EGLNMLALNHM>k__BackingField;    // 0x0x10
    public long <EMFABNLAJMM>k__BackingField;    // 0x0x18
    public int? <FLDAGKJGPBJ>k__BackingField;    // 0x0x20
    public int? <OFHGLABHGLL>k__BackingField;    // 0x0x28
    public long? <GIGKCPGHKJI>k__BackingField;    // 0x0x30
    public long <APENEKMHEAE>k__BackingField;    // 0x0x40
    public long <JLHMBHGJBLB>k__BackingField;    // 0x0x48
    public int <KPBEKMLAPCL>k__BackingField;    // 0x0x50
    public IPBNCMNPMCE <ELJEFCPMALA>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <INLBNGCGNBP>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public NMIAJDNBHGN <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public OAIIBDMKGPP creatorAccountRole;    // 0x0x58
}
...
{
    public JDECAOAPPMB <DBNGCMHPOAG>k__BackingField;    // 0x0x10
    public GJLIDLJLDBF <FKIENFFMNOC>k__BackingField;    // 0x0x14
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x18
    public string <PMONOMCKNJL>k__BackingField;    // 0x0x20
    public bool <ENHMDJHNPLD>k__BackingField;    // 0x0x28
}
...
{
    public List<JDECAOAPPMB> <IFHEMEHPGBC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{eLOLECHAJGO}   [Service.API]
public class ProgressionEventDTO
{
    public long <EMFABNLAJMM>k__BackingField;    // 0x0x10
    public string <PNEGEPIAKEA>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <IEPAMBCEKFF>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <MANFGKGHHDM>k__BackingField;    // 0x0x28
    public DateTime <CNOMCLICKPD>k__BackingField;    // 0x0x30
    public DateTime <OMICFAIOPEF>k__BackingField;    // 0x0x38
    public DateTime <FNOIDIIOHMK>k__BackingField;    // 0x0x40
    public bool <EIKIGLMGBHF>k__BackingField;    // 0x0x48
    public int <NMKCCIKBBHO>k__BackingField;    // 0x0x4C
    public float <KODFAGJODBG>k__BackingField;    // 0x0x50
    public Guid? <ILNECMDLDIA>k__BackingField;    // 0x0x54
    public string <HLEAOFCGBFN>k__BackingField;    // 0x0x68
    public string <BFNDBJONNNH>k__BackingField;    // 0x0x70
    public string <OHOMAFBBEFP>k__BackingField;    // 0x0x78
    public string <OIMNAEJDLMA>k__BackingField;    // 0x0x80
}
...
{
    public Guid <LJGPKFKKNCF>k__BackingField;    // 0x0x10
    public int <HPDJCNBMDEH>k__BackingField;    // 0x0x20
    public int <HLFECMDOHFH>k__BackingField;    // 0x0x24
    public int <HKLLGOOHKCA>k__BackingField;    // 0x0x28
    public long <JFHIFFLIBAG>k__BackingField;    // 0x0x30
    public long <PFMHMAFMIHL>k__BackingField;    // 0x0x38
}
...
{
    public int <KFIIFEAJBKO>k__BackingField;    // 0x0x10
    public int <GBOJJAEIPKK>k__BackingField;    // 0x0x14
    public int <PIEAGCOHECM>k__BackingField;    // 0x0x18
    public int <MEFMEKBNFDF>k__BackingField;    // 0x0x1C
    public int <IAKMIOOKALP>k__BackingField;    // 0x0x20
    public DateTime? <KEOECACFNLN>k__BackingField;    // 0x0x28
}
...
{
    public long <NBGNJEACAGL>k__BackingField;    // 0x0x10
    public int <FPPPAPFNJJL>k__BackingField;    // 0x0x18
    public string <KPOHGLLLMEL>k__BackingField;    // 0x0x20
    public int <GBOJJAEIPKK>k__BackingField;    // 0x0x28
    public int <GIFMGOAEDIM>k__BackingField;    // 0x0x2C
    public bool <LAFOBHNELOP>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public ECGIHOICKLI ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool OCONJBLEPGI;    // 0x0x28
}
...
{
    public NACOEBEFFHN? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public NACOEBEFFHN LPKDMENGMCL;  // wrapper
...
{
    public EPKMJFMGJBP KAIBLDBOOMO;  // wrapper
...
{
    public MLHEBAFEEEE DJMKKNDNCBM;  // wrapper
    public int? INGNABGIDHO;  // wrapper
...
{
    public CONKNPMIDCO MGEIOJDFPGA;  // wrapper
    public float? IMGCAFFGLCE;  // wrapper
...
{
    public CKLLLOHOMKK IEDLLOKGMHB;  // wrapper
...
{
    public FAFGHGIKAKI JODJBLPJEPE;  // wrapper
    public FKBPFFJNABI KLCPIPDEEIM;  // wrapper
    public byte[] PFKLHFEBMFA;  // wrapper
    public byte[] NOMAGDKKFCH;  // wrapper
    public Color KKBAHNFNJMK;  // wrapper
...
{
    public List<HPALFPEMGBH> ECGJPKGGOHO;  // wrapper
}
...
{
    public MOHKLACGPEN AIMMADPGAJJ;  // wrapper
    public NMIAJDNBHGN? BCOPKMNHLMI;  // wrapper
...
{
    public GIOILEDCNID KMBFMPBPBOP;  // wrapper
...
{
    public GDJCLJGAAHH inventionId;  // wrapper
}
...
// api/keepsakes/{aMLCIGODEFN}/collect  [API POST]
public class KeepsakesAMLCIGODEFNCollectRequest
{
    public Guid AMLCIGODEFN;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> FJCAEKADLEH;  // wrapper
    public JHLHPGCGNFO KJNLGLCIAFI;  // wrapper
    public long? BLPLCJENHDJ;  // wrapper
...
{
    public long? ICMJFGIJDKN;  // wrapper
}
...
{
    public long? PINPACMDEDH;  // wrapper
    public long? EMCCOMNHGDF;  // wrapper
    public List<string> GHDMMMCINAP;  // wrapper
    public DateTime DABBGBCMHPI;  // wrapper
    public DateTime DHHHBJCONFF;  // wrapper
    public AIDFCDAHFKH JODJBLPJEPE;  // wrapper
    public PEJMEEOCFLG JBJKMAJIDLB;  // wrapper
    public PEJMEEOCFLG DGINDGHACPD;  // wrapper
}
...
{
    public PEJMEEOCFLG JBJKMAJIDLB;  // wrapper
    public PEJMEEOCFLG BJOOLPDNJGM;  // wrapper
}
...
{
    public Guid LGJFFKKEONG;  // wrapper
...
{
    public Guid IKOGMJGDNJH;  // wrapper
    public Guid NJAKDGHBNKJ;  // wrapper
    public Guid? CPKNKKCGJKH;  // wrapper
}
...
{
    public List<HMGJKECFEOD> FHMPOEBCEHB;  // wrapper
}
...
{
    public Guid EOHNKCNILNI;  // wrapper
    public object Price;  // candidate
...
{
    public Guid EOHNKCNILNI;  // wrapper
    public long? OOMMKELJFHB;  // wrapper
    public byte? OAKMFADMPMH;  // wrapper
    public int? KKBAHNFNJMK;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid LGJFFKKEONG;  // wrapper
    public long? BILOKEEJKKI;  // wrapper
    public long? MGCMNAOBHHF;  // wrapper
    public int? CGGPKFNFKEA;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> OJJNHGGGKOD;  // wrapper
...
{
    public IEnumerable<IFDFHGPCMIC> PJAHOHCPDBI;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public IHNNKKJFHMD DJMKKNDNCBM;  // wrapper
    public Guid? CGAGKMFHAJD;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public CONKNPMIDCO MGEIOJDFPGA;  // wrapper
    public long? EPMDMMPLGEN;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats FLCNFLMNELF;  // wrapper
}
...
{
    public Guid AHPOFFDHMJJ;  // wrapper
...
{
    public Guid NBAJIMONLPB;  // wrapper
...
{
    public List<PGNHFCMJJPG> IBKLJACBDNF;  // wrapper
    public object roomId;  // candidate
