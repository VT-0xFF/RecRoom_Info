...
public class ABECIKDGGBJ
{
    public List<FDFOEHMCCMJ> <EPEOAODAMNM>k__BackingField;    // 0x0x10
}
...
public class ADPJKPHGLBF : AKDHFAKBCCK
{
    public PKEBLNJFNPM? <IDGHJOOLMEC>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <MCHAKJNEOGK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AGKOGCDLPNO
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class AGKOGCDLPNO
{
    public int <OEAJHLOPHBJ>k__BackingField;    // 0x0x10
    public int? <LLFPGOPLJCD>k__BackingField;    // 0x0x14
    public string <KHEMOLBOMIB>k__BackingField;    // 0x0x20
    public string <EBAOECLGHPJ>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// AHBDIOCBCOD
//   (not directly referenced by a detected call)
public class AHBDIOCBCOD
{
    public int <IDFDALNMGAG>k__BackingField;    // 0x0x10
    public LANKLBPEMKN <LCKMMKKOHGN>k__BackingField;    // 0x0x14
}
...
public class AHOFBNKJPAF
{
    public int <HLOAGCNJHHB>k__BackingField;    // 0x0x10
    public bool <ACFJNBCDEEA>k__BackingField;    // 0x0x14
    public DateTime <PKHAFLLECHN>k__BackingField;    // 0x0x18
    public bool <IOBFLJGJEGP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AIKNMBDIHPE
//   (not directly referenced by a detected call)
public class AIKNMBDIHPE
{
    public int <NGEPIENBIMO>k__BackingField;    // 0x0x10
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x18
    public string <IPPJMKJIEKI>k__BackingField;    // 0x0x20
    public string <HNDAOJDFAHO>k__BackingField;    // 0x0x28
    public string <KBIIIMEAMNM>k__BackingField;    // 0x0x30
    public bool <FKDFNHEMCBN>k__BackingField;    // 0x0x38
    public int <FBGGJKPHIGC>k__BackingField;    // 0x0x3C
    public LOCKILMCCDI <OCKBDKOGLPH>k__BackingField;    // 0x0x40
    public NEOBMJANLFC OIPIMMIOHAP;    // 0x0x48
    public NEOBMJANLFC GJEKHIBFCDF;    // 0x0x50
    public NEOBMJANLFC BIFKKGFFPHC;    // 0x0x58
    public ABCPMDFNECM LGDIALNFCHO;    // 0x0x60
}
...
public class AJONFOAEKCD
{
    public List<string> <LONIPBANJFI>k__BackingField;    // 0x0x10
    public List<string> <KNKKJANNAHN>k__BackingField;    // 0x0x18
    public List<string> <FFOGEODHBCG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ALPAHICGDBP
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class ALPAHICGDBP
{
    public List<int> <KJPKPNHCEAO>k__BackingField;    // 0x0x10
    public string <LGEODJCDKDA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AOPEAFPCHIC
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class AOPEAFPCHIC
{
    public int? <DCOGADKOGMG>k__BackingField;    // 0x0x10
    public string <KDHNOHDAJLD>k__BackingField;    // 0x0x18
    public string <PBPIJJIAIPC>k__BackingField;    // 0x0x20
}
...
public class BAGHAOGBOOB
{
    public int <POHBBNPGHKJ>k__BackingField;    // 0x0x10
    public int <HLOAGCNJHHB>k__BackingField;    // 0x0x14
    public float <HFPINCOMBJI>k__BackingField;    // 0x0x18
    public float <ABCKKDNEHKD>k__BackingField;    // 0x0x1C
    public bool <ACFJNBCDEEA>k__BackingField;    // 0x0x20
    public bool <AAFIBLFEFNL>k__BackingField;    // 0x0x21
    public bool <IDMDNHMADKL>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// BEEDJEMJFEF
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class BEEDJEMJFEF
{
    public long <GBOOLMMLAKM>k__BackingField;    // 0x0x10
    public int <JCMCEMEBBMM>k__BackingField;    // 0x0x18
    public long <PKLCAOHBDED>k__BackingField;    // 0x0x20
    public long? <FFNCEOOKCNA>k__BackingField;    // 0x0x28
    public long? <GPJMMLICLNO>k__BackingField;    // 0x0x38
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x48
    public string <HNDAOJDFAHO>k__BackingField;    // 0x0x50
    public string <LGKOHGPCENN>k__BackingField;    // 0x0x58
    public DateTime <EEIIFFHBLKL>k__BackingField;    // 0x0x60
    public DateTime <NCGLFJOLGJJ>k__BackingField;    // 0x0x68
    public int <FCEACMOPOEM>k__BackingField;    // 0x0x70
    public NFFIFFPLBAA <IENPFLFAKLL>k__BackingField;    // 0x0x74
    public bool <DKIKHMBKIPH>k__BackingField;    // 0x0x78
    public bool <FOLPCDADPGA>k__BackingField;    // 0x0x79
    public LKGHCGDAFBD <PNPHNBNKENP>k__BackingField;    // 0x0x7C
    public LKGHCGDAFBD <ILKPNDNOMLB>k__BackingField;    // 0x0x80
    public long? <JLAACPMOGIG>k__BackingField;    // 0x0x88
}
...
public class BFDDEHLCNPA
{
    public IBICIMNBIJK <PMLFDBHGHMC>k__BackingField;    // 0x0x10
    public string <GJGOCCEKEGL>k__BackingField;    // 0x0x18
    public int? <LKOIMGFFNPJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BKMPHBNKGCJ
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class BKMPHBNKGCJ
{
    public Guid? <ICPICMGMMEP>k__BackingField;    // 0x0x10
    public long? <PKLCAOHBDED>k__BackingField;    // 0x0x28
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x38
    public string <HNDAOJDFAHO>k__BackingField;    // 0x0x40
    public string <LGKOHGPCENN>k__BackingField;    // 0x0x48
    public ENBBEPINIIE <BNACKINNJIK>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// BNEHACJFHKP
//   (not directly referenced by a detected call)
public class BNEHACJFHKP
{
    public int <DJGKBOHKNAM>k__BackingField;    // 0x0x10
    public PMMGPNFEOJG <DONHMOFDBIL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BOJALEEOKAF
//   (not directly referenced by a detected call)
public class BOJALEEOKAF
{
    public bool <HFBNHHFIMDG>k__BackingField;    // 0x0x10
    public NKFBFJLHFGO <MBFNEJKBBOP>k__BackingField;    // 0x0x18
    public float <NBLAOJNFEGE>k__BackingField;    // 0x0x20
}
...
public class CCFPJCBLBDD
{
    public KOHLFELFBGK <MAMAADFKAMM>k__BackingField;    // 0x0x10
    public DIJJLBPEGDG <KLCAIALOEFF>k__BackingField;    // 0x0x18
}
...
public class CFFEOPHJCDB : NDCKKOPOFBE
{
    public List<PGJCBIMOBCD> NAGMFEEFKKG;    // 0x0x30
    public int <DMKKEGHPENK>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// CGPBEOHFLHG
//   (not directly referenced by a detected call)
public class CGPBEOHFLHG
{
    public DateTime <OMADAFPOMJO>k__BackingField;    // 0x0x10
    public string <PPPGOKGGNOC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// COGKNIJNPIO
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class COGKNIJNPIO
{
    public int <JHNDCLCBFNO>k__BackingField;    // 0x0x10
    public Guid <HPAECKHJNAD>k__BackingField;    // 0x0x14
    public long <HPEDDPCJOOI>k__BackingField;    // 0x0x28
    public DateTime <IOGILDHNABL>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// CPKOHMNEMIO
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{gFPEGBLLLMC}/{gFABFGBMMMG}   [Service.Econ]
public class CPKOHMNEMIO
{
    public INHIGKIFGMH <CJOKEEAFGMN>k__BackingField;    // 0x0x10
    public HNMBJADKCKC <ICJNCMJCLKC>k__BackingField;    // 0x0x14
    public int <DNNCKEIEGNC>k__BackingField;    // 0x0x18
    public int <FNBGGGEKBEO>k__BackingField;    // 0x0x1C
    public int <IBCOMOOCDDA>k__BackingField;    // 0x0x20
    public LPNJFPNACAN <ENGKOHJADFA>k__BackingField;    // 0x0x24
    public bool <MPPIBDPHCDH>k__BackingField;    // 0x0x28
    public float <NENOMMKOBPJ>k__BackingField;    // 0x0x2C
    public int <EENIACICNMJ>k__BackingField;    // 0x0x30
    public bool <JLJCOJLMOAC>k__BackingField;    // 0x0x34
}
...
//   RESPONSE DELETE api/keepsakes/{iEFINHMKLDJ}   [Service.API]
...
public class DCANMGNCKDM
{
    public bool <IKPMGJNDMEA>k__BackingField;    // 0x0x10
    public string <KLMABIOJMMO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DGDHEPNKCII
//   (not directly referenced by a detected call)
public class DGDHEPNKCII
{
    public int <DBBKEKPCGFA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DIJJLBPEGDG
//   (not directly referenced by a detected call)
public class DIJJLBPEGDG
{
    public Guid <ICPICMGMMEP>k__BackingField;    // 0x0x10
    public int <JHNDCLCBFNO>k__BackingField;    // 0x0x20
    public int <LODIKLCDKFO>k__BackingField;    // 0x0x24
    public Guid <CIMBNLIOPOA>k__BackingField;    // 0x0x28
    public DateTime <IOGILDHNABL>k__BackingField;    // 0x0x38
    public EDJIDLOEMKK <GKJGOEJHMJH>k__BackingField;    // 0x0x40
}
...
// base   : BEEDJEMJFEF
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class DKBDGJLEECA : BEEDJEMJFEF
{
    public List<FDFOEHMCCMJ> <EPEOAODAMNM>k__BackingField;    // 0x0x98
}
...
// EDJIDLOEMKK
//   (not directly referenced by a detected call)
public class EDJIDLOEMKK
{
    public Guid <ICPICMGMMEP>k__BackingField;    // 0x0x10
    public long <PKLCAOHBDED>k__BackingField;    // 0x0x20
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x28
    public string <HNDAOJDFAHO>k__BackingField;    // 0x0x30
    public string <LGKOHGPCENN>k__BackingField;    // 0x0x38
    public long <LNNBHHADHNG>k__BackingField;    // 0x0x40
    public Guid? <AJIKCEJKMBP>k__BackingField;    // 0x0x48
    public DateTime <IOGILDHNABL>k__BackingField;    // 0x0x60
    public int <IKMOIHGDPNG>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// EEICEFKMNGO
//   (not directly referenced by a detected call)
public class EEICEFKMNGO
{
    public int <DEJKJEKNCOE>k__BackingField;    // 0x0x10
    public DateTime <OMADAFPOMJO>k__BackingField;    // 0x0x18
    public DateTime? <FPPBBPHDKJE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EFJCHCPAMED
//   (not directly referenced by a detected call)
public class EFJCHCPAMED
{
    public float <DNEOEDFLCHD>k__BackingField;    // 0x0x10
    public float <MAMPCMDILKM>k__BackingField;    // 0x0x14
    public float <EMCKIFPNOJK>k__BackingField;    // 0x0x18
    public float <IMNADFNPJBI>k__BackingField;    // 0x0x1C
    public float <GHOFEFPMMEL>k__BackingField;    // 0x0x20
    public float <BPJNJDNNGHH>k__BackingField;    // 0x0x24
    public float <LBKMNEMMFBK>k__BackingField;    // 0x0x28
    public float <HBIKHEJBNCP>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// EMBNHHENKEB
//   (not directly referenced by a detected call)
public class EMBNHHENKEB
{
    public Guid <HNBGJGMKADK>k__BackingField;    // 0x0x10
    public Guid <DNMAEDBMIKE>k__BackingField;    // 0x0x20
    public DateTime <LGFAIDGJGFP>k__BackingField;    // 0x0x30
    public List<NKFBFJLHFGO> <AGHIHAFJCAC>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// ENBBEPINIIE
//   (not directly referenced by a detected call)
public class ENBBEPINIIE
{
    public long <LNNBHHADHNG>k__BackingField;    // 0x0x10
    public Guid? <HPAECKHJNAD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ENPCIJMHFHD
//   (not directly referenced by a detected call)
public class ENPCIJMHFHD
{
    public int <ENFCECOOFNB>k__BackingField;    // 0x0x10
    public DateTime? <EFBHDCNHLDE>k__BackingField;    // 0x0x18
    public DateTime? <FLJCMNEPBOL>k__BackingField;    // 0x0x28
}
...
public class FACBCCAJPLP
{
    public byte <HLCDEEGEOCI>k__BackingField;    // 0x0x10
    public int <LHFLDCBCPLB>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// FDFOEHMCCMJ
//   (not directly referenced by a detected call)
public class FDFOEHMCCMJ
{
    public string <KLLOKOCIFFE>k__BackingField;    // 0x0x10
    public BPJDMHCDGDE <JJFMMPHONKN>k__BackingField;    // 0x0x18
}
...
public class FJAFDEBHBFJ
{
    public string <PEJBNPCJJCI>k__BackingField;    // 0x0x10
    public string <LLEABENGCIB>k__BackingField;    // 0x0x18
    public bool <DNHMBPDJHHH>k__BackingField;    // 0x0x20
    public string <CGNEGJLODBC>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// FJKCCDPLGKO
//   (not directly referenced by a detected call)
public class FJKCCDPLGKO
{
    public int <NLKJLEOANGF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FKIOBPGKBKK
//   (not directly referenced by a detected call)
public class FKIOBPGKBKK
{
    public long <BNLPLFDHCIA>k__BackingField;    // 0x0x10
    public string <AKKFCCGOCFA>k__BackingField;    // 0x0x18
    public int <IPCJELKIPLP>k__BackingField;    // 0x0x20
    public int <AABCEBNDIHI>k__BackingField;    // 0x0x24
    public int <LBCFNKAJPFJ>k__BackingField;    // 0x0x28
    public int <LBCHHCEMPHD>k__BackingField;    // 0x0x2C
    public int <KHKFPMIPJOJ>k__BackingField;    // 0x0x30
    public string <HCBKEBINKND>k__BackingField;    // 0x0x38
    public string <HIAOGLGADPK>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// FOEBEPMDIHJ
//   (not directly referenced by a detected call)
public class FOEBEPMDIHJ
{
    public long <GGCJOJNJAAM>k__BackingField;    // 0x0x10
    public string <OLEHNEMGKNG>k__BackingField;    // 0x0x18
    public string <LFGEFMKEFAK>k__BackingField;    // 0x0x20
    public ADHAIPLMGPB? <OHFHHDCBCON>k__BackingField;    // 0x0x28
    public string <KLGJALPCJHC>k__BackingField;    // 0x0x30
    public string <ODDCKEMELNG>k__BackingField;    // 0x0x38
    public GPGFBHGOOIK <NGKHLMMJECL>k__BackingField;    // 0x0x40
    public int <KDFBJPMJJGO>k__BackingField;    // 0x0x44
    public int <PJDPCJILECJ>k__BackingField;    // 0x0x48
    public CPOHHNIGNNL? <HHKONEDLHLB>k__BackingField;    // 0x0x4C
    public NFHFKPMICML? <AFBDLKMIMFM>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// GAFCOHNJNHA
//   (not directly referenced by a detected call)
public class GAFCOHNJNHA
{
    public long <MOFOPFKACDH>k__BackingField;    // 0x0x10
    public long <GBOOLMMLAKM>k__BackingField;    // 0x0x18
    public int <KNCIGJCJLLJ>k__BackingField;    // 0x0x20
    public DateTime <OMADAFPOMJO>k__BackingField;    // 0x0x28
    public HLELPEIALOF <JJFMMPHONKN>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GCPAACAMNPE
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class GCPAACAMNPE
{
    public int <BEOECJICKJG>k__BackingField;    // 0x0x10
}
...
public class GHGAIKJFHFI
{
    public LANKLBPEMKN <LCKMMKKOHGN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GJBIHNLNHKL
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class GJBIHNLNHKL
{
    public long <EEKGGGPHPLL>k__BackingField;    // 0x0x10
    public int <JHNDCLCBFNO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GLKJJFGHKEI
//   (not directly referenced by a detected call)
public class GLKJJFGHKEI
{
    public NFHCICDNNND CDCMNEHFKAO;    // 0x0x10
    public int PGEJBMEFJGP;    // 0x0x14
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{bODIELNDIGK}   [Service.API]
...
public class HKCIAIMPFJK
{
    public DKBDGJLEECA <LDOEIGMELCC>k__BackingField;    // 0x0x10
    public LANKLBPEMKN <LCKMMKKOHGN>k__BackingField;    // 0x0x18
    public IMDCEKKNJHP <DPHIHDJJDCB>k__BackingField;    // 0x0x20
}
...
// IAGJDDKIPKJ
//   (not directly referenced by a detected call)
public class IAGJDDKIPKJ
{
    public int <KOMIPJOPLPB>k__BackingField;    // 0x0x10
    public JJPGFGOOBPG <JJFMMPHONKN>k__BackingField;    // 0x0x14
    public List<NFDGOGEIMIO> <BKGHEIPFODO>k__BackingField;    // 0x0x18
    public List<NFDGOGEIMIO> <IOLJJMEJNLI>k__BackingField;    // 0x0x20
    public bool <OLKIPFLDBAM>k__BackingField;    // 0x0x28
    public DateTime? <EPCBOKNNNNN>k__BackingField;    // 0x0x30
    public DateTime? <GEIDHPOLIKE>k__BackingField;    // 0x0x40
    public DateTime? <JCLDOHPPLIG>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// IHDOOCEGIHD
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class IHDOOCEGIHD
{
    public int <KKJNFIDCDAD>k__BackingField;    // 0x0x10
    public int <KPKOKDKCEPO>k__BackingField;    // 0x0x14
    public float <PHFBODPBNHK>k__BackingField;    // 0x0x18
    public int <PFOANPDNEDA>k__BackingField;    // 0x0x1C
    public int <BDBHDGJFLPI>k__BackingField;    // 0x0x20
    public int <LLOKFIGBBAH>k__BackingField;    // 0x0x24
    public int <FFFPGFGECCM>k__BackingField;    // 0x0x28
    public string <LEGJILOEEPO>k__BackingField;    // 0x0x30
    public string <EKLIMFKENAH>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// IMDCEKKNJHP
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class IMDCEKKNJHP
{
    public LJGFMGMDIJI <LCKMMKKOHGN>k__BackingField;    // 0x0x10
    public List<string> <EPEOAODAMNM>k__BackingField;    // 0x0x18
}
...
public class IMJDLKFNGNE
{
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x10
    public string <HNDAOJDFAHO>k__BackingField;    // 0x0x18
    public int? <LNNBHHADHNG>k__BackingField;    // 0x0x20
    public PKBICHICCEK? <IENPFLFAKLL>k__BackingField;    // 0x0x28
}
...
public class JABGALJCAMB
{
    public Dictionary<Guid, CCFPJCBLBDD> <KICKKMHNKKL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JHPDDDJGBAA
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class JHPDDDJGBAA
{
    public string <EGKOAAIIAAM>k__BackingField;    // 0x0x10
    public string <FEPAGJAOJNP>k__BackingField;    // 0x0x18
    public string <NIODOHHOLDE>k__BackingField;    // 0x0x20
    public string <HNDAOJDFAHO>k__BackingField;    // 0x0x28
    public string <KDHNOHDAJLD>k__BackingField;    // 0x0x30
    public EBBPOPNGPLO <MAMAADFKAMM>k__BackingField;    // 0x0x38
    public List<string> <PFKOMFHGIPA>k__BackingField;    // 0x0x40
    public List<string> <EPEOAODAMNM>k__BackingField;    // 0x0x48
    public string <KHAIBHEGBLL>k__BackingField;    // 0x0x50
    public List<CGPBEOHFLHG> <KDNLLJFJMFJ>k__BackingField;    // 0x0x58
}
...
public class JPDBILKEEEE
{
    public long <PKLCAOHBDED>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <PFJIFDCBKOP>k__BackingField;    // 0x0x18
    public ABPBMPAEEJL <MLJBOHEJFNI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JPHBAGILEFA
//   (not directly referenced by a detected call)
public class JPHBAGILEFA
{
    public long <EEKGGGPHPLL>k__BackingField;    // 0x0x10
    public Guid <AKKFCCGOCFA>k__BackingField;    // 0x0x18
    public long <PKLCAOHBDED>k__BackingField;    // 0x0x28
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x30
    public string <HNDAOJDFAHO>k__BackingField;    // 0x0x38
    public int <LNNBHHADHNG>k__BackingField;    // 0x0x40
    public Guid? <AJIKCEJKMBP>k__BackingField;    // 0x0x44
    public DateTime <OMADAFPOMJO>k__BackingField;    // 0x0x58
    public string <LGKOHGPCENN>k__BackingField;    // 0x0x60
    public KNNDNIFJLHI <JJFMMPHONKN>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// KDKDHCAFGMC
// base   : NBFPLENANBH`1<ECFDJIMFEAL>
//   RESPONSE ?      api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{bHGFBLJHJCH}   [Service.API]
public class KDKDHCAFGMC
{
    // (no instance fields in the metadata dump)
}
...
public class KFIGBPEBHAP
{
    public int <ONMKNODKPBB>k__BackingField;    // 0x0x10
    public JCBHCEPINPB <JJFMMPHONKN>k__BackingField;    // 0x0x14
    public MNLGBNEGEMN <HHAMBJLALKB>k__BackingField;    // 0x0x18
    public MNLGBNEGEMN <AODECGMDMNK>k__BackingField;    // 0x0x1C
    public MNLGBNEGEMN <JCAJCKDHBPH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KFNNAGNOGAG
//   (not directly referenced by a detected call)
public class KFNNAGNOGAG
{
    public ObscuredLong <BNLPLFDHCIA>k__BackingField;    // 0x0x10
    public string <AKKFCCGOCFA>k__BackingField;    // 0x0x38
    public ObscuredInt <JCMCEMEBBMM>k__BackingField;    // 0x0x40
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x58
    public string <HNDAOJDFAHO>k__BackingField;    // 0x0x60
    public string <LGKOHGPCENN>k__BackingField;    // 0x0x68
    public int <NDANFCKFPLO>k__BackingField;    // 0x0x70
    public PKBICHICCEK <IENPFLFAKLL>k__BackingField;    // 0x0x74
    public DateTime <IOGILDHNABL>k__BackingField;    // 0x0x78
    public DateTime <OMADAFPOMJO>k__BackingField;    // 0x0x80
    public DateTime? <JGFKFJCNJFP>k__BackingField;    // 0x0x88
    public long? <KHDNJIAALFA>k__BackingField;    // 0x0x98
    public int <DOOAPFIBIDB>k__BackingField;    // 0x0xA8
    public int <CBJPECGNGJD>k__BackingField;    // 0x0xAC
    public int <KOLLCPFEJOH>k__BackingField;    // 0x0xB0
    public OAOGIKLLCIG <BIHOHLFEJBD>k__BackingField;    // 0x0xB4
    public OAOGIKLLCIG <KMBLIJNALCG>k__BackingField;    // 0x0xB8
    public ObscuredBool <NAKJNIEDJEJ>k__BackingField;    // 0x0xBC
    public ObscuredBool <OLNCHNIGPJH>k__BackingField;    // 0x0xC8
    public ObscuredBool <HPHGHJEDLKN>k__BackingField;    // 0x0xD4
    public int? <LNNBHHADHNG>k__BackingField;    // 0x0xE0
    public bool <NAAOKHEPFMK>k__BackingField;    // 0x0xE8
}

// --------------------------------------------------------------------------
// KGKIHIINBMN
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class KGKIHIINBMN
{
    public List<AHBDIOCBCOD> <CBFPONBBNIJ>k__BackingField;    // 0x0x10
    public LANKLBPEMKN <LCKMMKKOHGN>k__BackingField;    // 0x0x18
}
...
public class KHGPPIIBDJC
{
    public Dictionary<int, int> <CADMOHCIMPD>k__BackingField;    // 0x0x10
    public List<HHNBOGPFJBF> <NLIKHBELKFP>k__BackingField;    // 0x0x18
    public GLKJJFGHKEI[][] <OPBPIMALCHL>k__BackingField;    // 0x0x20
    public NABEBIMMNOC <IMOLKADADMC>k__BackingField;    // 0x0x28
    public EFJCHCPAMED <GHJOKNLJOJO>k__BackingField;    // 0x0x30
    public DGDHEPNKCII <IBABLKCNBJN>k__BackingField;    // 0x0x38
    public FJKCCDPLGKO <OLCIBDBGFNN>k__BackingField;    // 0x0x40
    public OFLJAKJBNCA <FFMOJCPGFNO>k__BackingField;    // 0x0x48
    public string <IELHFECPMCK>k__BackingField;    // 0x0x50
}
...
public class KHMJCNFPCFA
{
    public ADHAIPLMGPB <OHFHHDCBCON>k__BackingField;    // 0x0x10
    public string <OGHNMOCBNCM>k__BackingField;    // 0x0x18
    public string <JEHJFNBDCFM>k__BackingField;    // 0x0x20
    public string <KBIIIMEAMNM>k__BackingField;    // 0x0x28
    public NFHFKPMICML <AFMOHFGLIKD>k__BackingField;    // 0x0x30
    public string <JMNHDELKOEE>k__BackingField;    // 0x0x38
    public int <LJDFDEJAOKL>k__BackingField;    // 0x0x40
    public bool <IKHDDKDKMDL>k__BackingField;    // 0x0x44
}

// --------------------------------------------------------------------------
// KKJGCALKIJD
//   (not directly referenced by a detected call)
public class KKJGCALKIJD
{
    public BEEDJEMJFEF <LDOEIGMELCC>k__BackingField;    // 0x0x10
    public GAFCOHNJNHA <BMEMEKJJBHG>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// LBKPEGBAEJI
// base   : NBFPLENANBH`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class LBKPEGBAEJI
{
    // (no instance fields in the metadata dump)
}
...
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{nBHCOBHPFBM}   [Service.API]
public class LFCFKFEHLGP
{
    public uint <EGKOAAIIAAM>k__BackingField;    // 0x0x10
    public uint? <OEKEACOINDB>k__BackingField;    // 0x0x14
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x20
    public string <HNDAOJDFAHO>k__BackingField;    // 0x0x28
    public DateTime <JMANGAPBOMB>k__BackingField;    // 0x0x30
    public DateTime? <GJJKMIKBKLI>k__BackingField;    // 0x0x38
    public bool <OKLILPCLJEO>k__BackingField;    // 0x0x48
    public List<JHPDDDJGBAA> <PBHOKONKOHO>k__BackingField;    // 0x0x50
    public List<string> <EPEOAODAMNM>k__BackingField;    // 0x0x58
    public int <OCAHFKGCDKJ>k__BackingField;    // 0x0x60
    public int <CFCMHKMJJGD>k__BackingField;    // 0x0x64
    public int <NJEHCDAIGKO>k__BackingField;    // 0x0x68
}
...
public class LKIGGLJPGIG
{
    public MBIPFIDELOE <PMLFDBHGHMC>k__BackingField;    // 0x0x10
    public int <BEOECJICKJG>k__BackingField;    // 0x0x14
    public long <FBCMJLDNGPG>k__BackingField;    // 0x0x18
    public bool <AMMNJFFDJGN>k__BackingField;    // 0x0x20
    public string <BHPFCOBAFLB>k__BackingField;    // 0x0x28
    public int? <MBGPNLNBNMO>k__BackingField;    // 0x0x30
    public bool <OOBNJGIOCMN>k__BackingField;    // 0x0x38
    public bool <LKFFBBFEFIK>k__BackingField;    // 0x0x39
    public bool <OODLEKLNGNJ>k__BackingField;    // 0x0x3A
    public bool <IDPGIMLEMNN>k__BackingField;    // 0x0x3B
    public string <ILBKNKOOCCD>k__BackingField;    // 0x0x40
    public DateTime? <BKLEHODCPNF>k__BackingField;    // 0x0x48
    public float <MENFGNAKLEA>k__BackingField;    // 0x0x58
}
...
public class LOMIDKNIHPI
{
    public List<BEEDJEMJFEF> <LPKEIDJLBPN>k__BackingField;    // 0x0x10
    public string <LGEODJCDKDA>k__BackingField;    // 0x0x18
}
...
// base   : IAGJDDKIPKJ
//   (not directly referenced by a detected call)
public class LPDILJHLPNK : IAGJDDKIPKJ
{
    public int <DAFJKEHCNMA>k__BackingField;    // 0x0x60
    public List<BOJALEEOKAF> <KIBDKGPMIKB>k__BackingField;    // 0x0x68
    public List<BOJALEEOKAF> <KFBDBIGHLMD>k__BackingField;    // 0x0x70
    public List<BOJALEEOKAF> <GOGEAENEMHI>k__BackingField;    // 0x0x78
}
...
public class MDICIDMLFOI
{
    public bool <PHFIAMMICMC>k__BackingField;    // 0x0x10
    public string <FEPAGJAOJNP>k__BackingField;    // 0x0x18
    public string <CEOEANKPIGC>k__BackingField;    // 0x0x20
}
...
public class MFBBFKMGNAP
{
    public bool <IKPMGJNDMEA>k__BackingField;    // 0x0x10
    public string <BHPFCOBAFLB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MMGLCCOBODN
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{cOFHGJDOHCE}   [Service.API]
public class MMGLCCOBODN
{
    public List<BEEDJEMJFEF> <HENBLPCNAKH>k__BackingField;    // 0x0x10
    public List<KKJGCALKIJD> <HBCCMILGJLA>k__BackingField;    // 0x0x18
}
...
public class MNAABBAMOLO
{
    public Guid <EKCIDCMGCEN>k__BackingField;    // 0x0x10
    public long <CDGDJOGELFO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MPAPINIJKOK
//   (not directly referenced by a detected call)
public class MPAPINIJKOK
{
    public bool <OGIBNBHKMMP>k__BackingField;    // 0x0x10
    public LLIBMLIHHPN <EKDMJGFNPGD>k__BackingField;    // 0x0x14
    public int <GKLAJLMELAL>k__BackingField;    // 0x0x18
    public DateTime <IOGILDHNABL>k__BackingField;    // 0x0x20
}
...
// NABEBIMMNOC
//   (not directly referenced by a detected call)
public class NABEBIMMNOC
{
    public int <IKPGCGJACBG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NFDGOGEIMIO
//   (not directly referenced by a detected call)
public class NFDGOGEIMIO
{
    public INHIGKIFGMH <CJOKEEAFGMN>k__BackingField;    // 0x0x10
    public int <LNNBHHADHNG>k__BackingField;    // 0x0x14
    public ENPCIJMHFHD <AIAJODAGFAE>k__BackingField;    // 0x0x18
}
...
public class NIPJMIMOFPC
{
    public Dictionary<Guid, BNEHACJFHKP> <POGDMBIFFPC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NKFBFJLHFGO
//   (not directly referenced by a detected call)
public class NKFBFJLHFGO
{
    public int <GGCJOJNJAAM>k__BackingField;    // 0x0x10
    public string <JEHJFNBDCFM>k__BackingField;    // 0x0x18
    public string <KBIIIMEAMNM>k__BackingField;    // 0x0x20
    public string <JMNHDELKOEE>k__BackingField;    // 0x0x28
    public string <OLEHNEMGKNG>k__BackingField;    // 0x0x30
    public string <ACEDCONJGBM>k__BackingField;    // 0x0x38
    public ADHAIPLMGPB? <OHFHHDCBCON>k__BackingField;    // 0x0x40
    public string <KLGJALPCJHC>k__BackingField;    // 0x0x48
    public string <ODDCKEMELNG>k__BackingField;    // 0x0x50
    public bool <POKLDDJDJDG>k__BackingField;    // 0x0x58
    public bool <FJHIOOEMNNA>k__BackingField;    // 0x0x59
    public bool <OABJCHBMBFO>k__BackingField;    // 0x0x5A
    public NFHFKPMICML <AFMOHFGLIKD>k__BackingField;    // 0x0x5C
    public int <LJDFDEJAOKL>k__BackingField;    // 0x0x60
    public INHIGKIFGMH <CJOKEEAFGMN>k__BackingField;    // 0x0x64
    public int <GMFBGCCKKLN>k__BackingField;    // 0x0x68
    public PKDGHFBNOIC <OMGCPAMLCDM>k__BackingField;    // 0x0x6C
    public CPOHHNIGNNL <HEDEDDFBKIN>k__BackingField;    // 0x0x70
    public int? <CMIHBOGHCOG>k__BackingField;    // 0x0x74
    public string <LDCJFGPDBEI>k__BackingField;    // 0x0x80
}
...
public class NPHLPPLMMPM : AKDHFAKBCCK
{
    public PDDJIGEPMIG? <IDGHJOOLMEC>k__BackingField;    // 0x0x18
    public COGKNIJNPIO <HAJJHEBPEDL>k__BackingField;    // 0x0x20
}
...
// OAPBDILEPML
//   (not directly referenced by a detected call)
public class OAPBDILEPML
{
    public long <ODMEJBOPAIK>k__BackingField;    // 0x0x10
    public Guid <PBCFAKEONID>k__BackingField;    // 0x0x18
    public Guid <FGKFFOFAEOJ>k__BackingField;    // 0x0x28
    public DateTime <OMADAFPOMJO>k__BackingField;    // 0x0x38
    public string <FAEMCGEOPEM>k__BackingField;    // 0x0x40
    public string <JLIHNLHFPIJ>k__BackingField;    // 0x0x48
    public string <IICPFDKFKKL>k__BackingField;    // 0x0x50
    public string <DEBKBPAEJCB>k__BackingField;    // 0x0x58
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{oCMHPLHMEPN}   [Service.Econ]
public class OCHNMMOFBPP
{
    public KOHLFELFBGK <MAMAADFKAMM>k__BackingField;    // 0x0x10
    public EDJIDLOEMKK <GKJGOEJHMJH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OFLJAKJBNCA
//   (not directly referenced by a detected call)
public class OFLJAKJBNCA
{
    public float <BKOOOBEALGH>k__BackingField;    // 0x0x10
}
...
public class OIEEMCPKNNO
{
    public HEDAJNGFDMC <MAMAADFKAMM>k__BackingField;    // 0x0x10
    public KFNNAGNOGAG <GKCFNHHBLKO>k__BackingField;    // 0x0x18
    public FKIOBPGKBKK <ILPCKLOCHAK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OIMNDKFJMOM
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItemDescs   [Service.API]
public class OIMNDKFJMOM
{
    public List<string> <CFLBCEEDELK>k__BackingField;    // 0x0x10
    public byte <HLCDEEGEOCI>k__BackingField;    // 0x0x18
    public int <LHFLDCBCPLB>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// OMCKPOHGEBN
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Econ]
public class OMCKPOHGEBN
{
    public Guid <JHBDNDBMLPL>k__BackingField;    // 0x0x10
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x20
    public string <LGKOHGPCENN>k__BackingField;    // 0x0x28
    public DateTime <LGFAIDGJGFP>k__BackingField;    // 0x0x30
    public DateTime? <HFDGMGBCNOC>k__BackingField;    // 0x0x38
    public List<EMBNHHENKEB> <LALJKCGEDAO>k__BackingField;    // 0x0x48
}
...
// base   : NDCKKOPOFBE
//   RESPONSE ?      api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{hJGDAPCNFFH}   [Service.Econ]
public class OONPCMDKGCC : NDCKKOPOFBE
{
    public int <FFPFIHIAPKK>k__BackingField;    // 0x0x30
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x38
    public DateTime <LGFAIDGJGFP>k__BackingField;    // 0x0x40
    public DateTime <COAPNIBHNEK>k__BackingField;    // 0x0x48
    public INHIGKIFGMH <CJOKEEAFGMN>k__BackingField;    // 0x0x50
    public IAGJDDKIPKJ <JPFNFMABBCE>k__BackingField;    // 0x0x58
    public List<LPDILJHLPNK> <AOIEAANBGDL>k__BackingField;    // 0x0x60
    public MPAPINIJKOK <NHMMKLJHPOC>k__BackingField;    // 0x0x68
}
...
public class PAJNAOFEHCE
{
    public long? <EGKOAAIIAAM>k__BackingField;    // 0x0x10
    public int? <AKNBMHMMAMO>k__BackingField;    // 0x0x20
    public string <OLEHNEMGKNG>k__BackingField;    // 0x0x28
    public ADHAIPLMGPB? <OHFHHDCBCON>k__BackingField;    // 0x0x30
    public string <ACEDCONJGBM>k__BackingField;    // 0x0x38
    public string <KLGJALPCJHC>k__BackingField;    // 0x0x40
    public string <ODDCKEMELNG>k__BackingField;    // 0x0x48
    public INHIGKIFGMH <CJOKEEAFGMN>k__BackingField;    // 0x0x50
    public int <GMFBGCCKKLN>k__BackingField;    // 0x0x54
    public int <KDFBJPMJJGO>k__BackingField;    // 0x0x58
    public CPOHHNIGNNL <HHKONEDLHLB>k__BackingField;    // 0x0x5C
    public NFHFKPMICML <AFBDLKMIMFM>k__BackingField;    // 0x0x60
    public string <LGOBNGAGIMB>k__BackingField;    // 0x0x68
    public FDJEILEBGBK <OOICJLJEOFJ>k__BackingField;    // 0x0x70
    public LLIBMLIHHPN <LGLKADBAMHC>k__BackingField;    // 0x0x74
    public ADNKEOABPKB? <JGAPBIPIJGC>k__BackingField;    // 0x0x78
    public bool <NJFHNKDGAMK>k__BackingField;    // 0x0x80
    public bool <LMOFIFIEKEJ>k__BackingField;    // 0x0x81
    public string <NIFDBHJMHEG>k__BackingField;    // 0x0x88
    public bool <CIBPNLPBLFM>k__BackingField;    // 0x0x90
    public bool KLCOKPOMEMC;    // 0x0x91
}

// --------------------------------------------------------------------------
// PBHJPIAHKGL
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.Econ]
public class PBHJPIAHKGL
{
    public int <NBMLLIKHJPF>k__BackingField;    // 0x0x10
    public string <DJDLNJELBNG>k__BackingField;    // 0x0x18
    public List<AIKNMBDIHPE> <DIGBOGMCFNN>k__BackingField;    // 0x0x20
    public FOEBEPMDIHJ <KBPOFEFJHOD>k__BackingField;    // 0x0x28
    public string <DGHPIDNKIJI>k__BackingField;    // 0x0x30
    public DateTime <LGFAIDGJGFP>k__BackingField;    // 0x0x38
    public DateTime <COAPNIBHNEK>k__BackingField;    // 0x0x40
    public DateTime <BFIGACDHJON>k__BackingField;    // 0x0x48
    public bool? <JCKOMOAAFPJ>k__BackingField;    // 0x0x50
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{iKDLFDDIPKI}   [Service.Econ]
public enum PGCJPMCDKBM
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
// base   : IAGJDDKIPKJ
//   (not directly referenced by a detected call)
public class PGJCBIMOBCD : IAGJDDKIPKJ
{
    public NKFBFJLHFGO <MBFNEJKBBOP>k__BackingField;    // 0x0x60
}
...
public class PICKABENMNG
{
    public Dictionary<string, OAPBDILEPML> <JJBIMLBJBHD>k__BackingField;    // 0x0x10
}
...
// PMMGPNFEOJG
//   (not directly referenced by a detected call)
public class PMMGPNFEOJG
{
    public Guid? <EFGCFBOKBPI>k__BackingField;    // 0x0x10
    public Guid <DBDKNCGJMLA>k__BackingField;    // 0x0x24
}
...
public class POEKMNCMFKH
{
    public PGCJPMCDKBM <MAMAADFKAMM>k__BackingField;    // 0x0x10
    public JPHBAGILEFA <BFFEHOLKHLA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// POKCNNGACOP
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class POKCNNGACOP
{
    public List<EEICEFKMNGO> <KIGDDHACAAA>k__BackingField;    // 0x0x10
    public string <LGEODJCDKDA>k__BackingField;    // 0x0x18
}
...
{
    public long <PKLCAOHBDED>k__BackingField;    // 0x0x10
    public long? <FFNCEOOKCNA>k__BackingField;    // 0x0x18
    public HHMMOFCFDIK <JFGEGNBBJJP>k__BackingField;    // 0x0x28
}
...
{
    public NLFJMHIDICO <LCKMMKKOHGN>k__BackingField;    // 0x0x10
    public string <IEJALMACCJO>k__BackingField;    // 0x0x18
    public string <GKFPGENNACI>k__BackingField;    // 0x0x20
    public string <ODDDMOIDCMA>k__BackingField;    // 0x0x28
}
...
{
    public long <GBOOLMMLAKM>k__BackingField;    // 0x0x10
    public long? <PDDJPHELMFH>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public AANOBHOHAOL FilterType;    // 0x0x20
...
{
    public HHMMOFCFDIK <NJPGIAIAPBI>k__BackingField;    // 0x0x10
    public string <GBILGHHOLFN>k__BackingField;    // 0x0x18
    public int <CBPCNDMCMCE>k__BackingField;    // 0x0x20
    public int <PAOILALNBCO>k__BackingField;    // 0x0x24
    public string <LGLALBMJGIH>k__BackingField;    // 0x0x28
    public string <CECGHCEFOPM>k__BackingField;    // 0x0x30
}
...
{
    public int <JHNDCLCBFNO>k__BackingField;    // 0x0x10
    public Guid <EPEJDHJAIOM>k__BackingField;    // 0x0x14
    public DateTime <FHOKGNGPECL>k__BackingField;    // 0x0x28
}
...
{
    public bool <NDHHPOOGKAF>k__BackingField;    // 0x0x10
    public int <OJCBLDOAFIH>k__BackingField;    // 0x0x14
    public bool <GBKAALJBPNF>k__BackingField;    // 0x0x18
}
...
{
    public Guid <EPEJDHJAIOM>k__BackingField;    // 0x0x10
    public HHMMOFCFDIK <CBJMCNFFAFH>k__BackingField;    // 0x0x20
    public int <ICBGILNFBIF>k__BackingField;    // 0x0x24
    public long <PKLCAOHBDED>k__BackingField;    // 0x0x28
    public long? <FFNCEOOKCNA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE POST   api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{aEKNMDBPDDF}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <DBCCDALOBIN>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <MKNCPANMCEN>k__BackingField;    // 0x0x18
}
...
{
    public long <BCHBAMONMPI>k__BackingField;    // 0x0x10
    public long <PKLCAOHBDED>k__BackingField;    // 0x0x18
    public long <LLGMIJFONHD>k__BackingField;    // 0x0x20
    public OOKFNMGPAEH <JJFMMPHONKN>k__BackingField;    // 0x0x28
    public int <IOBGJCHCBCO>k__BackingField;    // 0x0x2C
}
...
{
    public long <PKLCAOHBDED>k__BackingField;    // 0x0x10
    public List<Guid> <GHFILPFPILP>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <DBCCDALOBIN>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <MKNCPANMCEN>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <HFLOHABKKDK>k__BackingField;    // 0x0x20
}
...
{
    public long <LLGMIJFONHD>k__BackingField;    // 0x0x10
    public long <BAKGCACEEAH>k__BackingField;    // 0x0x18
    public int? <CKPLENLCDIN>k__BackingField;    // 0x0x20
    public int? <NKKJLCBFFKN>k__BackingField;    // 0x0x28
    public long? <OEGGPAHEAKJ>k__BackingField;    // 0x0x30
    public long <CKEDEMCNDOC>k__BackingField;    // 0x0x40
    public long <KGMDHAIOKMJ>k__BackingField;    // 0x0x48
    public int <GKNDECFCELI>k__BackingField;    // 0x0x50
    public OOKFNMGPAEH <GEHIOGNIAEO>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <NOJJNOFAIHG>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public CPOHHNIGNNL <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public NMOECCJMGEC creatorAccountRole;    // 0x0x58
}
...
{
    public LCHDGNCKKBC <GEACICLBIEB>k__BackingField;    // 0x0x10
    public NIAPAIGBOJF <JOGJIGIDJLI>k__BackingField;    // 0x0x14
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x18
    public string <HNDAOJDFAHO>k__BackingField;    // 0x0x20
    public bool <PNFEGJMJELB>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<LCHDGNCKKBC> <JOMPDLGBILM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE ?      api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{bODIELNDIGK}   [Service.API]
public class ProgressionEventDTO
{
    public long <BAKGCACEEAH>k__BackingField;    // 0x0x10
    public string <CNMPILOIMAM>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <GOGEAENEMHI>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <MGDAIMONJIG>k__BackingField;    // 0x0x28
    public DateTime <EEIIFFHBLKL>k__BackingField;    // 0x0x30
    public DateTime <NCGLFJOLGJJ>k__BackingField;    // 0x0x38
    public DateTime <KGJCHMGLABO>k__BackingField;    // 0x0x40
    public bool <MGHCINDHKFH>k__BackingField;    // 0x0x48
    public int <NJCAJKNHMKK>k__BackingField;    // 0x0x4C
    public float <LLGBNBNOOCP>k__BackingField;    // 0x0x50
    public Guid? <CMOANICOOFO>k__BackingField;    // 0x0x54
    public string <LINHIALDLBP>k__BackingField;    // 0x0x68
    public string <MIEBPFNGFCI>k__BackingField;    // 0x0x70
    public string <CJEIHMFLMDP>k__BackingField;    // 0x0x78
    public string <BKFJGKHJOMP>k__BackingField;    // 0x0x80
}
...
{
    public Guid <MMNJCDMNFNF>k__BackingField;    // 0x0x10
    public int <BBGALCHLPOA>k__BackingField;    // 0x0x20
    public int <JEMOIFIGHMH>k__BackingField;    // 0x0x24
    public int <NNLHHBGJMLE>k__BackingField;    // 0x0x28
    public long <NFEOCLAFIBF>k__BackingField;    // 0x0x30
    public long <JCGBDNDOFEA>k__BackingField;    // 0x0x38
}
...
{
    public int <JHNDCLCBFNO>k__BackingField;    // 0x0x10
    public int <KDFBJPMJJGO>k__BackingField;    // 0x0x14
    public int <CDOKBFAHJHG>k__BackingField;    // 0x0x18
    public int <PCCONAMGEGE>k__BackingField;    // 0x0x1C
    public int <IHHNPNAPNGJ>k__BackingField;    // 0x0x20
    public DateTime? <IJKLEHMDDPM>k__BackingField;    // 0x0x28
}
...
{
    public long <HAHEPBBJDOP>k__BackingField;    // 0x0x10
    public int <GGCJOJNJAAM>k__BackingField;    // 0x0x18
    public string <LGKOHGPCENN>k__BackingField;    // 0x0x20
    public int <KDFBJPMJJGO>k__BackingField;    // 0x0x28
    public int <HLMEBOFJMKC>k__BackingField;    // 0x0x2C
    public bool <MAEIMNGIOIP>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public NLEADKODKGO ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool CPJHFPIGNMF;    // 0x0x28
}
...
{
    public AAJHPDGMIKN? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public AAJHPDGMIKN OFIOEPHMACP;  // wrapper
...
{
    public FDJEILEBGBK EGENLKIHOMO;  // wrapper
...
{
    public COHMGPGFFDM PEMNIEMPPLO;  // wrapper
    public int? DEJMFHOOOCN;  // wrapper
...
{
    public MBIPFIDELOE AANMFLOENPK;  // wrapper
    public float? DEDJEFPNDII;  // wrapper
...
{
    public AIKNMBDIHPE PPDCMBFFBCM;  // wrapper
...
{
    public PKBICHICCEK CACOPFMIKKI;  // wrapper
    public LFOCDNCCJMB GFDDJPHDNPM;  // wrapper
    public byte[] KJNHLEPFKDP;  // wrapper
    public byte[] JAFBHLEBKEM;  // wrapper
    public Color BJLKCDOCMJA;  // wrapper
...
{
    public List<AAFIOJKNGOC> BJIKBICHKGO;  // wrapper
}
...
{
    public LAJGBFACEII NIMNJKDEJKJ;  // wrapper
    public CPOHHNIGNNL? PLKLHDDFNEG;  // wrapper
...
{
    public EKHEHKGOACD DCAFIENGEDD;  // wrapper
...
{
    public KFNNAGNOGAG inventionId;  // wrapper
}
...
// api/keepsakes/{iEFINHMKLDJ}/collect  [API POST]
public class KeepsakesIEFINHMKLDJCollectRequest
{
    public Guid IEFINHMKLDJ;  // wrapper
}

// api/messages/v1/sendMultiple  [API POST]
public class MessagesV1SendMultipleRequest
{
    public List<long> OPGDJOOAJPB;  // wrapper
    public HFLJJDLIKGE NOAJNBONPCM;  // wrapper
    public long? NGLNDFKLBFL;  // wrapper
...
{
    public long? PFEDNOBDCCE;  // wrapper
}
...
{
    public long? PIJEGGFFPOI;  // wrapper
    public long? PMPODOANKNE;  // wrapper
    public List<string> EPEPJNEHEHN;  // wrapper
    public DateTime DDFMCFEFMFD;  // wrapper
    public DateTime IFIOAPFGBDL;  // wrapper
    public NFFIFFPLBAA CACOPFMIKKI;  // wrapper
    public LKGHCGDAFBD EEDAJCDHMJC;  // wrapper
    public LKGHCGDAFBD MBDFMDDCMBC;  // wrapper
}
...
{
    public LKGHCGDAFBD EEDAJCDHMJC;  // wrapper
    public LKGHCGDAFBD OCMJIAPNFGG;  // wrapper
}
...
{
    public Guid FLEHBPAAFJO;  // wrapper
...
{
    public Guid OCMHPLHMEPN;  // wrapper
    public Guid DLCDMBFMNKG;  // wrapper
    public Guid? OFBHJDMMKFH;  // wrapper
}
...
{
    public List<BLGECMLKFIO> KDGACEAJAJI;  // wrapper
}
...
{
    public Guid JODPJNEEHKM;  // wrapper
    public object Price;  // candidate
...
{
    public Guid JODPJNEEHKM;  // wrapper
    public long? NCLOGDDEJAP;  // wrapper
    public byte? LHBJFJNOBAO;  // wrapper
    public int? BJLKCDOCMJA;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid FLEHBPAAFJO;  // wrapper
    public long? BFBDAACMIMC;  // wrapper
    public long? MCOPOEIIDHK;  // wrapper
    public int? HIGLKKMCPLJ;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> FJDDANGEILG;  // wrapper
...
{
    public IEnumerable<OPCLECEOCKD> HLCBAEEJBHK;  // wrapper
}

// api/roomkeys/v1/create  [Econ POST]
public class RoomkeysV1CreateRequest
{
    public KNNDNIFJLHI PEMNIEMPPLO;  // wrapper
    public Guid? HMFOCMKCHBL;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public MBIPFIDELOE AANMFLOENPK;  // wrapper
    public long? NIHJKBODPND;  // wrapper
    public object ReportCategory;  // candidate
    public object RoomId;  // candidate
    public object RoomKeyId;  // candidate
    public object Details;  // candidate
...
{
    public MatchCompleteStats LAEOKGHOJIA;  // wrapper
}
...
{
    public Guid GBLHIAHMJNF;  // wrapper
...
{
    public Guid DIJACBEFGMK;  // wrapper
...
{
    public List<JAHGHBJELJC> CBENKEADKNC;  // wrapper
    public object roomId;  // candidate
...
{
    public EBBPOPNGPLO AOAAKOCJLKL;  // wrapper
}
