...
public class ACDFJEOJFDB
{
    public LCPBOMPAANL <NPJACEHOEGI>k__BackingField;    // 0x0x10
    public GKNIGMDFJDM <ILEOFOIAOKH>k__BackingField;    // 0x0x18
    public GKDIGPKJPFP <PKNJALCJCLM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AEGCIMDELDP
//   (not directly referenced by a detected call)
public class AEGCIMDELDP
{
    public Guid <PAECJEGPAMG>k__BackingField;    // 0x0x10
    public long <DMEKLJMCLPP>k__BackingField;    // 0x0x20
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x28
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x30
    public string <FHGKJKMCGMH>k__BackingField;    // 0x0x38
    public long <PCBGEMDOINO>k__BackingField;    // 0x0x40
    public Guid? <DMJCFEAIGHA>k__BackingField;    // 0x0x48
    public DateTime <ACCDLKGCAEC>k__BackingField;    // 0x0x60
    public int <MFKBLMHCONM>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// AENLLDKHNGO
//   RESPONSE GET    api/playerevents/v1/all   [Service.Auth]
//   RESPONSE GET    api/playerevents/v1/all/{pKODCKADBCG}   [Service.Auth]
public class AENLLDKHNGO
{
    public List<APEPLDIMBOE> <KFIJLAMMNMK>k__BackingField;    // 0x0x10
    public List<CEMIJFMECBA> <PHMOECCDBBB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AEOKOGPLLEJ
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.WWW]
public class AEOKOGPLLEJ
{
    public long <KEMIKNACHDB>k__BackingField;    // 0x0x10
    public int <HHAMHFLPEGK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AGDJNFEONGP
//   (not directly referenced by a detected call)
public class AGDJNFEONGP
{
    public int <EDPFGLEHIPF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// AHKLIDHCBHH
// base   : HHMCKMENLNM`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class AHKLIDHCBHH
{
...
// AIDIFECKOEC
//   (not directly referenced by a detected call)
public class AIDIFECKOEC
{
    public int <EHGNMPPIOAG>k__BackingField;    // 0x0x10
    public DateTime <IEEHBJLFLDO>k__BackingField;    // 0x0x18
    public DateTime? <OJDLALJBPGJ>k__BackingField;    // 0x0x20
}
...
// base   : OOKGBHKFGDI
//   (not directly referenced by a detected call)
public class AKCAIINNICB : OOKGBHKFGDI
{
    public int <IFFCJKFGMLC>k__BackingField;    // 0x0x60
    public List<GAFFHEMOJLN> <FGKAKOAOJKH>k__BackingField;    // 0x0x68
    public List<GAFFHEMOJLN> <JOICJCOCJDH>k__BackingField;    // 0x0x70
    public List<GAFFHEMOJLN> <DMOKEPFMFCD>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// AMIGCBBBMBI
//   (not directly referenced by a detected call)
public class AMIGCBBBMBI
{
    public bool <AECPPCABIJD>k__BackingField;    // 0x0x10
    public BKDELBMDKCD <PAODEHHPDAC>k__BackingField;    // 0x0x14
    public int <GABLDDGBLBF>k__BackingField;    // 0x0x18
    public DateTime <ACCDLKGCAEC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ANMLAHGNGDF
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.WWW]
public class ANMLAHGNGDF
{
    public Guid? <PAECJEGPAMG>k__BackingField;    // 0x0x10
    public long? <DMEKLJMCLPP>k__BackingField;    // 0x0x28
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x38
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x40
    public string <FHGKJKMCGMH>k__BackingField;    // 0x0x48
    public KEJCEPKJIAM <GBFIEENMJAN>k__BackingField;    // 0x0x50
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{kIHNLCPBLAB}   [Service.Auth]
...
public class APBCLKCIAFE
{
    public BHHDHAPJGBB <ABPPNIHLEPL>k__BackingField;    // 0x0x10
    public PFLJOGJPHHO <PFDEOHMBDFJ>k__BackingField;    // 0x0x18
    public OILJIMGGNHN <KIDADAAHLMF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// APEPLDIMBOE
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class APEPLDIMBOE
{
    public long <IGDJENDNCBI>k__BackingField;    // 0x0x10
    public int <PJCPMJOEHNK>k__BackingField;    // 0x0x18
    public long <DMEKLJMCLPP>k__BackingField;    // 0x0x20
    public long? <LKJADMNGLLD>k__BackingField;    // 0x0x28
    public long? <KGJINAJCEDO>k__BackingField;    // 0x0x38
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x48
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x50
    public string <FHGKJKMCGMH>k__BackingField;    // 0x0x58
    public DateTime <HBJCODKIOHB>k__BackingField;    // 0x0x60
    public DateTime <KCDLMACPAHK>k__BackingField;    // 0x0x68
    public int <BBNEHDIDAKH>k__BackingField;    // 0x0x70
    public OEPLGNJPCAA <HAGHNKBANDP>k__BackingField;    // 0x0x74
    public bool <MFNEBADEBHL>k__BackingField;    // 0x0x78
    public bool <CEJCLCNKMMO>k__BackingField;    // 0x0x79
    public LEDEOFAAHNE <LCJLGMOHLHC>k__BackingField;    // 0x0x7C
    public LEDEOFAAHNE <GAJIPFHCAOJ>k__BackingField;    // 0x0x80
    public long? <CNDPJOAJAFF>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// BCMNPEEJLBP
//   (not directly referenced by a detected call)
public class BCMNPEEJLBP
{
    public IKBNGBAJDEG HIKMAHMOJFB;    // 0x0x10
    public int EFNMFIMCDKE;    // 0x0x14
}

// --------------------------------------------------------------------------
// BEANPENJNJE
//   RESPONSE GET    api/config/v2   [Service.Auth]
public class BEANPENJNJE
{
    public Dictionary<int, int> <MCMDHACHFLF>k__BackingField;    // 0x0x10
    public List<ICDPBFAGFMK> <BOMCDEANDEK>k__BackingField;    // 0x0x18
    public BCMNPEEJLBP[][] <CKFNFDKLKLG>k__BackingField;    // 0x0x20
    public AGDJNFEONGP <MPCIGFGNCBG>k__BackingField;    // 0x0x28
    public KCIFBAFMIPB <NGJKAPGOEFK>k__BackingField;    // 0x0x30
    public PLHFJPMFODI <FLPPCEGGFCH>k__BackingField;    // 0x0x38
    public NIMFIPMINHN <MECEFHENIFF>k__BackingField;    // 0x0x40
    public CNAABNICKOE <NMFCFKHNACN>k__BackingField;    // 0x0x48
    public string <KGPPCGNKJAH>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// BFEECDDJCKG
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class BFEECDDJCKG
{
    public Dictionary<Guid, GLAMKFCMLFL> <EFFNDOBKILM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BFPHLADMLCF
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.Auth]
public class BFPHLADMLCF
{
    public int <BJECOFFAKPB>k__BackingField;    // 0x0x10
    public int? <DJCJBHGACMO>k__BackingField;    // 0x0x14
    public string <CKKCKKLOCEO>k__BackingField;    // 0x0x20
    public string <PMCNPJPHGDP>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// BGLIPGIPFDH
//   (not directly referenced by a detected call)
public class BGLIPGIPFDH
{
    public string <GGKEPGNCOII>k__BackingField;    // 0x0x10
    public NDOABFHEDDC <NCAJIPEPNAI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BGMJDMBPBGN
//   REQUEST  POST   api/challenge/v2/updateProgress   [Service.WWW]
public class BGMJDMBPBGN
{
    public int <NHHCNJNKLIF>k__BackingField;    // 0x0x10
    public int <JPFEMOBGLJO>k__BackingField;    // 0x0x14
    public string <LOOAFLEKLDJ>k__BackingField;    // 0x0x18
    public bool <OMHNDKBNNJC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BHDOHGEHLBN
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.WWW]
public class BHDOHGEHLBN
{
    public int <ONCNCBNJGJP>k__BackingField;    // 0x0x10
}
...
// base   : APEPLDIMBOE
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class BHHDHAPJGBB : APEPLDIMBOE
{
    public List<BGLIPGIPFDH> <OAOMFAJCOFE>k__BackingField;    // 0x0x98
}
...
public class BKEKLNDBIJK
{
    public int <AHEPOJGKHPO>k__BackingField;    // 0x0x10
    public int <KABLCHPHPEO>k__BackingField;    // 0x0x14
    public float <OAFDFPGMIFD>k__BackingField;    // 0x0x18
    public float <GHECAGIODIC>k__BackingField;    // 0x0x1C
    public bool <MDBGBPFIHHH>k__BackingField;    // 0x0x20
    public bool <ELFNOPBMJLD>k__BackingField;    // 0x0x21
    public bool <FCDANCGPNJN>k__BackingField;    // 0x0x22
}
...
public class BODBHBJIIDE
{
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x10
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x18
    public int? <PCBGEMDOINO>k__BackingField;    // 0x0x20
    public EHEENOPEONH? <HAGHNKBANDP>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// BPHIKLFPCLI
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{aDHJMLHKLEC}/{pLCFCMNBENE}   [Service.WWW]
public class BPHIKLFPCLI
{
    public GGPNHKNMMJF <COOMMPDKPPK>k__BackingField;    // 0x0x10
    public LBDLJILENGP <MDDPMMADDOO>k__BackingField;    // 0x0x14
    public int <POBHHBCJMIL>k__BackingField;    // 0x0x18
    public int <KHAHJLPLEJF>k__BackingField;    // 0x0x1C
    public int <JINPHOCJGEN>k__BackingField;    // 0x0x20
    public NEHHCCNMBFF <PLJPFEJBKAL>k__BackingField;    // 0x0x24
    public bool <OIPMHEPJAKA>k__BackingField;    // 0x0x28
    public float <FIOJCMAAHEC>k__BackingField;    // 0x0x2C
    public int <DEKEOIGFGBF>k__BackingField;    // 0x0x30
    public bool <PJBPIPLBGGN>k__BackingField;    // 0x0x34
}
...
public class CBNGHGOMENF
{
    public List<long> <NJNGOHOPGME>k__BackingField;    // 0x0x10
    public LFANFOHAFFL <NCAJIPEPNAI>k__BackingField;    // 0x0x18
    public string <DDOAJBIMEEH>k__BackingField;    // 0x0x20
    public long? <DMEKLJMCLPP>k__BackingField;    // 0x0x28
}
...
public class CCFLNJAAIME
{
    public int <NHHCNJNKLIF>k__BackingField;    // 0x0x10
    public string <HBJCBENFNGK>k__BackingField;    // 0x0x18
    public List<PENINMOMJBN> <CJOKEHCKGHB>k__BackingField;    // 0x0x20
    public NEMNEILGLFD <KIEGBDKHBDP>k__BackingField;    // 0x0x28
    public string <PBAMAOKJBGO>k__BackingField;    // 0x0x30
    public DateTime <AEBCJGEMEOD>k__BackingField;    // 0x0x38
    public DateTime <GGJOBMINLLJ>k__BackingField;    // 0x0x40
    public DateTime <LILIKKMJNJB>k__BackingField;    // 0x0x48
    public bool? <CGONAPMKDGG>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// CCHJLKCINKD
//   (not directly referenced by a detected call)
public class CCHJLKCINKD
{
    public long <KEMIKNACHDB>k__BackingField;    // 0x0x10
    public Guid <KMINFPNHABB>k__BackingField;    // 0x0x18
    public long <DMEKLJMCLPP>k__BackingField;    // 0x0x28
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x30
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x38
    public int <PCBGEMDOINO>k__BackingField;    // 0x0x40
    public Guid? <DMJCFEAIGHA>k__BackingField;    // 0x0x44
    public DateTime <IEEHBJLFLDO>k__BackingField;    // 0x0x58
    public string <FHGKJKMCGMH>k__BackingField;    // 0x0x60
    public BMNAKPEGKDB <NCAJIPEPNAI>k__BackingField;    // 0x0x68
}
...
public class CEENIPJCNAF
{
    public LOBCOGJPLPO <OLOPJDPDLMH>k__BackingField;    // 0x0x10
    public string <FEBKJLPOCPL>k__BackingField;    // 0x0x18
    public string <MHNPKBDEHDC>k__BackingField;    // 0x0x20
    public string <OLJBPFCMFFA>k__BackingField;    // 0x0x28
    public DAFHKMKFGFP <OLPCFDJNJGF>k__BackingField;    // 0x0x30
    public string <FMDGIEEENHH>k__BackingField;    // 0x0x38
    public int <JILKDIJPPOH>k__BackingField;    // 0x0x40
    public bool <AOMBBAENJCP>k__BackingField;    // 0x0x44
}

// --------------------------------------------------------------------------
// CEMIJFMECBA
//   (not directly referenced by a detected call)
public class CEMIJFMECBA
{
    public APEPLDIMBOE <ABPPNIHLEPL>k__BackingField;    // 0x0x10
    public NONEDDDIPFD <FPDAIONIOLN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CLPNCMKFDLL
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.Auth]
public class CLPNCMKFDLL
{
    public string <CGACOKEJEOE>k__BackingField;    // 0x0x10
    public string <BOIDGPKMGCA>k__BackingField;    // 0x0x18
    public string <NJFHNFJGIKF>k__BackingField;    // 0x0x20
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x28
    public string <MDDAIMBAAKH>k__BackingField;    // 0x0x30
    public AJALGCONJHH <NPJACEHOEGI>k__BackingField;    // 0x0x38
    public List<string> <DGNLMCOBGNO>k__BackingField;    // 0x0x40
    public List<string> <OAOMFAJCOFE>k__BackingField;    // 0x0x48
    public string <JACBHMIJGKH>k__BackingField;    // 0x0x50
    public List<OAPECAFLCGH> <HGBFJHHHKHL>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// CNAABNICKOE
//   (not directly referenced by a detected call)
public class CNAABNICKOE
{
    public float <AMIPGAOPDNM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CNGFFNGOBNO
//   (not directly referenced by a detected call)
public class CNGFFNGOBNO
{
    public GGPNHKNMMJF <COOMMPDKPPK>k__BackingField;    // 0x0x10
    public int <PCBGEMDOINO>k__BackingField;    // 0x0x14
    public OHALPNFODFH <CDPHPAOPAMI>k__BackingField;    // 0x0x18
}
...
public class DJONKCNLLFO
{
    public JPJPMALFAAK <NPJACEHOEGI>k__BackingField;    // 0x0x10
    public GPCEFABFMIH <OCHNAPMGPGD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DNMFPJIPGDJ
//   REQUEST  POST   api/equipment/v1/update   [Service.WWW]
public class DNMFPJIPGDJ
{
    public string <EEGEHPLEMBD>k__BackingField;    // 0x0x10
    public string <BBLGEMICJLL>k__BackingField;    // 0x0x18
    public string <MHNPKBDEHDC>k__BackingField;    // 0x0x20
    public string <OLJBPFCMFFA>k__BackingField;    // 0x0x28
    public DAFHKMKFGFP <OLPCFDJNJGF>k__BackingField;    // 0x0x30
    public bool CBCGCBKEEGE;    // 0x0x34
    public bool <FCDANCGPNJN>k__BackingField;    // 0x0x35
}

// --------------------------------------------------------------------------
// DPEEBCFKIEP
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class DPEEBCFKIEP
{
    public Dictionary<Guid, DJONKCNLLFO> <ALOCDHHINEO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EDIAJNNECGH
//   RESPONSE GET    api/config/v1/amplitude   [Service.Auth]
public class EDIAJNNECGH
{
    public string <KHHPNFKKMFH>k__BackingField;    // 0x0x10
    public string <HMLMOCJHNGA>k__BackingField;    // 0x0x18
    public bool <CNGEJIIIOBM>k__BackingField;    // 0x0x20
    public string <NHGDALPONBD>k__BackingField;    // 0x0x28
}
...
public class EGEHFLCLGME
{
    public OHBNDCBLFDK <LCNMBAPDCDA>k__BackingField;    // 0x0x10
    public KEJCEPKJIAM <GBIBEJCFAPN>k__BackingField;    // 0x0x18
    public int <HGGBDGHOIGB>k__BackingField;    // 0x0x20
}
...
public class EIJICBAJGLP
{
    public List<string> <JHFMEGBJFFH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EMAPHEHPCDI
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{jDEPDKNELPP}   [Service.Auth]
public class EMAPHEHPCDI
{
    public uint <CGACOKEJEOE>k__BackingField;    // 0x0x10
    public uint? <JIPMALHGCNJ>k__BackingField;    // 0x0x14
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x20
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x28
    public DateTime <NCGMEBELNHA>k__BackingField;    // 0x0x30
    public DateTime? <GIJDPGNLPNH>k__BackingField;    // 0x0x38
    public bool <BHLNEIFBHAF>k__BackingField;    // 0x0x48
    public List<CLPNCMKFDLL> <FBPICHAKAKL>k__BackingField;    // 0x0x50
    public List<string> <OAOMFAJCOFE>k__BackingField;    // 0x0x58
    public int <PKPJLGCPPLL>k__BackingField;    // 0x0x60
    public int <BGPOBILBCOG>k__BackingField;    // 0x0x64
    public int <ICLMJIOKFPB>k__BackingField;    // 0x0x68
}
...
public class FFOMJBMKDLH
{
    public byte <GGJFAABHAIB>k__BackingField;    // 0x0x10
    public int <INJJBDIOGIO>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// FHBMFPODBCO
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.Auth]
public class FHBMFPODBCO
{
    public List<MMDGBCCDIOI> <OHDLGJIMOEL>k__BackingField;    // 0x0x10
    public PFLJOGJPHHO <PFDEOHMBDFJ>k__BackingField;    // 0x0x18
}
...
public class FHEFJIFKCGF
{
    public List<APEPLDIMBOE> <MDHOPKNDOJD>k__BackingField;    // 0x0x10
    public string <NLFFCIEHEFO>k__BackingField;    // 0x0x18
}
...
public class FKLLDFBHMHP : PKCEALPJFFG
{
    public DHAPNNKDEIG? <KODLBBHHLIM>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <ALJLDNMCJHL>k__BackingField;    // 0x0x20
}
...
public class FLEEADKFEEE
{
    public long <DMEKLJMCLPP>k__BackingField;    // 0x0x10
    public long? <LKJADMNGLLD>k__BackingField;    // 0x0x18
    public long? <KGJINAJCEDO>k__BackingField;    // 0x0x28
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x38
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x40
    public List<string> <OAOMFAJCOFE>k__BackingField;    // 0x0x48
    public string <FHGKJKMCGMH>k__BackingField;    // 0x0x50
    public DateTime <HBJCODKIOHB>k__BackingField;    // 0x0x58
    public DateTime <KCDLMACPAHK>k__BackingField;    // 0x0x60
    public OEPLGNJPCAA <HAGHNKBANDP>k__BackingField;    // 0x0x68
    public bool <MFNEBADEBHL>k__BackingField;    // 0x0x6C
    public bool <CEJCLCNKMMO>k__BackingField;    // 0x0x6D
    public LEDEOFAAHNE <LCJLGMOHLHC>k__BackingField;    // 0x0x70
    public LEDEOFAAHNE <GAJIPFHCAOJ>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// GAFFHEMOJLN
//   (not directly referenced by a detected call)
public class GAFFHEMOJLN
{
    public bool <DMELCKLAAIF>k__BackingField;    // 0x0x10
    public MHOCJHKGMDK <PEOCCDMKNFF>k__BackingField;    // 0x0x18
    public float <ELMBGANGOLN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GDEKNPDCLHH
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.WWW]
public class GDEKNPDCLHH
{
    public int <HHAMHFLPEGK>k__BackingField;    // 0x0x10
    public Guid <DIAJPALBAPA>k__BackingField;    // 0x0x14
    public long <GNKNGIGOOPL>k__BackingField;    // 0x0x28
    public DateTime <ACCDLKGCAEC>k__BackingField;    // 0x0x30
}
...
public class GIHMEDKCNBI : PKCEALPJFFG
{
    public BMBGMNKMCNF? <KODLBBHHLIM>k__BackingField;    // 0x0x18
    public GDEKNPDCLHH <COPPINLBPHB>k__BackingField;    // 0x0x20
}
...
// base   : JLDIMOKKPMA
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/season/{nDCAPOICIOI}   [Service.WWW]
public class GILCDFHCEHO : JLDIMOKKPMA
{
    public int <PANCPBNOLAM>k__BackingField;    // 0x0x30
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x38
    public DateTime <AEBCJGEMEOD>k__BackingField;    // 0x0x40
    public DateTime <GGJOBMINLLJ>k__BackingField;    // 0x0x48
    public GGPNHKNMMJF <COOMMPDKPPK>k__BackingField;    // 0x0x50
    public OOKGBHKFGDI <FPKHPCMFNOC>k__BackingField;    // 0x0x58
    public List<AKCAIINNICB> <IOKMCNAGAJC>k__BackingField;    // 0x0x60
    public AMIGCBBBMBI <ALJNPHBGJDJ>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// GKDIGPKJPFP
//   (not directly referenced by a detected call)
public class GKDIGPKJPFP
{
    public long <EHEIEGAPHPL>k__BackingField;    // 0x0x10
    public string <KMINFPNHABB>k__BackingField;    // 0x0x18
    public int <DKMBBKGNHAL>k__BackingField;    // 0x0x20
    public int <JKOOIEAICMA>k__BackingField;    // 0x0x24
    public int <NABBPOLHPEP>k__BackingField;    // 0x0x28
    public int <CGMJAHNOFOG>k__BackingField;    // 0x0x2C
    public int <MKOJBJOPMGB>k__BackingField;    // 0x0x30
    public string <OMCCEJNNJHN>k__BackingField;    // 0x0x38
    public string <GNDGJFKOBMF>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// GKNIGMDFJDM
//   (not directly referenced by a detected call)
public class GKNIGMDFJDM
{
    public ObscuredLong <CGAGFAGNFAM>k__BackingField;    // 0x0x10
    public string <KMINFPNHABB>k__BackingField;    // 0x0x38
    public ObscuredInt <MGFGOLIIAGE>k__BackingField;    // 0x0x40
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x58
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x60
    public string <FHGKJKMCGMH>k__BackingField;    // 0x0x68
    public byte <CJCAGLCEPMN>k__BackingField;    // 0x0x70
    public int <NPBCGPJIFDG>k__BackingField;    // 0x0x74
    public EHEENOPEONH <HAGHNKBANDP>k__BackingField;    // 0x0x78
    public DateTime <ACCDLKGCAEC>k__BackingField;    // 0x0x80
    public DateTime <IEEHBJLFLDO>k__BackingField;    // 0x0x88
    public DateTime? <BJGFKLPJJFG>k__BackingField;    // 0x0x90
    public long? <FEMGEBBNELO>k__BackingField;    // 0x0xA0
    public int <BCKEHAHNHNF>k__BackingField;    // 0x0xB0
    public int <ONKLMAFIFOO>k__BackingField;    // 0x0xB4
    public int <EPGNIODOJHD>k__BackingField;    // 0x0xB8
    public CNMMDCNNGBJ <GHGBJPCFBIB>k__BackingField;    // 0x0xBC
    public CNMMDCNNGBJ <BFNBBBCDMGP>k__BackingField;    // 0x0xC0
    public ObscuredBool <EPOEHNIMCHL>k__BackingField;    // 0x0xC4
    public ObscuredBool <IKIDKALHIJL>k__BackingField;    // 0x0xD0
    public ObscuredBool <LOENNPMOHBF>k__BackingField;    // 0x0xDC
    public int? <PCBGEMDOINO>k__BackingField;    // 0x0xE8
    public bool <HPLCGHJADIM>k__BackingField;    // 0x0xF0
}

// --------------------------------------------------------------------------
// GLAMKFCMLFL
//   (not directly referenced by a detected call)
public class GLAMKFCMLFL
{
    public int <HGGBDGHOIGB>k__BackingField;    // 0x0x10
    public OHBNDCBLFDK <LCNMBAPDCDA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GPCEFABFMIH
//   (not directly referenced by a detected call)
public class GPCEFABFMIH
{
    public Guid <PAECJEGPAMG>k__BackingField;    // 0x0x10
    public int <HHAMHFLPEGK>k__BackingField;    // 0x0x20
    public int <PECEIMLIEIN>k__BackingField;    // 0x0x24
    public Guid <KPHBGKLGKBL>k__BackingField;    // 0x0x28
    public DateTime <ACCDLKGCAEC>k__BackingField;    // 0x0x38
    public AEGCIMDELDP <IEDJHGEBHHK>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// HAICBGBMMJE
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.WWW]
public class HAICBGBMMJE
{
    public List<AIDIFECKOEC> <FCCDEPPNNLL>k__BackingField;    // 0x0x10
    public string <NLFFCIEHEFO>k__BackingField;    // 0x0x18
}
...
public class HCHIAIPLEPL : JLDIMOKKPMA
{
    public string <GBGEFGPGKFL>k__BackingField;    // 0x0x30
    public List<IKIEHALEDCE> MPADJCEKFIF;    // 0x0x38
    public int <AEKNPDMLHJB>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// HDIKLJCOHMG
//   REQUEST  POST   api/playerevents/v1/report   [Service.Auth]
public class HDIKLJCOHMG
{
    public LKCOHHGAFLE <BMLOKANHLGC>k__BackingField;    // 0x0x10
    public long <IGDJENDNCBI>k__BackingField;    // 0x0x18
    public string <CHBGJKGDJPC>k__BackingField;    // 0x0x20
}
...
public class HOPNPMJFCHO
{
    public bool <NBCAMEBIKOE>k__BackingField;    // 0x0x10
    public string <FOPJNJPOKPK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IKAOLBFEIBF
//   REQUEST  ?      api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItemDescs   [Service.Notifications]
public class IKAOLBFEIBF
{
    public List<string> <KFFAOPGDHIE>k__BackingField;    // 0x0x10
    public byte <GGJFAABHAIB>k__BackingField;    // 0x0x18
    public int <INJJBDIOGIO>k__BackingField;    // 0x0x1C
}
...
// base   : OOKGBHKFGDI
//   (not directly referenced by a detected call)
public class IKIEHALEDCE : OOKGBHKFGDI
{
    public MHOCJHKGMDK <PEOCCDMKNFF>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// IMLHPOIHDEJ
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.Auth]
public class IMLHPOIHDEJ
{
    public LKCOHHGAFLE <BMLOKANHLGC>k__BackingField;    // 0x0x10
    public int <ONCNCBNJGJP>k__BackingField;    // 0x0x14
    public long <FEIJHPECOBE>k__BackingField;    // 0x0x18
    public bool <EKLFHABMKLE>k__BackingField;    // 0x0x20
    public string <FOPJNJPOKPK>k__BackingField;    // 0x0x28
    public int? <LCJNDAOJDOA>k__BackingField;    // 0x0x30
    public bool <JDJBKGHCCPJ>k__BackingField;    // 0x0x38
    public bool <GDHJJDBDKAB>k__BackingField;    // 0x0x39
    public bool <LJFCFGOPELN>k__BackingField;    // 0x0x3A
    public bool <CBDFAFJKNMC>k__BackingField;    // 0x0x3B
    public string <NFDBNHLCPEA>k__BackingField;    // 0x0x40
    public DateTime? <GCIIJNGLENE>k__BackingField;    // 0x0x48
    public string <PGFEPNIOKDL>k__BackingField;    // 0x0x58
    public float <IOIEAFEBDCO>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// IODJOKIGBDA
//   REQUEST  POST   api/playerevents/v1/respond   [Service.Auth]
public class IODJOKIGBDA
{
    public long <IGDJENDNCBI>k__BackingField;    // 0x0x10
    public KINKHHKIJDG <NCAJIPEPNAI>k__BackingField;    // 0x0x18
}
...
public class JHIPGOAIKPF
{
    public int OHNDODMPNPE;    // 0x0x10
    public long JMKLMFAHKHJ;    // 0x0x18
}
...
public class JLDIICCCIAD
{
    public Guid <LIHNBAJGIII>k__BackingField;    // 0x0x10
    public long <GJHEIDPNGCJ>k__BackingField;    // 0x0x20
}
...
public class JPAAGCKCCNL
{
    public PFLJOGJPHHO <PFDEOHMBDFJ>k__BackingField;    // 0x0x10
}
...
public class KBEGFMGJLGK
{
    public Dictionary<string, NHNIKCBABGD> <JDIFNKKFGOL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KCIFBAFMIPB
//   (not directly referenced by a detected call)
public class KCIFBAFMIPB
{
    public float <MCKOKHEJIGD>k__BackingField;    // 0x0x10
    public float <OCPLOBNPAHM>k__BackingField;    // 0x0x14
    public float <CFCBBHHJAPE>k__BackingField;    // 0x0x18
    public float <IGBBPHFMNDL>k__BackingField;    // 0x0x1C
    public float <MCJGKDGFKLM>k__BackingField;    // 0x0x20
    public float <FGHEMGFLOAO>k__BackingField;    // 0x0x24
    public float <LAIAHEBBEON>k__BackingField;    // 0x0x28
    public float <FOIIJLNHCKP>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// KEJCEPKJIAM
//   (not directly referenced by a detected call)
public class KEJCEPKJIAM
{
    public long <PCBGEMDOINO>k__BackingField;    // 0x0x10
    public Guid? <DIAJPALBAPA>k__BackingField;    // 0x0x18
}
...
public class KMBIPICFNEL
{
    public bool <JCMIKGPBAEN>k__BackingField;    // 0x0x10
    public string <BOIDGPKMGCA>k__BackingField;    // 0x0x18
    public string <NLMCCMAGGDP>k__BackingField;    // 0x0x20
}
...
public class LAEAELIFNEF
{
    public int <GCKOBEBNGLN>k__BackingField;    // 0x0x10
    public EOLDBJAAGBO <NCAJIPEPNAI>k__BackingField;    // 0x0x14
    public DJAGOIJDLGA <KEDHHBMDJNF>k__BackingField;    // 0x0x18
    public DJAGOIJDLGA <GPFPIFLBHJP>k__BackingField;    // 0x0x1C
    public DJAGOIJDLGA <EPKBNNAIJEE>k__BackingField;    // 0x0x20
}
...
public class LHHKNBJCNML
{
    public MFDMPGEIJKK <NPJACEHOEGI>k__BackingField;    // 0x0x10
    public CCHJLKCINKD <LEMICEDEHII>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LNKIAPJLBMN
//   RESPONSE GET    api/config/v1/backtrace   [Service.Auth]
public class LNKIAPJLBMN
{
    public int <MDKAHLFGDLE>k__BackingField;    // 0x0x10
    public int <FLAPCGFACJB>k__BackingField;    // 0x0x14
    public float <HPBEOEAJFNA>k__BackingField;    // 0x0x18
    public int <GHEDAGPDEHL>k__BackingField;    // 0x0x1C
    public int <PGINMDCJNBA>k__BackingField;    // 0x0x20
    public int <GJHIFAMALIM>k__BackingField;    // 0x0x24
    public int <GMJAIBACPMA>k__BackingField;    // 0x0x28
    public string <ICEHGFABHEM>k__BackingField;    // 0x0x30
    public string <GFOLEAAHHKO>k__BackingField;    // 0x0x38
}
...
public class MDCAOKIDJLL
{
    public List<BGLIPGIPFDH> <OAOMFAJCOFE>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{aNDGAIINPHI}   [Service.WWW]
public enum MFDMPGEIJKK
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class MFLPFGOEOAO
{
    public BINGNGLJBAA <BMLOKANHLGC>k__BackingField;    // 0x0x10
    public string <CHBGJKGDJPC>k__BackingField;    // 0x0x18
    public int? <MPLIDOCKECA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MHOCJHKGMDK
//   (not directly referenced by a detected call)
public class MHOCJHKGMDK
{
    public int <JJEAFMGAKFL>k__BackingField;    // 0x0x10
    public string <MHNPKBDEHDC>k__BackingField;    // 0x0x18
    public string <OLJBPFCMFFA>k__BackingField;    // 0x0x20
    public string <FMDGIEEENHH>k__BackingField;    // 0x0x28
    public string <AGOKHPDMBCC>k__BackingField;    // 0x0x30
    public string <MHEHIIHJHDG>k__BackingField;    // 0x0x38
    public LOBCOGJPLPO? <OLOPJDPDLMH>k__BackingField;    // 0x0x40
    public string <LOCNKNJJKAF>k__BackingField;    // 0x0x48
    public string <CCBLKHACOEF>k__BackingField;    // 0x0x50
    public bool <LCIOEBBGDKK>k__BackingField;    // 0x0x58
    public bool <FKMGFJOAOFP>k__BackingField;    // 0x0x59
    public bool <IBIFPDGOGHL>k__BackingField;    // 0x0x5A
    public DAFHKMKFGFP <OLPCFDJNJGF>k__BackingField;    // 0x0x5C
    public GGPNHKNMMJF <COOMMPDKPPK>k__BackingField;    // 0x0x60
    public int <IAMMPNNGEPD>k__BackingField;    // 0x0x64
    public EIFIOAHKPFD <HIIGDGNNIAG>k__BackingField;    // 0x0x68
    public EIJDHPGOMCC <FGGNBDMACDP>k__BackingField;    // 0x0x6C
    public int? <CCGKBMKOJOP>k__BackingField;    // 0x0x70
    public string <BJHIAPIIDMH>k__BackingField;    // 0x0x78
    public int? <JILKDIJPPOH>k__BackingField;    // 0x0x80
    public int? <FHOAFCHOACC>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// MMDGBCCDIOI
//   (not directly referenced by a detected call)
public class MMDGBCCDIOI
{
    public int <JMGELCILEHM>k__BackingField;    // 0x0x10
    public PFLJOGJPHHO <PFDEOHMBDFJ>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// MONOJGALEIF
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Matchmaking]
public class MONOJGALEIF
{
    public Guid <MJJDAGEJDJB>k__BackingField;    // 0x0x10
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x20
    public string <FHGKJKMCGMH>k__BackingField;    // 0x0x28
    public DateTime <AEBCJGEMEOD>k__BackingField;    // 0x0x30
    public DateTime? <PKKDEAGFJKL>k__BackingField;    // 0x0x38
    public List<OOBFHHLNCMD> <CCEALNJAOLA>k__BackingField;    // 0x0x48
}
...
// NEMNEILGLFD
//   (not directly referenced by a detected call)
public class NEMNEILGLFD
{
    public long <JJEAFMGAKFL>k__BackingField;    // 0x0x10
    public string <AGOKHPDMBCC>k__BackingField;    // 0x0x18
    public string <IBIHMHPNIMD>k__BackingField;    // 0x0x20
    public LOBCOGJPLPO? <OLOPJDPDLMH>k__BackingField;    // 0x0x28
    public string <LOCNKNJJKAF>k__BackingField;    // 0x0x30
    public string <CCBLKHACOEF>k__BackingField;    // 0x0x38
    public PMCLKGCHJEB <DAAJJLCGBNO>k__BackingField;    // 0x0x40
    public int <ENEIDKOPDKL>k__BackingField;    // 0x0x44
    public int <CEHFEFBKNFL>k__BackingField;    // 0x0x48
    public EIJDHPGOMCC? <OKLGGOKINGH>k__BackingField;    // 0x0x4C
    public DAFHKMKFGFP? <NCALDAIGJHB>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// NHNIKCBABGD
//   (not directly referenced by a detected call)
public class NHNIKCBABGD
{
    public long <JALKAMGLEIF>k__BackingField;    // 0x0x10
    public Guid <PKBIOIGKBJI>k__BackingField;    // 0x0x18
    public Guid <NFNMICNMKAG>k__BackingField;    // 0x0x28
    public DateTime <IEEHBJLFLDO>k__BackingField;    // 0x0x38
    public string <IDHBNOLLELB>k__BackingField;    // 0x0x40
    public string <HBKFBAKLEEA>k__BackingField;    // 0x0x48
    public string <GAKEJHDAFBK>k__BackingField;    // 0x0x50
    public string <AADGNMMICBA>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// NIMFIPMINHN
//   (not directly referenced by a detected call)
public class NIMFIPMINHN
{
    public int <BAHDEDABIAM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NMJEHCCOICJ
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.?]
public class NMJEHCCOICJ
{
    public int? <NPCLMFALDGH>k__BackingField;    // 0x0x10
    public string <MDDAIMBAAKH>k__BackingField;    // 0x0x18
    public string <CMCFHFKEFPL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NONEDDDIPFD
//   (not directly referenced by a detected call)
public class NONEDDDIPFD
{
    public long <LAMMHMHOGND>k__BackingField;    // 0x0x10
    public long <IGDJENDNCBI>k__BackingField;    // 0x0x18
    public int <IPFBCLPGDDA>k__BackingField;    // 0x0x20
    public DateTime <IEEHBJLFLDO>k__BackingField;    // 0x0x28
    public KINKHHKIJDG <NCAJIPEPNAI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// OAPECAFLCGH
//   (not directly referenced by a detected call)
public class OAPECAFLCGH
{
    public DateTime <IEEHBJLFLDO>k__BackingField;    // 0x0x10
    public string <GOCNNMMMMHA>k__BackingField;    // 0x0x18
}
...
// OHALPNFODFH
//   (not directly referenced by a detected call)
public class OHALPNFODFH
{
    public int <DAJHBFNFJMF>k__BackingField;    // 0x0x10
    public DateTime? <CKFGFDGGLNE>k__BackingField;    // 0x0x18
    public DateTime? <IHLDLGAOJGG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// OHBNDCBLFDK
//   REQUEST  PUT    api/roomconsumables   [Service.WWW]
public class OHBNDCBLFDK
{
    public Guid? <LNIEDDCDKBC>k__BackingField;    // 0x0x10
    public Guid <MDKFBKALOFA>k__BackingField;    // 0x0x24
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{aBACGOKGPKP}   [Service.WWW]
public class OHOHPOIKDIB
{
    public JPJPMALFAAK <NPJACEHOEGI>k__BackingField;    // 0x0x10
    public AEGCIMDELDP <IEDJHGEBHHK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OILJIMGGNHN
//   RESPONSE POST   api/inventions/v1/settags   [Service.Auth]
public class OILJIMGGNHN
{
    public KMNEMPFJMOH <PFDEOHMBDFJ>k__BackingField;    // 0x0x10
    public List<string> <OAOMFAJCOFE>k__BackingField;    // 0x0x18
}
...
// OOBFHHLNCMD
//   (not directly referenced by a detected call)
public class OOBFHHLNCMD
{
    public Guid <ANCOCJGBABG>k__BackingField;    // 0x0x10
    public Guid <MNPBJHCOFGH>k__BackingField;    // 0x0x20
    public DateTime <AEBCJGEMEOD>k__BackingField;    // 0x0x30
    public List<MHOCJHKGMDK> <GBJHBFKILPL>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// OOKGBHKFGDI
//   (not directly referenced by a detected call)
public class OOKGBHKFGDI
{
    public int <GIMINIKKFME>k__BackingField;    // 0x0x10
    public OKDEAONFODE <NCAJIPEPNAI>k__BackingField;    // 0x0x14
    public List<CNGFFNGOBNO> <MELDPCMGIHM>k__BackingField;    // 0x0x18
    public List<CNGFFNGOBNO> <BJPMCOFIPGO>k__BackingField;    // 0x0x20
    public bool <EICABMENHAF>k__BackingField;    // 0x0x28
    public DateTime? <APAKFCHJGBK>k__BackingField;    // 0x0x30
    public DateTime? <PICDPECPONF>k__BackingField;    // 0x0x40
    public DateTime? <AIODALIEOPA>k__BackingField;    // 0x0x50
}
...
public class OPCIDJFNKKJ
{
    public int <KABLCHPHPEO>k__BackingField;    // 0x0x10
    public bool <MDBGBPFIHHH>k__BackingField;    // 0x0x14
    public DateTime <JIEJAMHOCOF>k__BackingField;    // 0x0x18
    public bool <AFDCECKIEPJ>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/progressionEvents/collect/{kIHNLCPBLAB}/{iFCEFJJEIPE}   [Service.Auth]
public class PAKMEJPDINK
{
    public long? <CGACOKEJEOE>k__BackingField;    // 0x0x10
    public int <IPFBCLPGDDA>k__BackingField;    // 0x0x20
    public int? <CCKDHEEKHNO>k__BackingField;    // 0x0x24
    public string <AGOKHPDMBCC>k__BackingField;    // 0x0x30
    public LOBCOGJPLPO? <OLOPJDPDLMH>k__BackingField;    // 0x0x38
    public string <MHEHIIHJHDG>k__BackingField;    // 0x0x40
    public string <LOCNKNJJKAF>k__BackingField;    // 0x0x48
    public string <CCBLKHACOEF>k__BackingField;    // 0x0x50
    public GGPNHKNMMJF <COOMMPDKPPK>k__BackingField;    // 0x0x58
    public int <IAMMPNNGEPD>k__BackingField;    // 0x0x5C
    public int <ENEIDKOPDKL>k__BackingField;    // 0x0x60
    public EIJDHPGOMCC <OKLGGOKINGH>k__BackingField;    // 0x0x64
    public DAFHKMKFGFP <NCALDAIGJHB>k__BackingField;    // 0x0x68
    public string <EGJGLGKIMEB>k__BackingField;    // 0x0x70
    public JBGMICKCHFJ <HDCHJDCGOMM>k__BackingField;    // 0x0x78
    public BKDELBMDKCD <NACDLPDHPLE>k__BackingField;    // 0x0x7C
    public HECLNDPGFPM? <AKEBLMEDCNH>k__BackingField;    // 0x0x80
    public bool <EIIGHIGHGJD>k__BackingField;    // 0x0x88
    public bool <EOKOCNKCNDM>k__BackingField;    // 0x0x89
    public string <MIPCDCCPMHM>k__BackingField;    // 0x0x90
    public bool <EAGCOIPFHMK>k__BackingField;    // 0x0x98
    public bool EPCHFENGIIB;    // 0x0x99
}

// --------------------------------------------------------------------------
// PAKNGIILDAM
//   (not directly referenced by a detected call)
public class PAKNGIILDAM
{
    // (no instance fields in the metadata dump)
}
...
// --------------------------------------------------------------------------
// PBBAIACDPAD
// base   : HHMCKMENLNM`1<MDIDJBKMIPO>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{pOBGAKFHBGF}   [Service.Auth]
public class PBBAIACDPAD
{
    // (no instance fields in the metadata dump)
}
...
public class PDBMCMEKPFI
{
    public List<string> <OKAPJKEJAHP>k__BackingField;    // 0x0x10
    public List<string> <MPBKABAFACD>k__BackingField;    // 0x0x18
    public List<string> <GKCNEINHFCB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PENINMOMJBN
//   (not directly referenced by a detected call)
public class PENINMOMJBN
{
    public int <JPFEMOBGLJO>k__BackingField;    // 0x0x10
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x18
    public string <LOOAFLEKLDJ>k__BackingField;    // 0x0x20
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x28
    public string <OLJBPFCMFFA>k__BackingField;    // 0x0x30
    public bool <OMHNDKBNNJC>k__BackingField;    // 0x0x38
    public int <MJGAJBOCLAH>k__BackingField;    // 0x0x3C
    public PAKNGIILDAM <GHEKLHLGAPM>k__BackingField;    // 0x0x40
    public OLOPNIJACJE CMMEHBGDMON;    // 0x0x48
    public OLOPNIJACJE MFBJAMPOKPL;    // 0x0x50
    public OLOPNIJACJE IJMBCKNEKMM;    // 0x0x58
    public BGDMOOFNMKA JDCOKHNGBJN;    // 0x0x60
}
...
//   RESPONSE DELETE api/keepsakes/{fKKJHAPDKFN}   [Service.Auth]
...
public class PFCFEBKIJKD
{
    public bool <NBCAMEBIKOE>k__BackingField;    // 0x0x10
    public string <MNPBAGFIOPC>k__BackingField;    // 0x0x18
}
...
public class PFNOAPOGBNB
{
    public long <DMEKLJMCLPP>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <FFDLKMPJAHK>k__BackingField;    // 0x0x18
    public HNGCIEGNLJB <JDKDADBLDFA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PGKEEGJLCEI
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.WWW]
public class PGKEEGJLCEI
{
    public Guid <DIAJPALBAPA>k__BackingField;    // 0x0x10
    public int <MDEGACBBJJI>k__BackingField;    // 0x0x20
    public long <MOFOBCIAOAD>k__BackingField;    // 0x0x28
    public Guid <LIHNBAJGIII>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// PJGKPECLBBD
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.WWW]
public class PJGKPECLBBD
{
    public List<int> <JNDAKMJDAHF>k__BackingField;    // 0x0x10
    public string <NLFFCIEHEFO>k__BackingField;    // 0x0x18
}
...
// PLHFJPMFODI
//   (not directly referenced by a detected call)
public class PLHFJPMFODI
{
    public int <CDNKMJKMPBD>k__BackingField;    // 0x0x10
}
...
public class AddKeepsakeInstanceRequest
{
    public long <DMEKLJMCLPP>k__BackingField;    // 0x0x10
    public long? <LKJADMNGLLD>k__BackingField;    // 0x0x18
    public LFEFOBEGNBK <BIICDKFBKIP>k__BackingField;    // 0x0x28
}
...
{
    public MBJHNKBAFNG <PFDEOHMBDFJ>k__BackingField;    // 0x0x10
    public string <KADFPKJMKCI>k__BackingField;    // 0x0x18
    public string <HINDLNMLLEB>k__BackingField;    // 0x0x20
    public string <PCCHBOLFEAF>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public GGPNHKNMMJF <CurrencyType>k__BackingField;    // 0x0x18
    public HECLNDPGFPM <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <IGDJENDNCBI>k__BackingField;    // 0x0x10
    public long? <HKLHLBJBAHG>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public LEJHOBMJDDL FilterType;    // 0x0x20
...
{
    public LFEFOBEGNBK <DOEJECDHKDD>k__BackingField;    // 0x0x10
    public string <ADEDKPFNKLG>k__BackingField;    // 0x0x18
    public int <LIEOIMMKGBM>k__BackingField;    // 0x0x20
    public int <KFMNEMJOLNH>k__BackingField;    // 0x0x24
    public string <LMAPHCLKBPN>k__BackingField;    // 0x0x28
    public string <LCPLLBCCIHG>k__BackingField;    // 0x0x30
}
...
{
    public int <HHAMHFLPEGK>k__BackingField;    // 0x0x10
    public Guid <AIGAHNGDCCN>k__BackingField;    // 0x0x14
    public DateTime <EHLMBGMMDLD>k__BackingField;    // 0x0x28
}
...
{
    public bool <KABDOEBCMBI>k__BackingField;    // 0x0x10
    public int <FIEHNFMFOIP>k__BackingField;    // 0x0x14
    public bool <MINGEBBIIHO>k__BackingField;    // 0x0x18
}
...
{
    public Guid <AIGAHNGDCCN>k__BackingField;    // 0x0x10
    public LFEFOBEGNBK <IBLCKGMEHPN>k__BackingField;    // 0x0x20
    public int <MHAPJMACFFP>k__BackingField;    // 0x0x24
    public long <DMEKLJMCLPP>k__BackingField;    // 0x0x28
    public long? <LKJADMNGLLD>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{mPOKKLMOGPD}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <OBPONKJNFLI>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <EGFDLFBJLMD>k__BackingField;    // 0x0x18
}
...
{
    public long <IIEDEPOEJFG>k__BackingField;    // 0x0x10
    public long <DMEKLJMCLPP>k__BackingField;    // 0x0x18
    public long <OGEODIMPEEK>k__BackingField;    // 0x0x20
    public IKNHFJCEBON <NCAJIPEPNAI>k__BackingField;    // 0x0x28
    public int <NKNNPJFJFKK>k__BackingField;    // 0x0x2C
}
...
{
    public long <DMEKLJMCLPP>k__BackingField;    // 0x0x10
    public List<Guid> <HKHINJICDPG>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <OBPONKJNFLI>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <EGFDLFBJLMD>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <EHBHLNPMKBF>k__BackingField;    // 0x0x20
}
...
{
    public long <OGEODIMPEEK>k__BackingField;    // 0x0x10
    public long <BLNIFONMDMP>k__BackingField;    // 0x0x18
    public int? <FAMEFGJFKJI>k__BackingField;    // 0x0x20
    public int? <FDEHOPACAJF>k__BackingField;    // 0x0x28
    public long? <IAIBAGMJNCN>k__BackingField;    // 0x0x30
    public long <LFLKIOBENIJ>k__BackingField;    // 0x0x40
    public long <CDPBADHJPGC>k__BackingField;    // 0x0x48
    public int <OKAPGGGOLHC>k__BackingField;    // 0x0x50
    public IKNHFJCEBON <OFNEHOIIDJI>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <OJPIAIEAAEH>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public EIJDHPGOMCC <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public MPLBPIHCELM creatorAccountRole;    // 0x0x58
}
...
{
    public CDCJDGODBGG <KMKKJNFLLIB>k__BackingField;    // 0x0x10
    public BJOMNLCEFOI <KPKLAACHMIP>k__BackingField;    // 0x0x14
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x18
    public string <JNNBPNDPDEL>k__BackingField;    // 0x0x20
    public bool <LHINMGAKEAI>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<CDCJDGODBGG> <JDBEPNOPKOB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{kIHNLCPBLAB}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <BLNIFONMDMP>k__BackingField;    // 0x0x10
    public string <PILLOPJPDMF>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <DMOKEPFMFCD>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <DNAAFBCJHNE>k__BackingField;    // 0x0x28
    public DateTime <HBJCODKIOHB>k__BackingField;    // 0x0x30
    public DateTime <KCDLMACPAHK>k__BackingField;    // 0x0x38
    public DateTime <PBPLEAKBFHH>k__BackingField;    // 0x0x40
    public bool <OPGJGGCAOFC>k__BackingField;    // 0x0x48
    public int <FDLDAPNGMPI>k__BackingField;    // 0x0x4C
    public float <KGBCAGIGBDL>k__BackingField;    // 0x0x50
    public Guid? <LEOIGLDAONB>k__BackingField;    // 0x0x54
    public string <NFONKLAFBBF>k__BackingField;    // 0x0x68
    public string <BDKCACGNMJM>k__BackingField;    // 0x0x70
    public string <PPNBLBBOPKL>k__BackingField;    // 0x0x78
    public string <OJMGLEICAHG>k__BackingField;    // 0x0x80
}
...
{
    public Guid <JFIEINGPDAP>k__BackingField;    // 0x0x10
    public int <DNJOHHCJHCI>k__BackingField;    // 0x0x20
    public int <HOEMABKPPFH>k__BackingField;    // 0x0x24
    public int <DPBGGIMIJHD>k__BackingField;    // 0x0x28
    public long <NLCJMEIGNKN>k__BackingField;    // 0x0x30
    public long <FJHLFKBINDJ>k__BackingField;    // 0x0x38
}
...
{
    public int <HHAMHFLPEGK>k__BackingField;    // 0x0x10
    public int <ENEIDKOPDKL>k__BackingField;    // 0x0x14
    public int <BPJACOMJOBP>k__BackingField;    // 0x0x18
    public int <EEPCINKKDFA>k__BackingField;    // 0x0x1C
    public int <DPOKPEJBGDF>k__BackingField;    // 0x0x20
    public DateTime? <GAKPCHEOOAO>k__BackingField;    // 0x0x28
}
...
{
    public long <CDACHJCPKMP>k__BackingField;    // 0x0x10
    public int <JJEAFMGAKFL>k__BackingField;    // 0x0x18
    public string <FHGKJKMCGMH>k__BackingField;    // 0x0x20
    public int <ENEIDKOPDKL>k__BackingField;    // 0x0x28
    public int <MDIEHDIIIFO>k__BackingField;    // 0x0x2C
    public bool <KMBGEDPJDGA>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public NPAKCEEAHOE ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool MJCFCFNHMMB;    // 0x0x28
}
...
{
    public JBGMICKCHFJ CMLJPEKFNMD;  // wrapper
...
{
    public PPOKFPNIFHN HJCFEPLFGPG;  // wrapper
    public int? CDACJEHGKPH;  // wrapper
...
{
    public LKCOHHGAFLE KCPKLKCFGNG;  // wrapper
    public float? FJIPCGACLJB;  // wrapper
    public bool? EGAPAIKDKGK;  // wrapper
...
{
    public List<AILBBDICCKJ> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public EIJDHPGOMCC BCCEHJNGNAL;  // wrapper
    public EIJDHPGOMCC? ECKDCBODIML;  // wrapper
...
{
    public ChatMessage EKPMNNKLPFJ;  // wrapper
    public NOILKLFJNKM KCPKLKCFGNG;  // wrapper
...
{
    public EHEENOPEONH MHEHIMJAHNO;  // wrapper
    public BDHCKBKDBLA FKNMEBPLOKE;  // wrapper
    public GFMMMIEPCHP NDLJPMMECOD;  // wrapper
    public GFMMMIEPCHP CPNPAIIDEAF;  // wrapper
...
{
    public CKHBCKOKILL EPFGKGJFLKN;  // wrapper
    public EIJDHPGOMCC? PNNDHIJMFNK;  // wrapper
...
{
    public NEEMGMBKLBC GCEJHGLIIPK;  // wrapper
...
{
    public GKNIGMDFJDM inventionId;  // wrapper
}
...
// api/keepsakes/{fKKJHAPDKFN}/collect  [Auth POST]
public class KeepsakesFKKJHAPDKFNCollectRequest
{
    public Guid FKKJHAPDKFN;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public LFANFOHAFFL OMAFMFMHALG;  // wrapper
    public long? NJOOPBBHHDG;  // wrapper
...
{
    public Guid JNJPLCIBMFO;  // wrapper
...
{
    public Guid LHBLBPCBMNN;  // wrapper
    public object Price;  // candidate
...
{
    public Guid LHBLBPCBMNN;  // wrapper
    public long? MCLBELCOPGK;  // wrapper
    public byte? KFFIKMKOGNM;  // wrapper
    public int? PIPDACHFJNO;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid JNJPLCIBMFO;  // wrapper
    public long? NJOLMKLNFPG;  // wrapper
    public long? PPPAOECOLCN;  // wrapper
    public int? MNPIGEMLOBF;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> JMFMJMCAPBJ;  // wrapper
...
{
    public BMNAKPEGKDB HJCFEPLFGPG;  // wrapper
    public Guid? BNLHLHLNBKO;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public LKCOHHGAFLE KCPKLKCFGNG;  // wrapper
    public long? FJLGDAOGGIP;  // wrapper
    public Guid? NGLAMJNKJBE;  // wrapper
    public int? JOLADKBILMM;  // wrapper
...
{
    public Guid HFMDDDKDEJC;  // wrapper
...
{
    public Guid CNBPMOBFMMD;  // wrapper
...
{
    public AJALGCONJHH OBFGHDCNMHD;  // wrapper
}
