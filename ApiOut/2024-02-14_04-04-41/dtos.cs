...
public class AAJCKIGKGBH
{
    public int <BHGCBPOCGEK>k__BackingField;    // 0x0x10
    public DKCEMLEBGIJ <FLPBINPMDGA>k__BackingField;    // 0x0x14
    public LBKLFCGIMPK <EGLGGIJNHOP>k__BackingField;    // 0x0x18
    public LBKLFCGIMPK <IPDPKOELELO>k__BackingField;    // 0x0x1C
    public LBKLFCGIMPK <AOGHHMHLBMK>k__BackingField;    // 0x0x20
}
...
public class AIONLBOLMEC
{
    public long <LKDOLAJCILC>k__BackingField;    // 0x0x10
    public long? <EABBKHIOOFC>k__BackingField;    // 0x0x18
    public long? <JCPOKFJPAPO>k__BackingField;    // 0x0x28
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x38
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x40
    public List<string> <MOLMBFCPGHJ>k__BackingField;    // 0x0x48
    public string <EDPOJIIHEHI>k__BackingField;    // 0x0x50
    public DateTime <KHMPGMCBPMP>k__BackingField;    // 0x0x58
    public DateTime <LJOFHADFLCC>k__BackingField;    // 0x0x60
    public PIMKECINBIJ <JEMMHGEOHOJ>k__BackingField;    // 0x0x68
    public bool <IOFEHFINIHE>k__BackingField;    // 0x0x6C
    public bool <KGLKELANOMO>k__BackingField;    // 0x0x6D
    public OIEOKLAIGDD <AHMMMHBEIEA>k__BackingField;    // 0x0x70
    public OIEOKLAIGDD <FMFCILPBPMA>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// ALAOEGGDDJK
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{nHOKIHPEMDP}/{cPGFPJJJNEL}   [Service.WWW]
public class ALAOEGGDDJK
{
    public HDDIIGANMBD <EICGMNNAICP>k__BackingField;    // 0x0x10
    public AHKKCLNLLKI <BJAGDAGKBIK>k__BackingField;    // 0x0x14
    public int <GAJDNMOFAEJ>k__BackingField;    // 0x0x18
    public int <FILAKBFLFGN>k__BackingField;    // 0x0x1C
    public int <NJNCJNKPMKE>k__BackingField;    // 0x0x20
    public NDMFPEFNEII <CDKPDFHKPCG>k__BackingField;    // 0x0x24
    public bool <BEKDJNCBOAJ>k__BackingField;    // 0x0x28
    public float <ABIDFALGGKM>k__BackingField;    // 0x0x2C
    public int <JONFDDMPHHD>k__BackingField;    // 0x0x30
    public bool <OANOLPLGOKC>k__BackingField;    // 0x0x34
}
...
public class ALCMHIAOCNC
{
    public int <DMPCBAHGNBC>k__BackingField;    // 0x0x10
    public bool <CCFPGBLKDHF>k__BackingField;    // 0x0x14
    public DateTime <ABHIABPGKOP>k__BackingField;    // 0x0x18
    public bool <KIIPPBEFDLG>k__BackingField;    // 0x0x20
}
...
public class ANHHDJAGCDA
{
    public bool <LFGLGFDFDKP>k__BackingField;    // 0x0x10
    public string <EOKGEJMLGLM>k__BackingField;    // 0x0x18
}
...
public class BABLKJHKGEG
{
    public PDMDOJEEFDL <AKBDDGIJKPD>k__BackingField;    // 0x0x10
    public string <CDCBNGPAHFB>k__BackingField;    // 0x0x18
    public string <KMMCLCODGFI>k__BackingField;    // 0x0x20
    public string <PCLONKKHJAJ>k__BackingField;    // 0x0x28
    public DGLCIAHMIGE <DFMJNJIDIDN>k__BackingField;    // 0x0x30
    public string <BJDEKBNCDDJ>k__BackingField;    // 0x0x38
    public int <JLFNEEPKNCL>k__BackingField;    // 0x0x40
    public bool <LBLJCLAFMPM>k__BackingField;    // 0x0x44
}

// --------------------------------------------------------------------------
// BCEBNPCDIKP
//   (not directly referenced by a detected call)
public class BCEBNPCDIKP
{
    public int <KJAOLAMLFAC>k__BackingField;    // 0x0x10
    public DateTime? <GFMKGIAHNLK>k__BackingField;    // 0x0x18
    public DateTime? <EAFBOJNFMPH>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// BELKHHNFJEB
//   (not directly referenced by a detected call)
public class BELKHHNFJEB
{
    public Guid <NGNOGNHADCF>k__BackingField;    // 0x0x10
    public int <AFKEPIKPMPH>k__BackingField;    // 0x0x20
    public int <HEHEJPJIMBH>k__BackingField;    // 0x0x24
    public Guid <AINBOCJHDEK>k__BackingField;    // 0x0x28
    public DateTime <MKGAJFPKOMA>k__BackingField;    // 0x0x38
    public JBLCFDKMIAF <LFNMIMFIJOK>k__BackingField;    // 0x0x40
}
...
public class BIMNHCDJAGK
{
    public List<string> <FCNCABAALEF>k__BackingField;    // 0x0x10
    public List<string> <EGOMNCALICF>k__BackingField;    // 0x0x18
    public List<string> <HPKPOOAEDII>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BJMDNGDJEAM
//   (not directly referenced by a detected call)
public class BJMDNGDJEAM
{
    public bool <PKDDAHGMCGI>k__BackingField;    // 0x0x10
    public IIBNAMGNKIL <DDAHIBEFCOC>k__BackingField;    // 0x0x14
    public int <NEMEALFMLPM>k__BackingField;    // 0x0x18
    public DateTime <MKGAJFPKOMA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BLBDGNGPPJG
//   (not directly referenced by a detected call)
public class BLBDGNGPPJG
{
    public long <OOEFPHAFOBB>k__BackingField;    // 0x0x10
    public string <PADBCLGOFDJ>k__BackingField;    // 0x0x18
    public string <BKFBJIDJPAJ>k__BackingField;    // 0x0x20
    public PDMDOJEEFDL? <AKBDDGIJKPD>k__BackingField;    // 0x0x28
    public string <CFFJFNFHFEP>k__BackingField;    // 0x0x30
    public string <PFFCFHDKAHG>k__BackingField;    // 0x0x38
    public IPMPGGNKDLA <BBBCGCAFBDG>k__BackingField;    // 0x0x40
    public int <FMPMDJAPHKP>k__BackingField;    // 0x0x44
    public int <MIFBIAONEJE>k__BackingField;    // 0x0x48
    public DNPCNPILLPP? <LAKFBPOGLBE>k__BackingField;    // 0x0x4C
    public DGLCIAHMIGE? <OGBBILEMAMA>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// BLPCHOMJPLJ
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.WWW]
public class BLPCHOMJPLJ
{
    public long <LKDOLAJCILC>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <BHGBPDDMGAO>k__BackingField;    // 0x0x18
    public FPHCHGNDPME <PIGJGFMDKCF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BMBABDKHEGG
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{pDDHPPHOJPD}   [Service.Auth]
public class BMBABDKHEGG
{
    public uint <HADODLDGLOD>k__BackingField;    // 0x0x10
    public uint? <NFDEJHDBBIF>k__BackingField;    // 0x0x14
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x20
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x28
    public DateTime <JDFKFCCJFCM>k__BackingField;    // 0x0x30
    public DateTime? <HBNFLHCHCPL>k__BackingField;    // 0x0x38
    public bool <CMCJMCEMDKC>k__BackingField;    // 0x0x48
    public List<GPLMBBDPENP> <JIOFCIPBHPE>k__BackingField;    // 0x0x50
    public List<string> <MOLMBFCPGHJ>k__BackingField;    // 0x0x58
    public int <HBAJGIHELAK>k__BackingField;    // 0x0x60
    public int <PBJKIGJAAAA>k__BackingField;    // 0x0x64
    public int <CGBKKIHAOCF>k__BackingField;    // 0x0x68
}
...
public class CAMBHODCDEH
{
    public MDBLKJBLAGM <AEOGGFBFIBD>k__BackingField;    // 0x0x10
    public int <MNEDBCMBNLO>k__BackingField;    // 0x0x14
    public long <CMPCLGIBFCK>k__BackingField;    // 0x0x18
    public bool <GDMCODBDBCJ>k__BackingField;    // 0x0x20
    public string <EOKGEJMLGLM>k__BackingField;    // 0x0x28
    public int? <KOENLADFKLK>k__BackingField;    // 0x0x30
    public bool <FJDOMFFGMDP>k__BackingField;    // 0x0x38
    public bool <DMDFBGKHDAM>k__BackingField;    // 0x0x39
    public bool <FMJAABJKGJM>k__BackingField;    // 0x0x3A
    public bool <GMNJMFPNGOM>k__BackingField;    // 0x0x3B
    public string <PCJAMGDHKNH>k__BackingField;    // 0x0x40
    public DateTime? <HFBLDKLGLFJ>k__BackingField;    // 0x0x48
    public string <IIDJEKPCCAL>k__BackingField;    // 0x0x58
    public float <GGAGAKCPJHL>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// CBHLCFMEKJB
//   RESPONSE GET    api/inventions/v1/details   [Service.Auth]
public class CBHLCFMEKJB
{
    public List<KCIDPBAJDFE> <MOLMBFCPGHJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CCHBILCOGHO
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.Auth]
public class CCHBILCOGHO
{
    public List<long> <HFDKGDMIMCC>k__BackingField;    // 0x0x10
    public MCGMNJBKLCI <FLPBINPMDGA>k__BackingField;    // 0x0x18
    public string <JFKOKFJDIGL>k__BackingField;    // 0x0x20
    public long? <LKDOLAJCILC>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// CFOHKGFJLLN
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class CFOHKGFJLLN
{
    public long <NAKOLCGFACM>k__BackingField;    // 0x0x10
    public int <ILMKLKAMPFJ>k__BackingField;    // 0x0x18
    public long <LKDOLAJCILC>k__BackingField;    // 0x0x20
    public long? <EABBKHIOOFC>k__BackingField;    // 0x0x28
    public long? <JCPOKFJPAPO>k__BackingField;    // 0x0x38
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x48
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x50
    public string <EDPOJIIHEHI>k__BackingField;    // 0x0x58
    public DateTime <KHMPGMCBPMP>k__BackingField;    // 0x0x60
    public DateTime <LJOFHADFLCC>k__BackingField;    // 0x0x68
    public int <LALOOMGMIAK>k__BackingField;    // 0x0x70
    public PIMKECINBIJ <JEMMHGEOHOJ>k__BackingField;    // 0x0x74
    public bool <IOFEHFINIHE>k__BackingField;    // 0x0x78
    public bool <KGLKELANOMO>k__BackingField;    // 0x0x79
    public OIEOKLAIGDD <AHMMMHBEIEA>k__BackingField;    // 0x0x7C
    public OIEOKLAIGDD <FMFCILPBPMA>k__BackingField;    // 0x0x80
    public long? <AJADFOFFODB>k__BackingField;    // 0x0x88
}
...
public class CIDKNLEPCFO
{
    public int <AAAEOBOCOLH>k__BackingField;    // 0x0x10
    public string <EAFLPMOAFLO>k__BackingField;    // 0x0x18
    public List<CJHCKAPIJDA> <CCGGCCKMACI>k__BackingField;    // 0x0x20
    public BLBDGNGPPJG <JHBGNICENAG>k__BackingField;    // 0x0x28
    public string <AHCCCNJMCCJ>k__BackingField;    // 0x0x30
    public DateTime <CBINACFOAGC>k__BackingField;    // 0x0x38
    public DateTime <FHLNEKGOKIA>k__BackingField;    // 0x0x40
    public DateTime <JHGOAEFEBNI>k__BackingField;    // 0x0x48
    public bool? <CLNBBNPPHBO>k__BackingField;    // 0x0x50
}
...
public class CINCPBIOCBP
{
    public Guid <CIKEBILNNNI>k__BackingField;    // 0x0x10
    public long <OLFOGAKIFAL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CJHCKAPIJDA
//   (not directly referenced by a detected call)
public class CJHCKAPIJDA
{
    public int <KGEIKHCLGAP>k__BackingField;    // 0x0x10
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x18
    public string <FMPOEBBIIIH>k__BackingField;    // 0x0x20
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x28
    public string <PCLONKKHJAJ>k__BackingField;    // 0x0x30
    public bool <IKIILOELNIO>k__BackingField;    // 0x0x38
    public int <HNEMGOGLOMF>k__BackingField;    // 0x0x3C
    public JPCCDCPNIKL <AFKHDMNKDBN>k__BackingField;    // 0x0x40
    public FKKEINNKDKG FBGELMGKNMA;    // 0x0x48
    public FKKEINNKDKG CFIEDDKBPHG;    // 0x0x50
    public FKKEINNKDKG FMNNPFCNLIJ;    // 0x0x58
    public JGJHHMEIDLH KLOAEODNGOO;    // 0x0x60
}

// --------------------------------------------------------------------------
// CKFFHAEEGGC
//   RESPONSE PUT    api/roomconsumables   [Service.WWW]
public class CKFFHAEEGGC
{
    public CAGBFFJGFDI <IOIAPDPOCJI>k__BackingField;    // 0x0x10
    public BELKHHNFJEB <ALLODCFDOFD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CLEDFGIEAJE
// base   : PHFNOODDLHF`1<CKGDMCOMGCE>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{mMJHOGEODDM}   [Service.Auth]
public class CLEDFGIEAJE
{
    // (no instance fields in the metadata dump)
}
...
// CMAKGAALAJJ
//   (not directly referenced by a detected call)
public class CMAKGAALAJJ
{
    public long <JLFGKEPBJMG>k__BackingField;    // 0x0x10
    public string <NAJJHDHKJPC>k__BackingField;    // 0x0x18
    public int <GDHGGGAIHKE>k__BackingField;    // 0x0x20
    public int <MHKNCHFHOCI>k__BackingField;    // 0x0x24
    public int <IBJFDJDLDAI>k__BackingField;    // 0x0x28
    public int <CKPNCADEFMN>k__BackingField;    // 0x0x2C
    public int <JEJCPHFPAGA>k__BackingField;    // 0x0x30
    public string <LCAKDFPJJGP>k__BackingField;    // 0x0x38
    public string <JMKHIMJNNFG>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// COFCLFOOEHN
//   REQUEST  POST   api/playerevents/v1/respond   [Service.Auth]
public class COFCLFOOEHN
{
    public long <NAKOLCGFACM>k__BackingField;    // 0x0x10
    public LFEEPJPIGKF <FLPBINPMDGA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CPDNDBJIEMD
//   (not directly referenced by a detected call)
public class CPDNDBJIEMD
{
    public ObscuredLong <FOFBOLJKADG>k__BackingField;    // 0x0x10
    public string <NAJJHDHKJPC>k__BackingField;    // 0x0x38
    public ObscuredInt <ACFELMAKPFG>k__BackingField;    // 0x0x40
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x58
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x60
    public string <EDPOJIIHEHI>k__BackingField;    // 0x0x68
    public byte <BDCFCAJPHCF>k__BackingField;    // 0x0x70
    public int <DIGLAMDMHKF>k__BackingField;    // 0x0x74
    public ILAJBCDCIOB <JEMMHGEOHOJ>k__BackingField;    // 0x0x78
    public bool <ACEBOCDNKIH>k__BackingField;    // 0x0x7C
    public DateTime <MKGAJFPKOMA>k__BackingField;    // 0x0x80
    public DateTime <MLDLOBMACLO>k__BackingField;    // 0x0x88
    public DateTime? <BENLCCLAJDB>k__BackingField;    // 0x0x90
    public long? <LAKEKIBOCBO>k__BackingField;    // 0x0xA0
    public int <MPNFNMJAIFL>k__BackingField;    // 0x0xB0
    public int <KCMDEANKGFH>k__BackingField;    // 0x0xB4
    public int <KPCPEJBONCG>k__BackingField;    // 0x0xB8
    public KAGJPENMELC <LLMMHNJFAOD>k__BackingField;    // 0x0xBC
    public KAGJPENMELC <GHPFCKDINGI>k__BackingField;    // 0x0xC0
    public ObscuredBool <EOHKKOHGLAA>k__BackingField;    // 0x0xC4
    public ObscuredBool <ICOLFPKJJJN>k__BackingField;    // 0x0xD0
    public ObscuredBool <HMACMDFBJHB>k__BackingField;    // 0x0xDC
    public int? <PCPEEGBAJIP>k__BackingField;    // 0x0xE8
    public bool <GGHBBMKHBFP>k__BackingField;    // 0x0xF0
}
...
// DGHPGHNLLMF
//   (not directly referenced by a detected call)
public class DGHPGHNLLMF
{
    public HDDIIGANMBD <EICGMNNAICP>k__BackingField;    // 0x0x10
    public int <PCPEEGBAJIP>k__BackingField;    // 0x0x14
    public BCEBNPCDIKP <PHEONECJKCP>k__BackingField;    // 0x0x18
}
...
public class DKCPDDKDNIL
{
    public Dictionary<Guid, OILEKECKALP> <JMOJKJFKCID>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DLAKKIFOEGF
//   (not directly referenced by a detected call)
public class DLAKKIFOEGF
{
    public int <DHIABBJNNDP>k__BackingField;    // 0x0x10
    public NBCIDNDEIJL <FLPBINPMDGA>k__BackingField;    // 0x0x14
    public List<DGHPGHNLLMF> <MJDKGMOIJAA>k__BackingField;    // 0x0x18
    public List<DGHPGHNLLMF> <NGFCMIFOPLL>k__BackingField;    // 0x0x20
    public bool <ANIBEHPMAAB>k__BackingField;    // 0x0x28
    public DateTime? <LICDDPBKNGF>k__BackingField;    // 0x0x30
    public DateTime? <ADDCIKMAKBJ>k__BackingField;    // 0x0x40
    public DateTime? <HEHNEOKIIPJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// DMHLMICMEHN
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.Auth]
public class DMHLMICMEHN
{
    public List<CFOHKGFJLLN> <MBEFNNDPAEG>k__BackingField;    // 0x0x10
    public string <CLIOLCFACHA>k__BackingField;    // 0x0x18
}
...
public class DPIJNJPBHNB
{
    public MDBLKJBLAGM <AEOGGFBFIBD>k__BackingField;    // 0x0x10
    public long <NAKOLCGFACM>k__BackingField;    // 0x0x18
    public string <OHOIOEEPOBK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ECPDMHIDLJL
//   RESPONSE GET    api/playerevents/v1/all   [Service.Auth]
//   RESPONSE GET    api/playerevents/v1/all/{bLJINDOMGGF}   [Service.Auth]
public class ECPDMHIDLJL
{
    public List<CFOHKGFJLLN> <OICBPPGNPMC>k__BackingField;    // 0x0x10
    public List<OBKILHCEOGL> <FBJFCGINEAC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EDNMLOAGCBM
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.WWW]
public class EDNMLOAGCBM
{
    public Guid <DLFPGKIHMHO>k__BackingField;    // 0x0x10
    public int <NFIFCOJHMLI>k__BackingField;    // 0x0x20
    public long <MIICFLMOJDL>k__BackingField;    // 0x0x28
    public Guid <CIKEBILNNNI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// EFAIIPLAIFB
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.WWW]
public class EFAIIPLAIFB
{
    public List<string> <OBDHKNGAEJK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EGKCOGEPNKM
//   (not directly referenced by a detected call)
public class EGKCOGEPNKM
{
    public int <OOEFPHAFOBB>k__BackingField;    // 0x0x10
    public string <KMMCLCODGFI>k__BackingField;    // 0x0x18
    public string <PCLONKKHJAJ>k__BackingField;    // 0x0x20
    public string <BJDEKBNCDDJ>k__BackingField;    // 0x0x28
    public string <PADBCLGOFDJ>k__BackingField;    // 0x0x30
    public string <HKCKKFEKIHA>k__BackingField;    // 0x0x38
    public PDMDOJEEFDL? <AKBDDGIJKPD>k__BackingField;    // 0x0x40
    public string <CFFJFNFHFEP>k__BackingField;    // 0x0x48
    public string <PFFCFHDKAHG>k__BackingField;    // 0x0x50
    public bool <MKIMEBOCAGK>k__BackingField;    // 0x0x58
    public bool <NKLKPHBCIBJ>k__BackingField;    // 0x0x59
    public bool <BDINAFFDEIJ>k__BackingField;    // 0x0x5A
    public DGLCIAHMIGE <DFMJNJIDIDN>k__BackingField;    // 0x0x5C
    public HDDIIGANMBD <EICGMNNAICP>k__BackingField;    // 0x0x60
    public int <FJADCJOFEAL>k__BackingField;    // 0x0x64
    public LIBPJNOCLHA <JFAKDMPLONK>k__BackingField;    // 0x0x68
    public DNPCNPILLPP <OCDNCDDBFPF>k__BackingField;    // 0x0x6C
    public int? <KANHBAKLMEN>k__BackingField;    // 0x0x70
    public string <DKDGGIBAION>k__BackingField;    // 0x0x78
    public int? <JLFNEEPKNCL>k__BackingField;    // 0x0x80
    public int? <NFABLCPPHKO>k__BackingField;    // 0x0x88
}
...
public class EPDHLLMPCII : GMFCGMBJMCA
{
    public string <OADICLPNAEG>k__BackingField;    // 0x0x30
    public List<LGODJGKEGHG> NHNELMFOAEO;    // 0x0x38
    public int <IPHEMIJKALL>k__BackingField;    // 0x0x40
}
...
// FCEPPOKIIBA
//   (not directly referenced by a detected call)
public class FCEPPOKIIBA
{
    public Guid <EGBPBJGAFOE>k__BackingField;    // 0x0x10
    public Guid <BACFOCLOKJG>k__BackingField;    // 0x0x20
    public DateTime <CBINACFOAGC>k__BackingField;    // 0x0x30
    public List<EGKCOGEPNKM> <IEEGJEBKPBP>k__BackingField;    // 0x0x38
}
...
public class FELAIDIKBHH
{
    public FGJPBEPDLLN <IOIAPDPOCJI>k__BackingField;    // 0x0x10
    public PKJNLFIHNIM <FNFCHCFAHKP>k__BackingField;    // 0x0x18
}
...
public class FFFCHMHIGOE
{
    public AIHMNOJLHFO <IOIAPDPOCJI>k__BackingField;    // 0x0x10
    public CPDNDBJIEMD <CPLMBPNKEMP>k__BackingField;    // 0x0x18
    public CMAKGAALAJJ <CMLNAKODHCL>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{eELHPMHMGKD}   [Service.WWW]
public enum FGJPBEPDLLN
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class FJCPLELELDP
{
    public int? <ENNIPFAJLLK>k__BackingField;    // 0x0x10
    public string <OIHFGOBIGDK>k__BackingField;    // 0x0x18
    public string <NPLNFLPIDCP>k__BackingField;    // 0x0x20
}
...
public class GCCFHCEPCOA
{
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x10
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x18
    public int? <PCPEEGBAJIP>k__BackingField;    // 0x0x20
    public ILAJBCDCIOB? <JEMMHGEOHOJ>k__BackingField;    // 0x0x28
}
...
public class GMKDJEFNMOC
{
    public JNLHGNKHHKN <CNCHPICBGHF>k__BackingField;    // 0x0x10
    public OMEOMKILJMA <BIAAOGCBMLG>k__BackingField;    // 0x0x18
    public int <GOPMGKNMBKJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GPLMBBDPENP
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.Auth]
public class GPLMBBDPENP
{
    public string <HADODLDGLOD>k__BackingField;    // 0x0x10
    public string <OMLEOFNOGLF>k__BackingField;    // 0x0x18
    public string <DLBACJEOOMD>k__BackingField;    // 0x0x20
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x28
    public string <OIHFGOBIGDK>k__BackingField;    // 0x0x30
    public NHNJJOPFLFL <IOIAPDPOCJI>k__BackingField;    // 0x0x38
    public List<string> <CCHGLBJDAKA>k__BackingField;    // 0x0x40
    public List<string> <MOLMBFCPGHJ>k__BackingField;    // 0x0x48
    public string <KANKMBJJICH>k__BackingField;    // 0x0x50
    public List<LPHCNDINNEP> <EHFJKPCIKCJ>k__BackingField;    // 0x0x58
}
...
// HJJNANNEAMH
//   (not directly referenced by a detected call)
public class HJJNANNEAMH
{
    public NLBMMCPJPFE LGNGOHGHDFN;    // 0x0x10
    public int OJCFFIBKBLH;    // 0x0x14
}

// --------------------------------------------------------------------------
// HLIIKAGGECL
//   RESPONSE GET    api/config/v1/azurespeech   [Service.Auth]
public class HLIIKAGGECL
{
    public bool <PAMCLNLBLID>k__BackingField;    // 0x0x10
    public string <OMLEOFNOGLF>k__BackingField;    // 0x0x18
    public string <ECKHILOOCFP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IADGCEDCKGE
//   REQUEST  ?      api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItemDescs   [Service.Notifications]
public class IADGCEDCKGE
{
    public List<string> <AFKCNKLICCM>k__BackingField;    // 0x0x10
    public byte <JHAHNLOEMBL>k__BackingField;    // 0x0x18
    public int <BJCMNCBNKCE>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// IBBGLGCAIOA
//   (not directly referenced by a detected call)
public class IBBGLGCAIOA
{
    public int <ENFLHODEIKM>k__BackingField;    // 0x0x10
}
...
public class IBHCJIMOHHA
{
    public int <CNCDOEDOKME>k__BackingField;    // 0x0x10
    public int <DMPCBAHGNBC>k__BackingField;    // 0x0x14
    public float <BNNOLIDJICO>k__BackingField;    // 0x0x18
    public float <NDIOPPHBFFC>k__BackingField;    // 0x0x1C
    public bool <CCFPGBLKDHF>k__BackingField;    // 0x0x20
    public bool <KCHEALHGGBK>k__BackingField;    // 0x0x21
    public bool <HMDMGNILILI>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// ICNHMDLFOGC
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.Auth]
public class ICNHMDLFOGC
{
    public int <LDDLNNHLLAA>k__BackingField;    // 0x0x10
    public int? <NJNEIOBNGJI>k__BackingField;    // 0x0x14
    public string <LMBNHJAJHAB>k__BackingField;    // 0x0x20
    public string <KFKBNJCKOLO>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// IDOEBDCBLJH
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.Auth]
public class IDOEBDCBLJH
{
    public List<LLBFMDJNJNL> <BGFCDKOGACD>k__BackingField;    // 0x0x10
    public OJOKBBGKCJD <FDGNPGGBBHI>k__BackingField;    // 0x0x18
}
...
public class IGBBMFIAHJJ : HCDAEPKAGBC
{
    public CGJIPBJBKEP? <IJALCONBJDO>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <KHBFLDDACFP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IGEKPEJHNBO
//   (not directly referenced by a detected call)
public class IGEKPEJHNBO
{
    public float <LKNMGBECAEC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IHKLIHONGJH
//   (not directly referenced by a detected call)
public class IHKLIHONGJH
{
    public int <EIADBHBAMFH>k__BackingField;    // 0x0x10
}
...
public class IKNHEMBLCGN
{
    public int <GIOJLGHHHAI>k__BackingField;    // 0x0x10
    public int <PIIOBJJGNMN>k__BackingField;    // 0x0x14
    public float <BMCNHCNMBLG>k__BackingField;    // 0x0x18
    public int <IJJOOIBIMAG>k__BackingField;    // 0x0x1C
    public int <FFMJPFMGKNM>k__BackingField;    // 0x0x20
    public int <IGOMJICJINP>k__BackingField;    // 0x0x24
    public int <OLMLGOJCOGG>k__BackingField;    // 0x0x28
    public string <EEINKDIGHMM>k__BackingField;    // 0x0x30
    public string <ADOKKHAAPJI>k__BackingField;    // 0x0x38
}
...
public class ILPKEBLHGKB
{
    public FPOMMFFPOCH <FDGNPGGBBHI>k__BackingField;    // 0x0x10
    public List<string> <MOLMBFCPGHJ>k__BackingField;    // 0x0x18
}
...
// JBLCFDKMIAF
//   (not directly referenced by a detected call)
public class JBLCFDKMIAF
{
    public Guid <NGNOGNHADCF>k__BackingField;    // 0x0x10
    public long <LKDOLAJCILC>k__BackingField;    // 0x0x20
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x28
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x30
    public string <EDPOJIIHEHI>k__BackingField;    // 0x0x38
    public long <PCPEEGBAJIP>k__BackingField;    // 0x0x40
    public Guid? <MIHFFLLAEKA>k__BackingField;    // 0x0x48
    public DateTime <MKGAJFPKOMA>k__BackingField;    // 0x0x60
    public int <GNPBDOEGGDN>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// JBMNGIGABBL
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.WWW]
public class JBMNGIGABBL
{
    public long <HHJCEANDACH>k__BackingField;    // 0x0x10
    public int <AFKEPIKPMPH>k__BackingField;    // 0x0x18
}
...
public class JBNCLEIOMNI
{
    public OJOKBBGKCJD <FDGNPGGBBHI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JCODMNCBGLL
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.WWW]
public class JCODMNCBGLL
{
    public Guid? <NGNOGNHADCF>k__BackingField;    // 0x0x10
    public long? <LKDOLAJCILC>k__BackingField;    // 0x0x28
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x38
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x40
    public string <EDPOJIIHEHI>k__BackingField;    // 0x0x48
    public OMEOMKILJMA <AJIMJLNGEOG>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// JDNPDJDEPDK
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItems/v2   [Service.Notifications]
public class JDNPDJDEPDK
{
    public byte <JHAHNLOEMBL>k__BackingField;    // 0x0x10
    public int <BJCMNCBNKCE>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// JKJNBKMBNKD
//   RESPONSE GET    api/config/v2   [Service.Auth]
public class JKJNBKMBNKD
{
    public Dictionary<int, int> <PNICOIAPBNB>k__BackingField;    // 0x0x10
    public List<CODLMENGEPB> <BJPFGBEJBBI>k__BackingField;    // 0x0x18
    public HJJNANNEAMH[][] <JEKAAEHGMCI>k__BackingField;    // 0x0x20
    public IBBGLGCAIOA <OFGMDIJNLDH>k__BackingField;    // 0x0x28
    public OCBDACODBMJ <AJKKGEIAGAH>k__BackingField;    // 0x0x30
    public IHKLIHONGJH <DHHLOOOBLDL>k__BackingField;    // 0x0x38
    public OOPAEEAHGDA <JFKEOPIDENG>k__BackingField;    // 0x0x40
    public IGEKPEJHNBO <JMAGKBAEIIC>k__BackingField;    // 0x0x48
    public string <OHPPDLKICOI>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// JNLHGNKHHKN
//   REQUEST  PUT    api/roomconsumables   [Service.WWW]
public class JNLHGNKHHKN
{
    public Guid? <FNHMOIFAKCN>k__BackingField;    // 0x0x10
    public Guid <IJPNIEHABDK>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// JPCCDCPNIKL
//   (not directly referenced by a detected call)
public class JPCCDCPNIKL
{
    // (no instance fields in the metadata dump)
}
...
public class KBFPPKAPJID
{
    public int EANDIGFADLJ;    // 0x0x10
    public long KCBDNPNBEOF;    // 0x0x18
}

// --------------------------------------------------------------------------
// KCIDPBAJDFE
//   (not directly referenced by a detected call)
public class KCIDPBAJDFE
{
    public string <NGNCHANLMPP>k__BackingField;    // 0x0x10
    public NOEHCLONNGN <FLPBINPMDGA>k__BackingField;    // 0x0x18
}
...
public class KKGDAKPLACB
{
    public int <AAAEOBOCOLH>k__BackingField;    // 0x0x10
    public int <KGEIKHCLGAP>k__BackingField;    // 0x0x14
    public string <FMPOEBBIIIH>k__BackingField;    // 0x0x18
    public bool <IKIILOELNIO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KNCJAGPLKGB
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class KNCJAGPLKGB
{
    public Dictionary<Guid, CKFFHAEEGGC> <KLNGFKGINHO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KNLFMKPOHIM
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.WWW]
public class KNLFMKPOHIM
{
    public List<LOKKJFEAGDE> <IPMABPONDPF>k__BackingField;    // 0x0x10
    public string <CLIOLCFACHA>k__BackingField;    // 0x0x18
}
...
public class LCDPDANEJBM
{
    public EPFAJHBPFOP <AEOGGFBFIBD>k__BackingField;    // 0x0x10
    public string <OHOIOEEPOBK>k__BackingField;    // 0x0x18
    public int? <PFELABAFKLM>k__BackingField;    // 0x0x20
}
...
// base   : DLAKKIFOEGF
//   (not directly referenced by a detected call)
public class LGODJGKEGHG : DLAKKIFOEGF
{
    public EGKCOGEPNKM <HFCINHHNMFP>k__BackingField;    // 0x0x60
}
...
// LLBFMDJNJNL
//   (not directly referenced by a detected call)
public class LLBFMDJNJNL
{
    public int <DPHDJBMJKEJ>k__BackingField;    // 0x0x10
    public OJOKBBGKCJD <FDGNPGGBBHI>k__BackingField;    // 0x0x14
}
...
// base   : GMFCGMBJMCA
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/season/{dDOAKFHMIDB}   [Service.WWW]
public class LLNHKMKFAJP : GMFCGMBJMCA
{
    public int <HPJEOJNOHJE>k__BackingField;    // 0x0x30
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x38
    public DateTime <CBINACFOAGC>k__BackingField;    // 0x0x40
    public DateTime <FHLNEKGOKIA>k__BackingField;    // 0x0x48
    public HDDIIGANMBD <EICGMNNAICP>k__BackingField;    // 0x0x50
    public DLAKKIFOEGF <ADNILKFLBLL>k__BackingField;    // 0x0x58
    public List<MABPHKNMEFJ> <OJOJLHAEPGE>k__BackingField;    // 0x0x60
    public BJMDNGDJEAM <BJOHHANLFEL>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// LNFBPCJJMMF
//   (not directly referenced by a detected call)
public class LNFBPCJJMMF
{
    public long <OHBDBOFJNJL>k__BackingField;    // 0x0x10
    public long <NAKOLCGFACM>k__BackingField;    // 0x0x18
    public int <MABGABJKDGE>k__BackingField;    // 0x0x20
    public DateTime <MLDLOBMACLO>k__BackingField;    // 0x0x28
    public LFEEPJPIGKF <FLPBINPMDGA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// LOKKJFEAGDE
//   (not directly referenced by a detected call)
public class LOKKJFEAGDE
{
    public int <GMLAMCNOEII>k__BackingField;    // 0x0x10
    public DateTime <MLDLOBMACLO>k__BackingField;    // 0x0x18
    public DateTime? <AFOKOLEHFGP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LPHCNDINNEP
//   (not directly referenced by a detected call)
public class LPHCNDINNEP
{
    public DateTime <MLDLOBMACLO>k__BackingField;    // 0x0x10
    public string <GNOGMJNCGBB>k__BackingField;    // 0x0x18
}
...
// base   : DLAKKIFOEGF
//   (not directly referenced by a detected call)
public class MABPHKNMEFJ : DLAKKIFOEGF
{
    public int <BCJFFLBPJIA>k__BackingField;    // 0x0x60
    public List<MNGIKJJOKEN> <JAMPMCKLKFB>k__BackingField;    // 0x0x68
    public List<MNGIKJJOKEN> <JBHKNLJDIGA>k__BackingField;    // 0x0x70
    public List<MNGIKJJOKEN> <AMDGNKGKDMG>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// MANOFNNBHEF
// base   : PHFNOODDLHF`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class MANOFNNBHEF
{
    // (no instance fields in the metadata dump)
}
...
public class MCBALFKHOKN
{
    public int <AFKEPIKPMPH>k__BackingField;    // 0x0x10
    public Guid <DLFPGKIHMHO>k__BackingField;    // 0x0x14
    public long <PMKADHEHNGH>k__BackingField;    // 0x0x28
    public DateTime <MKGAJFPKOMA>k__BackingField;    // 0x0x30
}
...
//   RESPONSE DELETE api/keepsakes/{pCOKCDLEHCJ}   [Service.Auth]
...
public class MCBLONMDLHH
{
    public bool <LFGLGFDFDKP>k__BackingField;    // 0x0x10
    public string <EJHKEFDKKLL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MIKFLGKLBAD
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.WWW]
public class MIKFLGKLBAD
{
    public long <HHJCEANDACH>k__BackingField;    // 0x0x10
    public int <AFKEPIKPMPH>k__BackingField;    // 0x0x18
}
...
public class MKDKKGJKBFE : HCDAEPKAGBC
{
    public PHHIAFHBAJP? <IJALCONBJDO>k__BackingField;    // 0x0x18
    public MCBALFKHOKN <GKDDIDBLMHM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MLNIJKEAGHO
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.WWW]
public class MLNIJKEAGHO
{
    public int <MNEDBCMBNLO>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/progressionEvents/collect/{nOJNGOOJGFG}/{cLFJCJFCCLP}   [Service.Auth]
public class MNFLCGKGFIG
{
    public long? <HADODLDGLOD>k__BackingField;    // 0x0x10
    public int <MABGABJKDGE>k__BackingField;    // 0x0x20
    public int? <OPFCIAAOMNI>k__BackingField;    // 0x0x24
    public string <PADBCLGOFDJ>k__BackingField;    // 0x0x30
    public PDMDOJEEFDL? <AKBDDGIJKPD>k__BackingField;    // 0x0x38
    public string <HKCKKFEKIHA>k__BackingField;    // 0x0x40
    public string <CFFJFNFHFEP>k__BackingField;    // 0x0x48
    public string <PFFCFHDKAHG>k__BackingField;    // 0x0x50
    public HDDIIGANMBD <EICGMNNAICP>k__BackingField;    // 0x0x58
    public int <FJADCJOFEAL>k__BackingField;    // 0x0x5C
    public int <FMPMDJAPHKP>k__BackingField;    // 0x0x60
    public DNPCNPILLPP <LAKFBPOGLBE>k__BackingField;    // 0x0x64
    public DGLCIAHMIGE <OGBBILEMAMA>k__BackingField;    // 0x0x68
    public string <PKKEILBJDOJ>k__BackingField;    // 0x0x70
    public MMEENBMCJPD <KNPMIKPDEEB>k__BackingField;    // 0x0x78
    public IIBNAMGNKIL <KGPIEANGGCG>k__BackingField;    // 0x0x7C
    public PHJJEJHPHNE? <DEIKCCJMMBO>k__BackingField;    // 0x0x80
    public bool <OLHBOMBPHMA>k__BackingField;    // 0x0x88
    public bool <FPCHJLPBBAO>k__BackingField;    // 0x0x89
    public string <JHAFMLNDJLJ>k__BackingField;    // 0x0x90
    public bool <LLIAAMHIOBP>k__BackingField;    // 0x0x98
    public bool BBOBOPFGDGF;    // 0x0x99
}

// --------------------------------------------------------------------------
// MNGIKJJOKEN
//   (not directly referenced by a detected call)
public class MNGIKJJOKEN
{
    public bool <FNEHCANHBNM>k__BackingField;    // 0x0x10
    public EGKCOGEPNKM <HFCINHHNMFP>k__BackingField;    // 0x0x18
    public float <FLOEBAKOHDB>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{jPOJNNNNBCO}   [Service.WWW]
public class NBFPAAAHILD
{
    public CAGBFFJGFDI <IOIAPDPOCJI>k__BackingField;    // 0x0x10
    public JBLCFDKMIAF <LFNMIMFIJOK>k__BackingField;    // 0x0x18
}
...
// OBKILHCEOGL
//   (not directly referenced by a detected call)
public class OBKILHCEOGL
{
    public CFOHKGFJLLN <BKDLPDKIOGL>k__BackingField;    // 0x0x10
    public LNFBPCJJMMF <NONKHJIKPFD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OCBDACODBMJ
//   (not directly referenced by a detected call)
public class OCBDACODBMJ
{
    public float <CIODABGACAI>k__BackingField;    // 0x0x10
    public float <HCMLHDNJFOL>k__BackingField;    // 0x0x14
    public float <FOANGMNELPB>k__BackingField;    // 0x0x18
    public float <FEMHBNAPIIE>k__BackingField;    // 0x0x1C
    public float <NAJBJKKEJME>k__BackingField;    // 0x0x20
    public float <EJBHLJHBGAN>k__BackingField;    // 0x0x24
    public float <NHOPIKLIFKI>k__BackingField;    // 0x0x28
    public float <OGOFEBOAOFG>k__BackingField;    // 0x0x2C
}
...
public class OFCGOAPEHDA
{
    public Dictionary<string, PMPFJEDJFGO> <GHHNFDGKDDJ>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{nOJNGOOJGFG}   [Service.Auth]
...
public class OHKIGFAMCJK
{
    public PNIPPKHPNMF <BKDLPDKIOGL>k__BackingField;    // 0x0x10
    public OJOKBBGKCJD <FDGNPGGBBHI>k__BackingField;    // 0x0x18
    public ILPKEBLHGKB <BIPLICBPGFC>k__BackingField;    // 0x0x20
}
...
// OILEKECKALP
//   (not directly referenced by a detected call)
public class OILEKECKALP
{
    public int <GOPMGKNMBKJ>k__BackingField;    // 0x0x10
    public JNLHGNKHHKN <CNCHPICBGHF>k__BackingField;    // 0x0x18
}
...
// OMEOMKILJMA
//   (not directly referenced by a detected call)
public class OMEOMKILJMA
{
    public long <PCPEEGBAJIP>k__BackingField;    // 0x0x10
    public Guid? <DLFPGKIHMHO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OOPAEEAHGDA
//   (not directly referenced by a detected call)
public class OOPAEEAHGDA
{
    public int <MGDNDOIEEDK>k__BackingField;    // 0x0x10
}
...
public class PDNIBDBFKII
{
    public string <IBJLBCDEOFK>k__BackingField;    // 0x0x10
    public string <ABKFBGOGMMH>k__BackingField;    // 0x0x18
    public string <KMMCLCODGFI>k__BackingField;    // 0x0x20
    public string <PCLONKKHJAJ>k__BackingField;    // 0x0x28
    public DGLCIAHMIGE <DFMJNJIDIDN>k__BackingField;    // 0x0x30
    public bool BPKGIGKCJOA;    // 0x0x34
    public bool <HMDMGNILILI>k__BackingField;    // 0x0x35
}

// --------------------------------------------------------------------------
// PFAADPLEBFA
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.WWW]
public class PFAADPLEBFA
{
    public List<int> <DJMGLACBNDM>k__BackingField;    // 0x0x10
    public string <CLIOLCFACHA>k__BackingField;    // 0x0x18
}
...
// PKJNLFIHNIM
//   (not directly referenced by a detected call)
public class PKJNLFIHNIM
{
    public long <HHJCEANDACH>k__BackingField;    // 0x0x10
    public Guid <NAJJHDHKJPC>k__BackingField;    // 0x0x18
    public long <LKDOLAJCILC>k__BackingField;    // 0x0x28
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x30
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x38
    public int <PCPEEGBAJIP>k__BackingField;    // 0x0x40
    public Guid? <MIHFFLLAEKA>k__BackingField;    // 0x0x44
    public DateTime <MLDLOBMACLO>k__BackingField;    // 0x0x58
    public string <EDPOJIIHEHI>k__BackingField;    // 0x0x60
    public KFAIOEIDCDN <FLPBINPMDGA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// PMPFJEDJFGO
//   (not directly referenced by a detected call)
public class PMPFJEDJFGO
{
    public long <GFCMDLBJOAO>k__BackingField;    // 0x0x10
    public Guid <LNJOOIMFNNK>k__BackingField;    // 0x0x18
    public Guid <APPJBOILBKC>k__BackingField;    // 0x0x28
    public DateTime <MLDLOBMACLO>k__BackingField;    // 0x0x38
    public string <GIKECJEEIGP>k__BackingField;    // 0x0x40
    public string <CCOIFLBLGAI>k__BackingField;    // 0x0x48
    public string <JIIHONIEEJB>k__BackingField;    // 0x0x50
    public string <NPEHPOFABAI>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// PNHHBKIDADK
//   RESPONSE GET    api/config/v1/amplitude   [Service.Auth]
public class PNHHBKIDADK
{
    public string <JOMMKALPJKK>k__BackingField;    // 0x0x10
    public string <NBMMBGBBEIK>k__BackingField;    // 0x0x18
    public bool <MMHLFFMPKMJ>k__BackingField;    // 0x0x20
    public string <FOBOOLENPHF>k__BackingField;    // 0x0x28
}
...
// base   : CFOHKGFJLLN
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class PNIPPKHPNMF : CFOHKGFJLLN
{
    public List<KCIDPBAJDFE> <MOLMBFCPGHJ>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// PPOMOOJFGCL
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Matchmaking]
public class PPOMOOJFGCL
{
    public Guid <IKEMGHBGFIH>k__BackingField;    // 0x0x10
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x20
    public string <EDPOJIIHEHI>k__BackingField;    // 0x0x28
    public DateTime <CBINACFOAGC>k__BackingField;    // 0x0x30
    public DateTime? <BMLOBKFFEII>k__BackingField;    // 0x0x38
    public List<FCEPPOKIIBA> <ONGGDEDDJAL>k__BackingField;    // 0x0x48
}
...
public class AddKeepsakeInstanceRequest
{
    public long <LKDOLAJCILC>k__BackingField;    // 0x0x10
    public long? <EABBKHIOOFC>k__BackingField;    // 0x0x18
    public HFMMDPIDLMH <EOCGFDFPJKO>k__BackingField;    // 0x0x28
}
...
{
    public JOKCFKNGNGE <FDGNPGGBBHI>k__BackingField;    // 0x0x10
    public string <DJFJNCMGDMA>k__BackingField;    // 0x0x18
    public string <HCEMKEDJINJ>k__BackingField;    // 0x0x20
    public string <JNOJBJJAJFF>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public HDDIIGANMBD <CurrencyType>k__BackingField;    // 0x0x18
    public PHJJEJHPHNE <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <NAKOLCGFACM>k__BackingField;    // 0x0x10
    public long? <IAEBNICLAMO>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public EBFKKENAGML FilterType;    // 0x0x20
...
{
    public HFMMDPIDLMH <GOFBGBLNJIH>k__BackingField;    // 0x0x10
    public string <DIDDDDECNEB>k__BackingField;    // 0x0x18
    public int <FAJIHHIJDGI>k__BackingField;    // 0x0x20
    public int <FNNOEMPMAGF>k__BackingField;    // 0x0x24
    public string <LEKDHGEPOMC>k__BackingField;    // 0x0x28
    public string <CCKEHJKHLNE>k__BackingField;    // 0x0x30
}
...
{
    public int <AFKEPIKPMPH>k__BackingField;    // 0x0x10
    public Guid <NAHHHNKIMAB>k__BackingField;    // 0x0x14
    public DateTime <JABOPLJHPIL>k__BackingField;    // 0x0x28
}
...
{
    public bool <DDDPDOMFEHF>k__BackingField;    // 0x0x10
    public int <CKJMGDBAMGC>k__BackingField;    // 0x0x14
    public bool <FAPEJAHHMAH>k__BackingField;    // 0x0x18
}
...
{
    public Guid <NAHHHNKIMAB>k__BackingField;    // 0x0x10
    public HFMMDPIDLMH <IKEPBGLDEJB>k__BackingField;    // 0x0x20
    public int <LHLKEIPOMHE>k__BackingField;    // 0x0x24
    public long <LKDOLAJCILC>k__BackingField;    // 0x0x28
    public long? <EABBKHIOOFC>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{bNOHLKMFIDN}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <NNFNPFCJAJB>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <PNMLOBMPMLG>k__BackingField;    // 0x0x18
}
...
{
    public long <NMGKKLGLELE>k__BackingField;    // 0x0x10
    public long <LKDOLAJCILC>k__BackingField;    // 0x0x18
    public long <MKPDFOHBCBB>k__BackingField;    // 0x0x20
    public HKIEBPHNJDH <FLPBINPMDGA>k__BackingField;    // 0x0x28
    public int <PJGHLOFMIGP>k__BackingField;    // 0x0x2C
}
...
{
    public long <LKDOLAJCILC>k__BackingField;    // 0x0x10
    public List<Guid> <MKGIKIFEOMP>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <NNFNPFCJAJB>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <PNMLOBMPMLG>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <JPEDEBGFCKF>k__BackingField;    // 0x0x20
}
...
{
    public long <MKPDFOHBCBB>k__BackingField;    // 0x0x10
    public long <EDMGDBLPODG>k__BackingField;    // 0x0x18
    public int? <EHGENJHFFCP>k__BackingField;    // 0x0x20
    public int? <AMMOCDKLDNP>k__BackingField;    // 0x0x28
    public long? <BGNGHOIOOKL>k__BackingField;    // 0x0x30
    public long <JKNBBFHEOON>k__BackingField;    // 0x0x40
    public long <MDMLNFMFCKH>k__BackingField;    // 0x0x48
    public int <HOLCEJNMJBI>k__BackingField;    // 0x0x50
    public HKIEBPHNJDH <DCCNKDOFEEK>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <LKFCEGKFFKM>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public DNPCNPILLPP <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public LAKGBFEFJJG creatorAccountRole;    // 0x0x58
}
...
{
    public AGJFHFNHIAJ <GHLNGDAMKGJ>k__BackingField;    // 0x0x10
    public HDEEPJLHGEH <ICKAMDALMAC>k__BackingField;    // 0x0x14
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x18
    public string <IOHICKHNCOC>k__BackingField;    // 0x0x20
    public bool <DHAFADPBCBE>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<AGJFHFNHIAJ> <PHODDNCGMNH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{nOJNGOOJGFG}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <EDMGDBLPODG>k__BackingField;    // 0x0x10
    public string <JMHIOLGDCJI>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <AMDGNKGKDMG>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <NAFBIMNBMAC>k__BackingField;    // 0x0x28
    public DateTime <KHMPGMCBPMP>k__BackingField;    // 0x0x30
    public DateTime <LJOFHADFLCC>k__BackingField;    // 0x0x38
    public DateTime <NLNKDKONJAP>k__BackingField;    // 0x0x40
    public bool <CFLIHADFCOM>k__BackingField;    // 0x0x48
    public int <ADEFGDBOPKO>k__BackingField;    // 0x0x4C
    public float <MDPNKDENOOF>k__BackingField;    // 0x0x50
    public Guid? <PCAHHIIKCIL>k__BackingField;    // 0x0x54
    public string <IFKPGPAIIGC>k__BackingField;    // 0x0x68
    public string <LDIEKNPCIBI>k__BackingField;    // 0x0x70
    public string <EAMONPLDLIC>k__BackingField;    // 0x0x78
    public string <DBBDMDHHKIG>k__BackingField;    // 0x0x80
}
...
{
    public Guid <HDDOPFECOKC>k__BackingField;    // 0x0x10
    public int <EAKJDOOLPCF>k__BackingField;    // 0x0x20
    public int <EEPLNAOCAIG>k__BackingField;    // 0x0x24
    public int <AAHPOBPEPMK>k__BackingField;    // 0x0x28
    public long <PPMCLBAGAJN>k__BackingField;    // 0x0x30
    public long <LBNOOFPOEED>k__BackingField;    // 0x0x38
}
...
{
    public int <AFKEPIKPMPH>k__BackingField;    // 0x0x10
    public int <FMPMDJAPHKP>k__BackingField;    // 0x0x14
    public int <JFPNJHFCJKM>k__BackingField;    // 0x0x18
    public int <LAPICMECDFP>k__BackingField;    // 0x0x1C
    public int <IEHABGDKADC>k__BackingField;    // 0x0x20
    public DateTime? <KKCHKLHFGEP>k__BackingField;    // 0x0x28
}
...
{
    public long <JGKACFGGLPM>k__BackingField;    // 0x0x10
    public int <OOEFPHAFOBB>k__BackingField;    // 0x0x18
    public string <EDPOJIIHEHI>k__BackingField;    // 0x0x20
    public int <FMPMDJAPHKP>k__BackingField;    // 0x0x28
    public int <OHIBIAHHHEC>k__BackingField;    // 0x0x2C
    public bool <MKDCDBNLBIP>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public FHKAEDPKKIO ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool OOEIBCBDJHB;    // 0x0x28
}
...
{
    public MMEENBMCJPD GBNPFOGGBGJ;  // wrapper
...
{
    public PKNMNGHACJJ ADAMDPHPFAA;  // wrapper
    public int? OFKKLJHCBGC;  // wrapper
...
{
    public MDBLKJBLAGM PLDDBGFMFFI;  // wrapper
    public float? EANMBKBIHNM;  // wrapper
    public bool? LCMGEIBCMCH;  // wrapper
...
{
    public List<DEPKPIDHOHK> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public DNPCNPILLPP PEHINKLIDNC;  // wrapper
    public DNPCNPILLPP? HLJJDNNMHCD;  // wrapper
...
{
    public ChatMessage DCKDMGKGDFN;  // wrapper
    public IPADAMHADNE PLDDBGFMFFI;  // wrapper
...
{
    public ILAJBCDCIOB NCGDBCOMJMA;  // wrapper
    public LKGKDGKHGOG JBEJDIDGHHP;  // wrapper
    public IBMNJNPMLGK CKMJBODIBOA;  // wrapper
    public IBMNJNPMLGK KPILFPGPDGD;  // wrapper
...
{
    public IIEDJBBHMIP NNMGJHPDLOG;  // wrapper
    public DNPCNPILLPP? JBNPBGKFDHP;  // wrapper
...
{
    public LEMBGJLNCBL NIAPMPLJOPJ;  // wrapper
...
{
    public CPDNDBJIEMD inventionId;  // wrapper
}
...
// api/keepsakes/{pCOKCDLEHCJ}/collect  [Auth POST]
public class KeepsakesPCOKCDLEHCJCollectRequest
{
    public Guid PCOKCDLEHCJ;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public MCGMNJBKLCI AKKEKGOPELO;  // wrapper
    public long? MAONELICPNP;  // wrapper
...
{
    public Guid ICPJPGMBPLI;  // wrapper
...
{
    public Guid CCLKDOKPPOI;  // wrapper
    public object Price;  // candidate
...
{
    public Guid CCLKDOKPPOI;  // wrapper
    public long? IPCKLLCIDPM;  // wrapper
    public byte? FAHALEOOBNP;  // wrapper
    public int? IKNGOAKEJAP;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid ICPJPGMBPLI;  // wrapper
    public long? JCPIKEPCIAO;  // wrapper
    public long? NGGIHIBDHBL;  // wrapper
    public int? LJMBCOIKEFG;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> BOJHHCEEAKE;  // wrapper
...
{
    public KFAIOEIDCDN ADAMDPHPFAA;  // wrapper
    public Guid? JONHGLELNIE;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public MDBLKJBLAGM PLDDBGFMFFI;  // wrapper
    public long? HFEJCPMNDNN;  // wrapper
    public Guid? FBGGMLLFPNA;  // wrapper
    public int? MKMGKCEIGOA;  // wrapper
...
{
    public Guid IBPANEENDJF;  // wrapper
...
{
    public Guid OAOCEIADLBL;  // wrapper
...
{
    public NHNJJOPFLFL MGGBOFBAAGB;  // wrapper
}
