...
public class AAAPDPGBMEF
{
    public int <FMNEGGMFJJK>k__BackingField;    // 0x0x10
    public string <MLLECFGGCBK>k__BackingField;    // 0x0x18
    public List<KMNEDCKDNGJ> <BCNCKBCAJHJ>k__BackingField;    // 0x0x20
    public CJEAJPHDCOI <PCNJAKFJJBC>k__BackingField;    // 0x0x28
    public string <FMJOLGPCNKL>k__BackingField;    // 0x0x30
    public DateTime <JPBNFGJKGNB>k__BackingField;    // 0x0x38
    public DateTime <HPEGNMEHKCM>k__BackingField;    // 0x0x40
    public DateTime <MDEEKFGKGPK>k__BackingField;    // 0x0x48
    public bool? <MPCKHEPNBPJ>k__BackingField;    // 0x0x50
}
...
public class AEHNCBFLDLM : CHDFDLICCDG
{
    public string <NCAIPIOMDNN>k__BackingField;    // 0x0x30
    public List<KAPOPJAMDNB> GIAIPKLJCEA;    // 0x0x38
    public int <MCNBCJKNIHL>k__BackingField;    // 0x0x40
}
...
public class AGGJODPKHPH
{
    public bool <LEPPKLJDNJI>k__BackingField;    // 0x0x10
    public string <POIAJALOFOG>k__BackingField;    // 0x0x18
    public string <EHOLJNEFDBL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AGJHIOHONAH
//   REQUEST  POST   api/challenge/v2/updateProgress   [Service.WWW]
public class AGJHIOHONAH
{
    public int <FMNEGGMFJJK>k__BackingField;    // 0x0x10
    public int <GCDKPANPDPJ>k__BackingField;    // 0x0x14
    public string <NOIKBNNLFGC>k__BackingField;    // 0x0x18
    public bool <AGECFEHCBEF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AHFHFHCCCIH
//   (not directly referenced by a detected call)
public class AHFHFHCCCIH
{
    public long <GNAKNEGIPIF>k__BackingField;    // 0x0x10
    public long <PJHEDNJHKDC>k__BackingField;    // 0x0x18
    public int <IHMPEMHNPDP>k__BackingField;    // 0x0x20
    public DateTime <LCMIIPDGMDM>k__BackingField;    // 0x0x28
    public OEAKPLPCNOM <IIBNKONJAPI>k__BackingField;    // 0x0x30
}
...
// AMHFICDGAMC
//   (not directly referenced by a detected call)
public class AMHFICDGAMC
{
    public bool <HDADGJHIGDH>k__BackingField;    // 0x0x10
    public NEHKHFDDNIH <OINENIHJIBE>k__BackingField;    // 0x0x14
    public int <AAOEJGANPPG>k__BackingField;    // 0x0x18
    public DateTime <NICJCMLGDNB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AMJCHEGMCFA
//   RESPONSE POST   api/inventions/v1/settags   [Service.Auth]
public class AMJCHEGMCFA
{
    public DBIHFCKALAE <JPJPIFNNOKO>k__BackingField;    // 0x0x10
    public List<string> <JPPMFHMOKLF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BCOMLCGGDLJ
//   (not directly referenced by a detected call)
public class BCOMLCGGDLJ
{
    public long <JCGNFHIGKNG>k__BackingField;    // 0x0x10
    public string <JLNFKGDKDGI>k__BackingField;    // 0x0x18
    public int <NIMIJAFGCML>k__BackingField;    // 0x0x20
    public int <LNDEHLGMHPC>k__BackingField;    // 0x0x24
    public int <PMFBCKDFIDG>k__BackingField;    // 0x0x28
    public int <BOPJAAMOAKN>k__BackingField;    // 0x0x2C
    public int <NCEBLEBHDKO>k__BackingField;    // 0x0x30
    public string <KKJMMPPJCDB>k__BackingField;    // 0x0x38
    public string <AAFDJMOPALC>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// BDEEDCOPPPA
//   (not directly referenced by a detected call)
public class BDEEDCOPPPA
{
    public int <KDBCMHIIBEK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BGGBJMONHOI
//   (not directly referenced by a detected call)
public class BGGBJMONHOI
{
    public int <PDLAGCJIFLE>k__BackingField;    // 0x0x10
    public DateTime <LCMIIPDGMDM>k__BackingField;    // 0x0x18
    public DateTime? <INLAFNGICEK>k__BackingField;    // 0x0x20
}
...
// BPAALMLDFBM
//   (not directly referenced by a detected call)
public class BPAALMLDFBM
{
    public string <OPCLIIICJBE>k__BackingField;    // 0x0x10
    public BIMNHAAJPAF <IIBNKONJAPI>k__BackingField;    // 0x0x18
}
...
// CEONFGNGMKL
//   (not directly referenced by a detected call)
public class CEONFGNGMKL
{
    public Guid <GHJLIKJKJMI>k__BackingField;    // 0x0x10
    public Guid <BAFEIDHIJNB>k__BackingField;    // 0x0x20
    public DateTime <JPBNFGJKGNB>k__BackingField;    // 0x0x30
    public List<JMOLJHLCHMC> <CGNMBDAIHME>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// CJEAJPHDCOI
//   (not directly referenced by a detected call)
public class CJEAJPHDCOI
{
    public long <NNJOEEBGBAP>k__BackingField;    // 0x0x10
    public string <GFGBDLGDCJE>k__BackingField;    // 0x0x18
    public string <BKCPDMHPBEH>k__BackingField;    // 0x0x20
    public GDNILMDIBAE? <FPIPGNBKNOG>k__BackingField;    // 0x0x28
    public string <JPCLCDEFOMP>k__BackingField;    // 0x0x30
    public string <NAJDDBCKJIC>k__BackingField;    // 0x0x38
    public DLGEBJOJFEC <FOJNDEPIPMK>k__BackingField;    // 0x0x40
    public int <ANPHMDCDEAM>k__BackingField;    // 0x0x44
    public int <NHLPOGGDOCB>k__BackingField;    // 0x0x48
    public DGIAIJHLAKA? <DKAGBNJMHLE>k__BackingField;    // 0x0x4C
    public OGNKBHOOMOF? <KLFOKIELGFD>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// CKAGMJHHAHM
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.WWW]
public class CKAGMJHHAHM
{
    public long <NIDAAOGOICD>k__BackingField;    // 0x0x10
    public int <CPCCBKFDPFJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CNADDOIIKMK
//   RESPONSE GET    api/config/v2   [Service.Auth]
public class CNADDOIIKMK
{
    public Dictionary<int, int> <FECPLAFGGHK>k__BackingField;    // 0x0x10
    public List<ADCOHFDOBDD> <PFGFAEMGPHL>k__BackingField;    // 0x0x18
    public NMHDOMDKCAM[][] <IOIPGIMKEJJ>k__BackingField;    // 0x0x20
    public BDEEDCOPPPA <NAKMHCIFLAG>k__BackingField;    // 0x0x28
    public KAAGJCHCJLO <BKPBOMDMLAD>k__BackingField;    // 0x0x30
    public PHFANPCJBMM <OFOFBCBEMPN>k__BackingField;    // 0x0x38
    public KFJJDDDCGPA <PFEADFCNEIE>k__BackingField;    // 0x0x40
    public FIJFGONCOJP <IJOEECHNKHI>k__BackingField;    // 0x0x48
    public string <HCFGMNDNFHB>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// CODKJBMAFJL
// base   : DFEAEPDPJNH`1<ONCCDPHIHCH>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{dDHFFPKHCJP}   [Service.Auth]
public class CODKJBMAFJL
{
    // (no instance fields in the metadata dump)
}
...
public class CPLJNIEHKBF
{
    public List<string> <CICEJHDIKEH>k__BackingField;    // 0x0x10
}
...
public class DAOJJDIKNOJ
{
    public Dictionary<Guid, KDALHGFIINJ> <BBGAPNLBDCA>k__BackingField;    // 0x0x10
}
...
public class DBACLFFNGIL
{
    public int <BGKEDMPKDDM>k__BackingField;    // 0x0x10
    public int <GPEFNLPLADP>k__BackingField;    // 0x0x14
    public float <ILOJKMANIEB>k__BackingField;    // 0x0x18
    public float <BDEPGEPCCHB>k__BackingField;    // 0x0x1C
    public bool <AGOOIDJCEIP>k__BackingField;    // 0x0x20
    public bool <BDAPHIKDAKG>k__BackingField;    // 0x0x21
    public bool <EOKHJMOBBLM>k__BackingField;    // 0x0x22
}
...
public class DBGGGJBIANM : CPHPNFAJGGI
{
    public PAJNBCPMAEO? <AKCHLMHOBHA>k__BackingField;    // 0x0x18
    public OGLOONJNCKF <FHKLNEDEPFE>k__BackingField;    // 0x0x20
}
...
// DBNAPJCOBEK
//   (not directly referenced by a detected call)
public class DBNAPJCOBEK
{
    public long <NIDAAOGOICD>k__BackingField;    // 0x0x10
    public Guid <JLNFKGDKDGI>k__BackingField;    // 0x0x18
    public long <BELGFLMBCFM>k__BackingField;    // 0x0x28
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x30
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x38
    public int <DABKGJEGCGA>k__BackingField;    // 0x0x40
    public Guid? <AFIAJFIGOBG>k__BackingField;    // 0x0x44
    public DateTime <LCMIIPDGMDM>k__BackingField;    // 0x0x58
    public string <GECPMEOLFKH>k__BackingField;    // 0x0x60
    public IONIHCLCDEF <IIBNKONJAPI>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// DCMGAJMMFOK
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.Auth]
public class DCMGAJMMFOK
{
    public string <BCFLKAKFPNI>k__BackingField;    // 0x0x10
    public string <POIAJALOFOG>k__BackingField;    // 0x0x18
    public string <AOGIDOJKKJG>k__BackingField;    // 0x0x20
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x28
    public string <LFEGPGLPPDF>k__BackingField;    // 0x0x30
    public HGEFGKLEMFH <KJKFFOIABMJ>k__BackingField;    // 0x0x38
    public List<string> <KJMAGCPJHAK>k__BackingField;    // 0x0x40
    public List<string> <JPPMFHMOKLF>k__BackingField;    // 0x0x48
    public string <NCFDCBHLOJI>k__BackingField;    // 0x0x50
    public List<NFHGPCEEMGE> <AMNAMDEMMDF>k__BackingField;    // 0x0x58
}
...
//   RESPONSE GET    api/playerevents/v1/all/{iAADOHAINLN}   [Service.Auth]
public class DIJPJAFFHEH
{
    public List<HILELHEEFEE> <NIENKPKFKKN>k__BackingField;    // 0x0x10
    public List<NCDGKACHGHL> <GPHBPKJNIDB>k__BackingField;    // 0x0x18
}
...
public class DNOKBCNKAAK
{
    public List<string> <ELLFFNGFPFG>k__BackingField;    // 0x0x10
    public byte <LBCHHLKDJGH>k__BackingField;    // 0x0x18
    public int <PCNGODCHDFE>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// EAOIFMLNECO
//   (not directly referenced by a detected call)
public class EAOIFMLNECO
{
    public int <ACPMMLJNHOB>k__BackingField;    // 0x0x10
    public PLAKADLFODB <JPJPIFNNOKO>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// EDNEFIOOEDG
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{dGIBOINMLED}   [Service.Auth]
public class EDNEFIOOEDG
{
    public uint <BCFLKAKFPNI>k__BackingField;    // 0x0x10
    public uint? <DCGMPLIEAIH>k__BackingField;    // 0x0x14
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x20
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x28
    public DateTime <JBMEPHLHAJC>k__BackingField;    // 0x0x30
    public DateTime? <NGLKNKINDPP>k__BackingField;    // 0x0x38
    public bool <JFFNHOGOFCF>k__BackingField;    // 0x0x48
    public List<DCMGAJMMFOK> <EKMBCPPKEKL>k__BackingField;    // 0x0x50
    public List<string> <JPPMFHMOKLF>k__BackingField;    // 0x0x58
    public int <JNBLFAEJFOH>k__BackingField;    // 0x0x60
    public int <JBMLALJGNAJ>k__BackingField;    // 0x0x64
    public int <FANDHLJAEEK>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// EGIAIEIIHFI
//   (not directly referenced by a detected call)
public class EGIAIEIIHFI
{
    public bool <PLDEMGJACBN>k__BackingField;    // 0x0x10
    public JMOLJHLCHMC <EGIOOCBBACB>k__BackingField;    // 0x0x18
    public float <POBKHMBJNBO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EJMFMNJKPDC
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.WWW]
public class EJMFMNJKPDC
{
    public List<BGGBJMONHOI> <IHGAONAPBJC>k__BackingField;    // 0x0x10
    public string <MIJELBBNIIB>k__BackingField;    // 0x0x18
}
...
public class EMCMOBKAOCF
{
    public Dictionary<string, FFHNAJNNDID> <OCKHCBOFIBN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EPDKHOBBBLF
//   (not directly referenced by a detected call)
public class EPDKHOBBBLF
{
    public Guid <AEMFKOCGOAJ>k__BackingField;    // 0x0x10
    public int <CPCCBKFDPFJ>k__BackingField;    // 0x0x20
    public int <MJKLKGDJFHJ>k__BackingField;    // 0x0x24
    public Guid <FLLMEOCIFBI>k__BackingField;    // 0x0x28
    public DateTime <NICJCMLGDNB>k__BackingField;    // 0x0x38
    public LDNCNIOFGDC <GDMIACNKBMO>k__BackingField;    // 0x0x40
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{pMFIEJACNHL}   [Service.WWW]
public enum FBBGHFJHDJA
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class FDJPPOPIGPO
{
    public int? <HBGBCONBJLN>k__BackingField;    // 0x0x10
    public string <LFEGPGLPPDF>k__BackingField;    // 0x0x18
    public string <NKNHMDDDCOJ>k__BackingField;    // 0x0x20
}
...
public class FDKEDGFPBJG
{
    public FBBGHFJHDJA <KJKFFOIABMJ>k__BackingField;    // 0x0x10
    public DBNAPJCOBEK <COFCIFIBJJB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FFHNAJNNDID
//   (not directly referenced by a detected call)
public class FFHNAJNNDID
{
    public long <PAIKFLLLEOD>k__BackingField;    // 0x0x10
    public Guid <CDIKLAIAJEO>k__BackingField;    // 0x0x18
    public Guid <HLKDOMJIJIC>k__BackingField;    // 0x0x28
    public DateTime <LCMIIPDGMDM>k__BackingField;    // 0x0x38
    public string <EKBNNHIIIHJ>k__BackingField;    // 0x0x40
    public string <HBLOPBPOODF>k__BackingField;    // 0x0x48
    public string <JEPPJMHGDOO>k__BackingField;    // 0x0x50
    public string <NCFKFKNMBNJ>k__BackingField;    // 0x0x58
}
...
// FIJFGONCOJP
//   (not directly referenced by a detected call)
public class FIJFGONCOJP
{
    public float <FPAMCFCGEKL>k__BackingField;    // 0x0x10
}
...
public class FMFDPAGCGJD
{
    public IODMOLIABNE <MOKNLOGIEAN>k__BackingField;    // 0x0x10
    public PCALGOMJILA <FBADPLMHJOI>k__BackingField;    // 0x0x18
    public int <KKLKOEGOLAG>k__BackingField;    // 0x0x20
}
...
public class FMLLBFEBOIM
{
    public int <GPEFNLPLADP>k__BackingField;    // 0x0x10
    public bool <AGOOIDJCEIP>k__BackingField;    // 0x0x14
    public DateTime <GAGEFJKDAJA>k__BackingField;    // 0x0x18
    public bool <ENJEOAELCCI>k__BackingField;    // 0x0x20
}
...
public class FOBDHAPEOJN
{
    public long <BELGFLMBCFM>k__BackingField;    // 0x0x10
    public long? <EFEAMKAMLKC>k__BackingField;    // 0x0x18
    public long? <FLFHFLDFIFF>k__BackingField;    // 0x0x28
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x38
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x40
    public List<string> <JPPMFHMOKLF>k__BackingField;    // 0x0x48
    public string <GECPMEOLFKH>k__BackingField;    // 0x0x50
    public DateTime <EGFEPONHMBE>k__BackingField;    // 0x0x58
    public DateTime <GEELNMKPGFH>k__BackingField;    // 0x0x60
    public AJFFGAEGNKL <HFNJLGHKACP>k__BackingField;    // 0x0x68
    public bool <OJJDPIJIAKP>k__BackingField;    // 0x0x6C
    public bool <CHNMPNFIAAI>k__BackingField;    // 0x0x6D
    public HBHGCNKIMNM <EHEOPJDMFPE>k__BackingField;    // 0x0x70
    public HBHGCNKIMNM <ALDDEKNHFBM>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// GBDNHOGGPCL
//   (not directly referenced by a detected call)
public class GBDNHOGGPCL
{
    public ObscuredLong <CIFKLLIIOFG>k__BackingField;    // 0x0x10
    public string <JLNFKGDKDGI>k__BackingField;    // 0x0x38
    public ObscuredInt <DGJNCLIDNND>k__BackingField;    // 0x0x40
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x58
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x60
    public string <GECPMEOLFKH>k__BackingField;    // 0x0x68
    public byte <DNPAKJPCMFB>k__BackingField;    // 0x0x70
    public int <MCNLHLKNCHJ>k__BackingField;    // 0x0x74
    public IBEOMPIIABN <HFNJLGHKACP>k__BackingField;    // 0x0x78
    public bool <ADDFENAHJPO>k__BackingField;    // 0x0x7C
    public DateTime <NICJCMLGDNB>k__BackingField;    // 0x0x80
    public DateTime <LCMIIPDGMDM>k__BackingField;    // 0x0x88
    public DateTime? <JDJKHEPEODI>k__BackingField;    // 0x0x90
    public long? <CBNKIDGOJAF>k__BackingField;    // 0x0xA0
    public int <NHAIKPEEMOF>k__BackingField;    // 0x0xB0
    public int <DIPMAKPGJAG>k__BackingField;    // 0x0xB4
    public int <PAJNAHHFAMC>k__BackingField;    // 0x0xB8
    public NGDJNHGELFO <OHAJIMHDKMD>k__BackingField;    // 0x0xBC
    public NGDJNHGELFO <PJHEJLBFEDP>k__BackingField;    // 0x0xC0
    public ObscuredBool <LPMOHPCIKIF>k__BackingField;    // 0x0xC4
    public ObscuredBool <GJIDEHODKAG>k__BackingField;    // 0x0xD0
    public ObscuredBool <OIHIBJDOEJM>k__BackingField;    // 0x0xDC
    public int? <DABKGJEGCGA>k__BackingField;    // 0x0xE8
    public bool <MKLOGMNCPDI>k__BackingField;    // 0x0xF0
}

// --------------------------------------------------------------------------
// GBJHGOGFGBB
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class GBJHGOGFGBB
{
    public Dictionary<Guid, LBMCHJBOGIP> <ILAGECJBFEI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GCDFJPFBHHI
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.WWW]
public class GCDFJPFBHHI
{
    public long <BELGFLMBCFM>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <DENGHIFOCJA>k__BackingField;    // 0x0x18
    public MPJKAHCJJLF <JIOHLBGGCFK>k__BackingField;    // 0x0x20
}
...
public class GDCIHHBBJAP
{
    public List<string> <GCNKKCAFLOM>k__BackingField;    // 0x0x10
    public List<string> <CHCGDKMGINF>k__BackingField;    // 0x0x18
    public List<string> <HJEDPMKKJMF>k__BackingField;    // 0x0x20
}
...
public class GDPDNHGOLCJ
{
    public List<int> <AONBGDMBIJN>k__BackingField;    // 0x0x10
    public string <MIJELBBNIIB>k__BackingField;    // 0x0x18
}
...
public class GKKBLPLNPOE
{
    public string <DMGMNFFGLLI>k__BackingField;    // 0x0x10
    public string <DCMGHHHKLJC>k__BackingField;    // 0x0x18
    public string <CALNNFIGKME>k__BackingField;    // 0x0x20
    public string <MMEMDNKFEJC>k__BackingField;    // 0x0x28
    public OGNKBHOOMOF <BEBKOJOONOO>k__BackingField;    // 0x0x30
    public bool BPMNPAEJCHC;    // 0x0x34
    public bool <EOKHJMOBBLM>k__BackingField;    // 0x0x35
}

// --------------------------------------------------------------------------
// GKOLPEEKIJD
//   REQUEST  POST   api/playerevents/v1/respond   [Service.Auth]
public class GKOLPEEKIJD
{
    public long <PJHEDNJHKDC>k__BackingField;    // 0x0x10
    public OEAKPLPCNOM <IIBNKONJAPI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GOHGMBAKGGI
//   RESPONSE GET    api/inventions/v1/details   [Service.Auth]
public class GOHGMBAKGGI
{
    public List<BPAALMLDFBM> <JPPMFHMOKLF>k__BackingField;    // 0x0x10
}
...
public class HCKGHGGPNDC
{
    public byte <LBCHHLKDJGH>k__BackingField;    // 0x0x10
    public int <PCNGODCHDFE>k__BackingField;    // 0x0x14
}
...
public class HDOHMOMKCGH
{
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x10
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x18
    public int? <DABKGJEGCGA>k__BackingField;    // 0x0x20
    public IBEOMPIIABN? <HFNJLGHKACP>k__BackingField;    // 0x0x28
}
...
public class HFGKAGMCGKI
{
    public GDNILMDIBAE <FPIPGNBKNOG>k__BackingField;    // 0x0x10
    public string <BIDHFKHOGNI>k__BackingField;    // 0x0x18
    public string <CALNNFIGKME>k__BackingField;    // 0x0x20
    public string <MMEMDNKFEJC>k__BackingField;    // 0x0x28
    public OGNKBHOOMOF <BEBKOJOONOO>k__BackingField;    // 0x0x30
    public string <IDIGJPPJAIN>k__BackingField;    // 0x0x38
    public int <JEJKAGLBOIK>k__BackingField;    // 0x0x40
    public bool <BDLHADJMLGF>k__BackingField;    // 0x0x44
}
...
// base   : CHDFDLICCDG
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/season/{eGFDIGEAKJN}   [Service.WWW]
public class HGOEMIICDKC : CHDFDLICCDG
{
    public int <BDINFALHGHN>k__BackingField;    // 0x0x30
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x38
    public DateTime <JPBNFGJKGNB>k__BackingField;    // 0x0x40
    public DateTime <HPEGNMEHKCM>k__BackingField;    // 0x0x48
    public OEIPNNLMLJL <CBAPGEOJBNE>k__BackingField;    // 0x0x50
    public PECPCHDLNIG <HOLGOADILMO>k__BackingField;    // 0x0x58
    public List<KNBCCCBGLLF> <CMGACMMJLCM>k__BackingField;    // 0x0x60
    public AMHFICDGAMC <KAGLGECNKAL>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// HILELHEEFEE
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class HILELHEEFEE
{
    public long <PJHEDNJHKDC>k__BackingField;    // 0x0x10
    public int <NIELICAOGGM>k__BackingField;    // 0x0x18
    public long <BELGFLMBCFM>k__BackingField;    // 0x0x20
    public long? <EFEAMKAMLKC>k__BackingField;    // 0x0x28
    public long? <FLFHFLDFIFF>k__BackingField;    // 0x0x38
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x48
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x50
    public string <GECPMEOLFKH>k__BackingField;    // 0x0x58
    public DateTime <EGFEPONHMBE>k__BackingField;    // 0x0x60
    public DateTime <GEELNMKPGFH>k__BackingField;    // 0x0x68
    public int <CGPLGKIAHAJ>k__BackingField;    // 0x0x70
    public AJFFGAEGNKL <HFNJLGHKACP>k__BackingField;    // 0x0x74
    public bool <OJJDPIJIAKP>k__BackingField;    // 0x0x78
    public bool <CHNMPNFIAAI>k__BackingField;    // 0x0x79
    public HBHGCNKIMNM <EHEOPJDMFPE>k__BackingField;    // 0x0x7C
    public HBHGCNKIMNM <ALDDEKNHFBM>k__BackingField;    // 0x0x80
    public long? <PNABAINBNKK>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// HLOAKNEDLFI
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Matchmaking]
public class HLOAKNEDLFI
{
    public Guid <FOLLONKFAIE>k__BackingField;    // 0x0x10
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x20
    public string <GECPMEOLFKH>k__BackingField;    // 0x0x28
    public DateTime <JPBNFGJKGNB>k__BackingField;    // 0x0x30
    public DateTime? <IHCONLIENLE>k__BackingField;    // 0x0x38
    public List<CEONFGNGMKL> <JOLJNCJONJP>k__BackingField;    // 0x0x48
}
...
public class IBMEFFFMAMO
{
    public FEHPFOPEHAO <IMCFBIMMDLE>k__BackingField;    // 0x0x10
    public long <PJHEDNJHKDC>k__BackingField;    // 0x0x18
    public string <MPPNOOOKIPE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IFFMJEFNBBC
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.Auth]
public class IFFMJEFNBBC
{
    public List<long> <GFCFNKIIFKO>k__BackingField;    // 0x0x10
    public OIABHMFIBMN <IIBNKONJAPI>k__BackingField;    // 0x0x18
    public string <BFNIEIDENBI>k__BackingField;    // 0x0x20
    public long? <BELGFLMBCFM>k__BackingField;    // 0x0x28
}
...
// IKBDODDJJAE
//   (not directly referenced by a detected call)
public class IKBDODDJJAE
{
    public OEIPNNLMLJL <CBAPGEOJBNE>k__BackingField;    // 0x0x10
    public int <DABKGJEGCGA>k__BackingField;    // 0x0x14
    public JAEPGEPKEKC <KBFFAIFBAPN>k__BackingField;    // 0x0x18
}
...
public class ILAFPLFEECC
{
    public PLAKADLFODB <JPJPIFNNOKO>k__BackingField;    // 0x0x10
}
...
public class INOEPMBAHPH : CPHPNFAJGGI
{
    public KIIHPEPFMKD? <AKCHLMHOBHA>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <KFNPPFCNKMF>k__BackingField;    // 0x0x20
}
...
public class INPIFEBBPNO
{
    public GCJOEIIOJGL <KJKFFOIABMJ>k__BackingField;    // 0x0x10
    public GBDNHOGGPCL <GNGAOCAGAKL>k__BackingField;    // 0x0x18
    public BCOMLCGGDLJ <DEINDCAJBLH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IODMOLIABNE
//   REQUEST  PUT    api/roomconsumables   [Service.WWW]
public class IODMOLIABNE
{
    public Guid? <IJIBKCMJIDE>k__BackingField;    // 0x0x10
    public Guid <CJOKNEBOBKG>k__BackingField;    // 0x0x24
}
...
// JAEPGEPKEKC
//   (not directly referenced by a detected call)
public class JAEPGEPKEKC
{
    public int <BIBOPHCIJGP>k__BackingField;    // 0x0x10
    public DateTime? <BADANJAGPCP>k__BackingField;    // 0x0x18
    public DateTime? <MIFLDMONCIL>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// JMOLJHLCHMC
//   (not directly referenced by a detected call)
public class JMOLJHLCHMC
{
    public int <NNJOEEBGBAP>k__BackingField;    // 0x0x10
    public string <CALNNFIGKME>k__BackingField;    // 0x0x18
    public string <MMEMDNKFEJC>k__BackingField;    // 0x0x20
    public string <IDIGJPPJAIN>k__BackingField;    // 0x0x28
    public string <GFGBDLGDCJE>k__BackingField;    // 0x0x30
    public string <MDEENNEIJBG>k__BackingField;    // 0x0x38
    public GDNILMDIBAE? <FPIPGNBKNOG>k__BackingField;    // 0x0x40
    public string <JPCLCDEFOMP>k__BackingField;    // 0x0x48
    public string <NAJDDBCKJIC>k__BackingField;    // 0x0x50
    public bool <ANEKACEEKJD>k__BackingField;    // 0x0x58
    public bool <CBIPKLBMHAE>k__BackingField;    // 0x0x59
    public bool <LFGODICOKEO>k__BackingField;    // 0x0x5A
    public OGNKBHOOMOF <BEBKOJOONOO>k__BackingField;    // 0x0x5C
    public OEIPNNLMLJL <CBAPGEOJBNE>k__BackingField;    // 0x0x60
    public int <HGDNAEIIHJC>k__BackingField;    // 0x0x64
    public FGOBKCGEENE <FOFLNLOKLFD>k__BackingField;    // 0x0x68
    public DGIAIJHLAKA <OOGDDKBECGB>k__BackingField;    // 0x0x6C
    public int? <FBNEJBCDPJA>k__BackingField;    // 0x0x70
    public string <GNFCPNONMOH>k__BackingField;    // 0x0x78
    public int? <JEJKAGLBOIK>k__BackingField;    // 0x0x80
    public int? <OBGNLIMNKLG>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// KAAGJCHCJLO
//   (not directly referenced by a detected call)
public class KAAGJCHCJLO
{
    public float <HEENIKNIGKD>k__BackingField;    // 0x0x10
    public float <MAGKCAMEHEE>k__BackingField;    // 0x0x14
    public float <OEPCKGFENLG>k__BackingField;    // 0x0x18
    public float <IMPDMBKMPPD>k__BackingField;    // 0x0x1C
    public float <IBCPNANFALE>k__BackingField;    // 0x0x20
    public float <OHJMCDJHLBH>k__BackingField;    // 0x0x24
    public float <BMAEOLIIKCD>k__BackingField;    // 0x0x28
    public float <JHMBAICJLND>k__BackingField;    // 0x0x2C
}
...
// base   : PECPCHDLNIG
//   (not directly referenced by a detected call)
public class KAPOPJAMDNB : PECPCHDLNIG
{
    public JMOLJHLCHMC <EGIOOCBBACB>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// KDALHGFIINJ
//   RESPONSE PUT    api/roomconsumables   [Service.WWW]
public class KDALHGFIINJ
{
    public AFKIIENONDM <KJKFFOIABMJ>k__BackingField;    // 0x0x10
    public EPDKHOBBBLF <KIDKEKLLGIB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KEMDFKPAFIO
// base   : DFEAEPDPJNH`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class KEMDFKPAFIO
{
    // (no instance fields in the metadata dump)
}
...
// KFJJDDDCGPA
//   (not directly referenced by a detected call)
public class KFJJDDDCGPA
{
    public int <ODKPIMBAPHE>k__BackingField;    // 0x0x10
}
...
// KMNEDCKDNGJ
//   (not directly referenced by a detected call)
public class KMNEDCKDNGJ
{
    public int <GCDKPANPDPJ>k__BackingField;    // 0x0x10
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x18
    public string <NOIKBNNLFGC>k__BackingField;    // 0x0x20
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x28
    public string <MMEMDNKFEJC>k__BackingField;    // 0x0x30
    public bool <AGECFEHCBEF>k__BackingField;    // 0x0x38
    public int <IFCIAFMAEAK>k__BackingField;    // 0x0x3C
    public CEFEHDJODED <NPGDMICBPPL>k__BackingField;    // 0x0x40
    public EPMMDEMILCC MJHIGNFPEHA;    // 0x0x48
    public EPMMDEMILCC DPNKLCHABPI;    // 0x0x50
    public EPMMDEMILCC BLJGANOBICP;    // 0x0x58
    public OADOBGICHLC MNHJCICPCJJ;    // 0x0x60
}
...
// base   : PECPCHDLNIG
//   (not directly referenced by a detected call)
public class KNBCCCBGLLF : PECPCHDLNIG
{
    public int <DNLANEPCOJN>k__BackingField;    // 0x0x60
    public List<EGIAIEIIHFI> <INFCHMNOHDB>k__BackingField;    // 0x0x68
    public List<EGIAIEIIHFI> <GEKMEIFFBPK>k__BackingField;    // 0x0x70
    public List<EGIAIEIIHFI> <OGLEGHANMKA>k__BackingField;    // 0x0x78
}
...
//   RESPONSE DELETE api/keepsakes/{gFIDPDNCIHA}   [Service.Auth]
...
public class LALALCEBIGO
{
    public bool <LCFHPFHEABO>k__BackingField;    // 0x0x10
    public string <HFPOFDPGALN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LBMCHJBOGIP
//   (not directly referenced by a detected call)
public class LBMCHJBOGIP
{
    public int <KKLKOEGOLAG>k__BackingField;    // 0x0x10
    public IODMOLIABNE <MOKNLOGIEAN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LBNENBOPPLC
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.Auth]
public class LBNENBOPPLC
{
    public FEHPFOPEHAO <IMCFBIMMDLE>k__BackingField;    // 0x0x10
    public int <HEBEHAKPPGJ>k__BackingField;    // 0x0x14
    public long <CEIICMBLAMD>k__BackingField;    // 0x0x18
    public bool <JEKCGOBJAMO>k__BackingField;    // 0x0x20
    public string <KCAFPDADBLP>k__BackingField;    // 0x0x28
    public int? <NIMHOMIKMME>k__BackingField;    // 0x0x30
    public bool <LMHIICCOIOH>k__BackingField;    // 0x0x38
    public bool <CDGJIDBIAMF>k__BackingField;    // 0x0x39
    public bool <FNEMHOEIFDF>k__BackingField;    // 0x0x3A
    public bool <NCIBJEHOCKG>k__BackingField;    // 0x0x3B
    public string <EMEIBEGCGMA>k__BackingField;    // 0x0x40
    public DateTime? <MNCPNFEFOKD>k__BackingField;    // 0x0x48
    public string <LENIPEOMHBF>k__BackingField;    // 0x0x58
    public float <CHJINCOJDAD>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// LDNCNIOFGDC
//   (not directly referenced by a detected call)
public class LDNCNIOFGDC
{
    public Guid <AEMFKOCGOAJ>k__BackingField;    // 0x0x10
    public long <BELGFLMBCFM>k__BackingField;    // 0x0x20
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x28
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x30
    public string <GECPMEOLFKH>k__BackingField;    // 0x0x38
    public long <DABKGJEGCGA>k__BackingField;    // 0x0x40
    public Guid? <AFIAJFIGOBG>k__BackingField;    // 0x0x48
    public DateTime <NICJCMLGDNB>k__BackingField;    // 0x0x60
    public int <GIJJACJMDGH>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// LIIPBPIAAMD
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.Auth]
public class LIIPBPIAAMD
{
    public int <NDEGDPFHKMJ>k__BackingField;    // 0x0x10
    public int? <EFIDNNJCIJF>k__BackingField;    // 0x0x14
    public string <LHMNPDBBLMC>k__BackingField;    // 0x0x20
    public string <PHHMJEOBCIN>k__BackingField;    // 0x0x28
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{mGECIOMADPE}   [Service.WWW]
public class LKNAEHHEEMG
{
    public AFKIIENONDM <KJKFFOIABMJ>k__BackingField;    // 0x0x10
    public LDNCNIOFGDC <GDMIACNKBMO>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/progressionEvents/collect/{iMPKLENPNOL}/{bKFKADGEDHF}   [Service.Auth]
public class LNKGEBKKFJK
{
    public long? <BCFLKAKFPNI>k__BackingField;    // 0x0x10
    public int <IHMPEMHNPDP>k__BackingField;    // 0x0x20
    public int? <JGOIEAMHMGK>k__BackingField;    // 0x0x24
    public string <GFGBDLGDCJE>k__BackingField;    // 0x0x30
    public GDNILMDIBAE? <FPIPGNBKNOG>k__BackingField;    // 0x0x38
    public string <MDEENNEIJBG>k__BackingField;    // 0x0x40
    public string <JPCLCDEFOMP>k__BackingField;    // 0x0x48
    public string <NAJDDBCKJIC>k__BackingField;    // 0x0x50
    public OEIPNNLMLJL <CBAPGEOJBNE>k__BackingField;    // 0x0x58
    public int <HGDNAEIIHJC>k__BackingField;    // 0x0x5C
    public int <ANPHMDCDEAM>k__BackingField;    // 0x0x60
    public DGIAIJHLAKA <DKAGBNJMHLE>k__BackingField;    // 0x0x64
    public OGNKBHOOMOF <KLFOKIELGFD>k__BackingField;    // 0x0x68
    public string <JABNKCBLNLM>k__BackingField;    // 0x0x70
    public POJENFLKNLE <LJFLCFENHLP>k__BackingField;    // 0x0x78
    public NEHKHFDDNIH <PBEHLDIGGBB>k__BackingField;    // 0x0x7C
    public FHHBGFKDLJD? <JOEJNABDOBM>k__BackingField;    // 0x0x80
    public bool <EACMNAEBAAO>k__BackingField;    // 0x0x88
    public bool <MDCGJFOKJNB>k__BackingField;    // 0x0x89
    public string <GPDLCCAELHA>k__BackingField;    // 0x0x90
    public bool <BIKLGBDFLAF>k__BackingField;    // 0x0x98
    public bool IDDCAIJKHIA;    // 0x0x99
}
...
public class MFKAKJPPINC
{
    public Guid <JHAJHCHHIDP>k__BackingField;    // 0x0x10
    public long <OGPEDMMIMDM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MFLJEPECIMF
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.Auth]
public class MFLJEPECIMF
{
    public List<HILELHEEFEE> <IEDFHHEFOAH>k__BackingField;    // 0x0x10
    public string <MIJELBBNIIB>k__BackingField;    // 0x0x18
}
...
public class MGBKKPCNGDJ
{
    public Guid <DIAFPNKKPEG>k__BackingField;    // 0x0x10
    public int <PIGANGPMCHN>k__BackingField;    // 0x0x20
    public long <DOKJPCNNKEJ>k__BackingField;    // 0x0x28
    public Guid <JHAJHCHHIDP>k__BackingField;    // 0x0x30
}
...
public class MLFFCGPAFLM
{
    public int <EHBJNHJIFNI>k__BackingField;    // 0x0x10
    public GNHFDJOCNGB <IIBNKONJAPI>k__BackingField;    // 0x0x14
    public JMOPJKGHDMM <JEIFIKMCPPL>k__BackingField;    // 0x0x18
    public JMOPJKGHDMM <DCGMHIBMOBF>k__BackingField;    // 0x0x1C
    public JMOPJKGHDMM <NFLMICJCDKC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MLMPBHPGHOB
//   RESPONSE GET    api/config/v1/amplitude   [Service.Auth]
public class MLMPBHPGHOB
{
    public string <ABCKKKHJHJP>k__BackingField;    // 0x0x10
    public string <KAMEBIMFGGF>k__BackingField;    // 0x0x18
    public bool <DICPBLGHCOB>k__BackingField;    // 0x0x20
    public string <PKPGHLHGFPO>k__BackingField;    // 0x0x28
}
...
public class MMFKLCJCCLK
{
    public bool <LCFHPFHEABO>k__BackingField;    // 0x0x10
    public string <KCAFPDADBLP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MNDENKOHEHD
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.WWW]
public class MNDENKOHEHD
{
    public int <HEBEHAKPPGJ>k__BackingField;    // 0x0x10
}
...
public class NAMLAONIIJD
{
    public int <NDBJKMMHEJI>k__BackingField;    // 0x0x10
    public int <CCKKIAMLHHE>k__BackingField;    // 0x0x14
    public float <HPLPILKNGHP>k__BackingField;    // 0x0x18
    public int <KMGHNCCELCK>k__BackingField;    // 0x0x1C
    public int <JBKMCBEJJGL>k__BackingField;    // 0x0x20
    public int <NNAKDOPEEPL>k__BackingField;    // 0x0x24
    public int <GJDBMEDELHE>k__BackingField;    // 0x0x28
    public string <BFIKENPOJFO>k__BackingField;    // 0x0x30
    public string <MAKOFFCDGIG>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// NCDGKACHGHL
//   (not directly referenced by a detected call)
public class NCDGKACHGHL
{
    public HILELHEEFEE <HBJHNCFABAM>k__BackingField;    // 0x0x10
    public AHFHFHCCCIH <LLIMOOMJFLC>k__BackingField;    // 0x0x18
}
...
// NFHGPCEEMGE
//   (not directly referenced by a detected call)
public class NFHGPCEEMGE
{
    public DateTime <LCMIIPDGMDM>k__BackingField;    // 0x0x10
    public string <GMGNAHEEMGA>k__BackingField;    // 0x0x18
}
...
// base   : HILELHEEFEE
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class NILGDMGCKLB : HILELHEEFEE
{
    public List<BPAALMLDFBM> <JPPMFHMOKLF>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// NMHDOMDKCAM
//   (not directly referenced by a detected call)
public class NMHDOMDKCAM
{
    public MCHFFGJFMAL DLOOIDOEILK;    // 0x0x10
    public int PMPIOLHCPBI;    // 0x0x14
}
...
// OEMCGIJNEJF
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{aMLPGNBNPKG}/{hJLFHHCGJAM}   [Service.WWW]
public class OEMCGIJNEJF
{
    public OEIPNNLMLJL <CBAPGEOJBNE>k__BackingField;    // 0x0x10
    public ADCMJOFJDOM <KAMMMABKJPA>k__BackingField;    // 0x0x14
    public int <LPEEPGAEPGD>k__BackingField;    // 0x0x18
    public int <HCAHNOEFMNO>k__BackingField;    // 0x0x1C
    public int <KEIIOOPEHPA>k__BackingField;    // 0x0x20
    public MJKMGBIKIMK <CGHPNPCBMKJ>k__BackingField;    // 0x0x24
    public bool <FOLAFJOJIFA>k__BackingField;    // 0x0x28
    public float <MJNJGKMOEEN>k__BackingField;    // 0x0x2C
    public int <LKKDJAEBKMN>k__BackingField;    // 0x0x30
    public bool <CCAMIFELMNI>k__BackingField;    // 0x0x34
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{iMPKLENPNOL}   [Service.Auth]
...
public class OFKNBNBGKMB
{
    public NILGDMGCKLB <HBJHNCFABAM>k__BackingField;    // 0x0x10
    public PLAKADLFODB <JPJPIFNNOKO>k__BackingField;    // 0x0x18
    public AMJCHEGMCFA <NPJALODEBML>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OGLOONJNCKF
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.WWW]
public class OGLOONJNCKF
{
    public int <CPCCBKFDPFJ>k__BackingField;    // 0x0x10
    public Guid <DIAFPNKKPEG>k__BackingField;    // 0x0x14
    public long <KONNEJJEJJM>k__BackingField;    // 0x0x28
    public DateTime <NICJCMLGDNB>k__BackingField;    // 0x0x30
}
...
public class OPBPEJMJDHP
{
    public Guid? <AEMFKOCGOAJ>k__BackingField;    // 0x0x10
    public long? <BELGFLMBCFM>k__BackingField;    // 0x0x28
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x38
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x40
    public string <GECPMEOLFKH>k__BackingField;    // 0x0x48
    public PCALGOMJILA <HDMMOKPOPBP>k__BackingField;    // 0x0x50
}
...
// PCALGOMJILA
//   (not directly referenced by a detected call)
public class PCALGOMJILA
{
    public long <DABKGJEGCGA>k__BackingField;    // 0x0x10
    public Guid? <DIAFPNKKPEG>k__BackingField;    // 0x0x18
}
...
public class PDOBIJAPHKA
{
    public DAIBJKKGELI <IMCFBIMMDLE>k__BackingField;    // 0x0x10
    public string <MPPNOOOKIPE>k__BackingField;    // 0x0x18
    public int? <LGHAPKGGNKN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PECPCHDLNIG
//   (not directly referenced by a detected call)
public class PECPCHDLNIG
{
    public int <JFDMOMIEMJN>k__BackingField;    // 0x0x10
    public KKPNFNBGDKG <IIBNKONJAPI>k__BackingField;    // 0x0x14
    public List<IKBDODDJJAE> <DGHMHHKJDIN>k__BackingField;    // 0x0x18
    public List<IKBDODDJJAE> <ONDFPIOLGHH>k__BackingField;    // 0x0x20
    public bool <MJLJKHIBLIN>k__BackingField;    // 0x0x28
    public DateTime? <HDMICAHDGKN>k__BackingField;    // 0x0x30
    public DateTime? <NDCCHMEHCGH>k__BackingField;    // 0x0x40
    public DateTime? <JGIIBEGDMNG>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// PFPECHFPOAN
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.WWW]
public class PFPECHFPOAN
{
    public int DICMJKCGDBP;    // 0x0x10
    public long DFHAJFKCFBM;    // 0x0x18
}

// --------------------------------------------------------------------------
// PHFANPCJBMM
//   (not directly referenced by a detected call)
public class PHFANPCJBMM
{
    public int <BMNJOAIKKAA>k__BackingField;    // 0x0x10
}
...
public class PMGMJGFAOLC
{
    public List<EAOIFMLNECO> <CLJAMGBAILI>k__BackingField;    // 0x0x10
    public PLAKADLFODB <JPJPIFNNOKO>k__BackingField;    // 0x0x18
}
...
public class AddKeepsakeInstanceRequest
{
    public long <BELGFLMBCFM>k__BackingField;    // 0x0x10
    public long? <EFEAMKAMLKC>k__BackingField;    // 0x0x18
    public EFLJMDBPODD <GHDCEEMFEFM>k__BackingField;    // 0x0x28
}
...
{
    public IMAFAMHCHDJ <JPJPIFNNOKO>k__BackingField;    // 0x0x10
    public string <OOKLBGFBEGP>k__BackingField;    // 0x0x18
    public string <GEAJNJFJEBG>k__BackingField;    // 0x0x20
    public string <IEGBIJJAFFK>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public OEIPNNLMLJL <CurrencyType>k__BackingField;    // 0x0x18
    public FHHBGFKDLJD <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <PJHEDNJHKDC>k__BackingField;    // 0x0x10
    public long? <GHPPFHGCHKN>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public EKDOOFNBPKA FilterType;    // 0x0x20
...
{
    public EFLJMDBPODD <PJLJGOEGDCF>k__BackingField;    // 0x0x10
    public string <GBGJIKOPJJK>k__BackingField;    // 0x0x18
    public int <HHAMOIGNKEJ>k__BackingField;    // 0x0x20
    public int <LCGGKIOKLDG>k__BackingField;    // 0x0x24
    public string <BDJCJHANJJN>k__BackingField;    // 0x0x28
    public string <GAHIAFOCGEB>k__BackingField;    // 0x0x30
}
...
{
    public int <CPCCBKFDPFJ>k__BackingField;    // 0x0x10
    public Guid <CMOCAMDJDKK>k__BackingField;    // 0x0x14
    public DateTime <EOJBLFKPLHO>k__BackingField;    // 0x0x28
}
...
{
    public bool <PGEOHEMLLOB>k__BackingField;    // 0x0x10
    public int <NBILLNNDCOO>k__BackingField;    // 0x0x14
    public bool <OEAHENPFHFP>k__BackingField;    // 0x0x18
}
...
{
    public Guid <CMOCAMDJDKK>k__BackingField;    // 0x0x10
    public EFLJMDBPODD <LBLMBDBDLIO>k__BackingField;    // 0x0x20
    public int <BDNABMACDFK>k__BackingField;    // 0x0x24
    public long <BELGFLMBCFM>k__BackingField;    // 0x0x28
    public long? <EFEAMKAMLKC>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{bDDGJJKPACH}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <BGLFMHPHMLN>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <NDMNHAPPACP>k__BackingField;    // 0x0x18
}
...
{
    public long <GLLGOHFJHBH>k__BackingField;    // 0x0x10
    public long <BELGFLMBCFM>k__BackingField;    // 0x0x18
    public long <CGNNPBPJILG>k__BackingField;    // 0x0x20
    public LKCBANGBGCM <IIBNKONJAPI>k__BackingField;    // 0x0x28
    public int <IGOHOGBILPC>k__BackingField;    // 0x0x2C
}
...
{
    public long <BELGFLMBCFM>k__BackingField;    // 0x0x10
    public List<Guid> <NMAFFMIDPHO>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <BGLFMHPHMLN>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <NDMNHAPPACP>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <OJMHFHGJJIN>k__BackingField;    // 0x0x20
}
...
{
    public long <CGNNPBPJILG>k__BackingField;    // 0x0x10
    public long <INIDICNBCNJ>k__BackingField;    // 0x0x18
    public int? <HKKCDKEEHJD>k__BackingField;    // 0x0x20
    public int? <IEIJPOACNCA>k__BackingField;    // 0x0x28
    public long? <BNCLKLPDOCN>k__BackingField;    // 0x0x30
    public long <GHGBBBGFJKJ>k__BackingField;    // 0x0x40
    public long <FMAMPBPINGP>k__BackingField;    // 0x0x48
    public int <LOGPODJFAKM>k__BackingField;    // 0x0x50
    public LKCBANGBGCM <PIBFNCBCFHH>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <JJLCEGFKLBN>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public DGIAIJHLAKA <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public FBFELBFAABF creatorAccountRole;    // 0x0x58
}
...
{
    public EGHLKOKIAAH <OIMKBAMFFDH>k__BackingField;    // 0x0x10
    public KKKNNAKEKOF <HGIBCHIONFO>k__BackingField;    // 0x0x14
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x18
    public string <PEPBCGDFJCI>k__BackingField;    // 0x0x20
    public bool <NCOPFMPEFJC>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<EGHLKOKIAAH> <AGHNCBHJHPG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{iMPKLENPNOL}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <INIDICNBCNJ>k__BackingField;    // 0x0x10
    public string <LHLIHHLMIOB>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <OGLEGHANMKA>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <DBKCAIJFDLC>k__BackingField;    // 0x0x28
    public DateTime <EGFEPONHMBE>k__BackingField;    // 0x0x30
    public DateTime <GEELNMKPGFH>k__BackingField;    // 0x0x38
    public DateTime <LCNBLLGAKAO>k__BackingField;    // 0x0x40
    public bool <INKBCBPDINO>k__BackingField;    // 0x0x48
    public int <EIJGGNHNDAM>k__BackingField;    // 0x0x4C
    public float <GPJHJIEHIIJ>k__BackingField;    // 0x0x50
    public Guid? <LJOMDJKIIAD>k__BackingField;    // 0x0x54
    public string <GEHOCBCJKPI>k__BackingField;    // 0x0x68
    public string <IOCPGAGLBBC>k__BackingField;    // 0x0x70
    public string <PBOMHKOMOKK>k__BackingField;    // 0x0x78
    public string <CHLKCNFLJNE>k__BackingField;    // 0x0x80
}
...
{
    public Guid <OONNLBGNPOO>k__BackingField;    // 0x0x10
    public int <NFAHMMPJPKG>k__BackingField;    // 0x0x20
    public int <LIGKCOGFPIJ>k__BackingField;    // 0x0x24
    public int <OAOAOAIECEL>k__BackingField;    // 0x0x28
    public long <EKDHBHFMMDE>k__BackingField;    // 0x0x30
    public long <BPJGGBGKKBL>k__BackingField;    // 0x0x38
}
...
{
    public int <CPCCBKFDPFJ>k__BackingField;    // 0x0x10
    public int <ANPHMDCDEAM>k__BackingField;    // 0x0x14
    public int <NPJPMBCPAFB>k__BackingField;    // 0x0x18
    public int <IFIGAOMODCG>k__BackingField;    // 0x0x1C
    public int <IKPDJLLILMK>k__BackingField;    // 0x0x20
    public DateTime? <EEMGPCCLBGA>k__BackingField;    // 0x0x28
}
...
{
    public long <OJEHAFEOFNG>k__BackingField;    // 0x0x10
    public int <NNJOEEBGBAP>k__BackingField;    // 0x0x18
    public string <GECPMEOLFKH>k__BackingField;    // 0x0x20
    public int <ANPHMDCDEAM>k__BackingField;    // 0x0x28
    public int <IDBOLOCDDNK>k__BackingField;    // 0x0x2C
    public bool <GILFAABEJHI>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public LLCLGGLILKL ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool NNINODGLPJJ;    // 0x0x28
}
...
{
    public OIDHIPJCPHH? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [Auth POST]
public class PlayerCheerV1CreateRequest
{
    public OIDHIPJCPHH BFBOIDLBCKO;  // wrapper
...
{
    public POJENFLKNLE DEBPJGOIGOD;  // wrapper
...
{
    public FMDHOEOACBD HFFNCGFKMBJ;  // wrapper
    public int? KAAFPGDPKAO;  // wrapper
...
{
    public FEHPFOPEHAO LFDMKFOJNGL;  // wrapper
    public float? IGLIBCJINOE;  // wrapper
    public bool? FCCNKLIAHHE;  // wrapper
...
{
    public List<GCJCFMDAODD> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public DGIAIJHLAKA HOLFPPNPJAH;  // wrapper
    public DGIAIJHLAKA? MNCINNBLECJ;  // wrapper
...
{
    public ChatMessage EMKENBOOEOH;  // wrapper
    public JPJFDNMAHJL LFDMKFOJNGL;  // wrapper
...
{
    public IBEOMPIIABN KDJELFDFPPI;  // wrapper
    public HJIAAAEBOHO KMFKDLPNGGM;  // wrapper
    public CLDDOHFKNOP BAAEFMEFJAP;  // wrapper
    public CLDDOHFKNOP OBEPELLGAAG;  // wrapper
...
{
    public BMOFKIBFFML PFILDDAEHHG;  // wrapper
    public DGIAIJHLAKA? FDHEEAJMFHI;  // wrapper
...
{
    public GIDEKFLELNC JCKDIMJCHPB;  // wrapper
...
{
    public GBDNHOGGPCL inventionId;  // wrapper
}
...
// api/keepsakes/{gFIDPDNCIHA}/collect  [Auth POST]
public class KeepsakesGFIDPDNCIHACollectRequest
{
    public Guid GFIDPDNCIHA;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public OIABHMFIBMN GHJLJIDKADO;  // wrapper
    public long? CGIDLDOBHII;  // wrapper
...
{
    public Guid FBNDGMDKJDM;  // wrapper
...
{
    public Guid GAHNAMJKCJB;  // wrapper
    public object Price;  // candidate
...
{
    public Guid GAHNAMJKCJB;  // wrapper
    public long? BPPBOBEEMFG;  // wrapper
    public byte? NEOAOHJOLBD;  // wrapper
    public int? OLDELFAHHJB;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid FBNDGMDKJDM;  // wrapper
    public long? KECBHJPINJD;  // wrapper
    public long? LAPJPEBECIF;  // wrapper
    public int? PHJHIIBKLAE;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> FGAICHJHDGD;  // wrapper
...
{
    public IONIHCLCDEF HFFNCGFKMBJ;  // wrapper
    public Guid? OENGDDGALDC;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public FEHPFOPEHAO LFDMKFOJNGL;  // wrapper
    public long? HHOEMHFFPCG;  // wrapper
    public Guid? JFDFPLHONPD;  // wrapper
    public int? JPPFFBEAILC;  // wrapper
...
{
    public Guid NNHGAEJEMPB;  // wrapper
...
{
    public Guid ANEBAKHAKEM;  // wrapper
...
{
    public HGEFGKLEMFH LBCOCFNMPPD;  // wrapper
}
