...
// DTO classes: 224 (plus referenced enums)

// --------------------------------------------------------------------------
// AALCFDAFKEE
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.Auth]
public class AALCFDAFKEE
{
    public List<long> <NPHMFECPMCC>k__BackingField;    // 0x0x10
    public PBJKPLNNBON <FCDBNKGNEKB>k__BackingField;    // 0x0x18
    public string <LOKKEMMGELH>k__BackingField;    // 0x0x20
    public long? <NIPLGILPHDP>k__BackingField;    // 0x0x28
}
...
public class ADHMFIHGEGL
{
    public NKICKCBDNMF <NPDBIMGAHBP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// ADKFAFHJPJP
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.WWW]
public class ADKFAFHJPJP
{
    public int <MECJBDIKAOI>k__BackingField;    // 0x0x10
    public string <IDFLLJIJKON>k__BackingField;    // 0x0x18
    public List<NFAHFDIHNOL> <OGPAOIMIAMF>k__BackingField;    // 0x0x20
    public KHKCEJGDBGO <KDEJKEKFJKO>k__BackingField;    // 0x0x28
    public string <IGHKDCPPJJG>k__BackingField;    // 0x0x30
    public DateTime <OJAPHNCDKBA>k__BackingField;    // 0x0x38
    public DateTime <CIOKOELCGKM>k__BackingField;    // 0x0x40
    public DateTime <KKAEDJLKJOH>k__BackingField;    // 0x0x48
    public bool? <JJENIGLGJOM>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// AEHIKJHEJMM
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.WWW]
public class AEHIKJHEJMM
{
    public Guid? <JGFJCGMOJAN>k__BackingField;    // 0x0x10
    public long? <NIPLGILPHDP>k__BackingField;    // 0x0x28
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x38
    public string <IEENPNALGOB>k__BackingField;    // 0x0x40
    public string <GEMOIPAMBKL>k__BackingField;    // 0x0x48
    public MGNHLEFLFBL <NGDDEJEMNHO>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// AGOALDBIDJA
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.Auth]
public class AGOALDBIDJA
{
    public List<ILJAJGDABOF> <BOPNPCNCNJA>k__BackingField;    // 0x0x10
    public NKICKCBDNMF <NPDBIMGAHBP>k__BackingField;    // 0x0x18
}
...
public class AJDIAKJMADN
{
    public int <IBGOGDJNEEL>k__BackingField;    // 0x0x10
    public bool <AMJPJMNEAMC>k__BackingField;    // 0x0x14
    public DateTime <EHKJOEHHBCM>k__BackingField;    // 0x0x18
    public bool <PAMIHEGIIME>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AKOPCAJJCAM
//   REQUEST  POST   api/playerevents/v1/respond   [Service.Auth]
public class AKOPCAJJCAM
{
    public long <GKBLMGOJPDO>k__BackingField;    // 0x0x10
    public GLKHPMMMBNN <FCDBNKGNEKB>k__BackingField;    // 0x0x18
}
...
public class AOLABBEPFOK
{
    public LIPMJLJHCHP <DMNEPDDPOAI>k__BackingField;    // 0x0x10
    public FMEEHHPHIFN <FGIIPDCGEMB>k__BackingField;    // 0x0x18
    public PCKFDBFNANI <CKKAANJJABK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BAIKOIOCEFH
//   (not directly referenced by a detected call)
public class BAIKOIOCEFH
{
    public int <HPFIGMJCGHN>k__BackingField;    // 0x0x10
}
...
// BFAKHOFAPDD
//   (not directly referenced by a detected call)
public class BFAKHOFAPDD
{
    public Guid <GCFCHFIJEPB>k__BackingField;    // 0x0x10
    public Guid <KFEJJPMLIIC>k__BackingField;    // 0x0x20
    public DateTime <OJAPHNCDKBA>k__BackingField;    // 0x0x30
    public List<ODLADKJHBFG> <AGCIMBCCCIK>k__BackingField;    // 0x0x38
}
...
public class BFLKEMANJFP
{
    public OGOKFBKAGIF <PKPIEFBCMFP>k__BackingField;    // 0x0x10
    public MGNHLEFLFBL <GPBGJMIKHCF>k__BackingField;    // 0x0x18
    public int <AOLCMEGIJOF>k__BackingField;    // 0x0x20
}
...
public class CAOJMHABJNB
{
    public int <BDBPNEJHHMC>k__BackingField;    // 0x0x10
    public int? <JHIALFIKFJP>k__BackingField;    // 0x0x14
    public string <HJPHHPMIPEM>k__BackingField;    // 0x0x20
    public string <FNNJPMKDHCG>k__BackingField;    // 0x0x28
}
...
public class CDBLEIAJFFI : COKACEIKMEF
{
    public List<PJEDNECPCCE> <LCIEGGGODKF>k__BackingField;    // 0x0x98
}
...
// base   : GIFMBFKGBNF
//   (not directly referenced by a detected call)
public class CDLMFHDOJNC : GIFMBFKGBNF
{
    public int <COAELFFJNMM>k__BackingField;    // 0x0x60
    public List<INGJIBNECCN> <FHGLFMGOAPH>k__BackingField;    // 0x0x68
    public List<INGJIBNECCN> <HPHKLMOBHMC>k__BackingField;    // 0x0x70
    public List<INGJIBNECCN> <MLECOCGOLCG>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// CGBHHGAIMIE
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class CGBHHGAIMIE
{
    public Dictionary<Guid, PKDKKDEAINC> <FAFMHFDBHJA>k__BackingField;    // 0x0x10
}
...
public class CNHEFJLLLHD
{
    public Guid <ACLLMAMJMFL>k__BackingField;    // 0x0x10
    public long <KBPIFCFLEHO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// COKACEIKMEF
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class COKACEIKMEF
{
    public long <GKBLMGOJPDO>k__BackingField;    // 0x0x10
    public int <KDEEOCOCGND>k__BackingField;    // 0x0x18
    public long <NIPLGILPHDP>k__BackingField;    // 0x0x20
    public long? <LGJKDEHEAFB>k__BackingField;    // 0x0x28
    public long? <MBMMEPIBCJG>k__BackingField;    // 0x0x38
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x48
    public string <IEENPNALGOB>k__BackingField;    // 0x0x50
    public string <GEMOIPAMBKL>k__BackingField;    // 0x0x58
    public DateTime <ELJHIEBNPDF>k__BackingField;    // 0x0x60
    public DateTime <IMIFJCFIEJI>k__BackingField;    // 0x0x68
    public int <OOPLGLDFEBM>k__BackingField;    // 0x0x70
    public MHKGINDLIFD <FCGAONGJAEN>k__BackingField;    // 0x0x74
    public bool <FMALOBGKPMD>k__BackingField;    // 0x0x78
    public bool <GCLCIHFNLCJ>k__BackingField;    // 0x0x79
    public EJALIIKGOHC <HONDOGAEMAI>k__BackingField;    // 0x0x7C
    public EJALIIKGOHC <EBCGCEIDGKH>k__BackingField;    // 0x0x80
    public long? <MKLANHLFCGK>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// CPEJODOKDEH
//   RESPONSE GET    api/inventions/   [Service.Auth]
//   RESPONSE GET    api/inventions/v1/personaldetails/{hOFNONJNODL}   [Service.Auth]
public class CPEJODOKDEH
{
    public bool <NCHJKJCNBLP>k__BackingField;    // 0x0x10
}
...
// DDOMHPDDMFL
//   (not directly referenced by a detected call)
public class DDOMHPDDMFL
{
    public long <DCHBOAHCIEL>k__BackingField;    // 0x0x10
    public Guid <OKKICKLLOGI>k__BackingField;    // 0x0x18
    public Guid <POCKDAEAOHD>k__BackingField;    // 0x0x28
    public DateTime <GDKDHEJKOAC>k__BackingField;    // 0x0x38
    public string <HNPBGAFAFNL>k__BackingField;    // 0x0x40
    public string <LAJNCDJFHLD>k__BackingField;    // 0x0x48
    public string <JOELFONAGNP>k__BackingField;    // 0x0x50
    public string <EAEDIPIJOEK>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// DJMLHABNFDH
//   RESPONSE GET    api/config/v1/azurespeech   [Service.Auth]
public class DJMLHABNFDH
{
    public bool <DPFGFAPELDA>k__BackingField;    // 0x0x10
    public string <OFOLNHNKEOC>k__BackingField;    // 0x0x18
    public string <AHEAFOKCDFK>k__BackingField;    // 0x0x20
}
...
public class DLEMBODNJMD
{
    public int? <JMHGKKKHMBC>k__BackingField;    // 0x0x10
    public string <LJOKHNABMPO>k__BackingField;    // 0x0x18
    public string <NHMFDLMMKKN>k__BackingField;    // 0x0x20
}
...
public class EBCANJIMLFO
{
    public BBJHLJMKPAF <CCCDLPOKEFK>k__BackingField;    // 0x0x10
    public string <PBEDJAPKKEA>k__BackingField;    // 0x0x18
    public string <CGLMOLLCJMM>k__BackingField;    // 0x0x20
    public string <HGEMGCPFIFK>k__BackingField;    // 0x0x28
    public PMEJLFDLBJL <HLDMJLADPBI>k__BackingField;    // 0x0x30
    public string <DHPICDHAJJC>k__BackingField;    // 0x0x38
    public int <KOEPJHEEDFN>k__BackingField;    // 0x0x40
    public bool <GPKKNEFMCGG>k__BackingField;    // 0x0x44
}

// --------------------------------------------------------------------------
// ECPOLNIECEA
//   (not directly referenced by a detected call)
public class ECPOLNIECEA
{
    public long <KJFPAOJHBMP>k__BackingField;    // 0x0x10
    public Guid <DOIFOCLLFNI>k__BackingField;    // 0x0x18
    public long <NIPLGILPHDP>k__BackingField;    // 0x0x28
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x30
    public string <IEENPNALGOB>k__BackingField;    // 0x0x38
    public int <HMDIAHMNKFP>k__BackingField;    // 0x0x40
    public Guid? <DABCALPKEIB>k__BackingField;    // 0x0x44
    public DateTime <GDKDHEJKOAC>k__BackingField;    // 0x0x58
    public string <GEMOIPAMBKL>k__BackingField;    // 0x0x60
    public JDAHEJJKMGO <FCDBNKGNEKB>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// EEPGLAIACPJ
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class EEPGLAIACPJ
{
    public Dictionary<Guid, JJFLHMJFICN> <LEKGPOJCBGG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EIHPFKOLKFM
//   (not directly referenced by a detected call)
public class EIHPFKOLKFM
{
    public int <NPPKGLHPFFN>k__BackingField;    // 0x0x10
    public DateTime? <FIHFHGOJJGG>k__BackingField;    // 0x0x18
    public DateTime? <EJHBPFNKPNC>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// EIKGNFJNPDN
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.WWW]
public class EIKGNFJNPDN
{
    public int <ICNLCJGNDKI>k__BackingField;    // 0x0x10
    public Guid <KBJBOMEDLBE>k__BackingField;    // 0x0x14
    public long <EFKFJHHOJHN>k__BackingField;    // 0x0x28
    public DateTime <MLCNMDCNEHJ>k__BackingField;    // 0x0x30
}
...
public class EKBIBNLBOKI
{
    public FDDOIGKGNEM <PLCFDAIJPHH>k__BackingField;    // 0x0x10
    public string <LMGNLHNCDPA>k__BackingField;    // 0x0x18
    public int? <FPMOFHJHMNB>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/keepsakes/{kOEFBEKPCLL}   [Service.Auth]
...
public class EKGPLLEBCLH
{
    public bool <HMJIACEIHJL>k__BackingField;    // 0x0x10
    public string <EPMBGJJEHJB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EMPOCEFHCGO
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.Auth]
public class EMPOCEFHCGO
{
    public string <FKILDIJPCNG>k__BackingField;    // 0x0x10
    public string <OFOLNHNKEOC>k__BackingField;    // 0x0x18
    public string <CLFONKIHPMH>k__BackingField;    // 0x0x20
    public string <IEENPNALGOB>k__BackingField;    // 0x0x28
    public string <LJOKHNABMPO>k__BackingField;    // 0x0x30
    public CGGHOLFHJDJ <DMNEPDDPOAI>k__BackingField;    // 0x0x38
    public List<string> <NCIODNOMLAA>k__BackingField;    // 0x0x40
    public List<string> <LCIEGGGODKF>k__BackingField;    // 0x0x48
    public string <HDBANFJJMBF>k__BackingField;    // 0x0x50
    public List<OLBGGJDANBF> <JBFKIDKLDLG>k__BackingField;    // 0x0x58
}
...
public class FAJCJEAJODO : MPLINKAJCON
{
    public DLDFGBEPECC? <GDJOGDDMINP>k__BackingField;    // 0x0x18
    public EIKGNFJNPDN <OOKONJCIAME>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FBHCDKNJGLL
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{oNHJKLALPDA}/{hJOBDBLHOAI}   [Service.WWW]
public class FBHCDKNJGLL
{
    public PKKAONGMOBM <BEKOIGNBGFJ>k__BackingField;    // 0x0x10
    public IEHDPBBJANB <GNFOKMEAKKH>k__BackingField;    // 0x0x14
    public int <MILKAIGPBHH>k__BackingField;    // 0x0x18
    public int <FNLJDOFEAJE>k__BackingField;    // 0x0x1C
    public int <NEBKLGDNBJO>k__BackingField;    // 0x0x20
    public FPPFCNLFJLD <FAAIPMFMOKA>k__BackingField;    // 0x0x24
    public bool <JKJILLONFKA>k__BackingField;    // 0x0x28
    public float <KJPCDMFHFDO>k__BackingField;    // 0x0x2C
    public int <BIDBHPODHCC>k__BackingField;    // 0x0x30
    public bool <AAADEANNGLK>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// FCNPCKKFLNL
// base   : CJBEHFCMECE`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class FCNPCKKFLNL
{
    // (no instance fields in the metadata dump)
}
...
public class FEBAPBGJDAG
{
    public Guid <MEJCLKOELOA>k__BackingField;    // 0x0x10
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x20
    public string <GEMOIPAMBKL>k__BackingField;    // 0x0x28
    public DateTime <OJAPHNCDKBA>k__BackingField;    // 0x0x30
    public DateTime? <CLIAHNPNIPD>k__BackingField;    // 0x0x38
    public List<BFAKHOFAPDD> <ONGFJGEIFNH>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// FFJMMMFMHCL
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{eOHPLEHPKEN}   [Service.Auth]
public class FFJMMMFMHCL
{
    public uint <FKILDIJPCNG>k__BackingField;    // 0x0x10
    public uint? <BHGBKCBBKGP>k__BackingField;    // 0x0x14
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x20
    public string <IEENPNALGOB>k__BackingField;    // 0x0x28
    public DateTime <CKGDMNJJAJJ>k__BackingField;    // 0x0x30
    public DateTime? <ECFMGBICOIP>k__BackingField;    // 0x0x38
    public bool <BBGCBKPDFDO>k__BackingField;    // 0x0x48
    public List<EMPOCEFHCGO> <DENNBCPFEKP>k__BackingField;    // 0x0x50
    public List<string> <LCIEGGGODKF>k__BackingField;    // 0x0x58
    public int <JPJJIMGHDIB>k__BackingField;    // 0x0x60
    public int <KMALJCIMEHP>k__BackingField;    // 0x0x64
    public int <DMBDJBFKEAP>k__BackingField;    // 0x0x68
}
...
// FMEEHHPHIFN
//   (not directly referenced by a detected call)
public class FMEEHHPHIFN
{
    public ObscuredLong <KFGOPFLKIIM>k__BackingField;    // 0x0x10
    public string <DOIFOCLLFNI>k__BackingField;    // 0x0x38
    public ObscuredInt <AIOEKEOOMFA>k__BackingField;    // 0x0x40
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x58
    public string <IEENPNALGOB>k__BackingField;    // 0x0x60
    public string <GEMOIPAMBKL>k__BackingField;    // 0x0x68
    public byte <ICOJBKBBLMF>k__BackingField;    // 0x0x70
    public int <JHGNBJLAKAB>k__BackingField;    // 0x0x74
    public HGEBMGKCJPN <FCGAONGJAEN>k__BackingField;    // 0x0x78
    public bool <NLIJBDEOPPI>k__BackingField;    // 0x0x7C
    public DateTime <MLCNMDCNEHJ>k__BackingField;    // 0x0x80
    public DateTime <GDKDHEJKOAC>k__BackingField;    // 0x0x88
    public DateTime? <PAHDLIHAKBH>k__BackingField;    // 0x0x90
    public long? <MBHDAAPEDLI>k__BackingField;    // 0x0xA0
    public int <IKGDFFMABAF>k__BackingField;    // 0x0xB0
    public int <GEGCEPCIMIA>k__BackingField;    // 0x0xB4
    public int <MAIJHIEPOHP>k__BackingField;    // 0x0xB8
    public NINLFAGHLLK <OJCDCHOHDDC>k__BackingField;    // 0x0xBC
    public NINLFAGHLLK <LFHBFBCNDAJ>k__BackingField;    // 0x0xC0
    public ObscuredBool <CALFLFFMPBD>k__BackingField;    // 0x0xC4
    public ObscuredBool <PLIMMBJHLDG>k__BackingField;    // 0x0xD0
    public ObscuredBool <LHNFKBNOAMA>k__BackingField;    // 0x0xDC
    public int? <HMDIAHMNKFP>k__BackingField;    // 0x0xE8
    public bool <DOKOIFKJFEE>k__BackingField;    // 0x0xF0
}

// --------------------------------------------------------------------------
// FOMHCMDLPPC
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.Auth]
public class FOMHCMDLPPC
{
    public List<COKACEIKMEF> <POMFFHNIKPO>k__BackingField;    // 0x0x10
    public string <DPOMDDDHCBI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FPNAAODOCCF
//   (not directly referenced by a detected call)
public class FPNAAODOCCF
{
    // (no instance fields in the metadata dump)
}
...
public class GFBMNHNJDEI
{
    public List<string> <MLNGALGADCJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GHANCJLMLGL
//   (not directly referenced by a detected call)
public class GHANCJLMLGL
{
    public PKKAONGMOBM <BEKOIGNBGFJ>k__BackingField;    // 0x0x10
    public int <HMDIAHMNKFP>k__BackingField;    // 0x0x14
    public EIHPFKOLKFM <FEELOLKBOKE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GIFMBFKGBNF
//   (not directly referenced by a detected call)
public class GIFMBFKGBNF
{
    public int <DBJIADGCOHG>k__BackingField;    // 0x0x10
    public BJGJBOBGHIL <FCDBNKGNEKB>k__BackingField;    // 0x0x14
    public List<GHANCJLMLGL> <NDBDGOHLOHK>k__BackingField;    // 0x0x18
    public List<GHANCJLMLGL> <OCIEHKEPCFP>k__BackingField;    // 0x0x20
    public bool <MIBMIJCPMJK>k__BackingField;    // 0x0x28
    public DateTime? <NHDCIJCPJNP>k__BackingField;    // 0x0x30
    public DateTime? <HBBMAKDIADC>k__BackingField;    // 0x0x40
    public DateTime? <KJCGCJIPKFK>k__BackingField;    // 0x0x50
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{cEBCBAJGGEE}   [Service.WWW]
public enum GJGJANEJDLB
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class GKELGEECLOD
{
    public Guid <KBJBOMEDLBE>k__BackingField;    // 0x0x10
    public int <KABDEGMCMMG>k__BackingField;    // 0x0x20
    public long <FFCAEHCCOHC>k__BackingField;    // 0x0x28
    public Guid <ACLLMAMJMFL>k__BackingField;    // 0x0x30
}
...
// GMFHHBFIOHK
//   (not directly referenced by a detected call)
public class GMFHHBFIOHK
{
    public int <HHDAGLFIBEO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GMJLPJNAPHL
//   (not directly referenced by a detected call)
public class GMJLPJNAPHL
{
    public float <KEAHLNMBJPB>k__BackingField;    // 0x0x10
    public float <ALCAABCOEMI>k__BackingField;    // 0x0x14
    public float <CCFFNOECOPO>k__BackingField;    // 0x0x18
    public float <MIMKMMNHAGA>k__BackingField;    // 0x0x1C
    public float <NPPNAMNFLNC>k__BackingField;    // 0x0x20
    public float <LMLDPBEMHPP>k__BackingField;    // 0x0x24
    public float <AALOJHDPEMM>k__BackingField;    // 0x0x28
    public float <ALFLEBAPCGL>k__BackingField;    // 0x0x2C
}
...
public class HFNEABBBMKL : MPLINKAJCON
{
    public LMBDCNBPJHC? <GDJOGDDMINP>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <ELPLDJOPNMN>k__BackingField;    // 0x0x20
}
...
public class HGOKKCOHLDD
{
    public NNFDMDJDEDD <NPDBIMGAHBP>k__BackingField;    // 0x0x10
    public List<string> <LCIEGGGODKF>k__BackingField;    // 0x0x18
}
...
public class HNDEOJGEBOL
{
    public string <MABICPGFAOJ>k__BackingField;    // 0x0x10
    public string <AGGHLGDFCKG>k__BackingField;    // 0x0x18
    public string <CGLMOLLCJMM>k__BackingField;    // 0x0x20
    public string <HGEMGCPFIFK>k__BackingField;    // 0x0x28
    public PMEJLFDLBJL <HLDMJLADPBI>k__BackingField;    // 0x0x30
    public bool CJJLAGOFMFN;    // 0x0x34
    public bool <DCACAJJIHBB>k__BackingField;    // 0x0x35
}

// --------------------------------------------------------------------------
// HNOAAJOMNLD
//   REQUEST  POST   api/challenge/v2/updateProgress   [Service.WWW]
public class HNOAAJOMNLD
{
    public int <MECJBDIKAOI>k__BackingField;    // 0x0x10
    public int <GFKBLMKFKLG>k__BackingField;    // 0x0x14
    public string <EJGFKBGLCBF>k__BackingField;    // 0x0x18
    public bool <KALKCCFCFHH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ICIEHOCIGDK
//   (not directly referenced by a detected call)
public class ICIEHOCIGDK
{
    public Guid <JGFJCGMOJAN>k__BackingField;    // 0x0x10
    public int <ICNLCJGNDKI>k__BackingField;    // 0x0x20
    public int <AGBIFBIDMBC>k__BackingField;    // 0x0x24
    public Guid <BNBFLOGICJL>k__BackingField;    // 0x0x28
    public DateTime <MLCNMDCNEHJ>k__BackingField;    // 0x0x38
    public KCCNFDNBKMP <GFECDHIEIOB>k__BackingField;    // 0x0x40
}
...
public class IEOFNOLOHPL
{
    public Dictionary<int, int> <MHNOOFNDHGG>k__BackingField;    // 0x0x10
    public List<HDKKJEFHDPF> <IMBPGBEHOCD>k__BackingField;    // 0x0x18
    public PKOIPHPDHED[][] <NLAFOCAOFCP>k__BackingField;    // 0x0x20
    public PLNFFHPLDLM <JJHJLLGHCIM>k__BackingField;    // 0x0x28
    public GMJLPJNAPHL <KJANHEHNOCN>k__BackingField;    // 0x0x30
    public GMFHHBFIOHK <IGPMHNGGDKH>k__BackingField;    // 0x0x38
    public BAIKOIOCEFH <BFJOPPHPEHE>k__BackingField;    // 0x0x40
    public NDHIFADFMGJ <IFFHEJBMLCG>k__BackingField;    // 0x0x48
    public string <HAELBDAJBKJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// ILJAJGDABOF
//   (not directly referenced by a detected call)
public class ILJAJGDABOF
{
    public int <JKHGJLOCLPI>k__BackingField;    // 0x0x10
    public NKICKCBDNMF <NPDBIMGAHBP>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// INGJIBNECCN
//   (not directly referenced by a detected call)
public class INGJIBNECCN
{
    public bool <INEBFNLGEHF>k__BackingField;    // 0x0x10
    public ODLADKJHBFG <ONNPJDCFODK>k__BackingField;    // 0x0x18
    public float <IDIKNNACAKG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// INIOJDKDDHB
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItems/v2   [Service.Notifications]
public class INIOJDKDDHB
{
    public byte <PAMDNLDNLDB>k__BackingField;    // 0x0x10
    public int <HPPOKECHLBG>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// JAHBCMBAMHO
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.WWW]
public class JAHBCMBAMHO
{
    public int ABJHJBIDKLL;    // 0x0x10
    public long GMNCGKLNHEJ;    // 0x0x18
}

// --------------------------------------------------------------------------
// JCCFBDNHMBB
//   RESPONSE GET    api/playerevents/v1/all   [Service.Auth]
//   RESPONSE GET    api/playerevents/v1/all/{cJALAELDLAM}   [Service.Auth]
public class JCCFBDNHMBB
{
    public List<COKACEIKMEF> <LFJLBOCNDME>k__BackingField;    // 0x0x10
    public List<OHKKMDNKJFG> <IPJMOHDBDAO>k__BackingField;    // 0x0x18
}
...
public class JGGLNNFNNMH
{
    public int <KFIFLNMCODH>k__BackingField;    // 0x0x10
    public IFHNPPOGGBL <FCDBNKGNEKB>k__BackingField;    // 0x0x14
    public FIJGLBCCGOA <JLIFPPIPLJF>k__BackingField;    // 0x0x18
    public FIJGLBCCGOA <DHCDPACNFBG>k__BackingField;    // 0x0x1C
    public FIJGLBCCGOA <GICCLNALJNL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JJFLHMJFICN
//   (not directly referenced by a detected call)
public class JJFLHMJFICN
{
    public int <AOLCMEGIJOF>k__BackingField;    // 0x0x10
    public OGOKFBKAGIF <PKPIEFBCMFP>k__BackingField;    // 0x0x18
}
...
public class JPKELOJMELG
{
    public long <NIPLGILPHDP>k__BackingField;    // 0x0x10
    public long? <LGJKDEHEAFB>k__BackingField;    // 0x0x18
    public long? <MBMMEPIBCJG>k__BackingField;    // 0x0x28
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x38
    public string <IEENPNALGOB>k__BackingField;    // 0x0x40
    public List<string> <LCIEGGGODKF>k__BackingField;    // 0x0x48
    public string <GEMOIPAMBKL>k__BackingField;    // 0x0x50
    public DateTime <ELJHIEBNPDF>k__BackingField;    // 0x0x58
    public DateTime <IMIFJCFIEJI>k__BackingField;    // 0x0x60
    public MHKGINDLIFD <FCGAONGJAEN>k__BackingField;    // 0x0x68
    public bool <FMALOBGKPMD>k__BackingField;    // 0x0x6C
    public bool <GCLCIHFNLCJ>k__BackingField;    // 0x0x6D
    public EJALIIKGOHC <HONDOGAEMAI>k__BackingField;    // 0x0x70
    public EJALIIKGOHC <EBCGCEIDGKH>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// KCCNFDNBKMP
//   (not directly referenced by a detected call)
public class KCCNFDNBKMP
{
    public Guid <JGFJCGMOJAN>k__BackingField;    // 0x0x10
    public long <NIPLGILPHDP>k__BackingField;    // 0x0x20
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x28
    public string <IEENPNALGOB>k__BackingField;    // 0x0x30
    public string <GEMOIPAMBKL>k__BackingField;    // 0x0x38
    public long <HMDIAHMNKFP>k__BackingField;    // 0x0x40
    public Guid? <DABCALPKEIB>k__BackingField;    // 0x0x48
    public DateTime <MLCNMDCNEHJ>k__BackingField;    // 0x0x60
    public int <BPDJMAGANEA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// KDLGNMCKMOD
//   (not directly referenced by a detected call)
public class KDLGNMCKMOD
{
    public bool <CKCNGOMGMCH>k__BackingField;    // 0x0x10
    public NLLBNCBCMJP <LIMIDHOJDGD>k__BackingField;    // 0x0x14
    public int <NKHHJAEFIEK>k__BackingField;    // 0x0x18
    public DateTime <MLCNMDCNEHJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KFJBNPPMGCO
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.WWW]
public class KFJBNPPMGCO
{
    public List<int> <HLDFMLDKAAO>k__BackingField;    // 0x0x10
    public string <DPOMDDDHCBI>k__BackingField;    // 0x0x18
}
...
// base   : FOCMHPKNCDL
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/season/{cENGNBMOAJL}   [Service.WWW]
public class KGOKFJKCHFG : FOCMHPKNCDL
{
    public int <AALDIOMKNFM>k__BackingField;    // 0x0x30
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x38
    public DateTime <OJAPHNCDKBA>k__BackingField;    // 0x0x40
    public DateTime <CIOKOELCGKM>k__BackingField;    // 0x0x48
    public PKKAONGMOBM <BEKOIGNBGFJ>k__BackingField;    // 0x0x50
    public GIFMBFKGBNF <DHJDCFFMHFI>k__BackingField;    // 0x0x58
    public List<CDLMFHDOJNC> <FAEBLNDKAMF>k__BackingField;    // 0x0x60
    public KDLGNMCKMOD <FBOJIHGKGOC>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// KHKCEJGDBGO
//   (not directly referenced by a detected call)
public class KHKCEJGDBGO
{
    public long <PGJOFEDOKLA>k__BackingField;    // 0x0x10
    public string <FOIJIHABAMO>k__BackingField;    // 0x0x18
    public string <NAKHHDMCIOC>k__BackingField;    // 0x0x20
    public BBJHLJMKPAF? <CCCDLPOKEFK>k__BackingField;    // 0x0x28
    public string <CMONDDFMBND>k__BackingField;    // 0x0x30
    public string <AINBMDEOOIM>k__BackingField;    // 0x0x38
    public JJNPCNJONGG <EJGNMDILFBE>k__BackingField;    // 0x0x40
    public int <KPCKAJLCIEN>k__BackingField;    // 0x0x44
    public int <MPKNOMILJHB>k__BackingField;    // 0x0x48
    public DNPGJPDMPJM? <FINPOKIDMIN>k__BackingField;    // 0x0x4C
    public PMEJLFDLBJL? <BPANFGDPMDO>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// KIAMOBIGEKG
//   (not directly referenced by a detected call)
public class KIAMOBIGEKG
{
    public int <ONPDFBIMFJC>k__BackingField;    // 0x0x10
    public DateTime <GDKDHEJKOAC>k__BackingField;    // 0x0x18
    public DateTime? <BDFMDPFAIIP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KJJKOPIBIBB
//   RESPONSE GET    api/inventions/v1/details   [Service.Auth]
public class KJJKOPIBIBB
{
    public List<PJEDNECPCCE> <LCIEGGGODKF>k__BackingField;    // 0x0x10
}
...
public class KKPHEEPCGAE
{
    public List<string> <CGEKAGNEJCF>k__BackingField;    // 0x0x10
    public List<string> <JMBPPKGOBAP>k__BackingField;    // 0x0x18
    public List<string> <JEGFBBDGOLP>k__BackingField;    // 0x0x20
}
...
public class KNDOEJABIBD
{
    public GJGJANEJDLB <DMNEPDDPOAI>k__BackingField;    // 0x0x10
    public ECPOLNIECEA <IBCKOCIMCEI>k__BackingField;    // 0x0x18
}
...
public class KNFHOOMBCLG
{
    public bool <HMJIACEIHJL>k__BackingField;    // 0x0x10
    public string <BFMHJHKNLGL>k__BackingField;    // 0x0x18
}
...
public class KOPGIDNNCIE
{
    public Dictionary<string, DDOMHPDDMFL> <INMEMBJLAGI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LALHBGBMHLG
//   (not directly referenced by a detected call)
public class LALHBGBMHLG
{
    public long <LLIHIBNOEIL>k__BackingField;    // 0x0x10
    public long <GKBLMGOJPDO>k__BackingField;    // 0x0x18
    public int <FKLAGAIBKBC>k__BackingField;    // 0x0x20
    public DateTime <GDKDHEJKOAC>k__BackingField;    // 0x0x28
    public GLKHPMMMBNN <FCDBNKGNEKB>k__BackingField;    // 0x0x30
}
...
public class LBHFFOHAHEA : FOCMHPKNCDL
{
    public string <NACPCIFPGDH>k__BackingField;    // 0x0x30
    public List<LBOOGGHIMOC> NFJICHKADAJ;    // 0x0x38
    public int <AAOLGEMHAEC>k__BackingField;    // 0x0x40
}
...
// base   : GIFMBFKGBNF
//   (not directly referenced by a detected call)
public class LBOOGGHIMOC : GIFMBFKGBNF
{
    public ODLADKJHBFG <ONNPJDCFODK>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// LFCFIFBPOIJ
// base   : CJBEHFCMECE`1<IGKEFAKFOEN>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{mOOLAGJMMGM}   [Service.Auth]
public class LFCFIFBPOIJ
{
    // (no instance fields in the metadata dump)
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{bODPMGLKFEG}   [Service.WWW]
public class LPFIJDHCNEE
{
    public BPJLNGPKJGB <DMNEPDDPOAI>k__BackingField;    // 0x0x10
    public KCCNFDNBKMP <GFECDHIEIOB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MCDBCOKKGCK
//   REQUEST  ?      api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItemDescs   [Service.Notifications]
public class MCDBCOKKGCK
{
    public List<string> <CINIOLBFPPM>k__BackingField;    // 0x0x10
    public byte <PAMDNLDNLDB>k__BackingField;    // 0x0x18
    public int <HPPOKECHLBG>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// MEAKOIKCFDP
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.WWW]
public class MEAKOIKCFDP
{
    public long <NIPLGILPHDP>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <LGOGCIGIHDC>k__BackingField;    // 0x0x18
    public NBGHJCOCKPC <MAMGGHJCHKG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MGNHLEFLFBL
//   (not directly referenced by a detected call)
public class MGNHLEFLFBL
{
    public long <HMDIAHMNKFP>k__BackingField;    // 0x0x10
    public Guid? <KBJBOMEDLBE>k__BackingField;    // 0x0x18
}
...
public class MJMHOMADPIA
{
    public long <KJFPAOJHBMP>k__BackingField;    // 0x0x10
    public int <ICNLCJGNDKI>k__BackingField;    // 0x0x18
}
...
public class NCMGLBOGKJK
{
    public BGGDGBDEHKI <PLCFDAIJPHH>k__BackingField;    // 0x0x10
    public int <INPLLAPNNAF>k__BackingField;    // 0x0x14
    public long <HOEJNHENJGI>k__BackingField;    // 0x0x18
    public bool <JOOEFJDKIKO>k__BackingField;    // 0x0x20
    public string <BFMHJHKNLGL>k__BackingField;    // 0x0x28
    public int? <INDMCGLGLHD>k__BackingField;    // 0x0x30
    public bool <KEACFDJEADH>k__BackingField;    // 0x0x38
    public bool <FLOJEDALNFI>k__BackingField;    // 0x0x39
    public bool <CENMGBHDMEO>k__BackingField;    // 0x0x3A
    public bool <MJBMDMKNGKD>k__BackingField;    // 0x0x3B
    public string <PEMDHOJJKEL>k__BackingField;    // 0x0x40
    public DateTime? <PLIMMNPBFFI>k__BackingField;    // 0x0x48
    public string <HBONLKCEFFC>k__BackingField;    // 0x0x58
    public float <AJAHJMENIHL>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// NDHIFADFMGJ
//   (not directly referenced by a detected call)
public class NDHIFADFMGJ
{
    public float <FCBPDBABHBG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NFAHFDIHNOL
//   (not directly referenced by a detected call)
public class NFAHFDIHNOL
{
    public int <GFKBLMKFKLG>k__BackingField;    // 0x0x10
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x18
    public string <EJGFKBGLCBF>k__BackingField;    // 0x0x20
    public string <IEENPNALGOB>k__BackingField;    // 0x0x28
    public string <HGEMGCPFIFK>k__BackingField;    // 0x0x30
    public bool <KALKCCFCFHH>k__BackingField;    // 0x0x38
    public int <IOLAGPEHGLG>k__BackingField;    // 0x0x3C
    public FPNAAODOCCF <KHBBIMAGFKH>k__BackingField;    // 0x0x40
    public OEINMAJNDOG GKPMLEMFCJC;    // 0x0x48
    public OEINMAJNDOG FHJAAODBJLJ;    // 0x0x50
    public OEINMAJNDOG MLPFHMKMFAM;    // 0x0x58
    public OCPEAPPEIAL OKJOMNPGFGO;    // 0x0x60
}
...
public class NJPJKEMKBEG
{
    public string <HHGCBGMCPPE>k__BackingField;    // 0x0x10
    public string <BLGAECNMNDK>k__BackingField;    // 0x0x18
    public bool <LHDHENAAKNF>k__BackingField;    // 0x0x20
    public string <ANPDPFLDBBG>k__BackingField;    // 0x0x28
}
...
public class OAHAEOJDNKJ
{
    public BGGDGBDEHKI <PLCFDAIJPHH>k__BackingField;    // 0x0x10
    public long <GKBLMGOJPDO>k__BackingField;    // 0x0x18
    public string <LMGNLHNCDPA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OAONJCCFJNE
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.WWW]
public class OAONJCCFJNE
{
    public List<KIAMOBIGEKG> <NHBCOCHNJCM>k__BackingField;    // 0x0x10
    public string <DPOMDDDHCBI>k__BackingField;    // 0x0x18
}
...
// ODLADKJHBFG
//   (not directly referenced by a detected call)
public class ODLADKJHBFG
{
    public int <PGJOFEDOKLA>k__BackingField;    // 0x0x10
    public string <CGLMOLLCJMM>k__BackingField;    // 0x0x18
    public string <HGEMGCPFIFK>k__BackingField;    // 0x0x20
    public string <DHPICDHAJJC>k__BackingField;    // 0x0x28
    public string <FOIJIHABAMO>k__BackingField;    // 0x0x30
    public string <CABKKJEPLBM>k__BackingField;    // 0x0x38
    public BBJHLJMKPAF? <CCCDLPOKEFK>k__BackingField;    // 0x0x40
    public string <CMONDDFMBND>k__BackingField;    // 0x0x48
    public string <AINBMDEOOIM>k__BackingField;    // 0x0x50
    public bool <KBKOCHCAFCH>k__BackingField;    // 0x0x58
    public bool <KCOKABOOJOE>k__BackingField;    // 0x0x59
    public bool <FGHKJFAPMCH>k__BackingField;    // 0x0x5A
    public PMEJLFDLBJL <HLDMJLADPBI>k__BackingField;    // 0x0x5C
    public PKKAONGMOBM <BEKOIGNBGFJ>k__BackingField;    // 0x0x60
    public int <NPKBFLKEBFJ>k__BackingField;    // 0x0x64
    public LOFJOKAAHBK <GNIAGLLBCJM>k__BackingField;    // 0x0x68
    public DNPGJPDMPJM <LIIMEBLEJPG>k__BackingField;    // 0x0x6C
    public int? <EHLMPJNEMOF>k__BackingField;    // 0x0x70
    public string <HOKJDHJFPBD>k__BackingField;    // 0x0x78
    public int? <KOEPJHEEDFN>k__BackingField;    // 0x0x80
    public int? <DFGENFFPPDC>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// OGOKFBKAGIF
//   REQUEST  PUT    api/roomconsumables   [Service.WWW]
public class OGOKFBKAGIF
{
    public Guid? <DCGAEOCPNJC>k__BackingField;    // 0x0x10
    public Guid <KOFHEDBIBGO>k__BackingField;    // 0x0x24
}
...
public class OHFNHNMJIBM
{
    public CDBLEIAJFFI <HGHOPDLNPID>k__BackingField;    // 0x0x10
    public NKICKCBDNMF <NPDBIMGAHBP>k__BackingField;    // 0x0x18
    public HGOKKCOHLDD <NGCMKAJOGDG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OHKKMDNKJFG
//   (not directly referenced by a detected call)
public class OHKKMDNKJFG
{
    public COKACEIKMEF <HGHOPDLNPID>k__BackingField;    // 0x0x10
    public LALHBGBMHLG <BCLGLOFBEJN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OLBGGJDANBF
//   (not directly referenced by a detected call)
public class OLBGGJDANBF
{
    public DateTime <GDKDHEJKOAC>k__BackingField;    // 0x0x10
    public string <DJMGOHDOKKG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OOMOMFOJCEH
//   RESPONSE GET    api/config/v1/backtrace   [Service.Auth]
public class OOMOMFOJCEH
{
    public int <PELKFGALMGA>k__BackingField;    // 0x0x10
    public int <PIGHEMAMBGE>k__BackingField;    // 0x0x14
    public float <EGKMHCNDKMP>k__BackingField;    // 0x0x18
    public int <AILOMHCDKMI>k__BackingField;    // 0x0x1C
    public int <FODJIFOBNFP>k__BackingField;    // 0x0x20
    public int <AJCJPLEAIFJ>k__BackingField;    // 0x0x24
    public int <NHCPJOPPLJH>k__BackingField;    // 0x0x28
    public string <MGLPLLFEGDM>k__BackingField;    // 0x0x30
    public string <OGGOCIOLPLP>k__BackingField;    // 0x0x38
}
...
public class PAHDHBAFLIB
{
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x10
    public string <IEENPNALGOB>k__BackingField;    // 0x0x18
    public int? <HMDIAHMNKFP>k__BackingField;    // 0x0x20
    public HGEBMGKCJPN? <FCGAONGJAEN>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// PBOHOEIBKIN
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.WWW]
public class PBOHOEIBKIN
{
    public int <INPLLAPNNAF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PCKFDBFNANI
//   (not directly referenced by a detected call)
public class PCKFDBFNANI
{
    public long <JCHNFJKLDAA>k__BackingField;    // 0x0x10
    public string <DOIFOCLLFNI>k__BackingField;    // 0x0x18
    public int <AAAFMHPHNDK>k__BackingField;    // 0x0x20
    public int <LEHMABIHPDA>k__BackingField;    // 0x0x24
    public int <CPCFCAKEPJL>k__BackingField;    // 0x0x28
    public int <JNAKDBMFDOF>k__BackingField;    // 0x0x2C
    public int <KPEMDFBFACE>k__BackingField;    // 0x0x30
    public string <MGILHMEPJLM>k__BackingField;    // 0x0x38
    public string <HHDNDPIGMHC>k__BackingField;    // 0x0x40
}
...
public class PDLAEOEGGAL
{
    public int <CJMGCEADFOG>k__BackingField;    // 0x0x10
    public int <IBGOGDJNEEL>k__BackingField;    // 0x0x14
    public float <KJNOEHIJOJA>k__BackingField;    // 0x0x18
    public float <CGDHHJPIDHJ>k__BackingField;    // 0x0x1C
    public bool <AMJPJMNEAMC>k__BackingField;    // 0x0x20
    public bool <LGFKCJKGFJO>k__BackingField;    // 0x0x21
    public bool <DCACAJJIHBB>k__BackingField;    // 0x0x22
}
...
//   RESPONSE POST   api/progressionEvents/collect/{aCBPAGONDJA}/{pMKLJPJMKDL}   [Service.Auth]
public class PHHPGKIMNOM
{
    public long? <FKILDIJPCNG>k__BackingField;    // 0x0x10
    public int <FKLAGAIBKBC>k__BackingField;    // 0x0x20
    public int? <JPPEPHBKDPG>k__BackingField;    // 0x0x24
    public string <FOIJIHABAMO>k__BackingField;    // 0x0x30
    public BBJHLJMKPAF? <CCCDLPOKEFK>k__BackingField;    // 0x0x38
    public string <CABKKJEPLBM>k__BackingField;    // 0x0x40
    public string <CMONDDFMBND>k__BackingField;    // 0x0x48
    public string <AINBMDEOOIM>k__BackingField;    // 0x0x50
    public PKKAONGMOBM <BEKOIGNBGFJ>k__BackingField;    // 0x0x58
    public int <NPKBFLKEBFJ>k__BackingField;    // 0x0x5C
    public int <KPCKAJLCIEN>k__BackingField;    // 0x0x60
    public DNPGJPDMPJM <FINPOKIDMIN>k__BackingField;    // 0x0x64
    public PMEJLFDLBJL <BPANFGDPMDO>k__BackingField;    // 0x0x68
    public string <PDAFCJCNNPL>k__BackingField;    // 0x0x70
    public BHFMDLIGJGB <HADDNGOILLG>k__BackingField;    // 0x0x78
    public NLLBNCBCMJP <KFFHFMFFAIN>k__BackingField;    // 0x0x7C
    public HLLFEMNDBPC? <NAKPBAPKKFO>k__BackingField;    // 0x0x80
    public bool <NNMGFCJNKBK>k__BackingField;    // 0x0x88
    public bool <IIIKJMMCCNJ>k__BackingField;    // 0x0x89
    public string <OEBHOOMCJFC>k__BackingField;    // 0x0x90
    public bool <LPJBPKCNDMP>k__BackingField;    // 0x0x98
    public bool JFPDLCEKBIB;    // 0x0x99
}

// --------------------------------------------------------------------------
// PJEDNECPCCE
//   (not directly referenced by a detected call)
public class PJEDNECPCCE
{
    public string <PGAMNKLHALP>k__BackingField;    // 0x0x10
    public FJHKDCHJLGB <FCDBNKGNEKB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PKDKKDEAINC
//   RESPONSE PUT    api/roomconsumables   [Service.WWW]
public class PKDKKDEAINC
{
    public BPJLNGPKJGB <DMNEPDDPOAI>k__BackingField;    // 0x0x10
    public ICIEHOCIGDK <CFOLEKCJLJF>k__BackingField;    // 0x0x18
}
...
// PKOIPHPDHED
//   (not directly referenced by a detected call)
public class PKOIPHPDHED
{
    public CBAPEBENDKM CPODIELMANA;    // 0x0x10
    public int GDCGMHDIEGF;    // 0x0x14
}

// --------------------------------------------------------------------------
// PLNFFHPLDLM
//   (not directly referenced by a detected call)
public class PLNFFHPLDLM
{
    public int <HLPFMCPBBOO>k__BackingField;    // 0x0x10
}
...
public class AddKeepsakeInstanceRequest
{
    public long <NIPLGILPHDP>k__BackingField;    // 0x0x10
    public long? <LGJKDEHEAFB>k__BackingField;    // 0x0x18
    public JNKBGACMLPG <FHOFLAFMKOH>k__BackingField;    // 0x0x28
}
...
{
    public LIPKJMPLDAK <NPDBIMGAHBP>k__BackingField;    // 0x0x10
    public string <AGMCEFJHIEB>k__BackingField;    // 0x0x18
    public string <NMDBOAIEMIB>k__BackingField;    // 0x0x20
    public string <JPKONCHGGIE>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public PKKAONGMOBM <CurrencyType>k__BackingField;    // 0x0x18
    public HLLFEMNDBPC <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <GKBLMGOJPDO>k__BackingField;    // 0x0x10
    public long? <LKEOFCNGPKA>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public FOFMJAJCGFN FilterType;    // 0x0x20
...
{
    public JNKBGACMLPG <IENONEIOEFA>k__BackingField;    // 0x0x10
    public string <JIEIEEIJBBL>k__BackingField;    // 0x0x18
    public int <IGEBBIEBACJ>k__BackingField;    // 0x0x20
    public int <MMJIPLPFNIP>k__BackingField;    // 0x0x24
    public string <BMCPFOEPOII>k__BackingField;    // 0x0x28
    public string <CDIFIBKMJGD>k__BackingField;    // 0x0x30
}
...
{
    public int <ICNLCJGNDKI>k__BackingField;    // 0x0x10
    public Guid <HNKOLNEKCLC>k__BackingField;    // 0x0x14
    public DateTime <FPAGBFHHKEH>k__BackingField;    // 0x0x28
}
...
{
    public bool <LGGEPAHMNLN>k__BackingField;    // 0x0x10
    public int <GJCEGDPKHGD>k__BackingField;    // 0x0x14
    public bool <FLKHPCIJDKI>k__BackingField;    // 0x0x18
}
...
{
    public Guid <HNKOLNEKCLC>k__BackingField;    // 0x0x10
    public JNKBGACMLPG <DIBNEECLKND>k__BackingField;    // 0x0x20
    public int <BLAKHEHFOPN>k__BackingField;    // 0x0x24
    public long <NIPLGILPHDP>k__BackingField;    // 0x0x28
    public long? <LGJKDEHEAFB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{aONOECEFMDJ}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <EKDOMBMHFNA>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <GAJACCLOOFE>k__BackingField;    // 0x0x18
}
...
{
    public long <DKNKICGEKLG>k__BackingField;    // 0x0x10
    public long <NIPLGILPHDP>k__BackingField;    // 0x0x18
    public long <OOCAILJBHON>k__BackingField;    // 0x0x20
    public CPIEBNKLFFL <FCDBNKGNEKB>k__BackingField;    // 0x0x28
    public int <IKOGEIKBCCK>k__BackingField;    // 0x0x2C
}
...
{
    public long <NIPLGILPHDP>k__BackingField;    // 0x0x10
    public List<Guid> <EBFCHBKMCHL>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <EKDOMBMHFNA>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <GAJACCLOOFE>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <ILAFKCFHCMD>k__BackingField;    // 0x0x20
}
...
{
    public long <OOCAILJBHON>k__BackingField;    // 0x0x10
    public long <FGHLDEPAKLE>k__BackingField;    // 0x0x18
    public int? <ALIOKEJMIKO>k__BackingField;    // 0x0x20
    public int? <NBGDAKJMJIB>k__BackingField;    // 0x0x28
    public long? <FGPPGGDFIIP>k__BackingField;    // 0x0x30
    public long <GCGIMKDLGBL>k__BackingField;    // 0x0x40
    public long <CONAFEOFLKF>k__BackingField;    // 0x0x48
    public int <BCMKEELGJFM>k__BackingField;    // 0x0x50
    public CPIEBNKLFFL <LFGKCIPFNPJ>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <FCJLPKHPOEL>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public DNPGJPDMPJM <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public NBFABDGBKDO creatorAccountRole;    // 0x0x58
}
...
{
    public CBHBLKFCLEK <MAGBKAJIOIK>k__BackingField;    // 0x0x10
    public IFNKLLGMJIF <BCLHJEEKHPI>k__BackingField;    // 0x0x14
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x18
    public string <IEENPNALGOB>k__BackingField;    // 0x0x20
    public bool <CCCNMKGDCKG>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<CBHBLKFCLEK> <DKFHLGKONFO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{aCBPAGONDJA}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <FGHLDEPAKLE>k__BackingField;    // 0x0x10
    public string <BAIMJDMCHOP>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <MLECOCGOLCG>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <NOAHLHAICKD>k__BackingField;    // 0x0x28
    public DateTime <ELJHIEBNPDF>k__BackingField;    // 0x0x30
    public DateTime <IMIFJCFIEJI>k__BackingField;    // 0x0x38
    public DateTime <LAKLBIEOPKA>k__BackingField;    // 0x0x40
    public bool <BFCCCIGNNLF>k__BackingField;    // 0x0x48
    public int <OOBDLNODEPO>k__BackingField;    // 0x0x4C
    public float <NPKOOCBCJII>k__BackingField;    // 0x0x50
    public Guid? <KBIKKKDKMEE>k__BackingField;    // 0x0x54
    public string <DHEJKHDNCAO>k__BackingField;    // 0x0x68
    public string <OBKOOGDCJOK>k__BackingField;    // 0x0x70
    public string <HBLJKFLLDKG>k__BackingField;    // 0x0x78
    public string <NDKDDMDOBLA>k__BackingField;    // 0x0x80
}
...
{
    public Guid <BAADNBFHALL>k__BackingField;    // 0x0x10
    public int <BPGGKCJJIKO>k__BackingField;    // 0x0x20
    public int <OIOPLIPIIKE>k__BackingField;    // 0x0x24
    public int <KKNKHEAFFGL>k__BackingField;    // 0x0x28
    public long <MANHGJFBBHA>k__BackingField;    // 0x0x30
    public long <IJFPBLLFNDP>k__BackingField;    // 0x0x38
}
...
{
    public int <ICNLCJGNDKI>k__BackingField;    // 0x0x10
    public int <KPCKAJLCIEN>k__BackingField;    // 0x0x14
    public int <NNBMKLLEHKJ>k__BackingField;    // 0x0x18
    public int <AHJOFPCFLIM>k__BackingField;    // 0x0x1C
    public int <GMJMJNEAHPN>k__BackingField;    // 0x0x20
    public DateTime? <KFCIPPPGAEH>k__BackingField;    // 0x0x28
}
...
{
    public long <LGDBAJLOOPD>k__BackingField;    // 0x0x10
    public int <PGJOFEDOKLA>k__BackingField;    // 0x0x18
    public string <GEMOIPAMBKL>k__BackingField;    // 0x0x20
    public int <KPCKAJLCIEN>k__BackingField;    // 0x0x28
    public int <BJHJEPOBLLM>k__BackingField;    // 0x0x2C
    public bool <PJMFPGGALFC>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public FBADNDMHBGB ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool EDOODDKGALG;    // 0x0x28
}
...
{
    public PCEEFENLFML? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [Auth POST]
public class PlayerCheerV1CreateRequest
{
    public PCEEFENLFML MCALNLPDLHM;  // wrapper
...
{
    public BHFMDLIGJGB PGOCIMAGEHO;  // wrapper
...
{
    public NEFINIMPGBE DMEGHACCPAC;  // wrapper
    public int? IJKEONKPFHN;  // wrapper
...
{
    public BGGDGBDEHKI LLMGANEGCEH;  // wrapper
    public float? JHGDLMPBIFM;  // wrapper
    public bool? MNAJMCBAAML;  // wrapper
...
{
    public List<DFKLECHGIGF> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public DNPGJPDMPJM HFFDKMJEBIA;  // wrapper
    public DNPGJPDMPJM? DBLHGDIGBNG;  // wrapper
...
{
    public ChatMessage LFMFEFFGFLH;  // wrapper
    public ADPEGIGGGIG LLMGANEGCEH;  // wrapper
...
{
    public HGEBMGKCJPN IIPGJOADPMM;  // wrapper
    public IBCJHIDNCPD DPHLOOCAAJJ;  // wrapper
    public EPBAHIGFCGL FGAILDCNCMP;  // wrapper
    public EPBAHIGFCGL GHKLMJMOKPO;  // wrapper
...
{
    public PIHFIGKDEIA HOGLDEOOGNP;  // wrapper
    public DNPGJPDMPJM? AKLDGDFDIMH;  // wrapper
...
{
    public KMBOFNBJAKO MEJLNBEMBLA;  // wrapper
...
{
    public FMEEHHPHIFN inventionId;  // wrapper
}
...
// api/keepsakes/{kOEFBEKPCLL}/collect  [Auth POST]
public class KeepsakesKOEFBEKPCLLCollectRequest
{
    public Guid KOEFBEKPCLL;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public PBJKPLNNBON NDBLNFLPBLF;  // wrapper
    public long? NIPGINDOPCB;  // wrapper
...
{
    public COKACEIKMEF DFCNPIIMCGK;  // wrapper
    public MHKGINDLIFD HHFLBJBBCMP;  // wrapper
    public MHKGINDLIFD IIPGJOADPMM;  // wrapper
}
...
{
    public COKACEIKMEF DFCNPIIMCGK;  // wrapper
    public long? GPLFMIEBNLE;  // wrapper
    public long? DEPEEFECHJF;  // wrapper
}
...
{
    public COKACEIKMEF DFCNPIIMCGK;  // wrapper
    public EJALIIKGOHC EBIOPJIGCHB;  // wrapper
    public EJALIIKGOHC OMHDOCOHKBF;  // wrapper
}
...
{
    public COKACEIKMEF DFCNPIIMCGK;  // wrapper
    public long? IGODCCLGDMP;  // wrapper
    public long? NDIHJAHDLAI;  // wrapper
}
...
{
    public COKACEIKMEF DFCNPIIMCGK;  // wrapper
    public DateTime GOKLBJCOKPP;  // wrapper
    public DateTime PHNGDCPFBEH;  // wrapper
    public DateTime IGNKFFHMACN;  // wrapper
    public DateTime ANKPNFAOBLI;  // wrapper
}
...
{
    public Guid CKPNEAKBBGI;  // wrapper
...
{
    public Guid EAMDDNDHPAO;  // wrapper
    public object Price;  // candidate
...
{
    public Guid EAMDDNDHPAO;  // wrapper
    public long? BEKGEJIDIEP;  // wrapper
    public byte? LHJBCAIFHFH;  // wrapper
    public int? DKDNEEAJCMI;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid CKPNEAKBBGI;  // wrapper
    public long? NPGLHOJFPAB;  // wrapper
    public long? LGJGLNFNEII;  // wrapper
    public int? GBCDHFFPEKH;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> BFBOJFAJKBG;  // wrapper
...
{
    public JDAHEJJKMGO DMEGHACCPAC;  // wrapper
    public Guid? FBLNJPAFDDG;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public BGGDGBDEHKI LLMGANEGCEH;  // wrapper
    public long? JMMNFECKGDI;  // wrapper
    public Guid? CKCEDCHMBNI;  // wrapper
    public int? CALFJJPLGEF;  // wrapper
...
{
    public Guid MEMEBJCGMDA;  // wrapper
...
{
    public Guid AOOHLEKLIJD;  // wrapper
...
{
    public CGGHOLFHJDJ BDFJCLKDOAO;  // wrapper
}
