...
public class AAOHPLGLPPI
{
    public long <KPLHBEGIKDF>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <JINEPIFMKII>k__BackingField;    // 0x0x18
    public PHLLCFBPMOK <KPGPNCBBANC>k__BackingField;    // 0x0x20
}
...
// ACCLAOCIPMB
//   (not directly referenced by a detected call)
public class ACCLAOCIPMB
{
    public int <NAACMLFMJEL>k__BackingField;    // 0x0x10
    public MJAPJHCFMKH <NKFDMJHLFMI>k__BackingField;    // 0x0x18
}
...
public class ACONBKGCEIE
{
    public Dictionary<string, OLFKBMDDBOP> <ABMFKFGBECB>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{jKHMKIDBHPH}   [Service.Auth]
...
public class AEALMJLLKLP
{
    public LCPJOGCJOMO <CAJPIAKBBJP>k__BackingField;    // 0x0x10
    public NGFKBHACIKN <KFIMDKDFEAD>k__BackingField;    // 0x0x18
    public EMEBFGAMLKG <LLOFGMOBKEI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AGIACHPGECL
//   (not directly referenced by a detected call)
public class AGIACHPGECL
{
    public LMNIKIFPIPG OOGGMIGEHGE;    // 0x0x10
    public int CJPAGMIMIFN;    // 0x0x14
}

// --------------------------------------------------------------------------
// AHIFPEMDLCJ
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.Auth]
public class AHIFPEMDLCJ
{
    public List<long> <FCGNHLFNFCG>k__BackingField;    // 0x0x10
    public GGNILCLMNHK <OJGMDHEDIHG>k__BackingField;    // 0x0x18
    public string <KCFAJFAOHBK>k__BackingField;    // 0x0x20
    public long? <KPLHBEGIKDF>k__BackingField;    // 0x0x28
}
...
public class AJPPJLOEFJM
{
    public BEEOGFOBHPE <IBMMFCBKOCN>k__BackingField;    // 0x0x10
    public string <FNGOJGHPKDG>k__BackingField;    // 0x0x18
    public int? <CKPJKDLHMBM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ALGCCMFOJJL
//   REQUEST  POST   api/playerevents/v1/respond   [Service.Auth]
public class ALGCCMFOJJL
{
    public long <LBDPJCLEJHE>k__BackingField;    // 0x0x10
    public APOFKNFKCCG <OJGMDHEDIHG>k__BackingField;    // 0x0x18
}
...
// AMKHGEMOBEB
//   (not directly referenced by a detected call)
public class AMKHGEMOBEB
{
    public DateTime <GJOLFAFKNBE>k__BackingField;    // 0x0x10
    public string <DLGMBAMPFIK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// APAJEIMGPCO
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.Auth]
public class APAJEIMGPCO
{
    public int? <KKHBNOGBEPD>k__BackingField;    // 0x0x10
    public string <NLFLNEKFACC>k__BackingField;    // 0x0x18
    public string <JHEOGMAMMLJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// APKJGNLIGDA
//   RESPONSE GET    api/config/v2/amplitude   [Service.Auth]
public class APKJGNLIGDA
{
    public string <ANEJFLFDNLI>k__BackingField;    // 0x0x10
    public string <FKGNLHGDLEM>k__BackingField;    // 0x0x18
    public bool <GMKAOHDOEEI>k__BackingField;    // 0x0x20
    public string <MKICKKEFKAN>k__BackingField;    // 0x0x28
}
...
public class BAGENILJJNF
{
    public bool <OJIJPNMMPIK>k__BackingField;    // 0x0x10
    public string <PACJJCOBCHP>k__BackingField;    // 0x0x18
    public string <PLDKDNHJPBF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BANDKPBCHMJ
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.WWW]
public class BANDKPBCHMJ
{
    public List<PIGDALGMOAO> <EMAIEJBGNAB>k__BackingField;    // 0x0x10
    public string <IOLGGIBDOAF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BFHBBNJJNCG
//   RESPONSE GET    api/inventions/v1/details   [Service.Auth]
public class BFHBBNJJNCG
{
    public List<DNPBJJNHBED> <OJDHGJJMHEC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BIANHNLBEPA
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{iKHGMOEEKMD}/{lBBNLIBHFFP}   [Service.WWW]
public class BIANHNLBEPA
{
    public CKOPOOHPKEK <KEOPMAABLFB>k__BackingField;    // 0x0x10
    public ABAHNGNNBFF <FHINALAKMPD>k__BackingField;    // 0x0x14
    public int <BEBKLFIKEKI>k__BackingField;    // 0x0x18
    public int <JBBEKFDJKHK>k__BackingField;    // 0x0x1C
    public int <BMCNIGHELLC>k__BackingField;    // 0x0x20
    public IMEGJMAPFAI <NLEHJGLGFBB>k__BackingField;    // 0x0x24
    public bool <FCALFLJCDFG>k__BackingField;    // 0x0x28
    public float <MEJOCJBIFHK>k__BackingField;    // 0x0x2C
    public int <PEBBKIAAJLB>k__BackingField;    // 0x0x30
    public bool <PEJGJGHMAFA>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// BMCGJOBJDHG
//   RESPONSE POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForCustomAvatarItemIds   [Service.Notifications]
public class BMCGJOBJDHG
{
    public Dictionary<Guid, OLFKBMDDBOP> <ENAIGLBJFBI>k__BackingField;    // 0x0x10
}
...
// CCINNIICJKC
//   (not directly referenced by a detected call)
public class CCINNIICJKC
{
    public float <MBKCMEOONCB>k__BackingField;    // 0x0x10
}
...
public class CEHGFLLEHIH
{
    public int <LELONNMGNJP>k__BackingField;    // 0x0x10
    public int? <IFJJNEEDBCJ>k__BackingField;    // 0x0x14
    public string <EFEMHKBEBEN>k__BackingField;    // 0x0x20
    public string <OOEIONAAFNP>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// CGKDKKDLJBE
//   (not directly referenced by a detected call)
public class CGKDKKDLJBE
{
    public int <CLGACAPLFML>k__BackingField;    // 0x0x10
    public string <FNCJIAIMPHG>k__BackingField;    // 0x0x18
    public string <CLEOOGMLCAL>k__BackingField;    // 0x0x20
    public string <NHCIMNFHOOA>k__BackingField;    // 0x0x28
    public string <PKAPMGKNMOP>k__BackingField;    // 0x0x30
    public string <BIMGLFIACNO>k__BackingField;    // 0x0x38
    public MHKEAMBBMIA? <JEHDNPADJOH>k__BackingField;    // 0x0x40
    public string <IAFNPDNDJHG>k__BackingField;    // 0x0x48
    public string <FDEEENJAIBA>k__BackingField;    // 0x0x50
    public bool <CDJPCCPLEHF>k__BackingField;    // 0x0x58
    public bool <BLMBEGBNALM>k__BackingField;    // 0x0x59
    public bool <JCJMFAFKEOI>k__BackingField;    // 0x0x5A
    public JPGEOMMCCPC <AANKFOABJON>k__BackingField;    // 0x0x5C
    public CKOPOOHPKEK <KEOPMAABLFB>k__BackingField;    // 0x0x60
    public int <EPDKPMINIIK>k__BackingField;    // 0x0x64
    public DEJCODPOCNK <LBHKELKBCFB>k__BackingField;    // 0x0x68
    public DDGHGFDKBBK <GLGJJHOPODL>k__BackingField;    // 0x0x6C
    public int? <DEBBDEGIDIA>k__BackingField;    // 0x0x70
    public string <ELCANNDHMLM>k__BackingField;    // 0x0x78
    public int? <ICEEJKPGLFJ>k__BackingField;    // 0x0x80
    public int? <BGOFFHBDEPA>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// CHDFKNLCCAD
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class CHDFKNLCCAD
{
    public long <LBDPJCLEJHE>k__BackingField;    // 0x0x10
    public int <EAMMJNBHPPH>k__BackingField;    // 0x0x18
    public long <KPLHBEGIKDF>k__BackingField;    // 0x0x20
    public long? <DKKDONJKCKI>k__BackingField;    // 0x0x28
    public long? <INIJFMFOGAL>k__BackingField;    // 0x0x38
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x48
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x50
    public string <NNIIAHDILMD>k__BackingField;    // 0x0x58
    public DateTime <NJCPGCNJDHB>k__BackingField;    // 0x0x60
    public DateTime <BFNOFJLFGGL>k__BackingField;    // 0x0x68
    public int <HGENCNHPEIG>k__BackingField;    // 0x0x70
    public NIGMOMHKFKD <JNPPNELOGOL>k__BackingField;    // 0x0x74
    public bool <EDCAPGPGILA>k__BackingField;    // 0x0x78
    public bool <JJIOCLHFGJO>k__BackingField;    // 0x0x79
    public FDDBAJHIGPO <KFAKAJEKGKF>k__BackingField;    // 0x0x7C
    public FDDBAJHIGPO <EBNGLCFIMEC>k__BackingField;    // 0x0x80
    public long? <GEKCEEFGIKG>k__BackingField;    // 0x0x88
}
...
public class CMPFBFEHNIN
{
    public Guid <GAMBGNEMHCJ>k__BackingField;    // 0x0x10
    public int <GBBOBHJOJCG>k__BackingField;    // 0x0x20
    public long <IBPJGGPLHDG>k__BackingField;    // 0x0x28
    public Guid <EBJFDOLGDPI>k__BackingField;    // 0x0x30
}
...
public class DDDCMPJDADA
{
    public DHIINPECDJG <IBMMFCBKOCN>k__BackingField;    // 0x0x10
    public int <PNBPKGLPAHN>k__BackingField;    // 0x0x14
    public long <GCHFGBLGBCA>k__BackingField;    // 0x0x18
    public bool <KHIBGCCIGOE>k__BackingField;    // 0x0x20
    public string <DMCNOCPHBHN>k__BackingField;    // 0x0x28
    public int? <DGANEOPHJEB>k__BackingField;    // 0x0x30
    public bool <BIFJCDIACCC>k__BackingField;    // 0x0x38
    public bool <IDJHPAMGIBG>k__BackingField;    // 0x0x39
    public bool <ADNIIAONEJD>k__BackingField;    // 0x0x3A
    public bool <HDFFDOMBJOA>k__BackingField;    // 0x0x3B
    public string <CMMJLANJCJA>k__BackingField;    // 0x0x40
    public DateTime? <MHJFBOKCHHA>k__BackingField;    // 0x0x48
    public string <BFOMPBNFGAF>k__BackingField;    // 0x0x58
    public float <JHFGGFDLNLA>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// DDDIFMLMELL
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.WWW]
public class DDDIFMLMELL
{
    public long <OHCEDPKMIKL>k__BackingField;    // 0x0x10
    public int <EAHPDDPBLMD>k__BackingField;    // 0x0x18
}
...
// DNPBJJNHBED
//   (not directly referenced by a detected call)
public class DNPBJJNHBED
{
    public string <JNEIPFIPDNH>k__BackingField;    // 0x0x10
    public OLEEFCJOJHI <OJGMDHEDIHG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EANBOJPIBJG
//   (not directly referenced by a detected call)
public class EANBOJPIBJG
{
    public int <DAEADJCJNMK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EEIACJEICON
//   (not directly referenced by a detected call)
public class EEIACJEICON
{
    public long <MOFDOEJECPB>k__BackingField;    // 0x0x10
    public string <ICDGBMFOMDA>k__BackingField;    // 0x0x18
    public int <AEEHLPDAOAK>k__BackingField;    // 0x0x20
    public int <FOFHMJLNCPI>k__BackingField;    // 0x0x24
    public int <KALAOFGOLDK>k__BackingField;    // 0x0x28
    public int <BFLHDIFBFKG>k__BackingField;    // 0x0x2C
    public int <IDJKLHEKAHA>k__BackingField;    // 0x0x30
    public string <IMECEBHJOMD>k__BackingField;    // 0x0x38
    public string <MLHHIHDFBGG>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// EGOMAOOPJMF
//   (not directly referenced by a detected call)
public class EGOMAOOPJMF
{
    public bool <IAOEEGOMMPJ>k__BackingField;    // 0x0x10
    public CGKDKKDLJBE <EIMBFOOELEM>k__BackingField;    // 0x0x18
    public float <BHFGNHFPOMB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EMEBFGAMLKG
//   RESPONSE POST   api/inventions/v1/settags   [Service.Auth]
public class EMEBFGAMLKG
{
    public IMPDEFKJOAJ <KFIMDKDFEAD>k__BackingField;    // 0x0x10
    public List<string> <OJDHGJJMHEC>k__BackingField;    // 0x0x18
}
...
// base   : JIMNCIDOFFF
//   (not directly referenced by a detected call)
public class FEOLJDLEEOF : JIMNCIDOFFF
{
    public int <FGCOBGIOKCF>k__BackingField;    // 0x0x68
    public List<EGOMAOOPJMF> <HHMBOOHEHFP>k__BackingField;    // 0x0x70
    public List<EGOMAOOPJMF> <PIHHCHFDDAB>k__BackingField;    // 0x0x78
    public List<EGOMAOOPJMF> <KAOGKIMHCII>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// FJCHLBCLHMP
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.WWW]
public class FJCHLBCLHMP
{
    public int KIPAHCMBJME;    // 0x0x10
    public long BAFGNJPEFCN;    // 0x0x18
}

// --------------------------------------------------------------------------
// FNCCJJEJKKA
//   (not directly referenced by a detected call)
public class FNCCJJEJKKA
{
    public Guid <CDILHHIEICO>k__BackingField;    // 0x0x10
    public long <KPLHBEGIKDF>k__BackingField;    // 0x0x20
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x28
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x30
    public string <NNIIAHDILMD>k__BackingField;    // 0x0x38
    public long <FJCJJFKJAJB>k__BackingField;    // 0x0x40
    public Guid? <LJFGIBCKHMP>k__BackingField;    // 0x0x48
    public DateTime <ILEGPKFLFMO>k__BackingField;    // 0x0x60
    public int <IBAGPMKCEAF>k__BackingField;    // 0x0x68
}
...
public class GBOHPLAOKMF
{
    public bool <HGMAELBDPFG>k__BackingField;    // 0x0x10
    public string <DMCNOCPHBHN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GDNCIJJBNEE
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class GDNCIJJBNEE
{
    public Dictionary<Guid, MHMMNLIKMNH> <DNKPDIFDHNM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GDPELCBEJPI
//   (not directly referenced by a detected call)
public class GDPELCBEJPI
{
    public int <EPEIEMKLCAF>k__BackingField;    // 0x0x10
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x18
    public string <GENJEMBOPOO>k__BackingField;    // 0x0x20
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x28
    public string <CLEOOGMLCAL>k__BackingField;    // 0x0x30
    public bool <EMGJHDFAGPK>k__BackingField;    // 0x0x38
    public int <GCIIILGCMOA>k__BackingField;    // 0x0x3C
    public HKFHMANDEIM <FOAMMAPGFEB>k__BackingField;    // 0x0x40
    public DLDKNBCLJKC GAKFABMFGNM;    // 0x0x48
    public DLDKNBCLJKC NENKGDJJHHJ;    // 0x0x50
    public DLDKNBCLJKC IMPLBDLLOPI;    // 0x0x58
    public COCAJNJCBAK LAFJDDOFECE;    // 0x0x60
}

// --------------------------------------------------------------------------
// GEJOOPJCCKH
//   (not directly referenced by a detected call)
public class GEJOOPJCCKH
{
    public int <NKEGLBHOFFM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GFKCKFOBFKG
//   REQUEST  POST   api/playerevents/v1/report   [Service.Auth]
public class GFKCKFOBFKG
{
    public DHIINPECDJG <IBMMFCBKOCN>k__BackingField;    // 0x0x10
    public long <LBDPJCLEJHE>k__BackingField;    // 0x0x18
    public string <FNGOJGHPKDG>k__BackingField;    // 0x0x20
}
...
public class GFPDAMAPONK
{
    public Guid <EBJFDOLGDPI>k__BackingField;    // 0x0x10
    public long <JBHBLPAGGIN>k__BackingField;    // 0x0x20
}
...
public class HCBNGPIJELB
{
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x10
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x18
    public int? <FJCJJFKJAJB>k__BackingField;    // 0x0x20
    public AMGJHJOBMLJ? <JNPPNELOGOL>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// HDEJDJLIMJO
//   RESPONSE GET    api/playerevents/v1/all   [Service.Auth]
//   RESPONSE GET    api/playerevents/v1/all/{kEDKJAFJCJC}   [Service.Auth]
public class HDEJDJLIMJO
{
    public List<CHDFKNLCCAD> <DEKDBDJKFMH>k__BackingField;    // 0x0x10
    public List<HPEKNGJLLLD> <HFDENPLENOC>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// HJIGDDCHKEE
// base   : OPJLHGFBAJG`1<IGIDDLBKHDO>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{oBKJNAOKLCF}   [Service.Auth]
public class HJIGDDCHKEE
{
    // (no instance fields in the metadata dump)
}
...
public class HLNENKBMHFJ
{
    public Dictionary<Guid, ACCLAOCIPMB> <OOPCPGLODCN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HPEKNGJLLLD
//   (not directly referenced by a detected call)
public class HPEKNGJLLLD
{
    public CHDFKNLCCAD <CAJPIAKBBJP>k__BackingField;    // 0x0x10
    public PKPPLOEBEBC <LMMBKPPDEME>k__BackingField;    // 0x0x18
}
...
public class IBBBKLNMNIF
{
    public Guid? <CDILHHIEICO>k__BackingField;    // 0x0x10
    public long? <KPLHBEGIKDF>k__BackingField;    // 0x0x28
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x38
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x40
    public string <NNIIAHDILMD>k__BackingField;    // 0x0x48
    public NIDEDMJHFKN <PBGFBNAEBCN>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// ICBFJOLECKD
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Matchmaking]
public class ICBFJOLECKD
{
    public Guid <HEDBCOHABLO>k__BackingField;    // 0x0x10
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x20
    public string <NNIIAHDILMD>k__BackingField;    // 0x0x28
    public DateTime <OPNIEKAHGBO>k__BackingField;    // 0x0x30
    public DateTime? <NOOHHIMIFGN>k__BackingField;    // 0x0x38
    public List<MKFNAOPJCBA> <EKHFJJBBKDF>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// IECEPIGILMO
//   (not directly referenced by a detected call)
public class IECEPIGILMO
{
    public int <AANJLGPJNIO>k__BackingField;    // 0x0x10
    public DateTime? <HDMPJOPIAAF>k__BackingField;    // 0x0x18
    public DateTime? <IFOPLDNFPCK>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// IFPBOAJIKKD
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.WWW]
public class IFPBOAJIKKD
{
    public List<int> <BCDIFHOMPOI>k__BackingField;    // 0x0x10
    public string <IOLGGIBDOAF>k__BackingField;    // 0x0x18
}
...
public class INMBGHBDMHE
{
    public string <CJONNEMFDBD>k__BackingField;    // 0x0x10
    public string <HLMCEDKDCNE>k__BackingField;    // 0x0x18
    public string <FNCJIAIMPHG>k__BackingField;    // 0x0x20
    public string <CLEOOGMLCAL>k__BackingField;    // 0x0x28
    public JPGEOMMCCPC <AANKFOABJON>k__BackingField;    // 0x0x30
    public bool ANGAECBHPMM;    // 0x0x34
    public bool <HOJJLCDEBJD>k__BackingField;    // 0x0x35
}

// --------------------------------------------------------------------------
// JBAHPMFMNDO
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItems/v2   [Service.Notifications]
public class JBAHPMFMNDO
{
    public byte <DPOPGGHKEOG>k__BackingField;    // 0x0x10
    public int <MAFMJHEDPDD>k__BackingField;    // 0x0x14
}
...
public class JCIEGLJAFFH
{
    public int <AADJEACJLKL>k__BackingField;    // 0x0x10
    public int <EPEIEMKLCAF>k__BackingField;    // 0x0x14
    public string <GENJEMBOPOO>k__BackingField;    // 0x0x18
    public bool <EMGJHDFAGPK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JCPKAGOFMPP
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.WWW]
public class JCPKAGOFMPP
{
    public int <EAHPDDPBLMD>k__BackingField;    // 0x0x10
    public Guid <GAMBGNEMHCJ>k__BackingField;    // 0x0x14
    public long <CHAEHFKNALG>k__BackingField;    // 0x0x28
    public DateTime <ILEGPKFLFMO>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// JECNHAPCIHC
//   (not directly referenced by a detected call)
public class JECNHAPCIHC
{
    public ObscuredLong <JAKIEBAJHOP>k__BackingField;    // 0x0x10
    public string <ICDGBMFOMDA>k__BackingField;    // 0x0x38
    public ObscuredInt <POBGPDDPDJL>k__BackingField;    // 0x0x40
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x58
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x60
    public string <NNIIAHDILMD>k__BackingField;    // 0x0x68
    public byte <GMKEIGBCAFM>k__BackingField;    // 0x0x70
    public int <JNGHJCKIJIL>k__BackingField;    // 0x0x74
    public AMGJHJOBMLJ <JNPPNELOGOL>k__BackingField;    // 0x0x78
    public bool <LLKKCBMDDMK>k__BackingField;    // 0x0x7C
    public DateTime <ILEGPKFLFMO>k__BackingField;    // 0x0x80
    public DateTime <GJOLFAFKNBE>k__BackingField;    // 0x0x88
    public DateTime? <ADDKPLPHHJC>k__BackingField;    // 0x0x90
    public long? <IPIPIFFAAPN>k__BackingField;    // 0x0xA0
    public int <PCJCELEHBIB>k__BackingField;    // 0x0xB0
    public int <JILDNABBDAP>k__BackingField;    // 0x0xB4
    public int <MDGDCOFLLEL>k__BackingField;    // 0x0xB8
    public CLDPODIMMFM <LBIPNPAGMIK>k__BackingField;    // 0x0xBC
    public CLDPODIMMFM <AEAGKBHFNPA>k__BackingField;    // 0x0xC0
    public ObscuredBool <DDBCMOGBGDD>k__BackingField;    // 0x0xC4
    public ObscuredBool <KHHEBGLNFLF>k__BackingField;    // 0x0xD0
    public ObscuredBool <HCFMEEMLCAE>k__BackingField;    // 0x0xDC
    public int? <FJCJJFKJAJB>k__BackingField;    // 0x0xE8
    public bool <LCICCIBFFBE>k__BackingField;    // 0x0xF0
}
...
public class JGBNKCOPPEM
{
    public MEIGCMMEMOL <GDIBAINAGFE>k__BackingField;    // 0x0x10
    public MHGHNFAAEIG <CHMJMKEAHLJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JGIMMLAGEPJ
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.Auth]
public class JGIMMLAGEPJ
{
    public List<OAFKANHNBHF> <HBAAHCJKFOI>k__BackingField;    // 0x0x10
    public NGFKBHACIKN <KFIMDKDFEAD>k__BackingField;    // 0x0x18
}
...
public class JHBDENLJCJJ
{
    public MHKEAMBBMIA <JEHDNPADJOH>k__BackingField;    // 0x0x10
    public string <AOABLAEHFLG>k__BackingField;    // 0x0x18
    public string <FNCJIAIMPHG>k__BackingField;    // 0x0x20
    public string <CLEOOGMLCAL>k__BackingField;    // 0x0x28
    public JPGEOMMCCPC <AANKFOABJON>k__BackingField;    // 0x0x30
    public string <NHCIMNFHOOA>k__BackingField;    // 0x0x38
    public int <ICEEJKPGLFJ>k__BackingField;    // 0x0x40
    public bool <OICFHGJFHNH>k__BackingField;    // 0x0x44
}
...
public class JHLIKHDCKEO
{
    public int <NJGIKMMBPGN>k__BackingField;    // 0x0x10
    public int <HOMFEPHKMBK>k__BackingField;    // 0x0x14
    public float <NHHJJLJMNIN>k__BackingField;    // 0x0x18
    public float <LAIIEAFKAGF>k__BackingField;    // 0x0x1C
    public bool <NFFAHCNKFLN>k__BackingField;    // 0x0x20
    public bool <CNLPIDOGCHC>k__BackingField;    // 0x0x21
    public bool <HOJJLCDEBJD>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// JIMNCIDOFFF
//   (not directly referenced by a detected call)
public class JIMNCIDOFFF
{
    public int <NNEFEBBDBIO>k__BackingField;    // 0x0x10
    public JBNFOLGKIIL <OJGMDHEDIHG>k__BackingField;    // 0x0x14
    public List<PLJODDLJCBL> <OEAGLBDBAPN>k__BackingField;    // 0x0x18
    public List<PLJODDLJCBL> <KAJBFJIFMDE>k__BackingField;    // 0x0x20
    public bool <DLGGFGNLFBK>k__BackingField;    // 0x0x28
    public DateTime? <POEKNCDAOEL>k__BackingField;    // 0x0x30
    public DateTime? <DKLIDJGGMEE>k__BackingField;    // 0x0x40
    public DateTime? <LCAJABKBFPI>k__BackingField;    // 0x0x50
    public bool <EMAGNJCMKML>k__BackingField;    // 0x0x60
}
...
public class JJFKGGHKFKF
{
    public int <HOMFEPHKMBK>k__BackingField;    // 0x0x10
    public bool <NFFAHCNKFLN>k__BackingField;    // 0x0x14
    public DateTime <FNEBJJOHGHB>k__BackingField;    // 0x0x18
    public bool <FCKPOGFACMI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JJKGKLGAHNN
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.Auth]
public class JJKGKLGAHNN
{
    public List<CHDFKNLCCAD> <EPDODKKAFNC>k__BackingField;    // 0x0x10
    public string <IOLGGIBDOAF>k__BackingField;    // 0x0x18
}
...
// JMBKILCEGDG
//   (not directly referenced by a detected call)
public class JMBKILCEGDG
{
    public Guid <CDILHHIEICO>k__BackingField;    // 0x0x10
    public int <EAHPDDPBLMD>k__BackingField;    // 0x0x20
    public int <CDEMFJOPOCJ>k__BackingField;    // 0x0x24
    public Guid <OHIOIMONCBD>k__BackingField;    // 0x0x28
    public DateTime <ILEGPKFLFMO>k__BackingField;    // 0x0x38
    public FNCCJJEJKKA <GDNPOBMMIMJ>k__BackingField;    // 0x0x40
}
...
public class KAKBLNCFHPL
{
    public List<Guid> <AIIAIOJCCMA>k__BackingField;    // 0x0x10
    public byte <DPOPGGHKEOG>k__BackingField;    // 0x0x18
    public int <MAFMJHEDPDD>k__BackingField;    // 0x0x1C
}
...
public class KBFPECDAPEA : JLHAOPLNNKM
{
    public IAJKIBJIPLH? <EJOAMLNDIED>k__BackingField;    // 0x0x18
    public JCPKAGOFMPP <FCDOGDMNCAD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KMJKCIJAJCJ
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.WWW]
public class KMJKCIJAJCJ
{
    public List<string> <BBJAKJAJNON>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KOIGJDDLLFB
//   (not directly referenced by a detected call)
public class KOIGJDDLLFB
{
    public long <CLGACAPLFML>k__BackingField;    // 0x0x10
    public string <PKAPMGKNMOP>k__BackingField;    // 0x0x18
    public string <MBGOGCFNABD>k__BackingField;    // 0x0x20
    public MHKEAMBBMIA? <JEHDNPADJOH>k__BackingField;    // 0x0x28
    public string <IAFNPDNDJHG>k__BackingField;    // 0x0x30
    public string <FDEEENJAIBA>k__BackingField;    // 0x0x38
    public OIBKCLIJMJC <INFHLIENDPG>k__BackingField;    // 0x0x40
    public int <COPGDGNNNCH>k__BackingField;    // 0x0x44
    public int <EDNNIHCOHJI>k__BackingField;    // 0x0x48
    public DDGHGFDKBBK? <JBJLLJKEHHF>k__BackingField;    // 0x0x4C
    public JPGEOMMCCPC? <JAMCKPFBAMJ>k__BackingField;    // 0x0x54
}
...
// base   : CHDFKNLCCAD
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class LCPJOGCJOMO : CHDFKNLCCAD
{
    public List<DNPBJJNHBED> <OJDHGJJMHEC>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// LDGJMAKELHL
//   (not directly referenced by a detected call)
public class LDGJMAKELHL
{
    public bool <HOJNFEHECAB>k__BackingField;    // 0x0x10
    public OAJHKBAIAOB <MLHOBLIIJAG>k__BackingField;    // 0x0x14
    public int <PGPCFMCCLBE>k__BackingField;    // 0x0x18
    public DateTime <ILEGPKFLFMO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LKKMNKKBPII
//   (not directly referenced by a detected call)
public class LKKMNKKBPII
{
    public int <EHEHMHFFDNL>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{kGLLDNNPDBH}   [Service.WWW]
public enum MEIGCMMEMOL
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
// MHGHNFAAEIG
//   (not directly referenced by a detected call)
public class MHGHNFAAEIG
{
    public long <OHCEDPKMIKL>k__BackingField;    // 0x0x10
    public Guid <ICDGBMFOMDA>k__BackingField;    // 0x0x18
    public long <KPLHBEGIKDF>k__BackingField;    // 0x0x28
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x30
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x38
    public int <FJCJJFKJAJB>k__BackingField;    // 0x0x40
    public Guid? <LJFGIBCKHMP>k__BackingField;    // 0x0x44
    public DateTime <GJOLFAFKNBE>k__BackingField;    // 0x0x58
    public string <NNIIAHDILMD>k__BackingField;    // 0x0x60
    public HHAKAJCILML <OJGMDHEDIHG>k__BackingField;    // 0x0x68
}
...
public class MHMMNLIKMNH
{
    public MHKNPICHPIH <GDIBAINAGFE>k__BackingField;    // 0x0x10
    public JMBKILCEGDG <BDFNGBPDEIL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MJAPJHCFMKH
//   REQUEST  PUT    api/roomconsumables   [Service.WWW]
public class MJAPJHCFMKH
{
    public Guid? <KMLGDBOPAMI>k__BackingField;    // 0x0x10
    public Guid <ADKEGKJBDEH>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// MKFNAOPJCBA
//   (not directly referenced by a detected call)
public class MKFNAOPJCBA
{
    public Guid <DFMDODPPNNI>k__BackingField;    // 0x0x10
    public Guid <KGONIHKJBAE>k__BackingField;    // 0x0x20
    public DateTime <OPNIEKAHGBO>k__BackingField;    // 0x0x30
    public List<CGKDKKDLJBE> <MHBKBGJNPEO>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// MOANLCIMFJH
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{jNIKIHKLGAD}   [Service.Auth]
public class MOANLCIMFJH
{
    public uint <IIHEGBNNHHK>k__BackingField;    // 0x0x10
    public uint? <JJPKMOGDFCA>k__BackingField;    // 0x0x14
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x20
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x28
    public DateTime <HAKDFEPOMMJ>k__BackingField;    // 0x0x30
    public DateTime? <CALFBADIKLN>k__BackingField;    // 0x0x38
    public bool <HNADGCHJDNB>k__BackingField;    // 0x0x48
    public List<NKMKAKNDKEH> <KLLMACFEOKL>k__BackingField;    // 0x0x50
    public List<string> <OJDHGJJMHEC>k__BackingField;    // 0x0x58
    public int <PEEHMMPFCDK>k__BackingField;    // 0x0x60
    public int <DMGINDKMDGL>k__BackingField;    // 0x0x64
    public int <LKCBKGPOMHF>k__BackingField;    // 0x0x68
}
...
//   RESPONSE DELETE api/keepsakes/{bICMFMGLGLI}   [Service.Auth]
...
public class NCBPNMLFMAL
{
    public bool <HGMAELBDPFG>k__BackingField;    // 0x0x10
    public string <MGCEADECPEE>k__BackingField;    // 0x0x18
}
...
public class NGFBDMFIDJN
{
    public NGFKBHACIKN <KFIMDKDFEAD>k__BackingField;    // 0x0x10
}
...
public class NGPHAFBMAKJ
{
    public int <PNBPKGLPAHN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NHLALODCENP
//   (not directly referenced by a detected call)
public class NHLALODCENP
{
    public float <GMABGGPGDHN>k__BackingField;    // 0x0x10
    public float <PMDAMKLPMKP>k__BackingField;    // 0x0x14
    public float <EEHLKEOPIEF>k__BackingField;    // 0x0x18
    public float <BFPKKHNGCOD>k__BackingField;    // 0x0x1C
    public float <GAOMKDANJAM>k__BackingField;    // 0x0x20
    public float <OMGDLGHMKIN>k__BackingField;    // 0x0x24
    public float <EHBAEICALDH>k__BackingField;    // 0x0x28
    public float <MIBHMEMHHKC>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// NIDEDMJHFKN
//   (not directly referenced by a detected call)
public class NIDEDMJHFKN
{
    public long <FJCJJFKJAJB>k__BackingField;    // 0x0x10
    public Guid? <GAMBGNEMHCJ>k__BackingField;    // 0x0x18
}
...
public class NKMKAKNDKEH
{
    public string <IIHEGBNNHHK>k__BackingField;    // 0x0x10
    public string <PACJJCOBCHP>k__BackingField;    // 0x0x18
    public string <EIOOFHCPPEL>k__BackingField;    // 0x0x20
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x28
    public string <NLFLNEKFACC>k__BackingField;    // 0x0x30
    public INIGDDDGJAA <GDIBAINAGFE>k__BackingField;    // 0x0x38
    public List<string> <EGLAIHJFEJO>k__BackingField;    // 0x0x40
    public List<string> <OJDHGJJMHEC>k__BackingField;    // 0x0x48
    public string <OILJMPMNNCF>k__BackingField;    // 0x0x50
    public List<AMKHGEMOBEB> <PJANMPNKOAB>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// NKMKCPGACLH
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.WWW]
public class NKMKCPGACLH
{
    public int <AADJEACJLKL>k__BackingField;    // 0x0x10
    public string <JDMDJGKJJIB>k__BackingField;    // 0x0x18
    public List<GDPELCBEJPI> <DNDDGOEIFIO>k__BackingField;    // 0x0x20
    public KOIGJDDLLFB <HMNKNGMNNOP>k__BackingField;    // 0x0x28
    public string <CBOMOHPKIPL>k__BackingField;    // 0x0x30
    public DateTime <OPNIEKAHGBO>k__BackingField;    // 0x0x38
    public DateTime <EBEHJBAPNIG>k__BackingField;    // 0x0x40
    public DateTime <OHHIOEONFHO>k__BackingField;    // 0x0x48
    public bool? <DEFKHCBKFBD>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// NLKBLPHJKAM
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.WWW]
public class NLKBLPHJKAM
{
    public long <OHCEDPKMIKL>k__BackingField;    // 0x0x10
    public int <EAHPDDPBLMD>k__BackingField;    // 0x0x18
}
...
// OAFKANHNBHF
//   (not directly referenced by a detected call)
public class OAFKANHNBHF
{
    public int <CPEHKHPHPMN>k__BackingField;    // 0x0x10
    public NGFKBHACIKN <KFIMDKDFEAD>k__BackingField;    // 0x0x14
}
...
public class OBCFNKDJIHE
{
    public List<string> <ALHLFHMIDFK>k__BackingField;    // 0x0x10
    public List<string> <KHFJGLPCKCD>k__BackingField;    // 0x0x18
    public List<string> <EDFFINHNDKC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OCLNBAKKBAK
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItemDescs   [Service.Notifications]
public class OCLNBAKKBAK
{
    public List<string> <DDMIKCFPMPF>k__BackingField;    // 0x0x10
    public byte <DPOPGGHKEOG>k__BackingField;    // 0x0x18
    public int <MAFMJHEDPDD>k__BackingField;    // 0x0x1C
}
...
//   RESPONSE POST   api/progressionEvents/collect/{jKHMKIDBHPH}/{pNAMEGMODBJ}   [Service.Auth]
public class ODGEOKMMLBI
{
    public long? <IIHEGBNNHHK>k__BackingField;    // 0x0x10
    public int <CJIGDLAEFAA>k__BackingField;    // 0x0x20
    public int? <PENFJFPPCPG>k__BackingField;    // 0x0x24
    public string <PKAPMGKNMOP>k__BackingField;    // 0x0x30
    public MHKEAMBBMIA? <JEHDNPADJOH>k__BackingField;    // 0x0x38
    public string <BIMGLFIACNO>k__BackingField;    // 0x0x40
    public string <IAFNPDNDJHG>k__BackingField;    // 0x0x48
    public string <FDEEENJAIBA>k__BackingField;    // 0x0x50
    public CKOPOOHPKEK <KEOPMAABLFB>k__BackingField;    // 0x0x58
    public int <EPDKPMINIIK>k__BackingField;    // 0x0x5C
    public int <COPGDGNNNCH>k__BackingField;    // 0x0x60
    public DDGHGFDKBBK <JBJLLJKEHHF>k__BackingField;    // 0x0x64
    public JPGEOMMCCPC <JAMCKPFBAMJ>k__BackingField;    // 0x0x68
    public string <DGPHIHJPCAK>k__BackingField;    // 0x0x70
    public CCJLLABHMJD <FPAAEDKFAOB>k__BackingField;    // 0x0x78
    public OAJHKBAIAOB <NPCINNMAIJO>k__BackingField;    // 0x0x7C
    public EOIDGBNCIOM? <PMHELJMJNAN>k__BackingField;    // 0x0x80
    public bool <IJFGGDFJGOJ>k__BackingField;    // 0x0x88
    public bool <CIJGILJIHHA>k__BackingField;    // 0x0x89
    public string <IAEMDHOLEHI>k__BackingField;    // 0x0x90
    public bool <IPBPDIPFFOL>k__BackingField;    // 0x0x98
    public bool LIIOCAHBCKH;    // 0x0x99
}
...
// base   : JBMBNCJPOMH
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/season/{mDLEGHJAGFB}   [Service.WWW]
public class ODMKFNOKINH : JBMBNCJPOMH
{
    public int <LDMGGDFKJJO>k__BackingField;    // 0x0x30
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x38
    public DateTime <OPNIEKAHGBO>k__BackingField;    // 0x0x40
    public DateTime <EBEHJBAPNIG>k__BackingField;    // 0x0x48
    public CKOPOOHPKEK <KEOPMAABLFB>k__BackingField;    // 0x0x50
    public JIMNCIDOFFF <FNCBDAENLAC>k__BackingField;    // 0x0x58
    public List<FEOLJDLEEOF> <GOICEMAMNNE>k__BackingField;    // 0x0x60
    public LDGJMAKELHL <HBKHHADBPAN>k__BackingField;    // 0x0x68
}
...
public class OEAJDFPOPDC : JLHAOPLNNKM
{
    public OLFLEMONKAB? <EJOAMLNDIED>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <ECFKEAJNBBM>k__BackingField;    // 0x0x20
}
...
public class OLAEBGIMPIE
{
    public long <KPLHBEGIKDF>k__BackingField;    // 0x0x10
    public long? <DKKDONJKCKI>k__BackingField;    // 0x0x18
    public long? <INIJFMFOGAL>k__BackingField;    // 0x0x28
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x38
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x40
    public List<string> <OJDHGJJMHEC>k__BackingField;    // 0x0x48
    public string <NNIIAHDILMD>k__BackingField;    // 0x0x50
    public DateTime <NJCPGCNJDHB>k__BackingField;    // 0x0x58
    public DateTime <BFNOFJLFGGL>k__BackingField;    // 0x0x60
    public NIGMOMHKFKD <JNPPNELOGOL>k__BackingField;    // 0x0x68
    public bool <EDCAPGPGILA>k__BackingField;    // 0x0x6C
    public bool <JJIOCLHFGJO>k__BackingField;    // 0x0x6D
    public FDDBAJHIGPO <KFAKAJEKGKF>k__BackingField;    // 0x0x70
    public FDDBAJHIGPO <EBNGLCFIMEC>k__BackingField;    // 0x0x74
}
...
// OLFKBMDDBOP
//   (not directly referenced by a detected call)
public class OLFKBMDDBOP
{
    public long <JMIGLBJIKHE>k__BackingField;    // 0x0x10
    public Guid <MMLONLHNHLH>k__BackingField;    // 0x0x18
    public Guid <HAAOGOCFNAA>k__BackingField;    // 0x0x28
    public DateTime <GJOLFAFKNBE>k__BackingField;    // 0x0x38
    public string <KGIPCHJFOFE>k__BackingField;    // 0x0x40
    public string <OFNJBHPDECH>k__BackingField;    // 0x0x48
    public string <PPNHHHPPIDF>k__BackingField;    // 0x0x50
    public string <KCJIJHLIAOF>k__BackingField;    // 0x0x58
    public string <NFOPLJAPMHC>k__BackingField;    // 0x0x60
    public string <HJBJMPEFMGE>k__BackingField;    // 0x0x68
}
...
// --------------------------------------------------------------------------
// OOIMEFLNFAM
// base   : OPJLHGFBAJG`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class OOIMEFLNFAM
{
    // (no instance fields in the metadata dump)
}
...
public class PAMAALKDFNK
{
    public Dictionary<int, int> <CMGABKAHAOA>k__BackingField;    // 0x0x10
    public List<BGIMOHKCFGO> <EKHACNIEGDN>k__BackingField;    // 0x0x18
    public AGIACHPGECL[][] <PNIOJKHJGIN>k__BackingField;    // 0x0x20
    public GEJOOPJCCKH <GFPBPLHFDCG>k__BackingField;    // 0x0x28
    public NHLALODCENP <OCDEJKHEGIK>k__BackingField;    // 0x0x30
    public EANBOJPIBJG <EJDKBONPHNA>k__BackingField;    // 0x0x38
    public LKKMNKKBPII <AMLMLFDBCFF>k__BackingField;    // 0x0x40
    public CCINNIICJKC <GLCLNLNLMPE>k__BackingField;    // 0x0x48
    public string <NHEBBIJCHAD>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// PCABHJFLAAG
//   RESPONSE GET    api/config/v1/backtrace   [Service.Auth]
public class PCABHJFLAAG
{
    public int <HLPGCFLAPPE>k__BackingField;    // 0x0x10
    public int <IMPGIADILBO>k__BackingField;    // 0x0x14
    public float <KHFPOOBLOKN>k__BackingField;    // 0x0x18
    public int <APCOKBLHDPD>k__BackingField;    // 0x0x1C
    public int <BONMLINFGIA>k__BackingField;    // 0x0x20
    public int <AHDOEDPMGHB>k__BackingField;    // 0x0x24
    public int <HOCEKDPOPDC>k__BackingField;    // 0x0x28
    public string <AMKFJOMOKPJ>k__BackingField;    // 0x0x30
    public string <MJGPHIHAHNM>k__BackingField;    // 0x0x38
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{mMCLHMLANMA}   [Service.WWW]
public class PCLBEFEAPML
{
    public MHKNPICHPIH <GDIBAINAGFE>k__BackingField;    // 0x0x10
    public FNCCJJEJKKA <GDNPOBMMIMJ>k__BackingField;    // 0x0x18
}
...
public class PFGAAFLEFGL
{
    public MJAPJHCFMKH <NKFDMJHLFMI>k__BackingField;    // 0x0x10
    public NIDEDMJHFKN <DDPJMGDACPG>k__BackingField;    // 0x0x18
    public int <NAACMLFMJEL>k__BackingField;    // 0x0x20
}
...
// PIGDALGMOAO
//   (not directly referenced by a detected call)
public class PIGDALGMOAO
{
    public int <LFGEKOKCDJD>k__BackingField;    // 0x0x10
    public DateTime <GJOLFAFKNBE>k__BackingField;    // 0x0x18
    public DateTime? <LIINJIOHBOF>k__BackingField;    // 0x0x20
}
...
public class PINJNDMAMGP
{
    public int <NIIAGPNMFDN>k__BackingField;    // 0x0x10
    public EEBDMAJBIPL <OJGMDHEDIHG>k__BackingField;    // 0x0x14
    public FBJBAJEDAKP <GAIALBPIEBK>k__BackingField;    // 0x0x18
    public FBJBAJEDAKP <JIFIPODBNHN>k__BackingField;    // 0x0x1C
    public FBJBAJEDAKP <NAAEHMGLKEJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PKJPKOPOJED
//   RESPONSE GET    api/inventions/   [Service.Auth]
//   RESPONSE GET    api/inventions/v1/personaldetails/{bDHONGPDPKN}   [Service.Auth]
public class PKJPKOPOJED
{
    public bool <OPCNIKDINMF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PKPPLOEBEBC
//   (not directly referenced by a detected call)
public class PKPPLOEBEBC
{
    public long <BILLCOGOFGN>k__BackingField;    // 0x0x10
    public long <LBDPJCLEJHE>k__BackingField;    // 0x0x18
    public int <CJIGDLAEFAA>k__BackingField;    // 0x0x20
    public DateTime <GJOLFAFKNBE>k__BackingField;    // 0x0x28
    public APOFKNFKCCG <OJGMDHEDIHG>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// PLJODDLJCBL
//   (not directly referenced by a detected call)
public class PLJODDLJCBL
{
    public CKOPOOHPKEK <KEOPMAABLFB>k__BackingField;    // 0x0x10
    public int <FJCJJFKJAJB>k__BackingField;    // 0x0x14
    public IECEPIGILMO <KLKNKCGCDAO>k__BackingField;    // 0x0x18
}
...
public class PNGMDHLMFCH
{
    public BNGFOIBHDNA <GDIBAINAGFE>k__BackingField;    // 0x0x10
    public JECNHAPCIHC <CDCEFKHJENM>k__BackingField;    // 0x0x18
    public EEIACJEICON <LCBFNJLFHJD>k__BackingField;    // 0x0x20
}
...
public class AddKeepsakeInstanceRequest
{
    public long <KPLHBEGIKDF>k__BackingField;    // 0x0x10
    public long? <DKKDONJKCKI>k__BackingField;    // 0x0x18
    public DHMJFGMICNG <PLILMGJNIDA>k__BackingField;    // 0x0x28
}
...
{
    public DCPGBBDIHON <KFIMDKDFEAD>k__BackingField;    // 0x0x10
    public string <KAAGCMJJMHL>k__BackingField;    // 0x0x18
    public string <CDCJFMAPNNC>k__BackingField;    // 0x0x20
    public string <HJEJIFKPDNH>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public CKOPOOHPKEK <CurrencyType>k__BackingField;    // 0x0x18
    public EOIDGBNCIOM <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <LBDPJCLEJHE>k__BackingField;    // 0x0x10
    public long? <JIMBEOCDPDC>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public KPAEABOBCCA FilterType;    // 0x0x20
...
{
    public DHMJFGMICNG <AFNGBBPCNPC>k__BackingField;    // 0x0x10
    public string <MJMFAAKBLKI>k__BackingField;    // 0x0x18
    public int <DAGNDIJDHFK>k__BackingField;    // 0x0x20
    public int <OMJNENDJNFA>k__BackingField;    // 0x0x24
    public string <ELOPIELAFFB>k__BackingField;    // 0x0x28
    public string <CDNKMOPIGJN>k__BackingField;    // 0x0x30
}
...
{
    public int <EAHPDDPBLMD>k__BackingField;    // 0x0x10
    public Guid <MGFEJHBHOKE>k__BackingField;    // 0x0x14
    public DateTime <LOGCBKOCNLD>k__BackingField;    // 0x0x28
}
...
{
    public bool <PPJJCNILDJL>k__BackingField;    // 0x0x10
    public int <EDHJPBMMNNP>k__BackingField;    // 0x0x14
    public bool <LHPOLDDEMJC>k__BackingField;    // 0x0x18
}
...
{
    public Guid <MGFEJHBHOKE>k__BackingField;    // 0x0x10
    public DHMJFGMICNG <NFNONEOOGPI>k__BackingField;    // 0x0x20
    public int <JGOMAINLILD>k__BackingField;    // 0x0x24
    public long <KPLHBEGIKDF>k__BackingField;    // 0x0x28
    public long? <DKKDONJKCKI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{oOCEPAEEAMM}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <HOFKFMKJODD>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <PIEALNDKAAE>k__BackingField;    // 0x0x18
}
...
{
    public long <BMGHLAJCNMI>k__BackingField;    // 0x0x10
    public long <KPLHBEGIKDF>k__BackingField;    // 0x0x18
    public long <HJFLALDBPHG>k__BackingField;    // 0x0x20
    public JEIBEGJBNKG <OJGMDHEDIHG>k__BackingField;    // 0x0x28
    public int <BMANGPOENIP>k__BackingField;    // 0x0x2C
}
...
{
    public long <KPLHBEGIKDF>k__BackingField;    // 0x0x10
    public List<Guid> <IHPJAGDGKMB>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <HOFKFMKJODD>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <PIEALNDKAAE>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <BFLNMCLHJKE>k__BackingField;    // 0x0x20
}
...
{
    public long <HJFLALDBPHG>k__BackingField;    // 0x0x10
    public long <KOHBLBFIEDE>k__BackingField;    // 0x0x18
    public int? <ILFFEEEOIOL>k__BackingField;    // 0x0x20
    public int? <BKICGGNNEDI>k__BackingField;    // 0x0x28
    public long? <HJMJEKGLLLI>k__BackingField;    // 0x0x30
    public long <NLIJIANOOIK>k__BackingField;    // 0x0x40
    public long <BIJACGENNLI>k__BackingField;    // 0x0x48
    public int <NIILAIJPAKO>k__BackingField;    // 0x0x50
    public JEIBEGJBNKG <DECIAFEDIJB>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <EMFGGOBELMK>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public DDGHGFDKBBK <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public MCHADAHGOKF creatorAccountRole;    // 0x0x58
}
...
{
    public HKPDFCGGANN <NKJNEKONHPG>k__BackingField;    // 0x0x10
    public CHKFGCJAKHM <OLEAJIPPJHK>k__BackingField;    // 0x0x14
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x18
    public string <CDEJAOPOFOP>k__BackingField;    // 0x0x20
    public bool <DCGKAKLKJNM>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<HKPDFCGGANN> <BJPOFIHPBDO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{jKHMKIDBHPH}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <KOHBLBFIEDE>k__BackingField;    // 0x0x10
    public string <HJLDPDAHLMD>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <KAOGKIMHCII>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <JEKPFGANMIN>k__BackingField;    // 0x0x28
    public DateTime <NJCPGCNJDHB>k__BackingField;    // 0x0x30
    public DateTime <BFNOFJLFGGL>k__BackingField;    // 0x0x38
    public DateTime <JBALLCDBCFC>k__BackingField;    // 0x0x40
    public bool <GCIPKJJHFAL>k__BackingField;    // 0x0x48
    public int <DKEHCGBPOOG>k__BackingField;    // 0x0x4C
    public float <LDBKOINEPLC>k__BackingField;    // 0x0x50
    public Guid? <KOFNHIHHADA>k__BackingField;    // 0x0x54
    public string <FJJNJGMAGNK>k__BackingField;    // 0x0x68
    public string <DGIPDCNFGIN>k__BackingField;    // 0x0x70
    public string <JABKAPPCADP>k__BackingField;    // 0x0x78
    public string <MFDMBGHHAIM>k__BackingField;    // 0x0x80
}
...
{
    public Guid <AEJBGKBFIJG>k__BackingField;    // 0x0x10
    public int <NNBDABGHOLP>k__BackingField;    // 0x0x20
    public int <FCDMKBPFOJE>k__BackingField;    // 0x0x24
    public int <DGPGGGAHFHG>k__BackingField;    // 0x0x28
    public long <HGNEMCNJNII>k__BackingField;    // 0x0x30
    public long <MGDJCDEMBNM>k__BackingField;    // 0x0x38
}
...
{
    public int <EAHPDDPBLMD>k__BackingField;    // 0x0x10
    public int <COPGDGNNNCH>k__BackingField;    // 0x0x14
    public int <IKCIHJCNEPL>k__BackingField;    // 0x0x18
    public int <IMMMBBNGENK>k__BackingField;    // 0x0x1C
    public int <KICAJMIHPDH>k__BackingField;    // 0x0x20
    public DateTime? <CKDBECJJIKC>k__BackingField;    // 0x0x28
}
...
{
    public long <ODIHKPJANOK>k__BackingField;    // 0x0x10
    public int <CLGACAPLFML>k__BackingField;    // 0x0x18
    public string <NNIIAHDILMD>k__BackingField;    // 0x0x20
    public int <COPGDGNNNCH>k__BackingField;    // 0x0x28
    public int <NAJOILNKAGO>k__BackingField;    // 0x0x2C
    public bool <JAMDCAMDLCA>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public PCMDALICGDD ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool LKPLCFGGFCP;    // 0x0x28
}
...
{
    public BDGBCJECGPP? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [Auth POST]
public class PlayerCheerV1CreateRequest
{
    public BDGBCJECGPP ADHALPCBMBA;  // wrapper
...
{
    public CCJLLABHMJD JEEELOLNMGJ;  // wrapper
...
{
    public IIJKLLMNBOI FLPJMDMACMC;  // wrapper
    public int? FJEOFCEAENN;  // wrapper
...
{
    public DHIINPECDJG PAHIFJMCNGE;  // wrapper
    public float? LDIOGEEKNAM;  // wrapper
    public bool? KINHDIIAGDB;  // wrapper
...
{
    public List<KJPHDDIDNHP> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public DDGHGFDKBBK KAEEGPAIBEC;  // wrapper
    public DDGHGFDKBBK? FPJPNGGEIPK;  // wrapper
...
{
    public ChatMessage JGNAJPMGGNE;  // wrapper
    public EPDFHDKOPBG PAHIFJMCNGE;  // wrapper
...
{
    public AMGJHJOBMLJ DOGLIFIFMAK;  // wrapper
    public JJFBOENEPNB NEJAJFFCANO;  // wrapper
    public CLFIGIGALPE MNBHKKGFEKJ;  // wrapper
    public CLFIGIGALPE PFIJIHCNLEN;  // wrapper
...
{
    public AAKMONHLKHG LNCNMDNGACD;  // wrapper
    public DDGHGFDKBBK? DFGLFLFFNPN;  // wrapper
...
{
    public IPOGMCCJGGI LGLJFDLNEEJ;  // wrapper
...
{
    public JECNHAPCIHC inventionId;  // wrapper
}
...
// api/keepsakes/{bICMFMGLGLI}/collect  [Auth POST]
public class KeepsakesBICMFMGLGLICollectRequest
{
    public Guid BICMFMGLGLI;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public GGNILCLMNHK JFHAHJALGMK;  // wrapper
    public long? NCFOOPOBBIJ;  // wrapper
...
{
    public Guid LEMDIGJHHBG;  // wrapper
...
{
    public Guid JIHEFNOOGLI;  // wrapper
    public object Price;  // candidate
...
{
    public Guid JIHEFNOOGLI;  // wrapper
    public long? NJAJNECCAJF;  // wrapper
    public byte? BHDANKLFIDC;  // wrapper
    public int? NHDAKDKKMHH;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid LEMDIGJHHBG;  // wrapper
    public long? DEDPLGDDGEB;  // wrapper
    public long? PKCPADAEEFG;  // wrapper
    public int? ADLNMELCEDO;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> HELLICJGLED;  // wrapper
...
{
    public HHAKAJCILML FLPJMDMACMC;  // wrapper
    public Guid? KJCMLCGANLI;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public DHIINPECDJG PAHIFJMCNGE;  // wrapper
    public long? HNFPBGLODNG;  // wrapper
    public Guid? HALAEDGFDHK;  // wrapper
    public int? CNKEJEIFOIN;  // wrapper
...
{
    public Guid CNBNJGGDFPM;  // wrapper
...
{
    public Guid KAJJNHDJENL;  // wrapper
...
{
    public INIGDDDGJAA PFNLIJMFPMI;  // wrapper
}
