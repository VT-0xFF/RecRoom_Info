...
public class ABEAKAFJMMG
{
    public int <PMHNLHPGOFP>k__BackingField;    // 0x0x10
}
...
public class ABLCBIHGGLI : HOBBFPHIHDM
{
    public EHHCLKCLABG? <LLNJLIGBBMD>k__BackingField;    // 0x0x18
    public DDLCNCBELPI <CDEIFBJALLO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ACNCJIJNGDO
//   (not directly referenced by a detected call)
public class ACNCJIJNGDO
{
    public int <IJKGPCCBHGL>k__BackingField;    // 0x0x10
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x18
    public string <HDPHHNJIHIC>k__BackingField;    // 0x0x20
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x28
    public string <KHHKMMKOFEE>k__BackingField;    // 0x0x30
    public bool <HPHAICADCBO>k__BackingField;    // 0x0x38
    public int <HHKOHCAPGIG>k__BackingField;    // 0x0x3C
    public MNMICEBLILB <FAFEAFFFPEK>k__BackingField;    // 0x0x40
    public KIFFGNKLKIA IMIDEBCJIFN;    // 0x0x48
    public KIFFGNKLKIA GGGHMIEMEFM;    // 0x0x50
    public KIFFGNKLKIA NKIAFKHNGIG;    // 0x0x58
    public HDAFLILBHDC FMIEDCBPFKE;    // 0x0x60
}

// --------------------------------------------------------------------------
// ADEDOAKFGGD
// base   : NGNMLJNCLAI`1<CBAJEIFIAPH>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{fKKKAPKCEIG}   [Service.Auth]
public class ADEDOAKFGGD
{
...
public class ADFPPLJMPGI
{
    public int <FDBHMLHLNDG>k__BackingField;    // 0x0x10
    public int <IELIPCMHBLD>k__BackingField;    // 0x0x14
    public float <MKALKPEOLDC>k__BackingField;    // 0x0x18
    public float <IFMOLLAHPGA>k__BackingField;    // 0x0x1C
    public bool <NNFCMOJJKLL>k__BackingField;    // 0x0x20
    public bool <CHDCGCOBDKM>k__BackingField;    // 0x0x21
    public bool <FHEFKPIDJOJ>k__BackingField;    // 0x0x22
}
...
public class AGBPFHAJCBP
{
    public byte <KBMPHNIIJKI>k__BackingField;    // 0x0x10
    public int <IEPELJHGHKP>k__BackingField;    // 0x0x14
}
...
//   RESPONSE DELETE api/keepsakes/{oBLNJEPEFPG}   [Service.Auth]
...
public class ALAHNNNHBGI
{
    public bool <CCBLPMOMJEJ>k__BackingField;    // 0x0x10
    public string <PPOLAAMNDMC>k__BackingField;    // 0x0x18
}
...
public class AOGMINEPOMB
{
    public Guid <AMGBGJFPDBN>k__BackingField;    // 0x0x10
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x20
    public string <CGFNKENMMCH>k__BackingField;    // 0x0x28
    public DateTime <DOAAPJKMGDC>k__BackingField;    // 0x0x30
    public DateTime? <JFPDBNABGPL>k__BackingField;    // 0x0x38
    public List<MPLNPCEGCBC> <ONNHKFIIKBJ>k__BackingField;    // 0x0x48
}
...
//   RESPONSE POST   api/progressionEvents/collect/{hLKGONIJIDN}/{bLKFBGEPDFM}   [Service.Auth]
public class BAEGIDAOFFA
{
    public long? <OFIGLLOELJC>k__BackingField;    // 0x0x10
    public int <NPBCGGJADPB>k__BackingField;    // 0x0x20
    public int? <NMCGHGFCJOD>k__BackingField;    // 0x0x24
    public string <ICBNCGNCECO>k__BackingField;    // 0x0x30
    public DIGADJFCLBL? <GLAAGAEHGLA>k__BackingField;    // 0x0x38
    public string <EACHGKNANDK>k__BackingField;    // 0x0x40
    public Guid? <NDONEKPHDNM>k__BackingField;    // 0x0x48
    public string <HEMMPMJBKND>k__BackingField;    // 0x0x60
    public string <HHLKKEBNJOC>k__BackingField;    // 0x0x68
    public DBHJEKGMJLL <LPPCBONECPO>k__BackingField;    // 0x0x70
    public int <HOIPABAPODN>k__BackingField;    // 0x0x74
    public int <AALDFDLBNEC>k__BackingField;    // 0x0x78
    public CLNJLBJMFHM <DJPEALLIJAE>k__BackingField;    // 0x0x7C
    public CJAKBAJCLDG <MNAFGHOGDHB>k__BackingField;    // 0x0x80
    public string <ENIBIJKCKGP>k__BackingField;    // 0x0x88
    public OLJNBBMOJJM <MKKOEELAGOK>k__BackingField;    // 0x0x90
    public AGBEKIKOEJM <JHPLDICFKEG>k__BackingField;    // 0x0x94
    public OOGHCHGEHPD? <ICDMLAACMAF>k__BackingField;    // 0x0x98
    public bool <LLMCCMOJGMH>k__BackingField;    // 0x0xA0
    public bool <PFNNNLNLPGF>k__BackingField;    // 0x0xA1
    public string <GDMMEEDFEAG>k__BackingField;    // 0x0xA8
    public bool <PKDCLCNKAFD>k__BackingField;    // 0x0xB0
    public bool EPJFFNJIOPN;    // 0x0xB1
}

// --------------------------------------------------------------------------
// BBLANJNBOFG
//   REQUEST  POST   api/playerevents/v1/report   [Service.Auth]
public class BBLANJNBOFG
{
    public BCMBEPOKCFL <AHIGEAGCAPG>k__BackingField;    // 0x0x10
    public long <DLNIMCPFFAB>k__BackingField;    // 0x0x18
    public string <JEELIJGPJJA>k__BackingField;    // 0x0x20
}
...
// BPJFLLJOIAI
//   (not directly referenced by a detected call)
public class BPJFLLJOIAI
{
    public int <CIAKDMMOOFJ>k__BackingField;    // 0x0x10
}
...
// base   : KNMBNJMHFBL
//   (not directly referenced by a detected call)
public class CEBHPHGFLHA : KNMBNJMHFBL
{
    public int <NAOFKOEOGKA>k__BackingField;    // 0x0x68
    public List<LIIINLNFBOP> <EMLHNKLABGG>k__BackingField;    // 0x0x70
    public List<LIIINLNFBOP> <IJPNAALGBKE>k__BackingField;    // 0x0x78
    public List<LIIINLNFBOP> <MFKJJHKGKIJ>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// CFBNFKPMHAM
//   (not directly referenced by a detected call)
public class CFBNFKPMHAM
{
    public float <LLFHHOIIKNB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CFIADMONBOA
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.Auth]
public class CFIADMONBOA
{
    public string <OFIGLLOELJC>k__BackingField;    // 0x0x10
    public string <KGEBLNIGCNP>k__BackingField;    // 0x0x18
    public string <BCGGOBIODDO>k__BackingField;    // 0x0x20
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x28
    public string <HPJGCBHLCOI>k__BackingField;    // 0x0x30
    public BOFJJGELNIN <FAMFCJPHBEH>k__BackingField;    // 0x0x38
    public List<string> <EOOLELHKPBL>k__BackingField;    // 0x0x40
    public List<string> <KFICDLHKGAN>k__BackingField;    // 0x0x48
    public string <DJGNPLEGNLC>k__BackingField;    // 0x0x50
    public List<IBBKEHGPPDL> <LDKMMFNMNJM>k__BackingField;    // 0x0x58
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{iCEEEPFACLP}   [Service.WWW]
public enum CGEGNJHIKGI
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class CKGLLJEJBMF
{
    public bool <IAMAJOLEKLK>k__BackingField;    // 0x0x10
    public string <KGEBLNIGCNP>k__BackingField;    // 0x0x18
    public string <HKEIFGJIFPP>k__BackingField;    // 0x0x20
}
...
public class CPDAFKANGEC
{
    public Guid <OFFBCFOOBAF>k__BackingField;    // 0x0x10
    public long <BLLOBHHEMND>k__BackingField;    // 0x0x20
}
...
public class CPGIIDGDCKJ
{
    public Dictionary<string, LALEFHIJMGM> <DIMGFJFPNIK>k__BackingField;    // 0x0x10
}
...
public class DADIMHJIHHB
{
    public List<HKKDKNMADBP> <KFICDLHKGAN>k__BackingField;    // 0x0x10
}
...
public class DCBBCDPKBBM : HOBBFPHIHDM
{
    public CAOEEHDCGIL? <LLNJLIGBBMD>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <OAEDHNDPCDB>k__BackingField;    // 0x0x20
}
...
public class DDCBNHNGNFE
{
    public NHNDIKBHNNJ <AHIGEAGCAPG>k__BackingField;    // 0x0x10
    public string <JEELIJGPJJA>k__BackingField;    // 0x0x18
    public int? <DICMBGPJCFE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DDLCNCBELPI
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.WWW]
public class DDLCNCBELPI
{
    public int <HHIAHKINJJL>k__BackingField;    // 0x0x10
    public Guid <KEECCEFBGBA>k__BackingField;    // 0x0x14
    public long <ABDOANPNHDP>k__BackingField;    // 0x0x28
    public DateTime <HCBJAOHPCED>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// DEBKIFGGLFN
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class DEBKIFGGLFN
{
    public Dictionary<Guid, OOOGFABLIIP> <EOLMPABBLJP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DHFHDFAPHAE
//   (not directly referenced by a detected call)
public class DHFHDFAPHAE
{
    public int <JOIFNLLPLEN>k__BackingField;    // 0x0x10
    public string <DKFGALPEPFG>k__BackingField;    // 0x0x18
    public string <KHHKMMKOFEE>k__BackingField;    // 0x0x20
    public string <KDDEJMALFEL>k__BackingField;    // 0x0x28
    public string <ICBNCGNCECO>k__BackingField;    // 0x0x30
    public string <EACHGKNANDK>k__BackingField;    // 0x0x38
    public Guid? <NDONEKPHDNM>k__BackingField;    // 0x0x40
    public DIGADJFCLBL? <GLAAGAEHGLA>k__BackingField;    // 0x0x54
    public string <HEMMPMJBKND>k__BackingField;    // 0x0x60
    public string <HHLKKEBNJOC>k__BackingField;    // 0x0x68
    public bool <LPDEPBGPIJA>k__BackingField;    // 0x0x70
    public bool <NCKMAGLHKIK>k__BackingField;    // 0x0x71
    public bool <EBPIAJBBJHO>k__BackingField;    // 0x0x72
    public CJAKBAJCLDG <LNBJJIGDDHA>k__BackingField;    // 0x0x74
    public DBHJEKGMJLL <LPPCBONECPO>k__BackingField;    // 0x0x78
    public int <HOIPABAPODN>k__BackingField;    // 0x0x7C
    public MKMHFBIPFNB <LEJDNKEMIJI>k__BackingField;    // 0x0x80
    public CLNJLBJMFHM <HBOOEEDCAIB>k__BackingField;    // 0x0x84
    public int? <OHPNNAKGMNG>k__BackingField;    // 0x0x88
    public string <HFHAOFJBLLM>k__BackingField;    // 0x0x90
    public int? <KNJFPDEJFNE>k__BackingField;    // 0x0x98
    public int? <JDIAEMDFEPB>k__BackingField;    // 0x0xA0
}
...
public class DKDLBEGBEGK
{
    public Guid? <BGOGJAGONFF>k__BackingField;    // 0x0x10
    public long? <EIMBALJPAND>k__BackingField;    // 0x0x28
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x38
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x40
    public string <CGFNKENMMCH>k__BackingField;    // 0x0x48
    public PDDMFKBMCHD <FKADKAJBJNG>k__BackingField;    // 0x0x50
}
...
public class ELLFPKBKNHK
{
    public List<int> <CLLJEAGFILP>k__BackingField;    // 0x0x10
    public string <KIPBJDIIFOB>k__BackingField;    // 0x0x18
}
...
public class EMGEAPMHDNG
{
    public List<string> <FLBMCDEJHEM>k__BackingField;    // 0x0x10
    public List<string> <NOPBIOPHIPO>k__BackingField;    // 0x0x18
    public List<string> <GEKKAMHBOKD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ENIPDOLPNGN
//   REQUEST  POST   api/equipment/v1/update   [Service.WWW]
public class ENIPDOLPNGN
{
    public string <AABMJPBCMKJ>k__BackingField;    // 0x0x10
    public string <DAEKELGDAFB>k__BackingField;    // 0x0x18
    public string <DKFGALPEPFG>k__BackingField;    // 0x0x20
    public string <KHHKMMKOFEE>k__BackingField;    // 0x0x28
    public CJAKBAJCLDG <LNBJJIGDDHA>k__BackingField;    // 0x0x30
    public bool GNJCCOOFCBB;    // 0x0x34
    public bool <FHEFKPIDJOJ>k__BackingField;    // 0x0x35
}

// --------------------------------------------------------------------------
// EOIBOKCGEIE
// base   : NGNMLJNCLAI`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class EOIBOKCGEIE
{
    // (no instance fields in the metadata dump)
}
...
public class EOJICEEPKEA
{
    public int? <MMEFEHEBCEO>k__BackingField;    // 0x0x10
    public string <HPJGCBHLCOI>k__BackingField;    // 0x0x18
    public string <KENOMCANDDN>k__BackingField;    // 0x0x20
}
...
// FDFBFCBHCPE
//   (not directly referenced by a detected call)
public class FDFBFCBHCPE
{
    public Guid <BGOGJAGONFF>k__BackingField;    // 0x0x10
    public int <HHIAHKINJJL>k__BackingField;    // 0x0x20
    public int <DPHKGIFJEGP>k__BackingField;    // 0x0x24
    public Guid <GMIABCHAFLP>k__BackingField;    // 0x0x28
    public DateTime <HCBJAOHPCED>k__BackingField;    // 0x0x38
    public IIGPGLCMPMC <DFHJILOKHIB>k__BackingField;    // 0x0x40
}
...
// FNIBPNBBNPO
//   (not directly referenced by a detected call)
public class FNIBPNBBNPO
{
    public long <AHKOFJKLJOB>k__BackingField;    // 0x0x10
    public Guid <POOCHJKIGMA>k__BackingField;    // 0x0x18
    public long <EIMBALJPAND>k__BackingField;    // 0x0x28
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x30
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x38
    public int <DBBNAKHKGCI>k__BackingField;    // 0x0x40
    public Guid? <OLBGMGBHIBM>k__BackingField;    // 0x0x44
    public DateTime <LJPOEDFLJPH>k__BackingField;    // 0x0x58
    public string <CGFNKENMMCH>k__BackingField;    // 0x0x60
    public ALJHBOCDJPO <MIIJEEMPFJG>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FOFKILIDCLL
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.WWW]
public class FOFKILIDCLL
{
    public int HFCEGLOCBCE;    // 0x0x10
    public long BGNLFFLHFJE;    // 0x0x18
}

// --------------------------------------------------------------------------
// FOLKEOFFALL
//   RESPONSE GET    api/config/v2   [Service.Auth]
public class FOLKEOFFALL
{
    public Dictionary<int, int> <NPDHONIPCKG>k__BackingField;    // 0x0x10
    public List<LOEKCJDGAIJ> <DHNMCGLOAFB>k__BackingField;    // 0x0x18
    public JDDLAHCEOMD[][] <EOPNJFJHKGA>k__BackingField;    // 0x0x20
    public ABEAKAFJMMG <ODEGBCAAFML>k__BackingField;    // 0x0x28
    public PBIFNJFNKLE <PCEOFJNADDO>k__BackingField;    // 0x0x30
    public BPJFLLJOIAI <PFCOFEIJJAJ>k__BackingField;    // 0x0x38
    public MFOKIGKCAAE <HKHLEKKAPHE>k__BackingField;    // 0x0x40
    public CFBNFKPMHAM <FGIEFOLMMIK>k__BackingField;    // 0x0x48
    public string <ELACOKBHPMK>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// FPPFOEKNNNJ
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.WWW]
public class FPPFOEKNNNJ
{
    public List<GJEFGIFKCAJ> <DNODELJAOHL>k__BackingField;    // 0x0x10
    public string <KIPBJDIIFOB>k__BackingField;    // 0x0x18
}
...
public class GDFACKBDECC
{
    public long <DLNIMCPFFAB>k__BackingField;    // 0x0x10
    public NBBHJCNIAKB <MIIJEEMPFJG>k__BackingField;    // 0x0x18
}
...
public class GGCLDOLILPL : HMFDENAIHPJ
{
    public List<HKKDKNMADBP> <KFICDLHKGAN>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// GJEFGIFKCAJ
//   (not directly referenced by a detected call)
public class GJEFGIFKCAJ
{
    public int <IFPLMNKCGPE>k__BackingField;    // 0x0x10
    public DateTime <LJPOEDFLJPH>k__BackingField;    // 0x0x18
    public DateTime? <ELJBKEOKHEN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GKOPNOMENHA
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.Auth]
public class GKOPNOMENHA
{
    public List<PMHHIIEAEAB> <MDFNNLAPOIP>k__BackingField;    // 0x0x10
    public MKCJNLPMPBP <PGMJOCLHIKD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GLHJKPCCEHH
//   (not directly referenced by a detected call)
public class GLHJKPCCEHH
{
    public HMFDENAIHPJ <JNAFOCAOKGJ>k__BackingField;    // 0x0x10
    public OHBILLNOHOI <OHCEPLMDIFF>k__BackingField;    // 0x0x18
}
...
public class GMPBBILIMCG
{
    public KNPEIDEKAFP <HOJOAPDBKLD>k__BackingField;    // 0x0x10
    public PDDMFKBMCHD <HHDFDBFDBDO>k__BackingField;    // 0x0x18
    public int <NNDAJGPJMGP>k__BackingField;    // 0x0x20
}
...
public class GONEHGKEBBC
{
    public DIGADJFCLBL <GLAAGAEHGLA>k__BackingField;    // 0x0x10
    public string <DFPHPCIPGBA>k__BackingField;    // 0x0x18
    public string <DKFGALPEPFG>k__BackingField;    // 0x0x20
    public string <KHHKMMKOFEE>k__BackingField;    // 0x0x28
    public CJAKBAJCLDG <LNBJJIGDDHA>k__BackingField;    // 0x0x30
    public string <KDDEJMALFEL>k__BackingField;    // 0x0x38
    public int <KNJFPDEJFNE>k__BackingField;    // 0x0x40
    public bool <EFKNCCJEEPK>k__BackingField;    // 0x0x44
}
...
public class HIEGOPCFNJA
{
    public GGCLDOLILPL <JNAFOCAOKGJ>k__BackingField;    // 0x0x10
    public MKCJNLPMPBP <PGMJOCLHIKD>k__BackingField;    // 0x0x18
    public JBACDLBFAPI <JEDAMIGOLBF>k__BackingField;    // 0x0x20
}
...
public class HJGDOCEALHP
{
    public int <IELIPCMHBLD>k__BackingField;    // 0x0x10
    public bool <NNFCMOJJKLL>k__BackingField;    // 0x0x14
    public DateTime <EKPJDFGDBFI>k__BackingField;    // 0x0x18
    public bool <CNFNNENNLKB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HKKDKNMADBP
//   (not directly referenced by a detected call)
public class HKKDKNMADBP
{
    public string <BJGGIAHPCAG>k__BackingField;    // 0x0x10
    public FGDKOKLOKJD <MIIJEEMPFJG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HMFDENAIHPJ
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class HMFDENAIHPJ
{
    public long <DLNIMCPFFAB>k__BackingField;    // 0x0x10
    public int <MIONCGNGBLL>k__BackingField;    // 0x0x18
    public long <EIMBALJPAND>k__BackingField;    // 0x0x20
    public long? <BPPJJEIDMDJ>k__BackingField;    // 0x0x28
    public long? <KCAMHNJHIDB>k__BackingField;    // 0x0x38
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x48
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x50
    public string <CGFNKENMMCH>k__BackingField;    // 0x0x58
    public DateTime <ILPKLLAEDJC>k__BackingField;    // 0x0x60
    public DateTime <LFCLGDKKOLJ>k__BackingField;    // 0x0x68
    public int <IJCFPDPJMEJ>k__BackingField;    // 0x0x70
    public KJOPDMKKHKF <JJNANJGNODG>k__BackingField;    // 0x0x74
    public bool <NCOPONKDAJG>k__BackingField;    // 0x0x78
    public bool <CKAMKMEPFOI>k__BackingField;    // 0x0x79
    public AIHDKBNLBEC <BMIHBHFOCBM>k__BackingField;    // 0x0x7C
    public AIHDKBNLBEC <LHNMMKJBLAI>k__BackingField;    // 0x0x80
    public long? <LBENHNPLDMG>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// HMMKONJIBLD
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.Auth]
public class HMMKONJIBLD
{
    public List<long> <LHELKFOGGGK>k__BackingField;    // 0x0x10
    public OJLDFFFENLM <MIIJEEMPFJG>k__BackingField;    // 0x0x18
    public string <FGBNDOBALPC>k__BackingField;    // 0x0x20
    public long? <EIMBALJPAND>k__BackingField;    // 0x0x28
}
...
public class HNELAICAHDF
{
    public List<Guid> <KONDEPDOKAH>k__BackingField;    // 0x0x10
    public byte <KBMPHNIIJKI>k__BackingField;    // 0x0x18
    public int <IEPELJHGHKP>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// IBBKEHGPPDL
//   (not directly referenced by a detected call)
public class IBBKEHGPPDL
{
    public DateTime <LJPOEDFLJPH>k__BackingField;    // 0x0x10
    public string <KOIOALAJCJN>k__BackingField;    // 0x0x18
}
...
public class IFKELAKMKJN
{
    public int <BKIFJOILJIA>k__BackingField;    // 0x0x10
    public HCJADHIGEFP <MIIJEEMPFJG>k__BackingField;    // 0x0x14
    public PCMCCCENNDC <LDLMLLFHHNM>k__BackingField;    // 0x0x18
    public PCMCCCENNDC <KCJHJKOMFLJ>k__BackingField;    // 0x0x1C
    public PCMCCCENNDC <BCHIHPBOPIC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IIGPGLCMPMC
//   (not directly referenced by a detected call)
public class IIGPGLCMPMC
{
    public Guid <BGOGJAGONFF>k__BackingField;    // 0x0x10
    public long <EIMBALJPAND>k__BackingField;    // 0x0x20
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x28
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x30
    public string <CGFNKENMMCH>k__BackingField;    // 0x0x38
    public long <DBBNAKHKGCI>k__BackingField;    // 0x0x40
    public Guid? <OLBGMGBHIBM>k__BackingField;    // 0x0x48
    public DateTime <HCBJAOHPCED>k__BackingField;    // 0x0x60
    public int <CHMCEJMOJNL>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// IJBLFOOBMKK
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.Auth]
public class IJBLFOOBMKK
{
    public BCMBEPOKCFL <AHIGEAGCAPG>k__BackingField;    // 0x0x10
    public int <ELFIJHHEENC>k__BackingField;    // 0x0x14
    public long <NIGJMBBMGIC>k__BackingField;    // 0x0x18
    public bool <BIDCGCNBGHJ>k__BackingField;    // 0x0x20
    public string <EAMFACHKPIC>k__BackingField;    // 0x0x28
    public int? <EICGGIAAOBJ>k__BackingField;    // 0x0x30
    public bool <EKNOEOFCPJM>k__BackingField;    // 0x0x38
    public bool <AICJIIMNAIP>k__BackingField;    // 0x0x39
    public bool <GAIGKAAPLAJ>k__BackingField;    // 0x0x3A
    public bool <NMLDBLIMKOF>k__BackingField;    // 0x0x3B
    public string <MLGLIPOOHNP>k__BackingField;    // 0x0x40
    public DateTime? <EOBHNAFANIC>k__BackingField;    // 0x0x48
    public string <EBOPJCBFGIK>k__BackingField;    // 0x0x58
    public float <JKPFEKIOKCI>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// IKAIBOGHPDA
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.WWW]
public class IKAIBOGHPDA
{
    public int <ELFIJHHEENC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JBACDLBFAPI
//   RESPONSE POST   api/inventions/v1/settags   [Service.Auth]
public class JBACDLBFAPI
{
    public PJBGJDKNOCP <PGMJOCLHIKD>k__BackingField;    // 0x0x10
    public List<string> <KFICDLHKGAN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JBKDIHIIBDB
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.Auth]
public class JBKDIHIIBDB
{
    public int <GHKAIMDDJDI>k__BackingField;    // 0x0x10
    public int? <AOLIDDNFLNF>k__BackingField;    // 0x0x14
    public string <LIBLOEAGDNC>k__BackingField;    // 0x0x20
    public string <OKGJMPNNBAI>k__BackingField;    // 0x0x28
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{kKPLAHHAOAP}   [Service.WWW]
public class JBNIGNLHMMD
{
    public PCBHLALBHKF <FAMFCJPHBEH>k__BackingField;    // 0x0x10
    public IIGPGLCMPMC <DFHJILOKHIB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JDDLAHCEOMD
//   (not directly referenced by a detected call)
public class JDDLAHCEOMD
{
    public LMMJADGCFJL BHBPOPKNEKI;    // 0x0x10
    public int OOPIDCHKODC;    // 0x0x14
}
...
// JKMGAACNCKG
//   (not directly referenced by a detected call)
public class JKMGAACNCKG
{
    public ObscuredLong <AGKGNCLBKHL>k__BackingField;    // 0x0x10
    public string <POOCHJKIGMA>k__BackingField;    // 0x0x38
    public ObscuredInt <KLINFJLILCM>k__BackingField;    // 0x0x40
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x58
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x60
    public string <CGFNKENMMCH>k__BackingField;    // 0x0x68
    public byte <PDKCLOIGGCP>k__BackingField;    // 0x0x70
    public int <IFEMKGDKEGB>k__BackingField;    // 0x0x74
    public KCMDKMFGMIO <JJNANJGNODG>k__BackingField;    // 0x0x78
    public bool <ELLBBHIKIFH>k__BackingField;    // 0x0x7C
    public DateTime <HCBJAOHPCED>k__BackingField;    // 0x0x80
    public DateTime <LJPOEDFLJPH>k__BackingField;    // 0x0x88
    public DateTime? <AAPEDHHFBND>k__BackingField;    // 0x0x90
    public long? <DHFBOLGHPJE>k__BackingField;    // 0x0xA0
    public int <IHOILHANANF>k__BackingField;    // 0x0xB0
    public int <GIKPPAALJCJ>k__BackingField;    // 0x0xB4
    public int <EBOCLAPEJGA>k__BackingField;    // 0x0xB8
    public PPDAALAPABN <IMIEEHGCEHH>k__BackingField;    // 0x0xBC
    public PPDAALAPABN <FBCMPLEDAFA>k__BackingField;    // 0x0xC0
    public ObscuredBool <MEGHOGINAJG>k__BackingField;    // 0x0xC4
    public ObscuredBool <LDKAADMFCFE>k__BackingField;    // 0x0xD0
    public ObscuredBool <CHFJLOLPJJI>k__BackingField;    // 0x0xDC
    public int? <DBBNAKHKGCI>k__BackingField;    // 0x0xE8
    public bool <PEOGADLOPMG>k__BackingField;    // 0x0xF0
}
...
// KEGFAJBHEGB
//   (not directly referenced by a detected call)
public class KEGFAJBHEGB
{
    public bool <CIKIBHAGGFM>k__BackingField;    // 0x0x10
    public AGBEKIKOEJM <NJOADBHICMF>k__BackingField;    // 0x0x14
    public int <FLGKKIJJIGA>k__BackingField;    // 0x0x18
    public DateTime <HCBJAOHPCED>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KGGJOEFEHEM
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.Auth]
public class KGGJOEFEHEM
{
    public List<HMFDENAIHPJ> <FMNPHEGAICL>k__BackingField;    // 0x0x10
    public string <KIPBJDIIFOB>k__BackingField;    // 0x0x18
}
...
public class KGMOHMPEPCO
{
    public Dictionary<Guid, MDDANJLOIOI> <PIADPMMFPFL>k__BackingField;    // 0x0x10
}
...
// KNMBNJMHFBL
//   (not directly referenced by a detected call)
public class KNMBNJMHFBL
{
    public int <MLDGFHADPKB>k__BackingField;    // 0x0x10
    public AELBODHMEEH <MIIJEEMPFJG>k__BackingField;    // 0x0x14
    public List<MNHAHIJHHDJ> <BGKPKKGMPBF>k__BackingField;    // 0x0x18
    public List<MNHAHIJHHDJ> <HENOCBNHDDN>k__BackingField;    // 0x0x20
    public bool <ODJMFPJBBOF>k__BackingField;    // 0x0x28
    public DateTime? <DLGGMCOGIIN>k__BackingField;    // 0x0x30
    public DateTime? <NHCKCEOKPJN>k__BackingField;    // 0x0x40
    public DateTime? <IKOFFOFHAHC>k__BackingField;    // 0x0x50
    public bool <NENGCDEHCFN>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// KNPEIDEKAFP
//   REQUEST  PUT    api/roomconsumables   [Service.WWW]
public class KNPEIDEKAFP
{
    public Guid? <ICIKKEEMLHC>k__BackingField;    // 0x0x10
    public Guid <GLJBPNOLCIG>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// LALEFHIJMGM
//   (not directly referenced by a detected call)
public class LALEFHIJMGM
{
    public long <ELPKMJOMGAA>k__BackingField;    // 0x0x10
    public Guid <NDONEKPHDNM>k__BackingField;    // 0x0x18
    public Guid <FIHKCBNECOA>k__BackingField;    // 0x0x28
    public DateTime <LJPOEDFLJPH>k__BackingField;    // 0x0x38
    public string <CKCNMODEMJE>k__BackingField;    // 0x0x40
    public string <DPLPLHMEOFF>k__BackingField;    // 0x0x48
    public string <EHHHCIGFLOB>k__BackingField;    // 0x0x50
    public string <BPGLICEJAJJ>k__BackingField;    // 0x0x58
    public string <GOGDPNOIMED>k__BackingField;    // 0x0x60
    public string <KHNNPMBHMEL>k__BackingField;    // 0x0x68
}
...
public class LFMBNHNFJLP
{
    public long <EIMBALJPAND>k__BackingField;    // 0x0x10
    public long? <BPPJJEIDMDJ>k__BackingField;    // 0x0x18
    public long? <KCAMHNJHIDB>k__BackingField;    // 0x0x28
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x38
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x40
    public List<string> <KFICDLHKGAN>k__BackingField;    // 0x0x48
    public string <CGFNKENMMCH>k__BackingField;    // 0x0x50
    public DateTime <ILPKLLAEDJC>k__BackingField;    // 0x0x58
    public DateTime <LFCLGDKKOLJ>k__BackingField;    // 0x0x60
    public KJOPDMKKHKF <JJNANJGNODG>k__BackingField;    // 0x0x68
    public bool <NCOPONKDAJG>k__BackingField;    // 0x0x6C
    public bool <CKAMKMEPFOI>k__BackingField;    // 0x0x6D
    public AIHDKBNLBEC <BMIHBHFOCBM>k__BackingField;    // 0x0x70
    public AIHDKBNLBEC <LHNMMKJBLAI>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// LHDDEENJBHB
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.WWW]
public class LHDDEENJBHB
{
    public List<string> <DCEEPEMAGCO>k__BackingField;    // 0x0x10
}
...
public class LHEKNKDHAHL
{
    public MKCJNLPMPBP <PGMJOCLHIKD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LIIINLNFBOP
//   (not directly referenced by a detected call)
public class LIIINLNFBOP
{
    public bool <CCEFENHKHAA>k__BackingField;    // 0x0x10
    public DHFHDFAPHAE <GFDCPKFPGBE>k__BackingField;    // 0x0x18
    public float <CODCLENAIMC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LJJCOCFLMOF
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.WWW]
public class LJJCOCFLMOF
{
    public long <AHKOFJKLJOB>k__BackingField;    // 0x0x10
    public int <HHIAHKINJJL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LJOFHEBKPPI
//   REQUEST  POST   api/challenge/v2/updateProgress   [Service.WWW]
public class LJOFHEBKPPI
{
    public int <EOBEFDKJIHF>k__BackingField;    // 0x0x10
    public int <IJKGPCCBHGL>k__BackingField;    // 0x0x14
    public string <HDPHHNJIHIC>k__BackingField;    // 0x0x18
    public bool <HPHAICADCBO>k__BackingField;    // 0x0x20
}
...
public class LMNLOJKMGCG
{
    public Guid <KEECCEFBGBA>k__BackingField;    // 0x0x10
    public int <HKDADKAKFOP>k__BackingField;    // 0x0x20
    public long <LHJKLCJBIGL>k__BackingField;    // 0x0x28
    public Guid <OFFBCFOOBAF>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// MBPLPHINMBF
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItemDescs   [Service.Notifications]
public class MBPLPHINMBF
{
    public List<string> <JFNHBMLBELA>k__BackingField;    // 0x0x10
    public byte <KBMPHNIIJKI>k__BackingField;    // 0x0x18
    public int <IEPELJHGHKP>k__BackingField;    // 0x0x1C
}
...
//   RESPONSE GET    api/playerevents/v1/all/{pAOMPGNMDBM}   [Service.Auth]
public class MCEDFKFINIA
{
    public List<HMFDENAIHPJ> <KEFBMFLBIGL>k__BackingField;    // 0x0x10
    public List<GLHJKPCCEHH> <OGOPJEMJJKK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MDDANJLOIOI
//   RESPONSE PUT    api/roomconsumables   [Service.WWW]
public class MDDANJLOIOI
{
    public PCBHLALBHKF <FAMFCJPHBEH>k__BackingField;    // 0x0x10
    public FDFBFCBHCPE <CKDGMMPCGKJ>k__BackingField;    // 0x0x18
}
...
public class MDNCOKLEOFE
{
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x10
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x18
    public int? <DBBNAKHKGCI>k__BackingField;    // 0x0x20
    public KCMDKMFGMIO? <JJNANJGNODG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// MFOKIGKCAAE
//   (not directly referenced by a detected call)
public class MFOKIGKCAAE
{
    public int <HPJJOBEIIMM>k__BackingField;    // 0x0x10
}
...
public class MMDPBFDCFIG
{
    public bool <CCBLPMOMJEJ>k__BackingField;    // 0x0x10
    public string <EAMFACHKPIC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MMHJNCEDGHF
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{nOBCIMPKLCI}/{gAEAFHDCNMI}   [Service.WWW]
public class MMHJNCEDGHF
{
    public DBHJEKGMJLL <LPPCBONECPO>k__BackingField;    // 0x0x10
    public JDOAJDLNOIB <NOMMBLBFFLF>k__BackingField;    // 0x0x14
    public int <PCIGKBHHONF>k__BackingField;    // 0x0x18
    public int <LKIJHHGJNMM>k__BackingField;    // 0x0x1C
    public int <EGJGGGCCNAF>k__BackingField;    // 0x0x20
    public FLPFICBAPPJ <AKAAKMFOJOD>k__BackingField;    // 0x0x24
    public bool <CDENDMBIDOK>k__BackingField;    // 0x0x28
    public float <PLOCJMBAOKF>k__BackingField;    // 0x0x2C
    public int <LCEODMBIBDJ>k__BackingField;    // 0x0x30
    public bool <PJBNAGKFJHI>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// MNHAHIJHHDJ
//   (not directly referenced by a detected call)
public class MNHAHIJHHDJ
{
    public DBHJEKGMJLL <LPPCBONECPO>k__BackingField;    // 0x0x10
    public int <DBBNAKHKGCI>k__BackingField;    // 0x0x14
    public PIDBMFDDHKG <HGEEPCHEFPA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MNMICEBLILB
//   (not directly referenced by a detected call)
public class MNMICEBLILB
{
    // (no instance fields in the metadata dump)
}
...
// MPLNPCEGCBC
//   (not directly referenced by a detected call)
public class MPLNPCEGCBC
{
    public Guid <IFELAAOODAA>k__BackingField;    // 0x0x10
    public Guid <BDILOCLOOPH>k__BackingField;    // 0x0x20
    public DateTime <DOAAPJKMGDC>k__BackingField;    // 0x0x30
    public List<DHFHDFAPHAE> <BIDGCMEPMKL>k__BackingField;    // 0x0x38
}
...
// NCOFOFCHAAO
//   (not directly referenced by a detected call)
public class NCOFOFCHAAO
{
    public long <JOIFNLLPLEN>k__BackingField;    // 0x0x10
    public string <ICBNCGNCECO>k__BackingField;    // 0x0x18
    public string <PHGPEGAOGNJ>k__BackingField;    // 0x0x20
    public DIGADJFCLBL? <GLAAGAEHGLA>k__BackingField;    // 0x0x28
    public string <HEMMPMJBKND>k__BackingField;    // 0x0x30
    public string <HHLKKEBNJOC>k__BackingField;    // 0x0x38
    public LMALFIOHDNG <HDMAPLKFGMO>k__BackingField;    // 0x0x40
    public int <AALDFDLBNEC>k__BackingField;    // 0x0x44
    public int <BNAJGFMMKNA>k__BackingField;    // 0x0x48
    public CLNJLBJMFHM? <DJPEALLIJAE>k__BackingField;    // 0x0x4C
    public CJAKBAJCLDG? <MNAFGHOGDHB>k__BackingField;    // 0x0x54
}

// --------------------------------------------------------------------------
// NGIHIDGNFDG
//   RESPONSE POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForCustomAvatarItemIds   [Service.Notifications]
public class NGIHIDGNFDG
{
    public Dictionary<Guid, LALEFHIJMGM> <ACNCMFBCGBG>k__BackingField;    // 0x0x10
}
...
// base   : AEBCHDHFEDB
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/season/{mJCMJDOBEGE}   [Service.WWW]
public class NINHBMAIKJE : AEBCHDHFEDB
{
    public int <MKAGODNBCHJ>k__BackingField;    // 0x0x30
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x38
    public DateTime <DOAAPJKMGDC>k__BackingField;    // 0x0x40
    public DateTime <HLADLLBAIGP>k__BackingField;    // 0x0x48
    public DBHJEKGMJLL <LPPCBONECPO>k__BackingField;    // 0x0x50
    public KNMBNJMHFBL <EGBDNHKGKKC>k__BackingField;    // 0x0x58
    public List<CEBHPHGFLHA> <DFICEJBFAKB>k__BackingField;    // 0x0x60
    public KEGFAJBHEGB <BBGEFJLONPP>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// NLABFIPENKF
//   RESPONSE GET    api/challenge/v2/getCurrent   [Service.WWW]
public class NLABFIPENKF
{
    public int <EOBEFDKJIHF>k__BackingField;    // 0x0x10
    public string <OFFCFOBNIMM>k__BackingField;    // 0x0x18
    public List<ACNCJIJNGDO> <MFKMNPCCLJC>k__BackingField;    // 0x0x20
    public NCOFOFCHAAO <KLMENIGOOCF>k__BackingField;    // 0x0x28
    public string <CIOGEHJBMIC>k__BackingField;    // 0x0x30
    public DateTime <DOAAPJKMGDC>k__BackingField;    // 0x0x38
    public DateTime <HLADLLBAIGP>k__BackingField;    // 0x0x40
    public DateTime <HPLNGEECPNJ>k__BackingField;    // 0x0x48
    public bool? <NJNPCHOAEJM>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// OBKAKFFHPOO
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{mCGNHGLIJDN}   [Service.Auth]
public class OBKAKFFHPOO
{
    public uint <OFIGLLOELJC>k__BackingField;    // 0x0x10
    public uint? <GGPKGOPMGNM>k__BackingField;    // 0x0x14
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x20
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x28
    public DateTime <FEBMODEIDDJ>k__BackingField;    // 0x0x30
    public DateTime? <JMMDLJLJIGE>k__BackingField;    // 0x0x38
    public bool <EKGDIIEFJFG>k__BackingField;    // 0x0x48
    public List<CFIADMONBOA> <ECKFDFFBMEJ>k__BackingField;    // 0x0x50
    public List<string> <KFICDLHKGAN>k__BackingField;    // 0x0x58
    public int <PNDBLMECHCN>k__BackingField;    // 0x0x60
    public int <HHAKEIJMMEF>k__BackingField;    // 0x0x64
    public int <IIOOLJAHCIP>k__BackingField;    // 0x0x68
}
...
public class ODPIONDANFM
{
    public CGEGNJHIKGI <FAMFCJPHBEH>k__BackingField;    // 0x0x10
    public FNIBPNBBNPO <MAOCFGCHPNB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OHBILLNOHOI
//   (not directly referenced by a detected call)
public class OHBILLNOHOI
{
    public long <HNHNAOIGFIM>k__BackingField;    // 0x0x10
    public long <DLNIMCPFFAB>k__BackingField;    // 0x0x18
    public int <NPBCGGJADPB>k__BackingField;    // 0x0x20
    public DateTime <LJPOEDFLJPH>k__BackingField;    // 0x0x28
    public NBBHJCNIAKB <MIIJEEMPFJG>k__BackingField;    // 0x0x30
}
...
public class OKAKPDILHAI
{
    public AKLAJNPKANH <FAMFCJPHBEH>k__BackingField;    // 0x0x10
    public JKMGAACNCKG <LKPKEMFCBGP>k__BackingField;    // 0x0x18
    public OLPIGPMGFPM <AMPNFLGLLMP>k__BackingField;    // 0x0x20
}
...
// OLPIGPMGFPM
//   (not directly referenced by a detected call)
public class OLPIGPMGFPM
{
    public long <INPOBHOAFCM>k__BackingField;    // 0x0x10
    public string <POOCHJKIGMA>k__BackingField;    // 0x0x18
    public int <PKJJBIMJHFJ>k__BackingField;    // 0x0x20
    public int <DGAKEDMCGAP>k__BackingField;    // 0x0x24
    public int <KGIFAONCDHA>k__BackingField;    // 0x0x28
    public int <BAAFLEIPMHK>k__BackingField;    // 0x0x2C
    public int <MKNKJHCNHDD>k__BackingField;    // 0x0x30
    public string <AJFGMOIPOAP>k__BackingField;    // 0x0x38
    public string <DMIEJLJDGEP>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// ONIFNHLIDCE
//   RESPONSE GET    api/config/v2/amplitude   [Service.Auth]
public class ONIFNHLIDCE
{
    public string <NONGAHCJGKB>k__BackingField;    // 0x0x10
    public string <DMOFJDEPBCB>k__BackingField;    // 0x0x18
    public bool <LKLLIABONAN>k__BackingField;    // 0x0x20
    public string <KBJIJFCDKKJ>k__BackingField;    // 0x0x28
}
...
// OOOGFABLIIP
//   (not directly referenced by a detected call)
public class OOOGFABLIIP
{
    public int <NNDAJGPJMGP>k__BackingField;    // 0x0x10
    public KNPEIDEKAFP <HOJOAPDBKLD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PBIFNJFNKLE
//   (not directly referenced by a detected call)
public class PBIFNJFNKLE
{
    public float <ONODFFJNBBO>k__BackingField;    // 0x0x10
    public float <POAFFIEOLJE>k__BackingField;    // 0x0x14
    public float <BJLCFGKICLH>k__BackingField;    // 0x0x18
    public float <MNFFDGBKMHN>k__BackingField;    // 0x0x1C
    public float <DGMEAAHNMBF>k__BackingField;    // 0x0x20
    public float <MMKIHFEJCON>k__BackingField;    // 0x0x24
    public float <AKBHOGMOECE>k__BackingField;    // 0x0x28
    public float <MCKIAFFKDMF>k__BackingField;    // 0x0x2C
}
...
public class PDCCJKEOFCP
{
    public int <EOLIOMGPHLJ>k__BackingField;    // 0x0x10
    public int <MMEMAJJNJEB>k__BackingField;    // 0x0x14
    public float <MFEFHLHEFPE>k__BackingField;    // 0x0x18
    public int <NIKAGMPHJFN>k__BackingField;    // 0x0x1C
    public int <JGEEFAMDMCA>k__BackingField;    // 0x0x20
    public int <BOHDJIMNJAB>k__BackingField;    // 0x0x24
    public int <IOOAAHNOCBP>k__BackingField;    // 0x0x28
    public string <DINIMHHBCMO>k__BackingField;    // 0x0x30
    public string <MAPCLBAHAEM>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// PDDMFKBMCHD
//   (not directly referenced by a detected call)
public class PDDMFKBMCHD
{
    public long <DBBNAKHKGCI>k__BackingField;    // 0x0x10
    public Guid? <KEECCEFBGBA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PIDBMFDDHKG
//   (not directly referenced by a detected call)
public class PIDBMFDDHKG
{
    public int <BIAMILDKGMI>k__BackingField;    // 0x0x10
    public DateTime? <PHKNDIMPAAH>k__BackingField;    // 0x0x18
    public DateTime? <DAGMLEOOJBB>k__BackingField;    // 0x0x28
}
...
public class PJOEMIHAKAA
{
    public long <EIMBALJPAND>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <JIGCMEAILMB>k__BackingField;    // 0x0x18
    public HAIOJDHKPAM <PIHLFPGOPHO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PKDMKPFMJEE
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.WWW]
public class PKDMKPFMJEE
{
    public long <AHKOFJKLJOB>k__BackingField;    // 0x0x10
    public int <HHIAHKINJJL>k__BackingField;    // 0x0x18
}
...
// PMHHIIEAEAB
//   (not directly referenced by a detected call)
public class PMHHIIEAEAB
{
    public int <CGNBECNBDMI>k__BackingField;    // 0x0x10
    public MKCJNLPMPBP <PGMJOCLHIKD>k__BackingField;    // 0x0x14
}
...
public class AddKeepsakeInstanceRequest
{
    public long <EIMBALJPAND>k__BackingField;    // 0x0x10
    public long? <BPPJJEIDMDJ>k__BackingField;    // 0x0x18
    public NMJLEKDIICC <PJFBHFAPNGH>k__BackingField;    // 0x0x28
}
...
{
    public DOBGDIPHDKL <PGMJOCLHIKD>k__BackingField;    // 0x0x10
    public string <BCLHMGAGONL>k__BackingField;    // 0x0x18
    public string <GLDCGKFDKFB>k__BackingField;    // 0x0x20
    public string <ENMNFLKIFDC>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public DBHJEKGMJLL <CurrencyType>k__BackingField;    // 0x0x18
    public OOGHCHGEHPD <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <DLNIMCPFFAB>k__BackingField;    // 0x0x10
    public long? <CINAMBIPOAM>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public EJHMGCOOMEG FilterType;    // 0x0x20
...
{
    public NMJLEKDIICC <GKBMOMBHPIM>k__BackingField;    // 0x0x10
    public string <OMACLDPBMPH>k__BackingField;    // 0x0x18
    public int <BFLCMLNGNOC>k__BackingField;    // 0x0x20
    public int <FJNJACPCDLJ>k__BackingField;    // 0x0x24
    public string <BEJFDNFJLFB>k__BackingField;    // 0x0x28
    public string <FDAAPAGNPPB>k__BackingField;    // 0x0x30
}
...
{
    public int <HHIAHKINJJL>k__BackingField;    // 0x0x10
    public Guid <DJMOPLFMKME>k__BackingField;    // 0x0x14
    public DateTime <OONHOFCGPAF>k__BackingField;    // 0x0x28
}
...
{
    public bool <KOHCKKGALOK>k__BackingField;    // 0x0x10
    public int <CADDLLJMKFG>k__BackingField;    // 0x0x14
    public bool <KEHLJHHDLJG>k__BackingField;    // 0x0x18
}
...
{
    public Guid <DJMOPLFMKME>k__BackingField;    // 0x0x10
    public NMJLEKDIICC <HEFKNDBCEJP>k__BackingField;    // 0x0x20
    public int <EELOLLOGBFM>k__BackingField;    // 0x0x24
    public long <EIMBALJPAND>k__BackingField;    // 0x0x28
    public long? <BPPJJEIDMDJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{jCNPIAGIPMK}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <HEGGGECMMOI>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <PJBEINHMPLH>k__BackingField;    // 0x0x18
}
...
{
    public long <JJEJKGHFENH>k__BackingField;    // 0x0x10
    public long <EIMBALJPAND>k__BackingField;    // 0x0x18
    public long <MGHCHFLNPMM>k__BackingField;    // 0x0x20
    public IDJBDDLFOFG <MIIJEEMPFJG>k__BackingField;    // 0x0x28
    public int <CDLGKMEGLKA>k__BackingField;    // 0x0x2C
}
...
{
    public long <EIMBALJPAND>k__BackingField;    // 0x0x10
    public List<Guid> <DFGGMKNHNEH>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <HEGGGECMMOI>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <PJBEINHMPLH>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <CCKFMKJEFKC>k__BackingField;    // 0x0x20
}
...
{
    public long <MGHCHFLNPMM>k__BackingField;    // 0x0x10
    public long <KGLIFLNOGEC>k__BackingField;    // 0x0x18
    public int? <IIFBEOPFOKL>k__BackingField;    // 0x0x20
    public int? <FFGHOPFKAIP>k__BackingField;    // 0x0x28
    public long? <LGFNEKINMDC>k__BackingField;    // 0x0x30
    public long <BHGPHJPJEKP>k__BackingField;    // 0x0x40
    public long <KDCOOPJALAN>k__BackingField;    // 0x0x48
    public int <PNPOPJEEAEK>k__BackingField;    // 0x0x50
    public IDJBDDLFOFG <BBPJPKNADAH>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <PBCEGDIJONA>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public CLNJLBJMFHM <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public ODPHDGIGBPN creatorAccountRole;    // 0x0x58
}
...
{
    public JJLFCPMGGKI <IGAJEKKHLGE>k__BackingField;    // 0x0x10
    public DGIFJIJKOPJ <GKBAHGEINGD>k__BackingField;    // 0x0x14
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x18
    public string <FFPIGCAPMMK>k__BackingField;    // 0x0x20
    public bool <PLIOPLNLMCB>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<JJLFCPMGGKI> <KIHNJDOOHAO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{hLKGONIJIDN}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <KGLIFLNOGEC>k__BackingField;    // 0x0x10
    public string <GNEGDHMMBOP>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <MFKJJHKGKIJ>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <AFECMMBDNNM>k__BackingField;    // 0x0x28
    public DateTime <ILPKLLAEDJC>k__BackingField;    // 0x0x30
    public DateTime <LFCLGDKKOLJ>k__BackingField;    // 0x0x38
    public DateTime <CGMDONJGHJN>k__BackingField;    // 0x0x40
    public bool <FHPFFOMAOIC>k__BackingField;    // 0x0x48
    public int <PGBHJEHHIAF>k__BackingField;    // 0x0x4C
    public float <CENCIEFPONC>k__BackingField;    // 0x0x50
    public Guid? <IGDAONDKJLD>k__BackingField;    // 0x0x54
    public string <MCBLPANGAHP>k__BackingField;    // 0x0x68
    public string <LJPEHIMDJJC>k__BackingField;    // 0x0x70
    public string <EAIHDBKDEEN>k__BackingField;    // 0x0x78
    public string <FOBLMGBIHPG>k__BackingField;    // 0x0x80
}
...
{
    public Guid <DHBLPCOLLGA>k__BackingField;    // 0x0x10
    public int <FPJFJPJMMCC>k__BackingField;    // 0x0x20
    public int <IPHLOIOEAEG>k__BackingField;    // 0x0x24
    public int <KCMFBEONHLL>k__BackingField;    // 0x0x28
    public long <IANBJDLCPAL>k__BackingField;    // 0x0x30
    public long <BGAEEKMDENA>k__BackingField;    // 0x0x38
}
...
{
    public int <HHIAHKINJJL>k__BackingField;    // 0x0x10
    public int <AALDFDLBNEC>k__BackingField;    // 0x0x14
    public int <JGGEHEMIDNO>k__BackingField;    // 0x0x18
    public int <LELMKOGLKBD>k__BackingField;    // 0x0x1C
    public int <GOLBNKFJFIO>k__BackingField;    // 0x0x20
    public DateTime? <HIAIGOJHHHC>k__BackingField;    // 0x0x28
}
...
{
    public long <IODCDDJJHFA>k__BackingField;    // 0x0x10
    public int <JOIFNLLPLEN>k__BackingField;    // 0x0x18
    public string <CGFNKENMMCH>k__BackingField;    // 0x0x20
    public int <AALDFDLBNEC>k__BackingField;    // 0x0x28
    public int <NMHMMGNCNBL>k__BackingField;    // 0x0x2C
    public bool <MLIMLADFKPL>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public AGKJAFGBFEO ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool KJDEJJIDNAM;    // 0x0x28
}
...
{
    public KIBCPHHALJF? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [Auth POST]
public class PlayerCheerV1CreateRequest
{
    public KIBCPHHALJF JDAFIIIIEJA;  // wrapper
...
{
    public OLJNBBMOJJM NOMONPJMNAO;  // wrapper
...
{
    public JMBNEPKFIHI CGEOAHHPHHK;  // wrapper
    public int? PDNNKMFJKFI;  // wrapper
...
{
    public BCMBEPOKCFL MAHCKJNNPGO;  // wrapper
    public float? NDBOEGGPPDH;  // wrapper
    public bool? BACKIGCPLAN;  // wrapper
...
{
    public List<IMADIEACKLJ> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public CLNJLBJMFHM JGGBEOJAHKH;  // wrapper
    public CLNJLBJMFHM? LCJECOCDPBF;  // wrapper
...
{
    public ChatMessage CPPFNMDMGHI;  // wrapper
    public PECPDKFLFKO MAHCKJNNPGO;  // wrapper
...
{
    public KCMDKMFGMIO INLJBNBBCKM;  // wrapper
    public HKODBMADFIN GJBGFGJPGMK;  // wrapper
    public CGPLIAIIKHJ FGACFMKLHGM;  // wrapper
    public CGPLIAIIKHJ OMDPHOBEEGC;  // wrapper
...
{
    public CBJCKFIJNIO LGCACEMANNO;  // wrapper
    public CLNJLBJMFHM? KBJIOELGCHD;  // wrapper
...
{
    public DKKBDLMAJAK HEGAPEPGCPK;  // wrapper
...
{
    public JKMGAACNCKG inventionId;  // wrapper
}
...
// api/keepsakes/{oBLNJEPEFPG}/collect  [Auth POST]
public class KeepsakesOBLNJEPEFPGCollectRequest
{
    public Guid OBLNJEPEFPG;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public OJLDFFFENLM AIHGGGMCHKM;  // wrapper
    public long? ECEDKLNOLLD;  // wrapper
...
{
    public AIHDKBNLBEC FPKFHBHBHDI;  // wrapper
    public AIHDKBNLBEC BJNFIHLMJKC;  // wrapper
    public HMFDENAIHPJ KDGIBEMHIKL;  // wrapper
}
...
{
    public long? ADPGIJLEEII;  // wrapper
    public HMFDENAIHPJ KDGIBEMHIKL;  // wrapper
    public long? JKFLKNFJJJK;  // wrapper
}

// api/playerevents/v2/{eventId}/time  [Auth PUT]
public class PlayereventsV2EventIdTimeRequest
{
    public DateTime IJBOKNKJPIJ;  // wrapper
    public DateTime GCGHBENNAFK;  // wrapper
    public HMFDENAIHPJ KDGIBEMHIKL;  // wrapper
    public DateTime KJEEBJIMKFL;  // wrapper
    public DateTime PBKIHEONCIH;  // wrapper
}
...
{
    public Guid GECNMBBJBEH;  // wrapper
...
{
    public Guid HNFJNDFLBKG;  // wrapper
    public object Price;  // candidate
...
{
    public Guid HNFJNDFLBKG;  // wrapper
    public long? IKFEFCANNLO;  // wrapper
    public byte? HCLPPDPEFHM;  // wrapper
    public int? GLALCIBBONF;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid GECNMBBJBEH;  // wrapper
    public long? PLHFOOKICDN;  // wrapper
    public long? JPLCPGGDNGN;  // wrapper
    public int? GEFCGJGAHLA;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> BJIJPHEEEMG;  // wrapper
...
{
    public ALJHBOCDJPO CGEOAHHPHHK;  // wrapper
    public Guid? JJMLCAIILOK;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public BCMBEPOKCFL MAHCKJNNPGO;  // wrapper
    public long? PMDEMECNIGJ;  // wrapper
    public Guid? LNGONBKAGML;  // wrapper
    public int? EBOJFNCNGFF;  // wrapper
...
{
    public Guid GMMGGIOIIPM;  // wrapper
...
{
    public Guid NFBPLHLJLLA;  // wrapper
...
{
    public BOFJJGELNIN JNMGKNJHMGH;  // wrapper
}
