...
public class AGDNDKJCIDN
{
    public int <KAPNIBGOIEB>k__BackingField;    // 0x0x10
    public GNBMHLKCDGC <AFLEJICHANH>k__BackingField;    // 0x0x14
}
...
public class APICFMKPOJK
{
    public MKHINDDHMOG <ONEKEBOBPJK>k__BackingField;    // 0x0x10
    public OFGKGHDEDAH <HJNKOGPINGN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BCGMDJGMAHK
//   (not directly referenced by a detected call)
public class BCGMDJGMAHK
{
    public Guid <MNGOOEBCFGN>k__BackingField;    // 0x0x10
    public long <GHCEAADJDEA>k__BackingField;    // 0x0x20
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x28
    public string <HDFJDDKFNOF>k__BackingField;    // 0x0x30
    public string <EEBBMHLFAFM>k__BackingField;    // 0x0x38
    public long <ANOBLICPEDN>k__BackingField;    // 0x0x40
    public Guid? <EBBLPCPCBBJ>k__BackingField;    // 0x0x48
    public DateTime <CJNOOCONLEB>k__BackingField;    // 0x0x60
    public int <ENAJKJHFOBK>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// BCILPCAEFMA
// base   : FDFIFNJEENA`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class BCILPCAEFMA
{
...
public class BFKNJFONDJJ
{
    public int <INNLJCHFMAE>k__BackingField;    // 0x0x10
    public int <HEMEFOAMDDJ>k__BackingField;    // 0x0x14
    public float <FNEHNIMLJJJ>k__BackingField;    // 0x0x18
    public float <CLCJKEGFOPH>k__BackingField;    // 0x0x1C
    public bool <NDPJDEGNFNO>k__BackingField;    // 0x0x20
    public bool <KKEEMEOEPIJ>k__BackingField;    // 0x0x21
    public bool <AFJCDBHAAHL>k__BackingField;    // 0x0x22
}
...
public class BJKJELDCDID
{
    public MBHJNPILBBM <PKMFABLGMOG>k__BackingField;    // 0x0x10
    public long <LCLBDABJBKB>k__BackingField;    // 0x0x18
    public string <MLDHBNLHINH>k__BackingField;    // 0x0x20
}
...
// base   : GNIGJBJNGPJ
//   (not directly referenced by a detected call)
public class BKLIBJKBDAM : GNIGJBJNGPJ
{
    public int <LDPNCHELGHA>k__BackingField;    // 0x0x68
    public List<HOIHAMAFJHB> <PCOPLIOOODE>k__BackingField;    // 0x0x70
    public List<HOIHAMAFJHB> <MOAKAOOAPDH>k__BackingField;    // 0x0x78
    public List<HOIHAMAFJHB> <KMJCCIAEAMK>k__BackingField;    // 0x0x80
}
...
public class BLACLJFOFIM
{
    public int <KMFMCEGLEPI>k__BackingField;    // 0x0x10
    public NHEMINGBKGI <MJONNIEMECH>k__BackingField;    // 0x0x14
    public LPGJDKMDOGL <NLGIPPNPHML>k__BackingField;    // 0x0x18
    public LPGJDKMDOGL <KFKPJKKJGLP>k__BackingField;    // 0x0x1C
    public LPGJDKMDOGL <EHBBCMHDHOJ>k__BackingField;    // 0x0x20
}
...
public class BOCEGILDLFD
{
    public Guid <DCLJOEGNKEB>k__BackingField;    // 0x0x10
    public int <BLPOBODOHAK>k__BackingField;    // 0x0x20
    public long <FJOKMJAGBPE>k__BackingField;    // 0x0x28
    public Guid <MGPFKGCDAJO>k__BackingField;    // 0x0x30
}
...
public class CELNDJKNBEO
{
    public int <HEMEFOAMDDJ>k__BackingField;    // 0x0x10
    public bool <NDPJDEGNFNO>k__BackingField;    // 0x0x14
    public DateTime <HHFLAMIDABA>k__BackingField;    // 0x0x18
    public bool <CHHDPBMINIC>k__BackingField;    // 0x0x20
}
...
public class CGDMIABMMFB
{
    public KJPGNDCMEDL <AAIDLDCAFKD>k__BackingField;    // 0x0x10
    public PENEMEBNDHE <AGHPCGMAHOA>k__BackingField;    // 0x0x18
    public int <KDHEEJAKHLC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CIEBNHHCOKF
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.WWW]
public class CIEBNHHCOKF
{
    public List<string> <JOKBMNHCOFM>k__BackingField;    // 0x0x10
}
...
// CIOHADIEFIJ
//   (not directly referenced by a detected call)
public class CIOHADIEFIJ
{
    public int <OBKIDNIKDNA>k__BackingField;    // 0x0x10
    public DateTime <AFKPBAMKGBH>k__BackingField;    // 0x0x18
    public DateTime? <DGBMJLBLONK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CJGEKHJGKKB
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{bLCJLIJFBDL}   [Service.Auth]
public class CJGEKHJGKKB
{
    public uint <EDDFDCELLKO>k__BackingField;    // 0x0x10
    public uint? <CBAIGKNAIGD>k__BackingField;    // 0x0x14
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x20
    public string <HDFJDDKFNOF>k__BackingField;    // 0x0x28
    public DateTime <BJCHBKDAMMG>k__BackingField;    // 0x0x30
    public DateTime? <GMFEBABJPJL>k__BackingField;    // 0x0x38
    public bool <EAABCJGCPEP>k__BackingField;    // 0x0x48
    public List<OFHLJGELCOP> <HIFABBPMBLD>k__BackingField;    // 0x0x50
    public List<string> <JINLACGEFKE>k__BackingField;    // 0x0x58
    public int <PGLMBGECEAN>k__BackingField;    // 0x0x60
    public int <LJEAONIDEBB>k__BackingField;    // 0x0x64
    public int <OMDHCJFJFFA>k__BackingField;    // 0x0x68
}
...
public class COKAEDNCCJC
{
    public OEHJMIOICDM <ONEKEBOBPJK>k__BackingField;    // 0x0x10
    public OFOKKLOCKIO <HIAPMEFMANJ>k__BackingField;    // 0x0x18
    public FDKCNNEBDLO <FHMLAJNKPPP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CPAPANEEBNI
//   (not directly referenced by a detected call)
public class CPAPANEEBNI
{
    public ECEKJCDPLNJ <KEDABDOCACK>k__BackingField;    // 0x0x10
    public DMBCOAIAPJI <LPIGBEICPCJ>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{pKIAGNLGIPF}   [Service.Auth]
...
public class DADMJDGEMCB
{
    public JMALBADOKOP <KEDABDOCACK>k__BackingField;    // 0x0x10
    public GNBMHLKCDGC <AFLEJICHANH>k__BackingField;    // 0x0x18
    public MGGENKNKOCO <DFCMPPPNPMM>k__BackingField;    // 0x0x20
}
...
public class DGKAIMFLJKF
{
    public List<Guid> <OBCCBCEFDDI>k__BackingField;    // 0x0x10
    public byte <EMJLJKBELPE>k__BackingField;    // 0x0x18
    public int <MIALEGMHALH>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// DMBCOAIAPJI
//   (not directly referenced by a detected call)
public class DMBCOAIAPJI
{
    public long <KHJDJBPHBJG>k__BackingField;    // 0x0x10
    public long <LCLBDABJBKB>k__BackingField;    // 0x0x18
    public int <FAGJEGFOFJG>k__BackingField;    // 0x0x20
    public DateTime <AFKPBAMKGBH>k__BackingField;    // 0x0x28
    public PPPNAAMOOBJ <MJONNIEMECH>k__BackingField;    // 0x0x30
}
...
public class DMBFLABGADD
{
    public List<string> <MMAFKAIBFLK>k__BackingField;    // 0x0x10
    public List<string> <IEHALACOILF>k__BackingField;    // 0x0x18
    public List<string> <LIDEDIBLEGG>k__BackingField;    // 0x0x20
}
...
public class ECEKJCDPLNJ
{
    public long <LCLBDABJBKB>k__BackingField;    // 0x0x10
    public int <KEDFFKLENON>k__BackingField;    // 0x0x18
    public long <GHCEAADJDEA>k__BackingField;    // 0x0x20
    public long? <OJCNKDFALGI>k__BackingField;    // 0x0x28
    public long? <PJDFLEADGKN>k__BackingField;    // 0x0x38
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x48
    public string <HDFJDDKFNOF>k__BackingField;    // 0x0x50
    public string <EEBBMHLFAFM>k__BackingField;    // 0x0x58
    public DateTime <CAAFKJOFDKA>k__BackingField;    // 0x0x60
    public DateTime <JEMAPLIGPJB>k__BackingField;    // 0x0x68
    public int <FICBCDNNOEJ>k__BackingField;    // 0x0x70
    public NNFLCDMGDDM <FCGEEMDEEOL>k__BackingField;    // 0x0x74
    public bool <IBDPBFHLDGC>k__BackingField;    // 0x0x78
    public bool <IMPDMPPNMPO>k__BackingField;    // 0x0x79
    public CCHNCMPNGOC <FMOCDDCJLIH>k__BackingField;    // 0x0x7C
    public CCHNCMPNGOC <IDFLNJNOMKC>k__BackingField;    // 0x0x80
    public long? <EJKCHBFDFOA>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// EEHJIAIGNPA
//   (not directly referenced by a detected call)
public class EEHJIAIGNPA
{
    public int <GIJDDHFLGPL>k__BackingField;    // 0x0x10
    public string <PHDHCBPLDIE>k__BackingField;    // 0x0x18
    public string <HNKLEFMLHDI>k__BackingField;    // 0x0x20
    public string <AHPICEECBMC>k__BackingField;    // 0x0x28
    public string <BOHIIKEAICH>k__BackingField;    // 0x0x30
    public string <MFDIDIGNPAJ>k__BackingField;    // 0x0x38
    public Guid? <DPOHPDJCBIF>k__BackingField;    // 0x0x40
    public NMKGKJNELMK? <MJKKJAPDDGK>k__BackingField;    // 0x0x54
    public string <MLIFMMCGJPM>k__BackingField;    // 0x0x60
    public string <PAHHNOCFLLL>k__BackingField;    // 0x0x68
    public bool <LANLCEEDLDD>k__BackingField;    // 0x0x70
    public bool <PFFLMIMIPDI>k__BackingField;    // 0x0x71
    public bool <HKCBKKFJOON>k__BackingField;    // 0x0x72
    public NMKCBDLHCNL <BEJPIEPOBNE>k__BackingField;    // 0x0x74
    public DFLKEFJNNCI <MAHKDAPBMAB>k__BackingField;    // 0x0x78
    public int <EDIBKCGIMEM>k__BackingField;    // 0x0x7C
    public PFEBHPMENGK <BLKDHHNMOGE>k__BackingField;    // 0x0x80
    public INBGDCCBHOO <PFLBHHANNIJ>k__BackingField;    // 0x0x84
    public int? <CKHNGJCCAJH>k__BackingField;    // 0x0x88
    public string <DGBEOIGJMLN>k__BackingField;    // 0x0x90
    public int? <IBIHPANDMLK>k__BackingField;    // 0x0x98
    public int? <DJADOMMBBJL>k__BackingField;    // 0x0xA0
}

// --------------------------------------------------------------------------
// EJJEGEIBJPL
//   RESPONSE GET    api/config/v2   [Service.Auth]
public class EJJEGEIBJPL
{
    public Dictionary<int, int> <NKHPDJMLPMA>k__BackingField;    // 0x0x10
    public List<APJECHAKHID> <FDIFIKIAEGM>k__BackingField;    // 0x0x18
    public HBFFAJMAOOP[][] <CDLOIDOKCGI>k__BackingField;    // 0x0x20
    public KOFBJDAFJGF <GNFKMMCCJKE>k__BackingField;    // 0x0x28
    public NIKBFOJACCG <KBNGDBNMFKH>k__BackingField;    // 0x0x30
    public KKHGNGDFKAI <LKCPODKNDHE>k__BackingField;    // 0x0x38
    public PBONEEDLPKM <LGBNPLNCPOL>k__BackingField;    // 0x0x40
    public JOAELPPIFHK <PMOAPGFJJMF>k__BackingField;    // 0x0x48
    public string <AHHLGFJOFHI>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// EKODCEBOCGN
//   RESPONSE ?      api/customAvatarItems/GetCustomAvatarItemCurrentSavesForCustomAvatarItemIds/v2   [Service.Auth]
public class EKODCEBOCGN
{
    public Dictionary<Guid, List<KMDPPKLFIEE>> <PNPFFBMNCJC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EMNHHPPNGKJ
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.Auth]
public class EMNHHPPNGKJ
{
    public List<long> <INLDDILNHGD>k__BackingField;    // 0x0x10
    public JCDIFNMFFCP <MJONNIEMECH>k__BackingField;    // 0x0x18
    public string <ONFDIBGAKBM>k__BackingField;    // 0x0x20
    public long? <GHCEAADJDEA>k__BackingField;    // 0x0x28
}
...
//   RESPONSE GET    api/playerevents/v1/all/{eGHHENCPOKH}   [Service.Auth]
public class FDGEFEFECLH
{
    public List<ECEKJCDPLNJ> <IBJJAPABBJF>k__BackingField;    // 0x0x10
    public List<CPAPANEEBNI> <NGFMPIPNJBO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FDKCNNEBDLO
//   (not directly referenced by a detected call)
public class FDKCNNEBDLO
{
    public long <OEGMMEFGKAH>k__BackingField;    // 0x0x10
    public string <KIGLDNKANBJ>k__BackingField;    // 0x0x18
    public int <CBPNJEGLIOB>k__BackingField;    // 0x0x20
    public bool <CJONDOGNOOA>k__BackingField;    // 0x0x24
    public int <JNHELEIBJOL>k__BackingField;    // 0x0x28
    public int <DLEGNEDIPDC>k__BackingField;    // 0x0x2C
    public int <BMLPJIHPGJH>k__BackingField;    // 0x0x30
    public int <POAJHBBEKHB>k__BackingField;    // 0x0x34
    public string <GOFLFFEKPCL>k__BackingField;    // 0x0x38
    public string <DPMHOMGFECO>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// FHMJGHLGIIO
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.Auth]
public class FHMJGHLGIIO
{
    public List<ECEKJCDPLNJ> <MOCCCELCDCG>k__BackingField;    // 0x0x10
    public string <HOENLLCLIKK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FIIEKEIOBBD
//   (not directly referenced by a detected call)
public class FIIEKEIOBBD
{
    public int <NHMNLJHOBFG>k__BackingField;    // 0x0x10
    public DateTime? <MBDEKMMBJDK>k__BackingField;    // 0x0x18
    public DateTime? <HFLPIIOLCCE>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// FJGLPDGIFGD
//   (not directly referenced by a detected call)
public class FJGLPDGIFGD
{
    public string <NHEHHFPKIMI>k__BackingField;    // 0x0x10
    public HIPIOBPAFLM <MJONNIEMECH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FJKNLNLDOGC
// base   : FDFIFNJEENA`1<JLBMGMIIKLH>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{jJNIDOFLAPJ}   [Service.Auth]
public class FJKNLNLDOGC
{
    // (no instance fields in the metadata dump)
}
...
public class FNEBGGGOPFG
{
    public long <GHCEAADJDEA>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <HKIKJHDGJHI>k__BackingField;    // 0x0x18
    public JPFBHIIMNON <PNJAEGMPBCG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FOLCFKBCJGJ
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class FOLCFKBCJGJ
{
    public Dictionary<Guid, HEDLANGNHGP> <ALFAOJGIIPE>k__BackingField;    // 0x0x10
}
...
public class GAJHPHPAPPF
{
    public Guid <MGPFKGCDAJO>k__BackingField;    // 0x0x10
    public long <FJHJFGPHAHA>k__BackingField;    // 0x0x20
}
...
public class GJGHPKLNAPA
{
    public long <GHCEAADJDEA>k__BackingField;    // 0x0x10
    public long? <OJCNKDFALGI>k__BackingField;    // 0x0x18
    public long? <PJDFLEADGKN>k__BackingField;    // 0x0x28
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x38
    public string <HDFJDDKFNOF>k__BackingField;    // 0x0x40
    public List<string> <JINLACGEFKE>k__BackingField;    // 0x0x48
    public string <EEBBMHLFAFM>k__BackingField;    // 0x0x50
    public DateTime <CAAFKJOFDKA>k__BackingField;    // 0x0x58
    public DateTime <JEMAPLIGPJB>k__BackingField;    // 0x0x60
    public NNFLCDMGDDM <FCGEEMDEEOL>k__BackingField;    // 0x0x68
    public bool <IBDPBFHLDGC>k__BackingField;    // 0x0x6C
    public bool <IMPDMPPNMPO>k__BackingField;    // 0x0x6D
    public CCHNCMPNGOC <FMOCDDCJLIH>k__BackingField;    // 0x0x70
    public CCHNCMPNGOC <IDFLNJNOMKC>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// GKOLMEDHBIO
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{dOIMBNKLAHO}/{eNFACKEKLJH}   [Service.WWW]
public class GKOLMEDHBIO
{
    public DFLKEFJNNCI <MAHKDAPBMAB>k__BackingField;    // 0x0x10
    public CIHDFHDKHJP <JILIBPOFDAJ>k__BackingField;    // 0x0x14
    public int <JPLLGJCDDJP>k__BackingField;    // 0x0x18
    public int <DMDJLAPCFPO>k__BackingField;    // 0x0x1C
    public int <LCEPPKEGEGM>k__BackingField;    // 0x0x20
    public FLNNHPPMEDN <CNCIAGOEDCI>k__BackingField;    // 0x0x24
    public bool <KCNICPELKKK>k__BackingField;    // 0x0x28
    public float <HDOBFGBACPD>k__BackingField;    // 0x0x2C
    public int <DPDOAJMBFGC>k__BackingField;    // 0x0x30
    public bool <GKANGHLGEFP>k__BackingField;    // 0x0x34
}
...
public class GNCLMPGIBGE
{
    public Dictionary<Guid, PMPGJDJOOKN> <DOADDAMAKPL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GNIGJBJNGPJ
//   (not directly referenced by a detected call)
public class GNIGJBJNGPJ
{
    public int <NGKDCNDHONH>k__BackingField;    // 0x0x10
    public BPOCLLBBOML <MJONNIEMECH>k__BackingField;    // 0x0x14
    public List<OPKJDHMEFLL> <CBMPIGNJIAA>k__BackingField;    // 0x0x18
    public List<OPKJDHMEFLL> <BDECDMKHIEL>k__BackingField;    // 0x0x20
    public bool <CCNMIGAHLKL>k__BackingField;    // 0x0x28
    public DateTime? <ALKAPNMMBJG>k__BackingField;    // 0x0x30
    public DateTime? <PLEGDMBJELB>k__BackingField;    // 0x0x40
    public DateTime? <LOLBOKKBKCA>k__BackingField;    // 0x0x50
    public bool <INOMIAKPPHI>k__BackingField;    // 0x0x60
    public bool <MFCPEDJIBNL>k__BackingField;    // 0x0x61
}
...
public class GOADKLANHGL
{
    public bool <OJCNNBHMOGJ>k__BackingField;    // 0x0x10
    public string <CLHFJAKGBJB>k__BackingField;    // 0x0x18
}
...
// HBFFAJMAOOP
//   (not directly referenced by a detected call)
public class HBFFAJMAOOP
{
    public MKMCFIEFAJD AHENMPEOHIM;    // 0x0x10
    public int ONHELHOJPKL;    // 0x0x14
}
...
public class HDKECABJIIM
{
    public Guid? <MNGOOEBCFGN>k__BackingField;    // 0x0x10
    public long? <GHCEAADJDEA>k__BackingField;    // 0x0x28
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x38
    public string <HDFJDDKFNOF>k__BackingField;    // 0x0x40
    public string <EEBBMHLFAFM>k__BackingField;    // 0x0x48
    public PENEMEBNDHE <NPHFPEECHBM>k__BackingField;    // 0x0x50
}
...
public class HDOHJHJGNMG
{
    public GLLCMEHKOJL <PKMFABLGMOG>k__BackingField;    // 0x0x10
    public string <MLDHBNLHINH>k__BackingField;    // 0x0x18
    public int? <CLEENIJIANK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HEDLANGNHGP
//   RESPONSE PUT    api/roomconsumables   [Service.WWW]
public class HEDLANGNHGP
{
    public LPPBJODDIEB <ONEKEBOBPJK>k__BackingField;    // 0x0x10
    public NKLPANEBBAF <AMINPBOGDJO>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{eDFMKGIPMDG}   [Service.WWW]
public class HEPCGBACLLO
{
    public LPPBJODDIEB <ONEKEBOBPJK>k__BackingField;    // 0x0x10
    public BCGMDJGMAHK <CENINIAFADJ>k__BackingField;    // 0x0x18
}
...
// HOIHAMAFJHB
//   (not directly referenced by a detected call)
public class HOIHAMAFJHB
{
    public bool <EJHACIAGHIL>k__BackingField;    // 0x0x10
    public EEHJIAIGNPA <JEGCIOIAMOM>k__BackingField;    // 0x0x18
    public float <JJFBFCODNOB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HPMONICIFBF
//   RESPONSE GET    api/config/v1/backtrace   [Service.Auth]
public class HPMONICIFBF
{
    public int <CJBMAEMGMFF>k__BackingField;    // 0x0x10
    public int <LOLIDODEMKF>k__BackingField;    // 0x0x14
    public float <HBLJOFHMCJG>k__BackingField;    // 0x0x18
    public int <OPFJGFJCPFC>k__BackingField;    // 0x0x1C
    public int <LPDKACNBJFP>k__BackingField;    // 0x0x20
    public int <JKIHIPOEDMP>k__BackingField;    // 0x0x24
    public int <NGDCNLIALHB>k__BackingField;    // 0x0x28
    public string <IHHJJKLOAMO>k__BackingField;    // 0x0x30
    public string <LCNENAFNDLN>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// IBMNLKIHGBJ
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.Auth]
public class IBMNLKIHGBJ
{
    public int? <ILNDNLPCHPL>k__BackingField;    // 0x0x10
    public string <FMHGKDHJMIF>k__BackingField;    // 0x0x18
    public string <LGDOBKMEJLA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IMODAHMJPIN
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.WWW]
public class IMODAHMJPIN
{
    public int <MDIAFGBCBHM>k__BackingField;    // 0x0x10
    public Guid <DCLJOEGNKEB>k__BackingField;    // 0x0x14
    public long <DFNMNBHCMGM>k__BackingField;    // 0x0x28
    public DateTime <CJNOOCONLEB>k__BackingField;    // 0x0x30
}
...
public class IPMEIEKEIDA
{
    public int <FONFDAIPEFH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JBMAKIIAPOD
//   REQUEST  POST   api/customAvatarItems/GetCustomAvatarItemCurrentSavesForLegacyAvatarItemDescs/v2   [Service.Auth]
public class JBMAKIIAPOD
{
    public List<string> <BALBAADMLEO>k__BackingField;    // 0x0x10
    public byte <EMJLJKBELPE>k__BackingField;    // 0x0x18
    public int <MIALEGMHALH>k__BackingField;    // 0x0x1C
}
...
// JDOBFBOLFGG
//   (not directly referenced by a detected call)
public class JDOBFBOLFGG
{
    public Guid <EBJOFOENNDN>k__BackingField;    // 0x0x10
    public Guid <MBEBGIGPANA>k__BackingField;    // 0x0x20
    public DateTime <OCJCOGGOOOH>k__BackingField;    // 0x0x30
    public List<EEHJIAIGNPA> <AOHCJKNJCCO>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// JECFFBFPLCE
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.Auth]
public class JECFFBFPLCE
{
    public MBHJNPILBBM <PKMFABLGMOG>k__BackingField;    // 0x0x10
    public int <FONFDAIPEFH>k__BackingField;    // 0x0x14
    public long <HCOOLPACLJA>k__BackingField;    // 0x0x18
    public bool <PAMJOEGBFHH>k__BackingField;    // 0x0x20
    public string <CLHFJAKGBJB>k__BackingField;    // 0x0x28
    public int? <BGNFLHIFMMG>k__BackingField;    // 0x0x30
    public bool <DFKEIBIJFBN>k__BackingField;    // 0x0x38
    public bool <IPFEPDPCMLE>k__BackingField;    // 0x0x39
    public bool <JGMMPHNCLGD>k__BackingField;    // 0x0x3A
    public bool <OGFPAIIMLLM>k__BackingField;    // 0x0x3B
    public string <FLDIBLHOBJP>k__BackingField;    // 0x0x40
    public DateTime? <NIIONDCMNEF>k__BackingField;    // 0x0x48
    public string <MKNGPOLBLEL>k__BackingField;    // 0x0x58
    public float <HKHIKKCJLBG>k__BackingField;    // 0x0x60
}
...
// base   : ECEKJCDPLNJ
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class JMALBADOKOP : ECEKJCDPLNJ
{
    public List<FJGLPDGIFGD> <JINLACGEFKE>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// JMBNBGCNECK
//   (not directly referenced by a detected call)
public class JMBNBGCNECK
{
    public DateTime <AFKPBAMKGBH>k__BackingField;    // 0x0x10
    public string <FIJBNANNHBC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JOAELPPIFHK
//   (not directly referenced by a detected call)
public class JOAELPPIFHK
{
    public float <FCDCLELGDKM>k__BackingField;    // 0x0x10
}
...
public class JPGCENPJLFK
{
    public GNBMHLKCDGC <AFLEJICHANH>k__BackingField;    // 0x0x10
}
...
public class KJPGNDCMEDL
{
    public Guid? <MJFAKCMEJBN>k__BackingField;    // 0x0x10
    public Guid <BCNCBIAAMIM>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// KKHGNGDFKAI
//   (not directly referenced by a detected call)
public class KKHGNGDFKAI
{
    public int <FPOOJNOMANL>k__BackingField;    // 0x0x10
}
...
// KMDPPKLFIEE
//   (not directly referenced by a detected call)
public class KMDPPKLFIEE
{
    public long <DBDALEIEIGE>k__BackingField;    // 0x0x10
    public Guid <DPOHPDJCBIF>k__BackingField;    // 0x0x18
    public Guid <NJIKCBJBMOB>k__BackingField;    // 0x0x28
    public DateTime <AFKPBAMKGBH>k__BackingField;    // 0x0x38
    public string <ONMACLPFAAA>k__BackingField;    // 0x0x40
    public string <LGJHOCDDICE>k__BackingField;    // 0x0x48
    public int <DOAGMNAMILD>k__BackingField;    // 0x0x50
    public string <CLMHJJHEIHM>k__BackingField;    // 0x0x58
    public string <BHDNAIEEAMN>k__BackingField;    // 0x0x60
    public string <KMHCGBOOADI>k__BackingField;    // 0x0x68
    public string <LBBNFFDDCML>k__BackingField;    // 0x0x70
    public int <AFEDJFCGHDA>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// KOFBJDAFJGF
//   (not directly referenced by a detected call)
public class KOFBJDAFJGF
{
    public int <CDCBIMCBCNM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LPFKOOHOHEM
//   RESPONSE GET    api/config/v1/azurespeech   [Service.Auth]
public class LPFKOOHOHEM
{
    public bool <BEGPPHOFFPO>k__BackingField;    // 0x0x10
    public string <GEJOAHAFOOO>k__BackingField;    // 0x0x18
    public string <KIBGBIKMPLE>k__BackingField;    // 0x0x20
}
...
public class MAJLMDNHANC
{
    public List<AGDNDKJCIDN> <INKGHCPAGCA>k__BackingField;    // 0x0x10
    public GNBMHLKCDGC <AFLEJICHANH>k__BackingField;    // 0x0x18
}
...
public class MEIMDJBJEGN
{
    public List<int> <FMALNLFLPPI>k__BackingField;    // 0x0x10
    public string <HOENLLCLIKK>k__BackingField;    // 0x0x18
}
...
public class MFBLBNJLDPK
{
    public long <NFHFJGJIEEF>k__BackingField;    // 0x0x10
    public int <MDIAFGBCBHM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MGGENKNKOCO
//   RESPONSE POST   api/inventions/v1/settags   [Service.Auth]
public class MGGENKNKOCO
{
    public KKNOLMCKAJO <AFLEJICHANH>k__BackingField;    // 0x0x10
    public List<string> <JINLACGEFKE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MHAMJGFIGOL
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.WWW]
public class MHAMJGFIGOL
{
    public List<CIOHADIEFIJ> <KFHIDAJBFDD>k__BackingField;    // 0x0x10
    public string <HOENLLCLIKK>k__BackingField;    // 0x0x18
}
...
public class MJKINBIMFAB
{
    public int <KNNKNDKNINE>k__BackingField;    // 0x0x10
    public int? <PCINECCPNAA>k__BackingField;    // 0x0x14
    public string <PNJODDOPHPJ>k__BackingField;    // 0x0x20
    public string <BAALMAGCOKE>k__BackingField;    // 0x0x28
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{lFGEDDOMAKA}   [Service.WWW]
public enum MKHINDDHMOG
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class NAODFNILMOA : PHPGJIIIGFJ
{
    public EAIFHBMLKNO? <DCCPPAMFFKD>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <FDMKFIHOKOG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NCOEKLHHMHH
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.WWW]
public class NCOEKLHHMHH
{
    public long <NFHFJGJIEEF>k__BackingField;    // 0x0x10
    public int <MDIAFGBCBHM>k__BackingField;    // 0x0x18
}
...
public class NEOBNBACAAK
{
    public List<FJGLPDGIFGD> <JINLACGEFKE>k__BackingField;    // 0x0x10
}
...
public class NHFIHKHPLFP
{
    public Dictionary<string, List<KMDPPKLFIEE>> <PBEFLIHBOOE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NIKBFOJACCG
//   (not directly referenced by a detected call)
public class NIKBFOJACCG
{
    public float <FLHGNICCIJI>k__BackingField;    // 0x0x10
    public float <DHJKELCNEJM>k__BackingField;    // 0x0x14
    public float <HENHDFLDHIA>k__BackingField;    // 0x0x18
    public float <BECGLDFFFCI>k__BackingField;    // 0x0x1C
    public float <EBMAPNMGLFK>k__BackingField;    // 0x0x20
    public float <OPCNDCLILOB>k__BackingField;    // 0x0x24
    public float <IKHNGIJLJAD>k__BackingField;    // 0x0x28
    public float <NKOGPMLKPIC>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// NKLPANEBBAF
//   (not directly referenced by a detected call)
public class NKLPANEBBAF
{
    public Guid <MNGOOEBCFGN>k__BackingField;    // 0x0x10
    public int <MDIAFGBCBHM>k__BackingField;    // 0x0x20
    public int <EIBJILDDJIJ>k__BackingField;    // 0x0x24
    public Guid <GAAPCAMPBIH>k__BackingField;    // 0x0x28
    public DateTime <CJNOOCONLEB>k__BackingField;    // 0x0x38
    public BCGMDJGMAHK <CENINIAFADJ>k__BackingField;    // 0x0x40
}
...
public class NPPDIGEGGOA
{
    public Guid <PIMFELKCKMK>k__BackingField;    // 0x0x10
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x20
    public string <EEBBMHLFAFM>k__BackingField;    // 0x0x28
    public DateTime <OCJCOGGOOOH>k__BackingField;    // 0x0x30
    public DateTime? <CIGOLNJHEMP>k__BackingField;    // 0x0x38
    public List<JDOBFBOLFGG> <DAEPGHMGCKA>k__BackingField;    // 0x0x48
}
...
public class OBEDIDMFHHA : PHPGJIIIGFJ
{
    public BMCMDJJEENI? <DCCPPAMFFKD>k__BackingField;    // 0x0x18
    public IMODAHMJPIN <EGMIAKFFPBL>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/keepsakes/{mMJNEIGAGKK}   [Service.Auth]
...
public class OBMLHMAMMHJ
{
    public bool <OJCNNBHMOGJ>k__BackingField;    // 0x0x10
    public string <JJEBEAJMGLF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OCPIHNEOBKF
//   REQUEST  POST   api/playerevents/v1/respond   [Service.Auth]
public class OCPIHNEOBKF
{
    public long <LCLBDABJBKB>k__BackingField;    // 0x0x10
    public PPPNAAMOOBJ <MJONNIEMECH>k__BackingField;    // 0x0x18
}
...
// OFGKGHDEDAH
//   (not directly referenced by a detected call)
public class OFGKGHDEDAH
{
    public long <NFHFJGJIEEF>k__BackingField;    // 0x0x10
    public Guid <KIGLDNKANBJ>k__BackingField;    // 0x0x18
    public long <GHCEAADJDEA>k__BackingField;    // 0x0x28
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x30
    public string <HDFJDDKFNOF>k__BackingField;    // 0x0x38
    public int <ANOBLICPEDN>k__BackingField;    // 0x0x40
    public Guid? <EBBLPCPCBBJ>k__BackingField;    // 0x0x44
    public DateTime <AFKPBAMKGBH>k__BackingField;    // 0x0x58
    public string <EEBBMHLFAFM>k__BackingField;    // 0x0x60
    public HDBMMHKAMDN <MJONNIEMECH>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// OFHLJGELCOP
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.Auth]
public class OFHLJGELCOP
{
    public string <EDDFDCELLKO>k__BackingField;    // 0x0x10
    public string <GEJOAHAFOOO>k__BackingField;    // 0x0x18
    public string <PEJMPKPNHFH>k__BackingField;    // 0x0x20
    public string <HDFJDDKFNOF>k__BackingField;    // 0x0x28
    public string <FMHGKDHJMIF>k__BackingField;    // 0x0x30
    public PBNMIPAKIGC <ONEKEBOBPJK>k__BackingField;    // 0x0x38
    public List<string> <JMHLJAOKOAO>k__BackingField;    // 0x0x40
    public List<string> <JINLACGEFKE>k__BackingField;    // 0x0x48
    public string <DGMPCCNPEOI>k__BackingField;    // 0x0x50
    public List<JMBNBGCNECK> <NBKICAMNGPJ>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// OFOKKLOCKIO
//   (not directly referenced by a detected call)
public class OFOKKLOCKIO
{
    public ObscuredLong <PNPBJHBDOOI>k__BackingField;    // 0x0x10
    public string <KIGLDNKANBJ>k__BackingField;    // 0x0x38
    public ObscuredInt <JJEMNPGIDOL>k__BackingField;    // 0x0x40
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x58
    public string <HDFJDDKFNOF>k__BackingField;    // 0x0x60
    public string <EEBBMHLFAFM>k__BackingField;    // 0x0x68
    public byte <HBPOGLDADMJ>k__BackingField;    // 0x0x70
    public int <KDIBDHIDOBM>k__BackingField;    // 0x0x74
    public GOCILOCPHNM <FCGEEMDEEOL>k__BackingField;    // 0x0x78
    public bool <AEGPMBIKJND>k__BackingField;    // 0x0x7C
    public DateTime <CJNOOCONLEB>k__BackingField;    // 0x0x80
    public DateTime <AFKPBAMKGBH>k__BackingField;    // 0x0x88
    public DateTime? <OOOELHEDLOO>k__BackingField;    // 0x0x90
    public long? <PAFJJGALPFJ>k__BackingField;    // 0x0xA0
    public int <DAEGLCLPAGL>k__BackingField;    // 0x0xB0
    public int <OLHDNNPDNCN>k__BackingField;    // 0x0xB4
    public int <FAJEEJFEALO>k__BackingField;    // 0x0xB8
    public BHECPLHJDNN <FJEOOIKKHMP>k__BackingField;    // 0x0xBC
    public BHECPLHJDNN <CFOJJNJGBEN>k__BackingField;    // 0x0xC0
    public ObscuredBool <HJHKOPBMJAE>k__BackingField;    // 0x0xC4
    public ObscuredBool <EFDBOHFGEEK>k__BackingField;    // 0x0xD0
    public ObscuredBool <NGBLDGLAOIH>k__BackingField;    // 0x0xDC
    public ObscuredBool <DGALOMONKIF>k__BackingField;    // 0x0xE8
    public int? <ANOBLICPEDN>k__BackingField;    // 0x0xF4
    public bool <BCFJKOAGONI>k__BackingField;    // 0x0xFC
}
...
public class OIBMJHGJEAF
{
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x10
    public string <HDFJDDKFNOF>k__BackingField;    // 0x0x18
    public int? <ANOBLICPEDN>k__BackingField;    // 0x0x20
    public GOCILOCPHNM? <FCGEEMDEEOL>k__BackingField;    // 0x0x28
}
...
// base   : AIOPINALBAE
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/season/{pPHKCPOOAIC}   [Service.WWW]
public class OKFDFHFNLDL : AIOPINALBAE
{
    public int <GEALLBMOHPK>k__BackingField;    // 0x0x30
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x38
    public DateTime <OCJCOGGOOOH>k__BackingField;    // 0x0x40
    public DateTime <ECGAFONELDE>k__BackingField;    // 0x0x48
    public DFLKEFJNNCI <MAHKDAPBMAB>k__BackingField;    // 0x0x50
    public GNIGJBJNGPJ <DNKAICPCCIP>k__BackingField;    // 0x0x58
    public List<BKLIBJKBDAM> <PJCDANCFOBE>k__BackingField;    // 0x0x60
    public OOJAMPFLEIJ <LMNEHMIBLJM>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// OOJAMPFLEIJ
//   (not directly referenced by a detected call)
public class OOJAMPFLEIJ
{
    public bool <PEHKEGIKMKK>k__BackingField;    // 0x0x10
    public HBMGLGOHEFM <AINEHFODCOO>k__BackingField;    // 0x0x14
    public int <CLJMMONELJO>k__BackingField;    // 0x0x18
    public DateTime <CJNOOCONLEB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OPKJDHMEFLL
//   (not directly referenced by a detected call)
public class OPKJDHMEFLL
{
    public DFLKEFJNNCI <MAHKDAPBMAB>k__BackingField;    // 0x0x10
    public int <ANOBLICPEDN>k__BackingField;    // 0x0x14
    public FIIEKEIOBBD <OMGEIMBCOKL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OPMFFKKBHNA
//   REQUEST  POST   api/equipment/v1/update   [Service.WWW]
public class OPMFFKKBHNA
{
    public string <FAPOGJCIJEH>k__BackingField;    // 0x0x10
    public string <FJNLHCGIFAJ>k__BackingField;    // 0x0x18
    public string <PHDHCBPLDIE>k__BackingField;    // 0x0x20
    public string <HNKLEFMLHDI>k__BackingField;    // 0x0x28
    public NMKCBDLHCNL <BEJPIEPOBNE>k__BackingField;    // 0x0x30
    public bool PDBCAIIHCFI;    // 0x0x34
    public bool <AFJCDBHAAHL>k__BackingField;    // 0x0x35
}
...
public class PBBBIBBOBEP
{
    public NMKGKJNELMK <MJKKJAPDDGK>k__BackingField;    // 0x0x10
    public string <PAPAMJFHEAC>k__BackingField;    // 0x0x18
    public string <PHDHCBPLDIE>k__BackingField;    // 0x0x20
    public string <HNKLEFMLHDI>k__BackingField;    // 0x0x28
    public NMKCBDLHCNL <BEJPIEPOBNE>k__BackingField;    // 0x0x30
    public string <AHPICEECBMC>k__BackingField;    // 0x0x38
    public int <IBIHPANDMLK>k__BackingField;    // 0x0x40
    public bool <IDNMBDOEGNK>k__BackingField;    // 0x0x44
}
...
// PBONEEDLPKM
//   (not directly referenced by a detected call)
public class PBONEEDLPKM
{
    public int <ONLGNMKDNGO>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/progressionEvents/collect/{pKIAGNLGIPF}/{jJOIBIMCBMD}   [Service.Auth]
public class PDKPMHDHADO
{
    public long? <EDDFDCELLKO>k__BackingField;    // 0x0x10
    public int <FAGJEGFOFJG>k__BackingField;    // 0x0x20
    public int? <LIDAFONNDFK>k__BackingField;    // 0x0x24
    public string <BOHIIKEAICH>k__BackingField;    // 0x0x30
    public NMKGKJNELMK? <MJKKJAPDDGK>k__BackingField;    // 0x0x38
    public string <MFDIDIGNPAJ>k__BackingField;    // 0x0x40
    public Guid? <DPOHPDJCBIF>k__BackingField;    // 0x0x48
    public string <MLIFMMCGJPM>k__BackingField;    // 0x0x60
    public string <PAHHNOCFLLL>k__BackingField;    // 0x0x68
    public DFLKEFJNNCI <MAHKDAPBMAB>k__BackingField;    // 0x0x70
    public int <EDIBKCGIMEM>k__BackingField;    // 0x0x74
    public int <BFAHNLFGLLE>k__BackingField;    // 0x0x78
    public INBGDCCBHOO <HEPEHKBPMEA>k__BackingField;    // 0x0x7C
    public NMKCBDLHCNL <CHINAMHOOKI>k__BackingField;    // 0x0x80
    public string <FLGGFCJCLPN>k__BackingField;    // 0x0x88
    public KAJLIHHEFAG <HMEEDHBJIJJ>k__BackingField;    // 0x0x90
    public HBMGLGOHEFM <GGLGFKIPHJN>k__BackingField;    // 0x0x94
    public BOPLAPBBMGG? <BBJOKOEKFML>k__BackingField;    // 0x0x98
    public bool <IMLLNIFEBJB>k__BackingField;    // 0x0xA0
    public bool <FAEANGCMNPC>k__BackingField;    // 0x0xA1
    public string <JLAAJKBJJDL>k__BackingField;    // 0x0xA8
    public bool <HHFAHBIMPLC>k__BackingField;    // 0x0xB0
    public bool OOBNFFKGKEL;    // 0x0xB1
}

// --------------------------------------------------------------------------
// PENEMEBNDHE
//   (not directly referenced by a detected call)
public class PENEMEBNDHE
{
    public long <ANOBLICPEDN>k__BackingField;    // 0x0x10
    public Guid? <DCLJOEGNKEB>k__BackingField;    // 0x0x18
}
...
public class PMHAKPGJLPM
{
    public byte <EMJLJKBELPE>k__BackingField;    // 0x0x10
    public int <MIALEGMHALH>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// PMPGJDJOOKN
//   (not directly referenced by a detected call)
public class PMPGJDJOOKN
{
    public int <KDHEEJAKHLC>k__BackingField;    // 0x0x10
    public KJPGNDCMEDL <AAIDLDCAFKD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PPDEFJFKJOJ
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.WWW]
public class PPDEFJFKJOJ
{
    public int AOJMAHFKCPL;    // 0x0x10
    public long NPKPMKMPMND;    // 0x0x18
}
...
public class AddKeepsakeInstanceRequest
{
    public long <GHCEAADJDEA>k__BackingField;    // 0x0x10
    public long? <OJCNKDFALGI>k__BackingField;    // 0x0x18
    public BJEOMDHFMAK <LCMOPKKLNAK>k__BackingField;    // 0x0x28
}
...
{
    public KCBBDFCNCHO <AFLEJICHANH>k__BackingField;    // 0x0x10
    public string <AJBDCIENMGK>k__BackingField;    // 0x0x18
    public string <FGCNFMPNIPE>k__BackingField;    // 0x0x20
    public string <KOAMLADDBPH>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public DFLKEFJNNCI <CurrencyType>k__BackingField;    // 0x0x18
    public BOPLAPBBMGG <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <LCLBDABJBKB>k__BackingField;    // 0x0x10
    public long? <LODNEOGLFNI>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public NKPBGJDONBL FilterType;    // 0x0x20
...
{
    public BJEOMDHFMAK <BCIMHMANAMK>k__BackingField;    // 0x0x10
    public string <DBELOGFJAGM>k__BackingField;    // 0x0x18
    public int <MOPDDHOHKPP>k__BackingField;    // 0x0x20
    public int <KKOFKCKLJME>k__BackingField;    // 0x0x24
    public string <DICEOALEEGC>k__BackingField;    // 0x0x28
    public string <JIGDCJELPPM>k__BackingField;    // 0x0x30
}
...
{
    public int <MDIAFGBCBHM>k__BackingField;    // 0x0x10
    public Guid <FMJPAJCGJCF>k__BackingField;    // 0x0x14
    public DateTime <NNBHGAFDBFB>k__BackingField;    // 0x0x28
}
...
{
    public bool <EGOMABDCPDK>k__BackingField;    // 0x0x10
    public int <CLBJMHMPIAA>k__BackingField;    // 0x0x14
    public bool <OGHJHCLHPLM>k__BackingField;    // 0x0x18
}
...
{
    public Guid <FMJPAJCGJCF>k__BackingField;    // 0x0x10
    public BJEOMDHFMAK <IFLDNADCAFC>k__BackingField;    // 0x0x20
    public int <FEIKAECKEGO>k__BackingField;    // 0x0x24
    public long <GHCEAADJDEA>k__BackingField;    // 0x0x28
    public long? <OJCNKDFALGI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{aKGGMDCCHEF}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <ILHKGKBDKAO>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <JGBCENFECCD>k__BackingField;    // 0x0x18
}
...
{
    public long <HBCKICDDFGC>k__BackingField;    // 0x0x10
    public long <GHCEAADJDEA>k__BackingField;    // 0x0x18
    public long <FLPAKHMLIKA>k__BackingField;    // 0x0x20
    public HHLFPKOENLO <MJONNIEMECH>k__BackingField;    // 0x0x28
    public int <LKCFIHDLEKD>k__BackingField;    // 0x0x2C
}
...
{
    public long <GHCEAADJDEA>k__BackingField;    // 0x0x10
    public List<Guid> <EOBAKMDNJEO>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <ILHKGKBDKAO>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <JGBCENFECCD>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <BKNFMOOHKIB>k__BackingField;    // 0x0x20
}
...
{
    public long <FLPAKHMLIKA>k__BackingField;    // 0x0x10
    public long <MPCCOPCNBGL>k__BackingField;    // 0x0x18
    public int? <PJOCIBJEDDP>k__BackingField;    // 0x0x20
    public int? <HKCMODKJAIM>k__BackingField;    // 0x0x28
    public long? <EJLLDLDJDFF>k__BackingField;    // 0x0x30
    public long <FGAJPFNFJKC>k__BackingField;    // 0x0x40
    public long <OKBIEMNHFPD>k__BackingField;    // 0x0x48
    public int <EKMFCHLGHHM>k__BackingField;    // 0x0x50
    public HHLFPKOENLO <ONMDGPDPFAP>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <KMIHKBHNNFH>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public INBGDCCBHOO <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public PFDMNDENLBK creatorAccountRole;    // 0x0x60
}
...
{
    public GDGHHEJKIGA <OEBMIOHFKJK>k__BackingField;    // 0x0x10
    public PEDHDGGBMCO <GMNANEJCIAI>k__BackingField;    // 0x0x14
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x18
    public string <HDFJDDKFNOF>k__BackingField;    // 0x0x20
    public bool <PFNPLDMBKJM>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<GDGHHEJKIGA> <LJNMPPKKBOE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{pKIAGNLGIPF}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <MPCCOPCNBGL>k__BackingField;    // 0x0x10
    public string <MCELNABDJEJ>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <KMJCCIAEAMK>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <DKIBFGENOHG>k__BackingField;    // 0x0x28
    public DateTime <CAAFKJOFDKA>k__BackingField;    // 0x0x30
    public DateTime <JEMAPLIGPJB>k__BackingField;    // 0x0x38
    public DateTime <GIKMBGFDMFG>k__BackingField;    // 0x0x40
    public bool <FEJMGMNIMFI>k__BackingField;    // 0x0x48
    public int <IHKOGDILJKF>k__BackingField;    // 0x0x4C
    public float <KDMBFJLKMHI>k__BackingField;    // 0x0x50
    public Guid? <FJFJHFDCOOM>k__BackingField;    // 0x0x54
    public string <BJIJOIFIOBK>k__BackingField;    // 0x0x68
    public string <AEAFBHLEMKH>k__BackingField;    // 0x0x70
    public string <LMDGFEEGJCE>k__BackingField;    // 0x0x78
    public string <NCGFDHLGPAB>k__BackingField;    // 0x0x80
}
...
{
    public Guid <DJKCCBBMOGL>k__BackingField;    // 0x0x10
    public int <IEAHKEFFDNA>k__BackingField;    // 0x0x20
    public int <PIAFFNJDABG>k__BackingField;    // 0x0x24
    public int <CKKFLBBGCKB>k__BackingField;    // 0x0x28
    public long <CDEGEICEOOP>k__BackingField;    // 0x0x30
    public long <GABDPMGDCOG>k__BackingField;    // 0x0x38
}
...
{
    public int <MDIAFGBCBHM>k__BackingField;    // 0x0x10
    public int <BFAHNLFGLLE>k__BackingField;    // 0x0x14
    public int <NIOOEEMKDAP>k__BackingField;    // 0x0x18
    public int <DBJOIELNNHP>k__BackingField;    // 0x0x1C
    public int <NBJGKICDHMH>k__BackingField;    // 0x0x20
    public DateTime? <DIIONCCJDCP>k__BackingField;    // 0x0x28
}
...
{
    public long <OCAKCPELPFL>k__BackingField;    // 0x0x10
    public int <GIJDDHFLGPL>k__BackingField;    // 0x0x18
    public string <EEBBMHLFAFM>k__BackingField;    // 0x0x20
    public int <BFAHNLFGLLE>k__BackingField;    // 0x0x28
    public int <ILOAPFKLNGF>k__BackingField;    // 0x0x2C
    public bool <COGLEHGHNBP>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public DGFKJOHNEKA ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool EFMAIHFHNBJ;    // 0x0x28
}
...
{
    public AMCPKNLHFIF? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [Auth POST]
public class PlayerCheerV1CreateRequest
{
    public AMCPKNLHFIF NHGIGMGLOIC;  // wrapper
...
{
    public KAJLIHHEFAG GFFJLJFCJJO;  // wrapper
...
{
    public HHNMBNMHLPD PBLNJHEPKAE;  // wrapper
    public int? IGINNEPBJOB;  // wrapper
...
{
    public MBHJNPILBBM EIEONFKEIIP;  // wrapper
    public float? DKCHNGNLHMG;  // wrapper
    public bool? LACPKLHEIML;  // wrapper
...
{
    public List<MMILDBOFIKL> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public INBGDCCBHOO FFHIJMOJNAI;  // wrapper
    public INBGDCCBHOO? PFHJAKKPDOH;  // wrapper
...
{
    public ChatMessage NFOHONOFFAP;  // wrapper
    public KGJJDJIMPMJ EIEONFKEIIP;  // wrapper
...
{
    public GOCILOCPHNM HBGFNCNPMFK;  // wrapper
    public HFPDHOKLIEC DCHCPEFJGJC;  // wrapper
    public DMHBNJNFFJP HPFDLNKDGIB;  // wrapper
    public DMHBNJNFFJP GJAKIAIHFGF;  // wrapper
...
{
    public EJGKIAPMNHJ FAIAAPGMGOI;  // wrapper
    public INBGDCCBHOO? OMFMDPACODG;  // wrapper
...
{
    public EPOEJKGDHPB LFLCLMACOKL;  // wrapper
...
{
    public OFOKKLOCKIO inventionId;  // wrapper
}
...
// api/keepsakes/{mMJNEIGAGKK}/collect  [Auth POST]
public class KeepsakesMMJNEIGAGKKCollectRequest
{
    public Guid MMJNEIGAGKK;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public JCDIFNMFFCP IPGIPDPIAID;  // wrapper
    public long? NBDDMFOIEKN;  // wrapper
...
{
    public Guid CCAEFADCGII;  // wrapper
...
{
    public Guid EOMOOABMPDK;  // wrapper
    public object Price;  // candidate
...
{
    public Guid EOMOOABMPDK;  // wrapper
    public long? HEEONHBPLFL;  // wrapper
    public byte? ALHFHMDBPCO;  // wrapper
    public int? MKAJENPGJDK;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid CCAEFADCGII;  // wrapper
    public long? ABIBGEKODLH;  // wrapper
    public long? FFJDLGKCOIG;  // wrapper
    public int? CHLNHGEJFAN;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> LIIDINHCICD;  // wrapper
...
{
    public HDBMMHKAMDN PBLNJHEPKAE;  // wrapper
    public Guid? HEPBDMIECOK;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public MBHJNPILBBM EIEONFKEIIP;  // wrapper
    public long? KOLDOJIHGNM;  // wrapper
    public Guid? NKHHHAALDJI;  // wrapper
    public int? BOFGEMLHGOO;  // wrapper
...
{
    public Guid LAMLHGMPLLA;  // wrapper
...
{
    public Guid AMHCKIAMBNO;  // wrapper
...
{
    public PBNMIPAKIGC IOBCPKFBNME;  // wrapper
}
