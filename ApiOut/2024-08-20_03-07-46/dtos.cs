...
public class ABNABLGDIBK
{
    public long <PFPKCFLHAEJ>k__BackingField;    // 0x0x10
    public int <APOIIHPJLHF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ACOENCOALMP
//   (not directly referenced by a detected call)
public class ACOENCOALMP
{
    public string <PGCEJKENLBM>k__BackingField;    // 0x0x10
    public LHFNHJGCGNM <JGEPGPIJGLN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AEGFPKCBIPO
//   RESPONSE POST   api/inventions/v1/settags   [Service.Auth]
public class AEGFPKCBIPO
{
    public NNJGCBBCEDN <AMNIPAHJDKJ>k__BackingField;    // 0x0x10
    public List<string> <NHNMCKJBEJI>k__BackingField;    // 0x0x18
}
...
public class AFIMOAOKNLO : GCPLBLGLPNL
{
    public BEOHMNMLOPK? <JONFEEFCLFO>k__BackingField;    // 0x0x18
    public CCOBIMEHHBI <JCHPJLOHIKB>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/keepsakes/{iIFFOFLIAJN}   [Service.Auth]
...
public class AIEOOGBICEA
{
    public bool <BAFOJHLNICC>k__BackingField;    // 0x0x10
    public string <HCIJHAMILLN>k__BackingField;    // 0x0x18
}
...
public class AJGOAPNMNOP
{
    public MDBPBMPDPBM <DHFNBMNIHEM>k__BackingField;    // 0x0x10
    public CNAPKCDOGPA <BPHMPNLNENF>k__BackingField;    // 0x0x18
    public int <PIIPMHGBAJP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AKPHKMJNCBH
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Matchmaking]
public class AKPHKMJNCBH
{
    public Guid <HIKDKINMDFC>k__BackingField;    // 0x0x10
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x20
    public string <KEAMGBHCFNC>k__BackingField;    // 0x0x28
    public DateTime <OHALFKOKAII>k__BackingField;    // 0x0x30
    public DateTime? <CGOFPNDBIBP>k__BackingField;    // 0x0x38
    public List<MONOFBKJCCK> <LAMEHCCHDML>k__BackingField;    // 0x0x48
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{gPDJAOBFIIA}   [Service.WWW]
public class AMMDDEMDPFD
{
    public KMIMFEPNOIO <ANLJAFDGBLA>k__BackingField;    // 0x0x10
    public PAPOMHKPMHP <BAOJDJINNPP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ANOBGJGPBNL
//   RESPONSE ?      api/customAvatarItems/GetCustomAvatarItemCurrentSavesForCustomAvatarItemIds/v2   [Service.Auth]
public class ANOBGJGPBNL
{
    public Dictionary<Guid, List<MICNDMEHBNK>> <HGAJEMACLPB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// AOELMLCMADP
//   (not directly referenced by a detected call)
public class AOELMLCMADP
{
    public int <HBICOJKIPDK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// AOFLIGNGLOF
//   (not directly referenced by a detected call)
public class AOFLIGNGLOF
{
    public bool <IPAJKKFPICL>k__BackingField;    // 0x0x10
    public KIFKHADONLI <IGGGJBCFKPK>k__BackingField;    // 0x0x18
    public float <ACFPNLALDON>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/progressionEvents/collect/{pFKCDJAIJBH}/{kDKDEIINEAJ}   [Service.Auth]
public class BLIIPDGBCGG
{
    public long? <JMNJHMIBEKB>k__BackingField;    // 0x0x10
    public int <ELCFDDJJCBE>k__BackingField;    // 0x0x20
    public int? <JCDDNMMEIEA>k__BackingField;    // 0x0x24
    public string <NJMADENDHFA>k__BackingField;    // 0x0x30
    public GDBGCKHGILF? <BALIPMFMCOE>k__BackingField;    // 0x0x38
    public string <JNAELJOKCEI>k__BackingField;    // 0x0x40
    public Guid? <JEBHHDJLFEH>k__BackingField;    // 0x0x48
    public string <NKGEMEOAICL>k__BackingField;    // 0x0x60
    public string <OBIJEKGLMMB>k__BackingField;    // 0x0x68
    public MNJOPKLBDCH <CAPMCEKFPEO>k__BackingField;    // 0x0x70
    public int <EDBBPEMKJFG>k__BackingField;    // 0x0x74
    public int <HMJICAHKMBJ>k__BackingField;    // 0x0x78
    public KGMPOBIGBMK <JDGOMGJILHN>k__BackingField;    // 0x0x7C
    public HLEDNNKNEEE <FGMLCIHLBAD>k__BackingField;    // 0x0x80
    public string <MICHMIDJBPA>k__BackingField;    // 0x0x88
    public MJPNHEHGJPK <APCJFKMNAED>k__BackingField;    // 0x0x90
    public CHLGHEMBAMD <PGFMFLKPKOB>k__BackingField;    // 0x0x94
    public NJMDCHNFCIN? <CDCGMMIBAMF>k__BackingField;    // 0x0x98
    public bool <DHMONOICAEL>k__BackingField;    // 0x0xA0
    public bool <PGNCHGNOIII>k__BackingField;    // 0x0xA1
    public string <IJNEDCBANOL>k__BackingField;    // 0x0xA8
    public bool <DMBHLMCJCHN>k__BackingField;    // 0x0xB0
    public bool IOHNCHKGLDC;    // 0x0xB1
}

// --------------------------------------------------------------------------
// BNEEAKPKPGL
//   RESPONSE GET    api/playerevents/v1/all   [Service.Auth]
//   RESPONSE GET    api/playerevents/v1/all/{kFDCPIPJNMG}   [Service.Auth]
public class BNEEAKPKPGL
{
    public List<LFBHNNPIDAG> <DBBEFIHFKDJ>k__BackingField;    // 0x0x10
    public List<KMKGFKHENMA> <LPEBIFNGBII>k__BackingField;    // 0x0x18
}
...
// CAJHHGJAGBD
//   (not directly referenced by a detected call)
public class CAJHHGJAGBD
{
    public bool <GKCENOJJBJP>k__BackingField;    // 0x0x10
    public CHLGHEMBAMD <KOMEJIOMGND>k__BackingField;    // 0x0x14
    public int <EDDBOIIPMFA>k__BackingField;    // 0x0x18
    public DateTime <CMJIJKAADHG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CCOBIMEHHBI
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.WWW]
public class CCOBIMEHHBI
{
    public int <APOIIHPJLHF>k__BackingField;    // 0x0x10
    public Guid <ADBIDDPOMDI>k__BackingField;    // 0x0x14
    public long <LLHKIELHJHE>k__BackingField;    // 0x0x28
    public DateTime <CMJIJKAADHG>k__BackingField;    // 0x0x30
}
...
public class CIABCPAGCIN
{
    public NNFDPIKOMAJ <LBDNOLKNIKD>k__BackingField;    // 0x0x10
    public long <FMDFKFBEDOA>k__BackingField;    // 0x0x18
    public string <IIJPJKOPEMH>k__BackingField;    // 0x0x20
}
...
public class CJPMFIHKKJA
{
    public int <DPLNELLIGOL>k__BackingField;    // 0x0x10
    public int <MJCIIEPIBPL>k__BackingField;    // 0x0x14
    public float <BLCNFJCELGO>k__BackingField;    // 0x0x18
    public int <BCFEBDHHAIK>k__BackingField;    // 0x0x1C
    public int <AEJAPLCGGJO>k__BackingField;    // 0x0x20
    public int <DMIJOFMNBOI>k__BackingField;    // 0x0x24
    public int <BBFONPGONKO>k__BackingField;    // 0x0x28
    public string <DFBGJMBNIOE>k__BackingField;    // 0x0x30
    public string <JNEJKIACJHI>k__BackingField;    // 0x0x38
}
...
// CNAPKCDOGPA
//   (not directly referenced by a detected call)
public class CNAPKCDOGPA
{
    public long <ACLLIMAJFDG>k__BackingField;    // 0x0x10
    public Guid? <ADBIDDPOMDI>k__BackingField;    // 0x0x18
}
...
public class DENJAONDGGM
{
    public KMIMFEPNOIO <ANLJAFDGBLA>k__BackingField;    // 0x0x10
    public JCEAEKOANLA <MOGJMDGAKJB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DFOFDKCAHEE
//   (not directly referenced by a detected call)
public class DFOFDKCAHEE
{
    public float <DAJMFJMHOCN>k__BackingField;    // 0x0x10
}
...
public class DHHGOKIHFGJ
{
    public CNBMEBLNKKD <ANLJAFDGBLA>k__BackingField;    // 0x0x10
    public GGDDHCMNKJK <FFHAAABCBFO>k__BackingField;    // 0x0x18
    public IGMBLCINKBO <OFFHIFFPFMK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DJBDLIFMNLC
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.WWW]
public class DJBDLIFMNLC
{
    public List<EGLHPIJMPJA> <HGCPMPAAECG>k__BackingField;    // 0x0x10
    public string <EAOJNPLCDBG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DOCDOFMCEKO
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.WWW]
public class DOCDOFMCEKO
{
    public Guid? <LCGDHICKJEI>k__BackingField;    // 0x0x10
    public long? <JFDHEGNDGAF>k__BackingField;    // 0x0x28
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x38
    public string <GPFJAAMAMNC>k__BackingField;    // 0x0x40
    public string <KEAMGBHCFNC>k__BackingField;    // 0x0x48
    public CNAPKCDOGPA <KKKBGBJCKDO>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// EGLHPIJMPJA
//   (not directly referenced by a detected call)
public class EGLHPIJMPJA
{
    public int <PPDBCKDADEO>k__BackingField;    // 0x0x10
    public DateTime <PKDCOINKOND>k__BackingField;    // 0x0x18
    public DateTime? <PPIDIMFHOCH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EKHEOKPAGMK
//   (not directly referenced by a detected call)
public class EKHEOKPAGMK
{
    public MNJOPKLBDCH <CAPMCEKFPEO>k__BackingField;    // 0x0x10
    public int <ACLLIMAJFDG>k__BackingField;    // 0x0x14
    public NNKANBGPDGN <MBJNPHLONIO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ELGLKBIGEMN
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.WWW]
public class ELGLKBIGEMN
{
    public Guid <ADBIDDPOMDI>k__BackingField;    // 0x0x10
    public int <HPIMKIDLHLM>k__BackingField;    // 0x0x20
    public long <PFMFABBEKFI>k__BackingField;    // 0x0x28
    public Guid <EFLBIJIPCMK>k__BackingField;    // 0x0x30
}
...
public class EMEHPBDGNCH
{
    public IOKGFGGDJIL <LBDNOLKNIKD>k__BackingField;    // 0x0x10
    public string <IIJPJKOPEMH>k__BackingField;    // 0x0x18
    public int? <IBHPPIFNBFM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ENFIPAMHBLH
//   (not directly referenced by a detected call)
public class ENFIPAMHBLH
{
    public int <PIIPMHGBAJP>k__BackingField;    // 0x0x10
    public MDBPBMPDPBM <DHFNBMNIHEM>k__BackingField;    // 0x0x18
}
...
public class FBPAFGKEFFH : LFBHNNPIDAG
{
    public List<ACOENCOALMP> <NHNMCKJBEJI>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// FCOGNEOGKBD
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.Auth]
public class FCOGNEOGKBD
{
    public NNFDPIKOMAJ <LBDNOLKNIKD>k__BackingField;    // 0x0x10
    public int <BGJEGGAACJL>k__BackingField;    // 0x0x14
    public long <AKLOMCJAGMO>k__BackingField;    // 0x0x18
    public bool <BDIBDLNFCCJ>k__BackingField;    // 0x0x20
    public string <LBMFCFHPJOP>k__BackingField;    // 0x0x28
    public int? <POPCGIKHOPE>k__BackingField;    // 0x0x30
    public bool <FGLPBJDKHOL>k__BackingField;    // 0x0x38
    public bool <ODIGLEEJHEJ>k__BackingField;    // 0x0x39
    public bool <BPIAEGGNIFE>k__BackingField;    // 0x0x3A
    public bool <DBLKKPFCIIF>k__BackingField;    // 0x0x3B
    public string <KMOGNMKPILB>k__BackingField;    // 0x0x40
    public DateTime? <GOMGFMNFNPL>k__BackingField;    // 0x0x48
    public string <ANAIMMLIJIO>k__BackingField;    // 0x0x58
    public float <PPPOKJDKCAN>k__BackingField;    // 0x0x60
}
...
public class FDLLKBFMJDJ
{
    public Guid <EFLBIJIPCMK>k__BackingField;    // 0x0x10
    public long <GPOGGGDGBAM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FHLHLOGHAAH
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{kKALBFHKHLJ}/{lKAEDHKDKIH}   [Service.WWW]
public class FHLHLOGHAAH
{
    public MNJOPKLBDCH <CAPMCEKFPEO>k__BackingField;    // 0x0x10
    public CJPBGCLNIAC <IIEDFMBBJAJ>k__BackingField;    // 0x0x14
    public int <AGBHCFGDLHE>k__BackingField;    // 0x0x18
    public int <ALCLAIEBBGN>k__BackingField;    // 0x0x1C
    public int <ABECIMJPHNJ>k__BackingField;    // 0x0x20
    public HJMLLMEGODA <ACOMMLMCFFD>k__BackingField;    // 0x0x24
    public bool <HKBDKFMGELH>k__BackingField;    // 0x0x28
    public float <FDENPEADFLO>k__BackingField;    // 0x0x2C
    public int <KIMEALPHLAO>k__BackingField;    // 0x0x30
    public bool <OLNPFGEKNEE>k__BackingField;    // 0x0x34
}
...
public class FLCIJJJOGOB : GCPLBLGLPNL
{
    public CLDLFDLNIGD? <JONFEEFCLFO>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <FLNGLJDHHIJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FMGGNFFIMNH
//   (not directly referenced by a detected call)
public class FMGGNFFIMNH
{
    public int <FNMKFHKHDAA>k__BackingField;    // 0x0x10
    public NOFNLIALBPO <JGEPGPIJGLN>k__BackingField;    // 0x0x14
    public List<EKHEOKPAGMK> <EAJJKBNPOJM>k__BackingField;    // 0x0x18
    public List<EKHEOKPAGMK> <HPBOHKJOJOF>k__BackingField;    // 0x0x20
    public bool <NHOLGOFOHHC>k__BackingField;    // 0x0x28
    public DateTime? <GCLANKNAFOK>k__BackingField;    // 0x0x30
    public DateTime? <MFEAOCNIMMA>k__BackingField;    // 0x0x40
    public DateTime? <FOCKLNJFCME>k__BackingField;    // 0x0x50
    public bool <ALIINEOMNPJ>k__BackingField;    // 0x0x60
    public bool <AMPIBOKKKEE>k__BackingField;    // 0x0x61
}

// --------------------------------------------------------------------------
// FNIENEGAOOB
//   REQUEST  ?      api/customAvatarItems/GetCustomAvatarItemCurrentSavesForCustomAvatarItemIds/v2   [Service.Auth]
public class FNIENEGAOOB
{
    public List<Guid> <BFJGLLMAPIH>k__BackingField;    // 0x0x10
    public byte <CNLOHPJFLHD>k__BackingField;    // 0x0x18
    public int <NLGPNBPHNAE>k__BackingField;    // 0x0x1C
}
...
public class GACKKEDGNNE
{
    public IBMHMCMEJND <ANLJAFDGBLA>k__BackingField;    // 0x0x10
    public HOPOPNHNACN <COJNFNEEBHF>k__BackingField;    // 0x0x18
}
...
// GGDDHCMNKJK
//   (not directly referenced by a detected call)
public class GGDDHCMNKJK
{
    public ObscuredLong <AONHHBICPOA>k__BackingField;    // 0x0x10
    public string <BIELJANMOKH>k__BackingField;    // 0x0x38
    public ObscuredInt <MKAEEFKIDJF>k__BackingField;    // 0x0x40
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x58
    public string <GPFJAAMAMNC>k__BackingField;    // 0x0x60
    public string <JCEFHKMIOCN>k__BackingField;    // 0x0x68
    public string <KEAMGBHCFNC>k__BackingField;    // 0x0x70
    public byte <JOKBJLENIBH>k__BackingField;    // 0x0x78
    public int <AIPCHFCCJAO>k__BackingField;    // 0x0x7C
    public IBMJBLBOIAO <EPGCEJJPLHK>k__BackingField;    // 0x0x80
    public bool <GOHNEPGDAAD>k__BackingField;    // 0x0x84
    public DateTime <CMJIJKAADHG>k__BackingField;    // 0x0x88
    public DateTime <PKDCOINKOND>k__BackingField;    // 0x0x90
    public DateTime? <FGPKNABAHDG>k__BackingField;    // 0x0x98
    public long? <MCIHODICLMB>k__BackingField;    // 0x0xA8
    public int <LMNKHLBBJGP>k__BackingField;    // 0x0xB8
    public int <PBALAOEPOKO>k__BackingField;    // 0x0xBC
    public int <NMFIDACIMDN>k__BackingField;    // 0x0xC0
    public GFAOJMKADGB <GACNHGFACLC>k__BackingField;    // 0x0xC4
    public GFAOJMKADGB <DCPEHHLPDLK>k__BackingField;    // 0x0xC8
    public ObscuredBool <FPIJFEKOIHP>k__BackingField;    // 0x0xCC
    public ObscuredBool <NJDCIIEDKGP>k__BackingField;    // 0x0xD8
    public ObscuredBool <HEBMGBHKJEK>k__BackingField;    // 0x0xE4
    public ObscuredBool <AMNIJFEDHCI>k__BackingField;    // 0x0xF0
    public int? <ACLLIMAJFDG>k__BackingField;    // 0x0xFC
    public bool <CJMMPACIFOB>k__BackingField;    // 0x0x104
    public string <IOMPFALOOOO>k__BackingField;    // 0x0x108
}
...
public class GGIOLPOMLIM
{
    public GDBGCKHGILF <BALIPMFMCOE>k__BackingField;    // 0x0x10
    public string <OIBLKDKLMGA>k__BackingField;    // 0x0x18
    public string <OCAPOBPAJOF>k__BackingField;    // 0x0x20
    public string <GODMCMNBBBK>k__BackingField;    // 0x0x28
    public HLEDNNKNEEE <IEDNOOHFLFO>k__BackingField;    // 0x0x30
    public string <CHPCEFFMPJI>k__BackingField;    // 0x0x38
    public int <IAIFDPPMPKE>k__BackingField;    // 0x0x40
    public bool <DHGDCHOOELO>k__BackingField;    // 0x0x44
}
...
public class GHANLODNAHD
{
    public List<string> <HFKFBONCIBD>k__BackingField;    // 0x0x10
    public List<string> <DJIJEGOFKLN>k__BackingField;    // 0x0x18
    public List<string> <IBDCEIHBKCH>k__BackingField;    // 0x0x20
}
...
// base   : FMGGNFFIMNH
//   (not directly referenced by a detected call)
public class GILEANDOPKH : FMGGNFFIMNH
{
    public int <GJBAOGEJGHC>k__BackingField;    // 0x0x68
    public List<AOFLIGNGLOF> <MOCMLFBEECP>k__BackingField;    // 0x0x70
    public List<AOFLIGNGLOF> <JOLOFLJFACB>k__BackingField;    // 0x0x78
    public List<AOFLIGNGLOF> <LGDBIHDPFBB>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// GKHMCJBEBAA
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.WWW]
public class GKHMCJBEBAA
{
    public long <JFDHEGNDGAF>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <CMDNEOCIJNM>k__BackingField;    // 0x0x18
    public CKLKDFHPFAC <KLJBMAMADLP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GLNLJMPCMNA
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.Auth]
public class GLNLJMPCMNA
{
    public List<KGEIPPJOPLC> <LCBPDNABJOH>k__BackingField;    // 0x0x10
    public JBHMLJKBLLK <AMNIPAHJDKJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GOADMACDBMH
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.Auth]
public class GOADMACDBMH
{
    public List<long> <FNGEIEJMMFE>k__BackingField;    // 0x0x10
    public OHNDLKNGNIB <JGEPGPIJGLN>k__BackingField;    // 0x0x18
    public string <MNLIMJENDCP>k__BackingField;    // 0x0x20
    public long? <JFDHEGNDGAF>k__BackingField;    // 0x0x28
}
...
// HHBNGKBLKNP
//   (not directly referenced by a detected call)
public class HHBNGKBLKNP
{
    public NMGCMLLEIGJ JFJLMPMLIJB;    // 0x0x10
    public int MEKMEMOFFGA;    // 0x0x14
}

// --------------------------------------------------------------------------
// HHFCHNLEMHH
//   RESPONSE GET    api/inventions/   [Service.Auth]
//   RESPONSE GET    api/inventions/v1/personaldetails/{hMBAPOGAKPH}   [Service.Auth]
public class HHFCHNLEMHH
{
    public bool <MENFIPCIHOA>k__BackingField;    // 0x0x10
}
...
// base   : AANABFPKHFJ
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/season/{bPAOALOHDME}   [Service.WWW]
public class HIAABMOHBOG : AANABFPKHFJ
{
    public int <LLBJILONDLO>k__BackingField;    // 0x0x30
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x38
    public DateTime <OHALFKOKAII>k__BackingField;    // 0x0x40
    public DateTime <KEJDOKPNDNC>k__BackingField;    // 0x0x48
    public MNJOPKLBDCH <CAPMCEKFPEO>k__BackingField;    // 0x0x50
    public FMGGNFFIMNH <EIJOAODHBPN>k__BackingField;    // 0x0x58
    public List<GILEANDOPKH> <JOKCJBDFBJG>k__BackingField;    // 0x0x60
    public CAJHHGJAGBD <OBDLFCAFIOC>k__BackingField;    // 0x0x68
}
...
//   RESPONSE GET    api/relationships/v2/sendfriendrequest   [Service.Data]
public class HMOAHEFFJGC
{
    public int <JNOIJCEFEOA>k__BackingField;    // 0x0x10
    public OHFNJIEJKKI <JGEPGPIJGLN>k__BackingField;    // 0x0x14
    public KMDMKNKNONN <FEMIGFHLHMP>k__BackingField;    // 0x0x18
    public KMDMKNKNONN <FOLDHOBFCAO>k__BackingField;    // 0x0x1C
    public KMDMKNKNONN <EHJOEAJGOGA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HNIPDHNAPMC
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.WWW]
public class HNIPDHNAPMC
{
    public int <BGJEGGAACJL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HOPOPNHNACN
//   (not directly referenced by a detected call)
public class HOPOPNHNACN
{
    public long <PFPKCFLHAEJ>k__BackingField;    // 0x0x10
    public Guid <BIELJANMOKH>k__BackingField;    // 0x0x18
    public long <JFDHEGNDGAF>k__BackingField;    // 0x0x28
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x30
    public string <GPFJAAMAMNC>k__BackingField;    // 0x0x38
    public int <ACLLIMAJFDG>k__BackingField;    // 0x0x40
    public Guid? <APIDJGAGBMI>k__BackingField;    // 0x0x44
    public DateTime <PKDCOINKOND>k__BackingField;    // 0x0x58
    public string <KEAMGBHCFNC>k__BackingField;    // 0x0x60
    public MAJFDKGKHHD <JGEPGPIJGLN>k__BackingField;    // 0x0x68
}
...
public class IAKLDAAEONK
{
    public int <MFKHFDAFFDI>k__BackingField;    // 0x0x10
    public bool <DMDNELCCIAI>k__BackingField;    // 0x0x14
    public DateTime <JAKFEOMGHII>k__BackingField;    // 0x0x18
    public bool <MALABMPIOGD>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{kEBBDHAGLDK}   [Service.WWW]
public enum IBMHMCMEJND
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
// IGMBLCINKBO
//   (not directly referenced by a detected call)
public class IGMBLCINKBO
{
    public long <HFOILKAHMDO>k__BackingField;    // 0x0x10
    public string <BIELJANMOKH>k__BackingField;    // 0x0x18
    public int <NPPFPNPPOMG>k__BackingField;    // 0x0x20
    public bool <CEOHHNBCBLK>k__BackingField;    // 0x0x24
    public int <IOJMFLLPMNP>k__BackingField;    // 0x0x28
    public int <DHAGMOCOINJ>k__BackingField;    // 0x0x2C
    public int <DCPDFDCEMDE>k__BackingField;    // 0x0x30
    public int <JMBCNFOEBDE>k__BackingField;    // 0x0x34
    public string <ACLNADGGLME>k__BackingField;    // 0x0x38
    public string <HAHKPDBKPAM>k__BackingField;    // 0x0x40
}
...
public class IJOGGBMCLHF
{
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x10
    public string <GPFJAAMAMNC>k__BackingField;    // 0x0x18
    public int? <ACLLIMAJFDG>k__BackingField;    // 0x0x20
    public IBMJBLBOIAO? <EPGCEJJPLHK>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// ILGOAKNPCHC
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.?]
public class ILGOAKNPCHC
{
    public int? <COJIHKPMFJG>k__BackingField;    // 0x0x10
    public string <DCFAKHINEDN>k__BackingField;    // 0x0x18
    public string <GJOJGPAACAB>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// JCAIEKAIEIO
// base   : CJFKONEAHCB`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class JCAIEKAIEIO
{
    // (no instance fields in the metadata dump)
}
...
// JCEAEKOANLA
//   (not directly referenced by a detected call)
public class JCEAEKOANLA
{
    public Guid <LCGDHICKJEI>k__BackingField;    // 0x0x10
    public int <APOIIHPJLHF>k__BackingField;    // 0x0x20
    public int <MEFIFIADKPE>k__BackingField;    // 0x0x24
    public Guid <BMCCPPCNEGP>k__BackingField;    // 0x0x28
    public DateTime <CMJIJKAADHG>k__BackingField;    // 0x0x38
    public PAPOMHKPMHP <BAOJDJINNPP>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// JHLBDLLOHNE
//   (not directly referenced by a detected call)
public class JHLBDLLOHNE
{
    public long <HDFCBLGIOAD>k__BackingField;    // 0x0x10
    public long <FMDFKFBEDOA>k__BackingField;    // 0x0x18
    public int <ELCFDDJJCBE>k__BackingField;    // 0x0x20
    public DateTime <PKDCOINKOND>k__BackingField;    // 0x0x28
    public OEOHKDAHJKA <JGEPGPIJGLN>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// JJLHBKGLDLF
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.Auth]
public class JJLHBKGLDLF
{
    public string <JMNJHMIBEKB>k__BackingField;    // 0x0x10
    public string <NFMBANNOFPH>k__BackingField;    // 0x0x18
    public string <MIIBIMDMEHJ>k__BackingField;    // 0x0x20
    public string <GPFJAAMAMNC>k__BackingField;    // 0x0x28
    public string <DCFAKHINEDN>k__BackingField;    // 0x0x30
    public NBMDFNGIPEJ <ANLJAFDGBLA>k__BackingField;    // 0x0x38
    public List<string> <GEBDJJNMFMI>k__BackingField;    // 0x0x40
    public List<string> <NHNMCKJBEJI>k__BackingField;    // 0x0x48
    public string <LKJODLOJEPM>k__BackingField;    // 0x0x50
    public List<LMBGBDAEFJD> <IFCHALDFGND>k__BackingField;    // 0x0x58
}
...
public class JKLNKNBENPG
{
    public int <BMNKBIOAPNF>k__BackingField;    // 0x0x10
    public int <MFKHFDAFFDI>k__BackingField;    // 0x0x14
    public float <BIEJNDJCKKM>k__BackingField;    // 0x0x18
    public float <ABIJENCNPKH>k__BackingField;    // 0x0x1C
    public bool <DMDNELCCIAI>k__BackingField;    // 0x0x20
    public bool <LGGHOBOJEKO>k__BackingField;    // 0x0x21
    public bool <ELMPPBDEHNJ>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// KGEIPPJOPLC
//   (not directly referenced by a detected call)
public class KGEIPPJOPLC
{
    public int <AFMKOFDIHDH>k__BackingField;    // 0x0x10
    public JBHMLJKBLLK <AMNIPAHJDKJ>k__BackingField;    // 0x0x14
}
...
public class KGOECOFLCOI
{
    public int <MLMFDOCFOOO>k__BackingField;    // 0x0x10
    public int? <ONEBDCNMJCE>k__BackingField;    // 0x0x14
    public string <LACBNNMPCFI>k__BackingField;    // 0x0x20
    public string <DGDLLHACHPJ>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// KIFKHADONLI
//   (not directly referenced by a detected call)
public class KIFKHADONLI
{
    public int <GKLFKPOCJKE>k__BackingField;    // 0x0x10
    public string <OCAPOBPAJOF>k__BackingField;    // 0x0x18
    public string <GODMCMNBBBK>k__BackingField;    // 0x0x20
    public string <CHPCEFFMPJI>k__BackingField;    // 0x0x28
    public string <NJMADENDHFA>k__BackingField;    // 0x0x30
    public string <JNAELJOKCEI>k__BackingField;    // 0x0x38
    public Guid? <JEBHHDJLFEH>k__BackingField;    // 0x0x40
    public GDBGCKHGILF? <BALIPMFMCOE>k__BackingField;    // 0x0x54
    public string <NKGEMEOAICL>k__BackingField;    // 0x0x60
    public string <OBIJEKGLMMB>k__BackingField;    // 0x0x68
    public bool <EILFBOGNEBO>k__BackingField;    // 0x0x70
    public bool <KIGPPEKGFDP>k__BackingField;    // 0x0x71
    public bool <AJPJJBDOGPM>k__BackingField;    // 0x0x72
    public HLEDNNKNEEE <IEDNOOHFLFO>k__BackingField;    // 0x0x74
    public MNJOPKLBDCH <CAPMCEKFPEO>k__BackingField;    // 0x0x78
    public int <EDBBPEMKJFG>k__BackingField;    // 0x0x7C
    public AIMLIFFOBJG <ADNJPIDKFOB>k__BackingField;    // 0x0x80
    public KGMPOBIGBMK <HALPEOOMNGM>k__BackingField;    // 0x0x84
    public int? <KNPKHCKMIOE>k__BackingField;    // 0x0x88
    public string <FEDOEBJAAGC>k__BackingField;    // 0x0x90
    public int? <IAIFDPPMPKE>k__BackingField;    // 0x0x98
    public int? <IJPLMHBDFPO>k__BackingField;    // 0x0xA0
}

// --------------------------------------------------------------------------
// KJIHCHEBIHN
//   RESPONSE GET    api/config/v1/azurespeech   [Service.Auth]
public class KJIHCHEBIHN
{
    public bool <FENGABPLCLK>k__BackingField;    // 0x0x10
    public string <NFMBANNOFPH>k__BackingField;    // 0x0x18
    public string <DJDLNJNEOFC>k__BackingField;    // 0x0x20
}
...
// KMKGFKHENMA
//   (not directly referenced by a detected call)
public class KMKGFKHENMA
{
    public LFBHNNPIDAG <NIDFAJDKECI>k__BackingField;    // 0x0x10
    public JHLBDLLOHNE <IMAKBIIDDID>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KNMDDDPNLFP
//   RESPONSE GET    api/inventions/v1/details   [Service.Auth]
public class KNMDDDPNLFP
{
    public List<ACOENCOALMP> <NHNMCKJBEJI>k__BackingField;    // 0x0x10
}
...
public class LCLJACEOIOH
{
    public Dictionary<Guid, DENJAONDGGM> <GDMFIDPPCNF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LFBHNNPIDAG
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class LFBHNNPIDAG
{
    public long <FMDFKFBEDOA>k__BackingField;    // 0x0x10
    public int <ADOADDMBBEJ>k__BackingField;    // 0x0x18
    public long <JFDHEGNDGAF>k__BackingField;    // 0x0x20
    public long? <MKCPFHJJJGN>k__BackingField;    // 0x0x28
    public long? <NJOGKNGLHNM>k__BackingField;    // 0x0x38
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x48
    public string <GPFJAAMAMNC>k__BackingField;    // 0x0x50
    public string <KEAMGBHCFNC>k__BackingField;    // 0x0x58
    public DateTime <KGIECDNNBPL>k__BackingField;    // 0x0x60
    public DateTime <PAIIJHPHDIJ>k__BackingField;    // 0x0x68
    public int <NGCDKHKJPPF>k__BackingField;    // 0x0x70
    public NFBPOFCBCGE <EPGCEJJPLHK>k__BackingField;    // 0x0x74
    public bool <BCLAMHOLCAA>k__BackingField;    // 0x0x78
    public bool <PIMIEDDONHC>k__BackingField;    // 0x0x79
    public KPKEDGCBGJA <MLFJGOLGHHG>k__BackingField;    // 0x0x7C
    public KPKEDGCBGJA <KNODOLKKMPF>k__BackingField;    // 0x0x80
    public long? <JIJEAHPABCM>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// LFCNFBDMICH
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class LFCNFBDMICH
{
    public Dictionary<Guid, ENFIPAMHBLH> <APMODEFOAFP>k__BackingField;    // 0x0x10
}
...
// LHKBNBNIIHF
//   (not directly referenced by a detected call)
public class LHKBNBNIIHF
{
    public int <ICJKGLCJIKD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LIGGCDIBODL
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{kHLDDJPHOBA}   [Service.Auth]
public class LIGGCDIBODL
{
    public uint <JMNJHMIBEKB>k__BackingField;    // 0x0x10
    public uint? <OMJKKJDMLKI>k__BackingField;    // 0x0x14
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x20
    public string <GPFJAAMAMNC>k__BackingField;    // 0x0x28
    public DateTime <DAAKALNGHHF>k__BackingField;    // 0x0x30
    public DateTime? <HJBPKADKBIG>k__BackingField;    // 0x0x38
    public bool <KCCNCJFIKJK>k__BackingField;    // 0x0x48
    public List<JJLHBKGLDLF> <KCBCMDMMEPM>k__BackingField;    // 0x0x50
    public List<string> <NHNMCKJBEJI>k__BackingField;    // 0x0x58
    public int <DMNEINADOAL>k__BackingField;    // 0x0x60
    public int <DPCKLIOLCCJ>k__BackingField;    // 0x0x64
    public int <PLMKKJPPDBN>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// LKLMBPGBNBD
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.WWW]
public class LKLMBPGBNBD
{
    public int HIGBIDBKCGL;    // 0x0x10
    public long BKCININNOLF;    // 0x0x18
}

// --------------------------------------------------------------------------
// LMBGBDAEFJD
//   (not directly referenced by a detected call)
public class LMBGBDAEFJD
{
    public DateTime <PKDCOINKOND>k__BackingField;    // 0x0x10
    public string <KGNILBPFNDB>k__BackingField;    // 0x0x18
}
...
public class MBPMMOFIIGN
{
    public List<int> <LBNOFLJPPHG>k__BackingField;    // 0x0x10
    public string <EAOJNPLCDBG>k__BackingField;    // 0x0x18
}
...
public class MCNHFGDMFOC
{
    public List<LFBHNNPIDAG> <IJBJJBMHNON>k__BackingField;    // 0x0x10
    public string <EAOJNPLCDBG>k__BackingField;    // 0x0x18
}
...
public class MDBPBMPDPBM
{
    public Guid? <CBCKKPHENIO>k__BackingField;    // 0x0x10
    public Guid <MLNFFDICENM>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// MICNDMEHBNK
//   (not directly referenced by a detected call)
public class MICNDMEHBNK
{
    public long <PJBKCKBHOGC>k__BackingField;    // 0x0x10
    public Guid <JEBHHDJLFEH>k__BackingField;    // 0x0x18
    public Guid <NPPFODLFCLI>k__BackingField;    // 0x0x28
    public DateTime <PKDCOINKOND>k__BackingField;    // 0x0x38
    public string <IIDKNLLEBME>k__BackingField;    // 0x0x40
    public string <CFAMLEIKJLC>k__BackingField;    // 0x0x48
    public int <BOFALLGHFPJ>k__BackingField;    // 0x0x50
    public string <JKNMLEOPKGK>k__BackingField;    // 0x0x58
    public string <DDKAOFMMGCO>k__BackingField;    // 0x0x60
    public string <EELLCGOEMAO>k__BackingField;    // 0x0x68
    public string <HFHBPODDMOK>k__BackingField;    // 0x0x70
    public int <FIGFFGFCEDO>k__BackingField;    // 0x0x78
}
...
// MONOFBKJCCK
//   (not directly referenced by a detected call)
public class MONOFBKJCCK
{
    public Guid <CJPPMMFFLCB>k__BackingField;    // 0x0x10
    public Guid <OFMAFIKICDB>k__BackingField;    // 0x0x20
    public DateTime <OHALFKOKAII>k__BackingField;    // 0x0x30
    public List<KIFKHADONLI> <MPKKHKKHHAL>k__BackingField;    // 0x0x38
}
...
public class NAMOJNCCILG
{
    public Dictionary<int, int> <HFAJILHANDO>k__BackingField;    // 0x0x10
    public List<CKPGPDFPKHE> <NECBJCIMNMF>k__BackingField;    // 0x0x18
    public HHBNGKBLKNP[][] <HBPHCEILKPB>k__BackingField;    // 0x0x20
    public AOELMLCMADP <EHEICNCECHC>k__BackingField;    // 0x0x28
    public OJAJALBPANH <IOCHPNOPLPB>k__BackingField;    // 0x0x30
    public LHKBNBNIIHF <DBDNLAILMKK>k__BackingField;    // 0x0x38
    public PADNCBGNAEA <FJDHJAFPFCG>k__BackingField;    // 0x0x40
    public DFOFDKCAHEE <NAAMKEBOCAA>k__BackingField;    // 0x0x48
    public string <APDHMNLDOIM>k__BackingField;    // 0x0x50
}
...
public class NKCEDHGBFFC
{
    public long <FMDFKFBEDOA>k__BackingField;    // 0x0x10
    public OEOHKDAHJKA <JGEPGPIJGLN>k__BackingField;    // 0x0x18
}
...
public class NMLOGPINBON
{
    public string <MGHNNLEFBIP>k__BackingField;    // 0x0x10
    public string <PIIJBPGJEHC>k__BackingField;    // 0x0x18
    public string <OCAPOBPAJOF>k__BackingField;    // 0x0x20
    public string <GODMCMNBBBK>k__BackingField;    // 0x0x28
    public HLEDNNKNEEE <IEDNOOHFLFO>k__BackingField;    // 0x0x30
    public bool GPCGADDDEOI;    // 0x0x34
    public bool <ELMPPBDEHNJ>k__BackingField;    // 0x0x35
}
...
// NNKANBGPDGN
//   (not directly referenced by a detected call)
public class NNKANBGPDGN
{
    public int <GAOEMPACCIA>k__BackingField;    // 0x0x10
    public DateTime? <HDKIOJOGPBM>k__BackingField;    // 0x0x18
    public DateTime? <OFNDPEKJPLJ>k__BackingField;    // 0x0x28
}
...
public class OCIEIGAGINK
{
    public List<string> <FPIDBIBAILJ>k__BackingField;    // 0x0x10
}
...
// OJAJALBPANH
//   (not directly referenced by a detected call)
public class OJAJALBPANH
{
    public float <HAAIBEFIOPH>k__BackingField;    // 0x0x10
    public float <GJLMBLFEDFN>k__BackingField;    // 0x0x14
    public float <NFOBKINCDMH>k__BackingField;    // 0x0x18
    public float <DKDGDODJONL>k__BackingField;    // 0x0x1C
    public float <ECNKMHPLGNG>k__BackingField;    // 0x0x20
    public float <IAADCJEIKKK>k__BackingField;    // 0x0x24
    public float <JMMEBIOBOKO>k__BackingField;    // 0x0x28
    public float <JHIHDLPLHPN>k__BackingField;    // 0x0x2C
}
...
public class ONEINHFLEGK
{
    public bool <BAFOJHLNICC>k__BackingField;    // 0x0x10
    public string <LBMFCFHPJOP>k__BackingField;    // 0x0x18
}
...
public class OOCFANFCIPO
{
    public FBPAFGKEFFH <NIDFAJDKECI>k__BackingField;    // 0x0x10
    public JBHMLJKBLLK <AMNIPAHJDKJ>k__BackingField;    // 0x0x18
    public AEGFPKCBIPO <CMILABMOOCE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PADNCBGNAEA
//   (not directly referenced by a detected call)
public class PADNCBGNAEA
{
    public int <AONDNEHJCBJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PAPOMHKPMHP
//   (not directly referenced by a detected call)
public class PAPOMHKPMHP
{
    public Guid <LCGDHICKJEI>k__BackingField;    // 0x0x10
    public long <JFDHEGNDGAF>k__BackingField;    // 0x0x20
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x28
    public string <GPFJAAMAMNC>k__BackingField;    // 0x0x30
    public string <KEAMGBHCFNC>k__BackingField;    // 0x0x38
    public long <ACLLIMAJFDG>k__BackingField;    // 0x0x40
    public Guid? <APIDJGAGBMI>k__BackingField;    // 0x0x48
    public DateTime <CMJIJKAADHG>k__BackingField;    // 0x0x60
    public int <MHGFEIFCGPN>k__BackingField;    // 0x0x68
}
...
public class PEFIBHMPKAE
{
    public long <JFDHEGNDGAF>k__BackingField;    // 0x0x10
    public long? <MKCPFHJJJGN>k__BackingField;    // 0x0x18
    public long? <NJOGKNGLHNM>k__BackingField;    // 0x0x28
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x38
    public string <GPFJAAMAMNC>k__BackingField;    // 0x0x40
    public List<string> <NHNMCKJBEJI>k__BackingField;    // 0x0x48
    public string <KEAMGBHCFNC>k__BackingField;    // 0x0x50
    public DateTime <KGIECDNNBPL>k__BackingField;    // 0x0x58
    public DateTime <PAIIJHPHDIJ>k__BackingField;    // 0x0x60
    public NFBPOFCBCGE <EPGCEJJPLHK>k__BackingField;    // 0x0x68
    public bool <BCLAMHOLCAA>k__BackingField;    // 0x0x6C
    public bool <PIMIEDDONHC>k__BackingField;    // 0x0x6D
    public KPKEDGCBGJA <MLFJGOLGHHG>k__BackingField;    // 0x0x70
    public KPKEDGCBGJA <KNODOLKKMPF>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// PMJFDKAFAHO
// base   : CJFKONEAHCB`1<OFDCHBFCKEB>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{aCCLPIHHMAK}   [Service.Auth]
public class PMJFDKAFAHO
{
    // (no instance fields in the metadata dump)
}
...
public class PMONEAENKGM
{
    public JBHMLJKBLLK <AMNIPAHJDKJ>k__BackingField;    // 0x0x10
}
...
public class AddKeepsakeInstanceRequest
{
    public long <JFDHEGNDGAF>k__BackingField;    // 0x0x10
    public long? <MKCPFHJJJGN>k__BackingField;    // 0x0x18
    public KEAEDCOMCGE <BCNABBCDJHL>k__BackingField;    // 0x0x28
}
...
{
    public MCMNLHFEPJA <AMNIPAHJDKJ>k__BackingField;    // 0x0x10
    public string <GFAOFOOAJLF>k__BackingField;    // 0x0x18
    public string <BEBPEEPPCKA>k__BackingField;    // 0x0x20
    public string <HDGMFEGCGGA>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public MNJOPKLBDCH <CurrencyType>k__BackingField;    // 0x0x18
    public NJMDCHNFCIN <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <FMDFKFBEDOA>k__BackingField;    // 0x0x10
    public long? <EGEAELOCNOD>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public NLPEHKMNGHO FilterType;    // 0x0x20
...
{
    public KEAEDCOMCGE <KGOLKECFABF>k__BackingField;    // 0x0x10
    public string <CMEHMHAFNKD>k__BackingField;    // 0x0x18
    public int <PLFGBFLHAIL>k__BackingField;    // 0x0x20
    public int <APAIABJCLGJ>k__BackingField;    // 0x0x24
    public string <MCHDHPLKCCD>k__BackingField;    // 0x0x28
    public string <GFDMGOAJKMF>k__BackingField;    // 0x0x30
}
...
{
    public int <APOIIHPJLHF>k__BackingField;    // 0x0x10
    public Guid <PKFFKCHFGIN>k__BackingField;    // 0x0x14
    public DateTime <OLMCBGKOCJM>k__BackingField;    // 0x0x28
}
...
{
    public bool <KKCKODJFNLI>k__BackingField;    // 0x0x10
    public int <DBAMFDKEJKA>k__BackingField;    // 0x0x14
    public bool <ONLAECDPNPA>k__BackingField;    // 0x0x18
}
...
{
    public Guid <PKFFKCHFGIN>k__BackingField;    // 0x0x10
    public KEAEDCOMCGE <AMFBBIGFLMN>k__BackingField;    // 0x0x20
    public int <JCOBMJDKHBD>k__BackingField;    // 0x0x24
    public long <JFDHEGNDGAF>k__BackingField;    // 0x0x28
    public long? <MKCPFHJJJGN>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{pADBFKNBHEL}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <AOGGIJFGCPM>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <LIJHMMDDGOE>k__BackingField;    // 0x0x18
}
...
{
    public long <JOCFPPDBAHM>k__BackingField;    // 0x0x10
    public long <JFDHEGNDGAF>k__BackingField;    // 0x0x18
    public long <FBJIGIPNNAJ>k__BackingField;    // 0x0x20
    public MEPHOLFLPBM <JGEPGPIJGLN>k__BackingField;    // 0x0x28
    public int <GIEMCEODHNH>k__BackingField;    // 0x0x2C
}
...
{
    public long <JFDHEGNDGAF>k__BackingField;    // 0x0x10
    public List<Guid> <JMBLMPDIHML>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <AOGGIJFGCPM>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <LIJHMMDDGOE>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <INAFKMICCIM>k__BackingField;    // 0x0x20
}
...
{
    public long <FBJIGIPNNAJ>k__BackingField;    // 0x0x10
    public long <FGMBIFJGAKI>k__BackingField;    // 0x0x18
    public int? <INKFAOPEPMH>k__BackingField;    // 0x0x20
    public int? <HMDIAEMGMND>k__BackingField;    // 0x0x28
    public long? <EHCPPOGBJDE>k__BackingField;    // 0x0x30
    public long <BOBMKBMFKDN>k__BackingField;    // 0x0x40
    public long <BMODJOHCNDO>k__BackingField;    // 0x0x48
    public int <BGNJEHBMKNC>k__BackingField;    // 0x0x50
    public MEPHOLFLPBM <LFIHLDEJJDE>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <PNOGNCOOKDJ>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public KGMPOBIGBMK <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public MJKPLCNHABA creatorAccountRole;    // 0x0x60
...
{
    public IKBNLCBHDCL <LBCCIKKCEDB>k__BackingField;    // 0x0x10
    public KEDADNNBKCH <BNCBLMKMMGI>k__BackingField;    // 0x0x14
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x18
    public string <GPFJAAMAMNC>k__BackingField;    // 0x0x20
    public bool <NHJDBOPLHKO>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<IKBNLCBHDCL> <GOKONFADPBI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{pFKCDJAIJBH}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <FGMBIFJGAKI>k__BackingField;    // 0x0x10
    public string <CNLEMCGCBBA>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <LGDBIHDPFBB>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <JMIOEIPOGDP>k__BackingField;    // 0x0x28
    public DateTime <KGIECDNNBPL>k__BackingField;    // 0x0x30
    public DateTime <PAIIJHPHDIJ>k__BackingField;    // 0x0x38
    public DateTime <PPGHFBIIIEG>k__BackingField;    // 0x0x40
    public bool <JBMAACCHGEF>k__BackingField;    // 0x0x48
    public int <HLBCPPNAJDA>k__BackingField;    // 0x0x4C
    public float <POKOIDEMOBF>k__BackingField;    // 0x0x50
    public Guid? <EBFGHFAFCMK>k__BackingField;    // 0x0x54
    public string <GEENMDLBOFE>k__BackingField;    // 0x0x68
    public string <EECLKAHCJFA>k__BackingField;    // 0x0x70
    public string <BNLMIKJCDBO>k__BackingField;    // 0x0x78
    public string <NIBFNKMIMHN>k__BackingField;    // 0x0x80
}
...
{
    public Guid <JLGBPKOANII>k__BackingField;    // 0x0x10
    public int <EOFIPCCNKML>k__BackingField;    // 0x0x20
    public int <ANPBHGDNBHP>k__BackingField;    // 0x0x24
    public int <BKFIFCHNAMK>k__BackingField;    // 0x0x28
    public long <IHPOHLPIEBF>k__BackingField;    // 0x0x30
    public long <HNCIOPNJGMP>k__BackingField;    // 0x0x38
}
...
{
    public int <APOIIHPJLHF>k__BackingField;    // 0x0x10
    public int <HMJICAHKMBJ>k__BackingField;    // 0x0x14
    public int <IDFNLDLGADL>k__BackingField;    // 0x0x18
    public int <BNEEBKHOOIN>k__BackingField;    // 0x0x1C
    public int <IJDCDEJAPBK>k__BackingField;    // 0x0x20
    public DateTime? <CLNKJMJDPBB>k__BackingField;    // 0x0x28
}
...
{
    public long <MACMNDPEGMN>k__BackingField;    // 0x0x10
    public int <GKLFKPOCJKE>k__BackingField;    // 0x0x18
    public string <KEAMGBHCFNC>k__BackingField;    // 0x0x20
    public int <HMJICAHKMBJ>k__BackingField;    // 0x0x28
    public int <GMCBOIGIMFD>k__BackingField;    // 0x0x2C
    public bool <GCOHEOAFMPB>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public FKIKFFGBAEL ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool NKNICBPNNIC;    // 0x0x28
}
...
{
    public KPBBHGHDOEA? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [Auth POST]
public class PlayerCheerV1CreateRequest
{
    public KPBBHGHDOEA JFHCLELBBHF;  // wrapper
...
{
    public MJPNHEHGJPK PHPHBJOAKCF;  // wrapper
...
{
    public LIGIEIEKJNK HNGLFCFOHLI;  // wrapper
    public int? EHPGBGADPPC;  // wrapper
...
{
    public NNFDPIKOMAJ PELEODPKAJB;  // wrapper
    public float? CCGGBOCOHEO;  // wrapper
    public bool? NFGBLHPFCDD;  // wrapper
...
{
    public List<MEDGMGIADBO> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public KGMPOBIGBMK PDLLDMABKGP;  // wrapper
    public KGMPOBIGBMK? KODKNDJPMEG;  // wrapper
...
{
    public ChatMessage KKHEHGHPOAA;  // wrapper
    public HNPBNOIKIOF PELEODPKAJB;  // wrapper
...
{
    public IBMJBLBOIAO EDAPJBNJBMN;  // wrapper
    public FIKPDBLBHOC MCLMFLPKMEL;  // wrapper
    public AKIMEIEMEDF KDFLCGFOGIK;  // wrapper
    public AKIMEIEMEDF GALALNPLAFI;  // wrapper
...
{
    public JNDIDEKAJMN KIFBGCJNPJL;  // wrapper
    public KGMPOBIGBMK? MEDKCCDLIJC;  // wrapper
...
{
    public CNEBKJFOAMP DJGJEDMNJCE;  // wrapper
...
{
    public GGDDHCMNKJK inventionId;  // wrapper
}
...
// api/keepsakes/{iIFFOFLIAJN}/collect  [Auth POST]
public class KeepsakesIIFFOFLIAJNCollectRequest
{
    public Guid IIFFOFLIAJN;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public OHNDLKNGNIB FKACLEPPPIO;  // wrapper
    public long? MFLLPFDNGGL;  // wrapper
...
{
    public LFBHNNPIDAG EHHDPKBKCAK;  // wrapper
    public NFBPOFCBCGE LMCOBCNOCDL;  // wrapper
    public NFBPOFCBCGE EDAPJBNJBMN;  // wrapper
}
...
{
    public LFBHNNPIDAG EHHDPKBKCAK;  // wrapper
    public long? BFHJJICJMNA;  // wrapper
    public long? JDJANHCBBCK;  // wrapper
}
...
{
    public LFBHNNPIDAG EHHDPKBKCAK;  // wrapper
    public KPKEDGCBGJA NKGLADNAGHJ;  // wrapper
    public KPKEDGCBGJA LLNEMIOFMOL;  // wrapper
}
...
{
    public LFBHNNPIDAG EHHDPKBKCAK;  // wrapper
    public long? CGABDLEBHJJ;  // wrapper
    public long? KNEHMNKKPOH;  // wrapper
}
...
{
    public LFBHNNPIDAG EHHDPKBKCAK;  // wrapper
    public DateTime CKMIGOAOJNE;  // wrapper
    public DateTime CIMFCAICMEC;  // wrapper
    public DateTime NPGLKCPEHKE;  // wrapper
    public DateTime KCGJJLJBGPA;  // wrapper
}
...
{
    public Guid LFPGCHPHFKA;  // wrapper
...
{
    public Guid FHDLNMJGNOO;  // wrapper
    public object Price;  // candidate
...
{
    public Guid FHDLNMJGNOO;  // wrapper
    public long? MJDCLCEGBGN;  // wrapper
    public byte? GDADABDCJHE;  // wrapper
    public int? NHCEIDKGILJ;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid LFPGCHPHFKA;  // wrapper
    public long? ANBJMOODOPF;  // wrapper
    public long? BOHFENKBMAB;  // wrapper
    public int? HJAEFBHLKLP;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> OEFIADEKGGF;  // wrapper
...
{
    public MAJFDKGKHHD HNGLFCFOHLI;  // wrapper
    public Guid? MNPINLKCJEL;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public NNFDPIKOMAJ PELEODPKAJB;  // wrapper
    public long? HMAGLPLBJII;  // wrapper
    public Guid? BICGOCMMNLE;  // wrapper
    public int? GIBEDGHKFOE;  // wrapper
...
{
    public Guid NHPJOGEDJOG;  // wrapper
...
{
    public Guid MICCDDNNJPM;  // wrapper
...
{
    public NBMDFNGIPEJ JKBDFOEMFHM;  // wrapper
}
