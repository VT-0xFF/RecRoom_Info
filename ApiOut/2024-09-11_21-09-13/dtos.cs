...
public class ABEENCHBGJN
{
    public HBBAEPBLNMC <AGJICAIHJPB>k__BackingField;    // 0x0x10
    public ICJELNHNKPH <FNICAEHOGFC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AGEOKEHEHHP
//   (not directly referenced by a detected call)
public class AGEOKEHEHHP
{
    public long <FBLOMAEJCEB>k__BackingField;    // 0x0x10
    public string <PHACAHGGCLA>k__BackingField;    // 0x0x18
    public int <BCEOOPPKCPL>k__BackingField;    // 0x0x20
    public bool <HPJFHAMIIED>k__BackingField;    // 0x0x24
    public int <NKBLNAENLNC>k__BackingField;    // 0x0x28
    public int <CBJMNLHFHLH>k__BackingField;    // 0x0x2C
    public int <MBDHPFJHJLM>k__BackingField;    // 0x0x30
    public int <PCKKIOBDJFN>k__BackingField;    // 0x0x34
    public string <AGLEAALIEGL>k__BackingField;    // 0x0x38
    public string <HNPELPBMGKH>k__BackingField;    // 0x0x40
}
...
public class AHFDGJBPKKE
{
    public AEAEIKIBKAA <MOOABBPBBPE>k__BackingField;    // 0x0x10
    public string <KJDMEAGJEGL>k__BackingField;    // 0x0x18
    public int? <EIGCLBLOFOI>k__BackingField;    // 0x0x20
}
...
public class AJNCGIEOKOG
{
    public int <DAIDHDKOKIK>k__BackingField;    // 0x0x10
    public bool <NCPHGBAOPKM>k__BackingField;    // 0x0x14
    public DateTime <CDELDIKJBDI>k__BackingField;    // 0x0x18
    public bool <LOEAINNBBKG>k__BackingField;    // 0x0x20
}
...
public class ALPKBKKIJEI
{
    public string <IEMOPFDPBNP>k__BackingField;    // 0x0x10
    public string <MOFDMALHCFO>k__BackingField;    // 0x0x18
    public string <DKIDFFGBNFM>k__BackingField;    // 0x0x20
    public string <MBFCBEDJLGE>k__BackingField;    // 0x0x28
    public string <BEMIFMOFOHN>k__BackingField;    // 0x0x30
    public ILILIBONCEN <CGAAFLBOPDK>k__BackingField;    // 0x0x38
    public List<string> <KGNEADJCHBG>k__BackingField;    // 0x0x40
    public List<string> <CLHHCBIGMHH>k__BackingField;    // 0x0x48
    public string <IIEBHLBBKCI>k__BackingField;    // 0x0x50
    public List<DBEMNOELHGJ> <IKBPLJMBBJI>k__BackingField;    // 0x0x58
}
...
public class AMBLIKEFAHB
{
    public NKIIJMEMELG <CGAAFLBOPDK>k__BackingField;    // 0x0x10
    public PHNJFNKONFF <KLBCJPBDCHK>k__BackingField;    // 0x0x18
}
...
public class ANKCBKAPAFK
{
    public NNHFDNEOMIK <CGAAFLBOPDK>k__BackingField;    // 0x0x10
    public JIMGJOBLFHK <NEKEOPJPHOD>k__BackingField;    // 0x0x18
    public AGEOKEHEHHP <EBOCJKDOHAM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// APGFPLDHFDP
//   (not directly referenced by a detected call)
public class APGFPLDHFDP
{
    public int <EPONNLBPMDM>k__BackingField;    // 0x0x10
    public string <CEGDHDCOMNF>k__BackingField;    // 0x0x18
    public string <PDFAHNDCGGA>k__BackingField;    // 0x0x20
    public string <DIOFHNCILNA>k__BackingField;    // 0x0x28
    public string <IHEOHDBMAPD>k__BackingField;    // 0x0x30
    public string <NBAMKNMJKHP>k__BackingField;    // 0x0x38
    public Guid? <BEKDKBLGFKH>k__BackingField;    // 0x0x40
    public PKNCEBFLPEN? <DJIJJKDGNIE>k__BackingField;    // 0x0x54
    public string <DGJLKHICMOG>k__BackingField;    // 0x0x60
    public string <HPGLDOFJCOJ>k__BackingField;    // 0x0x68
    public bool <FOMBKLCAEBE>k__BackingField;    // 0x0x70
    public bool <LPJDIAJGMPP>k__BackingField;    // 0x0x71
    public bool <ICBDPJCHPBD>k__BackingField;    // 0x0x72
    public BCECLOGHFGB <JNLCFLPNOBC>k__BackingField;    // 0x0x74
    public CDNMCAFDJLC <MIDBKAPGGJL>k__BackingField;    // 0x0x78
    public int <MBPLDPGAIIN>k__BackingField;    // 0x0x7C
    public DLHCECCOBNF <IAPMNNGKMIP>k__BackingField;    // 0x0x80
    public IGDCNFGMCEA <OKLMBFDFGED>k__BackingField;    // 0x0x84
    public int? <CPJOCPNHBCP>k__BackingField;    // 0x0x88
    public string <IHKOHJPHDKF>k__BackingField;    // 0x0x90
    public int? <JJJOEGJMIJN>k__BackingField;    // 0x0x98
    public int? <BAKFLPECBKE>k__BackingField;    // 0x0xA0
}

// --------------------------------------------------------------------------
// BADIALIONKJ
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.WWW]
public class BADIALIONKJ
{
    public int PKDNGKCGKCD;    // 0x0x10
    public long NKAHCNKFDBJ;    // 0x0x18
}

// --------------------------------------------------------------------------
// BAMOMPPBAHJ
//   (not directly referenced by a detected call)
public class BAMOMPPBAHJ
{
    public bool <EMLFAICJBFF>k__BackingField;    // 0x0x10
    public OKBOOJKEIMF <KIBJEHGBMOM>k__BackingField;    // 0x0x14
    public int <PECHKGFLECI>k__BackingField;    // 0x0x18
    public DateTime <FPKJCHJFKFA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BBOEHLNMBJK
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{oGOLMPBCMMK}/{kGEOJCMOEIG}   [Service.WWW]
public class BBOEHLNMBJK
{
    public CDNMCAFDJLC <MIDBKAPGGJL>k__BackingField;    // 0x0x10
    public KNDHPELLLAJ <FHBFAFCHIMM>k__BackingField;    // 0x0x14
    public int <LEKLLOIKAKN>k__BackingField;    // 0x0x18
    public int <OOEBHAKBAHL>k__BackingField;    // 0x0x1C
    public int <ALHNFBKAKCD>k__BackingField;    // 0x0x20
    public PAFGODCLMHE <AJGGCPDLDFE>k__BackingField;    // 0x0x24
    public bool <MKANKHFCJFD>k__BackingField;    // 0x0x28
    public float <PKJLGKMGKON>k__BackingField;    // 0x0x2C
    public int <KADBMHODIJO>k__BackingField;    // 0x0x30
    public bool <OMIGKNGGGPA>k__BackingField;    // 0x0x34
}
...
public class BMOEBJNJEHD
{
    public int <PKKDPMDEADL>k__BackingField;    // 0x0x10
}
...
public class BOMIFLBAJDK : MEKFDJOGGPE
{
    public EOLPBFPGAPB? <HLNFOBEBNEG>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <KNGCBKOJGON>k__BackingField;    // 0x0x20
}
...
// CAADPBKCDLA
//   (not directly referenced by a detected call)
public class CAADPBKCDLA
{
    public int <LMBAHHMGGGM>k__BackingField;    // 0x0x10
    public FMOHCLEDJOG <MEGFHENEHKI>k__BackingField;    // 0x0x18
}
...
// CGDOPHCBANK
//   (not directly referenced by a detected call)
public class CGDOPHCBANK
{
    public Guid <MBEFJIPBIIP>k__BackingField;    // 0x0x10
    public long <GKEOEAMBCHB>k__BackingField;    // 0x0x20
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x28
    public string <MBFCBEDJLGE>k__BackingField;    // 0x0x30
    public string <CODCGFGHFEL>k__BackingField;    // 0x0x38
    public long <GJEMNEBDIAJ>k__BackingField;    // 0x0x40
    public Guid? <AIKDIKHFJIJ>k__BackingField;    // 0x0x48
    public DateTime <FPKJCHJFKFA>k__BackingField;    // 0x0x60
    public int <AAMPBDOFPJI>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// CHAEMDBMBGD
//   RESPONSE GET    api/config/v2   [Service.Auth]
public class CHAEMDBMBGD
{
    public Dictionary<int, int> <NKBOOCBBMOG>k__BackingField;    // 0x0x10
    public List<CLNFPPDFOLE> <MKDJFMLDJGE>k__BackingField;    // 0x0x18
    public LKBIAMGIACM[][] <JJEMJCKKPMG>k__BackingField;    // 0x0x20
    public ODAMJEJOJNN <JIKLMDDJGAN>k__BackingField;    // 0x0x28
    public FICNFBMJHBO <IIBBDDIKKDI>k__BackingField;    // 0x0x30
    public HEJMMLICAMC <JNECCDGKLHH>k__BackingField;    // 0x0x38
    public INFMACPINIM <FNBIDHMDLJI>k__BackingField;    // 0x0x40
    public KHKBJCJLGLB <MBGJCMAABBH>k__BackingField;    // 0x0x48
    public string <OCOHLFIDECP>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// CJDBOADDKNP
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.WWW]
public class CJDBOADDKNP
{
    public long <BMIHFFKLFAP>k__BackingField;    // 0x0x10
    public int <PBDKGKFMFHJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CJLFMLAJMBO
//   (not directly referenced by a detected call)
public class CJLFMLAJMBO
{
    public string <JGDAKKJDFJN>k__BackingField;    // 0x0x10
    public MKMHJKFDNMM <CMLHALBDAPF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CMFJCPHGDAL
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.Auth]
public class CMFJCPHGDAL
{
    public List<OMEINCKHEKL> <BLPCIIHJNLG>k__BackingField;    // 0x0x10
    public KMLJEBLDIDN <GHJNCACMNNF>k__BackingField;    // 0x0x18
}
...
public class CMKDCNBILJC
{
    public Guid <OOOBPPNDGFM>k__BackingField;    // 0x0x10
    public long <FOOJFAIMDBJ>k__BackingField;    // 0x0x20
}
...
// DBEMNOELHGJ
//   (not directly referenced by a detected call)
public class DBEMNOELHGJ
{
    public DateTime <GDGKBBHDKCA>k__BackingField;    // 0x0x10
    public string <GDIPKOCMDMG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DHCIAPLIIOA
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Matchmaking]
public class DHCIAPLIIOA
{
    public Guid <NAMIGJLGALM>k__BackingField;    // 0x0x10
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x20
    public string <CODCGFGHFEL>k__BackingField;    // 0x0x28
    public DateTime <EAJJDEJJBNB>k__BackingField;    // 0x0x30
    public DateTime? <IKEEHDGFLBJ>k__BackingField;    // 0x0x38
    public List<DIADCHLGJIP> <DFACHHGMEEM>k__BackingField;    // 0x0x48
}
...
//   RESPONSE DELETE api/keepsakes/{oIHIGEJBGDG}   [Service.Auth]
...
public class DHPAFPJDDLL
{
    public bool <IGGNGOOAAAN>k__BackingField;    // 0x0x10
    public string <EPIINDALOHI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DIADCHLGJIP
//   (not directly referenced by a detected call)
public class DIADCHLGJIP
{
    public Guid <MMBPIKHEOOF>k__BackingField;    // 0x0x10
    public Guid <FDKNHGBGNHF>k__BackingField;    // 0x0x20
    public DateTime <EAJJDEJJBNB>k__BackingField;    // 0x0x30
    public List<APGFPLDHFDP> <ENEGNJMKBJP>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// DIADECHHNPL
//   (not directly referenced by a detected call)
public class DIADECHHNPL
{
    public int <PMJEEMMGGEI>k__BackingField;    // 0x0x10
    public DateTime <GDGKBBHDKCA>k__BackingField;    // 0x0x18
    public DateTime? <NHHEEIGEACO>k__BackingField;    // 0x0x20
}
...
//   RESPONSE GET    api/inventions/v1/personaldetails/{bCCFEKJCEMP}   [Service.Auth]
public class DMDGJNMOFAL
{
    public bool <EBLPGINPIOO>k__BackingField;    // 0x0x10
}
...
public class EBAMMCAPCND
{
    public bool <DLLHIKNBNLA>k__BackingField;    // 0x0x10
    public string <MOFDMALHCFO>k__BackingField;    // 0x0x18
    public string <KJPKFJMEPGP>k__BackingField;    // 0x0x20
}
...
// EDOKJOENDPG
//   (not directly referenced by a detected call)
public class EDOKJOENDPG
{
    public long <FLPNIGENADP>k__BackingField;    // 0x0x10
    public Guid <BEKDKBLGFKH>k__BackingField;    // 0x0x18
    public Guid <OGPMFIDKGBJ>k__BackingField;    // 0x0x28
    public DateTime <GDGKBBHDKCA>k__BackingField;    // 0x0x38
    public string <DMNMEIEKBCL>k__BackingField;    // 0x0x40
    public string <GCFGBCNIKKO>k__BackingField;    // 0x0x48
    public int <DCHOCFADMPJ>k__BackingField;    // 0x0x50
    public string <APGFDKHOPCC>k__BackingField;    // 0x0x58
    public string <JAHNHCKKPGF>k__BackingField;    // 0x0x60
    public string <PGFPENEDMPA>k__BackingField;    // 0x0x68
    public string <GKFOEIHNKIG>k__BackingField;    // 0x0x70
    public int <PCMGACHNIAH>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// EEIGLIGDGGP
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.WWW]
public class EEIGLIGDGGP
{
    public Guid? <MBEFJIPBIIP>k__BackingField;    // 0x0x10
    public long? <GKEOEAMBCHB>k__BackingField;    // 0x0x28
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x38
    public string <MBFCBEDJLGE>k__BackingField;    // 0x0x40
    public string <CODCGFGHFEL>k__BackingField;    // 0x0x48
    public PPJHIJPCADL <JGLIKPAEFLB>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// EJLMIFFNCIM
//   (not directly referenced by a detected call)
public class EJLMIFFNCIM
{
    public Guid <MBEFJIPBIIP>k__BackingField;    // 0x0x10
    public int <PBDKGKFMFHJ>k__BackingField;    // 0x0x20
    public int <HHECLHFLKKD>k__BackingField;    // 0x0x24
    public Guid <GGOKGNOHNIN>k__BackingField;    // 0x0x28
    public DateTime <FPKJCHJFKFA>k__BackingField;    // 0x0x38
    public CGDOPHCBANK <MCKKJOEMJFK>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// EJNCPNJIGKD
//   (not directly referenced by a detected call)
public class EJNCPNJIGKD
{
    public CDNMCAFDJLC <MIDBKAPGGJL>k__BackingField;    // 0x0x10
    public int <GJEMNEBDIAJ>k__BackingField;    // 0x0x14
    public KAAPOLGIAOB <BFFELPFDMGE>k__BackingField;    // 0x0x18
}
...
// FICNFBMJHBO
//   (not directly referenced by a detected call)
public class FICNFBMJHBO
{
    public float <GGMADCDPCON>k__BackingField;    // 0x0x10
    public float <GDIPODLAENA>k__BackingField;    // 0x0x14
    public float <NMKFAOAKHII>k__BackingField;    // 0x0x18
    public float <JNOMBOOPHFH>k__BackingField;    // 0x0x1C
    public float <DNCJFBJANMG>k__BackingField;    // 0x0x20
    public float <AIEHGDBIBHP>k__BackingField;    // 0x0x24
    public float <LBIJKFLEPDF>k__BackingField;    // 0x0x28
    public float <AKIPNJJNDIG>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// FLBDCJBNOFI
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.WWW]
public class FLBDCJBNOFI
{
    public List<string> <FFCFLBGJIDG>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{oHFAMLJFGJF}   [Service.WWW]
public class FMLAKGHBLHN
{
    public GHKAAOFLPLL <CGAAFLBOPDK>k__BackingField;    // 0x0x10
    public CGDOPHCBANK <MCKKJOEMJFK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FMOHCLEDJOG
//   REQUEST  PUT    api/roomconsumables   [Service.WWW]
public class FMOHCLEDJOG
{
    public Guid? <LMIJEJHGCEH>k__BackingField;    // 0x0x10
    public Guid <LMPECKNFCOH>k__BackingField;    // 0x0x24
}
...
public class FNJBMIFFCJD
{
    public int <BACHFIHMHMC>k__BackingField;    // 0x0x10
    public BFOMPPFFCCH <CMLHALBDAPF>k__BackingField;    // 0x0x14
    public IJPHGFONJCO <LFBJHKDABCG>k__BackingField;    // 0x0x18
    public IJPHGFONJCO <PLOOACCAEIK>k__BackingField;    // 0x0x1C
    public IJPHGFONJCO <DCFPILLBKAF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FPGNHENNLHM
//   RESPONSE ?      api/customAvatarItems/GetCustomAvatarItemCurrentSavesForCustomAvatarItemIds/v2   [Service.Auth]
public class FPGNHENNLHM
{
    public Dictionary<Guid, List<EDOKJOENDPG>> <LIBJPMDFFHA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GBBLIKCDEON
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.Auth]
public class GBBLIKCDEON
{
    public int <CBMJGCOOFAN>k__BackingField;    // 0x0x10
    public int? <ACBLIGMCAHD>k__BackingField;    // 0x0x14
    public string <FINECLFGKDC>k__BackingField;    // 0x0x20
    public string <LHAGMCELIPF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// GBEHPBBINOB
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.Auth]
public class GBEHPBBINOB
{
    public List<HBBAEPBLNMC> <FFBOFNMBBOD>k__BackingField;    // 0x0x10
    public string <GOFLGDABLIM>k__BackingField;    // 0x0x18
}
...
public class GCAGHLKLLCJ
{
    public bool <IGGNGOOAAAN>k__BackingField;    // 0x0x10
    public string <CCLAHFAMAKC>k__BackingField;    // 0x0x18
}
...
public class GDDAACJBPOP
{
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x10
    public string <MBFCBEDJLGE>k__BackingField;    // 0x0x18
    public int? <GJEMNEBDIAJ>k__BackingField;    // 0x0x20
    public HMAPOJNAMII? <NMMMCOBHAIA>k__BackingField;    // 0x0x28
}
...
public class GGGPICAMAJN
{
    public long <GKEOEAMBCHB>k__BackingField;    // 0x0x10
    public long? <FMJECPJAMAN>k__BackingField;    // 0x0x18
    public long? <DKMILMDKPPP>k__BackingField;    // 0x0x28
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x38
    public string <MBFCBEDJLGE>k__BackingField;    // 0x0x40
    public List<string> <CLHHCBIGMHH>k__BackingField;    // 0x0x48
    public string <CODCGFGHFEL>k__BackingField;    // 0x0x50
    public DateTime <LMOCIMEFAKI>k__BackingField;    // 0x0x58
    public DateTime <EABIFDGGEHF>k__BackingField;    // 0x0x60
    public CDDBILKOANK <NMMMCOBHAIA>k__BackingField;    // 0x0x68
    public bool <JGEICBJPALM>k__BackingField;    // 0x0x6C
    public bool <LDKOBBAOPJA>k__BackingField;    // 0x0x6D
    public PACKJBIKNNN <ADPOGAFDHPL>k__BackingField;    // 0x0x70
    public PACKJBIKNNN <BPIIBDHEPJD>k__BackingField;    // 0x0x74
}
...
public class GIPMKBOPAPF
{
    public FMOHCLEDJOG <MEGFHENEHKI>k__BackingField;    // 0x0x10
    public PPJHIJPCADL <LBECMEINAOD>k__BackingField;    // 0x0x18
    public int <LMBAHHMGGGM>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/progressionEvents/collect/{cFLJPCHKOGO}/{aCDNCOMKMKP}   [Service.Auth]
public class GJEHECGDLPG
{
    public long? <IEMOPFDPBNP>k__BackingField;    // 0x0x10
    public int <JOAANAOPCFI>k__BackingField;    // 0x0x20
    public int? <LJJLNCLGIHE>k__BackingField;    // 0x0x24
    public string <IHEOHDBMAPD>k__BackingField;    // 0x0x30
    public PKNCEBFLPEN? <DJIJJKDGNIE>k__BackingField;    // 0x0x38
    public string <NBAMKNMJKHP>k__BackingField;    // 0x0x40
    public Guid? <BEKDKBLGFKH>k__BackingField;    // 0x0x48
    public string <DGJLKHICMOG>k__BackingField;    // 0x0x60
    public string <HPGLDOFJCOJ>k__BackingField;    // 0x0x68
    public CDNMCAFDJLC <MIDBKAPGGJL>k__BackingField;    // 0x0x70
    public int <MBPLDPGAIIN>k__BackingField;    // 0x0x74
    public int <GJIMBOCFPPA>k__BackingField;    // 0x0x78
    public IGDCNFGMCEA <LDGKOHKGDDE>k__BackingField;    // 0x0x7C
    public BCECLOGHFGB <NNEOKDGHDLL>k__BackingField;    // 0x0x80
    public string <FMPCDEGKPGK>k__BackingField;    // 0x0x88
    public PDKGFNPLBAB <GHEOOFPNPGH>k__BackingField;    // 0x0x90
    public OKBOOJKEIMF <NGGBMONECLL>k__BackingField;    // 0x0x94
    public HIOJMJMAAJF? <GCOOJNHEOAN>k__BackingField;    // 0x0x98
    public bool <LAOJNOGCIJI>k__BackingField;    // 0x0xA0
    public bool <JDLDEEKBIDJ>k__BackingField;    // 0x0xA1
    public string <LMMKAHBLGKH>k__BackingField;    // 0x0xA8
    public bool <KBFLCBNCFEN>k__BackingField;    // 0x0xB0
    public bool LOFKOFKGFBA;    // 0x0xB1
}

// --------------------------------------------------------------------------
// HAHDOGHFHND
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.WWW]
public class HAHDOGHFHND
{
    public Guid <AIMNLJOGEHP>k__BackingField;    // 0x0x10
    public int <EGMBKOECLCK>k__BackingField;    // 0x0x20
    public long <NOKDKPGAHHI>k__BackingField;    // 0x0x28
    public Guid <OOOBPPNDGFM>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// HBBAEPBLNMC
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class HBBAEPBLNMC
{
    public long <NAABCEJNMMH>k__BackingField;    // 0x0x10
    public int <EFNGGMNAGAK>k__BackingField;    // 0x0x18
    public long <GKEOEAMBCHB>k__BackingField;    // 0x0x20
    public long? <FMJECPJAMAN>k__BackingField;    // 0x0x28
    public long? <DKMILMDKPPP>k__BackingField;    // 0x0x38
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x48
    public string <MBFCBEDJLGE>k__BackingField;    // 0x0x50
    public string <CODCGFGHFEL>k__BackingField;    // 0x0x58
    public DateTime <LMOCIMEFAKI>k__BackingField;    // 0x0x60
    public DateTime <EABIFDGGEHF>k__BackingField;    // 0x0x68
    public int <JKDLLCFJHFO>k__BackingField;    // 0x0x70
    public CDDBILKOANK <NMMMCOBHAIA>k__BackingField;    // 0x0x74
    public bool <JGEICBJPALM>k__BackingField;    // 0x0x78
    public bool <LDKOBBAOPJA>k__BackingField;    // 0x0x79
    public PACKJBIKNNN <ADPOGAFDHPL>k__BackingField;    // 0x0x7C
    public PACKJBIKNNN <BPIIBDHEPJD>k__BackingField;    // 0x0x80
    public long? <CELMBKBDLKK>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// HCOCBENHJCI
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.WWW]
public class HCOCBENHJCI
{
    public long <GKEOEAMBCHB>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <EGOILPKAOAM>k__BackingField;    // 0x0x18
    public HOJBKCCPFML <NILBHJODFOE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HEJMMLICAMC
//   (not directly referenced by a detected call)
public class HEJMMLICAMC
{
    public int <AIGIDHNOIDI>k__BackingField;    // 0x0x10
}
...
public class HFDNDENEADA : MEKFDJOGGPE
{
    public HKAMKNJDGOA? <HLNFOBEBNEG>k__BackingField;    // 0x0x18
    public IGNLJAGDNEI <HIKADKIDBJK>k__BackingField;    // 0x0x20
}
...
public class HKEKKLLNKAC
{
    public int <BGAMDNMEEJK>k__BackingField;    // 0x0x10
    public int <HCAMMCFBCFI>k__BackingField;    // 0x0x14
    public float <OPPGLDCJFOE>k__BackingField;    // 0x0x18
    public int <GIGEBNEAKMG>k__BackingField;    // 0x0x1C
    public int <OPGDJMILHIN>k__BackingField;    // 0x0x20
    public int <BLIMAEJONLE>k__BackingField;    // 0x0x24
    public int <PODLDCKJODG>k__BackingField;    // 0x0x28
    public string <GGOKOENALBH>k__BackingField;    // 0x0x30
    public string <DAKGEGAFHGI>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// HLIMBNILGJF
//   (not directly referenced by a detected call)
public class HLIMBNILGJF
{
    public int <BIGFCONCIMG>k__BackingField;    // 0x0x10
    public AKBMJHCDJCK <CMLHALBDAPF>k__BackingField;    // 0x0x14
    public List<EJNCPNJIGKD> <MOCBHFDFFMH>k__BackingField;    // 0x0x18
    public List<EJNCPNJIGKD> <OCIOMGABGPE>k__BackingField;    // 0x0x20
    public bool <EDNCBGKDIOK>k__BackingField;    // 0x0x28
    public DateTime? <PONBHKOMJMB>k__BackingField;    // 0x0x30
    public DateTime? <FIFPPCEGALE>k__BackingField;    // 0x0x40
    public DateTime? <DPCKKMPLBGG>k__BackingField;    // 0x0x50
    public bool <GBFDKHAOKFM>k__BackingField;    // 0x0x60
    public bool <PMEPAIOECKG>k__BackingField;    // 0x0x61
}
...
// ICJELNHNKPH
//   (not directly referenced by a detected call)
public class ICJELNHNKPH
{
    public long <MOHHOMFBEIN>k__BackingField;    // 0x0x10
    public long <NAABCEJNMMH>k__BackingField;    // 0x0x18
    public int <JOAANAOPCFI>k__BackingField;    // 0x0x20
    public DateTime <GDGKBBHDKCA>k__BackingField;    // 0x0x28
    public ECPDMKDNMMN <CMLHALBDAPF>k__BackingField;    // 0x0x30
}
...
public class IDKEOMLLPAC
{
    public List<string> <AKFDKFPOEOE>k__BackingField;    // 0x0x10
    public List<string> <CKOEKMJHNNL>k__BackingField;    // 0x0x18
    public List<string> <BPOOALALNAG>k__BackingField;    // 0x0x20
}
...
public class IGNLJAGDNEI
{
    public int <PBDKGKFMFHJ>k__BackingField;    // 0x0x10
    public Guid <AIMNLJOGEHP>k__BackingField;    // 0x0x14
    public long <BBIGGDMJEII>k__BackingField;    // 0x0x28
    public DateTime <FPKJCHJFKFA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// IJAJGCMPBFF
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{mCAKFNPAKIL}   [Service.Auth]
public class IJAJGCMPBFF
{
    public uint <IEMOPFDPBNP>k__BackingField;    // 0x0x10
    public uint? <BKBICLHGCFG>k__BackingField;    // 0x0x14
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x20
    public string <MBFCBEDJLGE>k__BackingField;    // 0x0x28
    public DateTime <KHBFNGOOGBM>k__BackingField;    // 0x0x30
    public DateTime? <EKOLCFLPOLP>k__BackingField;    // 0x0x38
    public bool <LHHOEFCEFKI>k__BackingField;    // 0x0x48
    public List<ALPKBKKIJEI> <PINBOHANEHA>k__BackingField;    // 0x0x50
    public List<string> <CLHHCBIGMHH>k__BackingField;    // 0x0x58
    public int <FAEOEMKOJOE>k__BackingField;    // 0x0x60
    public int <DBNFCKEPOBP>k__BackingField;    // 0x0x64
    public int <HDIMNCBJCIC>k__BackingField;    // 0x0x68
}
...
public class ILJHHONFALK
{
    public PKNCEBFLPEN <DJIJJKDGNIE>k__BackingField;    // 0x0x10
    public string <KAACEJHKLAF>k__BackingField;    // 0x0x18
    public string <CEGDHDCOMNF>k__BackingField;    // 0x0x20
    public string <PDFAHNDCGGA>k__BackingField;    // 0x0x28
    public BCECLOGHFGB <JNLCFLPNOBC>k__BackingField;    // 0x0x30
    public string <DIOFHNCILNA>k__BackingField;    // 0x0x38
    public int <JJJOEGJMIJN>k__BackingField;    // 0x0x40
    public bool <BKKCNPNLLDI>k__BackingField;    // 0x0x44
}

// --------------------------------------------------------------------------
// INFMACPINIM
//   (not directly referenced by a detected call)
public class INFMACPINIM
{
    public int <AJJNCKMIGJG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JDMEABMMPPL
//   REQUEST  POST   api/playerevents/v1/report   [Service.Auth]
public class JDMEABMMPPL
{
    public KFNNFMMEANB <MOOABBPBBPE>k__BackingField;    // 0x0x10
    public long <NAABCEJNMMH>k__BackingField;    // 0x0x18
    public string <KJDMEAGJEGL>k__BackingField;    // 0x0x20
}
...
// base   : HBBAEPBLNMC
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class JEFLJFCKJMJ : HBBAEPBLNMC
{
    public List<CJLFMLAJMBO> <CLHHCBIGMHH>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// JEOCABENGPO
//   (not directly referenced by a detected call)
public class JEOCABENGPO
{
    public bool <EOHCLELFDLN>k__BackingField;    // 0x0x10
    public APGFPLDHFDP <PJMOLHBDAHG>k__BackingField;    // 0x0x18
    public float <BGGICHLGNKN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JIMGJOBLFHK
//   (not directly referenced by a detected call)
public class JIMGJOBLFHK
{
    public ObscuredLong <LICNOBGDOLB>k__BackingField;    // 0x0x10
    public string <PHACAHGGCLA>k__BackingField;    // 0x0x38
    public ObscuredInt <GCMFIHHBIEF>k__BackingField;    // 0x0x40
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x58
    public string <MBFCBEDJLGE>k__BackingField;    // 0x0x60
    public string <GEPCKCLCFBN>k__BackingField;    // 0x0x68
    public string <CODCGFGHFEL>k__BackingField;    // 0x0x70
    public byte <LDABGJOHCJL>k__BackingField;    // 0x0x78
    public int <KCPDPJGKIDC>k__BackingField;    // 0x0x7C
    public HMAPOJNAMII <NMMMCOBHAIA>k__BackingField;    // 0x0x80
    public bool <IBGJCGNFELE>k__BackingField;    // 0x0x84
    public DateTime <FPKJCHJFKFA>k__BackingField;    // 0x0x88
    public DateTime <GDGKBBHDKCA>k__BackingField;    // 0x0x90
    public DateTime? <EHGNCDIPCBG>k__BackingField;    // 0x0x98
    public long? <NABLNCAEMNL>k__BackingField;    // 0x0xA8
    public int <OCOAKODBLMJ>k__BackingField;    // 0x0xB8
    public int <ADEOIGDAPID>k__BackingField;    // 0x0xBC
    public int <HPDEMBDNJAF>k__BackingField;    // 0x0xC0
    public KBBELAOKBNP <HPMACADMIBJ>k__BackingField;    // 0x0xC4
    public KBBELAOKBNP <BDBMBJICMKE>k__BackingField;    // 0x0xC8
    public ObscuredBool <JBEOCBKIHBP>k__BackingField;    // 0x0xCC
    public ObscuredBool <KPEFNAGJHKM>k__BackingField;    // 0x0xD8
    public ObscuredBool <CDEGAILNMFL>k__BackingField;    // 0x0xE4
    public ObscuredBool <GJGENBEIBFO>k__BackingField;    // 0x0xF0
    public int? <GJEMNEBDIAJ>k__BackingField;    // 0x0xFC
    public bool <JLOPKINEOPC>k__BackingField;    // 0x0x104
    public string <ODNMKPPGEPM>k__BackingField;    // 0x0x108
}

// --------------------------------------------------------------------------
// JLDGHCPHKLH
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.WWW]
public class JLDGHCPHKLH
{
    public List<int> <INDNHDJMGEA>k__BackingField;    // 0x0x10
    public string <GOFLGDABLIM>k__BackingField;    // 0x0x18
}
...
public class JLHBJHJGKCN
{
    public KFNNFMMEANB <MOOABBPBBPE>k__BackingField;    // 0x0x10
    public int <PKKDPMDEADL>k__BackingField;    // 0x0x14
    public long <AIJAEOPJBDB>k__BackingField;    // 0x0x18
    public bool <NFEFMOHBKGE>k__BackingField;    // 0x0x20
    public string <CCLAHFAMAKC>k__BackingField;    // 0x0x28
    public int? <KDPJDLLKEBC>k__BackingField;    // 0x0x30
    public bool <CNHLMPNBIIO>k__BackingField;    // 0x0x38
    public bool <GJGFFNKPIGE>k__BackingField;    // 0x0x39
    public bool <ACCJKFIMCII>k__BackingField;    // 0x0x3A
    public bool <DALGEKAOFJE>k__BackingField;    // 0x0x3B
    public string <AAKCIFNHEMP>k__BackingField;    // 0x0x40
    public DateTime? <LENCELGFABP>k__BackingField;    // 0x0x48
    public string <FPHJFJLEKDD>k__BackingField;    // 0x0x58
    public float <AFHMKECDPKA>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// JLIPENOJIFN
//   RESPONSE POST   api/inventions/v1/settags   [Service.Auth]
public class JLIPENOJIFN
{
    public DOHGMHCMFJD <GHJNCACMNNF>k__BackingField;    // 0x0x10
    public List<string> <CLHHCBIGMHH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JPNHLLKGPDO
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.WWW]
public class JPNHLLKGPDO
{
    public List<DIADECHHNPL> <CALFFGBGCEP>k__BackingField;    // 0x0x10
    public string <GOFLGDABLIM>k__BackingField;    // 0x0x18
}
...
// KAAPOLGIAOB
//   (not directly referenced by a detected call)
public class KAAPOLGIAOB
{
    public int <NPACHBDGEJB>k__BackingField;    // 0x0x10
    public DateTime? <IIDGEIGCLOL>k__BackingField;    // 0x0x18
    public DateTime? <PNONLABFHKO>k__BackingField;    // 0x0x28
}
...
public class KCMAPBJEALP
{
    public Dictionary<Guid, LLLKALKKLNH> <KLLPKMGKPKH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KHKBJCJLGLB
//   (not directly referenced by a detected call)
public class KHKBJCJLGLB
{
    public float <LOKPEMOIMCC>k__BackingField;    // 0x0x10
}
...
// base   : HLIMBNILGJF
//   (not directly referenced by a detected call)
public class KPGOGAJIJFL : HLIMBNILGJF
{
    public int <JDAAPMPKFGG>k__BackingField;    // 0x0x68
    public List<JEOCABENGPO> <OCMLBIKCDGJ>k__BackingField;    // 0x0x70
    public List<JEOCABENGPO> <KIPCNNKGPLN>k__BackingField;    // 0x0x78
    public List<JEOCABENGPO> <LDCGPAHNPFH>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// LAIKHLHLKMB
//   REQUEST  POST   api/playerevents/v1/respond   [Service.Auth]
public class LAIKHLHLKMB
{
    public long <NAABCEJNMMH>k__BackingField;    // 0x0x10
    public ECPDMKDNMMN <CMLHALBDAPF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LDFEDKOGBEF
//   RESPONSE GET    api/inventions/v1/details   [Service.Auth]
public class LDFEDKOGBEF
{
    public List<CJLFMLAJMBO> <CLHHCBIGMHH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LKBIAMGIACM
//   (not directly referenced by a detected call)
public class LKBIAMGIACM
{
    public PMIJNECBOCH PDEFHODDHNF;    // 0x0x10
    public int MFNKNDGNEPJ;    // 0x0x14
}

// --------------------------------------------------------------------------
// LKKNJPHAHIN
//   RESPONSE GET    api/playerevents/v1/all   [Service.Auth]
//   RESPONSE GET    api/playerevents/v1/all/{dKOHPFNHOFE}   [Service.Auth]
public class LKKNJPHAHIN
{
    public List<HBBAEPBLNMC> <MLLAPHJMPLK>k__BackingField;    // 0x0x10
    public List<ABEENCHBGJN> <MLHJFPEPBHC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LLLKALKKLNH
//   RESPONSE PUT    api/roomconsumables   [Service.WWW]
public class LLLKALKKLNH
{
    public GHKAAOFLPLL <CGAAFLBOPDK>k__BackingField;    // 0x0x10
    public EJLMIFFNCIM <MHNJDHGHCJA>k__BackingField;    // 0x0x18
}
...
public class LPNHKIJPFPP
{
    public JEFLJFCKJMJ <AGJICAIHJPB>k__BackingField;    // 0x0x10
    public KMLJEBLDIDN <GHJNCACMNNF>k__BackingField;    // 0x0x18
    public JLIPENOJIFN <IDMHCANDFMG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MDOHPOKDLPH
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.Auth]
public class MDOHPOKDLPH
{
    public List<long> <BGLBDOCEHMO>k__BackingField;    // 0x0x10
    public HKGJDENNFGA <CMLHALBDAPF>k__BackingField;    // 0x0x18
    public string <NIHPJMDOOKC>k__BackingField;    // 0x0x20
    public long? <GKEOEAMBCHB>k__BackingField;    // 0x0x28
}
...
// --------------------------------------------------------------------------
// MNJNEDIOFDM
// base   : CJPLDPAMPDM`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class MNJNEDIOFDM
{
    // (no instance fields in the metadata dump)
}
...
public class MPMFBFEHPMK
{
    public int? <EDEDDEIKFMI>k__BackingField;    // 0x0x10
    public string <BEMIFMOFOHN>k__BackingField;    // 0x0x18
    public string <NPOHCHAMEFA>k__BackingField;    // 0x0x20
}
...
public class NADLOCHDKFF
{
    public string <MAFJAOLOLAL>k__BackingField;    // 0x0x10
    public string <KPCIPFIPMDE>k__BackingField;    // 0x0x18
    public string <CEGDHDCOMNF>k__BackingField;    // 0x0x20
    public string <PDFAHNDCGGA>k__BackingField;    // 0x0x28
    public BCECLOGHFGB <JNLCFLPNOBC>k__BackingField;    // 0x0x30
    public bool DHDKPBJNCMF;    // 0x0x34
    public bool <FOAIENJPKKN>k__BackingField;    // 0x0x35
}

// --------------------------------------------------------------------------
// NAELDKOEHCP
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class NAELDKOEHCP
{
    public Dictionary<Guid, CAADPBKCDLA> <NLAGEBEAMFI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NIHMEAGKKEL
// base   : CJPLDPAMPDM`1<BBHCHJINLEI>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{iFJLNPOLAJM}   [Service.Auth]
public class NIHMEAGKKEL
{
    // (no instance fields in the metadata dump)
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{bECKIPDNJJK}   [Service.WWW]
public enum NKIIJMEMELG
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class NMENKOCEBOJ
{
    public List<Guid> <JPOCPFIDDCP>k__BackingField;    // 0x0x10
    public byte <GPFADEEDAIP>k__BackingField;    // 0x0x18
    public int <OPIBGAIABKB>k__BackingField;    // 0x0x1C
}
...
public class NNKKINGIKFH
{
    public int <GCGKEMAPFAJ>k__BackingField;    // 0x0x10
    public int <DAIDHDKOKIK>k__BackingField;    // 0x0x14
    public float <MLHPJJGCCIB>k__BackingField;    // 0x0x18
    public float <EJIKKFAAGFG>k__BackingField;    // 0x0x1C
    public bool <NCPHGBAOPKM>k__BackingField;    // 0x0x20
    public bool <JNIMGFFIDNP>k__BackingField;    // 0x0x21
    public bool <FOAIENJPKKN>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// ODAMJEJOJNN
//   (not directly referenced by a detected call)
public class ODAMJEJOJNN
{
    public int <FNGGINNDECD>k__BackingField;    // 0x0x10
}
...
// OMEINCKHEKL
//   (not directly referenced by a detected call)
public class OMEINCKHEKL
{
    public int <GONAMENIIOC>k__BackingField;    // 0x0x10
    public KMLJEBLDIDN <GHJNCACMNNF>k__BackingField;    // 0x0x14
}
...
public class OMPHDGCHMML
{
    public KMLJEBLDIDN <GHJNCACMNNF>k__BackingField;    // 0x0x10
}
...
// base   : MBMHOIJBDPH
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/season/{gGKDMGJFEEO}   [Service.WWW]
public class ONNEIEJBBBH : MBMHOIJBDPH
{
    public int <NNMHLMJNKJG>k__BackingField;    // 0x0x30
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x38
    public DateTime <EAJJDEJJBNB>k__BackingField;    // 0x0x40
    public DateTime <ABAPPEBHIEC>k__BackingField;    // 0x0x48
    public CDNMCAFDJLC <MIDBKAPGGJL>k__BackingField;    // 0x0x50
    public HLIMBNILGJF <KCKDFNHADLK>k__BackingField;    // 0x0x58
    public List<KPGOGAJIJFL> <ALFPCFDLPCA>k__BackingField;    // 0x0x60
    public BAMOMPPBAHJ <DFOHHIFMEBP>k__BackingField;    // 0x0x68
}
...
// PHNJFNKONFF
//   (not directly referenced by a detected call)
public class PHNJFNKONFF
{
    public long <BMIHFFKLFAP>k__BackingField;    // 0x0x10
    public Guid <PHACAHGGCLA>k__BackingField;    // 0x0x18
    public long <GKEOEAMBCHB>k__BackingField;    // 0x0x28
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x30
    public string <MBFCBEDJLGE>k__BackingField;    // 0x0x38
    public int <GJEMNEBDIAJ>k__BackingField;    // 0x0x40
    public Guid? <AIKDIKHFJIJ>k__BackingField;    // 0x0x44
    public DateTime <GDGKBBHDKCA>k__BackingField;    // 0x0x58
    public string <CODCGFGHFEL>k__BackingField;    // 0x0x60
    public CPGMMDJJHGA <CMLHALBDAPF>k__BackingField;    // 0x0x68
}
...
// PPJHIJPCADL
//   (not directly referenced by a detected call)
public class PPJHIJPCADL
{
    public long <GJEMNEBDIAJ>k__BackingField;    // 0x0x10
    public Guid? <AIMNLJOGEHP>k__BackingField;    // 0x0x18
}
...
public class AddKeepsakeInstanceRequest
{
    public long <GKEOEAMBCHB>k__BackingField;    // 0x0x10
    public long? <FMJECPJAMAN>k__BackingField;    // 0x0x18
    public DGKKLHHODBM <FBOPDMPBCFJ>k__BackingField;    // 0x0x28
}
...
{
    public EDIPFOAEGBB <GHJNCACMNNF>k__BackingField;    // 0x0x10
    public string <ANCOADPCLLK>k__BackingField;    // 0x0x18
    public string <FBLOIBGIHHE>k__BackingField;    // 0x0x20
    public string <MEGLJMKBHLB>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public CDNMCAFDJLC <CurrencyType>k__BackingField;    // 0x0x18
    public HIOJMJMAAJF <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <NAABCEJNMMH>k__BackingField;    // 0x0x10
    public long? <DHCELFBADEE>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public GAMCBODBOLH FilterType;    // 0x0x20
...
{
    public DGKKLHHODBM <GNAMNCAMEKD>k__BackingField;    // 0x0x10
    public string <EKECMOIMIAH>k__BackingField;    // 0x0x18
    public int <OGKJLFMFJNO>k__BackingField;    // 0x0x20
    public int <JMDKKLLHEPA>k__BackingField;    // 0x0x24
    public string <JFDHJIOCEJI>k__BackingField;    // 0x0x28
    public string <EALHFPOOFKE>k__BackingField;    // 0x0x30
}
...
{
    public int <PBDKGKFMFHJ>k__BackingField;    // 0x0x10
    public Guid <HILALDMKJBL>k__BackingField;    // 0x0x14
    public DateTime <BPEBAOGFJOH>k__BackingField;    // 0x0x28
}
...
{
    public bool <FJOMPNJAKGD>k__BackingField;    // 0x0x10
    public int <NGDJJFEDMLL>k__BackingField;    // 0x0x14
    public bool <JCBDHKDFOBJ>k__BackingField;    // 0x0x18
}
...
{
    public Guid <HILALDMKJBL>k__BackingField;    // 0x0x10
    public DGKKLHHODBM <LAOPELLCHCD>k__BackingField;    // 0x0x20
    public int <PNHINAKDELF>k__BackingField;    // 0x0x24
    public long <GKEOEAMBCHB>k__BackingField;    // 0x0x28
    public long? <FMJECPJAMAN>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{oHLBGNEKGCE}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <CFIBFOBJFBN>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <BJIFMPEPCLF>k__BackingField;    // 0x0x18
}
...
{
    public long <CFFNNKCMPDP>k__BackingField;    // 0x0x10
    public long <GKEOEAMBCHB>k__BackingField;    // 0x0x18
    public long <PMNHHNDPJML>k__BackingField;    // 0x0x20
    public FFDEMIDLJBC <CMLHALBDAPF>k__BackingField;    // 0x0x28
    public int <FFNIOENFIBF>k__BackingField;    // 0x0x2C
}
...
{
    public long <GKEOEAMBCHB>k__BackingField;    // 0x0x10
    public List<Guid> <HGNDEGJEBEA>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <CFIBFOBJFBN>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <BJIFMPEPCLF>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <NLMFJCKOMBJ>k__BackingField;    // 0x0x20
}
...
{
    public long <PMNHHNDPJML>k__BackingField;    // 0x0x10
    public long <OFNJMGHFCDE>k__BackingField;    // 0x0x18
    public int? <HLLDJIOAMJI>k__BackingField;    // 0x0x20
    public int? <HIGGIBEGNLD>k__BackingField;    // 0x0x28
    public long? <CNJPLBPAFFG>k__BackingField;    // 0x0x30
    public long <HDKCLJIFNMB>k__BackingField;    // 0x0x40
    public long <CPKIGIFLPKN>k__BackingField;    // 0x0x48
    public int <AMAGPLEDLFN>k__BackingField;    // 0x0x50
    public FFDEMIDLJBC <BPEBEPOJLKG>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <AHPBPEIBNDK>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public IGDCNFGMCEA <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public HFNNEAJJBFG creatorAccountRole;    // 0x0x60
...
{
    public BDOPNHLEDIH <JAODIBLGJPG>k__BackingField;    // 0x0x10
    public NACNJJGFKOJ <HKBBKKGEEPE>k__BackingField;    // 0x0x14
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x18
    public string <MBFCBEDJLGE>k__BackingField;    // 0x0x20
    public bool <BMGFFJAFNDI>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<BDOPNHLEDIH> <NANAJCEIDEK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{cFLJPCHKOGO}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <OFNJMGHFCDE>k__BackingField;    // 0x0x10
    public string <LBDAOPCNDOL>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <LDCGPAHNPFH>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <DAOJGOPKNNO>k__BackingField;    // 0x0x28
    public DateTime <LMOCIMEFAKI>k__BackingField;    // 0x0x30
    public DateTime <EABIFDGGEHF>k__BackingField;    // 0x0x38
    public DateTime <OGLBICLPCCA>k__BackingField;    // 0x0x40
    public bool <DFCLDGAAGOB>k__BackingField;    // 0x0x48
    public int <ADDGOPLHGJK>k__BackingField;    // 0x0x4C
    public float <LHJAEFDMNFN>k__BackingField;    // 0x0x50
    public Guid? <ELAGGMJHMKH>k__BackingField;    // 0x0x54
    public string <MFNDFLAGOPH>k__BackingField;    // 0x0x68
    public string <POAJDOJFHOF>k__BackingField;    // 0x0x70
    public string <HODHHPHDPHP>k__BackingField;    // 0x0x78
    public string <IOMOEDEMOLI>k__BackingField;    // 0x0x80
}
...
{
    public Guid <CPLNAAIFDOK>k__BackingField;    // 0x0x10
    public int <LHPMBAIPMHJ>k__BackingField;    // 0x0x20
    public int <HNCGOBOHJJD>k__BackingField;    // 0x0x24
    public int <CGJPCHHBDNN>k__BackingField;    // 0x0x28
    public long <PEDAGHGDMLP>k__BackingField;    // 0x0x30
    public long <CKOILGCNINI>k__BackingField;    // 0x0x38
}
...
{
    public int <PBDKGKFMFHJ>k__BackingField;    // 0x0x10
    public int <GJIMBOCFPPA>k__BackingField;    // 0x0x14
    public int <BAJMAPNKBHO>k__BackingField;    // 0x0x18
    public int <GLELGHLEGMD>k__BackingField;    // 0x0x1C
    public int <LKLBNCJGHMN>k__BackingField;    // 0x0x20
    public DateTime? <AHDAGHOAIEE>k__BackingField;    // 0x0x28
}
...
{
    public long <ICCBGAKCIJI>k__BackingField;    // 0x0x10
    public int <EPONNLBPMDM>k__BackingField;    // 0x0x18
    public string <CODCGFGHFEL>k__BackingField;    // 0x0x20
    public int <GJIMBOCFPPA>k__BackingField;    // 0x0x28
    public int <HCKNGBPGDGE>k__BackingField;    // 0x0x2C
    public bool <GDIFPNCOKPG>k__BackingField;    // 0x0x30
}
...
public class ReportRequest
{
    ...
    public NEDHOILLBLH ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool KPLKFJKEGGE;    // 0x0x28
}
...
{
    public MKDOBLAHHHP? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [Auth POST]
public class PlayerCheerV1CreateRequest
{
    public MKDOBLAHHHP AIPKBDMPEIL;  // wrapper
...
{
    public PDKGFNPLBAB GKMMCJMINBB;  // wrapper
...
{
    public NJCDDMAOKPG JLAAKHANEHC;  // wrapper
    public int? BOLKLPDINDL;  // wrapper
...
{
    public byte[] JGCMECODHDI;  // wrapper
    public DDHBOMPOCLF KMFCLMDKBKJ;  // wrapper
...
{
    public KFNNFMMEANB HCJNKGMONJF;  // wrapper
    public float? MLIPCMOPLPP;  // wrapper
    public bool? CNBADKIEIOP;  // wrapper
...
{
    public List<EBOIDAOENMM> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public IGDCNFGMCEA EIGKPCONJCB;  // wrapper
    public IGDCNFGMCEA? BDPPGHLJIEF;  // wrapper
...
{
    public ChatMessage KFAOBDLOMDC;  // wrapper
    public BOMAFKAOJAF HCJNKGMONJF;  // wrapper
...
{
    public HMAPOJNAMII NCLEFBNEIPE;  // wrapper
    public NOHMGJBOCIP COIHCJPNGAN;  // wrapper
    public KJOHDOJKOGN HFHAKPOKKPM;  // wrapper
    public KJOHDOJKOGN ALJFICHONEP;  // wrapper
...
{
    public ADGLAHJCPJK CDNKHMNOCIB;  // wrapper
    public IGDCNFGMCEA? EKGBANBFHHL;  // wrapper
...
{
    public DJCAAGBAMLJ DEAGCOCIFEP;  // wrapper
...
{
    public JIMGJOBLFHK inventionId;  // wrapper
}
...
// api/keepsakes/{oIHIGEJBGDG}/collect  [Auth POST]
public class KeepsakesOIHIGEJBGDGCollectRequest
{
    public Guid OIHIGEJBGDG;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public HKGJDENNFGA KEOIKFMHEJA;  // wrapper
    public long? FNKMOIJJLLC;  // wrapper
...
{
    public PACKJBIKNNN ADJGLCJHIHH;  // wrapper
    public PACKJBIKNNN JFBLJKILOPD;  // wrapper
    public HBBAEPBLNMC HFFPAFBHNGM;  // wrapper
}
...
{
    public long? KAEOEGGGCFM;  // wrapper
    public HBBAEPBLNMC HFFPAFBHNGM;  // wrapper
    public long? JBHMIAGEKMF;  // wrapper
}

// api/playerevents/v2/{eventId}/time  [Auth PUT]
public class PlayereventsV2EventIdTimeRequest
{
    public DateTime APGBJJBOFJM;  // wrapper
    public DateTime JGMKAHHJFKO;  // wrapper
    public HBBAEPBLNMC HFFPAFBHNGM;  // wrapper
    public DateTime AFBEPJIHKDP;  // wrapper
    public DateTime OKINHHNAOHL;  // wrapper
}
...
{
    public Guid JPCKBPPBDIM;  // wrapper
...
{
    public Guid FHGBJFJIBOI;  // wrapper
    public object Price;  // candidate
...
{
    public Guid FHGBJFJIBOI;  // wrapper
    public long? KPMPDDAODLM;  // wrapper
    public byte? CICGHDIEJHI;  // wrapper
    public int? FEHNKBJAMFH;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid JPCKBPPBDIM;  // wrapper
    public long? INMHMBCAIHJ;  // wrapper
    public long? MOBOCAMNDBJ;  // wrapper
    public int? NOIFCGELKHC;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> FCDCCFDNJHM;  // wrapper
...
{
    public CPGMMDJJHGA JLAAKHANEHC;  // wrapper
    public Guid? MACHDHDKGIJ;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public KFNNFMMEANB HCJNKGMONJF;  // wrapper
    public long? NHJELPHPMGJ;  // wrapper
    public Guid? MNLAOAAAPCD;  // wrapper
    public int? MJDFNJPLLME;  // wrapper
...
{
    public Guid AIEOGAFCJAF;  // wrapper
...
{
    public Guid MCKFPLHONII;  // wrapper
...
{
    public ILILIBONCEN INLNDCDGPKJ;  // wrapper
}
