...
public class ANOHOKELJOE
{
    public List<string> <HNLFBIGPHOO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BDALFAODINL
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Matchmaking]
public class BDALFAODINL
{
    public Guid <PEMIGFEAHHC>k__BackingField;    // 0x0x10
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x20
    public string <DFLJBJLBKKC>k__BackingField;    // 0x0x28
    public DateTime <DAOGLDJHHGP>k__BackingField;    // 0x0x30
    public DateTime? <JPJNEJEPNDF>k__BackingField;    // 0x0x38
    public List<JKGBMDAEDCF> <FJMEGOEEGAG>k__BackingField;    // 0x0x48
}
...
public class BEBEPHMOCOJ
{
    public ILOOCONMILH <ADDAGMMEGDE>k__BackingField;    // 0x0x10
    public PNEBDPLHGIA <HAADLJJPGOG>k__BackingField;    // 0x0x18
    public int <ADBABJMGOJF>k__BackingField;    // 0x0x20
}
...
public class BFBMGHOHCJP
{
    public OFCCIDKKIAB <FBPMGIMAGFN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BHGFKBKIEIP
//   RESPONSE GET    api/config/v1/azurespeech   [Service.Auth]
public class BHGFKBKIEIP
{
    public bool <GHPCGOBOHME>k__BackingField;    // 0x0x10
    public string <BOBPGIBEDBC>k__BackingField;    // 0x0x18
    public string <DBBCGAJMILD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BJOELMCPAJA
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class BJOELMCPAJA
{
    public Dictionary<Guid, OHNCONDLNEB> <KDJCILJHNKI>k__BackingField;    // 0x0x10
}
...
public class BMLPFJJJBAB
{
    public Guid <CNKLJEKBJOP>k__BackingField;    // 0x0x10
    public long <FDOLCDKAPFH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BOFFKOMLOEF
//   (not directly referenced by a detected call)
public class BOFFKOMLOEF
{
    public BKGFBALKPKI IFODNDJJLBF;    // 0x0x10
    public int NEPGBADFFLG;    // 0x0x14
}
...
public class CAOBBJAFGBM
{
    public string <GOCPNHBLHCM>k__BackingField;    // 0x0x10
    public string <AKPKDEJAOLE>k__BackingField;    // 0x0x18
    public string <DDJBBHOGNNO>k__BackingField;    // 0x0x20
    public string <MBFOLOLHGPD>k__BackingField;    // 0x0x28
    public FHDFHKILGFL <PAHAGHOKJJI>k__BackingField;    // 0x0x30
    public string <OKHKCKHDOJH>k__BackingField;    // 0x0x38
    public bool CKPCGOOOIOM;    // 0x0x40
    public bool <FHAOBLINEIA>k__BackingField;    // 0x0x41
}

// --------------------------------------------------------------------------
// CFPINIKFEII
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.Auth]
public class CFPINIKFEII
{
    public KBDGIJPICHH <LNDEGENONMI>k__BackingField;    // 0x0x10
    public int <MFFBCEHMHMA>k__BackingField;    // 0x0x14
    public long <KNKBMHENLLN>k__BackingField;    // 0x0x18
    public bool <IKIMNMLPGIL>k__BackingField;    // 0x0x20
    public string <AFEPABLOKHK>k__BackingField;    // 0x0x28
    public int? <FBBHGLPEFDE>k__BackingField;    // 0x0x30
    public bool <DPEOFLPJHOI>k__BackingField;    // 0x0x38
    public bool <JIPJOABNNDA>k__BackingField;    // 0x0x39
    public bool <KLBAGNGFCPF>k__BackingField;    // 0x0x3A
    public bool <EDDDEMNIEEB>k__BackingField;    // 0x0x3B
    public string <FIAEKACJCEI>k__BackingField;    // 0x0x40
    public DateTime? <KCLAHPMDFNI>k__BackingField;    // 0x0x48
    public string <KNPFNPIPNAA>k__BackingField;    // 0x0x58
    public float <OMMLECEOOCN>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// CHHDDBONJAO
//   RESPONSE GET    api/inventions/v1/details   [Service.Auth]
public class CHHDDBONJAO
{
    public List<GBMALMJBLMM> <EAKPKMLIJCF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CJGHBAKGNIH
//   (not directly referenced by a detected call)
public class CJGHBAKGNIH
{
    public bool <BELOJAKLDDL>k__BackingField;    // 0x0x10
    public EIELDNFDNCA <GAFPAPAOBAC>k__BackingField;    // 0x0x14
    public int <GPHNLCDHFIN>k__BackingField;    // 0x0x18
    public DateTime <BJHKJBIDPOH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DBABMAEIIHF
//   RESPONSE POST   api/inventions/v1/settags   [Service.Auth]
public class DBABMAEIIHF
{
    public MOLEKHMHCMA <FBPMGIMAGFN>k__BackingField;    // 0x0x10
    public List<string> <EAKPKMLIJCF>k__BackingField;    // 0x0x18
}
...
public class DJBFIPDBLKP
{
    public Guid <PEEGFCGCAIP>k__BackingField;    // 0x0x10
    public int <OOECGGELBKD>k__BackingField;    // 0x0x20
    public long <LCOEFPFCEKA>k__BackingField;    // 0x0x28
    public Guid <CNKLJEKBJOP>k__BackingField;    // 0x0x30
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{gLIBCHOOHBC}   [Service.WWW]
public enum DKCKDIOKOHC
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
public class DLPNCKGGEKG
{
    public List<Guid> <PHFEDPPNNAN>k__BackingField;    // 0x0x10
    public byte <ONINLKOAOJM>k__BackingField;    // 0x0x18
    public int <BAILNFFPNBO>k__BackingField;    // 0x0x1C
}
...
public class DPJGMHAJPMB : KPOIKBOPMCK
{
    public List<GBMALMJBLMM> <EAKPKMLIJCF>k__BackingField;    // 0x0x98
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{pABMNFAOLOC}   [Service.WWW]
public class EBAONOAJILF
{
    public AADLCMMEADB <LFNCBOKMIMD>k__BackingField;    // 0x0x10
    public LOLFOKODLIE <NHKIMJOOHEO>k__BackingField;    // 0x0x18
}
...
public class EEAHGLLCPID
{
    public long <FMKACOCEKBG>k__BackingField;    // 0x0x10
    public int <LBKHLEELAGH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EENBLPOEDMN
//   (not directly referenced by a detected call)
public class EENBLPOEDMN
{
    public int <BIHDJIGCKAM>k__BackingField;    // 0x0x10
    public OFCCIDKKIAB <FBPMGIMAGFN>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// EFGFCGGJDBE
//   (not directly referenced by a detected call)
public class EFGFCGGJDBE
{
    public int <JEFBDPHIBOM>k__BackingField;    // 0x0x10
    public DateTime <KFGLJDIKNGA>k__BackingField;    // 0x0x18
    public DateTime? <FAEJBFPPDHO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EFMCLCHDHEF
//   RESPONSE PUT    api/roomconsumables   [Service.WWW]
public class EFMCLCHDHEF
{
    public AADLCMMEADB <LFNCBOKMIMD>k__BackingField;    // 0x0x10
    public FAFDHKMDHBN <CGMDPCDDEFJ>k__BackingField;    // 0x0x18
}
...
public class EKHBGBGJHKB
{
    public Dictionary<int, int> <CFBCFLMEDII>k__BackingField;    // 0x0x10
    public List<JHDHLCEJDMG> <NMCOCBCKGNA>k__BackingField;    // 0x0x18
    public BOFFKOMLOEF[][] <IDFHHAJDJDD>k__BackingField;    // 0x0x20
    public ODPILELPHGF <CNDBBIKCJPJ>k__BackingField;    // 0x0x28
    public KPLMCOPKBJP <CGLJALGKKCH>k__BackingField;    // 0x0x30
    public PNJKKGJJCNB <LOLEKOBAGJJ>k__BackingField;    // 0x0x38
    public JIOKGOELLEC <EBPLCKBICIC>k__BackingField;    // 0x0x40
    public KOMOHIBDBEM <GFILFHCAEOM>k__BackingField;    // 0x0x48
    public string <JJKCOBFBCOH>k__BackingField;    // 0x0x50
}
...
public class ENEGCHNMOFD
{
    public MBJJPDHDEAN <KMBGMPOABEP>k__BackingField;    // 0x0x10
    public string <NFLIJNGHJAC>k__BackingField;    // 0x0x18
    public string <DDJBBHOGNNO>k__BackingField;    // 0x0x20
    public string <MBFOLOLHGPD>k__BackingField;    // 0x0x28
    public FHDFHKILGFL <PAHAGHOKJJI>k__BackingField;    // 0x0x30
    public string <FHNKDPLBGOM>k__BackingField;    // 0x0x38
    public int <IKIELFEAKAB>k__BackingField;    // 0x0x40
    public bool <EPFJEHMHDHJ>k__BackingField;    // 0x0x44
    public string <LEFLBOBGNAD>k__BackingField;    // 0x0x48
    public DateTime <KFGLJDIKNGA>k__BackingField;    // 0x0x50
}
...
// FAFDHKMDHBN
//   (not directly referenced by a detected call)
public class FAFDHKMDHBN
{
    public Guid <AGKDKEIPEEC>k__BackingField;    // 0x0x10
    public int <LBKHLEELAGH>k__BackingField;    // 0x0x20
    public int <NACFCHDICAG>k__BackingField;    // 0x0x24
    public Guid <COOKJEHJEKB>k__BackingField;    // 0x0x28
    public DateTime <BJHKJBIDPOH>k__BackingField;    // 0x0x38
    public LOLFOKODLIE <NHKIMJOOHEO>k__BackingField;    // 0x0x40
}
...
//   RESPONSE GET    api/storefronts/v1/season/{kLIFONBNCFM}   [Service.WWW]
public class FBAKGPGHNMG : OHHLANOLJPH
{
    public int <KEMHEKBKBDD>k__BackingField;    // 0x0x30
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x38
    public DateTime <DAOGLDJHHGP>k__BackingField;    // 0x0x40
    public DateTime <IONBPFNAOAF>k__BackingField;    // 0x0x48
    public EPPIAEMNOLD <PIKLCLCPNOG>k__BackingField;    // 0x0x50
    public IFPMGACAGJE <POGIHHGOMBK>k__BackingField;    // 0x0x58
    public List<GFMOJCHMHHE> <JHJHGPDOOPJ>k__BackingField;    // 0x0x60
    public CJGHBAKGNIH <LHNHAMDCKKK>k__BackingField;    // 0x0x68
}
...
// GBMALMJBLMM
//   (not directly referenced by a detected call)
public class GBMALMJBLMM
{
    public string <BPHACJKJCAH>k__BackingField;    // 0x0x10
    public EHMGDELFNNN <LPPLDBMDPAO>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/progressionEvents/collect/{nLENNBAEGLP}/{gFHNADHLMEN}   [Service.Auth]
public class GDEMINLBOPE
{
    public long? <DFOGEMHBNPE>k__BackingField;    // 0x0x10
    public int <PEAPOMLHKEF>k__BackingField;    // 0x0x20
    public int? <ICMNPJDMANC>k__BackingField;    // 0x0x24
    public string <HEBHLIPJIMM>k__BackingField;    // 0x0x30
    public MBJJPDHDEAN? <KMBGMPOABEP>k__BackingField;    // 0x0x38
    public string <IIJJBFKCKIG>k__BackingField;    // 0x0x40
    public Guid? <EEIBNFIBLCJ>k__BackingField;    // 0x0x48
    public string <ODKINGBBGDD>k__BackingField;    // 0x0x60
    public string <GLBJINJHEAB>k__BackingField;    // 0x0x68
    public EPPIAEMNOLD <PIKLCLCPNOG>k__BackingField;    // 0x0x70
    public int <EDHIMJPGOMA>k__BackingField;    // 0x0x74
    public int <BGCOKKLNEKM>k__BackingField;    // 0x0x78
    public AKAPKIKGGFB <AIJJDGNCEAM>k__BackingField;    // 0x0x7C
    public FHDFHKILGFL <FAGNHMDKBAA>k__BackingField;    // 0x0x80
    public string <KNJAHIEJHGK>k__BackingField;    // 0x0x88
    public LLDGBEIJNAC <CCKDKOJMAFA>k__BackingField;    // 0x0x90
    public EIELDNFDNCA <PLFFEEGBNII>k__BackingField;    // 0x0x94
    public EDMCJIEOBGG? <BHGPIOCECKE>k__BackingField;    // 0x0x98
    public bool <LOOBJFBKBEE>k__BackingField;    // 0x0xA0
    public bool <LPEAAPGDOLG>k__BackingField;    // 0x0xA1
    public string <GLDDNCDEOJO>k__BackingField;    // 0x0xA8
    public bool <APDAOAMAJNG>k__BackingField;    // 0x0xB0
    public bool KHCKDIPLEHI;    // 0x0xB1
}

// --------------------------------------------------------------------------
// GELHFBHFIJG
//   (not directly referenced by a detected call)
public class GELHFBHFIJG
{
    public long <FMKACOCEKBG>k__BackingField;    // 0x0x10
    public Guid <LMGEHNCDJBH>k__BackingField;    // 0x0x18
    public long <OOPNFIFFPCC>k__BackingField;    // 0x0x28
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x30
    public string <JIAGEDLLDCG>k__BackingField;    // 0x0x38
    public int <PAICGKBMDCF>k__BackingField;    // 0x0x40
    public Guid? <CFCIOJLJAPJ>k__BackingField;    // 0x0x44
    public DateTime <KFGLJDIKNGA>k__BackingField;    // 0x0x58
    public string <DFLJBJLBKKC>k__BackingField;    // 0x0x60
    public HBCPOOBFNPH <LPPLDBMDPAO>k__BackingField;    // 0x0x68
}
...
public class GFBDFMECLDG
{
    public bool <FMDBNMHLJJM>k__BackingField;    // 0x0x10
    public string <AFEPABLOKHK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GFCDLFLGOBG
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.WWW]
public class GFCDLFLGOBG
{
    public List<EFGFCGGJDBE> <FPMNHBPNCAA>k__BackingField;    // 0x0x10
    public string <EFDABCNLFJJ>k__BackingField;    // 0x0x18
}
...
// base   : IFPMGACAGJE
//   (not directly referenced by a detected call)
public class GFMOJCHMHHE : IFPMGACAGJE
{
    public int <HGPAGECHPKO>k__BackingField;    // 0x0x68
    public List<OPCBAEOMBPP> <EEJLBGJEFFM>k__BackingField;    // 0x0x70
    public List<OPCBAEOMBPP> <IFMFNIMGOMM>k__BackingField;    // 0x0x78
    public List<OPCBAEOMBPP> <CJMODMIJGMK>k__BackingField;    // 0x0x80
}
...
// HEEPBLLHGLF
//   (not directly referenced by a detected call)
public class HEEPBLLHGLF
{
    public EPPIAEMNOLD <PIKLCLCPNOG>k__BackingField;    // 0x0x10
    public int <PAICGKBMDCF>k__BackingField;    // 0x0x14
    public PBJMKKBFEPJ <OLEBKNLJCEK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HJBFGBDOBDA
//   (not directly referenced by a detected call)
public class HJBFGBDOBDA
{
    public long <CPAFDPICBEP>k__BackingField;    // 0x0x10
    public Guid <EEIBNFIBLCJ>k__BackingField;    // 0x0x18
    public Guid <JICEEAMFHEL>k__BackingField;    // 0x0x28
    public DateTime <KFGLJDIKNGA>k__BackingField;    // 0x0x38
    public string <IJNFOKKGFJD>k__BackingField;    // 0x0x40
    public string <LAFKLCJKAGL>k__BackingField;    // 0x0x48
    public int <AIKGMLGKBED>k__BackingField;    // 0x0x50
    public string <MCOPNMAGMAF>k__BackingField;    // 0x0x58
    public string <PPMMHAJFHOB>k__BackingField;    // 0x0x60
    public string <PKMHDDGLBFJ>k__BackingField;    // 0x0x68
    public string <KLNACCHIIJG>k__BackingField;    // 0x0x70
    public int <KEKPEAIHKNJ>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// HJOCGFKOFIM
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.Auth]
public class HJOCGFKOFIM
{
    public string <DFOGEMHBNPE>k__BackingField;    // 0x0x10
    public string <BOBPGIBEDBC>k__BackingField;    // 0x0x18
    public string <GPCCKCNKKCF>k__BackingField;    // 0x0x20
    public string <JIAGEDLLDCG>k__BackingField;    // 0x0x28
    public string <NKJLBOKJPEL>k__BackingField;    // 0x0x30
    public BDJCFNAJDHK <LFNCBOKMIMD>k__BackingField;    // 0x0x38
    public List<string> <DJMIFBBIJJE>k__BackingField;    // 0x0x40
    public List<string> <EAKPKMLIJCF>k__BackingField;    // 0x0x48
    public string <ODLHHCFHFCB>k__BackingField;    // 0x0x50
    public List<LOPMJBIJMGC> <CLIEJBBDLKL>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// HPJOODDBKEN
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.Auth]
public class HPJOODDBKEN
{
    public List<EENBLPOEDMN> <JFKFELOCPEM>k__BackingField;    // 0x0x10
    public OFCCIDKKIAB <FBPMGIMAGFN>k__BackingField;    // 0x0x18
}
...
public class IBNOJKJBAND : BIMKHLOBFHD
{
    public FLKFAAKFCLL? <JHLPIIDCEDG>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <FKGEDBIBEDF>k__BackingField;    // 0x0x20
}
...
// IENJLGACMAC
//   (not directly referenced by a detected call)
public class IENJLGACMAC
{
    public long <JGLGBCNCLLH>k__BackingField;    // 0x0x10
    public long <FGJIEPKBAPJ>k__BackingField;    // 0x0x18
    public int <PEAPOMLHKEF>k__BackingField;    // 0x0x20
    public DateTime <KFGLJDIKNGA>k__BackingField;    // 0x0x28
    public IBKMFDMPPHH <LPPLDBMDPAO>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// IFPMGACAGJE
//   (not directly referenced by a detected call)
public class IFPMGACAGJE
{
    public int <PCJPKCCNLPB>k__BackingField;    // 0x0x10
    public OGFKBIKHNBP <LPPLDBMDPAO>k__BackingField;    // 0x0x14
    public List<HEEPBLLHGLF> <GPBLCCACIHG>k__BackingField;    // 0x0x18
    public List<HEEPBLLHGLF> <PCHPGEPEILJ>k__BackingField;    // 0x0x20
    public bool <BBGNGDGAKCG>k__BackingField;    // 0x0x28
    public DateTime? <KAGMHIAEFFJ>k__BackingField;    // 0x0x30
    public DateTime? <OEILNLOODPM>k__BackingField;    // 0x0x40
    public DateTime? <EDDFBJODKCJ>k__BackingField;    // 0x0x50
    public bool <IANHLKEAGFK>k__BackingField;    // 0x0x60
    public bool <IDIANEGDDKK>k__BackingField;    // 0x0x61
}

// --------------------------------------------------------------------------
// ILOOCONMILH
//   REQUEST  PUT    api/roomconsumables   [Service.WWW]
public class ILOOCONMILH
{
    public Guid? <NAJGHNJHIIM>k__BackingField;    // 0x0x10
    public Guid <NEBLFBOMKLK>k__BackingField;    // 0x0x24
}
...
public class JAFKBBOPNDA
{
    public DKCKDIOKOHC <LFNCBOKMIMD>k__BackingField;    // 0x0x10
    public GELHFBHFIJG <MPCFMPFNCAN>k__BackingField;    // 0x0x18
}
...
public class JAJAOGGJDEK
{
    public List<string> <JMJPOMBMMNI>k__BackingField;    // 0x0x10
    public List<string> <NBMNOEMGLLN>k__BackingField;    // 0x0x18
    public List<string> <GJAJEGHIFAK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JIOKGOELLEC
//   (not directly referenced by a detected call)
public class JIOKGOELLEC
{
    public int <PHBFLHCKMJL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JKGBMDAEDCF
//   (not directly referenced by a detected call)
public class JKGBMDAEDCF
{
    public Guid <JOKGCLAGEEM>k__BackingField;    // 0x0x10
    public Guid <DDHDJOHMHGD>k__BackingField;    // 0x0x20
    public DateTime <DAOGLDJHHGP>k__BackingField;    // 0x0x30
    public List<OCLIENKADOO> <HPCNKGLFNEN>k__BackingField;    // 0x0x38
}
...
public class JLJOBIOKALJ
{
    public long <OOPNFIFFPCC>k__BackingField;    // 0x0x10
    public long? <NKPAFHDPIJD>k__BackingField;    // 0x0x18
    public long? <KNFCMIDGGNP>k__BackingField;    // 0x0x28
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x38
    public string <JIAGEDLLDCG>k__BackingField;    // 0x0x40
    public List<string> <EAKPKMLIJCF>k__BackingField;    // 0x0x48
    public string <DFLJBJLBKKC>k__BackingField;    // 0x0x50
    public DateTime <KEGGDNJOAIP>k__BackingField;    // 0x0x58
    public DateTime <LAPLMEBBKEH>k__BackingField;    // 0x0x60
    public BDBNOEEGLHH <BBAIKDAPMBJ>k__BackingField;    // 0x0x68
    public bool <CAJMPFMCLOP>k__BackingField;    // 0x0x6C
    public bool <LJNJOMBBJON>k__BackingField;    // 0x0x6D
    public BDPPBMNMGAF <ONDKLLBNAPI>k__BackingField;    // 0x0x70
    public BDPPBMNMGAF <NNBLODMCEBN>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// JNLLAFJNGDO
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.WWW]
public class JNLLAFJNGDO
{
    public int <MFFBCEHMHMA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JPFPBBCBMPK
//   RESPONSE GET    api/config/v1/backtrace   [Service.Auth]
public class JPFPBBCBMPK
{
    public int <PNPBNHJMDOM>k__BackingField;    // 0x0x10
    public int <LHGNOHJOMON>k__BackingField;    // 0x0x14
    public float <DOBBCBFEDOE>k__BackingField;    // 0x0x18
    public int <EOGHJDMFACD>k__BackingField;    // 0x0x1C
    public int <JAPFFIJACCI>k__BackingField;    // 0x0x20
    public int <BFAJKKPONLD>k__BackingField;    // 0x0x24
    public int <JKHKEAOGJDP>k__BackingField;    // 0x0x28
    public string <DDLEEEEAFGO>k__BackingField;    // 0x0x30
    public string <BLHDPIFNFJE>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// KLJIFGNECFI
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.WWW]
public class KLJIFGNECFI
{
    public int <LBKHLEELAGH>k__BackingField;    // 0x0x10
    public Guid <PEEGFCGCAIP>k__BackingField;    // 0x0x14
    public long <NNFFMJFKOGA>k__BackingField;    // 0x0x28
    public DateTime <BJHKJBIDPOH>k__BackingField;    // 0x0x30
}
...
public class KMELPCBPIAD
{
    public int <LELNAFLHLPH>k__BackingField;    // 0x0x10
    public int <DPCEFHDDHDF>k__BackingField;    // 0x0x14
    public float <HAKLMCCIAOM>k__BackingField;    // 0x0x18
    public float <FCNODJPFPMD>k__BackingField;    // 0x0x1C
    public bool <IGJCLHLEFHC>k__BackingField;    // 0x0x20
    public bool <IFMKBLBAECF>k__BackingField;    // 0x0x21
    public bool <FHAOBLINEIA>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// KMKEIEIPGBP
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.Auth]
public class KMKEIEIPGBP
{
    public List<long> <CBGGBOAOFKA>k__BackingField;    // 0x0x10
    public CDFIOHFOHPE <LPPLDBMDPAO>k__BackingField;    // 0x0x18
    public string <BBECBOBLFFL>k__BackingField;    // 0x0x20
    public long? <OOPNFIFFPCC>k__BackingField;    // 0x0x28
}
...
public class KNHGBGPOAAE
{
    public List<KPOIKBOPMCK> <ANPFBDJBBNK>k__BackingField;    // 0x0x10
    public string <EFDABCNLFJJ>k__BackingField;    // 0x0x18
}
...
// KOMOHIBDBEM
//   (not directly referenced by a detected call)
public class KOMOHIBDBEM
{
    public float <CJJPMLGHGCP>k__BackingField;    // 0x0x10
}
...
public class KPCDKDDPGKN
{
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x10
    public string <JIAGEDLLDCG>k__BackingField;    // 0x0x18
    public int? <PAICGKBMDCF>k__BackingField;    // 0x0x20
    public PAEOCALEFHE? <BBAIKDAPMBJ>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// KPLMCOPKBJP
//   (not directly referenced by a detected call)
public class KPLMCOPKBJP
{
    public float <KAJNFIMCHGL>k__BackingField;    // 0x0x10
    public float <AOLEMPMFMIA>k__BackingField;    // 0x0x14
    public float <AHHNBBMNAIL>k__BackingField;    // 0x0x18
    public float <PGCDJKCMNHO>k__BackingField;    // 0x0x1C
    public float <FMBMBOOJENO>k__BackingField;    // 0x0x20
    public float <HGMICOIJNAP>k__BackingField;    // 0x0x24
    public float <BFDACOMMCID>k__BackingField;    // 0x0x28
    public float <NENMHLGMHLE>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// KPOIKBOPMCK
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class KPOIKBOPMCK
{
    public long <FGJIEPKBAPJ>k__BackingField;    // 0x0x10
    public int <ALDBJLCPOFG>k__BackingField;    // 0x0x18
    public long <OOPNFIFFPCC>k__BackingField;    // 0x0x20
    public long? <NKPAFHDPIJD>k__BackingField;    // 0x0x28
    public long? <KNFCMIDGGNP>k__BackingField;    // 0x0x38
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x48
    public string <JIAGEDLLDCG>k__BackingField;    // 0x0x50
    public string <DFLJBJLBKKC>k__BackingField;    // 0x0x58
    public DateTime <KEGGDNJOAIP>k__BackingField;    // 0x0x60
    public DateTime <LAPLMEBBKEH>k__BackingField;    // 0x0x68
    public int <IEPKKMNNNEA>k__BackingField;    // 0x0x70
    public BDBNOEEGLHH <BBAIKDAPMBJ>k__BackingField;    // 0x0x74
    public bool <CAJMPFMCLOP>k__BackingField;    // 0x0x78
    public bool <LJNJOMBBJON>k__BackingField;    // 0x0x79
    public BDPPBMNMGAF <ONDKLLBNAPI>k__BackingField;    // 0x0x7C
    public BDPPBMNMGAF <NNBLODMCEBN>k__BackingField;    // 0x0x80
    public long? <FPNAHCGFKBK>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// LKFFGOMPJKG
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{oHDIEJAHBDF}/{aAIGMPGAION}   [Service.WWW]
public class LKFFGOMPJKG
{
    public EPPIAEMNOLD <PIKLCLCPNOG>k__BackingField;    // 0x0x10
    public AKJFKFBNPFG <JJLFAGODCDH>k__BackingField;    // 0x0x14
    public int <MOCAKPDOBMJ>k__BackingField;    // 0x0x18
    public int <EKIFMKGPDMB>k__BackingField;    // 0x0x1C
    public int <BJPJHHPHOCH>k__BackingField;    // 0x0x20
    public DGMLKKKENMJ <BDGBFJIGEBP>k__BackingField;    // 0x0x24
    public bool <JLEEIPMCDAJ>k__BackingField;    // 0x0x28
    public float <DHCNNKEDJAM>k__BackingField;    // 0x0x2C
    public int <GNEAEOLMIJB>k__BackingField;    // 0x0x30
    public bool <CDIICIACJAD>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// LKFMNEFDBHK
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class LKFMNEFDBHK
{
    public Dictionary<Guid, EFMCLCHDHEF> <OMDHAMINBKD>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{nMPFPMNJMLM}/appeal   [Service.Auth]
...
//   RESPONSE DELETE api/keepsakes/{pLOIFBAPGKK}   [Service.Auth]
...
public class LLJDCDJIOJL
{
    public bool <FMDBNMHLJJM>k__BackingField;    // 0x0x10
    public string <IHENMHNFMME>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LOLFOKODLIE
//   (not directly referenced by a detected call)
public class LOLFOKODLIE
{
    public Guid <AGKDKEIPEEC>k__BackingField;    // 0x0x10
    public long <OOPNFIFFPCC>k__BackingField;    // 0x0x20
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x28
    public string <JIAGEDLLDCG>k__BackingField;    // 0x0x30
    public string <DFLJBJLBKKC>k__BackingField;    // 0x0x38
    public long <PAICGKBMDCF>k__BackingField;    // 0x0x40
    public Guid? <CFCIOJLJAPJ>k__BackingField;    // 0x0x48
    public DateTime <BJHKJBIDPOH>k__BackingField;    // 0x0x60
    public int <EBABIPCOBNH>k__BackingField;    // 0x0x68
}
...
public class LONNDLIFOLK
{
    public HDIOHNBDHMG <LNDEGENONMI>k__BackingField;    // 0x0x10
    public string <CGECADLIDFN>k__BackingField;    // 0x0x18
    public int? <HBNJEHBBHCJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LOPMJBIJMGC
//   (not directly referenced by a detected call)
public class LOPMJBIJMGC
{
    public DateTime <KFGLJDIKNGA>k__BackingField;    // 0x0x10
    public string <GCFELNADNCM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MBEDPJKFGAP
//   (not directly referenced by a detected call)
public class MBEDPJKFGAP
{
    public KPOIKBOPMCK <FLLGJHBMAAJ>k__BackingField;    // 0x0x10
    public IENJLGACMAC <IPPOBGGPJPI>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/playerevents/v1/all/{hNGJMJOMBCE}   [Service.Auth]
public class MBPBPLCBJEE
{
    public List<KPOIKBOPMCK> <MOLFPNLMIOB>k__BackingField;    // 0x0x10
    public List<MBEDPJKFGAP> <ALMIOJPJMHO>k__BackingField;    // 0x0x18
}
...
public class MCHAFFEEJNM : BIMKHLOBFHD
{
    public IDLPLHCCJFP? <JHLPIIDCEDG>k__BackingField;    // 0x0x18
    public KLJIFGNECFI <LOCIMBOCPOL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MKICMGDLNCE
//   REQUEST  POST   api/playerevents/v1/report   [Service.Auth]
public class MKICMGDLNCE
{
    public KBDGIJPICHH <LNDEGENONMI>k__BackingField;    // 0x0x10
    public long <FGJIEPKBAPJ>k__BackingField;    // 0x0x18
    public string <CGECADLIDFN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MLCFIPEPLJA
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.Auth]
public class MLCFIPEPLJA
{
    public int? <BGJHCIGCJKC>k__BackingField;    // 0x0x10
    public string <NKJLBOKJPEL>k__BackingField;    // 0x0x18
    public string <NIMHKJJPGEC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MNHBINFELMO
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.Auth]
public class MNHBINFELMO
{
    public int <AGCOOJIDECN>k__BackingField;    // 0x0x10
    public int? <GAEGMGKEKGH>k__BackingField;    // 0x0x14
    public string <EKCCNHEKMOK>k__BackingField;    // 0x0x20
    public string <APJMCKGDHLD>k__BackingField;    // 0x0x28
}
...
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{hDCHKIOFILD}   [Service.Auth]
public class NKAOMKLJAOE
{
    public uint <DFOGEMHBNPE>k__BackingField;    // 0x0x10
    public uint? <CBDKGMJAGNJ>k__BackingField;    // 0x0x14
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x20
    public string <JIAGEDLLDCG>k__BackingField;    // 0x0x28
    public DateTime <FNFAGMIKKDP>k__BackingField;    // 0x0x30
    public DateTime? <DONJCNHJCNA>k__BackingField;    // 0x0x38
    public bool <EKPGAFCACFJ>k__BackingField;    // 0x0x48
    public List<HJOCGFKOFIM> <GLFKCBPFNOJ>k__BackingField;    // 0x0x50
    public List<string> <EAKPKMLIJCF>k__BackingField;    // 0x0x58
    public int <KADJPLDDJHI>k__BackingField;    // 0x0x60
    public int <DCELAKOKBAB>k__BackingField;    // 0x0x64
    public int <BDDEKBJJDBA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// NOJIKKMDNEL
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.WWW]
public class NOJIKKMDNEL
{
    public Guid? <AGKDKEIPEEC>k__BackingField;    // 0x0x10
    public long? <OOPNFIFFPCC>k__BackingField;    // 0x0x28
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x38
    public string <JIAGEDLLDCG>k__BackingField;    // 0x0x40
    public string <DFLJBJLBKKC>k__BackingField;    // 0x0x48
    public PNEBDPLHGIA <IDAIAJCKMEP>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// NOKBJOMKBJC
//   RESPONSE ?      api/customAvatarItems/GetCustomAvatarItemCurrentSavesForCustomAvatarItemIds/v2   [Service.Auth]
public class NOKBJOMKBJC
{
    public Dictionary<Guid, List<HJBFGBDOBDA>> <BBKGADLJPOP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OBBPNPONCGH
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.WWW]
public class OBBPNPONCGH
{
    public long <OOPNFIFFPCC>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <GMFFBOCFJIB>k__BackingField;    // 0x0x18
    public AFDHCDFLHOK <BBKAHHHLAGO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OCLIENKADOO
//   (not directly referenced by a detected call)
public class OCLIENKADOO
{
    public int <MAJMCKOOCPD>k__BackingField;    // 0x0x10
    public string <DDJBBHOGNNO>k__BackingField;    // 0x0x18
    public string <MBFOLOLHGPD>k__BackingField;    // 0x0x20
    public string <FHNKDPLBGOM>k__BackingField;    // 0x0x28
    public string <HEBHLIPJIMM>k__BackingField;    // 0x0x30
    public string <IIJJBFKCKIG>k__BackingField;    // 0x0x38
    public Guid? <EEIBNFIBLCJ>k__BackingField;    // 0x0x40
    public MBJJPDHDEAN? <KMBGMPOABEP>k__BackingField;    // 0x0x54
    public string <ODKINGBBGDD>k__BackingField;    // 0x0x60
    public string <GLBJINJHEAB>k__BackingField;    // 0x0x68
    public bool <NNNINEMJPEN>k__BackingField;    // 0x0x70
    public bool <OBBNIKLIPIN>k__BackingField;    // 0x0x71
    public bool <FKDHIEJHHGF>k__BackingField;    // 0x0x72
    public FHDFHKILGFL <PAHAGHOKJJI>k__BackingField;    // 0x0x74
    public EPPIAEMNOLD <PIKLCLCPNOG>k__BackingField;    // 0x0x78
    public int <EDHIMJPGOMA>k__BackingField;    // 0x0x7C
    public PNEPILPDPOB <GOOBCNBHIDA>k__BackingField;    // 0x0x80
    public AKAPKIKGGFB <MNNBLADAPBJ>k__BackingField;    // 0x0x84
    public int? <HDBCPACIBHC>k__BackingField;    // 0x0x88
    public string <HJHHPDMDNMM>k__BackingField;    // 0x0x90
    public int? <IKIELFEAKAB>k__BackingField;    // 0x0x98
    public int? <OBGIKMDMMDI>k__BackingField;    // 0x0xA0
    public string <OKHKCKHDOJH>k__BackingField;    // 0x0xA8
}

// --------------------------------------------------------------------------
// ODIBNMEEEIB
//   REQUEST  POST   api/playerevents/v1/respond   [Service.Auth]
public class ODIBNMEEEIB
{
    public long <FGJIEPKBAPJ>k__BackingField;    // 0x0x10
    public IBKMFDMPPHH <LPPLDBMDPAO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ODPILELPHGF
//   (not directly referenced by a detected call)
public class ODPILELPHGF
{
    public int <PEEIFNPHAPO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OEOHDJLEIKC
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.WWW]
public class OEOHDJLEIKC
{
    public List<int> <CJBGPEGCBMO>k__BackingField;    // 0x0x10
    public string <EFDABCNLFJJ>k__BackingField;    // 0x0x18
}
...
// OHNCONDLNEB
//   (not directly referenced by a detected call)
public class OHNCONDLNEB
{
    public int <ADBABJMGOJF>k__BackingField;    // 0x0x10
    public ILOOCONMILH <ADDAGMMEGDE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OLDDPBCHKPD
// base   : ONLKKBEOHLD`1<BHLBEAHKJIJ>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{aDNLINMDLDP}   [Service.Auth]
public class OLDDPBCHKPD
{
    // (no instance fields in the metadata dump)
}
...
public class OOKODMCFMEB
{
    public int JDAAOJECPNI;    // 0x0x10
    public long EIFNOJAFDKI;    // 0x0x18
}

// --------------------------------------------------------------------------
// OPCBAEOMBPP
//   (not directly referenced by a detected call)
public class OPCBAEOMBPP
{
    public bool <CLBPNPPKPDL>k__BackingField;    // 0x0x10
    public OCLIENKADOO <FEHCBGLGPFK>k__BackingField;    // 0x0x18
    public float <FGIAEDDFIGM>k__BackingField;    // 0x0x20
}
...
// PBJMKKBFEPJ
//   (not directly referenced by a detected call)
public class PBJMKKBFEPJ
{
    public int <HFMCKFFDMJN>k__BackingField;    // 0x0x10
    public DateTime? <KFMOCEOIIGA>k__BackingField;    // 0x0x18
    public DateTime? <KFCDBICDHDH>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// PFBCBIGOLCE
// base   : ONLKKBEOHLD`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class PFBCBIGOLCE
{
    // (no instance fields in the metadata dump)
}
...
public class PHKJGAAPPAM
{
    public DPJGMHAJPMB <FLLGJHBMAAJ>k__BackingField;    // 0x0x10
    public OFCCIDKKIAB <FBPMGIMAGFN>k__BackingField;    // 0x0x18
    public DBABMAEIIHF <FINICJEBNJG>k__BackingField;    // 0x0x20
}
...
public class PKMCBBDBLOK
{
    public int <DPCEFHDDHDF>k__BackingField;    // 0x0x10
    public bool <IGJCLHLEFHC>k__BackingField;    // 0x0x14
    public DateTime <NIMLINPFGKF>k__BackingField;    // 0x0x18
    public bool <HFHCDJNANJO>k__BackingField;    // 0x0x20
}
...
public class PLIDMNOLHOK
{
    public int <JEEFCAMALIF>k__BackingField;    // 0x0x10
    public BPNDKOFNPCJ <LPPLDBMDPAO>k__BackingField;    // 0x0x14
    public FGDJIICLOEB <BEGMALFKPNN>k__BackingField;    // 0x0x18
    public FGDJIICLOEB <MOMENPLFGCE>k__BackingField;    // 0x0x1C
    public FGDJIICLOEB <EADCJAPIMEC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PNEBDPLHGIA
//   (not directly referenced by a detected call)
public class PNEBDPLHGIA
{
    public long <PAICGKBMDCF>k__BackingField;    // 0x0x10
    public Guid? <PEEGFCGCAIP>k__BackingField;    // 0x0x18
}
...
// PNJKKGJJCNB
//   (not directly referenced by a detected call)
public class PNJKKGJJCNB
{
    public int <IJHEIDEIELH>k__BackingField;    // 0x0x10
}
...
public class AddKeepsakeInstanceRequest
{
    public long <OOPNFIFFPCC>k__BackingField;    // 0x0x10
    public long? <NKPAFHDPIJD>k__BackingField;    // 0x0x18
    public MKNCOJELGGF <KELOCPJHHHP>k__BackingField;    // 0x0x28
}
...
{
    public HLPBKGPOLFC <FBPMGIMAGFN>k__BackingField;    // 0x0x10
    public string <DAEPDKEOGBK>k__BackingField;    // 0x0x18
    public string <BHGKLGMADKH>k__BackingField;    // 0x0x20
    public string <KNOGHECOFGN>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public EPPIAEMNOLD <CurrencyType>k__BackingField;    // 0x0x18
    public EDMCJIEOBGG <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <FGJIEPKBAPJ>k__BackingField;    // 0x0x10
    public long? <FOIDICLONNP>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public JLKKKNIFAOG FilterType;    // 0x0x20
...
{
    public MKNCOJELGGF <KBGMLNJAKBE>k__BackingField;    // 0x0x10
    public string <GBBGBNAIPPF>k__BackingField;    // 0x0x18
    public int <KKLDMHJDCAB>k__BackingField;    // 0x0x20
    public int <ICIKIHBAEKM>k__BackingField;    // 0x0x24
    public string <LNCADNELKDN>k__BackingField;    // 0x0x28
    public string <ENMKKBMIGDH>k__BackingField;    // 0x0x30
}
...
{
    public int <LBKHLEELAGH>k__BackingField;    // 0x0x10
    public Guid <DKHICIHLHOA>k__BackingField;    // 0x0x14
    public DateTime <GFMHAGKLJNE>k__BackingField;    // 0x0x28
}
...
{
    public bool <HNOMAEJEFJE>k__BackingField;    // 0x0x10
    public int <CKJCBCGLCEN>k__BackingField;    // 0x0x14
    public bool <GOJKDLAHDDF>k__BackingField;    // 0x0x18
}
...
{
    public Guid <DKHICIHLHOA>k__BackingField;    // 0x0x10
    public MKNCOJELGGF <CPMFPIMICFJ>k__BackingField;    // 0x0x20
    public int <DGAAJJAIJGL>k__BackingField;    // 0x0x24
    public long <OOPNFIFFPCC>k__BackingField;    // 0x0x28
    public long? <NKPAFHDPIJD>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{lJJDPDIPAJJ}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <HJDGAJJJEAL>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <CDHDHOPDHJI>k__BackingField;    // 0x0x18
}
...
{
    public long <BLBEHLGMCLB>k__BackingField;    // 0x0x10
    public long <OOPNFIFFPCC>k__BackingField;    // 0x0x18
    public long <BLAHAFBOKJL>k__BackingField;    // 0x0x20
    public PNFHBDNFEPP <LPPLDBMDPAO>k__BackingField;    // 0x0x28
    public int <BFANLIFHHJF>k__BackingField;    // 0x0x2C
}
...
{
    public long <OOPNFIFFPCC>k__BackingField;    // 0x0x10
    public List<Guid> <CJBKJMJOOBE>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <HJDGAJJJEAL>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <CDHDHOPDHJI>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <CBPFNPMKDAE>k__BackingField;    // 0x0x20
}
...
{
    public long <BLAHAFBOKJL>k__BackingField;    // 0x0x10
    public long <CIMLGIFAFEE>k__BackingField;    // 0x0x18
    public int? <GINFMNFDJGA>k__BackingField;    // 0x0x20
    public int? <KKEAPAPAGBK>k__BackingField;    // 0x0x28
    public long? <GKAPMPIKBJE>k__BackingField;    // 0x0x30
    public long <APEBOCAEKLP>k__BackingField;    // 0x0x40
    public long <OBDKMNPEBGJ>k__BackingField;    // 0x0x48
    public int <FLOCGMHIHLJ>k__BackingField;    // 0x0x50
    public PNFHBDNFEPP <NGHBHKNAPLK>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <OKFABFJPGDO>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public AKAPKIKGGFB <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public NBJBDKMDDDH creatorAccountRole;    // 0x0x60
...
{
    public AINCINBNMKE <KPCFMAOKGNO>k__BackingField;    // 0x0x10
    public FJCPJPKBIOI <BBHCFIBMCJI>k__BackingField;    // 0x0x14
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x18
    public string <JIAGEDLLDCG>k__BackingField;    // 0x0x20
    public bool <CFKKPEGAHNN>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<AINCINBNMKE> <LIIDEECPCOJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{nLENNBAEGLP}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <CIMLGIFAFEE>k__BackingField;    // 0x0x10
    public string <JNJOAADPPKC>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <CJMODMIJGMK>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <LPPKGIDCOLJ>k__BackingField;    // 0x0x28
    public DateTime <KEGGDNJOAIP>k__BackingField;    // 0x0x30
    public DateTime <LAPLMEBBKEH>k__BackingField;    // 0x0x38
    public DateTime <KGECBBJBDGK>k__BackingField;    // 0x0x40
    public bool <PHPKEMAEGGM>k__BackingField;    // 0x0x48
    public int <PLBLMIFGIEA>k__BackingField;    // 0x0x4C
    public float <LBJFIIFCLKL>k__BackingField;    // 0x0x50
    public Guid? <APDPAGNAKGB>k__BackingField;    // 0x0x54
    public string <NNLALGLALJP>k__BackingField;    // 0x0x68
    public string <OGEJNOOMEAC>k__BackingField;    // 0x0x70
    public string <KNINDGJBCGO>k__BackingField;    // 0x0x78
    public string <NKOLNGDJJEL>k__BackingField;    // 0x0x80
}
...
{
    public Guid <KPLMNLDLAKG>k__BackingField;    // 0x0x10
    public int <AAPDBPJMEPI>k__BackingField;    // 0x0x20
    public int <KMLFMHILFAF>k__BackingField;    // 0x0x24
    public int <LBHMJEMDLKC>k__BackingField;    // 0x0x28
    public long <FJBGPCPIEBD>k__BackingField;    // 0x0x30
    public long <POFOMGKCPEE>k__BackingField;    // 0x0x38
}
...
{
    public int <LBKHLEELAGH>k__BackingField;    // 0x0x10
    public int <BGCOKKLNEKM>k__BackingField;    // 0x0x14
    public int <FJHFJAJAMHB>k__BackingField;    // 0x0x18
    public int <HOAJJCAHCFB>k__BackingField;    // 0x0x1C
    public int <PJIAMBDNEPE>k__BackingField;    // 0x0x20
    public DateTime? <IOOHIDJONHH>k__BackingField;    // 0x0x28
}
...
{
    public long <GHKIIPGONEF>k__BackingField;    // 0x0x10
    public int <MAJMCKOOCPD>k__BackingField;    // 0x0x18
    public string <DFLJBJLBKKC>k__BackingField;    // 0x0x20
    public int <BGCOKKLNEKM>k__BackingField;    // 0x0x28
    public int <ANCMADKKPPI>k__BackingField;    // 0x0x2C
    public bool <PMIHMHLJLNP>k__BackingField;    // 0x0x30
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public ILANOKOJJBK <Permission>k__BackingField;    // 0x0x18
    public PAEOCALEFHE <Accessibility>k__BackingField;    // 0x0x1C
...
public class ReportRequest
{
    ...
    public CMKFOEILIPM ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool HEDNFAAJBHD;    // 0x0x28
}
...
{
    public GLOCHBJBLPH? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [Auth POST]
public class PlayerCheerV1CreateRequest
{
    public GLOCHBJBLPH NFBAKOIAJLK;  // wrapper
...
{
    public LLDGBEIJNAC CCDJBEJDLAC;  // wrapper
...
{
    public CEFFDJCIDHB EKNPHEPNHJD;  // wrapper
    public int? GMBFKJOAACO;  // wrapper
...
{
    public byte[] EIFGKHNPLEK;  // wrapper
    public GBNPBHELFGI CALGECDDEFH;  // wrapper
...
{
    public KBDGIJPICHH GMNACBANEGJ;  // wrapper
    public float? ACMHLJNFEFC;  // wrapper
    public bool? PLDGAOEFGOO;  // wrapper
...
{
    public List<MMGKCPFJLPI> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public AKAPKIKGGFB EPLPPJHJIIM;  // wrapper
    public AKAPKIKGGFB? DLOLGDGBIHD;  // wrapper
...
{
    public ChatMessage NFKMLKNHFEM;  // wrapper
    public LIHCAHHMKLI GMNACBANEGJ;  // wrapper
...
{
    public PAEOCALEFHE IFBJNMEBEEF;  // wrapper
    public DAPNMLJACLN MLBANAMAOFB;  // wrapper
    public CBIJFDJHHPD EPHNOHHNPLK;  // wrapper
    public CBIJFDJHHPD LNEPPDFACHK;  // wrapper
...
// api/customAvatarItems/v1/{nMPFPMNJMLM}/appeal  [Auth POST]
public class CustomAvatarItemsV1NMPFPMNJMLMAppealRequest
{
    public Guid NMPFPMNJMLM;  // wrapper
}
...
{
    public BPIHEDBBIOI LFKLOJNPINC;  // wrapper
    public AKAPKIKGGFB? OILLBAEFFED;  // wrapper
...
{
    public LNEBEOPCMBO JAKJNHEPBJG;  // wrapper
...
// api/keepsakes/{pLOIFBAPGKK}/collect  [Auth POST]
public class KeepsakesPLOIFBAPGKKCollectRequest
{
    public Guid PLOIFBAPGKK;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public CDFIOHFOHPE DAAKHAEFHFI;  // wrapper
    public long? HLKBDGNJMKK;  // wrapper
...
{
    public KPOIKBOPMCK IJFMDJLIHBO;  // wrapper
    public BDBNOEEGLHH HNGDBPJJDMA;  // wrapper
    public BDBNOEEGLHH IFBJNMEBEEF;  // wrapper
}
...
{
    public KPOIKBOPMCK IJFMDJLIHBO;  // wrapper
    public long? LAJNHDDDECC;  // wrapper
    public long? CMOJEKONIHO;  // wrapper
}
...
{
    public KPOIKBOPMCK IJFMDJLIHBO;  // wrapper
    public BDPPBMNMGAF FNFIMAAAJII;  // wrapper
    public BDPPBMNMGAF GHENHLOIEJP;  // wrapper
}
...
{
    public KPOIKBOPMCK IJFMDJLIHBO;  // wrapper
    public long? OHKODNNCCKK;  // wrapper
    public long? FDCMMJDIOAB;  // wrapper
}
...
{
    public KPOIKBOPMCK IJFMDJLIHBO;  // wrapper
    public DateTime FCFHKJMPJPE;  // wrapper
    public DateTime IDMEGGHDION;  // wrapper
    public DateTime AOKHMGLMKIB;  // wrapper
    public DateTime NNCNFNLOCFK;  // wrapper
}
...
{
    public Guid HGKPDHJDFHL;  // wrapper
...
{
    public Guid OIPKAHNDCBB;  // wrapper
...
{
    public Guid OIPKAHNDCBB;  // wrapper
    public long? CPOPDFIHOGF;  // wrapper
    public byte? NNEEMNCGDEG;  // wrapper
    public int? FKCCOIADMAE;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid HGKPDHJDFHL;  // wrapper
    public long? OJMLBHBIANF;  // wrapper
    public long? BEALEBFKKGM;  // wrapper
    public int? JBBCNNPIHOD;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> FFHLFAMMNGJ;  // wrapper
...
{
    public HBCPOOBFNPH EKNPHEPNHJD;  // wrapper
    public Guid? DGBDHEDLKIF;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public KBDGIJPICHH GMNACBANEGJ;  // wrapper
    public long? GNFKFDAOOPN;  // wrapper
    public Guid? FBDBCPIOFCJ;  // wrapper
    public int? KHNDLBBJBOK;  // wrapper
...
{
    public Guid HLNPHOHMHNK;  // wrapper
...
{
    public Guid ODMEJNCKEPL;  // wrapper
...
{
    public BDJCFNAJDHK NECHOMCJEEJ;  // wrapper
}
