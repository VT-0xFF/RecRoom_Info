...
public class ADAMEHMFGAH
{
    public Dictionary<Guid, List<IAICGHGOOMJ>> <NDKOGDAMKMK>k__BackingField;    // 0x0x10
}
...
public class AEIHKLNPKPA
{
    public int? <DIEIHNGFIDH>k__BackingField;    // 0x0x10
    public string <CGMEOGNHOPM>k__BackingField;    // 0x0x18
    public string <IBJICEEBOFM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AFCEHKKKMLB
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.Auth]
public class AFCEHKKKMLB
{
    public int <MCBDJFNGDHN>k__BackingField;    // 0x0x10
    public int? <JAMPANCGKEL>k__BackingField;    // 0x0x14
    public string <OINLHBCNGGJ>k__BackingField;    // 0x0x20
    public string <FKFNFKNJNOA>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// AKCEDHNPNCN
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.Auth]
public class AKCEDHNPNCN
{
    public List<JIFONKHMGPA> <NLKFGKJFGOI>k__BackingField;    // 0x0x10
    public string <HHFKDEJLIDA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ANOMJIJJFGP
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.Auth]
public class ANOMJIJJFGP
{
    public List<GDNLPOMGMLC> <MNJHJPAAKDM>k__BackingField;    // 0x0x10
    public OFJNEIPDIGI <KIIJGGBDMBI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BECHOHOBFMK
//   REQUEST  POST   api/playerevents/v1/respond   [Service.Auth]
public class BECHOHOBFMK
{
    public long <JHOMHDLEAAM>k__BackingField;    // 0x0x10
    public PBNCODDKHCJ <HDILJMFIMNJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BFCAMOKDCJM
//   (not directly referenced by a detected call)
public class BFCAMOKDCJM
{
    public float <HJCJDFNKFKB>k__BackingField;    // 0x0x10
    public float <CBGLBENPJDG>k__BackingField;    // 0x0x14
    public float <MOIKGANJNBE>k__BackingField;    // 0x0x18
    public float <IBJPDDKLCBO>k__BackingField;    // 0x0x1C
    public float <ILIPPCPJBDP>k__BackingField;    // 0x0x20
    public float <MIDFLOOOFMK>k__BackingField;    // 0x0x24
    public float <PGJOBGFIBJH>k__BackingField;    // 0x0x28
    public float <KAIBMFCKNHB>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// BHNDENOEBLI
//   (not directly referenced by a detected call)
public class BHNDENOEBLI
{
    public JIFONKHMGPA <IPEKHFLMCPA>k__BackingField;    // 0x0x10
    public GJBIIIMBHMD <IOCAIKLAMHC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BILKHNNAPBA
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Matchmaking]
public class BILKHNNAPBA
{
    public Guid <DDPHGDCAFBD>k__BackingField;    // 0x0x10
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x20
    public string <OLMPKOKPCJA>k__BackingField;    // 0x0x28
    public DateTime <GMDICAKNJNE>k__BackingField;    // 0x0x30
    public DateTime? <OHBJPHEDDMK>k__BackingField;    // 0x0x38
    public List<ELLJLAMKEFF> <FLMDFGIFOKC>k__BackingField;    // 0x0x48
}
...
public class CENHDKHDKND
{
    public Dictionary<int, int> <AOLDHIMLOMK>k__BackingField;    // 0x0x10
    public List<LENLNEHFLLA> <KNFCGEIKBCA>k__BackingField;    // 0x0x18
    public MJBEEBFIGIL[][] <IEPNBDNOLAL>k__BackingField;    // 0x0x20
    public KFEAHDECNAE <MOCBBCFGMMI>k__BackingField;    // 0x0x28
    public BFCAMOKDCJM <BJNBMOKCGJH>k__BackingField;    // 0x0x30
    public GEEEHFBNAOE <HDKCHKOGMPC>k__BackingField;    // 0x0x38
    public EKFJAMHPONF <NDCELPFBGKJ>k__BackingField;    // 0x0x40
    public DFDLMNGIOLB <MHNGKLJANEC>k__BackingField;    // 0x0x48
    public string <DJLIJJOFPOK>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// CFEEMPEDOMB
//   (not directly referenced by a detected call)
public class CFEEMPEDOMB
{
    public bool <AAMMLFMOKDO>k__BackingField;    // 0x0x10
    public IPKKBEMDJIM <NALLEMGMIGL>k__BackingField;    // 0x0x18
    public float <DDMKHNGJLPM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CHHKJNEJINC
//   REQUEST  POST   api/playerevents/v1/report   [Service.Auth]
public class CHHKJNEJINC
{
    public JOOGKHHCHGF <KGDHJLNJMKM>k__BackingField;    // 0x0x10
    public long <JHOMHDLEAAM>k__BackingField;    // 0x0x18
    public string <PDJGLJACHFI>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{eAGIDIFAOGE}   [Service.WWW]
public class DADIEJJFFNM
{
    public MPHJPNLOKCP <EBPINPFIBMJ>k__BackingField;    // 0x0x10
    public OCDNIIHCGPG <NHNMOMPAIFH>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/storefronts/v1/season/{eHFDOANPJHD}   [Service.WWW]
public class DDKBKPANBJI : BLAOBCODLNE
{
    public int <OLPIILAJDII>k__BackingField;    // 0x0x30
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x38
    public DateTime <GMDICAKNJNE>k__BackingField;    // 0x0x40
    public DateTime <JNDPEPKNMBD>k__BackingField;    // 0x0x48
    public LJFLPMDPHPD <CLFELJFLBNF>k__BackingField;    // 0x0x50
    public HPENJFEPPDN <JHPGFOGMBAP>k__BackingField;    // 0x0x58
    public List<LKIJIHHOHKC> <ECEFEFBGJCH>k__BackingField;    // 0x0x60
    public JNBMLBNCKHH <GMKFKIEKKMJ>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// DEGFDDLNHBL
//   RESPONSE GET    api/config/v1/backtrace   [Service.Auth]
public class DEGFDDLNHBL
{
    public int <KJLIBICKNPL>k__BackingField;    // 0x0x10
    public int <CJKGKAMDBIK>k__BackingField;    // 0x0x14
    public float <PLFOJPOIKGC>k__BackingField;    // 0x0x18
    public int <FFBCKELNCFK>k__BackingField;    // 0x0x1C
    public int <IKBPCPDAGBN>k__BackingField;    // 0x0x20
    public int <LIFICJPPJND>k__BackingField;    // 0x0x24
    public int <IJONHNNJGDC>k__BackingField;    // 0x0x28
    public string <KDMHEAEGFKO>k__BackingField;    // 0x0x30
    public string <GMIHICPIEBB>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// DFDLMNGIOLB
//   (not directly referenced by a detected call)
public class DFDLMNGIOLB
{
    public float <HFNDMCNLKOO>k__BackingField;    // 0x0x10
}
...
public class DNKLJGLCGDI
{
    public int <PFINMFLJFLJ>k__BackingField;    // 0x0x10
    public int <HHNKPADDAPF>k__BackingField;    // 0x0x14
    public float <MLKPHNAENGB>k__BackingField;    // 0x0x18
    public float <LBJCMPFJLBD>k__BackingField;    // 0x0x1C
    public bool <ICBGMGPAGAC>k__BackingField;    // 0x0x20
    public bool <HDEBFKHFEOH>k__BackingField;    // 0x0x21
    public bool <LCIIKADFABD>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// DNPMGICIGFI
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.WWW]
public class DNPMGICIGFI
{
    public long <GCDIEAFGIBO>k__BackingField;    // 0x0x10
    public int <JCPPLJANJBI>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/progressionEvents/collect/{nKBIJHGDCGJ}/{eGJDEJKCBEL}   [Service.Auth]
public class DOAGALGKHJH
{
    public long? <AAONHLGKGLD>k__BackingField;    // 0x0x10
    public int <IABNKPKOLHG>k__BackingField;    // 0x0x20
    public int? <MLGIJIGKLAN>k__BackingField;    // 0x0x24
    public string <JKPCLMKKHFC>k__BackingField;    // 0x0x30
    public PMPFOCPHGJF? <CBFCEMBKDPA>k__BackingField;    // 0x0x38
    public string <CGEJALDKBGO>k__BackingField;    // 0x0x40
    public Guid? <MBFHHCEKNJP>k__BackingField;    // 0x0x48
    public string <NBPNEHAOOCH>k__BackingField;    // 0x0x60
    public string <HGIDCFOCNIE>k__BackingField;    // 0x0x68
    public LJFLPMDPHPD <CLFELJFLBNF>k__BackingField;    // 0x0x70
    public int <KFLHIIAFFNE>k__BackingField;    // 0x0x74
    public int <NJCCBJKPJFB>k__BackingField;    // 0x0x78
    public INHNKBPPFPC <NEJKEAPFNHE>k__BackingField;    // 0x0x7C
    public JKFOIILAEJG <EJBLLBEFALB>k__BackingField;    // 0x0x80
    public string <GLPIPFDFKIN>k__BackingField;    // 0x0x88
    public FFGDPIFLKJN <BBAANCJDMFD>k__BackingField;    // 0x0x90
    public ADGDNMNPAEJ <KLHMFMAMLBI>k__BackingField;    // 0x0x94
    public DJAMOLAFKAI? <OLOMCCHDDFO>k__BackingField;    // 0x0x98
    public bool <KNIDKOMAFIP>k__BackingField;    // 0x0xA0
    public bool <BDDCDGAPDCP>k__BackingField;    // 0x0xA1
    public string <JJJJBMKNBDG>k__BackingField;    // 0x0xA8
    public bool <MGJNHEPNLLH>k__BackingField;    // 0x0xB0
    public bool HMNGGJKJLLL;    // 0x0xB1
}

// --------------------------------------------------------------------------
// EECEOLCHIHL
//   RESPONSE GET    api/config/v1/azurespeech   [Service.Auth]
public class EECEOLCHIHL
{
    public bool <AHJMNEOBOPA>k__BackingField;    // 0x0x10
    public string <AMEGGECHHEK>k__BackingField;    // 0x0x18
    public string <MMODOBHAJLM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EENIPMCKCII
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.WWW]
public class EENIPMCKCII
{
    public List<string> <LEOPJPDKLJH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EHMBOGHOBNB
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class EHMBOGHOBNB
{
    public Dictionary<Guid, OIAALEAHHKD> <BBMDKGBMMJD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EKFJAMHPONF
//   (not directly referenced by a detected call)
public class EKFJAMHPONF
{
    public int <LFFPHHHDCJA>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{jEPHFKOBPAI}   [Service.WWW]
public enum EKMKBKLHBNL
{
    Success = 0,
    InvalidParameters = 1,
    DoesNotExist = 2,
...
// ELLJLAMKEFF
//   (not directly referenced by a detected call)
public class ELLJLAMKEFF
{
    public Guid <NAEHLIJJKKK>k__BackingField;    // 0x0x10
    public Guid <NFJNLFKHPGF>k__BackingField;    // 0x0x20
    public DateTime <GMDICAKNJNE>k__BackingField;    // 0x0x30
    public List<IPKKBEMDJIM> <APNJOPMFJIH>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// ELOALMONBAB
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.Auth]
public class ELOALMONBAB
{
    public JOOGKHHCHGF <KGDHJLNJMKM>k__BackingField;    // 0x0x10
    public int <IPGELDIEOIK>k__BackingField;    // 0x0x14
    public long <MPLLNDAAEAI>k__BackingField;    // 0x0x18
    public bool <PHKOFJLMOGI>k__BackingField;    // 0x0x20
    public string <JFNOBOBFFDO>k__BackingField;    // 0x0x28
    public int? <KIHIFOPEFDA>k__BackingField;    // 0x0x30
    public bool <BDFMGEJFGEM>k__BackingField;    // 0x0x38
    public bool <JNEIGCHINOG>k__BackingField;    // 0x0x39
    public bool <FCBIBNCCGPL>k__BackingField;    // 0x0x3A
    public bool <GDJGPLCPPCH>k__BackingField;    // 0x0x3B
    public string <ECCLIPMOGGG>k__BackingField;    // 0x0x40
    public DateTime? <LJLMOJFFGPH>k__BackingField;    // 0x0x48
    public string <GGBCMNDPFOC>k__BackingField;    // 0x0x58
    public float <JNKGKMNCEMI>k__BackingField;    // 0x0x60
}
...
public class FBNOHAHAMFI
{
    public Guid? <KPCJFJDNCNM>k__BackingField;    // 0x0x10
    public long? <LMFBMCOFJCN>k__BackingField;    // 0x0x28
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x38
    public string <OHHFMEJCFGL>k__BackingField;    // 0x0x40
    public string <OLMPKOKPCJA>k__BackingField;    // 0x0x48
    public NOICGKOIHJC <PJDDCFEAIPI>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// FDDHEBLLBBA
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.WWW]
public class FDDHEBLLBBA
{
    public int <JCPPLJANJBI>k__BackingField;    // 0x0x10
    public Guid <KMEKBDLOCPF>k__BackingField;    // 0x0x14
    public long <JNNIJKHCNCI>k__BackingField;    // 0x0x28
    public DateTime <NFOBDCEEFPM>k__BackingField;    // 0x0x30
}
...
// FGPJBECDDMD
//   (not directly referenced by a detected call)
public class FGPJBECDDMD
{
    public string <AFLKGPEPHEB>k__BackingField;    // 0x0x10
    public JDAPFJEODGH <HDILJMFIMNJ>k__BackingField;    // 0x0x18
}
...
public class FKHABCKCIBC
{
    public List<long> <MHCONAKEFBO>k__BackingField;    // 0x0x10
    public EPHGGIHPOKG <HDILJMFIMNJ>k__BackingField;    // 0x0x18
    public string <CJEPELDCFEM>k__BackingField;    // 0x0x20
    public long? <LMFBMCOFJCN>k__BackingField;    // 0x0x28
}
...
public class FLINCLBJPIL
{
    public long <LMFBMCOFJCN>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <OEKKIENPOCO>k__BackingField;    // 0x0x18
    public HPOOIHIEHOA <CBNEONNCFLH>k__BackingField;    // 0x0x20
}
...
public class GAACFOHCLLI
{
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x10
    public string <OHHFMEJCFGL>k__BackingField;    // 0x0x18
    public int? <MGNHNKLOHBC>k__BackingField;    // 0x0x20
    public HBMANPGAFHF? <DGPBCMKOLNN>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// GDNLPOMGMLC
//   (not directly referenced by a detected call)
public class GDNLPOMGMLC
{
    public int <PPGAAOLHIIG>k__BackingField;    // 0x0x10
    public OFJNEIPDIGI <KIIJGGBDMBI>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// GEEEHFBNAOE
//   (not directly referenced by a detected call)
public class GEEEHFBNAOE
{
    public int <CPIKEJNEDBJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GGAFOPEHCAP
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{cMEADPACGME}   [Service.Auth]
public class GGAFOPEHCAP
{
    public uint <AAONHLGKGLD>k__BackingField;    // 0x0x10
    public uint? <CEHDNCIIBFO>k__BackingField;    // 0x0x14
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x20
    public string <OHHFMEJCFGL>k__BackingField;    // 0x0x28
    public DateTime <HGGOOKACKBJ>k__BackingField;    // 0x0x30
    public DateTime? <JMONNLCGKNH>k__BackingField;    // 0x0x38
    public bool <EHEOIINAAHN>k__BackingField;    // 0x0x48
    public List<MPKBJLJGFAK> <IHNKFGNBHPP>k__BackingField;    // 0x0x50
    public List<string> <FKHGONGLCDP>k__BackingField;    // 0x0x58
    public int <HCKELNDOBDN>k__BackingField;    // 0x0x60
    public int <DOJOIJPALPO>k__BackingField;    // 0x0x64
    public int <IPGHAKLABJM>k__BackingField;    // 0x0x68
}
...
// GJBIIIMBHMD
//   (not directly referenced by a detected call)
public class GJBIIIMBHMD
{
    public long <GJDIFBPCFDK>k__BackingField;    // 0x0x10
    public long <JHOMHDLEAAM>k__BackingField;    // 0x0x18
    public int <IABNKPKOLHG>k__BackingField;    // 0x0x20
    public DateTime <LJOKLOKMKOE>k__BackingField;    // 0x0x28
    public PBNCODDKHCJ <HDILJMFIMNJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GKHBJACAHNB
//   REQUEST  POST   api/equipment/v1/update   [Service.WWW]
public class GKHBJACAHNB
{
    public string <CEINKCHPKNG>k__BackingField;    // 0x0x10
    public string <MBBEEMEAFOK>k__BackingField;    // 0x0x18
    public string <FIDMJHCMPAK>k__BackingField;    // 0x0x20
    public string <NHDJBOGOBOK>k__BackingField;    // 0x0x28
    public JKFOIILAEJG <JFNMFIKECHC>k__BackingField;    // 0x0x30
    public string <EPNOCEANLNB>k__BackingField;    // 0x0x38
    public bool KGIIFONOECP;    // 0x0x40
    public bool <LCIIKADFABD>k__BackingField;    // 0x0x41
}

// --------------------------------------------------------------------------
// GMHGFGFPJAL
//   RESPONSE GET    api/playerevents/v1/all   [Service.Auth]
//   RESPONSE GET    api/playerevents/v1/all/{kGOMJEMDBBE}   [Service.Auth]
public class GMHGFGFPJAL
{
    public List<JIFONKHMGPA> <EDABIEIAJGC>k__BackingField;    // 0x0x10
    public List<BHNDENOEBLI> <KAILDPKGFAP>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{eMOKKAAEAEE}/appeal   [Service.Auth]
...
//   RESPONSE DELETE api/keepsakes/{oDKODKJAEOJ}   [Service.Auth]
...
public class GOOALFLCKJC
{
    public bool <KFEABIKJMCA>k__BackingField;    // 0x0x10
    public string <EOPGGEOPPBF>k__BackingField;    // 0x0x18
}
...
public class HIPOMADAPPC
{
    public AIMEJIAJNOM <KGDHJLNJMKM>k__BackingField;    // 0x0x10
    public string <PDJGLJACHFI>k__BackingField;    // 0x0x18
    public int? <OKCBMCAKNHH>k__BackingField;    // 0x0x20
}
...
public class HLCALJPNMNB : NBFNJBPKNOC
{
    public BOBAMMFBENH? <GFDNBDLNGKG>k__BackingField;    // 0x0x18
    public FDDHEBLLBBA <HAIAEFJJPLC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HPENJFEPPDN
//   (not directly referenced by a detected call)
public class HPENJFEPPDN
{
    public int <GEJGHPMMLJC>k__BackingField;    // 0x0x10
    public ACGGLEIONKB <HDILJMFIMNJ>k__BackingField;    // 0x0x14
    public List<LOFFGHHAIIJ> <ABPJBAFOCIC>k__BackingField;    // 0x0x18
    public List<LOFFGHHAIIJ> <KINBMNIEFME>k__BackingField;    // 0x0x20
    public bool <LEMBCBPIJCD>k__BackingField;    // 0x0x28
    public DateTime? <GHLGIHAJIKN>k__BackingField;    // 0x0x30
    public DateTime? <GCDGGCLDFIJ>k__BackingField;    // 0x0x40
    public DateTime? <LDGPGDNIGLF>k__BackingField;    // 0x0x50
    public bool <AHBOEDJDGOM>k__BackingField;    // 0x0x60
    public bool <IDLHFBMMNAB>k__BackingField;    // 0x0x61
}
...
// IAICGHGOOMJ
//   (not directly referenced by a detected call)
public class IAICGHGOOMJ
{
    public long <JOKKGMBNAAA>k__BackingField;    // 0x0x10
    public Guid <MBFHHCEKNJP>k__BackingField;    // 0x0x18
    public Guid <IJEFCMBAKMM>k__BackingField;    // 0x0x28
    public DateTime <LJOKLOKMKOE>k__BackingField;    // 0x0x38
    public string <EGBBBBDFEEJ>k__BackingField;    // 0x0x40
    public string <NCEFAEAIHPA>k__BackingField;    // 0x0x48
    public int <OMDIDJHLHOA>k__BackingField;    // 0x0x50
    public string <EEKJNGCCFGP>k__BackingField;    // 0x0x58
    public string <BIKHDCIHJLH>k__BackingField;    // 0x0x60
    public string <LLLNHEKMKHM>k__BackingField;    // 0x0x68
    public string <GCFBCFHJMIL>k__BackingField;    // 0x0x70
    public int <BGHOEIEHJDB>k__BackingField;    // 0x0x78
}
...
public class IKNHGHFIDKP
{
    public EKMKBKLHBNL <EBPINPFIBMJ>k__BackingField;    // 0x0x10
    public ONNPJCGFAHB <MAHDDOLKANB>k__BackingField;    // 0x0x18
}
...
public class IOLEIALCEPH : NBFNJBPKNOC
{
    public HBOIANIJLGA? <GFDNBDLNGKG>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <PIBFEBILPEK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IPFAGAOJMFM
//   (not directly referenced by a detected call)
public class IPFAGAOJMFM
{
    public Guid <KPCJFJDNCNM>k__BackingField;    // 0x0x10
    public int <JCPPLJANJBI>k__BackingField;    // 0x0x20
    public int <OMEFFOKOFPE>k__BackingField;    // 0x0x24
    public Guid <JLHJMHALCBL>k__BackingField;    // 0x0x28
    public DateTime <NFOBDCEEFPM>k__BackingField;    // 0x0x38
    public OCDNIIHCGPG <NHNMOMPAIFH>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// IPKKBEMDJIM
//   (not directly referenced by a detected call)
public class IPKKBEMDJIM
{
    public int <KGLOKNHNANI>k__BackingField;    // 0x0x10
    public string <FIDMJHCMPAK>k__BackingField;    // 0x0x18
    public string <NHDJBOGOBOK>k__BackingField;    // 0x0x20
    public string <NJPGPHNBIIP>k__BackingField;    // 0x0x28
    public string <JKPCLMKKHFC>k__BackingField;    // 0x0x30
    public string <CGEJALDKBGO>k__BackingField;    // 0x0x38
    public Guid? <MBFHHCEKNJP>k__BackingField;    // 0x0x40
    public PMPFOCPHGJF? <CBFCEMBKDPA>k__BackingField;    // 0x0x54
    public string <NBPNEHAOOCH>k__BackingField;    // 0x0x60
    public string <HGIDCFOCNIE>k__BackingField;    // 0x0x68
    public bool <DCNKDFHPCEH>k__BackingField;    // 0x0x70
    public bool <JBIMBBAEJAK>k__BackingField;    // 0x0x71
    public bool <PAFHJIEBLLO>k__BackingField;    // 0x0x72
    public JKFOIILAEJG <JFNMFIKECHC>k__BackingField;    // 0x0x74
    public LJFLPMDPHPD <CLFELJFLBNF>k__BackingField;    // 0x0x78
    public int <KFLHIIAFFNE>k__BackingField;    // 0x0x7C
    public JPNFFOOKABJ <NLPAFMJBJOK>k__BackingField;    // 0x0x80
    public INHNKBPPFPC <NELPHPBHAMG>k__BackingField;    // 0x0x84
    public int? <OIGNGMMKLOM>k__BackingField;    // 0x0x88
    public string <FNOMHEAKBHC>k__BackingField;    // 0x0x90
    public int? <KEEHKCNEJGP>k__BackingField;    // 0x0x98
    public int? <GPHEPMBANKH>k__BackingField;    // 0x0xA0
    public string <EPNOCEANLNB>k__BackingField;    // 0x0xA8
}
...
public class JDAEMNOLADG : JIFONKHMGPA
{
    public List<FGPJBECDDMD> <FKHGONGLCDP>k__BackingField;    // 0x0x98
}
...
public class JEBPMHHKFPI
{
    public int <HHNKPADDAPF>k__BackingField;    // 0x0x10
    public bool <ICBGMGPAGAC>k__BackingField;    // 0x0x14
    public DateTime <GFOCLOKCFPC>k__BackingField;    // 0x0x18
    public bool <HBCLMHHAKAI>k__BackingField;    // 0x0x20
}
...
// JHFAAGIGJAK
//   (not directly referenced by a detected call)
public class JHFAAGIGJAK
{
    public int <OHJBCBMEIPM>k__BackingField;    // 0x0x10
    public DateTime <LJOKLOKMKOE>k__BackingField;    // 0x0x18
    public DateTime? <GPKHFIBKNIO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JIFONKHMGPA
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class JIFONKHMGPA
{
    public long <JHOMHDLEAAM>k__BackingField;    // 0x0x10
    public int <HPMMDNLMBMN>k__BackingField;    // 0x0x18
    public long <LMFBMCOFJCN>k__BackingField;    // 0x0x20
    public long? <MGLFNLMNMKK>k__BackingField;    // 0x0x28
    public long? <IIDMPAOKALK>k__BackingField;    // 0x0x38
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x48
    public string <OHHFMEJCFGL>k__BackingField;    // 0x0x50
    public string <OLMPKOKPCJA>k__BackingField;    // 0x0x58
    public DateTime <IEDMLIKPMHG>k__BackingField;    // 0x0x60
    public DateTime <LBIDJCNMFEP>k__BackingField;    // 0x0x68
    public int <JLMJDEOMLOC>k__BackingField;    // 0x0x70
    public NIMGKIDLHFG <DGPBCMKOLNN>k__BackingField;    // 0x0x74
    public bool <OLOLIHHCHGN>k__BackingField;    // 0x0x78
    public bool <DHDJMPNHJPB>k__BackingField;    // 0x0x79
    public LILFHCGDEOM <AGPEIEDELIH>k__BackingField;    // 0x0x7C
    public LILFHCGDEOM <CJAOIOOBBEG>k__BackingField;    // 0x0x80
    public long? <DKBEJGKJNHG>k__BackingField;    // 0x0x88
}
...
public class JLDFOAGOEPB
{
    public bool <KFEABIKJMCA>k__BackingField;    // 0x0x10
    public string <JFNOBOBFFDO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JNBMLBNCKHH
//   (not directly referenced by a detected call)
public class JNBMLBNCKHH
{
    public bool <AAGGFJLFDBL>k__BackingField;    // 0x0x10
    public ADGDNMNPAEJ <NBBOOAIHEKL>k__BackingField;    // 0x0x14
    public int <CPGFIGPPEBM>k__BackingField;    // 0x0x18
    public DateTime <NFOBDCEEFPM>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// JPPLLGPCPOL
// base   : GGAEDHJGBKG`1<CCFILKCCIDJ>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{bLLBNJOMEOO}   [Service.Auth]
public class JPPLLGPCPOL
{
    // (no instance fields in the metadata dump)
}
...
// KFEAHDECNAE
//   (not directly referenced by a detected call)
public class KFEAHDECNAE
{
    public int <JGNBANDKGJJ>k__BackingField;    // 0x0x10
}
...
public class KFPIPBIJMBL
{
    public List<string> <JPMEBICNOID>k__BackingField;    // 0x0x10
    public List<string> <JIEBKJCMIIK>k__BackingField;    // 0x0x18
    public List<string> <JMNDHHGIIFC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KMCEAOONEOG
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.WWW]
public class KMCEAOONEOG
{
    public long <GCDIEAFGIBO>k__BackingField;    // 0x0x10
    public int <JCPPLJANJBI>k__BackingField;    // 0x0x18
}
...
public class LEDFPEMOJPI
{
    public MPHJPNLOKCP <EBPINPFIBMJ>k__BackingField;    // 0x0x10
    public IPFAGAOJMFM <FFGDOBFMAPL>k__BackingField;    // 0x0x18
}
...
public class LJHOHAPGOEA
{
    public PMPFOCPHGJF <CBFCEMBKDPA>k__BackingField;    // 0x0x10
    public string <KCNDOIHMDKI>k__BackingField;    // 0x0x18
    public string <FIDMJHCMPAK>k__BackingField;    // 0x0x20
    public string <NHDJBOGOBOK>k__BackingField;    // 0x0x28
    public JKFOIILAEJG <JFNMFIKECHC>k__BackingField;    // 0x0x30
    public string <NJPGPHNBIIP>k__BackingField;    // 0x0x38
    public int <KEEHKCNEJGP>k__BackingField;    // 0x0x40
    public bool <IGECADBEJBF>k__BackingField;    // 0x0x44
    public string <CKLEDAEFPKL>k__BackingField;    // 0x0x48
    public DateTime <LJOKLOKMKOE>k__BackingField;    // 0x0x50
}
...
// base   : HPENJFEPPDN
//   (not directly referenced by a detected call)
public class LKIJIHHOHKC : HPENJFEPPDN
{
    public int <KGOAHNOJHGJ>k__BackingField;    // 0x0x68
    public List<CFEEMPEDOMB> <MAJDMMMIBAJ>k__BackingField;    // 0x0x70
    public List<CFEEMPEDOMB> <LMHNOEDDOFK>k__BackingField;    // 0x0x78
    public List<CFEEMPEDOMB> <KLIMKAHAAAM>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// LNFLKLECIJG
//   (not directly referenced by a detected call)
public class LNFLKLECIJG
{
    public int <INALPBGIEDC>k__BackingField;    // 0x0x10
    public DateTime? <LHJGBBBOHDD>k__BackingField;    // 0x0x18
    public DateTime? <ENGDEHACCDB>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// LOFFGHHAIIJ
//   (not directly referenced by a detected call)
public class LOFFGHHAIIJ
{
    public LJFLPMDPHPD <CLFELJFLBNF>k__BackingField;    // 0x0x10
    public int <MGNHNKLOHBC>k__BackingField;    // 0x0x14
    public LNFLKLECIJG <NHOIAMJPJFD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MADPDDLFCLJ
//   REQUEST  ?      api/customAvatarItems/GetCustomAvatarItemCurrentSavesForCustomAvatarItemIds/v2   [Service.Auth]
public class MADPDDLFCLJ
{
    public List<Guid> <FLBJHHPGBDJ>k__BackingField;    // 0x0x10
    public byte <MOFIOPFGDDL>k__BackingField;    // 0x0x18
    public int <GCOKKDEJHMJ>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// MJBEEBFIGIL
//   (not directly referenced by a detected call)
public class MJBEEBFIGIL
{
    public GHOKPHAKBLK HOCKEOKNALF;    // 0x0x10
    public int EGADJLBANAA;    // 0x0x14
}

// --------------------------------------------------------------------------
// MLKPMLDHHGM
//   RESPONSE POST   api/inventions/v1/settags   [Service.Auth]
public class MLKPMLDHHGM
{
    public FJMGMDIHGPB <KIIJGGBDMBI>k__BackingField;    // 0x0x10
    public List<string> <FKHGONGLCDP>k__BackingField;    // 0x0x18
}
...
public class MPKBJLJGFAK
{
    public string <AAONHLGKGLD>k__BackingField;    // 0x0x10
    public string <AMEGGECHHEK>k__BackingField;    // 0x0x18
    public string <LCFJHNNCCNP>k__BackingField;    // 0x0x20
    public string <OHHFMEJCFGL>k__BackingField;    // 0x0x28
    public string <CGMEOGNHOPM>k__BackingField;    // 0x0x30
    public NAFEGJJJLME <EBPINPFIBMJ>k__BackingField;    // 0x0x38
    public List<string> <ANAHMBDBOMP>k__BackingField;    // 0x0x40
    public List<string> <FKHGONGLCDP>k__BackingField;    // 0x0x48
    public string <GNEKCJNGIHF>k__BackingField;    // 0x0x50
    public List<OPIJLLPGPNM> <JELOIOOKCGN>k__BackingField;    // 0x0x58
}
...
public class NMOMMEDFPKL
{
    public int <IPGELDIEOIK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NOICGKOIHJC
//   (not directly referenced by a detected call)
public class NOICGKOIHJC
{
    public long <MGNHNKLOHBC>k__BackingField;    // 0x0x10
    public Guid? <KMEKBDLOCPF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OCDNIIHCGPG
//   (not directly referenced by a detected call)
public class OCDNIIHCGPG
{
    public Guid <KPCJFJDNCNM>k__BackingField;    // 0x0x10
    public long <LMFBMCOFJCN>k__BackingField;    // 0x0x20
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x28
    public string <OHHFMEJCFGL>k__BackingField;    // 0x0x30
    public string <OLMPKOKPCJA>k__BackingField;    // 0x0x38
    public long <MGNHNKLOHBC>k__BackingField;    // 0x0x40
    public Guid? <DJDJIDAEANN>k__BackingField;    // 0x0x48
    public DateTime <NFOBDCEEFPM>k__BackingField;    // 0x0x60
    public int <NEBJOBCKIHK>k__BackingField;    // 0x0x68
}
...
public class ODBOLEKHKBG
{
    public List<JHFAAGIGJAK> <JGHIEDEHNDO>k__BackingField;    // 0x0x10
    public string <HHFKDEJLIDA>k__BackingField;    // 0x0x18
}
...
public class ODCIFBLADNE
{
    public List<FGPJBECDDMD> <FKHGONGLCDP>k__BackingField;    // 0x0x10
}
...
public class OFOGNFMEJLG
{
    public int FFNGBLDMENO;    // 0x0x10
    public long LJCNGJJLMMH;    // 0x0x18
}
...
// OIAALEAHHKD
//   (not directly referenced by a detected call)
public class OIAALEAHHKD
{
    public int <BAAPLKBPEDC>k__BackingField;    // 0x0x10
    public OINALGKEJFB <IBKMPCJBHMB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OIBJADHMMCG
// base   : GGAEDHJGBKG`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class OIBJADHMMCG
{
    // (no instance fields in the metadata dump)
}
...
public class OINALGKEJFB
{
    public Guid? <HBKIGMBPGNA>k__BackingField;    // 0x0x10
    public Guid <HLCEKLECHLP>k__BackingField;    // 0x0x24
}
...
public class OJCJGDMPEKG
{
    public OINALGKEJFB <IBKMPCJBHMB>k__BackingField;    // 0x0x10
    public NOICGKOIHJC <MALDKBJBOFP>k__BackingField;    // 0x0x18
    public int <BAAPLKBPEDC>k__BackingField;    // 0x0x20
}
...
public class OMKKJICFEDA
{
    public OFJNEIPDIGI <KIIJGGBDMBI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// ONNPJCGFAHB
//   (not directly referenced by a detected call)
public class ONNPJCGFAHB
{
    public long <GCDIEAFGIBO>k__BackingField;    // 0x0x10
    public Guid <LMLJNFFBNKO>k__BackingField;    // 0x0x18
    public long <LMFBMCOFJCN>k__BackingField;    // 0x0x28
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x30
    public string <OHHFMEJCFGL>k__BackingField;    // 0x0x38
    public int <MGNHNKLOHBC>k__BackingField;    // 0x0x40
    public Guid? <DJDJIDAEANN>k__BackingField;    // 0x0x44
    public DateTime <LJOKLOKMKOE>k__BackingField;    // 0x0x58
    public string <OLMPKOKPCJA>k__BackingField;    // 0x0x60
    public OCEFFHPINAM <HDILJMFIMNJ>k__BackingField;    // 0x0x68
}
...
public class OOJHGOKHLPD
{
    public JDAEMNOLADG <IPEKHFLMCPA>k__BackingField;    // 0x0x10
    public OFJNEIPDIGI <KIIJGGBDMBI>k__BackingField;    // 0x0x18
    public MLKPMLDHHGM <MKBFDEAEFPK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OPIJLLPGPNM
//   (not directly referenced by a detected call)
public class OPIJLLPGPNM
{
    public DateTime <LJOKLOKMKOE>k__BackingField;    // 0x0x10
    public string <HBPCNDCLCDN>k__BackingField;    // 0x0x18
}
...
// PEGBPMPMAME
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{eBJLGNGGJNH}/{lLKDMMGGGBD}   [Service.WWW]
public class PEGBPMPMAME
{
    public LJFLPMDPHPD <CLFELJFLBNF>k__BackingField;    // 0x0x10
    public JFNOPBGLMGK <GKIGABLOIIC>k__BackingField;    // 0x0x14
    public int <EKIBIAKAPJN>k__BackingField;    // 0x0x18
    public int <HBNJGBBJGCE>k__BackingField;    // 0x0x1C
    public int <MJEODDLHAIK>k__BackingField;    // 0x0x20
    public OHLBCBMBPFB <BKJCOGBGCPF>k__BackingField;    // 0x0x24
    public bool <PDNBBJCBCHF>k__BackingField;    // 0x0x28
    public float <DBPELNFJECF>k__BackingField;    // 0x0x2C
    public int <FKHBGBKGBEP>k__BackingField;    // 0x0x30
    public bool <HLCOJIDBHPD>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// PFHGLGBMAJB
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.WWW]
public class PFHGLGBMAJB
{
    public Guid <KMEKBDLOCPF>k__BackingField;    // 0x0x10
    public int <AONILNGDIDK>k__BackingField;    // 0x0x20
    public long <HLAKLJOLGJN>k__BackingField;    // 0x0x28
    public Guid <JBDBINPKDIB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// PGLEKKEOFAH
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.WWW]
public class PGLEKKEOFAH
{
    public List<int> <PDOFHEBCJOM>k__BackingField;    // 0x0x10
    public string <HHFKDEJLIDA>k__BackingField;    // 0x0x18
}
...
public class PGPCMKNGOJL
{
    public Guid <JBDBINPKDIB>k__BackingField;    // 0x0x10
    public long <GDOMDGMFMDM>k__BackingField;    // 0x0x20
}
...
public class PIKGLGLLIIE
{
    public int <LMHEBGCICEG>k__BackingField;    // 0x0x10
    public OIJCDJEKHIH <HDILJMFIMNJ>k__BackingField;    // 0x0x14
    public HOMLNEJGANI <MBEGNNHMNHO>k__BackingField;    // 0x0x18
    public HOMLNEJGANI <HJEKOCGNDPG>k__BackingField;    // 0x0x1C
    public HOMLNEJGANI <IONEENJHIBJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PJHMIPOBCJF
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class PJHMIPOBCJF
{
    public Dictionary<Guid, LEDFPEMOJPI> <IDPNIBIDBCC>k__BackingField;    // 0x0x10
}
...
public class PMAMPLBMLHB
{
    public long <LMFBMCOFJCN>k__BackingField;    // 0x0x10
    public long? <MGLFNLMNMKK>k__BackingField;    // 0x0x18
    public long? <IIDMPAOKALK>k__BackingField;    // 0x0x28
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x38
    public string <OHHFMEJCFGL>k__BackingField;    // 0x0x40
    public List<string> <FKHGONGLCDP>k__BackingField;    // 0x0x48
    public string <OLMPKOKPCJA>k__BackingField;    // 0x0x50
    public DateTime <IEDMLIKPMHG>k__BackingField;    // 0x0x58
    public DateTime <LBIDJCNMFEP>k__BackingField;    // 0x0x60
    public NIMGKIDLHFG <DGPBCMKOLNN>k__BackingField;    // 0x0x68
    public bool <OLOLIHHCHGN>k__BackingField;    // 0x0x6C
    public bool <DHDJMPNHJPB>k__BackingField;    // 0x0x6D
    public LILFHCGDEOM <AGPEIEDELIH>k__BackingField;    // 0x0x70
    public LILFHCGDEOM <CJAOIOOBBEG>k__BackingField;    // 0x0x74
}
...
public class AddKeepsakeInstanceRequest
{
    public long <LMFBMCOFJCN>k__BackingField;    // 0x0x10
    public long? <MGLFNLMNMKK>k__BackingField;    // 0x0x18
    public JLDMECKKCCB <DPHKHFMDIAE>k__BackingField;    // 0x0x28
}
...
{
    public PAHKEEOAOHK <KIIJGGBDMBI>k__BackingField;    // 0x0x10
    public string <KILJOCAIIHK>k__BackingField;    // 0x0x18
    public string <IPDJCKCNAFG>k__BackingField;    // 0x0x20
    public string <DGFJEDOKGPH>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public LJFLPMDPHPD <CurrencyType>k__BackingField;    // 0x0x18
    public DJAMOLAFKAI <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <JHOMHDLEAAM>k__BackingField;    // 0x0x10
    public long? <NPMKDKPIHIA>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public CPCILLBJFGI FilterType;    // 0x0x20
...
{
    public JLDMECKKCCB <FEHAIDMMANH>k__BackingField;    // 0x0x10
    public string <IDLOOEAGJJO>k__BackingField;    // 0x0x18
    public int <ODPHDNMLFIO>k__BackingField;    // 0x0x20
    public int <MCODNAJMPDD>k__BackingField;    // 0x0x24
    public string <NBNKFIIOJNP>k__BackingField;    // 0x0x28
    public string <GFIIKNPHNDC>k__BackingField;    // 0x0x30
}
...
{
    public int <JCPPLJANJBI>k__BackingField;    // 0x0x10
    public Guid <MHNJPOJNBNB>k__BackingField;    // 0x0x14
    public DateTime <HPFIEDGCOFH>k__BackingField;    // 0x0x28
}
...
{
    public bool <MAFKAOACFHM>k__BackingField;    // 0x0x10
    public int <ILJLCDACJND>k__BackingField;    // 0x0x14
    public bool <EMFNDICMDNA>k__BackingField;    // 0x0x18
}
...
{
    public Guid <MHNJPOJNBNB>k__BackingField;    // 0x0x10
    public JLDMECKKCCB <PMCLGKKBOBA>k__BackingField;    // 0x0x20
    public int <EGOBOBKLEHD>k__BackingField;    // 0x0x24
    public long <LMFBMCOFJCN>k__BackingField;    // 0x0x28
    public long? <MGLFNLMNMKK>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{fBDCBEPJOOA}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <AONPFEOKODG>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <FGGJEOKKHNJ>k__BackingField;    // 0x0x18
}
...
{
    public long <PJJNMFENAFJ>k__BackingField;    // 0x0x10
    public long <LMFBMCOFJCN>k__BackingField;    // 0x0x18
    public long <PLEJKNLPJDH>k__BackingField;    // 0x0x20
    public BBCMLHEBPLG <HDILJMFIMNJ>k__BackingField;    // 0x0x28
    public int <JKNHFMBLMAM>k__BackingField;    // 0x0x2C
}
...
{
    public long <LMFBMCOFJCN>k__BackingField;    // 0x0x10
    public List<Guid> <BNFPBFKNPDN>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <AONPFEOKODG>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <FGGJEOKKHNJ>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <NBPFEFKAJMB>k__BackingField;    // 0x0x20
}
...
{
    public long <PLEJKNLPJDH>k__BackingField;    // 0x0x10
    public long <EGAKDNJBDCN>k__BackingField;    // 0x0x18
    public int? <NKDDJALMHEL>k__BackingField;    // 0x0x20
    public int? <NPACBKCELAE>k__BackingField;    // 0x0x28
    public long? <MPLPFJHFFBJ>k__BackingField;    // 0x0x30
    public long <OHANBAEAMEP>k__BackingField;    // 0x0x40
    public long <ECMFHEIEPDO>k__BackingField;    // 0x0x48
    public int <EHAHGLIGGMJ>k__BackingField;    // 0x0x50
    public BBCMLHEBPLG <NLMJDHPLHAD>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <EMFBGKKGDBK>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public INHNKBPPFPC <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public AMGEEFGMLAH creatorAccountRole;    // 0x0x60
...
{
    public AHGJBLFHGEI <MOCEGPNHDFD>k__BackingField;    // 0x0x10
    public NLDAIBPGDAD <OIMGJOAFLAH>k__BackingField;    // 0x0x14
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x18
    public string <OHHFMEJCFGL>k__BackingField;    // 0x0x20
    public bool <AAOIOAPLAKH>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<AHGJBLFHGEI> <KAEEHMFMMFF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{nKBIJHGDCGJ}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <EGAKDNJBDCN>k__BackingField;    // 0x0x10
    public string <FEGOKIDNCGC>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <KLIMKAHAAAM>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <BKECAGHNHCO>k__BackingField;    // 0x0x28
    public DateTime <IEDMLIKPMHG>k__BackingField;    // 0x0x30
    public DateTime <LBIDJCNMFEP>k__BackingField;    // 0x0x38
    public DateTime <LGNJLEJNENJ>k__BackingField;    // 0x0x40
    public bool <KJIEJPHBCMG>k__BackingField;    // 0x0x48
    public int <KJGILBKDIAN>k__BackingField;    // 0x0x4C
    public float <JMNHNIEIPOB>k__BackingField;    // 0x0x50
    public Guid? <ABINCIKMEGA>k__BackingField;    // 0x0x54
    public string <MCBFHPCAODK>k__BackingField;    // 0x0x68
    public string <MBBIANIGIJH>k__BackingField;    // 0x0x70
    public string <EDELOAEICJL>k__BackingField;    // 0x0x78
    public string <CLLFFJADKIL>k__BackingField;    // 0x0x80
}
...
{
    public Guid <LBHIHPHCBKD>k__BackingField;    // 0x0x10
    public int <KEHFEHHNKBH>k__BackingField;    // 0x0x20
    public int <EDCEDKBLPNL>k__BackingField;    // 0x0x24
    public int <PGGBOEDCJEC>k__BackingField;    // 0x0x28
    public long <OHNFBCGPAGB>k__BackingField;    // 0x0x30
    public long <LGMMAOKKFMM>k__BackingField;    // 0x0x38
}
...
{
    public int <JCPPLJANJBI>k__BackingField;    // 0x0x10
    public int <NJCCBJKPJFB>k__BackingField;    // 0x0x14
    public int <BPNPCHBEDKF>k__BackingField;    // 0x0x18
    public int <MPCLMDDIEJH>k__BackingField;    // 0x0x1C
    public int <ELKJBPCFEIC>k__BackingField;    // 0x0x20
    public DateTime? <EOGFMDKGLBD>k__BackingField;    // 0x0x28
}
...
{
    public long <IAAIHIHJNGK>k__BackingField;    // 0x0x10
    public int <KGLOKNHNANI>k__BackingField;    // 0x0x18
    public string <OLMPKOKPCJA>k__BackingField;    // 0x0x20
    public int <NJCCBJKPJFB>k__BackingField;    // 0x0x28
    public int <FEDNBFMDJBE>k__BackingField;    // 0x0x2C
    public bool <HFLOBHAPDMP>k__BackingField;    // 0x0x30
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public HGBHMPPDCPF <Permission>k__BackingField;    // 0x0x18
    public HBMANPGAFHF <Accessibility>k__BackingField;    // 0x0x1C
...
public class ReportRequest
{
    ...
    public MANPIEDEAIB ReportCategory;    // 0x0x20
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool CBLGBFCBANG;    // 0x0x28
}
...
{
    public HOELONLNLOK? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [Auth POST]
public class PlayerCheerV1CreateRequest
{
    public HOELONLNLOK LEFFIHEAHJN;  // wrapper
...
{
    public FFGDPIFLKJN AFPGICMGECN;  // wrapper
...
{
    public JHICMAHFFEL BKKHBFLPOHJ;  // wrapper
    public int? AIFDKHHAFGE;  // wrapper
...
{
    public JOOGKHHCHGF IBMPIINAEGB;  // wrapper
...
{
    public byte[] GGEMPJLCHFC;  // wrapper
    public EFBOCJDEABB ENOIPKDCELP;  // wrapper
...
{
    public JOOGKHHCHGF CGBDEPEDNKG;  // wrapper
    public float? CLFGGIEDNEN;  // wrapper
    public bool? CHJCOJPOLCJ;  // wrapper
...
{
    public List<KPJKPOMJGHE> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public INHNKBPPFPC KMDNOIPDFGB;  // wrapper
    public INHNKBPPFPC? OCINBGMEFJF;  // wrapper
...
{
    public ChatMessage FCMDIEEAPHD;  // wrapper
    public HKLKAFJJLBO CGBDEPEDNKG;  // wrapper
...
{
    public HBMANPGAFHF MIBABAGCHGL;  // wrapper
    public HPKJGCFBJFI BFONEKMMBID;  // wrapper
    public IFFJCBFPGLA EDHOFDKHAAI;  // wrapper
    public IFFJCBFPGLA BOAJJOLCJMB;  // wrapper
...
// api/customAvatarItems/v1/{eMOKKAAEAEE}/appeal  [Auth POST]
public class CustomAvatarItemsV1EMOKKAAEAEEAppealRequest
{
    public Guid EMOKKAAEAEE;  // wrapper
}
...
{
    public PLMGCCFGIIN EDCCNPNFGNG;  // wrapper
    public INHNKBPPFPC? OFJGBHGHLGP;  // wrapper
...
{
    public DFMEGHMFNAI GHLBPHDOCGE;  // wrapper
...
// api/keepsakes/{oDKODKJAEOJ}/collect  [Auth POST]
public class KeepsakesODKODKJAEOJCollectRequest
{
    public Guid ODKODKJAEOJ;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public EPHGGIHPOKG HNFHDKNEJKO;  // wrapper
    public long? NPGHGEFGHLA;  // wrapper
...
{
    public LILFHCGDEOM OOELIKHILNN;  // wrapper
    public LILFHCGDEOM BNOJAMJEEIL;  // wrapper
    public JIFONKHMGPA HHKIJPDPGMN;  // wrapper
}
...
{
    public long? GDENKKEDKLA;  // wrapper
    public JIFONKHMGPA HHKIJPDPGMN;  // wrapper
    public long? GJFOCPJMDOG;  // wrapper
}

// api/playerevents/v2/{eventId}/time  [Auth PUT]
public class PlayereventsV2EventIdTimeRequest
{
    public DateTime HKBMMFLELAH;  // wrapper
    public DateTime CGOLOAPELPB;  // wrapper
    public JIFONKHMGPA HHKIJPDPGMN;  // wrapper
    public DateTime OPMPLBHOFCI;  // wrapper
    public DateTime ODHMGGDNOBF;  // wrapper
}
...
{
    public Guid OHAAPAFDDOE;  // wrapper
...
{
    public Guid NIBGBEJMAKN;  // wrapper
...
{
    public Guid NIBGBEJMAKN;  // wrapper
    public long? EIFACNONKHL;  // wrapper
    public byte? LDNKIGHNFBK;  // wrapper
    public int? GNADFIPFMAK;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid OHAAPAFDDOE;  // wrapper
    public long? HOMLNGKABCJ;  // wrapper
    public long? NOMOMKEEIKH;  // wrapper
    public int? MPPODDJPBCD;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> DIEJPPEOGBB;  // wrapper
...
{
    public OCEFFHPINAM BKKHBFLPOHJ;  // wrapper
    public Guid? NBPOMBJFKPO;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public JOOGKHHCHGF CGBDEPEDNKG;  // wrapper
    public long? CNKDDPBCNCP;  // wrapper
    public Guid? KLGKNBMEEHF;  // wrapper
    public int? PAHLFABPKAJ;  // wrapper
...
{
    public Guid CPKJIKBMAGA;  // wrapper
...
{
    public Guid GFKLOGFAJJI;  // wrapper
...
{
    public NAFEGJJJLME DKCGFOEDIPL;  // wrapper
}
