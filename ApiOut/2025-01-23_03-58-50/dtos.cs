...
public class ABOFJOIJJOC
{
    public Guid? <PCGLDEIGCGG>k__BackingField;    // 0x0x10
    public long? <FPKGPOPOLDN>k__BackingField;    // 0x0x28
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x38
    public string <FPEKMMLLKLC>k__BackingField;    // 0x0x40
    public string <GNDGAMDOFBA>k__BackingField;    // 0x0x48
    public CDDDFONEMOE <HENAGDCHCKL>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// AFHFOAEKNOF
//   REQUEST  PUT    api/roomconsumables   [Service.WWW]
public class AFHFOAEKNOF
{
    public Guid? <ICBLIGABEPM>k__BackingField;    // 0x0x10
    public Guid <KOCGJIKBPFJ>k__BackingField;    // 0x0x24
}
...
public class AJGFNNLJGOA
{
    public APKOCENKPGB <CAOMGLNLFCI>k__BackingField;    // 0x0x10
    public string <KGEBLFKIDHN>k__BackingField;    // 0x0x18
    public int? <IFBACLLIANF>k__BackingField;    // 0x0x20
}
...
public class BDFOHCLEFND
{
    public Guid <HBHPNNCJDCB>k__BackingField;    // 0x0x10
    public long <INBICCGDKBA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BEICMAAEKMO
//   (not directly referenced by a detected call)
public class BEICMAAEKMO
{
    public int <HECEIMMHMMD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BGFIBHGCNGK
//   (not directly referenced by a detected call)
public class BGFIBHGCNGK
{
    public CKNIDJHDIHL <GFGHILHOPNN>k__BackingField;    // 0x0x10
    public int <DLBFFFDJBLO>k__BackingField;    // 0x0x14
    public MEFLPGALOAF <IHNMHFKLNPB>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{mPLJBDJDGNI}/appeal   [Service.Auth]
...
//   RESPONSE DELETE api/keepsakes/{nOIIKCGGEGJ}   [Service.Auth]
...
public class BIIFNDDLCPA
{
    public bool <OPALOIONNBF>k__BackingField;    // 0x0x10
    public string <KBOAPHMNNKF>k__BackingField;    // 0x0x18
}
...
// BOAECONJJOJ
//   (not directly referenced by a detected call)
public class BOAECONJJOJ
{
    public long <LFAIHLOEEHO>k__BackingField;    // 0x0x10
    public long <KMNAPFJBCGG>k__BackingField;    // 0x0x18
    public int <KAGAGJEOBKE>k__BackingField;    // 0x0x20
    public DateTime <NDGFBDGJOGP>k__BackingField;    // 0x0x28
    public BCDOJLDEKLL <JENDFPDCEFI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// BPEAMBBKOOH
// base   : KBJFEOGBAAH`1<CNGCMMPLMPL>
//   RESPONSE GET    api/customAvatarItems   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.Auth]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{oDMNGNBGFDO}   [Service.Auth]
public class BPEAMBBKOOH
{
...
// CBOOPFMODLH
//   (not directly referenced by a detected call)
public class CBOOPFMODLH
{
    public int <PGCDPHDOBNH>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/progressionEvents/collect/{eBOCJAGBOEL}/{cBGJEDKKKPN}   [Service.Auth]
public class CCEIAAGBJDI
{
    public long? <HIHNLPKFBEC>k__BackingField;    // 0x0x10
    public int <KAGAGJEOBKE>k__BackingField;    // 0x0x20
    public int? <HLMFFFNFMBA>k__BackingField;    // 0x0x24
    public string <LLHLFMPFOOI>k__BackingField;    // 0x0x30
    public LBACLDBMLMM? <DANLGMMLNHJ>k__BackingField;    // 0x0x38
    public string <JHJFMDJLOPE>k__BackingField;    // 0x0x40
    public Guid? <MKKFGIOJIED>k__BackingField;    // 0x0x48
    public string <PAFBDMDLCCI>k__BackingField;    // 0x0x60
    public string <BPLFDMEJNMC>k__BackingField;    // 0x0x68
    public CKNIDJHDIHL <GFGHILHOPNN>k__BackingField;    // 0x0x70
    public int <LAAFHLBIJJB>k__BackingField;    // 0x0x74
    public int <BDEILLHCEIB>k__BackingField;    // 0x0x78
    public AAAILENFEHK <NMHNGJNHGEH>k__BackingField;    // 0x0x7C
    public JODLHDGPBDI <FGGEPPJNBIN>k__BackingField;    // 0x0x80
    public string <AFJOBNJILEN>k__BackingField;    // 0x0x88
    public DILGPODPEFI <HGGAJJEAKLM>k__BackingField;    // 0x0x90
    public IDMEJNGCKAP <NIPFNKPBDBB>k__BackingField;    // 0x0x94
    public JFDFAILMNFD? <OLBOAMHKOLK>k__BackingField;    // 0x0x98
    public bool <FMFMPKJIMAN>k__BackingField;    // 0x0xA0
    public bool <BMAKBGNFBKM>k__BackingField;    // 0x0xA1
    public string <IFHBLJIINNH>k__BackingField;    // 0x0xA8
    public bool <HEIJEOPNCJO>k__BackingField;    // 0x0xB0
    public bool FOONPNIKGHF;    // 0x0xB1
}
...
// base   : LKKGFPPLFDA
//   (not directly referenced by a detected call)
public class CCPPMAIGGDO : LKKGFPPLFDA
{
    public int <BANDCEALHDP>k__BackingField;    // 0x0x68
    public List<JIOLLCFLNHB> <PPAFKFDEKKK>k__BackingField;    // 0x0x70
    public List<JIOLLCFLNHB> <FHCKJAFHLBG>k__BackingField;    // 0x0x78
    public List<JIOLLCFLNHB> <NKHAAGCLHKL>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// CDDDFONEMOE
//   (not directly referenced by a detected call)
public class CDDDFONEMOE
{
    public long <DLBFFFDJBLO>k__BackingField;    // 0x0x10
    public Guid? <HNOPJMBFMJG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CDIGEKDICAI
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.Auth]
public class CDIGEKDICAI
{
    public List<PAGBKKPCEEG> <GDKIGENOGPL>k__BackingField;    // 0x0x10
    public NGMNJBEKKCF <MNMMMHMPBJP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CGKBBCMALDD
//   (not directly referenced by a detected call)
public class CGKBBCMALDD
{
    public FOBBIBIHDMN LOADPFHNGIK;    // 0x0x10
    public int KEJCGGDDAGG;    // 0x0x14
}
...
public class CJAOFDGKLBA
{
    public List<string> <IOELCMJFFNO>k__BackingField;    // 0x0x10
}
...
public class CLDINPBOACL
{
    public CEBHFAFMLEJ <CAOMGLNLFCI>k__BackingField;    // 0x0x10
    public long <KMNAPFJBCGG>k__BackingField;    // 0x0x18
    public string <KGEBLFKIDHN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CLNDFIDFEFM
//   RESPONSE GET    api/config/v1/azurespeech   [Service.Auth]
public class CLNDFIDFEFM
{
    public bool <JGKGGAFKEEL>k__BackingField;    // 0x0x10
    public string <NHOGIHPAFJL>k__BackingField;    // 0x0x18
    public string <ENBMKDAJOLD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// COAELBMNOIH
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.WWW]
public class COAELBMNOIH
{
    public Guid <HNOPJMBFMJG>k__BackingField;    // 0x0x10
    public int <IMCLBHIELKM>k__BackingField;    // 0x0x20
    public long <DPDKNDCICGD>k__BackingField;    // 0x0x28
    public Guid <HBHPNNCJDCB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// CPLKFKAFEHG
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.Auth]
public class CPLKFKAFEHG
{
    public CEBHFAFMLEJ <CAOMGLNLFCI>k__BackingField;    // 0x0x10
    public int <JDAALDDBEOF>k__BackingField;    // 0x0x14
    public long <PHBCLOGLDIM>k__BackingField;    // 0x0x18
    public bool <JCDJNOMEBPD>k__BackingField;    // 0x0x20
    public string <EBJBBJICIHD>k__BackingField;    // 0x0x28
    public int? <MJMDEOECPEM>k__BackingField;    // 0x0x30
    public bool <DLAHPEAJPJL>k__BackingField;    // 0x0x38
    public bool <FFBPHBOPPOD>k__BackingField;    // 0x0x39
    public bool <JHCCKCDBKPJ>k__BackingField;    // 0x0x3A
    public bool <OPIFEHMKHIF>k__BackingField;    // 0x0x3B
    public string <AGEMJENLIJO>k__BackingField;    // 0x0x40
    public DateTime? <JEHOCONGCDK>k__BackingField;    // 0x0x48
    public string <LNDMLGHDFFF>k__BackingField;    // 0x0x58
    public float <DFCBGEALJDJ>k__BackingField;    // 0x0x60
}
...
public class DGDMMKMJJOO
{
    public RoomKeyResult <KLGBAHGNDDH>k__BackingField;    // 0x0x10
    public NIOLDBPFGHD <OOJOHFHCNDE>k__BackingField;    // 0x0x18
}
...
// DMNIGLKBKEL
//   (not directly referenced by a detected call)
public class DMNIGLKBKEL
{
    public string <FFLDCLELJPB>k__BackingField;    // 0x0x10
    public APIBLPKLKGJ <JENDFPDCEFI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DMPBDDKPIBH
//   RESPONSE PUT    api/roomconsumables   [Service.WWW]
public class DMPBDDKPIBH
{
    public KABANHHEBNO <KLGBAHGNDDH>k__BackingField;    // 0x0x10
    public FGBLFCPIOMK <OGJAKCNABHN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DNBHBFAJAAK
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.WWW]
public class DNBHBFAJAAK
{
    public int OANCDJKNPNN;    // 0x0x10
    public long FENCMBHCLMD;    // 0x0x18
}

// --------------------------------------------------------------------------
// DNGOOHLEEAF
//   RESPONSE GET    api/inventions/v1/details   [Service.Auth]
public class DNGOOHLEEAF
{
    public List<DMNIGLKBKEL> <MIKMKFGHHIA>k__BackingField;    // 0x0x10
}
...
public class DPBNHKFGFHD
{
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x10
    public string <FPEKMMLLKLC>k__BackingField;    // 0x0x18
    public int? <DLBFFFDJBLO>k__BackingField;    // 0x0x20
    public GINPKJDPNDP? <MEPEEPEMAHJ>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// ELKHEHNCAMD
//   (not directly referenced by a detected call)
public class ELKHEHNCAMD
{
    public NNDNNJJNDAA <DPBJJIAHMMC>k__BackingField;    // 0x0x10
    public BOAECONJJOJ <PNLGAGEDADC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EMEEGNOHDBF
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.Auth]
public class EMEEGNOHDBF
{
    public string <HIHNLPKFBEC>k__BackingField;    // 0x0x10
    public string <NHOGIHPAFJL>k__BackingField;    // 0x0x18
    public string <ALKOHFHHOAE>k__BackingField;    // 0x0x20
    public string <FPEKMMLLKLC>k__BackingField;    // 0x0x28
    public string <DGNKHNNMFGG>k__BackingField;    // 0x0x30
    public PLCHLBABHJA <KLGBAHGNDDH>k__BackingField;    // 0x0x38
    public List<string> <MFMKNGHOAEF>k__BackingField;    // 0x0x40
    public List<string> <MIKMKFGHHIA>k__BackingField;    // 0x0x48
    public string <IKAKLBAJFPN>k__BackingField;    // 0x0x50
    public List<FMFKEFHODON> <MLENOEIBACJ>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// EMHAGBAHEJE
//   (not directly referenced by a detected call)
public class EMHAGBAHEJE
{
    public Guid <PCGLDEIGCGG>k__BackingField;    // 0x0x10
    public long <FPKGPOPOLDN>k__BackingField;    // 0x0x20
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x28
    public string <FPEKMMLLKLC>k__BackingField;    // 0x0x30
    public string <GNDGAMDOFBA>k__BackingField;    // 0x0x38
    public long <DLBFFFDJBLO>k__BackingField;    // 0x0x40
    public Guid? <KMAFNOEIJBE>k__BackingField;    // 0x0x48
    public DateTime <CJJAGFMCKEP>k__BackingField;    // 0x0x60
    public int <OJGLLIONLCH>k__BackingField;    // 0x0x68
}
...
public class FBEINOKLHLP : PJAMLCBCNHJ
{
    public BPIKNGPJJOK? <LDDPDLEBFEI>k__BackingField;    // 0x0x18
    public GOODLDBHECH <AGJPPLECGAP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FBJFHOJNMDL
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class FBJFHOJNMDL
{
    public Dictionary<Guid, JLHHCEOOHEK> <OAMHONKJOKA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FDJPIADNJHE
//   RESPONSE POST   api/inventions/v1/settags   [Service.Auth]
public class FDJPIADNJHE
{
    public IBIKBJOGOPJ <MNMMMHMPBJP>k__BackingField;    // 0x0x10
    public List<string> <MIKMKFGHHIA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FGBLFCPIOMK
//   (not directly referenced by a detected call)
public class FGBLFCPIOMK
{
    public Guid <PCGLDEIGCGG>k__BackingField;    // 0x0x10
    public int <IAGPGODJKPL>k__BackingField;    // 0x0x20
    public int <CPJOKPOMBLE>k__BackingField;    // 0x0x24
    public Guid <NFPBGPCDDNA>k__BackingField;    // 0x0x28
    public DateTime <CJJAGFMCKEP>k__BackingField;    // 0x0x38
    public EMHAGBAHEJE <PPCEABAFDFE>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// FIJKCEEKPPG
//   RESPONSE GET    api/config/v1/backtrace   [Service.Auth]
public class FIJKCEEKPPG
{
    public int <MJBPHHGJKNK>k__BackingField;    // 0x0x10
    public int <GEIBAFDFOCH>k__BackingField;    // 0x0x14
    public float <MKHFFGEEPJH>k__BackingField;    // 0x0x18
    public int <ICAIKICGFEA>k__BackingField;    // 0x0x1C
    public int <LJPCCBGMALN>k__BackingField;    // 0x0x20
    public int <ACBBLPKGABC>k__BackingField;    // 0x0x24
    public int <HGDNPFHAEIK>k__BackingField;    // 0x0x28
    public string <GNCOIKHMEPB>k__BackingField;    // 0x0x30
    public string <ENMJILMBKGI>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// FJGNGPFBCNG
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.WWW]
public class FJGNGPFBCNG
{
    public int <JDAALDDBEOF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FMFKEFHODON
//   (not directly referenced by a detected call)
public class FMFKEFHODON
{
    public DateTime <NDGFBDGJOGP>k__BackingField;    // 0x0x10
    public string <MEPDLKJJCAK>k__BackingField;    // 0x0x18
}
...
public class GGICDNJIGNA
{
    public Guid <CHKIEOJCFFM>k__BackingField;    // 0x0x10
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x20
    public string <GNDGAMDOFBA>k__BackingField;    // 0x0x28
    public DateTime <MIELHBCLALL>k__BackingField;    // 0x0x30
    public DateTime? <KADCMJKAOMC>k__BackingField;    // 0x0x38
    public List<KKMMACDDMDE> <JHFJKPEMGJP>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// GIBOIFKANBL
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.WWW]
public class GIBOIFKANBL
{
    public long <FPKGPOPOLDN>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <IGIJONGGGGA>k__BackingField;    // 0x0x18
    public KCDLIIBEFFO <GMOCJIAFKNB>k__BackingField;    // 0x0x20
}
...
public class GKILKKOIIMD
{
    public int <LOHHCKAHJPP>k__BackingField;    // 0x0x10
    public bool <IBDBHELFLJG>k__BackingField;    // 0x0x14
    public DateTime <DADEDCIMJCJ>k__BackingField;    // 0x0x18
    public bool <HEILKNNFKOK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GOODLDBHECH
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.WWW]
public class GOODLDBHECH
{
    public int <IAGPGODJKPL>k__BackingField;    // 0x0x10
    public Guid <HNOPJMBFMJG>k__BackingField;    // 0x0x14
    public long <PHLDLDHCHHN>k__BackingField;    // 0x0x28
    public DateTime <CJJAGFMCKEP>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// HJBPEOHGKPC
//   (not directly referenced by a detected call)
public class HJBPEOHGKPC
{
    public float <PAMJHDKEHNC>k__BackingField;    // 0x0x10
    public float <DJKADCBFADO>k__BackingField;    // 0x0x14
    public float <ENOMHLNAEFL>k__BackingField;    // 0x0x18
    public float <NHKCHCPAMLG>k__BackingField;    // 0x0x1C
    public float <FKDCNJJHKCG>k__BackingField;    // 0x0x20
    public float <GCJHGIJOIDP>k__BackingField;    // 0x0x24
    public float <KGELJACMDDN>k__BackingField;    // 0x0x28
    public float <LGDDLNAIDNK>k__BackingField;    // 0x0x2C
}
...
public class HMHAJDAHAPE
{
    public KJGKAAFOICN <DPBJJIAHMMC>k__BackingField;    // 0x0x10
    public NGMNJBEKKCF <MNMMMHMPBJP>k__BackingField;    // 0x0x18
    public FDJPIADNJHE <CPPGBECBMIB>k__BackingField;    // 0x0x20
}
...
//   (not directly referenced by a detected call)
public class HMKFGHFJBCL : ValueType
{
    public Guid PLMJELCKKDA;    // 0x0x0
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class IHDHEKBLLBJ : ValueType
{
    public MCDELACKOKB DBMCPGPBMPA;    // 0x0x0
    public HMKFGHFJBCL PIDHJMIBNKL;    // 0x0x10
    public Guid MFPEPNKMCBA;    // 0x0x20
}

// --------------------------------------------------------------------------
// IJIPLANDFPA
//   (not directly referenced by a detected call)
public class IJIPLANDFPA
{
    public int <DCDMGGLHECN>k__BackingField;    // 0x0x10
    public string <HGJDDLCLNGG>k__BackingField;    // 0x0x18
    public string <DINBGHEDOKH>k__BackingField;    // 0x0x20
    public string <FOAPCGKBPDI>k__BackingField;    // 0x0x28
    public string <LLHLFMPFOOI>k__BackingField;    // 0x0x30
    public IHDHEKBLLBJ? <OBPAJKELCFM>k__BackingField;    // 0x0x38
    public string <JHJFMDJLOPE>k__BackingField;    // 0x0x70
    public Guid? <MKKFGIOJIED>k__BackingField;    // 0x0x78
    public LBACLDBMLMM? <DANLGMMLNHJ>k__BackingField;    // 0x0x8C
    public string <PAFBDMDLCCI>k__BackingField;    // 0x0x98
    public string <BPLFDMEJNMC>k__BackingField;    // 0x0xA0
    public bool <BLGBKPIGJIE>k__BackingField;    // 0x0xA8
    public bool <BLBLAEPFAPJ>k__BackingField;    // 0x0xA9
    public bool <ADCGCHHLMNH>k__BackingField;    // 0x0xAA
    public JODLHDGPBDI <GDGNEGNAGPD>k__BackingField;    // 0x0xAC
    public CKNIDJHDIHL <GFGHILHOPNN>k__BackingField;    // 0x0xB0
    public int <LAAFHLBIJJB>k__BackingField;    // 0x0xB4
    public GGDCCPBAPLE <LNGLJLICAGM>k__BackingField;    // 0x0xB8
    public AAAILENFEHK <OHJMIHBLILH>k__BackingField;    // 0x0xBC
    public int? <POGNGEHHGKK>k__BackingField;    // 0x0xC0
    public string <FIDEEINNFFI>k__BackingField;    // 0x0xC8
    public int? <MKANKAEKKPE>k__BackingField;    // 0x0xD0
    public int? <ODBNIHBPAKD>k__BackingField;    // 0x0xD8
    public string <IADDAGBDOFC>k__BackingField;    // 0x0xE0
}
...
public class IPHIHEAOMPG
{
    public List<string> <LFACIICNGPN>k__BackingField;    // 0x0x10
    public List<string> <MPFLFIJPEID>k__BackingField;    // 0x0x18
    public List<string> <KNBPJBFAAOH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IPLEMILOPMI
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.WWW]
public class IPLEMILOPMI
{
    public List<int> <LCMEBILGKHM>k__BackingField;    // 0x0x10
    public string <LNJDKMPNOCL>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JALAJEFPJOL
//   RESPONSE GET    api/playerevents/v1/all   [Service.Auth]
//   RESPONSE GET    api/playerevents/v1/all/{oLKCJJDGMPH}   [Service.Auth]
public class JALAJEFPJOL
{
    public List<NNDNNJJNDAA> <EKAFNMNKHDH>k__BackingField;    // 0x0x10
    public List<ELKHEHNCAMD> <GHHLMNDLPCM>k__BackingField;    // 0x0x18
}
...
// JIOLLCFLNHB
//   (not directly referenced by a detected call)
public class JIOLLCFLNHB
{
    public bool <EPBPOHAJGPB>k__BackingField;    // 0x0x10
    public IJIPLANDFPA <LKEJEBJDJFD>k__BackingField;    // 0x0x18
    public float <GDIEBBBGJNG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JLHHCEOOHEK
//   (not directly referenced by a detected call)
public class JLHHCEOOHEK
{
    public int <FHOIKCDFLDI>k__BackingField;    // 0x0x10
    public AFHFOAEKNOF <JFPOMNACFKL>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{gNOIOIJMMDN}   [Service.WWW]
public class JOJMNPGABFB
{
    public KABANHHEBNO <KLGBAHGNDDH>k__BackingField;    // 0x0x10
    public EMHAGBAHEJE <PPCEABAFDFE>k__BackingField;    // 0x0x18
}
...
public class KHBKPMGOPOK
{
    public int <PDJJMCCNMAN>k__BackingField;    // 0x0x10
    public int <LOHHCKAHJPP>k__BackingField;    // 0x0x14
    public float <HALGOPOGAPI>k__BackingField;    // 0x0x18
    public float <BPBCHHCDNNG>k__BackingField;    // 0x0x1C
    public bool <IBDBHELFLJG>k__BackingField;    // 0x0x20
    public bool <FPFPENHAHLM>k__BackingField;    // 0x0x21
    public bool <GNIAHHDBNAN>k__BackingField;    // 0x0x22
}
...
public class KJGKAAFOICN : NNDNNJJNDAA
{
    public List<DMNIGLKBKEL> <MIKMKFGHHIA>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// KKMMACDDMDE
//   (not directly referenced by a detected call)
public class KKMMACDDMDE
{
    public Guid <NBIACMBDNCA>k__BackingField;    // 0x0x10
    public Guid <MMOPAMAIELD>k__BackingField;    // 0x0x20
    public DateTime <MIELHBCLALL>k__BackingField;    // 0x0x30
    public List<IJIPLANDFPA> <KJBLKICKFPD>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// KKPOAFMBFHN
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.Auth]
public class KKPOAFMBFHN
{
    public int? <PBIIJPKNBDH>k__BackingField;    // 0x0x10
    public string <DGNKHNNMFGG>k__BackingField;    // 0x0x18
    public string <MLJHJEEEOIK>k__BackingField;    // 0x0x20
}
...
//   RESPONSE GET    api/storefronts/v1/season/{nOOJJDJAKDL}   [Service.WWW]
public class KPIDEMCBHCB : POEPFFJHMMP
{
    public int <HFJJKGFJJIM>k__BackingField;    // 0x0x30
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x38
    public DateTime <MIELHBCLALL>k__BackingField;    // 0x0x40
    public DateTime <JHJPHEHCJPD>k__BackingField;    // 0x0x48
    public CKNIDJHDIHL <GFGHILHOPNN>k__BackingField;    // 0x0x50
    public LKKGFPPLFDA <OFGILCKAPMH>k__BackingField;    // 0x0x58
    public List<CCPPMAIGGDO> <BMMDJGEHBCI>k__BackingField;    // 0x0x60
    public LFGKJLOGGEA <HALBGLBIOLC>k__BackingField;    // 0x0x68
}
...
public class LABAJAHKNPA
{
    public long <FPKGPOPOLDN>k__BackingField;    // 0x0x10
    public long? <BDAKLIEHCNJ>k__BackingField;    // 0x0x18
    public long? <AOJOANMLKEM>k__BackingField;    // 0x0x28
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x38
    public string <FPEKMMLLKLC>k__BackingField;    // 0x0x40
    public List<string> <MIKMKFGHHIA>k__BackingField;    // 0x0x48
    public string <GNDGAMDOFBA>k__BackingField;    // 0x0x50
    public DateTime <LDOMAIOMHPG>k__BackingField;    // 0x0x58
    public DateTime <DMMJONIDLBI>k__BackingField;    // 0x0x60
    public KOIENNMECMK <MEPEEPEMAHJ>k__BackingField;    // 0x0x68
    public bool <GNMCPMPIIJJ>k__BackingField;    // 0x0x6C
    public bool <HMDFCNOIBEO>k__BackingField;    // 0x0x6D
    public KPBJMCBAOAO <DANKBPANPBG>k__BackingField;    // 0x0x70
    public KPBJMCBAOAO <OJCJINKEGJH>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// LADMHBAJLOA
//   (not directly referenced by a detected call)
public class LADMHBAJLOA
{
    public int <JPAAOIOENOG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LAOJHEMDJHM
//   RESPONSE GET    api/config/v2   [Service.Auth]
public class LAOJHEMDJHM
{
    public Dictionary<int, int> <JLCPFCFHIKH>k__BackingField;    // 0x0x10
    public List<DCBLAJNAPIB> <OCMFDGCEBAN>k__BackingField;    // 0x0x18
    public CGKBBCMALDD[][] <HANEMCJNOCJ>k__BackingField;    // 0x0x20
    public LADMHBAJLOA <LPIJNINHFAF>k__BackingField;    // 0x0x28
    public HJBPEOHGKPC <HGJCEAKCGOC>k__BackingField;    // 0x0x30
    public BEICMAAEKMO <NMMALPNKNNO>k__BackingField;    // 0x0x38
    public CBOOPFMODLH <CMJMFBNEODK>k__BackingField;    // 0x0x40
    public LPMGMHNABIN <HCOMPKDMFLL>k__BackingField;    // 0x0x48
    public string <KHNFOKOHHLI>k__BackingField;    // 0x0x50
}
...
// LFGKJLOGGEA
//   (not directly referenced by a detected call)
public class LFGKJLOGGEA
{
    public bool <CBGGOOEGANI>k__BackingField;    // 0x0x10
    public IDMEJNGCKAP <FAOGPHGJBDA>k__BackingField;    // 0x0x14
    public int <EAGHIHLEIBH>k__BackingField;    // 0x0x18
    public DateTime <CJJAGFMCKEP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LGBPMCOEBAC
//   RESPONSE GET    api/testcasemanagement/   [Service.Auth]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{dOBPKLNCBDO}   [Service.Auth]
public class LGBPMCOEBAC
{
    public uint <HIHNLPKFBEC>k__BackingField;    // 0x0x10
    public uint? <OALBBIEEKCJ>k__BackingField;    // 0x0x14
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x20
    public string <FPEKMMLLKLC>k__BackingField;    // 0x0x28
    public DateTime <BFPMOIFEABN>k__BackingField;    // 0x0x30
    public DateTime? <OPMAEHJHCED>k__BackingField;    // 0x0x38
    public bool <MIBPJIGNEJO>k__BackingField;    // 0x0x48
    public List<EMEEGNOHDBF> <MCMDAFDPBBJ>k__BackingField;    // 0x0x50
    public List<string> <MIKMKFGHHIA>k__BackingField;    // 0x0x58
    public int <JFDHLPHNILP>k__BackingField;    // 0x0x60
    public int <PADNJCBNIPJ>k__BackingField;    // 0x0x64
    public int <BJBIKNJAOPF>k__BackingField;    // 0x0x68
}
...
public class LHNGIHELMCE : PJAMLCBCNHJ
{
    public CILOOCPPPIG? <LDDPDLEBFEI>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <DAEPPPGHFLA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LKKGFPPLFDA
//   (not directly referenced by a detected call)
public class LKKGFPPLFDA
{
    public int <EKGECBANICO>k__BackingField;    // 0x0x10
    public PCEJINPMGEM <JENDFPDCEFI>k__BackingField;    // 0x0x14
    public List<BGFIBHGCNGK> <IECHGFDDHDE>k__BackingField;    // 0x0x18
    public List<BGFIBHGCNGK> <BHPOOMMMKDA>k__BackingField;    // 0x0x20
    public bool <IPCEBMCGNPJ>k__BackingField;    // 0x0x28
    public DateTime? <EMFDNNDJPIB>k__BackingField;    // 0x0x30
    public DateTime? <BOJBHLFHKAP>k__BackingField;    // 0x0x40
    public DateTime? <NLNDJGHJPPH>k__BackingField;    // 0x0x50
    public bool <CCBCMBNAFAK>k__BackingField;    // 0x0x60
    public bool <IJGEFPKDCDH>k__BackingField;    // 0x0x61
}

// --------------------------------------------------------------------------
// LPMGMHNABIN
//   (not directly referenced by a detected call)
public class LPMGMHNABIN
{
    public float <AKIDOFFALME>k__BackingField;    // 0x0x10
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class MCDELACKOKB : ValueType
{
    public Guid PLMJELCKKDA;    // 0x0x0
}
...
public class MEBIAGJAKEM
{
    public List<NCMGMLINMBH> <KJPPOAJELND>k__BackingField;    // 0x0x10
    public string <LNJDKMPNOCL>k__BackingField;    // 0x0x18
}
...
// MEFLPGALOAF
//   (not directly referenced by a detected call)
public class MEFLPGALOAF
{
    public int <HBJDMLOGBMA>k__BackingField;    // 0x0x10
    public DateTime? <PAFDCOKAJBL>k__BackingField;    // 0x0x18
    public DateTime? <HKJOCAAKFPE>k__BackingField;    // 0x0x28
}
...
public class MGMKMDDFFMJ
{
    public AFHFOAEKNOF <JFPOMNACFKL>k__BackingField;    // 0x0x10
    public CDDDFONEMOE <MJJMHPBPDNP>k__BackingField;    // 0x0x18
    public int <FHOIKCDFLDI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MJBDDDPJMJJ
//   RESPONSE GET    api/storefronts/   [Service.WWW]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{bNJCADMAIFI}/{oGPABFEOEPD}   [Service.WWW]
public class MJBDDDPJMJJ
{
    public CKNIDJHDIHL <GFGHILHOPNN>k__BackingField;    // 0x0x10
    public DJCEPFNBLJN <FFOMEJAOMKH>k__BackingField;    // 0x0x14
    public int <LGMHLAKJOID>k__BackingField;    // 0x0x18
    public int <OJAPAAJIKCH>k__BackingField;    // 0x0x1C
    public int <JAALFJJHNIM>k__BackingField;    // 0x0x20
    public OOEPBDOCGIE <GBBLNDAJPJI>k__BackingField;    // 0x0x24
    public bool <NENILIOLJKL>k__BackingField;    // 0x0x28
    public float <ADBKHFABMGO>k__BackingField;    // 0x0x2C
    public int <DFKCMGJBCFG>k__BackingField;    // 0x0x30
    public bool <MDIDHEEOMCL>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// MNIJEAFKFND
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.Auth]
public class MNIJEAFKFND
{
    public List<long> <LAGOGBPPODB>k__BackingField;    // 0x0x10
    public HBDDGLMFBOI <JENDFPDCEFI>k__BackingField;    // 0x0x18
    public string <JNFHENHAICF>k__BackingField;    // 0x0x20
    public long? <FPKGPOPOLDN>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// MPEHOGPJBOK
// base   : KBJFEOGBAAH`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.Auth]
public class MPEHOGPJBOK
{
    // (no instance fields in the metadata dump)
}
...
public class MPGGMBGEKCJ
{
    public List<NNDNNJJNDAA> <MGKDDKMBIFB>k__BackingField;    // 0x0x10
    public string <LNJDKMPNOCL>k__BackingField;    // 0x0x18
}
...
public class MPINDPILCKF
{
    public long <ILIILNOKKED>k__BackingField;    // 0x0x10
    public int <IAGPGODJKPL>k__BackingField;    // 0x0x18
}
...
// NCMGMLINMBH
//   (not directly referenced by a detected call)
public class NCMGMLINMBH
{
    public int <KLBMNJNEHIE>k__BackingField;    // 0x0x10
    public DateTime <NDGFBDGJOGP>k__BackingField;    // 0x0x18
    public DateTime? <IDBDIKDPAGG>k__BackingField;    // 0x0x20
}
...
// NIOLDBPFGHD
//   (not directly referenced by a detected call)
public class NIOLDBPFGHD
{
    public long <ILIILNOKKED>k__BackingField;    // 0x0x10
    public Guid <KLPFFNLIBDL>k__BackingField;    // 0x0x18
    public long <FPKGPOPOLDN>k__BackingField;    // 0x0x28
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x30
    public string <FPEKMMLLKLC>k__BackingField;    // 0x0x38
    public int <DLBFFFDJBLO>k__BackingField;    // 0x0x40
    public Guid? <KMAFNOEIJBE>k__BackingField;    // 0x0x44
    public DateTime <NDGFBDGJOGP>k__BackingField;    // 0x0x58
    public string <GNDGAMDOFBA>k__BackingField;    // 0x0x60
    public BKLPOAGACGM <JENDFPDCEFI>k__BackingField;    // 0x0x68
}
...
public class NMFLOPHEBCE
{
    public bool <OPALOIONNBF>k__BackingField;    // 0x0x10
    public string <EBJBBJICIHD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NNDNNJJNDAA
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.Auth]
public class NNDNNJJNDAA
{
    public long <KMNAPFJBCGG>k__BackingField;    // 0x0x10
    public int <JGLLBDEENNC>k__BackingField;    // 0x0x18
    public long <FPKGPOPOLDN>k__BackingField;    // 0x0x20
    public long? <BDAKLIEHCNJ>k__BackingField;    // 0x0x28
    public long? <AOJOANMLKEM>k__BackingField;    // 0x0x38
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x48
    public string <FPEKMMLLKLC>k__BackingField;    // 0x0x50
    public string <GNDGAMDOFBA>k__BackingField;    // 0x0x58
    public DateTime <LDOMAIOMHPG>k__BackingField;    // 0x0x60
    public DateTime <DMMJONIDLBI>k__BackingField;    // 0x0x68
    public int <JCLIDJJGFCB>k__BackingField;    // 0x0x70
    public KOIENNMECMK <MEPEEPEMAHJ>k__BackingField;    // 0x0x74
    public bool <GNMCPMPIIJJ>k__BackingField;    // 0x0x78
    public bool <HMDFCNOIBEO>k__BackingField;    // 0x0x79
    public KPBJMCBAOAO <DANKBPANPBG>k__BackingField;    // 0x0x7C
    public KPBJMCBAOAO <OJCJINKEGJH>k__BackingField;    // 0x0x80
    public long? <CALANGCBABL>k__BackingField;    // 0x0x88
}
...
public class OBBIMEGBHBH
{
    public LBACLDBMLMM <DANLGMMLNHJ>k__BackingField;    // 0x0x10
    public string <OOGCLLJBDKH>k__BackingField;    // 0x0x18
    public string <HGJDDLCLNGG>k__BackingField;    // 0x0x20
    public string <DINBGHEDOKH>k__BackingField;    // 0x0x28
    public JODLHDGPBDI <GDGNEGNAGPD>k__BackingField;    // 0x0x30
    public string <FOAPCGKBPDI>k__BackingField;    // 0x0x38
    public int <MKANKAEKKPE>k__BackingField;    // 0x0x40
    public bool <LKFJFABGMLN>k__BackingField;    // 0x0x44
    public string <DECKIPHCJDM>k__BackingField;    // 0x0x48
    public DateTime <NDGFBDGJOGP>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// OEBLDPAGBFM
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.WWW]
public class OEBLDPAGBFM
{
    public Dictionary<Guid, DMPBDDKPIBH> <OPCDEGCCOGD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OEFHICJCANN
//   REQUEST  POST   api/equipment/v1/update   [Service.WWW]
public class OEFHICJCANN
{
    public string <DGKLPFNJNOM>k__BackingField;    // 0x0x10
    public string <FMDINEOELHB>k__BackingField;    // 0x0x18
    public string <HGJDDLCLNGG>k__BackingField;    // 0x0x20
    public string <DINBGHEDOKH>k__BackingField;    // 0x0x28
    public JODLHDGPBDI <GDGNEGNAGPD>k__BackingField;    // 0x0x30
    public string <IADDAGBDOFC>k__BackingField;    // 0x0x38
    public bool KKNNEIGEIPM;    // 0x0x40
    public bool <GNIAHHDBNAN>k__BackingField;    // 0x0x41
}

// --------------------------------------------------------------------------
// OJAGMPMIHPD
//   REQUEST  POST   api/relationships/v2/updateVoiceVolume   [Service.Auth]
public class OJAGMPMIHPD
{
    public int <KAGAGJEOBKE>k__BackingField;    // 0x0x10
    public byte <JKJDNENEGFP>k__BackingField;    // 0x0x14
}
...
public class OLKBFEDKODN
{
    public int <MHKJMMMLIEF>k__BackingField;    // 0x0x10
    public HBMFLGALDMK <JENDFPDCEFI>k__BackingField;    // 0x0x14
    public GPNIHEFNHOB <CHCFNIBCIGF>k__BackingField;    // 0x0x18
    public GPNIHEFNHOB <KLDGFBDBONC>k__BackingField;    // 0x0x1C
    public GPNIHEFNHOB <OBFDCHBCFLL>k__BackingField;    // 0x0x20
    public byte? <JKJDNENEGFP>k__BackingField;    // 0x0x24
}
...
// PAGBKKPCEEG
//   (not directly referenced by a detected call)
public class PAGBKKPCEEG
{
    public int <BMDDDCIHCEK>k__BackingField;    // 0x0x10
    public NGMNJBEKKCF <MNMMMHMPBJP>k__BackingField;    // 0x0x14
}
...
public class PGACIGIEIBG
{
    public NGMNJBEKKCF <MNMMMHMPBJP>k__BackingField;    // 0x0x10
}
...
public class POCEPHNNBNM
{
    public long <KMNAPFJBCGG>k__BackingField;    // 0x0x10
    public BCDOJLDEKLL <JENDFPDCEFI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// POMCLLLLLEP
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.Auth]
public class POMCLLLLLEP
{
    public int <IFHBFKLCMOO>k__BackingField;    // 0x0x10
    public int? <NPENNJKELLN>k__BackingField;    // 0x0x14
    public string <HCCHMDICJIB>k__BackingField;    // 0x0x20
    public string <ABIEFGGNOMF>k__BackingField;    // 0x0x28
}
...
public class AddKeepsakeInstanceRequest
{
    public long <FPKGPOPOLDN>k__BackingField;    // 0x0x10
    public long? <BDAKLIEHCNJ>k__BackingField;    // 0x0x18
    public NHCLBNIPKNG <DNBIANLOMKI>k__BackingField;    // 0x0x28
}
...
{
    public NFFBPFHPHBJ <MNMMMHMPBJP>k__BackingField;    // 0x0x10
    public string <ECHEFLDNOAL>k__BackingField;    // 0x0x18
    public string <BCOHBDLOPDA>k__BackingField;    // 0x0x20
    public string <MEJELOMPMOM>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public CKNIDJHDIHL <CurrencyType>k__BackingField;    // 0x0x18
    public JFDFAILMNFD <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public long <KMNAPFJBCGG>k__BackingField;    // 0x0x10
    public long? <HKBICDFHLDC>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public HEPHHAPMANA FilterType;    // 0x0x20
...
{
    public NHCLBNIPKNG <BFNADBCJEMG>k__BackingField;    // 0x0x10
    public string <LJFPGMFGNMP>k__BackingField;    // 0x0x18
    public int <GGLBAEBCPCJ>k__BackingField;    // 0x0x20
    public int <NKOHFLLFGNM>k__BackingField;    // 0x0x24
    public string <PJGJJLHPEJG>k__BackingField;    // 0x0x28
    public string <GGBJDJKOADA>k__BackingField;    // 0x0x30
}
...
{
    public int <IAGPGODJKPL>k__BackingField;    // 0x0x10
    public Guid <INJIDCJNGKP>k__BackingField;    // 0x0x14
    public DateTime <HDICPOCGHAP>k__BackingField;    // 0x0x28
}
...
{
    public bool <JMKOGMKMEBD>k__BackingField;    // 0x0x10
    public int <INLLAIBIOFE>k__BackingField;    // 0x0x14
    public bool <CIOCNMHJINF>k__BackingField;    // 0x0x18
}
...
{
    public Guid <INJIDCJNGKP>k__BackingField;    // 0x0x10
    public NHCLBNIPKNG <DMEPNFNKBEI>k__BackingField;    // 0x0x20
    public int <NJOIHJBAJCB>k__BackingField;    // 0x0x24
    public long <FPKGPOPOLDN>k__BackingField;    // 0x0x28
    public long? <BDAKLIEHCNJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.Auth]
//   RESPONSE GET    api/keepsakes/events/{cOAIJBNLMGB}   [Service.Auth]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <LHCBLNMILJF>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <ACHIOGPMJME>k__BackingField;    // 0x0x18
}
...
{
    public long <PIBECCOMJLJ>k__BackingField;    // 0x0x10
    public long <FPKGPOPOLDN>k__BackingField;    // 0x0x18
    public long <KMNONEIAEBH>k__BackingField;    // 0x0x20
    public BIFKICKCOCB <JENDFPDCEFI>k__BackingField;    // 0x0x28
    public int <AGBBOFDKNDF>k__BackingField;    // 0x0x2C
}
...
{
    public long <FPKGPOPOLDN>k__BackingField;    // 0x0x10
    public List<Guid> <AOBCAJEFHMM>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <LHCBLNMILJF>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <ACHIOGPMJME>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <DJEDDKPCNFD>k__BackingField;    // 0x0x20
}
...
{
    public long <KMNONEIAEBH>k__BackingField;    // 0x0x10
    public long <JMGMPPCDBID>k__BackingField;    // 0x0x18
    public int? <ONNDFGGIBKI>k__BackingField;    // 0x0x20
    public int? <CALGBLCAHAG>k__BackingField;    // 0x0x28
    public long? <PFNMDBGCEEG>k__BackingField;    // 0x0x30
    public long <DODBANOCMAF>k__BackingField;    // 0x0x40
    public long <PEKPNIHHHGE>k__BackingField;    // 0x0x48
    public int <APDPHGGCJBD>k__BackingField;    // 0x0x50
    public BIFKICKCOCB <FNGGCNKLOEE>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <OPFKECHBFEB>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public AAAILENFEHK <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public NBGFMFDOHOO creatorAccountRole;    // 0x0x60
...
{
    public AIEMFIBKCDC <BEGMKLIHGPN>k__BackingField;    // 0x0x10
    public MIMOFGMEJCK <MOCBMMLLDGH>k__BackingField;    // 0x0x14
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x18
    public string <FPEKMMLLKLC>k__BackingField;    // 0x0x20
    public bool <GDHAJPIPHOE>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<AIEMFIBKCDC> <NMIOJCPAKDB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.Auth]
//   RESPONSE GET    api/progressionEvents/event/{eBOCJAGBOEL}   [Service.Auth]
public class ProgressionEventDTO
{
    public long <JMGMPPCDBID>k__BackingField;    // 0x0x10
    public string <DKFGOAACKKC>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <NKHAAGCLHKL>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <KIIIMHLECBC>k__BackingField;    // 0x0x28
    public DateTime <LDOMAIOMHPG>k__BackingField;    // 0x0x30
    public DateTime <DMMJONIDLBI>k__BackingField;    // 0x0x38
    public DateTime <APNIIBLKGAI>k__BackingField;    // 0x0x40
    public bool <BNHKOJLHDDN>k__BackingField;    // 0x0x48
    public int <PHIIDBLNHJL>k__BackingField;    // 0x0x4C
    public float <MOAKGFMDOJO>k__BackingField;    // 0x0x50
    public Guid? <DJBIIFEDKMM>k__BackingField;    // 0x0x54
    public string <GEDEOBLFBGP>k__BackingField;    // 0x0x68
    public string <NCHFENGJOBH>k__BackingField;    // 0x0x70
    public string <ICLAOKLFHAF>k__BackingField;    // 0x0x78
    public string <DOBGNEEEEOJ>k__BackingField;    // 0x0x80
}
...
{
    public Guid <AGAHNJFNCJL>k__BackingField;    // 0x0x10
    public int <IBJDAKLCEDM>k__BackingField;    // 0x0x20
    public int <JAFMAECPPNP>k__BackingField;    // 0x0x24
    public int <ANECKAKPJCC>k__BackingField;    // 0x0x28
    public long <GBODFCODJMF>k__BackingField;    // 0x0x30
    public long <JNHDDKENLHO>k__BackingField;    // 0x0x38
}
...
{
    public int <IAGPGODJKPL>k__BackingField;    // 0x0x10
    public int <BDEILLHCEIB>k__BackingField;    // 0x0x14
    public int <EJFHDDLLGEG>k__BackingField;    // 0x0x18
    public int <NJMDNBPBLAC>k__BackingField;    // 0x0x1C
    public int <DFMBNILACMB>k__BackingField;    // 0x0x20
    public DateTime? <NDIELHLOOPF>k__BackingField;    // 0x0x28
}
...
{
    public long <DOHNKFCDJJI>k__BackingField;    // 0x0x10
    public int <DCDMGGLHECN>k__BackingField;    // 0x0x18
    public string <GNDGAMDOFBA>k__BackingField;    // 0x0x20
    public int <BDEILLHCEIB>k__BackingField;    // 0x0x28
    public int <EGINKEJNINK>k__BackingField;    // 0x0x2C
    public bool <PNLCMAMGNEA>k__BackingField;    // 0x0x30
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public MEODFHIGGGL <Permission>k__BackingField;    // 0x0x18
    public GINPKJDPNDP <Accessibility>k__BackingField;    // 0x0x1C
...
public class ReportRequest
{
    ...
    public JPPPJEPFBDH ReportCategory;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{jNMPEGAKHOM}   [Service.WWW]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool DGFMPIMNJCI;    // 0x0x28
}
...
{
    public FLACDECABJI? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [Auth POST]
public class PlayerCheerV1CreateRequest
{
    public FLACDECABJI KAOMCKKLHON;  // wrapper
...
{
    public DILGPODPEFI HBFEGFOHKBA;  // wrapper
...
{
    public LLONFBDKGHE OCLAPBNMMGE;  // wrapper
    public int? AKMDEDEINPH;  // wrapper
...
{
    public CEBHFAFMLEJ OOPGLAGBEFO;  // wrapper
...
{
    public byte[] EBNFOODJNOB;  // wrapper
    public HNMHGNEBEPL NAIOMCCNHHN;  // wrapper
...
{
    public CEBHFAFMLEJ GHDOGIJEAFO;  // wrapper
    public float? BFGADLPMHBH;  // wrapper
    public bool? PJILFJIFDMH;  // wrapper
...
{
    public List<IHDHEKBLLBJ> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [WWW POST]
public class AvatarV2GiftsGenerateRequest
{
    public AAAILENFEHK IKGPEBFFMPK;  // wrapper
    public AAAILENFEHK? DENBEBIJOOG;  // wrapper
...
{
    public ChatMessage PJFOMDHJLBF;  // wrapper
    public LJGPLJNFMFF GHDOGIJEAFO;  // wrapper
...
{
    public GINPKJDPNDP EJEAMKBKGJE;  // wrapper
    public DPJPOONOFHK CBIKFPMAOBJ;  // wrapper
    public HDODNHCNBJO FBINEFPOIJE;  // wrapper
    public HDODNHCNBJO BDPHBJFPMAG;  // wrapper
...
// api/customAvatarItems/v1/{mPLJBDJDGNI}/appeal  [Auth POST]
public class CustomAvatarItemsV1MPLJBDJDGNIAppealRequest
{
    public Guid MPLJBDJDGNI;  // wrapper
}
...
{
    public MOBADHDKKBJ HBIAFFCJNJB;  // wrapper
    public AAAILENFEHK? JKDECIJJHIF;  // wrapper
...
{
    public JHJHLJOPPHK MHIHIMJIIAN;  // wrapper
...
// api/keepsakes/{nOIIKCGGEGJ}/collect  [Auth POST]
public class KeepsakesNOIIKCGGEGJCollectRequest
{
    public Guid NOIIKCGGEGJ;  // wrapper
}

// api/messages/v2/send  [Auth POST]
public class MessagesV2SendRequest
{
    public HBDDGLMFBOI BJLPLJEIHCA;  // wrapper
    public long? NKDNOGOOODN;  // wrapper
...
{
    public NNDNNJJNDAA HNKEDPMPMLG;  // wrapper
    public KOIENNMECMK JNKNFAIOPDF;  // wrapper
    public KOIENNMECMK EJEAMKBKGJE;  // wrapper
}
...
{
    public NNDNNJJNDAA HNKEDPMPMLG;  // wrapper
    public long? PJNGKOFPCDP;  // wrapper
    public long? EKJEMBIMAIM;  // wrapper
}
...
{
    public NNDNNJJNDAA HNKEDPMPMLG;  // wrapper
    public KPBJMCBAOAO JLOPCMHDCLO;  // wrapper
    public KPBJMCBAOAO AGADGAOICHA;  // wrapper
}
...
{
    public NNDNNJJNDAA HNKEDPMPMLG;  // wrapper
    public long? BNHBDBALLKF;  // wrapper
    public long? IFPDLCPBOCG;  // wrapper
}
...
{
    public NNDNNJJNDAA HNKEDPMPMLG;  // wrapper
    public DateTime PIBFKNPJCKL;  // wrapper
    public DateTime OENMLMACAIN;  // wrapper
    public DateTime MFGGKOGDNHE;  // wrapper
    public DateTime BGOLCJDOLMA;  // wrapper
}
...
{
    public Guid NNKADIEBAID;  // wrapper
...
{
    public Guid KIBLIDHMJAK;  // wrapper
...
{
    public Guid KIBLIDHMJAK;  // wrapper
    public long? DOJBBJBKGHE;  // wrapper
    public byte? LJMPACNDPEI;  // wrapper
    public int? LCDEMOPFJEN;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid NNKADIEBAID;  // wrapper
    public long? CFHHNEODIHH;  // wrapper
    public long? MIGPECMPKAB;  // wrapper
    public int? LLGFFJCGDJC;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> OFGFBCNFINC;  // wrapper
...
{
    public BKLPOAGACGM OCLAPBNMMGE;  // wrapper
    public Guid? POKDGJMHOPM;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public CEBHFAFMLEJ GHDOGIJEAFO;  // wrapper
    public long? DNDNELCAGOK;  // wrapper
    public Guid? NCHFIJAMPNO;  // wrapper
    public int? IAACKFKCKDB;  // wrapper
...
{
    public Guid FHOJBJMCLFB;  // wrapper
...
{
    public Guid PIMLKCGEMKF;  // wrapper
...
{
    public PLCHLBABHJA BEBBFPELPIA;  // wrapper
}
