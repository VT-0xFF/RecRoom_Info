...
{
    public string <GBBMJJKENLB>k__BackingField;    // 0x0x10
    public int <BKPOGOCOFAC>k__BackingField;    // 0x0x18
}
...
//   REQUEST  PUT    api/inventions/v1/accessibility   [Service.Auth]
public class SetInventionVersionAccessibilityRequest
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public int <VersionNumber>k__BackingField;    // 0x0x18
    public IKKNJNIMHHO <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
{
    public KAKJLAMFNPB OPIPKPFJMCN;  // wrapper
}
...
public class PlayereventsV2EventIdAccessibilityRequest
{
    ...
    public KAKJLAMFNPB OPIPKPFJMCN;  // wrapper
    public KLJDDMEKMOO BAJPEOJJMNH;  // wrapper
}
...
public class PlayereventsV2EventIdClubRequest
{
    ...
    public KAKJLAMFNPB OPIPKPFJMCN;  // wrapper
    public long? CLMIKMLKIAB;  // wrapper
}
...
public class PlayereventsV2EventIdRoomRequest
{
    ...
    public KAKJLAMFNPB OPIPKPFJMCN;  // wrapper
    public long? PGAJEKBCLGL;  // wrapper
}
...
public class PlayereventsV2EventIdTimeRequest
{
    ...
    public KAKJLAMFNPB OPIPKPFJMCN;  // wrapper
    public DateTime LCFMCCFEMPJ;  // wrapper
    public DateTime BGDLGPKDAMI;  // wrapper
}
