...
public class AECEBLCGDEC
{
    public List<HKECKNILIOK> <ALOEKEBFJOE>k__BackingField;    // 0x0x10
    public string <ECIMBNJMBDE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AEJGJBNIHJJ
//   (not directly referenced by a detected call)
public class AEJGJBNIHJJ
{
    public EPHEAKCLDBB LOEALOIDPAH;    // 0x0x10
    public int BBFFGIKJCJH;    // 0x0x14
}

// --------------------------------------------------------------------------
// AMNCLJPKOMI
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.Econ]
public class AMNCLJPKOMI
{
    public int NGNDALAADPL;    // 0x0x10
    public long JONJBPHEAGC;    // 0x0x18
}
...
public class ANFANNMBMBD : FMGJKCGGLDA
{
    public MPEPJLKNBCJ? <GIAOJHALGHN>k__BackingField;    // 0x0x18
    public IMOHILLLLCK <IOKJDPJNECB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BAIOJCMFHJA
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{iIKCEJDFBDH}   [Service.API]
public class BAIOJCMFHJA
{
    public uint <LKGNIPBGNID>k__BackingField;    // 0x0x10
    public uint? <MIHCMIPMGMD>k__BackingField;    // 0x0x14
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x20
    public string <DJINDDMLDBA>k__BackingField;    // 0x0x28
    public DateTime <JABEJKNMMNM>k__BackingField;    // 0x0x30
    public DateTime? <OAJCAPEMMDE>k__BackingField;    // 0x0x38
    public bool <AKEJEKIENAH>k__BackingField;    // 0x0x48
    public List<KCKEEPKLCCH> <DEENBBCIPPK>k__BackingField;    // 0x0x50
    public List<string> <PCJAJODAOLJ>k__BackingField;    // 0x0x58
    public int <IOKGLEHCGGB>k__BackingField;    // 0x0x60
    public int <HAJLJHHLENP>k__BackingField;    // 0x0x64
    public int <CGNEAIMAIAJ>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// BBMLMKJJLIK
//   REQUEST  POST   api/equipment/v1/update   [Service.Econ]
public class BBMLMKJJLIK
{
    public string <CBEGDNILCGF>k__BackingField;    // 0x0x10
    public string <AJNFDEJAGPJ>k__BackingField;    // 0x0x18
    public string <NBAHGAILHOC>k__BackingField;    // 0x0x20
    public string <GJANGODNNBD>k__BackingField;    // 0x0x28
    public LCAONMOLFMM <KHBLLJFKLEP>k__BackingField;    // 0x0x30
    public string <MIMEGHDPNHO>k__BackingField;    // 0x0x38
    public bool MJEJPFLMDGG;    // 0x0x40
    public bool <LBOGPMJAHNL>k__BackingField;    // 0x0x41
}
...
public class BDEMDEKFJKI
{
    public int <IIFMEJPBAKN>k__BackingField;    // 0x0x10
    public bool <CABIPONPGLI>k__BackingField;    // 0x0x14
    public DateTime <INCOKEIHPOI>k__BackingField;    // 0x0x18
    public bool <APBPKLAPPMA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BJIGLGMENMK
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Auth]
public class BJIGLGMENMK
{
    public Guid <NNICFJHHJJK>k__BackingField;    // 0x0x10
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x20
    public string <GMGGJALANBF>k__BackingField;    // 0x0x28
    public DateTime <NKMHHJEGBCN>k__BackingField;    // 0x0x30
    public DateTime? <HGMAJKOFOIE>k__BackingField;    // 0x0x38
    public List<JNAPPEKJJFJ> <IJNKFEFHAFK>k__BackingField;    // 0x0x48
}
...
public class BLKONFMLDIL
{
    public int <PIIPGHOILCG>k__BackingField;    // 0x0x10
    public int <CFKGPNEMILG>k__BackingField;    // 0x0x14
    public float <BEOAHMFGCJL>k__BackingField;    // 0x0x18
    public int <FCKHENABFIO>k__BackingField;    // 0x0x1C
    public int <CNDMEDHOGON>k__BackingField;    // 0x0x20
    public int <LNLEJDLNGFM>k__BackingField;    // 0x0x24
    public int <CKOFJGOBEDB>k__BackingField;    // 0x0x28
    public string <LBNPOKHOIPC>k__BackingField;    // 0x0x30
    public string <LJOINMNKHDJ>k__BackingField;    // 0x0x38
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{kPKBBMKHPBE}   [Service.API]
...
public class BNJLLHGNADD
{
    public NNHHBOANHLC <KJGKKOPLLKN>k__BackingField;    // 0x0x10
    public AAMGEADCMPA <MPFMDDJBMGB>k__BackingField;    // 0x0x18
    public NAEJCLGGJFF <FKJOPNCBFBB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BOAABEMHNOO
//   (not directly referenced by a detected call)
public class BOAABEMHNOO
{
    public int <JAJCGMNMDLK>k__BackingField;    // 0x0x10
    public DateTime <JKKEBDGKJGM>k__BackingField;    // 0x0x18
}
...
// CAGBFCAGOOK
//   (not directly referenced by a detected call)
public class CAGBFCAGOOK
{
    public KGPOHDFBBLM <CLEFNNLBLBN>k__BackingField;    // 0x0x10
    public int? <PHCDJONOCEJ>k__BackingField;    // 0x0x14
    public Guid? <GJFKEPHNFON>k__BackingField;    // 0x0x1C
}
...
public class CBGLBCBGPAF
{
    public Guid? <ELIOBPCCGNC>k__BackingField;    // 0x0x10
    public Guid <KJFLKPGBKEI>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// CCAEPJFHACP
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class CCAEPJFHACP
{
    public long <GHLIHFDBBAG>k__BackingField;    // 0x0x10
    public int <KINFGACKIBI>k__BackingField;    // 0x0x18
    public long <PPALDIGJDGJ>k__BackingField;    // 0x0x20
    public long? <IPCFAIBEPJB>k__BackingField;    // 0x0x28
    public long? <EILFHBKBNGC>k__BackingField;    // 0x0x38
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x48
    public string <DJINDDMLDBA>k__BackingField;    // 0x0x50
    public string <GMGGJALANBF>k__BackingField;    // 0x0x58
    public DateTime <AAFJOMPCOEI>k__BackingField;    // 0x0x60
    public DateTime <OHMANJAJDLK>k__BackingField;    // 0x0x68
    public int <NDILIBLBILG>k__BackingField;    // 0x0x70
    public CODCMOIJOLB <LNNHNBDLFNO>k__BackingField;    // 0x0x74
    public bool <ALJADLOMCFL>k__BackingField;    // 0x0x78
    public bool <KFPHNOBMOIN>k__BackingField;    // 0x0x79
    public MKKBBHNBJOO <NJJEIIKEDLH>k__BackingField;    // 0x0x7C
    public MKKBBHNBJOO <HHDNPJDPEOA>k__BackingField;    // 0x0x80
    public long? <PHKJLGKKJOK>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// CCFJEIDEHHL
//   (not directly referenced by a detected call)
public class CCFJEIDEHHL
{
    public Guid <EALCMOKDMHL>k__BackingField;    // 0x0x10
    public long <PPALDIGJDGJ>k__BackingField;    // 0x0x20
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x28
    public string <DJINDDMLDBA>k__BackingField;    // 0x0x30
    public string <GMGGJALANBF>k__BackingField;    // 0x0x38
    public long <FHMCKEHGFMA>k__BackingField;    // 0x0x40
    public Guid? <EGHAMHBELJP>k__BackingField;    // 0x0x48
    public DateTime <HEPOHDBFKBC>k__BackingField;    // 0x0x60
    public int <JHMKPDFPAJE>k__BackingField;    // 0x0x68
}
...
public class CEOGENJDDLN
{
    public RoomKeyResult <FBGMMDGMKMA>k__BackingField;    // 0x0x10
    public INOJONIOMLO <OLBEJAFKOJM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CFJCIGNACEF
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class CFJCIGNACEF
{
    public List<OCKFBIOGNKI> <FCCOLEOAFPF>k__BackingField;    // 0x0x10
    public AAMGEADCMPA <MPFMDDJBMGB>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/storefronts/v1/season/{bKKLEKALCJB}   [Service.Econ]
public class CHCJKMCNECM : NIHPJLFNENH
{
    public int <GLEPHFAFDGE>k__BackingField;    // 0x0x30
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x38
    public DateTime <NKMHHJEGBCN>k__BackingField;    // 0x0x40
    public DateTime <PFEPLJFJIBG>k__BackingField;    // 0x0x48
    public OHDCEIDAPAG <GFGAGGMEGEO>k__BackingField;    // 0x0x50
    public GAFPFBGHLKH <AEPCELFGBLD>k__BackingField;    // 0x0x58
    public List<NCLJCDGNPBD> <CLMFHPILJGK>k__BackingField;    // 0x0x60
    public PDGPLBGACJC <MBJDPKDHIEL>k__BackingField;    // 0x0x68
}
...
public class CLJAACNMKDL
{
    public long <FJICAGCEPIA>k__BackingField;    // 0x0x10
    public int <FBEBFPIKIPI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CNHPBCHDPOJ
//   (not directly referenced by a detected call)
public class CNHPBCHDPOJ
{
    public long <MACMMDAEPDI>k__BackingField;    // 0x0x10
    public long <GHLIHFDBBAG>k__BackingField;    // 0x0x18
    public int <JINLAACKADL>k__BackingField;    // 0x0x20
    public DateTime <MJFDCMGFBOB>k__BackingField;    // 0x0x28
    public CHDEPBLNLOM <CLEFNNLBLBN>k__BackingField;    // 0x0x30
}
...
// --------------------------------------------------------------------------
// DACGDJJFLJB
// base   : GLGHGDBIHIE`1<PBIPCIHMMEN>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{iMEMNCCKPCI}   [Service.API]
public class DACGDJJFLJB
{
    // (no instance fields in the metadata dump)
}
...
public class DENALJKNOAK
{
    public IReadOnlyList<NKIPBOOKOIN> <CANKGOCCLNG>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/progressionEvents/collect/{kPKBBMKHPBE}/{iGCFMNAGCFG}   [Service.API]
public class DHHLNLKMNOA
{
    public long? <LKGNIPBGNID>k__BackingField;    // 0x0x10
    public int <JINLAACKADL>k__BackingField;    // 0x0x20
    public int? <DJIGCINIFMK>k__BackingField;    // 0x0x24
    public string <MICLALKPAGE>k__BackingField;    // 0x0x30
    public ANBJDABHKDF? <GIPCBDJBBCN>k__BackingField;    // 0x0x38
    public string <PDIBOCCNKHB>k__BackingField;    // 0x0x40
    public Guid? <HMJECIIGINJ>k__BackingField;    // 0x0x48
    public string <LIDCBOBIIMM>k__BackingField;    // 0x0x60
    public string <KBHFCGLOKLN>k__BackingField;    // 0x0x68
    public OHDCEIDAPAG <GFGAGGMEGEO>k__BackingField;    // 0x0x70
    public int <BFICBOOBPNP>k__BackingField;    // 0x0x74
    public int <CEPOMNMFMCK>k__BackingField;    // 0x0x78
    public FNEFDFLLFBO <OBPPDAOJMEP>k__BackingField;    // 0x0x7C
    public LCAONMOLFMM <PCAEAKGEDGL>k__BackingField;    // 0x0x80
    public string <OJFHGJCFEKE>k__BackingField;    // 0x0x88
    public MABNPILMDOB <BMLNMDFJNPO>k__BackingField;    // 0x0x90
    public HLIMIBICFIJ <OOJFCGDHCDD>k__BackingField;    // 0x0x94
    public OKJJNLMPKGN? <IDKPOABKAHG>k__BackingField;    // 0x0x98
    public bool <EAIKEENCLEB>k__BackingField;    // 0x0xA0
    public bool <EMABNHCACFD>k__BackingField;    // 0x0xA1
    public string <MAPJNKBDACF>k__BackingField;    // 0x0xA8
    public bool <JFADCBCPLDK>k__BackingField;    // 0x0xB0
    public bool CJCJIOEDPPN;    // 0x0xB1
}

// --------------------------------------------------------------------------
// DHKBOPFAEFI
//   (not directly referenced by a detected call)
public class DHKBOPFAEFI
{
    public float <FNMOCHBHCAN>k__BackingField;    // 0x0x10
    public float <COMBMHJGPKB>k__BackingField;    // 0x0x14
    public float <KADFFEBOACG>k__BackingField;    // 0x0x18
    public float <BDNJBJAKIPP>k__BackingField;    // 0x0x1C
    public float <BHMBGEPFAPO>k__BackingField;    // 0x0x20
    public float <OHFJMBNJNGP>k__BackingField;    // 0x0x24
    public float <CAFIGEKHNJP>k__BackingField;    // 0x0x28
    public float <HLGJDLHKNCB>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// DMGNAPKKKCI
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class DMGNAPKKKCI
{
    public List<int> <AHPHIJNFOBK>k__BackingField;    // 0x0x10
    public string <ECIMBNJMBDE>k__BackingField;    // 0x0x18
}
...
// EHALPLFJJDO
//   (not directly referenced by a detected call)
public class EHALPLFJJDO
{
    public OHDCEIDAPAG <GFGAGGMEGEO>k__BackingField;    // 0x0x10
    public int <FHMCKEHGFMA>k__BackingField;    // 0x0x14
    public NNIHNCLKKBF <JAGJBLOPFHL>k__BackingField;    // 0x0x18
}
...
public class EHEBAAFLCDB
{
    public int <KFNDGIDNKFG>k__BackingField;    // 0x0x10
    public BFKINBJEJJL <CLEFNNLBLBN>k__BackingField;    // 0x0x14
    public DMAFFNJHHBM <DFHJMIDJCED>k__BackingField;    // 0x0x18
    public DMAFFNJHHBM <KPOOCOOPCOJ>k__BackingField;    // 0x0x1C
    public DMAFFNJHHBM <CBDEJBNDKHI>k__BackingField;    // 0x0x20
    public byte? <JBCGGLCPAOE>k__BackingField;    // 0x0x24
}
...
public class EKHDFOAHNPL
{
    public AAMGEADCMPA <MPFMDDJBMGB>k__BackingField;    // 0x0x10
}
...
// EPOJJNCBOIL
//   (not directly referenced by a detected call)
public class EPOJJNCBOIL
{
    public CCAEPJFHACP <KJGKKOPLLKN>k__BackingField;    // 0x0x10
    public CNHPBCHDPOJ <GGHFOGHHOFA>k__BackingField;    // 0x0x18
}
...
public class FEBBKPDKCJH
{
    public long <PPALDIGJDGJ>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <ONEDGIKOIAO>k__BackingField;    // 0x0x18
    public MMOOKKPCNFF <GINOFPHLDGL>k__BackingField;    // 0x0x20
}
...
public class FGICBMKOPIJ
{
    public long <PPALDIGJDGJ>k__BackingField;    // 0x0x10
    public long? <IPCFAIBEPJB>k__BackingField;    // 0x0x18
    public long? <EILFHBKBNGC>k__BackingField;    // 0x0x28
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x38
    public string <DJINDDMLDBA>k__BackingField;    // 0x0x40
    public List<string> <PCJAJODAOLJ>k__BackingField;    // 0x0x48
    public string <GMGGJALANBF>k__BackingField;    // 0x0x50
    public DateTime <AAFJOMPCOEI>k__BackingField;    // 0x0x58
    public DateTime <OHMANJAJDLK>k__BackingField;    // 0x0x60
    public CODCMOIJOLB <LNNHNBDLFNO>k__BackingField;    // 0x0x68
    public bool <ALJADLOMCFL>k__BackingField;    // 0x0x6C
    public bool <KFPHNOBMOIN>k__BackingField;    // 0x0x6D
    public MKKBBHNBJOO <NJJEIIKEDLH>k__BackingField;    // 0x0x70
    public MKKBBHNBJOO <HHDNPJDPEOA>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// FIKDHFLBPCF
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class FIKDHFLBPCF
{
    public long <GHLIHFDBBAG>k__BackingField;    // 0x0x10
    public CHDEPBLNLOM <CLEFNNLBLBN>k__BackingField;    // 0x0x18
}
...
public class FOGFNPEGPOJ
{
    public int? <CPEKFPCIGIK>k__BackingField;    // 0x0x10
    public string <FICBMBOMOGH>k__BackingField;    // 0x0x18
    public string <FFGAHMKFPOJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FOIMFKMMENJ
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.Econ]
public class FOIMFKMMENJ
{
    public Guid <HDILECLAJEO>k__BackingField;    // 0x0x10
    public int <APMMKCFHGKM>k__BackingField;    // 0x0x20
    public long <HNPOLNNDIBL>k__BackingField;    // 0x0x28
    public Guid <OBFPBOPNAEP>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// FOKKNNKPLFM
//   (not directly referenced by a detected call)
public class FOKKNNKPLFM
{
    public int <KAAFLADBPHN>k__BackingField;    // 0x0x10
    public string <NBAHGAILHOC>k__BackingField;    // 0x0x18
    public string <GJANGODNNBD>k__BackingField;    // 0x0x20
    public string <OKCCFODHBII>k__BackingField;    // 0x0x28
    public string <MICLALKPAGE>k__BackingField;    // 0x0x30
    public GPINPBJCOOH? <KMBAEPOFMJF>k__BackingField;    // 0x0x38
    public string <PDIBOCCNKHB>k__BackingField;    // 0x0x70
    public Guid? <HMJECIIGINJ>k__BackingField;    // 0x0x78
    public ANBJDABHKDF? <GIPCBDJBBCN>k__BackingField;    // 0x0x8C
    public string <LIDCBOBIIMM>k__BackingField;    // 0x0x98
    public string <KBHFCGLOKLN>k__BackingField;    // 0x0xA0
    public bool <DHJFBBPFBNA>k__BackingField;    // 0x0xA8
    public bool <BEFOEEBLOHH>k__BackingField;    // 0x0xA9
    public bool <GGJPMFBBABI>k__BackingField;    // 0x0xAA
    public LCAONMOLFMM <KHBLLJFKLEP>k__BackingField;    // 0x0xAC
    public OHDCEIDAPAG <GFGAGGMEGEO>k__BackingField;    // 0x0xB0
    public int <BFICBOOBPNP>k__BackingField;    // 0x0xB4
    public IMHDFDKBDJL <MCPFHJPGHDP>k__BackingField;    // 0x0xB8
    public FNEFDFLLFBO <PDGPHHMCENP>k__BackingField;    // 0x0xBC
    public int? <HEFFFPFINGD>k__BackingField;    // 0x0xC0
    public string <JLPPFGLIMAL>k__BackingField;    // 0x0xC8
    public int? <OJBOBAOHGJE>k__BackingField;    // 0x0xD0
    public int? <BKBOILHCBIO>k__BackingField;    // 0x0xD8
    public string <MIMEGHDPNHO>k__BackingField;    // 0x0xE0
}

// --------------------------------------------------------------------------
// GAFPFBGHLKH
//   (not directly referenced by a detected call)
public class GAFPFBGHLKH
{
    public int <JHNMKBHMDIC>k__BackingField;    // 0x0x10
    public PLIDKAGAMBD <CLEFNNLBLBN>k__BackingField;    // 0x0x14
    public List<EHALPLFJJDO> <DILHJLBLGHO>k__BackingField;    // 0x0x18
    public List<EHALPLFJJDO> <MEHPIHGHMLA>k__BackingField;    // 0x0x20
    public bool <EMLEHPCFLPP>k__BackingField;    // 0x0x28
    public DateTime? <KBKIEPFFKKG>k__BackingField;    // 0x0x30
    public DateTime? <LOFOGDDBMHE>k__BackingField;    // 0x0x40
    public DateTime? <MGDCHJDGBOI>k__BackingField;    // 0x0x50
    public bool <ILNOHODKDIO>k__BackingField;    // 0x0x60
    public bool <GGDJKJJKPLJ>k__BackingField;    // 0x0x61
}
...
public class GFIJFAKEABJ
{
    public CBGLBCBGPAF <OPJNHMHEJFA>k__BackingField;    // 0x0x10
    public HDDKFADDPDN <KPNBMJNIEON>k__BackingField;    // 0x0x18
    public int <HHBLGIAAKND>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GKACLLAEPKN
//   RESPONSE PUT    api/roomconsumables   [Service.Econ]
public class GKACLLAEPKN
{
    public BNGCBCCDBMN <FBGMMDGMKMA>k__BackingField;    // 0x0x10
    public ICOMAMGGJCC <ONEDDMOGHKA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GMBBCDNIHKO
//   (not directly referenced by a detected call)
public class GMBBCDNIHKO
{
    public bool <BJMPIHMNFCJ>k__BackingField;    // 0x0x10
    public FOKKNNKPLFM <LIHCHPNEFFG>k__BackingField;    // 0x0x18
    public float <EIFAHHBMNHG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GMMHMDHMGMI
//   REQUEST  POST   api/relationships/v2/updateVoiceVolume   [Service.API]
public class GMMHMDHMGMI
{
    public int <JINLAACKADL>k__BackingField;    // 0x0x10
    public byte <JBCGGLCPAOE>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// GOFDCENDOLG
//   (not directly referenced by a detected call)
public class GOFDCENDOLG
{
    public int <OEHLHLLKPNG>k__BackingField;    // 0x0x10
}
...
public class GOKKFHODIKJ
{
    public Guid <OBFPBOPNAEP>k__BackingField;    // 0x0x10
    public long <CGGGEGPCEOL>k__BackingField;    // 0x0x20
}
...
//   (not directly referenced by a detected call)
public class GPINPBJCOOH : ValueType
{
    public JCFFMFFLEFL MODFKBBBGLD;    // 0x0x0
    public HOBMLDPDGIJ DKBCCDPGIDD;    // 0x0x10
    public Guid NHCOLFOFHLB;    // 0x0x20
}

// --------------------------------------------------------------------------
// HDDKFADDPDN
//   (not directly referenced by a detected call)
public class HDDKFADDPDN
{
    public long <FHMCKEHGFMA>k__BackingField;    // 0x0x10
    public Guid? <HDILECLAJEO>k__BackingField;    // 0x0x18
}
...
public class HHDKMCBICKE
{
    public bool <AGBJIEEPMMA>k__BackingField;    // 0x0x10
    public string <KLGFAJCHNHE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HINKEKKKIMP
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class HINKEKKKIMP
{
    public Guid? <EALCMOKDMHL>k__BackingField;    // 0x0x10
    public long? <PPALDIGJDGJ>k__BackingField;    // 0x0x28
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x38
    public string <DJINDDMLDBA>k__BackingField;    // 0x0x40
    public string <GMGGJALANBF>k__BackingField;    // 0x0x48
    public HDDKFADDPDN <KKALDKMJGED>k__BackingField;    // 0x0x50
}
...
public class HJEEHKJJNPE
{
    public int <AFMCNCLGCHE>k__BackingField;    // 0x0x10
    public int <IIFMEJPBAKN>k__BackingField;    // 0x0x14
    public float <DJGJFBBHIEF>k__BackingField;    // 0x0x18
    public float <EAPCGHGEJJJ>k__BackingField;    // 0x0x1C
    public bool <CABIPONPGLI>k__BackingField;    // 0x0x20
    public bool <AIGOFLNLPCF>k__BackingField;    // 0x0x21
    public bool <LBOGPMJAHNL>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// HKECKNILIOK
//   (not directly referenced by a detected call)
public class HKECKNILIOK
{
    public int <KNOHEHPBDAO>k__BackingField;    // 0x0x10
    public DateTime <MJFDCMGFBOB>k__BackingField;    // 0x0x18
    public DateTime? <NOFDABKCNGB>k__BackingField;    // 0x0x20
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class HOBMLDPDGIJ : ValueType
{
    public Guid IIBHEJCKGGH;    // 0x0x0
}

// --------------------------------------------------------------------------
// ICOMAMGGJCC
//   (not directly referenced by a detected call)
public class ICOMAMGGJCC
{
    public Guid <EALCMOKDMHL>k__BackingField;    // 0x0x10
    public int <FBEBFPIKIPI>k__BackingField;    // 0x0x20
    public int <BHPLPHMGIII>k__BackingField;    // 0x0x24
    public Guid <GIPMADBMKGL>k__BackingField;    // 0x0x28
    public DateTime <HEPOHDBFKBC>k__BackingField;    // 0x0x38
    public CCFJEIDEHHL <DJOCPHKNKIM>k__BackingField;    // 0x0x40
}
...
public class IJNLOPOBHEF
{
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x10
    public string <DJINDDMLDBA>k__BackingField;    // 0x0x18
    public int? <FHMCKEHGFMA>k__BackingField;    // 0x0x20
    public LILABGCADKK? <LNNHNBDLFNO>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// ILNPBNFHNNK
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class ILNPBNFHNNK
{
    public bool <IICHPCPOPJD>k__BackingField;    // 0x0x10
    public string <FFOFAIIPFNB>k__BackingField;    // 0x0x18
    public string <GGJBJMFBKBN>k__BackingField;    // 0x0x20
}
...
public class IMOHILLLLCK
{
    public int <FBEBFPIKIPI>k__BackingField;    // 0x0x10
    public Guid <HDILECLAJEO>k__BackingField;    // 0x0x14
    public long <HDGFAEFLEAH>k__BackingField;    // 0x0x28
    public DateTime <HEPOHDBFKBC>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// INOJONIOMLO
//   (not directly referenced by a detected call)
public class INOJONIOMLO
{
    public long <FJICAGCEPIA>k__BackingField;    // 0x0x10
    public Guid <OCKACODIDEP>k__BackingField;    // 0x0x18
    public long <PPALDIGJDGJ>k__BackingField;    // 0x0x28
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x30
    public string <DJINDDMLDBA>k__BackingField;    // 0x0x38
    public int <FHMCKEHGFMA>k__BackingField;    // 0x0x40
    public Guid? <EGHAMHBELJP>k__BackingField;    // 0x0x44
    public DateTime <MJFDCMGFBOB>k__BackingField;    // 0x0x58
    public string <GMGGJALANBF>k__BackingField;    // 0x0x60
    public DOJPAGLBPPI <CLEFNNLBLBN>k__BackingField;    // 0x0x68
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class JCFFMFFLEFL : ValueType
{
    public Guid IIBHEJCKGGH;    // 0x0x0
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{bJJJBPLOANK}   [Service.Econ]
public class JGKDEHBDMMI
{
    public BNGCBCCDBMN <FBGMMDGMKMA>k__BackingField;    // 0x0x10
    public CCFJEIDEHHL <DJOCPHKNKIM>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{dIFAHGJHFEP}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{nLMCBFMCBDO}   [Service.API]
...
public class JHDDEHBOPMH
{
    public bool <AGBJIEEPMMA>k__BackingField;    // 0x0x10
    public string <AIKPBKKAEFG>k__BackingField;    // 0x0x18
    public string <DIBCDDHEKNF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JNAPPEKJJFJ
//   (not directly referenced by a detected call)
public class JNAPPEKJJFJ
{
    public Guid <MJFDGDOGMKP>k__BackingField;    // 0x0x10
    public Guid <NEEGHPGGOKK>k__BackingField;    // 0x0x20
    public DateTime <NKMHHJEGBCN>k__BackingField;    // 0x0x30
    public List<FOKKNNKPLFM> <KLKLLAAOKJD>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// JNHCLCLGBEM
//   (not directly referenced by a detected call)
public class JNHCLCLGBEM
{
    public float <PMEMBEENIOI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JOBHJAFJOPD
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class JOBHJAFJOPD
{
    public int <MANODMOIFAD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JPEDJFEMHBD
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class JPEDJFEMHBD
{
    public ODPDNELFFAL <ACHIPNAEKFJ>k__BackingField;    // 0x0x10
    public long <GHLIHFDBBAG>k__BackingField;    // 0x0x18
    public string <GEACMCAAODM>k__BackingField;    // 0x0x20
}
...
public class KBNHOHHJKNC
{
    public List<string> <DBGIAMPLHMG>k__BackingField;    // 0x0x10
    public List<string> <BOIIPAKOFGO>k__BackingField;    // 0x0x18
    public List<string> <JMODPAHIFJB>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KCKEEPKLCCH
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class KCKEEPKLCCH
{
    public string <LKGNIPBGNID>k__BackingField;    // 0x0x10
    public string <FFOFAIIPFNB>k__BackingField;    // 0x0x18
    public string <CBAEKPMMLJG>k__BackingField;    // 0x0x20
    public string <DJINDDMLDBA>k__BackingField;    // 0x0x28
    public string <FICBMBOMOGH>k__BackingField;    // 0x0x30
    public BLFHCKAEGNF <FBGMMDGMKMA>k__BackingField;    // 0x0x38
    public List<string> <DAEAMEGGALC>k__BackingField;    // 0x0x40
    public List<string> <PCJAJODAOLJ>k__BackingField;    // 0x0x48
    public string <JGFPHHGJEAK>k__BackingField;    // 0x0x50
    public List<LLHLLKGPCBN> <ECHMFHHBONM>k__BackingField;    // 0x0x58
}
...
public class LAPGKNPMBFB
{
    public ANBJDABHKDF <GIPCBDJBBCN>k__BackingField;    // 0x0x10
    public string <DLHLCFMPBAP>k__BackingField;    // 0x0x18
    public string <NBAHGAILHOC>k__BackingField;    // 0x0x20
    public string <GJANGODNNBD>k__BackingField;    // 0x0x28
    public LCAONMOLFMM <KHBLLJFKLEP>k__BackingField;    // 0x0x30
    public string <OKCCFODHBII>k__BackingField;    // 0x0x38
    public int <OJBOBAOHGJE>k__BackingField;    // 0x0x40
    public bool <PCNGADBKMAF>k__BackingField;    // 0x0x44
    public string <NLAIDKMFMNP>k__BackingField;    // 0x0x48
    public DateTime <MJFDCMGFBOB>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// LBCFNPGKJKI
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.Econ]
public class LBCFNPGKJKI
{
    public List<string> <BDNDBHHFOKN>k__BackingField;    // 0x0x10
}
...
// LCGPGAENNHC
//   (not directly referenced by a detected call)
public class LCGPGAENNHC
{
    public int <BDKLMMGKJDL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LFNOOJJHGMA
//   (not directly referenced by a detected call)
public class LFNOOJJHGMA
{
    public CAGBFCAGOOK <KCLPEGGOKIC>k__BackingField;    // 0x0x10
    public long <POCNGEDJNFJ>k__BackingField;    // 0x0x18
    public GiftItemDTO <CLNCCEEFAOP>k__BackingField;    // 0x0x20
    public long? <KHKDGHCJOCM>k__BackingField;    // 0x0x28
    public int <GPMANIFPEHJ>k__BackingField;    // 0x0x38
}
...
// --------------------------------------------------------------------------
// LJFNBCIMIIO
// base   : GLGHGDBIHIE`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class LJFNBCIMIIO
{
    // (no instance fields in the metadata dump)
}
...
// LLHLLKGPCBN
//   (not directly referenced by a detected call)
public class LLHLLKGPCBN
{
    public DateTime <MJFDCMGFBOB>k__BackingField;    // 0x0x10
    public string <LPOGLHIJEPB>k__BackingField;    // 0x0x18
}
...
public class NAEJCLGGJFF
{
    public OPIDLALHCGI <MPFMDDJBMGB>k__BackingField;    // 0x0x10
    public List<string> <PCJAJODAOLJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NCAOJPOONBD
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.Econ]
public class NCAOJPOONBD
{
    public long <FJICAGCEPIA>k__BackingField;    // 0x0x10
    public int <FBEBFPIKIPI>k__BackingField;    // 0x0x18
}
...
// base   : GAFPFBGHLKH
//   (not directly referenced by a detected call)
public class NCLJCDGNPBD : GAFPFBGHLKH
{
    public int <IOJFMGININH>k__BackingField;    // 0x0x68
    public List<GMBBCDNIHKO> <CIEBCDIMLEG>k__BackingField;    // 0x0x70
    public List<GMBBCDNIHKO> <OEEHNKLFNNE>k__BackingField;    // 0x0x78
    public List<GMBBCDNIHKO> <KBFGNEIHFII>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// NDIIKKFCCJK
//   REQUEST  POST   api/items/bulkpurchase   [Service.Commerce]
public class NDIIKKFCCJK
{
    public List<LFNOOJJHGMA> <PCCHDJLBKCF>k__BackingField;    // 0x0x10
    public KPMNADCIPPD? <JOJCLHOFJMM>k__BackingField;    // 0x0x18
    public OHDCEIDAPAG <GFGAGGMEGEO>k__BackingField;    // 0x0x20
    public bool <FCGKMMDNAPB>k__BackingField;    // 0x0x24
    public bool <FKONKOAOKFC>k__BackingField;    // 0x0x25
}
...
// base   : AMGMNPOIFDD
//   (not directly referenced by a detected call)
public class NKIPBOOKOIN : AMGMNPOIFDD
{
    public CALMKOKBCAF ENLMJCJOCIO;    // 0x0x20
}
...
// base   : CCAEPJFHACP
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class NNHHBOANHLC : CCAEPJFHACP
{
    public List<OCCKHEJEODJ> <PCJAJODAOLJ>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// NNIHNCLKKBF
//   (not directly referenced by a detected call)
public class NNIHNCLKKBF
{
    public int <BCHAPINBKOL>k__BackingField;    // 0x0x10
    public DateTime? <ALKDCIDBBAE>k__BackingField;    // 0x0x18
    public DateTime? <CCMHLAKEJLK>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// OCCKHEJEODJ
//   (not directly referenced by a detected call)
public class OCCKHEJEODJ
{
    public string <AOINDAHBLGB>k__BackingField;    // 0x0x10
    public PDALOBOKGIK <CLEFNNLBLBN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OCKFBIOGNKI
//   (not directly referenced by a detected call)
public class OCKFBIOGNKI
{
    public int <IGGPHAEAGHJ>k__BackingField;    // 0x0x10
    public AAMGEADCMPA <MPFMDDJBMGB>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// ODNPGNFMAKF
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{oJKFBILBJGP}   [Service.API]
public class ODNPGNFMAKF
{
    public List<CCAEPJFHACP> <GEGNEONBLHE>k__BackingField;    // 0x0x10
    public List<EPOJJNCBOIL> <OGEBIDGFIBL>k__BackingField;    // 0x0x18
}
...
public class OIGMJAKGELF
{
    public ODPDNELFFAL <ACHIPNAEKFJ>k__BackingField;    // 0x0x10
    public int <MANODMOIFAD>k__BackingField;    // 0x0x14
    public long <CKMBPLKAJDM>k__BackingField;    // 0x0x18
    public bool <ANOMKEBGCAG>k__BackingField;    // 0x0x20
    public string <KLGFAJCHNHE>k__BackingField;    // 0x0x28
    public int? <IDDOMMPLGAF>k__BackingField;    // 0x0x30
    public bool <JOAMOKIAGMA>k__BackingField;    // 0x0x38
    public bool <FCKDPMLMILP>k__BackingField;    // 0x0x39
    public bool <JHAEMBCEGII>k__BackingField;    // 0x0x3A
    public bool <LFHIOADFGON>k__BackingField;    // 0x0x3B
    public string <GPBPIJEKFHC>k__BackingField;    // 0x0x40
    public DateTime? <ODIOIPEMPDN>k__BackingField;    // 0x0x48
    public string <CMMGCHOGOHL>k__BackingField;    // 0x0x58
    public float <DCNPMFAFKOO>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// OKIFAMMGKDL
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class OKIFAMMGKDL
{
    public Dictionary<Guid, GKACLLAEPKN> <FKCAGODHAKC>k__BackingField;    // 0x0x10
}
...
public class ONHBHPOADDB
{
    public List<long> <JOBCIIOBMGM>k__BackingField;    // 0x0x10
    public EMEBIKKFGAE <CLEFNNLBLBN>k__BackingField;    // 0x0x18
    public string <PHNAFGDJDFM>k__BackingField;    // 0x0x20
    public long? <PPALDIGJDGJ>k__BackingField;    // 0x0x28
}
...
public class OOMCCAGGODG : FMGJKCGGLDA
{
    public IDMACLPDHFH? <GIAOJHALGHN>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <CEMHDKDINIA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OOOLMMGKNHD
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class OOOLMMGKNHD
{
    public List<OCCKHEJEODJ> <PCJAJODAOLJ>k__BackingField;    // 0x0x10
}
...
public class PCIILDJHKLK
{
    public int <CDOHMKLKHCG>k__BackingField;    // 0x0x10
    public int? <NBBEEBFPHGO>k__BackingField;    // 0x0x14
    public string <IAPEMJMAHFE>k__BackingField;    // 0x0x20
    public string <NOHNABCPBAB>k__BackingField;    // 0x0x28
}
...
public class PDGKCLCNJFO
{
    public Dictionary<int, int> <MNMCNJPLEMD>k__BackingField;    // 0x0x10
    public List<CMCPAEKDKFF> <LDCMIFADMLD>k__BackingField;    // 0x0x18
    public AEJGJBNIHJJ[][] <DCCIDCICLHD>k__BackingField;    // 0x0x20
    public LCGPGAENNHC <EBJABKDPPNC>k__BackingField;    // 0x0x28
    public DHKBOPFAEFI <OFEPBOAECDP>k__BackingField;    // 0x0x30
    public BOAABEMHNOO <MBEFDCLELJO>k__BackingField;    // 0x0x38
    public GOFDCENDOLG <DOLLKCNPHJA>k__BackingField;    // 0x0x40
    public JNHCLCLGBEM <BDNOBODBMNC>k__BackingField;    // 0x0x48
    public string <EMFPDIMADNF>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// PDGPLBGACJC
//   (not directly referenced by a detected call)
public class PDGPLBGACJC
{
    public bool <HBDKIGOAKGC>k__BackingField;    // 0x0x10
    public HLIMIBICFIJ <NAPAIBOFBHI>k__BackingField;    // 0x0x14
    public int <EPPCCFNNKHI>k__BackingField;    // 0x0x18
    public DateTime <HEPOHDBFKBC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PDLOKCNKFJM
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class PDLOKCNKFJM
{
    public List<CCAEPJFHACP> <OOJJJMNJEFF>k__BackingField;    // 0x0x10
    public string <ECIMBNJMBDE>k__BackingField;    // 0x0x18
}
...
public class PFDIADEKIKE
{
    public FLBKMGFJKGC <ACHIPNAEKFJ>k__BackingField;    // 0x0x10
    public string <GEACMCAAODM>k__BackingField;    // 0x0x18
    public int? <DLHDKDFCGAK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PIKFNFCCGKP
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{dEABODKOIAD}/{gEKAFAFKFEJ}   [Service.Econ]
public class PIKFNFCCGKP
{
    public OHDCEIDAPAG <GFGAGGMEGEO>k__BackingField;    // 0x0x10
    public GEJAFKBBKDO <GAGPNPHBDBI>k__BackingField;    // 0x0x14
    public int <FJFIDNEMPNN>k__BackingField;    // 0x0x18
    public int <IEAJOGDBHEK>k__BackingField;    // 0x0x1C
    public int <HPDCCCMDGOB>k__BackingField;    // 0x0x20
    public PCFIGCOPLGM <PDDMMENMLDE>k__BackingField;    // 0x0x24
    public bool <CHHIJMHACBJ>k__BackingField;    // 0x0x28
    public float <KGJBNDHHGDB>k__BackingField;    // 0x0x2C
    public int <LLMBMJBKGJK>k__BackingField;    // 0x0x30
    public bool <BIILKNGPGEE>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// PKGIIMPFLGB
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class PKGIIMPFLGB
{
    public Dictionary<Guid, PKPEDGNEIEC> <OALODOIMFCO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PKPEDGNEIEC
//   (not directly referenced by a detected call)
public class PKPEDGNEIEC
{
    public int <HHBLGIAAKND>k__BackingField;    // 0x0x10
    public CBGLBCBGPAF <OPJNHMHEJFA>k__BackingField;    // 0x0x18
}
...
public class AddKeepsakeInstanceRequest
{
    public long <PPALDIGJDGJ>k__BackingField;    // 0x0x10
    public long? <IPCFAIBEPJB>k__BackingField;    // 0x0x18
    public DCINACICPGL <IHABEBAFANA>k__BackingField;    // 0x0x28
}
...
{
    public BKKECADINBE <MPFMDDJBMGB>k__BackingField;    // 0x0x10
    public string <KIBCCBHHKNC>k__BackingField;    // 0x0x18
    public string <NFJHILBOLGN>k__BackingField;    // 0x0x20
    public string <FPFGGEFLPJB>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public OHDCEIDAPAG <CurrencyType>k__BackingField;    // 0x0x18
    public OKJJNLMPKGN <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<FOHHPAKGDKF<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <GHLIHFDBBAG>k__BackingField;    // 0x0x10
    public long? <CDKPGNMAIJL>k__BackingField;    // 0x0x18
}
...
{
    public string <GENDFCOHOBG>k__BackingField;    // 0x0x10
    public int <IGLNIFEDEKP>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public ICEFOCKOGGH FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public FNEFDFLLFBO <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public DCINACICPGL <NHEIJIMAEKL>k__BackingField;    // 0x0x10
    public string <LALKIJLHHPP>k__BackingField;    // 0x0x18
    public int <GEGGOJAHHHA>k__BackingField;    // 0x0x20
    public int <FEFJANDCGCN>k__BackingField;    // 0x0x24
    public string <OBGIIFHHJJI>k__BackingField;    // 0x0x28
    public string <CENLHEJHGCB>k__BackingField;    // 0x0x30
}
...
{
    public int <FBEBFPIKIPI>k__BackingField;    // 0x0x10
    public Guid <BLAKEGALEFN>k__BackingField;    // 0x0x14
    public DateTime <EHFNPHOACPI>k__BackingField;    // 0x0x28
}
...
{
    public bool <JFCDOEAMMDB>k__BackingField;    // 0x0x10
    public int <AIHPOHKPFDC>k__BackingField;    // 0x0x14
    public bool <OBDHFKOGAAE>k__BackingField;    // 0x0x18
}
...
{
    public Guid <BLAKEGALEFN>k__BackingField;    // 0x0x10
    public DCINACICPGL <BAGLPMHMKKF>k__BackingField;    // 0x0x20
    public int <PDKKLMNFDJP>k__BackingField;    // 0x0x24
    public long <PPALDIGJDGJ>k__BackingField;    // 0x0x28
    public long? <IPCFAIBEPJB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{nHAMNJIOEHA}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <GIMKKBMDLHF>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <EBFJBDGOOGI>k__BackingField;    // 0x0x18
}
...
{
    public long <AIHAHLGBMDP>k__BackingField;    // 0x0x10
    public long <PPALDIGJDGJ>k__BackingField;    // 0x0x18
    public long <DFPHBHHNNGP>k__BackingField;    // 0x0x20
    public FOEPCPJDPOJ <CLEFNNLBLBN>k__BackingField;    // 0x0x28
    public int <OMIFGGADGAJ>k__BackingField;    // 0x0x2C
}
...
{
    public long <PPALDIGJDGJ>k__BackingField;    // 0x0x10
    public List<Guid> <BPKKKAODGOB>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <GIMKKBMDLHF>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <EBFJBDGOOGI>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <HEAGNCADMJM>k__BackingField;    // 0x0x20
}
...
{
    public long <DFPHBHHNNGP>k__BackingField;    // 0x0x10
    public long <LEBOEHMCAPM>k__BackingField;    // 0x0x18
    public int? <JBFIFLCLMPK>k__BackingField;    // 0x0x20
    public int? <ONPGIEJMBHI>k__BackingField;    // 0x0x28
    public long? <FKNBGMNPMEA>k__BackingField;    // 0x0x30
    public long <OPFOGGLGPJM>k__BackingField;    // 0x0x40
    public long <JLNOCENEONF>k__BackingField;    // 0x0x48
    public int <BMHLMJNGOBI>k__BackingField;    // 0x0x50
    public FOEPCPJDPOJ <AHDACNLGHHM>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <NMNBFHCPHCA>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public FNEFDFLLFBO <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public HJMLLMJGAOM creatorAccountRole;    // 0x0x68
...
{
    public LOJOHKLIPFG <MDHCFLOCELF>k__BackingField;    // 0x0x10
    public GDIHFIBKLGL <MMELDIJDNLN>k__BackingField;    // 0x0x14
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x18
    public string <DJINDDMLDBA>k__BackingField;    // 0x0x20
    public bool <GFKNLMLKBNB>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<LOJOHKLIPFG> <LFAFJECBABF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{kPKBBMKHPBE}   [Service.API]
public class ProgressionEventDTO
{
    public long <LEBOEHMCAPM>k__BackingField;    // 0x0x10
    public string <PDMILDKBLGO>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <KBFGNEIHFII>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <MHFBPBLEDNG>k__BackingField;    // 0x0x28
    public DateTime <AAFJOMPCOEI>k__BackingField;    // 0x0x30
    public DateTime <OHMANJAJDLK>k__BackingField;    // 0x0x38
    public DateTime <FINAHMNLFBH>k__BackingField;    // 0x0x40
    public bool <BFAAPKKOIFO>k__BackingField;    // 0x0x48
    public int <HIMJDFLFHJK>k__BackingField;    // 0x0x4C
    public float <MHHCLKLPPMH>k__BackingField;    // 0x0x50
    public Guid? <OEGMPGEGEDL>k__BackingField;    // 0x0x54
    public string <KCIEJFDOAOB>k__BackingField;    // 0x0x68
    public string <CDICLLLJNMC>k__BackingField;    // 0x0x70
    public string <MOFJOELHLKP>k__BackingField;    // 0x0x78
    public string <KCLKKDJPANJ>k__BackingField;    // 0x0x80
}
...
{
    public Guid <BLAHEPHJOKN>k__BackingField;    // 0x0x10
    public int <MLBLIMGBDCG>k__BackingField;    // 0x0x20
    public int <HOFIKCEHPNE>k__BackingField;    // 0x0x24
    public int <LDGLLHLAEPC>k__BackingField;    // 0x0x28
    public long <LEMAGCOLMDP>k__BackingField;    // 0x0x30
    public long <HGLDMMENCLH>k__BackingField;    // 0x0x38
}
...
{
    public int <FBEBFPIKIPI>k__BackingField;    // 0x0x10
    public int <CEPOMNMFMCK>k__BackingField;    // 0x0x14
    public int <OABKMHCCPGG>k__BackingField;    // 0x0x18
    public int <FACDLNONKOL>k__BackingField;    // 0x0x1C
    public int <ODCFCABMCIE>k__BackingField;    // 0x0x20
    public DateTime? <POKKCFIHDDL>k__BackingField;    // 0x0x28
}
...
{
    public long <IGLIHMFONBK>k__BackingField;    // 0x0x10
    public int <KAAFLADBPHN>k__BackingField;    // 0x0x18
    public string <GMGGJALANBF>k__BackingField;    // 0x0x20
    public int <CEPOMNMFMCK>k__BackingField;    // 0x0x28
    public int <AADBBLJJIIC>k__BackingField;    // 0x0x2C
    public bool <BOONAMEDCDI>k__BackingField;    // 0x0x30
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public MAKNGCHMFLN <Permission>k__BackingField;    // 0x0x18
    public LILABGCADKK <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<NDDPCAHEJOL<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public HACOOCOOKAC ReportCategory;    // 0x0x20
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public LILABGCADKK <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public INIJMHOJFNC <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<NJJHKHCPMAL> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{bEAGNKIEMCA}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool CHAGBPDNPBF;    // 0x0x28
}
...
{
    public BLLOLEFOBEG? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public BLLOLEFOBEG CGHEMMPALOC;  // wrapper
...
{
    public MABNPILMDOB LAJCLLIGFHE;  // wrapper
...
{
    public AFPCPDEINMM MAIGGPEPIHD;  // wrapper
    public int? KINLFPFLDON;  // wrapper
...
{
    public ODPDNELFFAL DAKOPMIKBDD;  // wrapper
...
{
    public byte[] AMHCLKHIFKH;  // wrapper
    public FJKDKHPKENL GOCLAFHJAFM;  // wrapper
...
{
    public ODPDNELFFAL ONCHHJKEKHB;  // wrapper
    public float? JDMLEPIKFDF;  // wrapper
    public bool? NAENDFCOOHC;  // wrapper
...
{
    public List<GPINPBJCOOH> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public FNEFDFLLFBO PFPNPMCGHHC;  // wrapper
    public FNEFDFLLFBO? FLMOOAKHGJB;  // wrapper
...
{
    public ChatMessage EIGJGBPHOMK;  // wrapper
    public FJPJHABCOGN ONCHHJKEKHB;  // wrapper
...
{
    public LILABGCADKK CDPMNKIKIKJ;  // wrapper
    public MELIGNJEMOH LGIKJGKPLDM;  // wrapper
    public HLHFKBPCBEC DJGCBCHOMAN;  // wrapper
    public HLHFKBPCBEC KPGJONLOMDJ;  // wrapper
...
// api/customAvatarItems/v1/{dIFAHGJHFEP}/appeal  [API POST]
public class CustomAvatarItemsV1DIFAHGJHFEPAppealRequest
{
    public Guid DIFAHGJHFEP;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{iMEMNCCKPCI}  [API GET]
public class CustomAvatarItemsV2FromCreatorIMEMNCCKPCIRequest
{
...
{
    public GMBHLHEMIHO IGLKDGMPKGP;  // wrapper
    public FNEFDFLLFBO? EJJJICAGKBM;  // wrapper
...
{
    public OLLOFGGPHOB BFJMLAMAGJH;  // wrapper
...
// api/keepsakes/{nLMCBFMCBDO}/collect  [API POST]
public class KeepsakesNLMCBFMCBDOCollectRequest
{
    public Guid NLMCBFMCBDO;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public EMEBIKKFGAE KNDLPHBBPCO;  // wrapper
    public long? CCHPCHDJHAI;  // wrapper
...
{
    public Guid DCMHKMBDPKF;  // wrapper
...
{
    public Guid HKNIOMHOFFB;  // wrapper
...
{
    public Guid HKNIOMHOFFB;  // wrapper
    public long? LHPDLIOOOMA;  // wrapper
    public byte? MKAKNMKKKCL;  // wrapper
    public int? CKANMCILFBE;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid DCMHKMBDPKF;  // wrapper
    public long? BDHIDLAFBMN;  // wrapper
    public long? IKDBPFDACOF;  // wrapper
    public int? OEEMFPJJMLD;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> NFHKMOGHIBC;  // wrapper
...
{
    public DOJPAGLBPPI MAIGGPEPIHD;  // wrapper
    public Guid? LKBEHLFMPFI;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public ODPDNELFFAL ONCHHJKEKHB;  // wrapper
    public long? KICJCLFMICL;  // wrapper
    public Guid? BGNLPPHDNDF;  // wrapper
    public int? IGIFKFPAFOO;  // wrapper
...
{
    public Guid CHACABAIHIG;  // wrapper
...
{
    public Guid APOCMIPOCHF;  // wrapper
...
{
    public BLFHCKAEGNF CIJAGNMJFNE;  // wrapper
}
