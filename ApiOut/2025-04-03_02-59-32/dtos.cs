...
// DTO classes: 260 (plus referenced enums)

// --------------------------------------------------------------------------
// ACDAMMDBIIE
//   REQUEST  PUT    api/customAvatarItems   [Service.API]
//   REQUEST  PUT    api/customAvatarItems/v1/{customAvatarItemId}   [Service.API]
public class ACDAMMDBIIE
{
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x10
    public string <JFBMELLPJIF>k__BackingField;    // 0x0x18
    public int? <FJPILJNAEOM>k__BackingField;    // 0x0x20
    public LFNHDMIHLED? <HELOLLHALNJ>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// ADLCFHGEHLG
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class ADLCFHGEHLG
{
    public long <KABPNKPMEIA>k__BackingField;    // 0x0x10
    public int <KFGKMKOBPBG>k__BackingField;    // 0x0x18
    public long <DAGMMPHKFDF>k__BackingField;    // 0x0x20
    public long? <CKHIGPJJJHJ>k__BackingField;    // 0x0x28
    public long? <FJLBBLIKPEJ>k__BackingField;    // 0x0x38
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x48
    public string <JFBMELLPJIF>k__BackingField;    // 0x0x50
    public string <NBAPAGMOMKJ>k__BackingField;    // 0x0x58
    public DateTime <EJKNFOANJOL>k__BackingField;    // 0x0x60
    public DateTime <LGCICLOGMNI>k__BackingField;    // 0x0x68
    public int <IDKFLNLCFED>k__BackingField;    // 0x0x70
    public FACADJOIBBN <HELOLLHALNJ>k__BackingField;    // 0x0x74
    public bool <PFGCAMCGMLK>k__BackingField;    // 0x0x78
    public bool <IDAEFJGBIEJ>k__BackingField;    // 0x0x79
    public PGDODDGDHMJ <BODOLFBIALO>k__BackingField;    // 0x0x7C
    public PGDODDGDHMJ <MGBGJKEMHGE>k__BackingField;    // 0x0x80
    public long? <FLOAEKHEBCP>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// AGAKPHLIHND
//   RESPONSE PUT    api/roomconsumables   [Service.Econ]
public class AGAKPHLIHND
{
    public FOIDODDFDIN <HFHIJPIHCHL>k__BackingField;    // 0x0x10
    public PALBIKHBJON <MJHDJPIANKE>k__BackingField;    // 0x0x18
}
...
public class AOPECIAKIFO
{
    public List<string> <AHJLMKLDLGJ>k__BackingField;    // 0x0x10
    public List<string> <FPEEGAPMMNH>k__BackingField;    // 0x0x18
    public List<string> <PLOOEEPHDPI>k__BackingField;    // 0x0x20
}
...
public class APMJCLCPBEN
{
    public long <DAGMMPHKFDF>k__BackingField;    // 0x0x10
    public long? <CKHIGPJJJHJ>k__BackingField;    // 0x0x18
    public long? <FJLBBLIKPEJ>k__BackingField;    // 0x0x28
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x38
    public string <JFBMELLPJIF>k__BackingField;    // 0x0x40
    public List<string> <ENFBCIKIDMH>k__BackingField;    // 0x0x48
    public string <NBAPAGMOMKJ>k__BackingField;    // 0x0x50
    public DateTime <EJKNFOANJOL>k__BackingField;    // 0x0x58
    public DateTime <LGCICLOGMNI>k__BackingField;    // 0x0x60
    public FACADJOIBBN <HELOLLHALNJ>k__BackingField;    // 0x0x68
    public bool <PFGCAMCGMLK>k__BackingField;    // 0x0x6C
    public bool <IDAEFJGBIEJ>k__BackingField;    // 0x0x6D
    public PGDODDGDHMJ <BODOLFBIALO>k__BackingField;    // 0x0x70
    public PGDODDGDHMJ <MGBGJKEMHGE>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// BACFEJBNMHF
//   REQUEST  POST   api/equipment/v1/update   [Service.Econ]
public class BACFEJBNMHF
{
    public string <EPNIMGCFLHD>k__BackingField;    // 0x0x10
    public string <NGHNGEHJKNG>k__BackingField;    // 0x0x18
    public string <EGKIBGDOFMD>k__BackingField;    // 0x0x20
    public string <BPHKJONLBPF>k__BackingField;    // 0x0x28
    public MHDLFPPLKJP <JCPANDONPDC>k__BackingField;    // 0x0x30
    public string <EMKKDEFDAMG>k__BackingField;    // 0x0x38
    public bool PCPDNCGFMFM;    // 0x0x40
    public bool <OMPMGFKMOIP>k__BackingField;    // 0x0x41
}
...
// CAMLNPIJMEM
//   (not directly referenced by a detected call)
public class CAMLNPIJMEM
{
    public Guid <HDDLKLDEPPC>k__BackingField;    // 0x0x10
    public Guid <GLKPKMGMNGM>k__BackingField;    // 0x0x20
    public DateTime <AJLKLBLPGOH>k__BackingField;    // 0x0x30
    public List<FLKKIGJEGDH> <KEMIOGMICNM>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// CANMGLIPPJJ
//   (not directly referenced by a detected call)
public class CANMGLIPPJJ
{
    public bool <EJLIFILNBGG>k__BackingField;    // 0x0x10
    public JLFFPKKOLLM <JJPOOIGFIAJ>k__BackingField;    // 0x0x14
    public int <CGAAJJJDHOK>k__BackingField;    // 0x0x18
    public DateTime <DLMDPIOGGAF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CEIGHLJFCHN
//   (not directly referenced by a detected call)
public class CEIGHLJFCHN
{
    public int <EEFLDKGIDKG>k__BackingField;    // 0x0x10
    public DateTime <IDNCPHJFMNB>k__BackingField;    // 0x0x18
}
...
// CGGIAKPPCBI
//   (not directly referenced by a detected call)
public class CGGIAKPPCBI
{
    public int <FJNNMCPIKJC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CILFFKHMGOO
//   REQUEST  PUT    api/roomconsumables   [Service.Econ]
public class CILFFKHMGOO
{
    public Guid? <HCIKCCMFFMO>k__BackingField;    // 0x0x10
    public Guid <OHGLNFJDLLO>k__BackingField;    // 0x0x24
}
...
// CJELFJBIGAD
//   (not directly referenced by a detected call)
public class CJELFJBIGAD
{
    public long <BENEPGDEJLN>k__BackingField;    // 0x0x10
    public Guid <GDLEPDHOEJH>k__BackingField;    // 0x0x18
    public long <DAGMMPHKFDF>k__BackingField;    // 0x0x28
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x30
    public string <JFBMELLPJIF>k__BackingField;    // 0x0x38
    public int <FJPILJNAEOM>k__BackingField;    // 0x0x40
    public Guid? <LJPJGFKPGFP>k__BackingField;    // 0x0x44
    public DateTime <AFFLNDDDGIJ>k__BackingField;    // 0x0x58
    public string <NBAPAGMOMKJ>k__BackingField;    // 0x0x60
    public MACIJMPNFBK <DJJJCKFFPIH>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// CJPBAAKODKI
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class CJPBAAKODKI
{
    public NGOGFOOOMLP <MCOKNBLOONC>k__BackingField;    // 0x0x10
    public int <EBADKCGPJFH>k__BackingField;    // 0x0x14
    public long <BFEFCAGFDDE>k__BackingField;    // 0x0x18
    public bool <FNAFKAHMFEP>k__BackingField;    // 0x0x20
    public string <OAGCGIOAAKN>k__BackingField;    // 0x0x28
    public int? <KAKMNHHDEMJ>k__BackingField;    // 0x0x30
    public bool <GLAPPJEAIHP>k__BackingField;    // 0x0x38
    public bool <BEDJCFLHKED>k__BackingField;    // 0x0x39
    public bool <LECKNPKKPOF>k__BackingField;    // 0x0x3A
    public bool <CHLAGCPPEBI>k__BackingField;    // 0x0x3B
    public string <NCKHNCMKMPF>k__BackingField;    // 0x0x40
    public DateTime? <JKAHPNPNILD>k__BackingField;    // 0x0x48
    public string <AJCKOEOGLGO>k__BackingField;    // 0x0x58
    public float <EBJCMFDOEOC>k__BackingField;    // 0x0x60
}

// --------------------------------------------------------------------------
// CNOPIACEDEH
//   (not directly referenced by a detected call)
public class CNOPIACEDEH
{
    public ADLCFHGEHLG <IAIEJMMGIGG>k__BackingField;    // 0x0x10
    public DAANDNLJEOF <MABDLJCHDMI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DAANDNLJEOF
//   (not directly referenced by a detected call)
public class DAANDNLJEOF
{
    public long <COEBHOFFHOL>k__BackingField;    // 0x0x10
    public long <KABPNKPMEIA>k__BackingField;    // 0x0x18
    public int <KLEPKCPJPJD>k__BackingField;    // 0x0x20
    public DateTime <AFFLNDDDGIJ>k__BackingField;    // 0x0x28
    public JOPDGIAOACB <DJJJCKFFPIH>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// DLACCHCDFDA
//   REQUEST  POST   api/relationships/v2/updateVoiceVolume   [Service.API]
public class DLACCHCDFDA
{
    public int <KLEPKCPJPJD>k__BackingField;    // 0x0x10
    public byte <DJNCMCFBBIE>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// DNOOIFADMOK
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class DNOOIFADMOK
{
    public List<int> <OMKKKDJHHGI>k__BackingField;    // 0x0x10
    public string <HEPCDOKJLPG>k__BackingField;    // 0x0x18
}
...
// base   : ADLCFHGEHLG
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class DOKCCOBBAMA : ADLCFHGEHLG
{
    public List<KDFHDHLPDLB> <ENFBCIKIDMH>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// DPBLFGNPNJE
//   (not directly referenced by a detected call)
public class DPBLFGNPNJE
{
    public JBBKDHMPLBF MCKDDHAJDHK;    // 0x0x10
    public int LBEKPABGDEO;    // 0x0x14
}
...
public class EFOBPMFGMMJ
{
    public Dictionary<int, int> <GAGDBMBFCKN>k__BackingField;    // 0x0x10
    public List<MNICMILCJBF> <ACJNBNNPFKN>k__BackingField;    // 0x0x18
    public DPBLFGNPNJE[][] <CHPGNDGPDDJ>k__BackingField;    // 0x0x20
    public CGGIAKPPCBI <EIBADEMOKBE>k__BackingField;    // 0x0x28
    public IBAJNFCDHFE <KNLKLNEMKIE>k__BackingField;    // 0x0x30
    public CEIGHLJFCHN <JGLAPLEIMDG>k__BackingField;    // 0x0x38
    public FPMMEGEMINE <DNABGFALMIB>k__BackingField;    // 0x0x40
    public NJPACJHDHNG <IKNJPAGOHJE>k__BackingField;    // 0x0x48
    public string <FLGOJIMJAIL>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// EGGADGKKCNO
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class EGGADGKKCNO
{
    public Dictionary<Guid, OPEEFJKGLED> <JAFFOOPJJPA>k__BackingField;    // 0x0x10
}
...
// EKFJLLGEBEG
//   (not directly referenced by a detected call)
public class EKFJLLGEBEG
{
    public long <FJPILJNAEOM>k__BackingField;    // 0x0x10
    public Guid? <BAIODBCFHAJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EKPANKGIFIF
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class EKPANKGIFIF
{
    public long <DAGMMPHKFDF>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <KDBKPAHPBJM>k__BackingField;    // 0x0x18
    public AOFHDGJHCMN <HJMJEGAFMCG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ELPPPJLBBBD
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class ELPPPJLBBBD
{
    public int <ALGJEDCAJPA>k__BackingField;    // 0x0x10
    public Guid <BAIODBCFHAJ>k__BackingField;    // 0x0x14
    public long <NNNDGNDDLIO>k__BackingField;    // 0x0x28
    public DateTime <DLMDPIOGGAF>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// ENNCBOGCHJF
//   (not directly referenced by a detected call)
public class ENNCBOGCHJF
{
    public bool <CFHBBOKNEKI>k__BackingField;    // 0x0x10
    public FLKKIGJEGDH <NFLHDOMBHLJ>k__BackingField;    // 0x0x18
    public float <GBNNOIGLFBG>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{aIAINBLOMMB}   [Service.Econ]
public class ENNNMBLOCAG
{
    public FOIDODDFDIN <HFHIJPIHCHL>k__BackingField;    // 0x0x10
    public MJONHEEGGCA <OAOAFKFHLND>k__BackingField;    // 0x0x18
}
...
public class FDAFEJKBHAB
{
    public string <MBFHNHPEGOO>k__BackingField;    // 0x0x10
    public string <NAIGONLCMAF>k__BackingField;    // 0x0x18
    public string <DAJAMHMKOFP>k__BackingField;    // 0x0x20
    public string <JFBMELLPJIF>k__BackingField;    // 0x0x28
    public string <PCNLIIPOEEM>k__BackingField;    // 0x0x30
    public KGFOHGPDAEN <HFHIJPIHCHL>k__BackingField;    // 0x0x38
    public List<string> <NBDBNJCNGIG>k__BackingField;    // 0x0x40
    public List<string> <ENFBCIKIDMH>k__BackingField;    // 0x0x48
    public string <KNPGJMGADPA>k__BackingField;    // 0x0x50
    public List<NHOCBEFMAEI> <DDGOIBBJHKB>k__BackingField;    // 0x0x58
}
...
//   (not directly referenced by a detected call)
public class FEJKALOKOAI : ValueType
{
    public LALAGECKOGA NJALIPJPANJ;    // 0x0x0
    public PECGMKADMMG HKHBOFNLGCJ;    // 0x0x10
    public Guid IHOCAHKEPON;    // 0x0x20
}

// --------------------------------------------------------------------------
// FFIFIFPBMDN
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class FFIFIFPBMDN
{
    public int <JOIJHDOBEJL>k__BackingField;    // 0x0x10
    public int? <OIELHFHLEEH>k__BackingField;    // 0x0x14
    public string <EBBKGFHPNOD>k__BackingField;    // 0x0x20
    public string <PIKENABNAIB>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// FKKMGNCGKEM
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.API]
public class FKKMGNCGKEM
{
    public List<long> <LFGFIECGKLI>k__BackingField;    // 0x0x10
    public HBAJDPHEHNO <DJJJCKFFPIH>k__BackingField;    // 0x0x18
    public string <AFCMLCJPJFO>k__BackingField;    // 0x0x20
    public long? <DAGMMPHKFDF>k__BackingField;    // 0x0x28
}
...
// FLKKIGJEGDH
//   (not directly referenced by a detected call)
public class FLKKIGJEGDH
{
    public int <NDPLBIPJGFB>k__BackingField;    // 0x0x10
    public string <EGKIBGDOFMD>k__BackingField;    // 0x0x18
    public string <BPHKJONLBPF>k__BackingField;    // 0x0x20
    public string <FMPLPJKDKDL>k__BackingField;    // 0x0x28
    public string <FMMGOMNMGOK>k__BackingField;    // 0x0x30
    public FEJKALOKOAI? <PGIDFBPBEIP>k__BackingField;    // 0x0x38
    public string <NODCINBKCLB>k__BackingField;    // 0x0x70
    public Guid? <HNAOPBIMHAH>k__BackingField;    // 0x0x78
    public NBGKJOHKEMA? <HEKHCGMFDOD>k__BackingField;    // 0x0x8C
    public string <LFEBPAJPHEG>k__BackingField;    // 0x0x98
    public string <NHJIKNKCCEF>k__BackingField;    // 0x0xA0
    public bool <CPEOHEDHJDH>k__BackingField;    // 0x0xA8
    public bool <HKLIMBIBCDC>k__BackingField;    // 0x0xA9
    public bool <GFFJDPIJMPE>k__BackingField;    // 0x0xAA
    public MHDLFPPLKJP <JCPANDONPDC>k__BackingField;    // 0x0xAC
    public JMJFIJCEBKJ <AEAMKCBNENP>k__BackingField;    // 0x0xB0
    public int <EFLMEINAFPK>k__BackingField;    // 0x0xB4
    public GEAINIFOMKK <GPGLKFBBNHM>k__BackingField;    // 0x0xB8
    public CJEELAAIIDE <OAKOFHPBBHK>k__BackingField;    // 0x0xBC
    public int? <HEALBFKBOND>k__BackingField;    // 0x0xC0
    public string <NBICOMGKFMK>k__BackingField;    // 0x0xC8
    public int? <HOFIBDJCOAI>k__BackingField;    // 0x0xD0
    public int? <AGCIEPOOGGL>k__BackingField;    // 0x0xD8
    public string <EMKKDEFDAMG>k__BackingField;    // 0x0xE0
}
...
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{kMICBDLIHGF}/{mCANMJACJML}   [Service.Econ]
public class FPFOFPJJIKH
{
    public JMJFIJCEBKJ <AEAMKCBNENP>k__BackingField;    // 0x0x10
    public BMKEIFMOPPF <PGEOCFCHANH>k__BackingField;    // 0x0x14
    public int <KFEFHGLPGFM>k__BackingField;    // 0x0x18
    public int <LFBLFNBJKLO>k__BackingField;    // 0x0x1C
    public int <GMBODBBJHBJ>k__BackingField;    // 0x0x20
    public EELGNNCJHJI <HOMLIKOKPDE>k__BackingField;    // 0x0x24
    public bool <KNOONNLKNHE>k__BackingField;    // 0x0x28
    public float <IFEMIKDHGGG>k__BackingField;    // 0x0x2C
    public int <GDEBIGBGAAK>k__BackingField;    // 0x0x30
    public bool <MCOPJDAOCNP>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// FPMMEGEMINE
//   (not directly referenced by a detected call)
public class FPMMEGEMINE
{
    public int <KAMGJAIECCI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GAFOELJJIHE
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class GAFOELJJIHE
{
    public Guid? <OPLHFINKCNC>k__BackingField;    // 0x0x10
    public long? <DAGMMPHKFDF>k__BackingField;    // 0x0x28
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x38
    public string <JFBMELLPJIF>k__BackingField;    // 0x0x40
    public string <NBAPAGMOMKJ>k__BackingField;    // 0x0x48
    public EKFJLLGEBEG <PIMCIMHDKBJ>k__BackingField;    // 0x0x50
}
...
public class GGDECBIKNBC
{
    public long <BENEPGDEJLN>k__BackingField;    // 0x0x10
    public int <ALGJEDCAJPA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GJJACIDPGBI
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{cBHDFIGALJM}   [Service.API]
public class GJJACIDPGBI
{
    public List<ADLCFHGEHLG> <FNDNKNFLKDG>k__BackingField;    // 0x0x10
    public List<CNOPIACEDEH> <KNIACPDFCFG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GKMPGHECLKB
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class GKMPGHECLKB
{
    public List<NAGDDPJNPLA> <MHJBLLKMDOL>k__BackingField;    // 0x0x10
    public string <HEPCDOKJLPG>k__BackingField;    // 0x0x18
}
...
public class GMIOGHMGFAP
{
    public RoomKeyResult <HFHIJPIHCHL>k__BackingField;    // 0x0x10
    public CJELFJBIGAD <GKPFCCDNONG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GNBHOAPKAGD
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class GNBHOAPKAGD
{
    public long <KABPNKPMEIA>k__BackingField;    // 0x0x10
    public JOPDGIAOACB <DJJJCKFFPIH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GOAEJIMAEAK
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class GOAEJIMAEAK
{
    public int <OCEOHMHFDEP>k__BackingField;    // 0x0x10
    public int <NEMAGAFOPJP>k__BackingField;    // 0x0x14
    public float <NHFBMGALIDB>k__BackingField;    // 0x0x18
    public int <MPBIEHNHBGJ>k__BackingField;    // 0x0x1C
    public int <HJELDBALHDO>k__BackingField;    // 0x0x20
    public int <MCOGFNKEGDJ>k__BackingField;    // 0x0x24
    public int <IHIPKNFBOOO>k__BackingField;    // 0x0x28
    public string <GLIIJADHFLK>k__BackingField;    // 0x0x30
    public string <LNLMHMOBMEB>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// HBNKGEELPCP
//   (not directly referenced by a detected call)
public class HBNKGEELPCP
{
    public int <CNCDIDMHODB>k__BackingField;    // 0x0x10
    public ALFHHELNNJL <EJNGNMKPLNF>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// HCBPINEEIMF
//   (not directly referenced by a detected call)
public class HCBPINEEIMF
{
    public int <POPFNJJCLIE>k__BackingField;    // 0x0x10
    public FOKMMOBCOGG <DJJJCKFFPIH>k__BackingField;    // 0x0x14
    public List<JJFJHIKINBD> <KHGFFIMPCEE>k__BackingField;    // 0x0x18
    public List<JJFJHIKINBD> <BFFBDJNBBLN>k__BackingField;    // 0x0x20
    public bool <DFMFGGJLNHL>k__BackingField;    // 0x0x28
    public DateTime? <OKLPFIDNIGJ>k__BackingField;    // 0x0x30
    public DateTime? <ACEKCAMIPIJ>k__BackingField;    // 0x0x40
    public DateTime? <LIIMHENMKGH>k__BackingField;    // 0x0x50
    public bool <CAONNNOPGEI>k__BackingField;    // 0x0x60
    public bool <BJOMFGMBOBC>k__BackingField;    // 0x0x61
}
...
// base   : HCBPINEEIMF
//   (not directly referenced by a detected call)
public class HDBPBCDFPPJ : HCBPINEEIMF
{
    public int <BEDLHOOKABL>k__BackingField;    // 0x0x68
    public List<ENNCBOGCHJF> <GCLIEGBOONK>k__BackingField;    // 0x0x70
    public List<ENNCBOGCHJF> <JDONFFIGKJH>k__BackingField;    // 0x0x78
    public List<ENNCBOGCHJF> <MEKMILMCOLH>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// HFKHMDOOCDM
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class HFKHMDOOCDM
{
    public Dictionary<Guid, AGAKPHLIHND> <GGLHDLMDBOM>k__BackingField;    // 0x0x10
}
...
public class HGFBJBBICOK : IPKKEDFKIIH
{
    public JHPMKIOLBIN? <DFEFOFFBIPI>k__BackingField;    // 0x0x18
    public ELPPPJLBBBD <CHKDBMMDIMA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HHBNGLDMEAH
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class HHBNGLDMEAH
{
    public int <EBADKCGPJFH>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/progressionEvents/collect/{gHDPNILDMFC}/{jAAHKJECIIC}   [Service.API]
public class HLDNPMEHLBF
{
    public long? <MBFHNHPEGOO>k__BackingField;    // 0x0x10
    public int <KLEPKCPJPJD>k__BackingField;    // 0x0x20
    public int? <KPILGMBEMCM>k__BackingField;    // 0x0x24
    public string <FMMGOMNMGOK>k__BackingField;    // 0x0x30
    public NBGKJOHKEMA? <HEKHCGMFDOD>k__BackingField;    // 0x0x38
    public string <NODCINBKCLB>k__BackingField;    // 0x0x40
    public Guid? <HNAOPBIMHAH>k__BackingField;    // 0x0x48
    public string <LFEBPAJPHEG>k__BackingField;    // 0x0x60
    public string <NHJIKNKCCEF>k__BackingField;    // 0x0x68
    public JMJFIJCEBKJ <AEAMKCBNENP>k__BackingField;    // 0x0x70
    public int <EFLMEINAFPK>k__BackingField;    // 0x0x74
    public int <HJAOHMIJEAM>k__BackingField;    // 0x0x78
    public CJEELAAIIDE <NOOLAEMPOBP>k__BackingField;    // 0x0x7C
    public MHDLFPPLKJP <MGNGGFFLMIK>k__BackingField;    // 0x0x80
    public string <ALANOMLKOIB>k__BackingField;    // 0x0x88
    public OOJNNNOJHED <DPCIHOGOJAF>k__BackingField;    // 0x0x90
    public JLFFPKKOLLM <HFGPGBKLNJB>k__BackingField;    // 0x0x94
    public CEMHNJHDBCA? <CEKFGOBMAKJ>k__BackingField;    // 0x0x98
    public bool <DMEIIDFLBNI>k__BackingField;    // 0x0xA0
    public bool <FJLNLEMHMFP>k__BackingField;    // 0x0xA1
    public string <MOPLCCILEKE>k__BackingField;    // 0x0xA8
    public bool <MLPOIBFDLFO>k__BackingField;    // 0x0xB0
    public bool NLHEANEEFLD;    // 0x0xB1
}

// --------------------------------------------------------------------------
// HLEJDBELHMM
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{nCJKGMLAKGH}   [Service.API]
public class HLEJDBELHMM
{
    public uint <MBFHNHPEGOO>k__BackingField;    // 0x0x10
    public uint? <PKCJDIIEOCP>k__BackingField;    // 0x0x14
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x20
    public string <JFBMELLPJIF>k__BackingField;    // 0x0x28
    public DateTime <JOOKDJFAHBP>k__BackingField;    // 0x0x30
    public DateTime? <CHODBJPGCHL>k__BackingField;    // 0x0x38
    public bool <CJJFNHAJHHJ>k__BackingField;    // 0x0x48
    public List<FDAFEJKBHAB> <APLBCEAOAKH>k__BackingField;    // 0x0x50
    public List<string> <ENFBCIKIDMH>k__BackingField;    // 0x0x58
    public int <ECPBFDHMGPO>k__BackingField;    // 0x0x60
    public int <DGDJOOPIAKN>k__BackingField;    // 0x0x64
    public int <FCINDMHIIKE>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// HNEPNBDPBKE
//   (not directly referenced by a detected call)
public class HNEPNBDPBKE
{
    public int <EPNDKFJDKEO>k__BackingField;    // 0x0x10
    public DateTime? <FECDFDOAFIG>k__BackingField;    // 0x0x18
    public DateTime? <NPDHMKNMHOK>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// IBAJNFCDHFE
//   (not directly referenced by a detected call)
public class IBAJNFCDHFE
{
    public float <BMDLLCDCBGD>k__BackingField;    // 0x0x10
    public float <NEMJGJDJKEO>k__BackingField;    // 0x0x14
    public float <LMNBMKDEJKJ>k__BackingField;    // 0x0x18
    public float <POBPNIACBHA>k__BackingField;    // 0x0x1C
    public float <BAJJFDEDOLK>k__BackingField;    // 0x0x20
    public float <LILBHPCALBL>k__BackingField;    // 0x0x24
    public float <ADCHACMDDDI>k__BackingField;    // 0x0x28
    public float <OKNCJEGKANL>k__BackingField;    // 0x0x2C
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{gHDPNILDMFC}   [Service.API]
...
public class IEGHADLDPCP
{
    public DOKCCOBBAMA <IAIEJMMGIGG>k__BackingField;    // 0x0x10
    public ALFHHELNNJL <EJNGNMKPLNF>k__BackingField;    // 0x0x18
    public KKBOBMLJOGE <MNGFGLFEOIE>k__BackingField;    // 0x0x20
}
...
public class JCFDNBIFPLM
{
    public int? <PCCOLHOEHEP>k__BackingField;    // 0x0x10
    public string <PCNLIIPOEEM>k__BackingField;    // 0x0x18
    public string <JGHOGGFGOOO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JDHMEDGLMMA
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class JDHMEDGLMMA
{
    public List<KDFHDHLPDLB> <ENFBCIKIDMH>k__BackingField;    // 0x0x10
}
...
public class JJDIELBJKCI
{
    public Guid <CPJGFNNMDII>k__BackingField;    // 0x0x10
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x20
    public string <NBAPAGMOMKJ>k__BackingField;    // 0x0x28
    public DateTime <AJLKLBLPGOH>k__BackingField;    // 0x0x30
    public DateTime? <EEOGHADHLLK>k__BackingField;    // 0x0x38
    public List<CAMLNPIJMEM> <LEBCLOBNOEG>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// JJFJHIKINBD
//   (not directly referenced by a detected call)
public class JJFJHIKINBD
{
    public JMJFIJCEBKJ <AEAMKCBNENP>k__BackingField;    // 0x0x10
    public int <FJPILJNAEOM>k__BackingField;    // 0x0x14
    public HNEPNBDPBKE <FNHGPLPPKHH>k__BackingField;    // 0x0x18
}
...
// base   : MPPOIJDONIG
//   (not directly referenced by a detected call)
public class JJNIFCKDHPG : MPPOIJDONIG
{
    public HHMBMCMAONM OFJNHMCPAOB;    // 0x0x20
}

// --------------------------------------------------------------------------
// JKPAKOJOJMM
//   (not directly referenced by a detected call)
public class JKPAKOJOJMM
{
    public NBGEGDGKHHH <BAGBBBDGCMM>k__BackingField;    // 0x0x10
    public long <EADODPKAOLB>k__BackingField;    // 0x0x18
    public GiftItemDTO <HBPFMKILCKE>k__BackingField;    // 0x0x20
    public long? <DKDGJFKGAAE>k__BackingField;    // 0x0x28
    public int <EMOFBPKGFKF>k__BackingField;    // 0x0x38
}
...
public class JLHFMJMLLFE
{
    public List<HBNKGEELPCP> <BNCNGNDEEOH>k__BackingField;    // 0x0x10
    public ALFHHELNNJL <EJNGNMKPLNF>k__BackingField;    // 0x0x18
}
...
public class JLJFBCDHCNK
{
    public int <OCDNBHBNNHB>k__BackingField;    // 0x0x10
    public bool <FHBIFCFJIFJ>k__BackingField;    // 0x0x14
    public DateTime <DIAIBMAAPGN>k__BackingField;    // 0x0x18
    public bool <DHJPKEEMBCJ>k__BackingField;    // 0x0x20
}
...
public class KAAGPBEIFFK
{
    public NGOGFOOOMLP <MCOKNBLOONC>k__BackingField;    // 0x0x10
    public long <KABPNKPMEIA>k__BackingField;    // 0x0x18
    public string <ADHDJDJFJLA>k__BackingField;    // 0x0x20
}
...
public class KBPGOIMEFBF
{
    public Guid <PPIPABEBEDJ>k__BackingField;    // 0x0x10
    public long <MDEOAAECEII>k__BackingField;    // 0x0x20
}
...
public class KCFLMCBIAIE
{
    public NBGKJOHKEMA <HEKHCGMFDOD>k__BackingField;    // 0x0x10
    public string <GFHDAONEHHO>k__BackingField;    // 0x0x18
    public string <EGKIBGDOFMD>k__BackingField;    // 0x0x20
    public string <BPHKJONLBPF>k__BackingField;    // 0x0x28
    public MHDLFPPLKJP <JCPANDONPDC>k__BackingField;    // 0x0x30
    public string <FMPLPJKDKDL>k__BackingField;    // 0x0x38
    public int <HOFIBDJCOAI>k__BackingField;    // 0x0x40
    public bool <KBLCOMEAEGF>k__BackingField;    // 0x0x44
    public string <FEIGAGMPDKH>k__BackingField;    // 0x0x48
    public DateTime <AFFLNDDDGIJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// KDFHDHLPDLB
//   (not directly referenced by a detected call)
public class KDFHDHLPDLB
{
    public string <HIMOFFJICDG>k__BackingField;    // 0x0x10
    public GLECGBHGAIF <DJJJCKFFPIH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KEMENMLJAJL
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.Econ]
public class KEMENMLJAJL
{
    public int EMBFOIFGOLE;    // 0x0x10
    public long GPHLDPJBFPG;    // 0x0x18
}
...
public class KHFIDMFKAMN
{
    public List<ADLCFHGEHLG> <JLEGKHNJKCP>k__BackingField;    // 0x0x10
    public string <HEPCDOKJLPG>k__BackingField;    // 0x0x18
}
...
public class KKBOBMLJOGE
{
    public EHHIAOKHLMM <EJNGNMKPLNF>k__BackingField;    // 0x0x10
    public List<string> <ENFBCIKIDMH>k__BackingField;    // 0x0x18
}
...
// base   : GBKCBEEPGPM
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{bJOJJMEFCAJ}   [Service.Econ]
public class KKLGAGMNOPJ : GBKCBEEPGPM
{
    public int <NDADOECPEKM>k__BackingField;    // 0x0x30
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x38
    public DateTime <AJLKLBLPGOH>k__BackingField;    // 0x0x40
    public DateTime <KDOHGKDOIJB>k__BackingField;    // 0x0x48
    public JMJFIJCEBKJ <AEAMKCBNENP>k__BackingField;    // 0x0x50
    public HCBPINEEIMF <OELGMALAJOF>k__BackingField;    // 0x0x58
    public List<HDBPBCDFPPJ> <CPLIPGMFGKI>k__BackingField;    // 0x0x60
    public CANMGLIPPJJ <ANAPNENBEPD>k__BackingField;    // 0x0x68
}
...
public class KPNKGNCPCAG
{
    public bool <APEMIONMOJN>k__BackingField;    // 0x0x10
    public string <OAGCGIOAAKN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KPPCNNOOHAN
// base   : KAGJDIGADOF`1<HEOFMDKPJDJ>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{lAEAKABKIPG}   [Service.API]
public class KPPCNNOOHAN
{
    // (no instance fields in the metadata dump)
}
...
public class LAAICNMIGBK
{
    public CILFFKHMGOO <ELJCIPNLKEL>k__BackingField;    // 0x0x10
    public EKFJLLGEBEG <JKAPFMIHOKN>k__BackingField;    // 0x0x18
    public int <PPDNKEPCNAM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LAKHHNJKMLN
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class LAKHHNJKMLN
{
    public bool <FDMGKMFGNHI>k__BackingField;    // 0x0x10
    public string <NAIGONLCMAF>k__BackingField;    // 0x0x18
    public string <OKPHEILNHJN>k__BackingField;    // 0x0x20
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class LALAGECKOGA : ValueType
{
    public Guid KDBHLLEACIN;    // 0x0x0
}
...
public class LHAPPADLEIA
{
    public List<string> <ALPFENHHOPE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LJDPJPLMIMF
//   REQUEST  POST   api/items/bulkpurchase   [Service.Commerce]
public class LJDPJPLMIMF
{
    public List<JKPAKOJOJMM> <EDMJDGAGCLN>k__BackingField;    // 0x0x10
    public KAPAKINLJNB? <NKBDHEOKNAH>k__BackingField;    // 0x0x18
    public JMJFIJCEBKJ <AEAMKCBNENP>k__BackingField;    // 0x0x20
    public bool <PBKMDNMNNJH>k__BackingField;    // 0x0x24
    public bool <GOEHMIDFIOF>k__BackingField;    // 0x0x25
}

// --------------------------------------------------------------------------
// LPHJEBONLAG
// base   : KAGJDIGADOF`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class LPHJEBONLAG
{
    // (no instance fields in the metadata dump)
}
...
public class MDDAHPADKLO
{
    public int <CDDBHPDDKLF>k__BackingField;    // 0x0x10
    public int <OCDNBHBNNHB>k__BackingField;    // 0x0x14
    public float <HKEJCHKLACK>k__BackingField;    // 0x0x18
    public float <FDPNAMNPEDG>k__BackingField;    // 0x0x1C
    public bool <FHBIFCFJIFJ>k__BackingField;    // 0x0x20
    public bool <JBNJILPCEKO>k__BackingField;    // 0x0x21
    public bool <OMPMGFKMOIP>k__BackingField;    // 0x0x22
}
...
public class MDOAEJBMPHO
{
    public int <GAPDLJGANBG>k__BackingField;    // 0x0x10
    public AIKFHBPKIIH <DJJJCKFFPIH>k__BackingField;    // 0x0x14
    public PDINNMGNHGH <BPCFJHPFJKE>k__BackingField;    // 0x0x18
    public PDINNMGNHGH <BFIMILDALMO>k__BackingField;    // 0x0x1C
    public PDINNMGNHGH <DHAENHMOHCJ>k__BackingField;    // 0x0x20
    public byte? <DJNCMCFBBIE>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// MHAGDPBDNEE
//   REQUEST  POST   api/items/purchaseInfos   [Service.Econ]
public class MHAGDPBDNEE
{
    public IReadOnlyList<JJNIFCKDHPG> <OGHDBPCEOPI>k__BackingField;    // 0x0x10
}
...
// MJONHEEGGCA
//   (not directly referenced by a detected call)
public class MJONHEEGGCA
{
    public Guid <OPLHFINKCNC>k__BackingField;    // 0x0x10
    public long <DAGMMPHKFDF>k__BackingField;    // 0x0x20
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x28
    public string <JFBMELLPJIF>k__BackingField;    // 0x0x30
    public string <NBAPAGMOMKJ>k__BackingField;    // 0x0x38
    public long <FJPILJNAEOM>k__BackingField;    // 0x0x40
    public Guid? <LJPJGFKPGFP>k__BackingField;    // 0x0x48
    public DateTime <DLMDPIOGGAF>k__BackingField;    // 0x0x60
    public int <IPEIDJGBCAO>k__BackingField;    // 0x0x68
}
...
// NAGDDPJNPLA
//   (not directly referenced by a detected call)
public class NAGDDPJNPLA
{
    public int <DFAJOMHILEC>k__BackingField;    // 0x0x10
    public DateTime <AFFLNDDDGIJ>k__BackingField;    // 0x0x18
    public DateTime? <MDNDMDJMADF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NBGEGDGKHHH
//   (not directly referenced by a detected call)
public class NBGEGDGKHHH
{
    public FMNBIFKKPFL <DJJJCKFFPIH>k__BackingField;    // 0x0x10
    public int? <CNJNLBCKEGK>k__BackingField;    // 0x0x14
    public Guid? <ANKHKEAAAGH>k__BackingField;    // 0x0x1C
}
...
// NHOCBEFMAEI
//   (not directly referenced by a detected call)
public class NHOCBEFMAEI
{
    public DateTime <AFFLNDDDGIJ>k__BackingField;    // 0x0x10
    public string <IILNMDEGDFK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NJPACJHDHNG
//   (not directly referenced by a detected call)
public class NJPACJHDHNG
{
    public float <BPPCIOOOBHK>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{lMGCOEEBLBC}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{lMJKJEPMLBH}   [Service.API]
...
public class NOFJPDKPAAM
{
    public bool <APEMIONMOJN>k__BackingField;    // 0x0x10
    public string <NPLHHAAACEA>k__BackingField;    // 0x0x18
    public string <DJLOGPCFLJJ>k__BackingField;    // 0x0x20
}
...
public class OCBEKHNLKJC
{
    public ALFHHELNNJL <EJNGNMKPLNF>k__BackingField;    // 0x0x10
}
...
public class OFCHEEBINKK : IPKKEDFKIIH
{
    public OPLGEGANBHM? <DFEFOFFBIPI>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <EPLBMPPANCC>k__BackingField;    // 0x0x20
}
...
public class OJOPMELMEBP
{
    public GHOBMIHNHKB <MCOKNBLOONC>k__BackingField;    // 0x0x10
    public string <ADHDJDJFJLA>k__BackingField;    // 0x0x18
    public int? <MGOKONKBDNL>k__BackingField;    // 0x0x20
}
...
// OPEEFJKGLED
//   (not directly referenced by a detected call)
public class OPEEFJKGLED
{
    public int <PPDNKEPCNAM>k__BackingField;    // 0x0x10
    public CILFFKHMGOO <ELJCIPNLKEL>k__BackingField;    // 0x0x18
}
...
public class OPLINFKGIBE
{
    public Guid <BAIODBCFHAJ>k__BackingField;    // 0x0x10
    public int <HBCPGEBKDLN>k__BackingField;    // 0x0x20
    public long <PNJNBFGANHM>k__BackingField;    // 0x0x28
    public Guid <PPIPABEBEDJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// PALBIKHBJON
//   (not directly referenced by a detected call)
public class PALBIKHBJON
{
    public Guid <OPLHFINKCNC>k__BackingField;    // 0x0x10
    public int <ALGJEDCAJPA>k__BackingField;    // 0x0x20
    public int <FIKKLAIFAPG>k__BackingField;    // 0x0x24
    public Guid <PNBPPBCAPGM>k__BackingField;    // 0x0x28
    public DateTime <DLMDPIOGGAF>k__BackingField;    // 0x0x38
    public MJONHEEGGCA <OAOAFKFHLND>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PDBKPBOOLMI
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.Econ]
public class PDBKPBOOLMI
{
    public long <BENEPGDEJLN>k__BackingField;    // 0x0x10
    public int <ALGJEDCAJPA>k__BackingField;    // 0x0x18
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class PECGMKADMMG : ValueType
{
    public Guid KDBHLLEACIN;    // 0x0x0
}
...
public class AddKeepsakeInstanceRequest
{
    public long <DAGMMPHKFDF>k__BackingField;    // 0x0x10
    public long? <CKHIGPJJJHJ>k__BackingField;    // 0x0x18
    public LAHJBOFKJLL <NHLEDIPHNIG>k__BackingField;    // 0x0x28
}
...
{
    public OAGOBEAOIDG <EJNGNMKPLNF>k__BackingField;    // 0x0x10
    public string <KOCBBDEBJPE>k__BackingField;    // 0x0x18
    public string <IFOLECPPPAB>k__BackingField;    // 0x0x20
    public string <IBEINBDCJOF>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public JMJFIJCEBKJ <CurrencyType>k__BackingField;    // 0x0x18
    public CEMHNJHDBCA <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<LMAFAOCAGDG<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <KABPNKPMEIA>k__BackingField;    // 0x0x10
    public long? <FHADNOOBDPH>k__BackingField;    // 0x0x18
}
...
{
    public string <NBAIGGEBDFJ>k__BackingField;    // 0x0x10
    public int <IAKMJGBKCEO>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public AJBNAKKDFLA FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public CJEELAAIIDE <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public LAHJBOFKJLL <MMKDKIBPOKH>k__BackingField;    // 0x0x10
    public string <AGIGMPEBHJK>k__BackingField;    // 0x0x18
    public int <OOBDFKDHIOJ>k__BackingField;    // 0x0x20
    public int <JHPMJBPKGDE>k__BackingField;    // 0x0x24
    public string <OIJDFPFNBCH>k__BackingField;    // 0x0x28
    public string <JGFNEEFFOMF>k__BackingField;    // 0x0x30
}
...
{
    public int <ALGJEDCAJPA>k__BackingField;    // 0x0x10
    public Guid <PDALHODPBMI>k__BackingField;    // 0x0x14
    public DateTime <GBEIEDFMHHM>k__BackingField;    // 0x0x28
}
...
{
    public bool <JCDEHNKHHAE>k__BackingField;    // 0x0x10
    public int <PBKMCAHGEGE>k__BackingField;    // 0x0x14
    public bool <KGFHMKOICNL>k__BackingField;    // 0x0x18
}
...
{
    public Guid <PDALHODPBMI>k__BackingField;    // 0x0x10
    public LAHJBOFKJLL <NMEKCBKGGLI>k__BackingField;    // 0x0x20
    public int <DKHHLMFIBMJ>k__BackingField;    // 0x0x24
    public long <DAGMMPHKFDF>k__BackingField;    // 0x0x28
    public long? <CKHIGPJJJHJ>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{pOLFGGGEODA}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <AHBAHOHMMJE>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <JHNGNMPNDAK>k__BackingField;    // 0x0x18
}
...
{
    public long <IHOLFPLEIDH>k__BackingField;    // 0x0x10
    public long <DAGMMPHKFDF>k__BackingField;    // 0x0x18
    public long <IIMIMDOFMOK>k__BackingField;    // 0x0x20
    public BDANJMAPMIG <DJJJCKFFPIH>k__BackingField;    // 0x0x28
    public int <BKKONLAMKEC>k__BackingField;    // 0x0x2C
}
...
{
    public long <DAGMMPHKFDF>k__BackingField;    // 0x0x10
    public List<Guid> <NPODBKPFIKM>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <AHBAHOHMMJE>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <JHNGNMPNDAK>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <LEIAKAJMJEC>k__BackingField;    // 0x0x20
}
...
{
    public long <IIMIMDOFMOK>k__BackingField;    // 0x0x10
    public long <LOCFBKKMDKF>k__BackingField;    // 0x0x18
    public int? <LMOOGHANCJE>k__BackingField;    // 0x0x20
    public int? <OMPCMHGBOJB>k__BackingField;    // 0x0x28
    public long? <PGCJFKJOONJ>k__BackingField;    // 0x0x30
    public long <IFHPCJABANG>k__BackingField;    // 0x0x40
    public long <OCPPNFOFAOK>k__BackingField;    // 0x0x48
    public int <JFKINKPJEGD>k__BackingField;    // 0x0x50
    public BDANJMAPMIG <HOIDHHFFOJE>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <IILLOPFBFGB>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public CJEELAAIIDE <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public NCKNCPPCAHN creatorAccountRole;    // 0x0x68
...
{
    public OHDLHLCNLHE <DHJMBMKDCOA>k__BackingField;    // 0x0x10
    public KIDJEBLNNCL <BFGEKKLPEBG>k__BackingField;    // 0x0x14
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x18
    public string <JFBMELLPJIF>k__BackingField;    // 0x0x20
    public bool <IHKDJADMPCA>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<OHDLHLCNLHE> <OECMHLLDPHC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{gHDPNILDMFC}   [Service.API]
public class ProgressionEventDTO
{
    public long <LOCFBKKMDKF>k__BackingField;    // 0x0x10
    public string <BBHGPIMHLDL>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <MEKMILMCOLH>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <BMMMKCHEAKC>k__BackingField;    // 0x0x28
    public DateTime <EJKNFOANJOL>k__BackingField;    // 0x0x30
    public DateTime <LGCICLOGMNI>k__BackingField;    // 0x0x38
    public DateTime <MAPBEOCOJFI>k__BackingField;    // 0x0x40
    public bool <BMLMENFFHBK>k__BackingField;    // 0x0x48
    public int <PPFKNMMNDCJ>k__BackingField;    // 0x0x4C
    public float <JAILPDNIIIF>k__BackingField;    // 0x0x50
    public Guid? <NJMFLGKGNDC>k__BackingField;    // 0x0x54
    public string <FDLENAENCLK>k__BackingField;    // 0x0x68
    public string <EOIIBNDLPCE>k__BackingField;    // 0x0x70
    public string <CKHHFFFJFHJ>k__BackingField;    // 0x0x78
    public string <AFBCCJBCEIA>k__BackingField;    // 0x0x80
}
...
{
    public Guid <FMKEFLGEBPI>k__BackingField;    // 0x0x10
    public int <DBKHKAPPDDL>k__BackingField;    // 0x0x20
    public int <IIBFOMPPMKO>k__BackingField;    // 0x0x24
    public int <ENMKGCKODNB>k__BackingField;    // 0x0x28
    public long <ACCNHFOECOM>k__BackingField;    // 0x0x30
    public long <NMHKBAAJJPP>k__BackingField;    // 0x0x38
}
...
{
    public int <ALGJEDCAJPA>k__BackingField;    // 0x0x10
    public int <HJAOHMIJEAM>k__BackingField;    // 0x0x14
    public int <KILHHKPFNPG>k__BackingField;    // 0x0x18
    public int <NPBCODJHHOO>k__BackingField;    // 0x0x1C
    public int <GDADEPHFMDC>k__BackingField;    // 0x0x20
    public DateTime? <ABFIGKLFIHJ>k__BackingField;    // 0x0x28
}
...
{
    public long <EDLOBJDPFIA>k__BackingField;    // 0x0x10
    public int <NDPLBIPJGFB>k__BackingField;    // 0x0x18
    public string <NBAPAGMOMKJ>k__BackingField;    // 0x0x20
    public int <HJAOHMIJEAM>k__BackingField;    // 0x0x28
    public int <LNNEMNMFBKE>k__BackingField;    // 0x0x2C
    public bool <CPCGGAAFDDG>k__BackingField;    // 0x0x30
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public LBNLNFJLBGL <Permission>k__BackingField;    // 0x0x18
    public LFNHDMIHLED <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<DDFGLELGIGA<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public CECDNPMINAH ReportCategory;    // 0x0x20
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public LFNHDMIHLED <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public MFMODIGGBCH <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<IKAHJLDCCHG> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{pILOEAAEPCJ}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool LJMCCHBIMND;    // 0x0x28
}
...
{
    public MAAPBJKLAMI? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public MAAPBJKLAMI IPJEDLNHODC;  // wrapper
...
{
    public OOJNNNOJHED OCHLMIHHGDH;  // wrapper
...
{
    public GGJNLOGIEPC HAFNBBNOLPO;  // wrapper
    public int? GMKABGLGDJK;  // wrapper
...
{
    public NGOGFOOOMLP ECDGAGABADF;  // wrapper
...
{
    public byte[] HPMNBNLACCC;  // wrapper
    public HLPJKPHOILD CLJAHENGAMP;  // wrapper
...
{
    public NGOGFOOOMLP EMNFLKAHBLG;  // wrapper
    public float? KBAHBMFJLOG;  // wrapper
    public bool? DIEJAMLNMFG;  // wrapper
...
{
    public List<FEJKALOKOAI> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public CJEELAAIIDE PCJJKLDOJMD;  // wrapper
    public CJEELAAIIDE? HEBEAAKFDPF;  // wrapper
...
{
    public ChatMessage DAMFJFKKFBI;  // wrapper
    public IDJGACJPHKL EMNFLKAHBLG;  // wrapper
...
{
    public LFNHDMIHLED NPGFKMBHNMB;  // wrapper
    public CLINHKJEGOJ GNKABCMMAMK;  // wrapper
    public MNBDLPDCMLE ONBOCOCLNKG;  // wrapper
    public MNBDLPDCMLE CEDCDAMJPAF;  // wrapper
...
// api/customAvatarItems/v1/{lMGCOEEBLBC}/appeal  [API POST]
public class CustomAvatarItemsV1LMGCOEEBLBCAppealRequest
{
    public Guid LMGCOEEBLBC;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{lAEAKABKIPG}  [API GET]
public class CustomAvatarItemsV2FromCreatorLAEAKABKIPGRequest
{
...
{
    public OJMEIAICOLM OHPILALBOPN;  // wrapper
    public CJEELAAIIDE? LDHEDJCJGMK;  // wrapper
...
{
    public IHPNDEMHEFA DEEJIECKHIC;  // wrapper
...
// api/keepsakes/{lMJKJEPMLBH}/collect  [API POST]
public class KeepsakesLMJKJEPMLBHCollectRequest
{
    public Guid LMJKJEPMLBH;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public HBAJDPHEHNO IHFKGHJIOCE;  // wrapper
    public long? MIFADOBCMAC;  // wrapper
...
{
    public Guid GJDFGJEOKNK;  // wrapper
...
{
    public Guid NKDBKIOAEHM;  // wrapper
...
{
    public Guid NKDBKIOAEHM;  // wrapper
    public long? EDDBIFCIPOC;  // wrapper
    public byte? KFBPKKLDJOM;  // wrapper
    public int? ODFBFMBMBOG;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid GJDFGJEOKNK;  // wrapper
    public long? ABOELGBENAG;  // wrapper
    public long? JIDLOCFBCFO;  // wrapper
    public int? FOLNLGICJKH;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> MHBNBGGMEBA;  // wrapper
...
{
    public MACIJMPNFBK HAFNBBNOLPO;  // wrapper
    public Guid? DKCIOKMBJEK;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public NGOGFOOOMLP EMNFLKAHBLG;  // wrapper
    public long? AOCJNFDFEAN;  // wrapper
    public Guid? OPDJMIHPBOJ;  // wrapper
    public int? AEGKAAEANBG;  // wrapper
...
{
    public Guid PHNCEBIMAPC;  // wrapper
...
{
    public Guid ALGPKPJOGOP;  // wrapper
...
{
    public KGFOHGPDAEN DGDEFLDDDDK;  // wrapper
}
