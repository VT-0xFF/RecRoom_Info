...
public class ABKFDGELHDG
{
    public int <GJPDBLDGJNI>k__BackingField;    // 0x0x10
    public byte <DKNKBMIHBNH>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// ACNHLDIFABM
//   RESPONSE PUT    api/roomconsumables   [Service.Econ]
public class ACNHLDIFABM
{
    public FBEMIOKKNKA <BHAGMHADOFK>k__BackingField;    // 0x0x10
    public PCNJAKCFJPO <LBFJJPJJEMK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AEBGFIBKDJF
//   (not directly referenced by a detected call)
public class AEBGFIBKDJF
{
    public Guid <BIDOMGGKJDC>k__BackingField;    // 0x0x10
    public long <OMCHLJJLPMB>k__BackingField;    // 0x0x20
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x28
    public string <JOMALAIAKLB>k__BackingField;    // 0x0x30
    public string <BAKMCEBMOOI>k__BackingField;    // 0x0x38
    public long <EGLGKEMCJEI>k__BackingField;    // 0x0x40
    public Guid? <KBDOICINLAE>k__BackingField;    // 0x0x48
    public DateTime <OHNBGAOHMHJ>k__BackingField;    // 0x0x60
    public int <KGOBKJLOGHB>k__BackingField;    // 0x0x68
}
...
// base   : GMFKICDBBIG
//   (not directly referenced by a detected call)
public class AGMGOBLFJCF : GMFKICDBBIG
{
    public int <DNBBBLFKFDH>k__BackingField;    // 0x0x68
    public List<JAAKBFPAEIK> <JAAAGGECNKI>k__BackingField;    // 0x0x70
    public List<JAAKBFPAEIK> <KMEHLAKJDMJ>k__BackingField;    // 0x0x78
    public List<JAAKBFPAEIK> <AHBKFPIPLGF>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// AHALNJLNOHH
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class AHALNJLNOHH
{
    public string <NNCPECPFPNE>k__BackingField;    // 0x0x10
    public string <MMFLPHBAMNE>k__BackingField;    // 0x0x18
    public string <JBPFLENOIEJ>k__BackingField;    // 0x0x20
    public string <JOMALAIAKLB>k__BackingField;    // 0x0x28
    public string <AHBPDFKFOCE>k__BackingField;    // 0x0x30
    public JGICOHOAAPM <BHAGMHADOFK>k__BackingField;    // 0x0x38
    public List<string> <HIMIOCCDGDH>k__BackingField;    // 0x0x40
    public List<string> <IFFNAJPLOKN>k__BackingField;    // 0x0x48
    public string <PLLPKOCDNNO>k__BackingField;    // 0x0x50
    public List<PEHADIKBKML> <NPLPAIFGJMP>k__BackingField;    // 0x0x58
}
...
public class AIBNMMHDEFD
{
    public long <PELPPNKAADA>k__BackingField;    // 0x0x10
    public int <GLAMBJMPLOM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AIEMAFOINCD
//   (not directly referenced by a detected call)
public class AIEMAFOINCD
{
    public JMOBIALPBAE <LLOKPFEHLPK>k__BackingField;    // 0x0x10
    public int <EGLGKEMCJEI>k__BackingField;    // 0x0x14
    public OBPIFKDFHPD <OPNJMLFKAJE>k__BackingField;    // 0x0x18
}
...
public class AONNFFCENEF
{
    public IReadOnlyList<LIJGNAADJPO> <CGHEEFMFBGF>k__BackingField;    // 0x0x10
}
...
//   (not directly referenced by a detected call)
public class BBFALMJKFCO : ValueType
{
    public BKGBLAEFKKI LJEOKMJLKJI;    // 0x0x0
    public BCAJBMEKGPP EAALAEMBDFO;    // 0x0x10
    public Guid NMFHCOEDCMP;    // 0x0x20
}
...
public class BBMIJHFODGD
{
    public Guid? <KIMJFKNIOPI>k__BackingField;    // 0x0x10
    public Guid <PPDFCLHBAKE>k__BackingField;    // 0x0x24
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class BCAJBMEKGPP : ValueType
{
    public Guid FIAGFFPOAHP;    // 0x0x0
}

// --------------------------------------------------------------------------
// BDHKFKFJNOP
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class BDHKFKFJNOP
{
    public List<CBHIDHEMBGJ> <EKMKGFKLGBE>k__BackingField;    // 0x0x10
    public IFOHFANHCAA <AHKNEAHMNBH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BHJIKPHKMAC
//   REQUEST  POST   api/equipment/v1/update   [Service.Econ]
public class BHJIKPHKMAC
{
    public string <BMPENDNBDJJ>k__BackingField;    // 0x0x10
    public string <KMAKPLMIAFG>k__BackingField;    // 0x0x18
    public string <MIAOCPBDIEM>k__BackingField;    // 0x0x20
    public string <DLFAMPKCFPB>k__BackingField;    // 0x0x28
    public FKLODFEJEFC <JPDKEIFGLLL>k__BackingField;    // 0x0x30
    public string <JHAMKJEMPGE>k__BackingField;    // 0x0x38
    public bool FEOPOJOCMCO;    // 0x0x40
    public bool <HNLMEGHBHKL>k__BackingField;    // 0x0x41
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class BKGBLAEFKKI : ValueType
{
    public Guid FIAGFFPOAHP;    // 0x0x0
}
...
// --------------------------------------------------------------------------
// BLHKLLDIIAF
// base   : IDDECIIKCLK`1<MKPOOCCADGL>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{gGDCPEHIKFL}   [Service.API]
public class BLHKLLDIIAF
{
...
public class BOJCLNKIBHA
{
    public List<IJDCFDLAFCH> <IFFNAJPLOKN>k__BackingField;    // 0x0x10
}
...
// CBHIDHEMBGJ
//   (not directly referenced by a detected call)
public class CBHIDHEMBGJ
{
    public int <PIEIDFEKKKL>k__BackingField;    // 0x0x10
    public IFOHFANHCAA <AHKNEAHMNBH>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// DBCPDALDPJL
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class DBCPDALDPJL
{
    public Dictionary<Guid, ACNHLDIFABM> <FPKJHEEMEFB>k__BackingField;    // 0x0x10
}
...
public class DCECCIJJJBA
{
    public int <NCDJGIHGKOB>k__BackingField;    // 0x0x10
    public bool <CHJDKLHNMPE>k__BackingField;    // 0x0x14
    public DateTime <DPLJIMGLFLC>k__BackingField;    // 0x0x18
    public bool <HKCHAECPAGL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DHKLKJIPGHJ
//   RESPONSE GET    api/config/v2   [Service.API]
public class DHKLKJIPGHJ
{
    public Dictionary<int, int> <IAJDPEIGCMG>k__BackingField;    // 0x0x10
    public List<EIJPPHDIFED> <DGBCBIICNJO>k__BackingField;    // 0x0x18
    public JFNBFCJIMNK[][] <MFNJGHOPCGE>k__BackingField;    // 0x0x20
    public NFHADPKLBCK <FCKDBOJCNHF>k__BackingField;    // 0x0x28
    public KFAOBIGDOEC <MKIOIFPPCNG>k__BackingField;    // 0x0x30
    public KLKLHCOBKGN <IPLNPCECLKB>k__BackingField;    // 0x0x38
    public LNJAFKCONJE <FJDKIFOJCIE>k__BackingField;    // 0x0x40
    public LANECCLLMJI <MCALCFEPHGI>k__BackingField;    // 0x0x48
    public string <HLDGGDLBHKD>k__BackingField;    // 0x0x50
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{kPCLJJLLFPK}   [Service.API]
...
public class DIGOGIJKBLC
{
    public KACDBBGFIOP <KGJFCOHMNJH>k__BackingField;    // 0x0x10
    public IFOHFANHCAA <AHKNEAHMNBH>k__BackingField;    // 0x0x18
    public OJADFBBNPHB <AFCPMNEBNLH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DJKNMGDNFIP
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class DJKNMGDNFIP
{
    public int <OGFPCLGBKJF>k__BackingField;    // 0x0x10
    public int? <HOOMBLDBJLA>k__BackingField;    // 0x0x14
    public string <HOLECHDGHFG>k__BackingField;    // 0x0x20
    public string <KIKHEODGFIN>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// DKAOOEFFGEN
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class DKAOOEFFGEN
{
    public long <DGCFBBPGMDB>k__BackingField;    // 0x0x10
    public GIJKGIHCDCC <IBMAEHPIIPB>k__BackingField;    // 0x0x18
}
...
// DMHMNGJDAPG
//   (not directly referenced by a detected call)
public class DMHMNGJDAPG
{
    public long <EGLGKEMCJEI>k__BackingField;    // 0x0x10
    public Guid? <KAGPPKDNDKA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DPNEEJIGNBE
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class DPNEEJIGNBE
{
    public bool <DGAMAICNIBI>k__BackingField;    // 0x0x10
    public string <MMFLPHBAMNE>k__BackingField;    // 0x0x18
    public string <LDLICHCFFDN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EFNPOAJMGBD
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.Econ]
public class EFNPOAJMGBD
{
    public long <PELPPNKAADA>k__BackingField;    // 0x0x10
    public int <GLAMBJMPLOM>k__BackingField;    // 0x0x18
}
...
// EHEIAAPDDMG
//   (not directly referenced by a detected call)
public class EHEIAAPDDMG
{
    public MMOOFGNBBLE <ACOBODLNJED>k__BackingField;    // 0x0x10
    public long <PAPGKFGNFJB>k__BackingField;    // 0x0x18
    public GiftItemDTO <AHKCENJBIIA>k__BackingField;    // 0x0x20
    public long? <MNJIDLLPCDO>k__BackingField;    // 0x0x28
    public int <DCHFJKMHCJG>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// EMMPOLCEABG
//   (not directly referenced by a detected call)
public class EMMPOLCEABG
{
    public HLFGEEPGPHA <KGJFCOHMNJH>k__BackingField;    // 0x0x10
    public KIIBLMAHPGD <PEKHOLCMPEP>k__BackingField;    // 0x0x18
}
...
public class EPIKGGEPLCO
{
    public CHEOLENCKAI <OMCOBKGJIAO>k__BackingField;    // 0x0x10
    public string <OKECLOCIIGL>k__BackingField;    // 0x0x18
    public int? <BBJGBOCAEGL>k__BackingField;    // 0x0x20
}
...
// FDHPINCENMB
//   (not directly referenced by a detected call)
public class FDHPINCENMB
{
    public long <PELPPNKAADA>k__BackingField;    // 0x0x10
    public Guid <ILFHGGPHMOJ>k__BackingField;    // 0x0x18
    public long <OMCHLJJLPMB>k__BackingField;    // 0x0x28
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x30
    public string <JOMALAIAKLB>k__BackingField;    // 0x0x38
    public int <EGLGKEMCJEI>k__BackingField;    // 0x0x40
    public Guid? <KBDOICINLAE>k__BackingField;    // 0x0x44
    public DateTime <CEDLPLOOPEP>k__BackingField;    // 0x0x58
    public string <BAKMCEBMOOI>k__BackingField;    // 0x0x60
    public NFCLLIJNMLP <IBMAEHPIIPB>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FFBEKIOGPFP
//   (not directly referenced by a detected call)
public class FFBEKIOGPFP
{
    public Guid <GHHNODOJPHH>k__BackingField;    // 0x0x10
    public Guid <ODLIHADMBLP>k__BackingField;    // 0x0x20
    public DateTime <KIIKJBHFCJA>k__BackingField;    // 0x0x30
    public List<KOOMIAIMMNH> <LELDLAHOBOJ>k__BackingField;    // 0x0x38
}
...
public class FLPKDMNECIO
{
    public int <MNODJGCJFFJ>k__BackingField;    // 0x0x10
    public int <GNAMKDOGFLP>k__BackingField;    // 0x0x14
    public float <AJLMHPFHGJL>k__BackingField;    // 0x0x18
    public int <FMPMOFFAHJP>k__BackingField;    // 0x0x1C
    public int <IFHEHMEKMLC>k__BackingField;    // 0x0x20
    public int <KDCPBAGPJFJ>k__BackingField;    // 0x0x24
    public int <FDKKMGMMKGD>k__BackingField;    // 0x0x28
    public string <NEJCJAAJNLP>k__BackingField;    // 0x0x30
    public string <BBOOIOBPFFH>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// FOCCJBDPGIH
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class FOCCJBDPGIH
{
    public int <LGDDKGJGLBG>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{oJEGODLFKAE}   [Service.Econ]
public class FOFGOIKPACL
{
    public FBEMIOKKNKA <BHAGMHADOFK>k__BackingField;    // 0x0x10
    public AEBGFIBKDJF <PCAKEFGFFKJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FOHDNNKDLMF
//   (not directly referenced by a detected call)
public class FOHDNNKDLMF
{
    public int <GMFILGEDIFE>k__BackingField;    // 0x0x10
    public BBMIJHFODGD <GEIOOBLPONE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GDBIIHBCKOE
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class GDBIIHBCKOE
{
    public Dictionary<Guid, FOHDNNKDLMF> <OEGMNAMCCBA>k__BackingField;    // 0x0x10
}
...
// GMFKICDBBIG
//   (not directly referenced by a detected call)
public class GMFKICDBBIG
{
    public int <CLJCJMHDAGB>k__BackingField;    // 0x0x10
    public HIJJKNGNEPC <IBMAEHPIIPB>k__BackingField;    // 0x0x14
    public List<AIEMAFOINCD> <HJPFFOGEGJC>k__BackingField;    // 0x0x18
    public List<AIEMAFOINCD> <HHDIAPBNLNH>k__BackingField;    // 0x0x20
    public bool <CKHFAPKPJHO>k__BackingField;    // 0x0x28
    public DateTime? <BDCKDEKLIBA>k__BackingField;    // 0x0x30
    public DateTime? <CLPAFFPNFBK>k__BackingField;    // 0x0x40
    public DateTime? <DCKEFBKLIMP>k__BackingField;    // 0x0x50
    public bool <HAMLFBAJNEJ>k__BackingField;    // 0x0x60
    public bool <AMOIAIAJLIB>k__BackingField;    // 0x0x61
}
...
public class HBLKCGLPBEL
{
    public List<string> <CBKNGMLKHBL>k__BackingField;    // 0x0x10
    public List<string> <JKGHEAODAJP>k__BackingField;    // 0x0x18
    public List<string> <ACLEKLHPJJM>k__BackingField;    // 0x0x20
}
...
public class HKIBENFPGOC
{
    public List<HLFGEEPGPHA> <HDIMEHKNMLA>k__BackingField;    // 0x0x10
    public string <AHKBONONNCA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HKMBMEGNHIN
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class HKMBMEGNHIN
{
    public long <OMCHLJJLPMB>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <GHIKLIJPFOK>k__BackingField;    // 0x0x18
    public MMHLNEJOIOA <JEBEIGJPLMN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HLAMONOBELK
//   REQUEST  POST   api/items/bulkpurchase   [Service.Commerce]
public class HLAMONOBELK
{
    public List<EHEIAAPDDMG> <PBMLMGIFKGH>k__BackingField;    // 0x0x10
    public DMBFOMPAHCH? <JHDMCFNPMEG>k__BackingField;    // 0x0x18
    public JMOBIALPBAE <LLOKPFEHLPK>k__BackingField;    // 0x0x20
    public bool <EDFHDFLADIB>k__BackingField;    // 0x0x24
    public bool <GOCKHHJBLDD>k__BackingField;    // 0x0x25
}

// --------------------------------------------------------------------------
// HLFGEEPGPHA
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class HLFGEEPGPHA
{
    public long <DGCFBBPGMDB>k__BackingField;    // 0x0x10
    public int <KJBFIKFDMHO>k__BackingField;    // 0x0x18
    public long <OMCHLJJLPMB>k__BackingField;    // 0x0x20
    public long? <FDPAPLIHIAK>k__BackingField;    // 0x0x28
    public long? <MDKEOKCDDCP>k__BackingField;    // 0x0x38
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x48
    public string <JOMALAIAKLB>k__BackingField;    // 0x0x50
    public string <BAKMCEBMOOI>k__BackingField;    // 0x0x58
    public DateTime <GAMNJCBPNNJ>k__BackingField;    // 0x0x60
    public DateTime <ICAOMKGHFPP>k__BackingField;    // 0x0x68
    public int <FELCPDAGHDN>k__BackingField;    // 0x0x70
    public OFCDIOFEKLN <NBBOALFNALM>k__BackingField;    // 0x0x74
    public bool <CFHENIBNGNF>k__BackingField;    // 0x0x78
    public bool <CCELHHECCJP>k__BackingField;    // 0x0x79
    public OIFBNIBMMFG <IDNFMECOBFL>k__BackingField;    // 0x0x7C
    public OIFBNIBMMFG <EOPGIOBLMHJ>k__BackingField;    // 0x0x80
    public long? <PBPGFBDDEGB>k__BackingField;    // 0x0x88
}
...
// HOCAAPNLMIL
//   (not directly referenced by a detected call)
public class HOCAAPNLMIL
{
    public bool <OJIAAKCBPID>k__BackingField;    // 0x0x10
    public NHEHHACAMCL <KBPGHNNPGCP>k__BackingField;    // 0x0x14
    public int <FDEDALFJPGL>k__BackingField;    // 0x0x18
    public DateTime <OHNBGAOHMHJ>k__BackingField;    // 0x0x20
}
...
public class HOHBDDPPJOD
{
    public int <DLLGHMPDINM>k__BackingField;    // 0x0x10
    public int <NCDJGIHGKOB>k__BackingField;    // 0x0x14
    public float <GCDCHODIIHN>k__BackingField;    // 0x0x18
    public float <EABAMILPKAJ>k__BackingField;    // 0x0x1C
    public bool <CHJDKLHNMPE>k__BackingField;    // 0x0x20
    public bool <MEBNADIEEGG>k__BackingField;    // 0x0x21
    public bool <HNLMEGHBHKL>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// HPAEHAJFIJH
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class HPAEHAJFIJH
{
    public IEJDNBBBEFC <OMCOBKGJIAO>k__BackingField;    // 0x0x10
    public int <LGDDKGJGLBG>k__BackingField;    // 0x0x14
    public long <GFCIKKCBNBL>k__BackingField;    // 0x0x18
    public bool <DOGNNEOMGID>k__BackingField;    // 0x0x20
    public string <GNJCHBKHCNF>k__BackingField;    // 0x0x28
    public int? <BBAJCFCBJIF>k__BackingField;    // 0x0x30
    public bool <JLKEJFEFIPL>k__BackingField;    // 0x0x38
    public bool <NIFNJGPEPFG>k__BackingField;    // 0x0x39
    public bool <AJBCBAKHOKE>k__BackingField;    // 0x0x3A
    public bool <PNFMNMOFCIH>k__BackingField;    // 0x0x3B
    public string <BDAFAMGCBBN>k__BackingField;    // 0x0x40
    public DateTime? <JKHCKJHHOGG>k__BackingField;    // 0x0x48
    public string <OEANNHCGIBE>k__BackingField;    // 0x0x58
    public float <CHJMJCABLEN>k__BackingField;    // 0x0x60
}
...
public class HPDDFOHIIFM
{
    public int <IABDHKPKCIO>k__BackingField;    // 0x0x10
    public PFMNHBCFOGN <IBMAEHPIIPB>k__BackingField;    // 0x0x14
    public LMIKCNHKEMP <FPGGONBMNMK>k__BackingField;    // 0x0x18
    public LMIKCNHKEMP <ANHANEHNFOG>k__BackingField;    // 0x0x1C
    public LMIKCNHKEMP <PIDLPJJEPIN>k__BackingField;    // 0x0x20
    public byte? <DKNKBMIHBNH>k__BackingField;    // 0x0x24
}
...
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{nBMAOFBFJAP}/{mBACJBGIJAL}   [Service.Econ]
public class IIBMOEOEPBJ
{
    public JMOBIALPBAE <LLOKPFEHLPK>k__BackingField;    // 0x0x10
    public HAMPHPPPIOL <ACJNOGJFPLI>k__BackingField;    // 0x0x14
    public int <DJDBOJIDIFN>k__BackingField;    // 0x0x18
    public int <JGKCKIIJKGJ>k__BackingField;    // 0x0x1C
    public int <IDKAJINBHCP>k__BackingField;    // 0x0x20
    public HKCOFCFMEKD <ADMMIKDINHE>k__BackingField;    // 0x0x24
    public bool <PJMMAPBJBBK>k__BackingField;    // 0x0x28
    public float <IBKAHCLBAAE>k__BackingField;    // 0x0x2C
    public int <FCGMEMDEKAK>k__BackingField;    // 0x0x30
    public bool <PCEOODELHFN>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// IJDCFDLAFCH
//   (not directly referenced by a detected call)
public class IJDCFDLAFCH
{
    public string <CMCHGGKGLOD>k__BackingField;    // 0x0x10
    public KFCGGMHBMIJ <IBMAEHPIIPB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JAAKBFPAEIK
//   (not directly referenced by a detected call)
public class JAAKBFPAEIK
{
    public bool <OJPNBAEMJMB>k__BackingField;    // 0x0x10
    public KOOMIAIMMNH <OHKCDNMCIGE>k__BackingField;    // 0x0x18
    public float <EPNEJKACDAJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JFNBFCJIMNK
//   (not directly referenced by a detected call)
public class JFNBFCJIMNK
{
    public GHEMLJOADCF DEGIIGEHKNM;    // 0x0x10
    public int BHPNIBLIOJI;    // 0x0x14
}
...
//   RESPONSE GET    api/playerevents/v1/all/{kGKDIIKHGOB}   [Service.API]
public class JHABIOOAMLB
{
    public List<HLFGEEPGPHA> <PAGJOCCIAJD>k__BackingField;    // 0x0x10
    public List<EMMPOLCEABG> <JGCOBFEIGLO>k__BackingField;    // 0x0x18
}
...
public class JOLLIHIHMAN
{
    public long <OMCHLJJLPMB>k__BackingField;    // 0x0x10
    public long? <FDPAPLIHIAK>k__BackingField;    // 0x0x18
    public long? <MDKEOKCDDCP>k__BackingField;    // 0x0x28
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x38
    public string <JOMALAIAKLB>k__BackingField;    // 0x0x40
    public List<string> <IFFNAJPLOKN>k__BackingField;    // 0x0x48
    public string <BAKMCEBMOOI>k__BackingField;    // 0x0x50
    public DateTime <GAMNJCBPNNJ>k__BackingField;    // 0x0x58
    public DateTime <ICAOMKGHFPP>k__BackingField;    // 0x0x60
    public OFCDIOFEKLN <NBBOALFNALM>k__BackingField;    // 0x0x68
    public bool <CFHENIBNGNF>k__BackingField;    // 0x0x6C
    public bool <CCELHHECCJP>k__BackingField;    // 0x0x6D
    public OIFBNIBMMFG <IDNFMECOBFL>k__BackingField;    // 0x0x70
    public OIFBNIBMMFG <EOPGIOBLMHJ>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// KABCCOJJJPA
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{fBLIJIPJKFJ}   [Service.API]
public class KABCCOJJJPA
{
    public uint <NNCPECPFPNE>k__BackingField;    // 0x0x10
    public uint? <MKODGGFIFIF>k__BackingField;    // 0x0x14
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x20
    public string <JOMALAIAKLB>k__BackingField;    // 0x0x28
    public DateTime <CMGAJDGOPOB>k__BackingField;    // 0x0x30
    public DateTime? <PNFNJFNDCLP>k__BackingField;    // 0x0x38
    public bool <KILPFAHLLML>k__BackingField;    // 0x0x48
    public List<AHALNJLNOHH> <JCLHOFPLENC>k__BackingField;    // 0x0x50
    public List<string> <IFFNAJPLOKN>k__BackingField;    // 0x0x58
    public int <MADPFPEGPEL>k__BackingField;    // 0x0x60
    public int <PPAODADIIPF>k__BackingField;    // 0x0x64
    public int <OCNICPDNDKP>k__BackingField;    // 0x0x68
}
...
// base   : HLFGEEPGPHA
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class KACDBBGFIOP : HLFGEEPGPHA
{
    public List<IJDCFDLAFCH> <IFFNAJPLOKN>k__BackingField;    // 0x0x98
}
...
// KFAOBIGDOEC
//   (not directly referenced by a detected call)
public class KFAOBIGDOEC
{
    public float <IGDGMCDFALO>k__BackingField;    // 0x0x10
    public float <OJEPCKLLPIJ>k__BackingField;    // 0x0x14
    public float <LIGKJGKJEBM>k__BackingField;    // 0x0x18
    public float <DMLGHDEJGCH>k__BackingField;    // 0x0x1C
    public float <FPPIMDIAHNG>k__BackingField;    // 0x0x20
    public float <ONIKKAGOOCB>k__BackingField;    // 0x0x24
    public float <NDGAOLOGNOK>k__BackingField;    // 0x0x28
    public float <ANAHJEDOIKD>k__BackingField;    // 0x0x2C
}
...
// KIIBLMAHPGD
//   (not directly referenced by a detected call)
public class KIIBLMAHPGD
{
    public long <MIPIGCGOCJL>k__BackingField;    // 0x0x10
    public long <DGCFBBPGMDB>k__BackingField;    // 0x0x18
    public int <GJPDBLDGJNI>k__BackingField;    // 0x0x20
    public DateTime <CEDLPLOOPEP>k__BackingField;    // 0x0x28
    public GIJKGIHCDCC <IBMAEHPIIPB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// KJEECGIDLHP
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.Econ]
public class KJEECGIDLHP
{
    public List<string> <IBABPPPKMGF>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KJEGLNNPOGG
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Auth]
public class KJEGLNNPOGG
{
    public Guid <OLHEELBPDMI>k__BackingField;    // 0x0x10
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x20
    public string <BAKMCEBMOOI>k__BackingField;    // 0x0x28
    public DateTime <KIIKJBHFCJA>k__BackingField;    // 0x0x30
    public DateTime? <NMMKMAFDAKH>k__BackingField;    // 0x0x38
    public List<FFBEKIOGPFP> <CKPAFCGEJKF>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// KLBBMHGJFKA
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class KLBBMHGJFKA
{
    public IEJDNBBBEFC <OMCOBKGJIAO>k__BackingField;    // 0x0x10
    public long <DGCFBBPGMDB>k__BackingField;    // 0x0x18
    public string <OKECLOCIIGL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KLKLHCOBKGN
//   (not directly referenced by a detected call)
public class KLKLHCOBKGN
{
    public int <ELCCODLJGKO>k__BackingField;    // 0x0x10
    public DateTime <HNNDJOMIPDE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KLMODPJCNIJ
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class KLMODPJCNIJ
{
    public int? <GPHGIMOFKJP>k__BackingField;    // 0x0x10
    public string <AHBPDFKFOCE>k__BackingField;    // 0x0x18
    public string <MJGIAEDGHBJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KOOMIAIMMNH
//   (not directly referenced by a detected call)
public class KOOMIAIMMNH
{
    public int <JCGKGPOAFJI>k__BackingField;    // 0x0x10
    public string <MIAOCPBDIEM>k__BackingField;    // 0x0x18
    public string <DLFAMPKCFPB>k__BackingField;    // 0x0x20
    public string <LBLKOBMNOCB>k__BackingField;    // 0x0x28
    public string <BONLCKDNMON>k__BackingField;    // 0x0x30
    public BBFALMJKFCO? <NGHCPJMINKH>k__BackingField;    // 0x0x38
    public string <PGBFHIIMGHM>k__BackingField;    // 0x0x70
    public Guid? <AMGGAMONFHD>k__BackingField;    // 0x0x78
    public GJGFKJMIFED? <FEHGIMCKLCG>k__BackingField;    // 0x0x8C
    public string <ONMOJMFNFDI>k__BackingField;    // 0x0x98
    public string <PFIMPGKPMPK>k__BackingField;    // 0x0xA0
    public bool <BKEOGJEPNAN>k__BackingField;    // 0x0xA8
    public bool <OKNBAIPLNLE>k__BackingField;    // 0x0xA9
    public bool <MJEBJAOAHHC>k__BackingField;    // 0x0xAA
    public FKLODFEJEFC <JPDKEIFGLLL>k__BackingField;    // 0x0xAC
    public JMOBIALPBAE <LLOKPFEHLPK>k__BackingField;    // 0x0xB0
    public int <GMFHLFKNCMG>k__BackingField;    // 0x0xB4
    public BBJBOGNMPDO <POONONGNNHG>k__BackingField;    // 0x0xB8
    public MHCMHLOBBIK <FHHFNEBGFBB>k__BackingField;    // 0x0xBC
    public int? <BEKOODJOKAO>k__BackingField;    // 0x0xC0
    public string <IECPADNLHME>k__BackingField;    // 0x0xC8
    public int? <PCHKJEEOKBI>k__BackingField;    // 0x0xD0
    public int? <LKMIFKAEKBD>k__BackingField;    // 0x0xD8
    public string <JHAMKJEMPGE>k__BackingField;    // 0x0xE0
}
...
public class KPANLMOBNIC
{
    public RoomKeyResult <BHAGMHADOFK>k__BackingField;    // 0x0x10
    public FDHPINCENMB <AJLJOKPKLLD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LANECCLLMJI
//   (not directly referenced by a detected call)
public class LANECCLLMJI
{
    public float <EKIJNIBDJDB>k__BackingField;    // 0x0x10
}
...
public class LCMAEKLHAOB
{
    public IFOHFANHCAA <AHKNEAHMNBH>k__BackingField;    // 0x0x10
}
...
public class LFODJMJAIML
{
    public GJGFKJMIFED <FEHGIMCKLCG>k__BackingField;    // 0x0x10
    public string <DGMFFOCBBHB>k__BackingField;    // 0x0x18
    public string <MIAOCPBDIEM>k__BackingField;    // 0x0x20
    public string <DLFAMPKCFPB>k__BackingField;    // 0x0x28
    public FKLODFEJEFC <JPDKEIFGLLL>k__BackingField;    // 0x0x30
    public string <LBLKOBMNOCB>k__BackingField;    // 0x0x38
    public int <PCHKJEEOKBI>k__BackingField;    // 0x0x40
    public bool <FACGGKEOHKE>k__BackingField;    // 0x0x44
    public string <IADNONHJLKF>k__BackingField;    // 0x0x48
    public DateTime <CEDLPLOOPEP>k__BackingField;    // 0x0x50
}
...
// base   : KABLIBNEALF
//   (not directly referenced by a detected call)
public class LIJGNAADJPO : KABLIBNEALF
{
    public HOBAGOBAGBC NBOFDFNFKFM;    // 0x0x20
}

// --------------------------------------------------------------------------
// LJLGOCBEPMN
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class LJLGOCBEPMN
{
    public List<int> <DDGBBMDGHPM>k__BackingField;    // 0x0x10
    public string <AHKBONONNCA>k__BackingField;    // 0x0x18
}
...
// LNJAFKCONJE
//   (not directly referenced by a detected call)
public class LNJAFKCONJE
{
    public int <DKBHPGOEMOH>k__BackingField;    // 0x0x10
}
...
public class LOJCPLLODLI : ALKIBBAMHAB
{
    public KEMFOOOPIGP? <JJDBJBNNIGG>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <KDEGGJOEJHJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MDJLEHALFLG
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.API]
public class MDJLEHALFLG
{
    public List<long> <EIIFIEBHEJM>k__BackingField;    // 0x0x10
    public CPLPAOPMENF <IBMAEHPIIPB>k__BackingField;    // 0x0x18
    public string <KHLNCKBAHGI>k__BackingField;    // 0x0x20
    public long? <OMCHLJJLPMB>k__BackingField;    // 0x0x28
}
...
public class MFAKJOFAABL
{
    public int <GLAMBJMPLOM>k__BackingField;    // 0x0x10
    public Guid <KAGPPKDNDKA>k__BackingField;    // 0x0x14
    public long <FJFBPKJHMFA>k__BackingField;    // 0x0x28
    public DateTime <OHNBGAOHMHJ>k__BackingField;    // 0x0x30
}
...
public class MKEAGGDNDEN
{
    public Guid <PDMGJLOEBDM>k__BackingField;    // 0x0x10
    public long <KEILBKMNDFB>k__BackingField;    // 0x0x20
}
...
// MMOOFGNBBLE
//   (not directly referenced by a detected call)
public class MMOOFGNBBLE
{
    public AHDPJLIOJFB <IBMAEHPIIPB>k__BackingField;    // 0x0x10
    public int? <DFOGILOOFKO>k__BackingField;    // 0x0x14
    public Guid? <ABMMHFKJJPG>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// MPBEPJGNIHD
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.Econ]
public class MPBEPJGNIHD
{
    public Guid <KAGPPKDNDKA>k__BackingField;    // 0x0x10
    public int <AKAMOCGKFBI>k__BackingField;    // 0x0x20
    public long <NMAEBMDOEGA>k__BackingField;    // 0x0x28
    public Guid <PDMGJLOEBDM>k__BackingField;    // 0x0x30
}
...
// NFHADPKLBCK
//   (not directly referenced by a detected call)
public class NFHADPKLBCK
{
    public int <KDCDOGMDBLC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NFJNHMNJHEM
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class NFJNHMNJHEM
{
    public List<PDDOAKKEKDO> <DOPMMEEOBOI>k__BackingField;    // 0x0x10
    public string <AHKBONONNCA>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/progressionEvents/collect/{kPCLJJLLFPK}/{fGBILBEOOFH}   [Service.API]
public class NGBAACAAEGB
{
    public long? <NNCPECPFPNE>k__BackingField;    // 0x0x10
    public int <GJPDBLDGJNI>k__BackingField;    // 0x0x20
    public int? <GEJGNPIPCNB>k__BackingField;    // 0x0x24
    public string <BONLCKDNMON>k__BackingField;    // 0x0x30
    public GJGFKJMIFED? <FEHGIMCKLCG>k__BackingField;    // 0x0x38
    public string <PGBFHIIMGHM>k__BackingField;    // 0x0x40
    public Guid? <AMGGAMONFHD>k__BackingField;    // 0x0x48
    public string <ONMOJMFNFDI>k__BackingField;    // 0x0x60
    public string <PFIMPGKPMPK>k__BackingField;    // 0x0x68
    public JMOBIALPBAE <LLOKPFEHLPK>k__BackingField;    // 0x0x70
    public int <GMFHLFKNCMG>k__BackingField;    // 0x0x74
    public int <CAHKFCKAMBN>k__BackingField;    // 0x0x78
    public MHCMHLOBBIK <CJOAPPDDANH>k__BackingField;    // 0x0x7C
    public FKLODFEJEFC <OCLNFADNHAF>k__BackingField;    // 0x0x80
    public string <GACDOPFAPIF>k__BackingField;    // 0x0x88
    public string <DANNPHLAGFI>k__BackingField;    // 0x0x90
    public bool <OCELMDJKEEH>k__BackingField;    // 0x0x98
    public OIGNCMMGMJK <MLMOELHDNDF>k__BackingField;    // 0x0x9C
    public NHEHHACAMCL <DNPBGMCBBNO>k__BackingField;    // 0x0xA0
    public ENIAACCGKEN? <PNNCCAHKNHC>k__BackingField;    // 0x0xA4
    public bool <BAACCGDIMHB>k__BackingField;    // 0x0xAC
    public bool <NMDEOGNEHPB>k__BackingField;    // 0x0xAD
    public string <NJIGILBDIKA>k__BackingField;    // 0x0xB0
    public string <COAMEHDLNNE>k__BackingField;    // 0x0xB8
    public bool <LFOLAJEOGAC>k__BackingField;    // 0x0xC0
    public bool PBOGPGOHHDI;    // 0x0xC1
}
...
public class NPAGLAJNOLJ
{
    public BBMIJHFODGD <GEIOOBLPONE>k__BackingField;    // 0x0x10
    public DMHMNGJDAPG <OAKBJOCPOHJ>k__BackingField;    // 0x0x18
    public int <GMFILGEDIFE>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// OBBPOPFNKEK
// base   : IDDECIIKCLK`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class OBBPOPFNKEK
{
    // (no instance fields in the metadata dump)
}
...
// OBPIFKDFHPD
//   (not directly referenced by a detected call)
public class OBPIFKDFHPD
{
    public int <MPAJKCBAEHB>k__BackingField;    // 0x0x10
    public DateTime? <GIFKPNNMEKI>k__BackingField;    // 0x0x18
    public DateTime? <FOINNNGMCGI>k__BackingField;    // 0x0x28
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{lHMBLLKGLHN}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{aKMEAMPGKCA}   [Service.API]
...
public class OCPDPLDGJJM
{
    public bool <HBGEJPPBLNA>k__BackingField;    // 0x0x10
    public string <IHDDJOJIAOH>k__BackingField;    // 0x0x18
    public string <GAAPIIAKGJH>k__BackingField;    // 0x0x20
}
...
// base   : DFOKMNCNAGL
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{gMLFGDBLLAL}   [Service.Econ]
public class OEHGCJPLKDH : DFOKMNCNAGL
{
    public int <FFHOFJHEMBM>k__BackingField;    // 0x0x30
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x38
    public DateTime <KIIKJBHFCJA>k__BackingField;    // 0x0x40
    public DateTime <BJOHGBKPPMP>k__BackingField;    // 0x0x48
    public JMOBIALPBAE <LLOKPFEHLPK>k__BackingField;    // 0x0x50
    public GMFKICDBBIG <NGOEKIAGPNA>k__BackingField;    // 0x0x58
    public List<AGMGOBLFJCF> <EEOALHKMGAE>k__BackingField;    // 0x0x60
    public HOCAAPNLMIL <JDKOKJLCFIG>k__BackingField;    // 0x0x68
}
...
public class OHDCKONOIGI
{
    public bool <HBGEJPPBLNA>k__BackingField;    // 0x0x10
    public string <GNJCHBKHCNF>k__BackingField;    // 0x0x18
}
...
public class OJADFBBNPHB
{
    public LDKAJAFINKE <AHKNEAHMNBH>k__BackingField;    // 0x0x10
    public List<string> <IFFNAJPLOKN>k__BackingField;    // 0x0x18
}
...
public class ONBDDIAOJCE
{
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x10
    public string <JOMALAIAKLB>k__BackingField;    // 0x0x18
    public int? <EGLGKEMCJEI>k__BackingField;    // 0x0x20
    public ALNGOLLGNAJ? <NBBOALFNALM>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// PCJPDJDMDAM
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.Econ]
public class PCJPDJDMDAM
{
    public int DLNFHNEMOGP;    // 0x0x10
    public long HMHELAEOMHL;    // 0x0x18
}

// --------------------------------------------------------------------------
// PCNJAKCFJPO
//   (not directly referenced by a detected call)
public class PCNJAKCFJPO
{
    public Guid <BIDOMGGKJDC>k__BackingField;    // 0x0x10
    public int <GLAMBJMPLOM>k__BackingField;    // 0x0x20
    public int <ALAMCJAOOEG>k__BackingField;    // 0x0x24
    public Guid <CNLNJFAKJEK>k__BackingField;    // 0x0x28
    public DateTime <OHNBGAOHMHJ>k__BackingField;    // 0x0x38
    public AEBGFIBKDJF <PCAKEFGFFKJ>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PDDOAKKEKDO
//   (not directly referenced by a detected call)
public class PDDOAKKEKDO
{
    public int <IJMMPJOBMBH>k__BackingField;    // 0x0x10
    public DateTime <CEDLPLOOPEP>k__BackingField;    // 0x0x18
    public DateTime? <GCGLJPJPDKC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PEHADIKBKML
//   (not directly referenced by a detected call)
public class PEHADIKBKML
{
    public DateTime <CEDLPLOOPEP>k__BackingField;    // 0x0x10
    public string <BBOFNMEELDF>k__BackingField;    // 0x0x18
}
...
public class PHCBDGGIENG : ALKIBBAMHAB
{
    public NPDIIMPFEBH? <JJDBJBNNIGG>k__BackingField;    // 0x0x18
    public MFAKJOFAABL <AKFNPLJPGBI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// POCEPBJIIAG
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class POCEPBJIIAG
{
    public Guid? <BIDOMGGKJDC>k__BackingField;    // 0x0x10
    public long? <OMCHLJJLPMB>k__BackingField;    // 0x0x28
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x38
    public string <JOMALAIAKLB>k__BackingField;    // 0x0x40
    public string <BAKMCEBMOOI>k__BackingField;    // 0x0x48
    public DMHMNGJDAPG <PNIBONFGOLB>k__BackingField;    // 0x0x50
}
...
public class AddKeepsakeInstanceRequest
{
    public long <OMCHLJJLPMB>k__BackingField;    // 0x0x10
    public long? <FDPAPLIHIAK>k__BackingField;    // 0x0x18
    public KICOBCGECLF <MDAJPHKILEO>k__BackingField;    // 0x0x28
}
...
{
    public CMDOMOKLIEG <AHKNEAHMNBH>k__BackingField;    // 0x0x10
    public string <GLGMLHOKPDN>k__BackingField;    // 0x0x18
    public string <EFENOHMEGPK>k__BackingField;    // 0x0x20
    public string <APLNKJOCDIO>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public JMOBIALPBAE <CurrencyType>k__BackingField;    // 0x0x18
    public ENIAACCGKEN <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<MGFOJMLPGFP<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <DGCFBBPGMDB>k__BackingField;    // 0x0x10
    public long? <JEELIHIGELE>k__BackingField;    // 0x0x18
}
...
{
    public string <BNCIEEFJEBB>k__BackingField;    // 0x0x10
    public int <BMIBCHCONDE>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public FPCPFFFCDNA FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public MHCMHLOBBIK <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public KICOBCGECLF <EMNIGCHCHFP>k__BackingField;    // 0x0x10
    public string <KOEFDKJMJAI>k__BackingField;    // 0x0x18
    public int <AHLJDMMAGPO>k__BackingField;    // 0x0x20
    public int <HAAPNKAGBDJ>k__BackingField;    // 0x0x24
    public string <KKJAHANNCPP>k__BackingField;    // 0x0x28
    public string <DJJEPHDGMMF>k__BackingField;    // 0x0x30
}
...
{
    public int <GLAMBJMPLOM>k__BackingField;    // 0x0x10
    public Guid <DJNMBLCDMCB>k__BackingField;    // 0x0x14
    public DateTime <IBHIELKJGJJ>k__BackingField;    // 0x0x28
}
...
{
    public bool <MHPMCIHDMMN>k__BackingField;    // 0x0x10
    public int <LDGJLLPMOKE>k__BackingField;    // 0x0x14
    public bool <DOJAMDOGNEF>k__BackingField;    // 0x0x18
}
...
{
    public Guid <DJNMBLCDMCB>k__BackingField;    // 0x0x10
    public KICOBCGECLF <LGLGHFKHJEA>k__BackingField;    // 0x0x20
    public int <FAMDLFCOKED>k__BackingField;    // 0x0x24
    public long <OMCHLJJLPMB>k__BackingField;    // 0x0x28
    public long? <FDPAPLIHIAK>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{bGMNHPBAPKK}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <HMONGJJMNEK>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <NHGOOFEBEIL>k__BackingField;    // 0x0x18
}
...
{
    public long <OMGMCHNDKOD>k__BackingField;    // 0x0x10
    public long <OMCHLJJLPMB>k__BackingField;    // 0x0x18
    public long <FJEKOMCINAJ>k__BackingField;    // 0x0x20
    public FOEBMMJINIE <IBMAEHPIIPB>k__BackingField;    // 0x0x28
    public int <CNDCACFMDOG>k__BackingField;    // 0x0x2C
}
...
{
    public long <OMCHLJJLPMB>k__BackingField;    // 0x0x10
    public List<Guid> <KCDELBABGPD>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <HMONGJJMNEK>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <NHGOOFEBEIL>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <JJCJCCJHCPM>k__BackingField;    // 0x0x20
}
...
{
    public long <FJEKOMCINAJ>k__BackingField;    // 0x0x10
    public long <IMNCNEPOCJM>k__BackingField;    // 0x0x18
    public int? <JLDNPLAHHNP>k__BackingField;    // 0x0x20
    public int? <BBFMMDOHDEM>k__BackingField;    // 0x0x28
    public long? <CBALFFABJPC>k__BackingField;    // 0x0x30
    public long <LMNLHEADDHB>k__BackingField;    // 0x0x40
    public long <KGAMNKJCLJO>k__BackingField;    // 0x0x48
    public int <DDLGMFLPBAK>k__BackingField;    // 0x0x50
    public FOEBMMJINIE <BGCLKGAPLHL>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <CAENIPDEFAB>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public MHCMHLOBBIK <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public JMJBOEJBCPI creatorAccountRole;    // 0x0x68
...
{
    public ILOHEJNELGD <OJOEBGFBMJD>k__BackingField;    // 0x0x10
    public MKNNABFBDJG <JBIMEADKNFK>k__BackingField;    // 0x0x14
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x18
    public string <JOMALAIAKLB>k__BackingField;    // 0x0x20
    public bool <KKHDDANELGG>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<ILOHEJNELGD> <PGKCLEHMLKG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{kPCLJJLLFPK}   [Service.API]
public class ProgressionEventDTO
{
    public long <IMNCNEPOCJM>k__BackingField;    // 0x0x10
    public string <ONFDGLMMGPG>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <AHBKFPIPLGF>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <EPGKKIFFGNP>k__BackingField;    // 0x0x28
    public DateTime <GAMNJCBPNNJ>k__BackingField;    // 0x0x30
    public DateTime <ICAOMKGHFPP>k__BackingField;    // 0x0x38
    public DateTime <KEJMMFCLNAO>k__BackingField;    // 0x0x40
    public bool <EPDOCJIALEB>k__BackingField;    // 0x0x48
    public int <CAIFOAIEMAE>k__BackingField;    // 0x0x4C
    public float <CMODACBPJIK>k__BackingField;    // 0x0x50
    public Guid? <BOBGGJHHPOO>k__BackingField;    // 0x0x54
    public string <JJKJPGGPGOI>k__BackingField;    // 0x0x68
    public string <KNNCBIHEJEH>k__BackingField;    // 0x0x70
    public string <DGHDKOINEPC>k__BackingField;    // 0x0x78
    public string <ONLCHEPIMBJ>k__BackingField;    // 0x0x80
}
...
{
    public Guid <GDNMPPGFGIN>k__BackingField;    // 0x0x10
    public int <FGIIJNOIIEB>k__BackingField;    // 0x0x20
    public int <FIEBBOOAFNP>k__BackingField;    // 0x0x24
    public int <EACAFPCMDEO>k__BackingField;    // 0x0x28
    public long <MLNNBKDCJCM>k__BackingField;    // 0x0x30
    public long <PPAFIAIMLBJ>k__BackingField;    // 0x0x38
}
...
{
    public int <GLAMBJMPLOM>k__BackingField;    // 0x0x10
    public int <CAHKFCKAMBN>k__BackingField;    // 0x0x14
    public int <CPEMPEENHAD>k__BackingField;    // 0x0x18
    public int <FHEPBELIAPK>k__BackingField;    // 0x0x1C
    public int <HLMAMMHAMBE>k__BackingField;    // 0x0x20
    public DateTime? <NHMFLPMBMNP>k__BackingField;    // 0x0x28
}
...
{
    public long <IMDGLMJIJMI>k__BackingField;    // 0x0x10
    public int <JCGKGPOAFJI>k__BackingField;    // 0x0x18
    public string <BAKMCEBMOOI>k__BackingField;    // 0x0x20
    public int <CAHKFCKAMBN>k__BackingField;    // 0x0x28
    public int <EPAONBCLPAC>k__BackingField;    // 0x0x2C
    public bool <NMPIMDJHLKH>k__BackingField;    // 0x0x30
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public POHHMDMPANO <Permission>k__BackingField;    // 0x0x18
    public ALNGOLLGNAJ <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<CLDOPFFBNJI<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public KPAHBDDOCJC ReportCategory;    // 0x0x20
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public ALNGOLLGNAJ <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public JBHJOIACNNC <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<OILEFKJABBN> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{gCPFCPNFMAG}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool PMOCNKIPNGC;    // 0x0x28
}
...
{
    public PCNKAGEMGMF? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public PCNKAGEMGMF BINFBNKFOEG;  // wrapper
...
{
    public OIGNCMMGMJK PLIOPHEFBIO;  // wrapper
...
{
    public GDMJABNKMGN KHNCICOHHHJ;  // wrapper
    public int? PPHPEINNDJE;  // wrapper
...
{
    public IEJDNBBBEFC OIFIPJBPKLJ;  // wrapper
...
{
    public byte[] AOFGGGKINCN;  // wrapper
    public JKMIINEELLD FIEBEABCLMD;  // wrapper
...
{
    public IEJDNBBBEFC KDFPGIOLHOI;  // wrapper
    public float? EOPCJJOPMMP;  // wrapper
    public bool? DDGGOMLOOJD;  // wrapper
...
{
    public List<BBFALMJKFCO> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public MHCMHLOBBIK FAJBNOJIOHK;  // wrapper
    public MHCMHLOBBIK? LPNPGANLFGE;  // wrapper
...
{
    public ChatMessage FGEBHLNNMNH;  // wrapper
    public CHAEHKICHJE KDFPGIOLHOI;  // wrapper
...
{
    public ALNGOLLGNAJ EMAIMHFDOKO;  // wrapper
    public OLHCBLFCFPF KBEDHMHMLDB;  // wrapper
    public BNAAENMNGDA CPCEMMOLGNL;  // wrapper
    public BNAAENMNGDA CEJPJPAPFOJ;  // wrapper
...
// api/customAvatarItems/v1/{lHMBLLKGLHN}/appeal  [API POST]
public class CustomAvatarItemsV1LHMBLLKGLHNAppealRequest
{
    public Guid LHMBLLKGLHN;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{gGDCPEHIKFL}  [API GET]
public class CustomAvatarItemsV2FromCreatorGGDCPEHIKFLRequest
{
...
{
    public CKKFNEIJICD IHDDBNIPCIM;  // wrapper
    public MHCMHLOBBIK? JPKCKHBKCLA;  // wrapper
...
{
    public BNBNPIOABPE NGMDBPFKPIK;  // wrapper
...
{
    public int? BIMIGOBGGFM;  // wrapper
    public Guid? LHMBLLKGLHN;  // wrapper
...
// api/keepsakes/{aKMEAMPGKCA}/collect  [API POST]
public class KeepsakesAKMEAMPGKCACollectRequest
{
    public Guid AKMEAMPGKCA;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public CPLPAOPMENF AMDMAMLIDJH;  // wrapper
    public long? NFMLPECGLEO;  // wrapper
...
{
    public Guid GEOHJNLANGM;  // wrapper
...
{
    public Guid IHAKIFCEJHB;  // wrapper
...
{
    public Guid IHAKIFCEJHB;  // wrapper
    public long? GGPHCFIKNBK;  // wrapper
    public byte? BLJJLAFHKPA;  // wrapper
    public int? JLFKDHGAEDA;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid GEOHJNLANGM;  // wrapper
    public long? CJKNJNIOKFP;  // wrapper
    public long? JJAAKAKFIPL;  // wrapper
    public int? DBCPOKBJJFD;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> OPJDOLNIGOE;  // wrapper
...
{
    public NFCLLIJNMLP KHNCICOHHHJ;  // wrapper
    public Guid? MIIAAAEKOHH;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public IEJDNBBBEFC KDFPGIOLHOI;  // wrapper
    public long? DGBKEBKMEEB;  // wrapper
    public Guid? MHJHGIKOLPB;  // wrapper
    public int? CFBIBGCKLLF;  // wrapper
...
{
    public Guid HPLLFIOGEGM;  // wrapper
...
{
    public Guid JHPHHEDNEFL;  // wrapper
...
{
    public JGICOHOAAPM ODCPPADIKPN;  // wrapper
}
