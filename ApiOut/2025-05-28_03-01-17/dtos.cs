...
public class AABBOHCJGMG
{
    public long <KOBCDEFLFEA>k__BackingField;    // 0x0x10
    public Guid? <ENCNLBFICNN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AAMIABJMAFG
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class AAMIABJMAFG
{
    public int <COJLLMOMBAL>k__BackingField;    // 0x0x10
    public int? <HJBGAHKMKGH>k__BackingField;    // 0x0x14
    public string <MEEPGGDNOJF>k__BackingField;    // 0x0x20
    public string <NMMDHIKBKFE>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// ACNAHMLNJFA
//   (not directly referenced by a detected call)
public class ACNAHMLNJFA
{
    public long <JDKDKDGNHEC>k__BackingField;    // 0x0x10
    public long <HDCCKJOJFKK>k__BackingField;    // 0x0x18
    public int <LBFAEPAJEGI>k__BackingField;    // 0x0x20
    public DateTime <DLAFINNBFJJ>k__BackingField;    // 0x0x28
    public BHJPAICNEDB <NCEHFAMFLOO>k__BackingField;    // 0x0x30
}
...
public class ADNHAHJKFPJ
{
    public List<IABOEBICFND> <MDGLFLIOFPG>k__BackingField;    // 0x0x10
    public OGOPDIEMCGO <KIADJALGEHB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AIDEHMJHANF
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{fONJFDCCINO}   [Service.API]
public class AIDEHMJHANF
{
    public uint <GCEODDOCLLM>k__BackingField;    // 0x0x10
    public uint? <ODPPACMNNBO>k__BackingField;    // 0x0x14
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x20
    public string <DIJDHLMAJHM>k__BackingField;    // 0x0x28
    public DateTime <EMMNMDIMJBF>k__BackingField;    // 0x0x30
    public DateTime? <OLCEHAGALJP>k__BackingField;    // 0x0x38
    public bool <HHABGHMDKLD>k__BackingField;    // 0x0x48
    public List<LINFIALOPIF> <KPNJJLDKJDN>k__BackingField;    // 0x0x50
    public List<string> <GOJEAJEELJB>k__BackingField;    // 0x0x58
    public int <BMKMIPNKBID>k__BackingField;    // 0x0x60
    public int <NMFJDLICEGD>k__BackingField;    // 0x0x64
    public int <ECDIBMPJAEN>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// AJFBHFFLFNH
// base   : IEHHPLNDNNN`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class AJFBHFFLFNH
{
...
// AJMHLHJLMDN
//   (not directly referenced by a detected call)
public class AJMHLHJLMDN
{
    public NBKPAFCODLJ <GMMMDFEONIC>k__BackingField;    // 0x0x10
    public ACNAHMLNJFA <BGELAIANPHB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// APDEKBHLFKH
//   (not directly referenced by a detected call)
public class APDEKBHLFKH
{
    public int <FPGOPABHPPK>k__BackingField;    // 0x0x10
    public DateTime <DLAFINNBFJJ>k__BackingField;    // 0x0x18
    public DateTime? <KHKGGNBFAMF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BBIHCEDLMGE
//   (not directly referenced by a detected call)
public class BBIHCEDLMGE
{
    public Guid <FIKENGCEOLB>k__BackingField;    // 0x0x10
    public int <PNOFJDAGOLC>k__BackingField;    // 0x0x20
    public int <CMODKOIPBCJ>k__BackingField;    // 0x0x24
    public Guid <LPKBMFIDLHG>k__BackingField;    // 0x0x28
    public DateTime <OEEAJEMOMNF>k__BackingField;    // 0x0x38
    public LDEEIMOMLON <GBJMFGFIAOG>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// BBPBFFKNPGL
//   (not directly referenced by a detected call)
public class BBPBFFKNPGL
{
    public JGLJJMGKLGN <KGOFIAAOFJK>k__BackingField;    // 0x0x10
    public long <NDHFJIGFPNN>k__BackingField;    // 0x0x18
    public GiftItemDTO <JGIMHAKGFHA>k__BackingField;    // 0x0x20
    public long? <NCGKCEKLJAA>k__BackingField;    // 0x0x28
    public int <BHLCLEHNIGM>k__BackingField;    // 0x0x38
}
...
//   (not directly referenced by a detected call)
public class BDOLPFMDEAO : ValueType
{
    public Guid PDFBNFKDLAH;    // 0x0x0
}

// --------------------------------------------------------------------------
// BEHJCFCNHKK
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.Econ]
public class BEHJCFCNHKK
{
    public Guid <ENCNLBFICNN>k__BackingField;    // 0x0x10
    public int <PPIBGLGCMBH>k__BackingField;    // 0x0x20
    public long <FKDADPKOKCM>k__BackingField;    // 0x0x28
    public Guid <BIEEDBANLHJ>k__BackingField;    // 0x0x30
}
...
public class BGGEGCBGDAH
{
    public COEGFEMIJLL <BDPKELEAMPC>k__BackingField;    // 0x0x10
    public AABBOHCJGMG <LLNBFKGCMPP>k__BackingField;    // 0x0x18
    public int <NEDNCMLPOHI>k__BackingField;    // 0x0x20
}
...
public class BJOEKPAFMLA
{
    public ADICAODPDHF <MJJLKMLBBEM>k__BackingField;    // 0x0x10
    public BBIHCEDLMGE <ABFMFJEJIIL>k__BackingField;    // 0x0x18
}
...
public class BMMLBEGFAMN
{
    public int <BLEPCCIJPEE>k__BackingField;    // 0x0x10
    public int <OJJHOAMGDFI>k__BackingField;    // 0x0x14
    public float <GJLNJHKBBJK>k__BackingField;    // 0x0x18
    public float <CHNFICMMEBK>k__BackingField;    // 0x0x1C
    public bool <EAPKLIEFHBA>k__BackingField;    // 0x0x20
    public bool <BPDALAPEIMH>k__BackingField;    // 0x0x21
    public bool <IGLLPLJHCJD>k__BackingField;    // 0x0x22
}
...
public class CAHNJPOONOB
{
    public List<string> <JELMJJKMNKI>k__BackingField;    // 0x0x10
    public List<string> <PJIOFMCGCBO>k__BackingField;    // 0x0x18
    public List<string> <BODDCMLDBGF>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/progressionEvents/collect/{iPAMPBNNPMD}/{dILOKLKFKEL}   [Service.API]
public class CAJGGKMOJIB
{
    public long? <GCEODDOCLLM>k__BackingField;    // 0x0x10
    public int <LBFAEPAJEGI>k__BackingField;    // 0x0x20
    public int? <ODDLKFPNOAM>k__BackingField;    // 0x0x24
    public string <CNMGEIEOLPN>k__BackingField;    // 0x0x30
    public NDBIOOABJBM? <GKMGIBOPJKH>k__BackingField;    // 0x0x38
    public string <MDAHHKDDFHC>k__BackingField;    // 0x0x40
    public Guid? <GHIFPBAFNDO>k__BackingField;    // 0x0x48
    public string <FHBIBMGPDMD>k__BackingField;    // 0x0x60
    public string <LADOHAFFKOF>k__BackingField;    // 0x0x68
    public POKBHADPEGG <IDKLGGGJNDF>k__BackingField;    // 0x0x70
    public int <IIPHOBFLJGH>k__BackingField;    // 0x0x74
    public int <GHDKGPPHKGM>k__BackingField;    // 0x0x78
    public OGMKPJCJPIA <CDDLJCIAOAF>k__BackingField;    // 0x0x7C
    public NAHJKMGHOEN <OIOPHICJPKB>k__BackingField;    // 0x0x80
    public string <NACCMJAODKE>k__BackingField;    // 0x0x88
    public string <JKHDCKIFEGG>k__BackingField;    // 0x0x90
    public bool <KFJCDIBPKKP>k__BackingField;    // 0x0x98
    public PAMJNKEHFFA <IIFOOLJFKGK>k__BackingField;    // 0x0x9C
    public AJJFEMDAEDB <CBLNAPHDMCD>k__BackingField;    // 0x0xA0
    public BMEIJOCDMOI? <KJKFKMDNMNH>k__BackingField;    // 0x0xA4
    public bool <PEIPKMNOMMD>k__BackingField;    // 0x0xAC
    public bool <KJPCHKOGLLL>k__BackingField;    // 0x0xAD
    public string <ILDHHJAJOFJ>k__BackingField;    // 0x0xB0
    public string <IEJEIGENJKG>k__BackingField;    // 0x0xB8
    public bool <MCLEHJOGPHM>k__BackingField;    // 0x0xC0
    public bool OADJHKDHGPO;    // 0x0xC1
}

// --------------------------------------------------------------------------
// CGLHBEKIIOL
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.API]
public class CGLHBEKIIOL
{
    public List<long> <KBFFKGEHMAN>k__BackingField;    // 0x0x10
    public NEMMFFOMDNM <NCEHFAMFLOO>k__BackingField;    // 0x0x18
    public string <FLAJLGFMJLI>k__BackingField;    // 0x0x20
    public long? <JBPMJCFNFEO>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// CGLJJOKPAOF
//   (not directly referenced by a detected call)
public class CGLJJOKPAOF
{
    public int <BLDBJGMJDPO>k__BackingField;    // 0x0x10
    public DateTime <PJDFHLNGPFD>k__BackingField;    // 0x0x18
}
...
public class CHKGHJAOPLD
{
    public KFJCLHFBOLB <MPKNKOLDKIB>k__BackingField;    // 0x0x10
    public string <GJNLIPFOHDG>k__BackingField;    // 0x0x18
    public int? <LGKOBIDIBJH>k__BackingField;    // 0x0x20
}
...
public class CJJOLCLGCOP
{
    public long <JBPMJCFNFEO>k__BackingField;    // 0x0x10
    public long? <CNJGMPFFDFA>k__BackingField;    // 0x0x18
    public long? <JPEGKGDHNFC>k__BackingField;    // 0x0x28
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x38
    public string <DIJDHLMAJHM>k__BackingField;    // 0x0x40
    public List<string> <GOJEAJEELJB>k__BackingField;    // 0x0x48
    public string <EADDLBPMJED>k__BackingField;    // 0x0x50
    public DateTime <ALBIMGOAHDN>k__BackingField;    // 0x0x58
    public DateTime <AKLMMNOCGBG>k__BackingField;    // 0x0x60
    public BMBPFGDPHEK <OCEOMOBNEMN>k__BackingField;    // 0x0x68
    public bool <GEJFDKLHJAI>k__BackingField;    // 0x0x6C
    public bool <PCPENHLLNOA>k__BackingField;    // 0x0x6D
    public MMHJPDPAOJG <CIOFLKGGHBO>k__BackingField;    // 0x0x70
    public MMHJPDPAOJG <KFCFILEAGPA>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// CMDFKKECCOF
//   (not directly referenced by a detected call)
public class CMDFKKECCOF
{
    public DDBNLLGLGMB FKJKEKGGCDM;    // 0x0x10
    public int LADMMNKICDG;    // 0x0x14
}

// --------------------------------------------------------------------------
// COEGFEMIJLL
//   REQUEST  PUT    api/roomconsumables   [Service.Econ]
public class COEGFEMIJLL
{
    public Guid? <CMHPKDIGALO>k__BackingField;    // 0x0x10
    public Guid <LJAGCDMGLPN>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// DBFGEFJNDMO
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class DBFGEFJNDMO
{
    public int <PNOFJDAGOLC>k__BackingField;    // 0x0x10
    public Guid <ENCNLBFICNN>k__BackingField;    // 0x0x14
    public long <LLHFICKCGFN>k__BackingField;    // 0x0x28
    public DateTime <OEEAJEMOMNF>k__BackingField;    // 0x0x30
}
...
public class DGEOGHGJGIJ
{
    public int <OJJHOAMGDFI>k__BackingField;    // 0x0x10
    public bool <EAPKLIEFHBA>k__BackingField;    // 0x0x14
    public DateTime <LBPFJDMKHDE>k__BackingField;    // 0x0x18
    public bool <IFJLKDJFAED>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DLGLJBBEKKJ
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class DLGLJBBEKKJ
{
    public List<LKEJPEGHBLK> <GOJEAJEELJB>k__BackingField;    // 0x0x10
}
...
// DNPOKPBKAFM
//   (not directly referenced by a detected call)
public class DNPOKPBKAFM
{
    public int <BFGJDIMCLCA>k__BackingField;    // 0x0x10
    public string <FAJMPJFAEHC>k__BackingField;    // 0x0x18
    public string <HKEEOHPFECF>k__BackingField;    // 0x0x20
    public string <MGABAAIDFIA>k__BackingField;    // 0x0x28
    public string <CNMGEIEOLPN>k__BackingField;    // 0x0x30
    public KJIKALIBABJ? <KAPENJMGKBL>k__BackingField;    // 0x0x38
    public string <MDAHHKDDFHC>k__BackingField;    // 0x0x70
    public Guid? <GHIFPBAFNDO>k__BackingField;    // 0x0x78
    public NDBIOOABJBM? <GKMGIBOPJKH>k__BackingField;    // 0x0x8C
    public string <FHBIBMGPDMD>k__BackingField;    // 0x0x98
    public string <LADOHAFFKOF>k__BackingField;    // 0x0xA0
    public bool <NOODOMLJLDN>k__BackingField;    // 0x0xA8
    public bool <IJLBACNFJDE>k__BackingField;    // 0x0xA9
    public bool <KDLLKNKFGCD>k__BackingField;    // 0x0xAA
    public NAHJKMGHOEN <EKIHAMBDAPM>k__BackingField;    // 0x0xAC
    public POKBHADPEGG <IDKLGGGJNDF>k__BackingField;    // 0x0xB0
    public int <IIPHOBFLJGH>k__BackingField;    // 0x0xB4
    public BGFFMOHEJKA <NMENDHOJEIN>k__BackingField;    // 0x0xB8
    public OGMKPJCJPIA <HMGLPPJMEPC>k__BackingField;    // 0x0xBC
    public int? <HIHFNJGPEJB>k__BackingField;    // 0x0xC0
    public string <HBLHAOKJENK>k__BackingField;    // 0x0xC8
    public int? <BCIPADEBMOG>k__BackingField;    // 0x0xD0
    public int? <CEBABILOEFF>k__BackingField;    // 0x0xD8
    public string <FOKJJNDNIFI>k__BackingField;    // 0x0xE0
}
...
// EHIKNACEEMM
//   (not directly referenced by a detected call)
public class EHIKNACEEMM
{
    public int <IJKAJLPECBE>k__BackingField;    // 0x0x10
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{lHOBOEDIEHF}   [Service.Econ]
public class EIGMGGBMHNN
{
    public ADICAODPDHF <MJJLKMLBBEM>k__BackingField;    // 0x0x10
    public LDEEIMOMLON <GBJMFGFIAOG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EJLIIIDOCAM
//   (not directly referenced by a detected call)
public class EJLIIIDOCAM
{
    public float <GBPEIAMKOKD>k__BackingField;    // 0x0x10
    public float <AEDDBHBBAKF>k__BackingField;    // 0x0x14
    public float <ONDNCHBOHID>k__BackingField;    // 0x0x18
    public float <GGEMFGAFNII>k__BackingField;    // 0x0x1C
    public float <LIKKEPMONJH>k__BackingField;    // 0x0x20
    public float <IEDDCKFFNLA>k__BackingField;    // 0x0x24
    public float <EPMNJJDNHFK>k__BackingField;    // 0x0x28
    public float <KGGKFHCBJIH>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// EPIFPHBDGCA
//   (not directly referenced by a detected call)
public class EPIFPHBDGCA
{
    public bool <MCLKNDBINDJ>k__BackingField;    // 0x0x10
    public AJJFEMDAEDB <CHLHNCDBHBC>k__BackingField;    // 0x0x14
    public int <INHMDOAGILN>k__BackingField;    // 0x0x18
    public DateTime <OEEAJEMOMNF>k__BackingField;    // 0x0x20
}
...
public class FCNIENNOJDD
{
    public Dictionary<int, int> <EHMEMHHPLMK>k__BackingField;    // 0x0x10
    public List<JNHAKBEPCNC> <OOKCPJBMCNL>k__BackingField;    // 0x0x18
    public CMDFKKECCOF[][] <NBKMBLBCCPK>k__BackingField;    // 0x0x20
    public EHIKNACEEMM <KJONHMGBHCL>k__BackingField;    // 0x0x28
    public EJLIIIDOCAM <JFMMDJFKGIH>k__BackingField;    // 0x0x30
    public CGLJJOKPAOF <NNPAAIOLDLB>k__BackingField;    // 0x0x38
    public MJBJAMEBJFD <NDNPBPFNCOM>k__BackingField;    // 0x0x40
    public LGJPMDLACBC <LNLLECPKILA>k__BackingField;    // 0x0x48
    public string <CGCLAHFGCAO>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// FDKIOMMEHBH
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class FDKIOMMEHBH
{
    public List<NBKPAFCODLJ> <LHEPDBJDPFC>k__BackingField;    // 0x0x10
    public string <DAHKJHMNHFI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FFNEPJIAONI
//   (not directly referenced by a detected call)
public class FFNEPJIAONI
{
    public int <BDAKFNDCCPO>k__BackingField;    // 0x0x10
    public DateTime? <LLIPPJIGAJI>k__BackingField;    // 0x0x18
    public DateTime? <PKEJNHFIGLE>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// FGCGOHKOLNG
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{kCCJJMPBCCD}/{nOKBMIKDLLD}   [Service.Econ]
public class FGCGOHKOLNG
{
    public POKBHADPEGG <IDKLGGGJNDF>k__BackingField;    // 0x0x10
    public JALLABNHNMC <AIBHLAFPOLM>k__BackingField;    // 0x0x14
    public int <APMFACDKIGB>k__BackingField;    // 0x0x18
    public int <KDOEFLJLDCC>k__BackingField;    // 0x0x1C
    public int <BCMGPLFDLCB>k__BackingField;    // 0x0x20
    public IEIJBHEMKCE <GOGKBNGKFGA>k__BackingField;    // 0x0x24
    public bool <OHCEIDIFIMC>k__BackingField;    // 0x0x28
    public float <NKJFCNIPAON>k__BackingField;    // 0x0x2C
    public int <GAPDKNDJMJL>k__BackingField;    // 0x0x30
    public bool <IODNOLIBGGG>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// FJABKDCFLFH
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class FJABKDCFLFH
{
    public long <HDCCKJOJFKK>k__BackingField;    // 0x0x10
    public BHJPAICNEDB <NCEHFAMFLOO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FJAJLICAHOE
//   (not directly referenced by a detected call)
public class FJAJLICAHOE
{
    public bool <AGOLJPKLHAE>k__BackingField;    // 0x0x10
    public DNPOKPBKAFM <DCFKIDBHIID>k__BackingField;    // 0x0x18
    public float <DLIDHEANFCF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FOMLJNDMGGH
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class FOMLJNDMGGH
{
    public JKMMGPHIPGD <MPKNKOLDKIB>k__BackingField;    // 0x0x10
    public long <HDCCKJOJFKK>k__BackingField;    // 0x0x18
    public string <GJNLIPFOHDG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GDGAJLLAIPD
//   (not directly referenced by a detected call)
public class GDGAJLLAIPD
{
    public POKBHADPEGG <IDKLGGGJNDF>k__BackingField;    // 0x0x10
    public int <KOBCDEFLFEA>k__BackingField;    // 0x0x14
    public FFNEPJIAONI <BMANFBGAIJO>k__BackingField;    // 0x0x18
}
...
public class GLOFJJLGBKJ
{
    public NDBIOOABJBM <GKMGIBOPJKH>k__BackingField;    // 0x0x10
    public string <GBFBOBPKOBL>k__BackingField;    // 0x0x18
    public string <FAJMPJFAEHC>k__BackingField;    // 0x0x20
    public string <HKEEOHPFECF>k__BackingField;    // 0x0x28
    public NAHJKMGHOEN <EKIHAMBDAPM>k__BackingField;    // 0x0x30
    public string <MGABAAIDFIA>k__BackingField;    // 0x0x38
    public int <BCIPADEBMOG>k__BackingField;    // 0x0x40
    public bool <DPCJGEPPAAH>k__BackingField;    // 0x0x44
    public string <JOMCFEHKEME>k__BackingField;    // 0x0x48
    public DateTime <DLAFINNBFJJ>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// HACEIIABKIB
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class HACEIIABKIB
{
    public int <EHKEGDOCHHE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HFHDICHFCOH
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.Econ]
public class HFHDICHFCOH
{
    public long <EFHADABIDLI>k__BackingField;    // 0x0x10
    public int <PNOFJDAGOLC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HGNOOKLAIIB
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class HGNOOKLAIIB
{
    public bool <LOCHIGEJHOG>k__BackingField;    // 0x0x10
    public string <NFDMKAJIHGM>k__BackingField;    // 0x0x18
    public string <DOFGHJILCDH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HIPJPBCMLPE
//   (not directly referenced by a detected call)
public class HIPJPBCMLPE
{
    public long <EFHADABIDLI>k__BackingField;    // 0x0x10
    public Guid <FADNFCEHEJL>k__BackingField;    // 0x0x18
    public long <JBPMJCFNFEO>k__BackingField;    // 0x0x28
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x30
    public string <DIJDHLMAJHM>k__BackingField;    // 0x0x38
    public int <KOBCDEFLFEA>k__BackingField;    // 0x0x40
    public Guid? <BBAJNGMIPJH>k__BackingField;    // 0x0x44
    public DateTime <DLAFINNBFJJ>k__BackingField;    // 0x0x58
    public string <EADDLBPMJED>k__BackingField;    // 0x0x60
    public EELKCMKLLDH <NCEHFAMFLOO>k__BackingField;    // 0x0x68
}
...
public class HJEANAFIEAB
{
    public string <ANCLLMCNEJK>k__BackingField;    // 0x0x10
    public string <PMJCPKKCDFA>k__BackingField;    // 0x0x18
    public string <FAJMPJFAEHC>k__BackingField;    // 0x0x20
    public string <HKEEOHPFECF>k__BackingField;    // 0x0x28
    public NAHJKMGHOEN <EKIHAMBDAPM>k__BackingField;    // 0x0x30
    public string <FOKJJNDNIFI>k__BackingField;    // 0x0x38
    public bool BLHAEDGELCI;    // 0x0x40
    public bool <IGLLPLJHCJD>k__BackingField;    // 0x0x41
}
...
public class HJNNCOJNDEP
{
    public RoomKeyResult <MJJLKMLBBEM>k__BackingField;    // 0x0x10
    public HIPJPBCMLPE <BOPOILHPFHJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HLGJACGCPOP
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class HLGJACGCPOP
{
    public long <EFHADABIDLI>k__BackingField;    // 0x0x10
    public int <PNOFJDAGOLC>k__BackingField;    // 0x0x18
}
...
public class HOMAGDBDOLH : GJMHHBHFDLL
{
    public MBILGBFPJKP? <FKFDCFEEJMD>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <NJEGFKJBAGL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HPOKPOOKLPM
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class HPOKPOOKLPM
{
    public JKMMGPHIPGD <MPKNKOLDKIB>k__BackingField;    // 0x0x10
    public int <EHKEGDOCHHE>k__BackingField;    // 0x0x14
    public long <JGCIEOPGHLH>k__BackingField;    // 0x0x18
    public bool <IELPFOLAMCJ>k__BackingField;    // 0x0x20
    public string <JLPGEMGLEGC>k__BackingField;    // 0x0x28
    public int? <PKOAEMLMIEP>k__BackingField;    // 0x0x30
    public bool <IALFKKFDJIC>k__BackingField;    // 0x0x38
    public bool <KBDBNMGPOOF>k__BackingField;    // 0x0x39
    public bool <DLKCOIENHJB>k__BackingField;    // 0x0x3A
    public bool <FMGLEGFMFGL>k__BackingField;    // 0x0x3B
    public string <MIFAPDFMPHP>k__BackingField;    // 0x0x40
    public DateTime? <GBOLNOHJOHC>k__BackingField;    // 0x0x48
    public string <BLPIJDCGJDM>k__BackingField;    // 0x0x58
    public bool <OEMCIELPKBE>k__BackingField;    // 0x0x60
    public string <JGEPEHDCNFB>k__BackingField;    // 0x0x68
    public string <LFKINNLHJIM>k__BackingField;    // 0x0x70
    public float <EGCBCDGDGDC>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// IABOEBICFND
//   (not directly referenced by a detected call)
public class IABOEBICFND
{
    public int <FICJJOCOEOI>k__BackingField;    // 0x0x10
    public OGOPDIEMCGO <KIADJALGEHB>k__BackingField;    // 0x0x14
}
...
public class IHNNBMPDAEO
{
    public Guid? <FIKENGCEOLB>k__BackingField;    // 0x0x10
    public long? <JBPMJCFNFEO>k__BackingField;    // 0x0x28
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x38
    public string <DIJDHLMAJHM>k__BackingField;    // 0x0x40
    public string <EADDLBPMJED>k__BackingField;    // 0x0x48
    public AABBOHCJGMG <AHPNNINBCAM>k__BackingField;    // 0x0x50
}
...
public class IIHNMBELOMG
{
    public OGOPDIEMCGO <KIADJALGEHB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IKKIIPJIFBK
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class IKKIIPJIFBK
{
    public Dictionary<Guid, BJOEKPAFMLA> <CAJDJHBHEPD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// INCJKKKEBEA
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class INCJKKKEBEA
{
    public DMAOPJNIPLM <KIADJALGEHB>k__BackingField;    // 0x0x10
    public List<string> <GOJEAJEELJB>k__BackingField;    // 0x0x18
}
...
// base   : PNOKONLOLNA
//   (not directly referenced by a detected call)
public class IOIOJHBPKHI : PNOKONLOLNA
{
    public DMMDHLMLBIF GMDHJIHAEGA;    // 0x0x20
}
...
// JBPADIOGNCE
//   (not directly referenced by a detected call)
public class JBPADIOGNCE
{
    public int <NEDNCMLPOHI>k__BackingField;    // 0x0x10
    public COEGFEMIJLL <BDPKELEAMPC>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/playerevents/v1/all/{oEBMJHLGKIE}   [Service.API]
public class JEPAAAOOJNJ
{
    public List<NBKPAFCODLJ> <AJCCJJKDCNI>k__BackingField;    // 0x0x10
    public List<AJMHLHJLMDN> <PPDKGACONLD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JGLJJMGKLGN
//   (not directly referenced by a detected call)
public class JGLJJMGKLGN
{
    public JPAKMCHALJJ <NCEHFAMFLOO>k__BackingField;    // 0x0x10
    public int? <PKPHCLKENDO>k__BackingField;    // 0x0x14
    public Guid? <OHOAKCEDEGG>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// JJMFAEGIIDM
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.Econ]
public class JJMFAEGIIDM
{
    public List<string> <LPLEBBOOLDH>k__BackingField;    // 0x0x10
}
...
public class JKHBIEJMBEN
{
    public Guid <BIEEDBANLHJ>k__BackingField;    // 0x0x10
    public long <FBALOOMANHO>k__BackingField;    // 0x0x20
}
...
public class KCPIADKEIKH
{
    public bool <PPNIDPPEKEH>k__BackingField;    // 0x0x10
    public string <JLPGEMGLEGC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KGGPBHHFBAE
//   RESPONSE GET    api/makerai/freetrialconfig   [Service.Econ]
public class KGGPBHHFBAE
{
    public TimeSpan <ANHFEPOECKE>k__BackingField;    // 0x0x10
    public TimeSpan <EHKEGDOCHHE>k__BackingField;    // 0x0x18
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class KJIKALIBABJ : ValueType
{
    public BDOLPFMDEAO HMKBGFIHHND;    // 0x0x0
    public NLJBOFABIDB NGHNNCEEHAF;    // 0x0x10
    public Guid CAJGHADLNHB;    // 0x0x20
}
...
// LDEEIMOMLON
//   (not directly referenced by a detected call)
public class LDEEIMOMLON
{
    public Guid <FIKENGCEOLB>k__BackingField;    // 0x0x10
    public long <JBPMJCFNFEO>k__BackingField;    // 0x0x20
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x28
    public string <DIJDHLMAJHM>k__BackingField;    // 0x0x30
    public string <EADDLBPMJED>k__BackingField;    // 0x0x38
    public long <KOBCDEFLFEA>k__BackingField;    // 0x0x40
    public Guid? <BBAJNGMIPJH>k__BackingField;    // 0x0x48
    public DateTime <OEEAJEMOMNF>k__BackingField;    // 0x0x60
    public int <BEOGEAGPHCA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// LGJPMDLACBC
//   (not directly referenced by a detected call)
public class LGJPMDLACBC
{
    public float <CHEECIJOHMO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LINFIALOPIF
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class LINFIALOPIF
{
    public string <GCEODDOCLLM>k__BackingField;    // 0x0x10
    public string <NFDMKAJIHGM>k__BackingField;    // 0x0x18
    public string <NCEPHPPGIJO>k__BackingField;    // 0x0x20
    public string <DIJDHLMAJHM>k__BackingField;    // 0x0x28
    public string <FLMIKDIOLDK>k__BackingField;    // 0x0x30
    public JEFAIFAAECO <MJJLKMLBBEM>k__BackingField;    // 0x0x38
    public List<string> <INKDNFNGBCL>k__BackingField;    // 0x0x40
    public List<string> <GOJEAJEELJB>k__BackingField;    // 0x0x48
    public string <GPNKFCPKFCB>k__BackingField;    // 0x0x50
    public List<MHEBBMOKKHN> <KBBGFEJOGMA>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// LKEJPEGHBLK
//   (not directly referenced by a detected call)
public class LKEJPEGHBLK
{
    public string <MCCBJKBEFJN>k__BackingField;    // 0x0x10
    public MJJKDBOAPEA <NCEHFAMFLOO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LLAHGHMDAMB
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class LLAHGHMDAMB
{
    public int <BMHHFJHMINN>k__BackingField;    // 0x0x10
    public int <CNKLAKHNCMF>k__BackingField;    // 0x0x14
    public float <EBGPHKLLKJJ>k__BackingField;    // 0x0x18
    public int <NAKEECNHGOF>k__BackingField;    // 0x0x1C
    public int <ADJIMMADKOF>k__BackingField;    // 0x0x20
    public int <FMADGDODFKJ>k__BackingField;    // 0x0x24
    public int <PEHIFPDFKLD>k__BackingField;    // 0x0x28
    public string <HLEDLJDBFFM>k__BackingField;    // 0x0x30
    public string <LGEMNMPODAN>k__BackingField;    // 0x0x38
}
...
public class LMIMPGCBPFF : NBKPAFCODLJ
{
    public List<LKEJPEGHBLK> <GOJEAJEELJB>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// LMMHJHEBOEK
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.Econ]
public class LMMHJHEBOEK
{
    public int OBGCOEMGDCC;    // 0x0x10
    public long NBFCKJKFFCO;    // 0x0x18
}
...
// MHEBBMOKKHN
//   (not directly referenced by a detected call)
public class MHEBBMOKKHN
{
    public DateTime <DLAFINNBFJJ>k__BackingField;    // 0x0x10
    public string <MJPPIGGJHEN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MJBJAMEBJFD
//   (not directly referenced by a detected call)
public class MJBJAMEBJFD
{
    public int <DKBCKPJNAMB>k__BackingField;    // 0x0x10
}
...
public class MPNBPHMFKNJ
{
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x10
    public string <DIJDHLMAJHM>k__BackingField;    // 0x0x18
    public int? <KOBCDEFLFEA>k__BackingField;    // 0x0x20
    public LBKDEAGGCAC? <OCEOMOBNEMN>k__BackingField;    // 0x0x28
}
...
public class NBDGJONGOLK
{
    public int? <EEHGDDAGCFG>k__BackingField;    // 0x0x10
    public string <FLMIKDIOLDK>k__BackingField;    // 0x0x18
    public string <OMHIMJFMHKH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NBKPAFCODLJ
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class NBKPAFCODLJ
{
    public long <HDCCKJOJFKK>k__BackingField;    // 0x0x10
    public int <JNPJBLFFCJO>k__BackingField;    // 0x0x18
    public long <JBPMJCFNFEO>k__BackingField;    // 0x0x20
    public long? <CNJGMPFFDFA>k__BackingField;    // 0x0x28
    public long? <JPEGKGDHNFC>k__BackingField;    // 0x0x38
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x48
    public string <DIJDHLMAJHM>k__BackingField;    // 0x0x50
    public string <EADDLBPMJED>k__BackingField;    // 0x0x58
    public DateTime <ALBIMGOAHDN>k__BackingField;    // 0x0x60
    public DateTime <AKLMMNOCGBG>k__BackingField;    // 0x0x68
    public int <LNLBBLEHAPC>k__BackingField;    // 0x0x70
    public BMBPFGDPHEK <OCEOMOBNEMN>k__BackingField;    // 0x0x74
    public bool <GEJFDKLHJAI>k__BackingField;    // 0x0x78
    public bool <PCPENHLLNOA>k__BackingField;    // 0x0x79
    public MMHJPDPAOJG <CIOFLKGGHBO>k__BackingField;    // 0x0x7C
    public MMHJPDPAOJG <KFCFILEAGPA>k__BackingField;    // 0x0x80
    public long? <BLMOFJGCCJJ>k__BackingField;    // 0x0x88
}
...
public class NDDJGILPOPK
{
    public long <JBPMJCFNFEO>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <DKLALEJGNHD>k__BackingField;    // 0x0x18
    public HJCENDAHOOF <CPJOIENKNBB>k__BackingField;    // 0x0x20
}
...
// base   : IEIHGACHPJL
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{hGELOFJPHBB}   [Service.Econ]
public class NEBCGLOLCPN : IEIHGACHPJL
{
    public int <FIKFGMOKMIN>k__BackingField;    // 0x0x30
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x38
    public DateTime <IGPEPIBEDPP>k__BackingField;    // 0x0x40
    public DateTime <DKNOHAGFEJB>k__BackingField;    // 0x0x48
    public POKBHADPEGG <IDKLGGGJNDF>k__BackingField;    // 0x0x50
    public PMHBCGFBCOC <CNMIGLKCKCJ>k__BackingField;    // 0x0x58
    public List<PFPIGNHFFEK> <NGJGBMMJADN>k__BackingField;    // 0x0x60
    public EPIFPHBDGCA <ADKEANDOJCE>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// NGCANEGLLBH
//   (not directly referenced by a detected call)
public class NGCANEGLLBH
{
    public Guid <AIGAKMEBJGP>k__BackingField;    // 0x0x10
    public Guid <OOJFMBJOENJ>k__BackingField;    // 0x0x20
    public DateTime <IGPEPIBEDPP>k__BackingField;    // 0x0x30
    public List<DNPOKPBKAFM> <PLOCJPMELIJ>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// NKGNBMJJPLB
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class NKGNBMJJPLB
{
    public List<APDEKBHLFKH> <LHNAELNAFIP>k__BackingField;    // 0x0x10
    public string <DAHKJHMNHFI>k__BackingField;    // 0x0x18
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class NLJBOFABIDB : ValueType
{
    public Guid PDFBNFKDLAH;    // 0x0x0
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{iPAMPBNNPMD}   [Service.API]
...
public class NMFPANMNBPD
{
    public LMIMPGCBPFF <GMMMDFEONIC>k__BackingField;    // 0x0x10
    public OGOPDIEMCGO <KIADJALGEHB>k__BackingField;    // 0x0x18
    public INCJKKKEBEA <CLLALOJABCL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NOKHBOMHELA
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class NOKHBOMHELA
{
    public Dictionary<Guid, JBPADIOGNCE> <PNLMIOCPOPH>k__BackingField;    // 0x0x10
}
...
public class ODNJNINJKME : GJMHHBHFDLL
{
    public POFABMENLBJ? <FKFDCFEEJMD>k__BackingField;    // 0x0x18
    public DBFGEFJNDMO <EDGMNBJJHJM>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// OIIMFMOEKAK
// base   : IEHHPLNDNNN`1<BADAFKCAGKI>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{kGBKPNAMAJO}   [Service.API]
public class OIIMFMOEKAK
{
    // (no instance fields in the metadata dump)
}
...
public class OKAJNEPFHOG
{
    public List<int> <BIGKIDECBII>k__BackingField;    // 0x0x10
    public string <DAHKJHMNHFI>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{fIBIOFOKNFN}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{iKDHIALBBON}   [Service.API]
...
public class ONAJOACHAJH
{
    public bool <PPNIDPPEKEH>k__BackingField;    // 0x0x10
    public string <GGMNCCJMMOG>k__BackingField;    // 0x0x18
    public string <KBKENFJFOKJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OPKPPLBHOHD
//   REQUEST  POST   api/relationships/v2/updateVoiceVolume   [Service.API]
public class OPKPPLBHOHD
{
    public int <LBFAEPAJEGI>k__BackingField;    // 0x0x10
    public byte <FGDNEMIKKAA>k__BackingField;    // 0x0x14
}
...
public class PEOFLIDENDO
{
    public IReadOnlyList<IOIOJHBPKHI> <BCJMLFCKHIH>k__BackingField;    // 0x0x10
}
...
// base   : PMHBCGFBCOC
//   (not directly referenced by a detected call)
public class PFPIGNHFFEK : PMHBCGFBCOC
{
    public int <AEPEDPFCLLF>k__BackingField;    // 0x0x68
    public List<FJAJLICAHOE> <JNGDEANNCIB>k__BackingField;    // 0x0x70
    public List<FJAJLICAHOE> <LHMAOBPJFEJ>k__BackingField;    // 0x0x78
    public List<FJAJLICAHOE> <LBPFEFPCBFC>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// PINKIKPMPBH
//   REQUEST  POST   api/items/bulkpurchase   [Service.Commerce]
public class PINKIKPMPBH
{
    public List<BBPBFFKNPGL> <LOHGJJOPPME>k__BackingField;    // 0x0x10
    public MOKDLLFJIKJ? <OHGDKPODDFB>k__BackingField;    // 0x0x18
    public POKBHADPEGG <IDKLGGGJNDF>k__BackingField;    // 0x0x20
    public bool <EGMEAGOOKCJ>k__BackingField;    // 0x0x24
    public bool <HCJHDAACMGK>k__BackingField;    // 0x0x25
}

// --------------------------------------------------------------------------
// PKMBHKMNCCK
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Auth]
public class PKMBHKMNCCK
{
    public Guid <ELKCIGELAHC>k__BackingField;    // 0x0x10
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x20
    public string <EADDLBPMJED>k__BackingField;    // 0x0x28
    public DateTime <IGPEPIBEDPP>k__BackingField;    // 0x0x30
    public DateTime? <DNCGHNDICLP>k__BackingField;    // 0x0x38
    public List<NGCANEGLLBH> <GNCAKOPIILD>k__BackingField;    // 0x0x48
}
...
public class PLMIIPBMJMP
{
    public int <JOMBOEHGNMG>k__BackingField;    // 0x0x10
    public AEIPGLIJLIF <NCEHFAMFLOO>k__BackingField;    // 0x0x14
    public PKJFGGACPPH <IKPFPGKIFBB>k__BackingField;    // 0x0x18
    public PKJFGGACPPH <JHPKEGNHJCB>k__BackingField;    // 0x0x1C
    public PKJFGGACPPH <ODBNKHDJNHF>k__BackingField;    // 0x0x20
    public byte? <FGDNEMIKKAA>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// PMHBCGFBCOC
//   (not directly referenced by a detected call)
public class PMHBCGFBCOC
{
    public int <FFGGCPIONOP>k__BackingField;    // 0x0x10
    public KIMHCOEHNMG <NCEHFAMFLOO>k__BackingField;    // 0x0x14
    public List<GDGAJLLAIPD> <CPLCFFFGBEB>k__BackingField;    // 0x0x18
    public List<GDGAJLLAIPD> <DCLONPBKIAF>k__BackingField;    // 0x0x20
    public bool <HLPEJABHAFM>k__BackingField;    // 0x0x28
    public DateTime? <MKMGHKMIGIF>k__BackingField;    // 0x0x30
    public DateTime? <JAKJCGIFNNM>k__BackingField;    // 0x0x40
    public DateTime? <OPJFKJLPDEE>k__BackingField;    // 0x0x50
    public bool <PEEOIOPNOEE>k__BackingField;    // 0x0x60
    public bool <LEIOEMGIDLN>k__BackingField;    // 0x0x61
}
...
public class AddKeepsakeInstanceRequest
{
    public long <JBPMJCFNFEO>k__BackingField;    // 0x0x10
    public long? <CNJGMPFFDFA>k__BackingField;    // 0x0x18
    public IDPKHHDKFDH <POANAJIGKBP>k__BackingField;    // 0x0x28
}
...
{
    public OBHJBKCKGDG <KIADJALGEHB>k__BackingField;    // 0x0x10
    public string <CEALBBJPPBA>k__BackingField;    // 0x0x18
    public string <KIIKICGPIGH>k__BackingField;    // 0x0x20
    public string <HLDCMLIPIFB>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public POKBHADPEGG <CurrencyType>k__BackingField;    // 0x0x18
    public BMEIJOCDMOI <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<ALEGLAIOOBG<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <HDCCKJOJFKK>k__BackingField;    // 0x0x10
    public long? <NOJGMECFKKL>k__BackingField;    // 0x0x18
}
...
{
    public string <HICGNEFFMKK>k__BackingField;    // 0x0x10
    public int <CKGOGHKIIOA>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public CLPEMAOAOAM FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public OGMKPJCJPIA <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public IDPKHHDKFDH <GFLBLDEOPJE>k__BackingField;    // 0x0x10
    public string <KLLHGDMHBDO>k__BackingField;    // 0x0x18
    public int <OFFOGLNKNMJ>k__BackingField;    // 0x0x20
    public int <BOHGGGIJPJA>k__BackingField;    // 0x0x24
    public string <IPBIDAIENNI>k__BackingField;    // 0x0x28
    public string <OMIANKOFKLG>k__BackingField;    // 0x0x30
}
...
{
    public int <PNOFJDAGOLC>k__BackingField;    // 0x0x10
    public Guid <OGBEDLIHMFG>k__BackingField;    // 0x0x14
    public DateTime <NNJDGONFMAE>k__BackingField;    // 0x0x28
}
...
{
    public bool <NOBJNCAFDGP>k__BackingField;    // 0x0x10
    public int <BAACCBKPNJF>k__BackingField;    // 0x0x14
    public bool <PLFAKOPOFKM>k__BackingField;    // 0x0x18
}
...
{
    public Guid <OGBEDLIHMFG>k__BackingField;    // 0x0x10
    public IDPKHHDKFDH <CEDNIKDNPHK>k__BackingField;    // 0x0x20
    public int <FKBKPOBDPFM>k__BackingField;    // 0x0x24
    public long <JBPMJCFNFEO>k__BackingField;    // 0x0x28
    public long? <CNJGMPFFDFA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{lBGJNPLAOBD}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <IKBDPPHEBKE>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <IDGJFMHIEMI>k__BackingField;    // 0x0x18
}
...
{
    public long <HDMKNGKNNMF>k__BackingField;    // 0x0x10
    public long <JBPMJCFNFEO>k__BackingField;    // 0x0x18
    public long <MJPBFKAOPOM>k__BackingField;    // 0x0x20
    public EGMKOKDOLNC <NCEHFAMFLOO>k__BackingField;    // 0x0x28
    public int <HNOFLOPADNC>k__BackingField;    // 0x0x2C
}
...
{
    public long <JBPMJCFNFEO>k__BackingField;    // 0x0x10
    public List<Guid> <KDFPHMGIPGK>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <IKBDPPHEBKE>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <IDGJFMHIEMI>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <DFIIBGJEGHD>k__BackingField;    // 0x0x20
}
...
{
    public long <MJPBFKAOPOM>k__BackingField;    // 0x0x10
    public long <KBCLCNJCBBC>k__BackingField;    // 0x0x18
    public int? <LPEOAAKOFHI>k__BackingField;    // 0x0x20
    public int? <IMLCOEOIPJO>k__BackingField;    // 0x0x28
    public long? <EPIEMBKHABM>k__BackingField;    // 0x0x30
    public long <JMMIEFPACKO>k__BackingField;    // 0x0x40
    public long <NHCEEGDIKLG>k__BackingField;    // 0x0x48
    public int <HPILCIHEAJD>k__BackingField;    // 0x0x50
    public EGMKOKDOLNC <LNKHAHCAGEM>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <LJJIFHBMHBA>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public OGMKPJCJPIA <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public OKJOLANABCP creatorAccountRole;    // 0x0x68
...
{
    public JOGADOPGLIE <MMENHDAHGAD>k__BackingField;    // 0x0x10
    public HHEKCLEDOFN <KAJFDPHFPLB>k__BackingField;    // 0x0x14
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x18
    public string <DIJDHLMAJHM>k__BackingField;    // 0x0x20
    public bool <BMKFODCCGHJ>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<JOGADOPGLIE> <DPFDLKFJGBK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{iPAMPBNNPMD}   [Service.API]
public class ProgressionEventDTO
{
    public long <KBCLCNJCBBC>k__BackingField;    // 0x0x10
    public string <OEONJDDPAHJ>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <LBPFEFPCBFC>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <LNKDOMHDHDN>k__BackingField;    // 0x0x28
    public DateTime <ALBIMGOAHDN>k__BackingField;    // 0x0x30
    public DateTime <AKLMMNOCGBG>k__BackingField;    // 0x0x38
    public DateTime <MGAHLIKHMJE>k__BackingField;    // 0x0x40
    public bool <HHAKEOLPCNM>k__BackingField;    // 0x0x48
    public int <KJIDBIPEDOL>k__BackingField;    // 0x0x4C
    public float <HDPDDEFBMDG>k__BackingField;    // 0x0x50
    public Guid? <DONMFCDFIBP>k__BackingField;    // 0x0x54
    public string <BHLIPLFPFEC>k__BackingField;    // 0x0x68
    public string <CPAJBFAEGKD>k__BackingField;    // 0x0x70
    public string <OJLBOGJNDNC>k__BackingField;    // 0x0x78
    public string <AAEBHIBONMA>k__BackingField;    // 0x0x80
}
...
{
    public Guid <LEAOFBBCOEG>k__BackingField;    // 0x0x10
    public int <ANPHOHEFBJE>k__BackingField;    // 0x0x20
    public int <CNNMBKDMJMD>k__BackingField;    // 0x0x24
    public int <CLEIDNKJHPC>k__BackingField;    // 0x0x28
    public long <HLGFKIJFFCB>k__BackingField;    // 0x0x30
    public long <PKHKJGOELCD>k__BackingField;    // 0x0x38
}
...
{
    public int <PNOFJDAGOLC>k__BackingField;    // 0x0x10
    public int <GHDKGPPHKGM>k__BackingField;    // 0x0x14
    public int <OOLDMKFBFEK>k__BackingField;    // 0x0x18
    public int <EANBFDALPDA>k__BackingField;    // 0x0x1C
    public int <ONMOPCFBLMF>k__BackingField;    // 0x0x20
    public DateTime? <OPEOHPEJEKL>k__BackingField;    // 0x0x28
    public int <AIBEOIHNFJN>k__BackingField;    // 0x0x38
}
...
{
    public long <OPDIOIAMDFP>k__BackingField;    // 0x0x10
    public int <BFGJDIMCLCA>k__BackingField;    // 0x0x18
    public string <EADDLBPMJED>k__BackingField;    // 0x0x20
    public int <GHDKGPPHKGM>k__BackingField;    // 0x0x28
    public int <EJDECNKKMPA>k__BackingField;    // 0x0x2C
    public bool <ACMOKFJLPED>k__BackingField;    // 0x0x30
    public bool <LMFEIDDKGKK>k__BackingField;    // 0x0x31
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public GJGENKMHAEF <Permission>k__BackingField;    // 0x0x18
    public LBKDEAGGCAC <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<EDHPCGOBEFC<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public EKALPIPFMIE ReportCategory;    // 0x0x20
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public LBKDEAGGCAC <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public GHLLBGAEOJP <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<DDBALLKBOME> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{pDNIELFDJGI}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool ENPCNHGDDKC;    // 0x0x28
}
...
{
    public FJOPGKHMFNI? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public FJOPGKHMFNI INEBIBPPDIB;  // wrapper
...
{
    public PAMJNKEHFFA BDFOINIOFMF;  // wrapper
...
{
    public LNAGCMEPPKJ AAFMBEEMJAC;  // wrapper
    public int? KIFKOLNLMJE;  // wrapper
...
{
    public JKMMGPHIPGD PNHIALFIGDM;  // wrapper
...
{
    public byte[] FFEMKICJPKP;  // wrapper
    public KHDBBGOHLMK LNOHNEGFEOK;  // wrapper
...
{
    public JKMMGPHIPGD IFPKAGNLMBE;  // wrapper
    public float? IHEKHLDDOJM;  // wrapper
    public bool? GFMCJDDEEDJ;  // wrapper
...
{
    public List<KJIKALIBABJ> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public OGMKPJCJPIA JAPGNGDBBIF;  // wrapper
    public OGMKPJCJPIA? FDIPBKCGHHN;  // wrapper
...
{
    public ChatMessage NJJDPBHNDPA;  // wrapper
    public DKCANABFKHG IFPKAGNLMBE;  // wrapper
...
{
    public LBKDEAGGCAC FIFIPCHEABN;  // wrapper
    public CMPCJACNOBJ JGOFCEBNPLK;  // wrapper
    public DNFKJANILEK DFMLIIMEBJH;  // wrapper
    public DNFKJANILEK FKDNGJENDOE;  // wrapper
...
// api/customAvatarItems/v1/{fIBIOFOKNFN}/appeal  [API POST]
public class CustomAvatarItemsV1FIBIOFOKNFNAppealRequest
{
    public Guid FIBIOFOKNFN;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{kGBKPNAMAJO}  [API GET]
public class CustomAvatarItemsV2FromCreatorKGBKPNAMAJORequest
{
...
{
    public KLGJLNHBICF FHFOBCNALPB;  // wrapper
    public OGMKPJCJPIA? KFNCNHCBNPK;  // wrapper
...
{
    public NMGBLODJCIK CCEODJIFNKL;  // wrapper
...
{
    public int? HGDCEGNJLGE;  // wrapper
    public Guid? FIBIOFOKNFN;  // wrapper
...
// api/keepsakes/{iKDHIALBBON}/collect  [API POST]
public class KeepsakesIKDHIALBBONCollectRequest
{
    public Guid IKDHIALBBON;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public NEMMFFOMDNM IDKJLFNOBOG;  // wrapper
    public long? CEACGIDOODJ;  // wrapper
...
{
    public Guid KMPFMAAMMCM;  // wrapper
...
{
    public Guid HLFLLAFPANF;  // wrapper
...
{
    public Guid HLFLLAFPANF;  // wrapper
    public long? KCJLAAOIKIO;  // wrapper
    public byte? HMDNNMIJNJJ;  // wrapper
    public int? DEJLIDMJHPI;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid KMPFMAAMMCM;  // wrapper
    public long? AGGINKEEJGN;  // wrapper
    public long? NNBINNDLPGM;  // wrapper
    public int? NPHMDGDNHJJ;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> CNCKIIIBBGO;  // wrapper
...
{
    public EELKCMKLLDH AAFMBEEMJAC;  // wrapper
    public Guid? ACFBLBKOEFL;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public JKMMGPHIPGD IFPKAGNLMBE;  // wrapper
    public long? NFAJHOGJGCO;  // wrapper
    public Guid? JOPDHEGNJPF;  // wrapper
    public int? OKMMLJMLLKO;  // wrapper
...
{
    public Guid KDMLPEIIGEG;  // wrapper
...
{
    public Guid JOEGIMADNDD;  // wrapper
...
{
    public JEFAIFAAECO OLDANJOLEDG;  // wrapper
}
