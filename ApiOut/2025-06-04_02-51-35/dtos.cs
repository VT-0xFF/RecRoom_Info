...
// DTO classes: 265 (plus referenced enums)
...
//   RESPONSE POST   api/customAvatarItems/v1/{fLLEHMEKPHP}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{eHGGCLOFHJH}   [Service.API]
...
public class ABCLBNPPLCC
{
    public bool <BBFBDIGKKHJ>k__BackingField;    // 0x0x10
    public string <GIBJBPBLJOK>k__BackingField;    // 0x0x18
    public string <INBGDFOEOBP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ABNKOAHBFOA
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class ABNKOAHBFOA
{
    public ODOJOFAJPLF <JOEPPAAADOD>k__BackingField;    // 0x0x10
    public List<string> <DHBEMLGJMDI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AEDLJNIBMFG
//   (not directly referenced by a detected call)
public class AEDLJNIBMFG
{
    public float <DONICBMKHFL>k__BackingField;    // 0x0x10
    public float <JJLILEMINKP>k__BackingField;    // 0x0x14
    public float <JAFAHINPAPB>k__BackingField;    // 0x0x18
    public float <GBLAEGDHBJD>k__BackingField;    // 0x0x1C
    public float <EKJIPKGKKMK>k__BackingField;    // 0x0x20
    public float <MCLAHIINIHN>k__BackingField;    // 0x0x24
    public float <IIPBCABEBJG>k__BackingField;    // 0x0x28
    public float <EOIJJKNPLBA>k__BackingField;    // 0x0x2C
}
...
public class AIEBJACPCMF
{
    public List<long> <HFMOPCFJHBA>k__BackingField;    // 0x0x10
    public OFHHJGJAMLN <KDIECALBFMD>k__BackingField;    // 0x0x18
    public string <JCDNPFPIBFJ>k__BackingField;    // 0x0x20
    public long? <HKJFKNEFBIH>k__BackingField;    // 0x0x28
}
...
public class ANIJOIBJAID
{
    public CEJMBAOJDBO <PIFHAGOHHHL>k__BackingField;    // 0x0x10
    public string <EJKGJDBKOEK>k__BackingField;    // 0x0x18
    public int? <CKKHDIPMBFK>k__BackingField;    // 0x0x20
}
...
public class ANNNBBPPCMO
{
    public List<DMDBNHCAHKF> <OBILHLMKJDN>k__BackingField;    // 0x0x10
    public ANNBMKDCIMI <JOEPPAAADOD>k__BackingField;    // 0x0x18
}
...
public class BAHEIOCONFB
{
    public PKFFGNGIAJB <ANDKNENLKGF>k__BackingField;    // 0x0x10
    public string <KCMALFIHGHL>k__BackingField;    // 0x0x18
    public string <LILPNGPPIEJ>k__BackingField;    // 0x0x20
    public string <BNFPLPOONPJ>k__BackingField;    // 0x0x28
    public EKPGHFMPAMO <FGJCNBGGCNM>k__BackingField;    // 0x0x30
    public string <IMPMNGLEHBC>k__BackingField;    // 0x0x38
    public int <BCKIPEDBHAG>k__BackingField;    // 0x0x40
    public bool <BOKAHIFCBMD>k__BackingField;    // 0x0x44
    public string <KPCPIIMDBFC>k__BackingField;    // 0x0x48
    public DateTime <MPGHDHAIHBN>k__BackingField;    // 0x0x50
}
...
public class BCDJPHMMCPI
{
    public Dictionary<Guid, JJMAKCOAOBG> <CANEMBFKHNL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// BCFCFJMAEKD
//   (not directly referenced by a detected call)
public class BCFCFJMAEKD
{
    public long <EAMKJAJOIDN>k__BackingField;    // 0x0x10
    public long <FPPOMOFOMJA>k__BackingField;    // 0x0x18
    public int <FAIKHGCKMEI>k__BackingField;    // 0x0x20
    public DateTime <MPGHDHAIHBN>k__BackingField;    // 0x0x28
    public JNOBBCOEKMD <KDIECALBFMD>k__BackingField;    // 0x0x30
}
...
public class BDGLODALJAB
{
    public long <HKJFKNEFBIH>k__BackingField;    // 0x0x10
    public long? <HIJJMJBODHE>k__BackingField;    // 0x0x18
    public long? <OLLKLJFAIBI>k__BackingField;    // 0x0x28
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x38
    public string <IAKNNINGHGD>k__BackingField;    // 0x0x40
    public List<string> <DHBEMLGJMDI>k__BackingField;    // 0x0x48
    public string <PHGPDLNHFKJ>k__BackingField;    // 0x0x50
    public DateTime <NIMIMKBAAGK>k__BackingField;    // 0x0x58
    public DateTime <OAKJBIADMMI>k__BackingField;    // 0x0x60
    public BNECKOIJALE <FDAKKOKEKLB>k__BackingField;    // 0x0x68
    public bool <HCLFLNFACHO>k__BackingField;    // 0x0x6C
    public bool <EEGMJOMCAMB>k__BackingField;    // 0x0x6D
    public GFGDKKBFFGK <MFAFMIHFLEA>k__BackingField;    // 0x0x70
    public GFGDKKBFFGK <FJNMPLPFICM>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// BFBLBPCCKIG
//   (not directly referenced by a detected call)
public class BFBLBPCCKIG
{
    public KDFLGNKDEGG NMBIBBELLLF;    // 0x0x10
    public int CNGPFGGBEBO;    // 0x0x14
}

// --------------------------------------------------------------------------
// BKNIAFBFOEO
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{bMLDAGLDFMB}/{nDKJIPKHGEB}   [Service.Econ]
public class BKNIAFBFOEO
{
    public AFALINLHGMI <PAECCIEDONH>k__BackingField;    // 0x0x10
    public FAHKIPDJEOD <BJEEPNGLFJE>k__BackingField;    // 0x0x14
    public int <DPOKDHBOKGE>k__BackingField;    // 0x0x18
    public int <COPEEIJBOIG>k__BackingField;    // 0x0x1C
    public int <AAFBNCDHFDE>k__BackingField;    // 0x0x20
    public IPPFKKGEIAK <BOKLLCGIHKO>k__BackingField;    // 0x0x24
    public bool <HEHHOIDGJOK>k__BackingField;    // 0x0x28
    public float <NDELMAHIAEE>k__BackingField;    // 0x0x2C
    public int <KDGCDKNIJDG>k__BackingField;    // 0x0x30
    public bool <EJMKIFPHMHM>k__BackingField;    // 0x0x34
}
...
public class BNNBAEMOBKH
{
    public Guid <HKHNCPOJJDF>k__BackingField;    // 0x0x10
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x20
    public string <PHGPDLNHFKJ>k__BackingField;    // 0x0x28
    public DateTime <IFPKACIFGOO>k__BackingField;    // 0x0x30
    public DateTime? <POFHAFCLNCI>k__BackingField;    // 0x0x38
    public List<LDODKNGBGHG> <FKNJPNKIMGC>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// BNNNKMHLGPM
//   (not directly referenced by a detected call)
public class BNNNKMHLGPM
{
    public int <OMGNOCILBDG>k__BackingField;    // 0x0x10
    public DateTime? <MHEKKJPCLGI>k__BackingField;    // 0x0x18
    public DateTime? <IHCBJLKBAIM>k__BackingField;    // 0x0x28
}
...
public class BPCDONPNIGE
{
    public LKHJJFELPMD <LHCFPCNPNIE>k__BackingField;    // 0x0x10
    public PCGNLIKJJAK <KDFMLNFOLPH>k__BackingField;    // 0x0x18
    public int <KONOEMFHALM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BPKHPANMKOB
//   RESPONSE PUT    api/roomconsumables   [Service.Econ]
public class BPKHPANMKOB
{
    public JOLAKIADOHF <BMJEJJJNGIA>k__BackingField;    // 0x0x10
    public HDAEODHAMDF <EJFFFKFEIMN>k__BackingField;    // 0x0x18
}
...
public class CBEGECKIHEM
{
    public int NPAGAHHHPCC;    // 0x0x10
    public long BGDKPJMDIOO;    // 0x0x18
}

// --------------------------------------------------------------------------
// CEEMBFDGDDM
//   RESPONSE GET    api/makerai/freetrialconfig   [Service.Econ]
public class CEEMBFDGDDM
{
    public TimeSpan <EANIGNGNHMN>k__BackingField;    // 0x0x10
    public TimeSpan <EGMBGHHILED>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CEJLPABAJGE
//   (not directly referenced by a detected call)
public class CEJLPABAJGE
{
    public int <PNOGHGNGHGM>k__BackingField;    // 0x0x10
    public KBMKJAFCAKI <KDIECALBFMD>k__BackingField;    // 0x0x14
    public List<IEIFNOIIDFI> <LGLBCPLDAOC>k__BackingField;    // 0x0x18
    public List<IEIFNOIIDFI> <IAGHHIABECN>k__BackingField;    // 0x0x20
    public bool <FMHOCMGBOCP>k__BackingField;    // 0x0x28
    public DateTime? <IEKJFDBKFOE>k__BackingField;    // 0x0x30
    public DateTime? <PLGAAJABNFK>k__BackingField;    // 0x0x40
    public DateTime? <KIDMDLFPCIF>k__BackingField;    // 0x0x50
    public bool <AEIBLNGOMLA>k__BackingField;    // 0x0x60
    public bool <LGICBOBHCGP>k__BackingField;    // 0x0x61
}

// --------------------------------------------------------------------------
// CHACFMJCDED
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class CHACFMJCDED
{
    public long <DDCGLADKGBI>k__BackingField;    // 0x0x10
    public int <IEOPPKJCDMN>k__BackingField;    // 0x0x18
}
...
public class CJHGGIHDAJF
{
    public int <FAIKHGCKMEI>k__BackingField;    // 0x0x10
    public byte <GNLIKPGFPPE>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// DDKHEDPEJEB
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class DDKHEDPEJEB
{
    public bool <DLNGKJBEACJ>k__BackingField;    // 0x0x10
    public string <GNLMNOGJMFN>k__BackingField;    // 0x0x18
    public string <BOJBOENLPBH>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/progressionEvents/collect/{aBLDALFJPJM}/{gEGDMHDEAOE}   [Service.API]
public class DEFMBGIMAIE
{
    public long? <POAKLGPAJEM>k__BackingField;    // 0x0x10
    public int <FAIKHGCKMEI>k__BackingField;    // 0x0x20
    public int? <LIHDJBIAAEE>k__BackingField;    // 0x0x24
    public string <PJNFFDIGIEP>k__BackingField;    // 0x0x30
    public PKFFGNGIAJB? <ANDKNENLKGF>k__BackingField;    // 0x0x38
    public string <CFBIDGAKKCL>k__BackingField;    // 0x0x40
    public Guid? <JFNOPPBCHMH>k__BackingField;    // 0x0x48
    public string <CMNPIEDEJIM>k__BackingField;    // 0x0x60
    public string <ILBCFOCCFMH>k__BackingField;    // 0x0x68
    public AFALINLHGMI <PAECCIEDONH>k__BackingField;    // 0x0x70
    public int <IOKLBGNCIIM>k__BackingField;    // 0x0x74
    public int <KCIFMBDMBIK>k__BackingField;    // 0x0x78
    public BBENDLFLDLL <HEKBBCLFIBK>k__BackingField;    // 0x0x7C
    public EKPGHFMPAMO <KLKBMNMCFKB>k__BackingField;    // 0x0x80
    public string <FCLBNKFJPLP>k__BackingField;    // 0x0x88
    public string <ICFJDBCADDO>k__BackingField;    // 0x0x90
    public bool <NOPJPGCJNCO>k__BackingField;    // 0x0x98
    public BLIFBLCKHPP <PCINIDEIHDJ>k__BackingField;    // 0x0x9C
    public DMGJGGMGIKH <KNDNKFICEEL>k__BackingField;    // 0x0xA0
    public GIECLLHGNOG? <CDPLJIDCPFB>k__BackingField;    // 0x0xA4
    public bool <MPOIKHHEBGI>k__BackingField;    // 0x0xAC
    public bool <CLAHHLPPPIP>k__BackingField;    // 0x0xAD
    public string <PHCGODDBHPP>k__BackingField;    // 0x0xB0
    public string <LIALFKIBDPF>k__BackingField;    // 0x0xB8
    public bool <AKFBABAJCKI>k__BackingField;    // 0x0xC0
    public bool FGAJCKEDHJN;    // 0x0xC1
}

// --------------------------------------------------------------------------
// DFEFEEAPOEJ
//   REQUEST  POST   api/items/purchaseInfos   [Service.Econ]
public class DFEFEEAPOEJ
{
    public IReadOnlyList<MAMOBBNLCDL> <EIELIBIMJIP>k__BackingField;    // 0x0x10
}
...
public class DIBGLIOAPBF
{
    public int <BBPJENOPHNN>k__BackingField;    // 0x0x10
    public int <FPCFOHCDJGP>k__BackingField;    // 0x0x14
    public float <MFJOBLPKNKB>k__BackingField;    // 0x0x18
    public float <MOGKKEEDOAF>k__BackingField;    // 0x0x1C
    public bool <HCDLEKPOIGL>k__BackingField;    // 0x0x20
    public bool <EGGLHICAENG>k__BackingField;    // 0x0x21
    public bool <JJFDINONGJF>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// DLAOAGANONF
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class DLAOAGANONF
{
    public Guid? <ADBJGAKMHHM>k__BackingField;    // 0x0x10
    public long? <HKJFKNEFBIH>k__BackingField;    // 0x0x28
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x38
    public string <IAKNNINGHGD>k__BackingField;    // 0x0x40
    public string <PHGPDLNHFKJ>k__BackingField;    // 0x0x48
    public PCGNLIKJJAK <GKNGOIMFAHO>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// DMBILFLOHHO
// base   : DLCKLFEAADK`1<GFAGOKJKJAJ>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{jGIINAOFPAB}   [Service.API]
public class DMBILFLOHHO
{
    // (no instance fields in the metadata dump)
}
...
// DMDBNHCAHKF
//   (not directly referenced by a detected call)
public class DMDBNHCAHKF
{
    public int <OLDICGBELPM>k__BackingField;    // 0x0x10
    public ANNBMKDCIMI <JOEPPAAADOD>k__BackingField;    // 0x0x14
}
...
public class ECGAJOKDGNJ
{
    public string <JKPGJOFMJGH>k__BackingField;    // 0x0x10
    public string <ADALMPNCEFH>k__BackingField;    // 0x0x18
    public string <LILPNGPPIEJ>k__BackingField;    // 0x0x20
    public string <BNFPLPOONPJ>k__BackingField;    // 0x0x28
    public EKPGHFMPAMO <FGJCNBGGCNM>k__BackingField;    // 0x0x30
    public string <CIHMLAJKKOD>k__BackingField;    // 0x0x38
    public bool NEEFBICPONL;    // 0x0x40
    public bool <JJFDINONGJF>k__BackingField;    // 0x0x41
}

// --------------------------------------------------------------------------
// ECMJKJLEKPA
//   (not directly referenced by a detected call)
public class ECMJKJLEKPA
{
    public float <ECEIONADAOC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EDJABGKKHLI
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class EDJABGKKHLI
{
    public PCHFKNHBAPC <PIFHAGOHHHL>k__BackingField;    // 0x0x10
    public int <EGMBGHHILED>k__BackingField;    // 0x0x14
    public long <AFLBIGAPGDM>k__BackingField;    // 0x0x18
    public bool <DBMDKFIPCDJ>k__BackingField;    // 0x0x20
    public string <IOJKBLDEEEO>k__BackingField;    // 0x0x28
    public int? <NPCLJNNPEDM>k__BackingField;    // 0x0x30
    public bool <PDFFANPABKF>k__BackingField;    // 0x0x38
    public bool <LGOEGLPOONG>k__BackingField;    // 0x0x39
    public bool <MOLGPEDKDII>k__BackingField;    // 0x0x3A
    public bool <LHONFJCCDGF>k__BackingField;    // 0x0x3B
    public string <PKIOBMJPBJP>k__BackingField;    // 0x0x40
    public DateTime? <JBMPGDNDCFI>k__BackingField;    // 0x0x48
    public string <KAILMIBBJPF>k__BackingField;    // 0x0x58
    public bool <BBNNPGJHDBO>k__BackingField;    // 0x0x60
    public string <HACOJBHGMMN>k__BackingField;    // 0x0x68
    public string <LNMFLBLKBGL>k__BackingField;    // 0x0x70
    public float <PHHCBFEKGKE>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// EFKGFDEAEEK
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class EFKGFDEAEEK
{
    public int <NJPEMCKJAPA>k__BackingField;    // 0x0x10
    public int <CHDIEDBGFPD>k__BackingField;    // 0x0x14
    public float <DIFCLIBHFCE>k__BackingField;    // 0x0x18
    public int <EIBCEKPKHFN>k__BackingField;    // 0x0x1C
    public int <PNFOEMLCLAM>k__BackingField;    // 0x0x20
    public int <HDNFDDDPKHL>k__BackingField;    // 0x0x24
    public int <GEOIHAGDCCC>k__BackingField;    // 0x0x28
    public string <AGCDCDOEECM>k__BackingField;    // 0x0x30
    public string <DDEEFAEJMIE>k__BackingField;    // 0x0x38
}
...
//   RESPONSE GET    api/playerevents/v1/all/{dJKBOHPOLAF}   [Service.API]
public class EHFDBNJDMNG
{
    public List<KPDAGMLDDMN> <KGIGEODJKME>k__BackingField;    // 0x0x10
    public List<KKBJOPKMKPM> <NGHCGMHALAJ>k__BackingField;    // 0x0x18
}
...
// EOMFEPNODNF
//   (not directly referenced by a detected call)
public class EOMFEPNODNF
{
    public string <FEFGKLKGEHH>k__BackingField;    // 0x0x10
    public JNLLMNCNLDH <KDIECALBFMD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EPEEHKMAFGD
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class EPEEHKMAFGD
{
    public List<EOMFEPNODNF> <DHBEMLGJMDI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EPFFGLBFJOF
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class EPFFGLBFJOF
{
    public List<KPDAGMLDDMN> <OKIEOHKJPBP>k__BackingField;    // 0x0x10
    public string <IHLLLOLIMFJ>k__BackingField;    // 0x0x18
}
...
// base   : DOGFEIGMFOH
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{aEFPEPBMHMM}   [Service.Econ]
public class FEONFAOBIPC : DOGFEIGMFOH
{
    public int <PLHDBKNDHLK>k__BackingField;    // 0x0x30
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x38
    public DateTime <IFPKACIFGOO>k__BackingField;    // 0x0x40
    public DateTime <DIAHNMACFAI>k__BackingField;    // 0x0x48
    public AFALINLHGMI <PAECCIEDONH>k__BackingField;    // 0x0x50
    public CEJLPABAJGE <KHIAFMPAHPM>k__BackingField;    // 0x0x58
    public List<IKMIDEPNBJN> <PALJCMAHMCE>k__BackingField;    // 0x0x60
    public POCNEJKPKID <LJNAOKNCLBM>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FFECCBCIIFN
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class FFECCBCIIFN
{
    public int <JLEAALLFPKN>k__BackingField;    // 0x0x10
    public int? <PIHPEDALCKP>k__BackingField;    // 0x0x14
    public string <FOGDDCBJKBH>k__BackingField;    // 0x0x20
    public string <MJCMLOJMPDC>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// FFOPFKAFAOL
//   (not directly referenced by a detected call)
public class FFOPFKAFAOL
{
    public EGEILCJOOBK <KDIECALBFMD>k__BackingField;    // 0x0x10
    public int? <KFDBLOBNNJI>k__BackingField;    // 0x0x14
    public Guid? <FJCCLHKGDHN>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// FGOPBLCIKMD
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{eBHOIBHGECB}   [Service.API]
public class FGOPBLCIKMD
{
    public uint <POAKLGPAJEM>k__BackingField;    // 0x0x10
    public uint? <HPNDHGLCPKD>k__BackingField;    // 0x0x14
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x20
    public string <IAKNNINGHGD>k__BackingField;    // 0x0x28
    public DateTime <GGFMLNOCMAB>k__BackingField;    // 0x0x30
    public DateTime? <GKEIECIOCPM>k__BackingField;    // 0x0x38
    public bool <PIMGGFECFLE>k__BackingField;    // 0x0x48
    public List<IGGKDAFIPMB> <PDDINFADFBP>k__BackingField;    // 0x0x50
    public List<string> <DHBEMLGJMDI>k__BackingField;    // 0x0x58
    public int <NHLLMOFEGCB>k__BackingField;    // 0x0x60
    public int <JBJIGPDDECH>k__BackingField;    // 0x0x64
    public int <PAIGNIEGBIM>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FGPIILNPAPF
//   (not directly referenced by a detected call)
public class FGPIILNPAPF
{
    public int <HHOBFGHDHKI>k__BackingField;    // 0x0x10
    public DateTime <PMJDHMBOBEI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FKGMDNPMBEH
//   (not directly referenced by a detected call)
public class FKGMDNPMBEH
{
    public Guid <ADBJGAKMHHM>k__BackingField;    // 0x0x10
    public long <HKJFKNEFBIH>k__BackingField;    // 0x0x20
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x28
    public string <IAKNNINGHGD>k__BackingField;    // 0x0x30
    public string <PHGPDLNHFKJ>k__BackingField;    // 0x0x38
    public long <IIHNBGOGNGD>k__BackingField;    // 0x0x40
    public Guid? <PNBNLLKBAPL>k__BackingField;    // 0x0x48
    public DateTime <JCPAONNBBEC>k__BackingField;    // 0x0x60
    public int <FNDNLEJMFGD>k__BackingField;    // 0x0x68
}
...
// GGJCDEJNFMA
//   (not directly referenced by a detected call)
public class GGJCDEJNFMA
{
    public int <OGCPAEKPAON>k__BackingField;    // 0x0x10
}
...
// HDAEODHAMDF
//   (not directly referenced by a detected call)
public class HDAEODHAMDF
{
    public Guid <ADBJGAKMHHM>k__BackingField;    // 0x0x10
    public int <IEOPPKJCDMN>k__BackingField;    // 0x0x20
    public int <BKJAFKMDLAN>k__BackingField;    // 0x0x24
    public Guid <NPNNJGCEDHF>k__BackingField;    // 0x0x28
    public DateTime <JCPAONNBBEC>k__BackingField;    // 0x0x38
    public FKGMDNPMBEH <PJGBOIBHAPB>k__BackingField;    // 0x0x40
}
...
public class HDLCNHFFMMI
{
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x10
    public string <IAKNNINGHGD>k__BackingField;    // 0x0x18
    public int? <IIHNBGOGNGD>k__BackingField;    // 0x0x20
    public LLFJILOKJLH? <FDAKKOKEKLB>k__BackingField;    // 0x0x28
}
...
//   (not directly referenced by a detected call)
public class HEHJIIEIGHG : ValueType
{
    public Guid JMHOEKKPCPG;    // 0x0x0
}
...
public class HJKIFFMGPEK : KPDAGMLDDMN
{
    public List<EOMFEPNODNF> <DHBEMLGJMDI>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// HKIBCKJIJFD
//   (not directly referenced by a detected call)
public class HKIBCKJIJFD
{
    public DateTime <MPGHDHAIHBN>k__BackingField;    // 0x0x10
    public string <ANADPGKJDAA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HPEPKKFMDEK
//   (not directly referenced by a detected call)
public class HPEPKKFMDEK
{
    public long <DDCGLADKGBI>k__BackingField;    // 0x0x10
    public Guid <AEJLKHBBCPE>k__BackingField;    // 0x0x18
    public long <HKJFKNEFBIH>k__BackingField;    // 0x0x28
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x30
    public string <IAKNNINGHGD>k__BackingField;    // 0x0x38
    public int <IIHNBGOGNGD>k__BackingField;    // 0x0x40
    public Guid? <PNBNLLKBAPL>k__BackingField;    // 0x0x44
    public DateTime <MPGHDHAIHBN>k__BackingField;    // 0x0x58
    public string <PHGPDLNHFKJ>k__BackingField;    // 0x0x60
    public LGBMGFOIFNM <KDIECALBFMD>k__BackingField;    // 0x0x68
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class HPJMJPAALJE : ValueType
{
    public Guid JMHOEKKPCPG;    // 0x0x0
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{aBLDALFJPJM}   [Service.API]
...
public class IBOLPMPHNFO
{
    public HJKIFFMGPEK <GEPABGPLJMK>k__BackingField;    // 0x0x10
    public ANNBMKDCIMI <JOEPPAAADOD>k__BackingField;    // 0x0x18
    public ABNKOAHBFOA <OJOJHHAOJCJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// ICANKDKNDHG
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.Econ]
public class ICANKDKNDHG
{
    public List<string> <HDNPNPEKLBK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IDMPCPGKEOI
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.Econ]
public class IDMPCPGKEOI
{
    public Guid <LOOENCNFBKB>k__BackingField;    // 0x0x10
    public int <NLHBBDALFKC>k__BackingField;    // 0x0x20
    public long <KIDONNPBLKB>k__BackingField;    // 0x0x28
    public Guid <FBFFEEKDPHA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// IEIFNOIIDFI
//   (not directly referenced by a detected call)
public class IEIFNOIIDFI
{
    public AFALINLHGMI <PAECCIEDONH>k__BackingField;    // 0x0x10
    public int <IIHNBGOGNGD>k__BackingField;    // 0x0x14
    public BNNNKMHLGPM <FPDOJDDBMHJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IGGKDAFIPMB
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class IGGKDAFIPMB
{
    public string <POAKLGPAJEM>k__BackingField;    // 0x0x10
    public string <GNLMNOGJMFN>k__BackingField;    // 0x0x18
    public string <FMLBMHHKAPD>k__BackingField;    // 0x0x20
    public string <IAKNNINGHGD>k__BackingField;    // 0x0x28
    public string <IFAMPHBCNBK>k__BackingField;    // 0x0x30
    public GAAKMOMJIAG <BMJEJJJNGIA>k__BackingField;    // 0x0x38
    public List<string> <DEGFBHLKNLJ>k__BackingField;    // 0x0x40
    public List<string> <DHBEMLGJMDI>k__BackingField;    // 0x0x48
    public string <CAGJJNJJDOF>k__BackingField;    // 0x0x50
    public List<HKIBCKJIJFD> <MBKLLEPIBBB>k__BackingField;    // 0x0x58
}
...
// base   : CEJLPABAJGE
//   (not directly referenced by a detected call)
public class IKMIDEPNBJN : CEJLPABAJGE
{
    public int <HIGGCECPJIH>k__BackingField;    // 0x0x68
    public List<JGOGFMLFFIC> <FKNIPEGJHFB>k__BackingField;    // 0x0x70
    public List<JGOGFMLFFIC> <ODNDLALBFOI>k__BackingField;    // 0x0x78
    public List<JGOGFMLFFIC> <DFAPLDCOJEM>k__BackingField;    // 0x0x80
}
...
public class IPBMGJJAFBJ
{
    public RoomKeyResult <BMJEJJJNGIA>k__BackingField;    // 0x0x10
    public HPEPKKFMDEK <MJHEMMENNLG>k__BackingField;    // 0x0x18
}
...
public class JEGCNLNJNGB
{
    public bool <BBFBDIGKKHJ>k__BackingField;    // 0x0x10
    public string <IOJKBLDEEEO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JGBIGGDHFCJ
// base   : DLCKLFEAADK`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class JGBIGGDHFCJ
{
    // (no instance fields in the metadata dump)
}
...
// JGOGFMLFFIC
//   (not directly referenced by a detected call)
public class JGOGFMLFFIC
{
    public bool <GKPFNEFALJE>k__BackingField;    // 0x0x10
    public MCHGFEJGFNI <CMOADGKLDLN>k__BackingField;    // 0x0x18
    public float <IHDNLGHIDAM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JJMAKCOAOBG
//   (not directly referenced by a detected call)
public class JJMAKCOAOBG
{
    public int <KONOEMFHALM>k__BackingField;    // 0x0x10
    public LKHJJFELPMD <LHCFPCNPNIE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JLNLKKLJJDA
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class JLNLKKLJJDA
{
    public int <IEOPPKJCDMN>k__BackingField;    // 0x0x10
    public Guid <LOOENCNFBKB>k__BackingField;    // 0x0x14
    public long <LHCCILFFODI>k__BackingField;    // 0x0x28
    public DateTime <JCPAONNBBEC>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// JNIIBEMJCLN
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class JNIIBEMJCLN
{
    public long <HKJFKNEFBIH>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <FJPEAKFGLLL>k__BackingField;    // 0x0x18
    public EBHGNNNNABL <MHJLBBPNDIE>k__BackingField;    // 0x0x20
}
...
// KCLBKEJFNLP
//   (not directly referenced by a detected call)
public class KCLBKEJFNLP
{
    public FFOPFKAFAOL <FKMEFBBMILH>k__BackingField;    // 0x0x10
    public long <KOHGJBCEDGF>k__BackingField;    // 0x0x18
    public GiftItemDTO <JPFKEBIMDPB>k__BackingField;    // 0x0x20
    public long? <MODGCAPNDBG>k__BackingField;    // 0x0x28
    public int <HECDKDICNEG>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// KDCHPLLNNDL
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class KDCHPLLNNDL
{
    public List<PBABADNGLPP> <ILPLHGMLKOP>k__BackingField;    // 0x0x10
    public string <IHLLLOLIMFJ>k__BackingField;    // 0x0x18
}
...
public class KJAJAIPDJLO : BKNNGALLFKE
{
    public CJBBMJPEOEJ? <LBPOJAKKOMP>k__BackingField;    // 0x0x18
    public JLNLKKLJJDA <OCJHCDMFINJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KKBJOPKMKPM
//   (not directly referenced by a detected call)
public class KKBJOPKMKPM
{
    public KPDAGMLDDMN <GEPABGPLJMK>k__BackingField;    // 0x0x10
    public BCFCFJMAEKD <LKCODJMJNPB>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KMDCFMNENDH
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class KMDCFMNENDH
{
    public int <EGMBGHHILED>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KMFJDIFFJAE
//   RESPONSE GET    api/config/v2   [Service.API]
public class KMFJDIFFJAE
{
    public Dictionary<int, int> <FCBDDCJMPAI>k__BackingField;    // 0x0x10
    public List<JJOBAFNOOEA> <KFJJFFMFAIC>k__BackingField;    // 0x0x18
    public BFBLBPCCKIG[][] <DNAIPNNBGAG>k__BackingField;    // 0x0x20
    public GGJCDEJNFMA <GCEPKOGLBGN>k__BackingField;    // 0x0x28
    public AEDLJNIBMFG <MEDJDMIKBMH>k__BackingField;    // 0x0x30
    public FGPIILNPAPF <GNILAJJJFBB>k__BackingField;    // 0x0x38
    public OLLFEJBEHPK <IKIAOFIOBCE>k__BackingField;    // 0x0x40
    public ECMJKJLEKPA <LFAPPJHPIGG>k__BackingField;    // 0x0x48
    public string <KJHDKHHGFKH>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// KPDAGMLDDMN
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class KPDAGMLDDMN
{
    public long <FPPOMOFOMJA>k__BackingField;    // 0x0x10
    public int <GPDODLCOAMI>k__BackingField;    // 0x0x18
    public long <HKJFKNEFBIH>k__BackingField;    // 0x0x20
    public long? <HIJJMJBODHE>k__BackingField;    // 0x0x28
    public long? <OLLKLJFAIBI>k__BackingField;    // 0x0x38
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x48
    public string <IAKNNINGHGD>k__BackingField;    // 0x0x50
    public string <PHGPDLNHFKJ>k__BackingField;    // 0x0x58
    public DateTime <NIMIMKBAAGK>k__BackingField;    // 0x0x60
    public DateTime <OAKJBIADMMI>k__BackingField;    // 0x0x68
    public int <EMGEKJINOIM>k__BackingField;    // 0x0x70
    public BNECKOIJALE <FDAKKOKEKLB>k__BackingField;    // 0x0x74
    public bool <HCLFLNFACHO>k__BackingField;    // 0x0x78
    public bool <EEGMJOMCAMB>k__BackingField;    // 0x0x79
    public GFGDKKBFFGK <MFAFMIHFLEA>k__BackingField;    // 0x0x7C
    public GFGDKKBFFGK <FJNMPLPFICM>k__BackingField;    // 0x0x80
    public long? <CCDJLBLNCLH>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// LDODKNGBGHG
//   (not directly referenced by a detected call)
public class LDODKNGBGHG
{
    public Guid <JDOKJBJPCBF>k__BackingField;    // 0x0x10
    public Guid <NEELLFALNPM>k__BackingField;    // 0x0x20
    public DateTime <IFPKACIFGOO>k__BackingField;    // 0x0x30
    public List<MCHGFEJGFNI> <EBIMOIHHGMI>k__BackingField;    // 0x0x38
}
...
public class LGKJOLMJPJP
{
    public int? <AEEDFAEOHJC>k__BackingField;    // 0x0x10
    public string <IFAMPHBCNBK>k__BackingField;    // 0x0x18
    public string <PLACHANDCIE>k__BackingField;    // 0x0x20
}
...
public class LIGFKGJFKNL : BKNNGALLFKE
{
    public KBBBLGAOJOB? <LBPOJAKKOMP>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <ABHBGNLLIAB>k__BackingField;    // 0x0x20
}
...
public class LIGHLHDBHGN
{
    public Guid <FBFFEEKDPHA>k__BackingField;    // 0x0x10
    public long <LKIDEDOCJPD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LKHJJFELPMD
//   REQUEST  PUT    api/roomconsumables   [Service.Econ]
public class LKHJJFELPMD
{
    public Guid? <GJFIKBIHNCA>k__BackingField;    // 0x0x10
    public Guid <ALFBLEOCDPD>k__BackingField;    // 0x0x24
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{bDDKJHFKDNE}   [Service.Econ]
public class LPGPJCHDHHG
{
    public JOLAKIADOHF <BMJEJJJNGIA>k__BackingField;    // 0x0x10
    public FKGMDNPMBEH <PJGBOIBHAPB>k__BackingField;    // 0x0x18
}
...
// base   : NCLLJDMGMFF
//   (not directly referenced by a detected call)
public class MAMOBBNLCDL : NCLLJDMGMFF
{
    public HHOJDCOLFLB FAOCHKMMFJK;    // 0x0x20
}

// --------------------------------------------------------------------------
// MCHGFEJGFNI
//   (not directly referenced by a detected call)
public class MCHGFEJGFNI
{
    public int <NHCFBANHONC>k__BackingField;    // 0x0x10
    public string <LILPNGPPIEJ>k__BackingField;    // 0x0x18
    public string <BNFPLPOONPJ>k__BackingField;    // 0x0x20
    public string <IMPMNGLEHBC>k__BackingField;    // 0x0x28
    public string <PJNFFDIGIEP>k__BackingField;    // 0x0x30
    public OOLKLJDECHH? <MAAKMFONKML>k__BackingField;    // 0x0x38
    public string <CFBIDGAKKCL>k__BackingField;    // 0x0x70
    public Guid? <JFNOPPBCHMH>k__BackingField;    // 0x0x78
    public PKFFGNGIAJB? <ANDKNENLKGF>k__BackingField;    // 0x0x8C
    public string <CMNPIEDEJIM>k__BackingField;    // 0x0x98
    public string <ILBCFOCCFMH>k__BackingField;    // 0x0xA0
    public bool <BIICMHLGHBN>k__BackingField;    // 0x0xA8
    public bool <CIDNAELLGLD>k__BackingField;    // 0x0xA9
    public bool <IABAHHOBFNN>k__BackingField;    // 0x0xAA
    public EKPGHFMPAMO <FGJCNBGGCNM>k__BackingField;    // 0x0xAC
    public AFALINLHGMI <PAECCIEDONH>k__BackingField;    // 0x0xB0
    public int <IOKLBGNCIIM>k__BackingField;    // 0x0xB4
    public AHNEIMADPDH <FKHBEHENLLF>k__BackingField;    // 0x0xB8
    public BBENDLFLDLL <HLHNJFCAHNF>k__BackingField;    // 0x0xBC
    public int? <ACHFBPONAKM>k__BackingField;    // 0x0xC0
    public string <PBJEIHONENC>k__BackingField;    // 0x0xC8
    public int? <BCKIPEDBHAG>k__BackingField;    // 0x0xD0
    public int? <DEBCNNNGPDH>k__BackingField;    // 0x0xD8
    public string <CIHMLAJKKOD>k__BackingField;    // 0x0xE0
}

// --------------------------------------------------------------------------
// MFIIACAPFNL
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class MFIIACAPFNL
{
    public List<int> <NHKKJCIEGMJ>k__BackingField;    // 0x0x10
    public string <IHLLLOLIMFJ>k__BackingField;    // 0x0x18
}
...
public class MLCDNCDBNAG
{
    public long <FPPOMOFOMJA>k__BackingField;    // 0x0x10
    public JNOBBCOEKMD <KDIECALBFMD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MMIEOCPIEFE
//   REQUEST  POST   api/items/bulkpurchase   [Service.Commerce]
public class MMIEOCPIEFE
{
    public List<KCLBKEJFNLP> <HDPKOKLNBKO>k__BackingField;    // 0x0x10
    public ANEPECIFGOK? <AKCADIAGGNO>k__BackingField;    // 0x0x18
    public AFALINLHGMI <PAECCIEDONH>k__BackingField;    // 0x0x20
    public bool <JBCEGOPFPBG>k__BackingField;    // 0x0x24
    public bool <MINMJIOKIFK>k__BackingField;    // 0x0x25
}
...
public class NBPAGOFMKKD
{
    public PCHFKNHBAPC <PIFHAGOHHHL>k__BackingField;    // 0x0x10
    public long <FPPOMOFOMJA>k__BackingField;    // 0x0x18
    public string <EJKGJDBKOEK>k__BackingField;    // 0x0x20
}
...
public class NEMMNMKBJAK
{
    public ANNBMKDCIMI <JOEPPAAADOD>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NGACCEPCCNC
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class NGACCEPCCNC
{
    public Dictionary<Guid, BPKHPANMKOB> <FHILDGDFFMP>k__BackingField;    // 0x0x10
}
...
public class OAECKPCLDAM
{
    public int <NMKPMDIDCNL>k__BackingField;    // 0x0x10
    public LJJDGLFJCGP <KDIECALBFMD>k__BackingField;    // 0x0x14
    public OMJKCEDJGJB <OGAECOPKPIF>k__BackingField;    // 0x0x18
    public OMJKCEDJGJB <MMGHHPDKPNJ>k__BackingField;    // 0x0x1C
    public OMJKCEDJGJB <MBOBAHHEDGF>k__BackingField;    // 0x0x20
    public byte? <GNLIKPGFPPE>k__BackingField;    // 0x0x24
}
...
public class OKMBEJKAAHA
{
    public int <FPCFOHCDJGP>k__BackingField;    // 0x0x10
    public bool <HCDLEKPOIGL>k__BackingField;    // 0x0x14
    public DateTime <NMBGKFEIIPP>k__BackingField;    // 0x0x18
    public bool <CNKJHOHABBG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OLLFEJBEHPK
//   (not directly referenced by a detected call)
public class OLLFEJBEHPK
{
    public int <INJONOMDABA>k__BackingField;    // 0x0x10
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class OOLKLJDECHH : ValueType
{
    public HEHJIIEIGHG ONCPEFHFHGI;    // 0x0x0
    public HPJMJPAALJE NDCKIGBKGDK;    // 0x0x10
    public Guid OLOFPEPFBNO;    // 0x0x20
}

// --------------------------------------------------------------------------
// PBABADNGLPP
//   (not directly referenced by a detected call)
public class PBABADNGLPP
{
    public int <IKLDEKIPKAF>k__BackingField;    // 0x0x10
    public DateTime <MPGHDHAIHBN>k__BackingField;    // 0x0x18
    public DateTime? <HHCFFMLIMIL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PCGNLIKJJAK
//   (not directly referenced by a detected call)
public class PCGNLIKJJAK
{
    public long <IIHNBGOGNGD>k__BackingField;    // 0x0x10
    public Guid? <LOOENCNFBKB>k__BackingField;    // 0x0x18
}
...
public class PFGHDDLOLBG
{
    public List<string> <LDDLJPBFLGI>k__BackingField;    // 0x0x10
    public List<string> <JCAKJKDHJFH>k__BackingField;    // 0x0x18
    public List<string> <FEEPECILCIL>k__BackingField;    // 0x0x20
}
...
// POCNEJKPKID
//   (not directly referenced by a detected call)
public class POCNEJKPKID
{
    public bool <ONJLLMDGKFE>k__BackingField;    // 0x0x10
    public DMGJGGMGIKH <PEBCLJBEAGO>k__BackingField;    // 0x0x14
    public int <HOAMEKKJIKL>k__BackingField;    // 0x0x18
    public DateTime <JCPAONNBBEC>k__BackingField;    // 0x0x20
}
...
public class AddKeepsakeInstanceRequest
{
    public long <HKJFKNEFBIH>k__BackingField;    // 0x0x10
    public long? <HIJJMJBODHE>k__BackingField;    // 0x0x18
    public FENEICOAGDP <GJMPAPMOEJO>k__BackingField;    // 0x0x28
}
...
{
    public MFMGPMPGIOE <JOEPPAAADOD>k__BackingField;    // 0x0x10
    public string <EAPACHJOEHE>k__BackingField;    // 0x0x18
    public string <DKDFIBPKDED>k__BackingField;    // 0x0x20
    public string <IFEGNMMKEKO>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public AFALINLHGMI <CurrencyType>k__BackingField;    // 0x0x18
    public GIECLLHGNOG <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<EKPKBBPPCGN<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <FPPOMOFOMJA>k__BackingField;    // 0x0x10
    public long? <MAPGNGDANLD>k__BackingField;    // 0x0x18
}
...
{
    public string <GNINLLNHOAJ>k__BackingField;    // 0x0x10
    public int <IOCJFLLPFMM>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public MLBJDMELLDP FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public BBENDLFLDLL <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public FENEICOAGDP <ABPBKNMCMMN>k__BackingField;    // 0x0x10
    public string <GGHKNHPBJHE>k__BackingField;    // 0x0x18
    public int <CLFJNLGDDOF>k__BackingField;    // 0x0x20
    public int <EJNFDOMOOMO>k__BackingField;    // 0x0x24
    public string <AOLPLLOCOAF>k__BackingField;    // 0x0x28
    public string <BFKBCDIFKCO>k__BackingField;    // 0x0x30
}
...
{
    public int <IEOPPKJCDMN>k__BackingField;    // 0x0x10
    public Guid <KHOLCFFAPKC>k__BackingField;    // 0x0x14
    public DateTime <OHOPEOINOPL>k__BackingField;    // 0x0x28
}
...
{
    public bool <LPDHMBNPEEN>k__BackingField;    // 0x0x10
    public int <ILHJIGPFNKC>k__BackingField;    // 0x0x14
    public bool <BKIHKFFHOBI>k__BackingField;    // 0x0x18
}
...
{
    public Guid <KHOLCFFAPKC>k__BackingField;    // 0x0x10
    public FENEICOAGDP <EPPBMBCMJOG>k__BackingField;    // 0x0x20
    public int <OGGMKAHMLCK>k__BackingField;    // 0x0x24
    public long <HKJFKNEFBIH>k__BackingField;    // 0x0x28
    public long? <HIJJMJBODHE>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{cNNKDELNHGM}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <LNCINBFAOCG>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <APEBBPDNNFE>k__BackingField;    // 0x0x18
}
...
{
    public long <IFGBDCAHGDP>k__BackingField;    // 0x0x10
    public long <HKJFKNEFBIH>k__BackingField;    // 0x0x18
    public long <JGEGDJDELGA>k__BackingField;    // 0x0x20
    public EGMDPNLNOOL <KDIECALBFMD>k__BackingField;    // 0x0x28
    public int <GNBAKFMMAEP>k__BackingField;    // 0x0x2C
}
...
{
    public long <HKJFKNEFBIH>k__BackingField;    // 0x0x10
    public List<Guid> <DPDMFGCLPNA>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <LNCINBFAOCG>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <APEBBPDNNFE>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <BNJMAGKECCH>k__BackingField;    // 0x0x20
}
...
{
    public long <JGEGDJDELGA>k__BackingField;    // 0x0x10
    public long <NEGPBIHAFEO>k__BackingField;    // 0x0x18
    public int? <BKAHLKMLJEM>k__BackingField;    // 0x0x20
    public int? <INPCOJGNEGI>k__BackingField;    // 0x0x28
    public long? <IOOMPMCEMHC>k__BackingField;    // 0x0x30
    public long <JKDEPAHMKAA>k__BackingField;    // 0x0x40
    public long <GOAMDLBDLPI>k__BackingField;    // 0x0x48
    public int <CMCLFLAIKPN>k__BackingField;    // 0x0x50
    public EGMDPNLNOOL <CCGJDDKMFCI>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <IKPPIPAGOCB>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public BBENDLFLDLL <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public BAMAEEMHEMC creatorAccountRole;    // 0x0x68
...
{
    public OABDLHECECJ <DOBJPPEEIHP>k__BackingField;    // 0x0x10
    public GFKKHDHKFNE <HEJLGKGNAHK>k__BackingField;    // 0x0x14
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x18
    public string <IAKNNINGHGD>k__BackingField;    // 0x0x20
    public bool <DOLIFGDIKHC>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<OABDLHECECJ> <GAHGADJOKON>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{aBLDALFJPJM}   [Service.API]
public class ProgressionEventDTO
{
    public long <NEGPBIHAFEO>k__BackingField;    // 0x0x10
    public string <EIHAMBDPGGI>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <DFAPLDCOJEM>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <PHAILHJIMFB>k__BackingField;    // 0x0x28
    public DateTime <NIMIMKBAAGK>k__BackingField;    // 0x0x30
    public DateTime <OAKJBIADMMI>k__BackingField;    // 0x0x38
    public DateTime <HDDCJKAPDBL>k__BackingField;    // 0x0x40
    public bool <ENHOKBGINBP>k__BackingField;    // 0x0x48
    public int <LECGHCEGNHB>k__BackingField;    // 0x0x4C
    public float <BKBCLFIJMMO>k__BackingField;    // 0x0x50
    public Guid? <MNBGLKJAKKN>k__BackingField;    // 0x0x54
    public string <OINLPKIBHIC>k__BackingField;    // 0x0x68
    public string <LPFONNANAAI>k__BackingField;    // 0x0x70
    public string <JJEDDNMCBCK>k__BackingField;    // 0x0x78
    public string <JAANFOLPIDE>k__BackingField;    // 0x0x80
}
...
{
    public Guid <KPHFBGDLKCI>k__BackingField;    // 0x0x10
    public int <GLPNEBKNCGP>k__BackingField;    // 0x0x20
    public int <AENPGDBHCGG>k__BackingField;    // 0x0x24
    public int <CCCEHPDJPIJ>k__BackingField;    // 0x0x28
    public long <JEGAKELPHNN>k__BackingField;    // 0x0x30
    public long <BBACHFCMNGH>k__BackingField;    // 0x0x38
}
...
{
    public int <IEOPPKJCDMN>k__BackingField;    // 0x0x10
    public int <KCIFMBDMBIK>k__BackingField;    // 0x0x14
    public int <MKPGDPDDMEG>k__BackingField;    // 0x0x18
    public int <IAHMKBJMHPC>k__BackingField;    // 0x0x1C
    public int <AOODIOPNONE>k__BackingField;    // 0x0x20
    public DateTime? <DJDADHGFDON>k__BackingField;    // 0x0x28
    public int <NJLIDNFBGHJ>k__BackingField;    // 0x0x38
}
...
{
    public long <AHOMIOMGMOC>k__BackingField;    // 0x0x10
    public int <NHCFBANHONC>k__BackingField;    // 0x0x18
    public string <PHGPDLNHFKJ>k__BackingField;    // 0x0x20
    public int <KCIFMBDMBIK>k__BackingField;    // 0x0x28
    public int <JBOFNAMJMKJ>k__BackingField;    // 0x0x2C
    public bool <LKKGFPMLENC>k__BackingField;    // 0x0x30
    public bool <PAALOKHCDGH>k__BackingField;    // 0x0x31
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public HAHLEDDAHPJ <Permission>k__BackingField;    // 0x0x18
    public LLFJILOKJLH <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<PGENNCGIFIJ<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public MFLHFKPCIHB ReportCategory;    // 0x0x20
}
...
public class ReplicationUnityAssetsDTO
{
    ...
    public List<CELIPIJEKBI> <UnityAssets>k__BackingField;    // 0x0x18
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public LLFJILOKJLH <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public HINBHOHOMMB <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<COALENDKCEC> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{lHPBOOMFOJN}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool DODDPNPIOKJ;    // 0x0x28
}
...
{
    public NNMELKOCILO? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public NNMELKOCILO EHAMCICGEJM;  // wrapper
...
{
    public BLIFBLCKHPP NLDGMFAJACK;  // wrapper
...
{
    public DPNOJHDAHHN CEPGAJKBPDM;  // wrapper
    public int? IOBBEBFMIIP;  // wrapper
...
{
    public PCHFKNHBAPC PIHOHKJGELH;  // wrapper
...
{
    public byte[] IMINNNCPCJF;  // wrapper
    public HKDCMKCPKEE MMBJAKPLILJ;  // wrapper
...
{
    public PCHFKNHBAPC JAPLNPEPIKA;  // wrapper
    public float? GHDIFIFCFPN;  // wrapper
    public bool? JFDFJDGGNKB;  // wrapper
...
{
    public List<OOLKLJDECHH> desc;  // wrapper
}

// api/avatar/v2/gifts/generate  [Econ POST]
public class AvatarV2GiftsGenerateRequest
{
    public BBENDLFLDLL MJAGIMDGJBK;  // wrapper
    public BBENDLFLDLL? FJJKHGKDOMD;  // wrapper
...
{
    public ChatMessage ILBALOOKKCP;  // wrapper
    public GMMJELANIGD JAPLNPEPIKA;  // wrapper
...
{
    public LLFJILOKJLH JAIHGHAJIFE;  // wrapper
    public NCKPDJBCADI OALEEOJFPBH;  // wrapper
    public PBNKDKNJHNM IAFGLIKGBPL;  // wrapper
    public PBNKDKNJHNM PJIICJCNKED;  // wrapper
...
// api/customAvatarItems/v1/{fLLEHMEKPHP}/appeal  [API POST]
public class CustomAvatarItemsV1FLLEHMEKPHPAppealRequest
{
    public Guid FLLEHMEKPHP;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{jGIINAOFPAB}  [API GET]
public class CustomAvatarItemsV2FromCreatorJGIINAOFPABRequest
{
...
{
    public EFCKDCGNEFN EHLJIFJHJIA;  // wrapper
    public BBENDLFLDLL? EGCCMFHIEFJ;  // wrapper
...
{
    public ENLKDJAKICA DMAIJILKAIG;  // wrapper
...
{
    public int? MCFDLOCHDBO;  // wrapper
    public Guid? FLLEHMEKPHP;  // wrapper
...
// api/keepsakes/{eHGGCLOFHJH}/collect  [API POST]
public class KeepsakesEHGGCLOFHJHCollectRequest
{
    public Guid EHGGCLOFHJH;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public OFHHJGJAMLN DOEMBJJOFCC;  // wrapper
    public long? GFHIJAKOMMI;  // wrapper
...
{
    public Guid GPOFFOABDHN;  // wrapper
...
{
    public Guid DPNMEACIPDO;  // wrapper
...
{
    public Guid DPNMEACIPDO;  // wrapper
    public long? NGIJGGNNGPB;  // wrapper
    public byte? GOMGOEKJPBC;  // wrapper
    public int? BIKIHAKPCIG;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid GPOFFOABDHN;  // wrapper
    public long? JBIEJLKBFNL;  // wrapper
    public long? BIALCILCFBL;  // wrapper
    public int? FCNCCILAAHD;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> JCPNJLMMOLN;  // wrapper
...
{
    public LGBMGFOIFNM CEPGAJKBPDM;  // wrapper
    public Guid? MJIDKDHKPAH;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public PCHFKNHBAPC JAPLNPEPIKA;  // wrapper
    public long? MCMOPKCFEMI;  // wrapper
    public Guid? NDLIOGEDEPM;  // wrapper
    public int? OGIPHMLBMLP;  // wrapper
...
{
    public Guid DKAKFDGNKBF;  // wrapper
...
{
    public Guid KADPNCGHCHA;  // wrapper
...
{
    public GAAKMOMJIAG INAAIDCJHDJ;  // wrapper
}
