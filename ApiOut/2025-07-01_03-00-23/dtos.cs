...
public class AABFCDDEDKD
{
    public int <CONHADNGPKC>k__BackingField;    // 0x0x10
    public bool <PGGAPJPFGHN>k__BackingField;    // 0x0x14
    public DateTime <IGMAJABDGMD>k__BackingField;    // 0x0x18
    public bool <DIJNAHPNGFH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AGCNGEHOCOC
//   REQUEST  POST   api/relationships/v2/updateVoiceVolume   [Service.API]
public class AGCNGEHOCOC
{
    public int <HNOBFMFDGBL>k__BackingField;    // 0x0x10
    public byte <ABIIDMCEAEL>k__BackingField;    // 0x0x14
}
...
public class AGNHLKICACM : CACKOKOICFC
{
    public int <AJGKPNPGAHO>k__BackingField;    // 0x0x68
    public List<KPJECFKINAE> <IFJBBGCOIBH>k__BackingField;    // 0x0x70
    public List<KPJECFKINAE> <BOABIPEGGLE>k__BackingField;    // 0x0x78
    public List<KPJECFKINAE> <OFHKMMLOIAI>k__BackingField;    // 0x0x80
}
...
public class AIBJFJDAFKJ
{
    public long <JMPAOFMJELC>k__BackingField;    // 0x0x10
    public OGBNOAOONOH <OAOEGOKJNBE>k__BackingField;    // 0x0x18
}
...
//   (not directly referenced by a detected call)
public class ALBLDJNNKOA : ValueType
{
    public Guid PPIICOOCLEP;    // 0x0x0
}
...
// BABBAMKEPKC
//   (not directly referenced by a detected call)
public class BABBAMKEPKC
{
    public PABPINJHJCA <OODCDOHBNAB>k__BackingField;    // 0x0x10
    public JBMOPCCLKMH <AHICJPHGBBA>k__BackingField;    // 0x0x18
}
...
public class BDBKPLMHJEA
{
    public int? <LLCKPIEGDBG>k__BackingField;    // 0x0x10
    public string <JNILNIICIBC>k__BackingField;    // 0x0x18
    public string <DLDPGJGGKCM>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// BKDIFPIGMDE
// base   : EPJMGKEPGPO`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class BKDIFPIGMDE
{
...
public class BKELKGCBNFH
{
    public string <BPIKAMLBJIC>k__BackingField;    // 0x0x10
    public string <JEAJCIOGDLG>k__BackingField;    // 0x0x18
    public string <LLPGIBLDGMM>k__BackingField;    // 0x0x20
    public string <JCKFAHGDHID>k__BackingField;    // 0x0x28
    public string <JNILNIICIBC>k__BackingField;    // 0x0x30
    public GBJKMKGPCCA <FCOLGHJHFED>k__BackingField;    // 0x0x38
    public List<string> <PNCDFCPNOHN>k__BackingField;    // 0x0x40
    public List<string> <FEAANHMFOFG>k__BackingField;    // 0x0x48
    public string <PPJOPBEMGDI>k__BackingField;    // 0x0x50
    public List<DDPHKEMMLLM> <KFFHDLGEOMG>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// BPOMAIDALCB
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class BPOMAIDALCB
{
    public bool <BOGIIEOGJIP>k__BackingField;    // 0x0x10
    public string <JEAJCIOGDLG>k__BackingField;    // 0x0x18
    public string <PPFCGAHCHOB>k__BackingField;    // 0x0x20
}
...
public class CAABHMJDJLG
{
    public Guid <DAPNPIFAJLE>k__BackingField;    // 0x0x10
    public int <PLMFIALAPDC>k__BackingField;    // 0x0x20
    public long <KPCBMGKNBEF>k__BackingField;    // 0x0x28
    public Guid <PGAHLAIOGDL>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// CACKOKOICFC
//   (not directly referenced by a detected call)
public class CACKOKOICFC
{
    public int <HLCHOFODFGH>k__BackingField;    // 0x0x10
    public NOECFAIEIMO <OAOEGOKJNBE>k__BackingField;    // 0x0x14
    public List<FOFCLFMAPHB> <FABLFPPPLBJ>k__BackingField;    // 0x0x18
    public List<FOFCLFMAPHB> <COOMFHDKNDD>k__BackingField;    // 0x0x20
    public bool <PIAHNLMKEOD>k__BackingField;    // 0x0x28
    public DateTime? <CHKHPLLFFHC>k__BackingField;    // 0x0x30
    public DateTime? <PMNDDBAMEHG>k__BackingField;    // 0x0x40
    public DateTime? <JCDLOPJDKJH>k__BackingField;    // 0x0x50
    public bool <BELADAIPNAC>k__BackingField;    // 0x0x60
    public bool <CGKMEALLGLO>k__BackingField;    // 0x0x61
}

// --------------------------------------------------------------------------
// CBFPHBMFHHP
//   (not directly referenced by a detected call)
public class CBFPHBMFHHP
{
    public Guid <JNCOMJLDGPD>k__BackingField;    // 0x0x10
    public int <EFHKOPBDPBG>k__BackingField;    // 0x0x20
    public int <FEPAGKLEFMG>k__BackingField;    // 0x0x24
    public Guid <MFHENBNJPNF>k__BackingField;    // 0x0x28
    public DateTime <PCOKGKENEOO>k__BackingField;    // 0x0x38
    public CGAKDMAHHPA <HLKOMFIKLIC>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// CCHDDDMLAOD
//   REQUEST  PUT    api/roomconsumables   [Service.Econ]
public class CCHDDDMLAOD
{
    public Guid? <LBCDLDPOPFA>k__BackingField;    // 0x0x10
    public Guid <DNGBINIAANK>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// CCLGEBGDLJK
//   (not directly referenced by a detected call)
public class CCLGEBGDLJK
{
    public int <DNMLEBHJAPD>k__BackingField;    // 0x0x10
    public AHENKHHJEOD <PDJKEKNEMEN>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// CDCCNLFCMDE
//   (not directly referenced by a detected call)
public class CDCCNLFCMDE
{
    public int <DGIAMBMEBNO>k__BackingField;    // 0x0x10
    public CCHDDDMLAOD <HNHGKLPKCLG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CGAKDMAHHPA
//   (not directly referenced by a detected call)
public class CGAKDMAHHPA
{
    public Guid <JNCOMJLDGPD>k__BackingField;    // 0x0x10
    public long <PEKOIJCGDLJ>k__BackingField;    // 0x0x20
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x28
    public string <JCKFAHGDHID>k__BackingField;    // 0x0x30
    public string <GCIPCPOJEID>k__BackingField;    // 0x0x38
    public long <HOKJMMGLFHN>k__BackingField;    // 0x0x40
    public Guid? <MFDFICKKDMB>k__BackingField;    // 0x0x48
    public DateTime <PCOKGKENEOO>k__BackingField;    // 0x0x60
    public int <DIBEJNCBKAD>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// CGFIGCGOGAD
// base   : EPJMGKEPGPO`1<MGOOJHEAKEA>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{kDEIANPCPJI}   [Service.API]
public class CGFIGCGOGAD
{
    // (no instance fields in the metadata dump)
}
...
public class CGMLDKMAKMP
{
    public string <IHOHLCJKBOH>k__BackingField;    // 0x0x10
    public string <MEILCJHJLIK>k__BackingField;    // 0x0x18
    public string <LOOJJKEIEOA>k__BackingField;    // 0x0x20
    public string <HLPDGBFBPLC>k__BackingField;    // 0x0x28
    public APOBPBFLPKF <MBAJNIGMMBB>k__BackingField;    // 0x0x30
    public string <AFIDBOGDAIA>k__BackingField;    // 0x0x38
    public bool MNBIOCMBIGC;    // 0x0x40
    public bool <HOHBOKJBNOI>k__BackingField;    // 0x0x41
}
...
// CJJEGCAENDE
//   (not directly referenced by a detected call)
public class CJJEGCAENDE
{
    public string <MNFOBBMDANI>k__BackingField;    // 0x0x10
    public HMHOHDFJNHD <OAOEGOKJNBE>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{bCMAFCIPNGO}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{lDPNMFLPJKL}   [Service.API]
...
public class CPMCKEPMDCL
{
    public bool <HMBEKPALGLP>k__BackingField;    // 0x0x10
    public string <GLLEOHACMDA>k__BackingField;    // 0x0x18
    public string <DCHECEBPFGM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// DCFDEDBHDLH
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class DCFDEDBHDLH
{
    public Dictionary<Guid, CDCCNLFCMDE> <NHIBFEFAENN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DDPHKEMMLLM
//   (not directly referenced by a detected call)
public class DDPHKEMMLLM
{
    public DateTime <OOAGOOGOJKK>k__BackingField;    // 0x0x10
    public string <LMEDHFHFKPM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DHBLHGAOEEM
//   RESPONSE GET    api/config/v2   [Service.API]
public class DHBLHGAOEEM
{
    public Dictionary<int, int> <ANDPBEPELOP>k__BackingField;    // 0x0x10
    public List<PIHEOIGBCHN> <GNFPDEPOADE>k__BackingField;    // 0x0x18
    public FEGCLDHLCAP[][] <PDGDHLJALJE>k__BackingField;    // 0x0x20
    public MKOJPLIHDDM <DFEMCGOOBLB>k__BackingField;    // 0x0x28
    public IFJELMJDJDM <BIDFFCLLKOE>k__BackingField;    // 0x0x30
    public JAFMJMJOFAA <HNCIABNMABJ>k__BackingField;    // 0x0x38
    public IOFGPFEPBHM <BMGPHPCNGEP>k__BackingField;    // 0x0x40
    public PMCNFOMBBIG <AFCBIGDOGJD>k__BackingField;    // 0x0x48
    public string <PJBNIONIKJE>k__BackingField;    // 0x0x50
}
...
//   RESPONSE POST   api/progressionEvents/collect/{lJJBBPBGFNK}/{gEIAMIOEJDL}   [Service.API]
public class DHFODADIHHB
{
    public long? <BPIKAMLBJIC>k__BackingField;    // 0x0x10
    public int <HNOBFMFDGBL>k__BackingField;    // 0x0x20
    public int? <NCLLHNLJCHK>k__BackingField;    // 0x0x24
    public string <CADBKAJEFBK>k__BackingField;    // 0x0x30
    public ELBENOBCHIN? <GAJPGFHCBKC>k__BackingField;    // 0x0x38
    public string <KAOFFBBBKIP>k__BackingField;    // 0x0x40
    public Guid? <PCJFNILHEDA>k__BackingField;    // 0x0x48
    public string <JCNHIJIBDFN>k__BackingField;    // 0x0x60
    public string <OGPFFIDAELL>k__BackingField;    // 0x0x68
    public MEPDKFDNMHJ <PKJFOHICGIJ>k__BackingField;    // 0x0x70
    public int <FIEMNHCEICG>k__BackingField;    // 0x0x74
    public int <JNHFCMMBKID>k__BackingField;    // 0x0x78
    public MDMIDLEFCPL <IOMGDDNKIMJ>k__BackingField;    // 0x0x7C
    public APOBPBFLPKF <GGLFLHKGPEH>k__BackingField;    // 0x0x80
    public string <HGOPDINJGIC>k__BackingField;    // 0x0x88
    public string <FFLADHHNKFP>k__BackingField;    // 0x0x90
    public bool <MGPHFHKGLMK>k__BackingField;    // 0x0x98
    public KBHKIMMHEIJ <LOLNEMKAIMM>k__BackingField;    // 0x0x9C
    public NDAOEIDIMDM <BKGPDNNENMH>k__BackingField;    // 0x0xA0
    public ILINBGFIHDA? <DDGDEMHDEOM>k__BackingField;    // 0x0xA4
    public bool <FAELCKAFELK>k__BackingField;    // 0x0xAC
    public bool <DBMBBFGCELP>k__BackingField;    // 0x0xAD
    public string <OGHNNMPKNGG>k__BackingField;    // 0x0xB0
    public string <FOIFFHBPLON>k__BackingField;    // 0x0xB8
    public bool <ODJBMJMNNMF>k__BackingField;    // 0x0xC0
    public bool JNAKGKCIFFD;    // 0x0xC1
}

// --------------------------------------------------------------------------
// DJHDJIIHJCD
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class DJHDJIIHJCD
{
    public List<EAAAANIMKKE> <MNAOCBIDCKB>k__BackingField;    // 0x0x10
    public string <HOCBEKCBCLN>k__BackingField;    // 0x0x18
}
...
public class DMHMFAAGOAO
{
    public IReadOnlyList<MFNLLKPFCKA> <BBGLPFEMHDB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// EAAAANIMKKE
//   (not directly referenced by a detected call)
public class EAAAANIMKKE
{
    public int <ABKIODLMGFB>k__BackingField;    // 0x0x10
    public DateTime <OOAGOOGOJKK>k__BackingField;    // 0x0x18
    public DateTime? <HEENPFBODEL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EADIMECPMGA
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.API]
public class EADIMECPMGA
{
    public List<long> <FBALIBDHOAJ>k__BackingField;    // 0x0x10
    public JHKNNJGGLIC <OAOEGOKJNBE>k__BackingField;    // 0x0x18
    public string <PIENBMGAOIO>k__BackingField;    // 0x0x20
    public long? <PEKOIJCGDLJ>k__BackingField;    // 0x0x28
}
...
public class EBJBPLKPKEM : HDEKNGMMHEC
{
    public OCFCHOIJOAE? <CDACPKAMABK>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <OHHKILFLIFH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EDEIANCGGLE
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class EDEIANCGGLE
{
    public long <GCOGFCFMDCN>k__BackingField;    // 0x0x10
    public int <EFHKOPBDPBG>k__BackingField;    // 0x0x18
}
...
public class EDHPDOBDCCH
{
    public Guid <PGAHLAIOGDL>k__BackingField;    // 0x0x10
    public long <NMODIFNICPL>k__BackingField;    // 0x0x20
}
...
// ELHBNCMACPN
//   (not directly referenced by a detected call)
public class ELHBNCMACPN
{
    public long <GCOGFCFMDCN>k__BackingField;    // 0x0x10
    public Guid <KLPMPAJGOKH>k__BackingField;    // 0x0x18
    public long <PEKOIJCGDLJ>k__BackingField;    // 0x0x28
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x30
    public string <JCKFAHGDHID>k__BackingField;    // 0x0x38
    public int <HOKJMMGLFHN>k__BackingField;    // 0x0x40
    public Guid? <MFDFICKKDMB>k__BackingField;    // 0x0x44
    public DateTime <OOAGOOGOJKK>k__BackingField;    // 0x0x58
    public string <GCIPCPOJEID>k__BackingField;    // 0x0x60
    public HHMILPHBHMO <OAOEGOKJNBE>k__BackingField;    // 0x0x68
}
...
public class FDCECLEHMLF
{
    public AOPMKNPGONG <INMJOINELBG>k__BackingField;    // 0x0x10
    public long <JMPAOFMJELC>k__BackingField;    // 0x0x18
    public string <OOJCAPJBNLA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FEGCLDHLCAP
//   (not directly referenced by a detected call)
public class FEGCLDHLCAP
{
    public IBOAKCBPMDJ NAKOOJBNFNP;    // 0x0x10
    public int NDBBHBGBPMK;    // 0x0x14
}
...
// FJKEIAEKCIA
//   (not directly referenced by a detected call)
public class FJKEIAEKCIA
{
    public bool <PFMHJHNJPEJ>k__BackingField;    // 0x0x10
    public NDAOEIDIMDM <FNILOIJKCII>k__BackingField;    // 0x0x14
    public int <BNICAKGCBLO>k__BackingField;    // 0x0x18
    public DateTime <PCOKGKENEOO>k__BackingField;    // 0x0x20
}
...
public class FKBLEHDHOOC
{
    public AHENKHHJEOD <PDJKEKNEMEN>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FOFCLFMAPHB
//   (not directly referenced by a detected call)
public class FOFCLFMAPHB
{
    public MEPDKFDNMHJ <PKJFOHICGIJ>k__BackingField;    // 0x0x10
    public int <HOKJMMGLFHN>k__BackingField;    // 0x0x14
    public HKKLLODBJAK <AIOAPIEDDPN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GBCEFHIECEG
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class GBCEFHIECEG
{
    public Dictionary<Guid, NLOAEGHLOAO> <NPAJOLMOAEK>k__BackingField;    // 0x0x10
}
...
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{pEOJMNNJEJM}/{bBPBNFBPNAF}   [Service.Econ]
public class GEAJDMMFICA
{
    public MEPDKFDNMHJ <PKJFOHICGIJ>k__BackingField;    // 0x0x10
    public KMOLBCDKKBA <KNOIMAMFFJL>k__BackingField;    // 0x0x14
    public int <MFAGBMHICFK>k__BackingField;    // 0x0x18
    public int <NILADMOOGMD>k__BackingField;    // 0x0x1C
    public int <HCAMMMEILHD>k__BackingField;    // 0x0x20
    public BCCNEACFJGB <OLIJENLFJGE>k__BackingField;    // 0x0x24
    public bool <FCNPNGAHNOB>k__BackingField;    // 0x0x28
    public float <HAPHECOIPOO>k__BackingField;    // 0x0x2C
    public int <EKMGOLDPAJN>k__BackingField;    // 0x0x30
    public bool <BHGPILIFFBC>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// GEBOLIBEIPJ
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class GEBOLIBEIPJ
{
    public List<CCLGEBGDLJK> <NOBCKHLPNBE>k__BackingField;    // 0x0x10
    public AHENKHHJEOD <PDJKEKNEMEN>k__BackingField;    // 0x0x18
}
...
public class GIKGPPGEPIL
{
    public bool <HMBEKPALGLP>k__BackingField;    // 0x0x10
    public string <LDOHABJLAAM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GJAPAFFHHAG
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class GJAPAFFHHAG
{
    public List<PABPINJHJCA> <EJKJGOMCHOA>k__BackingField;    // 0x0x10
    public string <HOCBEKCBCLN>k__BackingField;    // 0x0x18
}
...
public class GNGJMCMAGNO
{
    public CCHDDDMLAOD <HNHGKLPKCLG>k__BackingField;    // 0x0x10
    public ICJLBMGCKCF <FDPHEOPBJBJ>k__BackingField;    // 0x0x18
    public int <DGIAMBMEBNO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HBLLOACBFMG
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{hLIPPIOIAJK}   [Service.API]
public class HBLLOACBFMG
{
    public uint <BPIKAMLBJIC>k__BackingField;    // 0x0x10
    public uint? <MHOOONDACBF>k__BackingField;    // 0x0x14
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x20
    public string <JCKFAHGDHID>k__BackingField;    // 0x0x28
    public DateTime <BDFJLNJCKIG>k__BackingField;    // 0x0x30
    public DateTime? <POGDMLPBPCI>k__BackingField;    // 0x0x38
    public bool <IDIIHIFEHDD>k__BackingField;    // 0x0x48
    public List<BKELKGCBNFH> <HOPPMDEFPAP>k__BackingField;    // 0x0x50
    public List<string> <FEAANHMFOFG>k__BackingField;    // 0x0x58
    public int <HEHLCONFLPP>k__BackingField;    // 0x0x60
    public int <DPLNBFDILEA>k__BackingField;    // 0x0x64
    public int <APPHHDOKAHK>k__BackingField;    // 0x0x68
}
...
public class HFNMGHGMMCM
{
    public long <PEKOIJCGDLJ>k__BackingField;    // 0x0x10
    public long? <FFLBOAOCHPA>k__BackingField;    // 0x0x18
    public long? <LOPOHHICLPI>k__BackingField;    // 0x0x28
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x38
    public string <JCKFAHGDHID>k__BackingField;    // 0x0x40
    public List<string> <FEAANHMFOFG>k__BackingField;    // 0x0x48
    public string <GCIPCPOJEID>k__BackingField;    // 0x0x50
    public DateTime <BLNIPGBKNGC>k__BackingField;    // 0x0x58
    public DateTime <PBDOKPEBBDF>k__BackingField;    // 0x0x60
    public KHLECHNNNCH <IIHMIMHPFGF>k__BackingField;    // 0x0x68
    public bool <LOEIPMLGCOP>k__BackingField;    // 0x0x6C
    public bool <NGGCKDPCDBO>k__BackingField;    // 0x0x6D
    public FJHEJMLOMDO <OHEGLHGAKPD>k__BackingField;    // 0x0x70
    public FJHEJMLOMDO <AJAFJKIAPAD>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// HGICOIJDIIG
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class HGICOIJDIIG
{
    public List<CJJEGCAENDE> <FEAANHMFOFG>k__BackingField;    // 0x0x10
}
...
public class HJAMDHAJEGL
{
    public ELKMAAFFBIF <INMJOINELBG>k__BackingField;    // 0x0x10
    public string <OOJCAPJBNLA>k__BackingField;    // 0x0x18
    public int? <FGKDLDMIABD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HKKLLODBJAK
//   (not directly referenced by a detected call)
public class HKKLLODBJAK
{
    public int <ICLPLJJFBME>k__BackingField;    // 0x0x10
    public DateTime? <OBCPMDCCKGN>k__BackingField;    // 0x0x18
    public DateTime? <BHBDJGECOMB>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// HLJJEHDMOCA
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class HLJJEHDMOCA
{
    public int <EFHKOPBDPBG>k__BackingField;    // 0x0x10
    public Guid <DAPNPIFAJLE>k__BackingField;    // 0x0x14
    public long <LBLPLOOCDIH>k__BackingField;    // 0x0x28
    public DateTime <PCOKGKENEOO>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// HLNKMLJIBAE
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class HLNKMLJIBAE
{
    public int <KJICOCHEEPG>k__BackingField;    // 0x0x10
    public int <OEEBGLCPCEH>k__BackingField;    // 0x0x14
    public float <FNEIOAFFNNG>k__BackingField;    // 0x0x18
    public int <BDDHEPJAGEF>k__BackingField;    // 0x0x1C
    public int <IDOCIOINLDA>k__BackingField;    // 0x0x20
    public int <ENIOPALGNLF>k__BackingField;    // 0x0x24
    public int <LJLPJMBPLGG>k__BackingField;    // 0x0x28
    public string <MOOKPFCADBF>k__BackingField;    // 0x0x30
    public string <CAEMGGHCDIL>k__BackingField;    // 0x0x38
}
...
// ICJLBMGCKCF
//   (not directly referenced by a detected call)
public class ICJLBMGCKCF
{
    public long <HOKJMMGLFHN>k__BackingField;    // 0x0x10
    public Guid? <DAPNPIFAJLE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IFJELMJDJDM
//   (not directly referenced by a detected call)
public class IFJELMJDJDM
{
    public float <MJGDIJPPJMF>k__BackingField;    // 0x0x10
    public float <EICALDDHHFG>k__BackingField;    // 0x0x14
    public float <OGPDLIHCICB>k__BackingField;    // 0x0x18
    public float <NGNEFMPEOBF>k__BackingField;    // 0x0x1C
    public float <EAJDCPDPKEA>k__BackingField;    // 0x0x20
    public float <ACCBGDLPKOK>k__BackingField;    // 0x0x24
    public float <AMPCBGIBBHE>k__BackingField;    // 0x0x28
    public float <DMGANAONMCA>k__BackingField;    // 0x0x2C
}
...
public class ILLKJGIJMJM
{
    public int FBKBMAOFNCD;    // 0x0x10
    public long FCJCPOBHICP;    // 0x0x18
}
...
// IOFGPFEPBHM
//   (not directly referenced by a detected call)
public class IOFGPFEPBHM
{
    public int <PFBBFLKDEEL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IOFJDDCKIIM
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class IOFJDDCKIIM
{
    public CILJBLJBMIM <PDJKEKNEMEN>k__BackingField;    // 0x0x10
    public List<string> <FEAANHMFOFG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JAFMJMJOFAA
//   (not directly referenced by a detected call)
public class JAFMJMJOFAA
{
    public int <DEPGEOGPJML>k__BackingField;    // 0x0x10
    public DateTime <JAOLLKCBDCE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JBFLLDPKAIL
//   RESPONSE GET    api/makerai/freetrialconfig   [Service.Econ]
public class JBFLLDPKAIL
{
    public TimeSpan <LONBPEMKIKO>k__BackingField;    // 0x0x10
    public TimeSpan <GBMBJHCOCED>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JBMOPCCLKMH
//   (not directly referenced by a detected call)
public class JBMOPCCLKMH
{
    public long <LLAELGGDCNH>k__BackingField;    // 0x0x10
    public long <JMPAOFMJELC>k__BackingField;    // 0x0x18
    public int <HNOBFMFDGBL>k__BackingField;    // 0x0x20
    public DateTime <OOAGOOGOJKK>k__BackingField;    // 0x0x28
    public OGBNOAOONOH <OAOEGOKJNBE>k__BackingField;    // 0x0x30
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class KAMKFCKINLN : ValueType
{
    public OLAHBCMDBEM MOIAGGGLILM;    // 0x0x0
    public ALBLDJNNKOA GMFCCEEPGHD;    // 0x0x10
    public Guid BIJMOEKLIPJ;    // 0x0x20
}
...
public class KDCBAIHLEJJ
{
    public List<LOECGPNIFME> <OMNOANHMHGJ>k__BackingField;    // 0x0x10
    public DJOBOOACBNK? <JDCDCAIKFDM>k__BackingField;    // 0x0x18
    public MEPDKFDNMHJ <PKJFOHICGIJ>k__BackingField;    // 0x0x20
    public bool <PIFGELCOPKE>k__BackingField;    // 0x0x24
    public bool <FHOKMEEPMMH>k__BackingField;    // 0x0x25
    public Guid? <OGOAMGCPJAD>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// KDOFACLBDGB
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class KDOFACLBDGB
{
    public AOPMKNPGONG <INMJOINELBG>k__BackingField;    // 0x0x10
    public int <GBMBJHCOCED>k__BackingField;    // 0x0x14
    public long <HCDLHOIKOMC>k__BackingField;    // 0x0x18
    public bool <IDLMICLAAOJ>k__BackingField;    // 0x0x20
    public string <LDOHABJLAAM>k__BackingField;    // 0x0x28
    public int? <JFOLPKNDFKK>k__BackingField;    // 0x0x30
    public bool <EINCJCFPNNN>k__BackingField;    // 0x0x38
    public bool <EAPFHDOPECI>k__BackingField;    // 0x0x39
    public bool <BGMJKIJEFLM>k__BackingField;    // 0x0x3A
    public bool <KJDPDCIAFEP>k__BackingField;    // 0x0x3B
    public string <FDPPDGNELKO>k__BackingField;    // 0x0x40
    public DateTime? <HKMBAPNKKJO>k__BackingField;    // 0x0x48
    public string <BAOFLOIHJID>k__BackingField;    // 0x0x58
    public bool <BDLIDHPFKPD>k__BackingField;    // 0x0x60
    public string <JGECAHFNPMF>k__BackingField;    // 0x0x68
    public string <MKBJKNKEFMJ>k__BackingField;    // 0x0x70
    public float <PHMLOGGNCGH>k__BackingField;    // 0x0x78
}
...
public class KFAOFDDLNOF
{
    public ELBENOBCHIN <GAJPGFHCBKC>k__BackingField;    // 0x0x10
    public string <FJEOAOPPLFB>k__BackingField;    // 0x0x18
    public string <LOOJJKEIEOA>k__BackingField;    // 0x0x20
    public string <HLPDGBFBPLC>k__BackingField;    // 0x0x28
    public APOBPBFLPKF <MBAJNIGMMBB>k__BackingField;    // 0x0x30
    public string <LFJHBEBNHIF>k__BackingField;    // 0x0x38
    public int <KFPCCBDKFFA>k__BackingField;    // 0x0x40
    public bool <FFDOKHLNHFP>k__BackingField;    // 0x0x44
    public string <KGFPMMJCCPJ>k__BackingField;    // 0x0x48
    public DateTime <OOAGOOGOJKK>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// KHFCMFNHADK
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class KHFCMFNHADK
{
    public int <GBMBJHCOCED>k__BackingField;    // 0x0x10
}
...
public class KKKCEPBMJCH
{
    public Guid? <JNCOMJLDGPD>k__BackingField;    // 0x0x10
    public long? <PEKOIJCGDLJ>k__BackingField;    // 0x0x28
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x38
    public string <JCKFAHGDHID>k__BackingField;    // 0x0x40
    public string <GCIPCPOJEID>k__BackingField;    // 0x0x48
    public ICJLBMGCKCF <KCDCJDNJJBE>k__BackingField;    // 0x0x50
}
...
// KPJECFKINAE
//   (not directly referenced by a detected call)
public class KPJECFKINAE
{
    public bool <ABJKIPHLMKH>k__BackingField;    // 0x0x10
    public NGAKIONNNAB <CAGOEFMCPJA>k__BackingField;    // 0x0x18
    public float <BBJMOBOPPCC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LBMDELHPEOI
//   (not directly referenced by a detected call)
public class LBMDELHPEOI
{
    public INNLOKKDOPN <OAOEGOKJNBE>k__BackingField;    // 0x0x10
    public int? <PPOLEGBODMJ>k__BackingField;    // 0x0x14
    public Guid? <KNJJDBHLCFO>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// LJAJCMLHEJH
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{dKGJDLCFPAB}   [Service.API]
public class LJAJCMLHEJH
{
    public List<PABPINJHJCA> <MAOCJMFOLBM>k__BackingField;    // 0x0x10
    public List<BABBAMKEPKC> <CJDBMIIINAN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LOECGPNIFME
//   (not directly referenced by a detected call)
public class LOECGPNIFME
{
    public LBMDELHPEOI <DNKHAIKNPGH>k__BackingField;    // 0x0x10
    public long <HMDFINOMBMD>k__BackingField;    // 0x0x18
    public GiftItemDTO <DHOMOFBCAJJ>k__BackingField;    // 0x0x20
    public long? <JIMNONGGLKH>k__BackingField;    // 0x0x28
    public int <EJBNJFHAGFN>k__BackingField;    // 0x0x38
}
...
// MFJCMCALHNC
//   (not directly referenced by a detected call)
public class MFJCMCALHNC
{
    public Guid <LBAFIHKDOPJ>k__BackingField;    // 0x0x10
    public Guid <KHAPHKMHNGE>k__BackingField;    // 0x0x20
    public DateTime <JLFFCGPEOJN>k__BackingField;    // 0x0x30
    public List<NGAKIONNNAB> <PIKAJLFMCFH>k__BackingField;    // 0x0x38
}
...
// base   : CMJANDFMBCA
//   (not directly referenced by a detected call)
public class MFNLLKPFCKA : CMJANDFMBCA
{
    public GFAOFPFJBGH IHJHDNAKKAN;    // 0x0x20
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{lJJBBPBGFNK}   [Service.API]
...
public class MHKMIHKKCOG
{
    public NOODFPMAEND <OODCDOHBNAB>k__BackingField;    // 0x0x10
    public AHENKHHJEOD <PDJKEKNEMEN>k__BackingField;    // 0x0x18
    public IOFJDDCKIIM <GAFHGCHOGOC>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MKOJPLIHDDM
//   (not directly referenced by a detected call)
public class MKOJPLIHDDM
{
    public int <BDBCABALIGI>k__BackingField;    // 0x0x10
}
...
// NGAKIONNNAB
//   (not directly referenced by a detected call)
public class NGAKIONNNAB
{
    public int <COJMKMMEMNP>k__BackingField;    // 0x0x10
    public string <LOOJJKEIEOA>k__BackingField;    // 0x0x18
    public string <HLPDGBFBPLC>k__BackingField;    // 0x0x20
    public string <LFJHBEBNHIF>k__BackingField;    // 0x0x28
    public string <CADBKAJEFBK>k__BackingField;    // 0x0x30
    public KAMKFCKINLN? <KGHIDAIEBFE>k__BackingField;    // 0x0x38
    public string <KAOFFBBBKIP>k__BackingField;    // 0x0x70
    public Guid? <PCJFNILHEDA>k__BackingField;    // 0x0x78
    public ELBENOBCHIN? <GAJPGFHCBKC>k__BackingField;    // 0x0x8C
    public string <JCNHIJIBDFN>k__BackingField;    // 0x0x98
    public string <OGPFFIDAELL>k__BackingField;    // 0x0xA0
    public bool <KFBPGOMBDDI>k__BackingField;    // 0x0xA8
    public bool <MBCIPPLFDIG>k__BackingField;    // 0x0xA9
    public bool <KOPFOMFLCDI>k__BackingField;    // 0x0xAA
    public APOBPBFLPKF <MBAJNIGMMBB>k__BackingField;    // 0x0xAC
    public MEPDKFDNMHJ <PKJFOHICGIJ>k__BackingField;    // 0x0xB0
    public int <FIEMNHCEICG>k__BackingField;    // 0x0xB4
    public BHLGFNNJOMO <HEIPILDPOKG>k__BackingField;    // 0x0xB8
    public MDMIDLEFCPL <BJNHPJCFAPJ>k__BackingField;    // 0x0xBC
    public int? <PDPLMPCOGFI>k__BackingField;    // 0x0xC0
    public string <PFGCMHOHFOJ>k__BackingField;    // 0x0xC8
    public int? <KFPCCBDKFFA>k__BackingField;    // 0x0xD0
    public int? <FPGMPLKJDPL>k__BackingField;    // 0x0xD8
    public string <AFIDBOGDAIA>k__BackingField;    // 0x0xE0
}
...
public class NJDDEIBHGAI
{
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x10
    public string <JCKFAHGDHID>k__BackingField;    // 0x0x18
    public int? <HOKJMMGLFHN>k__BackingField;    // 0x0x20
    public JHEMHCNCGNK? <IIHMIMHPFGF>k__BackingField;    // 0x0x28
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{oHCFILHBJON}   [Service.Econ]
public class NKBMIACKMCM
{
    public FGLLAJCJMJC <FCOLGHJHFED>k__BackingField;    // 0x0x10
    public CGAKDMAHHPA <HLKOMFIKLIC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NLOAEGHLOAO
//   RESPONSE PUT    api/roomconsumables   [Service.Econ]
public class NLOAEGHLOAO
{
    public FGLLAJCJMJC <FCOLGHJHFED>k__BackingField;    // 0x0x10
    public CBFPHBMFHHP <FDINBFBAOJK>k__BackingField;    // 0x0x18
}
...
public class NOODFPMAEND : PABPINJHJCA
{
    public List<CJJEGCAENDE> <FEAANHMFOFG>k__BackingField;    // 0x0x98
}
...
public class ODEEIFDGDPM
{
    public List<string> <ODBFBGPCOMH>k__BackingField;    // 0x0x10
    public List<string> <EFOPOFBBDGD>k__BackingField;    // 0x0x18
    public List<string> <MMPJEPIGGMF>k__BackingField;    // 0x0x20
}
...
public class OIFOKDLFOMI
{
    public List<int> <BFPCFOAHKIC>k__BackingField;    // 0x0x10
    public string <HOCBEKCBCLN>k__BackingField;    // 0x0x18
}
...
public class OIKKBNHIIDM
{
    public Guid <EPLGBKBDIKO>k__BackingField;    // 0x0x10
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x20
    public string <GCIPCPOJEID>k__BackingField;    // 0x0x28
    public DateTime <JLFFCGPEOJN>k__BackingField;    // 0x0x30
    public DateTime? <EHIPEGBFLPK>k__BackingField;    // 0x0x38
    public List<MFJCMCALHNC> <LEBLAPELDJB>k__BackingField;    // 0x0x48
}
...
public class OJGOJFMFELK
{
    public RoomKeyResult <FCOLGHJHFED>k__BackingField;    // 0x0x10
    public ELHBNCMACPN <NMAJCGNJNKK>k__BackingField;    // 0x0x18
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class OLAHBCMDBEM : ValueType
{
    public Guid PPIICOOCLEP;    // 0x0x0
}
...
public class OOKEJKIMEIP
{
    public int <GDLIEEDCMOJ>k__BackingField;    // 0x0x10
    public int <CONHADNGPKC>k__BackingField;    // 0x0x14
    public float <HMDOKDKMIFC>k__BackingField;    // 0x0x18
    public float <FLGMLBCONKD>k__BackingField;    // 0x0x1C
    public bool <PGGAPJPFGHN>k__BackingField;    // 0x0x20
    public bool <MCIFMBOOEPF>k__BackingField;    // 0x0x21
    public bool <HOHBOKJBNOI>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// PABPINJHJCA
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class PABPINJHJCA
{
    public long <JMPAOFMJELC>k__BackingField;    // 0x0x10
    public int <DPFCGNOIJNG>k__BackingField;    // 0x0x18
    public long <PEKOIJCGDLJ>k__BackingField;    // 0x0x20
    public long? <FFLBOAOCHPA>k__BackingField;    // 0x0x28
    public long? <LOPOHHICLPI>k__BackingField;    // 0x0x38
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x48
    public string <JCKFAHGDHID>k__BackingField;    // 0x0x50
    public string <GCIPCPOJEID>k__BackingField;    // 0x0x58
    public DateTime <BLNIPGBKNGC>k__BackingField;    // 0x0x60
    public DateTime <PBDOKPEBBDF>k__BackingField;    // 0x0x68
    public int <HBFGIKBFHGI>k__BackingField;    // 0x0x70
    public KHLECHNNNCH <IIHMIMHPFGF>k__BackingField;    // 0x0x74
    public bool <LOEIPMLGCOP>k__BackingField;    // 0x0x78
    public bool <NGGCKDPCDBO>k__BackingField;    // 0x0x79
    public FJHEJMLOMDO <OHEGLHGAKPD>k__BackingField;    // 0x0x7C
    public FJHEJMLOMDO <AJAFJKIAPAD>k__BackingField;    // 0x0x80
    public long? <HDBPCADNCPB>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// PALHLLFJMPJ
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class PALHLLFJMPJ
{
    public long <PEKOIJCGDLJ>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <NAODEINLGPD>k__BackingField;    // 0x0x18
    public NIHMAGKOELM <DHCPLNABFCJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PEPLEJMEKMC
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class PEPLEJMEKMC
{
    public int <EJCCPAAKHOJ>k__BackingField;    // 0x0x10
    public int? <DIJLHFCIHAN>k__BackingField;    // 0x0x14
    public string <EDJGBMLKHDN>k__BackingField;    // 0x0x20
    public string <EMAMHPGMJKP>k__BackingField;    // 0x0x28
}
...
public class PHDHKHJGCAE
{
    public int <LOHNPJBIPNG>k__BackingField;    // 0x0x10
    public HMELGIIDOMP <OAOEGOKJNBE>k__BackingField;    // 0x0x14
    public DJIBBMGBEEA <MOBJEGGPCOM>k__BackingField;    // 0x0x18
    public DJIBBMGBEEA <HKNHGAPJDGE>k__BackingField;    // 0x0x1C
    public DJIBBMGBEEA <APLNNALIILN>k__BackingField;    // 0x0x20
    public byte? <ABIIDMCEAEL>k__BackingField;    // 0x0x24
}
...
// base   : MMNHILFAKMJ
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{kBIIPMNNGMC}   [Service.Econ]
public class PIIBDAFAJCG : MMNHILFAKMJ
{
    public int <HGPKNJEMPDE>k__BackingField;    // 0x0x30
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x38
    public DateTime <JLFFCGPEOJN>k__BackingField;    // 0x0x40
    public DateTime <NCOLCFEHPGO>k__BackingField;    // 0x0x48
    public MEPDKFDNMHJ <PKJFOHICGIJ>k__BackingField;    // 0x0x50
    public CACKOKOICFC <BEPLBEPGHPH>k__BackingField;    // 0x0x58
    public List<AGNHLKICACM> <PDJLGANBMAP>k__BackingField;    // 0x0x60
    public FJKEIAEKCIA <HIENNKKIEEH>k__BackingField;    // 0x0x68
}
...
public class PJIKCPIHMAF : HDEKNGMMHEC
{
    public CGPHONPINFE? <CDACPKAMABK>k__BackingField;    // 0x0x18
    public HLJJEHDMOCA <IBCAOAFCOAA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PMCNFOMBBIG
//   (not directly referenced by a detected call)
public class PMCNFOMBBIG
{
    public float <ELHDDMEKGMO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PNCCHMKGAEN
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.Econ]
public class PNCCHMKGAEN
{
    public List<string> <HPECIGCAOEH>k__BackingField;    // 0x0x10
}
...
public class AddKeepsakeInstanceRequest
{
    public long <PEKOIJCGDLJ>k__BackingField;    // 0x0x10
    public long? <FFLBOAOCHPA>k__BackingField;    // 0x0x18
    public DJAEGFIGJOO <ECIDNGBBILP>k__BackingField;    // 0x0x28
}
...
{
    public JCFHDOIDMDA <PDJKEKNEMEN>k__BackingField;    // 0x0x10
    public string <AMCBENBJKEP>k__BackingField;    // 0x0x18
    public string <KHENDNEKCED>k__BackingField;    // 0x0x20
    public string <DDLHPOCLOAI>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public MEPDKFDNMHJ <CurrencyType>k__BackingField;    // 0x0x18
    public ILINBGFIHDA <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<CBGGCDPLKFA<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <JMPAOFMJELC>k__BackingField;    // 0x0x10
    public long? <KFELCEHOBIM>k__BackingField;    // 0x0x18
}
...
{
    public string <DHGGCCJGIGN>k__BackingField;    // 0x0x10
    public int <MHAANCNHINO>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public CKMEHIJJMLA FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public MDMIDLEFCPL <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public DJAEGFIGJOO <MHHHILPCAEH>k__BackingField;    // 0x0x10
    public string <DJBNDGNGLGI>k__BackingField;    // 0x0x18
    public int <KICKGFBFANL>k__BackingField;    // 0x0x20
    public int <GLOPCAOGCOA>k__BackingField;    // 0x0x24
    public string <INICDEGHICB>k__BackingField;    // 0x0x28
    public string <AMHMLAENDAO>k__BackingField;    // 0x0x30
}
...
{
    public int <EFHKOPBDPBG>k__BackingField;    // 0x0x10
    public Guid <MFHEOFDHNEM>k__BackingField;    // 0x0x14
    public DateTime <CNCOPBHJEIA>k__BackingField;    // 0x0x28
}
...
{
    public bool <DALKPAPLMNC>k__BackingField;    // 0x0x10
    public int <BJJKKKGAEMJ>k__BackingField;    // 0x0x14
    public bool <LEBEAHHPBNN>k__BackingField;    // 0x0x18
}
...
{
    public Guid <MFHEOFDHNEM>k__BackingField;    // 0x0x10
    public DJAEGFIGJOO <LGIIIGKDFBO>k__BackingField;    // 0x0x20
    public int <OJMLDOIBNLN>k__BackingField;    // 0x0x24
    public long <PEKOIJCGDLJ>k__BackingField;    // 0x0x28
    public long? <FFLBOAOCHPA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{cCPDACGIOEI}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <OKKMNLBNFGI>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <FFDBGBPEMJA>k__BackingField;    // 0x0x18
}
...
{
    public long <FMLHDGMNCGN>k__BackingField;    // 0x0x10
    public long <PEKOIJCGDLJ>k__BackingField;    // 0x0x18
    public long <DPCFGHFINLE>k__BackingField;    // 0x0x20
    public LAHFMAFBGDD <OAOEGOKJNBE>k__BackingField;    // 0x0x28
    public int <AADIIKLBECL>k__BackingField;    // 0x0x2C
}
...
{
    public long <PEKOIJCGDLJ>k__BackingField;    // 0x0x10
    public List<Guid> <KJIOEEKMKOD>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <OKKMNLBNFGI>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <FFDBGBPEMJA>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <CMCCFLBGPKC>k__BackingField;    // 0x0x20
}
...
{
    public long <DPCFGHFINLE>k__BackingField;    // 0x0x10
    public long <JEAELJDNMLP>k__BackingField;    // 0x0x18
    public int? <LAMPAMLMHPN>k__BackingField;    // 0x0x20
    public int? <JLEKOAFLCFI>k__BackingField;    // 0x0x28
    public long? <MFFJOCIIECF>k__BackingField;    // 0x0x30
    public long <IEPKNPFEGIM>k__BackingField;    // 0x0x40
    public long <PIBFHCHDAHB>k__BackingField;    // 0x0x48
    public int <LGJCLPKFKGL>k__BackingField;    // 0x0x50
    public LAHFMAFBGDD <AGICOBNKCDF>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <KHFBAEDLNHI>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public MDMIDLEFCPL <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public MJGCNECCLCM creatorAccountRole;    // 0x0x68
...
{
    public PLMJEPIMKBJ <NLMHFHJKJJF>k__BackingField;    // 0x0x10
    public PNHOLMEPIDP <PKFEHFEBJDF>k__BackingField;    // 0x0x14
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x18
    public string <JCKFAHGDHID>k__BackingField;    // 0x0x20
    public bool <PKPPLFNOGCI>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<PLMJEPIMKBJ> <LDOFBADDCFA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{lJJBBPBGFNK}   [Service.API]
public class ProgressionEventDTO
{
    public long <JEAELJDNMLP>k__BackingField;    // 0x0x10
    public string <HBHAFDLOFED>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <OFHKMMLOIAI>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <FLDNOIPMBGL>k__BackingField;    // 0x0x28
    public DateTime <BLNIPGBKNGC>k__BackingField;    // 0x0x30
    public DateTime <PBDOKPEBBDF>k__BackingField;    // 0x0x38
    public DateTime <PGPEABMFHOL>k__BackingField;    // 0x0x40
    public bool <HONGBJBOOBD>k__BackingField;    // 0x0x48
    public int <MDLIONJJEEI>k__BackingField;    // 0x0x4C
    public float <PNFMBKCLEEB>k__BackingField;    // 0x0x50
    public Guid? <PJPGMMNADHO>k__BackingField;    // 0x0x54
    public string <AMGFODEMMFH>k__BackingField;    // 0x0x68
    public string <IHLDELPOKDF>k__BackingField;    // 0x0x70
    public string <OKLPNPICIDN>k__BackingField;    // 0x0x78
    public string <KAGJKBADJGF>k__BackingField;    // 0x0x80
}
...
{
    public Guid <NJDKGLCMPIM>k__BackingField;    // 0x0x10
    public int <HKOPKCIHEAE>k__BackingField;    // 0x0x20
    public int <JAALCDFFNEH>k__BackingField;    // 0x0x24
    public int <NFHHCCEDINM>k__BackingField;    // 0x0x28
    public long <NGCDNEBMKLG>k__BackingField;    // 0x0x30
    public long <APEAFMFIICH>k__BackingField;    // 0x0x38
}
...
{
    public int <EFHKOPBDPBG>k__BackingField;    // 0x0x10
    public int <JNHFCMMBKID>k__BackingField;    // 0x0x14
    public int <KHICHMGPJGJ>k__BackingField;    // 0x0x18
    public int <LAMLPDDAHAB>k__BackingField;    // 0x0x1C
    public int <PEGODBMFJNF>k__BackingField;    // 0x0x20
    public DateTime? <POPCBLDLAHI>k__BackingField;    // 0x0x28
    public int <PHJDFHGGBHB>k__BackingField;    // 0x0x38
}
...
{
    public long <IFDGJICDOHK>k__BackingField;    // 0x0x10
    public int <COJMKMMEMNP>k__BackingField;    // 0x0x18
    public string <GCIPCPOJEID>k__BackingField;    // 0x0x20
    public int <JNHFCMMBKID>k__BackingField;    // 0x0x28
    public int <LEOEAEHGJOI>k__BackingField;    // 0x0x2C
    public bool <LHANPCKGLLA>k__BackingField;    // 0x0x30
    public bool <MANKLFJPEDK>k__BackingField;    // 0x0x31
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public FLIOJOBPLIK <Permission>k__BackingField;    // 0x0x18
    public JHEMHCNCGNK <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<NEHKOJNNPNN<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public NDMGDDALHOJ ReportCategory;    // 0x0x20
}
...
public class ReplicationUnityAssetsDTO
{
    ...
    public List<EMINNKINCCH> <UnityAssets>k__BackingField;    // 0x0x18
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public JHEMHCNCGNK <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public AMFJEFLGECP <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<NFLEPADPHHN> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{lPAFADFLKEN}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool EDBNPGJCOPB;    // 0x0x28
}
...
{
    public PPPKCENJHEK? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public PPPKCENJHEK IJCLLOPKKGM;  // wrapper
...
{
    public KBHKIMMHEIJ PBEICEJAIBD;  // wrapper
...
{
    public ACOCCNDELPE JLPANLJHHFI;  // wrapper
    public int? EDOIENOJEAA;  // wrapper
...
{
    public AOPMKNPGONG JKECJMGGPEK;  // wrapper
...
{
    public byte[] ACJFHCNBBBO;  // wrapper
    public JLDKNAOIHJH BMFMOHDIDHH;  // wrapper
...
{
    public AOPMKNPGONG LFFKEJNHDBI;  // wrapper
    public float? BLMEKNOKPHC;  // wrapper
    public bool? OFDLHGLEHFN;  // wrapper
...
{
    public List<KAMKFCKINLN> desc;  // wrapper
}
...
{
    public MDMIDLEFCPL HILCMKALFIH;  // wrapper
    public MDMIDLEFCPL? IIKDGOEFLKP;  // wrapper
...
{
    public ChatMessage CJIMOMNMAGD;  // wrapper
    public DOIGKNAGIOL LFFKEJNHDBI;  // wrapper
...
{
    public JHEMHCNCGNK CEHECLIMMGG;  // wrapper
    public JLJKPGKKKBO MANOMFOGIGH;  // wrapper
    public MLBELIOHFNF KGPBNAAIBDO;  // wrapper
    public MLBELIOHFNF DJBOBLKOJIE;  // wrapper
...
// api/customAvatarItems/v1/{bCMAFCIPNGO}/appeal  [API POST]
public class CustomAvatarItemsV1BCMAFCIPNGOAppealRequest
{
    public Guid BCMAFCIPNGO;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{kDEIANPCPJI}  [API GET]
public class CustomAvatarItemsV2FromCreatorKDEIANPCPJIRequest
{
...
{
    public BACOABGKBMB GGEDFKLLFPH;  // wrapper
    public MDMIDLEFCPL? EIDJFNAEJOF;  // wrapper
...
{
    public IOFBPILMBEG CLEHCHFAEAC;  // wrapper
...
{
    public int? CLMNEDNIJMP;  // wrapper
    public Guid? BCMAFCIPNGO;  // wrapper
...
// api/keepsakes/{lDPNMFLPJKL}/collect  [API POST]
public class KeepsakesLDPNMFLPJKLCollectRequest
{
    public Guid LDPNMFLPJKL;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public JHKNNJGGLIC INKIBKIOMOC;  // wrapper
    public long? CDFGHIILPDC;  // wrapper
...
{
    public Guid JKBDBKBOKHO;  // wrapper
...
{
    public Guid ILHGHHIPACG;  // wrapper
...
{
    public Guid ILHGHHIPACG;  // wrapper
    public long? EJOBDJEOGPF;  // wrapper
    public byte? LPCNJBGEJJI;  // wrapper
    public int? HFIMNHFKOFL;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid JKBDBKBOKHO;  // wrapper
    public long? KCIAAEBOAON;  // wrapper
    public long? ADABADLFLPA;  // wrapper
    public int? JOKGMMAMPPN;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> MJNKOFMOBDK;  // wrapper
...
{
    public HHMILPHBHMO JLPANLJHHFI;  // wrapper
    public Guid? PEBLEPLNDAF;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public AOPMKNPGONG LFFKEJNHDBI;  // wrapper
    public long? CKBJBILCAFJ;  // wrapper
    public Guid? PALCNBNANLC;  // wrapper
    public int? LKOBGOFEPPB;  // wrapper
...
{
    public Guid KOCCGJLFEBK;  // wrapper
...
{
    public Guid MDNHFANBFKB;  // wrapper
...
{
    public GBJKMKGPCCA EDHHODEJENJ;  // wrapper
}
