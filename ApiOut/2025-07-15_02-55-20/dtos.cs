...
// DTO classes: 274 (plus referenced enums)

// --------------------------------------------------------------------------
// ACLOEPGAIHO
//   (not directly referenced by a detected call)
public class ACLOEPGAIHO
{
    public int <DGPAMKKKMPF>k__BackingField;    // 0x0x10
    public DateTime? <PCIFKMKJFHA>k__BackingField;    // 0x0x18
    public DateTime? <JOCLAPLBNMA>k__BackingField;    // 0x0x28
}
...
public class AFBPNCGMHKH
{
    public int? <MHEGNOIDFME>k__BackingField;    // 0x0x10
    public string <PBMFKGOJKAP>k__BackingField;    // 0x0x18
    public string <AEPJLILHCIK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// AHHBAKNDAEO
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class AHHBAKNDAEO
{
    public List<PLJGNEMBLOB> <GEDNBOBDGEA>k__BackingField;    // 0x0x10
    public MBHMGOCGDJK <JLLJGJJGFEJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AKEGGPHAEEE
//   RESPONSE PUT    api/roomconsumables   [Service.Econ]
public class AKEGGPHAEEE
{
    public HOKDNEMOHJI <FMJMIEDFMIO>k__BackingField;    // 0x0x10
    public ICBEMMDHAEK <HFFEFPAEEFH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AMBHCKHDHOK
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class AMBHCKHDHOK
{
    public List<GNCJAKMJMCH> <LIJEGJFBDAN>k__BackingField;    // 0x0x10
    public string <PGAOFHJJCPN>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{eNBDBKHHGMG}   [Service.API]
...
public class BCGMGOBACJE
{
    public GFPIJGLGFEM <BGBFOAANMDN>k__BackingField;    // 0x0x10
    public MBHMGOCGDJK <JLLJGJJGFEJ>k__BackingField;    // 0x0x18
    public NIBLHPBNBHB <FMNCEAGDGLJ>k__BackingField;    // 0x0x20
}
...
public class BDLGKHIFAGB
{
    public int <FBNAFEOMKNJ>k__BackingField;    // 0x0x10
    public NNLMKMPHAMH <HJOFFHGKNJN>k__BackingField;    // 0x0x14
    public JFMGKKOFCON <JLBCBFLENKI>k__BackingField;    // 0x0x18
    public JFMGKKOFCON <BHNCJGKGMBH>k__BackingField;    // 0x0x1C
    public JFMGKKOFCON <ONLEGEFGEJC>k__BackingField;    // 0x0x20
    public byte? <JNMGOCEAEGF>k__BackingField;    // 0x0x24
}
...
// BJOPDPDAMBE
//   (not directly referenced by a detected call)
public class BJOPDPDAMBE
{
    public bool <FBNBBPMDPAM>k__BackingField;    // 0x0x10
    public KOCKKNOECBG <JEOFEMKOIKJ>k__BackingField;    // 0x0x18
    public float <ALIJNIOPAFF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BOEKLIHFPDF
//   (not directly referenced by a detected call)
public class BOEKLIHFPDF
{
    public string <JGKAMKIMICB>k__BackingField;    // 0x0x10
    public EHHKJACDLND <HJOFFHGKNJN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BPBGJPBCICC
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class BPBGJPBCICC
{
    public List<BOEKLIHFPDF> <JBKGONHFNHO>k__BackingField;    // 0x0x10
}
...
// CAOPECLOJKH
//   (not directly referenced by a detected call)
public class CAOPECLOJKH
{
    public Guid <JAOLMDPIAKG>k__BackingField;    // 0x0x10
    public Guid <CBBGMAPHJCN>k__BackingField;    // 0x0x20
    public DateTime <GINHMHEJCEM>k__BackingField;    // 0x0x30
    public List<KOCKKNOECBG> <ODNLFFMHELJ>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// CBNHKDMGBNL
//   REQUEST  POST   api/relationships/v2/updateVoiceVolume   [Service.API]
public class CBNHKDMGBNL
{
    public int <DIMIPBLKBMD>k__BackingField;    // 0x0x10
    public byte <JNMGOCEAEGF>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// CDMMGLOFGLD
//   (not directly referenced by a detected call)
public class CDMMGLOFGLD
{
    public long <NBKPKCHEMMH>k__BackingField;    // 0x0x10
    public Guid <AHFMMGHNOPC>k__BackingField;    // 0x0x18
    public long <PPKBIKHAMJN>k__BackingField;    // 0x0x28
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x30
    public string <BBFHEBGHEGH>k__BackingField;    // 0x0x38
    public int <HEPHECNDGEL>k__BackingField;    // 0x0x40
    public Guid? <HPPEACLLHEG>k__BackingField;    // 0x0x44
    public DateTime <HBNKGIONILP>k__BackingField;    // 0x0x58
    public string <OLACNGNEBFN>k__BackingField;    // 0x0x60
    public OKDGPFAAALL <HJOFFHGKNJN>k__BackingField;    // 0x0x68
}
...
public class COAFHJKOEDB
{
    public TimeSpan <COIINOAMLOO>k__BackingField;    // 0x0x10
    public TimeSpan <FFIOGHDNBOB>k__BackingField;    // 0x0x18
}
...
// CPICFFHMGGD
//   (not directly referenced by a detected call)
public class CPICFFHMGGD
{
    public DateTime <HBNKGIONILP>k__BackingField;    // 0x0x10
    public string <EHAAODINJBM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CPMINPJNNJK
//   (not directly referenced by a detected call)
public class CPMINPJNNJK
{
    public float <FHPPBEIEBAG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DDPJCBPLFMB
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class DDPJCBPLFMB
{
    public int <NBINDLOPOGM>k__BackingField;    // 0x0x10
    public Guid <MDDMFHEGAEI>k__BackingField;    // 0x0x14
    public long <FLIIKNEBIIB>k__BackingField;    // 0x0x28
    public DateTime <HAHBBFJNICI>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// DFDKEDMIENA
// base   : FOJAKHCKOFN`1<MLJBIFMBPOL>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{hLOOHEHJKFE}   [Service.API]
public class DFDKEDMIENA
{
    // (no instance fields in the metadata dump)
}
...
public class DGGAPOGEALP
{
    public MBHMGOCGDJK <JLLJGJJGFEJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DICDKLCAKMJ
//   (not directly referenced by a detected call)
public class DICDKLCAKMJ
{
    public int <JCMPLPOOIGA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DIIIGMAPHBC
//   (not directly referenced by a detected call)
public class DIIIGMAPHBC
{
    public FPHNDCIJFGN <PBMPFOLBDIO>k__BackingField;    // 0x0x10
    public long <IPOIHMIJPFH>k__BackingField;    // 0x0x18
    public GiftItemDTO <DGMOEPDJFLB>k__BackingField;    // 0x0x20
    public long? <KOMKIADHABN>k__BackingField;    // 0x0x28
    public int <NHCJAACCCHG>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// DMCIEMPJCHJ
//   RESPONSE GET    api/config/v2   [Service.API]
public class DMCIEMPJCHJ
{
    public Dictionary<int, int> <IPPNKACBOBN>k__BackingField;    // 0x0x10
    public List<DOICMINMNOL> <BLHCPJPOIOL>k__BackingField;    // 0x0x18
    public JHNPNBGLILB[][] <MHMGGOFBPOK>k__BackingField;    // 0x0x20
    public GJPAGAMFCAO <MABNNHLPINA>k__BackingField;    // 0x0x28
    public LJGEAJIGEKH <LMBHJODPLFM>k__BackingField;    // 0x0x30
    public NKGGGEKCKOM <MLGAOPMAJBL>k__BackingField;    // 0x0x38
    public DICDKLCAKMJ <CANEFOMNOIP>k__BackingField;    // 0x0x40
    public CPMINPJNNJK <LPKFKCEEAFH>k__BackingField;    // 0x0x48
    public string <HKEKKOBJMMK>k__BackingField;    // 0x0x50
}
...
public class DOCHLJKAOOO
{
    public RoomKeyResult <FMJMIEDFMIO>k__BackingField;    // 0x0x10
    public CDMMGLOFGLD <DDGNHKGIPIG>k__BackingField;    // 0x0x18
}
...
public class EACGKKCCLCD
{
    public long <PPKBIKHAMJN>k__BackingField;    // 0x0x10
    public long? <AEALEABFINO>k__BackingField;    // 0x0x18
    public long? <GKHFPBMAKBD>k__BackingField;    // 0x0x28
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x38
    public string <BBFHEBGHEGH>k__BackingField;    // 0x0x40
    public List<string> <JBKGONHFNHO>k__BackingField;    // 0x0x48
    public string <OLACNGNEBFN>k__BackingField;    // 0x0x50
    public DateTime <BIPMIBELLKD>k__BackingField;    // 0x0x58
    public DateTime <DPAENBDEOEC>k__BackingField;    // 0x0x60
    public GOKIDHJICKB <CNFLKLDINMA>k__BackingField;    // 0x0x68
    public bool <IMOPNMOJJEM>k__BackingField;    // 0x0x6C
    public bool <CAGMPNFAKLE>k__BackingField;    // 0x0x6D
    public NHFMAHDBBOE <KELFBEMDMNF>k__BackingField;    // 0x0x70
    public NHFMAHDBBOE <JBLEBEFPPJC>k__BackingField;    // 0x0x74
}
...
public class EHPMHFPFFHH
{
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x10
    public string <BBFHEBGHEGH>k__BackingField;    // 0x0x18
    public int? <HEPHECNDGEL>k__BackingField;    // 0x0x20
    public MMGGFMEPBPM? <CNFLKLDINMA>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// EKDEPGPJLBI
//   (not directly referenced by a detected call)
public class EKDEPGPJLBI
{
    public GOIKMNKDKIA <FEBPANKIFOF>k__BackingField;    // 0x0x10
    public int <HEPHECNDGEL>k__BackingField;    // 0x0x14
    public ACLOEPGAIHO <BHPPGELONIA>k__BackingField;    // 0x0x18
}
...
// base   : OMANEGDECAE
//   (not directly referenced by a detected call)
public class ELIPMGIJLDI : OMANEGDECAE
{
    public int <GJEJGNHEDGE>k__BackingField;    // 0x0x68
    public List<BJOPDPDAMBE> <KCEMONFGOGC>k__BackingField;    // 0x0x70
    public List<BJOPDPDAMBE> <BHPKLHFNKCN>k__BackingField;    // 0x0x78
    public List<BJOPDPDAMBE> <FKELIIHEJOM>k__BackingField;    // 0x0x80
}
...
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{mNNONNHAEBL}/{lJKDEFDHAID}   [Service.Econ]
public class FFJPIAJKPAH
{
    public GOIKMNKDKIA <FEBPANKIFOF>k__BackingField;    // 0x0x10
    public FKJFLFGCHMP <GBLKLKDIDLF>k__BackingField;    // 0x0x14
    public int <HNHDPMAKHFN>k__BackingField;    // 0x0x18
    public int <FBIIDJOFOBL>k__BackingField;    // 0x0x1C
    public int <NCKENOHEIKC>k__BackingField;    // 0x0x20
    public PBJALOMPBPK <DMFLHIKFKDK>k__BackingField;    // 0x0x24
    public bool <EMNMPNJNNOL>k__BackingField;    // 0x0x28
    public float <DFMLPIBCMDK>k__BackingField;    // 0x0x2C
    public int <FPCEBJBFJBA>k__BackingField;    // 0x0x30
    public bool <CABIENIFAIC>k__BackingField;    // 0x0x34
}
...
// FNKLHEBELKO
//   (not directly referenced by a detected call)
public class FNKLHEBELKO
{
    public long <HEPHECNDGEL>k__BackingField;    // 0x0x10
    public Guid? <MDDMFHEGAEI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FNPKLJCEAAI
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class FNPKLJCEAAI
{
    public long <PPKBIKHAMJN>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <PAIPHHCAHHF>k__BackingField;    // 0x0x18
    public PMIGJNGACEH <EPCMEGKJOOF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FPHNDCIJFGN
//   (not directly referenced by a detected call)
public class FPHNDCIJFGN
{
    public NIMDIABJJID <HJOFFHGKNJN>k__BackingField;    // 0x0x10
    public int? <EEDOFOGDCDD>k__BackingField;    // 0x0x14
    public Guid? <CKKLDIFNGHD>k__BackingField;    // 0x0x1C
}
...
public class GEMFMDGAMFH
{
    public List<string> <CFDFNOMOEKI>k__BackingField;    // 0x0x10
    public List<string> <MADLAEGDDCG>k__BackingField;    // 0x0x18
    public List<string> <ACICAAFOOJF>k__BackingField;    // 0x0x20
}
...
//   (not directly referenced by a detected call)
public class GFJCEPIDMBH : ValueType
{
    public Guid FHNOHJCOOKK;    // 0x0x0
}
...
public class GFPIJGLGFEM : KMKOHDDPKAO
{
    public List<BOEKLIHFPDF> <JBKGONHFNHO>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// GJPAGAMFCAO
//   (not directly referenced by a detected call)
public class GJPAGAMFCAO
{
    public int <LAPNONNCKMA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// GNBLKEHJKEL
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.Econ]
public class GNBLKEHJKEL
{
    public int JOCGPOBHBCE;    // 0x0x10
    public long BGFGGBALBNF;    // 0x0x18
}

// --------------------------------------------------------------------------
// GNCJAKMJMCH
//   (not directly referenced by a detected call)
public class GNCJAKMJMCH
{
    public int <FPDBEPDBFMB>k__BackingField;    // 0x0x10
    public DateTime <HBNKGIONILP>k__BackingField;    // 0x0x18
    public DateTime? <BDPAHPFHFEI>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/progressionEvents/collect/{eNBDBKHHGMG}/{aLPJFENDBGD}   [Service.API]
public class HCGMPGFOLNI
{
    public long? <DIIBPEOGEPM>k__BackingField;    // 0x0x10
    public int <DIMIPBLKBMD>k__BackingField;    // 0x0x20
    public int? <CODMJECABJE>k__BackingField;    // 0x0x24
    public string <CBJMAJCNMLE>k__BackingField;    // 0x0x30
    public CDPDOLEKGHB? <ALILJBBKBFJ>k__BackingField;    // 0x0x38
    public string <HFCEIEJKMBO>k__BackingField;    // 0x0x40
    public Guid? <LCNCDEELPMD>k__BackingField;    // 0x0x48
    public string <BEKPOMMLHEO>k__BackingField;    // 0x0x60
    public string <BDLMEPGBOHN>k__BackingField;    // 0x0x68
    public GOIKMNKDKIA <FEBPANKIFOF>k__BackingField;    // 0x0x70
    public int <FCDJGDOAKHK>k__BackingField;    // 0x0x74
    public int <MHNADKOFOEF>k__BackingField;    // 0x0x78
    public CJOAAGIEEAK <EDMKCMBPHOD>k__BackingField;    // 0x0x7C
    public DOLKMBBGINI <CNJPDMHONND>k__BackingField;    // 0x0x80
    public string <MLFIPLFKJFL>k__BackingField;    // 0x0x88
    public string <BGCABBAKNKL>k__BackingField;    // 0x0x90
    public bool <HFDFIHIKPDC>k__BackingField;    // 0x0x98
    public BIFJBNEHKHJ <BMMIHKMNEJD>k__BackingField;    // 0x0x9C
    public JKDMBCIIAAG <AIMOFNLBFDG>k__BackingField;    // 0x0xA0
    public PJNBHMMJKPO? <FPMIPMEOMPG>k__BackingField;    // 0x0xA4
    public bool <DHJBNAEDNAE>k__BackingField;    // 0x0xAC
    public bool <MCDMAAFBMKE>k__BackingField;    // 0x0xAD
    public string <KMIIHNLABKF>k__BackingField;    // 0x0xB0
    public string <MEOHANMNGJL>k__BackingField;    // 0x0xB8
    public bool <CGHMFGIDDCK>k__BackingField;    // 0x0xC0
    public bool PHIPONHDDHO;    // 0x0xC1
}

// --------------------------------------------------------------------------
// HCIHHHJGOGF
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class HCIHHHJGOGF
{
    public bool <BBJGEHLJGNK>k__BackingField;    // 0x0x10
    public string <BEBCODKKJHG>k__BackingField;    // 0x0x18
    public string <OJFPCMEEHJI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HDCOPHGDMLB
//   REQUEST  POST   api/equipment/v1/update   [Service.Econ]
public class HDCOPHGDMLB
{
    public string <AHDFKMKCBGE>k__BackingField;    // 0x0x10
    public string <NBDEPKJIPOD>k__BackingField;    // 0x0x18
    public string <POMMHOFPBDG>k__BackingField;    // 0x0x20
    public string <BIMACOAPCPO>k__BackingField;    // 0x0x28
    public DOLKMBBGINI <ONJKIMHLEPN>k__BackingField;    // 0x0x30
    public string <EIMNFDOCHDG>k__BackingField;    // 0x0x38
    public bool ALFPCEHPBOB;    // 0x0x40
    public bool <NMKMHJKABHK>k__BackingField;    // 0x0x41
}
...
public class HDEFEOLGGDB
{
    public Guid <ADGPPGAHBAO>k__BackingField;    // 0x0x10
    public long <BMMBMNOEOFG>k__BackingField;    // 0x0x20
}
...
// HHIECEEIJOK
//   (not directly referenced by a detected call)
public class HHIECEEIJOK
{
    public bool <OAIHAIJJPHF>k__BackingField;    // 0x0x10
    public JKDMBCIIAAG <KHHDOAFHFNN>k__BackingField;    // 0x0x14
    public int <FOPMMLOFIKE>k__BackingField;    // 0x0x18
    public DateTime <HAHBBFJNICI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// HIAMPAGFOAB
//   (not directly referenced by a detected call)
public class HIAMPAGFOAB
{
    public int <LAEFDFENDPG>k__BackingField;    // 0x0x10
    public IJKLFCJDNFK <PDBBBFPODDO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HKJFLAAJMCE
//   REQUEST  POST   api/roomkeys/v1/awardbulk   [Service.Econ]
public class HKJFLAAJMCE
{
    public long <NBKPKCHEMMH>k__BackingField;    // 0x0x10
    public int <NBINDLOPOGM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HMHEPNMBCOD
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class HMHEPNMBCOD
{
    public GDOONLPJFCI <NEACLCLGLHF>k__BackingField;    // 0x0x10
    public long <PNHPNHMHFGF>k__BackingField;    // 0x0x18
    public string <BPPDECLBJPA>k__BackingField;    // 0x0x20
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class IBGOJPCJDBO : ValueType
{
    public Guid FHNOHJCOOKK;    // 0x0x0
}
...
// ICBEMMDHAEK
//   (not directly referenced by a detected call)
public class ICBEMMDHAEK
{
    public Guid <AEKOKAFEPEM>k__BackingField;    // 0x0x10
    public int <NBINDLOPOGM>k__BackingField;    // 0x0x20
    public int <IENFOPADEKN>k__BackingField;    // 0x0x24
    public Guid <MOFOGLJFKBO>k__BackingField;    // 0x0x28
    public DateTime <HAHBBFJNICI>k__BackingField;    // 0x0x38
    public JJFDLFBKOGO <CAKIJODIHNJ>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// ICEHJBIHEFJ
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class ICEHJBIHEFJ
{
    public GDOONLPJFCI <NEACLCLGLHF>k__BackingField;    // 0x0x10
    public int <FFIOGHDNBOB>k__BackingField;    // 0x0x14
    public long <MJNJHAHFHNI>k__BackingField;    // 0x0x18
    public bool <PMJKELDCILK>k__BackingField;    // 0x0x20
    public string <NKDKIAGHLGC>k__BackingField;    // 0x0x28
    public int? <BGBFDANNGLH>k__BackingField;    // 0x0x30
    public bool <COBIDODHGKP>k__BackingField;    // 0x0x38
    public bool <EIOHPNPPEEO>k__BackingField;    // 0x0x39
    public bool <KEDOFMCJGAO>k__BackingField;    // 0x0x3A
    public bool <DMMGLNDMGFE>k__BackingField;    // 0x0x3B
    public string <DHLNPIHFHFF>k__BackingField;    // 0x0x40
    public DateTime? <JJFCOOFAKFK>k__BackingField;    // 0x0x48
    public string <KKPHMLKHOIO>k__BackingField;    // 0x0x58
    public bool <AEFJLADBEKL>k__BackingField;    // 0x0x60
    public string <BBIHIAOFFLC>k__BackingField;    // 0x0x68
    public string <DBFICAODBAI>k__BackingField;    // 0x0x70
    public float <EPIDMIBMPFJ>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// IEMKOPDCODG
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class IEMKOPDCODG
{
    public long <PNHPNHMHFGF>k__BackingField;    // 0x0x10
    public CPELKIFFNLL <HJOFFHGKNJN>k__BackingField;    // 0x0x18
}
...
public class IGKNDDAILJJ
{
    public bool <KJOLODJDJGL>k__BackingField;    // 0x0x10
    public string <NKDKIAGHLGC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IINDDGAEDHH
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{oIBGADINDDP}   [Service.API]
public class IINDDGAEDHH
{
    public uint <DIIBPEOGEPM>k__BackingField;    // 0x0x10
    public uint? <DODFDJODFMM>k__BackingField;    // 0x0x14
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x20
    public string <BBFHEBGHEGH>k__BackingField;    // 0x0x28
    public DateTime <NPIEAOMNKHA>k__BackingField;    // 0x0x30
    public DateTime? <DBDMPLJBPIE>k__BackingField;    // 0x0x38
    public bool <DDMEFJPPKDB>k__BackingField;    // 0x0x48
    public List<JJEHFEDLDLP> <LBELEGDECMC>k__BackingField;    // 0x0x50
    public List<string> <JBKGONHFNHO>k__BackingField;    // 0x0x58
    public int <GFLJHPMKPOD>k__BackingField;    // 0x0x60
    public int <EEEDPAKEELL>k__BackingField;    // 0x0x64
    public int <EDGGHKLMHJC>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// IJKLFCJDNFK
//   REQUEST  PUT    api/roomconsumables   [Service.Econ]
public class IJKLFCJDNFK
{
    public Guid? <DDEGALJIEHH>k__BackingField;    // 0x0x10
    public Guid <LCMGPOCCCGD>k__BackingField;    // 0x0x24
}
...
public class IKFPCOIIBBE : PMJCGJKDKDL
{
    public HFEDKPDKJAK? <HGMHGDACEGI>k__BackingField;    // 0x0x18
    public DDPJCBPLFMB <GNAJCHEABPH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// IMOLDMNPJMA
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.Econ]
public class IMOLDMNPJMA
{
    public Guid <MDDMFHEGAEI>k__BackingField;    // 0x0x10
    public int <NBCPFNJCJFP>k__BackingField;    // 0x0x20
    public long <GPEDDKMBBAI>k__BackingField;    // 0x0x28
    public Guid <ADGPPGAHBAO>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// IOOKKCNGNDJ
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.Econ]
public class IOOKKCNGNDJ
{
    public List<string> <OMNPEDPIMED>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JCDEFPCEAPF
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class JCDEFPCEAPF
{
    public int <HLMDPNHDFOH>k__BackingField;    // 0x0x10
    public int <FNOANNBAHGN>k__BackingField;    // 0x0x14
    public float <LCGAIDDJBKE>k__BackingField;    // 0x0x18
    public int <KLIHFEBCNNK>k__BackingField;    // 0x0x1C
    public int <EBBFHEMIGEP>k__BackingField;    // 0x0x20
    public int <MGDJACIKKIN>k__BackingField;    // 0x0x24
    public int <ENJOADGANKC>k__BackingField;    // 0x0x28
    public string <IGBIBBNNFJN>k__BackingField;    // 0x0x30
    public string <HJPBHPDJCMH>k__BackingField;    // 0x0x38
}
...
public class JDOEGKPIFIC
{
    public CDPDOLEKGHB <ALILJBBKBFJ>k__BackingField;    // 0x0x10
    public string <CDAJJCFBIFK>k__BackingField;    // 0x0x18
    public string <POMMHOFPBDG>k__BackingField;    // 0x0x20
    public string <BIMACOAPCPO>k__BackingField;    // 0x0x28
    public DOLKMBBGINI <ONJKIMHLEPN>k__BackingField;    // 0x0x30
    public string <LLIKAFLPDHN>k__BackingField;    // 0x0x38
    public int <LOKFJJHCDLE>k__BackingField;    // 0x0x40
    public bool <NBBINIBHFEP>k__BackingField;    // 0x0x44
    public string <CAHOOCFLJPK>k__BackingField;    // 0x0x48
    public DateTime <HBNKGIONILP>k__BackingField;    // 0x0x50
}
...
// JHNPNBGLILB
//   (not directly referenced by a detected call)
public class JHNPNBGLILB
{
    public ADBIDFDALPH HCANOPCJDCA;    // 0x0x10
    public int FINAAJCCIGO;    // 0x0x14
}

// --------------------------------------------------------------------------
// JIENLJBILJO
// base   : FOJAKHCKOFN`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class JIENLJBILJO
{
    // (no instance fields in the metadata dump)
}
...
public class JJEHFEDLDLP
{
    public string <DIIBPEOGEPM>k__BackingField;    // 0x0x10
    public string <BEBCODKKJHG>k__BackingField;    // 0x0x18
    public string <EIMGFDEFGDD>k__BackingField;    // 0x0x20
    public string <BBFHEBGHEGH>k__BackingField;    // 0x0x28
    public string <PBMFKGOJKAP>k__BackingField;    // 0x0x30
    public JGCJIOBGLFM <FMJMIEDFMIO>k__BackingField;    // 0x0x38
    public List<string> <GIIONLHAMDF>k__BackingField;    // 0x0x40
    public List<string> <JBKGONHFNHO>k__BackingField;    // 0x0x48
    public string <NDIBBFJBJMG>k__BackingField;    // 0x0x50
    public List<CPICFFHMGGD> <FMCOJHBOGDH>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// JJFDLFBKOGO
//   (not directly referenced by a detected call)
public class JJFDLFBKOGO
{
    public Guid <AEKOKAFEPEM>k__BackingField;    // 0x0x10
    public long <PPKBIKHAMJN>k__BackingField;    // 0x0x20
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x28
    public string <BBFHEBGHEGH>k__BackingField;    // 0x0x30
    public string <OLACNGNEBFN>k__BackingField;    // 0x0x38
    public long <HEPHECNDGEL>k__BackingField;    // 0x0x40
    public Guid? <HPPEACLLHEG>k__BackingField;    // 0x0x48
    public DateTime <HAHBBFJNICI>k__BackingField;    // 0x0x60
    public int <GFPAEEHBLFF>k__BackingField;    // 0x0x68
}
...
// base   : LCMMBPEAPDD
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{lKBKOIFJLBC}   [Service.Econ]
public class JKCGBHJMKDM : LCMMBPEAPDD
{
    public int <BJBMJLBOCBK>k__BackingField;    // 0x0x30
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x38
    public DateTime <GINHMHEJCEM>k__BackingField;    // 0x0x40
    public DateTime <JDMJPOJDLCK>k__BackingField;    // 0x0x48
    public GOIKMNKDKIA <FEBPANKIFOF>k__BackingField;    // 0x0x50
    public OMANEGDECAE <FJBGKBHABIN>k__BackingField;    // 0x0x58
    public List<ELIPMGIJLDI> <MDNIBHOICGH>k__BackingField;    // 0x0x60
    public HHIECEEIJOK <NIMGEMGHHOP>k__BackingField;    // 0x0x68
}
...
public class JLCMOHJOEPJ
{
    public int <LGPLLCJELLK>k__BackingField;    // 0x0x10
    public int <PEAIJELOFFF>k__BackingField;    // 0x0x14
    public float <DEGHOHLEFBD>k__BackingField;    // 0x0x18
    public float <FKALLPPJDBN>k__BackingField;    // 0x0x1C
    public bool <HHKHCCFBGEK>k__BackingField;    // 0x0x20
    public bool <NIJOFAKKJFE>k__BackingField;    // 0x0x21
    public bool <NMKMHJKABHK>k__BackingField;    // 0x0x22
}
...
public class JNMPFELHKMO
{
    public FPPCOPCDJLD <NEACLCLGLHF>k__BackingField;    // 0x0x10
    public string <BPPDECLBJPA>k__BackingField;    // 0x0x18
    public int? <FEOABGBMIFO>k__BackingField;    // 0x0x20
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{fKAPDDOFNBF}   [Service.Econ]
public class JPFBPCEFNAF
{
    public HOKDNEMOHJI <FMJMIEDFMIO>k__BackingField;    // 0x0x10
    public JJFDLFBKOGO <CAKIJODIHNJ>k__BackingField;    // 0x0x18
}
...
public class KCPHGBCJMEM : PMJCGJKDKDL
{
    public AEKCHBEELBD? <HGMHGDACEGI>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <KDKLEPMEJFO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KEAKOHPKFKM
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class KEAKOHPKFKM
{
    public Guid? <AEKOKAFEPEM>k__BackingField;    // 0x0x10
    public long? <PPKBIKHAMJN>k__BackingField;    // 0x0x28
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x38
    public string <BBFHEBGHEGH>k__BackingField;    // 0x0x40
    public string <OLACNGNEBFN>k__BackingField;    // 0x0x48
    public FNKLHEBELKO <CLMKNIPFKHH>k__BackingField;    // 0x0x50
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class KJEPDDGGDOL : ValueType
{
    public IBGOJPCJDBO HFNMDJDALHB;    // 0x0x0
    public GFJCEPIDMBH KGNKNIDPGNH;    // 0x0x10
    public Guid MKBGABGDBKJ;    // 0x0x20
}

// --------------------------------------------------------------------------
// KLNGDKMDACE
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class KLNGDKMDACE
{
    public int <FFIOGHDNBOB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KLPHBFGBAFH
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.API]
public class KLPHBFGBAFH
{
    public List<long> <MGHNPMDEIAN>k__BackingField;    // 0x0x10
    public DGGACNPGEMC <HJOFFHGKNJN>k__BackingField;    // 0x0x18
    public string <LGGAEDBMDMI>k__BackingField;    // 0x0x20
    public long? <PPKBIKHAMJN>k__BackingField;    // 0x0x28
}
...
// base   : NEJPHGMKHHJ
//   (not directly referenced by a detected call)
public class KMDIFDONDBL : NEJPHGMKHHJ
{
    public GDMOJHPJMIB OAMNPKONCPO;    // 0x0x20
}

// --------------------------------------------------------------------------
// KMDKPFBMEHB
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class KMDKPFBMEHB
{
    public Dictionary<Guid, HIAMPAGFOAB> <HNBFEKDNLBI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KMKOHDDPKAO
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class KMKOHDDPKAO
{
    public long <PNHPNHMHFGF>k__BackingField;    // 0x0x10
    public int <ONGEBFLCLKD>k__BackingField;    // 0x0x18
    public long <PPKBIKHAMJN>k__BackingField;    // 0x0x20
    public long? <AEALEABFINO>k__BackingField;    // 0x0x28
    public long? <GKHFPBMAKBD>k__BackingField;    // 0x0x38
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x48
    public string <BBFHEBGHEGH>k__BackingField;    // 0x0x50
    public string <OLACNGNEBFN>k__BackingField;    // 0x0x58
    public DateTime <BIPMIBELLKD>k__BackingField;    // 0x0x60
    public DateTime <DPAENBDEOEC>k__BackingField;    // 0x0x68
    public int <EOPGAIAKIOB>k__BackingField;    // 0x0x70
    public GOKIDHJICKB <CNFLKLDINMA>k__BackingField;    // 0x0x74
    public bool <IMOPNMOJJEM>k__BackingField;    // 0x0x78
    public bool <CAGMPNFAKLE>k__BackingField;    // 0x0x79
    public NHFMAHDBBOE <KELFBEMDMNF>k__BackingField;    // 0x0x7C
    public NHFMAHDBBOE <JBLEBEFPPJC>k__BackingField;    // 0x0x80
    public long? <MJMCGMBIHHL>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// KOCKKNOECBG
//   (not directly referenced by a detected call)
public class KOCKKNOECBG
{
    public int <AJNGCHAHCPG>k__BackingField;    // 0x0x10
    public string <POMMHOFPBDG>k__BackingField;    // 0x0x18
    public string <BIMACOAPCPO>k__BackingField;    // 0x0x20
    public string <LLIKAFLPDHN>k__BackingField;    // 0x0x28
    public string <CBJMAJCNMLE>k__BackingField;    // 0x0x30
    public KJEPDDGGDOL? <LOEIIEHMJNE>k__BackingField;    // 0x0x38
    public string <HFCEIEJKMBO>k__BackingField;    // 0x0x70
    public Guid? <LCNCDEELPMD>k__BackingField;    // 0x0x78
    public CDPDOLEKGHB? <ALILJBBKBFJ>k__BackingField;    // 0x0x8C
    public string <BEKPOMMLHEO>k__BackingField;    // 0x0x98
    public string <BDLMEPGBOHN>k__BackingField;    // 0x0xA0
    public bool <LABELOPJJLG>k__BackingField;    // 0x0xA8
    public bool <LGAFPHKFLLJ>k__BackingField;    // 0x0xA9
    public bool <ENBGNOOAPLP>k__BackingField;    // 0x0xAA
    public DOLKMBBGINI <ONJKIMHLEPN>k__BackingField;    // 0x0xAC
    public GOIKMNKDKIA <FEBPANKIFOF>k__BackingField;    // 0x0xB0
    public int <FCDJGDOAKHK>k__BackingField;    // 0x0xB4
    public CLECBIALPEN <EKFFIJBOGBP>k__BackingField;    // 0x0xB8
    public CJOAAGIEEAK <EKLKMKNFGEB>k__BackingField;    // 0x0xBC
    public int? <BNDMLDLKOHL>k__BackingField;    // 0x0xC0
    public string <EDNODNLJCHA>k__BackingField;    // 0x0xC8
    public int? <LOKFJJHCDLE>k__BackingField;    // 0x0xD0
    public int? <OPNKBCCAFHJ>k__BackingField;    // 0x0xD8
    public string <EIMNFDOCHDG>k__BackingField;    // 0x0xE0
}
...
public class LFBLBCFHIBJ
{
    public int <PEAIJELOFFF>k__BackingField;    // 0x0x10
    public bool <HHKHCCFBGEK>k__BackingField;    // 0x0x14
    public DateTime <JFPLMGKHFFP>k__BackingField;    // 0x0x18
    public bool <NADHGMCLMME>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LHLOGCDKOHG
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class LHLOGCDKOHG
{
    public List<int> <HAKHPGLOKKI>k__BackingField;    // 0x0x10
    public string <PGAOFHJJCPN>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{cOGDOHLDAFA}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{fIKJJNJEAPJ}   [Service.API]
...
public class LHNADKNCFMA
{
    public bool <KJOLODJDJGL>k__BackingField;    // 0x0x10
    public string <OILKAKBDBEE>k__BackingField;    // 0x0x18
    public string <BLHFELJKMMP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LJGEAJIGEKH
//   (not directly referenced by a detected call)
public class LJGEAJIGEKH
{
    public float <LAECDFNEGMG>k__BackingField;    // 0x0x10
    public float <ACCJAPMFPOE>k__BackingField;    // 0x0x14
    public float <KGFLKCNKLPL>k__BackingField;    // 0x0x18
    public float <DNEEOFOJCDL>k__BackingField;    // 0x0x1C
    public float <BGAIEPOGAGL>k__BackingField;    // 0x0x20
    public float <GJOBIKGACOD>k__BackingField;    // 0x0x24
    public float <PCNBOAIHIJH>k__BackingField;    // 0x0x28
    public float <DMJDFDPAIEN>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// LOGPILJAJNH
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Auth]
public class LOGPILJAJNH
{
    public Guid <CPCDGHEMMJA>k__BackingField;    // 0x0x10
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x20
    public string <OLACNGNEBFN>k__BackingField;    // 0x0x28
    public DateTime <GINHMHEJCEM>k__BackingField;    // 0x0x30
    public DateTime? <NHFBBLCHJAI>k__BackingField;    // 0x0x38
    public List<CAOPECLOJKH> <CDCFCJCBPKB>k__BackingField;    // 0x0x48
}
...
public class MGNLECGKMAC
{
    public IJKLFCJDNFK <PDBBBFPODDO>k__BackingField;    // 0x0x10
    public FNKLHEBELKO <EFGLDOMODPF>k__BackingField;    // 0x0x18
    public int <LAEFDFENDPG>k__BackingField;    // 0x0x20
}
...
public class NIBLHPBNBHB
{
    public OIEEFONCNDK <JLLJGJJGFEJ>k__BackingField;    // 0x0x10
    public List<string> <JBKGONHFNHO>k__BackingField;    // 0x0x18
}
...
// NKGGGEKCKOM
//   (not directly referenced by a detected call)
public class NKGGGEKCKOM
{
    public int <GPDBJNFPIGO>k__BackingField;    // 0x0x10
    public DateTime <DHBEFNOJCKF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// NNJCGFMALFF
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class NNJCGFMALFF
{
    public List<KMKOHDDPKAO> <PJJMILMKOFM>k__BackingField;    // 0x0x10
    public string <PGAOFHJJCPN>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/playerevents/v1/all/{iOIEACLIHPH}   [Service.API]
public class OFDIDCMKJCF
{
    public List<KMKOHDDPKAO> <LDCNHNMKDFF>k__BackingField;    // 0x0x10
    public List<PLOPKFFNHIB> <CLCCADFNGMG>k__BackingField;    // 0x0x18
}
...
// OJKKHIFGNKD
//   (not directly referenced by a detected call)
public class OJKKHIFGNKD
{
    public long <MHKCHABIIGN>k__BackingField;    // 0x0x10
    public long <PNHPNHMHFGF>k__BackingField;    // 0x0x18
    public int <DIMIPBLKBMD>k__BackingField;    // 0x0x20
    public DateTime <HBNKGIONILP>k__BackingField;    // 0x0x28
    public CPELKIFFNLL <HJOFFHGKNJN>k__BackingField;    // 0x0x30
}
...
// OMANEGDECAE
//   (not directly referenced by a detected call)
public class OMANEGDECAE
{
    public int <COFJNJBMEGD>k__BackingField;    // 0x0x10
    public IAPBAEJBJLK <HJOFFHGKNJN>k__BackingField;    // 0x0x14
    public List<EKDEPGPJLBI> <KGNONNAIOBO>k__BackingField;    // 0x0x18
    public List<EKDEPGPJLBI> <HCMNGNIECIF>k__BackingField;    // 0x0x20
    public bool <EIIKADFDGBO>k__BackingField;    // 0x0x28
    public DateTime? <PNNFDDIPCBM>k__BackingField;    // 0x0x30
    public DateTime? <JEHIPILCNIM>k__BackingField;    // 0x0x40
    public DateTime? <CMOHFIFPPIJ>k__BackingField;    // 0x0x50
    public bool <ONFPFLFPNIK>k__BackingField;    // 0x0x60
    public bool <EHMBJEMCFFP>k__BackingField;    // 0x0x61
}

// --------------------------------------------------------------------------
// ONHGPEEFPOA
//   REQUEST  POST   api/items/bulkpurchase   [Service.Commerce]
public class ONHGPEEFPOA
{
    public List<DIIIGMAPHBC> <BBKHLMFFCIN>k__BackingField;    // 0x0x10
    public BDNNOMAEPNN? <HGNPNDPPLPJ>k__BackingField;    // 0x0x18
    public GOIKMNKDKIA <FEBPANKIFOF>k__BackingField;    // 0x0x20
    public bool <MIHGFMBDCLF>k__BackingField;    // 0x0x24
    public bool <HPHNKDGEAKM>k__BackingField;    // 0x0x25
    public Guid? <BIFMDDLHFGP>k__BackingField;    // 0x0x28
}
...
public class PHELMFGNAKB
{
    public IReadOnlyList<KMDIFDONDBL> <HOFOKPIAEPJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PJFOOLMJJIE
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class PJFOOLMJJIE
{
    public int <FJOFAIJBJGD>k__BackingField;    // 0x0x10
    public int? <MFJHLNDLPHN>k__BackingField;    // 0x0x14
    public string <NAPDAJAGBGM>k__BackingField;    // 0x0x20
    public string <DGPKEEFJNNE>k__BackingField;    // 0x0x28
}
...
public class PLBLPOHDCDB
{
    public Dictionary<Guid, AKEGGPHAEEE> <LILBMOEPMIL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PLJGNEMBLOB
//   (not directly referenced by a detected call)
public class PLJGNEMBLOB
{
    public int <BHAAOKNLPGH>k__BackingField;    // 0x0x10
    public MBHMGOCGDJK <JLLJGJJGFEJ>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// PLOPKFFNHIB
//   (not directly referenced by a detected call)
public class PLOPKFFNHIB
{
    public KMKOHDDPKAO <BGBFOAANMDN>k__BackingField;    // 0x0x10
    public OJKKHIFGNKD <MMPIFOFGKPL>k__BackingField;    // 0x0x18
}
...
public class AddKeepsakeInstanceRequest
{
    public long <PPKBIKHAMJN>k__BackingField;    // 0x0x10
    public long? <AEALEABFINO>k__BackingField;    // 0x0x18
    public HINJKNFEFAE <NHKAFKFKAOL>k__BackingField;    // 0x0x28
}
...
{
    public COAMEELAPHD <JLLJGJJGFEJ>k__BackingField;    // 0x0x10
    public string <PBPPJKDMGCE>k__BackingField;    // 0x0x18
    public string <CLMHIKKBJIE>k__BackingField;    // 0x0x20
    public string <HPKAGGGLBDM>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public GOIKMNKDKIA <CurrencyType>k__BackingField;    // 0x0x18
    public PJNBHMMJKPO <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<LBBMGKILIBB<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <PNHPNHMHFGF>k__BackingField;    // 0x0x10
    public long? <PEGKODJLNJM>k__BackingField;    // 0x0x18
}
...
{
    public string <OOIKKKOJCFC>k__BackingField;    // 0x0x10
    public int <NDBNJELOAHI>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public BOHCEEMLJMK FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public CJOAAGIEEAK <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public HINJKNFEFAE <ANMMBKMDMDC>k__BackingField;    // 0x0x10
    public string <EBGJJOOPCCJ>k__BackingField;    // 0x0x18
    public int <PGCHMNCMDGE>k__BackingField;    // 0x0x20
    public int <PCDNAAAMBOC>k__BackingField;    // 0x0x24
    public string <PKAEFJKEKPN>k__BackingField;    // 0x0x28
    public string <NMCKKBNBAKD>k__BackingField;    // 0x0x30
}
...
{
    public int <NBINDLOPOGM>k__BackingField;    // 0x0x10
    public Guid <HDIPMAHFDIA>k__BackingField;    // 0x0x14
    public DateTime <MHAPPKDHMKF>k__BackingField;    // 0x0x28
}
...
{
    public bool <BPMNIOPBNDA>k__BackingField;    // 0x0x10
    public int <AJHJHILNPJJ>k__BackingField;    // 0x0x14
    public bool <IAOLCBNHECH>k__BackingField;    // 0x0x18
}
...
{
    public Guid <HDIPMAHFDIA>k__BackingField;    // 0x0x10
    public HINJKNFEFAE <JLOOBJGAHCK>k__BackingField;    // 0x0x20
    public int <BILAFPJNGPD>k__BackingField;    // 0x0x24
    public long <PPKBIKHAMJN>k__BackingField;    // 0x0x28
    public long? <AEALEABFINO>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{kCMBLIMEDJJ}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <NHGIDOCFLOA>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <MEBMAPOMKHC>k__BackingField;    // 0x0x18
}
...
{
    public long <LJLLGHMGIBP>k__BackingField;    // 0x0x10
    public long <PPKBIKHAMJN>k__BackingField;    // 0x0x18
    public long <AACLFKOAMMA>k__BackingField;    // 0x0x20
    public BPBBJBLDIPA <HJOFFHGKNJN>k__BackingField;    // 0x0x28
    public int <BGJOIPOJMCN>k__BackingField;    // 0x0x2C
}
...
{
    public long <PPKBIKHAMJN>k__BackingField;    // 0x0x10
    public List<Guid> <HJGKCDKHFIM>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <NHGIDOCFLOA>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <MEBMAPOMKHC>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <EOBDBKDNPJN>k__BackingField;    // 0x0x20
}
...
{
    public long <AACLFKOAMMA>k__BackingField;    // 0x0x10
    public long <PNMODAGGIHA>k__BackingField;    // 0x0x18
    public int? <IBPODFIFMON>k__BackingField;    // 0x0x20
    public int? <EOLACGHAMMB>k__BackingField;    // 0x0x28
    public long? <FLOHFFNJJOK>k__BackingField;    // 0x0x30
    public long <JMALAPKEAHP>k__BackingField;    // 0x0x40
    public long <BODNAAAPLOG>k__BackingField;    // 0x0x48
    public int <CNNDENNKCBE>k__BackingField;    // 0x0x50
    public BPBBJBLDIPA <FCLKPPFBJOA>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <HFCICBEGLEJ>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public CJOAAGIEEAK <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public NAEHKMDNNHC creatorAccountRole;    // 0x0x68
...
{
    public JGAOJFMNDKM <MLFKDNBOLLG>k__BackingField;    // 0x0x10
    public LMPBCBHGIOI <JEBOGLANPOC>k__BackingField;    // 0x0x14
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x18
    public string <BBFHEBGHEGH>k__BackingField;    // 0x0x20
    public bool <GAPOMMGKPPM>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<JGAOJFMNDKM> <AKBADDBKBDL>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{eNBDBKHHGMG}   [Service.API]
public class ProgressionEventDTO
{
    public long <PNMODAGGIHA>k__BackingField;    // 0x0x10
    public string <DGKIAOCFFFC>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <FKELIIHEJOM>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <LJPMFJGDBOF>k__BackingField;    // 0x0x28
    public DateTime <BIPMIBELLKD>k__BackingField;    // 0x0x30
    public DateTime <DPAENBDEOEC>k__BackingField;    // 0x0x38
    public DateTime <BOKOBKNCDIC>k__BackingField;    // 0x0x40
    public bool <ODBNIICNPME>k__BackingField;    // 0x0x48
    public int <GMMNBNCJKGI>k__BackingField;    // 0x0x4C
    public float <AHBIPIOCBOK>k__BackingField;    // 0x0x50
    public Guid? <HDKGOFKACBD>k__BackingField;    // 0x0x54
    public string <NLFMBPMMPIB>k__BackingField;    // 0x0x68
    public string <PDJAJPDJLKB>k__BackingField;    // 0x0x70
    public string <PDNLOFHEBEA>k__BackingField;    // 0x0x78
    public string <BAIIECIIGKI>k__BackingField;    // 0x0x80
}
...
{
    public Guid <BPDOGFEDLOK>k__BackingField;    // 0x0x10
    public int <BJBECBLBNOK>k__BackingField;    // 0x0x20
    public int <HAFPHOMHANO>k__BackingField;    // 0x0x24
    public int <DCJILDLKOLK>k__BackingField;    // 0x0x28
    public long <MGOGDEKHDMO>k__BackingField;    // 0x0x30
    public long <MIBDCMADGKI>k__BackingField;    // 0x0x38
}
...
{
    public int <NBINDLOPOGM>k__BackingField;    // 0x0x10
    public int <MHNADKOFOEF>k__BackingField;    // 0x0x14
    public int <LFOAEGEKOIC>k__BackingField;    // 0x0x18
    public int <MGKFMEOFMAP>k__BackingField;    // 0x0x1C
    public int <AODONCOLCKG>k__BackingField;    // 0x0x20
    public DateTime? <CFHEHCFMGBN>k__BackingField;    // 0x0x28
    public int <JMDLHJBENAK>k__BackingField;    // 0x0x38
}
...
{
    public long <BKNAJJFHFOJ>k__BackingField;    // 0x0x10
    public int <AJNGCHAHCPG>k__BackingField;    // 0x0x18
    public string <OLACNGNEBFN>k__BackingField;    // 0x0x20
    public int <MHNADKOFOEF>k__BackingField;    // 0x0x28
    public int <JJMCMGLJBOJ>k__BackingField;    // 0x0x2C
    public bool <LOCHNFLKINH>k__BackingField;    // 0x0x30
    public bool <AIMFJFICENL>k__BackingField;    // 0x0x31
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public GNKFNDCHLOH <Permission>k__BackingField;    // 0x0x18
    public MMGGFMEPBPM <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<NBOFLANCOLJ<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public OKLMABCKDNC ReportCategory;    // 0x0x20
}
...
public class ReplicationUnityAssetsDTO
{
    ...
    public List<BFLLMGFLMKK> <UnityAssets>k__BackingField;    // 0x0x18
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public MMGGFMEPBPM <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public BMGDOKCGKDP <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<MLPEAEFOBCK> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{nJEHHJJEAOL}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool BBOPEJGMCLG;    // 0x0x28
}

// --------------------------------------------------------------------------
// RecRoom.MakerAI.Services.TerrainResponse
//   (not directly referenced by a detected call)
...
{
    public LANBDCIBBMI? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public LANBDCIBBMI IFPJGHMCHJE;  // wrapper
...
{
    public BIFJBNEHKHJ LPCDHJOPEEN;  // wrapper
...
{
    public CBCMKKCLPIB MDCDODCGNEK;  // wrapper
    public int? HMCOKFLKCNF;  // wrapper
...
{
    public GDOONLPJFCI KJPLFPDIOFO;  // wrapper
...
{
    public byte[] CBCNBAPLLJM;  // wrapper
    public HOBLMPOAKAI NJJMHMHCGJH;  // wrapper
...
{
    public GDOONLPJFCI CMCHODOKHFP;  // wrapper
    public float? MEPAGMDMELA;  // wrapper
    public bool? FJKMIKDGNFF;  // wrapper
...
{
    public List<KJEPDDGGDOL> desc;  // wrapper
}
...
{
    public CJOAAGIEEAK PBHLPKLGFAP;  // wrapper
    public CJOAAGIEEAK? NKKKLHBOOMF;  // wrapper
...
{
    public ChatMessage HLMEMBFCHLD;  // wrapper
    public KLPHMMGLEHN CMCHODOKHFP;  // wrapper
...
{
    public MMGGFMEPBPM HEMBOCGAKIC;  // wrapper
    public NHLFJDCHHHC OBLCNDIEHEG;  // wrapper
    public HHMFBLJHDNB MHMLCHOJDFL;  // wrapper
    public HHMFBLJHDNB KCDIDGLNJAH;  // wrapper
...
// api/customAvatarItems/v1/{cOGDOHLDAFA}/appeal  [API POST]
public class CustomAvatarItemsV1COGDOHLDAFAAppealRequest
{
    public Guid COGDOHLDAFA;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{hLOOHEHJKFE}  [API GET]
public class CustomAvatarItemsV2FromCreatorHLOOHEHJKFERequest
{
...
{
    public HELFNHBJMKM NEECAHMCOCK;  // wrapper
    public CJOAAGIEEAK? PFOBBGPCOEJ;  // wrapper
...
{
    public DHFLCFDGAAC KLPPAMBBICD;  // wrapper
...
{
    public int? PPHKGAAJGGM;  // wrapper
    public Guid? COGDOHLDAFA;  // wrapper
...
// api/keepsakes/{fIKJJNJEAPJ}/collect  [API POST]
public class KeepsakesFIKJJNJEAPJCollectRequest
{
    public Guid FIKJJNJEAPJ;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public DGGACNPGEMC COFHLKAKKDJ;  // wrapper
    public long? MJILNJAJHOI;  // wrapper
...
{
    public AEKCHBEELBD PIMGMADKJGB;  // wrapper
    public Guid ABHHHGDPOIF;  // wrapper
...
{
    public Guid INIEKEMGIAF;  // wrapper
...
{
    public Guid INIEKEMGIAF;  // wrapper
    public long? NFGPNILHDNB;  // wrapper
    public byte? MIEJLCKINFM;  // wrapper
    public int? MGBNCENPLKH;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid ABHHHGDPOIF;  // wrapper
    public long? BEAONNGPBDP;  // wrapper
    public long? JHELJMBCIFN;  // wrapper
    public int? ABBEBFOMLDM;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> KCHMACEBLIA;  // wrapper
...
{
    public OKDGPFAAALL MDCDODCGNEK;  // wrapper
    public Guid? BNNJLGCLHHO;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public GDOONLPJFCI CMCHODOKHFP;  // wrapper
    public long? HIHAIPPHCGN;  // wrapper
    public Guid? LIAKAJBGNHD;  // wrapper
    public int? AFJPOCNEGPG;  // wrapper
...
{
    public Guid EABPKNHPODO;  // wrapper
...
{
    public Guid ONIOLEKDKEC;  // wrapper
...
{
    public JGCJIOBGLFM KJKDNOKCENA;  // wrapper
}
