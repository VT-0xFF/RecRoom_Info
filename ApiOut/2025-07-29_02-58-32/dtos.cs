...
// DTO classes: 276 (plus referenced enums)
...
public class AEOCLEJNBGA
{
    public long <KIPHKAKHFDA>k__BackingField;    // 0x0x10
    public int <LNDJLFFBDIJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AFKLPIBCEHF
// base   : JOOJCLGELGF`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class AFKLPIBCEHF
{
...
public class AHMGJOJNNHE
{
    public int DIJMFFFNHIF;    // 0x0x10
    public long FHODKGKPDNP;    // 0x0x18
}

// --------------------------------------------------------------------------
// AJMDKHEGLAC
//   (not directly referenced by a detected call)
public class AJMDKHEGLAC
{
    public string <LCIEKBJBMEP>k__BackingField;    // 0x0x10
    public OOEFJEHICNE <JBBMNCGGKJP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ALHFPLNNGIB
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class ALHFPLNNGIB
{
    public int <HLIBPMPIMCF>k__BackingField;    // 0x0x10
    public int? <FKFHOJGDNOD>k__BackingField;    // 0x0x14
    public string <NJJAMPDBBDA>k__BackingField;    // 0x0x20
    public string <FOMANMOFMAH>k__BackingField;    // 0x0x28
}
...
//   (not directly referenced by a detected call)
public class ANBOJIKIHHJ : ValueType
{
    public BKDCIKGEGPK DPAFLFCIDHO;    // 0x0x0
    public NOKNCAGJAEE EKDOBFKODKM;    // 0x0x10
    public Guid FLMOBMMCAHM;    // 0x0x20
}

// --------------------------------------------------------------------------
// AOHAGPLPIGA
//   REQUEST  POST   api/relationships/v2/updateVoiceVolume   [Service.API]
public class AOHAGPLPIGA
{
    public int <JAIKPBAJOHJ>k__BackingField;    // 0x0x10
    public byte <MIOBMKDCAIE>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// APFJOMOFCIJ
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class APFJOMOFCIJ
{
    public List<OEKHEJIMMNK> <BFMCIJJIKHM>k__BackingField;    // 0x0x10
    public string <JINAEKBBCOB>k__BackingField;    // 0x0x18
}
...
//   RESPONSE GET    api/storefronts/v1/season/{nMLLEDFBKMM}   [Service.Econ]
public class BFMGFNCGACP : FBOODGEELKA
{
    public int <GCIBDKJNDOI>k__BackingField;    // 0x0x30
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x38
    public DateTime <LNOGNPOIIPM>k__BackingField;    // 0x0x40
    public DateTime <JHPHDGGICOI>k__BackingField;    // 0x0x48
    public OICCDKGHIEL <KCLAGJDNIEE>k__BackingField;    // 0x0x50
    public KCGACACFGKB <IIIHGMKDBAP>k__BackingField;    // 0x0x58
    public List<NDJJHBEABFE> <LGOPMOHEPFJ>k__BackingField;    // 0x0x60
    public LIOKHHNODBA <HKNENGAEDLG>k__BackingField;    // 0x0x68
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class BKDCIKGEGPK : ValueType
{
    public Guid DNLDANFOOJK;    // 0x0x0
}
...
// CLKCEBNNLOF
//   (not directly referenced by a detected call)
public class CLKCEBNNLOF
{
    public int <LEMEOALNKJA>k__BackingField;    // 0x0x10
    public DateTime? <KOCAJLOPCLH>k__BackingField;    // 0x0x18
    public DateTime? <FNIDBKGPPMA>k__BackingField;    // 0x0x28
}
...
public class CNKDAODNIBE
{
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x10
    public string <LBLCOJFDOOG>k__BackingField;    // 0x0x18
    public int? <LLDGFBLOBIC>k__BackingField;    // 0x0x20
    public MNNPGENBKHF? <DGAKLAKPDFP>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// DAPKCJNGEHJ
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class DAPKCJNGEHJ
{
    public Guid? <NGOFDMJLGOO>k__BackingField;    // 0x0x10
    public long? <JJIAHKJCFKB>k__BackingField;    // 0x0x28
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x38
    public string <LBLCOJFDOOG>k__BackingField;    // 0x0x40
    public string <EHFGGPJFBKH>k__BackingField;    // 0x0x48
    public FAGHKNLHEKK <OKMEDCPHNOA>k__BackingField;    // 0x0x50
}
...
// base   : ANAKCDECEIG
//   (not directly referenced by a detected call)
public class DLBAECGFOHO : ANAKCDECEIG
{
    public LDDCBLCJHMP LANAPDLOODN;    // 0x0x20
}

// --------------------------------------------------------------------------
// DLBALFNIHGN
// base   : JOOJCLGELGF`1<FKCOEBBJFAO>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{jPGJLOCGBDA}   [Service.API]
public class DLBALFNIHGN
{
    // (no instance fields in the metadata dump)
}
...
public class DPGMCCINGJB
{
    public RoomKeyResult <PEIGNMMIMID>k__BackingField;    // 0x0x10
    public OFOEPIBBJGB <INOIEMMOEJC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EABOKKLKEIO
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class EABOKKLKEIO
{
    public long <JJIAHKJCFKB>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <DMPNOODFNLB>k__BackingField;    // 0x0x18
    public DNCHANHHLHD <KPIEFFJHBFH>k__BackingField;    // 0x0x20
}
...
public class EFJLEDFBICK
{
    public List<string> <FKGLDNGJGLH>k__BackingField;    // 0x0x10
}
...
// EHDLDGEGEDP
//   (not directly referenced by a detected call)
public class EHDLDGEGEDP
{
    public OICCDKGHIEL <KCLAGJDNIEE>k__BackingField;    // 0x0x10
    public int <LLDGFBLOBIC>k__BackingField;    // 0x0x14
    public CLKCEBNNLOF <PBKAMJIAGLG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EIINIHOFFNA
//   RESPONSE GET    api/customAvatarItems/v1/pricingconfig   [Service.API]
public class EIINIHOFFNA
{
    public int KLOMCCKKOKB;    // 0x0x10
    public int EENGHEBHHBO;    // 0x0x14
}

// --------------------------------------------------------------------------
// EIKMKNIPDBD
//   (not directly referenced by a detected call)
public class EIKMKNIPDBD
{
    public OJAKKHGMPKO <GDHKLGAICBB>k__BackingField;    // 0x0x10
    public long <LBNCGHEAKMB>k__BackingField;    // 0x0x18
    public GiftItemDTO <EPCCHCLGOHA>k__BackingField;    // 0x0x20
    public long? <DMCOIKJBHAD>k__BackingField;    // 0x0x28
    public int <CMCKHGNHFDE>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// EKNGFPJDPIA
//   (not directly referenced by a detected call)
public class EKNGFPJDPIA
{
    public Guid <NGOFDMJLGOO>k__BackingField;    // 0x0x10
    public int <LNDJLFFBDIJ>k__BackingField;    // 0x0x20
    public int <BJHAAIJBOGC>k__BackingField;    // 0x0x24
    public Guid <DPPMNJLLEBO>k__BackingField;    // 0x0x28
    public DateTime <AGGIHCLCJAF>k__BackingField;    // 0x0x38
    public FEHHODFIHBA <JJOMAEDFNAF>k__BackingField;    // 0x0x40
}
...
//   RESPONSE GET    api/playerevents/v1/all/{lHPHKGMDHKM}   [Service.API]
public class EMNAGFMKNJE
{
    public List<ILEDGGKJOBB> <LBLFHGFIOBL>k__BackingField;    // 0x0x10
    public List<LKGLDOOBIAL> <EEANEILMKCP>k__BackingField;    // 0x0x18
}
...
// FAGHKNLHEKK
//   (not directly referenced by a detected call)
public class FAGHKNLHEKK
{
    public long <LLDGFBLOBIC>k__BackingField;    // 0x0x10
    public Guid? <BLCPCLKAPFN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FCFOLMNCAEN
//   (not directly referenced by a detected call)
public class FCFOLMNCAEN
{
    public float <NGNOHHINLJG>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FEHHODFIHBA
//   (not directly referenced by a detected call)
public class FEHHODFIHBA
{
    public Guid <NGOFDMJLGOO>k__BackingField;    // 0x0x10
    public long <JJIAHKJCFKB>k__BackingField;    // 0x0x20
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x28
    public string <LBLCOJFDOOG>k__BackingField;    // 0x0x30
    public string <EHFGGPJFBKH>k__BackingField;    // 0x0x38
    public long <LLDGFBLOBIC>k__BackingField;    // 0x0x40
    public Guid? <HNHJNKMLCKG>k__BackingField;    // 0x0x48
    public DateTime <AGGIHCLCJAF>k__BackingField;    // 0x0x60
    public int <JOHLJOLBOEH>k__BackingField;    // 0x0x68
}
...
public class FEJFJNCGFKA
{
    public NAPDNNCNOPF <KFEHCPNPDDF>k__BackingField;    // 0x0x10
    public string <DJOEIDCGHBL>k__BackingField;    // 0x0x18
    public string <DIMNGDKHKCM>k__BackingField;    // 0x0x20
    public string <BLMAJDCOGNB>k__BackingField;    // 0x0x28
    public HLLCBMIFJOL <OKGMGPAGLKE>k__BackingField;    // 0x0x30
    public string <AMAECAEPPCE>k__BackingField;    // 0x0x38
    public int <BHNLMFLEPEF>k__BackingField;    // 0x0x40
    public bool <EJNHNHNDABE>k__BackingField;    // 0x0x44
    public string <DJHBNGOBBDB>k__BackingField;    // 0x0x48
    public DateTime <HPNMAPJJMBJ>k__BackingField;    // 0x0x50
}
...
public class FIBBECBLGME
{
    public int <EHHIDDNGOGA>k__BackingField;    // 0x0x10
    public bool <DHKLHDMFFAI>k__BackingField;    // 0x0x14
    public DateTime <MGNHEPFPJPD>k__BackingField;    // 0x0x18
    public bool <ENHKGFKFKFD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FIFLIBAMIEM
//   RESPONSE GET    api/config/v2   [Service.API]
public class FIFLIBAMIEM
{
    public Dictionary<int, int> <JOAHINDJGJK>k__BackingField;    // 0x0x10
    public List<KFGDEPPKFHI> <FNEAPPAFDOB>k__BackingField;    // 0x0x18
    public GOCLBIFBHKC[][] <KAJHNDHMHGC>k__BackingField;    // 0x0x20
    public PMCPIHLFDCJ <PLBJHAIKKNL>k__BackingField;    // 0x0x28
    public JMJNJEENALC <PPFGPJCCANK>k__BackingField;    // 0x0x30
    public KPAEDMOHCHL <MNNOAGFGPLP>k__BackingField;    // 0x0x38
    public JBHGGBGEJJH <AINJGKEGNCM>k__BackingField;    // 0x0x40
    public FCFOLMNCAEN <KDMHEGMDBJD>k__BackingField;    // 0x0x48
    public string <OIDCBDDCKNC>k__BackingField;    // 0x0x50
}
...
public class FLBNMKJOPJH
{
    public int <LNDJLFFBDIJ>k__BackingField;    // 0x0x10
    public Guid <BLCPCLKAPFN>k__BackingField;    // 0x0x14
    public long <NACEOEBHAHM>k__BackingField;    // 0x0x28
    public DateTime <AGGIHCLCJAF>k__BackingField;    // 0x0x30
}
...
public class FMAGDLBEHCB
{
    public long <JJIAHKJCFKB>k__BackingField;    // 0x0x10
    public long? <DOKLOOAIOEH>k__BackingField;    // 0x0x18
    public long? <KKOEKAOAPGL>k__BackingField;    // 0x0x28
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x38
    public string <LBLCOJFDOOG>k__BackingField;    // 0x0x40
    public List<string> <IOHJBBCMMCP>k__BackingField;    // 0x0x48
    public string <EHFGGPJFBKH>k__BackingField;    // 0x0x50
    public DateTime <CHHCDELFANK>k__BackingField;    // 0x0x58
    public DateTime <OFJICPDDCLP>k__BackingField;    // 0x0x60
    public EDKMJEDMCMN <DGAKLAKPDFP>k__BackingField;    // 0x0x68
    public bool <DINCDJGHJGF>k__BackingField;    // 0x0x6C
    public bool <PPGHLEGEPHN>k__BackingField;    // 0x0x6D
    public DEAPGAKLCNM <CIOOKMCAOGB>k__BackingField;    // 0x0x70
    public DEAPGAKLCNM <JHMKILCHIDF>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// FOGNJBMGJNN
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class FOGNJBMGJNN
{
    public Dictionary<Guid, KIPJJELCMPG> <IDOPCDMHNAK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// FOMDEKHLOJK
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class FOMDEKHLOJK
{
    public int? <PMIDMPOCCJC>k__BackingField;    // 0x0x10
    public string <IKGFOBPIACA>k__BackingField;    // 0x0x18
    public string <MGKANCKPCAK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// GEDGGJHIBID
//   REQUEST  PUT    api/roomconsumables   [Service.Econ]
public class GEDGGJHIBID
{
    public Guid? <GDFHKBFGJIP>k__BackingField;    // 0x0x10
    public Guid <ICPEDKLGGKH>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// GEEKGMFDAJH
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.Econ]
public class GEEKGMFDAJH
{
    public Guid <BLCPCLKAPFN>k__BackingField;    // 0x0x10
    public int <DMJPFCGNGMK>k__BackingField;    // 0x0x20
    public long <CDEOMMPEEMF>k__BackingField;    // 0x0x28
    public Guid <BPDGNHHIGGG>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GEKNGOEFAMH
//   (not directly referenced by a detected call)
public class GEKNGOEFAMH
{
    public bool <JEIMIPPJANK>k__BackingField;    // 0x0x10
    public HHHICHALPEE <DOOJKHOHCOG>k__BackingField;    // 0x0x18
    public float <GCHFCNLMFCP>k__BackingField;    // 0x0x20
}
...
public class GMALEECNGIN
{
    public string <BKBAHNAJDME>k__BackingField;    // 0x0x10
    public string <CNIDFOFJDPI>k__BackingField;    // 0x0x18
    public string <DIMNGDKHKCM>k__BackingField;    // 0x0x20
    public string <BLMAJDCOGNB>k__BackingField;    // 0x0x28
    public HLLCBMIFJOL <OKGMGPAGLKE>k__BackingField;    // 0x0x30
    public string <GLMOGBAOBBM>k__BackingField;    // 0x0x38
    public bool BLJFMICGNAG;    // 0x0x40
    public bool <FHCOGKHPPGB>k__BackingField;    // 0x0x41
}

// --------------------------------------------------------------------------
// GOCLBIFBHKC
//   (not directly referenced by a detected call)
public class GOCLBIFBHKC
{
    public MFDPPKKIDCE PHPDKMHMGGJ;    // 0x0x10
    public int KOOHNBPPCFK;    // 0x0x14
}

// --------------------------------------------------------------------------
// HAELNCEJJFM
//   (not directly referenced by a detected call)
public class HAELNCEJJFM
{
    public int <LCABGCJIKND>k__BackingField;    // 0x0x10
    public GEDGGJHIBID <MBFNJEMHOOD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HHHICHALPEE
//   (not directly referenced by a detected call)
public class HHHICHALPEE
{
    public int <GEPANCNBNOI>k__BackingField;    // 0x0x10
    public string <DIMNGDKHKCM>k__BackingField;    // 0x0x18
    public string <BLMAJDCOGNB>k__BackingField;    // 0x0x20
    public string <AMAECAEPPCE>k__BackingField;    // 0x0x28
    public string <AFCIFCJHPFG>k__BackingField;    // 0x0x30
    public ANBOJIKIHHJ? <CFHGCOMHEDJ>k__BackingField;    // 0x0x38
    public string <FJPNAIMMMAH>k__BackingField;    // 0x0x70
    public Guid? <AILHCCCFJDM>k__BackingField;    // 0x0x78
    public NAPDNNCNOPF? <KFEHCPNPDDF>k__BackingField;    // 0x0x8C
    public string <FJGOGACAOJK>k__BackingField;    // 0x0x98
    public string <OHHPCKPEAPM>k__BackingField;    // 0x0xA0
    public bool <DILBGAIDOBD>k__BackingField;    // 0x0xA8
    public bool <HGNJDIINBMK>k__BackingField;    // 0x0xA9
    public bool <GGCGNKIEAPP>k__BackingField;    // 0x0xAA
    public HLLCBMIFJOL <OKGMGPAGLKE>k__BackingField;    // 0x0xAC
    public OICCDKGHIEL <KCLAGJDNIEE>k__BackingField;    // 0x0xB0
    public int <EABKHKIEDJG>k__BackingField;    // 0x0xB4
    public HLNDJKGLKLL <DCKOIHAHKEH>k__BackingField;    // 0x0xB8
    public APJEKMFCMFG <CKKPFNMCCKF>k__BackingField;    // 0x0xBC
    public int? <OHFGGCLKAMP>k__BackingField;    // 0x0xC0
    public string <FAMKEILNCLI>k__BackingField;    // 0x0xC8
    public int? <BHNLMFLEPEF>k__BackingField;    // 0x0xD0
    public int? <IFLALBANMHE>k__BackingField;    // 0x0xD8
    public string <GLMOGBAOBBM>k__BackingField;    // 0x0xE0
}
...
public class HNMBOMMAKGD
{
    public int <MJBLABCFPMI>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// HOIGKJDHLIL
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.API]
public class HOIGKJDHLIL
{
    public List<long> <ELIABFCAAGJ>k__BackingField;    // 0x0x10
    public IOKOJEHILMG <JBBMNCGGKJP>k__BackingField;    // 0x0x18
    public string <IHKKIGJMIBF>k__BackingField;    // 0x0x20
    public long? <JJIAHKJCFKB>k__BackingField;    // 0x0x28
}
...
public class IBIICHNPFDB
{
    public List<EIKMKNIPDBD> <GACFLEGDGHC>k__BackingField;    // 0x0x10
    public FKDMLAMDOEN? <LFGEACOICDB>k__BackingField;    // 0x0x18
    public OICCDKGHIEL <KCLAGJDNIEE>k__BackingField;    // 0x0x20
    public bool <MKJIJCIDIJG>k__BackingField;    // 0x0x24
    public bool <FIFLPNAKLNA>k__BackingField;    // 0x0x25
    public Guid? <EECMPICEJCN>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// IFOGDJCPPOK
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class IFOGDJCPPOK
{
    public List<OHMDEDKFNEA> <KHGMGCNHCGG>k__BackingField;    // 0x0x10
    public JDAODNDJBCH <BIAILNFNJLD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ILCIKNHNBJG
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class ILCIKNHNBJG
{
    public long <DIILBJJDGDD>k__BackingField;    // 0x0x10
    public DLIGKIIAIEC <JBBMNCGGKJP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// ILCKFDNIGPK
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class ILCKFDNIGPK
{
    public int <GIHCCGIPINK>k__BackingField;    // 0x0x10
    public int <LEAKBGLCAOB>k__BackingField;    // 0x0x14
    public float <FJLGLLKBIBH>k__BackingField;    // 0x0x18
    public int <CKOHMHGGJNK>k__BackingField;    // 0x0x1C
    public int <BABOOANEBCI>k__BackingField;    // 0x0x20
    public int <AFEBNBAKKFB>k__BackingField;    // 0x0x24
    public int <OCBHEKCNNCH>k__BackingField;    // 0x0x28
    public string <HHLBJGBBELK>k__BackingField;    // 0x0x30
    public string <CPOFPHKOIGI>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// ILEDGGKJOBB
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class ILEDGGKJOBB
{
    public long <DIILBJJDGDD>k__BackingField;    // 0x0x10
    public int <KINGMCCFCHF>k__BackingField;    // 0x0x18
    public long <JJIAHKJCFKB>k__BackingField;    // 0x0x20
    public long? <DOKLOOAIOEH>k__BackingField;    // 0x0x28
    public long? <KKOEKAOAPGL>k__BackingField;    // 0x0x38
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x48
    public string <LBLCOJFDOOG>k__BackingField;    // 0x0x50
    public string <EHFGGPJFBKH>k__BackingField;    // 0x0x58
    public DateTime <CHHCDELFANK>k__BackingField;    // 0x0x60
    public DateTime <OFJICPDDCLP>k__BackingField;    // 0x0x68
    public int <KHNHHNAELNJ>k__BackingField;    // 0x0x70
    public EDKMJEDMCMN <DGAKLAKPDFP>k__BackingField;    // 0x0x74
    public bool <DINCDJGHJGF>k__BackingField;    // 0x0x78
    public bool <PPGHLEGEPHN>k__BackingField;    // 0x0x79
    public DEAPGAKLCNM <CIOOKMCAOGB>k__BackingField;    // 0x0x7C
    public DEAPGAKLCNM <JHMKILCHIDF>k__BackingField;    // 0x0x80
    public long? <AKEMPEBLJAD>k__BackingField;    // 0x0x88
}
...
public class IMOLCLFNAMJ
{
    public GEDGGJHIBID <MBFNJEMHOOD>k__BackingField;    // 0x0x10
    public FAGHKNLHEKK <CMCNGBCPHMA>k__BackingField;    // 0x0x18
    public int <LCABGCJIKND>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JBHGGBGEJJH
//   (not directly referenced by a detected call)
public class JBHGGBGEJJH
{
    public int <MNDIEFEFIND>k__BackingField;    // 0x0x10
}
...
// JEPKPJBACFO
//   (not directly referenced by a detected call)
public class JEPKPJBACFO
{
    public DateTime <HPNMAPJJMBJ>k__BackingField;    // 0x0x10
    public string <GDNCPEAJCEF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JMJNJEENALC
//   (not directly referenced by a detected call)
public class JMJNJEENALC
{
    public float <OCFFCMEAHKE>k__BackingField;    // 0x0x10
    public float <FDKKECEFJOC>k__BackingField;    // 0x0x14
    public float <DCICPCIGPGO>k__BackingField;    // 0x0x18
    public float <CJBEOLEIPCH>k__BackingField;    // 0x0x1C
    public float <IEKAPKEKNOC>k__BackingField;    // 0x0x20
    public float <BCLDBICBHPB>k__BackingField;    // 0x0x24
    public float <MMHPIAEMNCE>k__BackingField;    // 0x0x28
    public float <GIDKIHLNFMC>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// KBLGHBLIGFC
//   REQUEST  POST   api/items/purchaseInfos   [Service.Econ]
public class KBLGHBLIGFC
{
    public IReadOnlyList<DLBAECGFOHO> <JHHHEGONLPO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KCGACACFGKB
//   (not directly referenced by a detected call)
public class KCGACACFGKB
{
    public int <LDEHMHJBOPB>k__BackingField;    // 0x0x10
    public OMCPPLOOAHG <JBBMNCGGKJP>k__BackingField;    // 0x0x14
    public List<EHDLDGEGEDP> <MBIJLFGFDAJ>k__BackingField;    // 0x0x18
    public List<EHDLDGEGEDP> <GODBHOLLIJP>k__BackingField;    // 0x0x20
    public bool <HHHJFLHIMHA>k__BackingField;    // 0x0x28
    public DateTime? <ELPHJLPLHGD>k__BackingField;    // 0x0x30
    public DateTime? <JCKFDNLJCCA>k__BackingField;    // 0x0x40
    public DateTime? <IKDGLNFDDOB>k__BackingField;    // 0x0x50
    public bool <IOLBGHMJBFP>k__BackingField;    // 0x0x60
    public bool <HDCHNCFLOPB>k__BackingField;    // 0x0x61
}

// --------------------------------------------------------------------------
// KCOINKEJNGD
//   RESPONSE GET    api/makerai/freetrialconfig   [Service.Econ]
public class KCOINKEJNGD
{
    public TimeSpan <PGOMJDBIDKJ>k__BackingField;    // 0x0x10
    public TimeSpan <MJBLABCFPMI>k__BackingField;    // 0x0x18
}
...
public class KDCHGGCIDDO
{
    public Guid <BPDGNHHIGGG>k__BackingField;    // 0x0x10
    public long <PEDCBAKAJIA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KIPJJELCMPG
//   RESPONSE PUT    api/roomconsumables   [Service.Econ]
public class KIPJJELCMPG
{
    public ALNILEDEBCM <PEIGNMMIMID>k__BackingField;    // 0x0x10
    public EKNGFPJDPIA <DIMKDNBKMCE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// KJIAAKIMOJF
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{fNONEKHIKKF}/{lIHOJKFJPPD}   [Service.Econ]
public class KJIAAKIMOJF
{
    public OICCDKGHIEL <KCLAGJDNIEE>k__BackingField;    // 0x0x10
    public ELHMMHPBDJD <PEMBKPOHPPD>k__BackingField;    // 0x0x14
    public int <BNJFJGHGONM>k__BackingField;    // 0x0x18
    public int <BJDBIPEOAJJ>k__BackingField;    // 0x0x1C
    public int <ECINOMDIEDO>k__BackingField;    // 0x0x20
    public BGNNNPGCKJI <EFOOCJDKJPC>k__BackingField;    // 0x0x24
    public bool <CKDNDJNPBJJ>k__BackingField;    // 0x0x28
    public float <HDBANOPHLPO>k__BackingField;    // 0x0x2C
    public int <DOKCJNIDPEM>k__BackingField;    // 0x0x30
    public bool <HLDNLFHBJMJ>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// KLNHKJONCMN
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class KLNHKJONCMN
{
    public List<int> <PHMPNANIBBF>k__BackingField;    // 0x0x10
    public string <JINAEKBBCOB>k__BackingField;    // 0x0x18
}
...
// KPAEDMOHCHL
//   (not directly referenced by a detected call)
public class KPAEDMOHCHL
{
    public int <CFAMGJPIOBD>k__BackingField;    // 0x0x10
    public DateTime <LCFBFOJEBJD>k__BackingField;    // 0x0x18
}
...
// LIOKHHNODBA
//   (not directly referenced by a detected call)
public class LIOKHHNODBA
{
    public bool <LNKJNIMBEIO>k__BackingField;    // 0x0x10
    public KNEJLBPHMMH <KFGOHBNJAPL>k__BackingField;    // 0x0x14
    public int <HCEMJIJGNPD>k__BackingField;    // 0x0x18
    public DateTime <AGGIHCLCJAF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LKGLDOOBIAL
//   (not directly referenced by a detected call)
public class LKGLDOOBIAL
{
    public ILEDGGKJOBB <ADEJCEDINMJ>k__BackingField;    // 0x0x10
    public LLNIMLACFOA <JHOBEDFDPLG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// LLNIMLACFOA
//   (not directly referenced by a detected call)
public class LLNIMLACFOA
{
    public long <KLAPDIDDJAM>k__BackingField;    // 0x0x10
    public long <DIILBJJDGDD>k__BackingField;    // 0x0x18
    public int <JAIKPBAJOHJ>k__BackingField;    // 0x0x20
    public DateTime <HPNMAPJJMBJ>k__BackingField;    // 0x0x28
    public DLIGKIIAIEC <JBBMNCGGKJP>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// LMLBOEIEJBA
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{eGJGKBPPPFG}   [Service.API]
public class LMLBOEIEJBA
{
    public uint <AEBAKOGHPOD>k__BackingField;    // 0x0x10
    public uint? <IMGMDFOEDKN>k__BackingField;    // 0x0x14
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x20
    public string <LBLCOJFDOOG>k__BackingField;    // 0x0x28
    public DateTime <KFCIPAEKCDJ>k__BackingField;    // 0x0x30
    public DateTime? <NNJHOMJPOCN>k__BackingField;    // 0x0x38
    public bool <FBHCANIKCKC>k__BackingField;    // 0x0x48
    public List<MBLCGGMALHF> <IPNKCKPIGIB>k__BackingField;    // 0x0x50
    public List<string> <IOHJBBCMMCP>k__BackingField;    // 0x0x58
    public int <KKPDOHPNPEI>k__BackingField;    // 0x0x60
    public int <OLOHJBOEIEC>k__BackingField;    // 0x0x64
    public int <GKDFIGLFHCK>k__BackingField;    // 0x0x68
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{lMNPCFKGDKI}   [Service.API]
...
public class LOKKMHGKDHJ
{
    public OGIKNOGEAMM <ADEJCEDINMJ>k__BackingField;    // 0x0x10
    public JDAODNDJBCH <BIAILNFNJLD>k__BackingField;    // 0x0x18
    public NLFBHFMFJHP <MIGOJHKJOMN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LOLPKLBLLIG
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class LOLPKLBLLIG
{
    public bool <AMDDCBHMKPA>k__BackingField;    // 0x0x10
    public string <OHOBKDCCBKB>k__BackingField;    // 0x0x18
    public string <GJOKIDJIIAG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MBLCGGMALHF
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class MBLCGGMALHF
{
    public string <AEBAKOGHPOD>k__BackingField;    // 0x0x10
    public string <OHOBKDCCBKB>k__BackingField;    // 0x0x18
    public string <PEPEDFNOPCK>k__BackingField;    // 0x0x20
    public string <LBLCOJFDOOG>k__BackingField;    // 0x0x28
    public string <IKGFOBPIACA>k__BackingField;    // 0x0x30
    public GHFHJNIOOPM <PEIGNMMIMID>k__BackingField;    // 0x0x38
    public List<string> <MMFDGOMNENE>k__BackingField;    // 0x0x40
    public List<string> <IOHJBBCMMCP>k__BackingField;    // 0x0x48
    public string <ELHOJGLAOBI>k__BackingField;    // 0x0x50
    public List<JEPKPJBACFO> <BDIFJICOHHO>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// MCGPNLJHFBE
//   (not directly referenced by a detected call)
public class MCGPNLJHFBE
{
    public Guid <NBGCIFJCCDH>k__BackingField;    // 0x0x10
    public Guid <CDIIOCPHICN>k__BackingField;    // 0x0x20
    public DateTime <LNOGNPOIIPM>k__BackingField;    // 0x0x30
    public List<HHHICHALPEE> <INAHBNGGDAA>k__BackingField;    // 0x0x38
}
...
public class MDOAIMCGFBM : EBDPEONBICP
{
    public LCNOABNNKJA? <AHPLKHPCANE>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <LPCHLOONNNE>k__BackingField;    // 0x0x20
}
...
public class MFIGPLJKOEK
{
    public Guid <LDKINAKMMDL>k__BackingField;    // 0x0x10
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x20
    public string <EHFGGPJFBKH>k__BackingField;    // 0x0x28
    public DateTime <LNOGNPOIIPM>k__BackingField;    // 0x0x30
    public DateTime? <MHDDIAALDEA>k__BackingField;    // 0x0x38
    public List<MCGPNLJHFBE> <MPNKDGJJDDJ>k__BackingField;    // 0x0x48
}
...
public class MNLFGBDOJFP
{
    public int <DNCLGOFEMDC>k__BackingField;    // 0x0x10
    public int <EHHIDDNGOGA>k__BackingField;    // 0x0x14
    public float <JKDPFELHNMD>k__BackingField;    // 0x0x18
    public float <FHCKPFAPGKF>k__BackingField;    // 0x0x1C
    public bool <DHKLHDMFFAI>k__BackingField;    // 0x0x20
    public bool <GOHCEHACAOJ>k__BackingField;    // 0x0x21
    public bool <FHCOGKHPPGB>k__BackingField;    // 0x0x22
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{mMEOCHBBBFL}   [Service.Econ]
public class NDHHKCGMJLH
{
    public ALNILEDEBCM <PEIGNMMIMID>k__BackingField;    // 0x0x10
    public FEHHODFIHBA <JJOMAEDFNAF>k__BackingField;    // 0x0x18
}
...
// base   : KCGACACFGKB
//   (not directly referenced by a detected call)
public class NDJJHBEABFE : KCGACACFGKB
{
    public int <FAKBADDLBFO>k__BackingField;    // 0x0x68
    public List<GEKNGOEFAMH> <LPDDLCHIJIA>k__BackingField;    // 0x0x70
    public List<GEKNGOEFAMH> <GEEFEBGDAPP>k__BackingField;    // 0x0x78
    public List<GEKNGOEFAMH> <LDILDIOHCBI>k__BackingField;    // 0x0x80
}
...
public class NJEFNIABHBN
{
    public int <NBNKGMAFIIG>k__BackingField;    // 0x0x10
    public BIOFAANDHPH <JBBMNCGGKJP>k__BackingField;    // 0x0x14
    public PFBNEPIEEJO <EECLFAADIOE>k__BackingField;    // 0x0x18
    public PFBNEPIEEJO <CMKJBGIMGHP>k__BackingField;    // 0x0x1C
    public PFBNEPIEEJO <LBBNLDIEAHP>k__BackingField;    // 0x0x20
    public byte? <MIOBMKDCAIE>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// NJJCFOIIHDM
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class NJJCFOIIHDM
{
    public Dictionary<Guid, HAELNCEJJFM> <OJNBLOFLOMJ>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// NJMHAIIGPBF
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class NJMHAIIGPBF
{
    public KNOKPBLABAO <PHMPLMCNGNG>k__BackingField;    // 0x0x10
    public int <MJBLABCFPMI>k__BackingField;    // 0x0x14
    public long <EIBECIOMAPL>k__BackingField;    // 0x0x18
    public bool <LBPJKDBGLOP>k__BackingField;    // 0x0x20
    public string <IJAMCCININE>k__BackingField;    // 0x0x28
    public int? <HMDOMOFLIPI>k__BackingField;    // 0x0x30
    public bool <AIDNEFGNIHK>k__BackingField;    // 0x0x38
    public bool <EBDIGMBNFEI>k__BackingField;    // 0x0x39
    public bool <LOENAJCPHKN>k__BackingField;    // 0x0x3A
    public bool <OJMLLNIDMNE>k__BackingField;    // 0x0x3B
    public string <BHBCMNAFOMO>k__BackingField;    // 0x0x40
    public DateTime? <GOGHFKKNOGA>k__BackingField;    // 0x0x48
    public string <MPFPICGGHKO>k__BackingField;    // 0x0x58
    public bool <KBGLKFIPCHE>k__BackingField;    // 0x0x60
    public string <HNLCAJPAHEE>k__BackingField;    // 0x0x68
    public string <BFHKFAHEHKI>k__BackingField;    // 0x0x70
    public float <HCMHFFLBOMB>k__BackingField;    // 0x0x78
}
...
public class NLFBHFMFJHP
{
    public ABJPPHBLHBK <BIAILNFNJLD>k__BackingField;    // 0x0x10
    public List<string> <IOHJBBCMMCP>k__BackingField;    // 0x0x18
}
...
public class NLNPJMGIGLP
{
    public bool <BICGOOMGJGD>k__BackingField;    // 0x0x10
    public string <IJAMCCININE>k__BackingField;    // 0x0x18
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class NOKNCAGJAEE : ValueType
{
    public Guid DNLDANFOOJK;    // 0x0x0
}
...
public class OAHFNMOBAKL
{
    public List<ILEDGGKJOBB> <MJPLICCHEEN>k__BackingField;    // 0x0x10
    public string <JINAEKBBCOB>k__BackingField;    // 0x0x18
}
...
// OEKHEJIMMNK
//   (not directly referenced by a detected call)
public class OEKHEJIMMNK
{
    public int <PEDBACCNCJN>k__BackingField;    // 0x0x10
    public DateTime <HPNMAPJJMBJ>k__BackingField;    // 0x0x18
    public DateTime? <LDDAPDKIBFG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OFOEPIBBJGB
//   (not directly referenced by a detected call)
public class OFOEPIBBJGB
{
    public long <KIPHKAKHFDA>k__BackingField;    // 0x0x10
    public Guid <BPGMJPAOFOF>k__BackingField;    // 0x0x18
    public long <JJIAHKJCFKB>k__BackingField;    // 0x0x28
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x30
    public string <LBLCOJFDOOG>k__BackingField;    // 0x0x38
    public int <LLDGFBLOBIC>k__BackingField;    // 0x0x40
    public Guid? <HNHJNKMLCKG>k__BackingField;    // 0x0x44
    public DateTime <HPNMAPJJMBJ>k__BackingField;    // 0x0x58
    public string <EHFGGPJFBKH>k__BackingField;    // 0x0x60
    public NIALFHNPALJ <JBBMNCGGKJP>k__BackingField;    // 0x0x68
}
...
// base   : ILEDGGKJOBB
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class OGIKNOGEAMM : ILEDGGKJOBB
{
    public List<AJMDKHEGLAC> <IOHJBBCMMCP>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// OHMDEDKFNEA
//   (not directly referenced by a detected call)
public class OHMDEDKFNEA
{
    public int <HPABJDMHELM>k__BackingField;    // 0x0x10
    public JDAODNDJBCH <BIAILNFNJLD>k__BackingField;    // 0x0x14
}
...
public class OIDMOIGHPIG
{
    public INOHEFCCPKG <PHMPLMCNGNG>k__BackingField;    // 0x0x10
    public string <DOJAIHHIPCA>k__BackingField;    // 0x0x18
    public int? <OJLBLMCNAKP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// OJAKKHGMPKO
//   (not directly referenced by a detected call)
public class OJAKKHGMPKO
{
    public NFKAGEEDJKA <JBBMNCGGKJP>k__BackingField;    // 0x0x10
    public int? <IKPAMPDGEEP>k__BackingField;    // 0x0x14
    public Guid? <BJKAOGEJPIN>k__BackingField;    // 0x0x1C
}
...
public class OMDCAANNEID
{
    public KNOKPBLABAO <PHMPLMCNGNG>k__BackingField;    // 0x0x10
    public long <DIILBJJDGDD>k__BackingField;    // 0x0x18
    public string <DOJAIHHIPCA>k__BackingField;    // 0x0x20
}
...
public class ONGAFAFBKNA
{
    public List<string> <HCKEEFODDPE>k__BackingField;    // 0x0x10
    public List<string> <MFAKHAOINOG>k__BackingField;    // 0x0x18
    public List<string> <NINPLCENELF>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{dMABDIEKAKJ}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{dFAIPONKOEG}   [Service.API]
...
public class OONMGGAOEHG
{
    public bool <BICGOOMGJGD>k__BackingField;    // 0x0x10
    public string <BPODFCGBIEG>k__BackingField;    // 0x0x18
    public string <PMAGEMKNAGF>k__BackingField;    // 0x0x20
}
...
public class PDGIDNFBPGA : EBDPEONBICP
{
    public EGCIDOLOJGD? <AHPLKHPCANE>k__BackingField;    // 0x0x18
    public FLBNMKJOPJH <DCIHGHMAMCA>k__BackingField;    // 0x0x20
}
...
public class PHAKFDKFAPK
{
    public JDAODNDJBCH <BIAILNFNJLD>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/progressionEvents/collect/{lMNPCFKGDKI}/{mHHLHKIIIBA}   [Service.API]
public class PKPHPAIKFAL
{
    public long? <AEBAKOGHPOD>k__BackingField;    // 0x0x10
    public int <JAIKPBAJOHJ>k__BackingField;    // 0x0x20
    public int? <KNJCMGCNKDH>k__BackingField;    // 0x0x24
    public string <AFCIFCJHPFG>k__BackingField;    // 0x0x30
    public NAPDNNCNOPF? <KFEHCPNPDDF>k__BackingField;    // 0x0x38
    public string <FJPNAIMMMAH>k__BackingField;    // 0x0x40
    public Guid? <AILHCCCFJDM>k__BackingField;    // 0x0x48
    public string <FJGOGACAOJK>k__BackingField;    // 0x0x60
    public string <OHHPCKPEAPM>k__BackingField;    // 0x0x68
    public OICCDKGHIEL <KCLAGJDNIEE>k__BackingField;    // 0x0x70
    public int <EABKHKIEDJG>k__BackingField;    // 0x0x74
    public int <PEIMPNPOLON>k__BackingField;    // 0x0x78
    public APJEKMFCMFG <DLINKDDLBCI>k__BackingField;    // 0x0x7C
    public HLLCBMIFJOL <PPPLHMLONKB>k__BackingField;    // 0x0x80
    public string <EPBBLNBCIOP>k__BackingField;    // 0x0x88
    public string <EGFKLCADICA>k__BackingField;    // 0x0x90
    public bool <GJECGBMPHLE>k__BackingField;    // 0x0x98
    public NPJJEBGBNDK <JCHCDIELPJA>k__BackingField;    // 0x0x9C
    public KNEJLBPHMMH <LDLFLEKLGMF>k__BackingField;    // 0x0xA0
    public NKILPDNDKBO? <DOEGMKPFLHB>k__BackingField;    // 0x0xA4
    public bool <FFCBGMGMKEB>k__BackingField;    // 0x0xAC
    public bool <COPAMMAIICN>k__BackingField;    // 0x0xAD
    public string <OFHHKGHHJHK>k__BackingField;    // 0x0xB0
    public string <CBPOHEGEKCN>k__BackingField;    // 0x0xB8
    public bool <KCFPAGIOEOP>k__BackingField;    // 0x0xC0
    public bool CCOIABDPJAB;    // 0x0xC1
}

// --------------------------------------------------------------------------
// PLACLPHGGKD
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class PLACLPHGGKD
{
    public List<AJMDKHEGLAC> <IOHJBBCMMCP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// PMCPIHLFDCJ
//   (not directly referenced by a detected call)
public class PMCPIHLFDCJ
{
    public int <PGIEJHFABCO>k__BackingField;    // 0x0x10
}
...
public class AddKeepsakeInstanceRequest
{
    public long <JJIAHKJCFKB>k__BackingField;    // 0x0x10
    public long? <DOKLOOAIOEH>k__BackingField;    // 0x0x18
    public KCEPIFFHDBI <ANBKABJDAMM>k__BackingField;    // 0x0x28
}
...
{
    public PINKDOGNHOB <BIAILNFNJLD>k__BackingField;    // 0x0x10
    public string <OEMBDLFGEIO>k__BackingField;    // 0x0x18
    public string <KIJMBCDCDNO>k__BackingField;    // 0x0x20
    public string <AOIDDPFCNMA>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public OICCDKGHIEL <CurrencyType>k__BackingField;    // 0x0x18
    public NKILPDNDKBO <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<LHJHOOALJOM<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <DIILBJJDGDD>k__BackingField;    // 0x0x10
    public long? <CNGJMNOOAPC>k__BackingField;    // 0x0x18
}
...
{
    public string <KCKMOEFPOPL>k__BackingField;    // 0x0x10
    public int <DINIFIBFNBG>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public PDIEBOFNJJE FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public APJEKMFCMFG <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public KCEPIFFHDBI <HDJBEHLIOMN>k__BackingField;    // 0x0x10
    public string <CNOPJLDBJNP>k__BackingField;    // 0x0x18
    public int <EFKKIFDBKID>k__BackingField;    // 0x0x20
    public int <JOJEOABFJBF>k__BackingField;    // 0x0x24
    public string <BAIDPNJPADE>k__BackingField;    // 0x0x28
    public string <EABHNOFAFFN>k__BackingField;    // 0x0x30
}
...
{
    public int <LNDJLFFBDIJ>k__BackingField;    // 0x0x10
    public Guid <MOMKPGLHIKJ>k__BackingField;    // 0x0x14
    public DateTime <LFJFOHFCINP>k__BackingField;    // 0x0x28
}
...
{
    public bool <CJMGFGLGKPL>k__BackingField;    // 0x0x10
    public int <KFONPPFEENB>k__BackingField;    // 0x0x14
    public bool <OGLKEDCGOJI>k__BackingField;    // 0x0x18
}
...
{
    public Guid <MOMKPGLHIKJ>k__BackingField;    // 0x0x10
    public KCEPIFFHDBI <BABIGEAHAND>k__BackingField;    // 0x0x20
    public int <PPMAOMGNLMA>k__BackingField;    // 0x0x24
    public long <JJIAHKJCFKB>k__BackingField;    // 0x0x28
    public long? <DOKLOOAIOEH>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{mJEOOKBAILL}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <HGOCNNPEBAO>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <OLKCDEFANGC>k__BackingField;    // 0x0x18
}
...
{
    public long <CCGBDEIDEGD>k__BackingField;    // 0x0x10
    public long <JJIAHKJCFKB>k__BackingField;    // 0x0x18
    public long <LPAGJGLNLJO>k__BackingField;    // 0x0x20
    public OOPMLGAEEJE <JBBMNCGGKJP>k__BackingField;    // 0x0x28
    public int <BFLILJPGMJI>k__BackingField;    // 0x0x2C
}
...
{
    public long <JJIAHKJCFKB>k__BackingField;    // 0x0x10
    public List<Guid> <CJKBNCOMLPJ>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <HGOCNNPEBAO>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <OLKCDEFANGC>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <KOLFNPDPBLC>k__BackingField;    // 0x0x20
}
...
{
    public long <LPAGJGLNLJO>k__BackingField;    // 0x0x10
    public long <DOPOFCFFMBM>k__BackingField;    // 0x0x18
    public int? <OADCLGDDNCE>k__BackingField;    // 0x0x20
    public int? <AOHBNAAIFJJ>k__BackingField;    // 0x0x28
    public long? <DJOIHAEHAAO>k__BackingField;    // 0x0x30
    public long <JEBCFONPGBC>k__BackingField;    // 0x0x40
    public long <BHDAFKBEHLB>k__BackingField;    // 0x0x48
    public int <FAHJBNPILAL>k__BackingField;    // 0x0x50
    public OOPMLGAEEJE <POCFOPLBAFL>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <LINFHDFDHCP>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public APJEKMFCMFG <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public HDAMBOGOJKO creatorAccountRole;    // 0x0x68
...
{
    public IFGGMLEBLIE <LCBGPPGLNJC>k__BackingField;    // 0x0x10
    public PLPBGAKGDEM <CNGMHJMMFGC>k__BackingField;    // 0x0x14
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x18
    public string <LBLCOJFDOOG>k__BackingField;    // 0x0x20
    public bool <AHNFDLJNCAN>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<IFGGMLEBLIE> <DMDBLFGJEBB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{lMNPCFKGDKI}   [Service.API]
public class ProgressionEventDTO
{
    public long <DOPOFCFFMBM>k__BackingField;    // 0x0x10
    public string <EKCGMIGIKMP>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <LDILDIOHCBI>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <GKJOLFMNJNJ>k__BackingField;    // 0x0x28
    public DateTime <CHHCDELFANK>k__BackingField;    // 0x0x30
    public DateTime <OFJICPDDCLP>k__BackingField;    // 0x0x38
    public DateTime <DFAKEINANCL>k__BackingField;    // 0x0x40
    public bool <CEIHPINHEHG>k__BackingField;    // 0x0x48
    public int <ADFJJBAELPP>k__BackingField;    // 0x0x4C
    public float <CMMAKDLAIGN>k__BackingField;    // 0x0x50
    public Guid? <IIDLLIHOHIK>k__BackingField;    // 0x0x54
    public string <KCJKIBEMBEB>k__BackingField;    // 0x0x68
    public string <GLFDLHFIGKH>k__BackingField;    // 0x0x70
    public string <HBHMKHJBAPN>k__BackingField;    // 0x0x78
    public string <HIOKCEJDDGP>k__BackingField;    // 0x0x80
}
...
{
    public Guid <CIOAKJKGFOI>k__BackingField;    // 0x0x10
    public int <FABMDLFLJHD>k__BackingField;    // 0x0x20
    public int <BFCBMLDPDNI>k__BackingField;    // 0x0x24
    public int <LJAGLCPBOFA>k__BackingField;    // 0x0x28
    public long <CLPNDBKIBKG>k__BackingField;    // 0x0x30
    public long <PAIBJDKNDDH>k__BackingField;    // 0x0x38
}
...
{
    public int <LNDJLFFBDIJ>k__BackingField;    // 0x0x10
    public int <PEIMPNPOLON>k__BackingField;    // 0x0x14
    public int <GGGHLIDJGPM>k__BackingField;    // 0x0x18
    public int <PNANMCAKAKN>k__BackingField;    // 0x0x1C
    public int <NANCKEIGGJJ>k__BackingField;    // 0x0x20
    public DateTime? <KLCEPMGLICI>k__BackingField;    // 0x0x28
    public int <HGLHGOLDGFD>k__BackingField;    // 0x0x38
}
...
{
    public long <KGCHEOPJELN>k__BackingField;    // 0x0x10
    public int <GEPANCNBNOI>k__BackingField;    // 0x0x18
    public string <EHFGGPJFBKH>k__BackingField;    // 0x0x20
    public int <PEIMPNPOLON>k__BackingField;    // 0x0x28
    public int <CCGJABLLCLI>k__BackingField;    // 0x0x2C
    public bool <LOJHMFJOAFO>k__BackingField;    // 0x0x30
    public bool <KCJILNCJMOD>k__BackingField;    // 0x0x31
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public LKHDDCCGHNO <Permission>k__BackingField;    // 0x0x18
    public MNNPGENBKHF <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<DJGBANOABHA<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public OIMCIAJLMMH ReportCategory;    // 0x0x20
}
...
public class ReplicationUnityAssetsDTO
{
    ...
    public List<EEJBHILGNHE> <UnityAssets>k__BackingField;    // 0x0x18
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public MNNPGENBKHF <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public NFPAENOCMMI <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<NAKADOFEBEA> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{bAMLGLOCHFE}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool CEEMBGJMMEG;    // 0x0x28
}
...
{
    public EEBCFDOCCAC? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public EEBCFDOCCAC ACMLCBAAKAG;  // wrapper
...
{
    public NPJJEBGBNDK GOKNGEPMPCO;  // wrapper
...
{
    public OAIOGADIKOP AEOGKDPPBBE;  // wrapper
    public int? ENKNGAFDFFN;  // wrapper
...
{
    public KNOKPBLABAO BBMGNKDFKAJ;  // wrapper
...
{
    public byte[] GPCDCFCPGFK;  // wrapper
    public DBBGEPHKEDF LNGINKDDHFC;  // wrapper
...
{
    public KNOKPBLABAO DBOAAFKFGCJ;  // wrapper
    public float? PEJJFECPCOE;  // wrapper
    public bool? FKGCKKLJMKB;  // wrapper
...
{
    public List<ANBOJIKIHHJ> desc;  // wrapper
}
...
{
    public APJEKMFCMFG HCLPHJDKMCA;  // wrapper
    public APJEKMFCMFG? KHFMOAGDKDJ;  // wrapper
...
{
    public ChatMessage ONGDPODJNBL;  // wrapper
    public MJOLKPKDPBC DBOAAFKFGCJ;  // wrapper
...
// api/consumables/  [Econ GET]
public class ConsumablesRequest
{
    public object creatorPlayerId;  // candidate
}
...
// api/consumables/v1/getTransferable/{gettransferableId}  [Econ GET]
public class ConsumablesV1GetTransferableGettransferableIdRequest
{
    public object creatorPlayerId;  // candidate
}
...
{
    public MNNPGENBKHF HKPCIADPKMN;  // wrapper
    public PEMBEDJIHKC LPOPNFIFKIN;  // wrapper
    public MFKBPJAHJLH LJIPOMFNMPC;  // wrapper
    public MFKBPJAHJLH GHGFCNKGGBN;  // wrapper
...
// api/customAvatarItems/v1/{dMABDIEKAKJ}/appeal  [API POST]
public class CustomAvatarItemsV1DMABDIEKAKJAppealRequest
{
    public Guid DMABDIEKAKJ;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{jPGJLOCGBDA}  [API GET]
public class CustomAvatarItemsV2FromCreatorJPGJLOCGBDARequest
{
...
{
    public AHDKBLGMDKF GPNOOENECDD;  // wrapper
    public APJEKMFCMFG? DNAMIFDHCIH;  // wrapper
...
{
    public JDAAPCNHCGP OJDAIDOMNLO;  // wrapper
...
{
    public int? LGJONAGGGAP;  // wrapper
    public Guid? DMABDIEKAKJ;  // wrapper
...
// api/keepsakes/{dFAIPONKOEG}/collect  [API POST]
public class KeepsakesDFAIPONKOEGCollectRequest
{
    public Guid DFAIPONKOEG;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public IOKOJEHILMG DHNJANCOPMO;  // wrapper
    public long? DKMPIOFKFMN;  // wrapper
...
{
    public Guid NFGHBCPBGPC;  // wrapper
...
{
    public Guid OLPDFCCNAID;  // wrapper
...
{
    public Guid OLPDFCCNAID;  // wrapper
    public long? AKCLGFCIMEJ;  // wrapper
    public byte? EBOPBDPOAOK;  // wrapper
    public int? EDNHAEBPHJD;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid NFGHBCPBGPC;  // wrapper
    public long? PKKGIIIEFOF;  // wrapper
    public long? ELNANKMHFDF;  // wrapper
    public int? BDAHFNCBGML;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> HKENEGGNMIM;  // wrapper
...
{
    public NIALFHNPALJ AEOGKDPPBBE;  // wrapper
    public Guid? KAEPDPGECID;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public KNOKPBLABAO DBOAAFKFGCJ;  // wrapper
    public long? JGMIGINHCGO;  // wrapper
    public Guid? DKGONICLDJD;  // wrapper
    public int? OGIFIIGNMEH;  // wrapper
...
{
    public Guid OMMPDHAKHPB;  // wrapper
...
{
    public Guid FGDOHBEHLCF;  // wrapper
...
{
    public GHFHJNIOOPM FALHEPCMBNJ;  // wrapper
}
