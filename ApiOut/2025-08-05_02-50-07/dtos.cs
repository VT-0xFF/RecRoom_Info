...
public class AIBIKEGHLEH
{
    public TimeSpan <FBDIAPIJNPH>k__BackingField;    // 0x0x10
    public TimeSpan <BJBPJMNOLLA>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{eNMLANEBIGH}   [Service.Econ]
public class APGPAHECGPI
{
    public BIGEJJKIFHI <LFLCEGCIION>k__BackingField;    // 0x0x10
    public FGPKEAKMMIM <LBEGDHHGBLH>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{nPMPEIAPAOF}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{dBIALNJHNFJ}   [Service.API]
...
public class BCMKODJOJFH
{
    public bool <PMIIAICDPMB>k__BackingField;    // 0x0x10
    public string <FDMEHIOOPOP>k__BackingField;    // 0x0x18
    public string <BFOLGEIOGIE>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BFCKPJCGKIG
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{jDIPBOIIMNA}/{gAOMLJKMKPE}   [Service.Econ]
public class BFCKPJCGKIG
{
    public LPMAKBILGPG <BLBLIDFJEBP>k__BackingField;    // 0x0x10
    public MMJCNPABCHD <AIFFIPCEAFM>k__BackingField;    // 0x0x14
    public int <BDOJMPKJJOH>k__BackingField;    // 0x0x18
    public int <OHNPGOKCFCB>k__BackingField;    // 0x0x1C
    public int <NKPPGIBDEOO>k__BackingField;    // 0x0x20
    public JCAMMGPGIKK <MDLMFBJMAEK>k__BackingField;    // 0x0x24
    public bool <PFHDJMPCHND>k__BackingField;    // 0x0x28
    public float <MBHMNLEOHFD>k__BackingField;    // 0x0x2C
    public int <CPCEGMDDFGJ>k__BackingField;    // 0x0x30
    public bool <APDCICFOJDK>k__BackingField;    // 0x0x34
}
...
public class BGLEHKIJBNK
{
    public int <EFJKFOPHJNH>k__BackingField;    // 0x0x10
    public bool <OGDJJLNEODA>k__BackingField;    // 0x0x14
    public DateTime <MHMOOLCOMHB>k__BackingField;    // 0x0x18
    public bool <JGFENIFECMA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BHEFEOCEOJC
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class BHEFEOCEOJC
{
    public List<IBEMBLNCLJE> <AJPNKGMNICD>k__BackingField;    // 0x0x10
}
...
public class BIFPMOOCNMM
{
    public List<DHMHCGFLDEA> <LNJKFAACOCG>k__BackingField;    // 0x0x10
    public EOOHNHDHELD <ILBBJGCGIHI>k__BackingField;    // 0x0x18
}
...
// base   : BLMABLEJOFL
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{dAFHFGCBPCL}   [Service.Econ]
public class BPDOCOLKLAJ : BLMABLEJOFL
{
    public int <LEOIIPPINNE>k__BackingField;    // 0x0x30
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x38
    public DateTime <JGGNHHPBFIC>k__BackingField;    // 0x0x40
    public DateTime <MGFHIDIEMEP>k__BackingField;    // 0x0x48
    public LPMAKBILGPG <BLBLIDFJEBP>k__BackingField;    // 0x0x50
    public KNBLNOONHBB <FDEFDOAJEOP>k__BackingField;    // 0x0x58
    public List<CACFJNGNAIN> <GOFEJLPNMNC>k__BackingField;    // 0x0x60
    public PBNDBIKGGCF <KKHEJIHEPHB>k__BackingField;    // 0x0x68
}
...
// base   : KNBLNOONHBB
//   (not directly referenced by a detected call)
public class CACFJNGNAIN : KNBLNOONHBB
{
    public int <IPLDJPOHLBA>k__BackingField;    // 0x0x68
    public List<COPDFBHMLCG> <CIAEKGOJOOK>k__BackingField;    // 0x0x70
    public List<COPDFBHMLCG> <AJBJIINGECI>k__BackingField;    // 0x0x78
    public List<COPDFBHMLCG> <IJJECOOEEKF>k__BackingField;    // 0x0x80
}
...
public class CAPLIFJDNGI
{
    public EOOHNHDHELD <ILBBJGCGIHI>k__BackingField;    // 0x0x10
}
...
public class CCKDIJMIFPP
{
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x10
    public string <PLBIDIIPELF>k__BackingField;    // 0x0x18
    public int? <MDJMOAMODBM>k__BackingField;    // 0x0x20
    public POKGCAJLAGP? <BLGGDOCMILG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// CIJECLJPGKH
//   (not directly referenced by a detected call)
public class CIJECLJPGKH
{
    public Guid <KOONAHIPMKF>k__BackingField;    // 0x0x10
    public int <BCHFLKDGMPA>k__BackingField;    // 0x0x20
    public int <BJIOFPOMFOP>k__BackingField;    // 0x0x24
    public Guid <EIFHDGLJNCI>k__BackingField;    // 0x0x28
    public DateTime <CDJGBKINGFP>k__BackingField;    // 0x0x38
    public FGPKEAKMMIM <LBEGDHHGBLH>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// CIMBIMDLDNI
//   (not directly referenced by a detected call)
public class CIMBIMDLDNI
{
    public int <EFNDMEFAIBA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// CKIPMFGBJPO
// base   : KJHGDBFNAOK`1<EMNLKCIAKAO>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{fALKJLPEIPI}   [Service.API]
public class CKIPMFGBJPO
{
    // (no instance fields in the metadata dump)
}
...
public class CLDDBBKFOJG
{
    public RoomKeyResult <LFLCEGCIION>k__BackingField;    // 0x0x10
    public FHHHIKOHPNK <PICNOFMCNEG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// COPDFBHMLCG
//   (not directly referenced by a detected call)
public class COPDFBHMLCG
{
    public bool <DNEEFHBICEM>k__BackingField;    // 0x0x10
    public PPPMIEAGFIE <PMPCDENLDBK>k__BackingField;    // 0x0x18
    public float <POCGENKDHKP>k__BackingField;    // 0x0x20
}
...
public class CPLOONMGFHG
{
    public long <LHMLGGGPDPH>k__BackingField;    // 0x0x10
    public long? <BININJEMHPD>k__BackingField;    // 0x0x18
    public long? <MHECPDCMEPO>k__BackingField;    // 0x0x28
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x38
    public string <PLBIDIIPELF>k__BackingField;    // 0x0x40
    public List<string> <AJPNKGMNICD>k__BackingField;    // 0x0x48
    public string <ELMJNFEOPHM>k__BackingField;    // 0x0x50
    public DateTime <FKFCEGPJKHB>k__BackingField;    // 0x0x58
    public DateTime <IMOJINJPLDB>k__BackingField;    // 0x0x60
    public LPKBLBJCKNG <BLGGDOCMILG>k__BackingField;    // 0x0x68
    public bool <DAPJJGJKPKM>k__BackingField;    // 0x0x6C
    public bool <AAHBIELHENI>k__BackingField;    // 0x0x6D
    public MABPFDBNDDD <KLMDHMFIIPD>k__BackingField;    // 0x0x70
    public MABPFDBNDDD <KCJDIMMLJEP>k__BackingField;    // 0x0x74
}
...
public class CPMNOMGGGEB : PILCIALAKPM
{
    public List<IBEMBLNCLJE> <AJPNKGMNICD>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// DEKFOCONBEI
//   RESPONSE PUT    api/roomconsumables   [Service.Econ]
public class DEKFOCONBEI
{
    public BIGEJJKIFHI <LFLCEGCIION>k__BackingField;    // 0x0x10
    public CIJECLJPGKH <IABJFIFNEGO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DHMHCGFLDEA
//   (not directly referenced by a detected call)
public class DHMHCGFLDEA
{
    public int <BHAEKCMFKKG>k__BackingField;    // 0x0x10
    public EOOHNHDHELD <ILBBJGCGIHI>k__BackingField;    // 0x0x14
}
...
public class DIFEDOHCHEH
{
    public string <GBGGKKIGAKH>k__BackingField;    // 0x0x10
    public string <IHPOMGDKEMM>k__BackingField;    // 0x0x18
    public string <OHMANCOJMEL>k__BackingField;    // 0x0x20
    public string <PLBIDIIPELF>k__BackingField;    // 0x0x28
    public string <KDNEMCGOMPA>k__BackingField;    // 0x0x30
    public EGBNFAKCIDA <LFLCEGCIION>k__BackingField;    // 0x0x38
    public List<string> <GPMOCMOCNHH>k__BackingField;    // 0x0x40
    public List<string> <AJPNKGMNICD>k__BackingField;    // 0x0x48
    public string <FDOMJJCPDBK>k__BackingField;    // 0x0x50
    public List<PMLEHEENNOB> <MALJFEBOKNF>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// DNAJHJDHBLH
//   (not directly referenced by a detected call)
public class DNAJHJDHBLH
{
    public Guid <GOLBNIOCODG>k__BackingField;    // 0x0x10
    public Guid <EDFDHGOILDL>k__BackingField;    // 0x0x20
    public DateTime <JGGNHHPBFIC>k__BackingField;    // 0x0x30
    public List<PPPMIEAGFIE> <DJGDFMDOBPL>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// DNLGOCCNAOH
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class DNLGOCCNAOH
{
    public NMGIHGEHJNF <CPNOEOEAIAE>k__BackingField;    // 0x0x10
    public int <BJBPJMNOLLA>k__BackingField;    // 0x0x14
    public long <JJIBONEBEKF>k__BackingField;    // 0x0x18
    public bool <OPGOIKCCFLH>k__BackingField;    // 0x0x20
    public string <AMPJBIOGKDG>k__BackingField;    // 0x0x28
    public int? <JOMEJGNIFCA>k__BackingField;    // 0x0x30
    public bool <HGLNMNNFGGJ>k__BackingField;    // 0x0x38
    public bool <JGEBEKBMBMJ>k__BackingField;    // 0x0x39
    public bool <NEFCOHGNKGD>k__BackingField;    // 0x0x3A
    public bool <BLIOIGMMKFD>k__BackingField;    // 0x0x3B
    public string <ABMDBPLMGOJ>k__BackingField;    // 0x0x40
    public DateTime? <GAOJBDICCKL>k__BackingField;    // 0x0x48
    public string <OIHFJCENMOC>k__BackingField;    // 0x0x58
    public bool <GEGCNBFAGHC>k__BackingField;    // 0x0x60
    public string <PLBBIPDKEIH>k__BackingField;    // 0x0x68
    public string <OMFIIAHOAJP>k__BackingField;    // 0x0x70
    public float <JKMAHHJHIFC>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// DOOJKDIHLPL
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class DOOJKDIHLPL
{
    public HPNCGAGGPDI <ILBBJGCGIHI>k__BackingField;    // 0x0x10
    public List<string> <AJPNKGMNICD>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// DPEPOAKHFDF
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class DPEPOAKHFDF
{
    public long <CODIGKCEBKH>k__BackingField;    // 0x0x10
    public KGDGFMMLKFB <IIJMLOANEOA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EAGKLIFNJAM
//   (not directly referenced by a detected call)
public class EAGKLIFNJAM
{
    public PILCIALAKPM <AGMKJCGFEOE>k__BackingField;    // 0x0x10
    public HKIKEMANEAF <LJMLNJEEMHK>k__BackingField;    // 0x0x18
}
...
public class EDNEMHJMHNM
{
    public List<PILCIALAKPM> <EIOMOALOLCB>k__BackingField;    // 0x0x10
    public string <PIPLLGJHOLA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EENICHPIHKA
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.Econ]
public class EENICHPIHKA
{
    public int NPOLMJHPEMJ;    // 0x0x10
    public long ICPMGFNBENF;    // 0x0x18
}
...
public class FBGPAKDPAEI
{
    public JBNEBPJJLNO <LFPNGPMHGCB>k__BackingField;    // 0x0x10
    public HEFEGBMFPEH <IFBHDABOFBN>k__BackingField;    // 0x0x18
    public int <POACNJOKGOP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FGPKEAKMMIM
//   (not directly referenced by a detected call)
public class FGPKEAKMMIM
{
    public Guid <KOONAHIPMKF>k__BackingField;    // 0x0x10
    public long <LHMLGGGPDPH>k__BackingField;    // 0x0x20
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x28
    public string <PLBIDIIPELF>k__BackingField;    // 0x0x30
    public string <ELMJNFEOPHM>k__BackingField;    // 0x0x38
    public long <MDJMOAMODBM>k__BackingField;    // 0x0x40
    public Guid? <AAMFHGLMCGF>k__BackingField;    // 0x0x48
    public DateTime <CDJGBKINGFP>k__BackingField;    // 0x0x60
    public int <GKIICMMNLEA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FHHHIKOHPNK
//   (not directly referenced by a detected call)
public class FHHHIKOHPNK
{
    public long <BIHEBMNAFLH>k__BackingField;    // 0x0x10
    public Guid <HMKFONHIBFL>k__BackingField;    // 0x0x18
    public long <LHMLGGGPDPH>k__BackingField;    // 0x0x28
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x30
    public string <PLBIDIIPELF>k__BackingField;    // 0x0x38
    public int <MDJMOAMODBM>k__BackingField;    // 0x0x40
    public Guid? <AAMFHGLMCGF>k__BackingField;    // 0x0x44
    public DateTime <NCGIKLIPDII>k__BackingField;    // 0x0x58
    public string <ELMJNFEOPHM>k__BackingField;    // 0x0x60
    public AKMHPKCGMLM <IIJMLOANEOA>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FNEHFHNIKNF
//   (not directly referenced by a detected call)
public class FNEHFHNIKNF
{
    public int <OBIKMOHOCPC>k__BackingField;    // 0x0x10
    public DateTime? <PDDKDOFJJNH>k__BackingField;    // 0x0x18
    public DateTime? <KCHLMDHFAAG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// FODGGCAJNNK
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{cLNGGGMIBPI}   [Service.API]
public class FODGGCAJNNK
{
    public uint <GBGGKKIGAKH>k__BackingField;    // 0x0x10
    public uint? <BFCPFAJCEPG>k__BackingField;    // 0x0x14
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x20
    public string <PLBIDIIPELF>k__BackingField;    // 0x0x28
    public DateTime <JONGBFBDMNK>k__BackingField;    // 0x0x30
    public DateTime? <NMEJINDMEFB>k__BackingField;    // 0x0x38
    public bool <JKBPIKBCHDC>k__BackingField;    // 0x0x48
    public List<DIFEDOHCHEH> <BAOLLOIBGAJ>k__BackingField;    // 0x0x50
    public List<string> <AJPNKGMNICD>k__BackingField;    // 0x0x58
    public int <DBHPKGPFNHM>k__BackingField;    // 0x0x60
    public int <OBKJDKNKLPN>k__BackingField;    // 0x0x64
    public int <EAGOOHDLOLF>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// GKBFLNOPNEC
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class GKBFLNOPNEC
{
    public int <BCHFLKDGMPA>k__BackingField;    // 0x0x10
    public Guid <LPCCKOFICIM>k__BackingField;    // 0x0x14
    public long <AFAADIMHAFB>k__BackingField;    // 0x0x28
    public DateTime <CDJGBKINGFP>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GKHNGKFINAC
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.API]
public class GKHNGKFINAC
{
    public List<long> <JHIKBFLJHEG>k__BackingField;    // 0x0x10
    public HEDAJLMGGPL <IIJMLOANEOA>k__BackingField;    // 0x0x18
    public string <ANFCGBGHIEN>k__BackingField;    // 0x0x20
    public long? <LHMLGGGPDPH>k__BackingField;    // 0x0x28
}
...
public class GOHBIOPEPAD
{
    public List<int> <BALEOABIKLJ>k__BackingField;    // 0x0x10
    public string <PIPLLGJHOLA>k__BackingField;    // 0x0x18
}
...
// HCKCDAENNPJ
//   (not directly referenced by a detected call)
public class HCKCDAENNPJ
{
    public DIDJNLAOFJB BPGMMOLDEEA;    // 0x0x10
    public int CIFMENELDNC;    // 0x0x14
}

// --------------------------------------------------------------------------
// HEFEGBMFPEH
//   (not directly referenced by a detected call)
public class HEFEGBMFPEH
{
    public long <MDJMOAMODBM>k__BackingField;    // 0x0x10
    public Guid? <LPCCKOFICIM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HELBJNOLKJJ
//   REQUEST  POST   api/equipment/v1/update   [Service.Econ]
public class HELBJNOLKJJ
{
    public string <CJAEBBOJAPB>k__BackingField;    // 0x0x10
    public string <LFENJAEGIPO>k__BackingField;    // 0x0x18
    public string <LHJJJIFLFPP>k__BackingField;    // 0x0x20
    public string <BJDHCMKIPBC>k__BackingField;    // 0x0x28
    public EBJFCGJIDIH <LKBLGOMEHPM>k__BackingField;    // 0x0x30
    public string <CDLGAKICLHB>k__BackingField;    // 0x0x38
    public bool FABAFIBDNLB;    // 0x0x40
    public bool <EKAHAIBPHPH>k__BackingField;    // 0x0x41
}

// --------------------------------------------------------------------------
// HENADDAEPEG
//   (not directly referenced by a detected call)
public class HENADDAEPEG
{
    public float <ADDPCDKJEGK>k__BackingField;    // 0x0x10
    public float <JALLCOKAAEL>k__BackingField;    // 0x0x14
    public float <HECLJBCKLEK>k__BackingField;    // 0x0x18
    public float <PPBFKFNMKEC>k__BackingField;    // 0x0x1C
    public float <PMOBDKEELFO>k__BackingField;    // 0x0x20
    public float <GBGCEDBPDCH>k__BackingField;    // 0x0x24
    public float <ENMDPMEOKEA>k__BackingField;    // 0x0x28
    public float <PFJBJFNLDEA>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// HKIKEMANEAF
//   (not directly referenced by a detected call)
public class HKIKEMANEAF
{
    public long <JAHCDIJOIEN>k__BackingField;    // 0x0x10
    public long <CODIGKCEBKH>k__BackingField;    // 0x0x18
    public int <LEAEPDOGGKA>k__BackingField;    // 0x0x20
    public DateTime <NCGIKLIPDII>k__BackingField;    // 0x0x28
    public KGDGFMMLKFB <IIJMLOANEOA>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// HLODFJGGHGI
//   RESPONSE GET    api/config/v2   [Service.API]
public class HLODFJGGHGI
{
    public Dictionary<int, int> <ALGOMEHAPMM>k__BackingField;    // 0x0x10
    public List<OEAFACBDDJC> <GFFHHECOHJA>k__BackingField;    // 0x0x18
    public HCKCDAENNPJ[][] <NOPDBCGOJDN>k__BackingField;    // 0x0x20
    public JMDMLGPAFHI <NADLBHDJDIM>k__BackingField;    // 0x0x28
    public HENADDAEPEG <ALAFEGIACMC>k__BackingField;    // 0x0x30
    public IMGIEAOBDBJ <IENFMFLHOBD>k__BackingField;    // 0x0x38
    public CIMBIMDLDNI <NIHJLPJBLIM>k__BackingField;    // 0x0x40
    public IEJLMABIPIL <OEJNBMFEKEK>k__BackingField;    // 0x0x48
    public string <AAMBKAAEHPH>k__BackingField;    // 0x0x50
}
...
public class HOBPLKPEHDG
{
    public LHBKFFHMLKB <CFGDBHGPIHA>k__BackingField;    // 0x0x10
    public string <FGMFKKOCFDD>k__BackingField;    // 0x0x18
    public string <LHJJJIFLFPP>k__BackingField;    // 0x0x20
    public string <BJDHCMKIPBC>k__BackingField;    // 0x0x28
    public EBJFCGJIDIH <LKBLGOMEHPM>k__BackingField;    // 0x0x30
    public string <JFHCEKHBJNM>k__BackingField;    // 0x0x38
    public int <JIIPBIBMLMK>k__BackingField;    // 0x0x40
    public bool <FKHDDBCKGGD>k__BackingField;    // 0x0x44
    public string <NOMNFFFMIAA>k__BackingField;    // 0x0x48
    public DateTime <NCGIKLIPDII>k__BackingField;    // 0x0x50
}
...
// IBEKCKGJFCJ
//   (not directly referenced by a detected call)
public class IBEKCKGJFCJ
{
    public BHKEDJFHKGB <IIJMLOANEOA>k__BackingField;    // 0x0x10
    public int? <OLLADGGOMCH>k__BackingField;    // 0x0x14
    public Guid? <NOCDHPAMDNF>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// IBEMBLNCLJE
//   (not directly referenced by a detected call)
public class IBEMBLNCLJE
{
    public string <PJLKNNCDPCM>k__BackingField;    // 0x0x10
    public IOLKEAPEMPA <IIJMLOANEOA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IBIIIJHJFDC
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class IBIIIJHJFDC
{
    public Dictionary<Guid, IHEIMPEPALO> <OCLBKLGDNML>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IEJLMABIPIL
//   (not directly referenced by a detected call)
public class IEJLMABIPIL
{
    public float <KLGIPNGACFF>k__BackingField;    // 0x0x10
}
...
// IHEIMPEPALO
//   (not directly referenced by a detected call)
public class IHEIMPEPALO
{
    public int <POACNJOKGOP>k__BackingField;    // 0x0x10
    public JBNEBPJJLNO <LFPNGPMHGCB>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/playerevents/v2/delete/{dJMGDOGJEPO}   [Service.API]
...
public class IJKGDGOLOLD
{
    public CPMNOMGGGEB <AGMKJCGFEOE>k__BackingField;    // 0x0x10
    public EOOHNHDHELD <ILBBJGCGIHI>k__BackingField;    // 0x0x18
    public DOOJKDIHLPL <LCIJADJNAGE>k__BackingField;    // 0x0x20
}
...
// IMGIEAOBDBJ
//   (not directly referenced by a detected call)
public class IMGIEAOBDBJ
{
    public int <LALAINLDFPP>k__BackingField;    // 0x0x10
    public DateTime <KKGOLAONODH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// INKLIJGCFJG
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Auth]
public class INKLIJGCFJG
{
    public Guid <FMHFGLNIMHF>k__BackingField;    // 0x0x10
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x20
    public string <ELMJNFEOPHM>k__BackingField;    // 0x0x28
    public DateTime <JGGNHHPBFIC>k__BackingField;    // 0x0x30
    public DateTime? <CODPOAEBBBA>k__BackingField;    // 0x0x38
    public List<DNAJHJDHBLH> <ELCBOLLFHGC>k__BackingField;    // 0x0x48
}
...
public class IOMEBPKCPNF
{
    public int DOKEMIPIMFA;    // 0x0x10
    public int GNJHHPJBLEE;    // 0x0x14
}

// --------------------------------------------------------------------------
// IONFDBPCAHN
//   REQUEST  POST   api/relationships/v2/updateVoiceVolume   [Service.API]
public class IONFDBPCAHN
{
    public int <LEAEPDOGGKA>k__BackingField;    // 0x0x10
    public byte <AJLFDJMKLDE>k__BackingField;    // 0x0x14
}
...
public class IPGLJNHENBJ
{
    public bool <PMIIAICDPMB>k__BackingField;    // 0x0x10
    public string <AMPJBIOGKDG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JBAJHFOJFMC
// base   : KJHGDBFNAOK`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class JBAJHFOJFMC
{
    // (no instance fields in the metadata dump)
}
...
public class JBNEBPJJLNO
{
    public Guid? <IEDBBGMFCEB>k__BackingField;    // 0x0x10
    public Guid <GMEPEJBEAIH>k__BackingField;    // 0x0x24
}
...
public class JFIIEBJFGBH
{
    public Guid? <KOONAHIPMKF>k__BackingField;    // 0x0x10
    public long? <LHMLGGGPDPH>k__BackingField;    // 0x0x28
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x38
    public string <PLBIDIIPELF>k__BackingField;    // 0x0x40
    public string <ELMJNFEOPHM>k__BackingField;    // 0x0x48
    public HEFEGBMFPEH <JLNIGLOKFGF>k__BackingField;    // 0x0x50
}
...
public class JJPMONEPNKG
{
    public int <DLEECIJDFCJ>k__BackingField;    // 0x0x10
    public int <EFJKFOPHJNH>k__BackingField;    // 0x0x14
    public float <LIFEBIJCKLD>k__BackingField;    // 0x0x18
    public float <GPIAKCIBLDK>k__BackingField;    // 0x0x1C
    public bool <OGDJJLNEODA>k__BackingField;    // 0x0x20
    public bool <LCKHEIAEPJL>k__BackingField;    // 0x0x21
    public bool <EKAHAIBPHPH>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// JMDMLGPAFHI
//   (not directly referenced by a detected call)
public class JMDMLGPAFHI
{
    public int <PKFFKCMCJND>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JMGJMIGCOAO
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class JMGJMIGCOAO
{
    public bool <DCOFFHFFOIC>k__BackingField;    // 0x0x10
    public string <IHPOMGDKEMM>k__BackingField;    // 0x0x18
    public string <IBEPJMLFNEM>k__BackingField;    // 0x0x20
}
...
//   RESPONSE POST   api/progressionEvents/collect/{dJMGDOGJEPO}/{lOHFDINIMHO}   [Service.API]
public class KGCPCHPAGKE
{
    public long? <GBGGKKIGAKH>k__BackingField;    // 0x0x10
    public int <LEAEPDOGGKA>k__BackingField;    // 0x0x20
    public int? <HCMBKJIBOLI>k__BackingField;    // 0x0x24
    public string <NLMMMOOLACH>k__BackingField;    // 0x0x30
    public LHBKFFHMLKB? <CFGDBHGPIHA>k__BackingField;    // 0x0x38
    public string <JBLJPDCHIAA>k__BackingField;    // 0x0x40
    public Guid? <NDFJHNIDNDO>k__BackingField;    // 0x0x48
    public string <ILAGBHLBAHF>k__BackingField;    // 0x0x60
    public string <KFODCJBOBOG>k__BackingField;    // 0x0x68
    public LPMAKBILGPG <BLBLIDFJEBP>k__BackingField;    // 0x0x70
    public int <LFIAGGIFOCI>k__BackingField;    // 0x0x74
    public int <GOANPPCLHKO>k__BackingField;    // 0x0x78
    public PGIDFLAKNGN <GGLEHJLOHFD>k__BackingField;    // 0x0x7C
    public EBJFCGJIDIH <JEGPOKJPBAI>k__BackingField;    // 0x0x80
    public string <KIAECPOOKON>k__BackingField;    // 0x0x88
    public string <KGALOBOEJHF>k__BackingField;    // 0x0x90
    public bool <ENGCOJELJMD>k__BackingField;    // 0x0x98
    public BHKAGDNLKEG <DMAOCHLJCGI>k__BackingField;    // 0x0x9C
    public IMFBMEFPKNK <DGAJBFALPNO>k__BackingField;    // 0x0xA0
    public LPGACNHIPAP? <BJLGFGPMGMJ>k__BackingField;    // 0x0xA4
    public bool <NAMKAEFPMAJ>k__BackingField;    // 0x0xAC
    public bool <CLJHKPKGNDG>k__BackingField;    // 0x0xAD
    public string <LLCLPAGCOHD>k__BackingField;    // 0x0xB0
    public string <ONKIEOPLINK>k__BackingField;    // 0x0xB8
    public bool <ELPIEPFJKBP>k__BackingField;    // 0x0xC0
    public bool FDHAAJPHPGI;    // 0x0xC1
}
...
//   (not directly referenced by a detected call)
public class KHANOMCGPKB : ValueType
{
    public Guid OOOANFDGEED;    // 0x0x0
}
...
public class KLJEDCBEDMI : DHPMAFKHCBE
{
    public IFGHKIOOJOC? <BIMCGNLJCID>k__BackingField;    // 0x0x18
    public GKBFLNOPNEC <JGBJIKOKDPL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KMGAEAJKLEO
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class KMGAEAJKLEO
{
    public List<MJDODFPCHGF> <NJGDNDIIHIH>k__BackingField;    // 0x0x10
    public string <PIPLLGJHOLA>k__BackingField;    // 0x0x18
}
...
// KNBLNOONHBB
//   (not directly referenced by a detected call)
public class KNBLNOONHBB
{
    public int <PODEJLFLGEE>k__BackingField;    // 0x0x10
    public OGEHKOHMFFG <IIJMLOANEOA>k__BackingField;    // 0x0x14
    public List<PBNABDNEJDP> <IEOLFIMOJDN>k__BackingField;    // 0x0x18
    public List<PBNABDNEJDP> <GJJNDNBDMPK>k__BackingField;    // 0x0x20
    public bool <EMJJCDFDBHP>k__BackingField;    // 0x0x28
    public DateTime? <IEPIDKDOGCM>k__BackingField;    // 0x0x30
    public DateTime? <IAKEBHBDHAB>k__BackingField;    // 0x0x40
    public DateTime? <EEFOAKPJFEE>k__BackingField;    // 0x0x50
    public bool <NGDFMJIENCM>k__BackingField;    // 0x0x60
    public bool <AOMMMAKKFGG>k__BackingField;    // 0x0x61
}
...
public class KPJKJCFMIPO
{
    public Guid <LIPOLGJFHMG>k__BackingField;    // 0x0x10
    public long <JPOGHNNIGLI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// LEHPMEMCKGA
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.Econ]
public class LEHPMEMCKGA
{
    public List<string> <MPENNLODGFL>k__BackingField;    // 0x0x10
}
...
// base   : MOOGFFFPOEO
//   (not directly referenced by a detected call)
public class LIOOKEBEHEM : MOOGFFFPOEO
{
    public IHDNLHKBJIA FHACIBPEDGD;    // 0x0x20
}

// --------------------------------------------------------------------------
// LJGOBCHIAGI
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class LJGOBCHIAGI
{
    public int <JDDJCDJNKKP>k__BackingField;    // 0x0x10
    public int? <GNLGENINNHL>k__BackingField;    // 0x0x14
    public string <IGGFBJFHIGN>k__BackingField;    // 0x0x20
    public string <GHGPCCFIOJD>k__BackingField;    // 0x0x28
}
...
public class MHAHPGHHNPH
{
    public List<string> <FDKBDMCJPGO>k__BackingField;    // 0x0x10
    public List<string> <BJLLLDIDKPD>k__BackingField;    // 0x0x18
    public List<string> <CEDPCFHFGID>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MHJCEPKCFPN
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{mNAACFOHONJ}   [Service.API]
public class MHJCEPKCFPN
{
    public List<PILCIALAKPM> <GFDAFFIBJJB>k__BackingField;    // 0x0x10
    public List<EAGKLIFNJAM> <PIBMIAILJBI>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// MHJHNNINGBM
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.Econ]
public class MHJHNNINGBM
{
    public Guid <LPCCKOFICIM>k__BackingField;    // 0x0x10
    public int <IDDNPGLPMIB>k__BackingField;    // 0x0x20
    public long <KLFPDPDKLFP>k__BackingField;    // 0x0x28
    public Guid <LIPOLGJFHMG>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// MJDODFPCHGF
//   (not directly referenced by a detected call)
public class MJDODFPCHGF
{
    public int <LMFPGBOJBNK>k__BackingField;    // 0x0x10
    public DateTime <NCGIKLIPDII>k__BackingField;    // 0x0x18
    public DateTime? <AGCAOJOKNPH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MKOPCEPCEKG
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class MKOPCEPCEKG
{
    public int? <KAOCKEBMBMN>k__BackingField;    // 0x0x10
    public string <KDNEMCGOMPA>k__BackingField;    // 0x0x18
    public string <GFJCOOEPLAA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MLEONPHBAOI
//   REQUEST  POST   api/items/purchaseInfos   [Service.Econ]
public class MLEONPHBAOI
{
    public IReadOnlyList<LIOOKEBEHEM> <COHOMMKAPGE>k__BackingField;    // 0x0x10
}
...
public class NEBDOKBHGNN
{
    public Dictionary<Guid, DEKFOCONBEI> <KNMHFBCOFKE>k__BackingField;    // 0x0x10
}
...
public class OCLBBFHAOFM
{
    public int <OEPMGCOPKHP>k__BackingField;    // 0x0x10
    public MCHFEHGJJNJ <IIJMLOANEOA>k__BackingField;    // 0x0x14
    public IFONGPFLEDP <HDPNEEBCAJL>k__BackingField;    // 0x0x18
    public IFONGPFLEDP <CBNDBGIBGBB>k__BackingField;    // 0x0x1C
    public IFONGPFLEDP <KLJDKCGLDOJ>k__BackingField;    // 0x0x20
    public byte? <AJLFDJMKLDE>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// ODOJHDAGCGJ
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class ODOJHDAGCGJ
{
    public long <LHMLGGGPDPH>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <KABKIBPFIBC>k__BackingField;    // 0x0x18
    public OHCDLPILAJC <AHBIFFPLBEG>k__BackingField;    // 0x0x20
}
...
public class OJNCCHBDBBO
{
    public long <BIHEBMNAFLH>k__BackingField;    // 0x0x10
    public int <BCHFLKDGMPA>k__BackingField;    // 0x0x18
}
...
public class ONANABFBLHH : DHPMAFKHCBE
{
    public LIKLNMJLDJD? <BIMCGNLJCID>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <CJJNOLPKKIM>k__BackingField;    // 0x0x20
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class PBBHALCOHCB : ValueType
{
    public PPDJPCBBHNI EEKLKEKCBLF;    // 0x0x0
    public KHANOMCGPKB CENJOCIOHOL;    // 0x0x10
    public Guid CDAPHDPIEII;    // 0x0x20
}

// --------------------------------------------------------------------------
// PBNABDNEJDP
//   (not directly referenced by a detected call)
public class PBNABDNEJDP
{
    public LPMAKBILGPG <BLBLIDFJEBP>k__BackingField;    // 0x0x10
    public int <MDJMOAMODBM>k__BackingField;    // 0x0x14
    public FNEHFHNIKNF <JCENGPDLKKM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// PBNDBIKGGCF
//   (not directly referenced by a detected call)
public class PBNDBIKGGCF
{
    public bool <IPDMHPNJKLA>k__BackingField;    // 0x0x10
    public IMFBMEFPKNK <AHOJHCLAJMN>k__BackingField;    // 0x0x14
    public int <APKOJGJICNL>k__BackingField;    // 0x0x18
    public DateTime <CDJGBKINGFP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PDCHLPLOIPF
//   RESPONSE GET    api/storefronts/v1/trialInvention/duration   [Service.Econ]
public class PDCHLPLOIPF
{
    public int <BJBPJMNOLLA>k__BackingField;    // 0x0x10
}
...
public class PEOIIPACFBP
{
    public JMGKKLIOJLM <CPNOEOEAIAE>k__BackingField;    // 0x0x10
    public string <ABJGJHFAMLJ>k__BackingField;    // 0x0x18
    public int? <NBPCJMNOOGJ>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PGDIMCFAIKH
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class PGDIMCFAIKH
{
    public int <AEIHOBBMEGK>k__BackingField;    // 0x0x10
    public int <LJFOFIEHJPJ>k__BackingField;    // 0x0x14
    public float <BMDCJBLIEHP>k__BackingField;    // 0x0x18
    public int <FPAMBLDELNB>k__BackingField;    // 0x0x1C
    public int <MKIDLBHGEMI>k__BackingField;    // 0x0x20
    public int <GEKFKHLKKBP>k__BackingField;    // 0x0x24
    public int <CCDBBFGPJCE>k__BackingField;    // 0x0x28
    public string <LPBOJMAFMMK>k__BackingField;    // 0x0x30
    public string <HHJAGBCFGJN>k__BackingField;    // 0x0x38
}
...
// PHMLDJDKPCI
//   (not directly referenced by a detected call)
public class PHMLDJDKPCI
{
    public IBEKCKGJFCJ <CIALEMOEPBJ>k__BackingField;    // 0x0x10
    public long <GKFKLJHHBJE>k__BackingField;    // 0x0x18
    public GiftItemDTO <MLKOMCPGEDD>k__BackingField;    // 0x0x20
    public long? <DIAOLBIJNAM>k__BackingField;    // 0x0x28
    public int <JFPDEMNLMCG>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// PIJHAADEFNM
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class PIJHAADEFNM
{
    public long <BIHEBMNAFLH>k__BackingField;    // 0x0x10
    public int <BCHFLKDGMPA>k__BackingField;    // 0x0x18
}
...
// PILCIALAKPM
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class PILCIALAKPM
{
    public long <CODIGKCEBKH>k__BackingField;    // 0x0x10
    public int <AKDHEHOBIPD>k__BackingField;    // 0x0x18
    public long <LHMLGGGPDPH>k__BackingField;    // 0x0x20
    public long? <BININJEMHPD>k__BackingField;    // 0x0x28
    public long? <MHECPDCMEPO>k__BackingField;    // 0x0x38
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x48
    public string <PLBIDIIPELF>k__BackingField;    // 0x0x50
    public string <ELMJNFEOPHM>k__BackingField;    // 0x0x58
    public DateTime <FKFCEGPJKHB>k__BackingField;    // 0x0x60
    public DateTime <IMOJINJPLDB>k__BackingField;    // 0x0x68
    public int <MACMJKCDKME>k__BackingField;    // 0x0x70
    public LPKBLBJCKNG <BLGGDOCMILG>k__BackingField;    // 0x0x74
    public bool <DAPJJGJKPKM>k__BackingField;    // 0x0x78
    public bool <AAHBIELHENI>k__BackingField;    // 0x0x79
    public MABPFDBNDDD <KLMDHMFIIPD>k__BackingField;    // 0x0x7C
    public MABPFDBNDDD <KCJDIMMLJEP>k__BackingField;    // 0x0x80
    public long? <DAHHFKENNNN>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// PJCALAEJOFA
//   REQUEST  POST   api/items/bulkpurchase   [Service.Commerce]
public class PJCALAEJOFA
{
    public List<PHMLDJDKPCI> <HPIIIPHLDMO>k__BackingField;    // 0x0x10
    public BKFNKFFICGC? <LGPLBEIENCM>k__BackingField;    // 0x0x18
    public LPMAKBILGPG <BLBLIDFJEBP>k__BackingField;    // 0x0x20
    public bool <IHHPNGJPKPM>k__BackingField;    // 0x0x24
    public bool <GHHGOMNLFBB>k__BackingField;    // 0x0x25
    public Guid? <LHEACHABPJB>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// PMLEHEENNOB
//   (not directly referenced by a detected call)
public class PMLEHEENNOB
{
    public DateTime <NCGIKLIPDII>k__BackingField;    // 0x0x10
    public string <NKBMGPFFNGG>k__BackingField;    // 0x0x18
}
...
public class POKPBCMOEIF
{
    public NMGIHGEHJNF <CPNOEOEAIAE>k__BackingField;    // 0x0x10
    public long <CODIGKCEBKH>k__BackingField;    // 0x0x18
    public string <ABJGJHFAMLJ>k__BackingField;    // 0x0x20
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class PPDJPCBBHNI : ValueType
{
    public Guid OOOANFDGEED;    // 0x0x0
}
...
// PPPMIEAGFIE
//   (not directly referenced by a detected call)
public class PPPMIEAGFIE
{
    public int <AMMLCLOIJIP>k__BackingField;    // 0x0x10
    public string <LHJJJIFLFPP>k__BackingField;    // 0x0x18
    public string <BJDHCMKIPBC>k__BackingField;    // 0x0x20
    public string <JFHCEKHBJNM>k__BackingField;    // 0x0x28
    public string <NLMMMOOLACH>k__BackingField;    // 0x0x30
    public PBBHALCOHCB? <GNINJBHGMKF>k__BackingField;    // 0x0x38
    public string <JBLJPDCHIAA>k__BackingField;    // 0x0x70
    public Guid? <NDFJHNIDNDO>k__BackingField;    // 0x0x78
    public LHBKFFHMLKB? <CFGDBHGPIHA>k__BackingField;    // 0x0x8C
    public string <ILAGBHLBAHF>k__BackingField;    // 0x0x98
    public string <KFODCJBOBOG>k__BackingField;    // 0x0xA0
    public bool <HEFHOBMBOOJ>k__BackingField;    // 0x0xA8
    public bool <AOGJBKDGJHA>k__BackingField;    // 0x0xA9
    public bool <PCPEGIHFALB>k__BackingField;    // 0x0xAA
    public EBJFCGJIDIH <LKBLGOMEHPM>k__BackingField;    // 0x0xAC
    public LPMAKBILGPG <BLBLIDFJEBP>k__BackingField;    // 0x0xB0
    public int <LFIAGGIFOCI>k__BackingField;    // 0x0xB4
    public OGFBEMPGJHE <JLHCPAKBILC>k__BackingField;    // 0x0xB8
    public PGIDFLAKNGN <FHJBBDPIFPM>k__BackingField;    // 0x0xBC
    public int? <EGCCINEBKEN>k__BackingField;    // 0x0xC0
    public string <LMKNLFPIGDD>k__BackingField;    // 0x0xC8
    public int? <JIIPBIBMLMK>k__BackingField;    // 0x0xD0
    public int? <PILDPMEOEKJ>k__BackingField;    // 0x0xD8
    public string <CDLGAKICLHB>k__BackingField;    // 0x0xE0
}
...
public class AddKeepsakeInstanceRequest
{
    public long <LHMLGGGPDPH>k__BackingField;    // 0x0x10
    public long? <BININJEMHPD>k__BackingField;    // 0x0x18
    public IJIHCOGNCDJ <OGELPNEDBBM>k__BackingField;    // 0x0x28
}
...
{
    public NLFMAKJNMGO <ILBBJGCGIHI>k__BackingField;    // 0x0x10
    public string <BHCAFMODLHK>k__BackingField;    // 0x0x18
    public string <BAFCGHCHAMO>k__BackingField;    // 0x0x20
    public string <HHEAKDKAKPI>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public LPMAKBILGPG <CurrencyType>k__BackingField;    // 0x0x18
    public LPGACNHIPAP <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<LHDJJNGKIAB<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <CODIGKCEBKH>k__BackingField;    // 0x0x10
    public long? <PFMOEMKCLFK>k__BackingField;    // 0x0x18
}
...
{
    public string <DGCNHIFFAKG>k__BackingField;    // 0x0x10
    public int <ACANIBBIOGG>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public GIAEHMBCDIH FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public PGIDFLAKNGN <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public IJIHCOGNCDJ <FIHMODAFLKP>k__BackingField;    // 0x0x10
    public string <AEAJJHMJBJE>k__BackingField;    // 0x0x18
    public int <IGGBJLJHPPK>k__BackingField;    // 0x0x20
    public int <MMPEHHPEEJG>k__BackingField;    // 0x0x24
    public string <GAPBPPCOFKB>k__BackingField;    // 0x0x28
    public string <GPGMMGKCLAE>k__BackingField;    // 0x0x30
}
...
{
    public int <BCHFLKDGMPA>k__BackingField;    // 0x0x10
    public Guid <FDIMPFEHHFI>k__BackingField;    // 0x0x14
    public DateTime <GOALANOJPAL>k__BackingField;    // 0x0x28
}
...
{
    public bool <IJEOLGLFFCK>k__BackingField;    // 0x0x10
    public int <KGNCKLDAEMF>k__BackingField;    // 0x0x14
    public bool <CEEOILBOHNB>k__BackingField;    // 0x0x18
}
...
{
    public Guid <FDIMPFEHHFI>k__BackingField;    // 0x0x10
    public IJIHCOGNCDJ <LGLANMLPKOL>k__BackingField;    // 0x0x20
    public int <ALPDOPCAICP>k__BackingField;    // 0x0x24
    public long <LHMLGGGPDPH>k__BackingField;    // 0x0x28
    public long? <BININJEMHPD>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{jAMKCCNJKDH}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <MNOOKKFEPMB>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <HNFLGMHBNFO>k__BackingField;    // 0x0x18
}
...
{
    public long <DJCIOFKFGAP>k__BackingField;    // 0x0x10
    public long <LHMLGGGPDPH>k__BackingField;    // 0x0x18
    public long <ABNDGPFFPAO>k__BackingField;    // 0x0x20
    public CFEADMJDODF <IIJMLOANEOA>k__BackingField;    // 0x0x28
    public int <FAPPANFINND>k__BackingField;    // 0x0x2C
}
...
{
    public long <LHMLGGGPDPH>k__BackingField;    // 0x0x10
    public List<Guid> <EKLDOLLNGOJ>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <MNOOKKFEPMB>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <HNFLGMHBNFO>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <LPGDOJKNIAA>k__BackingField;    // 0x0x20
}
...
{
    public long <ABNDGPFFPAO>k__BackingField;    // 0x0x10
    public long <HJFMFKHBDKD>k__BackingField;    // 0x0x18
    public int? <KIDPGBGFLHK>k__BackingField;    // 0x0x20
    public int? <BJJFCPGDIII>k__BackingField;    // 0x0x28
    public long? <MNAMMKKBIIG>k__BackingField;    // 0x0x30
    public long <HCIDCMHPJHF>k__BackingField;    // 0x0x40
    public long <IDDJJDLBIMN>k__BackingField;    // 0x0x48
    public int <EJPDKOADPJI>k__BackingField;    // 0x0x50
    public CFEADMJDODF <HPIPDFPFOAB>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <JECBHNOPOEN>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public PGIDFLAKNGN <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public JPNNICBILFM creatorAccountRole;    // 0x0x68
...
{
    public EALHCEOPBPH <LDIPLEBPBMC>k__BackingField;    // 0x0x10
    public KPGLEMCFPOK <AHIPOOINALL>k__BackingField;    // 0x0x14
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x18
    public string <PLBIDIIPELF>k__BackingField;    // 0x0x20
    public bool <GILAMGCCPNB>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<EALHCEOPBPH> <DCPPBEHPJKH>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{dJMGDOGJEPO}   [Service.API]
public class ProgressionEventDTO
{
    public long <HJFMFKHBDKD>k__BackingField;    // 0x0x10
    public string <IAEDANJNBCH>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <IJJECOOEEKF>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <BEDINAFJJHH>k__BackingField;    // 0x0x28
    public DateTime <FKFCEGPJKHB>k__BackingField;    // 0x0x30
    public DateTime <IMOJINJPLDB>k__BackingField;    // 0x0x38
    public DateTime <JPFNGCPDMFI>k__BackingField;    // 0x0x40
    public bool <JDCNHFIDALA>k__BackingField;    // 0x0x48
    public int <JOAMMKKGFGE>k__BackingField;    // 0x0x4C
    public float <MJJCDPCJDCL>k__BackingField;    // 0x0x50
    public Guid? <PMPLDEAGMIC>k__BackingField;    // 0x0x54
    public string <DIIPAMBHIGO>k__BackingField;    // 0x0x68
    public string <EOODILBABIG>k__BackingField;    // 0x0x70
    public string <GAGFMEOJHBP>k__BackingField;    // 0x0x78
    public string <PIDJPLLOCBP>k__BackingField;    // 0x0x80
}
...
{
    public Guid <LNLAOCOJPPC>k__BackingField;    // 0x0x10
    public int <FDCAKEOIHGC>k__BackingField;    // 0x0x20
    public int <JEKCJCBGGJB>k__BackingField;    // 0x0x24
    public int <POCELBICMDM>k__BackingField;    // 0x0x28
    public long <BKPOAONILMK>k__BackingField;    // 0x0x30
    public long <EEJBHOKBHEI>k__BackingField;    // 0x0x38
}
...
{
    public int <BCHFLKDGMPA>k__BackingField;    // 0x0x10
    public int <GOANPPCLHKO>k__BackingField;    // 0x0x14
    public int <HJCPLACCNJM>k__BackingField;    // 0x0x18
    public int <JGDEFHEOBMI>k__BackingField;    // 0x0x1C
    public int <FGLEEMMGOGC>k__BackingField;    // 0x0x20
    public DateTime? <MCAFHEHNCMC>k__BackingField;    // 0x0x28
    public int <HDLNFLIPOIF>k__BackingField;    // 0x0x38
}
...
{
    public long <LFLDNKHCGOL>k__BackingField;    // 0x0x10
    public int <AMMLCLOIJIP>k__BackingField;    // 0x0x18
    public string <ELMJNFEOPHM>k__BackingField;    // 0x0x20
    public int <GOANPPCLHKO>k__BackingField;    // 0x0x28
    public int <LPAIOJANJHA>k__BackingField;    // 0x0x2C
    public bool <MCICJNDCIAJ>k__BackingField;    // 0x0x30
    public bool <EMIGDJGIJJP>k__BackingField;    // 0x0x31
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public APEIBEALMAP <Permission>k__BackingField;    // 0x0x18
    public POKGCAJLAGP <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<KABIKKKCFIN<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public LNMFMMOAECP ReportCategory;    // 0x0x20
}
...
public class ReplicationUnityAssetsDTO
{
    ...
    public List<JAFANIIOBOG> <UnityAssets>k__BackingField;    // 0x0x18
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public POKGCAJLAGP <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public DMNENCMEDHB <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<IHGHKIHFKLE> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{cEKMGCDJKKL}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool ADLBINPCIDJ;    // 0x0x28
}
...
{
    public OLHFBJEPJEH? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public OLHFBJEPJEH HKNFCCJCEAK;  // wrapper
...
{
    public BHKAGDNLKEG DAEPDJIGCBD;  // wrapper
...
{
    public HCKPHMCAPCJ IIHAKBEOLJD;  // wrapper
    public int? MADHKHCJBHN;  // wrapper
...
{
    public NMGIHGEHJNF LNJMJDNNNKP;  // wrapper
...
{
    public byte[] NGIAGNLBILI;  // wrapper
    public MCABALGNILK AAHONCBJBPG;  // wrapper
...
{
    public NMGIHGEHJNF MCOPPHDEHDM;  // wrapper
    public float? IPPDHHMPHOA;  // wrapper
    public bool? IJOIKFLOJKM;  // wrapper
...
{
    public List<PBBHALCOHCB> desc;  // wrapper
}
...
{
    public PGIDFLAKNGN HFJHENFIDEF;  // wrapper
    public PGIDFLAKNGN? CMDAEBCMIDP;  // wrapper
...
{
    public ChatMessage AFDNIPHJHMO;  // wrapper
    public NDBBACIJABK MCOPPHDEHDM;  // wrapper
...
{
    public POKGCAJLAGP LGGIEAFHOLJ;  // wrapper
    public KAEFFAOLCBH PKECAGHNDBB;  // wrapper
    public ODFKOOMFCJO PPNALKFHLEN;  // wrapper
    public ODFKOOMFCJO BBPDLGLOEOL;  // wrapper
...
// api/customAvatarItems/v1/{nPMPEIAPAOF}/appeal  [API POST]
public class CustomAvatarItemsV1NPMPEIAPAOFAppealRequest
{
    public Guid NPMPEIAPAOF;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{fALKJLPEIPI}  [API GET]
public class CustomAvatarItemsV2FromCreatorFALKJLPEIPIRequest
{
...
{
    public OIPNAENOLDL OPLKKCFPIBB;  // wrapper
    public PGIDFLAKNGN? HJAIGIFKEID;  // wrapper
...
{
    public LFOHPIMHBBO BHINOAHINLP;  // wrapper
...
{
    public int? BJMOAIPPFNC;  // wrapper
    public Guid? NPMPEIAPAOF;  // wrapper
...
// api/keepsakes/{dBIALNJHNFJ}/collect  [API POST]
public class KeepsakesDBIALNJHNFJCollectRequest
{
    public Guid DBIALNJHNFJ;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public HEDAJLMGGPL GKFMCKLNDPA;  // wrapper
    public long? DCONEHIDLCB;  // wrapper
...
{
    public Guid ONOLAMODLNB;  // wrapper
...
{
    public Guid HIOJDFDKFCG;  // wrapper
...
{
    public Guid HIOJDFDKFCG;  // wrapper
    public long? GBNPHKOCHBO;  // wrapper
    public byte? PDPKIFONADM;  // wrapper
    public int? IFBOGFLAOGG;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid ONOLAMODLNB;  // wrapper
    public long? FJDKBIOMMOM;  // wrapper
    public long? EGEKCECLJKJ;  // wrapper
    public int? ANNGKNJEELJ;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> FGEMBJJOPFK;  // wrapper
...
{
    public AKMHPKCGMLM IIHAKBEOLJD;  // wrapper
    public Guid? GNLEHMIANKJ;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public NMGIHGEHJNF MCOPPHDEHDM;  // wrapper
    public long? GCCPKOBBHHO;  // wrapper
    public Guid? DBCKKPBCHLI;  // wrapper
    public int? JLMPKGEEFNG;  // wrapper
...
{
    public Guid HJHLEKDFIKC;  // wrapper
...
{
    public Guid JDEDLLCJFOL;  // wrapper
...
{
    public EGBNFAKCIDA KDCENPAFGPI;  // wrapper
}
