...
// DTO classes: 624 (plus referenced enums)
...
{
    public HVKVUJZXNUD<PNGBXTCDDKS, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public CGOWFXVOVPF<PNGBXTCDDKS, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public QBUZPCMMQEU CircuitsManager;    // 0x0x10
    public Id32<NAXUEJSETKJ> ClientId;    // 0x0x18
    public PNGBXTCDDKS Network;    // 0x0x20
}
...
{
    public Result<object, GOLLTPPMOJR>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.JYNMZFJHINI
//   (not directly referenced by a detected call)
public class DiceResult : JYNMZFJHINI
{
    // (no instance fields in the metadata dump)
}
...
{
    public ZWBQGEKCHWS _deps;    // 0x0x0
    public GGQWPRURVBI _staticNetSys;    // 0x0x8
}
...
// --------------------------------------------------------------------------
// Moq.Language.Flow.IReturnsResult`1
//   (not directly referenced by a detected call)
public class IReturnsResult
{
    // (no instance fields in the metadata dump)
}
...
public class DescribeImageRequestDTO
{
    public string <Model>k__BackingField;    // 0x0x10
    public string <Prompt>k__BackingField;    // 0x0x18
    public string <ImageURL>k__BackingField;    // 0x0x20
}
...
public class GameAIRoomSpendSummaryDTO
{
    ...
    public AIBalanceStatus <BalanceStatus>k__BackingField;    // 0x0x18
...
public class GenerateSpeechRequestDTO
{
    ...
    public bool <Streaming>k__BackingField;    // 0x0x38
}
...
{
    public IEnumerable<AwardRoomKeyRequest> items;    // 0x0x10
}
...
{
    public List<GNRYAHAJZBZ<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class AvatarEffectConfigDTO
{
    ...
    public DriverConfigDTO <PlayerVelocityDriverConfig>k__BackingField;    // 0x0x48
    public DriverConfigDTO <PlayerVoiceVolumeDriverConfig>k__BackingField;    // 0x0x50
    public DriverConfigDTO <PlayerHighFivesDriverConfig>k__BackingField;    // 0x0x58
}
...
public class DriverTypeBottleConfigDTO
{
    ...
    public string TextureName;    // 0x0x18
}
...
// base   : RecNet.SQZUKMLRTBM`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.CustomAvatarItemPagedResults
// base   : RecNet.Common.JBGLAGOJPBA`1<RecNet.CustomAvatarItem>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{fromcreatorId}   [Service.API]
public class CustomAvatarItemPagedResults
{
    // (no instance fields in the metadata dump)
}
...
{
    public int MinimumPriceInTokens;    // 0x0x10
    public int MaximumPriceInTokens;    // 0x0x14
}
...
{
    public string user_segment_algo_name;    // 0x0x10
    public string user_segment_algo_version;    // 0x0x18
    public string user_id;    // 0x0x20
    public string user_segment_value;    // 0x0x28
}
...
{
    public int AccountId;    // 0x0x10
    public long RoomKeyId;    // 0x0x18
}
...
{
    public IReadOnlyList<DoesPlayerOwnRoomKeyRequest> items;    // 0x0x10
}
...
public class DoesPlayerOwnRoomKeyResult
{
    public int AccountId;    // 0x0x10
    public long RoomKeyId;    // 0x0x18
    public bool DoesPlayerOwnRoomKey;    // 0x0x20
}
...
{
    public string <PrefabName>k__BackingField;    // 0x0x10
    public string <ModificationGuid>k__BackingField;    // 0x0x18
    public string <FriendlyName>k__BackingField;    // 0x0x20
    public string <Tooltip>k__BackingField;    // 0x0x28
    public GiftRarity <Rarity>k__BackingField;    // 0x0x30
    public string <ThumbnailImageName>k__BackingField;    // 0x0x38
    public bool VSVICKXJISG;    // 0x0x40
    public bool <IsDirty>k__BackingField;    // 0x0x41
}
...
//   RESPONSE POST   api/progressionEvents/collect/{id0}/{id1}   [Service.API]
public class GiftPackage
{
    ...
    public bool <Consumed>k__BackingField;    // 0x0xAC
    public bool <IsValid>k__BackingField;    // 0x0xAD
    public string <CustomMessage>k__BackingField;    // 0x0xB0
    public string <ErrorMessage>k__BackingField;    // 0x0xB8
    public bool <CanSpawnOnCurrentPlatform>k__BackingField;    // 0x0xC0
    public bool IsGifted;    // 0x0xC1
}
...
public class InAppMessageDTO
{
    ...
    public bool <QALFBJENUIW>k__BackingField;    // 0x0x38
    ...
    public string <IYKZYHKRFDQ>k__BackingField;    // 0x0x48
    public RFREONZAPSO <ContentObject>k__BackingField;    // 0x0x50
}
...
// --------------------------------------------------------------------------
// RecNet.KeepsakeCategoryConfigPagedResults
// base   : RecNet.Common.JBGLAGOJPBA`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class KeepsakeCategoryConfigPagedResults
{
    // (no instance fields in the metadata dump)
}
...
public class LoginResult : ValueType
{
    ...
    public YGJUKOZHHXU <SecurityCodeHint>k__BackingField;    // 0x0x8
...
public class ModerationBlockDetail
{
    ...
    public bool <IsVoiceModAutoban>k__BackingField;    // 0x0x39
    public bool <IsDeviceBan>k__BackingField;    // 0x0x3A
    public bool <IsWarning>k__BackingField;    // 0x0x3B
    public string <VoteKickReason>k__BackingField;    // 0x0x40
    public DateTime? <TimeoutStartedAt>k__BackingField;    // 0x0x48
    public string <AssociatedAccountUsername>k__BackingField;    // 0x0x58
    public bool <ShowCreatorCodeOfConduct>k__BackingField;    // 0x0x60
    public string <TopMessageOverride>k__BackingField;    // 0x0x68
    public string <BottomMessageOverride>k__BackingField;    // 0x0x70
    public float <BlockStartTime>k__BackingField;    // 0x0x78
}
...
public class NewInventionRequestDTO
{
    ...
    public AccountRoleType creatorAccountRole;    // 0x0x68
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.TRPMGKIGHKA/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.UFLREKKXKLN/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.NotificationDto_UGCStringAutoLocalizationJobNotificationDTO
// base   : RecNet.Notifications/NotificationDto`1<RecNet.UGCStringAutoLocalizationJobNotificationDTO>
//   (not directly referenced by a detected call)
public class NotificationDto_UGCStringAutoLocalizationJobNotificationDTO
{
    // (no instance fields in the metadata dump)
}
...
public class Objective
{
    ...
    public int RequiredScore;    // 0x0x14
}
...
// --------------------------------------------------------------------------
// RecNet.PlatformNotificationCategoryConfigPagedResultsDTO
// base   : RecNet.Common.JBGLAGOJPBA`1<RecNet.PlatformNotificationCategoryConfigDTO>
//   (not directly referenced by a detected call)
public class PlatformNotificationCategoryConfigPagedResultsDTO
{
    // (no instance fields in the metadata dump)
}
...
{
    public int <AccountId>k__BackingField;    // 0x0x10
    public int <Xp>k__BackingField;    // 0x0x14
    public int <GameMinutesToday>k__BackingField;    // 0x0x18
    public int <RewardsCollected>k__BackingField;    // 0x0x1C
    public int <BonusRewardsCollected>k__BackingField;    // 0x0x20
    public DateTime? <XpBoostLastPurchasedAt>k__BackingField;    // 0x0x28
    public int <PremiumRewardsCollected>k__BackingField;    // 0x0x38
}
...
public class ProgressionEventRewardDTO
{
    ...
    public int <GiftDropId>k__BackingField;    // 0x0x18
    public string <ImageName>k__BackingField;    // 0x0x20
    public int <Xp>k__BackingField;    // 0x0x28
    public int <RewardIndex>k__BackingField;    // 0x0x2C
    public bool <IsBonus>k__BackingField;    // 0x0x30
    public bool <IsRRPlusExclusive>k__BackingField;    // 0x0x31
}
...
//   REQUEST  POST   api/playerwarnings   [Service.API]
...
// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_UGCAddAutoLocalizedContentResponseDTO
// base   : RecNet.RecNetResultObject`1<RecNet.UGCAddAutoLocalizedContentResponseDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_UGCAddAutoLocalizedContentResponseDTO
{
    // (no instance fields in the metadata dump)
}

// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_UGCLocalizedContentResponseDTO
// base   : RecNet.RecNetResultObject`1<RecNet.UGCLocalizedContentResponseDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_UGCLocalizedContentResponseDTO
{
    // (no instance fields in the metadata dump)
}

// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_UGCStringAutoLocalizationScopeStatusDTO
// base   : RecNet.RecNetResultObject`1<RecNet.UGCStringAutoLocalizationScopeStatusDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_UGCStringAutoLocalizationScopeStatusDTO
{
    // (no instance fields in the metadata dump)
}
...
public class RoomOfferCreateOrUpdateRequestDTO
{
    ...
    public int? <MaxNumPurchasesPerPlayer>k__BackingField;    // 0x0x2C
    public int? <MaxCountPerPurchase>k__BackingField;    // 0x0x34
    public List<RoomOfferItemMappingDTO> <ItemMappings>k__BackingField;    // 0x0x40
    public Guid? <PriceUnitId>k__BackingField;    // 0x0x48
    public Guid? <OriginId>k__BackingField;    // 0x0x5C
    public bool <AllowRename>k__BackingField;    // 0x0x70
}
...
{
    public Guid OriginId;    // 0x0x10
    public long RoomId;    // 0x0x20
}
...
{
    public Guid <RoomOfferId>k__BackingField;    // 0x0x90
    public Guid? <PriceUnitId>k__BackingField;    // 0x0xA0
}
...
{
    public ObscuredInt <AccountId>k__BackingField;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<AccountRoleDTO> <Roles>k__BackingField;    // 0x0x120
    public IReadOnlyList<TagDTO> <Tags>k__BackingField;    // 0x0x128
    public IReadOnlyList<LoadScreenDTO> <LoadScreens>k__BackingField;    // 0x0x130
    public IReadOnlyList<string> <PromoImages>k__BackingField;    // 0x0x138
    public IReadOnlyList<ExternalContentReferenceDTO> <PromoExternalContent>k__BackingField;    // 0x0x140
    public SubRoomDataSaveModerationState <LastRoomModerationState>k__BackingField;    // 0x0x148
    public SubRoomDataSaveModerationState <CurrentRoomModerationState>k__BackingField;    // 0x0x149
    public IReadOnlyList<string> <FlaggedAssets>k__BackingField;    // 0x0x150
    public string <ModeratorMessage>k__BackingField;    // 0x0x158
    public RoomBanDetailsDTO <RoomBanDetails>k__BackingField;    // 0x0x160
    public Guid? <CurrentRoomLoadSnapshotId>k__BackingField;    // 0x0x168
    public Guid? <LatestRoomLoadSnapshotId>k__BackingField;    // 0x0x17C
    public Guid? <StagedRoomLoadSnapshotId>k__BackingField;    // 0x0x190
    public Guid? <CompatibleRoomLoadSnapshotId>k__BackingField;    // 0x0x1A4
    public RoomPublishStateAvailabilityDTO <PublishStateAvailability>k__BackingField;    // 0x0x1B8
    public IReadOnlyList<string> <RestrictedCircuitsAllowListNames>k__BackingField;    // 0x0x1C0
    public IReadOnlyList<string> LBMRUUHNXPO;    // 0x0x1C8
    public IReadOnlyList<string> GPYEXLYNJOU;    // 0x0x1D0
    public IReadOnlyList<string> RAXEBGVPHKO;    // 0x0x1D8
    public string VQCSWAQSMBT;    // 0x0x1E0
    public IReadOnlyList<string> PBDUWOPIFAT;    // 0x0x1E8
    public bool? SXJMTEUHOGX;    // 0x0x1F0
    public bool? RVJMAEQGERQ;    // 0x0x1F2
    public IReadOnlyList<ObscuredInt> RYOALAFIRKU;    // 0x0x1F8
    public IReadOnlyList<ObscuredInt> RNIKOCNNOLQ;    // 0x0x200
    public ObscuredInt? ZZIZXGSEQUL;    // 0x0x208
}
...
// --------------------------------------------------------------------------
// RecNet.Rooms.RoomSearchResultsDTO
// base   : RecNet.Common.JBGLAGOJPBA`1<RecNet.Rooms.RoomDTO>
//   (not directly referenced by a detected call)
public class RoomSearchResultsDTO
{
    // (no instance fields in the metadata dump)
}
...
// --------------------------------------------------------------------------
// RecNet.Rooms.SubRoomDataSavePagedResultsDTO
// base   : RecNet.Common.JBGLAGOJPBA`1<RecNet.Rooms.SubRoomDataSaveDTO>
//   (not directly referenced by a detected call)
public class SubRoomDataSavePagedResultsDTO
{
    // (no instance fields in the metadata dump)
}
...
// base   : RecNet.MVTXJTXFITM`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.UGCAddAutoLocalizedContentRequestDTO
//   (not directly referenced by a detected call)
public class UGCAddAutoLocalizedContentRequestDTO
{
    public List<UGCScopedStringRequestDTO> <Strings>k__BackingField;    // 0x0x10
    public string <Scope>k__BackingField;    // 0x0x18
    public bool <PerformAsync>k__BackingField;    // 0x0x20
    public int <WaitBeforeProcessingSeconds>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// RecNet.UGCAddAutoLocalizedContentResponseDTO
//   (not directly referenced by a detected call)
public class UGCAddAutoLocalizedContentResponseDTO
{
    public List<UGCScopedStringResponseDTO> <AutoLocalizedStrings>k__BackingField;    // 0x0x10
    public bool <PerformAsync>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.UGCLocalizedContentResponseDTO
//   (not directly referenced by a detected call)
public class UGCLocalizedContentResponseDTO
{
    public List<UGCScopedTranslationDTO> <Translations>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.UGCScopedStringRequestDTO
//   (not directly referenced by a detected call)
public class UGCScopedStringRequestDTO
{
    public string <BaseText>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.UGCScopedStringResponseDTO
//   (not directly referenced by a detected call)
public class UGCScopedStringResponseDTO
{
    public List<UGCScopedTranslationDTO> <Translations>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.UGCScopedTranslationDTO
//   (not directly referenced by a detected call)
public class UGCScopedTranslationDTO
{
    public string <ResolvingStringId>k__BackingField;    // 0x0x10
    public string <TranslatedText>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.UGCStringAutoLocalizationJobNotificationDTO
//   (not directly referenced by a detected call)
public class UGCStringAutoLocalizationJobNotificationDTO
{
    public string <Scope>k__BackingField;    // 0x0x10
    public JobStatus <Status>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.UGCStringAutoLocalizationScopeStatusDTO
//   (not directly referenced by a detected call)
public class UGCStringAutoLocalizationScopeStatusDTO
{
    public bool <JobIsEnqueued>k__BackingField;    // 0x0x10
}
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public QMCNGFKDPWJ <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<QSOUNSKEFVE> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public EAPWZEKDOJL _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public FOIFBZOYNIZ _line;    // 0x0x8
...
// --------------------------------------------------------------------------
// RecRoom.Core.Creation.MemoryStats.StandardDeviationResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class StandardDeviationResult : ValueType
{
    public string MetricName;    // 0x0x0
    public double Average;    // 0x0x8
    public double AverageError;    // 0x0x10
    public double StandardDeviation;    // 0x0x18
}
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool DPOATGPWPHJ;    // 0x0x30
}
...
// --------------------------------------------------------------------------
// RecRoom.RemoteCommands.DTOs.BuildMetadataDTO
//   (not directly referenced by a detected call)
public class BuildMetadataDTO
{
    public string <RMPZWALJDRF>k__BackingField;    // 0x0x10
    public string <IPLYPJCBNXU>k__BackingField;    // 0x0x18
    public string <IHZHEIRBHXE>k__BackingField;    // 0x0x20
    public string <OXLTKYMFQCY>k__BackingField;    // 0x0x28
    public DateTime <ZDUABNYGSOR>k__BackingField;    // 0x0x30
    public string <ULPSQHXQAZH>k__BackingField;    // 0x0x38
    public string <NPSCUUBEBZC>k__BackingField;    // 0x0x40
    public string <NDBMNTBRIIK>k__BackingField;    // 0x0x48
    public string <HQKPIMEPXIE>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// RecRoom.RemoteCommands.DTOs.ChipInstanceDTO
//   (not directly referenced by a detected call)
public class ChipInstanceDTO
{
    public Guid <PNNEETJJUBC>k__BackingField;    // 0x0x10
    public string <JQHLENULEYO>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// RecRoom.RemoteCommands.DTOs.CreatedRoomDTO
//   (not directly referenced by a detected call)
public class CreatedRoomDTO
{
    public long <RODNCJZLJXV>k__BackingField;    // 0x0x10
    public string <QTNWYVBJWLH>k__BackingField;    // 0x0x18
}
...
{
    public CQQMUBQBNJB pendingRequests;    // 0x0x0
...
{
    public QGGDGVMYJMC CTKZLRUOMOT;    // 0x0x10
    public GBFVOIKQDIE DWCBTCENJZB;    // 0x0x18
    public EJOQRXHTGDS EYIAQKNYCGJ;    // 0x0x20
    public YCKRWIQEMHS ZFZBEUSGTGF;    // 0x0x28
}
...
// --------------------------------------------------------------------------
// RecRoom.UGCLocalization.TranslationRequestResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class TranslationRequestResult : ValueType
{
    public string <Text>k__BackingField;    // 0x0x0
    public bool <Translated>k__BackingField;    // 0x0x8
}
...
{
    public string oldDeviceId;  // form
    public string newDeviceId;  // form
    public object platform;  // form
}
...
public class PlayerReportingV1HileRequest
{
    ...
    public object ReportedPlayer;  // form
}
...
{
    public object Id;  // form
    public object UnlockedLevel;  // form
}
...
public class RoomsV3ReportRequest
{
    ...
    public object RoomKeyId;  // form
    public string Details;  // form
    public object ReportCategory;  // form
    public object RoomOfferId;  // form
    public object RoomOfferVersion;  // form
}
