...
// DTO classes: 283 (plus referenced enums)

// --------------------------------------------------------------------------
// AAOKPJKHAIN
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class AAOKPJKHAIN
{
    public NIKIKDPGJKM <CHBGHBGPNNO>k__BackingField;    // 0x0x10
    public int <KHMAODIODEP>k__BackingField;    // 0x0x14
    public long <MGBBDNBNPFI>k__BackingField;    // 0x0x18
    public bool <AFGJEPHFCDL>k__BackingField;    // 0x0x20
    public string <EIIFPAELAEO>k__BackingField;    // 0x0x28
    public int? <APGFMEBIEEM>k__BackingField;    // 0x0x30
    public bool <HBKPGLNBFIB>k__BackingField;    // 0x0x38
    public bool <CIKKECCKFOP>k__BackingField;    // 0x0x39
    public bool <OLBGAPMLNJG>k__BackingField;    // 0x0x3A
    public bool <KOELMOCHHOA>k__BackingField;    // 0x0x3B
    public string <HJLACLCAOEK>k__BackingField;    // 0x0x40
    public DateTime? <MPKFNHGJMON>k__BackingField;    // 0x0x48
    public string <NHPAOPELPEE>k__BackingField;    // 0x0x58
    public bool <FNCLDNHPMBB>k__BackingField;    // 0x0x60
    public string <EFKDCCCEFAI>k__BackingField;    // 0x0x68
    public string <BDJAMJHMFBC>k__BackingField;    // 0x0x70
    public float <MONNDPCBIEA>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// ADJCCEDGCCM
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{oCHPGIEAOKE}   [Service.API]
public class ADJCCEDGCCM
{
    public List<OJEJMGKECPJ> <JPBDHNKCKEJ>k__BackingField;    // 0x0x10
    public List<GBFBLOCFHLB> <AEMDMPIMFAA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// AGOAAIANOGM
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.Econ]
public class AGOAAIANOGM
{
    public int NBKBDJDGPIC;    // 0x0x10
    public long CCKNONKBNNN;    // 0x0x18
}
...
public class AHLACGEMDOD
{
    public List<string> <ODAIECOPOLP>k__BackingField;    // 0x0x10
}
...
// AMEKGOPDNGC
//   (not directly referenced by a detected call)
public class AMEKGOPDNGC
{
    public long <CHCKMHLAMFC>k__BackingField;    // 0x0x10
    public Guid <NKIOOIHCNOL>k__BackingField;    // 0x0x18
    public Guid <BNOLEJIBMLK>k__BackingField;    // 0x0x28
    public DateTime <FMLJHHLKNPK>k__BackingField;    // 0x0x38
    public string <JCACBMGEEPD>k__BackingField;    // 0x0x40
    public string <KDAFBDICNCH>k__BackingField;    // 0x0x48
    public int <DNIELKHHFJJ>k__BackingField;    // 0x0x50
    public string <NJLOIADIGPM>k__BackingField;    // 0x0x58
    public string <ABFJGKPPEJD>k__BackingField;    // 0x0x60
    public string <CDCMAIMFPDL>k__BackingField;    // 0x0x68
    public string <AHABDAHFCPL>k__BackingField;    // 0x0x70
    public int <MMDKAGGNCBM>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// BCEAKJFMEMB
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class BCEAKJFMEMB
{
    public Guid? <PJHPDCDAOFI>k__BackingField;    // 0x0x10
    public long? <EDIEOMFAJHC>k__BackingField;    // 0x0x28
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x38
    public string <IFMOCMLGIBO>k__BackingField;    // 0x0x40
    public string <BHJLPEJHCKH>k__BackingField;    // 0x0x48
    public INIDMDNDDFD <AHOOEJMKOKL>k__BackingField;    // 0x0x50
}
...
public class BGFGLBBLOKE
{
    public OPNDCNNKOJP <KICHIJIMLMB>k__BackingField;    // 0x0x10
    public GKJECJOHBAL <DKHJMNEEBMP>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{mIKBNLDEMNP}   [Service.Econ]
public class BGGOGJCNAHI
{
    public OPNDCNNKOJP <KICHIJIMLMB>k__BackingField;    // 0x0x10
    public GEMIGEFOLPE <APKFIHOCIFM>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BGIJCBAECHJ
//   (not directly referenced by a detected call)
public class BGIJCBAECHJ
{
    public IEJIMKIBBAA <NMANFBCHGJK>k__BackingField;    // 0x0x10
    public long <JCBEIKFELPI>k__BackingField;    // 0x0x18
    public GiftItemDTO <APPNGOHMGMA>k__BackingField;    // 0x0x20
    public long? <CDJEOHODLIF>k__BackingField;    // 0x0x28
    public int <OKDALMMIJFG>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// BHHJAGFLBGH
//   (not directly referenced by a detected call)
public class BHHJAGFLBGH
{
    public string <JPDDFMPEBPJ>k__BackingField;    // 0x0x10
    public JEIDIJJBPCC <JHFPPALCFIF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BILICDPPPKJ
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{eGEEBANPJFL}/{cCHFDMKPFHA}   [Service.Econ]
public class BILICDPPPKJ
{
    public COKNLBOGDAO <DBJKBFCIPMH>k__BackingField;    // 0x0x10
    public IAEMKPMDALH <HPEOGFLNDOA>k__BackingField;    // 0x0x14
    public int <ICFJKPPKCCF>k__BackingField;    // 0x0x18
    public int <EDNFMMHEBIE>k__BackingField;    // 0x0x1C
    public int <LEJBJOBONAM>k__BackingField;    // 0x0x20
    public NHOMGBPCGAA <BFGOHLKBAGJ>k__BackingField;    // 0x0x24
    public bool <IANFAPHFBDN>k__BackingField;    // 0x0x28
    public float <IPMBGELLNLG>k__BackingField;    // 0x0x2C
    public int <PMCONKBGBNG>k__BackingField;    // 0x0x30
    public bool <AOIPDFEBPNH>k__BackingField;    // 0x0x34
}
...
public class CIIGGMDKOJB
{
    public long <KJPHNFDPINN>k__BackingField;    // 0x0x10
    public LDHKLOAMNGM <JHFPPALCFIF>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// CLMFNENCMPF
//   (not directly referenced by a detected call)
public class CLMFNENCMPF
{
    public int <PAGDIHABOMD>k__BackingField;    // 0x0x10
}
...
public class CMMDOFEJJON : AGLNOKIMMJN
{
    public FGAOABLLNIL? <JBCLDEGHIDC>k__BackingField;    // 0x0x18
    public GAEDBGPOKIH <DGFDCFDMJOA>k__BackingField;    // 0x0x20
}
...
public class COLJLOLNMIL
{
    public Dictionary<Guid, KGGLJGNICHB> <ANGJBHKMIGP>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// DCAJJBDGGMG
//   (not directly referenced by a detected call)
public class DCAJJBDGGMG
{
    public int <OBIGHAIDFPI>k__BackingField;    // 0x0x10
    public NBKCFIFLKOC <JHFPPALCFIF>k__BackingField;    // 0x0x14
    public List<OCDBPPBGNFP> <DEJBAPGLMNJ>k__BackingField;    // 0x0x18
    public List<OCDBPPBGNFP> <ABCPDILDPCB>k__BackingField;    // 0x0x20
    public bool <EJNHBAEOGJO>k__BackingField;    // 0x0x28
    public DateTime? <AJNOJHGAILO>k__BackingField;    // 0x0x30
    public DateTime? <MFBAOBECLIJ>k__BackingField;    // 0x0x40
    public DateTime? <DAJDHCPCJGP>k__BackingField;    // 0x0x50
    public bool <KCPNDBEICGC>k__BackingField;    // 0x0x60
    public bool <HFIMJGEJAPB>k__BackingField;    // 0x0x61
}
...
//   RESPONSE POST   api/progressionEvents/collect/{pHKEPFBPHEA}/{bCBLFDNBBLH}   [Service.API]
public class DELIHCCELHP
{
    public long? <MNIEDPKFEDB>k__BackingField;    // 0x0x10
    public int <FKAFKJKIGJG>k__BackingField;    // 0x0x20
    public int? <AKGFGJDFDKL>k__BackingField;    // 0x0x24
    public string <GNNHHMGJILI>k__BackingField;    // 0x0x30
    public BFHAFIEPAFC? <NGNEIHHHGEE>k__BackingField;    // 0x0x38
    public string <MKGODFNLDMO>k__BackingField;    // 0x0x40
    public Guid? <NKIOOIHCNOL>k__BackingField;    // 0x0x48
    public string <PALFFFEJANI>k__BackingField;    // 0x0x60
    public string <HPNNIPCGABC>k__BackingField;    // 0x0x68
    public COKNLBOGDAO <DBJKBFCIPMH>k__BackingField;    // 0x0x70
    public int <JANOBHCIGPM>k__BackingField;    // 0x0x74
    public int <PGLODMABABK>k__BackingField;    // 0x0x78
    public LBBELABPADG <EGPJIHIKBJN>k__BackingField;    // 0x0x7C
    public AHJINCPIKDJ <LJAELMBMEIP>k__BackingField;    // 0x0x80
    public string <IBPHIMBMFFI>k__BackingField;    // 0x0x88
    public string <ELGABDMAKEE>k__BackingField;    // 0x0x90
    public bool <PNPHFMBKMLP>k__BackingField;    // 0x0x98
    public LGBPLMEOAKA <ONBLJIOMAEB>k__BackingField;    // 0x0x9C
    public MALLPKNKEKG <IMLLLKBPPME>k__BackingField;    // 0x0xA0
    public KNHAMAEBGGK? <KEGMGNAJGCN>k__BackingField;    // 0x0xA4
    public bool <DLHHNIEIFCI>k__BackingField;    // 0x0xAC
    public bool <GLMJHNMBBKN>k__BackingField;    // 0x0xAD
    public string <BGLOOONLNEM>k__BackingField;    // 0x0xB0
    public string <DJMDPBKLCFM>k__BackingField;    // 0x0xB8
    public bool <BJNJJCLHGNO>k__BackingField;    // 0x0xC0
    public bool DPLMPJJCGMB;    // 0x0xC1
}

// --------------------------------------------------------------------------
// DIKGHBHLAOI
//   REQUEST  POST   api/equipment/v1/update   [Service.Econ]
public class DIKGHBHLAOI
{
    public string <CIBNNDGCGLG>k__BackingField;    // 0x0x10
    public string <IEMPOICOPAF>k__BackingField;    // 0x0x18
    public string <OKLDEHDHPEO>k__BackingField;    // 0x0x20
    public string <GAIABMDBABP>k__BackingField;    // 0x0x28
    public AHJINCPIKDJ <EOCKOPAFNOA>k__BackingField;    // 0x0x30
    public string <FCHJKHLMCFC>k__BackingField;    // 0x0x38
    public bool NCLMFMFEGJG;    // 0x0x40
    public bool <JMLJNBAEJMK>k__BackingField;    // 0x0x41
}
...
public class DLDFBBLMKOA : OJEJMGKECPJ
{
    public List<BHHJAGFLBGH> <PEEKIIFJONC>k__BackingField;    // 0x0x98
}
...
public class DNEBNJDPDOM
{
    public int <ALGNKAADLFD>k__BackingField;    // 0x0x10
    public CLHPCKFBECG <JHFPPALCFIF>k__BackingField;    // 0x0x14
    public GJDNODGOPMC <EPAEGNHDJFE>k__BackingField;    // 0x0x18
    public GJDNODGOPMC <JMHLCIAIDOA>k__BackingField;    // 0x0x1C
    public GJDNODGOPMC <JAEEIBBABFG>k__BackingField;    // 0x0x20
    public byte? <ANADLALFKPE>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// DNOMCAFKJHC
//   REQUEST  POST   api/items/bulkpurchase   [Service.Commerce]
public class DNOMCAFKJHC
{
    public List<BGIJCBAECHJ> <NENFOIPMPOK>k__BackingField;    // 0x0x10
    public BKMPEOKAHJC? <NLKALKHHBJG>k__BackingField;    // 0x0x18
    public COKNLBOGDAO <DBJKBFCIPMH>k__BackingField;    // 0x0x20
    public bool <FBNNPONLHIB>k__BackingField;    // 0x0x24
    public bool <LHAKJGAOCIG>k__BackingField;    // 0x0x25
    public Guid? <IHHGOPJFFNB>k__BackingField;    // 0x0x28
}
...
public class DOFOACKAFGF
{
    public NGEBNMPHDDE <CHBGHBGPNNO>k__BackingField;    // 0x0x10
    public string <CBPFPEMIPFE>k__BackingField;    // 0x0x18
    public int? <KHIGAGKLBOG>k__BackingField;    // 0x0x20
}
...
public class DOJFMAACEAD
{
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x10
    public string <IFMOCMLGIBO>k__BackingField;    // 0x0x18
    public int? <DCFLNCOIFBP>k__BackingField;    // 0x0x20
    public IHPKKIOOIAO? <MNHJMAGBMCF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// EDDECCMEKBI
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.Econ]
public class EDDECCMEKBI
{
    public Guid <HIIPJPNCLKH>k__BackingField;    // 0x0x10
    public int <CLBBFBDIOOD>k__BackingField;    // 0x0x20
    public long <POCMLOBJHAF>k__BackingField;    // 0x0x28
    public Guid <HCLKOHHLODH>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// EEGEKCNEGJC
//   (not directly referenced by a detected call)
public class EEGEKCNEGJC
{
    public long <GMMKANKBDOO>k__BackingField;    // 0x0x10
    public long <KJPHNFDPINN>k__BackingField;    // 0x0x18
    public int <FKAFKJKIGJG>k__BackingField;    // 0x0x20
    public DateTime <FMLJHHLKNPK>k__BackingField;    // 0x0x28
    public LDHKLOAMNGM <JHFPPALCFIF>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// EIAAGAMOIKD
//   RESPONSE GET    api/config/v2   [Service.API]
public class EIAAGAMOIKD
{
    public Dictionary<int, int> <GPFGKOINLPP>k__BackingField;    // 0x0x10
    public List<GHMEJBGDDDD> <HHIHJIDHCIG>k__BackingField;    // 0x0x18
    public HFNNMLMOAJD[][] <CIJICEDGFFL>k__BackingField;    // 0x0x20
    public NPMKAPKLKOD <NPDHCMPGNFJ>k__BackingField;    // 0x0x28
    public KPFCHCBAALP <FIKEOALPJLN>k__BackingField;    // 0x0x30
    public FPHLMFJKLAN <HJEIGEJOGLB>k__BackingField;    // 0x0x38
    public CLMFNENCMPF <OKEAJDMCEBE>k__BackingField;    // 0x0x40
    public IPFONIAAIMG <BGFKJEBCAFA>k__BackingField;    // 0x0x48
    public string <DOLOIPIFIOK>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// EJKMJNOBEDO
// base   : BJBJIPJCLPD`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class EJKMJNOBEDO
{
    // (no instance fields in the metadata dump)
}
...
public class ENDCNODHONN
{
    public int EJCCPPLAIEM;    // 0x0x10
    public int PDPIDGHNKGH;    // 0x0x14
}
...
//   (not directly referenced by a detected call)
public class EPADPFJDNDI : ValueType
{
    public MDLPHIOGMIH GLPGLCAOIMA;    // 0x0x0
    public NGBEPHHOLNP MBEGAIAGHEO;    // 0x0x10
    public Guid JPGHKDHGJKB;    // 0x0x20
}
...
// FAFHAGKOPBD
//   (not directly referenced by a detected call)
public class FAFHAGKOPBD
{
    public Guid <NKIOOIHCNOL>k__BackingField;    // 0x0x10
    public int <JCMIEIMBIAE>k__BackingField;    // 0x0x20
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x28
    public string <IFMOCMLGIBO>k__BackingField;    // 0x0x30
    public int <DCFLNCOIFBP>k__BackingField;    // 0x0x38
    public IHPKKIOOIAO <MNHJMAGBMCF>k__BackingField;    // 0x0x3C
    public bool <NCAJNCKCILO>k__BackingField;    // 0x0x40
    public bool <EJNHBAEOGJO>k__BackingField;    // 0x0x41
    public bool <DHBPBIKNIPO>k__BackingField;    // 0x0x42
    public int? <OKNHALKJKLI>k__BackingField;    // 0x0x44
    public string <FILBEOOEAHF>k__BackingField;    // 0x0x50
    public string <CLPGGNJONBK>k__BackingField;    // 0x0x58
    public string <DPEEICLNODB>k__BackingField;    // 0x0x60
    public DateTime <FMLJHHLKNPK>k__BackingField;    // 0x0x68
    public DateTime <BOGCALJMBGN>k__BackingField;    // 0x0x70
    public NFBCDHHPBCN <DGJCCPFIPHC>k__BackingField;    // 0x0x78
    public string <PEBJFFAMDLM>k__BackingField;    // 0x0x80
    public int <MMDKAGGNCBM>k__BackingField;    // 0x0x88
    public IReadOnlyList<AMEKGOPDNGC> <LBNHHGLOIEN>k__BackingField;    // 0x0x90
    public HCAAEADMMIL <OEPBDKIPLPB>k__BackingField;    // 0x0x98
}
...
// base   : DCAJJBDGGMG
//   (not directly referenced by a detected call)
public class FBPHMKMPFMG : DCAJJBDGGMG
{
    public int <AFNHFEIBHBN>k__BackingField;    // 0x0x68
    public List<JAENOAAGNGL> <KGKBKNFDCEG>k__BackingField;    // 0x0x70
    public List<JAENOAAGNGL> <FODPBKAGNNL>k__BackingField;    // 0x0x78
    public List<JAENOAAGNGL> <NPIGBENNDBN>k__BackingField;    // 0x0x80
}
...
// base   : CGIOODNGEEO
//   (not directly referenced by a detected call)
public class FEEJACDGGBD : CGIOODNGEEO
{
    public CGNGIDGHPFA DJFIONKHNPB;    // 0x0x20
}
...
public class FEGDNJNAODO
{
    public BFHAFIEPAFC <NGNEIHHHGEE>k__BackingField;    // 0x0x10
    public string <IAOOJHPFIAA>k__BackingField;    // 0x0x18
    public string <OKLDEHDHPEO>k__BackingField;    // 0x0x20
    public string <GAIABMDBABP>k__BackingField;    // 0x0x28
    public AHJINCPIKDJ <EOCKOPAFNOA>k__BackingField;    // 0x0x30
    public string <NFOEBHGPIGJ>k__BackingField;    // 0x0x38
    public int <DABPJOPICFL>k__BackingField;    // 0x0x40
    public bool <KPIGMLLLGOO>k__BackingField;    // 0x0x44
    public string <LKODINOIOPB>k__BackingField;    // 0x0x48
    public DateTime <FMLJHHLKNPK>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// FENGGACGOGJ
//   REQUEST  POST   api/roomkeys/v1/revoke   [Service.Econ]
public class FENGGACGOGJ
{
    public long <NKENHHDMMHH>k__BackingField;    // 0x0x10
    public int <GMOMHDJGKJJ>k__BackingField;    // 0x0x18
}
...
// FHKJPADBPKM
//   (not directly referenced by a detected call)
public class FHKJPADBPKM
{
    public int <BMEAFLMMAMF>k__BackingField;    // 0x0x10
    public string <OKLDEHDHPEO>k__BackingField;    // 0x0x18
    public string <GAIABMDBABP>k__BackingField;    // 0x0x20
    public string <NFOEBHGPIGJ>k__BackingField;    // 0x0x28
    public string <GNNHHMGJILI>k__BackingField;    // 0x0x30
    public EPADPFJDNDI? <GCGMNMNFNPD>k__BackingField;    // 0x0x38
    public string <MKGODFNLDMO>k__BackingField;    // 0x0x70
    public Guid? <NKIOOIHCNOL>k__BackingField;    // 0x0x78
    public BFHAFIEPAFC? <NGNEIHHHGEE>k__BackingField;    // 0x0x8C
    public string <PALFFFEJANI>k__BackingField;    // 0x0x98
    public string <HPNNIPCGABC>k__BackingField;    // 0x0xA0
    public bool <FMHOKEDGJFL>k__BackingField;    // 0x0xA8
    public bool <JEIACNANJJI>k__BackingField;    // 0x0xA9
    public bool <GBODHEGCAED>k__BackingField;    // 0x0xAA
    public AHJINCPIKDJ <EOCKOPAFNOA>k__BackingField;    // 0x0xAC
    public COKNLBOGDAO <DBJKBFCIPMH>k__BackingField;    // 0x0xB0
    public int <JANOBHCIGPM>k__BackingField;    // 0x0xB4
    public PDMMBMIFBNP <JEMBBFGKNHC>k__BackingField;    // 0x0xB8
    public LBBELABPADG <EIHDCHONIBE>k__BackingField;    // 0x0xBC
    public int? <FPKAHOCIEEH>k__BackingField;    // 0x0xC0
    public string <OAJEHJIEBIP>k__BackingField;    // 0x0xC8
    public int? <DABPJOPICFL>k__BackingField;    // 0x0xD0
    public int? <KIPNJGCFMBB>k__BackingField;    // 0x0xD8
    public string <FCHJKHLMCFC>k__BackingField;    // 0x0xE0
}

// --------------------------------------------------------------------------
// FPHLMFJKLAN
//   (not directly referenced by a detected call)
public class FPHLMFJKLAN
{
    public int <LPBFFNACOIO>k__BackingField;    // 0x0x10
    public DateTime <BJFJGIFJMNN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GAEDBGPOKIH
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class GAEDBGPOKIH
{
    public int <GMOMHDJGKJJ>k__BackingField;    // 0x0x10
    public Guid <HIIPJPNCLKH>k__BackingField;    // 0x0x14
    public long <OLKJGHMFGPK>k__BackingField;    // 0x0x28
    public DateTime <BOGCALJMBGN>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// GBFBLOCFHLB
//   (not directly referenced by a detected call)
public class GBFBLOCFHLB
{
    public OJEJMGKECPJ <GGIOHFECILC>k__BackingField;    // 0x0x10
    public EEGEKCNEGJC <AMFPHKGFAJG>k__BackingField;    // 0x0x18
}
...
public class GCOBELGJBGL
{
    public bool <BBFGMIGGNDK>k__BackingField;    // 0x0x10
    public string <EIIFPAELAEO>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GEMIGEFOLPE
//   (not directly referenced by a detected call)
public class GEMIGEFOLPE
{
    public Guid <PJHPDCDAOFI>k__BackingField;    // 0x0x10
    public long <EDIEOMFAJHC>k__BackingField;    // 0x0x20
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x28
    public string <IFMOCMLGIBO>k__BackingField;    // 0x0x30
    public string <BHJLPEJHCKH>k__BackingField;    // 0x0x38
    public long <DCFLNCOIFBP>k__BackingField;    // 0x0x40
    public Guid? <LGGNIKEKEAB>k__BackingField;    // 0x0x48
    public DateTime <BOGCALJMBGN>k__BackingField;    // 0x0x60
    public int <NKKINLLJMED>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// GIDLFAEFGHO
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class GIDLFAEFGHO
{
    public List<int> <BDIICAPNFGE>k__BackingField;    // 0x0x10
    public string <NLJDJIPIPNJ>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GKJECJOHBAL
//   (not directly referenced by a detected call)
public class GKJECJOHBAL
{
    public Guid <PJHPDCDAOFI>k__BackingField;    // 0x0x10
    public int <GMOMHDJGKJJ>k__BackingField;    // 0x0x20
    public int <NLFOCOGHNKA>k__BackingField;    // 0x0x24
    public Guid <FCHKODKMFMF>k__BackingField;    // 0x0x28
    public DateTime <BOGCALJMBGN>k__BackingField;    // 0x0x38
    public GEMIGEFOLPE <APKFIHOCIFM>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// GLNCKGLFFFL
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class GLNCKGLFFFL
{
    public List<OJEJMGKECPJ> <LKHIPENPOEJ>k__BackingField;    // 0x0x10
    public string <NLJDJIPIPNJ>k__BackingField;    // 0x0x18
}
...
public class GOFJOPPLHDE
{
    public long <EDIEOMFAJHC>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <ECCHKNKFIND>k__BackingField;    // 0x0x18
    public MIIPHAJAKPD <FHMGGKPOALF>k__BackingField;    // 0x0x20
    public bool <FNKLMCJACHH>k__BackingField;    // 0x0x21
    public long <ONPBGKDKLAB>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// HCAAEADMMIL
//   (not directly referenced by a detected call)
public class HCAAEADMMIL
{
    public FEEJACDGGBD <FLKILEDAOMA>k__BackingField;    // 0x0x10
    public IEJIMKIBBAA <GABGLOHKFJH>k__BackingField;    // 0x0x18
    public List<OCDBPPBGNFP> <DEJBAPGLMNJ>k__BackingField;    // 0x0x20
    public DateTime? <DAJDHCPCJGP>k__BackingField;    // 0x0x28
    public DateTime? <AJNOJHGAILO>k__BackingField;    // 0x0x38
    public DateTime? <MFBAOBECLIJ>k__BackingField;    // 0x0x48
    public bool <KCPNDBEICGC>k__BackingField;    // 0x0x58
    public bool <OGBKBPJBHNE>k__BackingField;    // 0x0x59
    public bool <GBODHEGCAED>k__BackingField;    // 0x0x5A
    public bool <EJNHBAEOGJO>k__BackingField;    // 0x0x5B
}

// --------------------------------------------------------------------------
// HDIPELLDLKL
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class HDIPELLDLKL
{
    public int <HKJPMBBLHAP>k__BackingField;    // 0x0x10
    public int <NEEBDJHJANE>k__BackingField;    // 0x0x14
    public float <IAAHIHBHHFE>k__BackingField;    // 0x0x18
    public int <MGKIDBNHIMH>k__BackingField;    // 0x0x1C
    public int <IBEPJPLLADH>k__BackingField;    // 0x0x20
    public int <EKLEMKGAADC>k__BackingField;    // 0x0x24
    public int <HFDJLGNNKCF>k__BackingField;    // 0x0x28
    public string <OGMOEIKDKCK>k__BackingField;    // 0x0x30
    public string <CFJPFPCLMLC>k__BackingField;    // 0x0x38
}
...
public class HFHHNPBPBOA
{
    public int <DPHFFABBFJG>k__BackingField;    // 0x0x10
    public int <CDNAIFKMDOP>k__BackingField;    // 0x0x14
    public float <HBFNMACOJAC>k__BackingField;    // 0x0x18
    public float <ECFEAALEEBF>k__BackingField;    // 0x0x1C
    public bool <MLEOBPJEDFP>k__BackingField;    // 0x0x20
    public bool <LDPAMHFLELO>k__BackingField;    // 0x0x21
    public bool <JMLJNBAEJMK>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// HFNNMLMOAJD
//   (not directly referenced by a detected call)
public class HFNNMLMOAJD
{
    public CLNGKNKGDMI JFNKJIPLJNG;    // 0x0x10
    public int APDPLKNOECK;    // 0x0x14
}

// --------------------------------------------------------------------------
// HGOFNFEIHBK
//   (not directly referenced by a detected call)
public class HGOFNFEIHBK
{
    public long <NKENHHDMMHH>k__BackingField;    // 0x0x10
    public Guid <IJPACAGFLKG>k__BackingField;    // 0x0x18
    public long <EDIEOMFAJHC>k__BackingField;    // 0x0x28
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x30
    public string <IFMOCMLGIBO>k__BackingField;    // 0x0x38
    public int <DCFLNCOIFBP>k__BackingField;    // 0x0x40
    public Guid? <LGGNIKEKEAB>k__BackingField;    // 0x0x44
    public DateTime <FMLJHHLKNPK>k__BackingField;    // 0x0x58
    public string <BHJLPEJHCKH>k__BackingField;    // 0x0x60
    public HJEJNNPBNMF <JHFPPALCFIF>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// HIMIAIHKACO
//   (not directly referenced by a detected call)
public class HIMIAIHKACO
{
    public int <LEABBECAEFE>k__BackingField;    // 0x0x10
    public DateTime <FMLJHHLKNPK>k__BackingField;    // 0x0x18
    public DateTime? <GIAABDHIGHE>k__BackingField;    // 0x0x20
}
...
// HKAAJGMDKLL
//   (not directly referenced by a detected call)
public class HKAAJGMDKLL
{
    public int <FPIGOJCCPGD>k__BackingField;    // 0x0x10
    public DateTime? <KCKLDEHPCOO>k__BackingField;    // 0x0x18
    public DateTime? <GEJLPKMEBCG>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// HMFJDABDEHC
//   (not directly referenced by a detected call)
public class HMFJDABDEHC
{
    public Guid <PBBMAJEGIFG>k__BackingField;    // 0x0x10
    public Guid <NDFNNBMEMBK>k__BackingField;    // 0x0x20
    public DateTime <IPLDMONMNIC>k__BackingField;    // 0x0x30
    public List<FHKJPADBPKM> <DJJHJCGHBDP>k__BackingField;    // 0x0x38
}
...
public class ICLJLNFHMLF
{
    public JELNPKDDDON <LPPFMCJELAM>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// IEJIMKIBBAA
//   (not directly referenced by a detected call)
public class IEJIMKIBBAA
{
    public LGCCIJILPFA <JHFPPALCFIF>k__BackingField;    // 0x0x10
    public int? <HBAAJJNICNL>k__BackingField;    // 0x0x14
    public Guid? <KNGPGGCDCPJ>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// IGNCFOLIHCD
//   RESPONSE GET    api/quickPlay/v1/getandclear   [Service.API]
public class IGNCFOLIHCD
{
    public int? <GAAKJFLCEDC>k__BackingField;    // 0x0x10
    public string <ANMBFIAFBOE>k__BackingField;    // 0x0x18
    public string <HDHGMAGKIFO>k__BackingField;    // 0x0x20
}
...
public class IIHGMGAALON
{
    public NIKIKDPGJKM <CHBGHBGPNNO>k__BackingField;    // 0x0x10
    public long <KJPHNFDPINN>k__BackingField;    // 0x0x18
    public string <CBPFPEMIPFE>k__BackingField;    // 0x0x20
}
...
public class IIMCHJMNNCI
{
    public DLDFBBLMKOA <GGIOHFECILC>k__BackingField;    // 0x0x10
    public JELNPKDDDON <LPPFMCJELAM>k__BackingField;    // 0x0x18
    public JIAJMEJBFLG <KJBPBMDHMLH>k__BackingField;    // 0x0x20
}
...
// INIDMDNDDFD
//   (not directly referenced by a detected call)
public class INIDMDNDDFD
{
    public long <DCFLNCOIFBP>k__BackingField;    // 0x0x10
    public Guid? <HIIPJPNCLKH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// IPFONIAAIMG
//   (not directly referenced by a detected call)
public class IPFONIAAIMG
{
    public float <GMBCCAHAAJB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// JAENOAAGNGL
//   (not directly referenced by a detected call)
public class JAENOAAGNGL
{
    public bool <EAJCGOCALCD>k__BackingField;    // 0x0x10
    public FHKJPADBPKM <MJEAKFFBDAG>k__BackingField;    // 0x0x18
    public float <BDBOEOCMFEF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JBHCPCADHIP
//   RESPONSE GET    api/subscriptionseasons/v1/seasons/current   [Service.Auth]
public class JBHCPCADHIP
{
    public Guid <BNFCBGILFNF>k__BackingField;    // 0x0x10
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x20
    public string <BHJLPEJHCKH>k__BackingField;    // 0x0x28
    public DateTime <IPLDMONMNIC>k__BackingField;    // 0x0x30
    public DateTime? <HNICEIDMENP>k__BackingField;    // 0x0x38
    public List<HMFJDABDEHC> <APOCEFGNGPP>k__BackingField;    // 0x0x48
}
...
public class JGMJDJKKHAO
{
    public KABHPEIGEKO <MDDMMFIGFBJ>k__BackingField;    // 0x0x10
    public INIDMDNDDFD <MDGHINPLKDG>k__BackingField;    // 0x0x18
    public int <COBMDHCDJIN>k__BackingField;    // 0x0x20
}
...
public class JHAJFBLKIDE
{
    public Guid <HCLKOHHLODH>k__BackingField;    // 0x0x10
    public long <EFIMBGHAJHD>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// JIAJMEJBFLG
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class JIAJMEJBFLG
{
    public DKCAEBNDCAB <LPPFMCJELAM>k__BackingField;    // 0x0x10
    public List<string> <PEEKIIFJONC>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// JLDNAEHMLJC
//   (not directly referenced by a detected call)
public class JLDNAEHMLJC
{
    public int <BBHLHDNPGBA>k__BackingField;    // 0x0x10
    public JELNPKDDDON <LPPFMCJELAM>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// KABHPEIGEKO
//   REQUEST  PUT    api/roomconsumables   [Service.Econ]
public class KABHPEIGEKO
{
    public Guid? <NMICFOCBEHG>k__BackingField;    // 0x0x10
    public Guid <FBOLCKDCNJO>k__BackingField;    // 0x0x24
}
...
// base   : ELMIIHIJHAI
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{dFJCPOCMFHP}   [Service.Econ]
public class KEJHGFOKDEJ : ELMIIHIJHAI
{
    public int <FINJCLALEMM>k__BackingField;    // 0x0x30
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x38
    public DateTime <IPLDMONMNIC>k__BackingField;    // 0x0x40
    public DateTime <JAGFONOIKEB>k__BackingField;    // 0x0x48
    public COKNLBOGDAO <DBJKBFCIPMH>k__BackingField;    // 0x0x50
    public DCAJJBDGGMG <HKPJMHMAAOG>k__BackingField;    // 0x0x58
    public List<FBPHMKMPFMG> <NBKIBOPCODD>k__BackingField;    // 0x0x60
    public MDLEOIIMFNM <GPENPCFJGIJ>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// KGGLJGNICHB
//   (not directly referenced by a detected call)
public class KGGLJGNICHB
{
    public int <COBMDHCDJIN>k__BackingField;    // 0x0x10
    public KABHPEIGEKO <MDDMMFIGFBJ>k__BackingField;    // 0x0x18
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{pJJIOIOLAMC}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{cHAPBCKABGN}   [Service.API]
...
public class KNPLFMAGNCA
{
    public bool <BBFGMIGGNDK>k__BackingField;    // 0x0x10
    public string <MDANLBNFCMN>k__BackingField;    // 0x0x18
    public string <CFEDOACPLMG>k__BackingField;    // 0x0x20
}
...
public class KOBLIBCDAFO
{
    public List<string> <HEPCHBFCALK>k__BackingField;    // 0x0x10
    public List<string> <NMIJPNJIDFO>k__BackingField;    // 0x0x18
    public List<string> <IKLFHLAMBMP>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// KPFCHCBAALP
//   (not directly referenced by a detected call)
public class KPFCHCBAALP
{
    public float <LMJHIJENOJO>k__BackingField;    // 0x0x10
    public float <MOIDEHMKPJD>k__BackingField;    // 0x0x14
    public float <EAKOCMHPNOC>k__BackingField;    // 0x0x18
    public float <PPHAEMGPCLE>k__BackingField;    // 0x0x1C
    public float <MAPFHKCAJMP>k__BackingField;    // 0x0x20
    public float <IJPAJJEHJKB>k__BackingField;    // 0x0x24
    public float <HHABMLFJAFL>k__BackingField;    // 0x0x28
    public float <EFLHCPKDCLM>k__BackingField;    // 0x0x2C
}
...
public class LGANNGKHDDE
{
    public List<HIMIAIHKACO> <JHLEJMNCNOP>k__BackingField;    // 0x0x10
    public string <NLJDJIPIPNJ>k__BackingField;    // 0x0x18
}
...
public class MAIOELJKJFC
{
    public int <FKAFKJKIGJG>k__BackingField;    // 0x0x10
    public byte <ANADLALFKPE>k__BackingField;    // 0x0x14
}
...
public class MBGMNFHNFHA
{
    public IReadOnlyList<FEEJACDGGBD> <EMOIPOPIFCO>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// MDLEOIIMFNM
//   (not directly referenced by a detected call)
public class MDLEOIIMFNM
{
    public bool <HKDIPFOOOPF>k__BackingField;    // 0x0x10
    public MALLPKNKEKG <LKNFKHNHNCF>k__BackingField;    // 0x0x14
    public int <PCKONDJHJDF>k__BackingField;    // 0x0x18
    public DateTime <BOGCALJMBGN>k__BackingField;    // 0x0x20
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class MDLPHIOGMIH : ValueType
{
    public Guid NMEMPCKPCOG;    // 0x0x0
}
...
public class MJKIHINJMLP
{
    public int <CDNAIFKMDOP>k__BackingField;    // 0x0x10
    public bool <MLEOBPJEDFP>k__BackingField;    // 0x0x14
    public DateTime <DJCCPDEOFOF>k__BackingField;    // 0x0x18
    public bool <PENGKCGGFAM>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MJPIKDOKFLN
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class MJPIKDOKFLN
{
    public List<BHHJAGFLBGH> <PEEKIIFJONC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// MMIHFGDPLHP
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class MMIHFGDPLHP
{
    public string <MNIEDPKFEDB>k__BackingField;    // 0x0x10
    public string <FAPAKHFACPI>k__BackingField;    // 0x0x18
    public string <NJOPFOLLFKH>k__BackingField;    // 0x0x20
    public string <IFMOCMLGIBO>k__BackingField;    // 0x0x28
    public string <ANMBFIAFBOE>k__BackingField;    // 0x0x30
    public CMIOMCNDFBC <KICHIJIMLMB>k__BackingField;    // 0x0x38
    public List<string> <JMFLLDBGAOL>k__BackingField;    // 0x0x40
    public List<string> <PEEKIIFJONC>k__BackingField;    // 0x0x48
    public string <COJFKIOINBO>k__BackingField;    // 0x0x50
    public List<NHLHKNNPAAM> <BOLIIAJOJPD>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// MNEIHIMKCAE
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class MNEIHIMKCAE
{
    public Dictionary<Guid, BGFGLBBLOKE> <CHFNEFBLOIK>k__BackingField;    // 0x0x10
}
...
public class NBLJNOOEFEG : AGLNOKIMMJN
{
    public IJNABNOAHHD? <JBCLDEGHIDC>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <BGJMFPIEJOC>k__BackingField;    // 0x0x20
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class NGBEPHHOLNP : ValueType
{
    public Guid NMEMPCKPCOG;    // 0x0x0
}
...
// NHLHKNNPAAM
//   (not directly referenced by a detected call)
public class NHLHKNNPAAM
{
    public DateTime <FMLJHHLKNPK>k__BackingField;    // 0x0x10
    public string <LFJBIKOCDIF>k__BackingField;    // 0x0x18
}
...
public class NKKMCPCGPCL
{
    public List<JLDNAEHMLJC> <FCNBKPKCKLL>k__BackingField;    // 0x0x10
    public JELNPKDDDON <LPPFMCJELAM>k__BackingField;    // 0x0x18
}
...
public class NOCGBPBOLNC
{
    public long <EDIEOMFAJHC>k__BackingField;    // 0x0x10
    public long? <NEIEFBHDIOP>k__BackingField;    // 0x0x18
    public long? <OPPBCFJGBDL>k__BackingField;    // 0x0x28
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x38
    public string <IFMOCMLGIBO>k__BackingField;    // 0x0x40
    public List<string> <PEEKIIFJONC>k__BackingField;    // 0x0x48
    public string <BHJLPEJHCKH>k__BackingField;    // 0x0x50
    public DateTime <DFOKNLEHAJN>k__BackingField;    // 0x0x58
    public DateTime <MCHLKDBILKL>k__BackingField;    // 0x0x60
    public AJHFBAPBCHK <MNHJMAGBMCF>k__BackingField;    // 0x0x68
    public bool <DMCGOLFENEA>k__BackingField;    // 0x0x6C
    public bool <OPNOCCAIKHL>k__BackingField;    // 0x0x6D
    public LFFNFNDEGMG <HAFJNDOEOFH>k__BackingField;    // 0x0x70
    public LFFNFNDEGMG <GMDAIOJBPLM>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// NPMKAPKLKOD
//   (not directly referenced by a detected call)
public class NPMKAPKLKOD
{
    public int <KFALENOPGAB>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// OCDBPPBGNFP
//   (not directly referenced by a detected call)
public class OCDBPPBGNFP
{
    public COKNLBOGDAO <DBJKBFCIPMH>k__BackingField;    // 0x0x10
    public int <DCFLNCOIFBP>k__BackingField;    // 0x0x14
    public HKAAJGMDKLL <INHJECFKAOA>k__BackingField;    // 0x0x18
}
...
public class OGNGKJDAONO
{
    public RoomKeyResult <KICHIJIMLMB>k__BackingField;    // 0x0x10
    public HGOFNFEIHBK <OPKPFMAOMBG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OHILBOHDPDC
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class OHILBOHDPDC
{
    public int <JCMIEIMBIAE>k__BackingField;    // 0x0x10
    public int? <OKNHALKJKLI>k__BackingField;    // 0x0x14
    public string <CLPGGNJONBK>k__BackingField;    // 0x0x20
    public string <FILBEOOEAHF>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// OIJMHBDAAKH
//   RESPONSE GET    api/makerai/freetrialconfig   [Service.Econ]
public class OIJMHBDAAKH
{
    public TimeSpan <CAOAIIIFANO>k__BackingField;    // 0x0x10
    public TimeSpan <KHMAODIODEP>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OJEJMGKECPJ
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class OJEJMGKECPJ
{
    public long <KJPHNFDPINN>k__BackingField;    // 0x0x10
    public int <CKGGOHFLJKF>k__BackingField;    // 0x0x18
    public long <EDIEOMFAJHC>k__BackingField;    // 0x0x20
    public long? <NEIEFBHDIOP>k__BackingField;    // 0x0x28
    public long? <OPPBCFJGBDL>k__BackingField;    // 0x0x38
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x48
    public string <IFMOCMLGIBO>k__BackingField;    // 0x0x50
    public string <BHJLPEJHCKH>k__BackingField;    // 0x0x58
    public DateTime <DFOKNLEHAJN>k__BackingField;    // 0x0x60
    public DateTime <MCHLKDBILKL>k__BackingField;    // 0x0x68
    public int <BBMANNIPPOE>k__BackingField;    // 0x0x70
    public AJHFBAPBCHK <MNHJMAGBMCF>k__BackingField;    // 0x0x74
    public bool <DMCGOLFENEA>k__BackingField;    // 0x0x78
    public bool <OPNOCCAIKHL>k__BackingField;    // 0x0x79
    public LFFNFNDEGMG <HAFJNDOEOFH>k__BackingField;    // 0x0x7C
    public LFFNFNDEGMG <GMDAIOJBPLM>k__BackingField;    // 0x0x80
    public long? <CBOPDPHILLM>k__BackingField;    // 0x0x88
}
...
public class OJMLGAHGEBK
{
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x10
    public long <JCMIEIMBIAE>k__BackingField;    // 0x0x18
    public List<FAFHAGKOPBD> <OGJLEGMFIOL>k__BackingField;    // 0x0x20
}
...
public class PANIJBDKBJH
{
    public int <KHMAODIODEP>k__BackingField;    // 0x0x10
}
...
// --------------------------------------------------------------------------
// PFDECDCFMGE
// base   : BJBJIPJCLPD`1<FAFHAGKOPBD>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{lNNPPOOFAGA}   [Service.API]
public class PFDECDCFMGE
{
    // (no instance fields in the metadata dump)
}
...
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{fMFDAFLDAAK}   [Service.API]
public class PFKPKPFDOAG
{
    public uint <MNIEDPKFEDB>k__BackingField;    // 0x0x10
    public uint? <CEGOADLFEMP>k__BackingField;    // 0x0x14
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x20
    public string <IFMOCMLGIBO>k__BackingField;    // 0x0x28
    public DateTime <KCDDJMHJPKE>k__BackingField;    // 0x0x30
    public DateTime? <NIFIGPECOIP>k__BackingField;    // 0x0x38
    public bool <BHKDIEJOGLM>k__BackingField;    // 0x0x48
    public List<MMIHFGDPLHP> <GDDHLEIFEKF>k__BackingField;    // 0x0x50
    public List<string> <PEEKIIFJONC>k__BackingField;    // 0x0x58
    public int <GNCGENCFAHO>k__BackingField;    // 0x0x60
    public int <GEEAPDDNMBA>k__BackingField;    // 0x0x64
    public int <CHKEIKOKPHP>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// PJDHOMANEHG
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class PJDHOMANEHG
{
    public bool <LJCCNEMIHAC>k__BackingField;    // 0x0x10
    public string <FAPAKHFACPI>k__BackingField;    // 0x0x18
    public string <LHOOKGBICIA>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// PNHLECKGLNP
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.API]
public class PNHLECKGLNP
{
    public List<long> <GNEPPDANPDE>k__BackingField;    // 0x0x10
    public BNLCCIFJKPM <JHFPPALCFIF>k__BackingField;    // 0x0x18
    public string <OKMFBFABEID>k__BackingField;    // 0x0x20
    public long? <EDIEOMFAJHC>k__BackingField;    // 0x0x28
}
...
public class AddKeepsakeInstanceRequest
{
    public long <EDIEOMFAJHC>k__BackingField;    // 0x0x10
    public long? <NEIEFBHDIOP>k__BackingField;    // 0x0x18
    public PEIKCOPGDKJ <HLCNEOLNDKJ>k__BackingField;    // 0x0x28
}
...
{
    public MCIHLMCJKHF <LPPFMCJELAM>k__BackingField;    // 0x0x10
    public string <GBHDMBFAIKO>k__BackingField;    // 0x0x18
    public string <CMOBOIBOGGO>k__BackingField;    // 0x0x20
    public string <ACHBCCFKAPC>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public COKNLBOGDAO <CurrencyType>k__BackingField;    // 0x0x18
    public KNHAMAEBGGK <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<PALBPPPGOHH<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <KJPHNFDPINN>k__BackingField;    // 0x0x10
    public long? <AMBBJKKLGLN>k__BackingField;    // 0x0x18
}
...
{
    public string <KBFCIOKILGB>k__BackingField;    // 0x0x10
    public int <EOPPPBMHKDN>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public OAIMOGCLIIO FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public LBBELABPADG <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public PEIKCOPGDKJ <GDHNOCBHBMI>k__BackingField;    // 0x0x10
    public string <ODGIFCKJADA>k__BackingField;    // 0x0x18
    public int <NFOMNAIDBGJ>k__BackingField;    // 0x0x20
    public int <BEOLMKIFFHF>k__BackingField;    // 0x0x24
    public string <EBEDIJKAJPF>k__BackingField;    // 0x0x28
    public string <PLDECGJIFLD>k__BackingField;    // 0x0x30
}
...
{
    public int <GMOMHDJGKJJ>k__BackingField;    // 0x0x10
    public Guid <IKJHJMOFALP>k__BackingField;    // 0x0x14
    public DateTime <EFPBBJHBBNC>k__BackingField;    // 0x0x28
}
...
{
    public bool <ANGOIJDLAGB>k__BackingField;    // 0x0x10
    public int <IJAKAHNBNJG>k__BackingField;    // 0x0x14
    public bool <NKBNDLNJHKE>k__BackingField;    // 0x0x18
}
...
{
    public Guid <IKJHJMOFALP>k__BackingField;    // 0x0x10
    public PEIKCOPGDKJ <KGDPEDMPNOE>k__BackingField;    // 0x0x20
    public int <KLMKJCPGGEB>k__BackingField;    // 0x0x24
    public long <EDIEOMFAJHC>k__BackingField;    // 0x0x28
    public long? <NEIEFBHDIOP>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{pLJIDOFCCEP}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <KMEGAMILDIO>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <OCIMGJJAPFE>k__BackingField;    // 0x0x18
}
...
{
    public long <NCKJEECMECF>k__BackingField;    // 0x0x10
    public long <EDIEOMFAJHC>k__BackingField;    // 0x0x18
    public long <IHAGACOFDKG>k__BackingField;    // 0x0x20
    public FPKMMDCDBCK <JHFPPALCFIF>k__BackingField;    // 0x0x28
    public int <ALLEADNLNFN>k__BackingField;    // 0x0x2C
}
...
{
    public long <EDIEOMFAJHC>k__BackingField;    // 0x0x10
    public List<Guid> <BBFLFCNENHO>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <KMEGAMILDIO>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <OCIMGJJAPFE>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <NHKNALDPGEA>k__BackingField;    // 0x0x20
}
...
{
    public long <IHAGACOFDKG>k__BackingField;    // 0x0x10
    public long <FHHDAKCMCGI>k__BackingField;    // 0x0x18
    public int? <EHOFMMLGGDD>k__BackingField;    // 0x0x20
    public int? <DFDFBAJHFGG>k__BackingField;    // 0x0x28
    public long? <ANAGKIJPCFG>k__BackingField;    // 0x0x30
    public long <LJGCKJPONKG>k__BackingField;    // 0x0x40
    public long <HGFMMGFDKCH>k__BackingField;    // 0x0x48
    public int <ICMENLIFHDM>k__BackingField;    // 0x0x50
    public FPKMMDCDBCK <IPGPNAJEMJC>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <HGELLKCDEKH>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public LBBELABPADG <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public DPLLHLFGGEJ creatorAccountRole;    // 0x0x68
...
{
    public HMKDOACABBJ <IBNIICCMEKB>k__BackingField;    // 0x0x10
    public HAJJPBALDDH <MIEKAKOEJCA>k__BackingField;    // 0x0x14
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x18
    public string <IFMOCMLGIBO>k__BackingField;    // 0x0x20
    public bool <MMIOMOEFPGF>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<HMKDOACABBJ> <KLFFDDHAGCE>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{pHKEPFBPHEA}   [Service.API]
public class ProgressionEventDTO
{
    public long <FHHDAKCMCGI>k__BackingField;    // 0x0x10
    public string <DDKHAIBFKBB>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <NPIGBENNDBN>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <MFACPMFCCBD>k__BackingField;    // 0x0x28
    public DateTime <DFOKNLEHAJN>k__BackingField;    // 0x0x30
    public DateTime <MCHLKDBILKL>k__BackingField;    // 0x0x38
    public DateTime <AAOJFDKBPLF>k__BackingField;    // 0x0x40
    public bool <HKJGJKLPCGF>k__BackingField;    // 0x0x48
    public int <FHEJLNNFIGF>k__BackingField;    // 0x0x4C
    public float <DLCMBCAOGLA>k__BackingField;    // 0x0x50
    public Guid? <FJCGBCFKALH>k__BackingField;    // 0x0x54
    public string <EJOCDJDBPBK>k__BackingField;    // 0x0x68
    public string <MKNJNOKEANI>k__BackingField;    // 0x0x70
    public string <BLGFJGKBLMP>k__BackingField;    // 0x0x78
    public string <FAKBNMJGDPD>k__BackingField;    // 0x0x80
}
...
{
    public Guid <MDIPLDOPJED>k__BackingField;    // 0x0x10
    public int <OLMMBBOPNFE>k__BackingField;    // 0x0x20
    public int <KJFMBIKGLLN>k__BackingField;    // 0x0x24
    public int <CMOMPKKIACJ>k__BackingField;    // 0x0x28
    public long <MGNPGFAJILH>k__BackingField;    // 0x0x30
    public long <BOAEDJCFGMG>k__BackingField;    // 0x0x38
}
...
{
    public int <GMOMHDJGKJJ>k__BackingField;    // 0x0x10
    public int <PGLODMABABK>k__BackingField;    // 0x0x14
    public int <GHDOFKEAPIO>k__BackingField;    // 0x0x18
    public int <GHNCHJEPOFI>k__BackingField;    // 0x0x1C
    public int <DEHHMABKEKC>k__BackingField;    // 0x0x20
    public DateTime? <KIPIHPOBMEP>k__BackingField;    // 0x0x28
    public int <PNGBMIKDHCO>k__BackingField;    // 0x0x38
}
...
{
    public long <MLEGPJJPODP>k__BackingField;    // 0x0x10
    public int <BMEAFLMMAMF>k__BackingField;    // 0x0x18
    public string <BHJLPEJHCKH>k__BackingField;    // 0x0x20
    public int <PGLODMABABK>k__BackingField;    // 0x0x28
    public int <LOKIMFECHOI>k__BackingField;    // 0x0x2C
    public bool <KLLFKBEJHBF>k__BackingField;    // 0x0x30
    public bool <BDAHAGOILAG>k__BackingField;    // 0x0x31
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public DNLALIJEMOE <Permission>k__BackingField;    // 0x0x18
    public IHPKKIOOIAO <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<LIIIDPHKBJF<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public ABNGKNPBFKP ReportCategory;    // 0x0x20
}
...
public class ReplicationUnityAssetsDTO
{
    ...
    public List<ALGNLHOIKAG> <UnityAssets>k__BackingField;    // 0x0x18
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public IHPKKIOOIAO <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public FCFPIGDGADE <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<HOAHODFJJPA> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{eHOHHEMAMCG}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool FLCKFJJPLMO;    // 0x0x28
}
...
{
    public GGJHGCFNGFI? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public GGJHGCFNGFI IIHHHDBMDLI;  // wrapper
...
{
    public LGBPLMEOAKA BMMNCBMEGCE;  // wrapper
...
{
    public DEOBAGKCNBH ADGMECOLKNH;  // wrapper
    public int? CMHELFPGILF;  // wrapper
...
{
    public NIKIKDPGJKM FBHPLCBGPHN;  // wrapper
...
{
    public byte[] KANAIIDGHCH;  // wrapper
    public GHIFCIOPAID DCOCJFJGMCL;  // wrapper
...
{
    public NIKIKDPGJKM NMPMJMKBAPF;  // wrapper
    public float? FLLMLFAPMDI;  // wrapper
    public bool? DCONGFMOFKH;  // wrapper
...
{
    public List<EPADPFJDNDI> desc;  // wrapper
}
...
{
    public LBBELABPADG KKBNGKDBMPF;  // wrapper
    public LBBELABPADG? MLCBDADCOEG;  // wrapper
...
{
    public ChatMessage JDFCBBCKOGJ;  // wrapper
    public OPLNLFADDGE NMPMJMKBAPF;  // wrapper
...
{
    public IHPKKIOOIAO FHOECEOGNGE;  // wrapper
    public NFBCDHHPBCN OHBBMMOFDGL;  // wrapper
    public IFMNLAHAINE AAEBENGBMMI;  // wrapper
    public IFMNLAHAINE MAHMGDLKNHD;  // wrapper
...
// api/customAvatarItems/v1/{pJJIOIOLAMC}/appeal  [API POST]
public class CustomAvatarItemsV1PJJIOIOLAMCAppealRequest
{
    public Guid PJJIOIOLAMC;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{lNNPPOOFAGA}  [API GET]
public class CustomAvatarItemsV2FromCreatorLNNPPOOFAGARequest
{
...
{
    public BOIHLABLBMA HNHBHGCFEMJ;  // wrapper
    public LBBELABPADG? EDKJLAAAKAD;  // wrapper
...
{
    public KGOLHEEAMOA AMAJPMNJNDO;  // wrapper
...
{
    public int? DAOECODEBJJ;  // wrapper
    public Guid? PJJIOIOLAMC;  // wrapper
...
// api/keepsakes/{cHAPBCKABGN}/collect  [API POST]
public class KeepsakesCHAPBCKABGNCollectRequest
{
    public Guid CHAPBCKABGN;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public BNLCCIFJKPM DHHBCOHIJDI;  // wrapper
    public long? MDNJLMOPJKG;  // wrapper
...
{
    public LFFNFNDEGMG MFPPFGJCKNF;  // wrapper
    public LFFNFNDEGMG CKHNOAMJJHH;  // wrapper
    public OJEJMGKECPJ NNIPPOGCGFP;  // wrapper
}
...
{
    public long? JDPEMOIFJMF;  // wrapper
    public OJEJMGKECPJ NNIPPOGCGFP;  // wrapper
    public long? ADCHKFMKAAG;  // wrapper
}

// api/playerevents/v2/{eventId}/time  [API PUT]
public class PlayereventsV2EventIdTimeRequest
{
    public DateTime FNCCBDMLILN;  // wrapper
    public DateTime MAEDMBKLJNJ;  // wrapper
    public OJEJMGKECPJ NNIPPOGCGFP;  // wrapper
    public DateTime ILDCGKDJHJM;  // wrapper
    public DateTime KHCMPLJEGIK;  // wrapper
}
...
{
    public Guid CAEAAAIELOA;  // wrapper
...
{
    public Guid EIDJGFGGDGI;  // wrapper
...
{
    public Guid EIDJGFGGDGI;  // wrapper
    public long? JNAGPJEONKM;  // wrapper
    public byte? ADPIMLAGACM;  // wrapper
    public int? BGBIPHDMBPB;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid CAEAAAIELOA;  // wrapper
    public long? CBBANDGEEIF;  // wrapper
    public long? CEKHJIDJMLP;  // wrapper
    public int? MBIPCKLBHPE;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> ONHEEOKCMKO;  // wrapper
...
{
    public HJEJNNPBNMF ADGMECOLKNH;  // wrapper
    public Guid? BMAEOFOMINH;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public NIKIKDPGJKM NMPMJMKBAPF;  // wrapper
    public long? CGCENAEFJMF;  // wrapper
    public Guid? NDGAKOGJINE;  // wrapper
    public int? GKBDEKCDPJG;  // wrapper
...
{
    public Guid FCHBKAFBCLF;  // wrapper
...
{
    public Guid FBPMPLAIMNG;  // wrapper
...
{
    public CMIOMCNDFBC BNHDFJIPJLP;  // wrapper
}
