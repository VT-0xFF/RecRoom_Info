...
// DTO classes: 285 (plus referenced enums)

// --------------------------------------------------------------------------
// ABCHGHDCMBJ
//   RESPONSE GET    api/testcasemanagement/v1/testcase/   [Service.API]
public class ABCHGHDCMBJ
{
    public string <ACJACKDIIOG>k__BackingField;    // 0x0x10
    public string <NPNLGMKBCAN>k__BackingField;    // 0x0x18
    public string <DJHMFFIIPML>k__BackingField;    // 0x0x20
    public string <MEOCMMMOBOM>k__BackingField;    // 0x0x28
    public string <FHKENGDOKAM>k__BackingField;    // 0x0x30
    public PFCFCHDFLNO <OHHCFFJCPJC>k__BackingField;    // 0x0x38
    public List<string> <GNCAFIGFPCA>k__BackingField;    // 0x0x40
    public List<string> <PHOIIMCCOGI>k__BackingField;    // 0x0x48
    public string <OCLFJCNMFHC>k__BackingField;    // 0x0x50
    public List<FEDPGOHFCAL> <DLOHKJIPJPE>k__BackingField;    // 0x0x58
}

// --------------------------------------------------------------------------
// ADOPOHFDNDH
//   RESPONSE GET    api/inventions/v1/details   [Service.API]
public class ADOPOHFDNDH
{
    public List<FPMGEPJAEGN> <PHOIIMCCOGI>k__BackingField;    // 0x0x10
}
...
public class AIHJEMDNHAA : ICNMJNLKFDK
{
    public List<FPMGEPJAEGN> <PHOIIMCCOGI>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// AJMKKKGAKDI
//   (not directly referenced by a detected call)
public class AJMKKKGAKDI
{
    public float <DAPOPBNJCLM>k__BackingField;    // 0x0x10
    public float <AMIDOCNEKLO>k__BackingField;    // 0x0x14
    public float <NGOBFNAECLN>k__BackingField;    // 0x0x18
    public float <AIGJHLBEGFL>k__BackingField;    // 0x0x1C
    public float <CMFGLEOKBPB>k__BackingField;    // 0x0x20
    public float <MIMJDJCBDGH>k__BackingField;    // 0x0x24
    public float <CJONONJNIAL>k__BackingField;    // 0x0x28
    public float <PMNDPCDIDAL>k__BackingField;    // 0x0x2C
}

// --------------------------------------------------------------------------
// AKDLIFLJLID
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.Econ]
public class AKDLIFLJLID
{
    public Guid? <JKBOLHMKOLM>k__BackingField;    // 0x0x10
    public long? <JBOILCHIGMF>k__BackingField;    // 0x0x28
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x38
    public string <MEOCMMMOBOM>k__BackingField;    // 0x0x40
    public string <DEKLPKKBNDH>k__BackingField;    // 0x0x48
    public EMEJEFJBKJC <ALJEBJOOGGH>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// ALPEBIDOMCI
//   (not directly referenced by a detected call)
public class ALPEBIDOMCI
{
    public Guid <JKBOLHMKOLM>k__BackingField;    // 0x0x10
    public long <JBOILCHIGMF>k__BackingField;    // 0x0x20
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x28
    public string <MEOCMMMOBOM>k__BackingField;    // 0x0x30
    public string <DEKLPKKBNDH>k__BackingField;    // 0x0x38
    public long <JGAGDHIHBLJ>k__BackingField;    // 0x0x40
    public Guid? <MFGBCBAGKEO>k__BackingField;    // 0x0x48
    public DateTime <NGJMOFPFONB>k__BackingField;    // 0x0x60
    public int <FFADAJOEJHD>k__BackingField;    // 0x0x68
}
...
// ANDADAPPDJB
//   (not directly referenced by a detected call)
public class ANDADAPPDJB
{
    public DMGHEJODOOO HBCGBGEDLBK;    // 0x0x10
    public int LNBEHINIBEL;    // 0x0x14
}

// --------------------------------------------------------------------------
// AODKLBMPMLO
//   RESPONSE GET    api/playerevents/v1/club/{clubId}   [Service.API]
public class AODKLBMPMLO
{
    public List<ICNMJNLKFDK> <COHHLLNPBPB>k__BackingField;    // 0x0x10
    public string <ILEJGAEHDLH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// APCPLJFPEIF
//   REQUEST  POST   api/playerevents/v1/report   [Service.API]
public class APCPLJFPEIF
{
    public CPAFECDDLMJ <CKOIGBNOKIN>k__BackingField;    // 0x0x10
    public long <ALMNBDIIMFN>k__BackingField;    // 0x0x18
    public string <GGKECLBCJEL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// BAIPJGJLBKH
//   RESPONSE PUT    api/roomconsumables   [Service.Econ]
public class BAIPJGJLBKH
{
    public BOHALPGOKLL <OHHCFFJCPJC>k__BackingField;    // 0x0x10
    public OOAKMDMPHMC <BEAGOCINGGH>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// BDNDKPMJLBM
//   RESPONSE GET    api/config/v2   [Service.API]
public class BDNDKPMJLBM
{
    public Dictionary<int, int> <ODOFGHENFJB>k__BackingField;    // 0x0x10
    public List<DGLACDONNHP> <DJGICKPLDGG>k__BackingField;    // 0x0x18
    public ANDADAPPDJB[][] <COAJAJLNMAN>k__BackingField;    // 0x0x20
    public PIALADEOKIF <PPAHALNMBMO>k__BackingField;    // 0x0x28
    public AJMKKKGAKDI <BOMPLNEBNFD>k__BackingField;    // 0x0x30
    public OKEAPMNIENK <LLCOLJGCPHH>k__BackingField;    // 0x0x38
    public EMMPGAJEIIH <DJHNCLEHGGC>k__BackingField;    // 0x0x40
    public JICABAJGHGG <HOMGPMBDAHF>k__BackingField;    // 0x0x48
    public string <OHBNGPCJDML>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// BFLBCDOPLHH
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.Econ]
public class BFLBCDOPLHH
{
    public long <JBOILCHIGMF>k__BackingField;    // 0x0x10
    public Dictionary<int, byte> <KGHMFJGLLEH>k__BackingField;    // 0x0x18
    public OIBMBGMNNAH <GFHJLHLJONC>k__BackingField;    // 0x0x20
    public bool <EGIBMEKBBCN>k__BackingField;    // 0x0x21
    public long <CEJLDLGFJLM>k__BackingField;    // 0x0x28
}
...
public class BKEDEALINBI
{
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x10
    public long <LMEPIEEHHAI>k__BackingField;    // 0x0x18
    public List<HJLACLGONDN> <OPDJDOOANGC>k__BackingField;    // 0x0x20
}
...
public class CBJFIEOLOIG
{
    public int? <KJLFJDFOCNG>k__BackingField;    // 0x0x10
    public string <FHKENGDOKAM>k__BackingField;    // 0x0x18
    public string <HJJHACFLFAH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// CHIBKLEEANL
//   (not directly referenced by a detected call)
public class CHIBKLEEANL
{
    public int <GEHEKBMEJHI>k__BackingField;    // 0x0x10
    public EBCBJGOJIBI <IEFCFJMABBC>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// CJMIFGIGDFL
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/balanceAddType/{mPANHJMLCKL}/{jLAMGBOGOJE}   [Service.Econ]
public class CJMIFGIGDFL
{
    public LMFNPHDGODM <HEKPNCEGMAG>k__BackingField;    // 0x0x10
    public MOCNHAMKIHJ <ALDPHPCGNFF>k__BackingField;    // 0x0x14
    public int <IHBLDOPBCBM>k__BackingField;    // 0x0x18
    public int <MJAPAAIAAHH>k__BackingField;    // 0x0x1C
    public int <IFCNBMNJKFH>k__BackingField;    // 0x0x20
    public FNHFNCBBDAF <ICLIHHEKCGK>k__BackingField;    // 0x0x24
    public bool <GJMAEMOCPOH>k__BackingField;    // 0x0x28
    public float <ADPMGLBDFEH>k__BackingField;    // 0x0x2C
    public int <MDKEPKIDJDH>k__BackingField;    // 0x0x30
    public bool <IPHONOHEDJP>k__BackingField;    // 0x0x34
}
...
//   (not directly referenced by a detected call)
public class CKPKFPAKPLM : ValueType
{
    public Guid OCONCDFGCOB;    // 0x0x0
}

// --------------------------------------------------------------------------
// CPGGCKBJEKG
//   RESPONSE GET    api/customAvatarItems/v1/design   [Service.API]
public class CPGGCKBJEKG
{
    public int <LMEPIEEHHAI>k__BackingField;    // 0x0x10
    public int? <FKILJMFIBKG>k__BackingField;    // 0x0x14
    public string <IBIIKEKAKIH>k__BackingField;    // 0x0x20
    public string <HCBACOBMBEA>k__BackingField;    // 0x0x28
}
...
public class DFPLEBKKFNJ
{
    public int <NAENAEFHFJI>k__BackingField;    // 0x0x10
    public int <IGCKLMPFEJM>k__BackingField;    // 0x0x14
    public float <CJPDAGABGMP>k__BackingField;    // 0x0x18
    public float <DDFAGADFOIG>k__BackingField;    // 0x0x1C
    public bool <LMFOGLCEPDH>k__BackingField;    // 0x0x20
    public bool <MKEDBJNBGCE>k__BackingField;    // 0x0x21
    public bool <MLNCPEIADFB>k__BackingField;    // 0x0x22
}

// --------------------------------------------------------------------------
// DHFFLDFNEMP
//   RESPONSE GET    api/testcasemanagement/   [Service.API]
//   RESPONSE GET    api/testcasemanagement/v1/testpass/{nMAIBBDGPCD}   [Service.API]
public class DHFFLDFNEMP
{
    public uint <ACJACKDIIOG>k__BackingField;    // 0x0x10
    public uint? <BBFNLCHCOBL>k__BackingField;    // 0x0x14
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x20
    public string <MEOCMMMOBOM>k__BackingField;    // 0x0x28
    public DateTime <POCPPMIPMLK>k__BackingField;    // 0x0x30
    public DateTime? <LOBMEFCANDL>k__BackingField;    // 0x0x38
    public bool <GBJHIBLMHPP>k__BackingField;    // 0x0x48
    public List<ABCHGHDCMBJ> <EEMJCFFNDHG>k__BackingField;    // 0x0x50
    public List<string> <PHOIIMCCOGI>k__BackingField;    // 0x0x58
    public int <EGLDAOBOLBI>k__BackingField;    // 0x0x60
    public int <ICGHEBDLMGP>k__BackingField;    // 0x0x64
    public int <LNDJCJEOCMI>k__BackingField;    // 0x0x68
}
...
public class DJFGJCINPGM
{
    public List<string> <AGINPAMFEKM>k__BackingField;    // 0x0x10
    public List<string> <EGCGDAKDIOI>k__BackingField;    // 0x0x18
    public List<string> <HPDFLLCBGIA>k__BackingField;    // 0x0x20
}
...
// EEJCFNMDBNE
//   (not directly referenced by a detected call)
public class EEJCFNMDBNE
{
    public LMFNPHDGODM <HEKPNCEGMAG>k__BackingField;    // 0x0x10
    public int <JGAGDHIHBLJ>k__BackingField;    // 0x0x14
    public HIJIDGMNGEE <PJJMCGJHPJG>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EFNPNOJGOBA
//   REQUEST  POST   api/roomcurrencies/v1/awardCurrency/bulk   [Service.Econ]
public class EFNPNOJGOBA
{
    public Guid <FNOBMMENOEE>k__BackingField;    // 0x0x10
    public int <DPDEDPBNIPP>k__BackingField;    // 0x0x20
    public long <ILGLAEHOKHN>k__BackingField;    // 0x0x28
    public Guid <BEGDLLEHBDE>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// EJJHDKNBJOG
//   REQUEST  POST   api/equipment/v1/update   [Service.Econ]
public class EJJHDKNBJOG
{
    public string <IIEOAKIMAKI>k__BackingField;    // 0x0x10
    public string <AONEONAGOOC>k__BackingField;    // 0x0x18
    public string <MCNFAJFOPHH>k__BackingField;    // 0x0x20
    public string <PNALOKBMKCG>k__BackingField;    // 0x0x28
    public BJHDLCNOPOE <MOLGALMNJBN>k__BackingField;    // 0x0x30
    public string <MNKFOJGHLMD>k__BackingField;    // 0x0x38
    public bool EPPKCCHCEMA;    // 0x0x40
    public bool <MLNCPEIADFB>k__BackingField;    // 0x0x41
}

// --------------------------------------------------------------------------
// EJMJPAHNMJL
//   RESPONSE GET    api/incentivizedreferrals/referrals   [Service.Econ]
public class EJMJPAHNMJL
{
    public List<MMDMEFLFFNB> <CAEMJGOEAIO>k__BackingField;    // 0x0x10
    public string <ILEJGAEHDLH>k__BackingField;    // 0x0x18
}
...
public class ELHGJFMHDFO
{
    public List<long> <ONOIENHHCAA>k__BackingField;    // 0x0x10
    public NFCHJPMCDNE <IFHHKMAPPLK>k__BackingField;    // 0x0x18
    public string <GAGPABJKJCD>k__BackingField;    // 0x0x20
    public long? <JBOILCHIGMF>k__BackingField;    // 0x0x28
}
...
// EMEJEFJBKJC
//   (not directly referenced by a detected call)
public class EMEJEFJBKJC
{
    public long <JGAGDHIHBLJ>k__BackingField;    // 0x0x10
    public Guid? <FNOBMMENOEE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// EMMPGAJEIIH
//   (not directly referenced by a detected call)
public class EMMPGAJEIIH
{
    public int <MPGDDECKPAP>k__BackingField;    // 0x0x10
}
...
//   RESPONSE POST   api/customAvatarItems/v1/{pCPOOIGHMLK}/appeal   [Service.API]
...
//   RESPONSE DELETE api/keepsakes/{kHHJKJEPENJ}   [Service.API]
...
public class ENEHDIDOEFG
{
    public bool <CCEKENADMKM>k__BackingField;    // 0x0x10
    public string <JBNAGALNGJD>k__BackingField;    // 0x0x18
    public string <GOEHHEHOBEG>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// EODEHKBHOBG
// base   : GMECIJHCICI`1<RecNet.KeepsakeCategoryConfigDTO>
//   RESPONSE GET    api/keepsakes/categories   [Service.API]
public class EODEHKBHOBG
{
    // (no instance fields in the metadata dump)
}
...
public class EPEHLLAICDK
{
    public long <FBJLFCHKGBD>k__BackingField;    // 0x0x10
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x18
    public DateTime <AHNPGANPAAH>k__BackingField;    // 0x0x20
    public DateTime <OHPLDCDDIDD>k__BackingField;    // 0x0x28
    public int <MPLCJDCOLHH>k__BackingField;    // 0x0x30
    public int <OPMPJPJNBCB>k__BackingField;    // 0x0x34
}
...
// base   : NBCPBKPGNHN
//   RESPONSE GET    api/storefronts/   [Service.Econ]
//   RESPONSE GET    api/storefronts/v1/season/{gDOALLFDIEI}   [Service.Econ]
public class FBHBPAIFOHF : NBCPBKPGNHN
{
    public int <EGKNFGGOJNN>k__BackingField;    // 0x0x30
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x38
    public DateTime <IMCAFBDNEJB>k__BackingField;    // 0x0x40
    public DateTime <GCFCKEODNNI>k__BackingField;    // 0x0x48
    public LMFNPHDGODM <HEKPNCEGMAG>k__BackingField;    // 0x0x50
    public LMNBBFNAMME <LEEJBIIGHEF>k__BackingField;    // 0x0x58
    public List<OJMMGOGFFMA> <PODKPJKCGBE>k__BackingField;    // 0x0x60
    public LJJBIHMPMAA <NIJCCEIOCHJ>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FBMHLCEFBKL
//   RESPONSE GET    api/influencerpartnerprogram/influencers   [Service.Econ]
public class FBMHLCEFBKL
{
    public List<int> <FLPCMPIHBGO>k__BackingField;    // 0x0x10
    public string <ILEJGAEHDLH>k__BackingField;    // 0x0x18
}
...
// FEDPGOHFCAL
//   (not directly referenced by a detected call)
public class FEDPGOHFCAL
{
    public DateTime <DAIEAKDBLPJ>k__BackingField;    // 0x0x10
    public string <BPPLHIILCGN>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// FELKOOEKDEA
//   RESPONSE POST   api/PlayerReporting/v1/moderationBlockDetails   [Service.API]
public class FELKOOEKDEA
{
    public CPAFECDDLMJ <CKOIGBNOKIN>k__BackingField;    // 0x0x10
    public int <IJBEOACOKLK>k__BackingField;    // 0x0x14
    public long <LFHIOEIGOGL>k__BackingField;    // 0x0x18
    public bool <DEDLNKOOFGM>k__BackingField;    // 0x0x20
    public string <FFEFDPLHDMO>k__BackingField;    // 0x0x28
    public int? <BCGFNNHLFPF>k__BackingField;    // 0x0x30
    public bool <MCLGPHBBBND>k__BackingField;    // 0x0x38
    public bool <FECAIJLBDAC>k__BackingField;    // 0x0x39
    public bool <HNELMCKIGGP>k__BackingField;    // 0x0x3A
    public bool <EPPNAMOIGKA>k__BackingField;    // 0x0x3B
    public string <CNICMHDFDIP>k__BackingField;    // 0x0x40
    public DateTime? <FGJKBPGGNBP>k__BackingField;    // 0x0x48
    public string <HFGADFFFCFF>k__BackingField;    // 0x0x58
    public bool <EHGEIOAEKLO>k__BackingField;    // 0x0x60
    public string <KMIDIKBGGHN>k__BackingField;    // 0x0x68
    public string <OKAJKCICOJP>k__BackingField;    // 0x0x70
    public float <IEJBNBJDFPF>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// FHAOFAMPDEC
//   RESPONSE GET    api/playerevents/v1/all   [Service.API]
//   RESPONSE GET    api/playerevents/v1/all/{kPCCLFNHPJC}   [Service.API]
public class FHAOFAMPDEC
{
    public List<ICNMJNLKFDK> <EGAAAJLLMAD>k__BackingField;    // 0x0x10
    public List<OHLKMABNAPM> <AHCALJPBFHK>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomconsumables/v1/roomConsumable/{jCEPLKHMKGM}   [Service.Econ]
public class FKGKBKMGOIO
{
    public BOHALPGOKLL <OHHCFFJCPJC>k__BackingField;    // 0x0x10
    public ALPEBIDOMCI <FFPELONFHAA>k__BackingField;    // 0x0x18
}
...
public class FLEADOGLLOA
{
    public AIHJEMDNHAA <GAALOIIPMNH>k__BackingField;    // 0x0x10
    public EBCBJGOJIBI <IEFCFJMABBC>k__BackingField;    // 0x0x18
    public IPAPHMAKOAB <HJCNOFKHDFK>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FLFHKDMHOPL
//   (not directly referenced by a detected call)
public class FLFHKDMHOPL
{
    public long <IDGFMLGFDIE>k__BackingField;    // 0x0x10
    public Guid <GNLGACBEHBA>k__BackingField;    // 0x0x18
    public long <JBOILCHIGMF>k__BackingField;    // 0x0x28
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x30
    public string <MEOCMMMOBOM>k__BackingField;    // 0x0x38
    public int <JGAGDHIHBLJ>k__BackingField;    // 0x0x40
    public Guid? <MFGBCBAGKEO>k__BackingField;    // 0x0x44
    public DateTime <DAIEAKDBLPJ>k__BackingField;    // 0x0x58
    public string <DEKLPKKBNDH>k__BackingField;    // 0x0x60
    public KFHPBPCBOMF <IFHHKMAPPLK>k__BackingField;    // 0x0x68
}

// --------------------------------------------------------------------------
// FLKEIPMPCJF
//   (not directly referenced by a detected call)
public class FLKEIPMPCJF
{
    public bool <FDPDBGAIPEL>k__BackingField;    // 0x0x10
    public KICGLGIDEMP <GGCIELINMIN>k__BackingField;    // 0x0x18
    public float <DBGFCDPEDPF>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// FMOLAOBEJCF
//   RESPONSE GET    api/makerai/freetrialconfig   [Service.Econ]
public class FMOLAOBEJCF
{
    public TimeSpan <BNMLLEABAKB>k__BackingField;    // 0x0x10
    public TimeSpan <IJBEOACOKLK>k__BackingField;    // 0x0x18
}
...
// FPMGEPJAEGN
//   (not directly referenced by a detected call)
public class FPMGEPJAEGN
{
    public string <DCFJFJEEEIH>k__BackingField;    // 0x0x10
    public GNPFLHLJALH <IFHHKMAPPLK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// GDGKJAFLADP
//   (not directly referenced by a detected call)
public class GDGKJAFLADP
{
    public long <EGHHMDJIBKI>k__BackingField;    // 0x0x10
    public Guid <PHNCAJFFBJD>k__BackingField;    // 0x0x18
    public Guid <AKKIKFDPFME>k__BackingField;    // 0x0x28
    public DateTime <DAIEAKDBLPJ>k__BackingField;    // 0x0x38
    public string <NLEIEOLLPII>k__BackingField;    // 0x0x40
    public string <NDBNFIKPGIG>k__BackingField;    // 0x0x48
    public int <NLLFPHLLMFE>k__BackingField;    // 0x0x50
    public string <DOKLCNCJOFF>k__BackingField;    // 0x0x58
    public string <PBMCMMCJDGD>k__BackingField;    // 0x0x60
    public string <DJMEOEKBCKF>k__BackingField;    // 0x0x68
    public string <APHEDDMMNFM>k__BackingField;    // 0x0x70
    public int <NFKNOBMHCHJ>k__BackingField;    // 0x0x78
}

// --------------------------------------------------------------------------
// GEHECBHLLJC
//   (not directly referenced by a detected call)
public class GEHECBHLLJC
{
    // (no instance fields in the metadata dump)
}
...
public class GPIPLLMBKIA
{
    public long <JBOILCHIGMF>k__BackingField;    // 0x0x10
    public long? <KDCMFBGMJBC>k__BackingField;    // 0x0x18
    public long? <ECFACHIMFPI>k__BackingField;    // 0x0x28
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x38
    public string <MEOCMMMOBOM>k__BackingField;    // 0x0x40
    public List<string> <PHOIIMCCOGI>k__BackingField;    // 0x0x48
    public string <DEKLPKKBNDH>k__BackingField;    // 0x0x50
    public DateTime <AHNPGANPAAH>k__BackingField;    // 0x0x58
    public DateTime <OHPLDCDDIDD>k__BackingField;    // 0x0x60
    public JDLJHEJGIAH <HDBKNMKENCB>k__BackingField;    // 0x0x68
    public bool <BOFDAJGBDON>k__BackingField;    // 0x0x6C
    public bool <JKIFAEHCGFD>k__BackingField;    // 0x0x6D
    public PPJEOJHAEMG <BPBIFCIGJCF>k__BackingField;    // 0x0x70
    public PPJEOJHAEMG <BEMBJHCCMMH>k__BackingField;    // 0x0x74
}

// --------------------------------------------------------------------------
// GPLLCNIODGH
//   REQUEST  POST   api/playerevents/v1/respond   [Service.API]
public class GPLLCNIODGH
{
    public long <ALMNBDIIMFN>k__BackingField;    // 0x0x10
    public OFCBAONCDCP <IFHHKMAPPLK>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HCMNFJGCGFK
//   RESPONSE GET    api/config/v1/backtrace   [Service.API]
public class HCMNFJGCGFK
{
    public int <BOKCPCIOGHK>k__BackingField;    // 0x0x10
    public int <FGEHMEKPIHD>k__BackingField;    // 0x0x14
    public float <LINAFAMHMGE>k__BackingField;    // 0x0x18
    public int <JCOMJCJOEBL>k__BackingField;    // 0x0x1C
    public int <MCOFMPHPCKD>k__BackingField;    // 0x0x20
    public int <CGBCABAAPPL>k__BackingField;    // 0x0x24
    public int <KCECAJCAGMF>k__BackingField;    // 0x0x28
    public string <BILEKOAJPID>k__BackingField;    // 0x0x30
    public string <ODAGHLKNCND>k__BackingField;    // 0x0x38
}
...
public class HHNIJMOFNPD
{
    public long <IDGFMLGFDIE>k__BackingField;    // 0x0x10
    public int <NDANIGGAMDA>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// HIJIDGMNGEE
//   (not directly referenced by a detected call)
public class HIJIDGMNGEE
{
    public int <JDEOLJCNFLG>k__BackingField;    // 0x0x10
    public DateTime? <KAHBKHDOKHM>k__BackingField;    // 0x0x18
    public DateTime? <BDMLNDANPPO>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// HJLACLGONDN
//   (not directly referenced by a detected call)
public class HJLACLGONDN
{
    public Guid <PHNCAJFFBJD>k__BackingField;    // 0x0x10
    public int <LMEPIEEHHAI>k__BackingField;    // 0x0x20
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x28
    public string <MEOCMMMOBOM>k__BackingField;    // 0x0x30
    public int <JGAGDHIHBLJ>k__BackingField;    // 0x0x38
    public OGPADJCDAAA <HDBKNMKENCB>k__BackingField;    // 0x0x3C
    public bool <JMGLOMDFHBH>k__BackingField;    // 0x0x40
    public bool <GFMHPFONJOK>k__BackingField;    // 0x0x41
    public bool <BFAIBPHOBBC>k__BackingField;    // 0x0x42
    public int? <FKILJMFIBKG>k__BackingField;    // 0x0x44
    public string <HCBACOBMBEA>k__BackingField;    // 0x0x50
    public string <IBIIKEKAKIH>k__BackingField;    // 0x0x58
    public string <OCJIGMLMPBK>k__BackingField;    // 0x0x60
    public DateTime <DAIEAKDBLPJ>k__BackingField;    // 0x0x68
    public DateTime <NGJMOFPFONB>k__BackingField;    // 0x0x70
    public BHAPJECFNOC <LGGJOPLDOOM>k__BackingField;    // 0x0x78
    public string <BDDEAEGLELH>k__BackingField;    // 0x0x80
    public int <NFKNOBMHCHJ>k__BackingField;    // 0x0x88
    public IReadOnlyList<GDGKJAFLADP> <KAGINIILOOB>k__BackingField;    // 0x0x90
    public HPHKLJMNEEE <CIKJBOMLHLL>k__BackingField;    // 0x0x98
}

// --------------------------------------------------------------------------
// HPHKLJMNEEE
//   (not directly referenced by a detected call)
public class HPHKLJMNEEE
{
    public PIEGLCNCEHC <GPIJMGJEGHL>k__BackingField;    // 0x0x10
    public MMDHIIEJGLF <JNDOMCDHNJG>k__BackingField;    // 0x0x18
    public List<EEJCFNMDBNE> <MMNCOPLAOOG>k__BackingField;    // 0x0x20
    public DateTime? <AKAHHKMBCKI>k__BackingField;    // 0x0x28
    public DateTime? <KDECIPKEEBB>k__BackingField;    // 0x0x38
    public DateTime? <MIMANBHBLJI>k__BackingField;    // 0x0x48
    public bool <AGCHBMILOFD>k__BackingField;    // 0x0x58
    public bool <AECOECHFDDC>k__BackingField;    // 0x0x59
    public bool <NKFKDDCOIGM>k__BackingField;    // 0x0x5A
    public bool <GFMHPFONJOK>k__BackingField;    // 0x0x5B
}

// --------------------------------------------------------------------------
// IBAKIMPIDBF
//   RESPONSE GET    api/roomcurrencies/v1/getBalance   [Service.Econ]
public class IBAKIMPIDBF
{
    public int <NDANIGGAMDA>k__BackingField;    // 0x0x10
    public Guid <FNOBMMENOEE>k__BackingField;    // 0x0x14
    public long <FPOKFEIBICO>k__BackingField;    // 0x0x28
    public DateTime <NGJMOFPFONB>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// ICNMJNLKFDK
//   RESPONSE GET    api/playerevents/v1/{eventId}   [Service.API]
public class ICNMJNLKFDK
{
    public long <ALMNBDIIMFN>k__BackingField;    // 0x0x10
    public int <CKHDNBMEPGJ>k__BackingField;    // 0x0x18
    public long <JBOILCHIGMF>k__BackingField;    // 0x0x20
    public long? <KDCMFBGMJBC>k__BackingField;    // 0x0x28
    public long? <ECFACHIMFPI>k__BackingField;    // 0x0x38
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x48
    public string <MEOCMMMOBOM>k__BackingField;    // 0x0x50
    public string <DEKLPKKBNDH>k__BackingField;    // 0x0x58
    public DateTime <AHNPGANPAAH>k__BackingField;    // 0x0x60
    public DateTime <OHPLDCDDIDD>k__BackingField;    // 0x0x68
    public int <MIPMLPEONDH>k__BackingField;    // 0x0x70
    public JDLJHEJGIAH <HDBKNMKENCB>k__BackingField;    // 0x0x74
    public bool <BOFDAJGBDON>k__BackingField;    // 0x0x78
    public bool <JKIFAEHCGFD>k__BackingField;    // 0x0x79
    public PPJEOJHAEMG <BPBIFCIGJCF>k__BackingField;    // 0x0x7C
    public PPJEOJHAEMG <BEMBJHCCMMH>k__BackingField;    // 0x0x80
    public long? <BCBNGAJCECK>k__BackingField;    // 0x0x88
}

// --------------------------------------------------------------------------
// IFBNFCPCAAJ
//   RESPONSE GET    api/customAvatarItems/v1/pricingconfig   [Service.API]
public class IFBNFCPCAAJ
{
    public int ADFEJENENII;    // 0x0x10
    public int NELIHDMMELB;    // 0x0x14
}

// --------------------------------------------------------------------------
// IGDJDOLLBJF
// base   : GMECIJHCICI`1<HJLACLGONDN>
//   RESPONSE GET    api/customAvatarItems   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v1/me   [Service.API]
//   RESPONSE GET    api/customAvatarItems/v2/fromCreator/{fNHHMALGNPF}   [Service.API]
public class IGDJDOLLBJF
{
    // (no instance fields in the metadata dump)
}
...
// IKFDPJIEMJB
//   (not directly referenced by a detected call)
public class IKFDPJIEMJB
{
    public Guid <NGBMOIHFOCA>k__BackingField;    // 0x0x10
    public Guid <HBOJJNMGBAI>k__BackingField;    // 0x0x20
    public DateTime <IMCAFBDNEJB>k__BackingField;    // 0x0x30
    public List<KICGLGIDEMP> <ACEHBOHPLNM>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// IPAPHMAKOAB
//   RESPONSE POST   api/inventions/v1/settags   [Service.API]
public class IPAPHMAKOAB
{
    public OOAHBJKLADP <IEFCFJMABBC>k__BackingField;    // 0x0x10
    public List<string> <PHOIIMCCOGI>k__BackingField;    // 0x0x18
}
...
public class JENBDMBCBDF
{
    public Guid? <MPMDEBFPNKF>k__BackingField;    // 0x0x10
    public Guid <BKGCIJHLHGE>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// JGAKFHPFDMM
//   REQUEST  POST   api/relationships/v2/updateVoiceVolume   [Service.API]
public class JGAKFHPFDMM
{
    public int <IEBAOOHNCCF>k__BackingField;    // 0x0x10
    public byte <MABLPLDKDKK>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// JICABAJGHGG
//   (not directly referenced by a detected call)
public class JICABAJGHGG
{
    public float <KDFJAOPKAKA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// KCCDMPIIJOG
//   REQUEST  POST   api/items/bulkpurchase   [Service.Commerce]
public class KCCDMPIIJOG
{
    public List<MHLOALDKMIB> <MDJGAMFJMMP>k__BackingField;    // 0x0x10
    public MNKKBGFEDOF? <DOJNFGIKDEJ>k__BackingField;    // 0x0x18
    public LMFNPHDGODM <HEKPNCEGMAG>k__BackingField;    // 0x0x20
    public bool <PGCOBNLAPFJ>k__BackingField;    // 0x0x24
    public bool <PLOKHPDNKNJ>k__BackingField;    // 0x0x25
    public Guid? <BKIJBFPEFPB>k__BackingField;    // 0x0x28
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class KCNLPKHKIFL : ValueType
{
    public Guid OCONCDFGCOB;    // 0x0x0
}
...
public class KEMBPEBBKMD
{
    public Guid <BEGDLLEHBDE>k__BackingField;    // 0x0x10
    public long <NLFGBOCEOOA>k__BackingField;    // 0x0x20
}
...
// KICGLGIDEMP
//   (not directly referenced by a detected call)
public class KICGLGIDEMP
{
    public int <OPMPJPJNBCB>k__BackingField;    // 0x0x10
    public string <MCNFAJFOPHH>k__BackingField;    // 0x0x18
    public string <PNALOKBMKCG>k__BackingField;    // 0x0x20
    public string <PMAJGABMMPP>k__BackingField;    // 0x0x28
    public string <CLGDMAOBPGL>k__BackingField;    // 0x0x30
    public NCHELFAJJGK? <PFOOPOBNOPF>k__BackingField;    // 0x0x38
    public string <OMPMHKEDIAL>k__BackingField;    // 0x0x70
    public Guid? <PHNCAJFFBJD>k__BackingField;    // 0x0x78
    public BHCOMPDPHKN? <BMJHDGBHGNN>k__BackingField;    // 0x0x8C
    public string <BKICKGJHGND>k__BackingField;    // 0x0x98
    public string <DLAKHCOKKJB>k__BackingField;    // 0x0xA0
    public bool <MFIMPKPFJDH>k__BackingField;    // 0x0xA8
    public bool <JLGOELEODCD>k__BackingField;    // 0x0xA9
    public bool <NKFKDDCOIGM>k__BackingField;    // 0x0xAA
    public BJHDLCNOPOE <MOLGALMNJBN>k__BackingField;    // 0x0xAC
    public LMFNPHDGODM <HEKPNCEGMAG>k__BackingField;    // 0x0xB0
    public int <IEMCJGGHCJG>k__BackingField;    // 0x0xB4
    public HGOIMOGAAEP <LKIJPLDAKBJ>k__BackingField;    // 0x0xB8
    public OMIDHABEBNI <FMCFHJMNHKL>k__BackingField;    // 0x0xBC
    public int? <LIBBPMEDGKM>k__BackingField;    // 0x0xC0
    public string <FOBLIIGPONO>k__BackingField;    // 0x0xC8
    public int? <MBFAMIICOIN>k__BackingField;    // 0x0xD0
    public int? <CFACGDGNIKP>k__BackingField;    // 0x0xD8
    public string <MNKFOJGHLMD>k__BackingField;    // 0x0xE0
}
...
public class LABFEEDEOCG
{
    public RoomKeyResult <OHHCFFJCPJC>k__BackingField;    // 0x0x10
    public FLFHKDMHOPL <EFBFDEGOIIN>k__BackingField;    // 0x0x18
}
...
public class LBGDNKIIBPM
{
    public EBCBJGOJIBI <IEFCFJMABBC>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LHAAPMPLCFH
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class LHAAPMPLCFH
{
    public Dictionary<Guid, BAIPJGJLBKH> <CKCMPKHKEHK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LJJBIHMPMAA
//   (not directly referenced by a detected call)
public class LJJBIHMPMAA
{
    public bool <PAIHPNAAJAP>k__BackingField;    // 0x0x10
    public AMLOJEALFHA <CEFKLLGJFHL>k__BackingField;    // 0x0x14
    public int <MLCIKLPAHKJ>k__BackingField;    // 0x0x18
    public DateTime <NGJMOFPFONB>k__BackingField;    // 0x0x20
}
...
public class LMKJENBMEOJ
{
    public int <IJBEOACOKLK>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// LMNBBFNAMME
//   (not directly referenced by a detected call)
public class LMNBBFNAMME
{
    public int <APBLCIADFCC>k__BackingField;    // 0x0x10
    public NDLFBGODIHD <IFHHKMAPPLK>k__BackingField;    // 0x0x14
    public List<EEJCFNMDBNE> <MMNCOPLAOOG>k__BackingField;    // 0x0x18
    public List<EEJCFNMDBNE> <BBJPCKGJCGM>k__BackingField;    // 0x0x20
    public bool <GFMHPFONJOK>k__BackingField;    // 0x0x28
    public DateTime? <KDECIPKEEBB>k__BackingField;    // 0x0x30
    public DateTime? <MIMANBHBLJI>k__BackingField;    // 0x0x40
    public DateTime? <AKAHHKMBCKI>k__BackingField;    // 0x0x50
    public bool <AGCHBMILOFD>k__BackingField;    // 0x0x60
    public bool <ABEMEHIDHFF>k__BackingField;    // 0x0x61
}
...
public class MAFPDFIIEMM
{
    public BHCOMPDPHKN <BMJHDGBHGNN>k__BackingField;    // 0x0x10
    public string <MPPKABFKBHF>k__BackingField;    // 0x0x18
    public string <MCNFAJFOPHH>k__BackingField;    // 0x0x20
    public string <PNALOKBMKCG>k__BackingField;    // 0x0x28
    public BJHDLCNOPOE <MOLGALMNJBN>k__BackingField;    // 0x0x30
    public string <PMAJGABMMPP>k__BackingField;    // 0x0x38
    public int <MBFAMIICOIN>k__BackingField;    // 0x0x40
    public bool <KMAPOPNGONB>k__BackingField;    // 0x0x44
    public string <OPGAOANBDFO>k__BackingField;    // 0x0x48
    public DateTime <DAIEAKDBLPJ>k__BackingField;    // 0x0x50
}
...
public class MCDBGDEBFGF
{
    public long <FBJLFCHKGBD>k__BackingField;    // 0x0x10
    public int <NDANIGGAMDA>k__BackingField;    // 0x0x18
    public int <NEEOMKEFCIK>k__BackingField;    // 0x0x1C
}
...
public class MCOIIAELPNA : MPHJLEJICEP
{
    public HENHMOBPLKP? <CHCIMMGNPOO>k__BackingField;    // 0x0x18
    public IBAKIMPIDBF <FCPOIEMBFOA>k__BackingField;    // 0x0x20
}
...
public class MEOCNDMMOAB
{
    public bool <CCEKENADMKM>k__BackingField;    // 0x0x10
    public string <FFEFDPLHDMO>k__BackingField;    // 0x0x18
}
...
public class MHEGCHPLOPJ
{
    public JENBDMBCBDF <MLHOGBJOJNK>k__BackingField;    // 0x0x10
    public EMEJEFJBKJC <DPFCLDFJDKB>k__BackingField;    // 0x0x18
    public int <BCHGDKGJDHL>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MHLOALDKMIB
//   (not directly referenced by a detected call)
public class MHLOALDKMIB
{
    public MMDHIIEJGLF <LHHKMFKOGOF>k__BackingField;    // 0x0x10
    public long <FHIHIPEKAFG>k__BackingField;    // 0x0x18
    public GiftItemDTO <LBGFAFHAOLE>k__BackingField;    // 0x0x20
    public long? <BEFGDPPJLOJ>k__BackingField;    // 0x0x28
    public int <IDLOMBBDBDE>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// MMDHIIEJGLF
//   (not directly referenced by a detected call)
public class MMDHIIEJGLF
{
    public FAJOKKEMLLC <IFHHKMAPPLK>k__BackingField;    // 0x0x10
    public int? <IINHFBBPPNO>k__BackingField;    // 0x0x14
    public Guid? <JMKGAEPDALI>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// MMDMEFLFFNB
//   (not directly referenced by a detected call)
public class MMDMEFLFFNB
{
    public int <NIMHNPAHDGK>k__BackingField;    // 0x0x10
    public DateTime <DAIEAKDBLPJ>k__BackingField;    // 0x0x18
    public DateTime? <JILNGAGOOKH>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// MNCIPGPIBMD
//   (not directly referenced by a detected call)
public class MNCIPGPIBMD
{
    public int <BCHGDKGJDHL>k__BackingField;    // 0x0x10
    public JENBDMBCBDF <MLHOGBJOJNK>k__BackingField;    // 0x0x18
}
...
public class MONGFKHIJKA
{
    public Guid <FLEKCPGMFGP>k__BackingField;    // 0x0x10
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x20
    public string <DEKLPKKBNDH>k__BackingField;    // 0x0x28
    public DateTime <IMCAFBDNEJB>k__BackingField;    // 0x0x30
    public DateTime? <BOKLLGEMOEH>k__BackingField;    // 0x0x38
    public List<IKFDPJIEMJB> <JKEOJDKACGI>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// MPLBGLLNEII
//   (not directly referenced by a detected call)
public class MPLBGLLNEII
{
    public long <NFGCEMMGEKG>k__BackingField;    // 0x0x10
    public long <ALMNBDIIMFN>k__BackingField;    // 0x0x18
    public int <IEBAOOHNCCF>k__BackingField;    // 0x0x20
    public DateTime <DAIEAKDBLPJ>k__BackingField;    // 0x0x28
    public OFCBAONCDCP <IFHHKMAPPLK>k__BackingField;    // 0x0x30
}
...
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class NCHELFAJJGK : ValueType
{
    public KCNLPKHKIFL GDNHGDFEPFP;    // 0x0x0
    public CKPKFPAKPLM GIMIIAEDGKP;    // 0x0x10
    public Guid KGGNNFDKFIB;    // 0x0x20
}
...
//   RESPONSE POST   api/progressionEvents/collect/{aBBKMELJHDN}/{aBNFHHPBGLB}   [Service.API]
public class NDAMNDNBEKH
{
    public long? <ACJACKDIIOG>k__BackingField;    // 0x0x10
    public int <IEBAOOHNCCF>k__BackingField;    // 0x0x20
    public int? <AFCGCJOKODI>k__BackingField;    // 0x0x24
    public string <CLGDMAOBPGL>k__BackingField;    // 0x0x30
    public BHCOMPDPHKN? <BMJHDGBHGNN>k__BackingField;    // 0x0x38
    public string <OMPMHKEDIAL>k__BackingField;    // 0x0x40
    public Guid? <PHNCAJFFBJD>k__BackingField;    // 0x0x48
    public string <BKICKGJHGND>k__BackingField;    // 0x0x60
    public string <DLAKHCOKKJB>k__BackingField;    // 0x0x68
    public LMFNPHDGODM <HEKPNCEGMAG>k__BackingField;    // 0x0x70
    public int <IEMCJGGHCJG>k__BackingField;    // 0x0x74
    public int <NEEOMKEFCIK>k__BackingField;    // 0x0x78
    public OMIDHABEBNI <FIELPIKDPAC>k__BackingField;    // 0x0x7C
    public BJHDLCNOPOE <EJOKJDCNCOK>k__BackingField;    // 0x0x80
    public string <IDJOADOJCGM>k__BackingField;    // 0x0x88
    public string <GAFHIOOAIFC>k__BackingField;    // 0x0x90
    public bool <EFPKPFFPPND>k__BackingField;    // 0x0x98
    public FDEIDHKCJEA <AOPJNLEJOFM>k__BackingField;    // 0x0x9C
    public AMLOJEALFHA <CJKLBLDMJCP>k__BackingField;    // 0x0xA0
    public EBECOMOBJJD? <IKAEMALLODF>k__BackingField;    // 0x0xA4
    public bool <FILMECHBKOM>k__BackingField;    // 0x0xAC
    public bool <PECBPBJDBMB>k__BackingField;    // 0x0xAD
    public string <DMFIBMHNLJI>k__BackingField;    // 0x0xB0
    public string <DCCJICLEKMF>k__BackingField;    // 0x0xB8
    public bool <PDCLOIFAGFO>k__BackingField;    // 0x0xC0
    public bool NHBHIOGNBAF;    // 0x0xC1
}
...
public class NFEIIKPLHCA : MPHJLEJICEP
{
    public LACADHPJJMN? <CHCIMMGNPOO>k__BackingField;    // 0x0x18
    public BalanceResponseDTO <HCJGCCEELEI>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NLEGBMDCLEC
//   RESPONSE POST   api/playerevents/v1/bulkInvite   [Service.API]
public class NLEGBMDCLEC
{
    public List<CHIBKLEEANL> <AJMHOBJDAFG>k__BackingField;    // 0x0x10
    public EBCBJGOJIBI <IEFCFJMABBC>k__BackingField;    // 0x0x18
}
...
public class NMIIMAFJJLM
{
    public GINGPABHDBE <CKOIGBNOKIN>k__BackingField;    // 0x0x10
    public string <GGKECLBCJEL>k__BackingField;    // 0x0x18
    public int? <DKCACNKIBCN>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// NNPJGFJKOJK
//   REQUEST  POST   api/roomkeys/v1/owns/bulk   [Service.Econ]
public class NNPJGFJKOJK
{
    public int NOJMGAAAMOI;    // 0x0x10
    public long MHAFAEGHPCD;    // 0x0x18
}

// --------------------------------------------------------------------------
// OCMGAKPKJCH
//   REQUEST  POST   api/items/purchaseInfos   [Service.Econ]
public class OCMGAKPKJCH
{
    public IReadOnlyList<PIEGLCNCEHC> <HAOPBHPIKBE>k__BackingField;    // 0x0x10
}
...
public class OEBKEMENCOF
{
    public int <PJDODDEGBDJ>k__BackingField;    // 0x0x10
    public OGJLAAIJKIN <IFHHKMAPPLK>k__BackingField;    // 0x0x14
    public FBEONKFBDAI <HHCCFDNJANP>k__BackingField;    // 0x0x18
    public FBEONKFBDAI <IKMNEINFKOH>k__BackingField;    // 0x0x1C
    public FBEONKFBDAI <HHLMFKMGMKO>k__BackingField;    // 0x0x20
    public byte? <MABLPLDKDKK>k__BackingField;    // 0x0x24
}
...
// OHLKMABNAPM
//   (not directly referenced by a detected call)
public class OHLKMABNAPM
{
    public ICNMJNLKFDK <GAALOIIPMNH>k__BackingField;    // 0x0x10
    public MPLBGLLNEII <FINHCIIMEFN>k__BackingField;    // 0x0x18
}
...
// base   : LMNBBFNAMME
//   (not directly referenced by a detected call)
public class OJMMGOGFFMA : LMNBBFNAMME
{
    public int <NMGLLCGADOO>k__BackingField;    // 0x0x68
    public List<FLKEIPMPCJF> <NDNFKNEOGKI>k__BackingField;    // 0x0x70
    public List<FLKEIPMPCJF> <LHCLEBMJHAF>k__BackingField;    // 0x0x78
    public List<FLKEIPMPCJF> <LEIEFDNMGKE>k__BackingField;    // 0x0x80
}

// --------------------------------------------------------------------------
// OKEAPMNIENK
//   (not directly referenced by a detected call)
public class OKEAPMNIENK
{
    public int <OCBIHFPJBLN>k__BackingField;    // 0x0x10
    public DateTime <CKPJEAIPDGE>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// OKECEMCKFBC
//   RESPONSE GET    api/config/v1/azurespeech   [Service.API]
public class OKECEMCKFBC
{
    public bool <EAKCIMCHNOI>k__BackingField;    // 0x0x10
    public string <NPNLGMKBCAN>k__BackingField;    // 0x0x18
    public string <FHMENGGGDMN>k__BackingField;    // 0x0x20
}
...
public class OKGMOFKDEBB
{
    public int <IGCKLMPFEJM>k__BackingField;    // 0x0x10
    public bool <LMFOGLCEPDH>k__BackingField;    // 0x0x14
    public DateTime <INLDDGDIGBL>k__BackingField;    // 0x0x18
    public bool <KKMOFFJCFIB>k__BackingField;    // 0x0x20
}
...
// OOAKMDMPHMC
//   (not directly referenced by a detected call)
public class OOAKMDMPHMC
{
    public Guid <JKBOLHMKOLM>k__BackingField;    // 0x0x10
    public int <NDANIGGAMDA>k__BackingField;    // 0x0x20
    public int <PAMPKOAGFMA>k__BackingField;    // 0x0x24
    public Guid <ANBGOPJKNMP>k__BackingField;    // 0x0x28
    public DateTime <NGJMOFPFONB>k__BackingField;    // 0x0x38
    public ALPEBIDOMCI <FFPELONFHAA>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// PALHDONLOKM
//   REQUEST  POST   api/avatar/v1/lockeditems/bulk   [Service.Econ]
public class PALHDONLOKM
{
    public List<string> <EANGMLFJJEF>k__BackingField;    // 0x0x10
}
...
// PIALADEOKIF
//   (not directly referenced by a detected call)
public class PIALADEOKIF
{
    public int <GKFKFNKKHAG>k__BackingField;    // 0x0x10
}
...
// base   : GCBFFNGFBNN
//   (not directly referenced by a detected call)
public class PIEGLCNCEHC : GCBFFNGFBNN
{
    public HDGFDNCHPPJ BMFIGBAJCHH;    // 0x0x20
}
...
public class PJPMGCENDHN
{
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x10
    public string <MEOCMMMOBOM>k__BackingField;    // 0x0x18
    public int? <JGAGDHIHBLJ>k__BackingField;    // 0x0x20
    public OGPADJCDAAA? <HDBKNMKENCB>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// PLBJCLHFKLG
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.Econ]
public class PLBJCLHFKLG
{
    public Dictionary<Guid, MNCIPGPIBMD> <FKIAOIPAAHE>k__BackingField;    // 0x0x10
}
...
public class AddKeepsakeInstanceRequest
{
    public long <JBOILCHIGMF>k__BackingField;    // 0x0x10
    public long? <KDCMFBGMJBC>k__BackingField;    // 0x0x18
    public OJBCBIHCMHF <ACJNAEHJNID>k__BackingField;    // 0x0x28
}
...
{
    public CEIJEJKCPMA <IEFCFJMABBC>k__BackingField;    // 0x0x10
    public string <HFLGACCMDEF>k__BackingField;    // 0x0x18
    public string <BGIGCPDFCOJ>k__BackingField;    // 0x0x20
    public string <APBFCHKLANG>k__BackingField;    // 0x0x28
}
...
public class BalanceResponseDTO
{
    ...
    public LMFNPHDGODM <CurrencyType>k__BackingField;    // 0x0x18
    public EBECOMOBJJD <BalanceType>k__BackingField;    // 0x0x1C
}
...
{
    public List<LFBLDDHNHPA<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
{
    public long <ALMNBDIIMFN>k__BackingField;    // 0x0x10
    public long? <OKODFLMCFFL>k__BackingField;    // 0x0x18
}
...
{
    public string <JPAFDJBGDAA>k__BackingField;    // 0x0x10
    public int <MFJHLKCKAHC>k__BackingField;    // 0x0x18
}
...
public class GetRankRequestDTO
{
    ...
    public MEHEJPNKGNI FilterType;    // 0x0x20
...
public class GiftItemDTO
{
    ...
    public OMIDHABEBNI <GiftContext>k__BackingField;    // 0x0x24
}
...
{
    public OJBCBIHCMHF <GHJLAGCCGEH>k__BackingField;    // 0x0x10
    public string <PIMBHFKFJKJ>k__BackingField;    // 0x0x18
    public int <CMDMJLCLGMJ>k__BackingField;    // 0x0x20
    public int <HDAEFADJOCG>k__BackingField;    // 0x0x24
    public string <FBONEACHNEK>k__BackingField;    // 0x0x28
    public string <POGEMLDHFIL>k__BackingField;    // 0x0x30
}
...
{
    public int <NDANIGGAMDA>k__BackingField;    // 0x0x10
    public Guid <EINKFMOIJMD>k__BackingField;    // 0x0x14
    public DateTime <AGAOFBLEBLB>k__BackingField;    // 0x0x28
}
...
{
    public bool <HNFAOLOGLOF>k__BackingField;    // 0x0x10
    public int <BNMPGDNJPJK>k__BackingField;    // 0x0x14
    public bool <KJFGHNNNJOM>k__BackingField;    // 0x0x18
}
...
{
    public Guid <EINKFMOIJMD>k__BackingField;    // 0x0x10
    public OJBCBIHCMHF <GJPNOBPECFN>k__BackingField;    // 0x0x20
    public int <PLBJEGKEOCL>k__BackingField;    // 0x0x24
    public long <JBOILCHIGMF>k__BackingField;    // 0x0x28
    public long? <KDCMFBGMJBC>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.KeepsakeProgressionEventInstancesDTO
//   RESPONSE GET    api/keepsakes   [Service.API]
//   RESPONSE GET    api/keepsakes/events/{kEFAHAJFGLE}   [Service.API]
public class KeepsakeProgressionEventInstancesDTO
{
    public List<KeepsakeRoomInstanceIdsDTO> <BEIHJDANJAN>k__BackingField;    // 0x0x10
    public List<KeepsakeRoomInstanceIdsDTO> <FJMCNGOOBCB>k__BackingField;    // 0x0x18
}
...
{
    public long <HCBMKBBBKHN>k__BackingField;    // 0x0x10
    public long <JBOILCHIGMF>k__BackingField;    // 0x0x18
    public long <BLHEIJCNAJC>k__BackingField;    // 0x0x20
    public LCIKBIAEKOC <IFHHKMAPPLK>k__BackingField;    // 0x0x28
    public int <GPGJHLOBNEN>k__BackingField;    // 0x0x2C
}
...
{
    public long <JBOILCHIGMF>k__BackingField;    // 0x0x10
    public List<Guid> <BOBEJGDEPOO>k__BackingField;    // 0x0x18
}
...
{
    public IReadOnlyList<KeepsakeInstanceDTO> <BEIHJDANJAN>k__BackingField;    // 0x0x10
    public IReadOnlyList<KeepsakeCollectionRecordDTO> <FJMCNGOOBCB>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <OECLKLHOKHD>k__BackingField;    // 0x0x20
}
...
{
    public long <BLHEIJCNAJC>k__BackingField;    // 0x0x10
    public long <CIAKIBAPGIE>k__BackingField;    // 0x0x18
    public int? <DMIFACAKJAN>k__BackingField;    // 0x0x20
    public int? <JHOJJDCMKHG>k__BackingField;    // 0x0x28
    public long? <NPICLLGLKDM>k__BackingField;    // 0x0x30
    public long <BOOEOPPGBHF>k__BackingField;    // 0x0x40
    public long <DLMIAKJCICJ>k__BackingField;    // 0x0x48
    public int <ELNHCKJPFIC>k__BackingField;    // 0x0x50
    public LCIKBIAEKOC <NNBJDOIAAED>k__BackingField;    // 0x0x54
    public List<KeepsakeRoomDTO> <GENPBDENBNP>k__BackingField;    // 0x0x58
}
...
public class MultiRecipientFreeGiftRequestDTO
{
    ...
    public string <Message>k__BackingField;    // 0x0x18
    public OMIDHABEBNI <GiftContext>k__BackingField;    // 0x0x20
}
...
public class NewInventionRequestDTO
{
    ...
    public LHDJNPMOIOH creatorAccountRole;    // 0x0x68
...
{
    public AJOBOALDHEL <CFLENHCPJIC>k__BackingField;    // 0x0x10
    public NEMAIPJHLAF <BANMELIDAJG>k__BackingField;    // 0x0x14
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x18
    public string <MEOCMMMOBOM>k__BackingField;    // 0x0x20
    public bool <PJADEMFHAKB>k__BackingField;    // 0x0x28
}
...
{
    public IReadOnlyList<AJOBOALDHEL> <HBIDJGLGAGA>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.ProgressionEventDTO
//   RESPONSE GET    api/progressionEvents   [Service.API]
//   RESPONSE GET    api/progressionEvents/event/{aBBKMELJHDN}   [Service.API]
public class ProgressionEventDTO
{
    public long <CIAKIBAPGIE>k__BackingField;    // 0x0x10
    public string <NENDEKKGJDG>k__BackingField;    // 0x0x18
    public List<ProgressionEventRewardDTO> <LEIEFDNMGKE>k__BackingField;    // 0x0x20
    public List<KeepsakeRoomListDTO> <MOPDJFCCOFE>k__BackingField;    // 0x0x28
    public DateTime <AHNPGANPAAH>k__BackingField;    // 0x0x30
    public DateTime <OHPLDCDDIDD>k__BackingField;    // 0x0x38
    public DateTime <LBAGDPBJOPK>k__BackingField;    // 0x0x40
    public bool <ELGFBGFOLKJ>k__BackingField;    // 0x0x48
    public int <OKEHOHLLHBL>k__BackingField;    // 0x0x4C
    public float <LDCBOIIJKNE>k__BackingField;    // 0x0x50
    public Guid? <DHAKOBGGKJN>k__BackingField;    // 0x0x54
    public string <KCLGKCOBPHD>k__BackingField;    // 0x0x68
    public string <AMKDBGLDJPB>k__BackingField;    // 0x0x70
    public string <MLHGEPOPDLP>k__BackingField;    // 0x0x78
    public string <GLAMMJFDFAL>k__BackingField;    // 0x0x80
}
...
{
    public Guid <PJMICGMPCHD>k__BackingField;    // 0x0x10
    public int <NMGCDOPAFGG>k__BackingField;    // 0x0x20
    public int <OAKDJFCFHAL>k__BackingField;    // 0x0x24
    public int <ICOLPJHPDGK>k__BackingField;    // 0x0x28
    public long <CHHIOCNEBLP>k__BackingField;    // 0x0x30
    public long <NBGFGOBNKBK>k__BackingField;    // 0x0x38
}
...
{
    public int <NDANIGGAMDA>k__BackingField;    // 0x0x10
    public int <NEEOMKEFCIK>k__BackingField;    // 0x0x14
    public int <FCPNFMBBFPK>k__BackingField;    // 0x0x18
    public int <FOMCEJIBNCP>k__BackingField;    // 0x0x1C
    public int <JPAOKIOLIED>k__BackingField;    // 0x0x20
    public DateTime? <MOANCOECCDC>k__BackingField;    // 0x0x28
    public int <FBCLNHMGPMM>k__BackingField;    // 0x0x38
}
...
{
    public long <LDFOEEIGMJG>k__BackingField;    // 0x0x10
    public int <OPMPJPJNBCB>k__BackingField;    // 0x0x18
    public string <DEKLPKKBNDH>k__BackingField;    // 0x0x20
    public int <NEEOMKEFCIK>k__BackingField;    // 0x0x28
    public int <NKJPFDOALKF>k__BackingField;    // 0x0x2C
    public bool <IFJDOLGPCEN>k__BackingField;    // 0x0x30
    public bool <GKBGEPCBILO>k__BackingField;    // 0x0x31
}
...
{
    public long <InventionId>k__BackingField;    // 0x0x10
    public JALBGOEMJIB <Permission>k__BackingField;    // 0x0x18
    public OGPADJCDAAA <Accessibility>k__BackingField;    // 0x0x1C
...
{
    public List<GNHDPBAIMDI<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class ReportRequest
{
    ...
    public JKGODIDOMBJ ReportCategory;    // 0x0x20
}
...
public class ReplicationUnityAssetsDTO
{
    ...
    public List<NGNDMMPMNND> <UnityAssets>k__BackingField;    // 0x0x18
}
...
public class SetInventionVersionAccessibilityRequest
{
    ...
    public OGPADJCDAAA <NewAccessibility>k__BackingField;    // 0x0x1C
}
...
public class MessageContentDTO
{
    ...
    public PCIFKPAECOP <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<MBNPKAIJEAD> <Content>k__BackingField;    // 0x0x18
}
...
//   RESPONSE DELETE api/roomkeys/v1/delete/{nLDCDJEIPJD}   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool NDEFPMBCLEL;    // 0x0x28
}
...
{
    public LLLMIINGIBL? CheerCategory;  // wrapper
}

// api/PlayerCheer/v1/create  [API POST]
public class PlayerCheerV1CreateRequest
{
    public LLLMIINGIBL ELMNEBFJFIL;  // wrapper
...
{
    public FDEIDHKCJEA OCEOABGJOBL;  // wrapper
...
{
    public GHIODAGHICF DGNODDPLLPC;  // wrapper
    public int? KOMPHKCAOJP;  // wrapper
...
{
    public CPAFECDDLMJ DKLMCHICBDJ;  // wrapper
...
{
    public byte[] BLPDDGCLNPE;  // wrapper
    public CNILINDMFFN JDGGNCIFFID;  // wrapper
...
{
    public CPAFECDDLMJ NADNJKFPKBM;  // wrapper
    public float? KLLFOPIENAD;  // wrapper
    public bool? NBPCLALEHEA;  // wrapper
...
{
    public List<NCHELFAJJGK> desc;  // wrapper
}
...
{
    public OMIDHABEBNI IJNPIDPIBFP;  // wrapper
    public OMIDHABEBNI? EELBGELMIMN;  // wrapper
...
{
    public ChatMessage JEBOHIALEMJ;  // wrapper
    public MJHHDBIMLBI NADNJKFPKBM;  // wrapper
...
{
    public object supportedVersion;  // candidate
}
...
{
    public OGPADJCDAAA MHLPAIHPPIO;  // wrapper
    public BHAPJECFNOC BGLKAFNFFIK;  // wrapper
    public GEKDGFHNEKG LNDHBDJFLFO;  // wrapper
    public GEKDGFHNEKG JCIDCNLFMLC;  // wrapper
...
{
    public object outfitType;  // candidate
}
...
// api/customAvatarItems/v1/{pCPOOIGHMLK}/appeal  [API POST]
public class CustomAvatarItemsV1PCPOOIGHMLKAppealRequest
{
    public Guid PCPOOIGHMLK;  // wrapper
}

// api/customAvatarItems/v2/fromCreator/{fNHHMALGNPF}  [API GET]
public class CustomAvatarItemsV2FromCreatorFNHHMALGNPFRequest
{
...
{
    public DJAMDOFAFDG MPJCJJAAHGG;  // wrapper
    public OMIDHABEBNI? OHNDMPKIDEO;  // wrapper
...
{
    public EKJNFFEJNMD PHBCJPDLLJP;  // wrapper
...
{
    public int? CBKJMCCIGII;  // wrapper
    public Guid? PCPOOIGHMLK;  // wrapper
...
// api/keepsakes/{kHHJKJEPENJ}/collect  [API POST]
public class KeepsakesKHHJKJEPENJCollectRequest
{
    public Guid KHHJKJEPENJ;  // wrapper
}

// api/messages/v2/send  [API POST]
public class MessagesV2SendRequest
{
    public NFCHJPMCDNE KBDOPBEDCNH;  // wrapper
    public long? GDCAPMONNDM;  // wrapper
...
{
    public object creatingAccountId;  // candidate
}
...
{
    public PPJEOJHAEMG OKFOLAOFJGI;  // wrapper
    public PPJEOJHAEMG CFFONNFILMA;  // wrapper
    public ICNMJNLKFDK CMIEDNHLIHD;  // wrapper
}
...
{
    public long? FMNCJOBEOEF;  // wrapper
    public ICNMJNLKFDK CMIEDNHLIHD;  // wrapper
    public long? CCDDJILDDKF;  // wrapper
}

// api/playerevents/v2/{eventId}/time  [API PUT]
public class PlayereventsV2EventIdTimeRequest
{
    public DateTime OFLPMAPNJKG;  // wrapper
    public DateTime PDIIAGIDEOG;  // wrapper
    public ICNMJNLKFDK CMIEDNHLIHD;  // wrapper
    public DateTime BBEAFLPMPML;  // wrapper
    public DateTime BKPGLNMKPLJ;  // wrapper
}
...
{
    public Guid KOOEBEJNFKJ;  // wrapper
...
{
    public Guid BLNKBGOHNKH;  // wrapper
...
{
    public Guid BLNKBGOHNKH;  // wrapper
    public long? KHOJKEIIKAA;  // wrapper
    public byte? ENDDNPPKCPO;  // wrapper
    public int? EOGEFFOIIOP;  // wrapper
    public object Color;  // candidate
    public object CurrencyId;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
...
{
    public Guid KOOEBEJNFKJ;  // wrapper
    public long? NDJBKIDHIBG;  // wrapper
    public long? MANOLGLEOMD;  // wrapper
    public int? MOKDONKKJGG;  // wrapper
    public object Price;  // candidate
    public object Amount;  // candidate
    public object Name;  // candidate
    public object PurchaseOfferId;  // candidate
...
{
    public IEnumerable<KeyValuePair<string, string>> PDCLAJMPOEB;  // wrapper
...
{
    public KFHPBPCBOMF DGNODDPLLPC;  // wrapper
    public Guid? EDJFHIDOPBH;  // wrapper
    public object Price;  // candidate
    public object Name;  // candidate
    public object ImageName;  // candidate
    public object Type;  // candidate
...
{
    public object Screenshot;  // candidate
    public object RoomReportId;  // candidate
}
...
{
    public CPAFECDDLMJ NADNJKFPKBM;  // wrapper
    public long? FDADEEJDCFG;  // wrapper
    public Guid? PPLHMDMKIHC;  // wrapper
    public int? MNNMPDOPOLC;  // wrapper
...
{
    public Guid NHIEJNCHEMF;  // wrapper
...
{
    public Guid DMCLBKMOFNL;  // wrapper
...
{
    public PFCFCHDFLNO BHFKGKPMICL;  // wrapper
}
