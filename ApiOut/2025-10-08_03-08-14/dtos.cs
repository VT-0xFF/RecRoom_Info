...
// DTO classes: 638 (plus referenced enums)
...
{
    public CPMALVBEJKV<YSDFEASZWFK, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public IBRXNUHZXBT<YSDFEASZWFK, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public SQESMBBMMXQ CircuitsManager;    // 0x0x10
    public Id32<YCAINYDNLEL> ClientId;    // 0x0x18
    public YSDFEASZWFK Network;    // 0x0x20
}
...
{
    public Result<object, XDRQUNZRUHP>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.IUICWHIRRGU
//   (not directly referenced by a detected call)
public class DiceResult : IUICWHIRRGU
{
    // (no instance fields in the metadata dump)
}
...
{
    public ZLOMSCLYJNW _deps;    // 0x0x0
    public EGZVYBEHFSY _staticNetSys;    // 0x0x8
}
...
//   REQUEST  POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.AI]
...
{
    public List<QZLWGWJOYLL<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// --------------------------------------------------------------------------
// RecNet.CheerRequest
//   REQUEST  POST   api/inventions/v2/cheer   [Service.AI]
...
//   REQUEST  ?      api/roomcurrencies   [Service.AI]
...
// base   : RecNet.NZLAWKABKFG`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Common.MJUEXNDRTSY`1<RecNet.CustomAvatarItem>
...
public class Equipment
{
    ...
    public bool QAGVDVLTJVS;    // 0x0x40
...
public class InAppMessageDTO
{
    ...
    public bool <EOFCZBPIQUU>k__BackingField;    // 0x0x38
    ...
    public string <MCNHTNKYLCU>k__BackingField;    // 0x0x48
    public FNDKLNUTQRK <ContentObject>k__BackingField;    // 0x0x50
}
...
//   REQUEST  POST   api/inventions/v1/settags   [Service.AI]
...
// base   : RecNet.Common.MJUEXNDRTSY`1<RecNet.KeepsakeCategoryConfigDTO>
...
public class LoginResult : ValueType
{
    ...
    public XFTJQLDOGBC <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.JQPJQIKBLZE/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.SVQDXZONUBX/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Common.MJUEXNDRTSY`1<RecNet.PlatformNotificationCategoryConfigDTO>
//   (not directly referenced by a detected call)
...
//   REQUEST  POST   api/inventions/v4/publish   [Service.AI]
...
//   RESPONSE POST   api/externalfriendinvite/v1/sendtextmessageinvite   [Service.AI]
//   RESPONSE POST   api/freegifts/v1/sendmultiple   [Service.Econ]
//   RESPONSE POST   api/gamerewards/v1/request   [Service.AI]
//   RESPONSE POST   api/gamerewards/v1/select   [Service.AI]
//   RESPONSE POST   api/images/v2/modifyaccessibility   [Service.AI]
...
//   RESPONSE GET    api/keepsakes   [Service.AI]
...
// --------------------------------------------------------------------------
// RecNet.Relationship
//   RESPONSE GET    api/relationships/v1/addfriendwithcode   [Service.AI]
//   RESPONSE GET    api/relationships/v1/favorite   [Service.AI]
...
//   RESPONSE GET    api/relationships/v2/addfriend   [Service.AI]
//   RESPONSE GET    api/relationships/v2/removefriend   [Service.API]
//   RESPONSE GET    api/relationships/v2/sendfriendrequest   [Service.AI]
...
//   REQUEST  PUT    api/roomconsumables/v1/roomConsumable   [Service.AI]
...
//   RESPONSE POST   api/roomconsumables/v1/roomConsumable/awardBulk   [Service.AI]
...
//   RESPONSE PUT    api/roomconsumables/v1/roomConsumable   [Service.AI]
...
//   REQUEST  PUT    api/roomconsumables/v1/roomconsumable/{roomconsumableId}/purchase/currency   [Service.AI]
//   REQUEST  PUT    api/roomconsumables/v1/roomconsumable/{roomconsumableId}/purchase/tokens   [Service.AI]
...
//   RESPONSE PUT    api/roomconsumables/v1/roomconsumable/{roomconsumableId}/purchase/currency   [Service.AI]
...
// base   : RecNet.RoomConsumablePurchaseResponse
//   RESPONSE PUT    api/roomconsumables/v1/roomconsumable/{roomconsumableId}/purchase/tokens   [Service.AI]
...
//   REQUEST  POST   api/roomEarningsDistributions/v1/earningsDistribution   [Service.AI]
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> EPSGMIZAUMW;    // 0x0x1C8
    public IReadOnlyList<string> EXHBSOLTLUG;    // 0x0x1D0
    public IReadOnlyList<string> COMPZYJQKQA;    // 0x0x1D8
    public string YJNRQGPQSTN;    // 0x0x1E0
    public IReadOnlyList<string> QSQEJAPQUSJ;    // 0x0x1E8
    public bool? JKKUDXDZKOR;    // 0x0x1F0
    public bool? DQNUGIAZFUU;    // 0x0x1F2
    public IReadOnlyList<ObscuredInt> XNMWNWUPBKW;    // 0x0x1F8
    public IReadOnlyList<ObscuredInt> QKMGFQPBNOY;    // 0x0x200
    public ObscuredInt? KYMGRIGCLRT;    // 0x0x208
}
...
// base   : RecNet.Common.MJUEXNDRTSY`1<RecNet.Rooms.RoomDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Common.MJUEXNDRTSY`1<RecNet.Rooms.SubRoomDataSaveDTO>
//   (not directly referenced by a detected call)
...
//   REQUEST  POST   api/messages/v1/sendMultiple   [Service.AI]
...
//   REQUEST  PUT    api/inventions/v2/accessibility   [Service.AI]
...
//   RESPONSE POST   api/inventions/v1/settags   [Service.AI]
...
// base   : RecNet.YMBBIASXKQU`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
//   REQUEST  POST   api/inventions/v2/updateprice   [Service.AI]
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public DSONEQYKYQT <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<OFPYJOZELZS> <Content>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// RecRoom.AI.OpenAI.Realtime.DOHLUJBKDTO
//   (not directly referenced by a detected call)
public class DOHLUJBKDTO
{
    // (no instance fields in the metadata dump)
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public ENFFXWRYOWP _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public WVEFTUJGTQP _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool EPNKCCPDLTX;    // 0x0x30
}
...
{
    public ZGFDMZFGNNX pendingRequests;    // 0x0x0
...
{
    public OEJGLDFIKZO FFRQMGYVOAZ;    // 0x0x10
    public CUJVBYRHGHA SARRDALHDLD;    // 0x0x18
    public TBDOKCNPZCW SNGRLPURGRN;    // 0x0x20
    public JJUZHWLOPXU KYAZQFRLGNR;    // 0x0x28
}
