...
// DTO classes: 643 (plus referenced enums)
...
{
    public KQGQLMLRMCJ<FUAZHRRWMOY, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public JSYUJENUFLH<FUAZHRRWMOY, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public RGZHVGRSJVI CircuitsManager;    // 0x0x10
    public Id32<VCZWSUVCRXV> ClientId;    // 0x0x18
    public FUAZHRRWMOY Network;    // 0x0x20
}
...
{
    public Result<object, HEYQXAVABBH>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.XXPJUJZPQAM
//   (not directly referenced by a detected call)
public class DiceResult : XXPJUJZPQAM
{
    // (no instance fields in the metadata dump)
}
...
{
    public XQEIROEEFNO _deps;    // 0x0x0
    public SVBMWMSSDIU _staticNetSys;    // 0x0x8
}
...
{
    public List<UYRTDYJUQTT<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.EPMJRXBDRNC`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Common.FITGDXGRUNO`1<RecNet.CustomAvatarItem>
...
public class Equipment
{
    ...
    public bool GBMMOJAVQRG;    // 0x0x40
...
public class GetRankRequestDTO
{
    ...
    public long? PrimaryKey;    // 0x0x18
    public int? SecondaryKey;    // 0x0x28
    public FilterType FilterType;    // 0x0x30
    public bool SortAscending;    // 0x0x34
    public LeaderboardType LeaderboardType;    // 0x0x38
}
...
{
    public int RankStart;    // 0x0x40
    public int RankEnd;    // 0x0x44
}
...
public class InAppMessageDTO
{
    ...
    public bool <NRXLDTRZTGE>k__BackingField;    // 0x0x38
    ...
    public string <GIPIKEPOLJG>k__BackingField;    // 0x0x48
    public TKQZWKXZMJS <ContentObject>k__BackingField;    // 0x0x50
}
...
// base   : RecNet.Common.FITGDXGRUNO`1<RecNet.KeepsakeCategoryConfigDTO>
...
public class LoginResult : ValueType
{
    ...
    public LZEKEQGJDZO <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.LDLTNDHPDQG/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.FGGKZVLXOFP/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Common.FITGDXGRUNO`1<RecNet.PlatformNotificationCategoryConfigDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt KZQMNHXRENI;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> SWBGGRORLZY;    // 0x0x1D0
    public IReadOnlyList<string> LJFWDFKNVDA;    // 0x0x1D8
    public IReadOnlyList<string> CEFECMYKAIA;    // 0x0x1E0
    public string LXNONWJLAKP;    // 0x0x1E8
    public IReadOnlyList<string> CEFCOBCRPKN;    // 0x0x1F0
    public bool? PVHXKQKLHXL;    // 0x0x1F8
    public bool? UYREQKRSCGM;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> XHMAADEHPUC;    // 0x0x200
    public IReadOnlyList<ObscuredInt> RGOVJVEOBVC;    // 0x0x208
    public ObscuredInt? JISQMGUUOCV;    // 0x0x210
}
...
// base   : RecNet.Common.FITGDXGRUNO`1<RecNet.Rooms.RoomDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Common.FITGDXGRUNO`1<RecNet.Rooms.SubRoomDataSaveDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.FPCGVHKMGIU`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public JLJDPNVOZKT <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<LZXAUCWKKEQ> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public BSZEZNSGOWH _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public PSHFYYWNMQL _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool IVVKSDMQWCF;    // 0x0x30
}
...
{
    public OEPKSBTBAXH pendingRequests;    // 0x0x0
    public Guid operationId;    // 0x0x8
}

// --------------------------------------------------------------------------
// RecRoom.RoomLoading.PhotonClients.ZOSGLOYKDTO
//   (not directly referenced by a detected call)
public class ZOSGLOYKDTO
{
    // (no instance fields in the metadata dump)
}
...
{
    public OJWHGTOEBFC OKJTSMVEIGF;    // 0x0x10
    public SDDZLOOPYIW LMUJNUHHTKF;    // 0x0x18
    public KJIRTJWLTJQ IILJCLKPIFV;    // 0x0x20
    public TAMXIFGLTQK CGOSWYXXYRJ;    // 0x0x28
}
