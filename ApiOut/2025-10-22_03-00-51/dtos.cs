...
// DTO classes: 642 (plus referenced enums)
...
{
    public HDNLXSMDIFI<ASKJDRVYIOB, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public HNVVLXUNLMK<ASKJDRVYIOB, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public GCFTXZUHCVV CircuitsManager;    // 0x0x10
    public Id32<CYNSIGMASWI> ClientId;    // 0x0x18
    public ASKJDRVYIOB Network;    // 0x0x20
}
...
{
    public Result<object, OYBEQJHIRPM>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.CEIHCTTFKOB
//   (not directly referenced by a detected call)
public class DiceResult : CEIHCTTFKOB
{
    // (no instance fields in the metadata dump)
}
...
{
    public ETPODEKPKCV _deps;    // 0x0x0
    public MPBKAGBRDNH _staticNetSys;    // 0x0x8
}
...
{
    public List<BCOBNVMNJLM<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.TJFDSIEZYDB`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Common.ZCZVNNSGFFL`1<RecNet.CustomAvatarItem>
...
public class Equipment
{
    ...
    public bool RUJWUBPXPQX;    // 0x0x40
...
public class InAppMessageDTO
{
    ...
    public bool <UDMWGHTULJL>k__BackingField;    // 0x0x38
    ...
    public string <TDVXUFVKXAT>k__BackingField;    // 0x0x48
    public QKGDHWAEVFX <ContentObject>k__BackingField;    // 0x0x50
}
...
// base   : RecNet.Common.ZCZVNNSGFFL`1<RecNet.KeepsakeCategoryConfigDTO>
...
public class LoginResult : ValueType
{
    ...
    public GYFWYCQXTAZ <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.XVEOEVMHCTR/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.RWWETSLKYSU/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Common.ZCZVNNSGFFL`1<RecNet.PlatformNotificationCategoryConfigDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt TKOKCZTCMFP;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> OHMSVMQSPZH;    // 0x0x1D0
    public IReadOnlyList<string> JQLLLDVHAEP;    // 0x0x1D8
    public IReadOnlyList<string> SRBLWRAPDQX;    // 0x0x1E0
    public string BVEUSLAZTQQ;    // 0x0x1E8
    public IReadOnlyList<string> XJLBNKROUWA;    // 0x0x1F0
    public bool? MSJQLYDHYZC;    // 0x0x1F8
    public bool? IIOYDYVZZKN;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> WJHKJXANROJ;    // 0x0x200
    public IReadOnlyList<ObscuredInt> WZDCAUCRJER;    // 0x0x208
    public ObscuredInt? QOPZDUNMZOU;    // 0x0x210
}
...
// base   : RecNet.Common.ZCZVNNSGFFL`1<RecNet.Rooms.RoomDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Common.ZCZVNNSGFFL`1<RecNet.Rooms.SubRoomDataSaveDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.ZAOKOGXRDSH`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public HVQBNZZGTCA <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<MUGQOGZXEOJ> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public TKNLLBEJAZY _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public GTRCTZRRKGA _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool JLWTFUPGNWE;    // 0x0x30
}
...
{
    public AXARZMWEGGY pendingRequests;    // 0x0x0
...
{
    public TPICXMNKDPD FZDXDPPJXPG;    // 0x0x10
    public LBYYQBWWZWZ PRCZNZUSLCW;    // 0x0x18
    public SLGKQDZWFPJ NNEAWPHHSGY;    // 0x0x20
    public HWQFGVTKLKB CCJYTRMKWUY;    // 0x0x28
}
