...
// DTO classes: 661 (plus referenced enums)
...
{
    public AFUEATRNTFO<GFLGYSGBDOL, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public BINWPURGJUI<GFLGYSGBDOL, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public AUQKPBYPMDP CircuitsManager;    // 0x0x10
    public Id32<FJSVDCFYEAW> ClientId;    // 0x0x18
    public GFLGYSGBDOL Network;    // 0x0x20
}
...
{
    public Result<object, XOJOHOBKPDS>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.SQLKBLQWDLJ
//   (not directly referenced by a detected call)
public class DiceResult : SQLKBLQWDLJ
{
    // (no instance fields in the metadata dump)
}
...
{
    public ALXXNXZFOSL _deps;    // 0x0x0
    public ZVRVTWCRUTF _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public FBVOMUBKERI inAppMessages;    // 0x0x70
}
...
{
    public List<KGMPTSKEKKA<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.WBHZCYWOEDT`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <CNGSMAPESJJ>k__BackingField;    // 0x0x38
    ...
    public string <BXQTBSDNBYJ>k__BackingField;    // 0x0x48
    public OZURRVRIAWL <ContentObject>k__BackingField;    // 0x0x50
}
...
public class LoginResult : ValueType
{
    ...
    public JKPMZWFYQBV <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.MZQUMCOZBTT/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.ELQEGDLDSQS/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt IAOSCZEMYKH;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> IXDKNPNZXGP;    // 0x0x1D0
    public IReadOnlyList<string> THJWLMNDCDT;    // 0x0x1D8
    public IReadOnlyList<string> VTJXQOBDTLH;    // 0x0x1E0
    public string HPXJTQZILXE;    // 0x0x1E8
    public IReadOnlyList<string> KZCQINUQEIW;    // 0x0x1F0
    public bool? GGFVUWGSBOC;    // 0x0x1F8
    public bool? GPVVEOFBRUT;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> FCZSTSTHVJB;    // 0x0x200
    public IReadOnlyList<ObscuredInt> TBQTWTLZWOX;    // 0x0x208
    public ObscuredInt? SVBASKXWMTI;    // 0x0x210
}
...
// base   : RecNet.ZQVRMSJCNUB`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public VDGFFCRYSIO <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<NYSFEOJXDVJ> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public GSJOVJNHIEE _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public BJLQUIWEUSC _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool RBIJZEGBNFI;    // 0x0x30
}
...
{
    public XQTTFYUWSSS pendingRequests;    // 0x0x0
...
{
    public MVZYDDMAODN GTVBHFZJJCG;    // 0x0x10
    public PIYWXEEYHLZ FLZKNZEKBWY;    // 0x0x18
    public GTOTEIGPFPL JPTMOBOXXVE;    // 0x0x20
    public ZMJYUQZMWBJ WVZBBZEBBLI;    // 0x0x28
}
...
public class RoomCurrenciesV2PurchaseRequest
{
    ...
    public object RequestedAmount;  // form
