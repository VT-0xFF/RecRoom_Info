...
// DTO classes: 663 (plus referenced enums)
...
{
    public NSRRADRIHLT<VDJIRLLJMFS, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public TDIMPNVDIIZ<VDJIRLLJMFS, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public TGMYLJQNIMW CircuitsManager;    // 0x0x10
    public Id32<VXOAABITZCX> ClientId;    // 0x0x18
    public VDJIRLLJMFS Network;    // 0x0x20
}
...
{
    public Result<object, JGLGQAAJYUN>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.QCAGCKTCKQE
//   (not directly referenced by a detected call)
public class DiceResult : QCAGCKTCKQE
{
    // (no instance fields in the metadata dump)
}

// --------------------------------------------------------------------------
// CircuitsV2.Lang.Nodes.KJPTAVIQDTO
// base   : CircuitsV2.Lang.Nodes.QYWDFLXEVZE
//   (not directly referenced by a detected call)
public class KJPTAVIQDTO : QYWDFLXEVZE
{
    public Guid <MIXNMPRBRCN>k__BackingField;    // 0x0x80
    public string DSROJSUJNTB;    // 0x0x90
    public QZTODGUKIZW OBBHPWXIBXV;    // 0x0x98
}
...
{
    public HGULJDEHQOI _deps;    // 0x0x0
    public BOOLTIYANOI _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public KZLJVDDJKAH inAppMessages;    // 0x0x70
}
...
{
    public List<KSEKFCNERXP<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.AYUJQAQEUSE`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <NZGXPDUFYJK>k__BackingField;    // 0x0x38
    ...
    public string <UAIVMMLNBXS>k__BackingField;    // 0x0x48
    public TCKQNGLXNOE <ContentObject>k__BackingField;    // 0x0x50
}
...
public class LoginResult : ValueType
{
    ...
    public PVAVVVYWAVS <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.EDGLYNGQTLI/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.ZSDDZLKPDAV/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt LEVNXDTBBDQ;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> PMCPLTXPTXU;    // 0x0x1D0
    public IReadOnlyList<string> DVBNVKPIOWO;    // 0x0x1D8
    public IReadOnlyList<string> GKHZBTLTYIQ;    // 0x0x1E0
    public string FRESLVXLNNV;    // 0x0x1E8
    public IReadOnlyList<string> RFSTLJXXZNP;    // 0x0x1F0
    public bool? TGEOSMMTYIF;    // 0x0x1F8
    public bool? MNBQCFPBMUY;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> OSZALILDXSO;    // 0x0x200
    public IReadOnlyList<ObscuredInt> TZRYZJDAIZG;    // 0x0x208
    public ObscuredInt? HKKLFUAAIQZ;    // 0x0x210
}
...
// base   : RecNet.CMBGCJRGTYI`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public WRAMEEKAPJN <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<HFQUDQKFCKU> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public OHAHSSWLDUX _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public FVWDZKJBYOH _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool WZSDXWGZMPL;    // 0x0x30
}
...
{
    public XNZVOZBCXUJ pendingRequests;    // 0x0x0
...
{
    public UFFFZRRBPXW TIDVWLUQWFP;    // 0x0x10
    public DJFXWYYSLCW WMRFSTLEXNH;    // 0x0x18
    public HNOFUIUXRAK KUMNPSNHNXF;    // 0x0x20
    public ACHQKVPRACK QZXQMNVOERJ;    // 0x0x28
}
