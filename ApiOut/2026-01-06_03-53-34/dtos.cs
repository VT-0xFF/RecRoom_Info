...
{
    public YIOIHAOHSAR<QKFNWZERSCU, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public YEBTSXMREUF<QKFNWZERSCU, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public VFRMMNWEYJQ CircuitsManager;    // 0x0x10
    public Id32<KQPBKUZCJXR> ClientId;    // 0x0x18
    public QKFNWZERSCU Network;    // 0x0x20
}
...
{
    public Result<object, PWKRFVXRRZL>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.VRLOOLYCTSA
//   (not directly referenced by a detected call)
public class DiceResult : VRLOOLYCTSA
{
    // (no instance fields in the metadata dump)
}
...
{
    public HYKMXKQCBUU _deps;    // 0x0x0
    public ZYLAWNEORYA _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public JREXIONHEGX inAppMessages;    // 0x0x70
}
...
{
    public List<PMDXJVZUUKR<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.VOXXRMIOJPC`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <HXWZDNRAWAQ>k__BackingField;    // 0x0x38
    ...
    public string <UEMJGPTWWAY>k__BackingField;    // 0x0x48
    public MCBICWXMIPK <ContentObject>k__BackingField;    // 0x0x50
}
...
public class TimeLimitedEventDTO
{
    ...
    public string <JECZUVXCDEH>k__BackingField;    // 0x0x30
...
public class LoginResult : ValueType
{
    ...
    public BJWYWQCSQII <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.YWLKMIRHCDY/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.UTJVHKRXQHH/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt HDNTBJTFXKO;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> ABGCWNMXYRA;    // 0x0x1D0
    public IReadOnlyList<string> MVDOCJLXLIS;    // 0x0x1D8
    public IReadOnlyList<string> HKJVFUEBTSE;    // 0x0x1E0
    public string VKSUZZFHCRF;    // 0x0x1E8
    public IReadOnlyList<string> BQKWQWAKJDP;    // 0x0x1F0
    public bool? PZWLNUMAMGF;    // 0x0x1F8
    public bool? SPYFBPRZBPC;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> LGLHACSMYSW;    // 0x0x200
    public IReadOnlyList<ObscuredInt> YIQGLQAPCOY;    // 0x0x208
    public ObscuredInt? KGLTOGTVXQB;    // 0x0x210
}
...
// base   : RecNet.CAJDZQHFHEM`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public RALJDDLNAFV <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<GLQBWKQREME> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public KPRJDCDAPVJ _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public HKCVOJVJRLV _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool MBGUQTJYIAV;    // 0x0x30
}
...
{
    public EBWHTYTUTYV pendingRequests;    // 0x0x0
...
{
    public ZPQUEANCUUE EMVJUYYRCBD;    // 0x0x10
    public LIBZUOBXHFU MKNMQXJNITL;    // 0x0x18
    public VZVYRIFALVM JIBXFHFUFXJ;    // 0x0x20
    public FTIFNKENWWG DUBRZCIRBSP;    // 0x0x28
}
