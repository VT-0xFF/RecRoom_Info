...
// DTO classes: 706 (plus referenced enums)
...
{
    public VZKFCAVCIQQ<ZNWMZVRLJBJ, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public GRMJQVWYAHK<ZNWMZVRLJBJ, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public PRNNMMJSLKB CircuitsManager;    // 0x0x10
    public Id32<GPNZGVDAJTA> ClientId;    // 0x0x18
    public ZNWMZVRLJBJ Network;    // 0x0x20
}
...
{
    public Result<object, AFOSPUXIYKE>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.XDIEVWEEGPR
//   (not directly referenced by a detected call)
public class DiceResult : XDIEVWEEGPR
{
    // (no instance fields in the metadata dump)
}
...
{
    public VUJTJJOWWBJ _deps;    // 0x0x0
    public AEMOPZBEDBJ _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public WXUIFUFYURE inAppMessages;    // 0x0x70
}
...
{
    public List<EKYMNUTGDKQ<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.GSIKMYFJEMN`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <VMXAUHBECKD>k__BackingField;    // 0x0x38
    ...
    public string <NCCFBOBCICV>k__BackingField;    // 0x0x48
    public SNAQDJOGEJZ <ContentObject>k__BackingField;    // 0x0x50
}
...
public class TimeLimitedEventDTO
{
    ...
    public string <SQOIKKYOVTC>k__BackingField;    // 0x0x30
...
public class LoginResult : ValueType
{
    ...
    public ZIUXEJLWLDB <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.YZOHFLCKRFD/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.KFRJVQRBBBA/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt MKCSJWOTELZ;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> DLQFGLMBONJ;    // 0x0x1D0
    public IReadOnlyList<string> YTTPAIHFXVH;    // 0x0x1D8
    public IReadOnlyList<string> XNYCVIOCDUR;    // 0x0x1E0
    public string CEWLVCOCJTY;    // 0x0x1E8
    public IReadOnlyList<string> TFDGJPXCQEK;    // 0x0x1F0
    public bool? NGDTVCFCVEC;    // 0x0x1F8
    public bool? IRKYYBDBJOT;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> CGKBHKKWSOP;    // 0x0x200
    public IReadOnlyList<ObscuredInt> NEPPUMQTHED;    // 0x0x208
    public ObscuredInt? KTXPZFMVSOO;    // 0x0x210
}
...
// base   : RecNet.QOZCWDLIIRP`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public GGQBCIQRWVY <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<NJKWXQSTICH> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public NDOQTORKZIM _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public RSSNHVGAUQS _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool FFSESSYRWWO;    // 0x0x30
}
...
{
    public YLRHRMDLXXQ pendingRequests;    // 0x0x0
...
{
    public YZOYTUKTKIH NLKAWVWHGGW;    // 0x0x10
    public IRFHPPUABZR NJWXSLCJYLW;    // 0x0x18
    public KDQLNOARXAF ZXFAPXPHZGW;    // 0x0x20
    public PTASQENSJAL CHSCNCNYHPE;    // 0x0x28
}
