...
// DTO classes: 707 (plus referenced enums)
...
{
    public IMPSIRPQCTD<BXZRGPVAATC, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public MFXCORTPMUN<BXZRGPVAATC, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public WUFOVRVICVI CircuitsManager;    // 0x0x10
    public Id32<ZORKRESYKMD> ClientId;    // 0x0x18
    public BXZRGPVAATC Network;    // 0x0x20
}
...
{
    public Result<object, ZVSGMZZHZEF>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.TZDNEDFMXOQ
//   (not directly referenced by a detected call)
public class DiceResult : TZDNEDFMXOQ
{
    // (no instance fields in the metadata dump)
}
...
{
    public ZVDGYJVWQXS _deps;    // 0x0x0
    public KIQIZMMDNIQ _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public VVOEYEBWWTN inAppMessages;    // 0x0x70
}
...
{
    public List<HLZNYLYOIUF<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
public class AvatarEffectConfigDTO
{
    ...
    public List<PlayerMovementSpeedEffectDTO> <PlayerMovementSpeedEffectConfigs>k__BackingField;    // 0x0x50
    public DriverConfigDTO <PlayerVelocityDriverConfig>k__BackingField;    // 0x0x58
    public DriverConfigDTO <PlayerVoiceVolumeDriverConfig>k__BackingField;    // 0x0x60
    public DriverConfigDTO <PlayerHighFivesDriverConfig>k__BackingField;    // 0x0x68
}
...
// base   : RecNet.BJCTVOFTGDW`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <WFCAMMMZFGY>k__BackingField;    // 0x0x38
    ...
    public string <UNTSZIALQDS>k__BackingField;    // 0x0x48
    public IZGDZOKDLIU <ContentObject>k__BackingField;    // 0x0x50
}
...
{
    public List<int> <Ingredients>k__BackingField;    // 0x0x10
}
...
public class RecipeDTO
{
    ...
    public string <Name>k__BackingField;    // 0x0x18
    public string <ImagePath>k__BackingField;    // 0x0x20
    public List<int> <IngredientIds>k__BackingField;    // 0x0x28
...
public class RecipesEventXpSourceDTO : TimedEventXpSourceDTO
{
    ...
    public List<RecipeIngredientDTO> <Ingredients>k__BackingField;    // 0x0x20
...
public class TimeLimitedEventConfigDTO
{
    ...
    public List<TimedEventXpSinkDTO> <XpSinks>k__BackingField;    // 0x0x20
}
...
public class TimeLimitedEventDTO
{
    ...
    public string <UGHINFNOOED>k__BackingField;    // 0x0x30
    public string <Metadata>k__BackingField;    // 0x0x38
    public TimeLimitedEventConfigDTO <Config>k__BackingField;    // 0x0x40
}
...
{
    public long <TimedRewardTreeNodeId>k__BackingField;    // 0x0x10
    public long? <ParentTimedRewardTreeNodeId>k__BackingField;    // 0x0x18
    public int? <ParentIndex>k__BackingField;    // 0x0x28
    public int <RequiredXp>k__BackingField;    // 0x0x30
    public List<int> <RewardGiftDropIds>k__BackingField;    // 0x0x38
}
...
public class LoginResult : ValueType
{
    ...
    public ZAOALZBEWJO <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.HOFKRKUEBCW/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.UMTRVAMXTPD/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_RecipeIngredientDTO
// base   : RecNet.RecNetResultObject`1<RecNet.Interfaces.TimeLimitedEvents.RecipeIngredientDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_RecipeIngredientDTO
{
    // (no instance fields in the metadata dump)
}
...
{
    public ObscuredInt IAMJKRGDXXU;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> RZKVIQPWOBI;    // 0x0x1D0
    public IReadOnlyList<string> SOSIBWJQEZU;    // 0x0x1D8
    public IReadOnlyList<string> NFTCZLYTKEM;    // 0x0x1E0
    public string MSHCWBUTWIX;    // 0x0x1E8
    public IReadOnlyList<string> LUXBWDBHXWJ;    // 0x0x1F0
    public bool? VJWZGGPJKYZ;    // 0x0x1F8
    public bool? CEPKZMMXMSA;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> EDOLRBLPPRU;    // 0x0x200
    public IReadOnlyList<ObscuredInt> ZQISYELSAKI;    // 0x0x208
    public ObscuredInt? LKVPLCJNAYF;    // 0x0x210
}
...
// base   : RecNet.ODOKNJEZTSI`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public MNBLXORRVOP <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<ELLCIJYQWCA> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public XHHKBSRZIYH _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public LOPLRFMSJIT _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool EBPNOPWJGHH;    // 0x0x30
}
...
{
    public JPGQTSIPIBH pendingRequests;    // 0x0x0
...
{
    public COVOCOLXXUI UBLEZUXYRFP;    // 0x0x10
    public VTVLVIWJEGO GBTOMIRRMLT;    // 0x0x18
    public NOWXTHPZPLA YIWTFAAIALN;    // 0x0x20
    public KQERKIHCNDI ZVOKTWCDXTV;    // 0x0x28
}
