...
{
    public TYTYGWVULLU<FLBRYQMQISN, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public UEZCSOSHWMK<FLBRYQMQISN, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public RRHCIMKELZN CircuitsManager;    // 0x0x10
    public Id32<WBUFIROFFZC> ClientId;    // 0x0x18
    public FLBRYQMQISN Network;    // 0x0x20
}
...
{
    public Result<object, WMUYMRHRYMC>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.BLKNPMMWVQF
//   (not directly referenced by a detected call)
public class DiceResult : BLKNPMMWVQF
{
    // (no instance fields in the metadata dump)
}
...
{
    public ELSNTWPCDON _deps;    // 0x0x0
    public DLOXXYQFPRD _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public EHPSUDGHYYI inAppMessages;    // 0x0x70
}
...
{
    public List<EYOYLHENQYS<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.GZJMDWWJPMH`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <SLLVNXYQOGR>k__BackingField;    // 0x0x38
    ...
    public string <INUVWQEMFXJ>k__BackingField;    // 0x0x48
    public CJVSOXSWHIN <ContentObject>k__BackingField;    // 0x0x50
}
...
// base   : RecNet.Interfaces.TimeLimitedEvents.UBSKZEBLWSY
//   (not directly referenced by a detected call)
...
public class TimeLimitedEventDTO
{
    ...
    public string <LDDNXZXTBDU>k__BackingField;    // 0x0x40
...
public class LoginResult : ValueType
{
    ...
    public RNAMFBQESDD <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.EZVANHGXPZN/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.ASUVHMYJBRW/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt OVPLYZOSNYR;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> PGIAKUJYOPL;    // 0x0x1D0
    public IReadOnlyList<string> ISWMBQHLSOP;    // 0x0x1D8
    public IReadOnlyList<string> KEQBEGDIZFR;    // 0x0x1E0
    public string QKYFFRHMGGU;    // 0x0x1E8
    public IReadOnlyList<string> FMHALPGLMEY;    // 0x0x1F0
    public bool? SVWUXODSEDC;    // 0x0x1F8
    public bool? LGZEIZNFGRH;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> BAHTEDEFTUR;    // 0x0x200
    public IReadOnlyList<ObscuredInt> MKPBDLZMFTP;    // 0x0x208
    public ObscuredInt? BYWLRWOBOEA;    // 0x0x210
}
...
// base   : RecNet.FWXFUQZTVVN`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
//   REQUEST  PUT    api/inventions/v2/metadata   [Service.AI]
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public HKNDQCYYRGU <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<JNRVUMIMAGV> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public YSPMOZFFUWS _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public KJKLCMWDLCQ _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool DWMTLYFGLWA;    // 0x0x30
}
...
{
    public YEGRVBHZXVS pendingRequests;    // 0x0x0
...
{
    public JMMAQOYKSZH NQFDUPPEUOQ;    // 0x0x10
    public RJQVPXGVQNL IICROBTOCJI;    // 0x0x18
    public COPKHIGAUKL RWTNGABVQDC;    // 0x0x20
    public ZCXFXOUZOLH XSSZFYPQHWU;    // 0x0x28
}
