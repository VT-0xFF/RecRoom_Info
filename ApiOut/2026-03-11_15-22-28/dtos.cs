...
// DTO classes: 717 (plus referenced enums)
...
{
    public JVSIOPAFIHP<KNSHTKDPPBO, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public BHSQOXYFTHX<KNSHTKDPPBO, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public UOILJAPMYSC CircuitsManager;    // 0x0x10
    public Id32<OFTCEQFRRMD> ClientId;    // 0x0x18
    public KNSHTKDPPBO Network;    // 0x0x20
}
...
{
    public Result<object, IMZVXBWNFZH>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.ENUINSLNSJS
//   (not directly referenced by a detected call)
public class DiceResult : ENUINSLNSJS
{
    // (no instance fields in the metadata dump)
}
...
{
    public OAIZGCDVQOY _deps;    // 0x0x0
    public BKAMUOKSWTC _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public MCTWDNCQQTJ inAppMessages;    // 0x0x70
}
...
{
    public List<RKQSLXBHCXD<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.JLKDRTVBVQM`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <QPBHIHLLDFW>k__BackingField;    // 0x0x38
    ...
    public string <ZZEJBYMPXDS>k__BackingField;    // 0x0x48
    public NSLLZDATTCE <ContentObject>k__BackingField;    // 0x0x50
}
...
// base   : RecNet.Interfaces.TimeLimitedEvents.JJJAAZSLQRF
//   (not directly referenced by a detected call)
...
public class TimeLimitedEventDTO
{
    ...
    public string <ZAICVJGXTQT>k__BackingField;    // 0x0x40
...
public class LoginResult : ValueType
{
    ...
    public GWNNRAMMAJK <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.EBZAIXFLWRI/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.KEXYUNYWLPH/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt UICPWGNHQVA;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> GOQKLJOOTLU;    // 0x0x1D0
    public IReadOnlyList<string> BVJFPLGBRPQ;    // 0x0x1D8
    public IReadOnlyList<string> HVHFHVATBWA;    // 0x0x1E0
    public string QHSCSIDQUZJ;    // 0x0x1E8
    public IReadOnlyList<string> IJKRBBCQCGZ;    // 0x0x1F0
    public bool? EZBKZXTFDTL;    // 0x0x1F8
    public bool? CFDKUKRWCWU;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> NZBQKVXBJYK;    // 0x0x200
    public IReadOnlyList<ObscuredInt> LKJUDDLLCWE;    // 0x0x208
    public ObscuredInt? XDGZVDXTOGN;    // 0x0x210
}
...
// base   : RecNet.KUFSBZYHCLW`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public EPXYEWXKMUL <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<KIHULVHVBYM> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public ADJDNATJUCX _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public PIXAVOSWWZJ _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool IVDOTJXDBOB;    // 0x0x30
}
...
{
    public IZAIMPHOPIR pendingRequests;    // 0x0x0
...
{
    public QKZRGTAMKVG FPQJJVNTAPL;    // 0x0x10
    public MKVXTPGTSZM NGILTPSYBZH;    // 0x0x18
    public NJLDKZUTSQW KFODPTCNARF;    // 0x0x20
    public QUHCGGYLRGO JJROCFBTTVN;    // 0x0x28
    public SJWQKLDPLOU JAFRTFHDGLD;    // 0x0x30
}
