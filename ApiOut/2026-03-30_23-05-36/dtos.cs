...
// DTO classes: 716 (plus referenced enums)
...
{
    public CYONTVTWVUG<RPLYECVWMOB, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public ZJJNMORMQIW<RPLYECVWMOB, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public QYNLRMWOSJV CircuitsManager;    // 0x0x10
    public Id32<YMXYNUJKSYU> ClientId;    // 0x0x18
    public RPLYECVWMOB Network;    // 0x0x20
}
...
{
    public Result<object, GVGCNFONGHQ>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.PZUCSFKURFH
//   (not directly referenced by a detected call)
public class DiceResult : PZUCSFKURFH
{
    // (no instance fields in the metadata dump)
}
...
{
    public WROGKVZRMEZ _deps;    // 0x0x0
    public LNVUNUKFJTD _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public EYMLWKTSPVG inAppMessages;    // 0x0x70
}
...
{
    public List<XWHNEKHMOOC<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.AAPTMCVHPEL`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <TUAPUQOXYVX>k__BackingField;    // 0x0x38
    ...
    public string <XNABKSNJOCL>k__BackingField;    // 0x0x48
    public ZYFOXNGGLRX <ContentObject>k__BackingField;    // 0x0x50
}
...
// base   : RecNet.Interfaces.TimeLimitedEvents.JOFOVGBZIHC
//   (not directly referenced by a detected call)
...
public class TimeLimitedEventDTO
{
    ...
    public string <SPJTIUIQZQO>k__BackingField;    // 0x0x40
...
public class LoginResult : ValueType
{
    ...
    public JLZCMZUBUNT <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.PBTILJHJFVR/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.VKJOMIEVJUU/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt NEPWEUIGDBL;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> RVOEQXRJGLP;    // 0x0x1D0
    public IReadOnlyList<string> AQTNMPTQCRN;    // 0x0x1D8
    public IReadOnlyList<string> SNSBRPGVYRZ;    // 0x0x1E0
    public string TLKAXRPMWCI;    // 0x0x1E8
    public IReadOnlyList<string> JMVHXLMJTTK;    // 0x0x1F0
    public bool? WPKSOSVLNMA;    // 0x0x1F8
    public bool? PRMBQHBBTIZ;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> SYPQBWNKSCF;    // 0x0x200
    public IReadOnlyList<ObscuredInt> WLKEDLJZDDT;    // 0x0x208
    public ObscuredInt? XTEVJNLPOTG;    // 0x0x210
}
...
// base   : RecNet.USLWEWPICFF`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public KYZMAJYZDLO <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<SBOIEAJIUQN> <Content>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// RecRoom.Avatars.Data.Shared.DDGKOWMFDTO
//   (not directly referenced by a detected call)
public class DDGKOWMFDTO
{
    // (no instance fields in the metadata dump)
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public CJXKULJFMZY _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public ZCQBFLFQWGY _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool JMSMVAQACMU;    // 0x0x30
}
...
{
    public QCKXMBVYINK pendingRequests;    // 0x0x0
...
{
    public OFQPPLCJMSJ FDATSQVYVNK;    // 0x0x10
    public XUGKTZRMKBX WGIOSXOWBZI;    // 0x0x18
    public UKUNFBVHYIL VXEVJBJAOZS;    // 0x0x20
    public ZVDPRYERHJD BHTGUQOIGRW;    // 0x0x28
    public EHBGCKFFDBH STLWUOCCMNY;    // 0x0x30
}
