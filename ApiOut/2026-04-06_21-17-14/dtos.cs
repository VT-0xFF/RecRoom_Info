...
{
    public YFDAPENMPOM<LHNTXVRCRQX, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public RFWPTPAMTQY<LHNTXVRCRQX, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public COWOBFPVIKZ CircuitsManager;    // 0x0x10
    public Id32<WNPWZNYIVVQ> ClientId;    // 0x0x18
    public LHNTXVRCRQX Network;    // 0x0x20
}
...
{
    public Result<object, YCREHOYWOHO>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.PWZSKQSFACX
//   (not directly referenced by a detected call)
public class DiceResult : PWZSKQSFACX
{
    // (no instance fields in the metadata dump)
}
...
{
    public UYPXTMTCQYP _deps;    // 0x0x0
    public SWFQECRPDPB _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public OGBOBGEVQNI inAppMessages;    // 0x0x70
}
...
{
    public List<XLVWJYJVKEU<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.YCKTVUEGJKZ`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <EJOHLXYSJAH>k__BackingField;    // 0x0x38
    ...
    public string <YDUCEHVDTIB>k__BackingField;    // 0x0x48
    public ERUUPSNPNKH <ContentObject>k__BackingField;    // 0x0x50
}
...
// base   : RecNet.Interfaces.TimeLimitedEvents.YGFOPHQNSSO
//   (not directly referenced by a detected call)
...
public class TimeLimitedEventDTO
{
    ...
    public string <CLZDRFFRZEE>k__BackingField;    // 0x0x40
...
public class LoginResult : ValueType
{
    ...
    public TILSRNHDUIH <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.IVCAKXDQCSR/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.BGLJJPBNWNQ/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt BJRLLCZSHEX;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> VOAXVQGKJVZ;    // 0x0x1D0
    public IReadOnlyList<string> TMTECTXIXVT;    // 0x0x1D8
    public IReadOnlyList<string> EUYVTJBVIKN;    // 0x0x1E0
    public string URSWRAMTEZU;    // 0x0x1E8
    public IReadOnlyList<string> EPFMWXIMZBI;    // 0x0x1F0
    public bool? HYLBQJXGRPI;    // 0x0x1F8
    public bool? NXKAEOUFPRJ;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> LFFJJXXQSZV;    // 0x0x200
    public IReadOnlyList<ObscuredInt> QVOSFMPECNZ;    // 0x0x208
    public ObscuredInt? EZPOWAVYXEC;    // 0x0x210
}
...
// base   : RecNet.NNBRWYULBEJ`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public ZAVLWMCDVSG <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<HZZEAMLZKDB> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public YKOXFKAMQGI _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public KBXBIQJRYGC _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool QBCSNCHRCYG;    // 0x0x30
}
...
{
    public RJWGFTBZJPM pendingRequests;    // 0x0x0
...
{
    public WHGYYENAIUL EHXZKUBIMDY;    // 0x0x10
    public DRYYLRJNWQT OSKSDASTCAY;    // 0x0x18
    public DKUBAVTRTKF IQPKOCIZMBY;    // 0x0x20
    public UKUDVOEDYRJ WILIUWWEAWG;    // 0x0x28
    public DBEFRWFSUIP DDZFBKKWOMQ;    // 0x0x30
}
