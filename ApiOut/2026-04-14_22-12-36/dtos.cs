...
{
    public HUACHFUJUGG<HPHIQELCELX, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public BFJWOIONIEO<HPHIQELCELX, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public XXEAPKVABFJ CircuitsManager;    // 0x0x10
    public Id32<GEJEFIAWMNS> ClientId;    // 0x0x18
    public HPHIQELCELX Network;    // 0x0x20
}
...
{
    public Result<object, SCULPNIXVDU>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.IBZGWALJKHP
//   (not directly referenced by a detected call)
public class DiceResult : IBZGWALJKHP
{
    // (no instance fields in the metadata dump)
}
...
{
    public ODRSNXNZSZX _deps;    // 0x0x0
    public HATGOKICMKB _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public HDUDWTKRXXS inAppMessages;    // 0x0x70
}
...
{
    public List<JDWNAEBDEWK<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.RIHJDVSHYVF`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <BRQYZXPANGJ>k__BackingField;    // 0x0x38
    ...
    public string <JUAQNEQWOOD>k__BackingField;    // 0x0x48
    public GANBPTWVCWJ <ContentObject>k__BackingField;    // 0x0x50
}
...
// base   : RecNet.Interfaces.TimeLimitedEvents.QGBDPVCDKIY
//   (not directly referenced by a detected call)
...
public class TimeLimitedEventDTO
{
    ...
    public string <QVCXAAGIYRA>k__BackingField;    // 0x0x40
...
public class LoginResult : ValueType
{
    ...
    public TRVOZDTXPDD <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.HZQYVABLPTF/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.HARQOXEIOMA/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt UUOXSNZUWMZ;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> ASDSWVANNYZ;    // 0x0x1D0
    public IReadOnlyList<string> EPDSAQIUJAD;    // 0x0x1D8
    public IReadOnlyList<string> CYMZICCIXLJ;    // 0x0x1E0
    public string YLFUNVCOQSI;    // 0x0x1E8
    public IReadOnlyList<string> PGJYZLJYJLS;    // 0x0x1F0
    public bool? SGGVFETIYHG;    // 0x0x1F8
    public bool? QULUETUMAHP;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> UJJCXFZPXLH;    // 0x0x200
    public IReadOnlyList<ObscuredInt> JTLPRUQHOZT;    // 0x0x208
    public ObscuredInt? AEQFOVVYSPO;    // 0x0x210
}
...
// base   : RecNet.BDDIUNODPTF`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public ZHZECXNUALK <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<SENYIVQWZDD> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public WSYNBUDJKHM _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public DNLAWRHDLRW _line;    // 0x0x8
...
//   REQUEST  GET    api/roomkeys/v1/mine   [Service.Econ]
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool EBNYZGCCIEU;    // 0x0x30
}
...
{
    public XNGDTWMSKZC pendingRequests;    // 0x0x0
...
{
    public PSAOWIFVEHP KJXKMHFLTOY;    // 0x0x10
    public UMPHRQRJQER JBCVUOXOEPY;    // 0x0x18
    public BEXQCYIXEDV PFZBSFYHGRC;    // 0x0x20
    public GRRPNGJXHKR MSQKANUJXLO;    // 0x0x28
    public GPLQSVASCFT IJMZZOYERAO;    // 0x0x30
}
