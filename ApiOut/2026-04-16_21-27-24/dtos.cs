...
{
    public OHLNKQHDPWD<ZIWGSIEKNOO, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public HADKPPFWQVZ<ZIWGSIEKNOO, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public LLXPXHNGEHC CircuitsManager;    // 0x0x10
    public Id32<QOLQCAXXJSV> ClientId;    // 0x0x18
    public ZIWGSIEKNOO Network;    // 0x0x20
}
...
{
    public Result<object, SEZYOHJZPUT>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.ZFURAATAEFM
//   (not directly referenced by a detected call)
public class DiceResult : ZFURAATAEFM
{
    // (no instance fields in the metadata dump)
}
...
{
    public VAEKADQIRNQ _deps;    // 0x0x0
    public KVHMMDKOSSW _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public AAJVOXJHQPT inAppMessages;    // 0x0x70
}
...
{
    public List<PZFTNNZSWSX<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.KDDCIWMSJRY`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <HJXSJXNPKGG>k__BackingField;    // 0x0x38
    ...
    public string <UWWTOMWTFDU>k__BackingField;    // 0x0x48
    public WQRFGGFYBAG <ContentObject>k__BackingField;    // 0x0x50
}
...
// base   : RecNet.Interfaces.TimeLimitedEvents.MPNSALGBXFX
//   (not directly referenced by a detected call)
...
public class TimeLimitedEventDTO
{
    ...
    public string <EJTGDXHHISV>k__BackingField;    // 0x0x40
...
public class LoginResult : ValueType
{
    ...
    public ROOLLGEASOG <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.UPAFFFBIDRG/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.CNSUQUYLXBR/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt OQNCOYJUWCM;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> SDFNCYUPUZC;    // 0x0x1D0
    public IReadOnlyList<string> XTOQGNZAKEY;    // 0x0x1D8
    public IReadOnlyList<string> XWEDVHTRVNU;    // 0x0x1E0
    public string NCVAGUHBHMV;    // 0x0x1E8
    public IReadOnlyList<string> DXOXZTSRSTV;    // 0x0x1F0
    public bool? ZRWNPYBQMJV;    // 0x0x1F8
    public bool? WWENOPUJAJM;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> UUXLKGMKCDS;    // 0x0x200
    public IReadOnlyList<ObscuredInt> BVFNHWWMOSO;    // 0x0x208
    public ObscuredInt? AJQNDWTLIDR;    // 0x0x210
}
...
// base   : RecNet.GDLCVTXFKWS`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public JBNYGMGDGCJ <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<HKQMQHRGDGG> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public EJMDVNERXCJ _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public OKJDPVNTSIZ _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool PJVFHJOPXKX;    // 0x0x30
}
...
{
    public JQUHMOCITDZ pendingRequests;    // 0x0x0
...
{
    public MCHVVJCOINQ BGDHEBCZSVJ;    // 0x0x10
    public QBAGDXSUNAY TYLHORHBCGP;    // 0x0x18
    public JHKJYAUZJLS QXIWNHJAULT;    // 0x0x20
    public SSIQTRFIVPS VLSHCIQBQSV;    // 0x0x28
    public VMMUBYLZSXM YWDKVRFBPTJ;    // 0x0x30
}
