...
{
    public NSSIEQQRQOQ<LWWLBIHZXST, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public CBYJFRFNFDK<LWWLBIHZXST, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public WVKEVWTACCJ CircuitsManager;    // 0x0x10
    public Id32<HGRDVVOSLAK> ClientId;    // 0x0x18
    public LWWLBIHZXST Network;    // 0x0x20
}
...
{
    public Result<object, CBUCXYTAOGI>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.SXFVAKKMZDB
//   (not directly referenced by a detected call)
public class DiceResult : SXFVAKKMZDB
{
    // (no instance fields in the metadata dump)
}
...
{
    public EDIRCJTODTF _deps;    // 0x0x0
    public WNWYUXAFTQH _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public OKAMHXHDWNQ inAppMessages;    // 0x0x70
}
...
{
    public List<KZWABWCSKCQ<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.TYGGAUKWCPT`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <RNGKAWAIZDJ>k__BackingField;    // 0x0x38
    ...
    public string <DVRQCDSFZJP>k__BackingField;    // 0x0x48
    public NRTEDQTCFLV <ContentObject>k__BackingField;    // 0x0x50
}
...
// base   : RecNet.Interfaces.TimeLimitedEvents.VUOBOTWCNRU
//   (not directly referenced by a detected call)
...
public class TimeLimitedEventDTO
{
    ...
    public string <TDDYWVVUMIY>k__BackingField;    // 0x0x40
...
public class LoginResult : ValueType
{
    ...
    public CCMREPOVRDV <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.FHOVXIIRYKR/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.UTMBINSRRAG/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt GDLVEBONEVB;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> IESIRLHFFYT;    // 0x0x1D0
    public IReadOnlyList<string> KUATIUOBXKZ;    // 0x0x1D8
    public IReadOnlyList<string> WLAACHYOPIN;    // 0x0x1E0
    public string CDMPKFRXYBE;    // 0x0x1E8
    public IReadOnlyList<string> SMSTIVKNETA;    // 0x0x1F0
    public bool? HIPJPGKNRPA;    // 0x0x1F8
    public bool? UFQQPSTATLN;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> CUTWDCFULBB;    // 0x0x200
    public IReadOnlyList<ObscuredInt> UTNQLRFCEFR;    // 0x0x208
    public ObscuredInt? UHSZLZPALOO;    // 0x0x210
}
...
// base   : RecNet.FRRGLUXINVH`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public BXTCLAGVJSG <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<IGYKNBXZJJJ> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public OYFUCBVVEZS _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public BQDMLGMPIXI _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool TBJOWRZUWWS;    // 0x0x30
}
...
{
    public ERIOKYKPZAS pendingRequests;    // 0x0x0
...
{
    public QWDCZOWMPKD XYPHPWBDKDI;    // 0x0x10
    public YJXJZRLPLVN TQYBEYDEMKU;    // 0x0x18
    public BMITHGLGCIV EEWEUTWUCFA;    // 0x0x20
    public ZMUPGIYERVV MOFTHEEMQJY;    // 0x0x28
    public FJLCDYTYJRB XGZIAKAKEIA;    // 0x0x30
}
