...
{
    public DDBBEEAJJTS<MGQGRHRPFYH, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public SQNVNHLDELG<MGQGRHRPFYH, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public SCQFSPRNDPD CircuitsManager;    // 0x0x10
    public Id32<BVHHKRGRDMC> ClientId;    // 0x0x18
    public MGQGRHRPFYH Network;    // 0x0x20
}
...
{
    public Result<object, FWOTOTOBXEY>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.KHXVQGDIFHB
//   (not directly referenced by a detected call)
public class DiceResult : KHXVQGDIFHB
{
    // (no instance fields in the metadata dump)
}
...
{
    public TVWXLXTXIIP _deps;    // 0x0x0
    public OKXJRNOVLSL _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public MZAOKPFLQAS inAppMessages;    // 0x0x70
}
...
{
    public List<IWXKOYMHURS<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// base   : RecNet.USMWRQJJQZH`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <CMNDFDZDGJZ>k__BackingField;    // 0x0x38
    ...
    public string <FIKHZFHXHQZ>k__BackingField;    // 0x0x48
    public SZQCVEIDVLV <ContentObject>k__BackingField;    // 0x0x50
}
...
// base   : RecNet.Interfaces.TimeLimitedEvents.IDDZNSRYIMS
//   (not directly referenced by a detected call)
...
public class TimeLimitedEventDTO
{
    ...
    public string <HNJNFJJYLSQ>k__BackingField;    // 0x0x40
...
public class LoginResult : ValueType
{
    ...
    public JEGZPZHCKEH <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.HJTPOGVDGSR/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.PBLVTTUOWSO/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
{
    public ObscuredInt FTCCLVMDBDZ;    // 0x0x10
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> NYHRJXIIOKL;    // 0x0x1D0
    public IReadOnlyList<string> GNHNGLFMSMJ;    // 0x0x1D8
    public IReadOnlyList<string> ICCURPEDMAZ;    // 0x0x1E0
    public string BFXVOIAXADY;    // 0x0x1E8
    public IReadOnlyList<string> VJVXMANPLJQ;    // 0x0x1F0
    public bool? ZSGOTNTVHCS;    // 0x0x1F8
    public bool? JRXGKTGEAGT;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> LKWPRIKJSHJ;    // 0x0x200
    public IReadOnlyList<ObscuredInt> FKTPAAZGBEP;    // 0x0x208
    public ObscuredInt? PATBGGBNUVU;    // 0x0x210
}
...
// base   : RecNet.ZEFEUCNBZAJ`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public XMAGSLOAKTY <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<UGNRIBHMBJZ> <Content>k__BackingField;    // 0x0x18
}
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public IKOBMFTUZAY _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public BZWZXIIRFFQ _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool SVKKWSITSOS;    // 0x0x30
}
...
{
    public JXOERQCNFFY pendingRequests;    // 0x0x0
...
{
    public ZPFIUOAJJJV YTLVACUUSYW;    // 0x0x10
    public PTYFJIYOPLR BBDTMTUFLTO;    // 0x0x18
    public ARRWXPDNQBT QVFXOHNXRJM;    // 0x0x20
    public LFDGYKZXINZ CDHWUFGDVDA;    // 0x0x28
    public FGSYVDLARNB FOIBVPVKLPW;    // 0x0x30
}
