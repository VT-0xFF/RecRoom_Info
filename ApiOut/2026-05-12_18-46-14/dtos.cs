...
// DTO classes: 719 (plus referenced enums)
...
{
    public FZBXDZLWBIS<ETNCQEUIWVP, MockStaticNetSysDeps> StaticNetSys;    // 0x0x0
    public ZGUBSLDPVXI<ETNCQEUIWVP, MockCV2DynamicNetSysDeps> CV2DynamicNetSys;    // 0x0x8
    public BOPULBRGFUP CircuitsManager;    // 0x0x10
    public Id32<QEBRWUBFUFW> ClientId;    // 0x0x18
    public ETNCQEUIWVP Network;    // 0x0x20
}
...
{
    public Result<object, LLLHSATKLGS>[] _results;    // 0x0x0
}
...
// base   : CircuitsV2.Lang.Nodes.RGXVOLLVJVD
//   (not directly referenced by a detected call)
public class DiceResult : RGXVOLLVJVD
{
    // (no instance fields in the metadata dump)
}
...
{
    public VQSBDUUAFGN _deps;    // 0x0x0
    public ISJHRHKEWBX _staticNetSys;    // 0x0x8
}
...
public class MessageNotificationController_InAppMessageDTO
{
    ...
    public VCPOQKTNGSU inAppMessages;    // 0x0x70
}
...
{
    public List<FXCLROJIDZM<DataTypeDTO>> <BalanceUpdates>k__BackingField;    // 0x0x0
}
...
// --------------------------------------------------------------------------
// RecNet.CircuitsGrantRoomBadgeRequestDTO
//   (not directly referenced by a detected call)
public class CircuitsGrantRoomBadgeRequestDTO
{
    public int <TargetAccountId>k__BackingField;    // 0x0x10
    public Guid <BadgeCustomAvatarItemId>k__BackingField;    // 0x0x14
    public long <RoomInstanceId>k__BackingField;    // 0x0x28
    public string <GrantMessage>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.CircuitsGrantRoomBadgeResponseDTO
//   (not directly referenced by a detected call)
public class CircuitsGrantRoomBadgeResponseDTO
{
    public CircuitsGrantRoomBadgeResponseCode <ResponseCode>k__BackingField;    // 0x0x10
    public string <ErrorMessage>k__BackingField;    // 0x0x18
}
...
public class AvatarEffectConfigDTO
{
    ...
    public List<PlayerTransformationEffectDTO> <PlayerTransformationEffectConfigs>k__BackingField;    // 0x0x50
    public List<PlayerMovementSpeedEffectDTO> <PlayerMovementSpeedEffectConfigs>k__BackingField;    // 0x0x58
    public DriverConfigDTO <PlayerVelocityDriverConfig>k__BackingField;    // 0x0x60
    public DriverConfigDTO <PlayerVoiceVolumeDriverConfig>k__BackingField;    // 0x0x68
    public DriverConfigDTO <PlayerHighFivesDriverConfig>k__BackingField;    // 0x0x70
}
...
// --------------------------------------------------------------------------
// RecNet.ConsumableEffects.AvatarItemEffects.PlayerMovementSpeedEffectDTO
//   (not directly referenced by a detected call)
public class PlayerMovementSpeedEffectDTO
{
    public string <Name>k__BackingField;    // 0x0x10
    public Guid <Id>k__BackingField;    // 0x0x18
    public float <WalkSpeedMultiplier>k__BackingField;    // 0x0x28
    public float? <CrouchSpeedMultiplier>k__BackingField;    // 0x0x2C
    public float? <ProneSpeedMultiplier>k__BackingField;    // 0x0x34
    public float <TeleportCooldownTimerMultiplier>k__BackingField;    // 0x0x3C
    public float? <TeleportCrouchCooldownTimerMultiplier>k__BackingField;    // 0x0x40
    public float? <TeleportProneCooldownTimerMultiplier>k__BackingField;    // 0x0x48
}
...
// --------------------------------------------------------------------------
// RecNet.ConsumableEffects.AvatarItemEffects.PlayerTransformationEffectDTO
//   (not directly referenced by a detected call)
public class PlayerTransformationEffectDTO
{
    public string <Name>k__BackingField;    // 0x0x10
    public Guid <Id>k__BackingField;    // 0x0x18
    public string <Key>k__BackingField;    // 0x0x28
    public bool <CanCrouch>k__BackingField;    // 0x0x30
    public float <MaxWalkSpeedMultiplier>k__BackingField;    // 0x0x34
    public PlayerTransformationFirstPersonEffect <FirstPersonEffect>k__BackingField;    // 0x0x38
    public PlayerTransformationKeyType <KeyType>k__BackingField;    // 0x0x39
}
...
public class CustomAvatarItem
{
    ...
    public IReadOnlyList<CustomAvatarItemTagDTO> <Tags>k__BackingField;    // 0x0x90
    public IReadOnlyList<CustomAvatarItemSaveDTO> <CurrentSaves>k__BackingField;    // 0x0x98
    public ItemPurchaseInfoDTO <PurchaseInfo>k__BackingField;    // 0x0xA0
}

// --------------------------------------------------------------------------
// RecNet.CustomAvatarItemBalanceModificationResponse
// base   : RecNet.IHVQNUUMCML`1<RecNet.CustomAvatarItem>
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.CustomAvatarItemTagDTO
//   (not directly referenced by a detected call)
public class CustomAvatarItemTagDTO
{
    public string <Value>k__BackingField;    // 0x0x10
    public TagType <TagType>k__BackingField;    // 0x0x18
}
...
public class BattlePassAccountProgressDTO
{
    ...
    public DateTime <DailyParticipationBonusResetTime>k__BackingField;    // 0x0x28
    public DateTime? <BoostedUntil>k__BackingField;    // 0x0x30
    public DateTime? <CompletionDate>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// RecNet.Econ.BattlePass.BattlePassBoostConfigDTO
//   (not directly referenced by a detected call)
public class BattlePassBoostConfigDTO
{
    public int <TemporaryBoostDurationInMinutes>k__BackingField;    // 0x0x10
    public int <TemporaryBoostXpMultiplierPercentage>k__BackingField;    // 0x0x14
    public int <PermanentBoostXpMultiplierPercentage>k__BackingField;    // 0x0x18
    public int <SocialBoostXpMultiplierPercentage>k__BackingField;    // 0x0x1C
    public int <MaxBoostXpMultiplierPercentage>k__BackingField;    // 0x0x20
}
...
public class BattlePassDTO
{
    public long <BattlePassId>k__BackingField;    // 0x0x10
    public string <Name>k__BackingField;    // 0x0x18
    public IReadOnlyList<long> <ValidRoomIds>k__BackingField;    // 0x0x20
    public DateTime <StartTime>k__BackingField;    // 0x0x28
    public DateTime <EndTime>k__BackingField;    // 0x0x30
    public IReadOnlyList<BattlePassLevelDTO> <Levels>k__BackingField;    // 0x0x38
    public IReadOnlyDictionary<BattlePassEvent, int> <EventXP>k__BackingField;    // 0x0x40
    public BattlePassBoostConfigDTO <BoostConfig>k__BackingField;    // 0x0x48
    public int <DailyParticipationBonusLimit>k__BackingField;    // 0x0x50
    public int <MinimumParticipationTimeInSeconds>k__BackingField;    // 0x0x54
    public IReadOnlyList<BattlePassSkuDTO> <PurchasableSkus>k__BackingField;    // 0x0x58
    public int <PermanentBoostTokenPrice>k__BackingField;    // 0x0x60
    public BattlePassLimitedTimeRewardDTO <LimitedTimeReward>k__BackingField;    // 0x0x68
}
...
{
    public BattlePassSkuType <Type>k__BackingField;    // 0x0x10
...
public class ReportBattlePassSessionResponseDTO
{
    ...
    public bool <WasParticipationBonusCountIncremented>k__BackingField;    // 0x0x20
    public int <BoostPercent>k__BackingField;    // 0x0x24
    public int <TeamBonusPercent>k__BackingField;    // 0x0x28
}
...
// --------------------------------------------------------------------------
// RecNet.FreeItemsWithRRPlusPromotionDTO
//   (not directly referenced by a detected call)
public class FreeItemsWithRRPlusPromotionDTO
{
    public int <RRPlusSignUpBonusId>k__BackingField;    // 0x0x10
    public List<ItemPurchaseMethodId> <BonusItemIds>k__BackingField;    // 0x0x18
}
...
public class GiftPackage
{
    ...
    public Guid? <PurchasableXpBoostId>k__BackingField;    // 0x0x70
    public float? <XpBoostMultiplier>k__BackingField;    // 0x0x84
    public int? <XpBoostDurationMinutes>k__BackingField;    // 0x0x8C
    public CurrencyType <CurrencyType>k__BackingField;    // 0x0x94
    public int <Currency>k__BackingField;    // 0x0x98
    public int <Xp>k__BackingField;    // 0x0x9C
    public GiftContext <GiftContext>k__BackingField;    // 0x0xA0
    public GiftRarity <GiftRarity>k__BackingField;    // 0x0xA4
    public string <RawMessage>k__BackingField;    // 0x0xA8
    public string <Signature>k__BackingField;    // 0x0xB0
    public bool <IsSignatureValid>k__BackingField;    // 0x0xB8
    public PlatformType <Platform>k__BackingField;    // 0x0xBC
    public PlatformMask <PlatformsToSpawnOn>k__BackingField;    // 0x0xC0
    public StorefrontBalanceType? <BalanceType>k__BackingField;    // 0x0xC4
    public long? <RoomId>k__BackingField;    // 0x0xD0
    public string <GiftDescription>k__BackingField;    // 0x0xE0
    public bool <Consumed>k__BackingField;    // 0x0xE8
    public bool <IsValid>k__BackingField;    // 0x0xE9
    public string <CustomMessage>k__BackingField;    // 0x0xF0
    public string <ErrorMessage>k__BackingField;    // 0x0xF8
    public bool <CanSpawnOnCurrentPlatform>k__BackingField;    // 0x0x100
    public bool IsGifted;    // 0x0x101
}
...
// --------------------------------------------------------------------------
// RecNet.GrantableId
//   REQUEST  POST   api/storefronts/v1/buyPurchaseReminder   [Service.Econ]
public class GrantableId
{
    public GrantableType <Type>k__BackingField;    // 0x0x10
    public int? <NumberId>k__BackingField;    // 0x0x14
    public Guid? <Guid>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// RecNet.GrantableType
// base   : System.Enum
//   (not directly referenced by a detected call)
...
public class InAppMessageDTO
{
    ...
    public bool <WKDCHMJMBKF>k__BackingField;    // 0x0x38
    ...
    public string <UNETSPILNQP>k__BackingField;    // 0x0x48
    public NPEFNKEXJEN <ContentObject>k__BackingField;    // 0x0x50
}
...
public class InitiatePurchaseRequest
{
    ...
    public List<GrantableId> <BonusSelectableGrantableIds>k__BackingField;    // 0x0x38
    public int? <GiftRecipientAccountId>k__BackingField;    // 0x0x40
    public string <GiftRecipientMessage>k__BackingField;    // 0x0x48
}
...
// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.ActiveConsumableXpMultiplierDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.TimedEventXpMultiplierDTO
//   (not directly referenced by a detected call)
public class ActiveConsumableXpMultiplierDTO : TimedEventXpMultiplierDTO
{
    public List<int> <ConsumableItemIds>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.ActiveRoomBoostCountXpMultiplierDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.TimedEventXpMultiplierDTO
//   (not directly referenced by a detected call)
public class ActiveRoomBoostCountXpMultiplierDTO : TimedEventXpMultiplierDTO
{
    public List<long> <RoomIds>k__BackingField;    // 0x0x18
    public int <MinRoomBoostCount>k__BackingField;    // 0x0x20
    public int? <MaxRoomBoostCount>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.ClientAuthoritativeCounterRateLimiterConfigDTO
//   (not directly referenced by a detected call)
public class ClientAuthoritativeCounterRateLimiterConfigDTO
{
    public float <MaxValuePerRequest>k__BackingField;    // 0x0x10
    public int <RateLimitWindowMinutes>k__BackingField;    // 0x0x14
    public float <MaxValuePerWindow>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.CompleteChallengeResponseDTO
//   (not directly referenced by a detected call)
public class CompleteChallengeResponseDTO
{
    public RecipesEventRewardsDTO <Rewards>k__BackingField;    // 0x0x10
    public RecipesEventChallengesDTO <ChallengeLanes>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.CookRecipeFromIngredientsRequestDTO
//   REQUEST  POST   api/recipesEvents   [Service.Econ]
//   REQUEST  POST   api/recipesEvents/{recipeseventId}/recipes/cook   [Service.Econ]
public class CookRecipeFromIngredientsRequestDTO
{
    public Dictionary<int, int> <IngredientCounts>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.CookRecipeResultDTO
//   (not directly referenced by a detected call)
public class CookRecipeResultDTO
{
    public int <RecipeId>k__BackingField;    // 0x0x10
    public int <XpGranted>k__BackingField;    // 0x0x14
    public List<GiftPackage> <GiftPackages>k__BackingField;    // 0x0x18
    public List<int> <GiftDropIds>k__BackingField;    // 0x0x20
    public bool <DidUnlockRecipe>k__BackingField;    // 0x0x28
    public bool <DidUnlockFinalRecipe>k__BackingField;    // 0x0x29
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.DistanceMovedXpSourceDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.TimedEventXpSourceDTO
//   (not directly referenced by a detected call)
public class DistanceMovedXpSourceDTO : TimedEventXpSourceDTO
{
    public float <XpPerMeter>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.GiftingXpSourceDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.TimedEventXpSourceDTO
//   (not directly referenced by a detected call)
public class GiftingXpSourceDTO : TimedEventXpSourceDTO
{
    public List<GiftingXpReward> <XpRewards>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.InRoomWithTagXpMultiplierDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.TimedEventXpMultiplierDTO
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.IncrementalCookRecordDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.WJUOHKOHOPO
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.IngredientDTO
//   (not directly referenced by a detected call)
public class IngredientDTO
{
    public int <Id>k__BackingField;    // 0x0x10
    public string <Name>k__BackingField;    // 0x0x18
    public string <ImagePath>k__BackingField;    // 0x0x20
    public float <Weight>k__BackingField;    // 0x0x28
    public RecipeIngredientCollectionMethod <CollectionMethod>k__BackingField;    // 0x0x2C
    public RecipesRarity <Rarity>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.IngredientRecordDTO
//   (not directly referenced by a detected call)
public class IngredientRecordDTO
{
    public int <IngredientId>k__BackingField;    // 0x0x10
    public int <Count>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.IngredientRewardDTO
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.OwnsAvatarItemXpMultiplierDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.TimedEventXpMultiplierDTO
//   (not directly referenced by a detected call)
public class OwnsAvatarItemXpMultiplierDTO : TimedEventXpMultiplierDTO
{
    public List<int> <AvatarItemIds>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.OwnsCustomAvatarItemXpMultiplierDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.TimedEventXpMultiplierDTO
//   (not directly referenced by a detected call)
public class OwnsCustomAvatarItemXpMultiplierDTO : TimedEventXpMultiplierDTO
{
    public List<Guid> <CustomAvatarItemIds>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.RecipeChallengeTypeDTO
//   (not directly referenced by a detected call)
public class RecipeChallengeTypeDTO
{
    ...
    public string <Name>k__BackingField;    // 0x0x18
    public string <ImagePath>k__BackingField;    // 0x0x20
    public string <ConfigJson>k__BackingField;    // 0x0x28
    public float <Weight>k__BackingField;    // 0x0x30
    public RecipesRarity <Rarity>k__BackingField;    // 0x0x34
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.RecipeDTO
//   (not directly referenced by a detected call)
public class RecipeDTO
{
    ...
    public string <Name>k__BackingField;    // 0x0x18
    public string <ImagePath>k__BackingField;    // 0x0x20
    public List<RecipeIngredientDTO> <Ingredients>k__BackingField;    // 0x0x28
    public bool <IsFallback>k__BackingField;    // 0x0x30
    public int <XpAmount>k__BackingField;    // 0x0x34
    public List<int> <GiftDropIds>k__BackingField;    // 0x0x38
    public RecipeUnlockState <DefaultUnlockState>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.RecipeIngredientDTO
//   (not directly referenced by a detected call)
public class RecipeIngredientDTO
{
    public int <IngredientId>k__BackingField;    // 0x0x10
    public int <IngredientCount>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.RecipeRecordDTO
//   (not directly referenced by a detected call)
public class RecipeRecordDTO
{
    public int <RecipeId>k__BackingField;    // 0x0x10
    public RecipeUnlockState <UnlockState>k__BackingField;    // 0x0x14
    public IncrementalCookRecordDTO <IncrementalCook>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.RecipesEventChallengeLaneConfigDTO
//   (not directly referenced by a detected call)
public class RecipesEventChallengeLaneConfigDTO
{
    public int <ChallengeLaneId>k__BackingField;    // 0x0x10
    public RecipesRarity <Rarity>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.RecipesEventChallengeLaneDTO
//   (not directly referenced by a detected call)
public class RecipesEventChallengeLaneDTO
{
    public int <ChallengeLaneId>k__BackingField;    // 0x0x10
    public int <ChallengeTypeId>k__BackingField;    // 0x0x14
    public int <IngredientId>k__BackingField;    // 0x0x18
    public int <IngredientCount>k__BackingField;    // 0x0x1C
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.RecipesEventChallengesDTO
//   (not directly referenced by a detected call)
public class RecipesEventChallengesDTO
{
    public List<RecipesEventChallengeLaneDTO> <ChallengeLanes>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.RecipesEventRecordDTO
//   RESPONSE GET    api/recipesEvents   [Service.Econ]
//   RESPONSE GET    api/recipesEvents/{recipeseventId}/records/me   [Service.Econ]
public class RecipesEventRecordDTO
{
    public int <AccountId>k__BackingField;    // 0x0x10
    public Guid <RecipesEventId>k__BackingField;    // 0x0x14
    public List<IngredientRecordDTO> <Ingredients>k__BackingField;    // 0x0x28
    public List<RecipeRecordDTO> <Recipes>k__BackingField;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.RecipesEventRewardsDTO
//   (not directly referenced by a detected call)
public class RecipesEventRewardsDTO
{
    public List<IngredientRewardDTO> <Ingredients>k__BackingField;    // 0x0x10
    public int <CurrencyAmount>k__BackingField;    // 0x0x18
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.RecipesEventXpSourceDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.TimedEventXpSourceDTO
//   (not directly referenced by a detected call)
public class RecipesEventXpSourceDTO : TimedEventXpSourceDTO
{
    public Guid <RecipesEventId>k__BackingField;    // 0x0x10
    public List<IngredientDTO> <Ingredients>k__BackingField;    // 0x0x20
    public List<RecipeDTO> <Recipes>k__BackingField;    // 0x0x28
    public List<RecipesEventChallengeLaneConfigDTO> <ChallengeLanes>k__BackingField;    // 0x0x30
    public List<RecipeChallengeTypeDTO> <Challenges>k__BackingField;    // 0x0x38
    public CurrencyType <CurrencyType>k__BackingField;    // 0x0x40
    public int <ChallengeSwapCost>k__BackingField;    // 0x0x44
    public int <ChallengeRewardSwapCost>k__BackingField;    // 0x0x48
    public int <DoubleAndCompleteChallengeCost>k__BackingField;    // 0x0x4C
    public int <RecipeHintPurchaseCost>k__BackingField;    // 0x0x50
    public int <CookRecipeCost>k__BackingField;    // 0x0x54
    public int <RecipeUnlockXp>k__BackingField;    // 0x0x58
    public ClientAuthoritativeCounterRateLimiterConfigDTO <IngredientCollectionRateLimiting>k__BackingField;    // 0x0x60
    public ClientAuthoritativeCounterRateLimiterConfigDTO <ChallengeCompletionRateLimiting>k__BackingField;    // 0x0x68
    public List<int> <AllRecipesUnlockedGiftDropIds>k__BackingField;    // 0x0x70
    public int <MinIngredientsForCooking>k__BackingField;    // 0x0x78
    public int <MaxIngredientsForCooking>k__BackingField;    // 0x0x7C
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.StageIngredientsRequestDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.WJUOHKOHOPO
//   REQUEST  POST   api/recipesEvents   [Service.Econ]
//   REQUEST  POST   api/recipesEvents/{recipeseventId}/recipes/{recipeId}/stage-ingredients   [Service.Econ]
...
// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.SuperStageResultDTO
//   (not directly referenced by a detected call)
public class SuperStageResultDTO
{
    public CurrencyType <CurrencyType>k__BackingField;    // 0x0x10
    public int <CurrencyCount>k__BackingField;    // 0x0x14
    public int <IngredientId>k__BackingField;    // 0x0x18
    public int <IngredientQuantity>k__BackingField;    // 0x0x1C
    public IncrementalCookRecordDTO <IncrementalCook>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimeLimitedEventConfigDTO
//   (not directly referenced by a detected call)
public class TimeLimitedEventConfigDTO
{
    public TimedEventCurrencyGrantDTO <CurrencyGrant>k__BackingField;    // 0x0x10
    public List<TimedEventXpSinkDTO> <XpSinks>k__BackingField;    // 0x0x18
    public TimeLimitedEventTeamConfigStorageDTO <TeamConfig>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimeLimitedEventDTO
//   RESPONSE GET    api/timeLimitedEvents   [Service.Econ]
//   RESPONSE GET    api/timeLimitedEvents/{timelimitedeventId}   [Service.Econ]
public class TimeLimitedEventDTO
{
    public long <TimeLimitedEventId>k__BackingField;    // 0x0x10
    ...
    public string <IQLNEPOBJPE>k__BackingField;    // 0x0x40
    public string <Metadata>k__BackingField;    // 0x0x48
    public TimeLimitedEventConfigDTO <Config>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimeLimitedEventTeamConfigDTO
//   RESPONSE GET    api/timeLimitedEvents   [Service.Econ]
//   RESPONSE GET    api/timeLimitedEvents/teamConfig/{teamconfigId}   [Service.Econ]
public class TimeLimitedEventTeamConfigDTO
{
    public long <TimeLimitedEventTeamConfigId>k__BackingField;    // 0x0x10
    public Guid <ReplicationId>k__BackingField;    // 0x0x18
    public int <MaxPlayersPerTeam>k__BackingField;    // 0x0x28
    public DateTime <TeamRegistrationStartTime>k__BackingField;    // 0x0x30
    public DateTime <TeamRegistrationEndTime>k__BackingField;    // 0x0x38
    public string <ActiveExperiment>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimeLimitedEventTeamConfigStorageDTO
//   (not directly referenced by a detected call)
public class TimeLimitedEventTeamConfigStorageDTO
{
    public long? <TimeLimitedEventTeamConfigId>k__BackingField;    // 0x0x10
    public TimeLimitedEventTeamConfigDTO <TimeLimitedEventTeamConfig>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedEventCurrencyGrantDTO
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedEventXpMultiplierDTO
//   (not directly referenced by a detected call)
public class TimedEventXpMultiplierDTO
{
    public float <XpMultiplier>k__BackingField;    // 0x0x10
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedEventXpSinkDTO
//   (not directly referenced by a detected call)
public class TimedEventXpSinkDTO
{
    public List<TimedEventXpSourceDTO> <XpSources>k__BackingField;    // 0x0x10
    public List<TimedEventXpMultiplierDTO> <XpMultipliers>k__BackingField;    // 0x0x18
    public string <GiftMessage>k__BackingField;    // 0x0x20
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedEventXpSourceDTO
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedRewardTrackXpSinkDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.TimedEventXpSinkDTO
//   (not directly referenced by a detected call)
public class TimedRewardTrackXpSinkDTO : TimedEventXpSinkDTO
{
    public long <TimedRewardTrackId>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedRewardTreeDTO
//   RESPONSE GET    api/timedRewardTrees   [Service.Econ]
//   RESPONSE GET    api/timedRewardTrees/{timedrewardtreeId}   [Service.Econ]
public class TimedRewardTreeDTO
{
    public long <TimedRewardTreeId>k__BackingField;    // 0x0x10
    public Guid? <ReplicationId>k__BackingField;    // 0x0x18
    ...
    public string <ActiveExperiment>k__BackingField;    // 0x0x48
    public List<TimedRewardTreeNodeDTO> <Nodes>k__BackingField;    // 0x0x50
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedRewardTreeNodeCollectedDTO
//   (not directly referenced by a detected call)
public class TimedRewardTreeNodeCollectedDTO
{
    public long <TimedRewardTreeId>k__BackingField;    // 0x0x10
    public int <AccountId>k__BackingField;    // 0x0x18
    public long <TimedRewardTreeNodeId>k__BackingField;    // 0x0x20
    public DateTime <CollectedAt>k__BackingField;    // 0x0x28
    public int <ConsumedXp>k__BackingField;    // 0x0x30
    public int <CurrentXp>k__BackingField;    // 0x0x34
    public int <TotalXp>k__BackingField;    // 0x0x38
    public List<int> <GiftDropIds>k__BackingField;    // 0x0x40
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedRewardTreeNodeDTO
//   (not directly referenced by a detected call)
public class TimedRewardTreeNodeDTO
{
    public Guid <ReplicationId>k__BackingField;    // 0x0x10
    public long <TimedRewardTreeNodeId>k__BackingField;    // 0x0x20
    public long? <ParentTimedRewardTreeNodeId>k__BackingField;    // 0x0x28
    public int? <ParentIndex>k__BackingField;    // 0x0x38
    public int <RequiredXp>k__BackingField;    // 0x0x40
    public List<int> <RewardGiftDropIds>k__BackingField;    // 0x0x48
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedRewardTreeRecordDTO
//   RESPONSE GET    api/timedRewardTrees   [Service.Econ]
//   RESPONSE GET    api/timedRewardTrees/{timedrewardtreeId}/record   [Service.Econ]
public class TimedRewardTreeRecordDTO
{
    public long <TimedRewardTreeId>k__BackingField;    // 0x0x10
    public int <AccountId>k__BackingField;    // 0x0x18
    public int <CurrentXp>k__BackingField;    // 0x0x1C
    public int <TotalXp>k__BackingField;    // 0x0x20
    public List<long> <CollectedNodeIds>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedRewardTreeXpEarnedDTO
//   (not directly referenced by a detected call)
public class TimedRewardTreeXpEarnedDTO
{
    ...
    public int <CurrentXp>k__BackingField;    // 0x0x1C
    public int <TotalXp>k__BackingField;    // 0x0x20
    public int <DeltaXp>k__BackingField;    // 0x0x24
    public float <DeltaXpMultiplier>k__BackingField;    // 0x0x28
}

// --------------------------------------------------------------------------
// RecNet.Interfaces.TimeLimitedEvents.TimedRewardTreeXpSinkDTO
// base   : RecNet.Interfaces.TimeLimitedEvents.TimedEventXpSinkDTO
//   (not directly referenced by a detected call)
public class TimedRewardTreeXpSinkDTO : TimedEventXpSinkDTO
{
    public long <TimedRewardTreeId>k__BackingField;    // 0x0x28
}
...
// --------------------------------------------------------------------------
// RecNet.LimitedTimeDiscountPromotionDTO
//   (not directly referenced by a detected call)
public class LimitedTimeDiscountPromotionDTO
{
    public LimitedTimeDiscountPromotionType <Type>k__BackingField;    // 0x0x10
    public decimal? <PercentOff>k__BackingField;    // 0x0x18
    public int? <SetPrice>k__BackingField;    // 0x0x30
    public int <DurationInMinutes>k__BackingField;    // 0x0x38
    public DateTime? <EndsAt>k__BackingField;    // 0x0x40
}
...
public class LoginResult : ValueType
{
    ...
    public VKJTNIDGMXL <SecurityCodeHint>k__BackingField;    // 0x0x8
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Data.FRNWCURICAL/EventDTO>
//   (not directly referenced by a detected call)
...
// base   : RecNet.Notifications/NotificationDto`1<RecNet.KAMYJMSMXWM/GiftPackageIdDTO>
//   (not directly referenced by a detected call)
...
// --------------------------------------------------------------------------
// RecNet.NotificationDto_PurchasableXpBoostActivationDTO
// base   : RecNet.Notifications/NotificationDto`1<RecNet.PurchasableXpBoostActivationDTO>
//   (not directly referenced by a detected call)
public class NotificationDto_PurchasableXpBoostActivationDTO
{
    // (no instance fields in the metadata dump)
}
...
// --------------------------------------------------------------------------
// RecNet.NotificationDto_TimedRewardTrackXpEarnedDTO
// base   : RecNet.Notifications/NotificationDto`1<RecNet.TimedRewardTrackXpEarnedDTO>
//   (not directly referenced by a detected call)
public class NotificationDto_TimedRewardTrackXpEarnedDTO
{
    // (no instance fields in the metadata dump)
}

// --------------------------------------------------------------------------
// RecNet.NotificationDto_TimedRewardTreeNodeCollectedDTO
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Interfaces.TimeLimitedEvents.TimedRewardTreeNodeCollectedDTO>
//   (not directly referenced by a detected call)
public class NotificationDto_TimedRewardTreeNodeCollectedDTO
{
    // (no instance fields in the metadata dump)
}

// --------------------------------------------------------------------------
// RecNet.NotificationDto_TimedRewardTreeXpEarnedDTO
// base   : RecNet.Notifications/NotificationDto`1<RecNet.Interfaces.TimeLimitedEvents.TimedRewardTreeXpEarnedDTO>
//   (not directly referenced by a detected call)
public class NotificationDto_TimedRewardTreeXpEarnedDTO
{
    // (no instance fields in the metadata dump)
}
...
public class Objective
{
    ...
    public string <DescriptionOverride>k__BackingField;    // 0x0x18
    public string <TooltipOverride>k__BackingField;    // 0x0x20
}
...
//   REQUEST  POST   api/objectives/v1/updateobjective   [Service.Data]
...
// --------------------------------------------------------------------------
// RecNet.PurchasableXpBoostActivationDTO
//   REQUEST  ?      api/purchasableXpBoosts   [Service.API]
public class PurchasableXpBoostActivationDTO
{
    public long <PurchasableXpBoostLedgerEntryId>k__BackingField;    // 0x0x10
    public Guid <PurchasableXpBoostId>k__BackingField;    // 0x0x18
    public float <XpMultiplier>k__BackingField;    // 0x0x28
    public DateTime <StartTime>k__BackingField;    // 0x0x30
    public DateTime <EndTime>k__BackingField;    // 0x0x38
}
...
// --------------------------------------------------------------------------
// RecNet.PurchaseCampaignPromotionDTO
//   (not directly referenced by a detected call)
public class PurchaseCampaignPromotionDTO
{
    public int <PurchaseCampaignId>k__BackingField;    // 0x0x10
    public List<GrantableId> <BonusSelectableGrantableIds>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// RecNet.PurchasePromotionDTO
//   RESPONSE GET    api/purchasePromotions/v2/promotion   [Service.Econ]
public class PurchasePromotionDTO
{
    public PurchasePromotionType <Type>k__BackingField;    // 0x0x10
    public StarterPackPromotionDTO <StarterPackPromotion>k__BackingField;    // 0x0x18
    public FreeItemsWithRRPlusPromotionDTO <FreeItemsWithRRPlusPromotion>k__BackingField;    // 0x0x20
    public LimitedTimeDiscountPromotionDTO <LimitedTimeDiscountPromotion>k__BackingField;    // 0x0x28
    public PurchaseCampaignPromotionDTO <PurchaseCampaignPromotion>k__BackingField;    // 0x0x30
}
...
//   RESPONSE POST   api/timeLimitedEvents   [Service.Econ]
//   RESPONSE POST   api/timeLimitedEvents/{timelimitedeventId}/acceptInvite   [Service.Econ]
//   RESPONSE POST   api/timeLimitedEvents/{timelimitedeventId}/declineInvite   [Service.Econ]
//   RESPONSE POST   api/timeLimitedEvents/{timelimitedeventId}/sendInvite   [Service.Econ]
//   RESPONSE POST   api/timedRewardTrees   [Service.Econ]
//   RESPONSE POST   api/timedRewardTrees/{timedrewardtreeId}/{id1}/collect   [Service.Econ]
...
// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_CompleteChallengeResponseDTO
// base   : RecNet.RecNetResultObject`1<RecNet.Interfaces.TimeLimitedEvents.CompleteChallengeResponseDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_CompleteChallengeResponseDTO
{
    // (no instance fields in the metadata dump)
}

// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_CookRecipeResultDTO
// base   : RecNet.RecNetResultObject`1<RecNet.Interfaces.TimeLimitedEvents.CookRecipeResultDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_CookRecipeResultDTO
{
    // (no instance fields in the metadata dump)
}
...
// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_IncrementalCookRecordDTO
// base   : RecNet.RecNetResultObject`1<RecNet.Interfaces.TimeLimitedEvents.IncrementalCookRecordDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_IncrementalCookRecordDTO
{
    // (no instance fields in the metadata dump)
}

// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_IngredientDTO
// base   : RecNet.RecNetResultObject`1<RecNet.Interfaces.TimeLimitedEvents.IngredientDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_IngredientDTO
{
    // (no instance fields in the metadata dump)
}
...
// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_RecipesEventChallengesDTO
// base   : RecNet.RecNetResultObject`1<RecNet.Interfaces.TimeLimitedEvents.RecipesEventChallengesDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_RecipesEventChallengesDTO
{
    // (no instance fields in the metadata dump)
}

// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_RecipesEventRewardsDTO
// base   : RecNet.RecNetResultObject`1<RecNet.Interfaces.TimeLimitedEvents.RecipesEventRewardsDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_RecipesEventRewardsDTO
{
    // (no instance fields in the metadata dump)
}
...
// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_SuperStageResultDTO
// base   : RecNet.RecNetResultObject`1<RecNet.Interfaces.TimeLimitedEvents.SuperStageResultDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_SuperStageResultDTO
{
    // (no instance fields in the metadata dump)
}

// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_TimedRewardTreeDTO
// base   : RecNet.RecNetResultObject`1<RecNet.Interfaces.TimeLimitedEvents.TimedRewardTreeDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_TimedRewardTreeDTO
{
    // (no instance fields in the metadata dump)
}

// --------------------------------------------------------------------------
// RecNet.RecNetResultObject_TimedRewardTreeRecordDTO
// base   : RecNet.RecNetResultObject`1<RecNet.Interfaces.TimeLimitedEvents.TimedRewardTreeRecordDTO>
//   (not directly referenced by a detected call)
public class RecNetResultObject_TimedRewardTreeRecordDTO
{
    // (no instance fields in the metadata dump)
}
...
// --------------------------------------------------------------------------
// RecNet.RewardPlayersForContextInRoomRequest
//   (not directly referenced by a detected call)
public class RewardPlayersForContextInRoomRequest
{
    public long <RoomId>k__BackingField;    // 0x0x10
    public long <SubRoomId>k__BackingField;    // 0x0x18
    public string <CheckpointName>k__BackingField;    // 0x0x20
    public List<string> <ActiveGameModifiers>k__BackingField;    // 0x0x28
    public Dictionary<int, HashSet<Guid>> <AccountIdsToCurrentOutfitCustomAvatarItemIds>k__BackingField;    // 0x0x30
    public Dictionary<int, int> <AccountIdsToTeamRank>k__BackingField;    // 0x0x38
}
...
public class RoomConsumableCreateOrUpdateRequest
{
    ...
    public UgcPurchasableItemVisibility <Visibility>k__BackingField;    // 0x0x5C
}
...
public class RoomOfferCreateOrUpdateRequestDTO
{
    ...
    public UgcPurchasableItemVisibility <Visibility>k__BackingField;    // 0x0x84
    public bool <IsGiftable>k__BackingField;    // 0x0x88
}
...
public class RoomOfferPurchaseRequestDTO
{
    ...
    public int? <GiftRecipientAccountId>k__BackingField;    // 0x0x48
}
...
{
    public Guid <RoomOfferId>k__BackingField;    // 0x0xC8
    public Guid? <PriceUnitId>k__BackingField;    // 0x0xD8
}
...
{
    public ObscuredInt DKMZVHAUBIJ;    // 0x0x10
...
// --------------------------------------------------------------------------
// RecNet.Rooms.PlayerRoomDataExportDTO
//   (not directly referenced by a detected call)
public class PlayerRoomDataExportDTO
{
    public long <RoomId>k__BackingField;    // 0x0x10
    public string <Data>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// RecNet.Rooms.PlayerRoomDataExportPageDTO
//   (not directly referenced by a detected call)
public class PlayerRoomDataExportPageDTO
{
    public int <AccountId>k__BackingField;    // 0x0x10
    public List<PlayerRoomDataExportDTO> <Items>k__BackingField;    // 0x0x18
    public string <ContinuationToken>k__BackingField;    // 0x0x20
}
...
public class RoomDetailsDTO : RoomDTO
{
    ...
    public IReadOnlyList<string> XRENVJWRYXD;    // 0x0x1D0
    public IReadOnlyList<string> BGFIPLEIIPN;    // 0x0x1D8
    public IReadOnlyList<string> KHHWQOXGKCT;    // 0x0x1E0
    public string JSLPOKFFASU;    // 0x0x1E8
    public IReadOnlyList<string> YMSSCJWNDRS;    // 0x0x1F0
    public bool? OAAAGWQRSHS;    // 0x0x1F8
    public bool? SQNTXMGHTAF;    // 0x0x1FA
    public IReadOnlyList<ObscuredInt> GTBEOZDZXGF;    // 0x0x200
    public IReadOnlyList<ObscuredInt> WKAFHLRRSCV;    // 0x0x208
    public ObscuredInt? QBRYLUYQISM;    // 0x0x210
}
...
// --------------------------------------------------------------------------
// RecNet.SquadAverageScoreDTO
//   (not directly referenced by a detected call)
public class SquadAverageScoreDTO
{
    public int <SquadId>k__BackingField;    // 0x0x10
    public int <AverageScore>k__BackingField;    // 0x0x14
}

// --------------------------------------------------------------------------
// RecNet.StarterPackPromotionDTO
//   (not directly referenced by a detected call)
public class StarterPackPromotionDTO
{
    public int <PurchaseReminderId>k__BackingField;    // 0x0x10
    public List<ItemPurchaseMethodId> <BonusItemIds>k__BackingField;    // 0x0x18
}
...
public class StorefrontGiftDrop
{
    ...
    public Guid? <PurchasableXpBoostId>k__BackingField;    // 0x0x8C
    public AvatarItemType? <AvatarItemType>k__BackingField;    // 0x0xA0
    public string <EquipmentPrefabName>k__BackingField;    // 0x0xA8
    public string <EquipmentModificationGuid>k__BackingField;    // 0x0xB0
    public bool <IsQuery>k__BackingField;    // 0x0xB8
    public bool <Unique>k__BackingField;    // 0x0xB9
    public bool <SubscribersOnly>k__BackingField;    // 0x0xBA
    public GiftRarity <Rarity>k__BackingField;    // 0x0xBC
    public CurrencyType <CurrencyType>k__BackingField;    // 0x0xC0
    public int <Currency>k__BackingField;    // 0x0xC4
    public GiftBoxContents <Content>k__BackingField;    // 0x0xC8
    public GiftContext <Context>k__BackingField;    // 0x0xCC
    public int <ItemCount>k__BackingField;    // 0x0xD0
    public int? <ItemSetId>k__BackingField;    // 0x0xD4
    public string <ItemSetFriendlyName>k__BackingField;    // 0x0xE0
    public int? <AvatarItemId>k__BackingField;    // 0x0xE8
    public int? <EquipmentItemId>k__BackingField;    // 0x0xF0
    public string <ThumbnailImageName>k__BackingField;    // 0x0xF8
}
...
public class TimedRewardTrackDTO
{
    ...
    public List<TimedRewardTrackLevelDTO> <Levels>k__BackingField;    // 0x0x38
}

// --------------------------------------------------------------------------
// RecNet.TimedRewardTrackLevelDTO
//   (not directly referenced by a detected call)
public class TimedRewardTrackLevelDTO
{
    public long <TimedRewardTrackLevelId>k__BackingField;    // 0x0x10
    public int <XpRequired>k__BackingField;    // 0x0x18
    public List<int> <RewardGiftDropIds>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// RecNet.TimedRewardTrackXpEarnedDTO
//   (not directly referenced by a detected call)
public class TimedRewardTrackXpEarnedDTO
{
    public long <TrackId>k__BackingField;    // 0x0x10
    public int <AccountId>k__BackingField;    // 0x0x18
    public int <TotalXp>k__BackingField;    // 0x0x1C
    public int <DeltaXp>k__BackingField;    // 0x0x20
    public float <DeltaXpMultiplier>k__BackingField;    // 0x0x24
}

// --------------------------------------------------------------------------
// RecNet.TokenSpendPurchaseReminderBalanceModificationResponse
// base   : RecNet.URBRABACEWX`1<RecNet.GiftPackage>
//   (not directly referenced by a detected call)
...
public class MessageContentDTO
{
    ...
    public string <Text>k__BackingField;    // 0x0x18
    public UGQQQLMFRRG <ImageFile>k__BackingField;    // 0x0x20
}
...
{
    public List<TMEVKFVBUCN> <Content>k__BackingField;    // 0x0x18
}
...
// --------------------------------------------------------------------------
// RecRoom.AI.OpenAI.Realtime.ResponseContentPartDTO
//   (not directly referenced by a detected call)
public class ResponseContentPartDTO
{
    public ResponseContentPartType <Type>k__BackingField;    // 0x0x10
    public string <Text>k__BackingField;    // 0x0x18
    public string <Audio>k__BackingField;    // 0x0x20
    public string <Transcript>k__BackingField;    // 0x0x28
}
...
public class ResponseContentPartEventDTO : EventBaseDTO
{
    ...
    public int <OutputIndex>k__BackingField;    // 0x0x30
    public int <ContentIndex>k__BackingField;    // 0x0x34
    public ResponseContentPartDTO <Part>k__BackingField;    // 0x0x38
}
...
{
    public UpdateInputVoiceTranscriptionSessionDTO <Session>k__BackingField;    // 0x0x20
}
...
// --------------------------------------------------------------------------
// RecRoom.AppUI.Data.ConsumeResult
// base   : System.Enum
//   (not directly referenced by a detected call)
...
public class PortViewHighlightRequest : ValueType
{
    ...
    public LVBVSRCPRKO _adapter;    // 0x0x8
...
public class WireHighlightRequest : ValueType
{
    ...
    public AWBRUIJTSSM _line;    // 0x0x8
...
public class AutocompleteResult : MonoBehaviour
{
    ...
    public bool YAIHZISCOHC;    // 0x0x30
}

// --------------------------------------------------------------------------
// RecRoom.ExportResult
// base   : System.ValueType
//   (not directly referenced by a detected call)
public class ExportResult : ValueType
{
    public ExportStatus ExportStatus;    // 0x0x0
    public ArchiveType ArchiveType;    // 0x0x4
    public FileInfo ZipArchiveFileInfo;    // 0x0x8
    public DirectoryInfo DirectoryInfo;    // 0x0x10
    public Exception Exception;    // 0x0x18
    public string ErrorString;    // 0x0x20
}
...
{
    public double Score;    // 0x0x0
    public int Index;    // 0x0x8
    public ReadOnlyMemory<char> Target;    // 0x0x10
    public BitArray highlightedChars;    // 0x0x20
}
...
{
    public JDYPUJIMVCY pendingRequests;    // 0x0x0
...
{
    public YYQIVVMNMAJ UPGGCETSTNW;    // 0x0x10
    public WWDAMWZGYHX CUEWYHKMBEW;    // 0x0x18
    public LWCSZZPQTXV OGRGGAIQQPK;    // 0x0x20
    public ZMVUTIDMKGZ LVVQXAFMRWU;    // 0x0x28
    public GRGAZRQUYTT OUSZPQKBEHA;    // 0x0x30
}
...
// --------------------------------------------------------------------------
// SharpGLTF.Validation.ValidationResult
//   (not directly referenced by a detected call)
public class ValidationResult
{
    public ModelRoot _Root;    // 0x0x10
    public ValidationMode _Mode;    // 0x0x18
    public bool _InstantThrow;    // 0x0x1C
    public List<Exception> _Errors;    // 0x0x20
}
...
public class ConsumablesV1QueryBulkRequest
{
    ...
    public List<string> configurationVersion;  // query
}
...
public class CustomAvatarItemsV1SearchRequest
{
    ...
    public IEnumerable<int> outfitTypes;  // query
    public string creatorUsername;  // query
    public int? creatorAccountId;  // query
    public int? minPrice;  // query
    public int? maxPrice;  // query
    public bool? isOwned;  // query
    public bool? isFeatured;  // query
    public object includePurchaseInfos;  // query
    public bool includeCoachItems;  // query
...
// api/customAvatarItems/v2/fromCreator/{creatorAccountId}  [API GET]
public class CustomAvatarItemsV2FromCreatorCreatorAccountIdRequest
{
...
// api/distanceMovedRewardTracks/distance  [Econ POST]
public class DistanceMovedRewardTracksDistanceRequest
{
    public object distanceMeters;  // form
}
...
{
    public List<long> inventionId;  // query
}
...
public class InventionsV2SearchRequest
{
    ...
    public List<long> skip;  // query
    public List<long> take;  // query
    public List<long> ugcVersion;  // query
}
...
public class Oktoberfeast2025ConsumeRequest
{
    ...
    public string consumableItemDesc;  // form
}
...
{
    public List<int> accountIds;  // form
    public object avatarItemId;  // form
}
...
{
    public List<int> accountIds;  // form
    public object equipmentItemId;  // form
}

// api/purchasePromotions/v2/promotion  [Econ GET]
public class PurchasePromotionsV2PromotionRequest
{
    public object ItemPurchaseMethodId.Type;  // query
    public object ItemPurchaseMethodId.NumberId;  // query
    public object ItemPurchaseMethodId.Guid;  // query
    public object RequestedPrice;  // query
    public object currencyType;  // query
}

// api/recipesEvents/{recipeseventId}/challenges/{challengeId}/complete  [Econ POST]
public class RecipesEventsRecipeseventIdChallengesChallengeIdCompleteRequest
{
    public object payToDoubleRewards;  // form
}

// api/recipesEvents/{recipeseventId}/ingredients/collect  [Econ POST]
public class RecipesEventsRecipeseventIdIngredientsCollectRequest
{
    public object flags;  // form
    public string consumableItemDesc;  // form
    public object consumableAccountId;  // form
}

// api/recipesEvents/{recipeseventId}/recipes/{recipeId}/cook  [Econ POST]
public class RecipesEventsRecipeseventIdRecipesRecipeIdCookRequest
{
    public object consumeStagedIngredients;  // form
}

// api/recipesEvents/{recipeseventId}/recipes/{recipeId}/super-stage  [Econ GET]
public class RecipesEventsRecipeseventIdRecipesRecipeIdSuperstageRequest
{
    public object ingredientId;  // query
    public object ingredientId;  // form
}
...
{
    public object RoomKeyId;  // form
    public object RequestedPrice;  // form
    public object RequestedPurchaseCurrencyId;  // form
    public object GiftRecipientAccountId;  // form
}

// api/storefronts/v1/buyProgressionEventXpBoost  [Econ POST]
public class StorefrontsV1BuyProgressionEventXpBoostRequest
{
    public object progressionEventId;  // form
    public object purchasableXpBoostId;  // form
    public object requestedPrice;  // form
    public object expectedXp;  // form
}
...
// api/timeLimitedEvents  [Econ GET]
public class TimeLimitedEventsRequest
{
    public object senderAccountId;  // query
    public object recipientAccountId;  // query
}

// api/timeLimitedEvents/{timelimitedeventId}/acceptInvite  [Econ POST]
public class TimeLimitedEventsTimelimitedeventIdAcceptInviteRequest
{
    public object senderAccountId;  // form
}

// api/timeLimitedEvents/{timelimitedeventId}/declineInvite  [Econ POST]
public class TimeLimitedEventsTimelimitedeventIdDeclineInviteRequest
{
    public object senderAccountId;  // form
}

// api/timeLimitedEvents/{timelimitedeventId}/sendInvite  [Econ POST]
public class TimeLimitedEventsTimelimitedeventIdSendInviteRequest
{
    public object recipientAccountId;  // form
}
